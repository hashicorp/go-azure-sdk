...
## `github.com/hashicorp/go-azure-sdk/data-plane/synapse/2021-06-01-preview/notebooks` Documentation

The `notebooks` SDK allows for interaction with <unknown source data type> `synapse` (API Version `2021-06-01-preview`).
...
```go
import "github.com/hashicorp/go-azure-sdk/data-plane/synapse/2021-06-01-preview/notebooks"
```
