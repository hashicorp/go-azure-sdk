...
type DatasetRenameDatasetOperationResponse struct {
...
func (c DatasetsClient) DatasetRenameDataset(ctx context.Context, id DatasetId, input ArtifactRenameRequest) (result DatasetRenameDatasetOperationResponse, err error) {
...
func (c DatasetsClient) DatasetRenameDatasetThenPoll(ctx context.Context, id DatasetId, input ArtifactRenameRequest) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after DatasetRenameDataset: %+v", err)
	}
