...
var _ Trigger = RerunTumblingWindowTrigger{}
...
var _ json.Marshaler = RerunTumblingWindowTrigger{}

func (s RerunTumblingWindowTrigger) MarshalJSON() ([]byte, error) {
	type wrapper RerunTumblingWindowTrigger
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling RerunTumblingWindowTrigger: %+v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("re-marshaling RerunTumblingWindowTrigger: %+v", err)
	}
