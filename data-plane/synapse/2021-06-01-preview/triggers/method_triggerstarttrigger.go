...
type TriggerStartTriggerOperationResponse struct {
...
// TriggerStartTrigger ...
func (c TriggersClient) TriggerStartTrigger(ctx context.Context, id TriggerId) (result TriggerStartTriggerOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:       fmt.Sprintf("%s/start", id.Path()),
	}
...
func (c TriggersClient) TriggerStartTriggerThenPoll(ctx context.Context, id TriggerId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after TriggerStartTrigger: %+v", err)
	}
