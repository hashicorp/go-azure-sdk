...
type DataFlowRenameDataFlowOperationResponse struct {
...
func (c DataFlowsClient) DataFlowRenameDataFlow(ctx context.Context, id DataflowId, input ArtifactRenameRequest) (result DataFlowRenameDataFlowOperationResponse, err error) {
...
func (c DataFlowsClient) DataFlowRenameDataFlowThenPoll(ctx context.Context, id DataflowId, input ArtifactRenameRequest) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after DataFlowRenameDataFlow: %+v", err)
	}
