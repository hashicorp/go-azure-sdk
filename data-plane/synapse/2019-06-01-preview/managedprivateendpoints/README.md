...
## `github.com/hashicorp/go-azure-sdk/data-plane/synapse/2019-06-01-preview/managedprivateendpoints` Documentation

The `managedprivateendpoints` SDK allows for interaction with <unknown source data type> `synapse` (API Version `2019-06-01-preview`).
...
```go
import "github.com/hashicorp/go-azure-sdk/data-plane/synapse/2019-06-01-preview/managedprivateendpoints"
```
