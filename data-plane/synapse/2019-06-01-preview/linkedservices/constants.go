...
const (
	...
	DynamicsAuthenticationTypeOfficeThreeSixFive  DynamicsAuthenticationType = "Office365"
)

func PossibleValuesForDynamicsAuthenticationType() []string {
	return []string{
		string(DynamicsAuthenticationTypeAADServicePrincipal),
		string(DynamicsAuthenticationTypeIfd),
		string(DynamicsAuthenticationTypeOfficeThreeSixFive),
	}
}

func (s *DynamicsAuthenticationType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseDynamicsAuthenticationType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseDynamicsAuthenticationType(input string) (*DynamicsAuthenticationType, error) {
	vals := map[string]DynamicsAuthenticationType{
		"aadserviceprincipal": DynamicsAuthenticationTypeAADServicePrincipal,
		"ifd":                 DynamicsAuthenticationTypeIfd,
		"office365":           DynamicsAuthenticationTypeOfficeThreeSixFive,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := DynamicsAuthenticationType(input)
	return &out, nil
}
...
func PossibleValuesForDynamicsDeploymentType() []string {
	return []string{
		string(DynamicsDeploymentTypeOnPremisesWithIfd),
		string(DynamicsDeploymentTypeOnline),
	}
}

func (s *DynamicsDeploymentType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseDynamicsDeploymentType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseDynamicsDeploymentType(input string) (*DynamicsDeploymentType, error) {
	vals := map[string]DynamicsDeploymentType{
		"onpremiseswithifd": DynamicsDeploymentTypeOnPremisesWithIfd,
		"online":            DynamicsDeploymentTypeOnline,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := DynamicsDeploymentType(input)
	return &out, nil
}
...
func PossibleValuesForDynamicsServicePrincipalCredentialType() []string {
	return []string{
		string(DynamicsServicePrincipalCredentialTypeServicePrincipalCert),
		string(DynamicsServicePrincipalCredentialTypeServicePrincipalKey),
	}
}

func (s *DynamicsServicePrincipalCredentialType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseDynamicsServicePrincipalCredentialType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseDynamicsServicePrincipalCredentialType(input string) (*DynamicsServicePrincipalCredentialType, error) {
	vals := map[string]DynamicsServicePrincipalCredentialType{
		"serviceprincipalcert": DynamicsServicePrincipalCredentialTypeServicePrincipalCert,
		"serviceprincipalkey":  DynamicsServicePrincipalCredentialTypeServicePrincipalKey,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := DynamicsServicePrincipalCredentialType(input)
	return &out, nil
}
...
func PossibleValuesForHdiNodeTypes() []string {
	return []string{
		string(HdiNodeTypesHeadnode),
		string(HdiNodeTypesWorkernode),
		string(HdiNodeTypesZookeeper),
	}
}

func (s *HdiNodeTypes) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseHdiNodeTypes(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseHdiNodeTypes(input string) (*HdiNodeTypes, error) {
	vals := map[string]HdiNodeTypes{
		"headnode":   HdiNodeTypesHeadnode,
		"workernode": HdiNodeTypesWorkernode,
		"zookeeper":  HdiNodeTypesZookeeper,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
