...
## `github.com/hashicorp/go-azure-sdk/data-plane/attestation/2022-08-01/attestation` Documentation

The `attestation` SDK allows for interaction with <unknown source data type> `attestation` (API Version `2022-08-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/data-plane/attestation/2022-08-01/attestation"
```
...
### Example Usage: `AttestationClient.AttestSevSnpVM`

```go
ctx := context.TODO()

payload := attestation.AttestSevSnpVMRequest{
	// ...
}


read, err := client.AttestSevSnpVM(ctx, payload)
if err != nil {
	// handle the error
}
if model := read.Model; model != nil {
