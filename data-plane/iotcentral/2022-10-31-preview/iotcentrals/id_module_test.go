...
func TestNewModuleID(t *testing.T) {
	id := NewModuleID("https://endpoint-url.example.com", "deviceId", "moduleName")
...
func TestFormatModuleID(t *testing.T) {
	actual := NewModuleID("https://endpoint-url.example.com", "deviceId", "moduleName").ID()
	expected := "https://endpoint-url.example.com/devices/deviceId/modules/moduleName"
	if actual != expected {
...
func TestParseModuleID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "https://endpoint-url.example.com/devices/deviceId/modules/moduleName/extra",
			Error: true,
		},
	}
