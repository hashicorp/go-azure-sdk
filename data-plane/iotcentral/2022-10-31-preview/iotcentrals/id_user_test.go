...
func TestNewUserID(t *testing.T) {
	id := NewUserID("https://endpoint-url.example.com", "userId")
...
func TestFormatUserID(t *testing.T) {
	actual := NewUserID("https://endpoint-url.example.com", "userId").ID()
	expected := "https://endpoint-url.example.com/users/userId"
	if actual != expected {
...
func TestParseUserID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "https://endpoint-url.example.com/users",
			Error: true,
		},
		{
			// Valid URI
			Input: "https://endpoint-url.example.com/users/userId",
			Expected: &UserId{
		...
		},
		{
			...
			Input: "https://endpoint-url.example.com/users/userId/extra",
			Error: true,
		},
	}
