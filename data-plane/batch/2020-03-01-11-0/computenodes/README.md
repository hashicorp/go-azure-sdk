...
## `github.com/hashicorp/go-azure-sdk/data-plane/batch/2020-03-01.11.0/computenodes` Documentation

The `computenodes` SDK allows for interaction with <unknown source data type> `batch` (API Version `2020-03-01.11.0`).
...
```go
import "github.com/hashicorp/go-azure-sdk/data-plane/batch/2020-03-01.11.0/computenodes"
```
...
```go
ctx := context.TODO()
id := computenodes.NewUserID("https://endpoint-url.example.com", "poolId", "nodeId")
