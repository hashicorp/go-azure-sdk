...
## `github.com/hashicorp/go-azure-sdk/data-plane/batch/2020-03-01.11.0/pools` Documentation

The `pools` SDK allows for interaction with <unknown source data type> `batch` (API Version `2020-03-01.11.0`).
...
```go
import "github.com/hashicorp/go-azure-sdk/data-plane/batch/2020-03-01.11.0/pools"
```
