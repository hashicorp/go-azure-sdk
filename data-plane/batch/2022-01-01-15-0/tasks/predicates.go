...
type CloudTaskOperationPredicate struct {
	CommandLine                 *string
	CreationTime                *string
	DisplayName                 *string
	ETag                        *string
...
func (p CloudTaskOperationPredicate) Matches(input CloudTask) bool {
	...
	if p.RequiredSlots != nil && (input.RequiredSlots == nil || *p.RequiredSlots != *input.RequiredSlots) {
		return false
	}
