...
type TaskReactivateOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type TaskReactivateOperationOptions struct {
...
func DefaultTaskReactivateOperationOptions() TaskReactivateOperationOptions {
	return TaskReactivateOperationOptions{}
}

func (o TaskReactivateOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o TaskReactivateOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}

	return &out
}

func (o TaskReactivateOperationOptions) ToQuery() *client.QueryParams {
...
// TaskReactivate ...
func (c TasksClient) TaskReactivate(ctx context.Context, id TaskId, options TaskReactivateOperationOptions) (result TaskReactivateOperationResponse, err error) {
