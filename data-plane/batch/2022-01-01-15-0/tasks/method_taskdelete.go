...
type TaskDeleteOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type TaskDeleteOperationOptions struct {
...
func DefaultTaskDeleteOperationOptions() TaskDeleteOperationOptions {
	return TaskDeleteOperationOptions{}
}

func (o TaskDeleteOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o TaskDeleteOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}

	return &out
}

func (o TaskDeleteOperationOptions) ToQuery() *client.QueryParams {
...
// TaskDelete ...
func (c TasksClient) TaskDelete(ctx context.Context, id TaskId, options TaskDeleteOperationOptions) (result TaskDeleteOperationResponse, err error) {
