...
type TaskGetOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *CloudTask
}

type TaskGetOperationOptions struct {
...
func DefaultTaskGetOperationOptions() TaskGetOperationOptions {
	return TaskGetOperationOptions{}
}

func (o TaskGetOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o TaskGetOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}

	return &out
}

func (o TaskGetOperationOptions) ToQuery() *client.QueryParams {
...
// TaskGet ...
func (c TasksClient) TaskGet(ctx context.Context, id TaskId, options TaskGetOperationOptions) (result TaskGetOperationResponse, err error) {
