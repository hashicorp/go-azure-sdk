...
type PoolDeleteOperationOptions struct {
...
func DefaultPoolDeleteOperationOptions() PoolDeleteOperationOptions {
	return PoolDeleteOperationOptions{}
}

func (o PoolDeleteOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o PoolDeleteOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}

	return &out
}

func (o PoolDeleteOperationOptions) ToQuery() *client.QueryParams {
...
// PoolDelete ...
func (c PoolsClient) PoolDelete(ctx context.Context, id PoolId, options PoolDeleteOperationOptions) (result PoolDeleteOperationResponse, err error) {
