...
type PoolPatchOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type PoolPatchOperationOptions struct {
...
func DefaultPoolPatchOperationOptions() PoolPatchOperationOptions {
	return PoolPatchOperationOptions{}
}

func (o PoolPatchOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o PoolPatchOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}

	return &out
}

func (o PoolPatchOperationOptions) ToQuery() *client.QueryParams {
...
// PoolPatch ...
func (c PoolsClient) PoolPatch(ctx context.Context, id PoolId, input PoolPatchParameter, options PoolPatchOperationOptions) (result PoolPatchOperationResponse, err error) {
