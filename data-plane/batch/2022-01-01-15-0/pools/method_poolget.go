...
type PoolGetOperationOptions struct {
...
func DefaultPoolGetOperationOptions() PoolGetOperationOptions {
	return PoolGetOperationOptions{}
}

func (o PoolGetOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o PoolGetOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}

	return &out
}

func (o PoolGetOperationOptions) ToQuery() *client.QueryParams {
...
// PoolGet ...
func (c PoolsClient) PoolGet(ctx context.Context, id PoolId, options PoolGetOperationOptions) (result PoolGetOperationResponse, err error) {
