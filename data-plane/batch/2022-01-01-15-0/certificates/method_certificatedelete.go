...
// CertificateDelete ...
func (c CertificatesClient) CertificateDelete(ctx context.Context, options CertificateDeleteOperationOptions) (result CertificateDeleteOperationResponse, err error) {
