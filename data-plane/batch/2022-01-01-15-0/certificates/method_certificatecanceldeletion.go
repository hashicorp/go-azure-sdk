...
type CertificateCancelDeletionOperationOptions struct {
...
func DefaultCertificateCancelDeletionOperationOptions() CertificateCancelDeletionOperationOptions {
	return CertificateCancelDeletionOperationOptions{}
}

func (o CertificateCancelDeletionOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o CertificateCancelDeletionOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}

	return &out
}

func (o CertificateCancelDeletionOperationOptions) ToQuery() *client.QueryParams {
