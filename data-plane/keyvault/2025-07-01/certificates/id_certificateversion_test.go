...
func TestNewCertificateversionID(t *testing.T) {
	id := NewCertificateversionID("https://endpoint_url", "certificateName")
...
func TestFormatCertificateversionID(t *testing.T) {
	actual := NewCertificateversionID("https://endpoint_url", "certificateName").ID()
	expected := "/https://endpoint_url/certificates/certificateName"
	if actual != expected {
...
func TestParseCertificateversionID(t *testing.T) {
	testData := []struct {
		...
		{
			// Valid URI
			Input: "/https://endpoint_url/certificates/certificateName",
			Expected: &CertificateversionId{
		...
		},
		{
			...
			Input: "/https://endpoint_url/certificates/certificateName/extra",
			Error: true,
		},
	}
