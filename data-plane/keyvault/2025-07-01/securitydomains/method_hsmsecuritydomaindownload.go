...
func (c SecuritydomainsClient) HSMSecurityDomainDownloadThenPoll(ctx context.Context, input CertificateInfoObject) error {
	return c.HSMSecurityDomainDownloadCallbackThenPoll(ctx, input, nil)
}

// HSMSecurityDomainDownloadCallbackThenPoll performs HSMSecurityDomainDownload, runs the optional callback function, then polls until it's completed
func (c SecuritydomainsClient) HSMSecurityDomainDownloadCallbackThenPoll(ctx context.Context, input CertificateInfoObject, callback func() error) error {
