...
func (c AdministrationsClient) SelectiveKeyRestoreOperation(ctx context.Context, id KeyId, input SelectiveKeyRestoreOperationParameters) (result SelectiveKeyRestoreOperationOperationResponse, err error) {
