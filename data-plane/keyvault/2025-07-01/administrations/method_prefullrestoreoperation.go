...
func (c AdministrationsClient) PreFullRestoreOperation(ctx context.Context, input PreRestoreOperationParameters) (result PreFullRestoreOperationOperationResponse, err error) {
