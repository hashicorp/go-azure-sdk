...
func (c AdministrationsClient) RoleAssignmentsListForScope(ctx context.Context, id ScopeId, options RoleAssignmentsListForScopeOperationOptions) (result RoleAssignmentsListForScopeOperationResponse, err error) {
...
func (c AdministrationsClient) RoleAssignmentsListForScopeComplete(ctx context.Context, id ScopeId, options RoleAssignmentsListForScopeOperationOptions) (RoleAssignmentsListForScopeCompleteResult, error) {
...
func (c AdministrationsClient) RoleAssignmentsListForScopeCompleteMatchingPredicate(ctx context.Context, id ScopeId, options RoleAssignmentsListForScopeOperationOptions, predicate RoleAssignmentOperationPredicate) (result RoleAssignmentsListForScopeCompleteResult, err error) {
