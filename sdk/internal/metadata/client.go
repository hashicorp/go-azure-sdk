...
func (c *Client) GetMetaData(ctx context.Context) (*MetaData, error) {
	...
	return &MetaData{
		...
		ResourceIdentifiers: ResourceIdentifiers{
			...
			LogAnalytics:   metadata.LogAnalyticsResourceId,
			Media:          metadata.Media,
			MicrosoftGraph: metadata.MicrosoftGraphResourceId,
			OSSRDBMS:       metadata.OssrDbmsResourceId,
			Synapse:        metadata.SynapseAnalyticsResourceId,
		},
