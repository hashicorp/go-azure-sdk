...
func (c PrivateEndpointConnectionsClient) UpdateTagsCallbackThenPoll(ctx context.Context, id PrivateEndpointConnectionId, input TagsObject, callback func() error) error {
