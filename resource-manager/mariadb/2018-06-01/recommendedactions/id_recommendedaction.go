...
func init() {
	recaser.RegisterResourceId(&RecommendedActionId{})
}
...
func (id RecommendedActionId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.DBforMariaDB/servers/%s/advisors/%s/recommendedActions/%s"
