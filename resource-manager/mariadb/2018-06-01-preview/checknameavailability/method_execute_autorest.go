...
func (c CheckNameAvailabilityClient) preparerForExecute(ctx context.Context, id commonids.SubscriptionId, input NameAvailabilityRequest) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/providers/Microsoft.DBforMariaDB/checkNameAvailability", id.ID())),
