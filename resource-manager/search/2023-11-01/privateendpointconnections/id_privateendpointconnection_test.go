...
func TestNewPrivateEndpointConnectionID(t *testing.T) {
	id := NewPrivateEndpointConnectionID("12345678-1234-9876-4563-123456789012", "example-resource-group", "searchServiceName", "privateEndpointConnectionName")
...
func TestFormatPrivateEndpointConnectionID(t *testing.T) {
	actual := NewPrivateEndpointConnectionID("12345678-1234-9876-4563-123456789012", "example-resource-group", "searchServiceName", "privateEndpointConnectionName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Search/searchServices/searchServiceName/privateEndpointConnections/privateEndpointConnectionName"
	if actual != expected {
...
func TestParsePrivateEndpointConnectionID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Search/searchServices/searchServiceName/privateEndpointConnections",
			Error: true,
		},
		{
			// Valid URI
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Search/searchServices/searchServiceName/privateEndpointConnections/privateEndpointConnectionName/extra",
			Error: true,
		},
	}
