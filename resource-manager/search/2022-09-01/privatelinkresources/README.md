...
## `github.com/hashicorp/go-azure-sdk/resource-manager/search/2022-09-01/privatelinkresources` Documentation

The `privatelinkresources` SDK allows for interaction with Azure Resource Manager `search` (API Version `2022-09-01`).
