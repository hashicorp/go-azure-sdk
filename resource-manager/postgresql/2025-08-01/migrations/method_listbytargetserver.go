...
func (c MigrationsClient) ListByTargetServerComplete(ctx context.Context, id FlexibleServerId, options ListByTargetServerOperationOptions) (ListByTargetServerCompleteResult, error) {
	return c.ListByTargetServerCompleteMatchingPredicate(ctx, id, options, MigrationOperationPredicate{})
}

// ListByTargetServerCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c MigrationsClient) ListByTargetServerCompleteMatchingPredicate(ctx context.Context, id FlexibleServerId, options ListByTargetServerOperationOptions, predicate MigrationOperationPredicate) (result ListByTargetServerCompleteResult, err error) {
