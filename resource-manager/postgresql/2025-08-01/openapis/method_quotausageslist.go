...
// QuotaUsagesList ...
func (c OpenapisClient) QuotaUsagesList(ctx context.Context, id LocationId) (result QuotaUsagesListOperationResponse, err error) {
...
func (c OpenapisClient) QuotaUsagesListComplete(ctx context.Context, id LocationId) (QuotaUsagesListCompleteResult, error) {
...
func (c OpenapisClient) QuotaUsagesListCompleteMatchingPredicate(ctx context.Context, id LocationId, predicate QuotaUsageOperationPredicate) (result QuotaUsagesListCompleteResult, err error) {
