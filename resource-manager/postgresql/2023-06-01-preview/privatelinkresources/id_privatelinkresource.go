...
func NewPrivateLinkResourceID(subscriptionId string, resourceGroupName string, flexibleServerName string, privateLinkResourceName string) PrivateLinkResourceId {
...
func (id PrivateLinkResourceId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.DBforPostgreSQL/flexibleServers/%s/privateLinkResources/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.FlexibleServerName, id.PrivateLinkResourceName)
}
