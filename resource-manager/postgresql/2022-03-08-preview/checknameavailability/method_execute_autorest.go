...
func (c CheckNameAvailabilityClient) preparerForExecute(ctx context.Context, id commonids.SubscriptionId, input CheckNameAvailabilityRequest) (*http.Request, error) {
