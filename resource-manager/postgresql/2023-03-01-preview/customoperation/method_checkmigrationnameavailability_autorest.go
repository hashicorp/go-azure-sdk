...
func (c CustomOperationClient) CheckMigrationNameAvailability(ctx context.Context, id FlexibleServerId, input MigrationNameAvailabilityResource) (result CheckMigrationNameAvailabilityOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "customoperation.CustomOperationClient", "CheckMigrationNameAvailability", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "customoperation.CustomOperationClient", "CheckMigrationNameAvailability", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForCheckMigrationNameAvailability(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "customoperation.CustomOperationClient", "CheckMigrationNameAvailability", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c CustomOperationClient) preparerForCheckMigrationNameAvailability(ctx context.Context, id FlexibleServerId, input MigrationNameAvailabilityResource) (*http.Request, error) {
...
func (c CustomOperationClient) responderForCheckMigrationNameAvailability(resp *http.Response) (result CheckMigrationNameAvailabilityOperationResponse, err error) {
