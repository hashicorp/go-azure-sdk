...
func TestFormatTopQueryStatisticID(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DBforPostgreSQL/servers/serverValue/topQueryStatistics/queryStatisticIdValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseTopQueryStatisticID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DBforPostgreSQL/servers/serverValue/topQueryStatistics",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DBforPostgreSQL/servers/serverValue/topQueryStatistics/queryStatisticIdValue",
			Expected: &TopQueryStatisticId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DBforPostgreSQL/servers/serverValue/topQueryStatistics/queryStatisticIdValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseTopQueryStatisticID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
		...
		if actual.QueryStatisticId != v.Expected.QueryStatisticId {
			t.Fatalf("Expected %q but got %q for QueryStatisticId", v.Expected.QueryStatisticId, actual.QueryStatisticId)
		}

	}
}

func TestParseTopQueryStatisticIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *TopQueryStatisticId
	...
	for _, v := range testData {
		...
		actual, err := ParseTopQueryStatisticIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForTopQueryStatisticId(t *testing.T) {
	segments := TopQueryStatisticId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("TopQueryStatisticId has no segments")
	}
