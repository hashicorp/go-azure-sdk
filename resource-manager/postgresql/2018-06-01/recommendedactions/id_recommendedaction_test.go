...
func TestFormatRecommendedActionID(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DBforPostgreSQL/servers/serverValue/advisors/advisorValue/recommendedActions/recommendedActionValue"
	if actual != expected {
...
func TestParseRecommendedActionID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DBforPostgreSQL/servers/serverValue/advisors/advisorValue/recommendedActions",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DBforPostgreSQL/servers/serverValue/advisors/advisorValue/recommendedActions/recommendedActionValue",
			Expected: &RecommendedActionId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DBforPostgreSQL/servers/serverValue/advisors/advisorValue/recommendedActions/recommendedActionValue/extra",
			Error: true,
		},
	}
