...
func (c AdministratorsClient) CreateCallbackThenPoll(ctx context.Context, id AdministratorId, input ActiveDirectoryAdministratorAdd, callback func() error) error {
