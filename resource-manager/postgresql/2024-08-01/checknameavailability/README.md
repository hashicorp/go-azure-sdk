...
## `github.com/hashicorp/go-azure-sdk/resource-manager/postgresql/2024-08-01/checknameavailability` Documentation

The `checknameavailability` SDK allows for interaction with Azure Resource Manager `postgresql` (API Version `2024-08-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/postgresql/2024-08-01/checknameavailability"
```
