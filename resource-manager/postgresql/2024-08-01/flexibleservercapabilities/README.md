...
## `github.com/hashicorp/go-azure-sdk/resource-manager/postgresql/2024-08-01/flexibleservercapabilities` Documentation

The `flexibleservercapabilities` SDK allows for interaction with Azure Resource Manager `postgresql` (API Version `2024-08-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/postgresql/2024-08-01/flexibleservercapabilities"
```
