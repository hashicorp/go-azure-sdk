...
func (c VirtualMachineImageTemplateClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ImageTemplateId, input ImageTemplate, callback func() error) error {
