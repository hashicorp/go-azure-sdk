...
func (c VirtualMachineImageTemplateClient) UpdateCallbackThenPoll(ctx context.Context, id ImageTemplateId, input ImageTemplateUpdateParameters, callback func() error) error {
