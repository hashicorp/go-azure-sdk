...
func NewPrivateEndpointConnectionID(subscriptionId string, resourceGroupName string, digitalTwinsInstanceName string, privateEndpointConnectionName string) PrivateEndpointConnectionId {
...
func (id PrivateEndpointConnectionId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.DigitalTwins/digitalTwinsInstances/%s/privateEndpointConnections/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.DigitalTwinsInstanceName, id.PrivateEndpointConnectionName)
}
