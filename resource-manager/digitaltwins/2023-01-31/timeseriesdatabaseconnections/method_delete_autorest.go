...
func (o DeleteOperationOptions) toQueryString() map[string]interface{} {
	...
	if o.CleanupConnectionArtifacts != nil {
		out["cleanupConnectionArtifacts"] = *o.CleanupConnectionArtifacts
	}
...
func (c TimeSeriesDatabaseConnectionsClient) preparerForDelete(ctx context.Context, id TimeSeriesDatabaseConnectionId, options DeleteOperationOptions) (*http.Request, error) {
