...
## `github.com/hashicorp/go-azure-sdk/resource-manager/digitaltwins/2022-10-31/digitaltwinsinstance` Documentation

The `digitaltwinsinstance` SDK allows for interaction with the Azure Resource Manager Service `digitaltwins` (API Version `2022-10-31`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/digitaltwins/2022-10-31/digitaltwinsinstance"
```
