...
func (c PrivateEndpointsClient) PrivateEndpointConnectionsDelete(ctx context.Context, id PrivateEndpointConnectionId) (result PrivateEndpointConnectionsDeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "privateendpoints.PrivateEndpointsClient", "PrivateEndpointConnectionsDelete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForPrivateEndpointConnectionsDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "privateendpoints.PrivateEndpointsClient", "PrivateEndpointConnectionsDelete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c PrivateEndpointsClient) preparerForPrivateEndpointConnectionsDelete(ctx context.Context, id PrivateEndpointConnectionId) (*http.Request, error) {
...
func (c PrivateEndpointsClient) senderForPrivateEndpointConnectionsDelete(ctx context.Context, req *http.Request) (future PrivateEndpointConnectionsDeleteOperationResponse, err error) {
