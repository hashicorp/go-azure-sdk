...
func (c AssetEndpointProfilesClient) CreateOrReplaceCallbackThenPoll(ctx context.Context, id AssetEndpointProfileId, input AssetEndpointProfile, callback func() error) error {
