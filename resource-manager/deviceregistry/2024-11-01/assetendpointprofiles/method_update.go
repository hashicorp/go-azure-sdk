...
func (c AssetEndpointProfilesClient) UpdateCallbackThenPoll(ctx context.Context, id AssetEndpointProfileId, input AssetEndpointProfileUpdate, callback func() error) error {
