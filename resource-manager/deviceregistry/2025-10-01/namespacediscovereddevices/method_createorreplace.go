...
// CreateOrReplace ...
func (c NamespaceDiscoveredDevicesClient) CreateOrReplace(ctx context.Context, id DiscoveredDeviceId, input NamespaceDiscoveredDevice) (result CreateOrReplaceOperationResponse, err error) {
