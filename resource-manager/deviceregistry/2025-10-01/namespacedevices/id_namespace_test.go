...
func TestNewNamespaceID(t *testing.T) {
	id := NewNamespaceID("12345678-1234-9876-4563-123456789012", "example-resource-group", "namespaceName")
...
func TestFormatNamespaceID(t *testing.T) {
	actual := NewNamespaceID("12345678-1234-9876-4563-123456789012", "example-resource-group", "namespaceName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DeviceRegistry/namespaces/namespaceName"
	if actual != expected {
...
func TestParseNamespaceID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DeviceRegistry/namespaces/namespaceName/extra",
			Error: true,
		},
	}
