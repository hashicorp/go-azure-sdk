...
func (c DiscoveredAssetsClient) CreateOrReplaceCallbackThenPoll(ctx context.Context, id DiscoveredAssetId, input DiscoveredAsset, callback func() error) error {
