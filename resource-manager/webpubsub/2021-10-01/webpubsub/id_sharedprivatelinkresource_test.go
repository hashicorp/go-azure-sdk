...
func TestFormatSharedPrivateLinkResourceID(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.SignalRService/webPubSub/resourceValue/sharedPrivateLinkResources/sharedPrivateLinkResourceValue"
	if actual != expected {
...
func TestParseSharedPrivateLinkResourceID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.SignalRService/webPubSub/resourceValue/sharedPrivateLinkResources",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.SignalRService/webPubSub/resourceValue/sharedPrivateLinkResources/sharedPrivateLinkResourceValue",
			Expected: &SharedPrivateLinkResourceId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.SignalRService/webPubSub/resourceValue/sharedPrivateLinkResources/sharedPrivateLinkResourceValue/extra",
			Error: true,
		},
	}
