...
type StandbyVirtualMachinePoolPrediction struct {
	...
	ForecastValues    StandbyVirtualMachinePoolForecastValues `json:"forecastValues"`
}

func (o *StandbyVirtualMachinePoolPrediction) GetForecastStartTimeAsTime() (*time.Time, error) {
	return dates.ParseAsFormat(&o.ForecastStartTime, "2006-01-02T15:04:05Z07:00")
}

func (o *StandbyVirtualMachinePoolPrediction) SetForecastStartTimeAsTime(input time.Time) {
