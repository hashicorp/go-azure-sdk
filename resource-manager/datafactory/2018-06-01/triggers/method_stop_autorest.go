...
func (c TriggersClient) Stop(ctx context.Context, id TriggerId) (result StopOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "triggers.TriggersClient", "Stop", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForStop(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "triggers.TriggersClient", "Stop", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c TriggersClient) preparerForStop(ctx context.Context, id TriggerId) (*http.Request, error) {
...
func (c TriggersClient) senderForStop(ctx context.Context, req *http.Request) (future StopOperationResponse, err error) {
