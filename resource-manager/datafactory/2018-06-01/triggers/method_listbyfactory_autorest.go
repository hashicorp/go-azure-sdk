...
func (c TriggersClient) ListByFactory(ctx context.Context, id FactoryId) (resp ListByFactoryOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "triggers.TriggersClient", "ListByFactory", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "triggers.TriggersClient", "ListByFactory", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByFactory(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "triggers.TriggersClient", "ListByFactory", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c TriggersClient) preparerForListByFactory(ctx context.Context, id FactoryId) (*http.Request, error) {
...
func (c TriggersClient) preparerForListByFactoryWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c TriggersClient) responderForListByFactory(resp *http.Response) (result ListByFactoryOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByFactoryOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "triggers.TriggersClient", "ListByFactory", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByFactory(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "triggers.TriggersClient", "ListByFactory", result.HttpResponse, "Failure responding to request")
				return
			}
