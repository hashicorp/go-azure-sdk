...
func (c TriggersClient) Start(ctx context.Context, id TriggerId) (result StartOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "triggers.TriggersClient", "Start", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForStart(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "triggers.TriggersClient", "Start", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c TriggersClient) preparerForStart(ctx context.Context, id TriggerId) (*http.Request, error) {
...
func (c TriggersClient) senderForStart(ctx context.Context, req *http.Request) (future StartOperationResponse, err error) {
