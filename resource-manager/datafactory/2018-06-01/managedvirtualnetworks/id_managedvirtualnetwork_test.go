...
func TestNewManagedVirtualNetworkID(t *testing.T) {
	id := NewManagedVirtualNetworkID("12345678-1234-9876-4563-123456789012", "example-resource-group", "factoryName", "managedVirtualNetworkName")
...
func TestFormatManagedVirtualNetworkID(t *testing.T) {
	actual := NewManagedVirtualNetworkID("12345678-1234-9876-4563-123456789012", "example-resource-group", "factoryName", "managedVirtualNetworkName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DataFactory/factories/factoryName/managedVirtualNetworks/managedVirtualNetworkName"
	if actual != expected {
...
func TestParseManagedVirtualNetworkID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DataFactory/factories/factoryName/managedVirtualNetworks/managedVirtualNetworkName/extra",
			Error: true,
		},
	}
