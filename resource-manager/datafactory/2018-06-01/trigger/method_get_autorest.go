...
func (c TriggerClient) Get(ctx context.Context, id TriggerId, options GetOperationOptions) (result GetOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "trigger.TriggerClient", "Get", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "trigger.TriggerClient", "Get", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForGet(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "trigger.TriggerClient", "Get", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c TriggerClient) preparerForGet(ctx context.Context, id TriggerId, options GetOperationOptions) (*http.Request, error) {
