...
func (c IntegrationRuntimeObjectMetadataClient) Refresh(ctx context.Context, id IntegrationRuntimeId) (result RefreshOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "integrationruntimeobjectmetadata.IntegrationRuntimeObjectMetadataClient", "Refresh", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForRefresh(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "integrationruntimeobjectmetadata.IntegrationRuntimeObjectMetadataClient", "Refresh", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c IntegrationRuntimeObjectMetadataClient) preparerForRefresh(ctx context.Context, id IntegrationRuntimeId) (*http.Request, error) {
...
func (c IntegrationRuntimeObjectMetadataClient) senderForRefresh(ctx context.Context, req *http.Request) (future RefreshOperationResponse, err error) {
