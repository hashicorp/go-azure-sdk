...
// ListByFactory ...
func (c GlobalParametersClient) ListByFactory(ctx context.Context, id FactoryId) (resp ListByFactoryOperationResponse, err error) {
	req, err := c.preparerForListByFactory(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "globalparameters.GlobalParametersClient", "ListByFactory", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "globalparameters.GlobalParametersClient", "ListByFactory", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByFactory(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "globalparameters.GlobalParametersClient", "ListByFactory", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c GlobalParametersClient) preparerForListByFactory(ctx context.Context, id FactoryId) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/globalParameters", id.ID())),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}

// preparerForListByFactoryWithNextLink prepares the ListByFactory request with the given nextLink token.
func (c GlobalParametersClient) preparerForListByFactoryWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c GlobalParametersClient) responderForListByFactory(resp *http.Response) (result ListByFactoryOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByFactoryOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "globalparameters.GlobalParametersClient", "ListByFactory", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByFactory(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "globalparameters.GlobalParametersClient", "ListByFactory", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c GlobalParametersClient) ListByFactoryCompleteMatchingPredicate(ctx context.Context, id FactoryId, predicate GlobalParameterResourceOperationPredicate) (resp ListByFactoryCompleteResult, err error) {
