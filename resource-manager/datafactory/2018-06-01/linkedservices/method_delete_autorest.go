...
func (c LinkedServicesClient) Delete(ctx context.Context, id LinkedServiceId) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "linkedservices.LinkedServicesClient", "Delete", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c LinkedServicesClient) responderForDelete(resp *http.Response) (result DeleteOperationResponse, err error) {
