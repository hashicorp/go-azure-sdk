...
func (c LinkedServicesClient) CreateOrUpdate(ctx context.Context, id LinkedServiceId, input LinkedServiceResource, options CreateOrUpdateOperationOptions) (result CreateOrUpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "linkedservices.LinkedServicesClient", "CreateOrUpdate", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c LinkedServicesClient) preparerForCreateOrUpdate(ctx context.Context, id LinkedServiceId, input LinkedServiceResource, options CreateOrUpdateOperationOptions) (*http.Request, error) {
...
func (c LinkedServicesClient) responderForCreateOrUpdate(resp *http.Response) (result CreateOrUpdateOperationResponse, err error) {
