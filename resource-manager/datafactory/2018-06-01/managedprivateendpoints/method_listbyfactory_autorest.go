...
func (c ManagedPrivateEndpointsClient) ListByFactory(ctx context.Context, id ManagedVirtualNetworkId) (resp ListByFactoryOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "managedprivateendpoints.ManagedPrivateEndpointsClient", "ListByFactory", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "managedprivateendpoints.ManagedPrivateEndpointsClient", "ListByFactory", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByFactory(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "managedprivateendpoints.ManagedPrivateEndpointsClient", "ListByFactory", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ManagedPrivateEndpointsClient) preparerForListByFactory(ctx context.Context, id ManagedVirtualNetworkId) (*http.Request, error) {
...
func (c ManagedPrivateEndpointsClient) preparerForListByFactoryWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ManagedPrivateEndpointsClient) responderForListByFactory(resp *http.Response) (result ListByFactoryOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByFactoryOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "managedprivateendpoints.ManagedPrivateEndpointsClient", "ListByFactory", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByFactory(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "managedprivateendpoints.ManagedPrivateEndpointsClient", "ListByFactory", result.HttpResponse, "Failure responding to request")
				return
			}
