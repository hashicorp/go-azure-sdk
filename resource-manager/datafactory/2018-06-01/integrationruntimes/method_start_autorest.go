...
func (c IntegrationRuntimesClient) Start(ctx context.Context, id IntegrationRuntimeId) (result StartOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "integrationruntimes.IntegrationRuntimesClient", "Start", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForStart(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "integrationruntimes.IntegrationRuntimesClient", "Start", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c IntegrationRuntimesClient) preparerForStart(ctx context.Context, id IntegrationRuntimeId) (*http.Request, error) {
...
func (c IntegrationRuntimesClient) senderForStart(ctx context.Context, req *http.Request) (future StartOperationResponse, err error) {
