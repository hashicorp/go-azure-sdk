...
func (c IntegrationRuntimesClient) Stop(ctx context.Context, id IntegrationRuntimeId) (result StopOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "integrationruntimes.IntegrationRuntimesClient", "Stop", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForStop(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "integrationruntimes.IntegrationRuntimesClient", "Stop", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c IntegrationRuntimesClient) preparerForStop(ctx context.Context, id IntegrationRuntimeId) (*http.Request, error) {
...
func (c IntegrationRuntimesClient) senderForStop(ctx context.Context, req *http.Request) (future StopOperationResponse, err error) {
