...
func (c DataFlowDebugSessionClient) CreateCallbackThenPoll(ctx context.Context, id FactoryId, input CreateDataFlowDebugSessionRequest, callback func() error) error {
