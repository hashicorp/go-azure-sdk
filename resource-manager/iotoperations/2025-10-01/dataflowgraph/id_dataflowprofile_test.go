...
func TestNewDataflowProfileID(t *testing.T) {
	id := NewDataflowProfileID("12345678-1234-9876-4563-123456789012", "example-resource-group", "instanceName", "dataflowProfileName")
...
func TestFormatDataflowProfileID(t *testing.T) {
	actual := NewDataflowProfileID("12345678-1234-9876-4563-123456789012", "example-resource-group", "instanceName", "dataflowProfileName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.IoTOperations/instances/instanceName/dataflowProfiles/dataflowProfileName"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseDataflowProfileID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *DataflowProfileId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.IoTOperations/instances/instanceName/dataflowProfiles/dataflowProfileName/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseDataflowProfileID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseDataflowProfileIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *DataflowProfileId
	...
	for _, v := range testData {
		...
		actual, err := ParseDataflowProfileIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForDataflowProfileId(t *testing.T) {
	segments := DataflowProfileId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("DataflowProfileId has no segments")
	}
