...
func PossibleValuesForDataflowHeaderActionType() []string {
	return []string{
		string(DataflowHeaderActionTypeAddIfNotPresent),
		string(DataflowHeaderActionTypeAddOrReplace),
		string(DataflowHeaderActionTypeRemove),
	}
}

func (s *DataflowHeaderActionType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseDataflowHeaderActionType(decoded)
	if err != nil {
...
func parseDataflowHeaderActionType(input string) (*DataflowHeaderActionType, error) {
	vals := map[string]DataflowHeaderActionType{
		"addifnotpresent": DataflowHeaderActionTypeAddIfNotPresent,
		"addorreplace":    DataflowHeaderActionTypeAddOrReplace,
		"remove":          DataflowHeaderActionTypeRemove,
	}
	...
	out := DataflowHeaderActionType(input)
	return &out, nil
}
