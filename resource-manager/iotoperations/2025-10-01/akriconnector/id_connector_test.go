...
func TestNewConnectorID(t *testing.T) {
	id := NewConnectorID("12345678-1234-9876-4563-123456789012", "example-resource-group", "instanceName", "akriConnectorTemplateName", "connectorName")
...
func TestFormatConnectorID(t *testing.T) {
	actual := NewConnectorID("12345678-1234-9876-4563-123456789012", "example-resource-group", "instanceName", "akriConnectorTemplateName", "connectorName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.IoTOperations/instances/instanceName/akriConnectorTemplates/akriConnectorTemplateName/connectors/connectorName"
	if actual != expected {
...
func TestParseConnectorID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.IoTOperations/instances/instanceName/akriConnectorTemplates/akriConnectorTemplateName/connectors",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.IoTOperations/instances/instanceName/akriConnectorTemplates/akriConnectorTemplateName/connectors/connectorName",
			Expected: &ConnectorId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.IoTOperations/instances/instanceName/akriConnectorTemplates/akriConnectorTemplateName/connectors/connectorName/extra",
			Error: true,
		},
	}
