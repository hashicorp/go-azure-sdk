...
func PossibleValuesForDataflowEndpointHostType() []string {
	return []string{
		string(DataflowEndpointHostTypeCustomKafka),
		string(DataflowEndpointHostTypeCustomMqtt),
		string(DataflowEndpointHostTypeEventGrid),
		string(DataflowEndpointHostTypeEventhub),
		string(DataflowEndpointHostTypeFabricRT),
		string(DataflowEndpointHostTypeLocalBroker),
	}
}

func (s *DataflowEndpointHostType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseDataflowEndpointHostType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseDataflowEndpointHostType(input string) (*DataflowEndpointHostType, error) {
	vals := map[string]DataflowEndpointHostType{
		"customkafka": DataflowEndpointHostTypeCustomKafka,
		"custommqtt":  DataflowEndpointHostTypeCustomMqtt,
		"eventgrid":   DataflowEndpointHostTypeEventGrid,
		"eventhub":    DataflowEndpointHostTypeEventhub,
		"fabricrt":    DataflowEndpointHostTypeFabricRT,
		"localbroker": DataflowEndpointHostTypeLocalBroker,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := DataflowEndpointHostType(input)
	return &out, nil
}
...
const (
	...
	DataflowOpenTelemetryAuthenticationMethodXFiveZeroNineCertificate DataflowOpenTelemetryAuthenticationMethod = "X509Certificate"
)

func PossibleValuesForDataflowOpenTelemetryAuthenticationMethod() []string {
	return []string{
		string(DataflowOpenTelemetryAuthenticationMethodAnonymous),
		string(DataflowOpenTelemetryAuthenticationMethodServiceAccountToken),
		string(DataflowOpenTelemetryAuthenticationMethodXFiveZeroNineCertificate),
	}
}

func (s *DataflowOpenTelemetryAuthenticationMethod) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseDataflowOpenTelemetryAuthenticationMethod(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseDataflowOpenTelemetryAuthenticationMethod(input string) (*DataflowOpenTelemetryAuthenticationMethod, error) {
	vals := map[string]DataflowOpenTelemetryAuthenticationMethod{
		"anonymous":           DataflowOpenTelemetryAuthenticationMethodAnonymous,
		"serviceaccounttoken": DataflowOpenTelemetryAuthenticationMethodServiceAccountToken,
		"x509certificate":     DataflowOpenTelemetryAuthenticationMethodXFiveZeroNineCertificate,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := DataflowOpenTelemetryAuthenticationMethod(input)
	return &out, nil
}
...
func PossibleValuesForEndpointType() []string {
	return []string{
		...
		string(EndpointTypeOpenTelemetry),
	}
}
...
func parseEndpointType(input string) (*EndpointType, error) {
	vals := map[string]EndpointType{
		...
		"opentelemetry":   EndpointTypeOpenTelemetry,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
