...
func TestNewBrokerID(t *testing.T) {
	id := NewBrokerID("12345678-1234-9876-4563-123456789012", "example-resource-group", "instanceName", "brokerName")
...
func TestFormatBrokerID(t *testing.T) {
	actual := NewBrokerID("12345678-1234-9876-4563-123456789012", "example-resource-group", "instanceName", "brokerName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.IoTOperations/instances/instanceName/brokers/brokerName"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseBrokerID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *BrokerId
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.IoTOperations/instances/instanceName/brokers/brokerName/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseBrokerID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseBrokerIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *BrokerId
	...
	for _, v := range testData {
		...
		actual, err := ParseBrokerIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForBrokerId(t *testing.T) {
	segments := BrokerId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("BrokerId has no segments")
	}
