...
func (c ShareSubscriptionClient) ListSynchronizationDetails(ctx context.Context, id ShareSubscriptionId, input ShareSubscriptionSynchronization, options ListSynchronizationDetailsOperationOptions) (resp ListSynchronizationDetailsOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "sharesubscription.ShareSubscriptionClient", "ListSynchronizationDetails", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "sharesubscription.ShareSubscriptionClient", "ListSynchronizationDetails", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListSynchronizationDetails(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "sharesubscription.ShareSubscriptionClient", "ListSynchronizationDetails", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ShareSubscriptionClient) preparerForListSynchronizationDetails(ctx context.Context, id ShareSubscriptionId, input ShareSubscriptionSynchronization, options ListSynchronizationDetailsOperationOptions) (*http.Request, error) {
...
func (c ShareSubscriptionClient) preparerForListSynchronizationDetailsWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ShareSubscriptionClient) responderForListSynchronizationDetails(resp *http.Response) (result ListSynchronizationDetailsOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListSynchronizationDetailsOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "sharesubscription.ShareSubscriptionClient", "ListSynchronizationDetails", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListSynchronizationDetails(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "sharesubscription.ShareSubscriptionClient", "ListSynchronizationDetails", result.HttpResponse, "Failure responding to request")
				return
			}
