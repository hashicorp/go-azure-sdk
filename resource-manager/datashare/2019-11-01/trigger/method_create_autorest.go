...
func (c TriggerClient) Create(ctx context.Context, id TriggerId, input Trigger) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "trigger.TriggerClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "trigger.TriggerClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c TriggerClient) preparerForCreate(ctx context.Context, id TriggerId, input Trigger) (*http.Request, error) {
...
func (c TriggerClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
