...
func (c ShareSubscriptionClient) ListSynchronizations(ctx context.Context, id ShareSubscriptionId, options ListSynchronizationsOperationOptions) (resp ListSynchronizationsOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "sharesubscription.ShareSubscriptionClient", "ListSynchronizations", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "sharesubscription.ShareSubscriptionClient", "ListSynchronizations", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListSynchronizations(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "sharesubscription.ShareSubscriptionClient", "ListSynchronizations", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ShareSubscriptionClient) preparerForListSynchronizations(ctx context.Context, id ShareSubscriptionId, options ListSynchronizationsOperationOptions) (*http.Request, error) {
...
func (c ShareSubscriptionClient) preparerForListSynchronizationsWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ShareSubscriptionClient) responderForListSynchronizations(resp *http.Response) (result ListSynchronizationsOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListSynchronizationsOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "sharesubscription.ShareSubscriptionClient", "ListSynchronizations", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListSynchronizations(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "sharesubscription.ShareSubscriptionClient", "ListSynchronizations", result.HttpResponse, "Failure responding to request")
				return
			}
