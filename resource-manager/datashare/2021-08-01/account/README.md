...
## `github.com/hashicorp/go-azure-sdk/resource-manager/datashare/2021-08-01/account` Documentation

The `account` SDK allows for interaction with Azure Resource Manager `datashare` (API Version `2021-08-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/datashare/2021-08-01/account"
```
