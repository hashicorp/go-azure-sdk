...
func TestFormatTagRuleID(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/NewRelic.Observability/monitors/monitorName/tagRules/tagRuleName"
	if actual != expected {
...
func TestParseTagRuleID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/NewRelic.Observability/monitors/monitorName/tagRules",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/NewRelic.Observability/monitors/monitorName/tagRules/tagRuleName",
			Expected: &TagRuleId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/NewRelic.Observability/monitors/monitorName/tagRules/tagRuleName/extra",
			Error: true,
		},
	}
