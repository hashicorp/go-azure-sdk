...
## `github.com/hashicorp/go-azure-sdk/resource-manager/newrelic/2024-10-01/organizations` Documentation

The `organizations` SDK allows for interaction with Azure Resource Manager `newrelic` (API Version `2024-10-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/newrelic/2024-10-01/organizations"
```
