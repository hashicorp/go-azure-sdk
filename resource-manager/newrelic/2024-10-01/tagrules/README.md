...
## `github.com/hashicorp/go-azure-sdk/resource-manager/newrelic/2024-10-01/tagrules` Documentation

The `tagrules` SDK allows for interaction with Azure Resource Manager `newrelic` (API Version `2024-10-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/newrelic/2024-10-01/tagrules"
```
