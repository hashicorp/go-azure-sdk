...
func TestNewZoneID(t *testing.T) {
	id := NewZoneID("12345678-1234-9876-4563-123456789012", "example-resource-group", "dnsZoneName", "A")
...
func TestFormatZoneID(t *testing.T) {
	actual := NewZoneID("12345678-1234-9876-4563-123456789012", "example-resource-group", "dnsZoneName", "A").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Network/dnsZones/dnsZoneName/A"
	if actual != expected {
...
func TestParseZoneID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Network/dnsZones/dnsZoneName/A/extra",
			Error: true,
		},
	}
