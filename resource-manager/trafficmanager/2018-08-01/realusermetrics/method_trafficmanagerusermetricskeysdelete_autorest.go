...
func (c RealUserMetricsClient) responderForTrafficManagerUserMetricsKeysDelete(resp *http.Response) (result TrafficManagerUserMetricsKeysDeleteOperationResponse, err error) {
