...
func (c RealUserMetricsClient) responderForTrafficManagerUserMetricsKeysCreateOrUpdate(resp *http.Response) (result TrafficManagerUserMetricsKeysCreateOrUpdateOperationResponse, err error) {
