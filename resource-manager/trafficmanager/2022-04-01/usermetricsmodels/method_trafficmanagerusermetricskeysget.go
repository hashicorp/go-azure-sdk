...
func (c UserMetricsModelsClient) TrafficManagerUserMetricsKeysGet(ctx context.Context, id commonids.SubscriptionId) (result TrafficManagerUserMetricsKeysGetOperationResponse, err error) {
