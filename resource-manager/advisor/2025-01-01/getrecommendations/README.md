...
## `github.com/hashicorp/go-azure-sdk/resource-manager/advisor/2025-01-01/getrecommendations` Documentation

The `getrecommendations` SDK allows for interaction with Azure Resource Manager `advisor` (API Version `2025-01-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/advisor/2025-01-01/getrecommendations"
```
