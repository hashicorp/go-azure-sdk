...
## `github.com/hashicorp/go-azure-sdk/resource-manager/advisor/2025-01-01/suppressions` Documentation

The `suppressions` SDK allows for interaction with Azure Resource Manager `advisor` (API Version `2025-01-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/advisor/2025-01-01/suppressions"
```
