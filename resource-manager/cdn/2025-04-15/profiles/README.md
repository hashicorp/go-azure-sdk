...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cdn/2025-04-15/profiles` Documentation

The `profiles` SDK allows for interaction with Azure Resource Manager `cdn` (API Version `2025-04-15`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/cdn/2025-04-15/profiles"
```
