...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cdn/2025-04-15/afdendpoints` Documentation

The `afdendpoints` SDK allows for interaction with Azure Resource Manager `cdn` (API Version `2025-04-15`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cdn/2025-04-15/afdendpoints"
```
