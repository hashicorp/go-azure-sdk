...
func TestNewCdnWebApplicationFirewallPolicyID(t *testing.T) {
	id := NewCdnWebApplicationFirewallPolicyID("12345678-1234-9876-4563-123456789012", "example-resource-group", "cdnWebApplicationFirewallPolicyValue")
	...
	if id.CdnWebApplicationFirewallPolicyName != "cdnWebApplicationFirewallPolicyValue" {
		t.Fatalf("Expected %q but got %q for Segment 'CdnWebApplicationFirewallPolicyName'", id.CdnWebApplicationFirewallPolicyName, "cdnWebApplicationFirewallPolicyValue")
	}
}

func TestFormatCdnWebApplicationFirewallPolicyID(t *testing.T) {
	actual := NewCdnWebApplicationFirewallPolicyID("12345678-1234-9876-4563-123456789012", "example-resource-group", "cdnWebApplicationFirewallPolicyValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/cdnWebApplicationFirewallPolicies/cdnWebApplicationFirewallPolicyValue"
	if actual != expected {
...
func TestParseCdnWebApplicationFirewallPolicyID(t *testing.T) {
	testData := []struct {
		...
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/cdnWebApplicationFirewallPolicies/cdnWebApplicationFirewallPolicyValue",
			Expected: &CdnWebApplicationFirewallPolicyId{
				SubscriptionId:                      "12345678-1234-9876-4563-123456789012",
				ResourceGroupName:                   "example-resource-group",
				CdnWebApplicationFirewallPolicyName: "cdnWebApplicationFirewallPolicyValue",
			},
		},
		{
			// Invalid (Valid Uri with Extra segment)
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/cdnWebApplicationFirewallPolicies/cdnWebApplicationFirewallPolicyValue/extra",
			Error: true,
		},
	}
