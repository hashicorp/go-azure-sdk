...
func TestNewRouteID(t *testing.T) {
	id := NewRouteID("12345678-1234-9876-4563-123456789012", "example-resource-group", "profileValue", "afdEndpointValue", "routeValue")
	...
	if id.AfdEndpointName != "afdEndpointValue" {
		t.Fatalf("Expected %q but got %q for Segment 'AfdEndpointName'", id.AfdEndpointName, "afdEndpointValue")
	}
...
func TestFormatRouteID(t *testing.T) {
	actual := NewRouteID("12345678-1234-9876-4563-123456789012", "example-resource-group", "profileValue", "afdEndpointValue", "routeValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/afdEndpoints/afdEndpointValue/routes/routeValue"
	if actual != expected {
...
func TestParseRouteID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/afdEndpoints/afdEndpointValue",
			Error: true,
		},
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/afdEndpoints/afdEndpointValue/routes",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/afdEndpoints/afdEndpointValue/routes/routeValue",
			Expected: &RouteId{
				SubscriptionId:    "12345678-1234-9876-4563-123456789012",
				ResourceGroupName: "example-resource-group",
				ProfileName:       "profileValue",
				AfdEndpointName:   "afdEndpointValue",
				RouteName:         "routeValue",
			},
		},
		{
			// Invalid (Valid Uri with Extra segment)
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/afdEndpoints/afdEndpointValue/routes/routeValue/extra",
			Error: true,
		},
	}
