...
type ProfilesCanMigrateOperationResponse struct {
...
// ProfilesCanMigrate ...
func (c OpenapisClient) ProfilesCanMigrate(ctx context.Context, id commonids.ResourceGroupId, input CanMigrateParameters) (result ProfilesCanMigrateOperationResponse, err error) {
...
func (c OpenapisClient) ProfilesCanMigrateThenPoll(ctx context.Context, id commonids.ResourceGroupId, input CanMigrateParameters) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after ProfilesCanMigrate: %+v", err)
	}
