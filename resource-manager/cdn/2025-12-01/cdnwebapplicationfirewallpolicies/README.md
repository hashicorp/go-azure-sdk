...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cdn/2025-12-01/cdnwebapplicationfirewallpolicies` Documentation

The `cdnwebapplicationfirewallpolicies` SDK allows for interaction with Azure Resource Manager `cdn` (API Version `2025-12-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/cdn/2025-12-01/cdnwebapplicationfirewallpolicies"
```
