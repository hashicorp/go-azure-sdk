...
// PoliciesList ...
func (c CdnWebApplicationFirewallPoliciesClient) PoliciesList(ctx context.Context, id commonids.ResourceGroupId) (result PoliciesListOperationResponse, err error) {
...
func (c CdnWebApplicationFirewallPoliciesClient) PoliciesListComplete(ctx context.Context, id commonids.ResourceGroupId) (PoliciesListCompleteResult, error) {
...
func (c CdnWebApplicationFirewallPoliciesClient) PoliciesListCompleteMatchingPredicate(ctx context.Context, id commonids.ResourceGroupId, predicate CdnWebApplicationFirewallPolicyOperationPredicate) (result PoliciesListCompleteResult, err error) {
