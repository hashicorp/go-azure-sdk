...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cdn/2025-06-01/routes` Documentation

The `routes` SDK allows for interaction with Azure Resource Manager `cdn` (API Version `2025-06-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cdn/2025-06-01/routes"
```
