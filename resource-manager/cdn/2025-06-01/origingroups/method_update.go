...
func (c OriginGroupsClient) UpdateCallbackThenPoll(ctx context.Context, id EndpointOriginGroupId, input OriginGroupUpdateParameters, callback func() error) error {
