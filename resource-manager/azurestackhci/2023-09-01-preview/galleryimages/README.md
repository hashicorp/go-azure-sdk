...
```go
ctx := context.TODO()
id := galleryimages.NewResourceGroupID("12345678-1234-9876-4563-123456789012", "example-resource-group")
...
```go
ctx := context.TODO()
id := galleryimages.NewSubscriptionID("12345678-1234-9876-4563-123456789012")
