...
## `github.com/hashicorp/go-azure-sdk/resource-manager/elastic/2024-03-01/monitorsresource` Documentation

The `monitorsresource` SDK allows for interaction with the Azure Resource Manager Service `elastic` (API Version `2024-03-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/elastic/2024-03-01/monitorsresource"
```
