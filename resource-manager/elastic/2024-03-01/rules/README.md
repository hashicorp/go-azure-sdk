...
## `github.com/hashicorp/go-azure-sdk/resource-manager/elastic/2024-03-01/rules` Documentation

The `rules` SDK allows for interaction with the Azure Resource Manager Service `elastic` (API Version `2024-03-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/elastic/2024-03-01/rules"
```
