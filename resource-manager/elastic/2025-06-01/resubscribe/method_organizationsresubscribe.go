...
func (c ResubscribeClient) OrganizationsResubscribe(ctx context.Context, id MonitorId, input ResubscribeProperties) (result OrganizationsResubscribeOperationResponse, err error) {
...
func (c ResubscribeClient) OrganizationsResubscribeThenPoll(ctx context.Context, id MonitorId, input ResubscribeProperties) error {
