...
// OpenAIList ...
func (c OpenAIIntegrationRPModelsClient) OpenAIList(ctx context.Context, id MonitorId) (result OpenAIListOperationResponse, err error) {
...
func (c OpenAIIntegrationRPModelsClient) OpenAIListComplete(ctx context.Context, id MonitorId) (OpenAIListCompleteResult, error) {
...
func (c OpenAIIntegrationRPModelsClient) OpenAIListCompleteMatchingPredicate(ctx context.Context, id MonitorId, predicate OpenAIIntegrationRPModelOperationPredicate) (result OpenAIListCompleteResult, err error) {
