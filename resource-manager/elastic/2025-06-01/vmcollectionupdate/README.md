...
## `github.com/hashicorp/go-azure-sdk/resource-manager/elastic/2025-06-01/vmcollectionupdate` Documentation

The `vmcollectionupdate` SDK allows for interaction with Azure Resource Manager `elastic` (API Version `2025-06-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/elastic/2025-06-01/vmcollectionupdate"
```
