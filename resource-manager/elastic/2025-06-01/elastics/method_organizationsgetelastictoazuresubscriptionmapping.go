...
func (c ElasticsClient) OrganizationsGetElasticToAzureSubscriptionMapping(ctx context.Context, id commonids.SubscriptionId) (result OrganizationsGetElasticToAzureSubscriptionMappingOperationResponse, err error) {
