...
## `github.com/hashicorp/go-azure-sdk/resource-manager/elastic/2025-06-01/tagrules` Documentation

The `tagrules` SDK allows for interaction with Azure Resource Manager `elastic` (API Version `2025-06-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/elastic/2025-06-01/tagrules"
```
