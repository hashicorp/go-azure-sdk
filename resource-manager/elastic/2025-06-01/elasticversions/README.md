...
## `github.com/hashicorp/go-azure-sdk/resource-manager/elastic/2025-06-01/elasticversions` Documentation

The `elasticversions` SDK allows for interaction with Azure Resource Manager `elastic` (API Version `2025-06-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/elastic/2025-06-01/elasticversions"
```
