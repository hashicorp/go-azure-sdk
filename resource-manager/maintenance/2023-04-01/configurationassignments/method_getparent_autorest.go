...
// GetParent ...
func (c ConfigurationAssignmentsClient) GetParent(ctx context.Context, id ProviderProviders2ConfigurationAssignmentId) (result GetParentOperationResponse, err error) {
...
func (c ConfigurationAssignmentsClient) preparerForGetParent(ctx context.Context, id ProviderProviders2ConfigurationAssignmentId) (*http.Request, error) {
