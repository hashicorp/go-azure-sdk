...
func (c ConfigurationAssignmentsClient) CreateOrUpdateParent(ctx context.Context, id ProviderProviders2ConfigurationAssignmentId, input ConfigurationAssignment) (result CreateOrUpdateParentOperationResponse, err error) {
...
func (c ConfigurationAssignmentsClient) preparerForCreateOrUpdateParent(ctx context.Context, id ProviderProviders2ConfigurationAssignmentId, input ConfigurationAssignment) (*http.Request, error) {
