...
func TestNewProviderProviders2ConfigurationAssignmentID(t *testing.T) {
	id := NewProviderProviders2ConfigurationAssignmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "providerValue", "resourceParentTypeValue", "resourceParentValue", "resourceTypeValue", "resourceValue", "configurationAssignmentValue")
...
func TestFormatProviderProviders2ConfigurationAssignmentID(t *testing.T) {
	actual := NewProviderProviders2ConfigurationAssignmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "providerValue", "resourceParentTypeValue", "resourceParentValue", "resourceTypeValue", "resourceValue", "configurationAssignmentValue").ID()
...
func TestParseProviderProviders2ConfigurationAssignmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ProviderProviders2ConfigurationAssignmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseProviderProviders2ConfigurationAssignmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseProviderProviders2ConfigurationAssignmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ProviderProviders2ConfigurationAssignmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseProviderProviders2ConfigurationAssignmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForProviderProviders2ConfigurationAssignmentId(t *testing.T) {
	segments := ProviderProviders2ConfigurationAssignmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ProviderProviders2ConfigurationAssignmentId has no segments")
	}
