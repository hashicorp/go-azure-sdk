...
// DeleteParent ...
func (c ConfigurationAssignmentsClient) DeleteParent(ctx context.Context, id ProviderProviders2ConfigurationAssignmentId) (result DeleteParentOperationResponse, err error) {
...
func (c ConfigurationAssignmentsClient) preparerForDeleteParent(ctx context.Context, id ProviderProviders2ConfigurationAssignmentId) (*http.Request, error) {
