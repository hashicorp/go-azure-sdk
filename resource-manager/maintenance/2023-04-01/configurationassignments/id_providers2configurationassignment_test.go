...
func TestNewProviders2ConfigurationAssignmentID(t *testing.T) {
	id := NewProviders2ConfigurationAssignmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "providerValue", "resourceTypeValue", "resourceValue", "configurationAssignmentValue")
...
func TestFormatProviders2ConfigurationAssignmentID(t *testing.T) {
	actual := NewProviders2ConfigurationAssignmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "providerValue", "resourceTypeValue", "resourceValue", "configurationAssignmentValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/providerValue/resourceTypeValue/resourceValue/providers/Microsoft.Maintenance/configurationAssignments/configurationAssignmentValue"
	if actual != expected {
...
func TestParseProviders2ConfigurationAssignmentID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/providerValue/resourceTypeValue/resourceValue/providers/Microsoft.Maintenance/configurationAssignments",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/providerValue/resourceTypeValue/resourceValue/providers/Microsoft.Maintenance/configurationAssignments/configurationAssignmentValue",
			Expected: &Providers2ConfigurationAssignmentId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/providerValue/resourceTypeValue/resourceValue/providers/Microsoft.Maintenance/configurationAssignments/configurationAssignmentValue/extra",
			Error: true,
		},
	}
