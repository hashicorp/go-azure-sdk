...
func TestNewApplyUpdateID(t *testing.T) {
	id := NewApplyUpdateID("12345678-1234-9876-4563-123456789012", "example-resource-group", "providerValue", "resourceTypeValue", "resourceValue", "applyUpdateValue")
...
func TestFormatApplyUpdateID(t *testing.T) {
	actual := NewApplyUpdateID("12345678-1234-9876-4563-123456789012", "example-resource-group", "providerValue", "resourceTypeValue", "resourceValue", "applyUpdateValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/providerValue/resourceTypeValue/resourceValue/providers/Microsoft.Maintenance/applyUpdates/applyUpdateValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseApplyUpdateID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ApplyUpdateId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/providerValue/resourceTypeValue/resourceValue/providers/Microsoft.Maintenance",
			Error: true,
		},
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/providerValue/resourceTypeValue/resourceValue/providers/Microsoft.Maintenance/applyUpdates",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/providerValue/resourceTypeValue/resourceValue/providers/Microsoft.Maintenance/applyUpdates/applyUpdateValue",
			Expected: &ApplyUpdateId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/providerValue/resourceTypeValue/resourceValue/providers/Microsoft.Maintenance/applyUpdates/applyUpdateValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseApplyUpdateID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseApplyUpdateIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ApplyUpdateId
	...
	for _, v := range testData {
		...
		actual, err := ParseApplyUpdateIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForApplyUpdateId(t *testing.T) {
	segments := ApplyUpdateId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ApplyUpdateId has no segments")
	}
