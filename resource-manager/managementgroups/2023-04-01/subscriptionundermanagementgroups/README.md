...
## `github.com/hashicorp/go-azure-sdk/resource-manager/managementgroups/2023-04-01/subscriptionundermanagementgroups` Documentation

The `subscriptionundermanagementgroups` SDK allows for interaction with Azure Resource Manager `managementgroups` (API Version `2023-04-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/managementgroups/2023-04-01/subscriptionundermanagementgroups"
```
