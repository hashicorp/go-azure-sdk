...
func (c ManagementGroupsClient) Delete(ctx context.Context, id commonids.ManagementGroupId, options DeleteOperationOptions) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementgroups.ManagementGroupsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementgroups.ManagementGroupsClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ManagementGroupsClient) preparerForDelete(ctx context.Context, id commonids.ManagementGroupId, options DeleteOperationOptions) (*http.Request, error) {
...
func (c ManagementGroupsClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
