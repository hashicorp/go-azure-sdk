...
func (c VirtualMachineScaleSetsClient) Reimage(ctx context.Context, id VirtualMachineScaleSetId, input VirtualMachineScaleSetReimageParameters) (result ReimageOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesets.VirtualMachineScaleSetsClient", "Reimage", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForReimage(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesets.VirtualMachineScaleSetsClient", "Reimage", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VirtualMachineScaleSetsClient) preparerForReimage(ctx context.Context, id VirtualMachineScaleSetId, input VirtualMachineScaleSetReimageParameters) (*http.Request, error) {
...
func (c VirtualMachineScaleSetsClient) senderForReimage(ctx context.Context, req *http.Request) (future ReimageOperationResponse, err error) {
