...
func (c VirtualMachineScaleSetVMsClient) PowerOff(ctx context.Context, id VirtualMachineScaleSetVirtualMachineId, options PowerOffOperationOptions) (result PowerOffOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesetvms.VirtualMachineScaleSetVMsClient", "PowerOff", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VirtualMachineScaleSetVMsClient) senderForPowerOff(ctx context.Context, req *http.Request) (future PowerOffOperationResponse, err error) {
