...
func (c VirtualMachineScaleSetVMsClient) Redeploy(ctx context.Context, id VirtualMachineScaleSetVirtualMachineId) (result RedeployOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesetvms.VirtualMachineScaleSetVMsClient", "Redeploy", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VirtualMachineScaleSetVMsClient) senderForRedeploy(ctx context.Context, req *http.Request) (future RedeployOperationResponse, err error) {
