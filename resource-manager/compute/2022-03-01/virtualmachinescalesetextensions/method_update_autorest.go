...
func (c VirtualMachineScaleSetExtensionsClient) Update(ctx context.Context, id ExtensionId, input VirtualMachineScaleSetExtensionUpdate) (result UpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesetextensions.VirtualMachineScaleSetExtensionsClient", "Update", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VirtualMachineScaleSetExtensionsClient) senderForUpdate(ctx context.Context, req *http.Request) (future UpdateOperationResponse, err error) {
