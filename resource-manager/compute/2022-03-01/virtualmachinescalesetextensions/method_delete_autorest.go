...
func (c VirtualMachineScaleSetExtensionsClient) Delete(ctx context.Context, id ExtensionId) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesetextensions.VirtualMachineScaleSetExtensionsClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VirtualMachineScaleSetExtensionsClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
