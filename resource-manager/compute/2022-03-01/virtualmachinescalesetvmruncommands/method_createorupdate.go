...
func (c VirtualMachineScaleSetVMRunCommandsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VirtualMachineScaleSetVirtualMachineRunCommandId, input VirtualMachineRunCommand, callback func() error) error {
