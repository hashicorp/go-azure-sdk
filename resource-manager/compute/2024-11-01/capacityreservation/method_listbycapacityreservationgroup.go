...
func (c CapacityReservationClient) ListByCapacityReservationGroup(ctx context.Context, id CapacityReservationGroupId, options ListByCapacityReservationGroupOperationOptions) (result ListByCapacityReservationGroupOperationResponse, err error) {
...
func (c CapacityReservationClient) ListByCapacityReservationGroupComplete(ctx context.Context, id CapacityReservationGroupId, options ListByCapacityReservationGroupOperationOptions) (ListByCapacityReservationGroupCompleteResult, error) {
