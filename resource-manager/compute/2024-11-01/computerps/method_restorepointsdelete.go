...
// RestorePointsDelete ...
func (c ComputeRPSClient) RestorePointsDelete(ctx context.Context, id RestorePointId) (result RestorePointsDeleteOperationResponse, err error) {
...
func (c ComputeRPSClient) RestorePointsDeleteThenPoll(ctx context.Context, id RestorePointId) error {
