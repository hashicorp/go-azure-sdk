...
func (c DedicatedHostClient) ListAvailableSizesComplete(ctx context.Context, id commonids.DedicatedHostId) (result ListAvailableSizesCompleteResult, err error) {
	items := make([]string, 0)
