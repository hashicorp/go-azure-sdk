...
func (c VirtualMachineScaleSetVMsClient) RunCommand(ctx context.Context, id VirtualMachineScaleSetVirtualMachineId, input RunCommandInput) (result RunCommandOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesetvms.VirtualMachineScaleSetVMsClient", "RunCommand", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForRunCommand(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesetvms.VirtualMachineScaleSetVMsClient", "RunCommand", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VirtualMachineScaleSetVMsClient) preparerForRunCommand(ctx context.Context, id VirtualMachineScaleSetVirtualMachineId, input RunCommandInput) (*http.Request, error) {
...
func (c VirtualMachineScaleSetVMsClient) senderForRunCommand(ctx context.Context, req *http.Request) (future RunCommandOperationResponse, err error) {
