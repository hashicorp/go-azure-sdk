...
func TestNewVirtualMachineScaleSetVirtualMachineID(t *testing.T) {
	id := NewVirtualMachineScaleSetVirtualMachineID("12345678-1234-9876-4563-123456789012", "example-resource-group", "vmScaleSetValue", "instanceIdValue")
...
func TestFormatVirtualMachineScaleSetVirtualMachineID(t *testing.T) {
	actual := NewVirtualMachineScaleSetVirtualMachineID("12345678-1234-9876-4563-123456789012", "example-resource-group", "vmScaleSetValue", "instanceIdValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Compute/virtualMachineScaleSets/vmScaleSetValue/virtualMachines/instanceIdValue"
	if actual != expected {
...
func TestParseVirtualMachineScaleSetVirtualMachineID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Compute/virtualMachineScaleSets/vmScaleSetValue/virtualMachines/instanceIdValue/extra",
			Error: true,
		},
	}
