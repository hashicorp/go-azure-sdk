...
func (c VirtualMachineScaleSetVMsClient) RetrieveBootDiagnosticsData(ctx context.Context, id VirtualMachineScaleSetVirtualMachineId, options RetrieveBootDiagnosticsDataOperationOptions) (result RetrieveBootDiagnosticsDataOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesetvms.VirtualMachineScaleSetVMsClient", "RetrieveBootDiagnosticsData", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForRetrieveBootDiagnosticsData(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesetvms.VirtualMachineScaleSetVMsClient", "RetrieveBootDiagnosticsData", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c VirtualMachineScaleSetVMsClient) responderForRetrieveBootDiagnosticsData(resp *http.Response) (result RetrieveBootDiagnosticsDataOperationResponse, err error) {
