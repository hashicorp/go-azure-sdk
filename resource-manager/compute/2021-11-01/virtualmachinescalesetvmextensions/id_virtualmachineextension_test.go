...
func TestNewVirtualMachineExtensionID(t *testing.T) {
	id := NewVirtualMachineExtensionID("12345678-1234-9876-4563-123456789012", "example-resource-group", "vmScaleSetValue", "instanceIdValue", "vmExtensionValue")
...
func TestFormatVirtualMachineExtensionID(t *testing.T) {
	actual := NewVirtualMachineExtensionID("12345678-1234-9876-4563-123456789012", "example-resource-group", "vmScaleSetValue", "instanceIdValue", "vmExtensionValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Compute/virtualMachineScaleSets/vmScaleSetValue/virtualMachines/instanceIdValue/extensions/vmExtensionValue"
	if actual != expected {
...
func TestParseVirtualMachineExtensionID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Compute/virtualMachineScaleSets/vmScaleSetValue/virtualMachines/instanceIdValue/extensions",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Compute/virtualMachineScaleSets/vmScaleSetValue/virtualMachines/instanceIdValue/extensions/vmExtensionValue",
			Expected: &VirtualMachineExtensionId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Compute/virtualMachineScaleSets/vmScaleSetValue/virtualMachines/instanceIdValue/extensions/vmExtensionValue/extra",
			Error: true,
		},
	}
