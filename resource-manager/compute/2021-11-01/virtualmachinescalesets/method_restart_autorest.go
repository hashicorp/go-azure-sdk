...
func (c VirtualMachineScaleSetsClient) Restart(ctx context.Context, id VirtualMachineScaleSetId, input VirtualMachineScaleSetVMInstanceIDs) (result RestartOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesets.VirtualMachineScaleSetsClient", "Restart", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForRestart(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesets.VirtualMachineScaleSetsClient", "Restart", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VirtualMachineScaleSetsClient) preparerForRestart(ctx context.Context, id VirtualMachineScaleSetId, input VirtualMachineScaleSetVMInstanceIDs) (*http.Request, error) {
...
func (c VirtualMachineScaleSetsClient) senderForRestart(ctx context.Context, req *http.Request) (future RestartOperationResponse, err error) {
