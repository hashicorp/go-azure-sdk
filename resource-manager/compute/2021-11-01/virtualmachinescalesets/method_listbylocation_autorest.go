...
// ListByLocation ...
func (c VirtualMachineScaleSetsClient) ListByLocation(ctx context.Context, id LocationId) (resp ListByLocationOperationResponse, err error) {
	req, err := c.preparerForListByLocation(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesets.VirtualMachineScaleSetsClient", "ListByLocation", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesets.VirtualMachineScaleSetsClient", "ListByLocation", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByLocation(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesets.VirtualMachineScaleSetsClient", "ListByLocation", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c VirtualMachineScaleSetsClient) preparerForListByLocation(ctx context.Context, id LocationId) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/virtualMachineScaleSets", id.ID())),
...
func (c VirtualMachineScaleSetsClient) preparerForListByLocationWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c VirtualMachineScaleSetsClient) responderForListByLocation(resp *http.Response) (result ListByLocationOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByLocationOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "virtualmachinescalesets.VirtualMachineScaleSetsClient", "ListByLocation", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByLocation(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "virtualmachinescalesets.VirtualMachineScaleSetsClient", "ListByLocation", result.HttpResponse, "Failure responding to request")
				return
			}
