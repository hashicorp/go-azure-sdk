...
// List ...
func (c VirtualMachinesClient) List(ctx context.Context, id commonids.ResourceGroupId) (resp ListOperationResponse, err error) {
...
func (c VirtualMachinesClient) preparerForList(ctx context.Context, id commonids.ResourceGroupId) (*http.Request, error) {
...
func (c VirtualMachinesClient) ListCompleteMatchingPredicate(ctx context.Context, id commonids.ResourceGroupId, predicate VirtualMachineOperationPredicate) (resp ListCompleteResult, err error) {
