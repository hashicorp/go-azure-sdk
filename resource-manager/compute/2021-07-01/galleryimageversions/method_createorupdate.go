...
func (c GalleryImageVersionsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id GalleryImageVersionId, input GalleryImageVersion, callback func() error) error {
