...
func (c GalleryImageVersionsClient) UpdateCallbackThenPoll(ctx context.Context, id GalleryImageVersionId, input GalleryImageVersionUpdate, callback func() error) error {
