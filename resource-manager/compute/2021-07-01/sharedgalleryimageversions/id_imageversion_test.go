...
func TestNewImageVersionID(t *testing.T) {
	id := NewImageVersionID("12345678-1234-9876-4563-123456789012", "locationName", "sharedGalleryName", "imageName", "versionName")
...
func TestFormatImageVersionID(t *testing.T) {
	actual := NewImageVersionID("12345678-1234-9876-4563-123456789012", "locationName", "sharedGalleryName", "imageName", "versionName").ID()
