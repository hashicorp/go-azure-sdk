...
func TestNewSharedGalleryImageID(t *testing.T) {
	id := NewSharedGalleryImageID("12345678-1234-9876-4563-123456789012", "locationName", "sharedGalleryName", "imageName")
...
func TestFormatSharedGalleryImageID(t *testing.T) {
	actual := NewSharedGalleryImageID("12345678-1234-9876-4563-123456789012", "locationName", "sharedGalleryName", "imageName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.Compute/locations/locationName/sharedGalleries/sharedGalleryName/images/imageName"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseSharedGalleryImageID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.Compute/locations/locationName/sharedGalleries/sharedGalleryName/images/imageName/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseSharedGalleryImageID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseSharedGalleryImageIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *SharedGalleryImageId
	...
	for _, v := range testData {
		...
		actual, err := ParseSharedGalleryImageIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForSharedGalleryImageId(t *testing.T) {
	segments := SharedGalleryImageId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("SharedGalleryImageId has no segments")
	}
