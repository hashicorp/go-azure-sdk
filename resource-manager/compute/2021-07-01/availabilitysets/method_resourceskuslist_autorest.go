...
// ResourceSkusList ...
func (c AvailabilitySetsClient) ResourceSkusList(ctx context.Context, id commonids.SubscriptionId, options ResourceSkusListOperationOptions) (resp ResourceSkusListOperationResponse, err error) {
	req, err := c.preparerForResourceSkusList(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "availabilitysets.AvailabilitySetsClient", "ResourceSkusList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "availabilitysets.AvailabilitySetsClient", "ResourceSkusList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForResourceSkusList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "availabilitysets.AvailabilitySetsClient", "ResourceSkusList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c AvailabilitySetsClient) preparerForResourceSkusList(ctx context.Context, id commonids.SubscriptionId, options ResourceSkusListOperationOptions) (*http.Request, error) {
...
func (c AvailabilitySetsClient) preparerForResourceSkusListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c AvailabilitySetsClient) responderForResourceSkusList(resp *http.Response) (result ResourceSkusListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ResourceSkusListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "availabilitysets.AvailabilitySetsClient", "ResourceSkusList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForResourceSkusList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "availabilitysets.AvailabilitySetsClient", "ResourceSkusList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c AvailabilitySetsClient) ResourceSkusListCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, options ResourceSkusListOperationOptions, predicate ResourceSkuOperationPredicate) (resp ResourceSkusListCompleteResult, err error) {
