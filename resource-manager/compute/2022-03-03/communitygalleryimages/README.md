...
The `communitygalleryimages` SDK allows for interaction with Azure Resource Manager `compute` (API Version `2022-03-03`).
...
```go
ctx := context.TODO()
id := communitygalleryimages.NewCommunityGalleryID("12345678-1234-9876-4563-123456789012", "locationName", "communityGalleryName")
