...
func (c GalleryImageVersionsClient) Get(ctx context.Context, id VersionId, options GetOperationOptions) (result GetOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "galleryimageversions.GalleryImageVersionsClient", "Get", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForGet(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "galleryimageversions.GalleryImageVersionsClient", "Get", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c GalleryImageVersionsClient) responderForGet(resp *http.Response) (result GetOperationResponse, err error) {
