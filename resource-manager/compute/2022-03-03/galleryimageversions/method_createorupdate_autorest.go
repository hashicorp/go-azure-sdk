...
func (c GalleryImageVersionsClient) CreateOrUpdate(ctx context.Context, id VersionId, input GalleryImageVersion) (result CreateOrUpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "galleryimageversions.GalleryImageVersionsClient", "CreateOrUpdate", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c GalleryImageVersionsClient) senderForCreateOrUpdate(ctx context.Context, req *http.Request) (future CreateOrUpdateOperationResponse, err error) {
