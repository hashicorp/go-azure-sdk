...
func (c CommunityGalleryImageVersionsClient) List(ctx context.Context, id CommunityGalleryImageId) (resp ListOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "communitygalleryimageversions.CommunityGalleryImageVersionsClient", "List", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "communitygalleryimageversions.CommunityGalleryImageVersionsClient", "List", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c CommunityGalleryImageVersionsClient) preparerForListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c CommunityGalleryImageVersionsClient) responderForList(resp *http.Response) (result ListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "communitygalleryimageversions.CommunityGalleryImageVersionsClient", "List", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "communitygalleryimageversions.CommunityGalleryImageVersionsClient", "List", result.HttpResponse, "Failure responding to request")
				return
			}
