...
func (c VirtualMachineScaleSetVMsClient) UpdateCallbackThenPoll(ctx context.Context, id VirtualMachineScaleSetVirtualMachineId, input VirtualMachineScaleSetVM, callback func() error) error {
