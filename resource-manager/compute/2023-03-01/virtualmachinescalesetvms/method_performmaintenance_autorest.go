...
func (c VirtualMachineScaleSetVMsClient) PerformMaintenance(ctx context.Context, id VirtualMachineScaleSetVirtualMachineId) (result PerformMaintenanceOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesetvms.VirtualMachineScaleSetVMsClient", "PerformMaintenance", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VirtualMachineScaleSetVMsClient) senderForPerformMaintenance(ctx context.Context, req *http.Request) (future PerformMaintenanceOperationResponse, err error) {
