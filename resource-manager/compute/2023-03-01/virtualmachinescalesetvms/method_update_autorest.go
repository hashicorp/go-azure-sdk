...
func (c VirtualMachineScaleSetVMsClient) preparerForUpdate(ctx context.Context, id VirtualMachineScaleSetVirtualMachineId, input VirtualMachineScaleSetVM) (*http.Request, error) {
