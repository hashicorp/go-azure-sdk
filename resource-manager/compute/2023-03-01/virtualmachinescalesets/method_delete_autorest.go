...
func (c VirtualMachineScaleSetsClient) Delete(ctx context.Context, id VirtualMachineScaleSetId, options DeleteOperationOptions) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesets.VirtualMachineScaleSetsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesets.VirtualMachineScaleSetsClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VirtualMachineScaleSetsClient) preparerForDelete(ctx context.Context, id VirtualMachineScaleSetId, options DeleteOperationOptions) (*http.Request, error) {
...
func (c VirtualMachineScaleSetsClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
