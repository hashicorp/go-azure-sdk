...
func (c VirtualMachineScaleSetsClient) Deallocate(ctx context.Context, id VirtualMachineScaleSetId, input VirtualMachineScaleSetVMInstanceIDs, options DeallocateOperationOptions) (result DeallocateOperationResponse, err error) {
	req, err := c.preparerForDeallocate(ctx, id, input, options)
	if err != nil {
...
func (c VirtualMachineScaleSetsClient) preparerForDeallocate(ctx context.Context, id VirtualMachineScaleSetId, input VirtualMachineScaleSetVMInstanceIDs, options DeallocateOperationOptions) (*http.Request, error) {
