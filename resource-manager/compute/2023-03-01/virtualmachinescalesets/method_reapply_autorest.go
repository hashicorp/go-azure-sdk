...
func (c VirtualMachineScaleSetsClient) Reapply(ctx context.Context, id VirtualMachineScaleSetId) (result ReapplyOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesets.VirtualMachineScaleSetsClient", "Reapply", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForReapply(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachinescalesets.VirtualMachineScaleSetsClient", "Reapply", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VirtualMachineScaleSetsClient) preparerForReapply(ctx context.Context, id VirtualMachineScaleSetId) (*http.Request, error) {
...
func (c VirtualMachineScaleSetsClient) senderForReapply(ctx context.Context, req *http.Request) (future ReapplyOperationResponse, err error) {
