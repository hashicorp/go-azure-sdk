...
func (c DedicatedHostClient) Restart(ctx context.Context, id HostId) (result RestartOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "dedicatedhost.DedicatedHostClient", "Restart", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForRestart(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "dedicatedhost.DedicatedHostClient", "Restart", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c DedicatedHostClient) preparerForRestart(ctx context.Context, id HostId) (*http.Request, error) {
...
func (c DedicatedHostClient) senderForRestart(ctx context.Context, req *http.Request) (future RestartOperationResponse, err error) {
