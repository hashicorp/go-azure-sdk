...
func (c VirtualMachineScaleSetVMRunCommandsClient) UpdateCallbackThenPoll(ctx context.Context, id VirtualMachineScaleSetVirtualMachineRunCommandId, input VirtualMachineRunCommandUpdate, callback func() error) error {
