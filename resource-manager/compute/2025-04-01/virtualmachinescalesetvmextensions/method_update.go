...
func (c VirtualMachineScaleSetVMExtensionsClient) UpdateCallbackThenPoll(ctx context.Context, id VirtualMachineExtensionId, input VirtualMachineScaleSetVMExtensionUpdate, callback func() error) error {
