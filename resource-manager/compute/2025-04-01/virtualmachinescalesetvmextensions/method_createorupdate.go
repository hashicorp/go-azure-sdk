...
func (c VirtualMachineScaleSetVMExtensionsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VirtualMachineExtensionId, input VirtualMachineScaleSetVMExtension, callback func() error) error {
