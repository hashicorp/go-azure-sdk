...
## `github.com/hashicorp/go-azure-sdk/resource-manager/compute/2025-04-01/restorepoints` Documentation

The `restorepoints` SDK allows for interaction with Azure Resource Manager `compute` (API Version `2025-04-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/compute/2025-04-01/restorepoints"
```
