...
## `github.com/hashicorp/go-azure-sdk/resource-manager/compute/2021-08-01/diskaccesses` Documentation

The `diskaccesses` SDK allows for interaction with the Azure Resource Manager Service `compute` (API Version `2021-08-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/compute/2021-08-01/diskaccesses"
```
...
```go
ctx := context.TODO()
id := diskaccesses.NewSubscriptionID()
...
```go
ctx := context.TODO()
id := diskaccesses.NewResourceGroupID()
