...
## `github.com/hashicorp/go-azure-sdk/resource-manager/compute/2021-08-01/snapshots` Documentation

The `snapshots` SDK allows for interaction with the Azure Resource Manager Service `compute` (API Version `2021-08-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/compute/2021-08-01/snapshots"
```
...
```go
ctx := context.TODO()
id := snapshots.NewSubscriptionID()
...
```go
ctx := context.TODO()
id := snapshots.NewResourceGroupID()
