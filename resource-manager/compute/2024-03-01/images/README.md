...
## `github.com/hashicorp/go-azure-sdk/resource-manager/compute/2024-03-01/images` Documentation

The `images` SDK allows for interaction with the Azure Resource Manager Service `compute` (API Version `2024-03-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/compute/2024-03-01/images"
```
