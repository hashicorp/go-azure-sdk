...
## `github.com/hashicorp/go-azure-sdk/resource-manager/costmanagement/2025-03-01/benefitrecommendations` Documentation

The `benefitrecommendations` SDK allows for interaction with Azure Resource Manager `costmanagement` (API Version `2025-03-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/costmanagement/2025-03-01/benefitrecommendations"
```
