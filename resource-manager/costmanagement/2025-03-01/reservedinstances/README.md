...
## `github.com/hashicorp/go-azure-sdk/resource-manager/costmanagement/2025-03-01/reservedinstances` Documentation

The `reservedinstances` SDK allows for interaction with Azure Resource Manager `costmanagement` (API Version `2025-03-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/costmanagement/2025-03-01/reservedinstances"
```
