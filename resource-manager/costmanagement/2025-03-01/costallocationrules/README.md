...
## `github.com/hashicorp/go-azure-sdk/resource-manager/costmanagement/2025-03-01/costallocationrules` Documentation

The `costallocationrules` SDK allows for interaction with Azure Resource Manager `costmanagement` (API Version `2025-03-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/costmanagement/2025-03-01/costallocationrules"
```
