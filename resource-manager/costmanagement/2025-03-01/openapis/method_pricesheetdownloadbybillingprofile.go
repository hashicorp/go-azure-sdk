...
func (c OpenapisClient) PriceSheetDownloadByBillingProfile(ctx context.Context, id BillingProfileId) (result PriceSheetDownloadByBillingProfileOperationResponse, err error) {
...
func (c OpenapisClient) PriceSheetDownloadByBillingProfileThenPoll(ctx context.Context, id BillingProfileId) error {
...
func (c OpenapisClient) PriceSheetDownloadByBillingProfileCallbackThenPoll(ctx context.Context, id BillingProfileId, callback func() error) error {
