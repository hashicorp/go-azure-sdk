...
func (c OpenapisClient) GenerateReservationDetailsReportByBillingAccountId(ctx context.Context, id BillingAccountId, options GenerateReservationDetailsReportByBillingAccountIdOperationOptions) (result GenerateReservationDetailsReportByBillingAccountIdOperationResponse, err error) {
...
func (c OpenapisClient) GenerateReservationDetailsReportByBillingAccountIdThenPoll(ctx context.Context, id BillingAccountId, options GenerateReservationDetailsReportByBillingAccountIdOperationOptions) error {
	return c.GenerateReservationDetailsReportByBillingAccountIdCallbackThenPoll(ctx, id, options, nil)
}

// GenerateReservationDetailsReportByBillingAccountIdCallbackThenPoll performs GenerateReservationDetailsReportByBillingAccountId, runs the optional callback function, then polls until it's completed
func (c OpenapisClient) GenerateReservationDetailsReportByBillingAccountIdCallbackThenPoll(ctx context.Context, id BillingAccountId, options GenerateReservationDetailsReportByBillingAccountIdOperationOptions, callback func() error) error {
