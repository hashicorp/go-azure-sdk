...
func (c OpenapisClient) GenerateBenefitUtilizationSummariesReportGenerateByBillingProfile(ctx context.Context, id BillingProfileId, input BenefitUtilizationSummariesRequest) (result GenerateBenefitUtilizationSummariesReportGenerateByBillingProfileOperationResponse, err error) {
...
func (c OpenapisClient) GenerateBenefitUtilizationSummariesReportGenerateByBillingProfileThenPoll(ctx context.Context, id BillingProfileId, input BenefitUtilizationSummariesRequest) error {
...
func (c OpenapisClient) GenerateBenefitUtilizationSummariesReportGenerateByBillingProfileCallbackThenPoll(ctx context.Context, id BillingProfileId, input BenefitUtilizationSummariesRequest, callback func() error) error {
