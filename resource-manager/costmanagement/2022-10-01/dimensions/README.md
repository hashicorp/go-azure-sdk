...
## `github.com/hashicorp/go-azure-sdk/resource-manager/costmanagement/2022-10-01/dimensions` Documentation

The `dimensions` SDK allows for interaction with Azure Resource Manager `costmanagement` (API Version `2022-10-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/costmanagement/2022-10-01/dimensions"
```
