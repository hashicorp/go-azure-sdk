...
func (c QueryClient) preparerForUsage(ctx context.Context, id commonids.ScopeId, input QueryDefinition) (*http.Request, error) {
...
func (c QueryClient) responderForUsage(resp *http.Response) (result UsageOperationResponse, err error) {
