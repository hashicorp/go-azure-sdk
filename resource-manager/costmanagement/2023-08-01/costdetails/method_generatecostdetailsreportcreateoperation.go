...
func (c CostDetailsClient) GenerateCostDetailsReportCreateOperationCallbackThenPoll(ctx context.Context, id commonids.ScopeId, input GenerateCostDetailsReportRequestDefinition, callback func() error) error {
