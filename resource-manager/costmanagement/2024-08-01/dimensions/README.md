...
## `github.com/hashicorp/go-azure-sdk/resource-manager/costmanagement/2024-08-01/dimensions` Documentation

The `dimensions` SDK allows for interaction with Azure Resource Manager `costmanagement` (API Version `2024-08-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/costmanagement/2024-08-01/dimensions"
```
