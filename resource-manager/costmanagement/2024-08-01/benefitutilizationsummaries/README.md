...
## `github.com/hashicorp/go-azure-sdk/resource-manager/costmanagement/2024-08-01/benefitutilizationsummaries` Documentation

The `benefitutilizationsummaries` SDK allows for interaction with Azure Resource Manager `costmanagement` (API Version `2024-08-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/costmanagement/2024-08-01/benefitutilizationsummaries"
```
