...
func TestNewConfigurationProfileAssignmentReportID(t *testing.T) {
	id := NewConfigurationProfileAssignmentReportID("12345678-1234-9876-4563-123456789012", "example-resource-group", "clusterValue", "configurationProfileAssignmentValue", "reportValue")
...
func TestFormatConfigurationProfileAssignmentReportID(t *testing.T) {
	actual := NewConfigurationProfileAssignmentReportID("12345678-1234-9876-4563-123456789012", "example-resource-group", "clusterValue", "configurationProfileAssignmentValue", "reportValue").ID()
