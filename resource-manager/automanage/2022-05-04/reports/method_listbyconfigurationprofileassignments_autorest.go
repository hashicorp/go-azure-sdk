...
func (c ReportsClient) ListByConfigurationProfileAssignments(ctx context.Context, id VirtualMachineProviders2ConfigurationProfileAssignmentId) (result ListByConfigurationProfileAssignmentsOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "reports.ReportsClient", "ListByConfigurationProfileAssignments", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "reports.ReportsClient", "ListByConfigurationProfileAssignments", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForListByConfigurationProfileAssignments(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "reports.ReportsClient", "ListByConfigurationProfileAssignments", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c ReportsClient) preparerForListByConfigurationProfileAssignments(ctx context.Context, id VirtualMachineProviders2ConfigurationProfileAssignmentId) (*http.Request, error) {
...
func (c ReportsClient) responderForListByConfigurationProfileAssignments(resp *http.Response) (result ListByConfigurationProfileAssignmentsOperationResponse, err error) {
