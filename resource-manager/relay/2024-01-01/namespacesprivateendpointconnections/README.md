...
## `github.com/hashicorp/go-azure-sdk/resource-manager/relay/2024-01-01/namespacesprivateendpointconnections` Documentation

The `namespacesprivateendpointconnections` SDK allows for interaction with Azure Resource Manager `relay` (API Version `2024-01-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/relay/2024-01-01/namespacesprivateendpointconnections"
```
