...
type NamespacesCreateOrUpdateOperationResponse struct {
...
func (c RelayNamespacesClient) NamespacesCreateOrUpdate(ctx context.Context, id NamespaceId, input RelayNamespace) (result NamespacesCreateOrUpdateOperationResponse, err error) {
...
func (c RelayNamespacesClient) NamespacesCreateOrUpdateThenPoll(ctx context.Context, id NamespaceId, input RelayNamespace) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after NamespacesCreateOrUpdate: %+v", err)
	}
