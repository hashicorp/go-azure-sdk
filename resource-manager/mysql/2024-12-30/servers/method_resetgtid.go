...
type ResetGtidOperationResponse struct {
...
// ResetGtid ...
func (c ServersClient) ResetGtid(ctx context.Context, id FlexibleServerId, input ServerGtidSetParameter) (result ResetGtidOperationResponse, err error) {
...
func (c ServersClient) ResetGtidThenPoll(ctx context.Context, id FlexibleServerId, input ServerGtidSetParameter) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after ResetGtid: %+v", err)
	}
