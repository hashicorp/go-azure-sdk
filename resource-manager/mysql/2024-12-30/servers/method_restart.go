...
// Restart ...
func (c ServersClient) Restart(ctx context.Context, id FlexibleServerId, input ServerRestartParameter) (result RestartOperationResponse, err error) {
...
func (c ServersClient) RestartThenPoll(ctx context.Context, id FlexibleServerId, input ServerRestartParameter) error {
...
func (c ServersClient) RestartCallbackThenPoll(ctx context.Context, id FlexibleServerId, input ServerRestartParameter, callback func() error) error {
