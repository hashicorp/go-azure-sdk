...
## `github.com/hashicorp/go-azure-sdk/resource-manager/mysql/2024-12-30/firewallrules` Documentation

The `firewallrules` SDK allows for interaction with Azure Resource Manager `mysql` (API Version `2024-12-30`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/mysql/2024-12-30/firewallrules"
```
