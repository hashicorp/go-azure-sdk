...
// ListByServer ...
func (c LogFilesClient) ListByServer(ctx context.Context, id FlexibleServerId) (resp ListByServerOperationResponse, err error) {
	req, err := c.preparerForListByServer(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "logfiles.LogFilesClient", "ListByServer", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "logfiles.LogFilesClient", "ListByServer", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByServer(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "logfiles.LogFilesClient", "ListByServer", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c LogFilesClient) preparerForListByServer(ctx context.Context, id FlexibleServerId) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/logFiles", id.ID())),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}

// preparerForListByServerWithNextLink prepares the ListByServer request with the given nextLink token.
func (c LogFilesClient) preparerForListByServerWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c LogFilesClient) responderForListByServer(resp *http.Response) (result ListByServerOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByServerOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "logfiles.LogFilesClient", "ListByServer", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByServer(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "logfiles.LogFilesClient", "ListByServer", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c LogFilesClient) ListByServerCompleteMatchingPredicate(ctx context.Context, id FlexibleServerId, predicate LogFileOperationPredicate) (resp ListByServerCompleteResult, err error) {
