...
func TestFormatFirewallRuleID(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DBforMySQL/servers/serverValue/firewallRules/firewallRuleValue"
	if actual != expected {
...
func TestParseFirewallRuleID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DBforMySQL/servers/serverValue/firewallRules",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DBforMySQL/servers/serverValue/firewallRules/firewallRuleValue",
			Expected: &FirewallRuleId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DBforMySQL/servers/serverValue/firewallRules/firewallRuleValue/extra",
			Error: true,
		},
	}
