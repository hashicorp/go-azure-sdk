...
func (c AADClient) AccessPolicyCreateUpdateCallbackThenPoll(ctx context.Context, id AccessPolicyId, input RedisCacheAccessPolicy, callback func() error) error {
