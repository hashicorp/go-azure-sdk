...
The `redis` SDK allows for interaction with Azure Resource Manager `redis` (API Version `2023-08-01`).
...
```go
ctx := context.TODO()
id := redis.NewRediID("12345678-1234-9876-4563-123456789012", "example-resource-group", "name")
