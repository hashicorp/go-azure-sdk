...
func TestNewDevCenterCatalogID(t *testing.T) {
	id := NewDevCenterCatalogID("12345678-1234-9876-4563-123456789012", "example-resource-group", "devCenterName", "catalogName")
...
func TestFormatDevCenterCatalogID(t *testing.T) {
	actual := NewDevCenterCatalogID("12345678-1234-9876-4563-123456789012", "example-resource-group", "devCenterName", "catalogName").ID()
