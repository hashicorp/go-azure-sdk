...
func TestNewImageID(t *testing.T) {
	id := NewImageID("12345678-1234-9876-4563-123456789012", "example-resource-group", "projectName", "imageName")
...
func TestFormatImageID(t *testing.T) {
	actual := NewImageID("12345678-1234-9876-4563-123456789012", "example-resource-group", "projectName", "imageName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DevCenter/projects/projectName/images/imageName"
	if actual != expected {
...
func TestParseImageID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DevCenter/projects/projectName/images/imageName/extra",
			Error: true,
		},
	}
