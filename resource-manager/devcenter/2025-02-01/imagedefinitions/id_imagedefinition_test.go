...
func TestNewImageDefinitionID(t *testing.T) {
	id := NewImageDefinitionID("12345678-1234-9876-4563-123456789012", "example-resource-group", "projectName", "catalogName", "imageDefinitionName")
...
func TestFormatImageDefinitionID(t *testing.T) {
	actual := NewImageDefinitionID("12345678-1234-9876-4563-123456789012", "example-resource-group", "projectName", "catalogName", "imageDefinitionName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DevCenter/projects/projectName/catalogs/catalogName/imageDefinitions/imageDefinitionName"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseImageDefinitionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ImageDefinitionId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DevCenter/projects/projectName/catalogs/catalogName/imageDefinitions/imageDefinitionName/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseImageDefinitionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseImageDefinitionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ImageDefinitionId
	...
	for _, v := range testData {
		...
		actual, err := ParseImageDefinitionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForImageDefinitionId(t *testing.T) {
	segments := ImageDefinitionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ImageDefinitionId has no segments")
	}
