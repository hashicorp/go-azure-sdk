...
func TestNewTaskID(t *testing.T) {
	id := NewTaskID("12345678-1234-9876-4563-123456789012", "example-resource-group", "devCenterName", "catalogName", "taskName")
...
func TestFormatTaskID(t *testing.T) {
	actual := NewTaskID("12345678-1234-9876-4563-123456789012", "example-resource-group", "devCenterName", "catalogName", "taskName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DevCenter/devCenters/devCenterName/catalogs/catalogName/tasks/taskName"
	if actual != expected {
...
func TestParseTaskID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DevCenter/devCenters/devCenterName/catalogs/catalogName/tasks",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DevCenter/devCenters/devCenterName/catalogs/catalogName/tasks/taskName",
			Expected: &TaskId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DevCenter/devCenters/devCenterName/catalogs/catalogName/tasks/taskName/extra",
			Error: true,
		},
	}
