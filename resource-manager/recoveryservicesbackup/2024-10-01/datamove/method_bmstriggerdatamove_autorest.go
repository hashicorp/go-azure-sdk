...
func (c DataMoveClient) BMSTriggerDataMove(ctx context.Context, id VaultId, input TriggerDataMoveRequest) (result BMSTriggerDataMoveOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "datamove.DataMoveClient", "BMSTriggerDataMove", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForBMSTriggerDataMove(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "datamove.DataMoveClient", "BMSTriggerDataMove", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c DataMoveClient) BMSTriggerDataMoveCallbackThenPoll(ctx context.Context, id VaultId, input TriggerDataMoveRequest, callback func() error) error {
...
func (c DataMoveClient) preparerForBMSTriggerDataMove(ctx context.Context, id VaultId, input TriggerDataMoveRequest) (*http.Request, error) {
...
func (c DataMoveClient) senderForBMSTriggerDataMove(ctx context.Context, req *http.Request) (future BMSTriggerDataMoveOperationResponse, err error) {
