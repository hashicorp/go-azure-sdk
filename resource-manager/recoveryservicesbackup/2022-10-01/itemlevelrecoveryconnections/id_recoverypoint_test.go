...
func TestNewRecoveryPointID(t *testing.T) {
	id := NewRecoveryPointID("12345678-1234-9876-4563-123456789012", "example-resource-group", "vaultValue", "fabricValue", "containerValue", "protectedItemValue", "recoveryPointIdValue")
...
func TestFormatRecoveryPointID(t *testing.T) {
	actual := NewRecoveryPointID("12345678-1234-9876-4563-123456789012", "example-resource-group", "vaultValue", "fabricValue", "containerValue", "protectedItemValue", "recoveryPointIdValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/vaultValue/backupFabrics/fabricValue/protectionContainers/containerValue/protectedItems/protectedItemValue/recoveryPoints/recoveryPointIdValue"
	if actual != expected {
...
func TestParseRecoveryPointID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/vaultValue/backupFabrics/fabricValue/protectionContainers/containerValue/protectedItems/protectedItemValue/recoveryPoints",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/vaultValue/backupFabrics/fabricValue/protectionContainers/containerValue/protectedItems/protectedItemValue/recoveryPoints/recoveryPointIdValue",
			Expected: &RecoveryPointId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/vaultValue/backupFabrics/fabricValue/protectionContainers/containerValue/protectedItems/protectedItemValue/recoveryPoints/recoveryPointIdValue/extra",
			Error: true,
		},
	}
