...
func TestNewProtectedItemID(t *testing.T) {
	id := NewProtectedItemID("12345678-1234-9876-4563-123456789012", "example-resource-group", "vaultName", "fabricName", "containerName", "protectedItemName")
...
func TestFormatProtectedItemID(t *testing.T) {
	actual := NewProtectedItemID("12345678-1234-9876-4563-123456789012", "example-resource-group", "vaultName", "fabricName", "containerName", "protectedItemName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/vaultName/backupFabrics/fabricName/protectionContainers/containerName/protectedItems/protectedItemName"
	if actual != expected {
...
func TestParseProtectedItemID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/vaultName/backupFabrics/fabricName/protectionContainers/containerName/protectedItems/protectedItemName/extra",
			Error: true,
		},
	}
