...
// MoveRecoveryPoint ...
func (c RecoveryPointsClient) MoveRecoveryPoint(ctx context.Context, id RecoveryPointId, input MoveRPAcrossTiersRequest) (result MoveRecoveryPointOperationResponse, err error) {
	req, err := c.preparerForMoveRecoveryPoint(ctx, id, input)
	if err != nil {
		err = autorest.NewErrorWithError(err, "recoverypoints.RecoveryPointsClient", "MoveRecoveryPoint", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForMoveRecoveryPoint(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "recoverypoints.RecoveryPointsClient", "MoveRecoveryPoint", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c RecoveryPointsClient) preparerForMoveRecoveryPoint(ctx context.Context, id RecoveryPointId, input MoveRPAcrossTiersRequest) (*http.Request, error) {
...
func (c RecoveryPointsClient) senderForMoveRecoveryPoint(ctx context.Context, req *http.Request) (future MoveRecoveryPointOperationResponse, err error) {
