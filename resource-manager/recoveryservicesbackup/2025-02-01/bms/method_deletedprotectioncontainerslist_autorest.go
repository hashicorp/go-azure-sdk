...
func (c BmsClient) DeletedProtectionContainersList(ctx context.Context, id VaultId, options DeletedProtectionContainersListOperationOptions) (resp DeletedProtectionContainersListOperationResponse, err error) {
	req, err := c.preparerForDeletedProtectionContainersList(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "bms.BmsClient", "DeletedProtectionContainersList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "bms.BmsClient", "DeletedProtectionContainersList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForDeletedProtectionContainersList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "bms.BmsClient", "DeletedProtectionContainersList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c BmsClient) preparerForDeletedProtectionContainersList(ctx context.Context, id VaultId, options DeletedProtectionContainersListOperationOptions) (*http.Request, error) {
...
func (c BmsClient) preparerForDeletedProtectionContainersListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c BmsClient) responderForDeletedProtectionContainersList(resp *http.Response) (result DeletedProtectionContainersListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result DeletedProtectionContainersListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "bms.BmsClient", "DeletedProtectionContainersList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForDeletedProtectionContainersList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "bms.BmsClient", "DeletedProtectionContainersList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c BmsClient) DeletedProtectionContainersListComplete(ctx context.Context, id VaultId, options DeletedProtectionContainersListOperationOptions) (DeletedProtectionContainersListCompleteResult, error) {
...
func (c BmsClient) DeletedProtectionContainersListCompleteMatchingPredicate(ctx context.Context, id VaultId, options DeletedProtectionContainersListOperationOptions, predicate ProtectionContainerResourceOperationPredicate) (resp DeletedProtectionContainersListCompleteResult, err error) {
