...
func (c BackupResourceStorageConfigsNonCRRClient) BMSPrepareDataMoveCallbackThenPoll(ctx context.Context, id VaultId, input PrepareDataMoveRequest, callback func() error) error {
