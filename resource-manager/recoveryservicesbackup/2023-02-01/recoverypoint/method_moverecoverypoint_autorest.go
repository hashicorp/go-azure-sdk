...
func (c RecoveryPointClient) MoveRecoveryPointCallbackThenPoll(ctx context.Context, id RecoveryPointId, input MoveRPAcrossTiersRequest, callback func() error) error {
