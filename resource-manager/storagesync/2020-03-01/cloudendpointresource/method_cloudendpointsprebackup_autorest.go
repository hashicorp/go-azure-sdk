...
func (c CloudEndpointResourceClient) CloudEndpointsPreBackup(ctx context.Context, id CloudEndpointId, input BackupRequest) (result CloudEndpointsPreBackupOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "cloudendpointresource.CloudEndpointResourceClient", "CloudEndpointsPreBackup", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCloudEndpointsPreBackup(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cloudendpointresource.CloudEndpointResourceClient", "CloudEndpointsPreBackup", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c CloudEndpointResourceClient) preparerForCloudEndpointsPreBackup(ctx context.Context, id CloudEndpointId, input BackupRequest) (*http.Request, error) {
...
func (c CloudEndpointResourceClient) senderForCloudEndpointsPreBackup(ctx context.Context, req *http.Request) (future CloudEndpointsPreBackupOperationResponse, err error) {
