...
func (c CloudEndpointResourceClient) CloudEndpointsPostRestore(ctx context.Context, id CloudEndpointId, input PostRestoreRequest) (result CloudEndpointsPostRestoreOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "cloudendpointresource.CloudEndpointResourceClient", "CloudEndpointsPostRestore", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCloudEndpointsPostRestore(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cloudendpointresource.CloudEndpointResourceClient", "CloudEndpointsPostRestore", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c CloudEndpointResourceClient) preparerForCloudEndpointsPostRestore(ctx context.Context, id CloudEndpointId, input PostRestoreRequest) (*http.Request, error) {
...
func (c CloudEndpointResourceClient) senderForCloudEndpointsPostRestore(ctx context.Context, req *http.Request) (future CloudEndpointsPostRestoreOperationResponse, err error) {
