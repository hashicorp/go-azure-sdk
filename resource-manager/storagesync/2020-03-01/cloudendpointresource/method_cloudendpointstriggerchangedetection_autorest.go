...
func (c CloudEndpointResourceClient) CloudEndpointsTriggerChangeDetection(ctx context.Context, id CloudEndpointId, input TriggerChangeDetectionParameters) (result CloudEndpointsTriggerChangeDetectionOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "cloudendpointresource.CloudEndpointResourceClient", "CloudEndpointsTriggerChangeDetection", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCloudEndpointsTriggerChangeDetection(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cloudendpointresource.CloudEndpointResourceClient", "CloudEndpointsTriggerChangeDetection", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c CloudEndpointResourceClient) preparerForCloudEndpointsTriggerChangeDetection(ctx context.Context, id CloudEndpointId, input TriggerChangeDetectionParameters) (*http.Request, error) {
...
func (c CloudEndpointResourceClient) senderForCloudEndpointsTriggerChangeDetection(ctx context.Context, req *http.Request) (future CloudEndpointsTriggerChangeDetectionOperationResponse, err error) {
