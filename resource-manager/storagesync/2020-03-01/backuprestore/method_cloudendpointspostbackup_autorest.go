...
func (c BackupRestoreClient) CloudEndpointsPostBackup(ctx context.Context, id CloudEndpointId, input BackupRequest) (result CloudEndpointsPostBackupOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "backuprestore.BackupRestoreClient", "CloudEndpointsPostBackup", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCloudEndpointsPostBackup(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "backuprestore.BackupRestoreClient", "CloudEndpointsPostBackup", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c BackupRestoreClient) preparerForCloudEndpointsPostBackup(ctx context.Context, id CloudEndpointId, input BackupRequest) (*http.Request, error) {
...
func (c BackupRestoreClient) senderForCloudEndpointsPostBackup(ctx context.Context, req *http.Request) (future CloudEndpointsPostBackupOperationResponse, err error) {
