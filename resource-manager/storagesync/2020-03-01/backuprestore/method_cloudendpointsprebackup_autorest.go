...
func (c BackupRestoreClient) CloudEndpointsPreBackup(ctx context.Context, id CloudEndpointId, input BackupRequest) (result CloudEndpointsPreBackupOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "backuprestore.BackupRestoreClient", "CloudEndpointsPreBackup", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCloudEndpointsPreBackup(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "backuprestore.BackupRestoreClient", "CloudEndpointsPreBackup", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c BackupRestoreClient) preparerForCloudEndpointsPreBackup(ctx context.Context, id CloudEndpointId, input BackupRequest) (*http.Request, error) {
...
func (c BackupRestoreClient) senderForCloudEndpointsPreBackup(ctx context.Context, req *http.Request) (future CloudEndpointsPreBackupOperationResponse, err error) {
