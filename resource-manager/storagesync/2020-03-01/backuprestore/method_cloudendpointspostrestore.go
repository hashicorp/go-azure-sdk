...
func (c BackupRestoreClient) CloudEndpointsPostRestoreCallbackThenPoll(ctx context.Context, id CloudEndpointId, input PostRestoreRequest, callback func() error) error {
