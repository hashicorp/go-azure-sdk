...
func (c BackupRestoreClient) CloudEndpointsPostBackupCallbackThenPoll(ctx context.Context, id CloudEndpointId, input BackupRequest, callback func() error) error {
