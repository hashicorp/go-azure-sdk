...
func (c BackupRestoreClient) CloudEndpointsPostRestore(ctx context.Context, id CloudEndpointId, input PostRestoreRequest) (result CloudEndpointsPostRestoreOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "backuprestore.BackupRestoreClient", "CloudEndpointsPostRestore", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCloudEndpointsPostRestore(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "backuprestore.BackupRestoreClient", "CloudEndpointsPostRestore", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c BackupRestoreClient) preparerForCloudEndpointsPostRestore(ctx context.Context, id CloudEndpointId, input PostRestoreRequest) (*http.Request, error) {
...
func (c BackupRestoreClient) senderForCloudEndpointsPostRestore(ctx context.Context, req *http.Request) (future CloudEndpointsPostRestoreOperationResponse, err error) {
