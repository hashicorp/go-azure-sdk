...
func (c BackupRestoreClient) CloudEndpointsPreRestoreCallbackThenPoll(ctx context.Context, id CloudEndpointId, input PreRestoreRequest, callback func() error) error {
