...
func (c BackupRestoreClient) CloudEndpointsPreBackupCallbackThenPoll(ctx context.Context, id CloudEndpointId, input BackupRequest, callback func() error) error {
