...
func NewPrivateEndpointConnectionID(subscriptionId string, resourceGroupName string, storageSyncServiceName string, privateEndpointConnectionName string) PrivateEndpointConnectionId {
...
func (id PrivateEndpointConnectionId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.StorageSync/storageSyncServices/%s/privateEndpointConnections/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.StorageSyncServiceName, id.PrivateEndpointConnectionName)
}
