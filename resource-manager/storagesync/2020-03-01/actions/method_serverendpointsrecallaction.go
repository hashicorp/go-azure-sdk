...
func (c ActionsClient) ServerEndpointsrecallActionCallbackThenPoll(ctx context.Context, id ServerEndpointId, input RecallActionParameters, callback func() error) error {
