...
func (c ActionsClient) RegisteredServerstriggerRolloverCallbackThenPoll(ctx context.Context, id RegisteredServerId, input TriggerRolloverRequest, callback func() error) error {
