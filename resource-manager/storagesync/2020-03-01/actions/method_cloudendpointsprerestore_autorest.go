...
func (c ActionsClient) CloudEndpointsPreRestore(ctx context.Context, id CloudEndpointId, input PreRestoreRequest) (result CloudEndpointsPreRestoreOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "actions.ActionsClient", "CloudEndpointsPreRestore", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCloudEndpointsPreRestore(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "actions.ActionsClient", "CloudEndpointsPreRestore", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ActionsClient) preparerForCloudEndpointsPreRestore(ctx context.Context, id CloudEndpointId, input PreRestoreRequest) (*http.Request, error) {
...
func (c ActionsClient) senderForCloudEndpointsPreRestore(ctx context.Context, req *http.Request) (future CloudEndpointsPreRestoreOperationResponse, err error) {
