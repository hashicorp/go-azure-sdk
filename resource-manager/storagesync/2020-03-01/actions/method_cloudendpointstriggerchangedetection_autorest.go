...
func (c ActionsClient) CloudEndpointsTriggerChangeDetection(ctx context.Context, id CloudEndpointId, input TriggerChangeDetectionParameters) (result CloudEndpointsTriggerChangeDetectionOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "actions.ActionsClient", "CloudEndpointsTriggerChangeDetection", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCloudEndpointsTriggerChangeDetection(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "actions.ActionsClient", "CloudEndpointsTriggerChangeDetection", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ActionsClient) preparerForCloudEndpointsTriggerChangeDetection(ctx context.Context, id CloudEndpointId, input TriggerChangeDetectionParameters) (*http.Request, error) {
...
func (c ActionsClient) senderForCloudEndpointsTriggerChangeDetection(ctx context.Context, req *http.Request) (future CloudEndpointsTriggerChangeDetectionOperationResponse, err error) {
