...
func (c ActionsClient) CloudEndpointsTriggerChangeDetectionCallbackThenPoll(ctx context.Context, id CloudEndpointId, input TriggerChangeDetectionParameters, callback func() error) error {
