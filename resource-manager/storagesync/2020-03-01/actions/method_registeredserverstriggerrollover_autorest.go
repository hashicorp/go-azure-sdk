...
func (c ActionsClient) RegisteredServerstriggerRollover(ctx context.Context, id RegisteredServerId, input TriggerRolloverRequest) (result RegisteredServerstriggerRolloverOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "actions.ActionsClient", "RegisteredServerstriggerRollover", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForRegisteredServerstriggerRollover(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "actions.ActionsClient", "RegisteredServerstriggerRollover", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ActionsClient) preparerForRegisteredServerstriggerRollover(ctx context.Context, id RegisteredServerId, input TriggerRolloverRequest) (*http.Request, error) {
...
func (c ActionsClient) senderForRegisteredServerstriggerRollover(ctx context.Context, req *http.Request) (future RegisteredServerstriggerRolloverOperationResponse, err error) {
