...
func (c ActionsClient) CloudEndpointsPostBackup(ctx context.Context, id CloudEndpointId, input BackupRequest) (result CloudEndpointsPostBackupOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "actions.ActionsClient", "CloudEndpointsPostBackup", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCloudEndpointsPostBackup(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "actions.ActionsClient", "CloudEndpointsPostBackup", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ActionsClient) preparerForCloudEndpointsPostBackup(ctx context.Context, id CloudEndpointId, input BackupRequest) (*http.Request, error) {
...
func (c ActionsClient) senderForCloudEndpointsPostBackup(ctx context.Context, req *http.Request) (future CloudEndpointsPostBackupOperationResponse, err error) {
