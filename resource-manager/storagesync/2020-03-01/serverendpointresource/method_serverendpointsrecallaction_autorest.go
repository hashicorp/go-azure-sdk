...
func (c ServerEndpointResourceClient) ServerEndpointsrecallAction(ctx context.Context, id ServerEndpointId, input RecallActionParameters) (result ServerEndpointsrecallActionOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "serverendpointresource.ServerEndpointResourceClient", "ServerEndpointsrecallAction", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForServerEndpointsrecallAction(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "serverendpointresource.ServerEndpointResourceClient", "ServerEndpointsrecallAction", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ServerEndpointResourceClient) preparerForServerEndpointsrecallAction(ctx context.Context, id ServerEndpointId, input RecallActionParameters) (*http.Request, error) {
...
func (c ServerEndpointResourceClient) senderForServerEndpointsrecallAction(ctx context.Context, req *http.Request) (future ServerEndpointsrecallActionOperationResponse, err error) {
