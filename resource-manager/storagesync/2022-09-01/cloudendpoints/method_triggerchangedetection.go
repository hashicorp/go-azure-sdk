...
type TriggerChangeDetectionOperationResponse struct {
...
func (c CloudEndpointsClient) TriggerChangeDetection(ctx context.Context, id CloudEndpointId, input TriggerChangeDetectionParameters) (result TriggerChangeDetectionOperationResponse, err error) {
...
func (c CloudEndpointsClient) TriggerChangeDetectionThenPoll(ctx context.Context, id CloudEndpointId, input TriggerChangeDetectionParameters) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after TriggerChangeDetection: %+v", err)
	}
