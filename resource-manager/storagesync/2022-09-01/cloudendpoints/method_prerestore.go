...
type PreRestoreOperationResponse struct {
...
// PreRestore ...
func (c CloudEndpointsClient) PreRestore(ctx context.Context, id CloudEndpointId, input PreRestoreRequest) (result PreRestoreOperationResponse, err error) {
...
func (c CloudEndpointsClient) PreRestoreThenPoll(ctx context.Context, id CloudEndpointId, input PreRestoreRequest) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after PreRestore: %+v", err)
	}
