...
type PostBackupOperationResponse struct {
...
// PostBackup ...
func (c CloudEndpointsClient) PostBackup(ctx context.Context, id CloudEndpointId, input BackupRequest) (result PostBackupOperationResponse, err error) {
...
func (c CloudEndpointsClient) PostBackupThenPoll(ctx context.Context, id CloudEndpointId, input BackupRequest) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after PostBackup: %+v", err)
	}
