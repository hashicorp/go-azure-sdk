...
// Update ...
func (c RegisteredServersClient) Update(ctx context.Context, id RegisteredServerId, input RegisteredServerUpdateParameters) (result UpdateOperationResponse, err error) {
