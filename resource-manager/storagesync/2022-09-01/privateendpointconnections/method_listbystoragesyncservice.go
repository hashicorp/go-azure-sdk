...
func (c PrivateEndpointConnectionsClient) ListByStorageSyncService(ctx context.Context, id StorageSyncServiceId) (result ListByStorageSyncServiceOperationResponse, err error) {
...
func (c PrivateEndpointConnectionsClient) ListByStorageSyncServiceComplete(ctx context.Context, id StorageSyncServiceId) (ListByStorageSyncServiceCompleteResult, error) {
	return c.ListByStorageSyncServiceCompleteMatchingPredicate(ctx, id, PrivateEndpointConnectionOperationPredicate{})
}

// ListByStorageSyncServiceCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c PrivateEndpointConnectionsClient) ListByStorageSyncServiceCompleteMatchingPredicate(ctx context.Context, id StorageSyncServiceId, predicate PrivateEndpointConnectionOperationPredicate) (result ListByStorageSyncServiceCompleteResult, err error) {
