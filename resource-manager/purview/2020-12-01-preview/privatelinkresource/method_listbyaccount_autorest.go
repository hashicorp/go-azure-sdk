...
// ListByAccount ...
func (c PrivateLinkResourceClient) ListByAccount(ctx context.Context, id AccountId) (resp ListByAccountOperationResponse, err error) {
...
func (c PrivateLinkResourceClient) responderForListByAccount(resp *http.Response) (result ListByAccountOperationResponse, err error) {
	type page struct {
