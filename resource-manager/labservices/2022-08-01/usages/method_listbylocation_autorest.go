...
func (c UsagesClient) ListByLocation(ctx context.Context, id LocationId) (resp ListByLocationOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "usages.UsagesClient", "ListByLocation", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "usages.UsagesClient", "ListByLocation", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByLocation(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "usages.UsagesClient", "ListByLocation", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c UsagesClient) preparerForListByLocation(ctx context.Context, id LocationId) (*http.Request, error) {
...
func (c UsagesClient) preparerForListByLocationWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c UsagesClient) responderForListByLocation(resp *http.Response) (result ListByLocationOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByLocationOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "usages.UsagesClient", "ListByLocation", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByLocation(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "usages.UsagesClient", "ListByLocation", result.HttpResponse, "Failure responding to request")
				return
			}
