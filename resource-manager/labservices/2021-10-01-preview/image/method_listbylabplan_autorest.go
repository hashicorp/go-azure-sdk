...
type ListByLabPlanOperationResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (ListByLabPlanOperationResponse, error)
}
...
func (c ImageClient) responderForListByLabPlan(resp *http.Response) (result ListByLabPlanOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByLabPlanOperationResponse, err error) {
