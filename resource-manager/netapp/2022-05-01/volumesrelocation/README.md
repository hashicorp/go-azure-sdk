...
## `github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2022-05-01/volumesrelocation` Documentation

The `volumesrelocation` SDK allows for interaction with the Azure Resource Manager Service `netapp` (API Version `2022-05-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2022-05-01/volumesrelocation"
```
