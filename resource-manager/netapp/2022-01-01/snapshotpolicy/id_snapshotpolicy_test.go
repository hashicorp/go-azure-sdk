...
func TestNewSnapshotPolicyID(t *testing.T) {
	id := NewSnapshotPolicyID("12345678-1234-9876-4563-123456789012", "example-resource-group", "accountValue", "snapshotPolicyValue")
...
func TestFormatSnapshotPolicyID(t *testing.T) {
	actual := NewSnapshotPolicyID("12345678-1234-9876-4563-123456789012", "example-resource-group", "accountValue", "snapshotPolicyValue").ID()
