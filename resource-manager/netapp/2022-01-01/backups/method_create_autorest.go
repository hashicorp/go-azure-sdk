...
func (c BackupsClient) Create(ctx context.Context, id BackupId, input Backup) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "backups.BackupsClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "backups.BackupsClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c BackupsClient) preparerForCreate(ctx context.Context, id BackupId, input Backup) (*http.Request, error) {
...
func (c BackupsClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
