...
func (c VolumeQuotaRulesClient) Create(ctx context.Context, id VolumeQuotaRuleId, input VolumeQuotaRule) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "volumequotarules.VolumeQuotaRulesClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "volumequotarules.VolumeQuotaRulesClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VolumeQuotaRulesClient) preparerForCreate(ctx context.Context, id VolumeQuotaRuleId, input VolumeQuotaRule) (*http.Request, error) {
...
func (c VolumeQuotaRulesClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
