...
## `github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2021-10-01/backuppolicy` Documentation

The `backuppolicy` SDK allows for interaction with the Azure Resource Manager Service `netapp` (API Version `2021-10-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2021-10-01/backuppolicy"
```
...
```go
ctx := context.TODO()
id := backuppolicy.NewBackupPolicyID("12345678-1234-9876-4563-123456789012", "example-resource-group", "accountValue", "backupPolicyValue")
