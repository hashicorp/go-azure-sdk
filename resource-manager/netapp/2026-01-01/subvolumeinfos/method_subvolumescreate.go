...
type SubvolumesCreateOperationResponse struct {
...
// SubvolumesCreate ...
func (c SubvolumeInfosClient) SubvolumesCreate(ctx context.Context, id SubVolumeId, input SubvolumeInfo) (result SubvolumesCreateOperationResponse, err error) {
...
func (c SubvolumeInfosClient) SubvolumesCreateThenPoll(ctx context.Context, id SubVolumeId, input SubvolumeInfo) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after SubvolumesCreate: %+v", err)
	}
