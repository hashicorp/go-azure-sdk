...
func TestNewBucketID(t *testing.T) {
	id := NewBucketID("12345678-1234-9876-4563-123456789012", "example-resource-group", "netAppAccountName", "capacityPoolName", "volumeName", "bucketName")
	...
	if id.BucketName != "bucketName" {
		t.Fatalf("Expected %q but got %q for Segment 'BucketName'", id.BucketName, "bucketName")
	}
}

func TestFormatBucketID(t *testing.T) {
	actual := NewBucketID("12345678-1234-9876-4563-123456789012", "example-resource-group", "netAppAccountName", "capacityPoolName", "volumeName", "bucketName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.NetApp/netAppAccounts/netAppAccountName/capacityPools/capacityPoolName/volumes/volumeName/buckets/bucketName"
	if actual != expected {
...
func TestParseBucketID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.NetApp/netAppAccounts/netAppAccountName/capacityPools/capacityPoolName/volumes/volumeName/buckets",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.NetApp/netAppAccounts/netAppAccountName/capacityPools/capacityPoolName/volumes/volumeName/buckets/bucketName",
			Expected: &BucketId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.NetApp/netAppAccounts/netAppAccountName/capacityPools/capacityPoolName/volumes/volumeName/buckets/bucketName/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseBucketID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
		...
		if actual.BucketName != v.Expected.BucketName {
			t.Fatalf("Expected %q but got %q for BucketName", v.Expected.BucketName, actual.BucketName)
		}

	}
}

func TestParseBucketIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *BucketId
	...
	for _, v := range testData {
		...
		actual, err := ParseBucketIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForBucketId(t *testing.T) {
	segments := BucketId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("BucketId has no segments")
	}
