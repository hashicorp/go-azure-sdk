...
import (
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2026-01-01/caches"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2026-01-01/netappresourcequotalimitsaccount"
	"github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2026-01-01/netapps"
	"github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2026-01-01/ransomwarereports"
	"github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2026-01-01/regioninforesources"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2026-01-01/subscriptionquotaitems"
	"github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2026-01-01/subvolumeinfos"
...
func NewClientWithBaseURI(sdkApi sdkEnv.Api, configureFunc func(c *resourcemanager.Client)) (*Client, error) {
	...
	bucketsClient, err := buckets.NewBucketsClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building Buckets client: %+v", err)
	}
	configureFunc(bucketsClient.Client)
