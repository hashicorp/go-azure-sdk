...
## `github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2022-11-01-preview/subvolumes` Documentation

The `subvolumes` SDK allows for interaction with the Azure Resource Manager Service `netapp` (API Version `2022-11-01-preview`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2022-11-01-preview/subvolumes"
```
