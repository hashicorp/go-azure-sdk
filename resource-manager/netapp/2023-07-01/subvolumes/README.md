...
## `github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2023-07-01/subvolumes` Documentation

The `subvolumes` SDK allows for interaction with Azure Resource Manager `netapp` (API Version `2023-07-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2023-07-01/subvolumes"
```
