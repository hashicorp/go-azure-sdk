...
func (c SubscriptionQuotaItemsClient) NetAppResourceQuotaLimitsListComplete(ctx context.Context, id LocationId) (NetAppResourceQuotaLimitsListCompleteResult, error) {
	return c.NetAppResourceQuotaLimitsListCompleteMatchingPredicate(ctx, id, QuotaItemOperationPredicate{})
}

// NetAppResourceQuotaLimitsListCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c SubscriptionQuotaItemsClient) NetAppResourceQuotaLimitsListCompleteMatchingPredicate(ctx context.Context, id LocationId, predicate QuotaItemOperationPredicate) (result NetAppResourceQuotaLimitsListCompleteResult, err error) {
