...
const (
	...
	CheckNameResourceTypesMicrosoftPointNetAppNetAppAccountsBackupVaultsBackups           CheckNameResourceTypes = "Microsoft.NetApp/netAppAccounts/backupVaults/backups"
	...
	CheckNameResourceTypesMicrosoftPointNetAppNetAppAccountsCapacityPoolsVolumesBackups   CheckNameResourceTypes = "Microsoft.NetApp/netAppAccounts/capacityPools/volumes/backups"
...
func PossibleValuesForCheckNameResourceTypes() []string {
	return []string{
		...
		string(CheckNameResourceTypesMicrosoftPointNetAppNetAppAccountsBackupVaultsBackups),
		...
		string(CheckNameResourceTypesMicrosoftPointNetAppNetAppAccountsCapacityPoolsVolumesBackups),
...
func parseCheckNameResourceTypes(input string) (*CheckNameResourceTypes, error) {
	vals := map[string]CheckNameResourceTypes{
		...
		"microsoft.netapp/netappaccounts/backupvaults/backups":            CheckNameResourceTypesMicrosoftPointNetAppNetAppAccountsBackupVaultsBackups,
		...
		"microsoft.netapp/netappaccounts/capacitypools/volumes/backups":   CheckNameResourceTypesMicrosoftPointNetAppNetAppAccountsCapacityPoolsVolumesBackups,
...
const (
	...
	CheckQuotaNameResourceTypesMicrosoftPointNetAppNetAppAccountsBackupVaultsBackups           CheckQuotaNameResourceTypes = "Microsoft.NetApp/netAppAccounts/backupVaults/backups"
	...
	CheckQuotaNameResourceTypesMicrosoftPointNetAppNetAppAccountsCapacityPoolsVolumesBackups   CheckQuotaNameResourceTypes = "Microsoft.NetApp/netAppAccounts/capacityPools/volumes/backups"
...
func PossibleValuesForCheckQuotaNameResourceTypes() []string {
	return []string{
		...
		string(CheckQuotaNameResourceTypesMicrosoftPointNetAppNetAppAccountsBackupVaultsBackups),
		...
		string(CheckQuotaNameResourceTypesMicrosoftPointNetAppNetAppAccountsCapacityPoolsVolumesBackups),
...
func parseCheckQuotaNameResourceTypes(input string) (*CheckQuotaNameResourceTypes, error) {
	vals := map[string]CheckQuotaNameResourceTypes{
		...
		"microsoft.netapp/netappaccounts/backupvaults/backups":            CheckQuotaNameResourceTypesMicrosoftPointNetAppNetAppAccountsBackupVaultsBackups,
		...
		"microsoft.netapp/netappaccounts/capacitypools/volumes/backups":   CheckQuotaNameResourceTypesMicrosoftPointNetAppNetAppAccountsCapacityPoolsVolumesBackups,
