...
func (c VolumesRelocationClient) VolumesRelocate(ctx context.Context, id VolumeId, input RelocateVolumeRequest) (result VolumesRelocateOperationResponse, err error) {
	req, err := c.preparerForVolumesRelocate(ctx, id, input)
	if err != nil {
...
func (c VolumesRelocationClient) preparerForVolumesRelocate(ctx context.Context, id VolumeId, input RelocateVolumeRequest) (*http.Request, error) {
