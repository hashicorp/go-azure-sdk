...
func (c SubVolumesClient) Create(ctx context.Context, id SubVolumeId, input SubvolumeInfo) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "subvolumes.SubVolumesClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "subvolumes.SubVolumesClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c SubVolumesClient) preparerForCreate(ctx context.Context, id SubVolumeId, input SubvolumeInfo) (*http.Request, error) {
...
func (c SubVolumesClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
