...
## `github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2024-09-01/volumequotarules` Documentation

The `volumequotarules` SDK allows for interaction with Azure Resource Manager `netapp` (API Version `2024-09-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2024-09-01/volumequotarules"
```
