...
## `github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2025-03-01/volumesrevert` Documentation

The `volumesrevert` SDK allows for interaction with Azure Resource Manager `netapp` (API Version `2025-03-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2025-03-01/volumesrevert"
```
