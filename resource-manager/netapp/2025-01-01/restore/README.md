...
## `github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2025-01-01/restore` Documentation

The `restore` SDK allows for interaction with Azure Resource Manager `netapp` (API Version `2025-01-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2025-01-01/restore"
```
