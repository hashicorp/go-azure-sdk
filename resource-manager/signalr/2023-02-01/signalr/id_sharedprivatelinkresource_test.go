...
func TestFormatSharedPrivateLinkResourceID(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.SignalRService/signalR/resourceName/sharedPrivateLinkResources/sharedPrivateLinkResourceName"
	if actual != expected {
...
func TestParseSharedPrivateLinkResourceID(t *testing.T) {
	testData := []struct {
		...
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.SignalRService/signalR/resourceName/sharedPrivateLinkResources/sharedPrivateLinkResourceName",
			Expected: &SharedPrivateLinkResourceId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.SignalRService/signalR/resourceName/sharedPrivateLinkResources/sharedPrivateLinkResourceName/extra",
			Error: true,
		},
	}
