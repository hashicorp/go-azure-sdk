...
## `github.com/hashicorp/go-azure-sdk/resource-manager/kubernetesconfiguration/2024-11-01/flux` Documentation

The `flux` SDK allows for interaction with Azure Resource Manager `kubernetesconfiguration` (API Version `2024-11-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/kubernetesconfiguration/2024-11-01/flux"
```
...
```go
ctx := context.TODO()
id := flux.NewScopedFluxConfigurationID("/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/some-resource-group", "fluxConfigurationName")
