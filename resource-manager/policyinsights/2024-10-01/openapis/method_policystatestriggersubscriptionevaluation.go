...
type PolicyStatesTriggerSubscriptionEvaluationOperationResponse struct {
...
func (c OpenapisClient) PolicyStatesTriggerSubscriptionEvaluation(ctx context.Context, id commonids.SubscriptionId) (result PolicyStatesTriggerSubscriptionEvaluationOperationResponse, err error) {
...
func (c OpenapisClient) PolicyStatesTriggerSubscriptionEvaluationCallbackThenPoll(ctx context.Context, id commonids.SubscriptionId, callback func() error) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after PolicyStatesTriggerSubscriptionEvaluation: %+v", err)
	}
