...
type AttestationsListForResourceCustomPager struct {
	NextLink *odata.Link `json:"nextLink"`
}

func (p *AttestationsListForResourceCustomPager) NextPageLink() *odata.Link {
	defer func() {
		p.NextLink = nil
	}()
...
func (c OpenapisClient) AttestationsListForResource(ctx context.Context, id commonids.ScopeId, options AttestationsListForResourceOperationOptions) (result AttestationsListForResourceOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &AttestationsListForResourceCustomPager{},
...
func (c OpenapisClient) AttestationsListForResourceComplete(ctx context.Context, id commonids.ScopeId, options AttestationsListForResourceOperationOptions) (AttestationsListForResourceCompleteResult, error) {
...
func (c OpenapisClient) AttestationsListForResourceCompleteMatchingPredicate(ctx context.Context, id commonids.ScopeId, options AttestationsListForResourceOperationOptions, predicate AttestationOperationPredicate) (result AttestationsListForResourceCompleteResult, err error) {
