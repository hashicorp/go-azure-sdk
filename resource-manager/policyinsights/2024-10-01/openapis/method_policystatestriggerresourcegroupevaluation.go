...
type PolicyStatesTriggerResourceGroupEvaluationOperationResponse struct {
...
func (c OpenapisClient) PolicyStatesTriggerResourceGroupEvaluation(ctx context.Context, id commonids.ResourceGroupId) (result PolicyStatesTriggerResourceGroupEvaluationOperationResponse, err error) {
...
func (c OpenapisClient) PolicyStatesTriggerResourceGroupEvaluationCallbackThenPoll(ctx context.Context, id commonids.ResourceGroupId, callback func() error) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after PolicyStatesTriggerResourceGroupEvaluation: %+v", err)
	}
