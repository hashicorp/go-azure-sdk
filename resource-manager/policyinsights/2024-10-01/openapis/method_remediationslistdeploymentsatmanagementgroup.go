...
type RemediationsListDeploymentsAtManagementGroupCustomPager struct {
	NextLink *odata.Link `json:"nextLink"`
}

func (p *RemediationsListDeploymentsAtManagementGroupCustomPager) NextPageLink() *odata.Link {
	defer func() {
		p.NextLink = nil
	}()
...
func (c OpenapisClient) RemediationsListDeploymentsAtManagementGroup(ctx context.Context, id Providers2RemediationId, options RemediationsListDeploymentsAtManagementGroupOperationOptions) (result RemediationsListDeploymentsAtManagementGroupOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &RemediationsListDeploymentsAtManagementGroupCustomPager{},
...
func (c OpenapisClient) RemediationsListDeploymentsAtManagementGroupComplete(ctx context.Context, id Providers2RemediationId, options RemediationsListDeploymentsAtManagementGroupOperationOptions) (RemediationsListDeploymentsAtManagementGroupCompleteResult, error) {
