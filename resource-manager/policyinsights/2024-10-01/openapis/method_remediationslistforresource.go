...
type RemediationsListForResourceCustomPager struct {
	NextLink *odata.Link `json:"nextLink"`
}

func (p *RemediationsListForResourceCustomPager) NextPageLink() *odata.Link {
	defer func() {
		p.NextLink = nil
	}()
...
func (c OpenapisClient) RemediationsListForResource(ctx context.Context, id commonids.ScopeId, options RemediationsListForResourceOperationOptions) (result RemediationsListForResourceOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &RemediationsListForResourceCustomPager{},
...
func (c OpenapisClient) RemediationsListForResourceComplete(ctx context.Context, id commonids.ScopeId, options RemediationsListForResourceOperationOptions) (RemediationsListForResourceCompleteResult, error) {
...
func (c OpenapisClient) RemediationsListForResourceCompleteMatchingPredicate(ctx context.Context, id commonids.ScopeId, options RemediationsListForResourceOperationOptions, predicate RemediationOperationPredicate) (result RemediationsListForResourceCompleteResult, err error) {
