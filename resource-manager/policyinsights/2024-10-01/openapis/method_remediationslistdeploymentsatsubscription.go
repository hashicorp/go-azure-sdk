...
type RemediationsListDeploymentsAtSubscriptionCustomPager struct {
	NextLink *odata.Link `json:"nextLink"`
}

func (p *RemediationsListDeploymentsAtSubscriptionCustomPager) NextPageLink() *odata.Link {
	defer func() {
		p.NextLink = nil
	}()
...
func (c OpenapisClient) RemediationsListDeploymentsAtSubscription(ctx context.Context, id RemediationId, options RemediationsListDeploymentsAtSubscriptionOperationOptions) (result RemediationsListDeploymentsAtSubscriptionOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &RemediationsListDeploymentsAtSubscriptionCustomPager{},
...
func (c OpenapisClient) RemediationsListDeploymentsAtSubscriptionComplete(ctx context.Context, id RemediationId, options RemediationsListDeploymentsAtSubscriptionOperationOptions) (RemediationsListDeploymentsAtSubscriptionCompleteResult, error) {
