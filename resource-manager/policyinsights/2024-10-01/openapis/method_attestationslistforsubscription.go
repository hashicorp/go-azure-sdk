...
type AttestationsListForSubscriptionCustomPager struct {
	NextLink *odata.Link `json:"nextLink"`
}

func (p *AttestationsListForSubscriptionCustomPager) NextPageLink() *odata.Link {
	defer func() {
		p.NextLink = nil
	}()
...
func (c OpenapisClient) AttestationsListForSubscription(ctx context.Context, id commonids.SubscriptionId, options AttestationsListForSubscriptionOperationOptions) (result AttestationsListForSubscriptionOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &AttestationsListForSubscriptionCustomPager{},
...
func (c OpenapisClient) AttestationsListForSubscriptionComplete(ctx context.Context, id commonids.SubscriptionId, options AttestationsListForSubscriptionOperationOptions) (AttestationsListForSubscriptionCompleteResult, error) {
...
func (c OpenapisClient) AttestationsListForSubscriptionCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, options AttestationsListForSubscriptionOperationOptions, predicate AttestationOperationPredicate) (result AttestationsListForSubscriptionCompleteResult, err error) {
