...
type RemediationsListForSubscriptionCustomPager struct {
	NextLink *odata.Link `json:"nextLink"`
}

func (p *RemediationsListForSubscriptionCustomPager) NextPageLink() *odata.Link {
	defer func() {
		p.NextLink = nil
	}()
...
func (c OpenapisClient) RemediationsListForSubscription(ctx context.Context, id commonids.SubscriptionId, options RemediationsListForSubscriptionOperationOptions) (result RemediationsListForSubscriptionOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &RemediationsListForSubscriptionCustomPager{},
...
func (c OpenapisClient) RemediationsListForSubscriptionComplete(ctx context.Context, id commonids.SubscriptionId, options RemediationsListForSubscriptionOperationOptions) (RemediationsListForSubscriptionCompleteResult, error) {
...
func (c OpenapisClient) RemediationsListForSubscriptionCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, options RemediationsListForSubscriptionOperationOptions, predicate RemediationOperationPredicate) (result RemediationsListForSubscriptionCompleteResult, err error) {
