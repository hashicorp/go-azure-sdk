...
type RemediationsListForManagementGroupCustomPager struct {
	NextLink *odata.Link `json:"nextLink"`
}

func (p *RemediationsListForManagementGroupCustomPager) NextPageLink() *odata.Link {
	defer func() {
		p.NextLink = nil
	}()
...
func (c OpenapisClient) RemediationsListForManagementGroup(ctx context.Context, id ManagementGroupId, options RemediationsListForManagementGroupOperationOptions) (result RemediationsListForManagementGroupOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:         &RemediationsListForManagementGroupCustomPager{},
...
func (c OpenapisClient) RemediationsListForManagementGroupComplete(ctx context.Context, id ManagementGroupId, options RemediationsListForManagementGroupOperationOptions) (RemediationsListForManagementGroupCompleteResult, error) {
...
func (c OpenapisClient) RemediationsListForManagementGroupCompleteMatchingPredicate(ctx context.Context, id ManagementGroupId, options RemediationsListForManagementGroupOperationOptions, predicate RemediationOperationPredicate) (result RemediationsListForManagementGroupCompleteResult, err error) {
