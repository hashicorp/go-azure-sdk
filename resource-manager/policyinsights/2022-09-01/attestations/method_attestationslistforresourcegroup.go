...
func (c AttestationsClient) AttestationsListForResourceGroup(ctx context.Context, id commonids.ResourceGroupId, options AttestationsListForResourceGroupOperationOptions) (result AttestationsListForResourceGroupOperationResponse, err error) {
...
func (c AttestationsClient) AttestationsListForResourceGroupCompleteMatchingPredicate(ctx context.Context, id commonids.ResourceGroupId, options AttestationsListForResourceGroupOperationOptions, predicate AttestationOperationPredicate) (result AttestationsListForResourceGroupCompleteResult, err error) {
