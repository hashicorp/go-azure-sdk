...
func (c SandboxCustomImagesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id SandboxCustomImageId, input SandboxCustomImage, callback func() error) error {
