...
## `github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2022-02-01/privatelinkresources` Documentation

The `privatelinkresources` SDK allows for interaction with the Azure Resource Manager Service `kusto` (API Version `2022-02-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2022-02-01/privatelinkresources"
```
