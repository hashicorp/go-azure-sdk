...
## `github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2021-08-27/managedprivateendpoints` Documentation

The `managedprivateendpoints` SDK allows for interaction with the Azure Resource Manager Service `kusto` (API Version `2021-08-27`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2021-08-27/managedprivateendpoints"
```
