...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2023-03-15/notebookworkspacesresource` Documentation

The `notebookworkspacesresource` SDK allows for interaction with the Azure Resource Manager Service `cosmosdb` (API Version `2023-03-15`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2023-03-15/notebookworkspacesresource"
```
