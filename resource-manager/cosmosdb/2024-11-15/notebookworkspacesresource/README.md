...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2024-11-15/notebookworkspacesresource` Documentation

The `notebookworkspacesresource` SDK allows for interaction with Azure Resource Manager `cosmosdb` (API Version `2024-11-15`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2024-11-15/notebookworkspacesresource"
```
