...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2024-11-15/restorables` Documentation

The `restorables` SDK allows for interaction with Azure Resource Manager `cosmosdb` (API Version `2024-11-15`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2024-11-15/restorables"
```
