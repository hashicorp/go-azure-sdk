...
func TestNewCassandraClusterID(t *testing.T) {
	id := NewCassandraClusterID("12345678-1234-9876-4563-123456789012", "example-resource-group", "clusterValue")
...
func TestFormatCassandraClusterID(t *testing.T) {
	actual := NewCassandraClusterID("12345678-1234-9876-4563-123456789012", "example-resource-group", "clusterValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DocumentDB/cassandraClusters/clusterValue"
	if actual != expected {
...
func TestParseCassandraClusterID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DocumentDB/cassandraClusters/clusterValue/extra",
			Error: true,
		},
	}
