...
func NewPrivateLinkResourceID(subscriptionId string, resourceGroupName string, accountName string, groupName string) PrivateLinkResourceId {
...
func (id PrivateLinkResourceId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.DocumentDB/databaseAccounts/%s/privateLinkResources/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.AccountName, id.GroupName)
}
