...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2023-11-15/materializedviewsbuilder` Documentation

The `materializedviewsbuilder` SDK allows for interaction with Azure Resource Manager `cosmosdb` (API Version `2023-11-15`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2023-11-15/materializedviewsbuilder"
```
