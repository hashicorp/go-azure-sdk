...
func TestNewSqlRoleAssignmentID(t *testing.T) {
	id := NewSqlRoleAssignmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "databaseAccountValue", "roleAssignmentIdValue")
...
func TestFormatSqlRoleAssignmentID(t *testing.T) {
	actual := NewSqlRoleAssignmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "databaseAccountValue", "roleAssignmentIdValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DocumentDB/databaseAccounts/databaseAccountValue/sqlRoleAssignments/roleAssignmentIdValue"
	if actual != expected {
...
func TestParseSqlRoleAssignmentID(t *testing.T) {
	testData := []struct {
		...
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DocumentDB/databaseAccounts/databaseAccountValue/sqlRoleAssignments/roleAssignmentIdValue",
			Expected: &SqlRoleAssignmentId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DocumentDB/databaseAccounts/databaseAccountValue/sqlRoleAssignments/roleAssignmentIdValue/extra",
			Error: true,
		},
	}
