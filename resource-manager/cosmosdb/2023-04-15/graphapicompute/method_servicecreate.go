...
func (c GraphAPIComputeClient) ServiceCreateCallbackThenPoll(ctx context.Context, id ServiceId, input ServiceResourceCreateUpdateParameters, callback func() error) error {
