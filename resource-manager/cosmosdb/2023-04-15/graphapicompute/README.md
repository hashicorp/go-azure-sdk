...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2023-04-15/graphapicompute` Documentation

The `graphapicompute` SDK allows for interaction with Azure Resource Manager `cosmosdb` (API Version `2023-04-15`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2023-04-15/graphapicompute"
```
