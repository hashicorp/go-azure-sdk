...
func (c OpenapisClient) ExportConfigurationsCreate(ctx context.Context, id ComponentId, input ApplicationInsightsComponentExportRequest) (result ExportConfigurationsCreateOperationResponse, err error) {
