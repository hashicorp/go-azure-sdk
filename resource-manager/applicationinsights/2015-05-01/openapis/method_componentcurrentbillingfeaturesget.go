...
func (c OpenapisClient) ComponentCurrentBillingFeaturesGet(ctx context.Context, id ComponentId) (result ComponentCurrentBillingFeaturesGetOperationResponse, err error) {
