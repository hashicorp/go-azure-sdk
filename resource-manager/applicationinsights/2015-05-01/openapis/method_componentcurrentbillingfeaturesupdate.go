...
func (c OpenapisClient) ComponentCurrentBillingFeaturesUpdate(ctx context.Context, id ComponentId, input ApplicationInsightsComponentBillingFeatures) (result ComponentCurrentBillingFeaturesUpdateOperationResponse, err error) {
