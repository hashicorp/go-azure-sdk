...
func (c OpenapisClient) ComponentFeatureCapabilitiesGet(ctx context.Context, id ComponentId) (result ComponentFeatureCapabilitiesGetOperationResponse, err error) {
