...
func NewNetworkSecurityPerimeterConfigurationID(subscriptionId string, resourceGroupName string, workspaceName string, networkSecurityPerimeterConfigurationName string) NetworkSecurityPerimeterConfigurationId {
...
func (id NetworkSecurityPerimeterConfigurationId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.OperationalInsights/workspaces/%s/networkSecurityPerimeterConfigurations/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.WorkspaceName, id.NetworkSecurityPerimeterConfigurationName)
}
