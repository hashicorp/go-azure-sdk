...
func TestNewQueriesID(t *testing.T) {
	id := NewQueriesID("12345678-1234-9876-4563-123456789012", "example-resource-group", "queryPackValue", "idValue")
...
func TestFormatQueriesID(t *testing.T) {
	actual := NewQueriesID("12345678-1234-9876-4563-123456789012", "example-resource-group", "queryPackValue", "idValue").ID()
...
func TestParseQueriesID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *QueriesId
	...
	for _, v := range testData {
		...
		actual, err := ParseQueriesID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseQueriesIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *QueriesId
	...
	for _, v := range testData {
		...
		actual, err := ParseQueriesIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForQueriesId(t *testing.T) {
	segments := QueriesId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("QueriesId has no segments")
	}
