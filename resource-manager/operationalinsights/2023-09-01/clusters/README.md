...
## `github.com/hashicorp/go-azure-sdk/resource-manager/operationalinsights/2023-09-01/clusters` Documentation

The `clusters` SDK allows for interaction with Azure Resource Manager `operationalinsights` (API Version `2023-09-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/operationalinsights/2023-09-01/clusters"
```
