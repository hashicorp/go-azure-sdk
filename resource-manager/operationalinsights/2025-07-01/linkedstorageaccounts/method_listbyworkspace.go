...
type ListByWorkspaceCompleteResult struct {
	...
	Items              []LinkedStorageAccountsResource
}
...
func (c LinkedStorageAccountsClient) ListByWorkspace(ctx context.Context, id WorkspaceId) (result ListByWorkspaceOperationResponse, err error) {
	...
	var values struct {
		Values *[]LinkedStorageAccountsResource `json:"value"`
	}
...
func (c LinkedStorageAccountsClient) ListByWorkspaceComplete(ctx context.Context, id WorkspaceId) (ListByWorkspaceCompleteResult, error) {
	return c.ListByWorkspaceCompleteMatchingPredicate(ctx, id, LinkedStorageAccountsResourceOperationPredicate{})
}

// ListByWorkspaceCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c LinkedStorageAccountsClient) ListByWorkspaceCompleteMatchingPredicate(ctx context.Context, id WorkspaceId, predicate LinkedStorageAccountsResourceOperationPredicate) (result ListByWorkspaceCompleteResult, err error) {
	items := make([]LinkedStorageAccountsResource, 0)
