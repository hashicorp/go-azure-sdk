...
## `github.com/hashicorp/go-azure-sdk/resource-manager/operationalinsights/2025-07-01/networksecurityperimeterconfigurations` Documentation

The `networksecurityperimeterconfigurations` SDK allows for interaction with Azure Resource Manager `operationalinsights` (API Version `2025-07-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/operationalinsights/2025-07-01/networksecurityperimeterconfigurations"
```
