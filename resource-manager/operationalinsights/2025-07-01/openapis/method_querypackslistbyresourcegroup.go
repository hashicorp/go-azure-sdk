...
type QueryPacksListByResourceGroupCustomPager struct {
	NextLink *odata.Link `json:"nextLink"`
}

func (p *QueryPacksListByResourceGroupCustomPager) NextPageLink() *odata.Link {
	defer func() {
		p.NextLink = nil
	}()
...
func (c OpenapisClient) QueryPacksListByResourceGroup(ctx context.Context, id commonids.ResourceGroupId) (result QueryPacksListByResourceGroupOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:      &QueryPacksListByResourceGroupCustomPager{},
...
func (c OpenapisClient) QueryPacksListByResourceGroupComplete(ctx context.Context, id commonids.ResourceGroupId) (QueryPacksListByResourceGroupCompleteResult, error) {
...
func (c OpenapisClient) QueryPacksListByResourceGroupCompleteMatchingPredicate(ctx context.Context, id commonids.ResourceGroupId, predicate LogAnalyticsQueryPackOperationPredicate) (result QueryPacksListByResourceGroupCompleteResult, err error) {
