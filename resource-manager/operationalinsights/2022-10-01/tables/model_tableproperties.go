...
type TableProperties struct {
	...
	RetentionInDaysAsDefault      *RetentionInDaysAsDefault      `json:"retentionInDaysAsDefault,omitempty"`
	...
	TotalRetentionInDaysAsDefault *TotalRetentionInDaysAsDefault `json:"totalRetentionInDaysAsDefault,omitempty"`
}
