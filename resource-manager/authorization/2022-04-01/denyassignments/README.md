...
```go
ctx := context.TODO()
id := denyassignments.NewScopedDenyAssignmentID("/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/some-resource-group", "denyAssignmentIdValue")
...
```go
ctx := context.TODO()
id := denyassignments.NewDenyAssignmentIdID("denyAssignmentIdValue")
