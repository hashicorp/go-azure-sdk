...
func NewPrivateLinkResourceID(subscriptionId string, resourceGroupName string, serverGroupsv2Name string, privateLinkResourceName string) PrivateLinkResourceId {
...
func (id PrivateLinkResourceId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.DBforPostgreSQL/serverGroupsv2/%s/privateLinkResources/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.ServerGroupsv2Name, id.PrivateLinkResourceName)
}
