...
type ListByServerGroupOperationResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (ListByServerGroupOperationResponse, error)
}
...
func (r ListByServerGroupOperationResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r ListByServerGroupOperationResponse) LoadMore(ctx context.Context) (resp ListByServerGroupOperationResponse, err error) {
	if !r.HasMore() {
...
// ListByServerGroup ...
func (c ConfigurationsClient) ListByServerGroup(ctx context.Context, id ServerGroupsv2Id) (resp ListByServerGroupOperationResponse, err error) {
...
func (c ConfigurationsClient) responderForListByServerGroup(resp *http.Response) (result ListByServerGroupOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByServerGroupOperationResponse, err error) {
