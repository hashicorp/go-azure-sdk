...
## `github.com/hashicorp/go-azure-sdk/resource-manager/web/2025-05-01/workflows` Documentation

The `workflows` SDK allows for interaction with Azure Resource Manager `web` (API Version `2025-05-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/web/2025-05-01/workflows"
```
