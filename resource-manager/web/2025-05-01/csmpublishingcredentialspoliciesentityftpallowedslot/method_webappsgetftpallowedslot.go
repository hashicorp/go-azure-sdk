...
type WebAppsGetFtpAllowedSlotOperationResponse struct {
...
func (c CsmPublishingCredentialsPoliciesEntityFtpAllowedSlotClient) WebAppsGetFtpAllowedSlot(ctx context.Context, id SlotId) (result WebAppsGetFtpAllowedSlotOperationResponse, err error) {
