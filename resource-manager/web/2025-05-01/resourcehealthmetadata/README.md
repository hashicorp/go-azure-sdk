...
## `github.com/hashicorp/go-azure-sdk/resource-manager/web/2025-05-01/resourcehealthmetadata` Documentation

The `resourcehealthmetadata` SDK allows for interaction with Azure Resource Manager `web` (API Version `2025-05-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/web/2025-05-01/resourcehealthmetadata"
```
