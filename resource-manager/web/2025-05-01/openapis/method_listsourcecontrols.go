...
// ListSourceControls ...
func (c OpenapisClient) ListSourceControls(ctx context.Context) (result ListSourceControlsOperationResponse, err error) {
...
func (c OpenapisClient) ListSourceControlsComplete(ctx context.Context) (ListSourceControlsCompleteResult, error) {
...
func (c OpenapisClient) ListSourceControlsCompleteMatchingPredicate(ctx context.Context, predicate SourceControlOperationPredicate) (result ListSourceControlsCompleteResult, err error) {
