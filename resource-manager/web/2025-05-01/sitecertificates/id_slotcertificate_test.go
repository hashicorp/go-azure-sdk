...
func TestNewSlotCertificateID(t *testing.T) {
	id := NewSlotCertificateID("12345678-1234-9876-4563-123456789012", "example-resource-group", "siteName", "slotName", "certificateName")
...
func TestFormatSlotCertificateID(t *testing.T) {
	actual := NewSlotCertificateID("12345678-1234-9876-4563-123456789012", "example-resource-group", "siteName", "slotName", "certificateName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Web/sites/siteName/slots/slotName/certificates/certificateName"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseSlotCertificateID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *SlotCertificateId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Web/sites/siteName/slots/slotName/certificates",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Web/sites/siteName/slots/slotName/certificates/certificateName",
			Expected: &SlotCertificateId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Web/sites/siteName/slots/slotName/certificates/certificateName/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseSlotCertificateID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseSlotCertificateIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *SlotCertificateId
	...
	for _, v := range testData {
		...
		actual, err := ParseSlotCertificateIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForSlotCertificateId(t *testing.T) {
	segments := SlotCertificateId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("SlotCertificateId has no segments")
	}
