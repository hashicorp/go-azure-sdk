...
## `github.com/hashicorp/go-azure-sdk/resource-manager/web/2025-05-01/kubeenvironments` Documentation

The `kubeenvironments` SDK allows for interaction with Azure Resource Manager `web` (API Version `2025-05-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/web/2025-05-01/kubeenvironments"
```
