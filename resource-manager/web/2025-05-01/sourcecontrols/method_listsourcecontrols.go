...
// ListSourceControls ...
func (c SourceControlsClient) ListSourceControls(ctx context.Context) (result ListSourceControlsOperationResponse, err error) {
...
func (c SourceControlsClient) ListSourceControlsComplete(ctx context.Context) (ListSourceControlsCompleteResult, error) {
...
func (c SourceControlsClient) ListSourceControlsCompleteMatchingPredicate(ctx context.Context, predicate SourceControlOperationPredicate) (result ListSourceControlsCompleteResult, err error) {
