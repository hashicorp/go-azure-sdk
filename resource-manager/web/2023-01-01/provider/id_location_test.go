...
func TestFormatLocationID(t *testing.T) {
	...
	expected := "/providers/Microsoft.Web/locations/locationValue"
	if actual != expected {
...
func TestParseLocationID(t *testing.T) {
	testData := []struct {
		...
		{
			// Valid URI
			Input: "/providers/Microsoft.Web/locations/locationValue",
			Expected: &LocationId{
		...
		},
		{
			...
			Input: "/providers/Microsoft.Web/locations/locationValue/extra",
			Error: true,
		},
	}
