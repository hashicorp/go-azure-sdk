...
func TestNewCertificateOrderCertificateID(t *testing.T) {
	id := NewCertificateOrderCertificateID("12345678-1234-9876-4563-123456789012", "example-resource-group", "certificateOrderName", "certificateName")
...
func TestFormatCertificateOrderCertificateID(t *testing.T) {
	actual := NewCertificateOrderCertificateID("12345678-1234-9876-4563-123456789012", "example-resource-group", "certificateOrderName", "certificateName").ID()
...
func TestParseCertificateOrderCertificateID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *CertificateOrderCertificateId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseCertificateOrderCertificateID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseCertificateOrderCertificateIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *CertificateOrderCertificateId
	...
	for _, v := range testData {
		...
		actual, err := ParseCertificateOrderCertificateIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForCertificateOrderCertificateId(t *testing.T) {
	segments := CertificateOrderCertificateId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("CertificateOrderCertificateId has no segments")
	}
