...
The `topleveldomains` SDK allows for interaction with Azure Resource Manager `web` (API Version `2023-12-01`).
...
```go
ctx := context.TODO()
id := topleveldomains.NewTopLevelDomainID("12345678-1234-9876-4563-123456789012", "name")
