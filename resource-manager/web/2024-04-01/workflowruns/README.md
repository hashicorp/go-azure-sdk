...
## `github.com/hashicorp/go-azure-sdk/resource-manager/web/2024-04-01/workflowruns` Documentation

The `workflowruns` SDK allows for interaction with Azure Resource Manager `web` (API Version `2024-04-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/web/2024-04-01/workflowruns"
```
