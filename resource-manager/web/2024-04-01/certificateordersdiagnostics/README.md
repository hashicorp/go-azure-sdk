...
## `github.com/hashicorp/go-azure-sdk/resource-manager/web/2024-04-01/certificateordersdiagnostics` Documentation

The `certificateordersdiagnostics` SDK allows for interaction with Azure Resource Manager `web` (API Version `2024-04-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/web/2024-04-01/certificateordersdiagnostics"
```
...
```go
ctx := context.TODO()
id := certificateordersdiagnostics.NewCertificateOrderDetectorID("12345678-1234-9876-4563-123456789012", "example-resource-group", "certificateOrderName", "detectorName")
