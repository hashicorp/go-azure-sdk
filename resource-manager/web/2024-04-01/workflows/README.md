...
## `github.com/hashicorp/go-azure-sdk/resource-manager/web/2024-04-01/workflows` Documentation

The `workflows` SDK allows for interaction with Azure Resource Manager `web` (API Version `2024-04-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/web/2024-04-01/workflows"
```
