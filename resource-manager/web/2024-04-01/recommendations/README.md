...
## `github.com/hashicorp/go-azure-sdk/resource-manager/web/2024-04-01/recommendations` Documentation

The `recommendations` SDK allows for interaction with Azure Resource Manager `web` (API Version `2024-04-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/web/2024-04-01/recommendations"
```
