...
## `github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/appserviceplans` Documentation

The `appserviceplans` SDK allows for interaction with Azure Resource Manager `web` (API Version `2026-07-15`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/appserviceplans"
```
...
### Example Usage: `AppServicePlansClient.StartWebApps`

```go
ctx := context.TODO()
id := commonids.NewAppServicePlanID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverFarmName")

read, err := client.StartWebApps(ctx, id)
if err != nil {
	// handle the error
}
if model := read.Model; model != nil {
...
### Example Usage: `AppServicePlansClient.StopWebApps`

```go
ctx := context.TODO()
id := commonids.NewAppServicePlanID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverFarmName")

read, err := client.StopWebApps(ctx, id)
if err != nil {
	// handle the error
}
if model := read.Model; model != nil {
