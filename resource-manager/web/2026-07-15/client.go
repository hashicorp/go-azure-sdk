...
import (
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/aigateways"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/appserviceenvironments"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/appserviceplans"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/certificates"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/deletedwebapps"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/diagnostics"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/global"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/kubeenvironments"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/openapis"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/provider"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/recommendations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/resourcehealthmetadata"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/sitecertificates"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/staticsites"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/staticsitesasyncoperations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/webapps"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/workflowrunactions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/workflowruns"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/workflows"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/workflowtriggerhistories"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/workflowtriggers"
	"github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/workflowversions"
	"github.com/hashicorp/go-azure-sdk/sdk/client/resourcemanager"
	sdkEnv "github.com/hashicorp/go-azure-sdk/sdk/environments"
)

type Client struct {
	AiGateways                 *aigateways.AiGatewaysClient
	...
	StaticSitesAsyncOperations *staticsitesasyncoperations.StaticSitesAsyncOperationsClient
...
func NewClientWithBaseURI(sdkApi sdkEnv.Api, configureFunc func(c *resourcemanager.Client)) (*Client, error) {
	aiGatewaysClient, err := aigateways.NewAiGatewaysClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building AiGateways client: %+v", err)
	}
	configureFunc(aiGatewaysClient.Client)
	...
	staticSitesAsyncOperationsClient, err := staticsitesasyncoperations.NewStaticSitesAsyncOperationsClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building StaticSitesAsyncOperations client: %+v", err)
	}
	configureFunc(staticSitesAsyncOperationsClient.Client)
	...
	return &Client{
		...
		StaticSitesAsyncOperations: staticSitesAsyncOperationsClient,
