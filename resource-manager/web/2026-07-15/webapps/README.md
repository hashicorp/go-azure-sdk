...
## `github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/webapps` Documentation

The `webapps` SDK allows for interaction with Azure Resource Manager `web` (API Version `2026-07-15`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/webapps"
```
...
### Example Usage: `WebAppsClient.SitesGetNetworkSecurityPerimeterConfiguration`

```go
ctx := context.TODO()
id := webapps.NewNetworkSecurityPerimeterConfigurationID("12345678-1234-9876-4563-123456789012", "example-resource-group", "siteName", "networkSecurityPerimeterConfigurationName")

read, err := client.SitesGetNetworkSecurityPerimeterConfiguration(ctx, id)
if err != nil {
	// handle the error
}
if model := read.Model; model != nil {
...
### Example Usage: `WebAppsClient.SitesListNetworkSecurityPerimeterConfigurations`

```go
ctx := context.TODO()
id := commonids.NewAppServiceID("12345678-1234-9876-4563-123456789012", "example-resource-group", "siteName")

// alternatively `client.SitesListNetworkSecurityPerimeterConfigurations(ctx, id)` can be used to do batched pagination
items, err := client.SitesListNetworkSecurityPerimeterConfigurationsComplete(ctx, id)
if err != nil {
	// handle the error
}
for _, item := range items {
