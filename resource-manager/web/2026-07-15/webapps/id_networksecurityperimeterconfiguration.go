...
func NewNetworkSecurityPerimeterConfigurationID(subscriptionId string, resourceGroupName string, siteName string, networkSecurityPerimeterConfigurationName string) NetworkSecurityPerimeterConfigurationId {
...
func (id NetworkSecurityPerimeterConfigurationId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.Web/sites/%s/networkSecurityPerimeterConfigurations/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.SiteName, id.NetworkSecurityPerimeterConfigurationName)
}
