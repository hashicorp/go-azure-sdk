...
## `github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/workflows` Documentation

The `workflows` SDK allows for interaction with Azure Resource Manager `web` (API Version `2026-07-15`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/workflows"
```
