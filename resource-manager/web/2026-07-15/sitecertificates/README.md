...
## `github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/sitecertificates` Documentation

The `sitecertificates` SDK allows for interaction with Azure Resource Manager `web` (API Version `2026-07-15`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/sitecertificates"
```
