...
## `github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/diagnostics` Documentation

The `diagnostics` SDK allows for interaction with Azure Resource Manager `web` (API Version `2026-07-15`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/web/2026-07-15/diagnostics"
```
