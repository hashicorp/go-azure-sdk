...
func (c OpenapisClient) RegionalCheckNameAvailability(ctx context.Context, id ProviderLocationId, input DnlResourceNameAvailabilityRequest) (result RegionalCheckNameAvailabilityOperationResponse, err error) {
