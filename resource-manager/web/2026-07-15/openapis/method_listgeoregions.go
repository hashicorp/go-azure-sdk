...
func (o ListGeoRegionsOperationOptions) ToQuery() *client.QueryParams {
	...
	if o.CustomModeWorkersEnabled != nil {
		out.Append("customModeWorkersEnabled", fmt.Sprintf("%v", *o.CustomModeWorkersEnabled))
	}
...
// ListGeoRegions ...
func (c OpenapisClient) ListGeoRegions(ctx context.Context, id commonids.SubscriptionId, options ListGeoRegionsOperationOptions) (result ListGeoRegionsOperationResponse, err error) {
...
func (c OpenapisClient) ListGeoRegionsComplete(ctx context.Context, id commonids.SubscriptionId, options ListGeoRegionsOperationOptions) (ListGeoRegionsCompleteResult, error) {
...
func (c OpenapisClient) ListGeoRegionsCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, options ListGeoRegionsOperationOptions, predicate GeoRegionOperationPredicate) (result ListGeoRegionsCompleteResult, err error) {
