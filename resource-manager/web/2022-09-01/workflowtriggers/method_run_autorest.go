...
func (c WorkflowTriggersClient) Run(ctx context.Context, id TriggerId) (result RunOperationResponse, err error) {
	...
	result, err = c.senderForRun(ctx, req)
	if err != nil {
...
// senderForRun sends the Run request. The method will close the
// http.Response Body if it receives an error.
func (c WorkflowTriggersClient) senderForRun(ctx context.Context, req *http.Request) (future RunOperationResponse, err error) {
