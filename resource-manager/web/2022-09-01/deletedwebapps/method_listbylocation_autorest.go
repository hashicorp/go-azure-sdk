...
func (c DeletedWebAppsClient) ListByLocation(ctx context.Context, id ProviderLocationId) (resp ListByLocationOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "deletedwebapps.DeletedWebAppsClient", "ListByLocation", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "deletedwebapps.DeletedWebAppsClient", "ListByLocation", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByLocation(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "deletedwebapps.DeletedWebAppsClient", "ListByLocation", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c DeletedWebAppsClient) preparerForListByLocation(ctx context.Context, id ProviderLocationId) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/deletedSites", id.ID())),
...
func (c DeletedWebAppsClient) preparerForListByLocationWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c DeletedWebAppsClient) responderForListByLocation(resp *http.Response) (result ListByLocationOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByLocationOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "deletedwebapps.DeletedWebAppsClient", "ListByLocation", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByLocation(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "deletedwebapps.DeletedWebAppsClient", "ListByLocation", result.HttpResponse, "Failure responding to request")
				return
			}
