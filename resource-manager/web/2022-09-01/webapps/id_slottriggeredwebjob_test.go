...
func TestNewSlotTriggeredWebJobID(t *testing.T) {
	id := NewSlotTriggeredWebJobID("12345678-1234-9876-4563-123456789012", "example-resource-group", "siteValue", "slotValue", "triggeredWebJobValue")
...
func TestFormatSlotTriggeredWebJobID(t *testing.T) {
	actual := NewSlotTriggeredWebJobID("12345678-1234-9876-4563-123456789012", "example-resource-group", "siteValue", "slotValue", "triggeredWebJobValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Web/sites/siteValue/slots/slotValue/triggeredWebJobs/triggeredWebJobValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseSlotTriggeredWebJobID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *SlotTriggeredWebJobId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Web/sites/siteValue/slots/slotValue/triggeredWebJobs/triggeredWebJobValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseSlotTriggeredWebJobID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseSlotTriggeredWebJobIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *SlotTriggeredWebJobId
	...
	for _, v := range testData {
		...
		actual, err := ParseSlotTriggeredWebJobIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForSlotTriggeredWebJobId(t *testing.T) {
	segments := SlotTriggeredWebJobId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("SlotTriggeredWebJobId has no segments")
	}
