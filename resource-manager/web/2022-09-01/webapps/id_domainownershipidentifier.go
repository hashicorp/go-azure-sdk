...
func ParseDomainOwnershipIdentifierID(input string) (*DomainOwnershipIdentifierId, error) {
	...
	if id.DomainOwnershipIdentifierName, ok = parsed.Parsed["domainOwnershipIdentifierName"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "domainOwnershipIdentifierName", *parsed)
	}
