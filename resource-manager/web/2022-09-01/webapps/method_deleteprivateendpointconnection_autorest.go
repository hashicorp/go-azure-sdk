...
func (c WebAppsClient) DeletePrivateEndpointConnection(ctx context.Context, id PrivateEndpointConnectionId) (result DeletePrivateEndpointConnectionOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "webapps.WebAppsClient", "DeletePrivateEndpointConnection", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDeletePrivateEndpointConnection(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "webapps.WebAppsClient", "DeletePrivateEndpointConnection", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c WebAppsClient) preparerForDeletePrivateEndpointConnection(ctx context.Context, id PrivateEndpointConnectionId) (*http.Request, error) {
...
func (c WebAppsClient) senderForDeletePrivateEndpointConnection(ctx context.Context, req *http.Request) (future DeletePrivateEndpointConnectionOperationResponse, err error) {
