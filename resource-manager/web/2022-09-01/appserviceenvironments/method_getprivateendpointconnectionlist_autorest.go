...
func (c AppServiceEnvironmentsClient) GetPrivateEndpointConnectionList(ctx context.Context, id HostingEnvironmentId) (resp GetPrivateEndpointConnectionListOperationResponse, err error) {
	req, err := c.preparerForGetPrivateEndpointConnectionList(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appserviceenvironments.AppServiceEnvironmentsClient", "GetPrivateEndpointConnectionList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "appserviceenvironments.AppServiceEnvironmentsClient", "GetPrivateEndpointConnectionList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForGetPrivateEndpointConnectionList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appserviceenvironments.AppServiceEnvironmentsClient", "GetPrivateEndpointConnectionList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c AppServiceEnvironmentsClient) preparerForGetPrivateEndpointConnectionList(ctx context.Context, id HostingEnvironmentId) (*http.Request, error) {
...
func (c AppServiceEnvironmentsClient) preparerForGetPrivateEndpointConnectionListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c AppServiceEnvironmentsClient) responderForGetPrivateEndpointConnectionList(resp *http.Response) (result GetPrivateEndpointConnectionListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result GetPrivateEndpointConnectionListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "appserviceenvironments.AppServiceEnvironmentsClient", "GetPrivateEndpointConnectionList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForGetPrivateEndpointConnectionList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "appserviceenvironments.AppServiceEnvironmentsClient", "GetPrivateEndpointConnectionList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c AppServiceEnvironmentsClient) GetPrivateEndpointConnectionListCompleteMatchingPredicate(ctx context.Context, id HostingEnvironmentId, predicate RemotePrivateEndpointConnectionARMResourceOperationPredicate) (resp GetPrivateEndpointConnectionListCompleteResult, err error) {
