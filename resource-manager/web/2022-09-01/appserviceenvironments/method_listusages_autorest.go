...
// ListUsages ...
func (c AppServiceEnvironmentsClient) ListUsages(ctx context.Context, id HostingEnvironmentId, options ListUsagesOperationOptions) (resp ListUsagesOperationResponse, err error) {
	req, err := c.preparerForListUsages(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appserviceenvironments.AppServiceEnvironmentsClient", "ListUsages", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "appserviceenvironments.AppServiceEnvironmentsClient", "ListUsages", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListUsages(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appserviceenvironments.AppServiceEnvironmentsClient", "ListUsages", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c AppServiceEnvironmentsClient) preparerForListUsages(ctx context.Context, id HostingEnvironmentId, options ListUsagesOperationOptions) (*http.Request, error) {
...
func (c AppServiceEnvironmentsClient) preparerForListUsagesWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c AppServiceEnvironmentsClient) responderForListUsages(resp *http.Response) (result ListUsagesOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListUsagesOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "appserviceenvironments.AppServiceEnvironmentsClient", "ListUsages", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListUsages(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "appserviceenvironments.AppServiceEnvironmentsClient", "ListUsages", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c AppServiceEnvironmentsClient) ListUsagesCompleteMatchingPredicate(ctx context.Context, id HostingEnvironmentId, options ListUsagesOperationOptions, predicate CsmUsageQuotaOperationPredicate) (resp ListUsagesCompleteResult, err error) {
