...
func (c AppServiceEnvironmentsClient) DeletePrivateEndpointConnection(ctx context.Context, id HostingEnvironmentPrivateEndpointConnectionId) (result DeletePrivateEndpointConnectionOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "appserviceenvironments.AppServiceEnvironmentsClient", "DeletePrivateEndpointConnection", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDeletePrivateEndpointConnection(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appserviceenvironments.AppServiceEnvironmentsClient", "DeletePrivateEndpointConnection", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c AppServiceEnvironmentsClient) preparerForDeletePrivateEndpointConnection(ctx context.Context, id HostingEnvironmentPrivateEndpointConnectionId) (*http.Request, error) {
...
func (c AppServiceEnvironmentsClient) senderForDeletePrivateEndpointConnection(ctx context.Context, req *http.Request) (future DeletePrivateEndpointConnectionOperationResponse, err error) {
