...
func (c AppServiceEnvironmentsClient) ApproveOrRejectPrivateEndpointConnection(ctx context.Context, id HostingEnvironmentPrivateEndpointConnectionId, input PrivateLinkConnectionApprovalRequestResource) (result ApproveOrRejectPrivateEndpointConnectionOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "appserviceenvironments.AppServiceEnvironmentsClient", "ApproveOrRejectPrivateEndpointConnection", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForApproveOrRejectPrivateEndpointConnection(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appserviceenvironments.AppServiceEnvironmentsClient", "ApproveOrRejectPrivateEndpointConnection", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c AppServiceEnvironmentsClient) preparerForApproveOrRejectPrivateEndpointConnection(ctx context.Context, id HostingEnvironmentPrivateEndpointConnectionId, input PrivateLinkConnectionApprovalRequestResource) (*http.Request, error) {
...
func (c AppServiceEnvironmentsClient) senderForApproveOrRejectPrivateEndpointConnection(ctx context.Context, req *http.Request) (future ApproveOrRejectPrivateEndpointConnectionOperationResponse, err error) {
