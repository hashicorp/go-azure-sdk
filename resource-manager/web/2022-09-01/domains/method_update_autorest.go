...
func (c DomainsClient) Update(ctx context.Context, id DomainId, input DomainPatchResource) (result UpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "domains.DomainsClient", "Update", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c DomainsClient) preparerForUpdate(ctx context.Context, id DomainId, input DomainPatchResource) (*http.Request, error) {
...
func (c DomainsClient) responderForUpdate(resp *http.Response) (result UpdateOperationResponse, err error) {
