...
func TestNewDomainOwnershipIdentifierID(t *testing.T) {
	id := NewDomainOwnershipIdentifierID("12345678-1234-9876-4563-123456789012", "example-resource-group", "domainName", "domainOwnershipIdentifierName")
...
func TestFormatDomainOwnershipIdentifierID(t *testing.T) {
	actual := NewDomainOwnershipIdentifierID("12345678-1234-9876-4563-123456789012", "example-resource-group", "domainName", "domainOwnershipIdentifierName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DomainRegistration/domains/domainName/domainOwnershipIdentifiers/domainOwnershipIdentifierName"
	if actual != expected {
...
func TestParseDomainOwnershipIdentifierID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DomainRegistration/domains/domainName",
			Error: true,
		},
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DomainRegistration/domains/domainName/domainOwnershipIdentifiers",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DomainRegistration/domains/domainName/domainOwnershipIdentifiers/domainOwnershipIdentifierName",
			Expected: &DomainOwnershipIdentifierId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DomainRegistration/domains/domainName/domainOwnershipIdentifiers/domainOwnershipIdentifierName/extra",
			Error: true,
		},
	}
