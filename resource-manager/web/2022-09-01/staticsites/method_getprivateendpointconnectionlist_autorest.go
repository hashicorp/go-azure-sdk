...
func (c StaticSitesClient) GetPrivateEndpointConnectionList(ctx context.Context, id StaticSiteId) (resp GetPrivateEndpointConnectionListOperationResponse, err error) {
	req, err := c.preparerForGetPrivateEndpointConnectionList(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "staticsites.StaticSitesClient", "GetPrivateEndpointConnectionList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "staticsites.StaticSitesClient", "GetPrivateEndpointConnectionList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForGetPrivateEndpointConnectionList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "staticsites.StaticSitesClient", "GetPrivateEndpointConnectionList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c StaticSitesClient) preparerForGetPrivateEndpointConnectionList(ctx context.Context, id StaticSiteId) (*http.Request, error) {
...
func (c StaticSitesClient) preparerForGetPrivateEndpointConnectionListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c StaticSitesClient) responderForGetPrivateEndpointConnectionList(resp *http.Response) (result GetPrivateEndpointConnectionListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result GetPrivateEndpointConnectionListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "staticsites.StaticSitesClient", "GetPrivateEndpointConnectionList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForGetPrivateEndpointConnectionList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "staticsites.StaticSitesClient", "GetPrivateEndpointConnectionList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c StaticSitesClient) GetPrivateEndpointConnectionListCompleteMatchingPredicate(ctx context.Context, id StaticSiteId, predicate RemotePrivateEndpointConnectionARMResourceOperationPredicate) (resp GetPrivateEndpointConnectionListCompleteResult, err error) {
