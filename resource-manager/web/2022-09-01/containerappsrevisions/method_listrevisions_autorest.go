...
// ListRevisions ...
func (c ContainerAppsRevisionsClient) ListRevisions(ctx context.Context, id ProviderContainerAppId) (resp ListRevisionsOperationResponse, err error) {
	req, err := c.preparerForListRevisions(ctx, id)
	if err != nil {
...
func (c ContainerAppsRevisionsClient) preparerForListRevisions(ctx context.Context, id ProviderContainerAppId) (*http.Request, error) {
...
func (c ContainerAppsRevisionsClient) ListRevisionsCompleteMatchingPredicate(ctx context.Context, id ProviderContainerAppId, predicate RevisionOperationPredicate) (resp ListRevisionsCompleteResult, err error) {
	items := make([]Revision, 0)

	page, err := c.ListRevisions(ctx, id)
	if err != nil {
