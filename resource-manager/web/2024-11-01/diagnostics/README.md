...
## `github.com/hashicorp/go-azure-sdk/resource-manager/web/2024-11-01/diagnostics` Documentation

The `diagnostics` SDK allows for interaction with Azure Resource Manager `web` (API Version `2024-11-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/web/2024-11-01/diagnostics"
```
