...
## `github.com/hashicorp/go-azure-sdk/resource-manager/web/2024-11-01/global` Documentation

The `global` SDK allows for interaction with Azure Resource Manager `web` (API Version `2024-11-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/web/2024-11-01/global"
```
