...
func (c PrivateLinkForAzureAdClient) CreateCallbackThenPoll(ctx context.Context, id PrivateLinkForAzureAdId, input PrivateLinkPolicy, callback func() error) error {
