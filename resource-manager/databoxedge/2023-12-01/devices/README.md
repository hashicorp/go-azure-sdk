...
## `github.com/hashicorp/go-azure-sdk/resource-manager/databoxedge/2023-12-01/devices` Documentation

The `devices` SDK allows for interaction with the Azure Resource Manager Service `databoxedge` (API Version `2023-12-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/databoxedge/2023-12-01/devices"
```
