...
type SupportPackagesTriggerSupportPackageOperationResponse struct {
	Poller       pollers.Poller
	HttpResponse *http.Response
	OData        *odata.OData
}

// SupportPackagesTriggerSupportPackage ...
func (c DataBoxEdgeDevicesClient) SupportPackagesTriggerSupportPackage(ctx context.Context, id DataBoxEdgeDeviceId, input TriggerSupportPackageRequest) (result SupportPackagesTriggerSupportPackageOperationResponse, err error) {
...
func (c DataBoxEdgeDevicesClient) SupportPackagesTriggerSupportPackageThenPoll(ctx context.Context, id DataBoxEdgeDeviceId, input TriggerSupportPackageRequest) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after SupportPackagesTriggerSupportPackage: %+v", err)
	}
