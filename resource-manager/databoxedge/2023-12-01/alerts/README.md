...
## `github.com/hashicorp/go-azure-sdk/resource-manager/databoxedge/2023-12-01/alerts` Documentation

The `alerts` SDK allows for interaction with the Azure Resource Manager Service `databoxedge` (API Version `2023-12-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/databoxedge/2023-12-01/alerts"
```
