...
func (c StorageAccountCredentialsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id StorageAccountCredentialId, input StorageAccountCredential, callback func() error) error {
