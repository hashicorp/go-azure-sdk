...
type MonitoringConfigCreateOrUpdateOperationResponse struct {
...
func (c MonitoringMetricConfigurationsClient) MonitoringConfigCreateOrUpdate(ctx context.Context, id RoleId, input MonitoringMetricConfiguration) (result MonitoringConfigCreateOrUpdateOperationResponse, err error) {
...
func (c MonitoringMetricConfigurationsClient) MonitoringConfigCreateOrUpdateThenPoll(ctx context.Context, id RoleId, input MonitoringMetricConfiguration) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after MonitoringConfigCreateOrUpdate: %+v", err)
	}
