...
## `github.com/hashicorp/go-azure-sdk/resource-manager/databoxedge/2023-07-01/orders` Documentation

The `orders` SDK allows for interaction with Azure Resource Manager `databoxedge` (API Version `2023-07-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/databoxedge/2023-07-01/orders"
```
