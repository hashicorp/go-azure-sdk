...
The `monitoringconfig` SDK allows for interaction with Azure Resource Manager `databoxedge` (API Version `2023-07-01`).
...
```go
ctx := context.TODO()
id := monitoringconfig.NewRoleID("12345678-1234-9876-4563-123456789012", "example-resource-group", "dataBoxEdgeDeviceName", "roleName")
