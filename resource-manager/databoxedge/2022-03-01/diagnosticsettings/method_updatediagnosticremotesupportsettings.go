...
func (c DiagnosticSettingsClient) UpdateDiagnosticRemoteSupportSettingsThenPoll(ctx context.Context, id DataBoxEdgeDeviceId, input DiagnosticRemoteSupportSettings) error {
	return c.UpdateDiagnosticRemoteSupportSettingsCallbackThenPoll(ctx, id, input, nil)
}

// UpdateDiagnosticRemoteSupportSettingsCallbackThenPoll performs UpdateDiagnosticRemoteSupportSettings, runs the optional callback function, then polls until it's completed
func (c DiagnosticSettingsClient) UpdateDiagnosticRemoteSupportSettingsCallbackThenPoll(ctx context.Context, id DataBoxEdgeDeviceId, input DiagnosticRemoteSupportSettings, callback func() error) error {
