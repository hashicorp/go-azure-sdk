...
func (c BandwidthSchedulesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id BandwidthScheduleId, input BandwidthSchedule, callback func() error) error {
