...
func (c MonitoringConfigClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id RoleId, input MonitoringMetricConfiguration, callback func() error) error {
