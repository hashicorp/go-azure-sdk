...
## `github.com/hashicorp/go-azure-sdk/resource-manager/databoxedge/2020-12-01/nodes` Documentation

The `nodes` SDK allows for interaction with the Azure Resource Manager Service `databoxedge` (API Version `2020-12-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/databoxedge/2020-12-01/nodes"
```
