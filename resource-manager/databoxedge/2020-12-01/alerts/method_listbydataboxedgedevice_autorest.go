...
func (c AlertsClient) ListByDataBoxEdgeDevice(ctx context.Context, id DataBoxEdgeDeviceId) (resp ListByDataBoxEdgeDeviceOperationResponse, err error) {
	req, err := c.preparerForListByDataBoxEdgeDevice(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "alerts.AlertsClient", "ListByDataBoxEdgeDevice", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "alerts.AlertsClient", "ListByDataBoxEdgeDevice", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByDataBoxEdgeDevice(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "alerts.AlertsClient", "ListByDataBoxEdgeDevice", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c AlertsClient) preparerForListByDataBoxEdgeDevice(ctx context.Context, id DataBoxEdgeDeviceId) (*http.Request, error) {
...
func (c AlertsClient) preparerForListByDataBoxEdgeDeviceWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c AlertsClient) responderForListByDataBoxEdgeDevice(resp *http.Response) (result ListByDataBoxEdgeDeviceOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByDataBoxEdgeDeviceOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "alerts.AlertsClient", "ListByDataBoxEdgeDevice", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByDataBoxEdgeDevice(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "alerts.AlertsClient", "ListByDataBoxEdgeDevice", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c AlertsClient) ListByDataBoxEdgeDeviceCompleteMatchingPredicate(ctx context.Context, id DataBoxEdgeDeviceId, predicate AlertOperationPredicate) (resp ListByDataBoxEdgeDeviceCompleteResult, err error) {
	items := make([]Alert, 0)
