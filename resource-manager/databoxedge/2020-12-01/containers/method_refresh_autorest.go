...
func (c ContainersClient) Refresh(ctx context.Context, id ContainerId) (result RefreshOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "containers.ContainersClient", "Refresh", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForRefresh(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "containers.ContainersClient", "Refresh", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ContainersClient) preparerForRefresh(ctx context.Context, id ContainerId) (*http.Request, error) {
...
func (c ContainersClient) senderForRefresh(ctx context.Context, req *http.Request) (future RefreshOperationResponse, err error) {
