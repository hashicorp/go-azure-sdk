...
func (c UsersClient) ListByDataBoxEdgeDevice(ctx context.Context, id DataBoxEdgeDeviceId, options ListByDataBoxEdgeDeviceOperationOptions) (resp ListByDataBoxEdgeDeviceOperationResponse, err error) {
	req, err := c.preparerForListByDataBoxEdgeDevice(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "users.UsersClient", "ListByDataBoxEdgeDevice", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "users.UsersClient", "ListByDataBoxEdgeDevice", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByDataBoxEdgeDevice(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "users.UsersClient", "ListByDataBoxEdgeDevice", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c UsersClient) preparerForListByDataBoxEdgeDevice(ctx context.Context, id DataBoxEdgeDeviceId, options ListByDataBoxEdgeDeviceOperationOptions) (*http.Request, error) {
...
func (c UsersClient) preparerForListByDataBoxEdgeDeviceWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c UsersClient) responderForListByDataBoxEdgeDevice(resp *http.Response) (result ListByDataBoxEdgeDeviceOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByDataBoxEdgeDeviceOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "users.UsersClient", "ListByDataBoxEdgeDevice", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByDataBoxEdgeDevice(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "users.UsersClient", "ListByDataBoxEdgeDevice", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c UsersClient) ListByDataBoxEdgeDeviceCompleteMatchingPredicate(ctx context.Context, id DataBoxEdgeDeviceId, options ListByDataBoxEdgeDeviceOperationOptions, predicate UserOperationPredicate) (resp ListByDataBoxEdgeDeviceCompleteResult, err error) {
	items := make([]User, 0)
