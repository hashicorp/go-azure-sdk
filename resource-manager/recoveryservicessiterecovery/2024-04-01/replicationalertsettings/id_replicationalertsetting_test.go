...
func TestNewReplicationAlertSettingID(t *testing.T) {
	...
	if id.ReplicationAlertSettingName != "replicationAlertSettingName" {
		t.Fatalf("Expected %q but got %q for Segment 'ReplicationAlertSettingName'", id.ReplicationAlertSettingName, "replicationAlertSettingName")
	}
}

func TestFormatReplicationAlertSettingID(t *testing.T) {
	actual := NewReplicationAlertSettingID("12345678-1234-9876-4563-123456789012", "example-resource-group", "vaultName", "replicationAlertSettingName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/vaultName/replicationAlertSettings/replicationAlertSettingName"
	if actual != expected {
...
func TestParseReplicationAlertSettingID(t *testing.T) {
	testData := []struct {
		...
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/vaultName/replicationAlertSettings/replicationAlertSettingName",
			Expected: &ReplicationAlertSettingId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/vaultName/replicationAlertSettings/replicationAlertSettingName/extra",
			Error: true,
		},
	}
