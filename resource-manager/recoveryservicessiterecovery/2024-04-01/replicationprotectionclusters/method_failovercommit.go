...
func (c ReplicationProtectionClustersClient) FailoverCommitCallbackThenPoll(ctx context.Context, id ReplicationProtectionClusterId, callback func() error) error {
