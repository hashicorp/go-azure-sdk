...
func (c ReplicationProtectionClustersClient) CreateCallbackThenPoll(ctx context.Context, id ReplicationProtectionClusterId, input ReplicationProtectionCluster, callback func() error) error {
