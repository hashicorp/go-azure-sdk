...
func (c ReplicationMigrationItemsClient) Migrate(ctx context.Context, id ReplicationMigrationItemId, input MigrateInput) (result MigrateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationmigrationitems.ReplicationMigrationItemsClient", "Migrate", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForMigrate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationmigrationitems.ReplicationMigrationItemsClient", "Migrate", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationMigrationItemsClient) preparerForMigrate(ctx context.Context, id ReplicationMigrationItemId, input MigrateInput) (*http.Request, error) {
...
func (c ReplicationMigrationItemsClient) senderForMigrate(ctx context.Context, req *http.Request) (future MigrateOperationResponse, err error) {
