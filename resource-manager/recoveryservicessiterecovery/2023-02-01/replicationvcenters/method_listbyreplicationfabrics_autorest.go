...
func (c ReplicationvCentersClient) ListByReplicationFabrics(ctx context.Context, id ReplicationFabricId) (resp ListByReplicationFabricsOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationvcenters.ReplicationvCentersClient", "ListByReplicationFabrics", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationvcenters.ReplicationvCentersClient", "ListByReplicationFabrics", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByReplicationFabrics(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationvcenters.ReplicationvCentersClient", "ListByReplicationFabrics", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ReplicationvCentersClient) preparerForListByReplicationFabrics(ctx context.Context, id ReplicationFabricId) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/replicationvCenters", id.ID())),
...
func (c ReplicationvCentersClient) preparerForListByReplicationFabricsWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ReplicationvCentersClient) responderForListByReplicationFabrics(resp *http.Response) (result ListByReplicationFabricsOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByReplicationFabricsOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "replicationvcenters.ReplicationvCentersClient", "ListByReplicationFabrics", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByReplicationFabrics(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "replicationvcenters.ReplicationvCentersClient", "ListByReplicationFabrics", result.HttpResponse, "Failure responding to request")
				return
			}
