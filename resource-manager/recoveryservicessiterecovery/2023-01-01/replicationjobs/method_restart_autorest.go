...
func (c ReplicationJobsClient) Restart(ctx context.Context, id ReplicationJobId) (result RestartOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationjobs.ReplicationJobsClient", "Restart", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForRestart(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationjobs.ReplicationJobsClient", "Restart", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationJobsClient) preparerForRestart(ctx context.Context, id ReplicationJobId) (*http.Request, error) {
...
func (c ReplicationJobsClient) senderForRestart(ctx context.Context, req *http.Request) (future RestartOperationResponse, err error) {
