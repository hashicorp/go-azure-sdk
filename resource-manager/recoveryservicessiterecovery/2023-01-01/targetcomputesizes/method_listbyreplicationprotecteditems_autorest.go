...
func (c TargetComputeSizesClient) ListByReplicationProtectedItems(ctx context.Context, id ReplicationProtectedItemId) (resp ListByReplicationProtectedItemsOperationResponse, err error) {
	req, err := c.preparerForListByReplicationProtectedItems(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "targetcomputesizes.TargetComputeSizesClient", "ListByReplicationProtectedItems", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "targetcomputesizes.TargetComputeSizesClient", "ListByReplicationProtectedItems", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByReplicationProtectedItems(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "targetcomputesizes.TargetComputeSizesClient", "ListByReplicationProtectedItems", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c TargetComputeSizesClient) preparerForListByReplicationProtectedItems(ctx context.Context, id ReplicationProtectedItemId) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/targetComputeSizes", id.ID())),
...
func (c TargetComputeSizesClient) preparerForListByReplicationProtectedItemsWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c TargetComputeSizesClient) responderForListByReplicationProtectedItems(resp *http.Response) (result ListByReplicationProtectedItemsOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByReplicationProtectedItemsOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "targetcomputesizes.TargetComputeSizesClient", "ListByReplicationProtectedItems", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByReplicationProtectedItems(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "targetcomputesizes.TargetComputeSizesClient", "ListByReplicationProtectedItems", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c TargetComputeSizesClient) ListByReplicationProtectedItemsCompleteMatchingPredicate(ctx context.Context, id ReplicationProtectedItemId, predicate TargetComputeSizeOperationPredicate) (resp ListByReplicationProtectedItemsCompleteResult, err error) {
