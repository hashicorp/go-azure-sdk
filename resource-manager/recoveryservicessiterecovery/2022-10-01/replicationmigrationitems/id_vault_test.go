...
func TestNewVaultID(t *testing.T) {
	id := NewVaultID("12345678-1234-9876-4563-123456789012", "example-resource-group", "resourceValue")
...
func TestFormatVaultID(t *testing.T) {
	actual := NewVaultID("12345678-1234-9876-4563-123456789012", "example-resource-group", "resourceValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/resourceValue"
	if actual != expected {
...
func TestParseVaultID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/resourceValue/extra",
			Error: true,
		},
	}
...
func TestSegmentsForVaultId(t *testing.T) {
	segments := VaultId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("VaultId has no segments")
	}
