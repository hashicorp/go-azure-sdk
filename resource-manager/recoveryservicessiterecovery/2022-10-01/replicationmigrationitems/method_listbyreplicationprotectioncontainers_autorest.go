...
func (c ReplicationMigrationItemsClient) ListByReplicationProtectionContainers(ctx context.Context, id ReplicationProtectionContainerId, options ListByReplicationProtectionContainersOperationOptions) (resp ListByReplicationProtectionContainersOperationResponse, err error) {
	req, err := c.preparerForListByReplicationProtectionContainers(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationmigrationitems.ReplicationMigrationItemsClient", "ListByReplicationProtectionContainers", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationmigrationitems.ReplicationMigrationItemsClient", "ListByReplicationProtectionContainers", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByReplicationProtectionContainers(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationmigrationitems.ReplicationMigrationItemsClient", "ListByReplicationProtectionContainers", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ReplicationMigrationItemsClient) preparerForListByReplicationProtectionContainers(ctx context.Context, id ReplicationProtectionContainerId, options ListByReplicationProtectionContainersOperationOptions) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/replicationMigrationItems", id.ID())),
...
func (c ReplicationMigrationItemsClient) preparerForListByReplicationProtectionContainersWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ReplicationMigrationItemsClient) responderForListByReplicationProtectionContainers(resp *http.Response) (result ListByReplicationProtectionContainersOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByReplicationProtectionContainersOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "replicationmigrationitems.ReplicationMigrationItemsClient", "ListByReplicationProtectionContainers", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByReplicationProtectionContainers(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "replicationmigrationitems.ReplicationMigrationItemsClient", "ListByReplicationProtectionContainers", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c ReplicationMigrationItemsClient) ListByReplicationProtectionContainersCompleteMatchingPredicate(ctx context.Context, id ReplicationProtectionContainerId, options ListByReplicationProtectionContainersOperationOptions, predicate MigrationItemOperationPredicate) (resp ListByReplicationProtectionContainersCompleteResult, err error) {
