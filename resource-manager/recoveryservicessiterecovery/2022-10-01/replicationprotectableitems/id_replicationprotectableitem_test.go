...
func TestNewReplicationProtectableItemID(t *testing.T) {
	id := NewReplicationProtectableItemID("12345678-1234-9876-4563-123456789012", "example-resource-group", "vaultValue", "replicationFabricValue", "replicationProtectionContainerValue", "replicationProtectableItemValue")
	...
	if id.ReplicationProtectableItemName != "replicationProtectableItemValue" {
		t.Fatalf("Expected %q but got %q for Segment 'ReplicationProtectableItemName'", id.ReplicationProtectableItemName, "replicationProtectableItemValue")
	}
}

func TestFormatReplicationProtectableItemID(t *testing.T) {
	actual := NewReplicationProtectableItemID("12345678-1234-9876-4563-123456789012", "example-resource-group", "vaultValue", "replicationFabricValue", "replicationProtectionContainerValue", "replicationProtectableItemValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/vaultValue/replicationFabrics/replicationFabricValue/replicationProtectionContainers/replicationProtectionContainerValue/replicationProtectableItems/replicationProtectableItemValue"
	if actual != expected {
...
func TestParseReplicationProtectableItemID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/vaultValue/replicationFabrics/replicationFabricValue/replicationProtectionContainers/replicationProtectionContainerValue/replicationProtectableItems",
			Error: true,
		},
		{
			// Valid URI
			...
			Expected: &ReplicationProtectableItemId{
				...
				ReplicationProtectableItemName:     "replicationProtectableItemValue",
			},
		},
		{
