...
func init() {
	recaser.RegisterResourceId(&ReplicationProtectableItemId{})
}
...
func (id *ReplicationProtectableItemId) FromParseResult(input resourceids.ParseResult) error {
	...
	if id.ReplicationProtectableItemName, ok = input.Parsed["replicationProtectableItemName"]; !ok {
		return resourceids.NewSegmentNotSpecifiedError(id, "replicationProtectableItemName", input)
	}
...
func (id ReplicationProtectableItemId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("replicationProtectableItemName", "replicationProtectableItemName"),
	}
}
