...
func (o DeleteOperationOptions) toQueryString() map[string]interface{} {
	...
	if o.DeleteOption != nil {
		out["deleteOption"] = *o.DeleteOption
	}
...
func (c ReplicationMigrationItemsClient) Delete(ctx context.Context, id ReplicationMigrationItemId, options DeleteOperationOptions) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationmigrationitems.ReplicationMigrationItemsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationmigrationitems.ReplicationMigrationItemsClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationMigrationItemsClient) preparerForDelete(ctx context.Context, id ReplicationMigrationItemId, options DeleteOperationOptions) (*http.Request, error) {
...
func (c ReplicationMigrationItemsClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
