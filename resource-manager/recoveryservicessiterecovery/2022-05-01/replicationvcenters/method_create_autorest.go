...
func (c ReplicationvCentersClient) Create(ctx context.Context, id ReplicationvCenterId, input AddVCenterRequest) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationvcenters.ReplicationvCentersClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationvcenters.ReplicationvCentersClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationvCentersClient) preparerForCreate(ctx context.Context, id ReplicationvCenterId, input AddVCenterRequest) (*http.Request, error) {
...
func (c ReplicationvCentersClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
