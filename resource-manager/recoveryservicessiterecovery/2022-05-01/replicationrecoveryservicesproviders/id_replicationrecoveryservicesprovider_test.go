...
func TestNewReplicationRecoveryServicesProviderID(t *testing.T) {
	id := NewReplicationRecoveryServicesProviderID("12345678-1234-9876-4563-123456789012", "example-resource-group", "resourceValue", "fabricValue", "providerValue")
...
func TestFormatReplicationRecoveryServicesProviderID(t *testing.T) {
	actual := NewReplicationRecoveryServicesProviderID("12345678-1234-9876-4563-123456789012", "example-resource-group", "resourceValue", "fabricValue", "providerValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/resourceValue/replicationFabrics/fabricValue/replicationRecoveryServicesProviders/providerValue"
	if actual != expected {
...
func TestParseReplicationRecoveryServicesProviderID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/resourceValue/replicationFabrics/fabricValue/replicationRecoveryServicesProviders",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/resourceValue/replicationFabrics/fabricValue/replicationRecoveryServicesProviders/providerValue",
			Expected: &ReplicationRecoveryServicesProviderId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/resourceValue/replicationFabrics/fabricValue/replicationRecoveryServicesProviders/providerValue/extra",
			Error: true,
		},
	}
