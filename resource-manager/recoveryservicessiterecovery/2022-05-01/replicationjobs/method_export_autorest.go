...
func (c ReplicationJobsClient) Export(ctx context.Context, id VaultId, input JobQueryParameter) (result ExportOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationjobs.ReplicationJobsClient", "Export", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForExport(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationjobs.ReplicationJobsClient", "Export", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationJobsClient) preparerForExport(ctx context.Context, id VaultId, input JobQueryParameter) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/replicationJobs/export", id.ID())),
...
func (c ReplicationJobsClient) senderForExport(ctx context.Context, req *http.Request) (future ExportOperationResponse, err error) {
