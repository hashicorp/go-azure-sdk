...
func TestNewReplicationStorageClassificationID(t *testing.T) {
	id := NewReplicationStorageClassificationID("12345678-1234-9876-4563-123456789012", "example-resource-group", "vaultValue", "replicationFabricValue", "replicationStorageClassificationValue")
...
func TestFormatReplicationStorageClassificationID(t *testing.T) {
	actual := NewReplicationStorageClassificationID("12345678-1234-9876-4563-123456789012", "example-resource-group", "vaultValue", "replicationFabricValue", "replicationStorageClassificationValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/vaultValue/replicationFabrics/replicationFabricValue/replicationStorageClassifications/replicationStorageClassificationValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseReplicationStorageClassificationID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ReplicationStorageClassificationId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.RecoveryServices/vaults/vaultValue/replicationFabrics/replicationFabricValue/replicationStorageClassifications/replicationStorageClassificationValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseReplicationStorageClassificationID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseReplicationStorageClassificationIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ReplicationStorageClassificationId
	...
	for _, v := range testData {
		...
		actual, err := ParseReplicationStorageClassificationIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForReplicationStorageClassificationId(t *testing.T) {
	segments := ReplicationStorageClassificationId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ReplicationStorageClassificationId has no segments")
	}
