...
func (c ReplicationProtectionClustersClient) TestFailoverCleanupCallbackThenPoll(ctx context.Context, id ReplicationProtectionClusterId, input ClusterTestFailoverCleanupInput, callback func() error) error {
