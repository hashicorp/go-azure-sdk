...
func (c ReplicationProtectionClustersClient) UnplannedFailoverCallbackThenPoll(ctx context.Context, id ReplicationProtectionClusterId, input ClusterUnplannedFailoverInput, callback func() error) error {
