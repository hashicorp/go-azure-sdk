...
func (c ReplicationStorageClassificationMappingsClient) CreateCallbackThenPoll(ctx context.Context, id ReplicationStorageClassificationMappingId, input StorageClassificationMappingInput, callback func() error) error {
