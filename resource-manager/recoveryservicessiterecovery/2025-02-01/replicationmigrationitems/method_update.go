...
func (c ReplicationMigrationItemsClient) UpdateCallbackThenPoll(ctx context.Context, id ReplicationMigrationItemId, input UpdateMigrationItemInput, callback func() error) error {
