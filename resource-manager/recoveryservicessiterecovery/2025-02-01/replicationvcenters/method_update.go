...
func (c ReplicationvCentersClient) UpdateCallbackThenPoll(ctx context.Context, id ReplicationvCenterId, input UpdateVCenterRequest, callback func() error) error {
