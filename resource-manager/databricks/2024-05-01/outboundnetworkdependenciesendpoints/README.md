...
## `github.com/hashicorp/go-azure-sdk/resource-manager/databricks/2024-05-01/outboundnetworkdependenciesendpoints` Documentation

The `outboundnetworkdependenciesendpoints` SDK allows for interaction with the Azure Resource Manager Service `databricks` (API Version `2024-05-01`).
