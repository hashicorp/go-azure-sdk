...
func (c PUTClient) senderForPrivateEndpointConnectionsCreate(ctx context.Context, req *http.Request) (future PrivateEndpointConnectionsCreateOperationResponse, err error) {
