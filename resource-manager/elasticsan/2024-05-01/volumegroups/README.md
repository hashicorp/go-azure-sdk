...
## `github.com/hashicorp/go-azure-sdk/resource-manager/elasticsan/2024-05-01/volumegroups` Documentation

The `volumegroups` SDK allows for interaction with the Azure Resource Manager Service `elasticsan` (API Version `2024-05-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/elasticsan/2024-05-01/volumegroups"
```
