...
// SkusList ...
func (c ElasticSanSkusClient) SkusList(ctx context.Context, options SkusListOperationOptions) (result SkusListOperationResponse, err error) {
	req, err := c.preparerForSkusList(ctx, options)
	if err != nil {
...
func (c ElasticSanSkusClient) preparerForSkusList(ctx context.Context, options SkusListOperationOptions) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath("/providers/Microsoft.ElasticSan/skus"),
