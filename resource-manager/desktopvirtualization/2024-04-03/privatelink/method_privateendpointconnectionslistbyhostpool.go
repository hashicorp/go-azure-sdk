...
func (c PrivateLinkClient) PrivateEndpointConnectionsListByHostPoolComplete(ctx context.Context, id HostPoolId, options PrivateEndpointConnectionsListByHostPoolOperationOptions) (PrivateEndpointConnectionsListByHostPoolCompleteResult, error) {
	return c.PrivateEndpointConnectionsListByHostPoolCompleteMatchingPredicate(ctx, id, options, PrivateEndpointConnectionWithSystemDataOperationPredicate{})
}
...
func (c PrivateLinkClient) PrivateEndpointConnectionsListByHostPoolCompleteMatchingPredicate(ctx context.Context, id HostPoolId, options PrivateEndpointConnectionsListByHostPoolOperationOptions, predicate PrivateEndpointConnectionWithSystemDataOperationPredicate) (result PrivateEndpointConnectionsListByHostPoolCompleteResult, err error) {
