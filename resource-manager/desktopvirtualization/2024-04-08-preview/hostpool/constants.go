...
func PossibleValuesForDirectUDP() []string {
	return []string{
		string(DirectUDPDefault),
		string(DirectUDPDisabled),
		string(DirectUDPEnabled),
	}
}

func (s *DirectUDP) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseDirectUDP(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseDirectUDP(input string) (*DirectUDP, error) {
	vals := map[string]DirectUDP{
		"default":  DirectUDPDefault,
		"disabled": DirectUDPDisabled,
		"enabled":  DirectUDPEnabled,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForManagedPrivateUDP() []string {
	return []string{
		string(ManagedPrivateUDPDefault),
		string(ManagedPrivateUDPDisabled),
		string(ManagedPrivateUDPEnabled),
	}
}

func (s *ManagedPrivateUDP) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseManagedPrivateUDP(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseManagedPrivateUDP(input string) (*ManagedPrivateUDP, error) {
	vals := map[string]ManagedPrivateUDP{
		"default":  ManagedPrivateUDPDefault,
		"disabled": ManagedPrivateUDPDisabled,
		"enabled":  ManagedPrivateUDPEnabled,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForManagementType() []string {
	return []string{
		string(ManagementTypeAutomated),
		string(ManagementTypeStandard),
	}
}

func (s *ManagementType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseManagementType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseManagementType(input string) (*ManagementType, error) {
	vals := map[string]ManagementType{
		"automated": ManagementTypeAutomated,
		"standard":  ManagementTypeStandard,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForPublicUDP() []string {
	return []string{
		string(PublicUDPDefault),
		string(PublicUDPDisabled),
		string(PublicUDPEnabled),
	}
}

func (s *PublicUDP) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parsePublicUDP(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parsePublicUDP(input string) (*PublicUDP, error) {
	vals := map[string]PublicUDP{
		"default":  PublicUDPDefault,
		"disabled": PublicUDPDisabled,
		"enabled":  PublicUDPEnabled,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForRelayUDP() []string {
	return []string{
		string(RelayUDPDefault),
		string(RelayUDPDisabled),
		string(RelayUDPEnabled),
	}
}

func (s *RelayUDP) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseRelayUDP(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseRelayUDP(input string) (*RelayUDP, error) {
	vals := map[string]RelayUDP{
		"default":  RelayUDPDefault,
		"disabled": RelayUDPDisabled,
		"enabled":  RelayUDPEnabled,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
