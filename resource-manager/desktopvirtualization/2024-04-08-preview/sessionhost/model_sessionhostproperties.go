...
type SessionHostProperties struct {
	...
	LastSessionHostUpdateTime     *string                         `json:"lastSessionHostUpdateTime,omitempty"`
	LastUpdateTime                *string                         `json:"lastUpdateTime,omitempty"`
	ObjectId                      *string                         `json:"objectId,omitempty"`
	OsVersion                     *string                         `json:"osVersion,omitempty"`
	ResourceId                    *string                         `json:"resourceId,omitempty"`
	SessionHostConfiguration      *string                         `json:"sessionHostConfiguration,omitempty"`
...
func (o *SessionHostProperties) GetLastSessionHostUpdateTimeAsTime() (*time.Time, error) {
	if o.LastSessionHostUpdateTime == nil {
		return nil, nil
	}
	return dates.ParseAsFormat(o.LastSessionHostUpdateTime, "2006-01-02T15:04:05Z07:00")
}

func (o *SessionHostProperties) SetLastSessionHostUpdateTimeAsTime(input time.Time) {
	formatted := input.Format("2006-01-02T15:04:05Z07:00")
	o.LastSessionHostUpdateTime = &formatted
}
