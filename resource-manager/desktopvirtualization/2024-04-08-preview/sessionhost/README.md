...
## `github.com/hashicorp/go-azure-sdk/resource-manager/desktopvirtualization/2024-04-08-preview/sessionhost` Documentation

The `sessionhost` SDK allows for interaction with Azure Resource Manager `desktopvirtualization` (API Version `2024-04-08-preview`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/desktopvirtualization/2024-04-08-preview/sessionhost"
```
...
### Example Usage: `SessionHostClient.RetryProvisioning`

```go
ctx := context.TODO()
id := sessionhost.NewSessionHostID("12345678-1234-9876-4563-123456789012", "example-resource-group", "hostPoolName", "sessionHostName")

read, err := client.RetryProvisioning(ctx, id)
if err != nil {
	// handle the error
}
if model := read.Model; model != nil {
