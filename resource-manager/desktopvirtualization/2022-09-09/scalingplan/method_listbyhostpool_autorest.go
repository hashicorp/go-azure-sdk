...
// ListByHostPool ...
func (c ScalingPlanClient) ListByHostPool(ctx context.Context, id HostPoolId, options ListByHostPoolOperationOptions) (resp ListByHostPoolOperationResponse, err error) {
...
func (c ScalingPlanClient) preparerForListByHostPool(ctx context.Context, id HostPoolId, options ListByHostPoolOperationOptions) (*http.Request, error) {
...
func (c ScalingPlanClient) ListByHostPoolCompleteMatchingPredicate(ctx context.Context, id HostPoolId, options ListByHostPoolOperationOptions, predicate ScalingPlanOperationPredicate) (resp ListByHostPoolCompleteResult, err error) {
