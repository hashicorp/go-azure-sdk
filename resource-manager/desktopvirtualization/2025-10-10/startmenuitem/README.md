...
## `github.com/hashicorp/go-azure-sdk/resource-manager/desktopvirtualization/2025-10-10/startmenuitem` Documentation

The `startmenuitem` SDK allows for interaction with Azure Resource Manager `desktopvirtualization` (API Version `2025-10-10`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/desktopvirtualization/2025-10-10/startmenuitem"
```
