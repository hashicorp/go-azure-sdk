...
func (c CreateResourceClient) CreationSupportedGet(ctx context.Context, id SubscriptionStatusId) (result CreationSupportedGetOperationResponse, err error) {
...
func (c CreateResourceClient) CreationSupportedGetComplete(ctx context.Context, id SubscriptionStatusId) (CreationSupportedGetCompleteResult, error) {
...
func (c CreateResourceClient) CreationSupportedGetCompleteMatchingPredicate(ctx context.Context, id SubscriptionStatusId, predicate CreateResourceSupportedPropertiesOperationPredicate) (result CreationSupportedGetCompleteResult, err error) {
