...
type SingleSignOnCreateOrUpdateOperationResponse struct {
...
// SingleSignOnCreateOrUpdate ...
func (c DynatraceSingleSignOnResourcesClient) SingleSignOnCreateOrUpdate(ctx context.Context, id SingleSignOnConfigurationId, input DynatraceSingleSignOnResource) (result SingleSignOnCreateOrUpdateOperationResponse, err error) {
...
func (c DynatraceSingleSignOnResourcesClient) SingleSignOnCreateOrUpdateThenPoll(ctx context.Context, id SingleSignOnConfigurationId, input DynatraceSingleSignOnResource) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after SingleSignOnCreateOrUpdate: %+v", err)
	}
