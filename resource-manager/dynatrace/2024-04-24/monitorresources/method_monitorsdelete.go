...
// MonitorsDelete ...
func (c MonitorResourcesClient) MonitorsDelete(ctx context.Context, id MonitorId) (result MonitorsDeleteOperationResponse, err error) {
...
func (c MonitorResourcesClient) MonitorsDeleteThenPoll(ctx context.Context, id MonitorId) error {
