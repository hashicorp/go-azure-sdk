...
type MonitorsUpgradePlanOperationResponse struct {
...
// MonitorsUpgradePlan ...
func (c MonitorResourcesClient) MonitorsUpgradePlan(ctx context.Context, id MonitorId, input UpgradePlanRequest) (result MonitorsUpgradePlanOperationResponse, err error) {
...
func (c MonitorResourcesClient) MonitorsUpgradePlanThenPoll(ctx context.Context, id MonitorId, input UpgradePlanRequest) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after MonitorsUpgradePlan: %+v", err)
	}
