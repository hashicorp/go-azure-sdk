...
func (c MonitorResourcesClient) MonitorsListByResourceGroup(ctx context.Context, id commonids.ResourceGroupId) (result MonitorsListByResourceGroupOperationResponse, err error) {
...
func (c MonitorResourcesClient) MonitorsListByResourceGroupComplete(ctx context.Context, id commonids.ResourceGroupId) (MonitorsListByResourceGroupCompleteResult, error) {
	return c.MonitorsListByResourceGroupCompleteMatchingPredicate(ctx, id, MonitorResourceOperationPredicate{})
}

// MonitorsListByResourceGroupCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c MonitorResourcesClient) MonitorsListByResourceGroupCompleteMatchingPredicate(ctx context.Context, id commonids.ResourceGroupId, predicate MonitorResourceOperationPredicate) (result MonitorsListByResourceGroupCompleteResult, err error) {
