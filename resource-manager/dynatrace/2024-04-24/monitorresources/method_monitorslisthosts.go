...
// MonitorsListHosts ...
func (c MonitorResourcesClient) MonitorsListHosts(ctx context.Context, id MonitorId) (result MonitorsListHostsOperationResponse, err error) {
...
func (c MonitorResourcesClient) MonitorsListHostsComplete(ctx context.Context, id MonitorId) (MonitorsListHostsCompleteResult, error) {
	return c.MonitorsListHostsCompleteMatchingPredicate(ctx, id, VMInfoOperationPredicate{})
}

// MonitorsListHostsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c MonitorResourcesClient) MonitorsListHostsCompleteMatchingPredicate(ctx context.Context, id MonitorId, predicate VMInfoOperationPredicate) (result MonitorsListHostsCompleteResult, err error) {
	items := make([]VMInfo, 0)
