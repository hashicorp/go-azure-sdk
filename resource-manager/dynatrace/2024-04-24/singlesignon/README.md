...
## `github.com/hashicorp/go-azure-sdk/resource-manager/dynatrace/2024-04-24/singlesignon` Documentation

The `singlesignon` SDK allows for interaction with Azure Resource Manager `dynatrace` (API Version `2024-04-24`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/dynatrace/2024-04-24/singlesignon"
```
