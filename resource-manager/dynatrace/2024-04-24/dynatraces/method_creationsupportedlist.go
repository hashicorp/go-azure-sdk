...
func (c DynatracesClient) CreationSupportedList(ctx context.Context, id SubscriptionStatusId) (result CreationSupportedListOperationResponse, err error) {
...
func (c DynatracesClient) CreationSupportedListComplete(ctx context.Context, id SubscriptionStatusId) (CreationSupportedListCompleteResult, error) {
...
func (c DynatracesClient) CreationSupportedListCompleteMatchingPredicate(ctx context.Context, id SubscriptionStatusId, predicate CreateResourceSupportedPropertiesOperationPredicate) (result CreationSupportedListCompleteResult, err error) {
