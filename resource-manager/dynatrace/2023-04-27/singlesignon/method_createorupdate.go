...
func (c SingleSignOnClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id SingleSignOnConfigurationId, input DynatraceSingleSignOnResource, callback func() error) error {
