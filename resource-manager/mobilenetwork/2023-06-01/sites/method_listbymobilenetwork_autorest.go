...
func (c SitesClient) ListByMobileNetwork(ctx context.Context, id MobileNetworkId) (resp ListByMobileNetworkOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "sites.SitesClient", "ListByMobileNetwork", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "sites.SitesClient", "ListByMobileNetwork", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByMobileNetwork(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "sites.SitesClient", "ListByMobileNetwork", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c SitesClient) preparerForListByMobileNetwork(ctx context.Context, id MobileNetworkId) (*http.Request, error) {
...
func (c SitesClient) preparerForListByMobileNetworkWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c SitesClient) responderForListByMobileNetwork(resp *http.Response) (result ListByMobileNetworkOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByMobileNetworkOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "sites.SitesClient", "ListByMobileNetwork", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByMobileNetwork(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "sites.SitesClient", "ListByMobileNetwork", result.HttpResponse, "Failure responding to request")
				return
			}
