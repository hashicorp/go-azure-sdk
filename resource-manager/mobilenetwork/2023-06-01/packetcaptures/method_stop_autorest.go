...
func (c PacketCapturesClient) Stop(ctx context.Context, id PacketCaptureId) (result StopOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "packetcaptures.PacketCapturesClient", "Stop", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForStop(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "packetcaptures.PacketCapturesClient", "Stop", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c PacketCapturesClient) preparerForStop(ctx context.Context, id PacketCaptureId) (*http.Request, error) {
...
func (c PacketCapturesClient) senderForStop(ctx context.Context, req *http.Request) (future StopOperationResponse, err error) {
