...
## `github.com/hashicorp/go-azure-sdk/resource-manager/mobilenetwork/2023-06-01/datanetworks` Documentation

The `datanetworks` SDK allows for interaction with Azure Resource Manager `mobilenetwork` (API Version `2023-06-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/mobilenetwork/2023-06-01/datanetworks"
```
