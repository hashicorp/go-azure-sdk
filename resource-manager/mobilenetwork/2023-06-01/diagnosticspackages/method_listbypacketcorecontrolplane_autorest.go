...
func (c DiagnosticsPackagesClient) ListByPacketCoreControlPlane(ctx context.Context, id PacketCoreControlPlaneId) (resp ListByPacketCoreControlPlaneOperationResponse, err error) {
	req, err := c.preparerForListByPacketCoreControlPlane(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "diagnosticspackages.DiagnosticsPackagesClient", "ListByPacketCoreControlPlane", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "diagnosticspackages.DiagnosticsPackagesClient", "ListByPacketCoreControlPlane", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByPacketCoreControlPlane(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "diagnosticspackages.DiagnosticsPackagesClient", "ListByPacketCoreControlPlane", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c DiagnosticsPackagesClient) preparerForListByPacketCoreControlPlane(ctx context.Context, id PacketCoreControlPlaneId) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/diagnosticsPackages", id.ID())),
...
func (c DiagnosticsPackagesClient) preparerForListByPacketCoreControlPlaneWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c DiagnosticsPackagesClient) responderForListByPacketCoreControlPlane(resp *http.Response) (result ListByPacketCoreControlPlaneOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByPacketCoreControlPlaneOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "diagnosticspackages.DiagnosticsPackagesClient", "ListByPacketCoreControlPlane", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByPacketCoreControlPlane(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "diagnosticspackages.DiagnosticsPackagesClient", "ListByPacketCoreControlPlane", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c DiagnosticsPackagesClient) ListByPacketCoreControlPlaneCompleteMatchingPredicate(ctx context.Context, id PacketCoreControlPlaneId, predicate DiagnosticsPackageOperationPredicate) (resp ListByPacketCoreControlPlaneCompleteResult, err error) {
