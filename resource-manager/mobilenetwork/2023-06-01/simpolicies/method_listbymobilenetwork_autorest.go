...
// ListByMobileNetwork ...
func (c SIMPoliciesClient) ListByMobileNetwork(ctx context.Context, id MobileNetworkId) (resp ListByMobileNetworkOperationResponse, err error) {
	req, err := c.preparerForListByMobileNetwork(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "simpolicies.SIMPoliciesClient", "ListByMobileNetwork", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "simpolicies.SIMPoliciesClient", "ListByMobileNetwork", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByMobileNetwork(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "simpolicies.SIMPoliciesClient", "ListByMobileNetwork", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c SIMPoliciesClient) preparerForListByMobileNetwork(ctx context.Context, id MobileNetworkId) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/simPolicies", id.ID())),
...
func (c SIMPoliciesClient) preparerForListByMobileNetworkWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c SIMPoliciesClient) responderForListByMobileNetwork(resp *http.Response) (result ListByMobileNetworkOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByMobileNetworkOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "simpolicies.SIMPoliciesClient", "ListByMobileNetwork", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByMobileNetwork(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "simpolicies.SIMPoliciesClient", "ListByMobileNetwork", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c SIMPoliciesClient) ListByMobileNetworkCompleteMatchingPredicate(ctx context.Context, id MobileNetworkId, predicate SimPolicyOperationPredicate) (resp ListByMobileNetworkCompleteResult, err error) {
