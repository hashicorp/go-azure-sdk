...
func (c PacketCoreDataPlanesClient) ListByPacketCoreControlPlane(ctx context.Context, id PacketCoreControlPlaneId) (resp ListByPacketCoreControlPlaneOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "packetcoredataplanes.PacketCoreDataPlanesClient", "ListByPacketCoreControlPlane", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "packetcoredataplanes.PacketCoreDataPlanesClient", "ListByPacketCoreControlPlane", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByPacketCoreControlPlane(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "packetcoredataplanes.PacketCoreDataPlanesClient", "ListByPacketCoreControlPlane", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c PacketCoreDataPlanesClient) preparerForListByPacketCoreControlPlane(ctx context.Context, id PacketCoreControlPlaneId) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/packetCoreDataPlanes", id.ID())),
...
func (c PacketCoreDataPlanesClient) preparerForListByPacketCoreControlPlaneWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c PacketCoreDataPlanesClient) responderForListByPacketCoreControlPlane(resp *http.Response) (result ListByPacketCoreControlPlaneOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByPacketCoreControlPlaneOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "packetcoredataplanes.PacketCoreDataPlanesClient", "ListByPacketCoreControlPlane", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByPacketCoreControlPlane(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "packetcoredataplanes.PacketCoreDataPlanesClient", "ListByPacketCoreControlPlane", result.HttpResponse, "Failure responding to request")
				return
			}
