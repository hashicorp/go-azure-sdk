...
func (c FqdnListLocalRulestackClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id LocalRulestackFqdnListId, input FqdnListLocalRulestackResource, callback func() error) error {
