...
func (c PrefixListLocalRulestackClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id LocalRulestackPrefixListId, input PrefixListResource, callback func() error) error {
