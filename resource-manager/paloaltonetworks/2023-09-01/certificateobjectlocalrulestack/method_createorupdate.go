...
func (c CertificateObjectLocalRulestackClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id LocalRulestackCertificateId, input CertificateObjectLocalRulestackResource, callback func() error) error {
