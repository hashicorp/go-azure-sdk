...
func (c GlobalRulestackClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id GlobalRulestackId, input GlobalRulestackResource, callback func() error) error {
