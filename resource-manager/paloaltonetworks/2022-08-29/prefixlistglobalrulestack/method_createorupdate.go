...
func (c PrefixListGlobalRulestackClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id PrefixListId, input PrefixListGlobalRulestackResource, callback func() error) error {
