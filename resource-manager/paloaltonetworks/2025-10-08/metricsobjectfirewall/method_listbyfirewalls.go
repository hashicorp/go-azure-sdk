...
// ListByFirewalls ...
func (c MetricsObjectFirewallClient) ListByFirewalls(ctx context.Context, id FirewallId) (result ListByFirewallsOperationResponse, err error) {
...
func (c MetricsObjectFirewallClient) ListByFirewallsComplete(ctx context.Context, id FirewallId) (ListByFirewallsCompleteResult, error) {
	return c.ListByFirewallsCompleteMatchingPredicate(ctx, id, MetricsObjectFirewallResourceOperationPredicate{})
}

// ListByFirewallsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c MetricsObjectFirewallClient) ListByFirewallsCompleteMatchingPredicate(ctx context.Context, id FirewallId, predicate MetricsObjectFirewallResourceOperationPredicate) (result ListByFirewallsCompleteResult, err error) {
