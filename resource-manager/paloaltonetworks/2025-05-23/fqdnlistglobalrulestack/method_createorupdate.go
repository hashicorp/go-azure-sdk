...
func (c FqdnListGlobalRulestackClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id FqdnListId, input FqdnListGlobalRulestackResource, callback func() error) error {
