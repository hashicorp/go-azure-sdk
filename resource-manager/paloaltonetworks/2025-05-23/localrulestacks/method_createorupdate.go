...
func (c LocalRulestacksClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id LocalRulestackId, input LocalRulestackResource, callback func() error) error {
