...
func (c QuotaInformationClient) QuotaCreateOrUpdateCallbackThenPoll(ctx context.Context, id ScopedQuotaId, input CurrentQuotaLimitBase, callback func() error) error {
