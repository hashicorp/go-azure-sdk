...
func (c GroupQuotaSubscriptionIdsClient) GroupQuotaSubscriptionsList(ctx context.Context, id GroupQuotaId) (result GroupQuotaSubscriptionsListOperationResponse, err error) {
...
func (c GroupQuotaSubscriptionIdsClient) GroupQuotaSubscriptionsListComplete(ctx context.Context, id GroupQuotaId) (GroupQuotaSubscriptionsListCompleteResult, error) {
...
func (c GroupQuotaSubscriptionIdsClient) GroupQuotaSubscriptionsListCompleteMatchingPredicate(ctx context.Context, id GroupQuotaId, predicate GroupQuotaSubscriptionIdOperationPredicate) (result GroupQuotaSubscriptionsListCompleteResult, err error) {
