...
func (c GroupQuotasEntitiesClient) GroupQuotaLimitsRequestList(ctx context.Context, id ResourceProviderId, options GroupQuotaLimitsRequestListOperationOptions) (result GroupQuotaLimitsRequestListOperationResponse, err error) {
...
func (c GroupQuotasEntitiesClient) GroupQuotaLimitsRequestListComplete(ctx context.Context, id ResourceProviderId, options GroupQuotaLimitsRequestListOperationOptions) (GroupQuotaLimitsRequestListCompleteResult, error) {
...
func (c GroupQuotasEntitiesClient) GroupQuotaLimitsRequestListCompleteMatchingPredicate(ctx context.Context, id ResourceProviderId, options GroupQuotaLimitsRequestListOperationOptions, predicate SubmittedResourceRequestStatusOperationPredicate) (result GroupQuotaLimitsRequestListCompleteResult, err error) {
