...
func (c QuotaAllocationRequestStatusesClient) GroupQuotaSubscriptionAllocationRequestList(ctx context.Context, id GroupQuotaResourceProviderId, options GroupQuotaSubscriptionAllocationRequestListOperationOptions) (result GroupQuotaSubscriptionAllocationRequestListOperationResponse, err error) {
...
func (c QuotaAllocationRequestStatusesClient) GroupQuotaSubscriptionAllocationRequestListComplete(ctx context.Context, id GroupQuotaResourceProviderId, options GroupQuotaSubscriptionAllocationRequestListOperationOptions) (GroupQuotaSubscriptionAllocationRequestListCompleteResult, error) {
...
func (c QuotaAllocationRequestStatusesClient) GroupQuotaSubscriptionAllocationRequestListCompleteMatchingPredicate(ctx context.Context, id GroupQuotaResourceProviderId, options GroupQuotaSubscriptionAllocationRequestListOperationOptions, predicate QuotaAllocationRequestStatusOperationPredicate) (result GroupQuotaSubscriptionAllocationRequestListCompleteResult, err error) {
