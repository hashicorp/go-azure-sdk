...
// UsagesList ...
func (c CurrentUsagesBasesClient) UsagesList(ctx context.Context, id commonids.ScopeId) (result UsagesListOperationResponse, err error) {
...
func (c CurrentUsagesBasesClient) UsagesListComplete(ctx context.Context, id commonids.ScopeId) (UsagesListCompleteResult, error) {
...
func (c CurrentUsagesBasesClient) UsagesListCompleteMatchingPredicate(ctx context.Context, id commonids.ScopeId, predicate CurrentUsagesBaseOperationPredicate) (result UsagesListCompleteResult, err error) {
