...
// QuotaCreateOrUpdate ...
func (c CurrentQuotaLimitBasesClient) QuotaCreateOrUpdate(ctx context.Context, id ScopedQuotaId, input CurrentQuotaLimitBase) (result QuotaCreateOrUpdateOperationResponse, err error) {
