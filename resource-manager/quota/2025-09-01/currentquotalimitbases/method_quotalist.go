...
// QuotaList ...
func (c CurrentQuotaLimitBasesClient) QuotaList(ctx context.Context, id commonids.ScopeId) (result QuotaListOperationResponse, err error) {
...
func (c CurrentQuotaLimitBasesClient) QuotaListComplete(ctx context.Context, id commonids.ScopeId) (QuotaListCompleteResult, error) {
...
func (c CurrentQuotaLimitBasesClient) QuotaListCompleteMatchingPredicate(ctx context.Context, id commonids.ScopeId, predicate CurrentQuotaLimitBaseOperationPredicate) (result QuotaListCompleteResult, err error) {
