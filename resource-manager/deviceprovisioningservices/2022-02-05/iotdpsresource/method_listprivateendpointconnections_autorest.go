...
func (c IotDpsResourceClient) ListPrivateEndpointConnections(ctx context.Context, id ProvisioningServiceId) (result ListPrivateEndpointConnectionsOperationResponse, err error) {
...
func (c IotDpsResourceClient) preparerForListPrivateEndpointConnections(ctx context.Context, id ProvisioningServiceId) (*http.Request, error) {
