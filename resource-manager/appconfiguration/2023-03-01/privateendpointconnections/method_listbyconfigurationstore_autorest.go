...
func (c PrivateEndpointConnectionsClient) ListByConfigurationStore(ctx context.Context, id ConfigurationStoreId) (resp ListByConfigurationStoreOperationResponse, err error) {
...
func (c PrivateEndpointConnectionsClient) responderForListByConfigurationStore(resp *http.Response) (result ListByConfigurationStoreOperationResponse, err error) {
	type page struct {
...
func (c PrivateEndpointConnectionsClient) ListByConfigurationStoreCompleteMatchingPredicate(ctx context.Context, id ConfigurationStoreId, predicate PrivateEndpointConnectionOperationPredicate) (resp ListByConfigurationStoreCompleteResult, err error) {
