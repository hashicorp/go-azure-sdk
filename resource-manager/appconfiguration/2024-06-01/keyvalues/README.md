...
## `github.com/hashicorp/go-azure-sdk/resource-manager/appconfiguration/2024-06-01/keyvalues` Documentation

The `keyvalues` SDK allows for interaction with Azure Resource Manager `appconfiguration` (API Version `2024-06-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/appconfiguration/2024-06-01/keyvalues"
```
