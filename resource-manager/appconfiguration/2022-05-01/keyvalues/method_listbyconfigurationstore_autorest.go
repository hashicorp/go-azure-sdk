...
func (c KeyValuesClient) ListByConfigurationStore(ctx context.Context, id ConfigurationStoreId) (resp ListByConfigurationStoreOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "keyvalues.KeyValuesClient", "ListByConfigurationStore", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "keyvalues.KeyValuesClient", "ListByConfigurationStore", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByConfigurationStore(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "keyvalues.KeyValuesClient", "ListByConfigurationStore", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c KeyValuesClient) ListByConfigurationStoreComplete(ctx context.Context, id ConfigurationStoreId) (ListByConfigurationStoreCompleteResult, error) {
	return c.ListByConfigurationStoreCompleteMatchingPredicate(ctx, id, KeyValueOperationPredicate{})
}
...
func (c KeyValuesClient) preparerForListByConfigurationStore(ctx context.Context, id ConfigurationStoreId) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/keyValues", id.ID())),
...
func (c KeyValuesClient) preparerForListByConfigurationStoreWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c KeyValuesClient) responderForListByConfigurationStore(resp *http.Response) (result ListByConfigurationStoreOperationResponse, err error) {
	type page struct {
		Values   []KeyValue `json:"value"`
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByConfigurationStoreOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "keyvalues.KeyValuesClient", "ListByConfigurationStore", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByConfigurationStore(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "keyvalues.KeyValuesClient", "ListByConfigurationStore", result.HttpResponse, "Failure responding to request")
				return
			}
