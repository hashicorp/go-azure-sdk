...
func (c AccountsClient) UpdateCallbackThenPoll(ctx context.Context, id AccountId, input UpdateDataLakeAnalyticsAccountParameters, callback func() error) error {
