...
func (c AccountsClient) CreateCallbackThenPoll(ctx context.Context, id AccountId, input CreateDataLakeAnalyticsAccountParameters, callback func() error) error {
