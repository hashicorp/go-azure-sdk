...
type ListStorageContainersOperationResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (ListStorageContainersOperationResponse, error)
}
...
func (r ListStorageContainersOperationResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r ListStorageContainersOperationResponse) LoadMore(ctx context.Context) (resp ListStorageContainersOperationResponse, err error) {
	if !r.HasMore() {
...
func (c StorageAccountsClient) ListStorageContainers(ctx context.Context, id StorageAccountId) (resp ListStorageContainersOperationResponse, err error) {
...
func (c StorageAccountsClient) responderForListStorageContainers(resp *http.Response) (result ListStorageContainersOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListStorageContainersOperationResponse, err error) {
