...
type ListSasTokensOperationResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (ListSasTokensOperationResponse, error)
}
...
func (r ListSasTokensOperationResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r ListSasTokensOperationResponse) LoadMore(ctx context.Context) (resp ListSasTokensOperationResponse, err error) {
	if !r.HasMore() {
...
// ListSasTokens ...
func (c StorageAccountsClient) ListSasTokens(ctx context.Context, id ContainerId) (resp ListSasTokensOperationResponse, err error) {
...
func (c StorageAccountsClient) responderForListSasTokens(resp *http.Response) (result ListSasTokensOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListSasTokensOperationResponse, err error) {
