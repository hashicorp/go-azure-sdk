...
func init() {
	recaser.RegisterResourceId(&DataLakeStoreAccountId{})
}
...
func (id *DataLakeStoreAccountId) FromParseResult(input resourceids.ParseResult) error {
	...
	if id.DataLakeStoreAccountName, ok = input.Parsed["dataLakeStoreAccountName"]; !ok {
		return resourceids.NewSegmentNotSpecifiedError(id, "dataLakeStoreAccountName", input)
	}
...
func (id DataLakeStoreAccountId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("dataLakeStoreAccountName", "dataLakeStoreAccountName"),
	}
}
