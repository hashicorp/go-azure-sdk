...
## `github.com/hashicorp/go-azure-sdk/resource-manager/keyvault/2026-02-01/mhsmprivateendpointconnections` Documentation

The `mhsmprivateendpointconnections` SDK allows for interaction with Azure Resource Manager `keyvault` (API Version `2026-02-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/keyvault/2026-02-01/mhsmprivateendpointconnections"
```
