...
## `github.com/hashicorp/go-azure-sdk/resource-manager/keyvault/2026-02-01/openapis` Documentation

The `openapis` SDK allows for interaction with Azure Resource Manager `keyvault` (API Version `2026-02-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/keyvault/2026-02-01/openapis"
```
