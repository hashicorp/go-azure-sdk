...
// ListByResource ...
func (c MhsmPrivateEndpointConnectionsClient) ListByResource(ctx context.Context, id ManagedHSMId) (result ListByResourceOperationResponse, err error) {
...
func (c MhsmPrivateEndpointConnectionsClient) ListByResourceComplete(ctx context.Context, id ManagedHSMId) (ListByResourceCompleteResult, error) {
	return c.ListByResourceCompleteMatchingPredicate(ctx, id, MHSMPrivateEndpointConnectionOperationPredicate{})
}

// ListByResourceCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c MhsmPrivateEndpointConnectionsClient) ListByResourceCompleteMatchingPredicate(ctx context.Context, id ManagedHSMId, predicate MHSMPrivateEndpointConnectionOperationPredicate) (result ListByResourceCompleteResult, err error) {
