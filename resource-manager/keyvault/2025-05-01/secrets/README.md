...
## `github.com/hashicorp/go-azure-sdk/resource-manager/keyvault/2025-05-01/secrets` Documentation

The `secrets` SDK allows for interaction with Azure Resource Manager `keyvault` (API Version `2025-05-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/keyvault/2025-05-01/secrets"
```
