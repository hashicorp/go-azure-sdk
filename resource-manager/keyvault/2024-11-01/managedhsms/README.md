...
## `github.com/hashicorp/go-azure-sdk/resource-manager/keyvault/2024-11-01/managedhsms` Documentation

The `managedhsms` SDK allows for interaction with Azure Resource Manager `keyvault` (API Version `2024-11-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/keyvault/2024-11-01/managedhsms"
```
