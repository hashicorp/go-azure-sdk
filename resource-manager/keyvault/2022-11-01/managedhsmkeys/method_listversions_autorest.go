...
type ListVersionsOperationResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (ListVersionsOperationResponse, error)
}
...
func (c ManagedHsmKeysClient) ListVersions(ctx context.Context, id KeyId) (resp ListVersionsOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "managedhsmkeys.ManagedHsmKeysClient", "ListVersions", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "managedhsmkeys.ManagedHsmKeysClient", "ListVersions", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListVersions(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "managedhsmkeys.ManagedHsmKeysClient", "ListVersions", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ManagedHsmKeysClient) preparerForListVersions(ctx context.Context, id KeyId) (*http.Request, error) {
...
func (c ManagedHsmKeysClient) preparerForListVersionsWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ManagedHsmKeysClient) responderForListVersions(resp *http.Response) (result ListVersionsOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListVersionsOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "managedhsmkeys.ManagedHsmKeysClient", "ListVersions", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListVersions(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "managedhsmkeys.ManagedHsmKeysClient", "ListVersions", result.HttpResponse, "Failure responding to request")
				return
			}
