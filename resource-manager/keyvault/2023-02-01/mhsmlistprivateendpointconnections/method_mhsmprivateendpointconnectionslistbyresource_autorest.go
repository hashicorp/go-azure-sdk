...
type MHSMPrivateEndpointConnectionsListByResourceOperationResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (MHSMPrivateEndpointConnectionsListByResourceOperationResponse, error)
}
...
func (r MHSMPrivateEndpointConnectionsListByResourceOperationResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r MHSMPrivateEndpointConnectionsListByResourceOperationResponse) LoadMore(ctx context.Context) (resp MHSMPrivateEndpointConnectionsListByResourceOperationResponse, err error) {
	if !r.HasMore() {
...
func (c MHSMListPrivateEndpointConnectionsClient) MHSMPrivateEndpointConnectionsListByResource(ctx context.Context, id ManagedHSMId) (resp MHSMPrivateEndpointConnectionsListByResourceOperationResponse, err error) {
...
func (c MHSMListPrivateEndpointConnectionsClient) responderForMHSMPrivateEndpointConnectionsListByResource(resp *http.Response) (result MHSMPrivateEndpointConnectionsListByResourceOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result MHSMPrivateEndpointConnectionsListByResourceOperationResponse, err error) {
