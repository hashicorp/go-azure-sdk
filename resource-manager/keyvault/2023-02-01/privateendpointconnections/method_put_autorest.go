...
func (c PrivateEndpointConnectionsClient) preparerForPut(ctx context.Context, id commonids.KeyVaultPrivateEndpointConnectionId, input PrivateEndpointConnection) (*http.Request, error) {
