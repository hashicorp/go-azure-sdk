...
func (c KeysClient) preparerForList(ctx context.Context, id commonids.KeyVaultId) (*http.Request, error) {
...
func (c KeysClient) responderForList(resp *http.Response) (result ListOperationResponse, err error) {
	type page struct {
