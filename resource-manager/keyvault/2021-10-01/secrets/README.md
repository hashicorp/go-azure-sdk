...
## `github.com/hashicorp/go-azure-sdk/resource-manager/keyvault/2021-10-01/secrets` Documentation
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/keyvault/2021-10-01/secrets"
```
...
```go
ctx := context.TODO()
id := secrets.NewVaultID("12345678-1234-9876-4563-123456789012", "example-resource-group", "vaultValue")
