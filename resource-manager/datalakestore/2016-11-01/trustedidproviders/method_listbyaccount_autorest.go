...
// ListByAccount ...
func (c TrustedIdProvidersClient) ListByAccount(ctx context.Context, id AccountId) (resp ListByAccountOperationResponse, err error) {
...
func (c TrustedIdProvidersClient) ListByAccountCompleteMatchingPredicate(ctx context.Context, id AccountId, predicate TrustedIdProviderOperationPredicate) (resp ListByAccountCompleteResult, err error) {
...
func (c TrustedIdProvidersClient) responderForListByAccount(resp *http.Response) (result ListByAccountOperationResponse, err error) {
	type page struct {
