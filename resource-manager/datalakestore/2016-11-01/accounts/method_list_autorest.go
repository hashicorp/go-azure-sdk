...
func (c AccountsClient) ListCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, options ListOperationOptions, predicate DataLakeStoreAccountBasicOperationPredicate) (resp ListCompleteResult, err error) {
...
func (c AccountsClient) preparerForList(ctx context.Context, id commonids.SubscriptionId, options ListOperationOptions) (*http.Request, error) {
...
func (c AccountsClient) responderForList(resp *http.Response) (result ListOperationResponse, err error) {
	type page struct {
