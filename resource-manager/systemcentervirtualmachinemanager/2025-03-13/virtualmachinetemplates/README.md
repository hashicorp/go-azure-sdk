...
## `github.com/hashicorp/go-azure-sdk/resource-manager/systemcentervirtualmachinemanager/2025-03-13/virtualmachinetemplates` Documentation

The `virtualmachinetemplates` SDK allows for interaction with Azure Resource Manager `systemcentervirtualmachinemanager` (API Version `2025-03-13`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/systemcentervirtualmachinemanager/2025-03-13/virtualmachinetemplates"
```
