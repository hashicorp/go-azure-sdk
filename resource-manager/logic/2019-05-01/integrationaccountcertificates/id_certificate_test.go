...
func TestNewCertificateID(t *testing.T) {
	id := NewCertificateID("12345678-1234-9876-4563-123456789012", "example-resource-group", "integrationAccountName", "certificateName")
...
func TestFormatCertificateID(t *testing.T) {
	actual := NewCertificateID("12345678-1234-9876-4563-123456789012", "example-resource-group", "integrationAccountName", "certificateName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Logic/integrationAccounts/integrationAccountName/certificates/certificateName"
	if actual != expected {
...
func TestParseCertificateID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Logic/integrationAccounts/integrationAccountName/certificates",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Logic/integrationAccounts/integrationAccountName/certificates/certificateName",
			Expected: &CertificateId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Logic/integrationAccounts/integrationAccountName/certificates/certificateName/extra",
			Error: true,
		},
	}
