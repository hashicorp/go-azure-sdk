...
import (
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/insights/2021-05-01-preview/insights"
...
func NewClientWithBaseURI(endpoint string, configureAuthFunc func(c *autorest.Client)) Client {
	...
	insightsClient := insights.NewInsightsClientWithBaseURI(endpoint)
	configureAuthFunc(&insightsClient.Client)
