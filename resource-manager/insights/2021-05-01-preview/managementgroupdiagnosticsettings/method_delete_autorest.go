...
func (c ManagementGroupDiagnosticSettingsClient) Delete(ctx context.Context, id Providers2DiagnosticSettingId) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementgroupdiagnosticsettings.ManagementGroupDiagnosticSettingsClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForDelete(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementgroupdiagnosticsettings.ManagementGroupDiagnosticSettingsClient", "Delete", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c ManagementGroupDiagnosticSettingsClient) responderForDelete(resp *http.Response) (result DeleteOperationResponse, err error) {
