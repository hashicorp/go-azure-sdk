...
func (c ManagementGroupDiagnosticSettingsClient) CreateOrUpdate(ctx context.Context, id Providers2DiagnosticSettingId, input ManagementGroupDiagnosticSettingsResource) (result CreateOrUpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementgroupdiagnosticsettings.ManagementGroupDiagnosticSettingsClient", "CreateOrUpdate", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForCreateOrUpdate(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementgroupdiagnosticsettings.ManagementGroupDiagnosticSettingsClient", "CreateOrUpdate", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c ManagementGroupDiagnosticSettingsClient) responderForCreateOrUpdate(resp *http.Response) (result CreateOrUpdateOperationResponse, err error) {
