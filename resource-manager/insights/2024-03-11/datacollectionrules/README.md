...
## `github.com/hashicorp/go-azure-sdk/resource-manager/insights/2024-03-11/datacollectionrules` Documentation

The `datacollectionrules` SDK allows for interaction with Azure Resource Manager `insights` (API Version `2024-03-11`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/insights/2024-03-11/datacollectionrules"
```
