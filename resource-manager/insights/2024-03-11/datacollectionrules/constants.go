...
func PossibleValuesForKnownAgentSettingName() []string {
	return []string{
		...
		string(KnownAgentSettingNameTags),
...
func parseKnownAgentSettingName(input string) (*KnownAgentSettingName, error) {
	vals := map[string]KnownAgentSettingName{
		...
		"tags":                              KnownAgentSettingNameTags,
...
func PossibleValuesForKnownEtwProviderDataSourceLogLevel() []string {
	return []string{
		string(KnownEtwProviderDataSourceLogLevelCritical),
		string(KnownEtwProviderDataSourceLogLevelError),
		string(KnownEtwProviderDataSourceLogLevelInformational),
		string(KnownEtwProviderDataSourceLogLevelVerbose),
		string(KnownEtwProviderDataSourceLogLevelWarning),
	}
}

func (s *KnownEtwProviderDataSourceLogLevel) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseKnownEtwProviderDataSourceLogLevel(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseKnownEtwProviderDataSourceLogLevel(input string) (*KnownEtwProviderDataSourceLogLevel, error) {
	vals := map[string]KnownEtwProviderDataSourceLogLevel{
		"critical":      KnownEtwProviderDataSourceLogLevelCritical,
		"error":         KnownEtwProviderDataSourceLogLevelError,
		"informational": KnownEtwProviderDataSourceLogLevelInformational,
		"verbose":       KnownEtwProviderDataSourceLogLevelVerbose,
		"warning":       KnownEtwProviderDataSourceLogLevelWarning,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := KnownEtwProviderDataSourceLogLevel(input)
	return &out, nil
}
...
func PossibleValuesForKnownEtwProviderType() []string {
	return []string{
		string(KnownEtwProviderTypeEventSource),
		string(KnownEtwProviderTypeManifest),
	}
}

func (s *KnownEtwProviderType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseKnownEtwProviderType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseKnownEtwProviderType(input string) (*KnownEtwProviderType, error) {
	vals := map[string]KnownEtwProviderType{
		"eventsource": KnownEtwProviderTypeEventSource,
		"manifest":    KnownEtwProviderTypeManifest,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := KnownEtwProviderType(input)
	return &out, nil
}
...
const (
	KnownOtelLogsDataSourceStreamsMicrosoftNegativeOTelNegativeLogs KnownOtelLogsDataSourceStreams = "Microsoft-OTel-Logs"
)

func PossibleValuesForKnownOtelLogsDataSourceStreams() []string {
	return []string{
		string(KnownOtelLogsDataSourceStreamsMicrosoftNegativeOTelNegativeLogs),
	}
}

func (s *KnownOtelLogsDataSourceStreams) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseKnownOtelLogsDataSourceStreams(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseKnownOtelLogsDataSourceStreams(input string) (*KnownOtelLogsDataSourceStreams, error) {
	vals := map[string]KnownOtelLogsDataSourceStreams{
		"microsoft-otel-logs": KnownOtelLogsDataSourceStreamsMicrosoftNegativeOTelNegativeLogs,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := KnownOtelLogsDataSourceStreams(input)
	return &out, nil
}
...
const (
	KnownOtelLogsDirectDataSourceStreamsMicrosoftNegativeOTelNegativeLogs KnownOtelLogsDirectDataSourceStreams = "Microsoft-OTel-Logs"
)

func PossibleValuesForKnownOtelLogsDirectDataSourceStreams() []string {
	return []string{
		string(KnownOtelLogsDirectDataSourceStreamsMicrosoftNegativeOTelNegativeLogs),
	}
}

func (s *KnownOtelLogsDirectDataSourceStreams) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseKnownOtelLogsDirectDataSourceStreams(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseKnownOtelLogsDirectDataSourceStreams(input string) (*KnownOtelLogsDirectDataSourceStreams, error) {
	vals := map[string]KnownOtelLogsDirectDataSourceStreams{
		"microsoft-otel-logs": KnownOtelLogsDirectDataSourceStreamsMicrosoftNegativeOTelNegativeLogs,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := KnownOtelLogsDirectDataSourceStreams(input)
	return &out, nil
}
...
const (
	KnownOtelTracesDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeEvents    KnownOtelTracesDataSourceStreams = "Microsoft-OTel-Traces-Events"
	KnownOtelTracesDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeResources KnownOtelTracesDataSourceStreams = "Microsoft-OTel-Traces-Resources"
	KnownOtelTracesDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeSpans     KnownOtelTracesDataSourceStreams = "Microsoft-OTel-Traces-Spans"
)

func PossibleValuesForKnownOtelTracesDataSourceStreams() []string {
	return []string{
		string(KnownOtelTracesDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeEvents),
		string(KnownOtelTracesDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeResources),
		string(KnownOtelTracesDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeSpans),
	}
}

func (s *KnownOtelTracesDataSourceStreams) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseKnownOtelTracesDataSourceStreams(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseKnownOtelTracesDataSourceStreams(input string) (*KnownOtelTracesDataSourceStreams, error) {
	vals := map[string]KnownOtelTracesDataSourceStreams{
		"microsoft-otel-traces-events":    KnownOtelTracesDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeEvents,
		"microsoft-otel-traces-resources": KnownOtelTracesDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeResources,
		"microsoft-otel-traces-spans":     KnownOtelTracesDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeSpans,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := KnownOtelTracesDataSourceStreams(input)
	return &out, nil
}
...
const (
	KnownOtelTracesDirectDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeEvents    KnownOtelTracesDirectDataSourceStreams = "Microsoft-OTel-Traces-Events"
	KnownOtelTracesDirectDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeResources KnownOtelTracesDirectDataSourceStreams = "Microsoft-OTel-Traces-Resources"
	KnownOtelTracesDirectDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeSpans     KnownOtelTracesDirectDataSourceStreams = "Microsoft-OTel-Traces-Spans"
)

func PossibleValuesForKnownOtelTracesDirectDataSourceStreams() []string {
	return []string{
		string(KnownOtelTracesDirectDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeEvents),
		string(KnownOtelTracesDirectDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeResources),
		string(KnownOtelTracesDirectDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeSpans),
	}
}

func (s *KnownOtelTracesDirectDataSourceStreams) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseKnownOtelTracesDirectDataSourceStreams(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseKnownOtelTracesDirectDataSourceStreams(input string) (*KnownOtelTracesDirectDataSourceStreams, error) {
	vals := map[string]KnownOtelTracesDirectDataSourceStreams{
		"microsoft-otel-traces-events":    KnownOtelTracesDirectDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeEvents,
		"microsoft-otel-traces-resources": KnownOtelTracesDirectDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeResources,
		"microsoft-otel-traces-spans":     KnownOtelTracesDirectDataSourceStreamsMicrosoftNegativeOTelNegativeTracesNegativeSpans,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := KnownOtelTracesDirectDataSourceStreams(input)
	return &out, nil
}
...
const (
	KnownPerformanceCountersOTelDataSourceStreamsMicrosoftNegativeOtelPerfMetrics KnownPerformanceCountersOTelDataSourceStreams = "Microsoft-OtelPerfMetrics"
)

func PossibleValuesForKnownPerformanceCountersOTelDataSourceStreams() []string {
	return []string{
		string(KnownPerformanceCountersOTelDataSourceStreamsMicrosoftNegativeOtelPerfMetrics),
	}
}

func (s *KnownPerformanceCountersOTelDataSourceStreams) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseKnownPerformanceCountersOTelDataSourceStreams(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseKnownPerformanceCountersOTelDataSourceStreams(input string) (*KnownPerformanceCountersOTelDataSourceStreams, error) {
	vals := map[string]KnownPerformanceCountersOTelDataSourceStreams{
		"microsoft-otelperfmetrics": KnownPerformanceCountersOTelDataSourceStreamsMicrosoftNegativeOtelPerfMetrics,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := KnownPerformanceCountersOTelDataSourceStreams(input)
	return &out, nil
}
