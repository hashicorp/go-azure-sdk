...
func (c PrivateLinkResourcesClient) ListByPrivateLinkScope(ctx context.Context, id PrivateLinkScopeId) (resp ListByPrivateLinkScopeOperationResponse, err error) {
...
func (c PrivateLinkResourcesClient) preparerForListByPrivateLinkScope(ctx context.Context, id PrivateLinkScopeId) (*http.Request, error) {
...
func (c PrivateLinkResourcesClient) ListByPrivateLinkScopeCompleteMatchingPredicate(ctx context.Context, id PrivateLinkScopeId, predicate PrivateLinkResourceOperationPredicate) (resp ListByPrivateLinkScopeCompleteResult, err error) {
