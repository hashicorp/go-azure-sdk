...
func (c PrivateEndpointConnectionsClient) ListByPrivateLinkScope(ctx context.Context, id PrivateLinkScopeId) (resp ListByPrivateLinkScopeOperationResponse, err error) {
...
func (c PrivateEndpointConnectionsClient) ListByPrivateLinkScopeCompleteMatchingPredicate(ctx context.Context, id PrivateLinkScopeId, predicate PrivateEndpointConnectionOperationPredicate) (resp ListByPrivateLinkScopeCompleteResult, err error) {
