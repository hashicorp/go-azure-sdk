...
## `github.com/hashicorp/go-azure-sdk/resource-manager/resources/2024-03-01/resourcegroups` Documentation

The `resourcegroups` SDK allows for interaction with the Azure Resource Manager Service `resources` (API Version `2024-03-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/resources/2024-03-01/resourcegroups"
```
