...
func (c PolicyExemptionsClient) ListForResourceGroup(ctx context.Context, id commonids.ResourceGroupId, options ListForResourceGroupOperationOptions) (resp ListForResourceGroupOperationResponse, err error) {
	req, err := c.preparerForListForResourceGroup(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "policyexemptions.PolicyExemptionsClient", "ListForResourceGroup", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "policyexemptions.PolicyExemptionsClient", "ListForResourceGroup", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListForResourceGroup(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "policyexemptions.PolicyExemptionsClient", "ListForResourceGroup", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c PolicyExemptionsClient) preparerForListForResourceGroup(ctx context.Context, id commonids.ResourceGroupId, options ListForResourceGroupOperationOptions) (*http.Request, error) {
...
func (c PolicyExemptionsClient) preparerForListForResourceGroupWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c PolicyExemptionsClient) responderForListForResourceGroup(resp *http.Response) (result ListForResourceGroupOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListForResourceGroupOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "policyexemptions.PolicyExemptionsClient", "ListForResourceGroup", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListForResourceGroup(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "policyexemptions.PolicyExemptionsClient", "ListForResourceGroup", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c PolicyExemptionsClient) ListForResourceGroupCompleteMatchingPredicate(ctx context.Context, id commonids.ResourceGroupId, options ListForResourceGroupOperationOptions, predicate PolicyExemptionOperationPredicate) (resp ListForResourceGroupCompleteResult, err error) {
