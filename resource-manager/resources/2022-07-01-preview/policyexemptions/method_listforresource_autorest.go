...
// ListForResource ...
func (c PolicyExemptionsClient) ListForResource(ctx context.Context, id commonids.ScopeId, options ListForResourceOperationOptions) (resp ListForResourceOperationResponse, err error) {
...
func (c PolicyExemptionsClient) preparerForListForResource(ctx context.Context, id commonids.ScopeId, options ListForResourceOperationOptions) (*http.Request, error) {
