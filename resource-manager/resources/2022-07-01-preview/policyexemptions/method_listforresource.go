...
// ListForResource ...
func (c PolicyExemptionsClient) ListForResource(ctx context.Context, id ResourceId, options ListForResourceOperationOptions) (result ListForResourceOperationResponse, err error) {
...
func (c PolicyExemptionsClient) ListForResourceCompleteMatchingPredicate(ctx context.Context, id ResourceId, options ListForResourceOperationOptions, predicate PolicyExemptionOperationPredicate) (result ListForResourceCompleteResult, err error) {
