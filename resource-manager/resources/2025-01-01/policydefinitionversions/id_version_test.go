...
func TestNewVersionID(t *testing.T) {
	id := NewVersionID("policyDefinitionName", "versionName")
...
func TestFormatVersionID(t *testing.T) {
	actual := NewVersionID("policyDefinitionName", "versionName").ID()
	expected := "/providers/Microsoft.Authorization/policyDefinitions/policyDefinitionName/versions/versionName"
	if actual != expected {
...
func TestParseVersionID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/providers/Microsoft.Authorization/policyDefinitions/policyDefinitionName",
			Error: true,
		},
		{
			// Incomplete URI
			Input: "/providers/Microsoft.Authorization/policyDefinitions/policyDefinitionName/versions",
			Error: true,
		},
		{
			// Valid URI
			Input: "/providers/Microsoft.Authorization/policyDefinitions/policyDefinitionName/versions/versionName",
			Expected: &VersionId{
		...
		},
		{
			...
			Input: "/providers/Microsoft.Authorization/policyDefinitions/policyDefinitionName/versions/versionName/extra",
			Error: true,
		},
	}
