...
func TestNewPolicyDefinitionID(t *testing.T) {
	id := NewPolicyDefinitionID("policyDefinitionName")
...
func TestFormatPolicyDefinitionID(t *testing.T) {
	actual := NewPolicyDefinitionID("policyDefinitionName").ID()
	expected := "/providers/Microsoft.Authorization/policyDefinitions/policyDefinitionName"
	if actual != expected {
...
func TestParsePolicyDefinitionID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/providers/Microsoft.Authorization/policyDefinitions/policyDefinitionName/extra",
			Error: true,
		},
	}
