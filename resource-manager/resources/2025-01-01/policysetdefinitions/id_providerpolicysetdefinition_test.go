...
func TestNewProviderPolicySetDefinitionID(t *testing.T) {
	id := NewProviderPolicySetDefinitionID("12345678-1234-9876-4563-123456789012", "policySetDefinitionName")
...
func TestFormatProviderPolicySetDefinitionID(t *testing.T) {
	actual := NewProviderPolicySetDefinitionID("12345678-1234-9876-4563-123456789012", "policySetDefinitionName").ID()
