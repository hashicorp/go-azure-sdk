...
// GetBuiltIn ...
func (c PolicySetDefinitionVersionsClient) GetBuiltIn(ctx context.Context, id PolicySetDefinitionVersionId, options GetBuiltInOperationOptions) (result GetBuiltInOperationResponse, err error) {
