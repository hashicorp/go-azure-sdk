...
## `github.com/hashicorp/go-azure-sdk/resource-manager/resources/2025-03-01/providers` Documentation

The `providers` SDK allows for interaction with Azure Resource Manager `resources` (API Version `2025-03-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/resources/2025-03-01/providers"
```
