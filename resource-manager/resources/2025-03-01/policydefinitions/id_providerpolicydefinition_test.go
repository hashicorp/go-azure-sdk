...
func TestNewProviderPolicyDefinitionID(t *testing.T) {
	id := NewProviderPolicyDefinitionID("12345678-1234-9876-4563-123456789012", "policyDefinitionName")
...
func TestFormatProviderPolicyDefinitionID(t *testing.T) {
	actual := NewProviderPolicyDefinitionID("12345678-1234-9876-4563-123456789012", "policyDefinitionName").ID()
