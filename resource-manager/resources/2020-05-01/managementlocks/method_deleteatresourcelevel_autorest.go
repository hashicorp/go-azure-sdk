...
func (c ManagementLocksClient) DeleteAtResourceLevel(ctx context.Context, id ResourceLockScopedId) (result DeleteAtResourceLevelOperationResponse, err error) {
...
func (c ManagementLocksClient) preparerForDeleteAtResourceLevel(ctx context.Context, id ResourceLockScopedId) (*http.Request, error) {
