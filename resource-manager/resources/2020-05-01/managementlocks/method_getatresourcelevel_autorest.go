...
// GetAtResourceLevel ...
func (c ManagementLocksClient) GetAtResourceLevel(ctx context.Context, id ResourceLockScopedId) (result GetAtResourceLevelOperationResponse, err error) {
...
func (c ManagementLocksClient) preparerForGetAtResourceLevel(ctx context.Context, id ResourceLockScopedId) (*http.Request, error) {
