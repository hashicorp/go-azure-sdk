...
// ListForResource ...
func (c PolicyAssignmentsClient) ListForResource(ctx context.Context, id ScopedResourceId, options ListForResourceOperationOptions) (resp ListForResourceOperationResponse, err error) {
...
func (c PolicyAssignmentsClient) preparerForListForResource(ctx context.Context, id ScopedResourceId, options ListForResourceOperationOptions) (*http.Request, error) {
...
func (c PolicyAssignmentsClient) ListForResourceComplete(ctx context.Context, id ScopedResourceId, options ListForResourceOperationOptions) (ListForResourceCompleteResult, error) {
...
func (c PolicyAssignmentsClient) ListForResourceCompleteMatchingPredicate(ctx context.Context, id ScopedResourceId, options ListForResourceOperationOptions, predicate PolicyAssignmentOperationPredicate) (resp ListForResourceCompleteResult, err error) {
