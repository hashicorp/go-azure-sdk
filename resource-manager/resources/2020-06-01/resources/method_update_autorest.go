...
func (c ResourcesClient) Update(ctx context.Context, id ResourceId, input GenericResource) (result UpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "resources.ResourcesClient", "Update", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ResourcesClient) senderForUpdate(ctx context.Context, req *http.Request) (future UpdateOperationResponse, err error) {
