...
func (c ResourcesClient) Delete(ctx context.Context, id ScopedResourceId) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "resources.ResourcesClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ResourcesClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
