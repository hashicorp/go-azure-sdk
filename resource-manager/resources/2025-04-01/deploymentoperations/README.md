...
## `github.com/hashicorp/go-azure-sdk/resource-manager/resources/2025-04-01/deploymentoperations` Documentation

The `deploymentoperations` SDK allows for interaction with Azure Resource Manager `resources` (API Version `2025-04-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/resources/2025-04-01/deploymentoperations"
```
