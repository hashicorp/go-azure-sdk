...
type DeploymentProperties struct {
	...
	ExternalInputDefinitions    *map[string]DeploymentExternalInputDefinition        `json:"externalInputDefinitions,omitempty"`
	ExternalInputs              *map[string]DeploymentExternalInput                  `json:"externalInputs,omitempty"`
