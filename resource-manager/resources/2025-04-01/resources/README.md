...
## `github.com/hashicorp/go-azure-sdk/resource-manager/resources/2025-04-01/resources` Documentation

The `resources` SDK allows for interaction with Azure Resource Manager `resources` (API Version `2025-04-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/resources/2025-04-01/resources"
```
