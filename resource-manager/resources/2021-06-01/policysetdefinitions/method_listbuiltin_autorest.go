...
// ListBuiltIn ...
func (c PolicySetDefinitionsClient) ListBuiltIn(ctx context.Context, options ListBuiltInOperationOptions) (resp ListBuiltInOperationResponse, err error) {
	req, err := c.preparerForListBuiltIn(ctx, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "policysetdefinitions.PolicySetDefinitionsClient", "ListBuiltIn", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "policysetdefinitions.PolicySetDefinitionsClient", "ListBuiltIn", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListBuiltIn(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "policysetdefinitions.PolicySetDefinitionsClient", "ListBuiltIn", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c PolicySetDefinitionsClient) preparerForListBuiltIn(ctx context.Context, options ListBuiltInOperationOptions) (*http.Request, error) {
...
func (c PolicySetDefinitionsClient) preparerForListBuiltInWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c PolicySetDefinitionsClient) responderForListBuiltIn(resp *http.Response) (result ListBuiltInOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListBuiltInOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "policysetdefinitions.PolicySetDefinitionsClient", "ListBuiltIn", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListBuiltIn(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "policysetdefinitions.PolicySetDefinitionsClient", "ListBuiltIn", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c PolicySetDefinitionsClient) ListBuiltInCompleteMatchingPredicate(ctx context.Context, options ListBuiltInOperationOptions, predicate PolicySetDefinitionOperationPredicate) (resp ListBuiltInCompleteResult, err error) {
