...
func (c PolicySetDefinitionsClient) ListByManagementGroup(ctx context.Context, id commonids.ManagementGroupId, options ListByManagementGroupOperationOptions) (resp ListByManagementGroupOperationResponse, err error) {
	req, err := c.preparerForListByManagementGroup(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "policysetdefinitions.PolicySetDefinitionsClient", "ListByManagementGroup", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "policysetdefinitions.PolicySetDefinitionsClient", "ListByManagementGroup", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByManagementGroup(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "policysetdefinitions.PolicySetDefinitionsClient", "ListByManagementGroup", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c PolicySetDefinitionsClient) preparerForListByManagementGroup(ctx context.Context, id commonids.ManagementGroupId, options ListByManagementGroupOperationOptions) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/providers/Microsoft.Authorization/policySetDefinitions", id.ID())),
...
func (c PolicySetDefinitionsClient) preparerForListByManagementGroupWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c PolicySetDefinitionsClient) responderForListByManagementGroup(resp *http.Response) (result ListByManagementGroupOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByManagementGroupOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "policysetdefinitions.PolicySetDefinitionsClient", "ListByManagementGroup", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByManagementGroup(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "policysetdefinitions.PolicySetDefinitionsClient", "ListByManagementGroup", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c PolicySetDefinitionsClient) ListByManagementGroupCompleteMatchingPredicate(ctx context.Context, id commonids.ManagementGroupId, options ListByManagementGroupOperationOptions, predicate PolicySetDefinitionOperationPredicate) (resp ListByManagementGroupCompleteResult, err error) {
