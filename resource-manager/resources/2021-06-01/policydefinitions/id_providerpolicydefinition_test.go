...
func TestNewProviderPolicyDefinitionID(t *testing.T) {
	id := NewProviderPolicyDefinitionID("12345678-1234-9876-4563-123456789012", "policyDefinitionValue")
...
func TestFormatProviderPolicyDefinitionID(t *testing.T) {
	actual := NewProviderPolicyDefinitionID("12345678-1234-9876-4563-123456789012", "policyDefinitionValue").ID()
...
func TestParseProviderPolicyDefinitionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ProviderPolicyDefinitionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseProviderPolicyDefinitionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseProviderPolicyDefinitionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ProviderPolicyDefinitionId
	...
	for _, v := range testData {
		...
		actual, err := ParseProviderPolicyDefinitionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForProviderPolicyDefinitionId(t *testing.T) {
	segments := ProviderPolicyDefinitionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ProviderPolicyDefinitionId has no segments")
	}
