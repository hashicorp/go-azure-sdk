...
## `github.com/hashicorp/go-azure-sdk/resource-manager/resources/2022-09-01/tags` Documentation

The `tags` SDK allows for interaction with the Azure Resource Manager Service `resources` (API Version `2022-09-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/resources/2022-09-01/tags"
```
