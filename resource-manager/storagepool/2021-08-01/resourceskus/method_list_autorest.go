...
// List ...
func (c ResourceSkusClient) List(ctx context.Context, id LocationId) (resp ListOperationResponse, err error) {
...
func (c ResourceSkusClient) ListCompleteMatchingPredicate(ctx context.Context, id LocationId, predicate ResourceSkuInfoOperationPredicate) (resp ListCompleteResult, err error) {
...
func (c ResourceSkusClient) responderForList(resp *http.Response) (result ListOperationResponse, err error) {
	type page struct {
