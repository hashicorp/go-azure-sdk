...
// List ...
func (c DiskPoolZonesClient) List(ctx context.Context, id LocationId) (resp ListOperationResponse, err error) {
...
func (c DiskPoolZonesClient) ListCompleteMatchingPredicate(ctx context.Context, id LocationId, predicate DiskPoolZoneInfoOperationPredicate) (resp ListCompleteResult, err error) {
...
func (c DiskPoolZonesClient) responderForList(resp *http.Response) (result ListOperationResponse, err error) {
	type page struct {
