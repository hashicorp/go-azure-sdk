...
## `github.com/hashicorp/go-azure-sdk/resource-manager/datadog/2022-06-01/rules` Documentation

The `rules` SDK allows for interaction with Azure Resource Manager `datadog` (API Version `2022-06-01`).
