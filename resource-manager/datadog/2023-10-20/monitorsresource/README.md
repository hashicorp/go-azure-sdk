...
## `github.com/hashicorp/go-azure-sdk/resource-manager/datadog/2023-10-20/monitorsresource` Documentation

The `monitorsresource` SDK allows for interaction with Azure Resource Manager `datadog` (API Version `2023-10-20`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/datadog/2023-10-20/monitorsresource"
```
