...
## `github.com/hashicorp/go-azure-sdk/resource-manager/datadog/2023-10-20/rules` Documentation

The `rules` SDK allows for interaction with Azure Resource Manager `datadog` (API Version `2023-10-20`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/datadog/2023-10-20/rules"
```
