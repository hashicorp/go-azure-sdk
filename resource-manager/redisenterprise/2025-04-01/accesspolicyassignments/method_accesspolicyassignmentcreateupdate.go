...
func (c AccessPolicyAssignmentsClient) AccessPolicyAssignmentCreateUpdate(ctx context.Context, id AccessPolicyAssignmentId, input AccessPolicyAssignment) (result AccessPolicyAssignmentCreateUpdateOperationResponse, err error) {
...
func (c AccessPolicyAssignmentsClient) AccessPolicyAssignmentCreateUpdateThenPoll(ctx context.Context, id AccessPolicyAssignmentId, input AccessPolicyAssignment) error {
...
func (c AccessPolicyAssignmentsClient) AccessPolicyAssignmentCreateUpdateCallbackThenPoll(ctx context.Context, id AccessPolicyAssignmentId, input AccessPolicyAssignment, callback func() error) error {
