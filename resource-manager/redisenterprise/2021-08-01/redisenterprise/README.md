...
## `github.com/hashicorp/go-azure-sdk/resource-manager/redisenterprise/2021-08-01/redisenterprise` Documentation

The `redisenterprise` SDK allows for interaction with the Azure Resource Manager Service `redisenterprise` (API Version `2021-08-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/redisenterprise/2021-08-01/redisenterprise"
```
