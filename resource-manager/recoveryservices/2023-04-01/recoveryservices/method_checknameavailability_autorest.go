...
func (c RecoveryServicesClient) preparerForCheckNameAvailability(ctx context.Context, id ProviderLocationId, input CheckNameAvailabilityParameters) (*http.Request, error) {
