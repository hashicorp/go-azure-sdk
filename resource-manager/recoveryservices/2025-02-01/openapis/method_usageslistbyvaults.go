...
// UsagesListByVaults ...
func (c OpenapisClient) UsagesListByVaults(ctx context.Context, id VaultId) (result UsagesListByVaultsOperationResponse, err error) {
...
func (c OpenapisClient) UsagesListByVaultsComplete(ctx context.Context, id VaultId) (UsagesListByVaultsCompleteResult, error) {
...
func (c OpenapisClient) UsagesListByVaultsCompleteMatchingPredicate(ctx context.Context, id VaultId, predicate VaultUsageOperationPredicate) (result UsagesListByVaultsCompleteResult, err error) {
