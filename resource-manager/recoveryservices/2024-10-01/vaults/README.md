...
## `github.com/hashicorp/go-azure-sdk/resource-manager/recoveryservices/2024-10-01/vaults` Documentation

The `vaults` SDK allows for interaction with Azure Resource Manager `recoveryservices` (API Version `2024-10-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/recoveryservices/2024-10-01/vaults"
```
