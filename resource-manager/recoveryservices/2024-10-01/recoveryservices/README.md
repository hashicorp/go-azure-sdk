...
## `github.com/hashicorp/go-azure-sdk/resource-manager/recoveryservices/2024-10-01/recoveryservices` Documentation

The `recoveryservices` SDK allows for interaction with Azure Resource Manager `recoveryservices` (API Version `2024-10-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/recoveryservices/2024-10-01/recoveryservices"
```
