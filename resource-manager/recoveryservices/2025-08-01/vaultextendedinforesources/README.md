...
## `github.com/hashicorp/go-azure-sdk/resource-manager/recoveryservices/2025-08-01/vaultextendedinforesources` Documentation

The `vaultextendedinforesources` SDK allows for interaction with Azure Resource Manager `recoveryservices` (API Version `2025-08-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/recoveryservices/2025-08-01/vaultextendedinforesources"
```
