...
func TestFormatDeletedVaultID(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.RecoveryServices/locations/locationName/deletedVaults/deletedVaultName"
	if actual != expected {
...
func TestParseDeletedVaultID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.RecoveryServices/locations/locationName/deletedVaults/deletedVaultName/extra",
			Error: true,
		},
	}
