...
func NewOperationID(subscriptionId string, locationName string, deletedVaultName string, operationId string) OperationId {
	return OperationId{
...
func (id OperationId) ID() string {
	fmtString := "/subscriptions/%s/providers/Microsoft.RecoveryServices/locations/%s/deletedVaults/%s/operations/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.LocationName, id.DeletedVaultName, id.OperationId)
}
