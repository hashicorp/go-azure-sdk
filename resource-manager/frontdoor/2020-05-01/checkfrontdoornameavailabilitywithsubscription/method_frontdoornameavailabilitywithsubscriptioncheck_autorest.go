...
type FrontDoorNameAvailabilityWithSubscriptionCheckOperationResponse struct {
	HttpResponse *http.Response
	Model        *CheckNameAvailabilityOutput
}

// FrontDoorNameAvailabilityWithSubscriptionCheck ...
func (c CheckFrontDoorNameAvailabilityWithSubscriptionClient) FrontDoorNameAvailabilityWithSubscriptionCheck(ctx context.Context, id commonids.SubscriptionId, input CheckNameAvailabilityInput) (result FrontDoorNameAvailabilityWithSubscriptionCheckOperationResponse, err error) {
...
func (c CheckFrontDoorNameAvailabilityWithSubscriptionClient) preparerForFrontDoorNameAvailabilityWithSubscriptionCheck(ctx context.Context, id commonids.SubscriptionId, input CheckNameAvailabilityInput) (*http.Request, error) {
...
func (c CheckFrontDoorNameAvailabilityWithSubscriptionClient) responderForFrontDoorNameAvailabilityWithSubscriptionCheck(resp *http.Response) (result FrontDoorNameAvailabilityWithSubscriptionCheckOperationResponse, err error) {
