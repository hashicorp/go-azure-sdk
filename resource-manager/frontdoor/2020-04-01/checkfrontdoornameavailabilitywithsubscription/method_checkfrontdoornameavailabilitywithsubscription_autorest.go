...
type CheckFrontDoorNameAvailabilityWithSubscriptionOperationResponse struct {
	HttpResponse *http.Response
	Model        *CheckNameAvailabilityOutput
}

// CheckFrontDoorNameAvailabilityWithSubscription ...
func (c CheckFrontDoorNameAvailabilityWithSubscriptionClient) CheckFrontDoorNameAvailabilityWithSubscription(ctx context.Context, id commonids.SubscriptionId, input CheckNameAvailabilityInput) (result CheckFrontDoorNameAvailabilityWithSubscriptionOperationResponse, err error) {
...
func (c CheckFrontDoorNameAvailabilityWithSubscriptionClient) preparerForCheckFrontDoorNameAvailabilityWithSubscription(ctx context.Context, id commonids.SubscriptionId, input CheckNameAvailabilityInput) (*http.Request, error) {
...
func (c CheckFrontDoorNameAvailabilityWithSubscriptionClient) responderForCheckFrontDoorNameAvailabilityWithSubscription(resp *http.Response) (result CheckFrontDoorNameAvailabilityWithSubscriptionOperationResponse, err error) {
