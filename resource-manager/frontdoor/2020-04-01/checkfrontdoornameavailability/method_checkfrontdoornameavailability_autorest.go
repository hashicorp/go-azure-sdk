...
type CheckFrontDoorNameAvailabilityOperationResponse struct {
	HttpResponse *http.Response
	Model        *CheckNameAvailabilityOutput
}

// CheckFrontDoorNameAvailability ...
func (c CheckFrontDoorNameAvailabilityClient) CheckFrontDoorNameAvailability(ctx context.Context, input CheckNameAvailabilityInput) (result CheckFrontDoorNameAvailabilityOperationResponse, err error) {
...
func (c CheckFrontDoorNameAvailabilityClient) responderForCheckFrontDoorNameAvailability(resp *http.Response) (result CheckFrontDoorNameAvailabilityOperationResponse, err error) {
