...
## `github.com/hashicorp/go-azure-sdk/resource-manager/loadtestservice/2022-04-15-preview/loadtests` Documentation

The `loadtests` SDK allows for interaction with the Azure Resource Manager Service `loadtestservice` (API Version `2022-04-15-preview`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/loadtestservice/2022-04-15-preview/loadtests"
```
