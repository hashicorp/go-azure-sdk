...
func (c VirtualMachineTemplatesClient) CreateCallbackThenPoll(ctx context.Context, id VirtualMachineTemplateId, input VirtualMachineTemplate, callback func() error) error {
