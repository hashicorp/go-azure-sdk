...
## `github.com/hashicorp/go-azure-sdk/resource-manager/connectedvmware/2023-10-01/inventoryitems` Documentation

The `inventoryitems` SDK allows for interaction with Azure Resource Manager `connectedvmware` (API Version `2023-10-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/connectedvmware/2023-10-01/inventoryitems"
```
