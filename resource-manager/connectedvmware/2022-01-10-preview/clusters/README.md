...
## `github.com/hashicorp/go-azure-sdk/resource-manager/connectedvmware/2022-01-10-preview/clusters` Documentation

The `clusters` SDK allows for interaction with Azure Resource Manager `connectedvmware` (API Version `2022-01-10-preview`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/connectedvmware/2022-01-10-preview/clusters"
```
