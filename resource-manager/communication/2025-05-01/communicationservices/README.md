...
## `github.com/hashicorp/go-azure-sdk/resource-manager/communication/2025-05-01/communicationservices` Documentation

The `communicationservices` SDK allows for interaction with Azure Resource Manager `communication` (API Version `2025-05-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/communication/2025-05-01/communicationservices"
```
