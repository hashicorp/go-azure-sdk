...
## `github.com/hashicorp/go-azure-sdk/resource-manager/communication/2025-05-01/senderusernames` Documentation

The `senderusernames` SDK allows for interaction with Azure Resource Manager `communication` (API Version `2025-05-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/communication/2025-05-01/senderusernames"
```
