...
func (c BatchDeploymentClient) Update(ctx context.Context, id DeploymentId, input PartialBatchDeploymentPartialMinimalTrackedResourceWithProperties) (result UpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "batchdeployment.BatchDeploymentClient", "Update", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForUpdate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "batchdeployment.BatchDeploymentClient", "Update", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c BatchDeploymentClient) preparerForUpdate(ctx context.Context, id DeploymentId, input PartialBatchDeploymentPartialMinimalTrackedResourceWithProperties) (*http.Request, error) {
...
func (c BatchDeploymentClient) senderForUpdate(ctx context.Context, req *http.Request) (future UpdateOperationResponse, err error) {
