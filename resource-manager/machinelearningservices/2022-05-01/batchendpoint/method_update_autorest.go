...
func (c BatchEndpointClient) Update(ctx context.Context, id BatchEndpointId, input PartialMinimalTrackedResourceWithIdentity) (result UpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "batchendpoint.BatchEndpointClient", "Update", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForUpdate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "batchendpoint.BatchEndpointClient", "Update", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c BatchEndpointClient) preparerForUpdate(ctx context.Context, id BatchEndpointId, input PartialMinimalTrackedResourceWithIdentity) (*http.Request, error) {
...
func (c BatchEndpointClient) senderForUpdate(ctx context.Context, req *http.Request) (future UpdateOperationResponse, err error) {
