...
func NewClientWithBaseURI(endpoint string, configureAuthFunc func(c *autorest.Client)) Client {
	...
	dataContainerRegistryClient := datacontainerregistry.NewDataContainerRegistryClientWithBaseURI(endpoint)
	configureAuthFunc(&dataContainerRegistryClient.Client)

	dataVersionClient := dataversion.NewDataVersionClientWithBaseURI(endpoint)
	configureAuthFunc(&dataVersionClient.Client)

	dataVersionRegistryClient := dataversionregistry.NewDataVersionRegistryClientWithBaseURI(endpoint)
	configureAuthFunc(&dataVersionRegistryClient.Client)
	...
	registryManagementClient := registrymanagement.NewRegistryManagementClientWithBaseURI(endpoint)
	configureAuthFunc(&registryManagementClient.Client)
