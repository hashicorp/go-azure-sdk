...
func (c WorkspacePrivateEndpointConnectionsClient) PrivateEndpointConnectionsList(ctx context.Context, id WorkspaceId) (result PrivateEndpointConnectionsListOperationResponse, err error) {
