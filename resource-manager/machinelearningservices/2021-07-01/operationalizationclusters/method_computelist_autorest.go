...
// ComputeList ...
func (c OperationalizationClustersClient) ComputeList(ctx context.Context, id WorkspaceId, options ComputeListOperationOptions) (resp ComputeListOperationResponse, err error) {
	req, err := c.preparerForComputeList(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "operationalizationclusters.OperationalizationClustersClient", "ComputeList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "operationalizationclusters.OperationalizationClustersClient", "ComputeList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForComputeList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "operationalizationclusters.OperationalizationClustersClient", "ComputeList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c OperationalizationClustersClient) preparerForComputeListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c OperationalizationClustersClient) responderForComputeList(resp *http.Response) (result ComputeListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ComputeListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "operationalizationclusters.OperationalizationClustersClient", "ComputeList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForComputeList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "operationalizationclusters.OperationalizationClustersClient", "ComputeList", result.HttpResponse, "Failure responding to request")
				return
			}
