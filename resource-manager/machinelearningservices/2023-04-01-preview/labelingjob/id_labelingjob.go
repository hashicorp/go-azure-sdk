...
func (id *LabelingJobId) FromParseResult(input resourceids.ParseResult) error {
	var ok bool
	...
	if id.LabelingJobName, ok = input.Parsed["labelingJobName"]; !ok {
		return resourceids.NewSegmentNotSpecifiedError(id, "labelingJobName", input)
	}
