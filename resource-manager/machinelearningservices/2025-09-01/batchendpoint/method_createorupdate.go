...
func (c BatchEndpointClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id BatchEndpointId, input BatchEndpointTrackedResource, callback func() error) error {
