...
func (c BatchDeploymentClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id DeploymentId, input BatchDeploymentTrackedResource, callback func() error) error {
