...
func (c OnlineDeploymentClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id OnlineEndpointDeploymentId, input OnlineDeploymentTrackedResource, callback func() error) error {
