...
type ManagedNetworkSettings struct {
	EnableFirewallLog       *bool                          `json:"enableFirewallLog,omitempty"`
	EnableNetworkMonitor    *bool                          `json:"enableNetworkMonitor,omitempty"`
...
func (s *ManagedNetworkSettings) UnmarshalJSON(bytes []byte) error {
	...
	s.EnableFirewallLog = decoded.EnableFirewallLog
	s.EnableNetworkMonitor = decoded.EnableNetworkMonitor
