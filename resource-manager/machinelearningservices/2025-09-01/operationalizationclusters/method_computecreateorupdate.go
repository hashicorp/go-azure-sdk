...
func (c OperationalizationClustersClient) ComputeCreateOrUpdateCallbackThenPoll(ctx context.Context, id ComputeId, input ComputeResource, callback func() error) error {
