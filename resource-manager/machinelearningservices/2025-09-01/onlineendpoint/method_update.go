...
func (c OnlineEndpointClient) UpdateCallbackThenPoll(ctx context.Context, id OnlineEndpointId, input PartialMinimalTrackedResourceWithIdentity, callback func() error) error {
