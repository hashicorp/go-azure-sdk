...
func (c BatchEndpointClient) UpdateCallbackThenPoll(ctx context.Context, id BatchEndpointId, input PartialMinimalTrackedResourceWithIdentity, callback func() error) error {
