...
func (c FeaturesetContainerClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id FeatureSetId, input FeaturesetContainerResource, callback func() error) error {
