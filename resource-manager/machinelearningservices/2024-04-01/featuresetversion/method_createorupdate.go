...
func (c FeaturesetVersionClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id FeatureSetVersionId, input FeaturesetVersionResource, callback func() error) error {
