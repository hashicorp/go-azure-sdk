...
func (c OnlineEndpointClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id OnlineEndpointId, input OnlineEndpointTrackedResource, callback func() error) error {
