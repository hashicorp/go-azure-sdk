...
func (c FeaturestoreEntityContainerClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id FeatureStoreEntityId, input FeaturestoreEntityContainerResource, callback func() error) error {
