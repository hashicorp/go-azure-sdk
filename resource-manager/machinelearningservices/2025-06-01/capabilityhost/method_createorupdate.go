...
func (c CapabilityHostClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id CapabilityHostId, input CapabilityHostResource, callback func() error) error {
