...
func (c BatchDeploymentClient) UpdateCallbackThenPoll(ctx context.Context, id DeploymentId, input PartialBatchDeploymentPartialMinimalTrackedResourceWithProperties, callback func() error) error {
