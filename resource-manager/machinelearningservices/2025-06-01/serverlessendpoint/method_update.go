...
func (c ServerlessEndpointClient) UpdateCallbackThenPoll(ctx context.Context, id ServerlessEndpointId, input PartialMinimalTrackedResourceWithSkuAndIdentity, callback func() error) error {
