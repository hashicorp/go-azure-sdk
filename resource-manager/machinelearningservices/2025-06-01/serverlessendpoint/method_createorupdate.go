...
func (c ServerlessEndpointClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ServerlessEndpointId, input ServerlessEndpointTrackedResource, callback func() error) error {
