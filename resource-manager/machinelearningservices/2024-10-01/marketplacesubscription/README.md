...
## `github.com/hashicorp/go-azure-sdk/resource-manager/machinelearningservices/2024-10-01/marketplacesubscription` Documentation

The `marketplacesubscription` SDK allows for interaction with Azure Resource Manager `machinelearningservices` (API Version `2024-10-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/machinelearningservices/2024-10-01/marketplacesubscription"
```
