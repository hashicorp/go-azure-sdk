...
func (c ApplicationClient) preparerForUpdate(ctx context.Context, id ApplicationId, input ApplicationResourceUpdate) (*http.Request, error) {
...
func (c ApplicationClient) senderForUpdate(ctx context.Context, req *http.Request) (future UpdateOperationResponse, err error) {
