...
func (id ProductId) ID() string {
	fmtString := "/providers/Microsoft.Billing/billingAccounts/%s/customers/%s/products/%s"
	return fmt.Sprintf(fmtString, id.BillingAccountName, id.CustomerName, id.ProductName)
}
...
func (id ProductId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("productName", "productName"),
	}
}
