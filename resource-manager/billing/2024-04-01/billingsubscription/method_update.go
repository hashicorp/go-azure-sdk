...
func (c BillingSubscriptionClient) UpdateCallbackThenPoll(ctx context.Context, id BillingAccountBillingSubscriptionId, input BillingSubscriptionPatch, callback func() error) error {
