...
func init() {
	recaser.RegisterResourceId(&SavingsPlanOrderId{})
}
...
func (id SavingsPlanOrderId) ID() string {
	fmtString := "/providers/Microsoft.Billing/billingAccounts/%s/savingsPlanOrders/%s"
	return fmt.Sprintf(fmtString, id.BillingAccountName, id.SavingsPlanOrderId)
}
