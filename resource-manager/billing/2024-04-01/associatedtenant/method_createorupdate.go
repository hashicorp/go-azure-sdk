...
func (c AssociatedTenantClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id AssociatedTenantId, input AssociatedTenant, callback func() error) error {
