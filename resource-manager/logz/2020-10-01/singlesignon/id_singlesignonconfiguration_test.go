...
func TestFormatSingleSignOnConfigurationID(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Logz/monitors/monitorName/singleSignOnConfigurations/singleSignOnConfigurationName"
	if actual != expected {
...
func TestParseSingleSignOnConfigurationID(t *testing.T) {
	testData := []struct {
		...
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Logz/monitors/monitorName/singleSignOnConfigurations/singleSignOnConfigurationName",
			Expected: &SingleSignOnConfigurationId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Logz/monitors/monitorName/singleSignOnConfigurations/singleSignOnConfigurationName/extra",
			Error: true,
		},
	}
