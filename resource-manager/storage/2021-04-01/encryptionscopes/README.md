...
## `github.com/hashicorp/go-azure-sdk/resource-manager/storage/2021-04-01/encryptionscopes` Documentation

The `encryptionscopes` SDK allows for interaction with the Azure Resource Manager Service `storage` (API Version `2021-04-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/storage/2021-04-01/encryptionscopes"
```
