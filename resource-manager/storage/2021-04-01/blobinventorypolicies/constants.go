...
func PossibleValuesForBlobInventoryPolicyName() []string {
	return []string{
		string(BlobInventoryPolicyNameDefault),
	}
}

func parseBlobInventoryPolicyName(input string) (*BlobInventoryPolicyName, error) {
	vals := map[string]BlobInventoryPolicyName{
		"default": BlobInventoryPolicyNameDefault,
	}
	...
	out := BlobInventoryPolicyName(input)
	return &out, nil
}
