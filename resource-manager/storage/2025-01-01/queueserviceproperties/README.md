...
## `github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-01-01/queueserviceproperties` Documentation

The `queueserviceproperties` SDK allows for interaction with Azure Resource Manager `storage` (API Version `2025-01-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-01-01/queueserviceproperties"
```
