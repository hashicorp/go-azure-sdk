...
func (c PrivateEndpointConnectionProxiesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id PrivateEndpointConnectionProxyId, input PrivateEndpointConnectionProxy, callback func() error) error {
