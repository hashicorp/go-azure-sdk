...
func TestParsePrivateEndpointConnectionProxyID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
	...
	for _, v := range testData {
		...
		actual, err := ParsePrivateEndpointConnectionProxyID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
		...
		if actual.PrivateEndpointConnectionProxyId != v.Expected.PrivateEndpointConnectionProxyId {
			t.Fatalf("Expected %q but got %q for PrivateEndpointConnectionProxyId", v.Expected.PrivateEndpointConnectionProxyId, actual.PrivateEndpointConnectionProxyId)
		}

	}
}

func TestParsePrivateEndpointConnectionProxyIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *PrivateEndpointConnectionProxyId
	...
	for _, v := range testData {
		...
		actual, err := ParsePrivateEndpointConnectionProxyIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForPrivateEndpointConnectionProxyId(t *testing.T) {
	segments := PrivateEndpointConnectionProxyId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("PrivateEndpointConnectionProxyId has no segments")
	}
