...
func TestFormatPrivateEndpointConnectionID(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.HDInsight/clusters/clusterValue/privateEndpointConnections/privateEndpointConnectionValue"
	if actual != expected {
...
func TestParsePrivateEndpointConnectionID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.HDInsight/clusters/clusterValue/privateEndpointConnections",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.HDInsight/clusters/clusterValue/privateEndpointConnections/privateEndpointConnectionValue",
			Expected: &PrivateEndpointConnectionId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.HDInsight/clusters/clusterValue/privateEndpointConnections/privateEndpointConnectionValue/extra",
			Error: true,
		},
	}
