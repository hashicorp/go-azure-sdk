...
// Update ...
func (c SqlMigrationServicesClient) Update(ctx context.Context, id SqlMigrationServiceId, input SqlMigrationServiceUpdate) (result UpdateOperationResponse, err error) {
