...
func TestNewSubscriptionResourceGroupID(t *testing.T) {
	id := NewSubscriptionResourceGroupID("12345678-1234-9876-4563-123456789012", "resourceGroupName")
...
func TestFormatSubscriptionResourceGroupID(t *testing.T) {
	actual := NewSubscriptionResourceGroupID("12345678-1234-9876-4563-123456789012", "resourceGroupName").ID()
