...
func (c StandardOperationClient) ServicesListByResourceGroup(ctx context.Context, id SubscriptionResourceGroupId) (result ServicesListByResourceGroupOperationResponse, err error) {
...
func (c StandardOperationClient) ServicesListByResourceGroupComplete(ctx context.Context, id SubscriptionResourceGroupId) (ServicesListByResourceGroupCompleteResult, error) {
...
func (c StandardOperationClient) ServicesListByResourceGroupCompleteMatchingPredicate(ctx context.Context, id SubscriptionResourceGroupId, predicate DataMigrationServiceOperationPredicate) (result ServicesListByResourceGroupCompleteResult, err error) {
