...
const (
	...
	CommandTypeMigratePointSqlServerPointAzureDbSqlMiPointComplete CommandType = "Migrate.SqlServer.AzureDbSqlMi.Complete"
	CommandTypeMigratePointSyncPointCompletePointDatabase          CommandType = "Migrate.Sync.Complete.Database"
	CommandTypeRestart                                             CommandType = "restart"
)

func PossibleValuesForCommandType() []string {
	return []string{
		string(CommandTypeCancel),
		string(CommandTypeFinish),
		string(CommandTypeMigratePointSqlServerPointAzureDbSqlMiPointComplete),
		string(CommandTypeMigratePointSyncPointCompletePointDatabase),
		string(CommandTypeRestart),
	}
}

func (s *CommandType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseCommandType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseCommandType(input string) (*CommandType, error) {
	vals := map[string]CommandType{
		"cancel": CommandTypeCancel,
		"finish": CommandTypeFinish,
		"migrate.sqlserver.azuredbsqlmi.complete": CommandTypeMigratePointSqlServerPointAzureDbSqlMiPointComplete,
		"migrate.sync.complete.database":          CommandTypeMigratePointSyncPointCompletePointDatabase,
		"restart":                                 CommandTypeRestart,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForServerLevelPermissionsGroup() []string {
	return []string{
		...
		string(ServerLevelPermissionsGroupMigrationFromSqlServerToAzureVM),
	}
}
...
func parseServerLevelPermissionsGroup(input string) (*ServerLevelPermissionsGroup, error) {
	vals := map[string]ServerLevelPermissionsGroup{
		...
		"migrationfromsqlservertoazurevm":     ServerLevelPermissionsGroupMigrationFromSqlServerToAzureVM,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
const (
	TaskTypeConnectPointMongoDb                                                    TaskType = "Connect.MongoDb"
	TaskTypeConnectToSourcePointMySql                                              TaskType = "ConnectToSource.MySql"
	TaskTypeConnectToSourcePointOraclePointSync                                    TaskType = "ConnectToSource.Oracle.Sync"
	TaskTypeConnectToSourcePointPostgreSqlPointSync                                TaskType = "ConnectToSource.PostgreSql.Sync"
	TaskTypeConnectToSourcePointSqlServer                                          TaskType = "ConnectToSource.SqlServer"
	TaskTypeConnectToSourcePointSqlServerPointSync                                 TaskType = "ConnectToSource.SqlServer.Sync"
	TaskTypeConnectToTargetPointAzureDbForMySql                                    TaskType = "ConnectToTarget.AzureDbForMySql"
	TaskTypeConnectToTargetPointAzureDbForPostgreSqlPointSync                      TaskType = "ConnectToTarget.AzureDbForPostgreSql.Sync"
	TaskTypeConnectToTargetPointAzureSqlDbMI                                       TaskType = "ConnectToTarget.AzureSqlDbMI"
	TaskTypeConnectToTargetPointAzureSqlDbMIPointSyncPointLRS                      TaskType = "ConnectToTarget.AzureSqlDbMI.Sync.LRS"
	TaskTypeConnectToTargetPointOraclePointAzureDbForPostgreSqlPointSync           TaskType = "ConnectToTarget.Oracle.AzureDbForPostgreSql.Sync"
	TaskTypeConnectToTargetPointSqlDb                                              TaskType = "ConnectToTarget.SqlDb"
	TaskTypeConnectToTargetPointSqlDbPointSync                                     TaskType = "ConnectToTarget.SqlDb.Sync"
	TaskTypeGetTDECertificatesPointSql                                             TaskType = "GetTDECertificates.Sql"
	TaskTypeGetUserTablesMySql                                                     TaskType = "GetUserTablesMySql"
	TaskTypeGetUserTablesOracle                                                    TaskType = "GetUserTablesOracle"
	TaskTypeGetUserTablesPointAzureSqlDbPointSync                                  TaskType = "GetUserTables.AzureSqlDb.Sync"
	TaskTypeGetUserTablesPointSql                                                  TaskType = "GetUserTables.Sql"
	TaskTypeGetUserTablesPostgreSql                                                TaskType = "GetUserTablesPostgreSql"
	TaskTypeMigratePointMongoDb                                                    TaskType = "Migrate.MongoDb"
	TaskTypeMigratePointMySqlPointAzureDbForMySql                                  TaskType = "Migrate.MySql.AzureDbForMySql"
	TaskTypeMigratePointMySqlPointAzureDbForMySqlPointSync                         TaskType = "Migrate.MySql.AzureDbForMySql.Sync"
	TaskTypeMigratePointOraclePointAzureDbForPostgreSqlPointSync                   TaskType = "Migrate.Oracle.AzureDbForPostgreSql.Sync"
	TaskTypeMigratePointPostgreSqlPointAzureDbForPostgreSqlPointSyncVTwo           TaskType = "Migrate.PostgreSql.AzureDbForPostgreSql.SyncV2"
	TaskTypeMigratePointSqlServerPointAzureSqlDbMI                                 TaskType = "Migrate.SqlServer.AzureSqlDbMI"
	TaskTypeMigratePointSqlServerPointAzureSqlDbMIPointSyncPointLRS                TaskType = "Migrate.SqlServer.AzureSqlDbMI.Sync.LRS"
	TaskTypeMigratePointSqlServerPointAzureSqlDbPointSync                          TaskType = "Migrate.SqlServer.AzureSqlDb.Sync"
	TaskTypeMigratePointSqlServerPointSqlDb                                        TaskType = "Migrate.SqlServer.SqlDb"
	TaskTypeMigratePointSsis                                                       TaskType = "Migrate.Ssis"
	TaskTypeMigrateSchemaSqlServerSqlDb                                            TaskType = "MigrateSchemaSqlServerSqlDb"
	TaskTypeServicePointCheckPointOCI                                              TaskType = "Service.Check.OCI"
	TaskTypeServicePointInstallPointOCI                                            TaskType = "Service.Install.OCI"
	TaskTypeServicePointUploadPointOCI                                             TaskType = "Service.Upload.OCI"
	TaskTypeValidateMigrationInputPointSqlServerPointAzureSqlDbMI                  TaskType = "ValidateMigrationInput.SqlServer.AzureSqlDbMI"
	TaskTypeValidateMigrationInputPointSqlServerPointAzureSqlDbMIPointSyncPointLRS TaskType = "ValidateMigrationInput.SqlServer.AzureSqlDbMI.Sync.LRS"
	TaskTypeValidateMigrationInputPointSqlServerPointSqlDbPointSync                TaskType = "ValidateMigrationInput.SqlServer.SqlDb.Sync"
	TaskTypeValidatePointMongoDb                                                   TaskType = "Validate.MongoDb"
	TaskTypeValidatePointOraclePointAzureDbPostgreSqlPointSync                     TaskType = "Validate.Oracle.AzureDbPostgreSql.Sync"
)

func PossibleValuesForTaskType() []string {
	return []string{
		string(TaskTypeConnectPointMongoDb),
		string(TaskTypeConnectToSourcePointMySql),
		string(TaskTypeConnectToSourcePointOraclePointSync),
		string(TaskTypeConnectToSourcePointPostgreSqlPointSync),
		string(TaskTypeConnectToSourcePointSqlServer),
		string(TaskTypeConnectToSourcePointSqlServerPointSync),
		string(TaskTypeConnectToTargetPointAzureDbForMySql),
		string(TaskTypeConnectToTargetPointAzureDbForPostgreSqlPointSync),
		string(TaskTypeConnectToTargetPointAzureSqlDbMI),
		string(TaskTypeConnectToTargetPointAzureSqlDbMIPointSyncPointLRS),
		string(TaskTypeConnectToTargetPointOraclePointAzureDbForPostgreSqlPointSync),
		string(TaskTypeConnectToTargetPointSqlDb),
		string(TaskTypeConnectToTargetPointSqlDbPointSync),
		string(TaskTypeGetTDECertificatesPointSql),
		string(TaskTypeGetUserTablesMySql),
		string(TaskTypeGetUserTablesOracle),
		string(TaskTypeGetUserTablesPointAzureSqlDbPointSync),
		string(TaskTypeGetUserTablesPointSql),
		string(TaskTypeGetUserTablesPostgreSql),
		string(TaskTypeMigratePointMongoDb),
		string(TaskTypeMigratePointMySqlPointAzureDbForMySql),
		string(TaskTypeMigratePointMySqlPointAzureDbForMySqlPointSync),
		...
		string(TaskTypeMigratePointSqlServerPointAzureSqlDbMI),
		string(TaskTypeMigratePointSqlServerPointAzureSqlDbMIPointSyncPointLRS),
		string(TaskTypeMigratePointSqlServerPointAzureSqlDbPointSync),
		string(TaskTypeMigratePointSqlServerPointSqlDb),
		string(TaskTypeMigratePointSsis),
		string(TaskTypeMigrateSchemaSqlServerSqlDb),
		string(TaskTypeServicePointCheckPointOCI),
		string(TaskTypeServicePointInstallPointOCI),
		string(TaskTypeServicePointUploadPointOCI),
		string(TaskTypeValidateMigrationInputPointSqlServerPointAzureSqlDbMI),
		string(TaskTypeValidateMigrationInputPointSqlServerPointAzureSqlDbMIPointSyncPointLRS),
		string(TaskTypeValidateMigrationInputPointSqlServerPointSqlDbPointSync),
		string(TaskTypeValidatePointMongoDb),
		string(TaskTypeValidatePointOraclePointAzureDbPostgreSqlPointSync),
	}
}
...
func parseTaskType(input string) (*TaskType, error) {
	vals := map[string]TaskType{
		"connect.mongodb":                                        TaskTypeConnectPointMongoDb,
		"connecttosource.mysql":                                  TaskTypeConnectToSourcePointMySql,
		"connecttosource.oracle.sync":                            TaskTypeConnectToSourcePointOraclePointSync,
		"connecttosource.postgresql.sync":                        TaskTypeConnectToSourcePointPostgreSqlPointSync,
		"connecttosource.sqlserver":                              TaskTypeConnectToSourcePointSqlServer,
		"connecttosource.sqlserver.sync":                         TaskTypeConnectToSourcePointSqlServerPointSync,
		"connecttotarget.azuredbformysql":                        TaskTypeConnectToTargetPointAzureDbForMySql,
		"connecttotarget.azuredbforpostgresql.sync":              TaskTypeConnectToTargetPointAzureDbForPostgreSqlPointSync,
		"connecttotarget.azuresqldbmi":                           TaskTypeConnectToTargetPointAzureSqlDbMI,
		"connecttotarget.azuresqldbmi.sync.lrs":                  TaskTypeConnectToTargetPointAzureSqlDbMIPointSyncPointLRS,
		"connecttotarget.oracle.azuredbforpostgresql.sync":       TaskTypeConnectToTargetPointOraclePointAzureDbForPostgreSqlPointSync,
		"connecttotarget.sqldb":                                  TaskTypeConnectToTargetPointSqlDb,
		"connecttotarget.sqldb.sync":                             TaskTypeConnectToTargetPointSqlDbPointSync,
		"gettdecertificates.sql":                                 TaskTypeGetTDECertificatesPointSql,
		"getusertablesmysql":                                     TaskTypeGetUserTablesMySql,
		"getusertablesoracle":                                    TaskTypeGetUserTablesOracle,
		"getusertables.azuresqldb.sync":                          TaskTypeGetUserTablesPointAzureSqlDbPointSync,
		"getusertables.sql":                                      TaskTypeGetUserTablesPointSql,
		"getusertablespostgresql":                                TaskTypeGetUserTablesPostgreSql,
		"migrate.mongodb":                                        TaskTypeMigratePointMongoDb,
		"migrate.mysql.azuredbformysql":                          TaskTypeMigratePointMySqlPointAzureDbForMySql,
		"migrate.mysql.azuredbformysql.sync":                     TaskTypeMigratePointMySqlPointAzureDbForMySqlPointSync,
		"migrate.oracle.azuredbforpostgresql.sync":               TaskTypeMigratePointOraclePointAzureDbForPostgreSqlPointSync,
		"migrate.postgresql.azuredbforpostgresql.syncv2":         TaskTypeMigratePointPostgreSqlPointAzureDbForPostgreSqlPointSyncVTwo,
		"migrate.sqlserver.azuresqldbmi":                         TaskTypeMigratePointSqlServerPointAzureSqlDbMI,
		"migrate.sqlserver.azuresqldbmi.sync.lrs":                TaskTypeMigratePointSqlServerPointAzureSqlDbMIPointSyncPointLRS,
		"migrate.sqlserver.azuresqldb.sync":                      TaskTypeMigratePointSqlServerPointAzureSqlDbPointSync,
		"migrate.sqlserver.sqldb":                                TaskTypeMigratePointSqlServerPointSqlDb,
		"migrate.ssis":                                           TaskTypeMigratePointSsis,
		"migrateschemasqlserversqldb":                            TaskTypeMigrateSchemaSqlServerSqlDb,
		"service.check.oci":                                      TaskTypeServicePointCheckPointOCI,
		"service.install.oci":                                    TaskTypeServicePointInstallPointOCI,
		"service.upload.oci":                                     TaskTypeServicePointUploadPointOCI,
		"validatemigrationinput.sqlserver.azuresqldbmi":          TaskTypeValidateMigrationInputPointSqlServerPointAzureSqlDbMI,
		"validatemigrationinput.sqlserver.azuresqldbmi.sync.lrs": TaskTypeValidateMigrationInputPointSqlServerPointAzureSqlDbMIPointSyncPointLRS,
		"validatemigrationinput.sqlserver.sqldb.sync":            TaskTypeValidateMigrationInputPointSqlServerPointSqlDbPointSync,
		"validate.mongodb":                                       TaskTypeValidatePointMongoDb,
		"validate.oracle.azuredbpostgresql.sync":                 TaskTypeValidatePointOraclePointAzureDbPostgreSqlPointSync,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
