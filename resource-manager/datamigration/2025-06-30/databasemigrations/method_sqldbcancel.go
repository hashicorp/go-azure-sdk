...
type SqlDbcancelOperationResponse struct {
...
// SqlDbcancel ...
func (c DatabaseMigrationsClient) SqlDbcancel(ctx context.Context, id DatabaseMigrationId, input MigrationOperationInput) (result SqlDbcancelOperationResponse, err error) {
...
func (c DatabaseMigrationsClient) SqlDbcancelThenPoll(ctx context.Context, id DatabaseMigrationId, input MigrationOperationInput) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after SqlDbcancel: %+v", err)
	}
