...
type SqlDbretryOperationResponse struct {
...
// SqlDbretry ...
func (c DatabaseMigrationsClient) SqlDbretry(ctx context.Context, id DatabaseMigrationId, input MigrationOperationInput) (result SqlDbretryOperationResponse, err error) {
...
func (c DatabaseMigrationsClient) SqlDbretryThenPoll(ctx context.Context, id DatabaseMigrationId, input MigrationOperationInput) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after SqlDbretry: %+v", err)
	}
