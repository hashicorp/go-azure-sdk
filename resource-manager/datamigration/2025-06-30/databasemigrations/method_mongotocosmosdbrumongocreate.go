...
type MongoToCosmosDbRUMongoCreateOperationResponse struct {
...
func (c DatabaseMigrationsClient) MongoToCosmosDbRUMongoCreate(ctx context.Context, id DatabaseAccountProviders2DatabaseMigrationId, input DatabaseMigrationCosmosDbMongo) (result MongoToCosmosDbRUMongoCreateOperationResponse, err error) {
...
func (c DatabaseMigrationsClient) MongoToCosmosDbRUMongoCreateThenPoll(ctx context.Context, id DatabaseAccountProviders2DatabaseMigrationId, input DatabaseMigrationCosmosDbMongo) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after MongoToCosmosDbRUMongoCreate: %+v", err)
	}
