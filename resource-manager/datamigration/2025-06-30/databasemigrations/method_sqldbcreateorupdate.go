...
type SqlDbCreateOrUpdateOperationResponse struct {
...
// SqlDbCreateOrUpdate ...
func (c DatabaseMigrationsClient) SqlDbCreateOrUpdate(ctx context.Context, id DatabaseMigrationId, input DatabaseMigrationSqlDb) (result SqlDbCreateOrUpdateOperationResponse, err error) {
...
func (c DatabaseMigrationsClient) SqlDbCreateOrUpdateThenPoll(ctx context.Context, id DatabaseMigrationId, input DatabaseMigrationSqlDb) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after SqlDbCreateOrUpdate: %+v", err)
	}
