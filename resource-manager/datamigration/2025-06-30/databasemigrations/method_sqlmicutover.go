...
type SqlMicutoverOperationResponse struct {
...
// SqlMicutover ...
func (c DatabaseMigrationsClient) SqlMicutover(ctx context.Context, id Providers2DatabaseMigrationId, input MigrationOperationInput) (result SqlMicutoverOperationResponse, err error) {
...
func (c DatabaseMigrationsClient) SqlMicutoverThenPoll(ctx context.Context, id Providers2DatabaseMigrationId, input MigrationOperationInput) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after SqlMicutover: %+v", err)
	}
