...
func (c GETClient) ServicesListByResourceGroup(ctx context.Context, id SubscriptionResourceGroupId) (result ServicesListByResourceGroupOperationResponse, err error) {
...
func (c GETClient) ServicesListByResourceGroupComplete(ctx context.Context, id SubscriptionResourceGroupId) (ServicesListByResourceGroupCompleteResult, error) {
...
func (c GETClient) ServicesListByResourceGroupCompleteMatchingPredicate(ctx context.Context, id SubscriptionResourceGroupId, predicate DataMigrationServiceOperationPredicate) (result ServicesListByResourceGroupCompleteResult, err error) {
