...
func (c ServiceResourceClient) ServicesListByResourceGroup(ctx context.Context, id SubscriptionResourceGroupId) (result ServicesListByResourceGroupOperationResponse, err error) {
...
func (c ServiceResourceClient) ServicesListByResourceGroupComplete(ctx context.Context, id SubscriptionResourceGroupId) (ServicesListByResourceGroupCompleteResult, error) {
...
func (c ServiceResourceClient) ServicesListByResourceGroupCompleteMatchingPredicate(ctx context.Context, id SubscriptionResourceGroupId, predicate DataMigrationServiceOperationPredicate) (result ServicesListByResourceGroupCompleteResult, err error) {
