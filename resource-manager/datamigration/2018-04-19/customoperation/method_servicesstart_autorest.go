...
func (c CustomOperationClient) ServicesStart(ctx context.Context, id ServiceId) (result ServicesStartOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "customoperation.CustomOperationClient", "ServicesStart", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForServicesStart(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "customoperation.CustomOperationClient", "ServicesStart", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c CustomOperationClient) preparerForServicesStart(ctx context.Context, id ServiceId) (*http.Request, error) {
...
func (c CustomOperationClient) senderForServicesStart(ctx context.Context, req *http.Request) (future ServicesStartOperationResponse, err error) {
