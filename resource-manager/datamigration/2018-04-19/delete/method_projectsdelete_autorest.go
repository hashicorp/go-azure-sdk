...
func (c DELETEClient) ProjectsDelete(ctx context.Context, id ProjectId, options ProjectsDeleteOperationOptions) (result ProjectsDeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "delete.DELETEClient", "ProjectsDelete", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "delete.DELETEClient", "ProjectsDelete", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForProjectsDelete(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "delete.DELETEClient", "ProjectsDelete", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c DELETEClient) preparerForProjectsDelete(ctx context.Context, id ProjectId, options ProjectsDeleteOperationOptions) (*http.Request, error) {
...
func (c DELETEClient) responderForProjectsDelete(resp *http.Response) (result ProjectsDeleteOperationResponse, err error) {
