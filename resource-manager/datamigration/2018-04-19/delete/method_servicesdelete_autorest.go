...
func (c DELETEClient) ServicesDelete(ctx context.Context, id ServiceId, options ServicesDeleteOperationOptions) (result ServicesDeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "delete.DELETEClient", "ServicesDelete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForServicesDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "delete.DELETEClient", "ServicesDelete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c DELETEClient) preparerForServicesDelete(ctx context.Context, id ServiceId, options ServicesDeleteOperationOptions) (*http.Request, error) {
...
func (c DELETEClient) senderForServicesDelete(ctx context.Context, req *http.Request) (future ServicesDeleteOperationResponse, err error) {
