...
func (c StandardOperationClient) ServicesListByResourceGroup(ctx context.Context, id ResourceGroupId) (resp ServicesListByResourceGroupOperationResponse, err error) {
	req, err := c.preparerForServicesListByResourceGroup(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServicesListByResourceGroup", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServicesListByResourceGroup", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForServicesListByResourceGroup(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServicesListByResourceGroup", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c StandardOperationClient) preparerForServicesListByResourceGroup(ctx context.Context, id ResourceGroupId) (*http.Request, error) {
...
func (c StandardOperationClient) preparerForServicesListByResourceGroupWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c StandardOperationClient) responderForServicesListByResourceGroup(resp *http.Response) (result ServicesListByResourceGroupOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ServicesListByResourceGroupOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServicesListByResourceGroup", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForServicesListByResourceGroup(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServicesListByResourceGroup", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c StandardOperationClient) ServicesListByResourceGroupCompleteMatchingPredicate(ctx context.Context, id ResourceGroupId, predicate DataMigrationServiceOperationPredicate) (resp ServicesListByResourceGroupCompleteResult, err error) {
