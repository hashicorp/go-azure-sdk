...
func (c StandardOperationClient) ProjectsDelete(ctx context.Context, id ProjectId, options ProjectsDeleteOperationOptions) (result ProjectsDeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ProjectsDelete", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ProjectsDelete", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForProjectsDelete(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ProjectsDelete", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c StandardOperationClient) preparerForProjectsDelete(ctx context.Context, id ProjectId, options ProjectsDeleteOperationOptions) (*http.Request, error) {
...
func (c StandardOperationClient) responderForProjectsDelete(resp *http.Response) (result ProjectsDeleteOperationResponse, err error) {
