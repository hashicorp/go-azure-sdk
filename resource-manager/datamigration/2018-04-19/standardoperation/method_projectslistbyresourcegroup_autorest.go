...
func (c StandardOperationClient) ProjectsListByResourceGroup(ctx context.Context, id ServiceId) (resp ProjectsListByResourceGroupOperationResponse, err error) {
	req, err := c.preparerForProjectsListByResourceGroup(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ProjectsListByResourceGroup", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ProjectsListByResourceGroup", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForProjectsListByResourceGroup(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ProjectsListByResourceGroup", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c StandardOperationClient) preparerForProjectsListByResourceGroup(ctx context.Context, id ServiceId) (*http.Request, error) {
...
func (c StandardOperationClient) preparerForProjectsListByResourceGroupWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c StandardOperationClient) responderForProjectsListByResourceGroup(resp *http.Response) (result ProjectsListByResourceGroupOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ProjectsListByResourceGroupOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ProjectsListByResourceGroup", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForProjectsListByResourceGroup(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ProjectsListByResourceGroup", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c StandardOperationClient) ProjectsListByResourceGroupCompleteMatchingPredicate(ctx context.Context, id ServiceId, predicate ProjectOperationPredicate) (resp ProjectsListByResourceGroupCompleteResult, err error) {
