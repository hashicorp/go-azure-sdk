...
// TasksList ...
func (c StandardOperationClient) TasksList(ctx context.Context, id ProjectId, options TasksListOperationOptions) (resp TasksListOperationResponse, err error) {
	req, err := c.preparerForTasksList(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "TasksList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "TasksList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForTasksList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "TasksList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c StandardOperationClient) preparerForTasksList(ctx context.Context, id ProjectId, options TasksListOperationOptions) (*http.Request, error) {
...
func (c StandardOperationClient) preparerForTasksListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c StandardOperationClient) responderForTasksList(resp *http.Response) (result TasksListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result TasksListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "TasksList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForTasksList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "TasksList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c StandardOperationClient) TasksListCompleteMatchingPredicate(ctx context.Context, id ProjectId, options TasksListOperationOptions, predicate ProjectTaskOperationPredicate) (resp TasksListCompleteResult, err error) {
