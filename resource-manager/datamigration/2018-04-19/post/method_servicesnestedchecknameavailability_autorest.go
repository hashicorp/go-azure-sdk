...
func (c POSTClient) ServicesNestedCheckNameAvailability(ctx context.Context, id ServiceId, input NameAvailabilityRequest) (result ServicesNestedCheckNameAvailabilityOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "post.POSTClient", "ServicesNestedCheckNameAvailability", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "post.POSTClient", "ServicesNestedCheckNameAvailability", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForServicesNestedCheckNameAvailability(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "post.POSTClient", "ServicesNestedCheckNameAvailability", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c POSTClient) preparerForServicesNestedCheckNameAvailability(ctx context.Context, id ServiceId, input NameAvailabilityRequest) (*http.Request, error) {
...
func (c POSTClient) responderForServicesNestedCheckNameAvailability(resp *http.Response) (result ServicesNestedCheckNameAvailabilityOperationResponse, err error) {
