...
func (c GETClient) ProjectsListByResourceGroup(ctx context.Context, id ServiceId) (resp ProjectsListByResourceGroupOperationResponse, err error) {
	req, err := c.preparerForProjectsListByResourceGroup(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ProjectsListByResourceGroup", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ProjectsListByResourceGroup", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForProjectsListByResourceGroup(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ProjectsListByResourceGroup", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c GETClient) preparerForProjectsListByResourceGroup(ctx context.Context, id ServiceId) (*http.Request, error) {
...
func (c GETClient) preparerForProjectsListByResourceGroupWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c GETClient) responderForProjectsListByResourceGroup(resp *http.Response) (result ProjectsListByResourceGroupOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ProjectsListByResourceGroupOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "get.GETClient", "ProjectsListByResourceGroup", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForProjectsListByResourceGroup(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "get.GETClient", "ProjectsListByResourceGroup", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c GETClient) ProjectsListByResourceGroupCompleteMatchingPredicate(ctx context.Context, id ServiceId, predicate ProjectOperationPredicate) (resp ProjectsListByResourceGroupCompleteResult, err error) {
