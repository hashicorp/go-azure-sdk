...
// ServicesList ...
func (c GETClient) ServicesList(ctx context.Context, id commonids.SubscriptionId) (resp ServicesListOperationResponse, err error) {
	req, err := c.preparerForServicesList(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ServicesList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ServicesList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForServicesList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ServicesList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c GETClient) preparerForServicesList(ctx context.Context, id commonids.SubscriptionId) (*http.Request, error) {
...
func (c GETClient) preparerForServicesListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c GETClient) responderForServicesList(resp *http.Response) (result ServicesListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ServicesListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "get.GETClient", "ServicesList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForServicesList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "get.GETClient", "ServicesList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c GETClient) ServicesListCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, predicate DataMigrationServiceOperationPredicate) (resp ServicesListCompleteResult, err error) {
