...
// ServiceTasksList ...
func (c GETClient) ServiceTasksList(ctx context.Context, id ServiceId, options ServiceTasksListOperationOptions) (resp ServiceTasksListOperationResponse, err error) {
	req, err := c.preparerForServiceTasksList(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ServiceTasksList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ServiceTasksList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForServiceTasksList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ServiceTasksList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c GETClient) preparerForServiceTasksList(ctx context.Context, id ServiceId, options ServiceTasksListOperationOptions) (*http.Request, error) {
...
func (c GETClient) preparerForServiceTasksListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c GETClient) responderForServiceTasksList(resp *http.Response) (result ServiceTasksListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ServiceTasksListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "get.GETClient", "ServiceTasksList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForServiceTasksList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "get.GETClient", "ServiceTasksList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c GETClient) ServiceTasksListCompleteMatchingPredicate(ctx context.Context, id ServiceId, options ServiceTasksListOperationOptions, predicate ProjectTaskOperationPredicate) (resp ServiceTasksListCompleteResult, err error) {
