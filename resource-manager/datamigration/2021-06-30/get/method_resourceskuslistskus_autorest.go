...
func (c GETClient) ResourceSkusListSkus(ctx context.Context, id commonids.SubscriptionId) (resp ResourceSkusListSkusOperationResponse, err error) {
	req, err := c.preparerForResourceSkusListSkus(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ResourceSkusListSkus", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ResourceSkusListSkus", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForResourceSkusListSkus(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ResourceSkusListSkus", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c GETClient) preparerForResourceSkusListSkus(ctx context.Context, id commonids.SubscriptionId) (*http.Request, error) {
...
func (c GETClient) preparerForResourceSkusListSkusWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c GETClient) responderForResourceSkusListSkus(resp *http.Response) (result ResourceSkusListSkusOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ResourceSkusListSkusOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "get.GETClient", "ResourceSkusListSkus", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForResourceSkusListSkus(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "get.GETClient", "ResourceSkusListSkus", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c GETClient) ResourceSkusListSkusCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, predicate ResourceSkuOperationPredicate) (resp ResourceSkusListSkusCompleteResult, err error) {
