...
// ProjectsList ...
func (c GETClient) ProjectsList(ctx context.Context, id ServiceId) (resp ProjectsListOperationResponse, err error) {
	req, err := c.preparerForProjectsList(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ProjectsList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ProjectsList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForProjectsList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "ProjectsList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c GETClient) preparerForProjectsList(ctx context.Context, id ServiceId) (*http.Request, error) {
...
func (c GETClient) preparerForProjectsListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c GETClient) responderForProjectsList(resp *http.Response) (result ProjectsListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ProjectsListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "get.GETClient", "ProjectsList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForProjectsList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "get.GETClient", "ProjectsList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c GETClient) ProjectsListCompleteMatchingPredicate(ctx context.Context, id ServiceId, predicate ProjectOperationPredicate) (resp ProjectsListCompleteResult, err error) {
