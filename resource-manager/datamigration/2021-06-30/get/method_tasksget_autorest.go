...
func (c GETClient) TasksGet(ctx context.Context, id TaskId, options TasksGetOperationOptions) (result TasksGetOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "TasksGet", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "TasksGet", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForTasksGet(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "TasksGet", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c GETClient) preparerForTasksGet(ctx context.Context, id TaskId, options TasksGetOperationOptions) (*http.Request, error) {
...
func (c GETClient) responderForTasksGet(resp *http.Response) (result TasksGetOperationResponse, err error) {
