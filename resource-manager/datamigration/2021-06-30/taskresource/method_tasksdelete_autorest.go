...
func (c TaskResourceClient) TasksDelete(ctx context.Context, id TaskId, options TasksDeleteOperationOptions) (result TasksDeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "taskresource.TaskResourceClient", "TasksDelete", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "taskresource.TaskResourceClient", "TasksDelete", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForTasksDelete(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "taskresource.TaskResourceClient", "TasksDelete", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c TaskResourceClient) preparerForTasksDelete(ctx context.Context, id TaskId, options TasksDeleteOperationOptions) (*http.Request, error) {
...
func (c TaskResourceClient) responderForTasksDelete(resp *http.Response) (result TasksDeleteOperationResponse, err error) {
