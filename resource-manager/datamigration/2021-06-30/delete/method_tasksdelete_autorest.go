...
func (c DELETEClient) TasksDelete(ctx context.Context, id TaskId, options TasksDeleteOperationOptions) (result TasksDeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "delete.DELETEClient", "TasksDelete", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "delete.DELETEClient", "TasksDelete", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForTasksDelete(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "delete.DELETEClient", "TasksDelete", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c DELETEClient) preparerForTasksDelete(ctx context.Context, id TaskId, options TasksDeleteOperationOptions) (*http.Request, error) {
...
func (c DELETEClient) responderForTasksDelete(resp *http.Response) (result TasksDeleteOperationResponse, err error) {
