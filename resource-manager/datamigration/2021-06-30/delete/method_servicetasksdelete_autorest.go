...
func (c DELETEClient) ServiceTasksDelete(ctx context.Context, id ServiceTaskId, options ServiceTasksDeleteOperationOptions) (result ServiceTasksDeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "delete.DELETEClient", "ServiceTasksDelete", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "delete.DELETEClient", "ServiceTasksDelete", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForServiceTasksDelete(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "delete.DELETEClient", "ServiceTasksDelete", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c DELETEClient) preparerForServiceTasksDelete(ctx context.Context, id ServiceTaskId, options ServiceTasksDeleteOperationOptions) (*http.Request, error) {
...
func (c DELETEClient) responderForServiceTasksDelete(resp *http.Response) (result ServiceTasksDeleteOperationResponse, err error) {
