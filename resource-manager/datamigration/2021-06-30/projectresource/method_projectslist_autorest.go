...
func (c ProjectResourceClient) ProjectsList(ctx context.Context, id ServiceId) (resp ProjectsListOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "projectresource.ProjectResourceClient", "ProjectsList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "projectresource.ProjectResourceClient", "ProjectsList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForProjectsList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "projectresource.ProjectResourceClient", "ProjectsList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ProjectResourceClient) preparerForProjectsList(ctx context.Context, id ServiceId) (*http.Request, error) {
...
func (c ProjectResourceClient) preparerForProjectsListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ProjectResourceClient) responderForProjectsList(resp *http.Response) (result ProjectsListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ProjectsListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "projectresource.ProjectResourceClient", "ProjectsList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForProjectsList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "projectresource.ProjectResourceClient", "ProjectsList", result.HttpResponse, "Failure responding to request")
				return
			}
