...
func (c StandardOperationClient) ServiceTasksGet(ctx context.Context, id ServiceTaskId, options ServiceTasksGetOperationOptions) (result ServiceTasksGetOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServiceTasksGet", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServiceTasksGet", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForServiceTasksGet(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServiceTasksGet", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c StandardOperationClient) preparerForServiceTasksGet(ctx context.Context, id ServiceTaskId, options ServiceTasksGetOperationOptions) (*http.Request, error) {
...
func (c StandardOperationClient) responderForServiceTasksGet(resp *http.Response) (result ServiceTasksGetOperationResponse, err error) {
