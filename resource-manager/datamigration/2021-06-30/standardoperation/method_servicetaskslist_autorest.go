...
// ServiceTasksList ...
func (c StandardOperationClient) ServiceTasksList(ctx context.Context, id ServiceId, options ServiceTasksListOperationOptions) (resp ServiceTasksListOperationResponse, err error) {
	req, err := c.preparerForServiceTasksList(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServiceTasksList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServiceTasksList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForServiceTasksList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServiceTasksList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c StandardOperationClient) preparerForServiceTasksList(ctx context.Context, id ServiceId, options ServiceTasksListOperationOptions) (*http.Request, error) {
...
func (c StandardOperationClient) preparerForServiceTasksListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c StandardOperationClient) responderForServiceTasksList(resp *http.Response) (result ServiceTasksListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ServiceTasksListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServiceTasksList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForServiceTasksList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServiceTasksList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c StandardOperationClient) ServiceTasksListCompleteMatchingPredicate(ctx context.Context, id ServiceId, options ServiceTasksListOperationOptions, predicate ProjectTaskOperationPredicate) (resp ServiceTasksListCompleteResult, err error) {
