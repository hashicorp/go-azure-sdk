...
func (c StandardOperationClient) ServicesDelete(ctx context.Context, id ServiceId, options ServicesDeleteOperationOptions) (result ServicesDeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServicesDelete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForServicesDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "standardoperation.StandardOperationClient", "ServicesDelete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c StandardOperationClient) preparerForServicesDelete(ctx context.Context, id ServiceId, options ServicesDeleteOperationOptions) (*http.Request, error) {
...
func (c StandardOperationClient) senderForServicesDelete(ctx context.Context, req *http.Request) (future ServicesDeleteOperationResponse, err error) {
