...
// FilesList ...
func (c FileResourceClient) FilesList(ctx context.Context, id ProjectId) (resp FilesListOperationResponse, err error) {
	req, err := c.preparerForFilesList(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "fileresource.FileResourceClient", "FilesList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "fileresource.FileResourceClient", "FilesList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForFilesList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "fileresource.FileResourceClient", "FilesList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c FileResourceClient) preparerForFilesList(ctx context.Context, id ProjectId) (*http.Request, error) {
...
func (c FileResourceClient) preparerForFilesListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c FileResourceClient) responderForFilesList(resp *http.Response) (result FilesListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result FilesListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "fileresource.FileResourceClient", "FilesList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForFilesList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "fileresource.FileResourceClient", "FilesList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c FileResourceClient) FilesListCompleteMatchingPredicate(ctx context.Context, id ProjectId, predicate ProjectFileOperationPredicate) (resp FilesListCompleteResult, err error) {
