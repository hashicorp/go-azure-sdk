...
func (c PATCHClient) ServicesUpdate(ctx context.Context, id ServiceId, input DataMigrationService) (result ServicesUpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "patch.PATCHClient", "ServicesUpdate", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForServicesUpdate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "patch.PATCHClient", "ServicesUpdate", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c PATCHClient) preparerForServicesUpdate(ctx context.Context, id ServiceId, input DataMigrationService) (*http.Request, error) {
...
func (c PATCHClient) senderForServicesUpdate(ctx context.Context, req *http.Request) (future ServicesUpdateOperationResponse, err error) {
