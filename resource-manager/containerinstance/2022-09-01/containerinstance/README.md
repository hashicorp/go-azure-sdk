...
## `github.com/hashicorp/go-azure-sdk/resource-manager/containerinstance/2022-09-01/containerinstance` Documentation

The `containerinstance` SDK allows for interaction with the Azure Resource Manager Service `containerinstance` (API Version `2022-09-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/containerinstance/2022-09-01/containerinstance"
```
