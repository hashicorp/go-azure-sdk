...
func (c VirtualNetworkRulesClient) responderForNamespacesGetVirtualNetworkRule(resp *http.Response) (result NamespacesGetVirtualNetworkRuleOperationResponse, err error) {
