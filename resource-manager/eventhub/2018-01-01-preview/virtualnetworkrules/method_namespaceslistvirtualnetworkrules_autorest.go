...
type NamespacesListVirtualNetworkRulesOperationResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (NamespacesListVirtualNetworkRulesOperationResponse, error)
}
...
func (c VirtualNetworkRulesClient) NamespacesListVirtualNetworkRulesComplete(ctx context.Context, id NamespaceId) (NamespacesListVirtualNetworkRulesCompleteResult, error) {
	return c.NamespacesListVirtualNetworkRulesCompleteMatchingPredicate(ctx, id, VirtualNetworkRuleOperationPredicate{})
}
...
func (c VirtualNetworkRulesClient) responderForNamespacesListVirtualNetworkRules(resp *http.Response) (result NamespacesListVirtualNetworkRulesOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result NamespacesListVirtualNetworkRulesOperationResponse, err error) {
