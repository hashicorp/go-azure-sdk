...
type NamespacesCreateOrUpdateIpFilterRuleOperationResponse struct {
	HttpResponse *http.Response
	Model        *IpFilterRule
}

// NamespacesCreateOrUpdateIpFilterRule ...
func (c IpFilterRulesClient) NamespacesCreateOrUpdateIpFilterRule(ctx context.Context, id IpfilterruleId, input IpFilterRule) (result NamespacesCreateOrUpdateIpFilterRuleOperationResponse, err error) {
...
func (c IpFilterRulesClient) responderForNamespacesCreateOrUpdateIpFilterRule(resp *http.Response) (result NamespacesCreateOrUpdateIpFilterRuleOperationResponse, err error) {
