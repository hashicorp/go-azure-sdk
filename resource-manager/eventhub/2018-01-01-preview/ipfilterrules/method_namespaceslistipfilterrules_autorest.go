...
type NamespacesListIPFilterRulesOperationResponse struct {
	HttpResponse *http.Response
	Model        *[]IpFilterRule

	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (NamespacesListIPFilterRulesOperationResponse, error)
}
...
func (r NamespacesListIPFilterRulesOperationResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r NamespacesListIPFilterRulesOperationResponse) LoadMore(ctx context.Context) (resp NamespacesListIPFilterRulesOperationResponse, err error) {
	if !r.HasMore() {
...
func (c IpFilterRulesClient) NamespacesListIPFilterRules(ctx context.Context, id NamespaceId) (resp NamespacesListIPFilterRulesOperationResponse, err error) {
...
func (c IpFilterRulesClient) NamespacesListIPFilterRulesComplete(ctx context.Context, id NamespaceId) (NamespacesListIPFilterRulesCompleteResult, error) {
	return c.NamespacesListIPFilterRulesCompleteMatchingPredicate(ctx, id, IpFilterRuleOperationPredicate{})
}

// NamespacesListIPFilterRulesCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c IpFilterRulesClient) NamespacesListIPFilterRulesCompleteMatchingPredicate(ctx context.Context, id NamespaceId, predicate IpFilterRuleOperationPredicate) (resp NamespacesListIPFilterRulesCompleteResult, err error) {
...
func (c IpFilterRulesClient) responderForNamespacesListIPFilterRules(resp *http.Response) (result NamespacesListIPFilterRulesOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result NamespacesListIPFilterRulesOperationResponse, err error) {
