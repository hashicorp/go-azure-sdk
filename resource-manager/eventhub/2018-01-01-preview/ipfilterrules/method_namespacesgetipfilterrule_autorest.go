...
type NamespacesGetIpFilterRuleOperationResponse struct {
	HttpResponse *http.Response
	Model        *IpFilterRule
}

// NamespacesGetIpFilterRule ...
func (c IpFilterRulesClient) NamespacesGetIpFilterRule(ctx context.Context, id IpfilterruleId) (result NamespacesGetIpFilterRuleOperationResponse, err error) {
...
func (c IpFilterRulesClient) responderForNamespacesGetIpFilterRule(resp *http.Response) (result NamespacesGetIpFilterRuleOperationResponse, err error) {
