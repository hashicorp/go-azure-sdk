...
type NamespacesDeleteIpFilterRuleOperationResponse struct {
	HttpResponse *http.Response
}

// NamespacesDeleteIpFilterRule ...
func (c IpFilterRulesClient) NamespacesDeleteIpFilterRule(ctx context.Context, id IpfilterruleId) (result NamespacesDeleteIpFilterRuleOperationResponse, err error) {
...
func (c IpFilterRulesClient) responderForNamespacesDeleteIpFilterRule(resp *http.Response) (result NamespacesDeleteIpFilterRuleOperationResponse, err error) {
