...
type ListBySkuOperationResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (ListBySkuOperationResponse, error)
}
...
func (c RegionsClient) ListBySkuComplete(ctx context.Context, id SkuId) (ListBySkuCompleteResult, error) {
	return c.ListBySkuCompleteMatchingPredicate(ctx, id, MessagingRegionsOperationPredicate{})
}
...
func (c RegionsClient) responderForListBySku(resp *http.Response) (result ListBySkuOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListBySkuOperationResponse, err error) {
