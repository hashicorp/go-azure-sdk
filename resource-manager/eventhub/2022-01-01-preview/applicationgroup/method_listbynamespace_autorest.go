...
// ListByNamespace ...
func (c ApplicationGroupClient) ListByNamespace(ctx context.Context, id NamespaceId) (resp ListByNamespaceOperationResponse, err error) {
	req, err := c.preparerForListByNamespace(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgroup.ApplicationGroupClient", "ListByNamespace", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgroup.ApplicationGroupClient", "ListByNamespace", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByNamespace(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgroup.ApplicationGroupClient", "ListByNamespace", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ApplicationGroupClient) ListByNamespaceCompleteMatchingPredicate(ctx context.Context, id NamespaceId, predicate ApplicationGroupOperationPredicate) (resp ListByNamespaceCompleteResult, err error) {
...
func (c ApplicationGroupClient) preparerForListByNamespace(ctx context.Context, id NamespaceId) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/applicationGroups", id.ID())),
...
func (c ApplicationGroupClient) preparerForListByNamespaceWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ApplicationGroupClient) responderForListByNamespace(resp *http.Response) (result ListByNamespaceOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByNamespaceOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "applicationgroup.ApplicationGroupClient", "ListByNamespace", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByNamespace(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "applicationgroup.ApplicationGroupClient", "ListByNamespace", result.HttpResponse, "Failure responding to request")
				return
			}
