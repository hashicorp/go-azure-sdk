...
func (c SitesClient) GetSiteHealthSummary(ctx context.Context, id VMwareSiteId) (resp GetSiteHealthSummaryOperationResponse, err error) {
	req, err := c.preparerForGetSiteHealthSummary(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "sites.SitesClient", "GetSiteHealthSummary", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "sites.SitesClient", "GetSiteHealthSummary", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForGetSiteHealthSummary(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "sites.SitesClient", "GetSiteHealthSummary", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c SitesClient) preparerForGetSiteHealthSummary(ctx context.Context, id VMwareSiteId) (*http.Request, error) {
...
func (c SitesClient) preparerForGetSiteHealthSummaryWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c SitesClient) responderForGetSiteHealthSummary(resp *http.Response) (result GetSiteHealthSummaryOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result GetSiteHealthSummaryOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "sites.SitesClient", "GetSiteHealthSummary", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForGetSiteHealthSummary(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "sites.SitesClient", "GetSiteHealthSummary", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c SitesClient) GetSiteHealthSummaryCompleteMatchingPredicate(ctx context.Context, id VMwareSiteId, predicate SiteHealthSummaryOperationPredicate) (resp GetSiteHealthSummaryCompleteResult, err error) {
