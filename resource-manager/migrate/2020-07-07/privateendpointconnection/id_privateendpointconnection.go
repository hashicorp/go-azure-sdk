...
func ParsePrivateEndpointConnectionID(input string) (*PrivateEndpointConnectionId, error) {
	...
	if id.MasterSiteName, ok = parsed.Parsed["masterSiteName"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "masterSiteName", *parsed)
	}
...
func (id PrivateEndpointConnectionId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.OffAzure/masterSites/%s/privateEndpointConnections/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.MasterSiteName, id.PrivateEndpointConnectionName)
}
