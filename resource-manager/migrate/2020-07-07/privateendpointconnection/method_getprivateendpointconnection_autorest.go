...
func (c PrivateEndpointConnectionClient) GetPrivateEndpointConnection(ctx context.Context, id PrivateEndpointConnectionId) (result GetPrivateEndpointConnectionOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "privateendpointconnection.PrivateEndpointConnectionClient", "GetPrivateEndpointConnection", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "privateendpointconnection.PrivateEndpointConnectionClient", "GetPrivateEndpointConnection", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c PrivateEndpointConnectionClient) preparerForGetPrivateEndpointConnection(ctx context.Context, id PrivateEndpointConnectionId) (*http.Request, error) {
...
func (c PrivateEndpointConnectionClient) responderForGetPrivateEndpointConnection(resp *http.Response) (result GetPrivateEndpointConnectionOperationResponse, err error) {
