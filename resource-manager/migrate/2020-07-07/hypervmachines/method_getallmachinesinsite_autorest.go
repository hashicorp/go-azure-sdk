...
func (c HyperVMachinesClient) GetAllMachinesInSite(ctx context.Context, id HyperVSiteId, options GetAllMachinesInSiteOperationOptions) (resp GetAllMachinesInSiteOperationResponse, err error) {
	req, err := c.preparerForGetAllMachinesInSite(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "hypervmachines.HyperVMachinesClient", "GetAllMachinesInSite", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "hypervmachines.HyperVMachinesClient", "GetAllMachinesInSite", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForGetAllMachinesInSite(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "hypervmachines.HyperVMachinesClient", "GetAllMachinesInSite", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c HyperVMachinesClient) preparerForGetAllMachinesInSite(ctx context.Context, id HyperVSiteId, options GetAllMachinesInSiteOperationOptions) (*http.Request, error) {
...
func (c HyperVMachinesClient) preparerForGetAllMachinesInSiteWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c HyperVMachinesClient) responderForGetAllMachinesInSite(resp *http.Response) (result GetAllMachinesInSiteOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result GetAllMachinesInSiteOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "hypervmachines.HyperVMachinesClient", "GetAllMachinesInSite", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForGetAllMachinesInSite(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "hypervmachines.HyperVMachinesClient", "GetAllMachinesInSite", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c HyperVMachinesClient) GetAllMachinesInSiteCompleteMatchingPredicate(ctx context.Context, id HyperVSiteId, options GetAllMachinesInSiteOperationOptions, predicate HyperVMachineOperationPredicate) (resp GetAllMachinesInSiteCompleteResult, err error) {
