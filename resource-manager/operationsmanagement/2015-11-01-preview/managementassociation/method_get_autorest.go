...
func (c ManagementAssociationClient) Get(ctx context.Context, id ManagementAssociationId) (result GetOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementassociation.ManagementAssociationClient", "Get", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForGet(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementassociation.ManagementAssociationClient", "Get", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c ManagementAssociationClient) responderForGet(resp *http.Response) (result GetOperationResponse, err error) {
