...
func (c ManagementAssociationClient) Delete(ctx context.Context, id ScopedManagementAssociationId) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementassociation.ManagementAssociationClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForDelete(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementassociation.ManagementAssociationClient", "Delete", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c ManagementAssociationClient) responderForDelete(resp *http.Response) (result DeleteOperationResponse, err error) {
