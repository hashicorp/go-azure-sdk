...
func (c ManagementAssociationClient) CreateOrUpdate(ctx context.Context, id ManagementAssociationId, input ManagementAssociation) (result CreateOrUpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementassociation.ManagementAssociationClient", "CreateOrUpdate", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForCreateOrUpdate(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementassociation.ManagementAssociationClient", "CreateOrUpdate", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c ManagementAssociationClient) responderForCreateOrUpdate(resp *http.Response) (result CreateOrUpdateOperationResponse, err error) {
