...
func TestNewCapabilitiesID(t *testing.T) {
	id := NewCapabilitiesID("12345678-1234-9876-4563-123456789012", "example-resource-group", "parentProviderNamespaceValue", "parentResourceTypeValue", "parentResourceValue", "targetValue", "capabilityValue")
...
func TestFormatCapabilitiesID(t *testing.T) {
	actual := NewCapabilitiesID("12345678-1234-9876-4563-123456789012", "example-resource-group", "parentProviderNamespaceValue", "parentResourceTypeValue", "parentResourceValue", "targetValue", "capabilityValue").ID()
...
func TestParseCapabilitiesID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *CapabilitiesId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseCapabilitiesID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseCapabilitiesIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *CapabilitiesId
	...
	for _, v := range testData {
		...
		actual, err := ParseCapabilitiesIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForCapabilitiesId(t *testing.T) {
	segments := CapabilitiesId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("CapabilitiesId has no segments")
	}
