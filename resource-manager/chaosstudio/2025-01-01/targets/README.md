...
## `github.com/hashicorp/go-azure-sdk/resource-manager/chaosstudio/2025-01-01/targets` Documentation

The `targets` SDK allows for interaction with Azure Resource Manager `chaosstudio` (API Version `2025-01-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/chaosstudio/2025-01-01/targets"
```
