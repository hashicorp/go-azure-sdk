...
## `github.com/hashicorp/go-azure-sdk/resource-manager/chaosstudio/2025-01-01/targettypes` Documentation

The `targettypes` SDK allows for interaction with Azure Resource Manager `chaosstudio` (API Version `2025-01-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/chaosstudio/2025-01-01/targettypes"
```
