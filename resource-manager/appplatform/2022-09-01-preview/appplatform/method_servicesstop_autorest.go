...
func (c AppPlatformClient) ServicesStop(ctx context.Context, id SpringId) (result ServicesStopOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "ServicesStop", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForServicesStop(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "ServicesStop", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c AppPlatformClient) preparerForServicesStop(ctx context.Context, id SpringId) (*http.Request, error) {
...
func (c AppPlatformClient) senderForServicesStop(ctx context.Context, req *http.Request) (future ServicesStopOperationResponse, err error) {
