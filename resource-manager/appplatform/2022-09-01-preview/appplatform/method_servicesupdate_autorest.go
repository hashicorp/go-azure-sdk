...
func (c AppPlatformClient) ServicesUpdate(ctx context.Context, id SpringId, input ServiceResource) (result ServicesUpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "ServicesUpdate", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForServicesUpdate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "ServicesUpdate", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c AppPlatformClient) preparerForServicesUpdate(ctx context.Context, id SpringId, input ServiceResource) (*http.Request, error) {
...
func (c AppPlatformClient) senderForServicesUpdate(ctx context.Context, req *http.Request) (future ServicesUpdateOperationResponse, err error) {
