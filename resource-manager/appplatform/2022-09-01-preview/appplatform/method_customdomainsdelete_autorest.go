...
func (c AppPlatformClient) CustomDomainsDelete(ctx context.Context, id DomainId) (result CustomDomainsDeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "CustomDomainsDelete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCustomDomainsDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "CustomDomainsDelete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c AppPlatformClient) preparerForCustomDomainsDelete(ctx context.Context, id DomainId) (*http.Request, error) {
...
func (c AppPlatformClient) senderForCustomDomainsDelete(ctx context.Context, req *http.Request) (future CustomDomainsDeleteOperationResponse, err error) {
