...
## `github.com/hashicorp/go-azure-sdk/resource-manager/appplatform/2023-05-01-preview/appplatform` Documentation

The `appplatform` SDK allows for interaction with the Azure Resource Manager Service `appplatform` (API Version `2023-05-01-preview`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/appplatform/2023-05-01-preview/appplatform"
```
