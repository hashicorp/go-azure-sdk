...
func (c AppPlatformClient) ServicesList(ctx context.Context, id commonids.ResourceGroupId) (resp ServicesListOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "ServicesList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "ServicesList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForServicesList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "ServicesList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c AppPlatformClient) preparerForServicesList(ctx context.Context, id commonids.ResourceGroupId) (*http.Request, error) {
...
func (c AppPlatformClient) preparerForServicesListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c AppPlatformClient) responderForServicesList(resp *http.Response) (result ServicesListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ServicesListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "ServicesList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForServicesList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "ServicesList", result.HttpResponse, "Failure responding to request")
				return
			}
