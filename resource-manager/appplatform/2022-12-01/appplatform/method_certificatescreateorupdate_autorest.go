...
func (c AppPlatformClient) CertificatesCreateOrUpdate(ctx context.Context, id CertificateId, input CertificateResource) (result CertificatesCreateOrUpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "CertificatesCreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCertificatesCreateOrUpdate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "CertificatesCreateOrUpdate", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c AppPlatformClient) preparerForCertificatesCreateOrUpdate(ctx context.Context, id CertificateId, input CertificateResource) (*http.Request, error) {
...
func (c AppPlatformClient) senderForCertificatesCreateOrUpdate(ctx context.Context, req *http.Request) (future CertificatesCreateOrUpdateOperationResponse, err error) {
