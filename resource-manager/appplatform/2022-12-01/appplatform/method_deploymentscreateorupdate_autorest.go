...
func (c AppPlatformClient) DeploymentsCreateOrUpdate(ctx context.Context, id DeploymentId, input DeploymentResource) (result DeploymentsCreateOrUpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "DeploymentsCreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDeploymentsCreateOrUpdate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "DeploymentsCreateOrUpdate", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c AppPlatformClient) preparerForDeploymentsCreateOrUpdate(ctx context.Context, id DeploymentId, input DeploymentResource) (*http.Request, error) {
...
func (c AppPlatformClient) senderForDeploymentsCreateOrUpdate(ctx context.Context, req *http.Request) (future DeploymentsCreateOrUpdateOperationResponse, err error) {
