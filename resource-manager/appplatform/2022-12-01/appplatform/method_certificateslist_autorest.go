...
func (c AppPlatformClient) CertificatesList(ctx context.Context, id SpringId) (resp CertificatesListOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "CertificatesList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "CertificatesList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForCertificatesList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "CertificatesList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c AppPlatformClient) preparerForCertificatesList(ctx context.Context, id SpringId) (*http.Request, error) {
...
func (c AppPlatformClient) preparerForCertificatesListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c AppPlatformClient) responderForCertificatesList(resp *http.Response) (result CertificatesListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result CertificatesListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "CertificatesList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForCertificatesList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "CertificatesList", result.HttpResponse, "Failure responding to request")
				return
			}
