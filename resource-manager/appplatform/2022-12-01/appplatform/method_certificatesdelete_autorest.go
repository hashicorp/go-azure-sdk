...
func (c AppPlatformClient) CertificatesDelete(ctx context.Context, id CertificateId) (result CertificatesDeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "CertificatesDelete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCertificatesDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "CertificatesDelete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c AppPlatformClient) preparerForCertificatesDelete(ctx context.Context, id CertificateId) (*http.Request, error) {
...
func (c AppPlatformClient) senderForCertificatesDelete(ctx context.Context, req *http.Request) (future CertificatesDeleteOperationResponse, err error) {
