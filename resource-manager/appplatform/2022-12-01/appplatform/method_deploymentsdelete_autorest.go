...
func (c AppPlatformClient) DeploymentsDelete(ctx context.Context, id DeploymentId) (result DeploymentsDeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "DeploymentsDelete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDeploymentsDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "DeploymentsDelete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c AppPlatformClient) preparerForDeploymentsDelete(ctx context.Context, id DeploymentId) (*http.Request, error) {
...
func (c AppPlatformClient) senderForDeploymentsDelete(ctx context.Context, req *http.Request) (future DeploymentsDeleteOperationResponse, err error) {
