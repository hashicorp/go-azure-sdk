...
func (c AppPlatformClient) ServicesStart(ctx context.Context, id SpringId) (result ServicesStartOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "ServicesStart", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForServicesStart(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appplatform.AppPlatformClient", "ServicesStart", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c AppPlatformClient) preparerForServicesStart(ctx context.Context, id SpringId) (*http.Request, error) {
...
func (c AppPlatformClient) senderForServicesStart(ctx context.Context, req *http.Request) (future ServicesStartOperationResponse, err error) {
