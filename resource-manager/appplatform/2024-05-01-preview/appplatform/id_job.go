...
func NewJobID(subscriptionId string, resourceGroupName string, springName string, jobName string) JobId {
	return JobId{
...
func (id JobId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.AppPlatform/spring/%s/jobs/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.SpringName, id.JobName)
}
