...
func TestNewEnvironmentID(t *testing.T) {
	id := NewEnvironmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "organizationName", "environmentId")
...
func TestFormatEnvironmentID(t *testing.T) {
	actual := NewEnvironmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "organizationName", "environmentId").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Confluent/organizations/organizationName/environments/environmentId"
	if actual != expected {
...
func TestParseEnvironmentID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Confluent/organizations/organizationName/environments/environmentId/extra",
			Error: true,
		},
	}
