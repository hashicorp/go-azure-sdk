...
func TestNewApiKeyID(t *testing.T) {
	id := NewApiKeyID("12345678-1234-9876-4563-123456789012", "example-resource-group", "organizationName", "apiKeyId")
	...
	if id.ApiKeyId != "apiKeyId" {
		t.Fatalf("Expected %q but got %q for Segment 'ApiKeyId'", id.ApiKeyId, "apiKeyId")
	}
}

func TestFormatApiKeyID(t *testing.T) {
	actual := NewApiKeyID("12345678-1234-9876-4563-123456789012", "example-resource-group", "organizationName", "apiKeyId").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Confluent/organizations/organizationName/apiKeys/apiKeyId"
	if actual != expected {
...
func TestParseApiKeyID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Confluent/organizations/organizationName/apiKeys",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Confluent/organizations/organizationName/apiKeys/apiKeyId",
			Expected: &ApiKeyId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Confluent/organizations/organizationName/apiKeys/apiKeyId/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		if actual.ApiKeyId != v.Expected.ApiKeyId {
			t.Fatalf("Expected %q but got %q for ApiKeyId", v.Expected.ApiKeyId, actual.ApiKeyId)
		}
