...
func PossibleValuesForChannelBinding() []string {
	return []string{
		string(ChannelBindingDisabled),
		string(ChannelBindingEnabled),
	}
}

func (s *ChannelBinding) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseChannelBinding(decoded)
	if err != nil {
...
func parseChannelBinding(input string) (*ChannelBinding, error) {
	vals := map[string]ChannelBinding{
		"disabled": ChannelBindingDisabled,
		"enabled":  ChannelBindingEnabled,
	}
...
func PossibleValuesForLdapSigning() []string {
	return []string{
		string(LdapSigningDisabled),
		string(LdapSigningEnabled),
	}
}

func (s *LdapSigning) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseLdapSigning(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseLdapSigning(input string) (*LdapSigning, error) {
	vals := map[string]LdapSigning{
		"disabled": LdapSigningDisabled,
		"enabled":  LdapSigningEnabled,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForSyncOnPremSamAccountName() []string {
	return []string{
		string(SyncOnPremSamAccountNameDisabled),
		string(SyncOnPremSamAccountNameEnabled),
	}
}

func (s *SyncOnPremSamAccountName) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseSyncOnPremSamAccountName(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseSyncOnPremSamAccountName(input string) (*SyncOnPremSamAccountName, error) {
	vals := map[string]SyncOnPremSamAccountName{
		"disabled": SyncOnPremSamAccountNameDisabled,
		"enabled":  SyncOnPremSamAccountNameEnabled,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := SyncOnPremSamAccountName(input)
	return &out, nil
}
...
func PossibleValuesForSyncScope() []string {
	return []string{
		string(SyncScopeAll),
		string(SyncScopeCloudOnly),
	}
}

func (s *SyncScope) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseSyncScope(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseSyncScope(input string) (*SyncScope, error) {
	vals := map[string]SyncScope{
		"all":       SyncScopeAll,
		"cloudonly": SyncScopeCloudOnly,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
