...
func (c OuContainerClient) Create(ctx context.Context, id OuContainerId, input ContainerAccount) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "oucontainer.OuContainerClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "oucontainer.OuContainerClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c OuContainerClient) preparerForCreate(ctx context.Context, id OuContainerId, input ContainerAccount) (*http.Request, error) {
...
func (c OuContainerClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
