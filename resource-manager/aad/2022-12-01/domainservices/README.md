...
## `github.com/hashicorp/go-azure-sdk/resource-manager/aad/2022-12-01/domainservices` Documentation

The `domainservices` SDK allows for interaction with the Azure Resource Manager Service `aad` (API Version `2022-12-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/aad/2022-12-01/domainservices"
```
