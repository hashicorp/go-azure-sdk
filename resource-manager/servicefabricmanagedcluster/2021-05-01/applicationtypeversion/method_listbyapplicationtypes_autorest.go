...
type ListByApplicationTypesOperationResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (ListByApplicationTypesOperationResponse, error)
}
...
func (r ListByApplicationTypesOperationResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r ListByApplicationTypesOperationResponse) LoadMore(ctx context.Context) (resp ListByApplicationTypesOperationResponse, err error) {
	if !r.HasMore() {
...
func (c ApplicationTypeVersionClient) ListByApplicationTypes(ctx context.Context, id ApplicationTypeId) (resp ListByApplicationTypesOperationResponse, err error) {
...
func (c ApplicationTypeVersionClient) responderForListByApplicationTypes(resp *http.Response) (result ListByApplicationTypesOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByApplicationTypesOperationResponse, err error) {
