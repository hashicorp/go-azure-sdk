...
func (c ApplicationTypeVersionClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VersionId, input ApplicationTypeVersionResource, callback func() error) error {
