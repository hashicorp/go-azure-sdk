...
func NewPrivateEndpointConnectionID(subscriptionId string, resourceGroupName string, cloudHsmClusterName string, privateEndpointConnectionName string) PrivateEndpointConnectionId {
...
func (id PrivateEndpointConnectionId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.HardwareSecurityModules/cloudHsmClusters/%s/privateEndpointConnections/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.CloudHsmClusterName, id.PrivateEndpointConnectionName)
}
