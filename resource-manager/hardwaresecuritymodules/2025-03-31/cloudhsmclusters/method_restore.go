...
func (c CloudHsmClustersClient) RestoreCallbackThenPoll(ctx context.Context, id CloudHsmClusterId, input RestoreRequestProperties, callback func() error) error {
