...
func (c CloudHSMClusterPrivateLinkGetClient) CloudHsmClusterPrivateLinkResourcesListByCloudHsmCluster(ctx context.Context, id CloudHsmClusterId) (result CloudHsmClusterPrivateLinkResourcesListByCloudHsmClusterOperationResponse, err error) {
...
func (c CloudHSMClusterPrivateLinkGetClient) CloudHsmClusterPrivateLinkResourcesListByCloudHsmClusterComplete(ctx context.Context, id CloudHsmClusterId) (CloudHsmClusterPrivateLinkResourcesListByCloudHsmClusterCompleteResult, error) {
