...
// ConnectedClusterGet ...
func (c HybridKubernetesClient) ConnectedClusterGet(ctx context.Context, id ConnectedClusterId) (result ConnectedClusterGetOperationResponse, err error) {
...
func (c HybridKubernetesClient) responderForConnectedClusterGet(resp *http.Response) (result ConnectedClusterGetOperationResponse, err error) {
