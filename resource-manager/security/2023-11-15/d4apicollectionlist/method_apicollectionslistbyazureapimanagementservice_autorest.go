...
func (c D4APICollectionListClient) APICollectionsListByAzureApiManagementService(ctx context.Context, id ServiceId) (resp APICollectionsListByAzureApiManagementServiceOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "d4apicollectionlist.D4APICollectionListClient", "APICollectionsListByAzureApiManagementService", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "d4apicollectionlist.D4APICollectionListClient", "APICollectionsListByAzureApiManagementService", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForAPICollectionsListByAzureApiManagementService(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "d4apicollectionlist.D4APICollectionListClient", "APICollectionsListByAzureApiManagementService", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c D4APICollectionListClient) preparerForAPICollectionsListByAzureApiManagementService(ctx context.Context, id ServiceId) (*http.Request, error) {
...
func (c D4APICollectionListClient) preparerForAPICollectionsListByAzureApiManagementServiceWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c D4APICollectionListClient) responderForAPICollectionsListByAzureApiManagementService(resp *http.Response) (result APICollectionsListByAzureApiManagementServiceOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result APICollectionsListByAzureApiManagementServiceOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "d4apicollectionlist.D4APICollectionListClient", "APICollectionsListByAzureApiManagementService", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForAPICollectionsListByAzureApiManagementService(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "d4apicollectionlist.D4APICollectionListClient", "APICollectionsListByAzureApiManagementService", result.HttpResponse, "Failure responding to request")
				return
			}
