...
func (c APIMConfigClient) APICollectionsOnboardAzureApiManagementApi(ctx context.Context, id ApiCollectionId) (result APICollectionsOnboardAzureApiManagementApiOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "apimconfig.APIMConfigClient", "APICollectionsOnboardAzureApiManagementApi", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForAPICollectionsOnboardAzureApiManagementApi(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "apimconfig.APIMConfigClient", "APICollectionsOnboardAzureApiManagementApi", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c APIMConfigClient) preparerForAPICollectionsOnboardAzureApiManagementApi(ctx context.Context, id ApiCollectionId) (*http.Request, error) {
...
func (c APIMConfigClient) senderForAPICollectionsOnboardAzureApiManagementApi(ctx context.Context, req *http.Request) (future APICollectionsOnboardAzureApiManagementApiOperationResponse, err error) {
