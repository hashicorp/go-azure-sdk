...
func (c AssessmentsMetadataClient) AssessmentsMetadataCreateInSubscription(ctx context.Context, id ProviderAssessmentMetadataId, input SecurityAssessmentMetadata) (result AssessmentsMetadataCreateInSubscriptionOperationResponse, err error) {
...
func (c AssessmentsMetadataClient) preparerForAssessmentsMetadataCreateInSubscription(ctx context.Context, id ProviderAssessmentMetadataId, input SecurityAssessmentMetadata) (*http.Request, error) {
