...
func (c AssessmentsMetadataClient) preparerForCreateInSubscription(ctx context.Context, id ProviderAssessmentMetadataId, input SecurityAssessmentMetadata) (*http.Request, error) {
