...
func (c AssessmentsMetadataClient) AssessmentsMetadataListBySubscriptionComplete(ctx context.Context, id commonids.SubscriptionId) (AssessmentsMetadataListBySubscriptionCompleteResult, error) {
	return c.AssessmentsMetadataListBySubscriptionCompleteMatchingPredicate(ctx, id, SecurityAssessmentMetadataOperationPredicate{})
}
...
func (c AssessmentsMetadataClient) AssessmentsMetadataListBySubscriptionCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, predicate SecurityAssessmentMetadataOperationPredicate) (resp AssessmentsMetadataListBySubscriptionCompleteResult, err error) {
