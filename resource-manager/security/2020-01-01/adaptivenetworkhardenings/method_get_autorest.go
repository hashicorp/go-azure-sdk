...
func (c AdaptiveNetworkHardeningsClient) Get(ctx context.Context, id ScopedAdaptiveNetworkHardeningId) (result GetOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "adaptivenetworkhardenings.AdaptiveNetworkHardeningsClient", "Get", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForGet(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "adaptivenetworkhardenings.AdaptiveNetworkHardeningsClient", "Get", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c AdaptiveNetworkHardeningsClient) responderForGet(resp *http.Response) (result GetOperationResponse, err error) {
