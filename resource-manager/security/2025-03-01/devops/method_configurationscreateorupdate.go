...
func (c DevOpsClient) ConfigurationsCreateOrUpdateCallbackThenPoll(ctx context.Context, id SecurityConnectorId, input DevOpsConfiguration, callback func() error) error {
