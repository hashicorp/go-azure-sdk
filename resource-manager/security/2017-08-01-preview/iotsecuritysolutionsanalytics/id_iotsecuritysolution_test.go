...
func TestNewIotSecuritySolutionID(t *testing.T) {
	id := NewIotSecuritySolutionID("12345678-1234-9876-4563-123456789012", "example-resource-group", "iotSecuritySolutionValue")
...
func TestFormatIotSecuritySolutionID(t *testing.T) {
	actual := NewIotSecuritySolutionID("12345678-1234-9876-4563-123456789012", "example-resource-group", "iotSecuritySolutionValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Security/iotSecuritySolutions/iotSecuritySolutionValue"
	if actual != expected {
...
func TestParseIotSecuritySolutionID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Security/iotSecuritySolutions/iotSecuritySolutionValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseIotSecuritySolutionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseIotSecuritySolutionIDInsensitively(t *testing.T) {
	...
	for _, v := range testData {
		...
		actual, err := ParseIotSecuritySolutionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForIotSecuritySolutionId(t *testing.T) {
	segments := IotSecuritySolutionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("IotSecuritySolutionId has no segments")
	}
