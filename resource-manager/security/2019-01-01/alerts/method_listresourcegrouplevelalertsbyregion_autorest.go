...
func (o ListResourceGroupLevelAlertsByRegionOperationOptions) toHeaders() map[string]interface{} {
	out := make(map[string]interface{})

	return out
}

func (o ListResourceGroupLevelAlertsByRegionOperationOptions) toQueryString() map[string]interface{} {
	out := make(map[string]interface{})
...
func (c AlertsClient) ListResourceGroupLevelAlertsByRegion(ctx context.Context, id ProviderLocationId, options ListResourceGroupLevelAlertsByRegionOperationOptions) (resp ListResourceGroupLevelAlertsByRegionOperationResponse, err error) {
	req, err := c.preparerForListResourceGroupLevelAlertsByRegion(ctx, id, options)
	if err != nil {
...
func (c AlertsClient) preparerForListResourceGroupLevelAlertsByRegion(ctx context.Context, id ProviderLocationId, options ListResourceGroupLevelAlertsByRegionOperationOptions) (*http.Request, error) {
...
func (c AlertsClient) ListResourceGroupLevelAlertsByRegionCompleteMatchingPredicate(ctx context.Context, id ProviderLocationId, options ListResourceGroupLevelAlertsByRegionOperationOptions, predicate AlertOperationPredicate) (resp ListResourceGroupLevelAlertsByRegionCompleteResult, err error) {
	...
	page, err := c.ListResourceGroupLevelAlertsByRegion(ctx, id, options)
	if err != nil {
