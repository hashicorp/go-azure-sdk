...
type ListByWorkspaceCompleteResult struct {
	...
	Items              []WorkspacePrivateLinkResource
}
...
func (c WorkspacePrivateLinkResourcesClient) ListByWorkspace(ctx context.Context, id WorkspaceId) (result ListByWorkspaceOperationResponse, err error) {
	...
	var values struct {
		Values *[]WorkspacePrivateLinkResource `json:"value"`
	}
...
func (c WorkspacePrivateLinkResourcesClient) ListByWorkspaceComplete(ctx context.Context, id WorkspaceId) (ListByWorkspaceCompleteResult, error) {
	return c.ListByWorkspaceCompleteMatchingPredicate(ctx, id, WorkspacePrivateLinkResourceOperationPredicate{})
}

// ListByWorkspaceCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c WorkspacePrivateLinkResourcesClient) ListByWorkspaceCompleteMatchingPredicate(ctx context.Context, id WorkspaceId, predicate WorkspacePrivateLinkResourceOperationPredicate) (result ListByWorkspaceCompleteResult, err error) {
	items := make([]WorkspacePrivateLinkResource, 0)
