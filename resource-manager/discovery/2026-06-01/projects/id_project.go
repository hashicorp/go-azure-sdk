...
func NewProjectID(subscriptionId string, resourceGroupName string, workspaceName string, projectName string) ProjectId {
	return ProjectId{
...
func (id ProjectId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.Discovery/workspaces/%s/projects/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.WorkspaceName, id.ProjectName)
}
