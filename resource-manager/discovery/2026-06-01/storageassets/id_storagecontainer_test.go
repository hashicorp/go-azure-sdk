...
func TestFormatStorageContainerID(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Discovery/storageContainers/storageContainerName"
	if actual != expected {
...
func TestParseStorageContainerID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Discovery/storageContainers/storageContainerName/extra",
			Error: true,
		},
	}
