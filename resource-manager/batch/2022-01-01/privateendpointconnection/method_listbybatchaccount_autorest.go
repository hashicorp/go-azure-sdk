...
func (c PrivateEndpointConnectionClient) ListByBatchAccount(ctx context.Context, id BatchAccountId, options ListByBatchAccountOperationOptions) (resp ListByBatchAccountOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "privateendpointconnection.PrivateEndpointConnectionClient", "ListByBatchAccount", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "privateendpointconnection.PrivateEndpointConnectionClient", "ListByBatchAccount", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByBatchAccount(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "privateendpointconnection.PrivateEndpointConnectionClient", "ListByBatchAccount", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c PrivateEndpointConnectionClient) preparerForListByBatchAccount(ctx context.Context, id BatchAccountId, options ListByBatchAccountOperationOptions) (*http.Request, error) {
...
func (c PrivateEndpointConnectionClient) preparerForListByBatchAccountWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c PrivateEndpointConnectionClient) responderForListByBatchAccount(resp *http.Response) (result ListByBatchAccountOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByBatchAccountOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "privateendpointconnection.PrivateEndpointConnectionClient", "ListByBatchAccount", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByBatchAccount(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "privateendpointconnection.PrivateEndpointConnectionClient", "ListByBatchAccount", result.HttpResponse, "Failure responding to request")
				return
			}
