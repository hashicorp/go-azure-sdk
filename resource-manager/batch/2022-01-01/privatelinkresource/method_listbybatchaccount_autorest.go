...
// ListByBatchAccount ...
func (c PrivateLinkResourceClient) ListByBatchAccount(ctx context.Context, id BatchAccountId, options ListByBatchAccountOperationOptions) (resp ListByBatchAccountOperationResponse, err error) {
	req, err := c.preparerForListByBatchAccount(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "privatelinkresource.PrivateLinkResourceClient", "ListByBatchAccount", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "privatelinkresource.PrivateLinkResourceClient", "ListByBatchAccount", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByBatchAccount(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "privatelinkresource.PrivateLinkResourceClient", "ListByBatchAccount", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c PrivateLinkResourceClient) preparerForListByBatchAccount(ctx context.Context, id BatchAccountId, options ListByBatchAccountOperationOptions) (*http.Request, error) {
...
func (c PrivateLinkResourceClient) preparerForListByBatchAccountWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c PrivateLinkResourceClient) responderForListByBatchAccount(resp *http.Response) (result ListByBatchAccountOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByBatchAccountOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "privatelinkresource.PrivateLinkResourceClient", "ListByBatchAccount", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByBatchAccount(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "privatelinkresource.PrivateLinkResourceClient", "ListByBatchAccount", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c PrivateLinkResourceClient) ListByBatchAccountCompleteMatchingPredicate(ctx context.Context, id BatchAccountId, options ListByBatchAccountOperationOptions, predicate PrivateLinkResourceOperationPredicate) (resp ListByBatchAccountCompleteResult, err error) {
