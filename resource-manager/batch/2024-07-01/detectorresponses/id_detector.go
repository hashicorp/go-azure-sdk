...
func (id *DetectorId) FromParseResult(input resourceids.ParseResult) error {
	...
	if id.DetectorId, ok = input.Parsed["detectorId"]; !ok {
		return resourceids.NewSegmentNotSpecifiedError(id, "detectorId", input)
	}
...
func (id DetectorId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("detectorId", "detectorId"),
	}
}
