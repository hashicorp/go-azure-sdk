...
## `github.com/hashicorp/go-azure-sdk/resource-manager/batch/2024-07-01/privateendpointconnection` Documentation

The `privateendpointconnection` SDK allows for interaction with the Azure Resource Manager Service `batch` (API Version `2024-07-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/batch/2024-07-01/privateendpointconnection"
```
