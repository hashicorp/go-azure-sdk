...
func (c PrivateEndpointConnectionClient) UpdateCallbackThenPoll(ctx context.Context, id PrivateEndpointConnectionId, input PrivateEndpointConnection, options UpdateOperationOptions, callback func() error) error {
