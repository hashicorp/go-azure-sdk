...
func (id *EntityId) FromParseResult(input resourceids.ParseResult) error {
	...
	if id.EntityIdentifier, ok = input.Parsed["entityIdentifier"]; !ok {
		return resourceids.NewSegmentNotSpecifiedError(id, "entityIdentifier", input)
	}
...
func (id EntityId) ID() string {
	...
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.WorkspaceName, id.EntityIdentifier)
}
...
func (id EntityId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("entityIdentifier", "entityIdentifierValue"),
	}
}
...
func (id EntityId) String() string {
	components := []string{
		...
		fmt.Sprintf("Entity Identifier: %q", id.EntityIdentifier),
	}
