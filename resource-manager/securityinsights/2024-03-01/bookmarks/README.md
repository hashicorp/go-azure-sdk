...
## `github.com/hashicorp/go-azure-sdk/resource-manager/securityinsights/2024-03-01/bookmarks` Documentation

The `bookmarks` SDK allows for interaction with the Azure Resource Manager Service `securityinsights` (API Version `2024-03-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/securityinsights/2024-03-01/bookmarks"
```
