...
// IndicatorCreate ...
func (c ThreatIntelligenceClient) IndicatorCreate(ctx context.Context, id IndicatorId, input ThreatIntelligenceIndicatorModelForRequestBody) (result IndicatorCreateOperationResponse, err error) {
...
func (c ThreatIntelligenceClient) preparerForIndicatorCreate(ctx context.Context, id IndicatorId, input ThreatIntelligenceIndicatorModelForRequestBody) (*http.Request, error) {
