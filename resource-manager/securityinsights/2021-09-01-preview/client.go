...
func NewClientWithBaseURI(sdkApi sdkEnv.Api, configureFunc func(c *resourcemanager.Client)) (*Client, error) {
	...
	automationRuleClient, err := automationrule.NewAutomationRuleClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building AutomationRule client: %+v", err)
	}
	configureFunc(automationRuleClient.Client)
