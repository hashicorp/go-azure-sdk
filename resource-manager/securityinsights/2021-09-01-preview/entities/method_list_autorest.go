...
func (c EntitiesClient) preparerForList(ctx context.Context, id WorkspaceId) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/providers/Microsoft.SecurityInsights/entities", id.ID())),
