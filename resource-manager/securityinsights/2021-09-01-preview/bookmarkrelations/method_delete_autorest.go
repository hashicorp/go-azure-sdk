...
func (c BookmarkRelationsClient) Delete(ctx context.Context, id BookmarkRelationId) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "bookmarkrelations.BookmarkRelationsClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForDelete(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "bookmarkrelations.BookmarkRelationsClient", "Delete", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c BookmarkRelationsClient) responderForDelete(resp *http.Response) (result DeleteOperationResponse, err error) {
