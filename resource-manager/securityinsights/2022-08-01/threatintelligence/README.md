...
## `github.com/hashicorp/go-azure-sdk/resource-manager/securityinsights/2022-08-01/threatintelligence` Documentation
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/securityinsights/2022-08-01/threatintelligence"
```
...
```go
ctx := context.TODO()
id := threatintelligence.NewIndicatorID("12345678-1234-9876-4563-123456789012", "example-resource-group", "workspaceValue", "nameValue")
