...
func (c WatchlistsClient) CreateOrUpdateThenPoll(ctx context.Context, id WatchlistId, input Watchlist) error {
...
func (c WatchlistsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id WatchlistId, input Watchlist, callback func() error) error {
