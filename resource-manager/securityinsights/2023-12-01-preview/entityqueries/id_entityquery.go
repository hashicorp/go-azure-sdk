...
func init() {
	recaser.RegisterResourceId(&EntityQueryId{})
}
...
func (id *EntityQueryId) FromParseResult(input resourceids.ParseResult) error {
	...
	if id.EntityQueryId, ok = input.Parsed["entityQueryId"]; !ok {
		return resourceids.NewSegmentNotSpecifiedError(id, "entityQueryId", input)
	}
...
func (id EntityQueryId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("entityQueryId", "entityQueryId"),
	}
}
