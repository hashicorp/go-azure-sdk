...
func (c ManagedPrivateEndpointsClient) CreateCallbackThenPoll(ctx context.Context, id ManagedPrivateEndpointId, input ManagedPrivateEndpointModel, callback func() error) error {
