...
func TestNewEnvironmentID(t *testing.T) {
	id := NewEnvironmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serviceValue", "workspaceValue", "environmentValue")
...
func TestFormatEnvironmentID(t *testing.T) {
	actual := NewEnvironmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serviceValue", "workspaceValue", "environmentValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.ApiCenter/services/serviceValue/workspaces/workspaceValue/environments/environmentValue"
	if actual != expected {
...
func TestParseEnvironmentID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.ApiCenter",
			Error: true,
		},
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.ApiCenter/services",
			Error: true,
		},
		{
			// Incomplete URI
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.ApiCenter/services/serviceValue/workspaces/workspaceValue/environments",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.ApiCenter/services/serviceValue/workspaces/workspaceValue/environments/environmentValue",
			Expected: &EnvironmentId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.ApiCenter/services/serviceValue/workspaces/workspaceValue/environments/environmentValue/extra",
			Error: true,
		},
	}
...
func TestSegmentsForEnvironmentId(t *testing.T) {
	segments := EnvironmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("EnvironmentId has no segments")
	}
