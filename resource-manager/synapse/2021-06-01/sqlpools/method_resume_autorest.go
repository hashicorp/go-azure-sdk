...
func (c SqlPoolsClient) Resume(ctx context.Context, id SqlPoolId) (result ResumeOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "sqlpools.SqlPoolsClient", "Resume", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForResume(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "sqlpools.SqlPoolsClient", "Resume", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c SqlPoolsClient) preparerForResume(ctx context.Context, id SqlPoolId) (*http.Request, error) {
...
func (c SqlPoolsClient) senderForResume(ctx context.Context, req *http.Request) (future ResumeOperationResponse, err error) {
