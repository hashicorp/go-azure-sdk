...
func (c SqlPoolsClient) Create(ctx context.Context, id SqlPoolId, input SqlPool) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "sqlpools.SqlPoolsClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "sqlpools.SqlPoolsClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c SqlPoolsClient) preparerForCreate(ctx context.Context, id SqlPoolId, input SqlPool) (*http.Request, error) {
...
func (c SqlPoolsClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
