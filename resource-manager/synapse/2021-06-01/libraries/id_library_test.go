...
func TestNewLibraryID(t *testing.T) {
	id := NewLibraryID("12345678-1234-9876-4563-123456789012", "example-resource-group", "workspaceName", "libraryName")
...
func TestFormatLibraryID(t *testing.T) {
	actual := NewLibraryID("12345678-1234-9876-4563-123456789012", "example-resource-group", "workspaceName", "libraryName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Synapse/workspaces/workspaceName/libraries/libraryName"
	if actual != expected {
...
func TestParseLibraryID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Synapse/workspaces/workspaceName/libraries",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Synapse/workspaces/workspaceName/libraries/libraryName",
			Expected: &LibraryId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Synapse/workspaces/workspaceName/libraries/libraryName/extra",
			Error: true,
		},
	}
