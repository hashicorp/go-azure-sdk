...
func (c BigDataPoolsClient) CreateOrUpdate(ctx context.Context, id BigDataPoolId, input BigDataPoolResourceInfo, options CreateOrUpdateOperationOptions) (result CreateOrUpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "bigdatapools.BigDataPoolsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreateOrUpdate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "bigdatapools.BigDataPoolsClient", "CreateOrUpdate", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c BigDataPoolsClient) preparerForCreateOrUpdate(ctx context.Context, id BigDataPoolId, input BigDataPoolResourceInfo, options CreateOrUpdateOperationOptions) (*http.Request, error) {
...
func (c BigDataPoolsClient) senderForCreateOrUpdate(ctx context.Context, req *http.Request) (future CreateOrUpdateOperationResponse, err error) {
