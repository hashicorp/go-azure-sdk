...
func TestParseRestorableDroppedSqlPoolID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
	...
	for _, v := range testData {
		...
		actual, err := ParseRestorableDroppedSqlPoolID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
		...
		if actual.RestorableDroppedSqlPoolId != v.Expected.RestorableDroppedSqlPoolId {
			t.Fatalf("Expected %q but got %q for RestorableDroppedSqlPoolId", v.Expected.RestorableDroppedSqlPoolId, actual.RestorableDroppedSqlPoolId)
		}

	}
}

func TestParseRestorableDroppedSqlPoolIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RestorableDroppedSqlPoolId
	...
	for _, v := range testData {
		...
		actual, err := ParseRestorableDroppedSqlPoolIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForRestorableDroppedSqlPoolId(t *testing.T) {
	segments := RestorableDroppedSqlPoolId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("RestorableDroppedSqlPoolId has no segments")
	}
