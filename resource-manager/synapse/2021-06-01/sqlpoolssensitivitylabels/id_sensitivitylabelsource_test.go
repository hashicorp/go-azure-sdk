...
func TestNewSensitivityLabelSourceID(t *testing.T) {
	id := NewSensitivityLabelSourceID("12345678-1234-9876-4563-123456789012", "example-resource-group", "workspaceValue", "sqlPoolValue", "schemaValue", "tableValue", "columnValue", "current")
...
func TestFormatSensitivityLabelSourceID(t *testing.T) {
	actual := NewSensitivityLabelSourceID("12345678-1234-9876-4563-123456789012", "example-resource-group", "workspaceValue", "sqlPoolValue", "schemaValue", "tableValue", "columnValue", "current").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Synapse/workspaces/workspaceValue/sqlPools/sqlPoolValue/schemas/schemaValue/tables/tableValue/columns/columnValue/sensitivityLabels/current"
	if actual != expected {
...
func TestParseSensitivityLabelSourceID(t *testing.T) {
	testData := []struct {
		...
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Synapse/workspaces/workspaceValue/sqlPools/sqlPoolValue/schemas/schemaValue/tables/tableValue/columns/columnValue/sensitivityLabels/current",
			Expected: &SensitivityLabelSourceId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Synapse/workspaces/workspaceValue/sqlPools/sqlPoolValue/schemas/schemaValue/tables/tableValue/columns/columnValue/sensitivityLabels/current/extra",
			Error: true,
		},
	}
