...
func (c MachinesClient) InstallPatches(ctx context.Context, id MachineId, input MachineInstallPatchesParameters) (result InstallPatchesOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "machines.MachinesClient", "InstallPatches", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForInstallPatches(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "machines.MachinesClient", "InstallPatches", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c MachinesClient) preparerForInstallPatches(ctx context.Context, id MachineId, input MachineInstallPatchesParameters) (*http.Request, error) {
...
func (c MachinesClient) senderForInstallPatches(ctx context.Context, req *http.Request) (future InstallPatchesOperationResponse, err error) {
