...
func (c PrivateLinkResourcesClient) ListByPrivateLinkScope(ctx context.Context, id ProviderPrivateLinkScopeId) (resp ListByPrivateLinkScopeOperationResponse, err error) {
	req, err := c.preparerForListByPrivateLinkScope(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "privatelinkresources.PrivateLinkResourcesClient", "ListByPrivateLinkScope", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "privatelinkresources.PrivateLinkResourcesClient", "ListByPrivateLinkScope", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByPrivateLinkScope(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "privatelinkresources.PrivateLinkResourcesClient", "ListByPrivateLinkScope", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c PrivateLinkResourcesClient) preparerForListByPrivateLinkScope(ctx context.Context, id ProviderPrivateLinkScopeId) (*http.Request, error) {
...
func (c PrivateLinkResourcesClient) preparerForListByPrivateLinkScopeWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c PrivateLinkResourcesClient) responderForListByPrivateLinkScope(resp *http.Response) (result ListByPrivateLinkScopeOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByPrivateLinkScopeOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "privatelinkresources.PrivateLinkResourcesClient", "ListByPrivateLinkScope", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByPrivateLinkScope(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "privatelinkresources.PrivateLinkResourcesClient", "ListByPrivateLinkScope", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c PrivateLinkResourcesClient) ListByPrivateLinkScopeCompleteMatchingPredicate(ctx context.Context, id ProviderPrivateLinkScopeId, predicate PrivateLinkResourceOperationPredicate) (resp ListByPrivateLinkScopeCompleteResult, err error) {
