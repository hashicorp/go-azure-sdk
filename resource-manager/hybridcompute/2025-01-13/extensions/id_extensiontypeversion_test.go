...
func TestNewExtensionTypeVersionID(t *testing.T) {
	id := NewExtensionTypeVersionID("12345678-1234-9876-4563-123456789012", "locationName", "publisherName", "extensionTypeName", "versionName")
...
func TestFormatExtensionTypeVersionID(t *testing.T) {
	actual := NewExtensionTypeVersionID("12345678-1234-9876-4563-123456789012", "locationName", "publisherName", "extensionTypeName", "versionName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.HybridCompute/locations/locationName/publishers/publisherName/extensionTypes/extensionTypeName/versions/versionName"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseExtensionTypeVersionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ExtensionTypeVersionId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.HybridCompute/locations/locationName/publishers/publisherName/extensionTypes/extensionTypeName/versions",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.HybridCompute/locations/locationName/publishers/publisherName/extensionTypes/extensionTypeName/versions/versionName",
			Expected: &ExtensionTypeVersionId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.HybridCompute/locations/locationName/publishers/publisherName/extensionTypes/extensionTypeName/versions/versionName/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseExtensionTypeVersionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseExtensionTypeVersionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ExtensionTypeVersionId
	...
	for _, v := range testData {
		...
		actual, err := ParseExtensionTypeVersionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForExtensionTypeVersionId(t *testing.T) {
	segments := ExtensionTypeVersionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ExtensionTypeVersionId has no segments")
	}
