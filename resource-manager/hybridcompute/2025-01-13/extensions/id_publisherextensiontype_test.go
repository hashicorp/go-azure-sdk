...
func TestNewPublisherExtensionTypeID(t *testing.T) {
	id := NewPublisherExtensionTypeID("12345678-1234-9876-4563-123456789012", "locationName", "publisherName", "extensionTypeName")
...
func TestFormatPublisherExtensionTypeID(t *testing.T) {
	actual := NewPublisherExtensionTypeID("12345678-1234-9876-4563-123456789012", "locationName", "publisherName", "extensionTypeName").ID()
...
func TestParsePublisherExtensionTypeID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *PublisherExtensionTypeId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParsePublisherExtensionTypeID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParsePublisherExtensionTypeIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *PublisherExtensionTypeId
	...
	for _, v := range testData {
		...
		actual, err := ParsePublisherExtensionTypeIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForPublisherExtensionTypeId(t *testing.T) {
	segments := PublisherExtensionTypeId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("PublisherExtensionTypeId has no segments")
	}
