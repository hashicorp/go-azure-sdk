...
func (c ProxyClient) SpatialAnchorsAccountsListBySubscription(ctx context.Context, id commonids.SubscriptionId) (resp SpatialAnchorsAccountsListBySubscriptionOperationResponse, err error) {
	req, err := c.preparerForSpatialAnchorsAccountsListBySubscription(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "proxy.ProxyClient", "SpatialAnchorsAccountsListBySubscription", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "proxy.ProxyClient", "SpatialAnchorsAccountsListBySubscription", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForSpatialAnchorsAccountsListBySubscription(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "proxy.ProxyClient", "SpatialAnchorsAccountsListBySubscription", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ProxyClient) SpatialAnchorsAccountsListBySubscriptionCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, predicate SpatialAnchorsAccountOperationPredicate) (resp SpatialAnchorsAccountsListBySubscriptionCompleteResult, err error) {
...
func (c ProxyClient) preparerForSpatialAnchorsAccountsListBySubscription(ctx context.Context, id commonids.SubscriptionId) (*http.Request, error) {
...
func (c ProxyClient) preparerForSpatialAnchorsAccountsListBySubscriptionWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ProxyClient) responderForSpatialAnchorsAccountsListBySubscription(resp *http.Response) (result SpatialAnchorsAccountsListBySubscriptionOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result SpatialAnchorsAccountsListBySubscriptionOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "proxy.ProxyClient", "SpatialAnchorsAccountsListBySubscription", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForSpatialAnchorsAccountsListBySubscription(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "proxy.ProxyClient", "SpatialAnchorsAccountsListBySubscription", result.HttpResponse, "Failure responding to request")
				return
			}
