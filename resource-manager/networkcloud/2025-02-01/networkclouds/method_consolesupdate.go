...
func (c NetworkcloudsClient) ConsolesUpdateThenPoll(ctx context.Context, id ConsoleId, input ConsolePatchParameters, options ConsolesUpdateOperationOptions) error {
	return c.ConsolesUpdateCallbackThenPoll(ctx, id, input, options, nil)
}

// ConsolesUpdateCallbackThenPoll performs ConsolesUpdate, runs the optional callback function, then polls until it's completed
func (c NetworkcloudsClient) ConsolesUpdateCallbackThenPoll(ctx context.Context, id ConsoleId, input ConsolePatchParameters, options ConsolesUpdateOperationOptions, callback func() error) error {
