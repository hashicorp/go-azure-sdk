...
func ParseBmcKeySetID(input string) (*BmcKeySetId, error) {
	...
	if id.BmcKeySetName, ok = parsed.Parsed["bmcKeySetName"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "bmcKeySetName", *parsed)
	}
...
func (id BmcKeySetId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("bmcKeySetName", "bmcKeySetValue"),
	}
}
