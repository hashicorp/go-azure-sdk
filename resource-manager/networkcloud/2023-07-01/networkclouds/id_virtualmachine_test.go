...
func TestFormatVirtualMachineID(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.NetworkCloud/virtualMachines/virtualMachineValue"
	if actual != expected {
...
func TestParseVirtualMachineID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.NetworkCloud/virtualMachines/virtualMachineValue/extra",
			Error: true,
		},
	}
