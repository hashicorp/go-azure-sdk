...
// Update ...
func (c ConsolesClient) Update(ctx context.Context, id ConsoleId, input ConsolePatchParameters, options UpdateOperationOptions) (result UpdateOperationResponse, err error) {
