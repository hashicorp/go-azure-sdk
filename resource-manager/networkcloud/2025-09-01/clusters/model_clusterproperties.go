...
type ClusterProperties struct {
	...
	ClusterExtendedLocation           *AzureResourceManagerCommonTypesExtendedLocation `json:"clusterExtendedLocation,omitempty"`
	...
	HybridAksExtendedLocation         *AzureResourceManagerCommonTypesExtendedLocation `json:"hybridAksExtendedLocation,omitempty"`
