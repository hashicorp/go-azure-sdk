...
type RestartNodeOperationResponse struct {
...
// RestartNode ...
func (c KubernetesClustersClient) RestartNode(ctx context.Context, id KubernetesClusterId, input KubernetesClusterRestartNodeParameters) (result RestartNodeOperationResponse, err error) {
...
func (c KubernetesClustersClient) RestartNodeThenPoll(ctx context.Context, id KubernetesClusterId, input KubernetesClusterRestartNodeParameters) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after RestartNode: %+v", err)
	}
