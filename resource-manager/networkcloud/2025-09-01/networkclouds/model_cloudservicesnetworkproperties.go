...
type CloudServicesNetworkProperties struct {
	...
	StorageOptions                 *CloudServicesNetworkStorageOptions               `json:"storageOptions,omitempty"`
	StorageStatus                  *CloudServicesNetworkStorageStatus                `json:"storageStatus,omitempty"`
