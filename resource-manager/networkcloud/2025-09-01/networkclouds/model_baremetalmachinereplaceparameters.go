...
type BareMetalMachineReplaceParameters struct {
	...
	SafeguardMode  *BareMetalMachineReplaceSafeguardMode `json:"safeguardMode,omitempty"`
	SerialNumber   *string                               `json:"serialNumber,omitempty"`
	StoragePolicy  *BareMetalMachineReplaceStoragePolicy `json:"storagePolicy,omitempty"`
}
