...
func (c KubernetesClusterFeaturesClient) ListByKubernetesCluster(ctx context.Context, id KubernetesClusterId, options ListByKubernetesClusterOperationOptions) (result ListByKubernetesClusterOperationResponse, err error) {
...
func (c KubernetesClusterFeaturesClient) ListByKubernetesClusterComplete(ctx context.Context, id KubernetesClusterId, options ListByKubernetesClusterOperationOptions) (ListByKubernetesClusterCompleteResult, error) {
	return c.ListByKubernetesClusterCompleteMatchingPredicate(ctx, id, options, KubernetesClusterFeatureOperationPredicate{})
}

// ListByKubernetesClusterCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c KubernetesClusterFeaturesClient) ListByKubernetesClusterCompleteMatchingPredicate(ctx context.Context, id KubernetesClusterId, options ListByKubernetesClusterOperationOptions, predicate KubernetesClusterFeatureOperationPredicate) (result ListByKubernetesClusterCompleteResult, err error) {
