...
type EnableRemoteVendorManagementOperationResponse struct {
...
func (c StorageAppliancesClient) EnableRemoteVendorManagement(ctx context.Context, id StorageApplianceId, input StorageApplianceEnableRemoteVendorManagementParameters) (result EnableRemoteVendorManagementOperationResponse, err error) {
...
func (c StorageAppliancesClient) EnableRemoteVendorManagementThenPoll(ctx context.Context, id StorageApplianceId, input StorageApplianceEnableRemoteVendorManagementParameters) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after EnableRemoteVendorManagement: %+v", err)
	}
