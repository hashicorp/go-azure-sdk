...
type AssignRelayOperationResponse struct {
...
// AssignRelay ...
func (c VirtualMachinesClient) AssignRelay(ctx context.Context, id VirtualMachineId, input VirtualMachineAssignRelayParameters) (result AssignRelayOperationResponse, err error) {
...
func (c VirtualMachinesClient) AssignRelayThenPoll(ctx context.Context, id VirtualMachineId, input VirtualMachineAssignRelayParameters) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after AssignRelay: %+v", err)
	}
