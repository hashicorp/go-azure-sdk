...
// Update ...
func (c ClusterManagersClient) Update(ctx context.Context, id ClusterManagerId, input ClusterManagerPatchParameters, options UpdateOperationOptions) (result UpdateOperationResponse, err error) {
