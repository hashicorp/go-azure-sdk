...
// Update ...
func (c TrunkedNetworksClient) Update(ctx context.Context, id TrunkedNetworkId, input TrunkedNetworkPatchParameters, options UpdateOperationOptions) (result UpdateOperationResponse, err error) {
