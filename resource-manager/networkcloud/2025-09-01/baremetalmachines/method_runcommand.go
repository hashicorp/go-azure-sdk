...
// RunCommand ...
func (c BareMetalMachinesClient) RunCommand(ctx context.Context, id BareMetalMachineId, input BareMetalMachineRunCommandParameters) (result RunCommandOperationResponse, err error) {
