...
type UncordonOperationResponse struct {
...
// Uncordon ...
func (c BareMetalMachinesClient) Uncordon(ctx context.Context, id BareMetalMachineId) (result UncordonOperationResponse, err error) {
...
func (c BareMetalMachinesClient) UncordonThenPoll(ctx context.Context, id BareMetalMachineId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after Uncordon: %+v", err)
	}
