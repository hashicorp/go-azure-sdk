...
func (c ClusterMetricsConfigurationsClient) MetricsConfigurationsUpdate(ctx context.Context, id MetricsConfigurationId, input ClusterMetricsConfigurationPatchParameters, options MetricsConfigurationsUpdateOperationOptions) (result MetricsConfigurationsUpdateOperationResponse, err error) {
...
func (c ClusterMetricsConfigurationsClient) MetricsConfigurationsUpdateThenPoll(ctx context.Context, id MetricsConfigurationId, input ClusterMetricsConfigurationPatchParameters, options MetricsConfigurationsUpdateOperationOptions) error {
...
func (c ClusterMetricsConfigurationsClient) MetricsConfigurationsUpdateCallbackThenPoll(ctx context.Context, id MetricsConfigurationId, input ClusterMetricsConfigurationPatchParameters, options MetricsConfigurationsUpdateOperationOptions, callback func() error) error {
