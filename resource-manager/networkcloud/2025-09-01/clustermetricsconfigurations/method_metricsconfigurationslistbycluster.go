...
func (c ClusterMetricsConfigurationsClient) MetricsConfigurationsListByCluster(ctx context.Context, id ClusterId, options MetricsConfigurationsListByClusterOperationOptions) (result MetricsConfigurationsListByClusterOperationResponse, err error) {
...
func (c ClusterMetricsConfigurationsClient) MetricsConfigurationsListByClusterComplete(ctx context.Context, id ClusterId, options MetricsConfigurationsListByClusterOperationOptions) (MetricsConfigurationsListByClusterCompleteResult, error) {
...
func (c ClusterMetricsConfigurationsClient) MetricsConfigurationsListByClusterCompleteMatchingPredicate(ctx context.Context, id ClusterId, options MetricsConfigurationsListByClusterOperationOptions, predicate ClusterMetricsConfigurationOperationPredicate) (result MetricsConfigurationsListByClusterCompleteResult, err error) {
