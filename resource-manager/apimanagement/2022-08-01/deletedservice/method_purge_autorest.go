...
func (c DeletedServiceClient) Purge(ctx context.Context, id DeletedServiceId) (result PurgeOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "deletedservice.DeletedServiceClient", "Purge", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForPurge(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "deletedservice.DeletedServiceClient", "Purge", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c DeletedServiceClient) preparerForPurge(ctx context.Context, id DeletedServiceId) (*http.Request, error) {
...
func (c DeletedServiceClient) senderForPurge(ctx context.Context, req *http.Request) (future PurgeOperationResponse, err error) {
