...
func (c ApiSchemaClient) ListByApi(ctx context.Context, id ApiId, options ListByApiOperationOptions) (resp ListByApiOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "apischema.ApiSchemaClient", "ListByApi", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "apischema.ApiSchemaClient", "ListByApi", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByApi(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "apischema.ApiSchemaClient", "ListByApi", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ApiSchemaClient) preparerForListByApi(ctx context.Context, id ApiId, options ListByApiOperationOptions) (*http.Request, error) {
...
func (c ApiSchemaClient) preparerForListByApiWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ApiSchemaClient) responderForListByApi(resp *http.Response) (result ListByApiOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByApiOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "apischema.ApiSchemaClient", "ListByApi", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByApi(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "apischema.ApiSchemaClient", "ListByApi", result.HttpResponse, "Failure responding to request")
				return
			}
