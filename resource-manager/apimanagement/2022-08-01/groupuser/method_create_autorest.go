...
func (c GroupUserClient) Create(ctx context.Context, id UserId) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "groupuser.GroupUserClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForCreate(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "groupuser.GroupUserClient", "Create", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c GroupUserClient) responderForCreate(resp *http.Response) (result CreateOperationResponse, err error) {
