...
import (
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/apimanagement/2022-08-01/documentation"
...
type Client struct {
	...
	Documentation                        *documentation.DocumentationClient
...
func NewClientWithBaseURI(endpoint string, configureAuthFunc func(c *autorest.Client)) Client {
	...
	documentationClient := documentation.NewDocumentationClientWithBaseURI(endpoint)
	configureAuthFunc(&documentationClient.Client)
