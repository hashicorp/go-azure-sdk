...
func (c ApiManagementServiceClient) MigrateToStv2ThenPoll(ctx context.Context, id ServiceId) error {
	return c.MigrateToStv2CallbackThenPoll(ctx, id, nil)
}

// MigrateToStv2CallbackThenPoll performs MigrateToStv2, runs the optional callback function, then polls until it's completed
func (c ApiManagementServiceClient) MigrateToStv2CallbackThenPoll(ctx context.Context, id ServiceId, callback func() error) error {
