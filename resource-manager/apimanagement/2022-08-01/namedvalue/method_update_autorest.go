...
func (c NamedValueClient) Update(ctx context.Context, id NamedValueId, input NamedValueUpdateParameters, options UpdateOperationOptions) (result UpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "namedvalue.NamedValueClient", "Update", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForUpdate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "namedvalue.NamedValueClient", "Update", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c NamedValueClient) preparerForUpdate(ctx context.Context, id NamedValueId, input NamedValueUpdateParameters, options UpdateOperationOptions) (*http.Request, error) {
...
func (c NamedValueClient) senderForUpdate(ctx context.Context, req *http.Request) (future UpdateOperationResponse, err error) {
