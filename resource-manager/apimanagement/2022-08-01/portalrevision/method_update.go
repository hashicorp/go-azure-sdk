...
func (c PortalRevisionClient) UpdateCallbackThenPoll(ctx context.Context, id PortalRevisionId, input PortalRevisionContract, options UpdateOperationOptions, callback func() error) error {
