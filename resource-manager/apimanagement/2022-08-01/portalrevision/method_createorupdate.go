...
func (c PortalRevisionClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id PortalRevisionId, input PortalRevisionContract, callback func() error) error {
