...
func (c PortalRevisionClient) Update(ctx context.Context, id PortalRevisionId, input PortalRevisionContract, options UpdateOperationOptions) (result UpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "portalrevision.PortalRevisionClient", "Update", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForUpdate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "portalrevision.PortalRevisionClient", "Update", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c PortalRevisionClient) preparerForUpdate(ctx context.Context, id PortalRevisionId, input PortalRevisionContract, options UpdateOperationOptions) (*http.Request, error) {
...
func (c PortalRevisionClient) senderForUpdate(ctx context.Context, req *http.Request) (future UpdateOperationResponse, err error) {
