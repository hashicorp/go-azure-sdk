...
func (c GatewayApiClient) Delete(ctx context.Context, id GatewayApiId) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "gatewayapi.GatewayApiClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForDelete(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "gatewayapi.GatewayApiClient", "Delete", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c GatewayApiClient) responderForDelete(resp *http.Response) (result DeleteOperationResponse, err error) {
