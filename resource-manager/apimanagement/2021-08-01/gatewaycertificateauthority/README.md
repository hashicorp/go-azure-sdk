...
```go
ctx := context.TODO()
id := gatewaycertificateauthority.NewCertificateAuthoritiesID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serviceValue", "gatewayIdValue", "certificateIdValue")
