...
func (c ApiSchemaClient) Get(ctx context.Context, id SchemaId) (result GetOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "apischema.ApiSchemaClient", "Get", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForGet(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "apischema.ApiSchemaClient", "Get", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c ApiSchemaClient) responderForGet(resp *http.Response) (result GetOperationResponse, err error) {
