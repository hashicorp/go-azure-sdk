...
func (c ApiDiagnosticClient) Get(ctx context.Context, id ApiDiagnosticId) (result GetOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "apidiagnostic.ApiDiagnosticClient", "Get", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForGet(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "apidiagnostic.ApiDiagnosticClient", "Get", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c ApiDiagnosticClient) responderForGet(resp *http.Response) (result GetOperationResponse, err error) {
