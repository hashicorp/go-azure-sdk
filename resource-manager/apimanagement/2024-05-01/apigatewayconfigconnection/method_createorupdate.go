...
func (c ApiGatewayConfigConnectionClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ConfigConnectionId, input ApiManagementGatewayConfigConnectionResource, callback func() error) error {
