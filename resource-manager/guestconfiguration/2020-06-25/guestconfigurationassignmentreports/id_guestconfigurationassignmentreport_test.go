...
func TestNewGuestConfigurationAssignmentReportID(t *testing.T) {
	id := NewGuestConfigurationAssignmentReportID("12345678-1234-9876-4563-123456789012", "example-resource-group", "virtualMachineValue", "guestConfigurationAssignmentValue", "reportIdValue")
...
func TestFormatGuestConfigurationAssignmentReportID(t *testing.T) {
	actual := NewGuestConfigurationAssignmentReportID("12345678-1234-9876-4563-123456789012", "example-resource-group", "virtualMachineValue", "guestConfigurationAssignmentValue", "reportIdValue").ID()
