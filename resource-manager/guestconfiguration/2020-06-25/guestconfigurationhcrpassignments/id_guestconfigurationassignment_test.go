...
func TestNewGuestConfigurationAssignmentID(t *testing.T) {
	id := NewGuestConfigurationAssignmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "machineName", "guestConfigurationAssignmentName")
...
func TestFormatGuestConfigurationAssignmentID(t *testing.T) {
	actual := NewGuestConfigurationAssignmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "machineName", "guestConfigurationAssignmentName").ID()
