...
func NewGuestConfigurationConnectedVMwarevSphereAssignmentsReportsClientWithBaseURI(api sdkEnv.Api) (*GuestConfigurationConnectedVMwarevSphereAssignmentsReportsClient, error) {
