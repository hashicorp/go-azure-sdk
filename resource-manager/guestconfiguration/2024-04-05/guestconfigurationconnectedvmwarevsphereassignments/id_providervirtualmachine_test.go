...
func TestNewProviderVirtualMachineID(t *testing.T) {
	id := NewProviderVirtualMachineID("12345678-1234-9876-4563-123456789012", "example-resource-group", "virtualMachineName")
...
func TestFormatProviderVirtualMachineID(t *testing.T) {
	actual := NewProviderVirtualMachineID("12345678-1234-9876-4563-123456789012", "example-resource-group", "virtualMachineName").ID()
