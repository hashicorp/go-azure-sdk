...
func TestNewProviderVirtualMachineProviders2GuestConfigurationAssignmentID(t *testing.T) {
	id := NewProviderVirtualMachineProviders2GuestConfigurationAssignmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "virtualMachineValue", "guestConfigurationAssignmentValue")
...
func TestFormatProviderVirtualMachineProviders2GuestConfigurationAssignmentID(t *testing.T) {
	actual := NewProviderVirtualMachineProviders2GuestConfigurationAssignmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "virtualMachineValue", "guestConfigurationAssignmentValue").ID()
