...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cognitive/2026-03-01/raiexternalsafetyprovider` Documentation

The `raiexternalsafetyprovider` SDK allows for interaction with Azure Resource Manager `cognitive` (API Version `2026-03-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/cognitive/2026-03-01/raiexternalsafetyprovider"
```
