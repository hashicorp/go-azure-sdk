...
func (c ManagedNetworkClient) ProvisionsProvisionManagedNetwork(ctx context.Context, id ManagedNetworkId, input interface{}) (result ProvisionsProvisionManagedNetworkOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:       fmt.Sprintf("%s/provision", id.ID()),
	}
...
func (c ManagedNetworkClient) ProvisionsProvisionManagedNetworkThenPoll(ctx context.Context, id ManagedNetworkId, input interface{}) error {
...
func (c ManagedNetworkClient) ProvisionsProvisionManagedNetworkCallbackThenPoll(ctx context.Context, id ManagedNetworkId, input interface{}, callback func() error) error {
