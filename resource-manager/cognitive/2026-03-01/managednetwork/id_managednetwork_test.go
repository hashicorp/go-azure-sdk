...
func TestNewManagedNetworkID(t *testing.T) {
	id := NewManagedNetworkID("12345678-1234-9876-4563-123456789012", "example-resource-group", "accountName", "managedNetworkName")
...
func TestFormatManagedNetworkID(t *testing.T) {
	actual := NewManagedNetworkID("12345678-1234-9876-4563-123456789012", "example-resource-group", "accountName", "managedNetworkName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CognitiveServices/accounts/accountName/managedNetworks/managedNetworkName"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseManagedNetworkID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ManagedNetworkId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CognitiveServices/accounts/accountName/managedNetworks/managedNetworkName/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseManagedNetworkID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseManagedNetworkIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ManagedNetworkId
	...
	for _, v := range testData {
		...
		actual, err := ParseManagedNetworkIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForManagedNetworkId(t *testing.T) {
	segments := ManagedNetworkId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ManagedNetworkId has no segments")
	}
