...
type ListCompleteResult struct {
	...
	Items              []ModelCapacityListResultValueItem
}
...
func (c ModelCapacitiesClient) List(ctx context.Context, id commonids.SubscriptionId, options ListOperationOptions) (result ListOperationResponse, err error) {
	...
	var values struct {
		Values *[]ModelCapacityListResultValueItem `json:"value"`
	}
...
func (c ModelCapacitiesClient) ListComplete(ctx context.Context, id commonids.SubscriptionId, options ListOperationOptions) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, options, ModelCapacityListResultValueItemOperationPredicate{})
}

// ListCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ModelCapacitiesClient) ListCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, options ListOperationOptions, predicate ModelCapacityListResultValueItemOperationPredicate) (result ListCompleteResult, err error) {
	items := make([]ModelCapacityListResultValueItem, 0)
