...
func NewRaiPolicyID(subscriptionId string, raiPolicyName string) RaiPolicyId {
	return RaiPolicyId{
...
func (id RaiPolicyId) ID() string {
	fmtString := "/subscriptions/%s/providers/Microsoft.CognitiveServices/raiPolicy/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.RaiPolicyName)
}
...
func (id RaiPolicyId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.StaticSegment("staticRaiPolicy", "raiPolicy", "raiPolicy"),
