...
func NewApplicationID(subscriptionId string, resourceGroupName string, accountName string, projectName string, applicationName string) ApplicationId {
...
func (id ApplicationId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.CognitiveServices/accounts/%s/projects/%s/applications/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.AccountName, id.ProjectName, id.ApplicationName)
}
