...
func TestNewProjectConnectionID(t *testing.T) {
	id := NewProjectConnectionID("12345678-1234-9876-4563-123456789012", "example-resource-group", "accountName", "projectName", "connectionName")
...
func TestFormatProjectConnectionID(t *testing.T) {
	actual := NewProjectConnectionID("12345678-1234-9876-4563-123456789012", "example-resource-group", "accountName", "projectName", "connectionName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CognitiveServices/accounts/accountName/projects/projectName/connections/connectionName"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseProjectConnectionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ProjectConnectionId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CognitiveServices/accounts/accountName/projects/projectName/connections",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CognitiveServices/accounts/accountName/projects/projectName/connections/connectionName",
			Expected: &ProjectConnectionId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CognitiveServices/accounts/accountName/projects/projectName/connections/connectionName/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseProjectConnectionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseProjectConnectionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ProjectConnectionId
	...
	for _, v := range testData {
		...
		actual, err := ParseProjectConnectionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForProjectConnectionId(t *testing.T) {
	segments := ProjectConnectionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ProjectConnectionId has no segments")
	}
