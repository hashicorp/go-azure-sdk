...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cognitive/2022-12-01/cognitiveservicescommitmentplans` Documentation

The `cognitiveservicescommitmentplans` SDK allows for interaction with the Azure Resource Manager Service `cognitive` (API Version `2022-12-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cognitive/2022-12-01/cognitiveservicescommitmentplans"
```
