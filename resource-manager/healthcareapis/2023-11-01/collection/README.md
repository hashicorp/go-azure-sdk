...
## `github.com/hashicorp/go-azure-sdk/resource-manager/healthcareapis/2023-11-01/collection` Documentation

The `collection` SDK allows for interaction with Azure Resource Manager `healthcareapis` (API Version `2023-11-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/healthcareapis/2023-11-01/collection"
```
