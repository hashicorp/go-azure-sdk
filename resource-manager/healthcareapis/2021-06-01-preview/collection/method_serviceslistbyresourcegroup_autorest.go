...
func (c CollectionClient) ServicesListByResourceGroup(ctx context.Context, id commonids.ResourceGroupId) (resp ServicesListByResourceGroupOperationResponse, err error) {
...
func (c CollectionClient) responderForServicesListByResourceGroup(resp *http.Response) (result ServicesListByResourceGroupOperationResponse, err error) {
	type page struct {
