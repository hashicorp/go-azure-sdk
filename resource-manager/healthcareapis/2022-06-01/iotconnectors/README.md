...
## `github.com/hashicorp/go-azure-sdk/resource-manager/healthcareapis/2022-06-01/iotconnectors` Documentation

The `iotconnectors` SDK allows for interaction with the Azure Resource Manager Service `healthcareapis` (API Version `2022-06-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/healthcareapis/2022-06-01/iotconnectors"
```
