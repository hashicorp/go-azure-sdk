...
## `github.com/hashicorp/go-azure-sdk/resource-manager/healthcareapis/2023-02-28/iotconnectors` Documentation

The `iotconnectors` SDK allows for interaction with Azure Resource Manager `healthcareapis` (API Version `2023-02-28`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/healthcareapis/2023-02-28/iotconnectors"
```
