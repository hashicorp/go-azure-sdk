...
## `github.com/hashicorp/go-azure-sdk/resource-manager/healthcareapis/2023-02-28/workspaces` Documentation

The `workspaces` SDK allows for interaction with Azure Resource Manager `healthcareapis` (API Version `2023-02-28`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/healthcareapis/2023-02-28/workspaces"
```
