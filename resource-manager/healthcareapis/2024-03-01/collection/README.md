...
## `github.com/hashicorp/go-azure-sdk/resource-manager/healthcareapis/2024-03-01/collection` Documentation

The `collection` SDK allows for interaction with the Azure Resource Manager Service `healthcareapis` (API Version `2024-03-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/healthcareapis/2024-03-01/collection"
```
