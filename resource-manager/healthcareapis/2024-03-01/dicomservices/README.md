...
## `github.com/hashicorp/go-azure-sdk/resource-manager/healthcareapis/2024-03-01/dicomservices` Documentation

The `dicomservices` SDK allows for interaction with the Azure Resource Manager Service `healthcareapis` (API Version `2024-03-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/healthcareapis/2024-03-01/dicomservices"
```
