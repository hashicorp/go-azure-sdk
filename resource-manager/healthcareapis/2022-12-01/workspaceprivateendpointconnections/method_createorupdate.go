...
func (c WorkspacePrivateEndpointConnectionsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id WorkspacePrivateEndpointConnectionId, input PrivateEndpointConnectionDescription, callback func() error) error {
