...
func (c OpenShiftClustersClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ProviderOpenShiftClusterId, input OpenShiftCluster, callback func() error) error {
