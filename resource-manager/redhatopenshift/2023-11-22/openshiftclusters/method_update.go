...
func (c OpenShiftClustersClient) UpdateCallbackThenPoll(ctx context.Context, id ProviderOpenShiftClusterId, input OpenShiftClusterUpdate, callback func() error) error {
