...
## `github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2024-02-01/managedclusters` Documentation

The `managedclusters` SDK allows for interaction with the Azure Resource Manager Service `containerservice` (API Version `2024-02-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2024-02-01/managedclusters"
```
