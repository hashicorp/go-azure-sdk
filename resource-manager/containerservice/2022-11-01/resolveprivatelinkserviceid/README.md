...
## `github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2022-11-01/resolveprivatelinkserviceid` Documentation

The `resolveprivatelinkserviceid` SDK allows for interaction with the Azure Resource Manager Service `containerservice` (API Version `2022-11-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2022-11-01/resolveprivatelinkserviceid"
```
