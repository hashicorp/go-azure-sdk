...
func (c ManagedClustersClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.KubernetesClusterId, input ManagedCluster, callback func() error) error {
