...
import (
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2025-07-01/machines"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2025-07-01/privateendpointconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2025-07-01/privatelinkresources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2025-07-01/resolveprivatelinkserviceid"
...
type Client struct {
	...
	DeploymentSafeguards        *deploymentsafeguards.DeploymentSafeguardsClient
...
func NewClientWithBaseURI(sdkApi sdkEnv.Api, configureFunc func(c *resourcemanager.Client)) (*Client, error) {
	...
	deploymentSafeguardsClient, err := deploymentsafeguards.NewDeploymentSafeguardsClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building DeploymentSafeguards client: %+v", err)
	}
	configureFunc(deploymentSafeguardsClient.Client)
	...
	return &Client{
		...
		DeploymentSafeguards:        deploymentSafeguardsClient,
