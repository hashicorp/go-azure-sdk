...
The `managedclusters` SDK allows for interaction with Azure Resource Manager `containerservice` (API Version `2023-09-02-preview`).
...
```go
ctx := context.TODO()
id := managedclusters.NewGuardrailsVersionID("12345678-1234-9876-4563-123456789012", "location", "version")
