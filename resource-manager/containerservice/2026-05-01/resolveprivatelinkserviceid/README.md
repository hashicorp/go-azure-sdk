...
## `github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2026-05-01/resolveprivatelinkserviceid` Documentation

The `resolveprivatelinkserviceid` SDK allows for interaction with Azure Resource Manager `containerservice` (API Version `2026-05-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2026-05-01/resolveprivatelinkserviceid"
```
