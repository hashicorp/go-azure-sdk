...
func TestNewLongTermRetentionDatabaseID(t *testing.T) {
	id := NewLongTermRetentionDatabaseID("12345678-1234-9876-4563-123456789012", "locationValue", "longTermRetentionServerValue", "longTermRetentionDatabaseValue")
...
func TestFormatLongTermRetentionDatabaseID(t *testing.T) {
	actual := NewLongTermRetentionDatabaseID("12345678-1234-9876-4563-123456789012", "locationValue", "longTermRetentionServerValue", "longTermRetentionDatabaseValue").ID()
