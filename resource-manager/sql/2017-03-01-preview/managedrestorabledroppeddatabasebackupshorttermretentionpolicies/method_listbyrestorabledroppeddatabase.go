...
func (c ManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClient) ListByRestorableDroppedDatabase(ctx context.Context, id RestorableDroppedDatabaseId) (result ListByRestorableDroppedDatabaseOperationResponse, err error) {
...
func (c ManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClient) ListByRestorableDroppedDatabaseComplete(ctx context.Context, id RestorableDroppedDatabaseId) (ListByRestorableDroppedDatabaseCompleteResult, error) {
...
func (c ManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClient) ListByRestorableDroppedDatabaseCompleteMatchingPredicate(ctx context.Context, id RestorableDroppedDatabaseId, predicate ManagedBackupShortTermRetentionPolicyOperationPredicate) (result ListByRestorableDroppedDatabaseCompleteResult, err error) {
