...
## `github.com/hashicorp/go-azure-sdk/resource-manager/sql/2017-03-01-preview/managedrestorabledroppeddatabasebackupshorttermretentionpolicies` Documentation

The `managedrestorabledroppeddatabasebackupshorttermretentionpolicies` SDK allows for interaction with the Azure Resource Manager Service `sql` (API Version `2017-03-01-preview`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/sql/2017-03-01-preview/managedrestorabledroppeddatabasebackupshorttermretentionpolicies"
```
...
```go
ctx := context.TODO()
id := managedrestorabledroppeddatabasebackupshorttermretentionpolicies.NewRestorableDroppedDatabaseID("12345678-1234-9876-4563-123456789012", "example-resource-group", "managedInstanceValue", "restorableDroppedDatabaseIdValue")
