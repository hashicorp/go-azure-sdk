...
// Get ...
func (c ManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClient) Get(ctx context.Context, id RestorableDroppedDatabaseId) (result GetOperationResponse, err error) {
