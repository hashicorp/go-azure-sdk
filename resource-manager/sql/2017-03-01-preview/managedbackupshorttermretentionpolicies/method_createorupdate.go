...
func (c ManagedBackupShortTermRetentionPoliciesClient) CreateOrUpdateThenPoll(ctx context.Context, id ManagedInstanceDatabaseId, input ManagedBackupShortTermRetentionPolicy) error {
