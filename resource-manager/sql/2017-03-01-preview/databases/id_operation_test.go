...
func TestNewOperationID(t *testing.T) {
	id := NewOperationID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverValue", "databaseValue", "operationIdValue")
...
func TestFormatOperationID(t *testing.T) {
	actual := NewOperationID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverValue", "databaseValue", "operationIdValue").ID()
