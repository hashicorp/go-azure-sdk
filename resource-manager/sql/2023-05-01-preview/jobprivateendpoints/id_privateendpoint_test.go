...
func TestNewPrivateEndpointID(t *testing.T) {
	id := NewPrivateEndpointID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverValue", "jobAgentValue", "privateEndpointValue")
...
func TestFormatPrivateEndpointID(t *testing.T) {
	actual := NewPrivateEndpointID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverValue", "jobAgentValue", "privateEndpointValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverValue/jobAgents/jobAgentValue/privateEndpoints/privateEndpointValue"
	if actual != expected {
...
func TestParsePrivateEndpointID(t *testing.T) {
	testData := []struct {
		...
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverValue/jobAgents/jobAgentValue/privateEndpoints/privateEndpointValue",
			Expected: &PrivateEndpointId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverValue/jobAgents/jobAgentValue/privateEndpoints/privateEndpointValue/extra",
			Error: true,
		},
	}
