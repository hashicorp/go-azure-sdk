...
func TestNewExecutionStepID(t *testing.T) {
	id := NewExecutionStepID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverName", "jobAgentName", "jobName", "jobExecutionId", "stepName")
...
func TestFormatExecutionStepID(t *testing.T) {
	actual := NewExecutionStepID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverName", "jobAgentName", "jobName", "jobExecutionId", "stepName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverName/jobAgents/jobAgentName/jobs/jobName/executions/jobExecutionId/steps/stepName"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseExecutionStepID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ExecutionStepId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverName/jobAgents/jobAgentName/jobs/jobName/executions/jobExecutionId/steps/stepName/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseExecutionStepID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseExecutionStepIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ExecutionStepId
	...
	for _, v := range testData {
		...
		actual, err := ParseExecutionStepIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForExecutionStepId(t *testing.T) {
	segments := ExecutionStepId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ExecutionStepId has no segments")
	}
