...
func (c WorkloadClassifiersClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id WorkloadClassifierId, input WorkloadClassifier, callback func() error) error {
