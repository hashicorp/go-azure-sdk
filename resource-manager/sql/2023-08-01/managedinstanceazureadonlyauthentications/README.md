...
## `github.com/hashicorp/go-azure-sdk/resource-manager/sql/2023-08-01/managedinstanceazureadonlyauthentications` Documentation

The `managedinstanceazureadonlyauthentications` SDK allows for interaction with Azure Resource Manager `sql` (API Version `2023-08-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/sql/2023-08-01/managedinstanceazureadonlyauthentications"
```
