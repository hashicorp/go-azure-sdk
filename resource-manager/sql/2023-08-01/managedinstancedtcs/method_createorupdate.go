...
func (c ManagedInstanceDtcsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.SqlManagedInstanceId, input ManagedInstanceDtc, callback func() error) error {
