...
## `github.com/hashicorp/go-azure-sdk/resource-manager/sql/2023-08-01/jobexecutions` Documentation

The `jobexecutions` SDK allows for interaction with Azure Resource Manager `sql` (API Version `2023-08-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/sql/2023-08-01/jobexecutions"
```
