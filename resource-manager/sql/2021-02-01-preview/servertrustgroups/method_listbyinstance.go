...
// ListByInstance ...
func (c ServerTrustGroupsClient) ListByInstance(ctx context.Context, id ManagedInstanceId) (result ListByInstanceOperationResponse, err error) {
...
func (c ServerTrustGroupsClient) ListByInstanceComplete(ctx context.Context, id ManagedInstanceId) (ListByInstanceCompleteResult, error) {
...
func (c ServerTrustGroupsClient) ListByInstanceCompleteMatchingPredicate(ctx context.Context, id ManagedInstanceId, predicate ServerTrustGroupOperationPredicate) (result ListByInstanceCompleteResult, err error) {
