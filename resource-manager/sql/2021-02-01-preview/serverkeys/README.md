...
## `github.com/hashicorp/go-azure-sdk/resource-manager/sql/2021-02-01-preview/serverkeys` Documentation

The `serverkeys` SDK allows for interaction with the Azure Resource Manager Service `sql` (API Version `2021-02-01-preview`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/sql/2021-02-01-preview/serverkeys"
```
