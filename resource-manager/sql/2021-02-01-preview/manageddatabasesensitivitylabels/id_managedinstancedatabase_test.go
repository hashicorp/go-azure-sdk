...
func TestNewManagedInstanceDatabaseID(t *testing.T) {
	id := NewManagedInstanceDatabaseID("12345678-1234-9876-4563-123456789012", "example-resource-group", "managedInstanceValue", "databaseValue")
...
func TestFormatManagedInstanceDatabaseID(t *testing.T) {
	actual := NewManagedInstanceDatabaseID("12345678-1234-9876-4563-123456789012", "example-resource-group", "managedInstanceValue", "databaseValue").ID()
...
func TestParseManagedInstanceDatabaseID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ManagedInstanceDatabaseId
	}{
		{
			// Incomplete URI
			Input: "",
...
func TestParseManagedInstanceDatabaseIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ManagedInstanceDatabaseId
	...
	for _, v := range testData {
		...
		actual, err := ParseManagedInstanceDatabaseIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForManagedInstanceDatabaseId(t *testing.T) {
	segments := ManagedInstanceDatabaseId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ManagedInstanceDatabaseId has no segments")
	}
