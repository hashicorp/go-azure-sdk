...
// Get ...
func (c ManagedDatabaseAdvancedThreatProtectionSettingsClient) Get(ctx context.Context, id ManagedInstanceDatabaseId) (result GetOperationResponse, err error) {
