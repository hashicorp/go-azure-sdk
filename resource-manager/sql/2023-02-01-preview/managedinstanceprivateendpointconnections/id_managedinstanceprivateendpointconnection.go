...
func init() {
	recaser.RegisterResourceId(&ManagedInstancePrivateEndpointConnectionId{})
}
...
func (id *ManagedInstancePrivateEndpointConnectionId) FromParseResult(input resourceids.ParseResult) error {
	var ok bool
