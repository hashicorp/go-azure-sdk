...
func (c LongTermRetentionBackupsClient) UpdateCallbackThenPoll(ctx context.Context, id LongTermRetentionBackupId, input UpdateLongTermRetentionBackupParameters, callback func() error) error {
