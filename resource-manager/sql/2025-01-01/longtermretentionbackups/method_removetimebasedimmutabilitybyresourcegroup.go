...
type RemoveTimeBasedImmutabilityByResourceGroupOperationResponse struct {
...
func (c LongTermRetentionBackupsClient) RemoveTimeBasedImmutabilityByResourceGroup(ctx context.Context, id LongTermRetentionDatabaseLongTermRetentionBackupId) (result RemoveTimeBasedImmutabilityByResourceGroupOperationResponse, err error) {
...
func (c LongTermRetentionBackupsClient) RemoveTimeBasedImmutabilityByResourceGroupThenPoll(ctx context.Context, id LongTermRetentionDatabaseLongTermRetentionBackupId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after RemoveTimeBasedImmutabilityByResourceGroup: %+v", err)
	}
