...
type RemoveLegalHoldImmutabilityOperationResponse struct {
...
func (c LongTermRetentionBackupsClient) RemoveLegalHoldImmutability(ctx context.Context, id LongTermRetentionBackupId) (result RemoveLegalHoldImmutabilityOperationResponse, err error) {
...
func (c LongTermRetentionBackupsClient) RemoveLegalHoldImmutabilityThenPoll(ctx context.Context, id LongTermRetentionBackupId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after RemoveLegalHoldImmutability: %+v", err)
	}
