...
type SetLegalHoldImmutabilityByResourceGroupOperationResponse struct {
...
func (c LongTermRetentionBackupsClient) SetLegalHoldImmutabilityByResourceGroup(ctx context.Context, id LongTermRetentionDatabaseLongTermRetentionBackupId) (result SetLegalHoldImmutabilityByResourceGroupOperationResponse, err error) {
...
func (c LongTermRetentionBackupsClient) SetLegalHoldImmutabilityByResourceGroupThenPoll(ctx context.Context, id LongTermRetentionDatabaseLongTermRetentionBackupId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after SetLegalHoldImmutabilityByResourceGroup: %+v", err)
	}
