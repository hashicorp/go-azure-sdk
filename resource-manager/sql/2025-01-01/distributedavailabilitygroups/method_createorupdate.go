...
func (c DistributedAvailabilityGroupsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id DistributedAvailabilityGroupId, input DistributedAvailabilityGroup, callback func() error) error {
