...
func (c DistributedAvailabilityGroupsClient) UpdateCallbackThenPoll(ctx context.Context, id DistributedAvailabilityGroupId, input DistributedAvailabilityGroup, callback func() error) error {
