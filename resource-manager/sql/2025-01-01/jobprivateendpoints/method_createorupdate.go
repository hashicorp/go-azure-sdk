...
func (c JobPrivateEndpointsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id PrivateEndpointId, input JobPrivateEndpoint, callback func() error) error {
