...
func NewOperationID(subscriptionId string, resourceGroupName string, instancePoolName string, operationId string) OperationId {
	return OperationId{
...
func (id OperationId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.Sql/instancePools/%s/operations/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.InstancePoolName, id.OperationId)
}
