...
func (c RestorePointsClient) CreateCallbackThenPoll(ctx context.Context, id commonids.SqlDatabaseId, input CreateDatabaseRestorePointDefinition, callback func() error) error {
