...
func (c ServerTrustGroupsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ServerTrustGroupId, input ServerTrustGroup, callback func() error) error {
