...
func (c ServerConfigurationOptionsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.SqlManagedInstanceId, input ServerConfigurationOption, callback func() error) error {
