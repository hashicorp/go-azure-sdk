...
func TestNewLongTermRetentionDatabaseLongTermRetentionBackupID(t *testing.T) {
	id := NewLongTermRetentionDatabaseLongTermRetentionBackupID("12345678-1234-9876-4563-123456789012", "example-resource-group", "locationValue", "longTermRetentionServerValue", "longTermRetentionDatabaseValue", "longTermRetentionBackupValue")
...
func TestFormatLongTermRetentionDatabaseLongTermRetentionBackupID(t *testing.T) {
	actual := NewLongTermRetentionDatabaseLongTermRetentionBackupID("12345678-1234-9876-4563-123456789012", "example-resource-group", "locationValue", "longTermRetentionServerValue", "longTermRetentionDatabaseValue", "longTermRetentionBackupValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/locations/locationValue/longTermRetentionServers/longTermRetentionServerValue/longTermRetentionDatabases/longTermRetentionDatabaseValue/longTermRetentionBackups/longTermRetentionBackupValue"
	if actual != expected {
...
func TestParseLongTermRetentionDatabaseLongTermRetentionBackupID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/locations/locationValue/longTermRetentionServers/longTermRetentionServerValue/longTermRetentionDatabases/longTermRetentionDatabaseValue/longTermRetentionBackups",
			Error: true,
		},
		{
			// Valid URI
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/locations/locationValue/longTermRetentionServers/longTermRetentionServerValue/longTermRetentionDatabases/longTermRetentionDatabaseValue/longTermRetentionBackups/longTermRetentionBackupValue/extra",
			Error: true,
		},
	}
