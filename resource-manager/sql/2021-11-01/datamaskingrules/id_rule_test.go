...
func TestNewRuleID(t *testing.T) {
	id := NewRuleID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverValue", "databaseValue", "ruleValue")
...
func TestFormatRuleID(t *testing.T) {
	actual := NewRuleID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverValue", "databaseValue", "ruleValue").ID()
