...
func TestNewDatabaseOperationID(t *testing.T) {
	id := NewDatabaseOperationID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverValue", "databaseValue", "operationIdValue")
...
func TestFormatDatabaseOperationID(t *testing.T) {
	actual := NewDatabaseOperationID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverValue", "databaseValue", "operationIdValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverValue/databases/databaseValue/operations/operationIdValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseDatabaseOperationID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverValue/databases/databaseValue/operations",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverValue/databases/databaseValue/operations/operationIdValue",
			Expected: &DatabaseOperationId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverValue/databases/databaseValue/operations/operationIdValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseDatabaseOperationID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseDatabaseOperationIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *DatabaseOperationId
	...
	for _, v := range testData {
		...
		actual, err := ParseDatabaseOperationIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForDatabaseOperationId(t *testing.T) {
	segments := DatabaseOperationId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("DatabaseOperationId has no segments")
	}
