...
// CreateOrUpdate ...
func (c EncryptionProtectorsClient) CreateOrUpdate(ctx context.Context, id ServerId, input EncryptionProtector) (result CreateOrUpdateOperationResponse, err error) {
