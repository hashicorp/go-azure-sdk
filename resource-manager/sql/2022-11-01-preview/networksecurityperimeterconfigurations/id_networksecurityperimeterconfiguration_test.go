...
func TestNewNetworkSecurityPerimeterConfigurationID(t *testing.T) {
	id := NewNetworkSecurityPerimeterConfigurationID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverValue", "networkSecurityPerimeterConfigurationValue")
...
func TestFormatNetworkSecurityPerimeterConfigurationID(t *testing.T) {
	actual := NewNetworkSecurityPerimeterConfigurationID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverValue", "networkSecurityPerimeterConfigurationValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverValue/networkSecurityPerimeterConfigurations/networkSecurityPerimeterConfigurationValue"
	if actual != expected {
...
func TestParseNetworkSecurityPerimeterConfigurationID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverValue/networkSecurityPerimeterConfigurations",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverValue/networkSecurityPerimeterConfigurations/networkSecurityPerimeterConfigurationValue",
			Expected: &NetworkSecurityPerimeterConfigurationId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverValue/networkSecurityPerimeterConfigurations/networkSecurityPerimeterConfigurationValue/extra",
			Error: true,
		},
	}
