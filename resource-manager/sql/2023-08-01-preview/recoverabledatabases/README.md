...
## `github.com/hashicorp/go-azure-sdk/resource-manager/sql/2023-08-01-preview/recoverabledatabases` Documentation

The `recoverabledatabases` SDK allows for interaction with the Azure Resource Manager Service `sql` (API Version `2023-08-01-preview`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/sql/2023-08-01-preview/recoverabledatabases"
```
