...
func (c ManagedLedgerDigestUploadsClient) DisableCallbackThenPoll(ctx context.Context, id commonids.SqlManagedInstanceDatabaseId, callback func() error) error {
