...
func TestNewLongTermRetentionServerID(t *testing.T) {
	id := NewLongTermRetentionServerID("12345678-1234-9876-4563-123456789012", "locationValue", "longTermRetentionServerValue")
...
func TestFormatLongTermRetentionServerID(t *testing.T) {
	actual := NewLongTermRetentionServerID("12345678-1234-9876-4563-123456789012", "locationValue", "longTermRetentionServerValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.Sql/locations/locationValue/longTermRetentionServers/longTermRetentionServerValue"
	if actual != expected {
...
func TestParseLongTermRetentionServerID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.Sql/locations/locationValue/longTermRetentionServers/longTermRetentionServerValue/extra",
			Error: true,
		},
	}
