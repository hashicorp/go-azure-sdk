...
func (c OrganizationsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id OrganizationId, input InformaticaOrganizationResource, callback func() error) error {
