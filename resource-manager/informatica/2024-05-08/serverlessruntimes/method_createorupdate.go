...
func (c ServerlessRuntimesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ServerlessRuntimeId, input InformaticaServerlessRuntimeResource, callback func() error) error {
