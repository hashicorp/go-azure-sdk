...
func (c VideosClient) VideosList(ctx context.Context, id VideoAnalyzerId, options VideosListOperationOptions) (resp VideosListOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "videos.VideosClient", "VideosList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "videos.VideosClient", "VideosList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForVideosList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "videos.VideosClient", "VideosList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c VideosClient) preparerForVideosList(ctx context.Context, id VideoAnalyzerId, options VideosListOperationOptions) (*http.Request, error) {
...
func (c VideosClient) preparerForVideosListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c VideosClient) responderForVideosList(resp *http.Response) (result VideosListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result VideosListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "videos.VideosClient", "VideosList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForVideosList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "videos.VideosClient", "VideosList", result.HttpResponse, "Failure responding to request")
				return
			}
