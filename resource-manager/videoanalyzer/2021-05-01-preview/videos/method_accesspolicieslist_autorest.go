...
func (c VideosClient) AccessPoliciesList(ctx context.Context, id VideoAnalyzerId, options AccessPoliciesListOperationOptions) (resp AccessPoliciesListOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "videos.VideosClient", "AccessPoliciesList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "videos.VideosClient", "AccessPoliciesList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForAccessPoliciesList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "videos.VideosClient", "AccessPoliciesList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c VideosClient) preparerForAccessPoliciesList(ctx context.Context, id VideoAnalyzerId, options AccessPoliciesListOperationOptions) (*http.Request, error) {
...
func (c VideosClient) preparerForAccessPoliciesListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c VideosClient) responderForAccessPoliciesList(resp *http.Response) (result AccessPoliciesListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result AccessPoliciesListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "videos.VideosClient", "AccessPoliciesList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForAccessPoliciesList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "videos.VideosClient", "AccessPoliciesList", result.HttpResponse, "Failure responding to request")
				return
			}
