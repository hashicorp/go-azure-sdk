...
func (c DisksClient) preparerForList(ctx context.Context, id UserId, options ListOperationOptions) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/disks", id.ID())),
