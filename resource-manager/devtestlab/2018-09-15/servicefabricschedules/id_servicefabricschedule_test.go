...
func TestParseServiceFabricScheduleID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DevTestLab/labs/labValue/users",
			Error: true,
		},
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DevTestLab/labs/labValue/users/userValue",
			Error: true,
		},
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DevTestLab/labs/labValue/users/userValue/serviceFabrics",
			Error: true,
		},
		{
			// Incomplete URI
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.DevTestLab/labs/labValue/users/userValue/serviceFabrics/serviceFabricValue/schedules",
			Error: true,
		},
		{
			// Valid URI
	...
	for _, v := range testData {
		...
		actual, err := ParseServiceFabricScheduleID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseServiceFabricScheduleIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ServiceFabricScheduleId
	...
	for _, v := range testData {
		...
		actual, err := ParseServiceFabricScheduleIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForServiceFabricScheduleId(t *testing.T) {
	segments := ServiceFabricScheduleId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ServiceFabricScheduleId has no segments")
	}
