...
func (c ServiceFabricSchedulesClient) Execute(ctx context.Context, id ServiceFabricScheduleId) (result ExecuteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "servicefabricschedules.ServiceFabricSchedulesClient", "Execute", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForExecute(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "servicefabricschedules.ServiceFabricSchedulesClient", "Execute", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ServiceFabricSchedulesClient) preparerForExecute(ctx context.Context, id ServiceFabricScheduleId) (*http.Request, error) {
...
func (c ServiceFabricSchedulesClient) senderForExecute(ctx context.Context, req *http.Request) (future ExecuteOperationResponse, err error) {
