...
func (c ServiceFabricsClient) Start(ctx context.Context, id ServiceFabricId) (result StartOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "servicefabrics.ServiceFabricsClient", "Start", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForStart(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "servicefabrics.ServiceFabricsClient", "Start", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ServiceFabricsClient) preparerForStart(ctx context.Context, id ServiceFabricId) (*http.Request, error) {
...
func (c ServiceFabricsClient) senderForStart(ctx context.Context, req *http.Request) (future StartOperationResponse, err error) {
