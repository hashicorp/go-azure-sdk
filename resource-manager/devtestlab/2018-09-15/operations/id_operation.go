...
func ParseOperationID(input string) (*OperationId, error) {
	...
	if id.OperationName, ok = parsed.Parsed["operationName"]; !ok {
		return nil, fmt.Errorf("the segment 'operationName' was not found in the resource id %q", input)
	}
...
func (id OperationId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("operationName", "operationValue"),
	}
}
