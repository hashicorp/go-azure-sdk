...
// List ...
func (c SecretsClient) List(ctx context.Context, id UserId, options ListOperationOptions) (resp ListOperationResponse, err error) {
...
func (c SecretsClient) preparerForList(ctx context.Context, id UserId, options ListOperationOptions) (*http.Request, error) {
...
func (c SecretsClient) responderForList(resp *http.Response) (result ListOperationResponse, err error) {
	type page struct {
...
func (c SecretsClient) ListCompleteMatchingPredicate(ctx context.Context, id UserId, options ListOperationOptions, predicate SecretOperationPredicate) (resp ListCompleteResult, err error) {
	items := make([]Secret, 0)
