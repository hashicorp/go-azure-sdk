...
## `github.com/hashicorp/go-azure-sdk/resource-manager/servicebus/2021-11-01/disasterrecoveryconfigs` Documentation
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/servicebus/2021-11-01/disasterrecoveryconfigs"
```
...
```go
ctx := context.TODO()
id := disasterrecoveryconfigs.NewDisasterRecoveryConfigAuthorizationRuleID("12345678-1234-9876-4563-123456789012", "example-resource-group", "namespaceValue", "aliasValue", "authorizationRuleValue")
