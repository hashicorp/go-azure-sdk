...
func (c MigrationConfigsClient) Get(ctx context.Context, id ConfigId) (result GetOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "migrationconfigs.MigrationConfigsClient", "Get", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForGet(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "migrationconfigs.MigrationConfigsClient", "Get", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c MigrationConfigsClient) responderForGet(resp *http.Response) (result GetOperationResponse, err error) {
