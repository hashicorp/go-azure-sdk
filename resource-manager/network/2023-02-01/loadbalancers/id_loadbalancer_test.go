...
func TestNewLoadBalancerID(t *testing.T) {
	id := NewLoadBalancerID("12345678-1234-9876-4563-123456789012", "example-resource-group", "loadBalancerValue")
...
func TestFormatLoadBalancerID(t *testing.T) {
	actual := NewLoadBalancerID("12345678-1234-9876-4563-123456789012", "example-resource-group", "loadBalancerValue").ID()
