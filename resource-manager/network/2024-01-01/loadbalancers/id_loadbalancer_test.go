...
func TestNewLoadBalancerID(t *testing.T) {
	id := NewLoadBalancerID("12345678-1234-9876-4563-123456789012", "resourceGroupName", "loadBalancerName")
...
func TestFormatLoadBalancerID(t *testing.T) {
	actual := NewLoadBalancerID("12345678-1234-9876-4563-123456789012", "resourceGroupName", "loadBalancerName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroupName/providers/Microsoft.Network/loadBalancers/loadBalancerName"
	if actual != expected {
...
func TestParseLoadBalancerID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroupName/providers/Microsoft.Network/loadBalancers/loadBalancerName/extra",
			Error: true,
		},
	}
