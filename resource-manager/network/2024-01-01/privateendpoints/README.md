...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-01-01/privateendpoints` Documentation

The `privateendpoints` SDK allows for interaction with the Azure Resource Manager Service `network` (API Version `2024-01-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-01-01/privateendpoints"
```
