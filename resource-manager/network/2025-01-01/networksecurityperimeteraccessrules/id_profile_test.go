...
func TestNewProfileID(t *testing.T) {
	id := NewProfileID("12345678-1234-9876-4563-123456789012", "example-resource-group", "networkSecurityPerimeterName", "profileName")
...
func TestFormatProfileID(t *testing.T) {
	actual := NewProfileID("12345678-1234-9876-4563-123456789012", "example-resource-group", "networkSecurityPerimeterName", "profileName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Network/networkSecurityPerimeters/networkSecurityPerimeterName/profiles/profileName"
	if actual != expected {
...
func TestParseProfileID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Network/networkSecurityPerimeters/networkSecurityPerimeterName/profiles/profileName/extra",
			Error: true,
		},
	}
