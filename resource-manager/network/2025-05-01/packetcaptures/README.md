...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-05-01/packetcaptures` Documentation

The `packetcaptures` SDK allows for interaction with Azure Resource Manager `network` (API Version `2025-05-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-05-01/packetcaptures"
```
