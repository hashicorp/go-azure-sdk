...
type CustomIPPrefixPropertiesFormat struct {
	...
	ChildCustomIPPrefixes *[]CommonSubResource `json:"childCustomIpPrefixes,omitempty"`
	Cidr                  *string              `json:"cidr,omitempty"`
	CommissionedState     *CommissionedState   `json:"commissionedState,omitempty"`
	CustomIPPrefixParent  *CommonSubResource   `json:"customIpPrefixParent,omitempty"`
