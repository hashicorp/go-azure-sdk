...
func (c VirtualNetworkTapClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VirtualNetworkTapId, input CommonVirtualNetworkTap, callback func() error) error {
