...
func (c MediaClient) StreamingLocatorsListPaths(ctx context.Context, id StreamingLocatorId) (result StreamingLocatorsListPathsOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "StreamingLocatorsListPaths", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "StreamingLocatorsListPaths", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForStreamingLocatorsListPaths(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "StreamingLocatorsListPaths", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c MediaClient) preparerForStreamingLocatorsListPaths(ctx context.Context, id StreamingLocatorId) (*http.Request, error) {
...
func (c MediaClient) responderForStreamingLocatorsListPaths(resp *http.Response) (result StreamingLocatorsListPathsOperationResponse, err error) {
