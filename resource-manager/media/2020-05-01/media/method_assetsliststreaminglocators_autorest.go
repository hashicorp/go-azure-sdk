...
func (c MediaClient) AssetsListStreamingLocators(ctx context.Context, id AssetId) (result AssetsListStreamingLocatorsOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "AssetsListStreamingLocators", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "AssetsListStreamingLocators", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForAssetsListStreamingLocators(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "AssetsListStreamingLocators", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c MediaClient) preparerForAssetsListStreamingLocators(ctx context.Context, id AssetId) (*http.Request, error) {
...
func (c MediaClient) responderForAssetsListStreamingLocators(resp *http.Response) (result AssetsListStreamingLocatorsOperationResponse, err error) {
