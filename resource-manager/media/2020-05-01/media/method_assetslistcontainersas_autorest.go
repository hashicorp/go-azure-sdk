...
func (c MediaClient) AssetsListContainerSas(ctx context.Context, id AssetId, input ListContainerSasInput) (result AssetsListContainerSasOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "AssetsListContainerSas", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "AssetsListContainerSas", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForAssetsListContainerSas(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "AssetsListContainerSas", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c MediaClient) preparerForAssetsListContainerSas(ctx context.Context, id AssetId, input ListContainerSasInput) (*http.Request, error) {
...
func (c MediaClient) responderForAssetsListContainerSas(resp *http.Response) (result AssetsListContainerSasOperationResponse, err error) {
