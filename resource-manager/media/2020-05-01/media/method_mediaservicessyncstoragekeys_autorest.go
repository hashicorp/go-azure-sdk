...
func (c MediaClient) MediaservicesSyncStorageKeys(ctx context.Context, id ProviderMediaServiceId, input SyncStorageKeysInput) (result MediaservicesSyncStorageKeysOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "MediaservicesSyncStorageKeys", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "MediaservicesSyncStorageKeys", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForMediaservicesSyncStorageKeys(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "MediaservicesSyncStorageKeys", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c MediaClient) preparerForMediaservicesSyncStorageKeys(ctx context.Context, id ProviderMediaServiceId, input SyncStorageKeysInput) (*http.Request, error) {
...
func (c MediaClient) responderForMediaservicesSyncStorageKeys(resp *http.Response) (result MediaservicesSyncStorageKeysOperationResponse, err error) {
