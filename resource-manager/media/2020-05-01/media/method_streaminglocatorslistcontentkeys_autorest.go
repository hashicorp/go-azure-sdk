...
func (c MediaClient) StreamingLocatorsListContentKeys(ctx context.Context, id StreamingLocatorId) (result StreamingLocatorsListContentKeysOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "StreamingLocatorsListContentKeys", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "StreamingLocatorsListContentKeys", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForStreamingLocatorsListContentKeys(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "StreamingLocatorsListContentKeys", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c MediaClient) preparerForStreamingLocatorsListContentKeys(ctx context.Context, id StreamingLocatorId) (*http.Request, error) {
...
func (c MediaClient) responderForStreamingLocatorsListContentKeys(resp *http.Response) (result StreamingLocatorsListContentKeysOperationResponse, err error) {
