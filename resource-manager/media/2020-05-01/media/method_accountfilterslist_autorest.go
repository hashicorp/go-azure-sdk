...
func (c MediaClient) AccountFiltersList(ctx context.Context, id MediaServiceId) (resp AccountFiltersListOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "AccountFiltersList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "AccountFiltersList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForAccountFiltersList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "AccountFiltersList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c MediaClient) preparerForAccountFiltersList(ctx context.Context, id MediaServiceId) (*http.Request, error) {
...
func (c MediaClient) preparerForAccountFiltersListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c MediaClient) responderForAccountFiltersList(resp *http.Response) (result AccountFiltersListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result AccountFiltersListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "media.MediaClient", "AccountFiltersList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForAccountFiltersList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "media.MediaClient", "AccountFiltersList", result.HttpResponse, "Failure responding to request")
				return
			}
