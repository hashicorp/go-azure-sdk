...
func (c MediaClient) StreamingLocatorsList(ctx context.Context, id MediaServiceId, options StreamingLocatorsListOperationOptions) (resp StreamingLocatorsListOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "StreamingLocatorsList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "StreamingLocatorsList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForStreamingLocatorsList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "StreamingLocatorsList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c MediaClient) preparerForStreamingLocatorsList(ctx context.Context, id MediaServiceId, options StreamingLocatorsListOperationOptions) (*http.Request, error) {
...
func (c MediaClient) preparerForStreamingLocatorsListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c MediaClient) responderForStreamingLocatorsList(resp *http.Response) (result StreamingLocatorsListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result StreamingLocatorsListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "media.MediaClient", "StreamingLocatorsList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForStreamingLocatorsList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "media.MediaClient", "StreamingLocatorsList", result.HttpResponse, "Failure responding to request")
				return
			}
