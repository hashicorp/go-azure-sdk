...
func (c MediaClient) ContentKeyPoliciesGetPolicyPropertiesWithSecrets(ctx context.Context, id ContentKeyPoliciesId) (result ContentKeyPoliciesGetPolicyPropertiesWithSecretsOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "ContentKeyPoliciesGetPolicyPropertiesWithSecrets", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "ContentKeyPoliciesGetPolicyPropertiesWithSecrets", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForContentKeyPoliciesGetPolicyPropertiesWithSecrets(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "ContentKeyPoliciesGetPolicyPropertiesWithSecrets", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c MediaClient) preparerForContentKeyPoliciesGetPolicyPropertiesWithSecrets(ctx context.Context, id ContentKeyPoliciesId) (*http.Request, error) {
...
func (c MediaClient) responderForContentKeyPoliciesGetPolicyPropertiesWithSecrets(resp *http.Response) (result ContentKeyPoliciesGetPolicyPropertiesWithSecretsOperationResponse, err error) {
