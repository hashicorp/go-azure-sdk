...
func (c MediaClient) MediaservicesListEdgePolicies(ctx context.Context, id ProviderMediaServiceId, input ListEdgePoliciesInput) (result MediaservicesListEdgePoliciesOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "MediaservicesListEdgePolicies", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "MediaservicesListEdgePolicies", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForMediaservicesListEdgePolicies(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "MediaservicesListEdgePolicies", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c MediaClient) preparerForMediaservicesListEdgePolicies(ctx context.Context, id ProviderMediaServiceId, input ListEdgePoliciesInput) (*http.Request, error) {
...
func (c MediaClient) responderForMediaservicesListEdgePolicies(resp *http.Response) (result MediaservicesListEdgePoliciesOperationResponse, err error) {
