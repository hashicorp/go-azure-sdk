...
func TestNewContentKeyPoliciesID(t *testing.T) {
	id := NewContentKeyPoliciesID("12345678-1234-9876-4563-123456789012", "example-resource-group", "accountValue", "contentKeyPolicyValue")
...
func TestFormatContentKeyPoliciesID(t *testing.T) {
	actual := NewContentKeyPoliciesID("12345678-1234-9876-4563-123456789012", "example-resource-group", "accountValue", "contentKeyPolicyValue").ID()
...
func TestParseContentKeyPoliciesID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ContentKeyPoliciesId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseContentKeyPoliciesID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseContentKeyPoliciesIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ContentKeyPoliciesId
	...
	for _, v := range testData {
		...
		actual, err := ParseContentKeyPoliciesIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForContentKeyPoliciesId(t *testing.T) {
	segments := ContentKeyPoliciesId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ContentKeyPoliciesId has no segments")
	}
