...
func (c MediaClient) MediaservicesListBySubscription(ctx context.Context, id commonids.SubscriptionId) (resp MediaservicesListBySubscriptionOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "MediaservicesListBySubscription", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "MediaservicesListBySubscription", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForMediaservicesListBySubscription(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "media.MediaClient", "MediaservicesListBySubscription", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c MediaClient) preparerForMediaservicesListBySubscriptionWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c MediaClient) responderForMediaservicesListBySubscription(resp *http.Response) (result MediaservicesListBySubscriptionOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result MediaservicesListBySubscriptionOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "media.MediaClient", "MediaservicesListBySubscription", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForMediaservicesListBySubscription(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "media.MediaClient", "MediaservicesListBySubscription", result.HttpResponse, "Failure responding to request")
				return
			}
