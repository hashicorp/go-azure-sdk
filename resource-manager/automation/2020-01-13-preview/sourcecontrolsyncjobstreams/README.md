...
```go
ctx := context.TODO()
id := sourcecontrolsyncjobstreams.NewStreamID("12345678-1234-9876-4563-123456789012", "example-resource-group", "automationAccountValue", "jobIdValue", "jobStreamIdValue")
