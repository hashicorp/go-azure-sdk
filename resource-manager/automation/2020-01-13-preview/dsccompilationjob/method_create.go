...
func (c DscCompilationJobClient) CreateCallbackThenPoll(ctx context.Context, id commonids.AutomationCompilationJobId, input DscCompilationJobCreateParameters, callback func() error) error {
