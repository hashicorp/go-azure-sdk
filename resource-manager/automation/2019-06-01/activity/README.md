...
## `github.com/hashicorp/go-azure-sdk/resource-manager/automation/2019-06-01/activity` Documentation
...
```go
ctx := context.TODO()
id := activity.NewActivitiesID("12345678-1234-9876-4563-123456789012", "example-resource-group", "automationAccountValue", "moduleValue", "activityValue")
