...
## `github.com/hashicorp/go-azure-sdk/resource-manager/automation/2015-10-31/schedule` Documentation

The `schedule` SDK allows for interaction with Azure Resource Manager `automation` (API Version `2015-10-31`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/automation/2015-10-31/schedule"
```
