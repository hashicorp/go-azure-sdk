...
## `github.com/hashicorp/go-azure-sdk/resource-manager/automation/2015-10-31/activity` Documentation

The `activity` SDK allows for interaction with Azure Resource Manager `automation` (API Version `2015-10-31`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/automation/2015-10-31/activity"
```
