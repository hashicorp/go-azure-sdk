...
type BackupInstancesTriggerCrossRegionRestoreOperationResponse struct {
...
// BackupInstancesTriggerCrossRegionRestore ...
func (c DataprotectionsClient) BackupInstancesTriggerCrossRegionRestore(ctx context.Context, id ProviderLocationId, input CrossRegionRestoreRequestObject) (result BackupInstancesTriggerCrossRegionRestoreOperationResponse, err error) {
...
func (c DataprotectionsClient) BackupInstancesTriggerCrossRegionRestoreThenPoll(ctx context.Context, id ProviderLocationId, input CrossRegionRestoreRequestObject) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after BackupInstancesTriggerCrossRegionRestore: %+v", err)
	}
