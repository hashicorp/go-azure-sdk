...
func TestFormatDeletedVaultID(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.DataProtection/locations/locationName/deletedVaults/deletedVaultName"
	if actual != expected {
...
func TestParseDeletedVaultID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.DataProtection/locations/locationName",
			Error: true,
		},
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.DataProtection/locations/locationName/deletedVaults",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.DataProtection/locations/locationName/deletedVaults/deletedVaultName",
			Expected: &DeletedVaultId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.DataProtection/locations/locationName/deletedVaults/deletedVaultName/extra",
			Error: true,
		},
	}
