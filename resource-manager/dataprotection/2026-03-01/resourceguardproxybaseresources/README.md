...
## `github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/resourceguardproxybaseresources` Documentation

The `resourceguardproxybaseresources` SDK allows for interaction with Azure Resource Manager `dataprotection` (API Version `2026-03-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/resourceguardproxybaseresources"
```
