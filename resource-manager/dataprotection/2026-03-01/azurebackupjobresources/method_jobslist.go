...
// JobsList ...
func (c AzureBackupJobResourcesClient) JobsList(ctx context.Context, id BackupVaultId) (result JobsListOperationResponse, err error) {
...
func (c AzureBackupJobResourcesClient) JobsListComplete(ctx context.Context, id BackupVaultId) (JobsListCompleteResult, error) {
...
func (c AzureBackupJobResourcesClient) JobsListCompleteMatchingPredicate(ctx context.Context, id BackupVaultId, predicate AzureBackupJobResourceOperationPredicate) (result JobsListCompleteResult, err error) {
