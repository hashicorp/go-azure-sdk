...
import (
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/azurebackupjobresources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/azurebackuprecoverypointresources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/backupinstanceresources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/backupinstances"
	"github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/backupvaultoperationresults"
	"github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/backupvaultresources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/basebackuppolicyresources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/dataprotections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/deletedbackupinstanceresources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/deletedbackupvaults"
	"github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/dppbaseresourceoperationgroup"
	"github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/resourceguardproxybaseresources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/resourceguardresources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-03-01/resourceguards"
...
type Client struct {
	...
	DeletedBackupVaults               *deletedbackupvaults.DeletedBackupVaultsClient
...
func NewClientWithBaseURI(sdkApi sdkEnv.Api, configureFunc func(c *resourcemanager.Client)) (*Client, error) {
	...
	deletedBackupVaultsClient, err := deletedbackupvaults.NewDeletedBackupVaultsClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building DeletedBackupVaults client: %+v", err)
	}
	configureFunc(deletedBackupVaultsClient.Client)
	...
	return &Client{
		...
		DeletedBackupVaults:               deletedBackupVaultsClient,
