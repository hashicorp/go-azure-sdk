...
## `github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2025-02-01/resourceguards` Documentation

The `resourceguards` SDK allows for interaction with Azure Resource Manager `dataprotection` (API Version `2025-02-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2025-02-01/resourceguards"
```
