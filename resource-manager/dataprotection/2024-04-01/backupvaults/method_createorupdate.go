...
func (c BackupVaultsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id BackupVaultId, input BackupVaultResource, options CreateOrUpdateOperationOptions, callback func() error) error {
