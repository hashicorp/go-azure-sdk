...
func (c BackupVaultsClient) UpdateCallbackThenPoll(ctx context.Context, id BackupVaultId, input PatchResourceRequestInput, options UpdateOperationOptions, callback func() error) error {
