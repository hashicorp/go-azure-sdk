...
## `github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-06-01/resourceguardresources` Documentation

The `resourceguardresources` SDK allows for interaction with Azure Resource Manager `dataprotection` (API Version `2026-06-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-06-01/resourceguardresources"
```
