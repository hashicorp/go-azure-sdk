...
## `github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-06-01/azurebackupjobresources` Documentation

The `azurebackupjobresources` SDK allows for interaction with Azure Resource Manager `dataprotection` (API Version `2026-06-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-06-01/azurebackupjobresources"
```
