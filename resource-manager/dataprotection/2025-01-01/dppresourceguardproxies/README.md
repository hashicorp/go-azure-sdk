...
## `github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2025-01-01/dppresourceguardproxies` Documentation

The `dppresourceguardproxies` SDK allows for interaction with Azure Resource Manager `dataprotection` (API Version `2025-01-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2025-01-01/dppresourceguardproxies"
```
