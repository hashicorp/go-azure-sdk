...
## `github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2024-03-01/resourceguards` Documentation

The `resourceguards` SDK allows for interaction with the Azure Resource Manager Service `dataprotection` (API Version `2024-03-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2024-03-01/resourceguards"
```
