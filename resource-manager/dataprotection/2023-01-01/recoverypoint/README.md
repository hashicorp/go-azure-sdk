...
## `github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2023-01-01/recoverypoint` Documentation

The `recoverypoint` SDK allows for interaction with the Azure Resource Manager Service `dataprotection` (API Version `2023-01-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2023-01-01/recoverypoint"
```
