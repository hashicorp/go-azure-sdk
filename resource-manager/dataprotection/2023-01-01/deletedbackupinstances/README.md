...
## `github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2023-01-01/deletedbackupinstances` Documentation

The `deletedbackupinstances` SDK allows for interaction with the Azure Resource Manager Service `dataprotection` (API Version `2023-01-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2023-01-01/deletedbackupinstances"
```
