...
## `github.com/hashicorp/go-azure-sdk/resource-manager/management/2023-04-01/managements` Documentation

The `managements` SDK allows for interaction with Azure Resource Manager `management` (API Version `2023-04-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/management/2023-04-01/managements"
```
