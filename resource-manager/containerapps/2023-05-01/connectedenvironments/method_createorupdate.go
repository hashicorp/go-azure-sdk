...
func (c ConnectedEnvironmentsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ConnectedEnvironmentId, input ConnectedEnvironment, callback func() error) error {
