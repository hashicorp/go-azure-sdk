...
func TestNewReplicaID(t *testing.T) {
	id := NewReplicaID("12345678-1234-9876-4563-123456789012", "example-resource-group", "containerAppName", "revisionName", "replicaName")
...
func TestFormatReplicaID(t *testing.T) {
	actual := NewReplicaID("12345678-1234-9876-4563-123456789012", "example-resource-group", "containerAppName", "revisionName", "replicaName").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.App/containerApps/containerAppName/revisions/revisionName/replicas/replicaName"
	if actual != expected {
...
func TestParseReplicaID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.App/containerApps/containerAppName/revisions/revisionName/replicas",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.App/containerApps/containerAppName/revisions/revisionName/replicas/replicaName",
			Expected: &ReplicaId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.App/containerApps/containerAppName/revisions/revisionName/replicas/replicaName/extra",
			Error: true,
		},
	}
