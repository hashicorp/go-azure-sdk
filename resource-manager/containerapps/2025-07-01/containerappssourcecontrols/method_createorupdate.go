...
func (c ContainerAppsSourceControlsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id SourceControlId, input SourceControl, callback func() error) error {
