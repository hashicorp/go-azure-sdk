...
func (c ConnectedEnvironmentsStoragesClient) CreateOrUpdateThenPoll(ctx context.Context, id ConnectedEnvironmentStorageId, input ConnectedEnvironmentStorage) error {
...
func (c ConnectedEnvironmentsStoragesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ConnectedEnvironmentStorageId, input ConnectedEnvironmentStorage, callback func() error) error {
