...
func (c ManagedCertificatesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ManagedCertificateId, input ManagedCertificate, callback func() error) error {
