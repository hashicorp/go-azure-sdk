...
## `github.com/hashicorp/go-azure-sdk/resource-manager/storageactions/2026-03-01/storagetasks` Documentation

The `storagetasks` SDK allows for interaction with Azure Resource Manager `storageactions` (API Version `2026-03-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/storageactions/2026-03-01/storagetasks"
```
...
### Example Usage: `StorageTasksClient.StopAllAssignments`

```go
ctx := context.TODO()
id := storagetasks.NewStorageTaskID("12345678-1234-9876-4563-123456789012", "example-resource-group", "storageTaskName")

if err := client.StopAllAssignmentsThenPoll(ctx, id); err != nil {
	// handle the error
}
```
