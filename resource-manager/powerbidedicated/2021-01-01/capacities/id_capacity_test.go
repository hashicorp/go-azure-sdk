...
func TestNewCapacityID(t *testing.T) {
	id := NewCapacityID("12345678-1234-9876-4563-123456789012", "example-resource-group", "dedicatedCapacityValue")
...
func TestFormatCapacityID(t *testing.T) {
	actual := NewCapacityID("12345678-1234-9876-4563-123456789012", "example-resource-group", "dedicatedCapacityValue").ID()
