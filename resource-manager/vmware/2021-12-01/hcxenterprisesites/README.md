...
## `github.com/hashicorp/go-azure-sdk/resource-manager/vmware/2021-12-01/hcxenterprisesites` Documentation

The `hcxenterprisesites` SDK allows for interaction with the Azure Resource Manager Service `vmware` (API Version `2021-12-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/vmware/2021-12-01/hcxenterprisesites"
```
