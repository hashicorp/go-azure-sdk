...
## `github.com/hashicorp/go-azure-sdk/resource-manager/vmware/2020-03-20/hcxenterprisesites` Documentation

The `hcxenterprisesites` SDK allows for interaction with the Azure Resource Manager Service `vmware` (API Version `2020-03-20`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/vmware/2020-03-20/hcxenterprisesites"
```
