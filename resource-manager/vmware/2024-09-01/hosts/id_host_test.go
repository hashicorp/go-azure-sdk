...
func TestNewHostID(t *testing.T) {
	id := NewHostID("12345678-1234-9876-4563-123456789012", "example-resource-group", "privateCloudName", "clusterName", "hostId")
	...
	if id.HostId != "hostId" {
		t.Fatalf("Expected %q but got %q for Segment 'HostId'", id.HostId, "hostId")
	}
}

func TestFormatHostID(t *testing.T) {
	actual := NewHostID("12345678-1234-9876-4563-123456789012", "example-resource-group", "privateCloudName", "clusterName", "hostId").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.AVS/privateClouds/privateCloudName/clusters/clusterName/hosts/hostId"
	if actual != expected {
...
func TestParseHostID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.AVS/privateClouds/privateCloudName/clusters/clusterName/hosts",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.AVS/privateClouds/privateCloudName/clusters/clusterName/hosts/hostId",
			Expected: &HostId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.AVS/privateClouds/privateCloudName/clusters/clusterName/hosts/hostId/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		if actual.HostId != v.Expected.HostId {
			t.Fatalf("Expected %q but got %q for HostId", v.Expected.HostId, actual.HostId)
		}
