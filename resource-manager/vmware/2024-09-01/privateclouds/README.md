...
## `github.com/hashicorp/go-azure-sdk/resource-manager/vmware/2024-09-01/privateclouds` Documentation

The `privateclouds` SDK allows for interaction with Azure Resource Manager `vmware` (API Version `2024-09-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/vmware/2024-09-01/privateclouds"
```
