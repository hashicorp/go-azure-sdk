...
## `github.com/hashicorp/go-azure-sdk/resource-manager/vmware/2024-09-01/authorizations` Documentation

The `authorizations` SDK allows for interaction with Azure Resource Manager `vmware` (API Version `2024-09-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/vmware/2024-09-01/authorizations"
```
