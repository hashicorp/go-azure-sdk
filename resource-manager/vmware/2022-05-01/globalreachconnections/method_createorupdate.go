...
func (c GlobalReachConnectionsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id GlobalReachConnectionId, input GlobalReachConnection, callback func() error) error {
