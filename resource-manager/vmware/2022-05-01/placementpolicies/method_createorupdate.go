...
func (c PlacementPoliciesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id PlacementPolicyId, input PlacementPolicy, callback func() error) error {
