...
func (c LocationsClient) CheckTrialAvailability(ctx context.Context, id LocationId, input Sku) (result CheckTrialAvailabilityOperationResponse, err error) {
	req, err := c.preparerForCheckTrialAvailability(ctx, id, input)
	if err != nil {
...
func (c LocationsClient) preparerForCheckTrialAvailability(ctx context.Context, id LocationId, input Sku) (*http.Request, error) {
