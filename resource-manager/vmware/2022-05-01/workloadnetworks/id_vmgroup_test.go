...
func TestNewVMGroupID(t *testing.T) {
	...
	if id.VmGroupId != "vmGroupIdValue" {
		t.Fatalf("Expected %q but got %q for Segment 'VmGroupId'", id.VmGroupId, "vmGroupIdValue")
	}
}
...
func TestParseVMGroupID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.AVS/privateClouds/privateCloudValue/workloadNetworks/default/vmGroups",
			Error: true,
		},
		{
			// Valid URI
			...
			Expected: &VMGroupId{
				...
				VmGroupId:         "vmGroupIdValue",
			},
		},
		{
			// Invalid (Valid Uri with Extra segment)
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.AVS/privateClouds/privateCloudValue/workloadNetworks/default/vmGroups/vmGroupIdValue/extra",
			Error: true,
		},
	}
