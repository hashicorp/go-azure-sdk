...
func PossibleValuesForCloudLinkProvisioningState() []string {
	return []string{
		string(CloudLinkProvisioningStateCanceled),
		string(CloudLinkProvisioningStateFailed),
		string(CloudLinkProvisioningStateSucceeded),
	}
}
...
func (s *CloudLinkProvisioningState) UnmarshalJSON(bytes []byte) error {
	...
	out, err := parseCloudLinkProvisioningState(decoded)
	if err != nil {
...
func parseCloudLinkProvisioningState(input string) (*CloudLinkProvisioningState, error) {
	vals := map[string]CloudLinkProvisioningState{
		"canceled":  CloudLinkProvisioningStateCanceled,
		"failed":    CloudLinkProvisioningStateFailed,
		"succeeded": CloudLinkProvisioningStateSucceeded,
	}
	...
	out := CloudLinkProvisioningState(input)
	return &out, nil
}
