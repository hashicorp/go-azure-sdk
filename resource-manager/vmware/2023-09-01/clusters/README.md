...
## `github.com/hashicorp/go-azure-sdk/resource-manager/vmware/2023-09-01/clusters` Documentation

The `clusters` SDK allows for interaction with the Azure Resource Manager Service `vmware` (API Version `2023-09-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/vmware/2023-09-01/clusters"
```
