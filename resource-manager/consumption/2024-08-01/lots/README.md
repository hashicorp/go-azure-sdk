...
## `github.com/hashicorp/go-azure-sdk/resource-manager/consumption/2024-08-01/lots` Documentation

The `lots` SDK allows for interaction with the Azure Resource Manager Service `consumption` (API Version `2024-08-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/consumption/2024-08-01/lots"
```
