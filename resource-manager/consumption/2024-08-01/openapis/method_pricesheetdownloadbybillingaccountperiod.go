...
type PriceSheetDownloadByBillingAccountPeriodOperationResponse struct {
...
// PriceSheetDownloadByBillingAccountPeriod ...
func (c OpenapisClient) PriceSheetDownloadByBillingAccountPeriod(ctx context.Context, id BillingAccountBillingPeriodId) (result PriceSheetDownloadByBillingAccountPeriodOperationResponse, err error) {
...
func (c OpenapisClient) PriceSheetDownloadByBillingAccountPeriodThenPoll(ctx context.Context, id BillingAccountBillingPeriodId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after PriceSheetDownloadByBillingAccountPeriod: %+v", err)
	}
