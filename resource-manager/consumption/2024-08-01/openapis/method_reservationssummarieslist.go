...
func (c OpenapisClient) ReservationsSummariesList(ctx context.Context, id commonids.ScopeId, options ReservationsSummariesListOperationOptions) (result ReservationsSummariesListOperationResponse, err error) {
...
func (c OpenapisClient) ReservationsSummariesListComplete(ctx context.Context, id commonids.ScopeId, options ReservationsSummariesListOperationOptions) (ReservationsSummariesListCompleteResult, error) {
...
func (c OpenapisClient) ReservationsSummariesListCompleteMatchingPredicate(ctx context.Context, id commonids.ScopeId, options ReservationsSummariesListOperationOptions, predicate ReservationSummaryOperationPredicate) (result ReservationsSummariesListCompleteResult, err error) {
