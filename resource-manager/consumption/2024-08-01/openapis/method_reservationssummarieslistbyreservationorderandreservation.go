...
func (c OpenapisClient) ReservationsSummariesListByReservationOrderAndReservation(ctx context.Context, id ReservationId, options ReservationsSummariesListByReservationOrderAndReservationOperationOptions) (result ReservationsSummariesListByReservationOrderAndReservationOperationResponse, err error) {
...
func (c OpenapisClient) ReservationsSummariesListByReservationOrderAndReservationComplete(ctx context.Context, id ReservationId, options ReservationsSummariesListByReservationOrderAndReservationOperationOptions) (ReservationsSummariesListByReservationOrderAndReservationCompleteResult, error) {
...
func (c OpenapisClient) ReservationsSummariesListByReservationOrderAndReservationCompleteMatchingPredicate(ctx context.Context, id ReservationId, options ReservationsSummariesListByReservationOrderAndReservationOperationOptions, predicate ReservationSummaryOperationPredicate) (result ReservationsSummariesListByReservationOrderAndReservationCompleteResult, err error) {
