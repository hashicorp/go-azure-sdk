...
func (c OpenapisClient) ReservationsDetailsList(ctx context.Context, id commonids.ScopeId, options ReservationsDetailsListOperationOptions) (result ReservationsDetailsListOperationResponse, err error) {
...
func (c OpenapisClient) ReservationsDetailsListComplete(ctx context.Context, id commonids.ScopeId, options ReservationsDetailsListOperationOptions) (ReservationsDetailsListCompleteResult, error) {
...
func (c OpenapisClient) ReservationsDetailsListCompleteMatchingPredicate(ctx context.Context, id commonids.ScopeId, options ReservationsDetailsListOperationOptions, predicate ReservationDetailOperationPredicate) (result ReservationsDetailsListCompleteResult, err error) {
