...
func (c EventsClient) ListByBillingAccount(ctx context.Context, id BillingAccountId, options ListByBillingAccountOperationOptions) (resp ListByBillingAccountOperationResponse, err error) {
	req, err := c.preparerForListByBillingAccount(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "events.EventsClient", "ListByBillingAccount", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "events.EventsClient", "ListByBillingAccount", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByBillingAccount(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "events.EventsClient", "ListByBillingAccount", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c EventsClient) preparerForListByBillingAccount(ctx context.Context, id BillingAccountId, options ListByBillingAccountOperationOptions) (*http.Request, error) {
...
func (c EventsClient) preparerForListByBillingAccountWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c EventsClient) responderForListByBillingAccount(resp *http.Response) (result ListByBillingAccountOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByBillingAccountOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "events.EventsClient", "ListByBillingAccount", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByBillingAccount(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "events.EventsClient", "ListByBillingAccount", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c EventsClient) ListByBillingAccountCompleteMatchingPredicate(ctx context.Context, id BillingAccountId, options ListByBillingAccountOperationOptions, predicate EventSummaryOperationPredicate) (resp ListByBillingAccountCompleteResult, err error) {
