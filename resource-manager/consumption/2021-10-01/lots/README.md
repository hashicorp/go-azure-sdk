...
## `github.com/hashicorp/go-azure-sdk/resource-manager/consumption/2021-10-01/lots` Documentation

The `lots` SDK allows for interaction with Azure Resource Manager `consumption` (API Version `2021-10-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/consumption/2021-10-01/lots"
```
