...
func (c LotsClient) ListByBillingProfile(ctx context.Context, id BillingProfileId) (resp ListByBillingProfileOperationResponse, err error) {
	req, err := c.preparerForListByBillingProfile(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "lots.LotsClient", "ListByBillingProfile", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "lots.LotsClient", "ListByBillingProfile", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByBillingProfile(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "lots.LotsClient", "ListByBillingProfile", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c LotsClient) preparerForListByBillingProfile(ctx context.Context, id BillingProfileId) (*http.Request, error) {
...
func (c LotsClient) preparerForListByBillingProfileWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c LotsClient) responderForListByBillingProfile(resp *http.Response) (result ListByBillingProfileOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByBillingProfileOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "lots.LotsClient", "ListByBillingProfile", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByBillingProfile(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "lots.LotsClient", "ListByBillingProfile", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c LotsClient) ListByBillingProfileCompleteMatchingPredicate(ctx context.Context, id BillingProfileId, predicate LotSummaryOperationPredicate) (resp ListByBillingProfileCompleteResult, err error) {
	items := make([]LotSummary, 0)

	page, err := c.ListByBillingProfile(ctx, id)
	if err != nil {
