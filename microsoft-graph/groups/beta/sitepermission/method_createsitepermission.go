...
func (c SitePermissionClient) CreateSitePermission(ctx context.Context, id GroupIdSiteId, input beta.Permission) (result CreateSitePermissionOperationResponse, err error) {
