...
func (c CalendarEventExceptionOccurrenceClient) ListCalendarEventExceptionOccurrences(ctx context.Context, id GroupIdCalendarEventId) (result ListCalendarEventExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceClient) ListCalendarEventExceptionOccurrencesComplete(ctx context.Context, id GroupIdCalendarEventId) (ListCalendarEventExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarEventExceptionOccurrenceClient) ListCalendarEventExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarEventId, predicate EventOperationPredicate) (result ListCalendarEventExceptionOccurrencesCompleteResult, err error) {
