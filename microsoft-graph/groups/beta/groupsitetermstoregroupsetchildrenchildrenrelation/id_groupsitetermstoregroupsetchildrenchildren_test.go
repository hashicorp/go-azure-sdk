...
func TestNewGroupSiteTermStoreGroupSetChildrenChildrenID(t *testing.T) {
	id := NewGroupSiteTermStoreGroupSetChildrenChildrenID("groupIdValue", "siteIdValue", "groupId1Value", "setIdValue", "termIdValue", "termId1Value")
...
func TestFormatGroupSiteTermStoreGroupSetChildrenChildrenID(t *testing.T) {
	actual := NewGroupSiteTermStoreGroupSetChildrenChildrenID("groupIdValue", "siteIdValue", "groupId1Value", "setIdValue", "termIdValue", "termId1Value").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStore/groups/groupId1Value/sets/setIdValue/children/termIdValue/children/termId1Value"
	if actual != expected {
...
func TestParseGroupSiteTermStoreGroupSetChildrenChildrenID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/groups/groupId1Value/sets/setIdValue/children/termIdValue/children/termId1Value/extra",
			Error: true,
		},
	}
