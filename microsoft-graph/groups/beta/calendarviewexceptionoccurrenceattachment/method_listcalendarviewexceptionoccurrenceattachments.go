...
func (c CalendarViewExceptionOccurrenceAttachmentClient) ListCalendarViewExceptionOccurrenceAttachments(ctx context.Context, id GroupIdCalendarViewIdExceptionOccurrenceId) (result ListCalendarViewExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceAttachmentClient) ListCalendarViewExceptionOccurrenceAttachmentsComplete(ctx context.Context, id GroupIdCalendarViewIdExceptionOccurrenceId) (ListCalendarViewExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c CalendarViewExceptionOccurrenceAttachmentClient) ListCalendarViewExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarViewIdExceptionOccurrenceId, predicate AttachmentOperationPredicate) (result ListCalendarViewExceptionOccurrenceAttachmentsCompleteResult, err error) {
