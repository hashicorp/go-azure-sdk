...
func (c PlannerPlanTaskClient) ListPlannerPlanTasks(ctx context.Context, id GroupIdPlannerPlanId) (result ListPlannerPlanTasksOperationResponse, err error) {
...
func (c PlannerPlanTaskClient) ListPlannerPlanTasksComplete(ctx context.Context, id GroupIdPlannerPlanId) (ListPlannerPlanTasksCompleteResult, error) {
...
func (c PlannerPlanTaskClient) ListPlannerPlanTasksCompleteMatchingPredicate(ctx context.Context, id GroupIdPlannerPlanId, predicate PlannerTaskOperationPredicate) (result ListPlannerPlanTasksCompleteResult, err error) {
