...
func (c CalendarEventInstanceClient) CancelCalendarEventInstance(ctx context.Context, id beta.GroupIdCalendarEventIdInstanceId, input CancelCalendarEventInstanceRequest) (result CancelCalendarEventInstanceOperationResponse, err error) {
