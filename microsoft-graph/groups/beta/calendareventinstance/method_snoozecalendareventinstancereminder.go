...
func (c CalendarEventInstanceClient) SnoozeCalendarEventInstanceReminder(ctx context.Context, id beta.GroupIdCalendarEventIdInstanceId, input SnoozeCalendarEventInstanceReminderRequest) (result SnoozeCalendarEventInstanceReminderOperationResponse, err error) {
