...
func TestNewGroupSiteOnenoteResourceID(t *testing.T) {
	id := NewGroupSiteOnenoteResourceID("groupIdValue", "siteIdValue", "onenoteResourceIdValue")
...
func TestFormatGroupSiteOnenoteResourceID(t *testing.T) {
	actual := NewGroupSiteOnenoteResourceID("groupIdValue", "siteIdValue", "onenoteResourceIdValue").ID()
...
func TestParseGroupSiteOnenoteResourceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteOnenoteResourceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteOnenoteResourceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteOnenoteResourceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteOnenoteResourceId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteOnenoteResourceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteOnenoteResourceId(t *testing.T) {
	segments := GroupSiteOnenoteResourceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteOnenoteResourceId has no segments")
	}
