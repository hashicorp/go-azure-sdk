...
func (c EventInstanceExceptionOccurrenceAttachmentClient) CreateEventInstanceExceptionOccurrenceAttachmentsUploadSession(ctx context.Context, id beta.GroupIdEventIdInstanceIdExceptionOccurrenceId, input CreateEventInstanceExceptionOccurrenceAttachmentsUploadSessionRequest) (result CreateEventInstanceExceptionOccurrenceAttachmentsUploadSessionOperationResponse, err error) {
