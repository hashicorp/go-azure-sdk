...
func (c CalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrences(ctx context.Context, id GroupIdCalendarViewId) (result ListCalendarViewExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrencesComplete(ctx context.Context, id GroupIdCalendarViewId) (ListCalendarViewExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarViewId, predicate EventOperationPredicate) (result ListCalendarViewExceptionOccurrencesCompleteResult, err error) {
