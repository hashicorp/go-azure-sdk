...
func (c SiteListSubscriptionClient) CreateSiteListSubscriptionReauthorize(ctx context.Context, id beta.GroupIdSiteIdListIdSubscriptionId) (result CreateSiteListSubscriptionReauthorizeOperationResponse, err error) {
