...
func (c SiteListSubscriptionClient) CreateSiteListSubscription(ctx context.Context, id GroupIdSiteIdListId, input beta.Subscription) (result CreateSiteListSubscriptionOperationResponse, err error) {
