...
func (c CalendarCalendarViewAttachmentClient) CreateCalendarViewAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, input beta.Attachment) (result CreateCalendarViewAttachmentOperationResponse, err error) {
