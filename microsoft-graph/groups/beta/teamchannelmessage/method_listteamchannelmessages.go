...
func (c TeamChannelMessageClient) ListTeamChannelMessages(ctx context.Context, id GroupIdTeamChannelId) (result ListTeamChannelMessagesOperationResponse, err error) {
...
func (c TeamChannelMessageClient) ListTeamChannelMessagesComplete(ctx context.Context, id GroupIdTeamChannelId) (ListTeamChannelMessagesCompleteResult, error) {
	return c.ListTeamChannelMessagesCompleteMatchingPredicate(ctx, id, ChatMessageOperationPredicate{})
}

// ListTeamChannelMessagesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c TeamChannelMessageClient) ListTeamChannelMessagesCompleteMatchingPredicate(ctx context.Context, id GroupIdTeamChannelId, predicate ChatMessageOperationPredicate) (result ListTeamChannelMessagesCompleteResult, err error) {
	items := make([]beta.ChatMessage, 0)

	resp, err := c.ListTeamChannelMessages(ctx, id)
	if err != nil {
