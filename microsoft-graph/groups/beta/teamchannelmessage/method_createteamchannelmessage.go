...
func (c TeamChannelMessageClient) CreateTeamChannelMessage(ctx context.Context, id beta.GroupIdTeamChannelId, input beta.ChatMessage) (result CreateTeamChannelMessageOperationResponse, err error) {
