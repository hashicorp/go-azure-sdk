...
func (c SiteContentTypeColumnClient) CreateSiteContentTypeColumn(ctx context.Context, id beta.GroupIdSiteIdContentTypeId, input beta.ColumnDefinition) (result CreateSiteContentTypeColumnOperationResponse, err error) {
