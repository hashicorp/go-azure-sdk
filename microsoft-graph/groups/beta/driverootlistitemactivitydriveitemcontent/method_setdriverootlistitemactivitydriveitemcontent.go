...
func (c DriveRootListItemActivityDriveItemContentClient) SetDriveRootListItemActivityDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdRootListItemActivityId, input []byte) (result SetDriveRootListItemActivityDriveItemContentOperationResponse, err error) {
