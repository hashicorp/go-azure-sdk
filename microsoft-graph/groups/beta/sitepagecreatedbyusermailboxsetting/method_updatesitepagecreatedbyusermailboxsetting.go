...
func (c SitePageCreatedByUserMailboxSettingClient) UpdateSitePageCreatedByUserMailboxSetting(ctx context.Context, id beta.GroupIdSiteIdPageId, input beta.MailboxSettings) (result UpdateSitePageCreatedByUserMailboxSettingOperationResponse, err error) {
