...
func (c SitePageSitePageCanvasLayoutHorizontalSectionColumnWebpartClient) ListSitePageCanvasLayoutHorizontalSectionColumnWebpartsComplete(ctx context.Context, id beta.GroupIdSiteIdPageIdSitePageCanvasLayoutHorizontalSectionIdColumnId, options ListSitePageCanvasLayoutHorizontalSectionColumnWebpartsOperationOptions) (ListSitePageCanvasLayoutHorizontalSectionColumnWebpartsCompleteResult, error) {
...
func (c SitePageSitePageCanvasLayoutHorizontalSectionColumnWebpartClient) ListSitePageCanvasLayoutHorizontalSectionColumnWebpartsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdSiteIdPageIdSitePageCanvasLayoutHorizontalSectionIdColumnId, options ListSitePageCanvasLayoutHorizontalSectionColumnWebpartsOperationOptions, predicate WebPartOperationPredicate) (result ListSitePageCanvasLayoutHorizontalSectionColumnWebpartsCompleteResult, err error) {
