...
func (c TeamChannelMessageReplyHostedContentClient) GetTeamChannelMessageReplyHostedContentValue(ctx context.Context, id beta.GroupIdTeamChannelIdMessageIdReplyIdHostedContentId) (result GetTeamChannelMessageReplyHostedContentValueOperationResponse, err error) {
