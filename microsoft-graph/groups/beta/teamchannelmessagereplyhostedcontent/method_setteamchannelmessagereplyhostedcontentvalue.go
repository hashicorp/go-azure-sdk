...
func (c TeamChannelMessageReplyHostedContentClient) SetTeamChannelMessageReplyHostedContentValue(ctx context.Context, id beta.GroupIdTeamChannelIdMessageIdReplyIdHostedContentId, input []byte) (result SetTeamChannelMessageReplyHostedContentValueOperationResponse, err error) {
