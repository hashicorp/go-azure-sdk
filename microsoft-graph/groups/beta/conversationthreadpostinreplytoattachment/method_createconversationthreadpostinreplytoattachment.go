...
func (c ConversationThreadPostInReplyToAttachmentClient) CreateConversationThreadPostInReplyToAttachment(ctx context.Context, id beta.GroupIdConversationIdThreadIdPostId, input beta.Attachment) (result CreateConversationThreadPostInReplyToAttachmentOperationResponse, err error) {
