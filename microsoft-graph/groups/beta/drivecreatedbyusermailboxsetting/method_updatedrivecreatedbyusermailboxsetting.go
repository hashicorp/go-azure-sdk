...
func (c DriveCreatedByUserMailboxSettingClient) UpdateDriveCreatedByUserMailboxSetting(ctx context.Context, id beta.GroupIdDriveId, input beta.MailboxSettings) (result UpdateDriveCreatedByUserMailboxSettingOperationResponse, err error) {
