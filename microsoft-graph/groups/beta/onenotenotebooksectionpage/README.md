...
## `github.com/hashicorp/go-azure-sdk/microsoft-graph/groups/beta/onenotenotebooksectionpage` Documentation

The `onenotenotebooksectionpage` SDK allows for interaction with Microsoft Graph `groups` (API Version `beta`).
...
```go
import "github.com/hashicorp/go-azure-sdk/microsoft-graph/groups/beta/onenotenotebooksectionpage"
```
