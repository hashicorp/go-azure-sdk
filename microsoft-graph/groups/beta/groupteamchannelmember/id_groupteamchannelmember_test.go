...
func TestNewGroupTeamChannelMemberID(t *testing.T) {
	id := NewGroupTeamChannelMemberID("groupIdValue", "channelIdValue", "conversationMemberIdValue")
...
func TestFormatGroupTeamChannelMemberID(t *testing.T) {
	actual := NewGroupTeamChannelMemberID("groupIdValue", "channelIdValue", "conversationMemberIdValue").ID()
...
func TestParseGroupTeamChannelMemberID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamChannelMemberId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamChannelMemberID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupTeamChannelMemberIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamChannelMemberId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamChannelMemberIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupTeamChannelMemberId(t *testing.T) {
	segments := GroupTeamChannelMemberId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupTeamChannelMemberId has no segments")
	}
