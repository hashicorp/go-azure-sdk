...
func (c TeamScheduleOpenShiftClient) CreateTeamScheduleOpenShift(ctx context.Context, id beta.GroupId, input beta.OpenShift) (result CreateTeamScheduleOpenShiftOperationResponse, err error) {
