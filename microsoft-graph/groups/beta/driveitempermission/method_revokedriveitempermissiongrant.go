...
func (c DriveItemPermissionClient) RevokeDriveItemPermissionGrant(ctx context.Context, id beta.GroupIdDriveIdItemIdPermissionId, input RevokeDriveItemPermissionGrantRequest) (result RevokeDriveItemPermissionGrantOperationResponse, err error) {
