...
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) ListCalendarCalendarViewExceptionOccurrenceInstanceAttachments(ctx context.Context, id GroupIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceId) (result ListCalendarCalendarViewExceptionOccurrenceInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) ListCalendarCalendarViewExceptionOccurrenceInstanceAttachmentsComplete(ctx context.Context, id GroupIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceId) (ListCalendarCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) ListCalendarCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceId, predicate AttachmentOperationPredicate) (result ListCalendarCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteResult, err error) {
