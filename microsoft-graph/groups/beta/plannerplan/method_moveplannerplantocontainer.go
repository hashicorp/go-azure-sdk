...
func (c PlannerPlanClient) MovePlannerPlanToContainer(ctx context.Context, id beta.GroupIdPlannerPlanId, input MovePlannerPlanToContainerRequest) (result MovePlannerPlanToContainerOperationResponse, err error) {
