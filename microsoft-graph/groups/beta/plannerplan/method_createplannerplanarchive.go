...
func (c PlannerPlanClient) CreatePlannerPlanArchive(ctx context.Context, id beta.GroupIdPlannerPlanId, input CreatePlannerPlanArchiveRequest) (result CreatePlannerPlanArchiveOperationResponse, err error) {
