...
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) CreateCalendarViewInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceId, input beta.Attachment) (result CreateCalendarViewInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
