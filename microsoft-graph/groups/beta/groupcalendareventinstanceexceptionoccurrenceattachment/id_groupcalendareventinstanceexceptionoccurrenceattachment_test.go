...
func TestNewGroupCalendarEventInstanceExceptionOccurrenceAttachmentID(t *testing.T) {
	id := NewGroupCalendarEventInstanceExceptionOccurrenceAttachmentID("groupIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue")
...
func TestFormatGroupCalendarEventInstanceExceptionOccurrenceAttachmentID(t *testing.T) {
	actual := NewGroupCalendarEventInstanceExceptionOccurrenceAttachmentID("groupIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue").ID()
...
func TestParseGroupCalendarEventInstanceExceptionOccurrenceAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupCalendarEventInstanceExceptionOccurrenceAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupCalendarEventInstanceExceptionOccurrenceAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupCalendarEventInstanceExceptionOccurrenceAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupCalendarEventInstanceExceptionOccurrenceAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupCalendarEventInstanceExceptionOccurrenceAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupCalendarEventInstanceExceptionOccurrenceAttachmentId(t *testing.T) {
	segments := GroupCalendarEventInstanceExceptionOccurrenceAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupCalendarEventInstanceExceptionOccurrenceAttachmentId has no segments")
	}
