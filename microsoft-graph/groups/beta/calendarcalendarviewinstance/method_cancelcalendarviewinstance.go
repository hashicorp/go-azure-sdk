...
func (c CalendarCalendarViewInstanceClient) CancelCalendarViewInstance(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, input CancelCalendarViewInstanceRequest) (result CancelCalendarViewInstanceOperationResponse, err error) {
