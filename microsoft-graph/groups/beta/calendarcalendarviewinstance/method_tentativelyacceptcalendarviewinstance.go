...
func (c CalendarCalendarViewInstanceClient) TentativelyAcceptCalendarViewInstance(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, input TentativelyAcceptCalendarViewInstanceRequest) (result TentativelyAcceptCalendarViewInstanceOperationResponse, err error) {
