...
func (c CalendarCalendarViewInstanceClient) SnoozeCalendarViewInstanceReminder(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, input SnoozeCalendarViewInstanceReminderRequest) (result SnoozeCalendarViewInstanceReminderOperationResponse, err error) {
