...
func TestNewGroupTeamTagMemberID(t *testing.T) {
	id := NewGroupTeamTagMemberID("groupIdValue", "teamworkTagIdValue", "teamworkTagMemberIdValue")
...
func TestFormatGroupTeamTagMemberID(t *testing.T) {
	actual := NewGroupTeamTagMemberID("groupIdValue", "teamworkTagIdValue", "teamworkTagMemberIdValue").ID()
...
func TestParseGroupTeamTagMemberID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamTagMemberId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamTagMemberID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupTeamTagMemberIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamTagMemberId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamTagMemberIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupTeamTagMemberId(t *testing.T) {
	segments := GroupTeamTagMemberId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupTeamTagMemberId has no segments")
	}
