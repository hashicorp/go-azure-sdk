...
func (c SiteInformationProtectionThreatAssessmentRequestClient) UpdateSiteInformationProtectionThreatAssessmentRequest(ctx context.Context, id GroupIdSiteIdInformationProtectionThreatAssessmentRequestId, input beta.ThreatAssessmentRequest) (result UpdateSiteInformationProtectionThreatAssessmentRequestOperationResponse, err error) {
