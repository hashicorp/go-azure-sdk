...
func (c CalendarPermissionClient) CreateCalendarPermission(ctx context.Context, id beta.GroupId, input beta.CalendarPermission) (result CreateCalendarPermissionOperationResponse, err error) {
