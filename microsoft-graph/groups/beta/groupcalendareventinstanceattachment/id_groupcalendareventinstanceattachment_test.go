...
func TestNewGroupCalendarEventInstanceAttachmentID(t *testing.T) {
	id := NewGroupCalendarEventInstanceAttachmentID("groupIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue")
...
func TestFormatGroupCalendarEventInstanceAttachmentID(t *testing.T) {
	actual := NewGroupCalendarEventInstanceAttachmentID("groupIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue").ID()
...
func TestParseGroupCalendarEventInstanceAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupCalendarEventInstanceAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupCalendarEventInstanceAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupCalendarEventInstanceAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupCalendarEventInstanceAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupCalendarEventInstanceAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupCalendarEventInstanceAttachmentId(t *testing.T) {
	segments := GroupCalendarEventInstanceAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupCalendarEventInstanceAttachmentId has no segments")
	}
