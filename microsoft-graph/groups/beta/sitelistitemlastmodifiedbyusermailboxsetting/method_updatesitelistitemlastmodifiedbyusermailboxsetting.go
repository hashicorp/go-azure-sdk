...
func (c SiteListItemLastModifiedByUserMailboxSettingClient) UpdateSiteListItemLastModifiedByUserMailboxSetting(ctx context.Context, id beta.GroupIdSiteIdListIdItemId, input beta.MailboxSettings) (result UpdateSiteListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
