...
func TestNewGroupIdSiteIdAnalyticItemActivityStatIdActivityID(t *testing.T) {
	id := NewGroupIdSiteIdAnalyticItemActivityStatIdActivityID("groupIdValue", "siteIdValue", "itemActivityStatIdValue", "itemActivityIdValue")
...
func TestFormatGroupIdSiteIdAnalyticItemActivityStatIdActivityID(t *testing.T) {
	actual := NewGroupIdSiteIdAnalyticItemActivityStatIdActivityID("groupIdValue", "siteIdValue", "itemActivityStatIdValue", "itemActivityIdValue").ID()
...
func TestParseGroupIdSiteIdAnalyticItemActivityStatIdActivityID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdSiteIdAnalyticItemActivityStatIdActivityId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupIdSiteIdAnalyticItemActivityStatIdActivityID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupIdSiteIdAnalyticItemActivityStatIdActivityIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdSiteIdAnalyticItemActivityStatIdActivityId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupIdSiteIdAnalyticItemActivityStatIdActivityIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupIdSiteIdAnalyticItemActivityStatIdActivityId(t *testing.T) {
	segments := GroupIdSiteIdAnalyticItemActivityStatIdActivityId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupIdSiteIdAnalyticItemActivityStatIdActivityId has no segments")
	}
