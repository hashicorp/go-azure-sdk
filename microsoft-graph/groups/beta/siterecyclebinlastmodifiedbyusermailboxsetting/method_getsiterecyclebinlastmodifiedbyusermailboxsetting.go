...
func (c SiteRecycleBinLastModifiedByUserMailboxSettingClient) GetSiteRecycleBinLastModifiedByUserMailboxSetting(ctx context.Context, id GroupIdSiteId) (result GetSiteRecycleBinLastModifiedByUserMailboxSettingOperationResponse, err error) {
