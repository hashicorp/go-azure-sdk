package grouponenotenotebooksectiongroupsectionparentnotebook
...
func TestNewGroupOnenoteNotebookSectionGroupSectionID(t *testing.T) {
	id := NewGroupOnenoteNotebookSectionGroupSectionID("groupIdValue", "notebookIdValue", "sectionGroupIdValue", "onenoteSectionIdValue")
...
func TestFormatGroupOnenoteNotebookSectionGroupSectionID(t *testing.T) {
	actual := NewGroupOnenoteNotebookSectionGroupSectionID("groupIdValue", "notebookIdValue", "sectionGroupIdValue", "onenoteSectionIdValue").ID()
...
func TestParseGroupOnenoteNotebookSectionGroupSectionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupOnenoteNotebookSectionGroupSectionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupOnenoteNotebookSectionGroupSectionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupOnenoteNotebookSectionGroupSectionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupOnenoteNotebookSectionGroupSectionId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupOnenoteNotebookSectionGroupSectionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupOnenoteNotebookSectionGroupSectionId(t *testing.T) {
	segments := GroupOnenoteNotebookSectionGroupSectionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupOnenoteNotebookSectionGroupSectionId has no segments")
	}
