...
func (c TeamPrimaryChannelMessageReplyClient) CreateTeamPrimaryChannelMessageReply(ctx context.Context, id beta.GroupIdTeamPrimaryChannelMessageId, input beta.ChatMessage) (result CreateTeamPrimaryChannelMessageReplyOperationResponse, err error) {
