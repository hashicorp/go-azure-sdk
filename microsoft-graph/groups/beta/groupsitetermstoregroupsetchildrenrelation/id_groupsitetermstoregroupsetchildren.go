...
func NewGroupSiteTermStoreGroupSetChildrenID(groupId string, siteId string, groupId1 string, setId string, termId string) GroupSiteTermStoreGroupSetChildrenId {
...
func (id GroupSiteTermStoreGroupSetChildrenId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStore/groups/%s/sets/%s/children/%s"
