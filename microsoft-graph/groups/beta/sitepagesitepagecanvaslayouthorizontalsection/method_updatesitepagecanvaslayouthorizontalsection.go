...
func (c SitePageSitePageCanvasLayoutHorizontalSectionClient) UpdateSitePageCanvasLayoutHorizontalSection(ctx context.Context, id beta.GroupIdSiteIdPageIdSitePageCanvasLayoutHorizontalSectionId, input beta.HorizontalSection, options UpdateSitePageCanvasLayoutHorizontalSectionOperationOptions) (result UpdateSitePageCanvasLayoutHorizontalSectionOperationResponse, err error) {
