...
func TestNewGroupCalendarViewExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	id := NewGroupCalendarViewExceptionOccurrenceInstanceExtensionID("groupIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue")
...
func TestFormatGroupCalendarViewExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	actual := NewGroupCalendarViewExceptionOccurrenceInstanceExtensionID("groupIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue").ID()
...
func TestParseGroupCalendarViewExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupCalendarViewExceptionOccurrenceInstanceExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupCalendarViewExceptionOccurrenceInstanceExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupCalendarViewExceptionOccurrenceInstanceExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupCalendarViewExceptionOccurrenceInstanceExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupCalendarViewExceptionOccurrenceInstanceExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupCalendarViewExceptionOccurrenceInstanceExtensionId(t *testing.T) {
	segments := GroupCalendarViewExceptionOccurrenceInstanceExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupCalendarViewExceptionOccurrenceInstanceExtensionId has no segments")
	}
