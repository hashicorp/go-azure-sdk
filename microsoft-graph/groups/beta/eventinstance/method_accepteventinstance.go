...
func (c EventInstanceClient) AcceptEventInstance(ctx context.Context, id beta.GroupIdEventIdInstanceId, input AcceptEventInstanceRequest) (result AcceptEventInstanceOperationResponse, err error) {
