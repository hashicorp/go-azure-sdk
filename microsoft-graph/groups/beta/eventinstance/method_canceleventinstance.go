...
func (c EventInstanceClient) CancelEventInstance(ctx context.Context, id beta.GroupIdEventIdInstanceId, input CancelEventInstanceRequest) (result CancelEventInstanceOperationResponse, err error) {
