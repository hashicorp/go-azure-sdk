...
// a new time.
func (c EventInstanceClient) SnoozeEventInstanceReminder(ctx context.Context, id beta.GroupIdEventIdInstanceId, input SnoozeEventInstanceReminderRequest) (result SnoozeEventInstanceReminderOperationResponse, err error) {
