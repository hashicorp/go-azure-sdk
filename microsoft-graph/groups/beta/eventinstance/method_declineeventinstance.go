...
func (c EventInstanceClient) DeclineEventInstance(ctx context.Context, id beta.GroupIdEventIdInstanceId, input DeclineEventInstanceRequest) (result DeclineEventInstanceOperationResponse, err error) {
