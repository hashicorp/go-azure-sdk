...
func (c CalendarViewInstanceClient) CancelCalendarViewInstance(ctx context.Context, id beta.GroupIdCalendarViewIdInstanceId, input CancelCalendarViewInstanceRequest) (result CancelCalendarViewInstanceOperationResponse, err error) {
