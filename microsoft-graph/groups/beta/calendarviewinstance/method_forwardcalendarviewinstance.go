...
// Outlook.com account.
func (c CalendarViewInstanceClient) ForwardCalendarViewInstance(ctx context.Context, id beta.GroupIdCalendarViewIdInstanceId, input ForwardCalendarViewInstanceRequest) (result ForwardCalendarViewInstanceOperationResponse, err error) {
