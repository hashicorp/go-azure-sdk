...
func (c CalendarViewInstanceClient) DismissCalendarViewInstanceReminder(ctx context.Context, id beta.GroupIdCalendarViewIdInstanceId) (result DismissCalendarViewInstanceReminderOperationResponse, err error) {
