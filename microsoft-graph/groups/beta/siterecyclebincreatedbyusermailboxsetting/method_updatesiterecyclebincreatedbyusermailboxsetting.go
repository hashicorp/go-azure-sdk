...
func (c SiteRecycleBinCreatedByUserMailboxSettingClient) UpdateSiteRecycleBinCreatedByUserMailboxSetting(ctx context.Context, id GroupIdSiteId, input beta.MailboxSettings) (result UpdateSiteRecycleBinCreatedByUserMailboxSettingOperationResponse, err error) {
