...
func (c DriveItemListItemDocumentSetVersionClient) CreateDriveItemListItemDocumentSetVersion(ctx context.Context, id beta.GroupIdDriveIdItemId, input beta.DocumentSetVersion) (result CreateDriveItemListItemDocumentSetVersionOperationResponse, err error) {
