...
func (c CalendarEventExceptionOccurrenceInstanceClient) DeclineCalendarEventExceptionOccurrenceInstance(ctx context.Context, id beta.GroupIdCalendarEventIdExceptionOccurrenceIdInstanceId, input DeclineCalendarEventExceptionOccurrenceInstanceRequest) (result DeclineCalendarEventExceptionOccurrenceInstanceOperationResponse, err error) {
