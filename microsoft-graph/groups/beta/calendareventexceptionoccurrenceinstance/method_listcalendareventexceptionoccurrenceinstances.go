...
func (c CalendarEventExceptionOccurrenceInstanceClient) ListCalendarEventExceptionOccurrenceInstances(ctx context.Context, id GroupIdCalendarEventIdExceptionOccurrenceId) (result ListCalendarEventExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceInstanceClient) ListCalendarEventExceptionOccurrenceInstancesComplete(ctx context.Context, id GroupIdCalendarEventIdExceptionOccurrenceId) (ListCalendarEventExceptionOccurrenceInstancesCompleteResult, error) {
...
func (c CalendarEventExceptionOccurrenceInstanceClient) ListCalendarEventExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarEventIdExceptionOccurrenceId, predicate EventOperationPredicate) (result ListCalendarEventExceptionOccurrenceInstancesCompleteResult, err error) {
