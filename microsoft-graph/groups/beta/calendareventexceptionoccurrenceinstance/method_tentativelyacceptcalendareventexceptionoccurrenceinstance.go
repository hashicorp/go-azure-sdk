...
// times.
func (c CalendarEventExceptionOccurrenceInstanceClient) TentativelyAcceptCalendarEventExceptionOccurrenceInstance(ctx context.Context, id beta.GroupIdCalendarEventIdExceptionOccurrenceIdInstanceId, input TentativelyAcceptCalendarEventExceptionOccurrenceInstanceRequest) (result TentativelyAcceptCalendarEventExceptionOccurrenceInstanceOperationResponse, err error) {
