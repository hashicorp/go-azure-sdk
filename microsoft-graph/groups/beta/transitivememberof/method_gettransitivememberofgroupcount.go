...
func (c TransitiveMemberOfClient) GetTransitiveMemberOfGroupCount(ctx context.Context, id beta.GroupId, options GetTransitiveMemberOfGroupCountOperationOptions) (result GetTransitiveMemberOfGroupCountOperationResponse, err error) {
