...
func (c DriveItemListItemActivityContentClient) GetDriveItemListItemActivityContent(ctx context.Context, id beta.GroupIdDriveIdItemIdListItemActivityId, options GetDriveItemListItemActivityContentOperationOptions) (result GetDriveItemListItemActivityContentOperationResponse, err error) {
