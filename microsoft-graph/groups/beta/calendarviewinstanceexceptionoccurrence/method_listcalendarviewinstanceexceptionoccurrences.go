...
func (c CalendarViewInstanceExceptionOccurrenceClient) ListCalendarViewInstanceExceptionOccurrences(ctx context.Context, id GroupIdCalendarViewIdInstanceId) (result ListCalendarViewInstanceExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarViewInstanceExceptionOccurrenceClient) ListCalendarViewInstanceExceptionOccurrencesComplete(ctx context.Context, id GroupIdCalendarViewIdInstanceId) (ListCalendarViewInstanceExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarViewInstanceExceptionOccurrenceClient) ListCalendarViewInstanceExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarViewIdInstanceId, predicate EventOperationPredicate) (result ListCalendarViewInstanceExceptionOccurrencesCompleteResult, err error) {
