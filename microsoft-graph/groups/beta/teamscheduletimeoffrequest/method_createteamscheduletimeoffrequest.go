...
func (c TeamScheduleTimeOffRequestClient) CreateTeamScheduleTimeOffRequest(ctx context.Context, id GroupId, input beta.TimeOffRequest) (result CreateTeamScheduleTimeOffRequestOperationResponse, err error) {
