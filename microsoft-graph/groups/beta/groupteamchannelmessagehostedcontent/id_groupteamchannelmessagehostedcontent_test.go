...
func TestNewGroupTeamChannelMessageHostedContentID(t *testing.T) {
	id := NewGroupTeamChannelMessageHostedContentID("groupIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageHostedContentIdValue")
...
func TestFormatGroupTeamChannelMessageHostedContentID(t *testing.T) {
	actual := NewGroupTeamChannelMessageHostedContentID("groupIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageHostedContentIdValue").ID()
...
func TestParseGroupTeamChannelMessageHostedContentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamChannelMessageHostedContentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamChannelMessageHostedContentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupTeamChannelMessageHostedContentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamChannelMessageHostedContentId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamChannelMessageHostedContentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupTeamChannelMessageHostedContentId(t *testing.T) {
	segments := GroupTeamChannelMessageHostedContentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupTeamChannelMessageHostedContentId has no segments")
	}
