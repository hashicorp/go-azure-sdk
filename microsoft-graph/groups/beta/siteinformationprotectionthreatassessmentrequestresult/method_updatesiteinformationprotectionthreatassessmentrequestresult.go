...
// UpdateSiteInformationProtectionThreatAssessmentRequestResult ...
func (c SiteInformationProtectionThreatAssessmentRequestResultClient) UpdateSiteInformationProtectionThreatAssessmentRequestResult(ctx context.Context, id GroupIdSiteIdInformationProtectionThreatAssessmentRequestIdResultId, input beta.ThreatAssessmentResult) (result UpdateSiteInformationProtectionThreatAssessmentRequestResultOperationResponse, err error) {
