...
func (c TeamPrimaryChannelSharedWithTeamTeamClient) GetTeamPrimaryChannelSharedWithTeam(ctx context.Context, id beta.GroupIdTeamPrimaryChannelSharedWithTeamId, options GetTeamPrimaryChannelSharedWithTeamOperationOptions) (result GetTeamPrimaryChannelSharedWithTeamOperationResponse, err error) {
