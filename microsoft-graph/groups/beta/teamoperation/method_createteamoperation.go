...
// CreateTeamOperation ...
func (c TeamOperationClient) CreateTeamOperation(ctx context.Context, id GroupId, input beta.TeamsAsyncOperation) (result CreateTeamOperationOperationResponse, err error) {
