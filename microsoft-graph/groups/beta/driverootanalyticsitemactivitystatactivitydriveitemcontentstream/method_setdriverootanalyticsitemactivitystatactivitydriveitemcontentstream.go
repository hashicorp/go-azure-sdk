...
func (c DriveRootAnalyticsItemActivityStatActivityDriveItemContentStreamClient) SetDriveRootAnalyticsItemActivityStatActivityDriveItemContentStream(ctx context.Context, id beta.GroupIdDriveIdRootAnalyticsItemActivityStatIdActivityId, input []byte) (result SetDriveRootAnalyticsItemActivityStatActivityDriveItemContentStreamOperationResponse, err error) {
