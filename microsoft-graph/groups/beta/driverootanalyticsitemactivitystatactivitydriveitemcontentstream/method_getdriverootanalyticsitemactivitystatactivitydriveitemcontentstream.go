...
func (c DriveRootAnalyticsItemActivityStatActivityDriveItemContentStreamClient) GetDriveRootAnalyticsItemActivityStatActivityDriveItemContentStream(ctx context.Context, id beta.GroupIdDriveIdRootAnalyticsItemActivityStatIdActivityId) (result GetDriveRootAnalyticsItemActivityStatActivityDriveItemContentStreamOperationResponse, err error) {
