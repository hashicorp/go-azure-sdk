...
func (c TeamScheduleSwapShiftsChangeRequestClient) CreateTeamScheduleSwapShiftsChangeRequest(ctx context.Context, id beta.GroupId, input beta.SwapShiftsChangeRequest) (result CreateTeamScheduleSwapShiftsChangeRequestOperationResponse, err error) {
