...
func (c CalendarEventExtensionClient) CreateCalendarEventExtension(ctx context.Context, id beta.GroupIdCalendarEventId, input beta.Extension) (result CreateCalendarEventExtensionOperationResponse, err error) {
