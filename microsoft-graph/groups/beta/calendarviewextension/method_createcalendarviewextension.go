...
func (c CalendarViewExtensionClient) CreateCalendarViewExtension(ctx context.Context, id beta.GroupIdCalendarViewId, input beta.Extension) (result CreateCalendarViewExtensionOperationResponse, err error) {
