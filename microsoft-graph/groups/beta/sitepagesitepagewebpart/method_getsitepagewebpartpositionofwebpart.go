...
func (c SitePageSitePageWebPartClient) GetSitePageWebPartPositionOfWebPart(ctx context.Context, id beta.GroupIdSiteIdPageIdSitePageWebPartId, options GetSitePageWebPartPositionOfWebPartOperationOptions) (result GetSitePageWebPartPositionOfWebPartOperationResponse, err error) {
