...
func (c SitePageSitePageWebPartClient) CreateSitePageWebPart(ctx context.Context, id beta.GroupIdSiteIdPageId, input beta.WebPart, options CreateSitePageWebPartOperationOptions) (result CreateSitePageWebPartOperationResponse, err error) {
