...
func (c SitePageSitePageWebPartClient) DeleteSitePageWebPart(ctx context.Context, id beta.GroupIdSiteIdPageIdSitePageWebPartId, options DeleteSitePageWebPartOperationOptions) (result DeleteSitePageWebPartOperationResponse, err error) {
