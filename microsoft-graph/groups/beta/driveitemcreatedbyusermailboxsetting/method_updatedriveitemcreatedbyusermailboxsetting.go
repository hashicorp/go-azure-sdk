...
func (c DriveItemCreatedByUserMailboxSettingClient) UpdateDriveItemCreatedByUserMailboxSetting(ctx context.Context, id beta.GroupIdDriveIdItemId, input beta.MailboxSettings) (result UpdateDriveItemCreatedByUserMailboxSettingOperationResponse, err error) {
