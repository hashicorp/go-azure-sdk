...
func (c CalendarEventExceptionOccurrenceAttachmentClient) CreateCalendarEventExceptionOccurrenceAttachment(ctx context.Context, id beta.GroupIdCalendarEventIdExceptionOccurrenceId, input beta.Attachment) (result CreateCalendarEventExceptionOccurrenceAttachmentOperationResponse, err error) {
