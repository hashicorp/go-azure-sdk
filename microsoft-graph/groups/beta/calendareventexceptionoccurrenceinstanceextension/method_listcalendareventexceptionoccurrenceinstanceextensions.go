...
func (c CalendarEventExceptionOccurrenceInstanceExtensionClient) ListCalendarEventExceptionOccurrenceInstanceExtensions(ctx context.Context, id GroupIdCalendarEventIdExceptionOccurrenceIdInstanceId) (result ListCalendarEventExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceInstanceExtensionClient) ListCalendarEventExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id GroupIdCalendarEventIdExceptionOccurrenceIdInstanceId) (ListCalendarEventExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
