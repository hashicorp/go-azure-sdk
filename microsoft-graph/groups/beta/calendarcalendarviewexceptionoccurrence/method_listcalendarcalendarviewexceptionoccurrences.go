...
func (c CalendarCalendarViewExceptionOccurrenceClient) ListCalendarCalendarViewExceptionOccurrences(ctx context.Context, id GroupIdCalendarCalendarViewId) (result ListCalendarCalendarViewExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceClient) ListCalendarCalendarViewExceptionOccurrencesComplete(ctx context.Context, id GroupIdCalendarCalendarViewId) (ListCalendarCalendarViewExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarCalendarViewExceptionOccurrenceClient) ListCalendarCalendarViewExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarCalendarViewId, predicate EventOperationPredicate) (result ListCalendarCalendarViewExceptionOccurrencesCompleteResult, err error) {
