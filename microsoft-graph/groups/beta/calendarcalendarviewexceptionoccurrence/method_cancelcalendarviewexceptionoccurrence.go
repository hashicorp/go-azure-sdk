...
func (c CalendarCalendarViewExceptionOccurrenceClient) CancelCalendarViewExceptionOccurrence(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdExceptionOccurrenceId, input CancelCalendarViewExceptionOccurrenceRequest) (result CancelCalendarViewExceptionOccurrenceOperationResponse, err error) {
