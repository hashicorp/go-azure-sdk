...
// ListDrives ...
func (c DriveClient) ListDrives(ctx context.Context, id GroupId) (result ListDrivesOperationResponse, err error) {
...
func (c DriveClient) ListDrivesComplete(ctx context.Context, id GroupId) (ListDrivesCompleteResult, error) {
...
func (c DriveClient) ListDrivesCompleteMatchingPredicate(ctx context.Context, id GroupId, predicate DriveOperationPredicate) (result ListDrivesCompleteResult, err error) {
