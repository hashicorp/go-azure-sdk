...
func (c TeamChannelSharedWithTeamTeamClient) GetTeamChannelSharedWithTeam(ctx context.Context, id beta.GroupIdTeamChannelIdSharedWithTeamId, options GetTeamChannelSharedWithTeamOperationOptions) (result GetTeamChannelSharedWithTeamOperationResponse, err error) {
