...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) ListCalendarCalendarViewExceptionOccurrenceAttachments(ctx context.Context, id GroupIdCalendarCalendarViewIdExceptionOccurrenceId) (result ListCalendarCalendarViewExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) ListCalendarCalendarViewExceptionOccurrenceAttachmentsComplete(ctx context.Context, id GroupIdCalendarCalendarViewIdExceptionOccurrenceId) (ListCalendarCalendarViewExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) ListCalendarCalendarViewExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarCalendarViewIdExceptionOccurrenceId, predicate AttachmentOperationPredicate) (result ListCalendarCalendarViewExceptionOccurrenceAttachmentsCompleteResult, err error) {
