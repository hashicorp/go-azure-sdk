...
func (c EventAttachmentClient) CreateEventAttachmentsUploadSession(ctx context.Context, id beta.GroupIdEventId, input CreateEventAttachmentsUploadSessionRequest) (result CreateEventAttachmentsUploadSessionOperationResponse, err error) {
