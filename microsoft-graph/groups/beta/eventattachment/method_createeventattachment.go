...
func (c EventAttachmentClient) CreateEventAttachment(ctx context.Context, id beta.GroupIdEventId, input beta.Attachment) (result CreateEventAttachmentOperationResponse, err error) {
