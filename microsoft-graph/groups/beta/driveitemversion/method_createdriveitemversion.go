...
func (c DriveItemVersionClient) CreateDriveItemVersion(ctx context.Context, id beta.GroupIdDriveIdItemId, input beta.DriveItemVersion) (result CreateDriveItemVersionOperationResponse, err error) {
