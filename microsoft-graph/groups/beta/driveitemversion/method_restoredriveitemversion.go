...
func (c DriveItemVersionClient) RestoreDriveItemVersion(ctx context.Context, id beta.GroupIdDriveIdItemIdVersionId) (result RestoreDriveItemVersionOperationResponse, err error) {
