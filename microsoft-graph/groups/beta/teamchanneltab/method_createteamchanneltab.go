...
func (c TeamChannelTabClient) CreateTeamChannelTab(ctx context.Context, id beta.GroupIdTeamChannelId, input beta.TeamsTab) (result CreateTeamChannelTabOperationResponse, err error) {
