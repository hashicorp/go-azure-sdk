...
func TestNewGroupSiteTermStoreGroupSetTermID(t *testing.T) {
	id := NewGroupSiteTermStoreGroupSetTermID("groupIdValue", "siteIdValue", "groupId1Value", "setIdValue", "termIdValue")
...
func TestFormatGroupSiteTermStoreGroupSetTermID(t *testing.T) {
	actual := NewGroupSiteTermStoreGroupSetTermID("groupIdValue", "siteIdValue", "groupId1Value", "setIdValue", "termIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStore/groups/groupId1Value/sets/setIdValue/terms/termIdValue"
	if actual != expected {
...
func TestParseGroupSiteTermStoreGroupSetTermID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/groups/groupId1Value/sets/setIdValue/terms/termIdValue/extra",
			Error: true,
		},
	}
