...
func (c SiteInformationProtectionSensitivityPolicySettingClient) UpdateSiteInformationProtectionSensitivityPolicySetting(ctx context.Context, id GroupIdSiteId, input beta.SensitivityPolicySettings) (result UpdateSiteInformationProtectionSensitivityPolicySettingOperationResponse, err error) {
