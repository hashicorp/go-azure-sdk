...
func (c EventExceptionOccurrenceExtensionClient) ListEventExceptionOccurrenceExtensions(ctx context.Context, id GroupIdEventIdExceptionOccurrenceId) (result ListEventExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceExtensionClient) ListEventExceptionOccurrenceExtensionsComplete(ctx context.Context, id GroupIdEventIdExceptionOccurrenceId) (ListEventExceptionOccurrenceExtensionsCompleteResult, error) {
...
func (c EventExceptionOccurrenceExtensionClient) ListEventExceptionOccurrenceExtensionsCompleteMatchingPredicate(ctx context.Context, id GroupIdEventIdExceptionOccurrenceId, predicate ExtensionOperationPredicate) (result ListEventExceptionOccurrenceExtensionsCompleteResult, err error) {
