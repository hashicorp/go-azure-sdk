...
func (c EventExceptionOccurrenceExtensionClient) CreateEventExceptionOccurrenceExtension(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceId, input beta.Extension) (result CreateEventExceptionOccurrenceExtensionOperationResponse, err error) {
