...
func NewGroupSiteTermStoreSetParentGroupSetTermRelationID(groupId string, siteId string, setId string, setId1 string, termId string, relationId string) GroupSiteTermStoreSetParentGroupSetTermRelationId {
...
func (id GroupSiteTermStoreSetParentGroupSetTermRelationId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStore/sets/%s/parentGroup/sets/%s/terms/%s/relations/%s"
