package groupsitetermstoresetparentgroupsettermrelationfromterm
...
func TestNewGroupSiteTermStoreSetParentGroupSetTermRelationID(t *testing.T) {
	id := NewGroupSiteTermStoreSetParentGroupSetTermRelationID("groupIdValue", "siteIdValue", "setIdValue", "setId1Value", "termIdValue", "relationIdValue")
...
func TestFormatGroupSiteTermStoreSetParentGroupSetTermRelationID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetParentGroupSetTermRelationID("groupIdValue", "siteIdValue", "setIdValue", "setId1Value", "termIdValue", "relationIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/terms/termIdValue/relations/relationIdValue"
	if actual != expected {
...
func TestParseGroupSiteTermStoreSetParentGroupSetTermRelationID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/terms/termIdValue/relations",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/terms/termIdValue/relations/relationIdValue",
			Expected: &GroupSiteTermStoreSetParentGroupSetTermRelationId{
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/terms/termIdValue/relations/relationIdValue/extra",
			Error: true,
		},
	}
