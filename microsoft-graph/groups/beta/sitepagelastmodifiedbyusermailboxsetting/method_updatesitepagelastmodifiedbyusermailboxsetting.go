...
func (c SitePageLastModifiedByUserMailboxSettingClient) UpdateSitePageLastModifiedByUserMailboxSetting(ctx context.Context, id beta.GroupIdSiteIdPageId, input beta.MailboxSettings) (result UpdateSitePageLastModifiedByUserMailboxSettingOperationResponse, err error) {
