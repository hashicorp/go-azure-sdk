...
func (c SiteListContentTypeClient) CreateSiteListContentType(ctx context.Context, id GroupIdSiteIdListId, input beta.ContentType) (result CreateSiteListContentTypeOperationResponse, err error) {
