...
func (c SiteListContentTypeClient) CreateSiteListContentType(ctx context.Context, id beta.GroupIdSiteIdListId, input beta.ContentType) (result CreateSiteListContentTypeOperationResponse, err error) {
