...
func (c CalendarEventAttachmentClient) CreateCalendarEventAttachmentsUploadSession(ctx context.Context, id beta.GroupIdCalendarEventId, input CreateCalendarEventAttachmentsUploadSessionRequest) (result CreateCalendarEventAttachmentsUploadSessionOperationResponse, err error) {
