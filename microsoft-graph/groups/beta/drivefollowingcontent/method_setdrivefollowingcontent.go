...
func (c DriveFollowingContentClient) SetDriveFollowingContent(ctx context.Context, id beta.GroupIdDriveIdFollowingId, input []byte) (result SetDriveFollowingContentOperationResponse, err error) {
