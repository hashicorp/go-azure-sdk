...
// a new time.
func (c CalendarEventClient) SnoozeCalendarEventReminder(ctx context.Context, id beta.GroupIdCalendarEventId, input SnoozeCalendarEventReminderRequest) (result SnoozeCalendarEventReminderOperationResponse, err error) {
