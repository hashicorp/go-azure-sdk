...
func (c CalendarEventClient) TentativelyAcceptCalendarEvent(ctx context.Context, id beta.GroupIdCalendarEventId, input TentativelyAcceptCalendarEventRequest) (result TentativelyAcceptCalendarEventOperationResponse, err error) {
