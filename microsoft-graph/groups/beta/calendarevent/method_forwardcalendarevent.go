...
// Outlook.com account.
func (c CalendarEventClient) ForwardCalendarEvent(ctx context.Context, id beta.GroupIdCalendarEventId, input ForwardCalendarEventRequest) (result ForwardCalendarEventOperationResponse, err error) {
