...
func (c CalendarEventClient) CancelCalendarEvent(ctx context.Context, id beta.GroupIdCalendarEventId, input CancelCalendarEventRequest) (result CancelCalendarEventOperationResponse, err error) {
