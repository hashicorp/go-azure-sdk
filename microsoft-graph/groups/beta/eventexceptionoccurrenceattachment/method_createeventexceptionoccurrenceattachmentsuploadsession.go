...
func (c EventExceptionOccurrenceAttachmentClient) CreateEventExceptionOccurrenceAttachmentsUploadSession(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceId, input CreateEventExceptionOccurrenceAttachmentsUploadSessionRequest) (result CreateEventExceptionOccurrenceAttachmentsUploadSessionOperationResponse, err error) {
