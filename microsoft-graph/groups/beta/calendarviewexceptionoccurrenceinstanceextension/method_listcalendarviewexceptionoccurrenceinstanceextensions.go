...
func (c CalendarViewExceptionOccurrenceInstanceExtensionClient) ListCalendarViewExceptionOccurrenceInstanceExtensions(ctx context.Context, id GroupIdCalendarViewIdExceptionOccurrenceIdInstanceId) (result ListCalendarViewExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceInstanceExtensionClient) ListCalendarViewExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id GroupIdCalendarViewIdExceptionOccurrenceIdInstanceId) (ListCalendarViewExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
...
func (c CalendarViewExceptionOccurrenceInstanceExtensionClient) ListCalendarViewExceptionOccurrenceInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarViewIdExceptionOccurrenceIdInstanceId, predicate ExtensionOperationPredicate) (result ListCalendarViewExceptionOccurrenceInstanceExtensionsCompleteResult, err error) {
