...
func (c EventExceptionOccurrenceInstanceExtensionClient) ListEventExceptionOccurrenceInstanceExtensions(ctx context.Context, id GroupIdEventIdExceptionOccurrenceIdInstanceId) (result ListEventExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceInstanceExtensionClient) ListEventExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id GroupIdEventIdExceptionOccurrenceIdInstanceId) (ListEventExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
