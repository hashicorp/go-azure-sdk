...
func (c DriveItemClient) CreateDriveItemLink(ctx context.Context, id beta.GroupIdDriveIdItemId, input CreateDriveItemLinkRequest) (result CreateDriveItemLinkOperationResponse, err error) {
