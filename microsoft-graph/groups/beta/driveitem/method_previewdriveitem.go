...
func (c DriveItemClient) PreviewDriveItem(ctx context.Context, id beta.GroupIdDriveIdItemId, input PreviewDriveItemRequest) (result PreviewDriveItemOperationResponse, err error) {
