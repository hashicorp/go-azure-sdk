...
func (c DriveItemClient) CheckinDriveItem(ctx context.Context, id beta.GroupIdDriveIdItemId, input CheckinDriveItemRequest) (result CheckinDriveItemOperationResponse, err error) {
