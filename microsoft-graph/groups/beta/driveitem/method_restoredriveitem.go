...
// bin.
func (c DriveItemClient) RestoreDriveItem(ctx context.Context, id beta.GroupIdDriveIdItemId, input RestoreDriveItemRequest) (result RestoreDriveItemOperationResponse, err error) {
