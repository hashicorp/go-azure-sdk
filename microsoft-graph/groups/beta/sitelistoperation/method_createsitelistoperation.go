...
func (c SiteListOperationClient) CreateSiteListOperation(ctx context.Context, id beta.GroupIdSiteIdListId, input beta.RichLongRunningOperation) (result CreateSiteListOperationOperationResponse, err error) {
