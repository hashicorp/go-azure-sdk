package setgroupsitetermstoregroupsettermchildren
...
func TestNewGroupSiteTermStoreGroupSetTermChildrenID(t *testing.T) {
	id := NewGroupSiteTermStoreGroupSetTermChildrenID("groupIdValue", "siteIdValue", "groupId1Value", "setIdValue", "termIdValue", "termId1Value")
...
func TestFormatGroupSiteTermStoreGroupSetTermChildrenID(t *testing.T) {
	actual := NewGroupSiteTermStoreGroupSetTermChildrenID("groupIdValue", "siteIdValue", "groupId1Value", "setIdValue", "termIdValue", "termId1Value").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStore/groups/groupId1Value/sets/setIdValue/terms/termIdValue/children/termId1Value"
	if actual != expected {
...
func TestParseGroupSiteTermStoreGroupSetTermChildrenID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/groups/groupId1Value/sets/setIdValue/terms/termIdValue/children/termId1Value/extra",
			Error: true,
		},
	}
