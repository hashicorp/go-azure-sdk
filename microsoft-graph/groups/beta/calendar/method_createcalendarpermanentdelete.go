...
func (c CalendarClient) CreateCalendarPermanentDelete(ctx context.Context, id beta.GroupId, options CreateCalendarPermanentDeleteOperationOptions) (result CreateCalendarPermanentDeleteOperationResponse, err error) {
