...
func TestNewGroupSiteInformationProtectionThreatAssessmentRequestResultID(t *testing.T) {
	id := NewGroupSiteInformationProtectionThreatAssessmentRequestResultID("groupIdValue", "siteIdValue", "threatAssessmentRequestIdValue", "threatAssessmentResultIdValue")
...
func TestFormatGroupSiteInformationProtectionThreatAssessmentRequestResultID(t *testing.T) {
	actual := NewGroupSiteInformationProtectionThreatAssessmentRequestResultID("groupIdValue", "siteIdValue", "threatAssessmentRequestIdValue", "threatAssessmentResultIdValue").ID()
...
func TestParseGroupSiteInformationProtectionThreatAssessmentRequestResultID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteInformationProtectionThreatAssessmentRequestResultId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteInformationProtectionThreatAssessmentRequestResultID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteInformationProtectionThreatAssessmentRequestResultIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteInformationProtectionThreatAssessmentRequestResultId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteInformationProtectionThreatAssessmentRequestResultIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteInformationProtectionThreatAssessmentRequestResultId(t *testing.T) {
	segments := GroupSiteInformationProtectionThreatAssessmentRequestResultId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteInformationProtectionThreatAssessmentRequestResultId has no segments")
	}
