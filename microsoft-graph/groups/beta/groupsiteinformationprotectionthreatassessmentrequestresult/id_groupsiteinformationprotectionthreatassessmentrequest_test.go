...
func TestNewGroupSiteInformationProtectionThreatAssessmentRequestID(t *testing.T) {
	id := NewGroupSiteInformationProtectionThreatAssessmentRequestID("groupIdValue", "siteIdValue", "threatAssessmentRequestIdValue")
...
func TestFormatGroupSiteInformationProtectionThreatAssessmentRequestID(t *testing.T) {
	actual := NewGroupSiteInformationProtectionThreatAssessmentRequestID("groupIdValue", "siteIdValue", "threatAssessmentRequestIdValue").ID()
...
func TestParseGroupSiteInformationProtectionThreatAssessmentRequestID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteInformationProtectionThreatAssessmentRequestId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteInformationProtectionThreatAssessmentRequestID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteInformationProtectionThreatAssessmentRequestIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteInformationProtectionThreatAssessmentRequestId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteInformationProtectionThreatAssessmentRequestIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteInformationProtectionThreatAssessmentRequestId(t *testing.T) {
	segments := GroupSiteInformationProtectionThreatAssessmentRequestId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteInformationProtectionThreatAssessmentRequestId has no segments")
	}
