...
func TestNewGroupSiteTermStoreSetParentGroupSetChildrenChildrenID(t *testing.T) {
	id := NewGroupSiteTermStoreSetParentGroupSetChildrenChildrenID("groupIdValue", "siteIdValue", "setIdValue", "setId1Value", "termIdValue", "termId1Value")
...
func TestFormatGroupSiteTermStoreSetParentGroupSetChildrenChildrenID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetParentGroupSetChildrenChildrenID("groupIdValue", "siteIdValue", "setIdValue", "setId1Value", "termIdValue", "termId1Value").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/children/termIdValue/children/termId1Value"
	if actual != expected {
...
func TestParseGroupSiteTermStoreSetParentGroupSetChildrenChildrenID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/children/termIdValue/children/termId1Value/extra",
			Error: true,
		},
	}
