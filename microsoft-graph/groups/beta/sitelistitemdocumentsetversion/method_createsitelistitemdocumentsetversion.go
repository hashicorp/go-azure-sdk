...
func (c SiteListItemDocumentSetVersionClient) CreateSiteListItemDocumentSetVersion(ctx context.Context, id beta.GroupIdSiteIdListIdItemId, input beta.DocumentSetVersion) (result CreateSiteListItemDocumentSetVersionOperationResponse, err error) {
