...
func (c DriveRootListItemClient) CreateDriveRootListItemLink(ctx context.Context, id beta.GroupIdDriveId, input CreateDriveRootListItemLinkRequest) (result CreateDriveRootListItemLinkOperationResponse, err error) {
