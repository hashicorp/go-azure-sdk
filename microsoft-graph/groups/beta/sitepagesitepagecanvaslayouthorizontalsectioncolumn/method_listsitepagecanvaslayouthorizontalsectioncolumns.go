...
// section.
func (c SitePageSitePageCanvasLayoutHorizontalSectionColumnClient) ListSitePageCanvasLayoutHorizontalSectionColumns(ctx context.Context, id beta.GroupIdSiteIdPageIdSitePageCanvasLayoutHorizontalSectionId, options ListSitePageCanvasLayoutHorizontalSectionColumnsOperationOptions) (result ListSitePageCanvasLayoutHorizontalSectionColumnsOperationResponse, err error) {
...
func (c SitePageSitePageCanvasLayoutHorizontalSectionColumnClient) ListSitePageCanvasLayoutHorizontalSectionColumnsComplete(ctx context.Context, id beta.GroupIdSiteIdPageIdSitePageCanvasLayoutHorizontalSectionId, options ListSitePageCanvasLayoutHorizontalSectionColumnsOperationOptions) (ListSitePageCanvasLayoutHorizontalSectionColumnsCompleteResult, error) {
