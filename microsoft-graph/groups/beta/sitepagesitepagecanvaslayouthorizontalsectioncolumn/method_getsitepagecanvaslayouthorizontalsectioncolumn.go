...
// section.
func (c SitePageSitePageCanvasLayoutHorizontalSectionColumnClient) GetSitePageCanvasLayoutHorizontalSectionColumn(ctx context.Context, id beta.GroupIdSiteIdPageIdSitePageCanvasLayoutHorizontalSectionIdColumnId, options GetSitePageCanvasLayoutHorizontalSectionColumnOperationOptions) (result GetSitePageCanvasLayoutHorizontalSectionColumnOperationResponse, err error) {
