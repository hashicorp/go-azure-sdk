...
func TestNewGroupSiteListItemVersionID(t *testing.T) {
	id := NewGroupSiteListItemVersionID("groupIdValue", "siteIdValue", "listIdValue", "listItemIdValue", "listItemVersionIdValue")
...
func TestFormatGroupSiteListItemVersionID(t *testing.T) {
	actual := NewGroupSiteListItemVersionID("groupIdValue", "siteIdValue", "listIdValue", "listItemIdValue", "listItemVersionIdValue").ID()
...
func TestParseGroupSiteListItemVersionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteListItemVersionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteListItemVersionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteListItemVersionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteListItemVersionId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteListItemVersionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteListItemVersionId(t *testing.T) {
	segments := GroupSiteListItemVersionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteListItemVersionId has no segments")
	}
