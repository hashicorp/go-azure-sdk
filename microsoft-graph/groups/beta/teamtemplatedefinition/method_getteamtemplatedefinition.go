...
func (c TeamTemplateDefinitionClient) GetTeamTemplateDefinition(ctx context.Context, id GroupId) (result GetTeamTemplateDefinitionOperationResponse, err error) {
