...
func (c PlannerPlanBucketClient) CreatePlannerPlanBucket(ctx context.Context, id beta.GroupIdPlannerPlanId, input beta.PlannerBucket) (result CreatePlannerPlanBucketOperationResponse, err error) {
