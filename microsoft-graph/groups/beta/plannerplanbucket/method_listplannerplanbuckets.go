...
func (c PlannerPlanBucketClient) ListPlannerPlanBuckets(ctx context.Context, id GroupIdPlannerPlanId) (result ListPlannerPlanBucketsOperationResponse, err error) {
...
func (c PlannerPlanBucketClient) ListPlannerPlanBucketsComplete(ctx context.Context, id GroupIdPlannerPlanId) (ListPlannerPlanBucketsCompleteResult, error) {
...
func (c PlannerPlanBucketClient) ListPlannerPlanBucketsCompleteMatchingPredicate(ctx context.Context, id GroupIdPlannerPlanId, predicate PlannerBucketOperationPredicate) (result ListPlannerPlanBucketsCompleteResult, err error) {
