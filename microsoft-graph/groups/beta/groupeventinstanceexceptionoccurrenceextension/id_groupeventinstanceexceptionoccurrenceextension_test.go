...
func TestNewGroupEventInstanceExceptionOccurrenceExtensionID(t *testing.T) {
	id := NewGroupEventInstanceExceptionOccurrenceExtensionID("groupIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue")
...
func TestFormatGroupEventInstanceExceptionOccurrenceExtensionID(t *testing.T) {
	actual := NewGroupEventInstanceExceptionOccurrenceExtensionID("groupIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue").ID()
...
func TestParseGroupEventInstanceExceptionOccurrenceExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupEventInstanceExceptionOccurrenceExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupEventInstanceExceptionOccurrenceExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupEventInstanceExceptionOccurrenceExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupEventInstanceExceptionOccurrenceExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupEventInstanceExceptionOccurrenceExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupEventInstanceExceptionOccurrenceExtensionId(t *testing.T) {
	segments := GroupEventInstanceExceptionOccurrenceExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupEventInstanceExceptionOccurrenceExtensionId has no segments")
	}
