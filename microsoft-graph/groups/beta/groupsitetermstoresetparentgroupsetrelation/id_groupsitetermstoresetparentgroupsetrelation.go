...
func NewGroupSiteTermStoreSetParentGroupSetRelationID(groupId string, siteId string, setId string, setId1 string, relationId string) GroupSiteTermStoreSetParentGroupSetRelationId {
...
func (id GroupSiteTermStoreSetParentGroupSetRelationId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStore/sets/%s/parentGroup/sets/%s/relations/%s"
	return fmt.Sprintf(fmtString, id.GroupId, id.SiteId, id.SetId, id.SetId1, id.RelationId)
}
