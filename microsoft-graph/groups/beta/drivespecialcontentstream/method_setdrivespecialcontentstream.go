...
func (c DriveSpecialContentStreamClient) SetDriveSpecialContentStream(ctx context.Context, id beta.GroupIdDriveIdSpecialId, input []byte) (result SetDriveSpecialContentStreamOperationResponse, err error) {
