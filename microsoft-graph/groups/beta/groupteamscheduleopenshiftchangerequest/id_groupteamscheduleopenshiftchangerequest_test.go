...
func TestNewGroupTeamScheduleOpenShiftChangeRequestID(t *testing.T) {
	id := NewGroupTeamScheduleOpenShiftChangeRequestID("groupIdValue", "openShiftChangeRequestIdValue")
...
func TestFormatGroupTeamScheduleOpenShiftChangeRequestID(t *testing.T) {
	actual := NewGroupTeamScheduleOpenShiftChangeRequestID("groupIdValue", "openShiftChangeRequestIdValue").ID()
...
func TestParseGroupTeamScheduleOpenShiftChangeRequestID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamScheduleOpenShiftChangeRequestId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamScheduleOpenShiftChangeRequestID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupTeamScheduleOpenShiftChangeRequestIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamScheduleOpenShiftChangeRequestId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamScheduleOpenShiftChangeRequestIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupTeamScheduleOpenShiftChangeRequestId(t *testing.T) {
	segments := GroupTeamScheduleOpenShiftChangeRequestId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupTeamScheduleOpenShiftChangeRequestId has no segments")
	}
