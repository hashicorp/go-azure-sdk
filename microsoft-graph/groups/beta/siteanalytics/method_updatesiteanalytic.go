...
func (c SiteAnalyticsClient) UpdateSiteAnalytic(ctx context.Context, id beta.GroupIdSiteId, input beta.ItemAnalytics) (result UpdateSiteAnalyticOperationResponse, err error) {
