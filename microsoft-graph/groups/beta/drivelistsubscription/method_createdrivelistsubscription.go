...
func (c DriveListSubscriptionClient) CreateDriveListSubscription(ctx context.Context, id beta.GroupIdDriveId, input beta.Subscription) (result CreateDriveListSubscriptionOperationResponse, err error) {
