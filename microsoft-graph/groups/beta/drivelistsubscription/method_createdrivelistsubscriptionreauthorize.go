...
func (c DriveListSubscriptionClient) CreateDriveListSubscriptionReauthorize(ctx context.Context, id beta.GroupIdDriveIdListSubscriptionId) (result CreateDriveListSubscriptionReauthorizeOperationResponse, err error) {
