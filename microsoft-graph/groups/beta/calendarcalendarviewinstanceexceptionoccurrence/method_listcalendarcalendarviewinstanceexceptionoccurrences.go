...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) ListCalendarCalendarViewInstanceExceptionOccurrences(ctx context.Context, id GroupIdCalendarCalendarViewIdInstanceId) (result ListCalendarCalendarViewInstanceExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) ListCalendarCalendarViewInstanceExceptionOccurrencesComplete(ctx context.Context, id GroupIdCalendarCalendarViewIdInstanceId) (ListCalendarCalendarViewInstanceExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) ListCalendarCalendarViewInstanceExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarCalendarViewIdInstanceId, predicate EventOperationPredicate) (result ListCalendarCalendarViewInstanceExceptionOccurrencesCompleteResult, err error) {
