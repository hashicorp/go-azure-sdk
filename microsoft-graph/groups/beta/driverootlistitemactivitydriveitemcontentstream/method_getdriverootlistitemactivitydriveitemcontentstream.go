...
func (c DriveRootListItemActivityDriveItemContentStreamClient) GetDriveRootListItemActivityDriveItemContentStream(ctx context.Context, id beta.GroupIdDriveIdRootListItemActivityId) (result GetDriveRootListItemActivityDriveItemContentStreamOperationResponse, err error) {
