...
func (c DriveRootListItemActivityDriveItemContentStreamClient) SetDriveRootListItemActivityDriveItemContentStream(ctx context.Context, id beta.GroupIdDriveIdRootListItemActivityId, input []byte) (result SetDriveRootListItemActivityDriveItemContentStreamOperationResponse, err error) {
