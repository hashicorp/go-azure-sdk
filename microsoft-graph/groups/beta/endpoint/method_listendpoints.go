...
// ListEndpoints ...
func (c EndpointClient) ListEndpoints(ctx context.Context, id GroupId) (result ListEndpointsOperationResponse, err error) {
...
func (c EndpointClient) ListEndpointsComplete(ctx context.Context, id GroupId) (ListEndpointsCompleteResult, error) {
...
func (c EndpointClient) ListEndpointsCompleteMatchingPredicate(ctx context.Context, id GroupId, predicate EndpointOperationPredicate) (result ListEndpointsCompleteResult, err error) {
