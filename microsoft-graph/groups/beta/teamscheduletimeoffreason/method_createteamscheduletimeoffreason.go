...
func (c TeamScheduleTimeOffReasonClient) CreateTeamScheduleTimeOffReason(ctx context.Context, id beta.GroupId, input beta.TimeOffReason) (result CreateTeamScheduleTimeOffReasonOperationResponse, err error) {
