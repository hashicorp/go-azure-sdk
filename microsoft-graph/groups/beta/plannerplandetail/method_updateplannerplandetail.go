...
func (c PlannerPlanDetailClient) UpdatePlannerPlanDetail(ctx context.Context, id GroupIdPlannerPlanId, input beta.PlannerPlanDetails) (result UpdatePlannerPlanDetailOperationResponse, err error) {
