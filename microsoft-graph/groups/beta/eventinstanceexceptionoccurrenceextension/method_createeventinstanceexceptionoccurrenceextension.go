...
func (c EventInstanceExceptionOccurrenceExtensionClient) CreateEventInstanceExceptionOccurrenceExtension(ctx context.Context, id beta.GroupIdEventIdInstanceIdExceptionOccurrenceId, input beta.Extension) (result CreateEventInstanceExceptionOccurrenceExtensionOperationResponse, err error) {
