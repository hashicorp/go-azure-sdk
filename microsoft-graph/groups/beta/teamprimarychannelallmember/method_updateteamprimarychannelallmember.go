...
func (c TeamPrimaryChannelAllMemberClient) UpdateTeamPrimaryChannelAllMember(ctx context.Context, id beta.GroupIdTeamPrimaryChannelAllMemberId, input beta.ConversationMember, options UpdateTeamPrimaryChannelAllMemberOperationOptions) (result UpdateTeamPrimaryChannelAllMemberOperationResponse, err error) {
