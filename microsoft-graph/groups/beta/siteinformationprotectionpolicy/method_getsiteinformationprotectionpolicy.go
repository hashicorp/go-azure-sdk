...
// GetSiteInformationProtectionPolicy ...
func (c SiteInformationProtectionPolicyClient) GetSiteInformationProtectionPolicy(ctx context.Context, id GroupIdSiteId) (result GetSiteInformationProtectionPolicyOperationResponse, err error) {
