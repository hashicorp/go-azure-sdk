...
// collection
func (c MembersWithLicenseErrorClient) ListMembersWithLicenseErrorUsers(ctx context.Context, id beta.GroupId, options ListMembersWithLicenseErrorUsersOperationOptions) (result ListMembersWithLicenseErrorUsersOperationResponse, err error) {
...
func (c MembersWithLicenseErrorClient) ListMembersWithLicenseErrorUsersComplete(ctx context.Context, id beta.GroupId, options ListMembersWithLicenseErrorUsersOperationOptions) (ListMembersWithLicenseErrorUsersCompleteResult, error) {
...
func (c MembersWithLicenseErrorClient) ListMembersWithLicenseErrorUsersCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, options ListMembersWithLicenseErrorUsersOperationOptions, predicate UserOperationPredicate) (result ListMembersWithLicenseErrorUsersCompleteResult, err error) {
