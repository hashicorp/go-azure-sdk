...
func (c TeamScheduleSchedulingGroupClient) CreateTeamScheduleSchedulingGroup(ctx context.Context, id beta.GroupId, input beta.SchedulingGroup) (result CreateTeamScheduleSchedulingGroupOperationResponse, err error) {
