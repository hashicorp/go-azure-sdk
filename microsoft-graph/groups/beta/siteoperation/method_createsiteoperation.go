...
// CreateSiteOperation ...
func (c SiteOperationClient) CreateSiteOperation(ctx context.Context, id GroupIdSiteId, input beta.RichLongRunningOperation) (result CreateSiteOperationOperationResponse, err error) {
