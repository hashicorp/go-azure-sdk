...
func (c EventInstanceExceptionOccurrenceClient) ForwardEventInstanceExceptionOccurrence(ctx context.Context, id beta.GroupIdEventIdInstanceIdExceptionOccurrenceId, input ForwardEventInstanceExceptionOccurrenceRequest) (result ForwardEventInstanceExceptionOccurrenceOperationResponse, err error) {
