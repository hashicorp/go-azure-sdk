...
func (c EventInstanceExceptionOccurrenceClient) DeclineEventInstanceExceptionOccurrence(ctx context.Context, id beta.GroupIdEventIdInstanceIdExceptionOccurrenceId, input DeclineEventInstanceExceptionOccurrenceRequest) (result DeclineEventInstanceExceptionOccurrenceOperationResponse, err error) {
