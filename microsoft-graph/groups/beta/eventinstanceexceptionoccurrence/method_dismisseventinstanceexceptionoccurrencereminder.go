...
func (c EventInstanceExceptionOccurrenceClient) DismissEventInstanceExceptionOccurrenceReminder(ctx context.Context, id beta.GroupIdEventIdInstanceIdExceptionOccurrenceId) (result DismissEventInstanceExceptionOccurrenceReminderOperationResponse, err error) {
