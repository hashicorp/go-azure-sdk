...
func TestNewGroupSiteListSubscriptionID(t *testing.T) {
	id := NewGroupSiteListSubscriptionID("groupIdValue", "siteIdValue", "listIdValue", "subscriptionIdValue")
...
func TestFormatGroupSiteListSubscriptionID(t *testing.T) {
	actual := NewGroupSiteListSubscriptionID("groupIdValue", "siteIdValue", "listIdValue", "subscriptionIdValue").ID()
...
func TestParseGroupSiteListSubscriptionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteListSubscriptionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteListSubscriptionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteListSubscriptionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteListSubscriptionId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteListSubscriptionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteListSubscriptionId(t *testing.T) {
	segments := GroupSiteListSubscriptionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteListSubscriptionId has no segments")
	}
