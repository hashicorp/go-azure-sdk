...
func NewGroupSiteTermStoreGroupSetRelationID(groupId string, siteId string, groupId1 string, setId string, relationId string) GroupSiteTermStoreGroupSetRelationId {
...
func (id GroupSiteTermStoreGroupSetRelationId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStore/groups/%s/sets/%s/relations/%s"
	return fmt.Sprintf(fmtString, id.GroupId, id.SiteId, id.GroupId1, id.SetId, id.RelationId)
}
