...
func TestNewGroupTeamScheduleSwapShiftsChangeRequestID(t *testing.T) {
	id := NewGroupTeamScheduleSwapShiftsChangeRequestID("groupIdValue", "swapShiftsChangeRequestIdValue")
...
func TestFormatGroupTeamScheduleSwapShiftsChangeRequestID(t *testing.T) {
	actual := NewGroupTeamScheduleSwapShiftsChangeRequestID("groupIdValue", "swapShiftsChangeRequestIdValue").ID()
...
func TestParseGroupTeamScheduleSwapShiftsChangeRequestID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamScheduleSwapShiftsChangeRequestId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamScheduleSwapShiftsChangeRequestID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupTeamScheduleSwapShiftsChangeRequestIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamScheduleSwapShiftsChangeRequestId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamScheduleSwapShiftsChangeRequestIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupTeamScheduleSwapShiftsChangeRequestId(t *testing.T) {
	segments := GroupTeamScheduleSwapShiftsChangeRequestId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupTeamScheduleSwapShiftsChangeRequestId has no segments")
	}
