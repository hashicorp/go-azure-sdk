...
func (c ConversationThreadPostInReplyToExtensionClient) CreateConversationThreadPostInReplyToExtension(ctx context.Context, id beta.GroupIdConversationIdThreadIdPostId, input beta.Extension) (result CreateConversationThreadPostInReplyToExtensionOperationResponse, err error) {
