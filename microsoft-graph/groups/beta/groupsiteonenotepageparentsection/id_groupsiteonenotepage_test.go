package groupsiteonenotepageparentsection
...
func TestNewGroupSiteOnenotePageID(t *testing.T) {
	id := NewGroupSiteOnenotePageID("groupIdValue", "siteIdValue", "onenotePageIdValue")
...
func TestFormatGroupSiteOnenotePageID(t *testing.T) {
	actual := NewGroupSiteOnenotePageID("groupIdValue", "siteIdValue", "onenotePageIdValue").ID()
...
func TestParseGroupSiteOnenotePageID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteOnenotePageId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteOnenotePageID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteOnenotePageIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteOnenotePageId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteOnenotePageIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteOnenotePageId(t *testing.T) {
	segments := GroupSiteOnenotePageId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteOnenotePageId has no segments")
	}
