...
func (c DriveListItemActivityClient) CreateDriveListItemActivity(ctx context.Context, id beta.GroupIdDriveIdListItemId, input beta.ItemActivityOLD) (result CreateDriveListItemActivityOperationResponse, err error) {
