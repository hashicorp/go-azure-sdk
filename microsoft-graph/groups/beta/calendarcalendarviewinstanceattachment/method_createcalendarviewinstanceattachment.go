...
func (c CalendarCalendarViewInstanceAttachmentClient) CreateCalendarViewInstanceAttachment(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, input beta.Attachment) (result CreateCalendarViewInstanceAttachmentOperationResponse, err error) {
