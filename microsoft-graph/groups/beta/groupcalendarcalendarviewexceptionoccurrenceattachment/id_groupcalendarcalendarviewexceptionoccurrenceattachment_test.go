...
func TestNewGroupCalendarCalendarViewExceptionOccurrenceAttachmentID(t *testing.T) {
	id := NewGroupCalendarCalendarViewExceptionOccurrenceAttachmentID("groupIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue")
...
func TestFormatGroupCalendarCalendarViewExceptionOccurrenceAttachmentID(t *testing.T) {
	actual := NewGroupCalendarCalendarViewExceptionOccurrenceAttachmentID("groupIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue").ID()
...
func TestParseGroupCalendarCalendarViewExceptionOccurrenceAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupCalendarCalendarViewExceptionOccurrenceAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupCalendarCalendarViewExceptionOccurrenceAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupCalendarCalendarViewExceptionOccurrenceAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupCalendarCalendarViewExceptionOccurrenceAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupCalendarCalendarViewExceptionOccurrenceAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupCalendarCalendarViewExceptionOccurrenceAttachmentId(t *testing.T) {
	segments := GroupCalendarCalendarViewExceptionOccurrenceAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupCalendarCalendarViewExceptionOccurrenceAttachmentId has no segments")
	}
