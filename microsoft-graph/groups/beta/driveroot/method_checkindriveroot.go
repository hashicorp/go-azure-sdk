...
func (c DriveRootClient) CheckinDriveRoot(ctx context.Context, id beta.GroupIdDriveId, input CheckinDriveRootRequest) (result CheckinDriveRootOperationResponse, err error) {
