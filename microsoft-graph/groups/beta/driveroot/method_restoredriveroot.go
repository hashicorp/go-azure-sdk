...
// bin.
func (c DriveRootClient) RestoreDriveRoot(ctx context.Context, id beta.GroupIdDriveId, input RestoreDriveRootRequest) (result RestoreDriveRootOperationResponse, err error) {
