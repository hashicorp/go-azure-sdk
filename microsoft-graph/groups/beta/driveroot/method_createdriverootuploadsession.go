...
func (c DriveRootClient) CreateDriveRootUploadSession(ctx context.Context, id beta.GroupIdDriveId, input CreateDriveRootUploadSessionRequest) (result CreateDriveRootUploadSessionOperationResponse, err error) {
