...
func (c DriveRootClient) PreviewDriveRoot(ctx context.Context, id beta.GroupIdDriveId, input PreviewDriveRootRequest) (result PreviewDriveRootOperationResponse, err error) {
