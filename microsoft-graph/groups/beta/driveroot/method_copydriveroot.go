...
// progress.
func (c DriveRootClient) CopyDriveRoot(ctx context.Context, id beta.GroupIdDriveId, input CopyDriveRootRequest) (result CopyDriveRootOperationResponse, err error) {
