...
func (c DriveRootClient) CreateDriveRootLink(ctx context.Context, id beta.GroupIdDriveId, input CreateDriveRootLinkRequest) (result CreateDriveRootLinkOperationResponse, err error) {
