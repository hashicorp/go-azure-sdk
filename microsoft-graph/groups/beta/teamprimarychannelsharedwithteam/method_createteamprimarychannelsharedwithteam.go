...
func (c TeamPrimaryChannelSharedWithTeamClient) CreateTeamPrimaryChannelSharedWithTeam(ctx context.Context, id beta.GroupId, input beta.SharedWithChannelTeamInfo) (result CreateTeamPrimaryChannelSharedWithTeamOperationResponse, err error) {
