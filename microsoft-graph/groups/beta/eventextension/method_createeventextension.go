...
func (c EventExtensionClient) CreateEventExtension(ctx context.Context, id beta.GroupIdEventId, input beta.Extension) (result CreateEventExtensionOperationResponse, err error) {
