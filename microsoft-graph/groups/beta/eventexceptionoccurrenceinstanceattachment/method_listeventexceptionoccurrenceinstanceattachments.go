...
func (c EventExceptionOccurrenceInstanceAttachmentClient) ListEventExceptionOccurrenceInstanceAttachments(ctx context.Context, id GroupIdEventIdExceptionOccurrenceIdInstanceId) (result ListEventExceptionOccurrenceInstanceAttachmentsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceInstanceAttachmentClient) ListEventExceptionOccurrenceInstanceAttachmentsComplete(ctx context.Context, id GroupIdEventIdExceptionOccurrenceIdInstanceId) (ListEventExceptionOccurrenceInstanceAttachmentsCompleteResult, error) {
...
func (c EventExceptionOccurrenceInstanceAttachmentClient) ListEventExceptionOccurrenceInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id GroupIdEventIdExceptionOccurrenceIdInstanceId, predicate AttachmentOperationPredicate) (result ListEventExceptionOccurrenceInstanceAttachmentsCompleteResult, err error) {
