...
func (c EventExceptionOccurrenceInstanceAttachmentClient) CreateEventExceptionOccurrenceInstanceAttachmentsUploadSession(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, input CreateEventExceptionOccurrenceInstanceAttachmentsUploadSessionRequest) (result CreateEventExceptionOccurrenceInstanceAttachmentsUploadSessionOperationResponse, err error) {
