...
func (c ThreadPostInReplyToClient) ForwardThreadPostInReplyTo(ctx context.Context, id beta.GroupIdThreadIdPostId, input ForwardThreadPostInReplyToRequest) (result ForwardThreadPostInReplyToOperationResponse, err error) {
