...
func (c CalendarEventExceptionOccurrenceExtensionClient) ListCalendarEventExceptionOccurrenceExtensions(ctx context.Context, id GroupIdCalendarEventIdExceptionOccurrenceId) (result ListCalendarEventExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceExtensionClient) ListCalendarEventExceptionOccurrenceExtensionsComplete(ctx context.Context, id GroupIdCalendarEventIdExceptionOccurrenceId) (ListCalendarEventExceptionOccurrenceExtensionsCompleteResult, error) {
