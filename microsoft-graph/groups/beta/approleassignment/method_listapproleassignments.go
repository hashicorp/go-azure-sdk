...
func (c AppRoleAssignmentClient) ListAppRoleAssignments(ctx context.Context, id GroupId) (result ListAppRoleAssignmentsOperationResponse, err error) {
...
func (c AppRoleAssignmentClient) ListAppRoleAssignmentsComplete(ctx context.Context, id GroupId) (ListAppRoleAssignmentsCompleteResult, error) {
...
func (c AppRoleAssignmentClient) ListAppRoleAssignmentsCompleteMatchingPredicate(ctx context.Context, id GroupId, predicate AppRoleAssignmentOperationPredicate) (result ListAppRoleAssignmentsCompleteResult, err error) {
