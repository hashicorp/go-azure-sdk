...
func (c AppRoleAssignmentClient) CreateAppRoleAssignment(ctx context.Context, id beta.GroupId, input beta.AppRoleAssignment) (result CreateAppRoleAssignmentOperationResponse, err error) {
