...
func (c DriveRootContentStreamClient) GetDriveRootContentStream(ctx context.Context, id beta.GroupIdDriveId) (result GetDriveRootContentStreamOperationResponse, err error) {
