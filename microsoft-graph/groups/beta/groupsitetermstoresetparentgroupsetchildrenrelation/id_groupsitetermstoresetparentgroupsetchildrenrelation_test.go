...
func TestNewGroupSiteTermStoreSetParentGroupSetChildrenRelationID(t *testing.T) {
	id := NewGroupSiteTermStoreSetParentGroupSetChildrenRelationID("groupIdValue", "siteIdValue", "setIdValue", "setId1Value", "termIdValue", "relationIdValue")
...
func TestFormatGroupSiteTermStoreSetParentGroupSetChildrenRelationID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetParentGroupSetChildrenRelationID("groupIdValue", "siteIdValue", "setIdValue", "setId1Value", "termIdValue", "relationIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/children/termIdValue/relations/relationIdValue"
	if actual != expected {
...
func TestParseGroupSiteTermStoreSetParentGroupSetChildrenRelationID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/children/termIdValue/relations",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/children/termIdValue/relations/relationIdValue",
			Expected: &GroupSiteTermStoreSetParentGroupSetChildrenRelationId{
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/children/termIdValue/relations/relationIdValue/extra",
			Error: true,
		},
	}
