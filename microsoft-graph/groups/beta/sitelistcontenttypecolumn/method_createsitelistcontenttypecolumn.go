...
func (c SiteListContentTypeColumnClient) CreateSiteListContentTypeColumn(ctx context.Context, id beta.GroupIdSiteIdListIdContentTypeId, input beta.ColumnDefinition) (result CreateSiteListContentTypeColumnOperationResponse, err error) {
