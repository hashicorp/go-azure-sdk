...
// GetSiteInformationProtection ...
func (c SiteInformationProtectionClient) GetSiteInformationProtection(ctx context.Context, id GroupIdSiteId) (result GetSiteInformationProtectionOperationResponse, err error) {
