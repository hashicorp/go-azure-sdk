...
func TestNewGroupConversationThreadPostInReplyToMentionID(t *testing.T) {
	id := NewGroupConversationThreadPostInReplyToMentionID("groupIdValue", "conversationIdValue", "conversationThreadIdValue", "postIdValue", "mentionIdValue")
...
func TestFormatGroupConversationThreadPostInReplyToMentionID(t *testing.T) {
	actual := NewGroupConversationThreadPostInReplyToMentionID("groupIdValue", "conversationIdValue", "conversationThreadIdValue", "postIdValue", "mentionIdValue").ID()
...
func TestParseGroupConversationThreadPostInReplyToMentionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupConversationThreadPostInReplyToMentionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupConversationThreadPostInReplyToMentionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupConversationThreadPostInReplyToMentionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupConversationThreadPostInReplyToMentionId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupConversationThreadPostInReplyToMentionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupConversationThreadPostInReplyToMentionId(t *testing.T) {
	segments := GroupConversationThreadPostInReplyToMentionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupConversationThreadPostInReplyToMentionId has no segments")
	}
