...
func (c ConversationThreadPostAttachmentClient) CreateConversationThreadPostAttachmentsUploadSession(ctx context.Context, id beta.GroupIdConversationIdThreadIdPostId, input CreateConversationThreadPostAttachmentsUploadSessionRequest) (result CreateConversationThreadPostAttachmentsUploadSessionOperationResponse, err error) {
