...
func (c ConversationThreadPostAttachmentClient) CreateConversationThreadPostAttachment(ctx context.Context, id beta.GroupIdConversationIdThreadIdPostId, input beta.Attachment) (result CreateConversationThreadPostAttachmentOperationResponse, err error) {
