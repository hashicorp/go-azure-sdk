...
func (c ThreadPostClient) ForwardThreadPost(ctx context.Context, id beta.GroupIdThreadIdPostId, input ForwardThreadPostRequest) (result ForwardThreadPostOperationResponse, err error) {
