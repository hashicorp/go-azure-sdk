...
func NewGroupSiteTermStoreSetTermChildrenID(groupId string, siteId string, setId string, termId string, termId1 string) GroupSiteTermStoreSetTermChildrenId {
