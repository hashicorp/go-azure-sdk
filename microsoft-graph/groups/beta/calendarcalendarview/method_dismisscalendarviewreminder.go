...
// in a user calendar.
func (c CalendarCalendarViewClient) DismissCalendarViewReminder(ctx context.Context, id beta.GroupIdCalendarCalendarViewId) (result DismissCalendarViewReminderOperationResponse, err error) {
