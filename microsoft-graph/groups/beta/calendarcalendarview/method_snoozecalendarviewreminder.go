...
// a new time.
func (c CalendarCalendarViewClient) SnoozeCalendarViewReminder(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, input SnoozeCalendarViewReminderRequest) (result SnoozeCalendarViewReminderOperationResponse, err error) {
