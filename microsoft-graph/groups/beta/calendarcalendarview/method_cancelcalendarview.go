...
func (c CalendarCalendarViewClient) CancelCalendarView(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, input CancelCalendarViewRequest) (result CancelCalendarViewOperationResponse, err error) {
