...
func (c CalendarCalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, input TentativelyAcceptCalendarViewRequest) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
