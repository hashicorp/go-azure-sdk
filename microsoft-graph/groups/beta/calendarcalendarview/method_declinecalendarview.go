...
func (c CalendarCalendarViewClient) DeclineCalendarView(ctx context.Context, id beta.GroupIdCalendarCalendarViewId, input DeclineCalendarViewRequest) (result DeclineCalendarViewOperationResponse, err error) {
