...
func (c EventExceptionOccurrenceClient) DeclineEventExceptionOccurrence(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceId, input DeclineEventExceptionOccurrenceRequest) (result DeclineEventExceptionOccurrenceOperationResponse, err error) {
