...
func (c EventExceptionOccurrenceClient) CancelEventExceptionOccurrence(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceId, input CancelEventExceptionOccurrenceRequest) (result CancelEventExceptionOccurrenceOperationResponse, err error) {
