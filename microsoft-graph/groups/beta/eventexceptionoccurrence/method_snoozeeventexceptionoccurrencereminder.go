...
func (c EventExceptionOccurrenceClient) SnoozeEventExceptionOccurrenceReminder(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceId, input SnoozeEventExceptionOccurrenceReminderRequest) (result SnoozeEventExceptionOccurrenceReminderOperationResponse, err error) {
