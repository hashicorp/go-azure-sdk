...
func (c EventExceptionOccurrenceClient) TentativelyAcceptEventExceptionOccurrence(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceId, input TentativelyAcceptEventExceptionOccurrenceRequest) (result TentativelyAcceptEventExceptionOccurrenceOperationResponse, err error) {
