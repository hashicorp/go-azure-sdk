...
// ListSiteRecycleBinItemCreatedByUserServiceProvisioningErrors ...
func (c SiteRecycleBinItemCreatedByUserServiceProvisioningErrorClient) ListSiteRecycleBinItemCreatedByUserServiceProvisioningErrors(ctx context.Context, id GroupIdSiteIdRecycleBinItemId) (result ListSiteRecycleBinItemCreatedByUserServiceProvisioningErrorsOperationResponse, err error) {
...
func (c SiteRecycleBinItemCreatedByUserServiceProvisioningErrorClient) ListSiteRecycleBinItemCreatedByUserServiceProvisioningErrorsComplete(ctx context.Context, id GroupIdSiteIdRecycleBinItemId) (ListSiteRecycleBinItemCreatedByUserServiceProvisioningErrorsCompleteResult, error) {
	return c.ListSiteRecycleBinItemCreatedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx, id, ServiceProvisioningErrorOperationPredicate{})
}
