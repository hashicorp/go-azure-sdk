...
func (c TeamChannelMemberClient) RemoveTeamChannelMembers(ctx context.Context, id beta.GroupIdTeamChannelId, input RemoveTeamChannelMembersRequest, options RemoveTeamChannelMembersOperationOptions) (result RemoveTeamChannelMembersOperationResponse, err error) {
...
func (c TeamChannelMemberClient) RemoveTeamChannelMembersComplete(ctx context.Context, id beta.GroupIdTeamChannelId, input RemoveTeamChannelMembersRequest, options RemoveTeamChannelMembersOperationOptions) (RemoveTeamChannelMembersCompleteResult, error) {
...
func (c TeamChannelMemberClient) RemoveTeamChannelMembersCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdTeamChannelId, input RemoveTeamChannelMembersRequest, options RemoveTeamChannelMembersOperationOptions, predicate ActionResultPartOperationPredicate) (result RemoveTeamChannelMembersCompleteResult, err error) {
