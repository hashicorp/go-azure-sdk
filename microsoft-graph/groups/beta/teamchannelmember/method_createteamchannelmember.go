...
func (c TeamChannelMemberClient) CreateTeamChannelMember(ctx context.Context, id beta.GroupIdTeamChannelId, input beta.ConversationMember) (result CreateTeamChannelMemberOperationResponse, err error) {
