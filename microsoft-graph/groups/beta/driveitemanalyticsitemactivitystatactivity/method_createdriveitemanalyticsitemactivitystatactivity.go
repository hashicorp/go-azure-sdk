...
func (c DriveItemAnalyticsItemActivityStatActivityClient) CreateDriveItemAnalyticsItemActivityStatActivity(ctx context.Context, id beta.GroupIdDriveIdItemIdAnalyticsItemActivityStatId, input beta.ItemActivity) (result CreateDriveItemAnalyticsItemActivityStatActivityOperationResponse, err error) {
