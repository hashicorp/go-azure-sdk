...
func TestNewGroupIdSiteIdListIdItemID(t *testing.T) {
	id := NewGroupIdSiteIdListIdItemID("groupIdValue", "siteIdValue", "listIdValue", "listItemIdValue")
...
func TestFormatGroupIdSiteIdListIdItemID(t *testing.T) {
	actual := NewGroupIdSiteIdListIdItemID("groupIdValue", "siteIdValue", "listIdValue", "listItemIdValue").ID()
