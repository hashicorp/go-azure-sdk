...
func TestNewGroupSiteOnenoteNotebookSectionGroupSectionID(t *testing.T) {
	id := NewGroupSiteOnenoteNotebookSectionGroupSectionID("groupIdValue", "siteIdValue", "notebookIdValue", "sectionGroupIdValue", "onenoteSectionIdValue")
...
func TestFormatGroupSiteOnenoteNotebookSectionGroupSectionID(t *testing.T) {
	actual := NewGroupSiteOnenoteNotebookSectionGroupSectionID("groupIdValue", "siteIdValue", "notebookIdValue", "sectionGroupIdValue", "onenoteSectionIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/onenote/notebooks/notebookIdValue/sectionGroups/sectionGroupIdValue/sections/onenoteSectionIdValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseGroupSiteOnenoteNotebookSectionGroupSectionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteOnenoteNotebookSectionGroupSectionId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/onenote/notebooks/notebookIdValue/sectionGroups/sectionGroupIdValue/sections/onenoteSectionIdValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteOnenoteNotebookSectionGroupSectionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteOnenoteNotebookSectionGroupSectionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteOnenoteNotebookSectionGroupSectionId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteOnenoteNotebookSectionGroupSectionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteOnenoteNotebookSectionGroupSectionId(t *testing.T) {
	segments := GroupSiteOnenoteNotebookSectionGroupSectionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteOnenoteNotebookSectionGroupSectionId has no segments")
	}
