...
func TestNewGroupSiteInformationProtectionSensitivityLabelSublabelID(t *testing.T) {
	id := NewGroupSiteInformationProtectionSensitivityLabelSublabelID("groupIdValue", "siteIdValue", "sensitivityLabelIdValue", "sensitivityLabelId1Value")
...
func TestFormatGroupSiteInformationProtectionSensitivityLabelSublabelID(t *testing.T) {
	actual := NewGroupSiteInformationProtectionSensitivityLabelSublabelID("groupIdValue", "siteIdValue", "sensitivityLabelIdValue", "sensitivityLabelId1Value").ID()
...
func TestParseGroupSiteInformationProtectionSensitivityLabelSublabelID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteInformationProtectionSensitivityLabelSublabelId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteInformationProtectionSensitivityLabelSublabelID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteInformationProtectionSensitivityLabelSublabelIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteInformationProtectionSensitivityLabelSublabelId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteInformationProtectionSensitivityLabelSublabelIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteInformationProtectionSensitivityLabelSublabelId(t *testing.T) {
	segments := GroupSiteInformationProtectionSensitivityLabelSublabelId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteInformationProtectionSensitivityLabelSublabelId has no segments")
	}
