...
func (c CalendarCalendarPermissionClient) ListCalendarCalendarPermissions(ctx context.Context, id GroupId) (result ListCalendarCalendarPermissionsOperationResponse, err error) {
...
func (c CalendarCalendarPermissionClient) ListCalendarCalendarPermissionsComplete(ctx context.Context, id GroupId) (ListCalendarCalendarPermissionsCompleteResult, error) {
...
func (c CalendarCalendarPermissionClient) ListCalendarCalendarPermissionsCompleteMatchingPredicate(ctx context.Context, id GroupId, predicate CalendarPermissionOperationPredicate) (result ListCalendarCalendarPermissionsCompleteResult, err error) {
