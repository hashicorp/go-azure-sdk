...
func (c DriveActivityDriveItemContentStreamClient) SetDriveActivityDriveItemContentStream(ctx context.Context, id beta.GroupIdDriveIdActivityId, input []byte) (result SetDriveActivityDriveItemContentStreamOperationResponse, err error) {
