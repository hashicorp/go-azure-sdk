...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstances(ctx context.Context, id GroupIdCalendarViewIdExceptionOccurrenceId) (result ListCalendarViewExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstancesComplete(ctx context.Context, id GroupIdCalendarViewIdExceptionOccurrenceId) (ListCalendarViewExceptionOccurrenceInstancesCompleteResult, error) {
...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarViewIdExceptionOccurrenceId, predicate EventOperationPredicate) (result ListCalendarViewExceptionOccurrenceInstancesCompleteResult, err error) {
