...
func (c DriveListItemCreatedByUserMailboxSettingClient) UpdateDriveListItemCreatedByUserMailboxSetting(ctx context.Context, id beta.GroupIdDriveIdListItemId, input beta.MailboxSettings) (result UpdateDriveListItemCreatedByUserMailboxSettingOperationResponse, err error) {
