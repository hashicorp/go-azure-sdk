...
func (c SiteListContentTypeColumnLinkClient) CreateSiteListContentTypeColumnLink(ctx context.Context, id beta.GroupIdSiteIdListIdContentTypeId, input beta.ColumnLink) (result CreateSiteListContentTypeColumnLinkOperationResponse, err error) {
