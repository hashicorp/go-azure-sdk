...
func (c DriveItemListItemActivityContentStreamClient) DeleteDriveItemListItemActivityContentStream(ctx context.Context, id beta.GroupIdDriveIdItemIdListItemActivityId, options DeleteDriveItemListItemActivityContentStreamOperationOptions) (result DeleteDriveItemListItemActivityContentStreamOperationResponse, err error) {
