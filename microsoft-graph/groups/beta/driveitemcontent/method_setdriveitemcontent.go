...
func (c DriveItemContentClient) SetDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdItemId, input []byte) (result SetDriveItemContentOperationResponse, err error) {
