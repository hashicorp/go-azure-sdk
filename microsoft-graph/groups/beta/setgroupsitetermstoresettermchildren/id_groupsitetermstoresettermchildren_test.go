...
func TestNewGroupSiteTermStoreSetTermChildrenID(t *testing.T) {
	id := NewGroupSiteTermStoreSetTermChildrenID("groupIdValue", "siteIdValue", "setIdValue", "termIdValue", "termId1Value")
...
func TestFormatGroupSiteTermStoreSetTermChildrenID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetTermChildrenID("groupIdValue", "siteIdValue", "setIdValue", "termIdValue", "termId1Value").ID()
