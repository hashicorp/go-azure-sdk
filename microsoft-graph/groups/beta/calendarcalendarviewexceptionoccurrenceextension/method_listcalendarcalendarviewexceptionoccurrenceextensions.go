...
func (c CalendarCalendarViewExceptionOccurrenceExtensionClient) ListCalendarCalendarViewExceptionOccurrenceExtensions(ctx context.Context, id GroupIdCalendarCalendarViewIdExceptionOccurrenceId) (result ListCalendarCalendarViewExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceExtensionClient) ListCalendarCalendarViewExceptionOccurrenceExtensionsComplete(ctx context.Context, id GroupIdCalendarCalendarViewIdExceptionOccurrenceId) (ListCalendarCalendarViewExceptionOccurrenceExtensionsCompleteResult, error) {
...
func (c CalendarCalendarViewExceptionOccurrenceExtensionClient) ListCalendarCalendarViewExceptionOccurrenceExtensionsCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarCalendarViewIdExceptionOccurrenceId, predicate ExtensionOperationPredicate) (result ListCalendarCalendarViewExceptionOccurrenceExtensionsCompleteResult, err error) {
