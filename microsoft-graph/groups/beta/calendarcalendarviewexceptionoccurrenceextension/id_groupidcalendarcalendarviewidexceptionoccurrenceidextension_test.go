...
func TestNewGroupIdCalendarCalendarViewIdExceptionOccurrenceIdExtensionID(t *testing.T) {
	id := NewGroupIdCalendarCalendarViewIdExceptionOccurrenceIdExtensionID("groupIdValue", "eventIdValue", "eventId1Value", "extensionIdValue")
...
func TestFormatGroupIdCalendarCalendarViewIdExceptionOccurrenceIdExtensionID(t *testing.T) {
	actual := NewGroupIdCalendarCalendarViewIdExceptionOccurrenceIdExtensionID("groupIdValue", "eventIdValue", "eventId1Value", "extensionIdValue").ID()
