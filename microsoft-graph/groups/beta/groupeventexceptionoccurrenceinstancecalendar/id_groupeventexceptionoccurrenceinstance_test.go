package groupeventexceptionoccurrenceinstancecalendar
...
func TestNewGroupEventExceptionOccurrenceInstanceID(t *testing.T) {
	id := NewGroupEventExceptionOccurrenceInstanceID("groupIdValue", "eventIdValue", "eventId1Value", "eventId2Value")
...
func TestFormatGroupEventExceptionOccurrenceInstanceID(t *testing.T) {
	actual := NewGroupEventExceptionOccurrenceInstanceID("groupIdValue", "eventIdValue", "eventId1Value", "eventId2Value").ID()
...
func TestParseGroupEventExceptionOccurrenceInstanceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupEventExceptionOccurrenceInstanceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupEventExceptionOccurrenceInstanceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupEventExceptionOccurrenceInstanceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupEventExceptionOccurrenceInstanceId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupEventExceptionOccurrenceInstanceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupEventExceptionOccurrenceInstanceId(t *testing.T) {
	segments := GroupEventExceptionOccurrenceInstanceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupEventExceptionOccurrenceInstanceId has no segments")
	}
