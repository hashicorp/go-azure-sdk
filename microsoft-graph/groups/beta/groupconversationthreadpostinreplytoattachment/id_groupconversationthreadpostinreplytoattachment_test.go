...
func TestNewGroupConversationThreadPostInReplyToAttachmentID(t *testing.T) {
	id := NewGroupConversationThreadPostInReplyToAttachmentID("groupIdValue", "conversationIdValue", "conversationThreadIdValue", "postIdValue", "attachmentIdValue")
...
func TestFormatGroupConversationThreadPostInReplyToAttachmentID(t *testing.T) {
	actual := NewGroupConversationThreadPostInReplyToAttachmentID("groupIdValue", "conversationIdValue", "conversationThreadIdValue", "postIdValue", "attachmentIdValue").ID()
...
func TestParseGroupConversationThreadPostInReplyToAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupConversationThreadPostInReplyToAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupConversationThreadPostInReplyToAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupConversationThreadPostInReplyToAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupConversationThreadPostInReplyToAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupConversationThreadPostInReplyToAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupConversationThreadPostInReplyToAttachmentId(t *testing.T) {
	segments := GroupConversationThreadPostInReplyToAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupConversationThreadPostInReplyToAttachmentId has no segments")
	}
