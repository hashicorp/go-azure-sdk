...
func (c DriveRootAnalyticsItemActivityStatActivityDriveItemContentClient) SetDriveRootAnalyticsItemActivityStatActivityDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdRootAnalyticsItemActivityStatIdActivityId, input []byte) (result SetDriveRootAnalyticsItemActivityStatActivityDriveItemContentOperationResponse, err error) {
