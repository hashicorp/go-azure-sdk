...
func (c TeamPrimaryChannelMessageReplyHostedContentClient) GetTeamPrimaryChannelMessageReplyHostedContentValue(ctx context.Context, id beta.GroupIdTeamPrimaryChannelMessageIdReplyIdHostedContentId) (result GetTeamPrimaryChannelMessageReplyHostedContentValueOperationResponse, err error) {
