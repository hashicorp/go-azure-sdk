...
// UpdateDriveRootExtension - Update the navigation property extensions in groups
func (c DriveRootExtensionClient) UpdateDriveRootExtension(ctx context.Context, id beta.GroupIdDriveIdRootExtensionId, input beta.Extension, options UpdateDriveRootExtensionOperationOptions) (result UpdateDriveRootExtensionOperationResponse, err error) {
