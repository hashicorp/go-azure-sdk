...
// DeleteDriveRootExtension - Delete navigation property extensions for groups
func (c DriveRootExtensionClient) DeleteDriveRootExtension(ctx context.Context, id beta.GroupIdDriveIdRootExtensionId, options DeleteDriveRootExtensionOperationOptions) (result DeleteDriveRootExtensionOperationResponse, err error) {
