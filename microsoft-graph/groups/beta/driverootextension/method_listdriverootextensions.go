...
// ListDriveRootExtensions - Get extensions from groups. The collection of open extensions defined for this item.
// Nullable.
func (c DriveRootExtensionClient) ListDriveRootExtensions(ctx context.Context, id beta.GroupIdDriveId, options ListDriveRootExtensionsOperationOptions) (result ListDriveRootExtensionsOperationResponse, err error) {
...
func (c DriveRootExtensionClient) ListDriveRootExtensionsComplete(ctx context.Context, id beta.GroupIdDriveId, options ListDriveRootExtensionsOperationOptions) (ListDriveRootExtensionsCompleteResult, error) {
...
func (c DriveRootExtensionClient) ListDriveRootExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdDriveId, options ListDriveRootExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListDriveRootExtensionsCompleteResult, err error) {
