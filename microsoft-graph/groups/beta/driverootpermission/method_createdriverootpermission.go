...
func (c DriveRootPermissionClient) CreateDriveRootPermission(ctx context.Context, id beta.GroupIdDriveId, input beta.Permission) (result CreateDriveRootPermissionOperationResponse, err error) {
