...
// UpdateSiteInformationProtectionSensitivityLabelSublabel ...
func (c SiteInformationProtectionSensitivityLabelSublabelClient) UpdateSiteInformationProtectionSensitivityLabelSublabel(ctx context.Context, id GroupIdSiteIdInformationProtectionSensitivityLabelIdSublabelId, input beta.SensitivityLabel) (result UpdateSiteInformationProtectionSensitivityLabelSublabelOperationResponse, err error) {
