...
func TestNewGroupConversationThreadPostAttachmentID(t *testing.T) {
	id := NewGroupConversationThreadPostAttachmentID("groupIdValue", "conversationIdValue", "conversationThreadIdValue", "postIdValue", "attachmentIdValue")
...
func TestFormatGroupConversationThreadPostAttachmentID(t *testing.T) {
	actual := NewGroupConversationThreadPostAttachmentID("groupIdValue", "conversationIdValue", "conversationThreadIdValue", "postIdValue", "attachmentIdValue").ID()
	expected := "/groups/groupIdValue/conversations/conversationIdValue/threads/conversationThreadIdValue/posts/postIdValue/attachments/attachmentIdValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseGroupConversationThreadPostAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupConversationThreadPostAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		{
			// Incomplete URI
			Input: "/groups/groupIdValue/conversations/conversationIdValue/threads/conversationThreadIdValue/posts/postIdValue/attachments",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupIdValue/conversations/conversationIdValue/threads/conversationThreadIdValue/posts/postIdValue/attachments/attachmentIdValue",
			Expected: &GroupConversationThreadPostAttachmentId{
		...
		},
		{
			...
			Input: "/groups/groupIdValue/conversations/conversationIdValue/threads/conversationThreadIdValue/posts/postIdValue/attachments/attachmentIdValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseGroupConversationThreadPostAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupConversationThreadPostAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupConversationThreadPostAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupConversationThreadPostAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupConversationThreadPostAttachmentId(t *testing.T) {
	segments := GroupConversationThreadPostAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupConversationThreadPostAttachmentId has no segments")
	}
