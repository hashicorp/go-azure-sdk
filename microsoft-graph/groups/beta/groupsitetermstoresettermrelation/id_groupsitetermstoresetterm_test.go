...
func TestNewGroupSiteTermStoreSetTermID(t *testing.T) {
	id := NewGroupSiteTermStoreSetTermID("groupIdValue", "siteIdValue", "setIdValue", "termIdValue")
...
func TestFormatGroupSiteTermStoreSetTermID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetTermID("groupIdValue", "siteIdValue", "setIdValue", "termIdValue").ID()
