...
func (c DriveItemAnalyticsItemActivityStatClient) CreateDriveItemAnalyticsItemActivityStat(ctx context.Context, id beta.GroupIdDriveIdItemId, input beta.ItemActivityStat) (result CreateDriveItemAnalyticsItemActivityStatOperationResponse, err error) {
