...
func (c TeamMemberClient) RemoveTeamMembers(ctx context.Context, id beta.GroupId, input RemoveTeamMembersRequest, options RemoveTeamMembersOperationOptions) (result RemoveTeamMembersOperationResponse, err error) {
...
func (c TeamMemberClient) RemoveTeamMembersComplete(ctx context.Context, id beta.GroupId, input RemoveTeamMembersRequest, options RemoveTeamMembersOperationOptions) (RemoveTeamMembersCompleteResult, error) {
...
func (c TeamMemberClient) RemoveTeamMembersCompleteMatchingPredicate(ctx context.Context, id beta.GroupId, input RemoveTeamMembersRequest, options RemoveTeamMembersOperationOptions, predicate ActionResultPartOperationPredicate) (result RemoveTeamMembersCompleteResult, err error) {
