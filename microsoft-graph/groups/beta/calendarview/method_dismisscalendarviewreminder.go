...
// in a user calendar.
func (c CalendarViewClient) DismissCalendarViewReminder(ctx context.Context, id beta.GroupIdCalendarViewId) (result DismissCalendarViewReminderOperationResponse, err error) {
