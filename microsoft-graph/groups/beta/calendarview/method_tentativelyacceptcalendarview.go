...
func (c CalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id beta.GroupIdCalendarViewId, input TentativelyAcceptCalendarViewRequest) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
