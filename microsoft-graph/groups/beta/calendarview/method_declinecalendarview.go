...
func (c CalendarViewClient) DeclineCalendarView(ctx context.Context, id beta.GroupIdCalendarViewId, input DeclineCalendarViewRequest) (result DeclineCalendarViewOperationResponse, err error) {
