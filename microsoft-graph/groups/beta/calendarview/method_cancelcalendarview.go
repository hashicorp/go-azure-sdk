...
func (c CalendarViewClient) CancelCalendarView(ctx context.Context, id beta.GroupIdCalendarViewId, input CancelCalendarViewRequest) (result CancelCalendarViewOperationResponse, err error) {
