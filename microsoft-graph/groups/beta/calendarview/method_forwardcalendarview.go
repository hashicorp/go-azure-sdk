...
// Outlook.com account.
func (c CalendarViewClient) ForwardCalendarView(ctx context.Context, id beta.GroupIdCalendarViewId, input ForwardCalendarViewRequest) (result ForwardCalendarViewOperationResponse, err error) {
