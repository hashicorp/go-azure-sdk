...
func (c CalendarViewInstanceExceptionOccurrenceExtensionClient) UpdateCalendarViewInstanceExceptionOccurrenceExtension(ctx context.Context, id beta.GroupIdCalendarViewIdInstanceIdExceptionOccurrenceIdExtensionId, input beta.Extension) (result UpdateCalendarViewInstanceExceptionOccurrenceExtensionOperationResponse, err error) {
