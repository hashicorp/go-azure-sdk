...
func (c CalendarViewInstanceExceptionOccurrenceExtensionClient) ListCalendarViewInstanceExceptionOccurrenceExtensions(ctx context.Context, id GroupIdCalendarViewIdInstanceIdExceptionOccurrenceId) (result ListCalendarViewInstanceExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c CalendarViewInstanceExceptionOccurrenceExtensionClient) ListCalendarViewInstanceExceptionOccurrenceExtensionsComplete(ctx context.Context, id GroupIdCalendarViewIdInstanceIdExceptionOccurrenceId) (ListCalendarViewInstanceExceptionOccurrenceExtensionsCompleteResult, error) {
...
func (c CalendarViewInstanceExceptionOccurrenceExtensionClient) ListCalendarViewInstanceExceptionOccurrenceExtensionsCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarViewIdInstanceIdExceptionOccurrenceId, predicate ExtensionOperationPredicate) (result ListCalendarViewInstanceExceptionOccurrenceExtensionsCompleteResult, err error) {
