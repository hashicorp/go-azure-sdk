...
func (c ConversationClient) CreateConversation(ctx context.Context, id beta.GroupId, input beta.Conversation) (result CreateConversationOperationResponse, err error) {
