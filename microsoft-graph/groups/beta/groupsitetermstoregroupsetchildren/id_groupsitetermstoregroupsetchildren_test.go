...
func TestNewGroupSiteTermStoreGroupSetChildrenID(t *testing.T) {
	id := NewGroupSiteTermStoreGroupSetChildrenID("groupIdValue", "siteIdValue", "groupId1Value", "setIdValue", "termIdValue")
...
func TestFormatGroupSiteTermStoreGroupSetChildrenID(t *testing.T) {
	actual := NewGroupSiteTermStoreGroupSetChildrenID("groupIdValue", "siteIdValue", "groupId1Value", "setIdValue", "termIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStore/groups/groupId1Value/sets/setIdValue/children/termIdValue"
	if actual != expected {
...
func TestParseGroupSiteTermStoreGroupSetChildrenID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/groups/groupId1Value/sets/setIdValue/children/termIdValue/extra",
			Error: true,
		},
	}
