...
func TestNewGroupTeamPermissionGrantID(t *testing.T) {
	id := NewGroupTeamPermissionGrantID("groupIdValue", "resourceSpecificPermissionGrantIdValue")
...
func TestFormatGroupTeamPermissionGrantID(t *testing.T) {
	actual := NewGroupTeamPermissionGrantID("groupIdValue", "resourceSpecificPermissionGrantIdValue").ID()
...
func TestParseGroupTeamPermissionGrantID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamPermissionGrantId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamPermissionGrantID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupTeamPermissionGrantIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamPermissionGrantId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamPermissionGrantIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupTeamPermissionGrantId(t *testing.T) {
	segments := GroupTeamPermissionGrantId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupTeamPermissionGrantId has no segments")
	}
