...
func (c CalendarViewInstanceExceptionOccurrenceAttachmentClient) ListCalendarViewInstanceExceptionOccurrenceAttachments(ctx context.Context, id GroupIdCalendarViewIdInstanceIdExceptionOccurrenceId) (result ListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarViewInstanceExceptionOccurrenceAttachmentClient) ListCalendarViewInstanceExceptionOccurrenceAttachmentsComplete(ctx context.Context, id GroupIdCalendarViewIdInstanceIdExceptionOccurrenceId) (ListCalendarViewInstanceExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c CalendarViewInstanceExceptionOccurrenceAttachmentClient) ListCalendarViewInstanceExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarViewIdInstanceIdExceptionOccurrenceId, predicate AttachmentOperationPredicate) (result ListCalendarViewInstanceExceptionOccurrenceAttachmentsCompleteResult, err error) {
