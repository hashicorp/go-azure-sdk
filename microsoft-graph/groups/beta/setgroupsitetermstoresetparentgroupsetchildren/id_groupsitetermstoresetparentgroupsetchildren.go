...
func NewGroupSiteTermStoreSetParentGroupSetChildrenID(groupId string, siteId string, setId string, setId1 string, termId string) GroupSiteTermStoreSetParentGroupSetChildrenId {
...
func (id GroupSiteTermStoreSetParentGroupSetChildrenId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStore/sets/%s/parentGroup/sets/%s/children/%s"
