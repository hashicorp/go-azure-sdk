...
func TestNewGroupCalendarEventExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	id := NewGroupCalendarEventExceptionOccurrenceInstanceExtensionID("groupIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue")
...
func TestFormatGroupCalendarEventExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	actual := NewGroupCalendarEventExceptionOccurrenceInstanceExtensionID("groupIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue").ID()
...
func TestParseGroupCalendarEventExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupCalendarEventExceptionOccurrenceInstanceExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupCalendarEventExceptionOccurrenceInstanceExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupCalendarEventExceptionOccurrenceInstanceExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupCalendarEventExceptionOccurrenceInstanceExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupCalendarEventExceptionOccurrenceInstanceExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupCalendarEventExceptionOccurrenceInstanceExtensionId(t *testing.T) {
	segments := GroupCalendarEventExceptionOccurrenceInstanceExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupCalendarEventExceptionOccurrenceInstanceExtensionId has no segments")
	}
