...
func (c SitePageSitePageCanvasLayoutVerticalSectionWebpartClient) GetSitePageCanvasLayoutVerticalSectionWebpartPositionOfWebPart(ctx context.Context, id beta.GroupIdSiteIdPageIdSitePageCanvasLayoutVerticalSectionWebpartId, options GetSitePageCanvasLayoutVerticalSectionWebpartPositionOfWebPartOperationOptions) (result GetSitePageCanvasLayoutVerticalSectionWebpartPositionOfWebPartOperationResponse, err error) {
