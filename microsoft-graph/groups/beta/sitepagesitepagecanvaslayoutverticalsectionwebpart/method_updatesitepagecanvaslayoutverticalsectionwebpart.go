...
func (c SitePageSitePageCanvasLayoutVerticalSectionWebpartClient) UpdateSitePageCanvasLayoutVerticalSectionWebpart(ctx context.Context, id beta.GroupIdSiteIdPageIdSitePageCanvasLayoutVerticalSectionWebpartId, input beta.WebPart, options UpdateSitePageCanvasLayoutVerticalSectionWebpartOperationOptions) (result UpdateSitePageCanvasLayoutVerticalSectionWebpartOperationResponse, err error) {
