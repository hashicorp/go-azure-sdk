...
func (c SitePageSitePageCanvasLayoutVerticalSectionWebpartClient) CreateSitePageCanvasLayoutVerticalSectionWebpart(ctx context.Context, id beta.GroupIdSiteIdPageId, input beta.WebPart, options CreateSitePageCanvasLayoutVerticalSectionWebpartOperationOptions) (result CreateSitePageCanvasLayoutVerticalSectionWebpartOperationResponse, err error) {
