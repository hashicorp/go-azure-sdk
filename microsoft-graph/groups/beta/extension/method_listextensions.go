...
// ListExtensions ...
func (c ExtensionClient) ListExtensions(ctx context.Context, id GroupId) (result ListExtensionsOperationResponse, err error) {
...
func (c ExtensionClient) ListExtensionsComplete(ctx context.Context, id GroupId) (ListExtensionsCompleteResult, error) {
...
func (c ExtensionClient) ListExtensionsCompleteMatchingPredicate(ctx context.Context, id GroupId, predicate ExtensionOperationPredicate) (result ListExtensionsCompleteResult, err error) {
