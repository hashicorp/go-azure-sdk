...
func (c TeamPrimaryChannelMessageClient) CreateTeamPrimaryChannelMessage(ctx context.Context, id beta.GroupId, input beta.ChatMessage) (result CreateTeamPrimaryChannelMessageOperationResponse, err error) {
