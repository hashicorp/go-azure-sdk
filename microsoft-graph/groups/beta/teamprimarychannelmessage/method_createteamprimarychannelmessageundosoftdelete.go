...
func (c TeamPrimaryChannelMessageClient) CreateTeamPrimaryChannelMessageUndoSoftDelete(ctx context.Context, id beta.GroupIdTeamPrimaryChannelMessageId) (result CreateTeamPrimaryChannelMessageUndoSoftDeleteOperationResponse, err error) {
