...
func (c SiteContentTypeClient) CreateSiteContentType(ctx context.Context, id GroupIdSiteId, input beta.ContentType) (result CreateSiteContentTypeOperationResponse, err error) {
