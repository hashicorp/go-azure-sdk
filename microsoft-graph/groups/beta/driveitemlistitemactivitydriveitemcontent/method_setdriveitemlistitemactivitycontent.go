...
func (c DriveItemListItemActivityDriveItemContentClient) SetDriveItemListItemActivityContent(ctx context.Context, id beta.GroupIdDriveIdItemIdListItemActivityId, input []byte) (result SetDriveItemListItemActivityContentOperationResponse, err error) {
