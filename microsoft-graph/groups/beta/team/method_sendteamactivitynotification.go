...
func (c TeamClient) SendTeamActivityNotification(ctx context.Context, id beta.GroupId, input SendTeamActivityNotificationRequest) (result SendTeamActivityNotificationOperationResponse, err error) {
