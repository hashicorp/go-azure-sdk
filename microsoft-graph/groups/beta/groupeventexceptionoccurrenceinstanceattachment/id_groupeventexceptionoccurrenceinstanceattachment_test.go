...
func TestNewGroupEventExceptionOccurrenceInstanceAttachmentID(t *testing.T) {
	id := NewGroupEventExceptionOccurrenceInstanceAttachmentID("groupIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue")
...
func TestFormatGroupEventExceptionOccurrenceInstanceAttachmentID(t *testing.T) {
	actual := NewGroupEventExceptionOccurrenceInstanceAttachmentID("groupIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue").ID()
...
func TestParseGroupEventExceptionOccurrenceInstanceAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupEventExceptionOccurrenceInstanceAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupEventExceptionOccurrenceInstanceAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupEventExceptionOccurrenceInstanceAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupEventExceptionOccurrenceInstanceAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupEventExceptionOccurrenceInstanceAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupEventExceptionOccurrenceInstanceAttachmentId(t *testing.T) {
	segments := GroupEventExceptionOccurrenceInstanceAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupEventExceptionOccurrenceInstanceAttachmentId has no segments")
	}
