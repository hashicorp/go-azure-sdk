...
func TestNewGroupSiteInformationProtectionPolicyLabelID(t *testing.T) {
	id := NewGroupSiteInformationProtectionPolicyLabelID("groupIdValue", "siteIdValue", "informationProtectionLabelIdValue")
...
func TestFormatGroupSiteInformationProtectionPolicyLabelID(t *testing.T) {
	actual := NewGroupSiteInformationProtectionPolicyLabelID("groupIdValue", "siteIdValue", "informationProtectionLabelIdValue").ID()
...
func TestParseGroupSiteInformationProtectionPolicyLabelID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteInformationProtectionPolicyLabelId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteInformationProtectionPolicyLabelID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteInformationProtectionPolicyLabelIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteInformationProtectionPolicyLabelId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteInformationProtectionPolicyLabelIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteInformationProtectionPolicyLabelId(t *testing.T) {
	segments := GroupSiteInformationProtectionPolicyLabelId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteInformationProtectionPolicyLabelId has no segments")
	}
