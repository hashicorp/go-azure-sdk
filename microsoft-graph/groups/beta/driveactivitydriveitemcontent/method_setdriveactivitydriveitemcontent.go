...
func (c DriveActivityDriveItemContentClient) SetDriveActivityDriveItemContent(ctx context.Context, id beta.GroupIdDriveIdActivityId, input []byte) (result SetDriveActivityDriveItemContentOperationResponse, err error) {
