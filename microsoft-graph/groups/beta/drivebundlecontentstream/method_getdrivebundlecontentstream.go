...
func (c DriveBundleContentStreamClient) GetDriveBundleContentStream(ctx context.Context, id beta.GroupIdDriveIdBundleId) (result GetDriveBundleContentStreamOperationResponse, err error) {
