...
func (c DriveItemChildClient) CreateDriveItemChild(ctx context.Context, id beta.GroupIdDriveIdItemId, input beta.DriveItem) (result CreateDriveItemChildOperationResponse, err error) {
