...
func TestNewGroupThreadPostInReplyToAttachmentID(t *testing.T) {
	id := NewGroupThreadPostInReplyToAttachmentID("groupIdValue", "conversationThreadIdValue", "postIdValue", "attachmentIdValue")
...
func TestFormatGroupThreadPostInReplyToAttachmentID(t *testing.T) {
	actual := NewGroupThreadPostInReplyToAttachmentID("groupIdValue", "conversationThreadIdValue", "postIdValue", "attachmentIdValue").ID()
...
func TestParseGroupThreadPostInReplyToAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupThreadPostInReplyToAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupThreadPostInReplyToAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupThreadPostInReplyToAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupThreadPostInReplyToAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupThreadPostInReplyToAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupThreadPostInReplyToAttachmentId(t *testing.T) {
	segments := GroupThreadPostInReplyToAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupThreadPostInReplyToAttachmentId has no segments")
	}
