...
func TestNewGroupSiteTermStoreSetTermChildrenRelationID(t *testing.T) {
	id := NewGroupSiteTermStoreSetTermChildrenRelationID("groupIdValue", "siteIdValue", "setIdValue", "termIdValue", "termId1Value", "relationIdValue")
...
func TestFormatGroupSiteTermStoreSetTermChildrenRelationID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetTermChildrenRelationID("groupIdValue", "siteIdValue", "setIdValue", "termIdValue", "termId1Value", "relationIdValue").ID()
