...
func NewGroupSiteTermStoreSetTermChildrenRelationID(groupId string, siteId string, setId string, termId string, termId1 string, relationId string) GroupSiteTermStoreSetTermChildrenRelationId {
