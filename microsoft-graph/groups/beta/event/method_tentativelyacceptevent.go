...
func (c EventClient) TentativelyAcceptEvent(ctx context.Context, id beta.GroupIdEventId, input TentativelyAcceptEventRequest) (result TentativelyAcceptEventOperationResponse, err error) {
