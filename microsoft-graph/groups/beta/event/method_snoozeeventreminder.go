...
// time.
func (c EventClient) SnoozeEventReminder(ctx context.Context, id beta.GroupIdEventId, input SnoozeEventReminderRequest) (result SnoozeEventReminderOperationResponse, err error) {
