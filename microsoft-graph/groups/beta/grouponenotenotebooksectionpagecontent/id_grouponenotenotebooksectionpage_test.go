package grouponenotenotebooksectionpagecontent
...
func TestNewGroupOnenoteNotebookSectionPageID(t *testing.T) {
	id := NewGroupOnenoteNotebookSectionPageID("groupIdValue", "notebookIdValue", "onenoteSectionIdValue", "onenotePageIdValue")
...
func TestFormatGroupOnenoteNotebookSectionPageID(t *testing.T) {
	actual := NewGroupOnenoteNotebookSectionPageID("groupIdValue", "notebookIdValue", "onenoteSectionIdValue", "onenotePageIdValue").ID()
...
func TestParseGroupOnenoteNotebookSectionPageID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupOnenoteNotebookSectionPageId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupOnenoteNotebookSectionPageID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupOnenoteNotebookSectionPageIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupOnenoteNotebookSectionPageId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupOnenoteNotebookSectionPageIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupOnenoteNotebookSectionPageId(t *testing.T) {
	segments := GroupOnenoteNotebookSectionPageId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupOnenoteNotebookSectionPageId has no segments")
	}
