...
func (c PermissionGrantClient) CreatePermissionGrant(ctx context.Context, id GroupId, input beta.ResourceSpecificPermissionGrant) (result CreatePermissionGrantOperationResponse, err error) {
