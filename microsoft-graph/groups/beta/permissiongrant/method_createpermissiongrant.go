...
func (c PermissionGrantClient) CreatePermissionGrant(ctx context.Context, id beta.GroupId, input beta.ResourceSpecificPermissionGrant) (result CreatePermissionGrantOperationResponse, err error) {
