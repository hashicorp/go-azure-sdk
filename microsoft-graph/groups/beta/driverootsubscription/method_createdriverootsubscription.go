...
func (c DriveRootSubscriptionClient) CreateDriveRootSubscription(ctx context.Context, id beta.GroupIdDriveId, input beta.Subscription) (result CreateDriveRootSubscriptionOperationResponse, err error) {
