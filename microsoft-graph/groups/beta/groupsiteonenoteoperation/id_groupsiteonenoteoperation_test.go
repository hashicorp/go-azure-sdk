...
func TestNewGroupSiteOnenoteOperationID(t *testing.T) {
	id := NewGroupSiteOnenoteOperationID("groupIdValue", "siteIdValue", "onenoteOperationIdValue")
...
func TestFormatGroupSiteOnenoteOperationID(t *testing.T) {
	actual := NewGroupSiteOnenoteOperationID("groupIdValue", "siteIdValue", "onenoteOperationIdValue").ID()
...
func TestParseGroupSiteOnenoteOperationID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteOnenoteOperationId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteOnenoteOperationID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteOnenoteOperationIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteOnenoteOperationId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteOnenoteOperationIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteOnenoteOperationId(t *testing.T) {
	segments := GroupSiteOnenoteOperationId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteOnenoteOperationId has no segments")
	}
