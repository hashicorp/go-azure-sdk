...
func (c CalendarCalendarViewInstanceExtensionClient) CreateCalendarViewInstanceExtension(ctx context.Context, id beta.GroupIdCalendarCalendarViewIdInstanceId, input beta.Extension) (result CreateCalendarViewInstanceExtensionOperationResponse, err error) {
