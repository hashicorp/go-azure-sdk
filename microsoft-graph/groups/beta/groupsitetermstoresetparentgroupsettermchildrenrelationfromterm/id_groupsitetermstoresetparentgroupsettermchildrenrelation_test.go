...
func TestNewGroupSiteTermStoreSetParentGroupSetTermChildrenRelationID(t *testing.T) {
	id := NewGroupSiteTermStoreSetParentGroupSetTermChildrenRelationID("groupIdValue", "siteIdValue", "setIdValue", "setId1Value", "termIdValue", "termId1Value", "relationIdValue")
...
func TestFormatGroupSiteTermStoreSetParentGroupSetTermChildrenRelationID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetParentGroupSetTermChildrenRelationID("groupIdValue", "siteIdValue", "setIdValue", "setId1Value", "termIdValue", "termId1Value", "relationIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/terms/termIdValue/children/termId1Value/relations/relationIdValue"
	if actual != expected {
...
func TestParseGroupSiteTermStoreSetParentGroupSetTermChildrenRelationID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/terms/termIdValue/children/termId1Value/relations",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/terms/termIdValue/children/termId1Value/relations/relationIdValue",
			Expected: &GroupSiteTermStoreSetParentGroupSetTermChildrenRelationId{
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/terms/termIdValue/children/termId1Value/relations/relationIdValue/extra",
			Error: true,
		},
	}
