...
func NewGroupSettingID(groupId string, directorySettingId string) GroupSettingId {
...
func ParseGroupSettingID(input string) (*GroupSettingId, error) {
	...
	if id.DirectorySettingId, ok = parsed.Parsed["directorySettingId"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "directorySettingId", *parsed)
	}
...
func (id GroupSettingId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("directorySettingId", "directorySettingIdValue"),
	}
}
