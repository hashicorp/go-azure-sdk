...
func (c EventExceptionOccurrenceInstanceClient) SnoozeEventExceptionOccurrenceInstanceReminder(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, input SnoozeEventExceptionOccurrenceInstanceReminderRequest) (result SnoozeEventExceptionOccurrenceInstanceReminderOperationResponse, err error) {
