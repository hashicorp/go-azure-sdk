...
func (c EventExceptionOccurrenceInstanceClient) ForwardEventExceptionOccurrenceInstance(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId, input ForwardEventExceptionOccurrenceInstanceRequest) (result ForwardEventExceptionOccurrenceInstanceOperationResponse, err error) {
