...
func (c EventExceptionOccurrenceInstanceClient) DismissEventExceptionOccurrenceInstanceReminder(ctx context.Context, id beta.GroupIdEventIdExceptionOccurrenceIdInstanceId) (result DismissEventExceptionOccurrenceInstanceReminderOperationResponse, err error) {
