...
func (c TeamChannelAllMemberClient) GetTeamChannelAllMembersCount(ctx context.Context, id beta.GroupIdTeamChannelId, options GetTeamChannelAllMembersCountOperationOptions) (result GetTeamChannelAllMembersCountOperationResponse, err error) {
