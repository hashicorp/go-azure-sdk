...
func (c TeamChannelAllMemberClient) DeleteTeamChannelAllMember(ctx context.Context, id beta.GroupIdTeamChannelIdAllMemberId, options DeleteTeamChannelAllMemberOperationOptions) (result DeleteTeamChannelAllMemberOperationResponse, err error) {
