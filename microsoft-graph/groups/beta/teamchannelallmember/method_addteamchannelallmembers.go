...
func (c TeamChannelAllMemberClient) AddTeamChannelAllMembers(ctx context.Context, id beta.GroupIdTeamChannelId, input AddTeamChannelAllMembersRequest, options AddTeamChannelAllMembersOperationOptions) (result AddTeamChannelAllMembersOperationResponse, err error) {
...
func (c TeamChannelAllMemberClient) AddTeamChannelAllMembersComplete(ctx context.Context, id beta.GroupIdTeamChannelId, input AddTeamChannelAllMembersRequest, options AddTeamChannelAllMembersOperationOptions) (AddTeamChannelAllMembersCompleteResult, error) {
...
func (c TeamChannelAllMemberClient) AddTeamChannelAllMembersCompleteMatchingPredicate(ctx context.Context, id beta.GroupIdTeamChannelId, input AddTeamChannelAllMembersRequest, options AddTeamChannelAllMembersOperationOptions, predicate ActionResultPartOperationPredicate) (result AddTeamChannelAllMembersCompleteResult, err error) {
