...
func (c TeamTagMemberClient) CreateTeamTagMember(ctx context.Context, id beta.GroupIdTeamTagId, input beta.TeamworkTagMember) (result CreateTeamTagMemberOperationResponse, err error) {
