...
// ListPhotos ...
func (c PhotoClient) ListPhotos(ctx context.Context, id GroupId) (result ListPhotosOperationResponse, err error) {
...
func (c PhotoClient) ListPhotosComplete(ctx context.Context, id GroupId) (ListPhotosCompleteResult, error) {
...
func (c PhotoClient) ListPhotosCompleteMatchingPredicate(ctx context.Context, id GroupId, predicate ProfilePhotoOperationPredicate) (result ListPhotosCompleteResult, err error) {
