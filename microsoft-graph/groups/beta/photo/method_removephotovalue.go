...
func (c PhotoClient) RemovePhotoValue(ctx context.Context, id beta.GroupId, options RemovePhotoValueOperationOptions) (result RemovePhotoValueOperationResponse, err error) {
