...
func (c SitePageLastModifiedByUserServiceProvisioningErrorClient) ListSitePageLastModifiedByUserServiceProvisioningErrors(ctx context.Context, id GroupIdSiteIdPageId) (result ListSitePageLastModifiedByUserServiceProvisioningErrorsOperationResponse, err error) {
...
func (c SitePageLastModifiedByUserServiceProvisioningErrorClient) ListSitePageLastModifiedByUserServiceProvisioningErrorsComplete(ctx context.Context, id GroupIdSiteIdPageId) (ListSitePageLastModifiedByUserServiceProvisioningErrorsCompleteResult, error) {
	return c.ListSitePageLastModifiedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx, id, ServiceProvisioningErrorOperationPredicate{})
}
...
func (c SitePageLastModifiedByUserServiceProvisioningErrorClient) ListSitePageLastModifiedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id GroupIdSiteIdPageId, predicate ServiceProvisioningErrorOperationPredicate) (result ListSitePageLastModifiedByUserServiceProvisioningErrorsCompleteResult, err error) {
	items := make([]beta.ServiceProvisioningError, 0)

	resp, err := c.ListSitePageLastModifiedByUserServiceProvisioningErrors(ctx, id)
	if err != nil {
