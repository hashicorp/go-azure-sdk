...
func (c DriveListItemClient) CreateDriveListItem(ctx context.Context, id beta.GroupIdDriveId, input beta.ListItem) (result CreateDriveListItemOperationResponse, err error) {
