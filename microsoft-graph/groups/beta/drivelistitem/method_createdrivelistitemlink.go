...
func (c DriveListItemClient) CreateDriveListItemLink(ctx context.Context, id beta.GroupIdDriveIdListItemId, input CreateDriveListItemLinkRequest) (result CreateDriveListItemLinkOperationResponse, err error) {
