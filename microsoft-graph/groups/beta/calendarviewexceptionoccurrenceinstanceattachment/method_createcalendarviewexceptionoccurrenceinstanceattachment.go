...
func (c CalendarViewExceptionOccurrenceInstanceAttachmentClient) CreateCalendarViewExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.GroupIdCalendarViewIdExceptionOccurrenceIdInstanceId, input beta.Attachment) (result CreateCalendarViewExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
