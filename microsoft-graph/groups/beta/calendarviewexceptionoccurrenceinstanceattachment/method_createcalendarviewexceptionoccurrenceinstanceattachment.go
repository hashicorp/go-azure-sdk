...
func (c CalendarViewExceptionOccurrenceInstanceAttachmentClient) CreateCalendarViewExceptionOccurrenceInstanceAttachment(ctx context.Context, id GroupIdCalendarViewIdExceptionOccurrenceIdInstanceId, input beta.Attachment) (result CreateCalendarViewExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
