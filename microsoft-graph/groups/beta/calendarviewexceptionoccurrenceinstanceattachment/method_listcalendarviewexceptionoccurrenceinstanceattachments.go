...
func (c CalendarViewExceptionOccurrenceInstanceAttachmentClient) ListCalendarViewExceptionOccurrenceInstanceAttachments(ctx context.Context, id GroupIdCalendarViewIdExceptionOccurrenceIdInstanceId) (result ListCalendarViewExceptionOccurrenceInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceInstanceAttachmentClient) ListCalendarViewExceptionOccurrenceInstanceAttachmentsComplete(ctx context.Context, id GroupIdCalendarViewIdExceptionOccurrenceIdInstanceId) (ListCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarViewExceptionOccurrenceInstanceAttachmentClient) ListCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarViewIdExceptionOccurrenceIdInstanceId, predicate AttachmentOperationPredicate) (result ListCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteResult, err error) {
