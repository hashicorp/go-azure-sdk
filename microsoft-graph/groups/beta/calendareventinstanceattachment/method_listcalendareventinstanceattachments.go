...
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachments(ctx context.Context, id GroupIdCalendarEventIdInstanceId) (result ListCalendarEventInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachmentsComplete(ctx context.Context, id GroupIdCalendarEventIdInstanceId) (ListCalendarEventInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarEventIdInstanceId, predicate AttachmentOperationPredicate) (result ListCalendarEventInstanceAttachmentsCompleteResult, err error) {
