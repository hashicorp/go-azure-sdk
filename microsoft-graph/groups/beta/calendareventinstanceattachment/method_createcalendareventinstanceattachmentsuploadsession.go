...
func (c CalendarEventInstanceAttachmentClient) CreateCalendarEventInstanceAttachmentsUploadSession(ctx context.Context, id beta.GroupIdCalendarEventIdInstanceId, input CreateCalendarEventInstanceAttachmentsUploadSessionRequest) (result CreateCalendarEventInstanceAttachmentsUploadSessionOperationResponse, err error) {
