...
func (c DriveRootListItemVersionClient) CreateDriveRootListItemVersion(ctx context.Context, id beta.GroupIdDriveId, input beta.ListItemVersion) (result CreateDriveRootListItemVersionOperationResponse, err error) {
