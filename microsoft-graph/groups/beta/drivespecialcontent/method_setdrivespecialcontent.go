...
func (c DriveSpecialContentClient) SetDriveSpecialContent(ctx context.Context, id beta.GroupIdDriveIdSpecialId, input []byte) (result SetDriveSpecialContentOperationResponse, err error) {
