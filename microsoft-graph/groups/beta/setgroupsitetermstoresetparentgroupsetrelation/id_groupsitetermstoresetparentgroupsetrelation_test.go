...
func TestNewGroupSiteTermStoreSetParentGroupSetRelationID(t *testing.T) {
	id := NewGroupSiteTermStoreSetParentGroupSetRelationID("groupIdValue", "siteIdValue", "setIdValue", "setId1Value", "relationIdValue")
...
func TestFormatGroupSiteTermStoreSetParentGroupSetRelationID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetParentGroupSetRelationID("groupIdValue", "siteIdValue", "setIdValue", "setId1Value", "relationIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/relations/relationIdValue"
	if actual != expected {
...
func TestParseGroupSiteTermStoreSetParentGroupSetRelationID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/relations",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/relations/relationIdValue",
			Expected: &GroupSiteTermStoreSetParentGroupSetRelationId{
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/parentGroup/sets/setId1Value/relations/relationIdValue/extra",
			Error: true,
		},
	}
