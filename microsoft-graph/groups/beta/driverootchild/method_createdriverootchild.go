...
func (c DriveRootChildClient) CreateDriveRootChild(ctx context.Context, id beta.GroupIdDriveId, input beta.DriveItem) (result CreateDriveRootChildOperationResponse, err error) {
