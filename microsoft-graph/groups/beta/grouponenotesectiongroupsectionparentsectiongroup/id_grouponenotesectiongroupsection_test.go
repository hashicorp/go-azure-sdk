package grouponenotesectiongroupsectionparentsectiongroup
...
func TestNewGroupOnenoteSectionGroupSectionID(t *testing.T) {
	id := NewGroupOnenoteSectionGroupSectionID("groupIdValue", "sectionGroupIdValue", "onenoteSectionIdValue")
...
func TestFormatGroupOnenoteSectionGroupSectionID(t *testing.T) {
	actual := NewGroupOnenoteSectionGroupSectionID("groupIdValue", "sectionGroupIdValue", "onenoteSectionIdValue").ID()
...
func TestParseGroupOnenoteSectionGroupSectionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupOnenoteSectionGroupSectionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupOnenoteSectionGroupSectionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupOnenoteSectionGroupSectionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupOnenoteSectionGroupSectionId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupOnenoteSectionGroupSectionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupOnenoteSectionGroupSectionId(t *testing.T) {
	segments := GroupOnenoteSectionGroupSectionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupOnenoteSectionGroupSectionId has no segments")
	}
