...
func (c CalendarCalendarViewExceptionOccurrenceInstanceExtensionClient) ListCalendarCalendarViewExceptionOccurrenceInstanceExtensions(ctx context.Context, id GroupIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceId) (result ListCalendarCalendarViewExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceInstanceExtensionClient) ListCalendarCalendarViewExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id GroupIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceId) (ListCalendarCalendarViewExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
