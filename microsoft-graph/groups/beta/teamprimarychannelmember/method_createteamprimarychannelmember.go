...
func (c TeamPrimaryChannelMemberClient) CreateTeamPrimaryChannelMember(ctx context.Context, id beta.GroupId, input beta.ConversationMember) (result CreateTeamPrimaryChannelMemberOperationResponse, err error) {
