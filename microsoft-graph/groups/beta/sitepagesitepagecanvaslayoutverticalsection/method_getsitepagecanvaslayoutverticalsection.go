...
func (c SitePageSitePageCanvasLayoutVerticalSectionClient) GetSitePageCanvasLayoutVerticalSection(ctx context.Context, id beta.GroupIdSiteIdPageId, options GetSitePageCanvasLayoutVerticalSectionOperationOptions) (result GetSitePageCanvasLayoutVerticalSectionOperationResponse, err error) {
