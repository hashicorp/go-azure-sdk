...
func (c SitePageSitePageCanvasLayoutVerticalSectionClient) UpdateSitePageCanvasLayoutVerticalSection(ctx context.Context, id beta.GroupIdSiteIdPageId, input beta.VerticalSection, options UpdateSitePageCanvasLayoutVerticalSectionOperationOptions) (result UpdateSitePageCanvasLayoutVerticalSectionOperationResponse, err error) {
