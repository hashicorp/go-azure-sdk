...
func (c TeamScheduleClient) ShareTeamSchedule(ctx context.Context, id beta.GroupId, input ShareTeamScheduleRequest) (result ShareTeamScheduleOperationResponse, err error) {
