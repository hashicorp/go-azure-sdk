...
func (c ConversationThreadClient) CreateConversationThread(ctx context.Context, id stable.GroupIdConversationId, input stable.ConversationThread) (result CreateConversationThreadOperationResponse, err error) {
