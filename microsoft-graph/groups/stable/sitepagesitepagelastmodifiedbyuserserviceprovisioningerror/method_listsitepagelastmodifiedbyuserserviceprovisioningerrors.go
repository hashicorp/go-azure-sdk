...
func (c SitePageSitePageLastModifiedByUserServiceProvisioningErrorClient) ListSitePageLastModifiedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdSiteIdPageId, options ListSitePageLastModifiedByUserServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListSitePageLastModifiedByUserServiceProvisioningErrorsCompleteResult, err error) {
