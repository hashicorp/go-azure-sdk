...
func (c PlannerPlanClient) CreatePlannerPlan(ctx context.Context, id stable.GroupId, input stable.PlannerPlan) (result CreatePlannerPlanOperationResponse, err error) {
