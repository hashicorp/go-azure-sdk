...
func (c CalendarViewExtensionClient) CreateCalendarViewExtension(ctx context.Context, id stable.GroupIdCalendarViewId, input stable.Extension) (result CreateCalendarViewExtensionOperationResponse, err error) {
