...
func (c TeamPermissionGrantClient) ListTeamPermissionGrants(ctx context.Context, id GroupId) (result ListTeamPermissionGrantsOperationResponse, err error) {
...
func (c TeamPermissionGrantClient) ListTeamPermissionGrantsComplete(ctx context.Context, id GroupId) (ListTeamPermissionGrantsCompleteResult, error) {
	return c.ListTeamPermissionGrantsCompleteMatchingPredicate(ctx, id, ResourceSpecificPermissionGrantOperationPredicate{})
}

// ListTeamPermissionGrantsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c TeamPermissionGrantClient) ListTeamPermissionGrantsCompleteMatchingPredicate(ctx context.Context, id GroupId, predicate ResourceSpecificPermissionGrantOperationPredicate) (result ListTeamPermissionGrantsCompleteResult, err error) {
	items := make([]stable.ResourceSpecificPermissionGrant, 0)

	resp, err := c.ListTeamPermissionGrants(ctx, id)
	if err != nil {
