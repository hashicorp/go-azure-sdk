...
// ListTeamTags ...
func (c TeamTagClient) ListTeamTags(ctx context.Context, id GroupId) (result ListTeamTagsOperationResponse, err error) {
...
func (c TeamTagClient) ListTeamTagsComplete(ctx context.Context, id GroupId) (ListTeamTagsCompleteResult, error) {
	return c.ListTeamTagsCompleteMatchingPredicate(ctx, id, TeamworkTagOperationPredicate{})
}

// ListTeamTagsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c TeamTagClient) ListTeamTagsCompleteMatchingPredicate(ctx context.Context, id GroupId, predicate TeamworkTagOperationPredicate) (result ListTeamTagsCompleteResult, err error) {
	items := make([]stable.TeamworkTag, 0)

	resp, err := c.ListTeamTags(ctx, id)
	if err != nil {
