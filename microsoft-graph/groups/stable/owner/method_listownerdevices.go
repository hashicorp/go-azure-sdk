...
func (c OwnerClient) ListOwnerDevices(ctx context.Context, id stable.GroupId, options ListOwnerDevicesOperationOptions) (result ListOwnerDevicesOperationResponse, err error) {
...
func (c OwnerClient) ListOwnerDevicesComplete(ctx context.Context, id stable.GroupId, options ListOwnerDevicesOperationOptions) (ListOwnerDevicesCompleteResult, error) {
...
func (c OwnerClient) ListOwnerDevicesCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListOwnerDevicesOperationOptions, predicate DeviceOperationPredicate) (result ListOwnerDevicesCompleteResult, err error) {
