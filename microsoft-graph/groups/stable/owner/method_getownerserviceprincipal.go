...
func (c OwnerClient) GetOwnerServicePrincipal(ctx context.Context, id stable.GroupIdOwnerId, options GetOwnerServicePrincipalOperationOptions) (result GetOwnerServicePrincipalOperationResponse, err error) {
