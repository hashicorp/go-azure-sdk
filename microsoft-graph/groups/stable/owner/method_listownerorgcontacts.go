...
// collection
func (c OwnerClient) ListOwnerOrgContacts(ctx context.Context, id stable.GroupId, options ListOwnerOrgContactsOperationOptions) (result ListOwnerOrgContactsOperationResponse, err error) {
...
func (c OwnerClient) ListOwnerOrgContactsComplete(ctx context.Context, id stable.GroupId, options ListOwnerOrgContactsOperationOptions) (ListOwnerOrgContactsCompleteResult, error) {
...
func (c OwnerClient) ListOwnerOrgContactsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListOwnerOrgContactsOperationOptions, predicate OrgContactOperationPredicate) (result ListOwnerOrgContactsCompleteResult, err error) {
