...
func (c OwnerClient) ListOwnerGroups(ctx context.Context, id stable.GroupId, options ListOwnerGroupsOperationOptions) (result ListOwnerGroupsOperationResponse, err error) {
...
func (c OwnerClient) ListOwnerGroupsComplete(ctx context.Context, id stable.GroupId, options ListOwnerGroupsOperationOptions) (ListOwnerGroupsCompleteResult, error) {
...
func (c OwnerClient) ListOwnerGroupsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListOwnerGroupsOperationOptions, predicate GroupOperationPredicate) (result ListOwnerGroupsCompleteResult, err error) {
