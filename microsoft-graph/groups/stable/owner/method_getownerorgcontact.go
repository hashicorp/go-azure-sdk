...
func (c OwnerClient) GetOwnerOrgContact(ctx context.Context, id stable.GroupIdOwnerId, options GetOwnerOrgContactOperationOptions) (result GetOwnerOrgContactOperationResponse, err error) {
