...
func (c OwnerClient) GetOwnerServicePrincipalCount(ctx context.Context, id stable.GroupId, options GetOwnerServicePrincipalCountOperationOptions) (result GetOwnerServicePrincipalCountOperationResponse, err error) {
