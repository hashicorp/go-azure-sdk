...
func (c ThreadPostInReplyToClient) ForwardThreadPostInReplyTo(ctx context.Context, id stable.GroupIdThreadIdPostId, input ForwardThreadPostInReplyToRequest) (result ForwardThreadPostInReplyToOperationResponse, err error) {
