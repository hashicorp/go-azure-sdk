...
func (c CalendarPermissionClient) GetCalendarPermissionsCount(ctx context.Context, id stable.GroupId, options GetCalendarPermissionsCountOperationOptions) (result GetCalendarPermissionsCountOperationResponse, err error) {
