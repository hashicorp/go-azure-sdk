...
// shared.
func (c CalendarPermissionClient) GetCalendarPermission(ctx context.Context, id stable.GroupIdCalendarCalendarPermissionId, options GetCalendarPermissionOperationOptions) (result GetCalendarPermissionOperationResponse, err error) {
