...
func (c MembersWithLicenseErrorClient) ListMembersWithLicenseErrorDevices(ctx context.Context, id stable.GroupId, options ListMembersWithLicenseErrorDevicesOperationOptions) (result ListMembersWithLicenseErrorDevicesOperationResponse, err error) {
...
func (c MembersWithLicenseErrorClient) ListMembersWithLicenseErrorDevicesComplete(ctx context.Context, id stable.GroupId, options ListMembersWithLicenseErrorDevicesOperationOptions) (ListMembersWithLicenseErrorDevicesCompleteResult, error) {
...
func (c MembersWithLicenseErrorClient) ListMembersWithLicenseErrorDevicesCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListMembersWithLicenseErrorDevicesOperationOptions, predicate DeviceOperationPredicate) (result ListMembersWithLicenseErrorDevicesCompleteResult, err error) {
