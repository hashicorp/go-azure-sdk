...
func (c TeamChannelMemberClient) CreateTeamChannelMember(ctx context.Context, id stable.GroupIdTeamChannelId, input stable.ConversationMember) (result CreateTeamChannelMemberOperationResponse, err error) {
