...
func (c SiteAnalyticItemActivityStatClient) CreateSiteAnalyticItemActivityStat(ctx context.Context, id GroupIdSiteId, input stable.ItemActivityStat) (result CreateSiteAnalyticItemActivityStatOperationResponse, err error) {
