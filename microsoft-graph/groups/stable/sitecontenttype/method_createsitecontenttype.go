...
func (c SiteContentTypeClient) CreateSiteContentType(ctx context.Context, id stable.GroupIdSiteId, input stable.ContentType) (result CreateSiteContentTypeOperationResponse, err error) {
