...
func (c SiteContentTypeClient) CreateSiteContentType(ctx context.Context, id GroupIdSiteId, input stable.ContentType) (result CreateSiteContentTypeOperationResponse, err error) {
