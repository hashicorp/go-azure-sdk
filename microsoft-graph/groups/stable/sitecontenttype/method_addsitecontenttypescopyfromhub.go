...
// Updates – August 2021.
func (c SiteContentTypeClient) AddSiteContentTypesCopyFromHub(ctx context.Context, id stable.GroupIdSiteId, input AddSiteContentTypesCopyFromHubRequest) (result AddSiteContentTypesCopyFromHubOperationResponse, err error) {
