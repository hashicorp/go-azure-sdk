...
func (c SiteColumnClient) CreateSiteColumn(ctx context.Context, id stable.GroupIdSiteId, input stable.ColumnDefinition) (result CreateSiteColumnOperationResponse, err error) {
