...
func (c PlannerPlanTaskClient) CreatePlannerPlanTask(ctx context.Context, id stable.GroupIdPlannerPlanId, input stable.PlannerTask) (result CreatePlannerPlanTaskOperationResponse, err error) {
