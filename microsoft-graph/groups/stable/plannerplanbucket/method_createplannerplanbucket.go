...
func (c PlannerPlanBucketClient) CreatePlannerPlanBucket(ctx context.Context, id stable.GroupIdPlannerPlanId, input stable.PlannerBucket) (result CreatePlannerPlanBucketOperationResponse, err error) {
