...
func (c TeamPrimaryChannelAllMemberClient) CreateTeamPrimaryChannelAllMember(ctx context.Context, id stable.GroupId, input stable.ConversationMember, options CreateTeamPrimaryChannelAllMemberOperationOptions) (result CreateTeamPrimaryChannelAllMemberOperationResponse, err error) {
