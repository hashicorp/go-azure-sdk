...
func (c TeamPrimaryChannelAllMemberClient) DeleteTeamPrimaryChannelAllMember(ctx context.Context, id stable.GroupIdTeamPrimaryChannelAllMemberId, options DeleteTeamPrimaryChannelAllMemberOperationOptions) (result DeleteTeamPrimaryChannelAllMemberOperationResponse, err error) {
