...
func (c TeamPrimaryChannelAllMemberClient) AddTeamPrimaryChannelAllMembers(ctx context.Context, id stable.GroupId, input AddTeamPrimaryChannelAllMembersRequest, options AddTeamPrimaryChannelAllMembersOperationOptions) (result AddTeamPrimaryChannelAllMembersOperationResponse, err error) {
...
func (c TeamPrimaryChannelAllMemberClient) AddTeamPrimaryChannelAllMembersComplete(ctx context.Context, id stable.GroupId, input AddTeamPrimaryChannelAllMembersRequest, options AddTeamPrimaryChannelAllMembersOperationOptions) (AddTeamPrimaryChannelAllMembersCompleteResult, error) {
...
func (c TeamPrimaryChannelAllMemberClient) AddTeamPrimaryChannelAllMembersCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, input AddTeamPrimaryChannelAllMembersRequest, options AddTeamPrimaryChannelAllMembersOperationOptions, predicate ActionResultPartOperationPredicate) (result AddTeamPrimaryChannelAllMembersCompleteResult, err error) {
