...
func (c TeamPrimaryChannelAllMemberClient) RemoveTeamPrimaryChannelAllMembers(ctx context.Context, id stable.GroupId, input RemoveTeamPrimaryChannelAllMembersRequest, options RemoveTeamPrimaryChannelAllMembersOperationOptions) (result RemoveTeamPrimaryChannelAllMembersOperationResponse, err error) {
...
func (c TeamPrimaryChannelAllMemberClient) RemoveTeamPrimaryChannelAllMembersComplete(ctx context.Context, id stable.GroupId, input RemoveTeamPrimaryChannelAllMembersRequest, options RemoveTeamPrimaryChannelAllMembersOperationOptions) (RemoveTeamPrimaryChannelAllMembersCompleteResult, error) {
...
func (c TeamPrimaryChannelAllMemberClient) RemoveTeamPrimaryChannelAllMembersCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, input RemoveTeamPrimaryChannelAllMembersRequest, options RemoveTeamPrimaryChannelAllMembersOperationOptions, predicate ActionResultPartOperationPredicate) (result RemoveTeamPrimaryChannelAllMembersCompleteResult, err error) {
