...
func (c DriveItemCreatedByUserMailboxSettingClient) UpdateDriveItemCreatedByUserMailboxSetting(ctx context.Context, id stable.GroupIdDriveIdItemId, input stable.MailboxSettings) (result UpdateDriveItemCreatedByUserMailboxSettingOperationResponse, err error) {
