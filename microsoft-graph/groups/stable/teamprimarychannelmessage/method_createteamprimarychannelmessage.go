...
func (c TeamPrimaryChannelMessageClient) CreateTeamPrimaryChannelMessage(ctx context.Context, id stable.GroupId, input stable.ChatMessage) (result CreateTeamPrimaryChannelMessageOperationResponse, err error) {
