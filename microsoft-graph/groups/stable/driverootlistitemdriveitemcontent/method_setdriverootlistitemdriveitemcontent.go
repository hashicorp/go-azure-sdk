...
func (c DriveRootListItemDriveItemContentClient) SetDriveRootListItemDriveItemContent(ctx context.Context, id stable.GroupIdDriveId, input []byte) (result SetDriveRootListItemDriveItemContentOperationResponse, err error) {
