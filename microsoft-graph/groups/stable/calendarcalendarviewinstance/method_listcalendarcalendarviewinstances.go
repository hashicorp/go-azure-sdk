...
func (c CalendarCalendarViewInstanceClient) ListCalendarCalendarViewInstances(ctx context.Context, id GroupIdCalendarCalendarViewId) (result ListCalendarCalendarViewInstancesOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceClient) ListCalendarCalendarViewInstancesComplete(ctx context.Context, id GroupIdCalendarCalendarViewId) (ListCalendarCalendarViewInstancesCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceClient) ListCalendarCalendarViewInstancesCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarCalendarViewId, predicate EventOperationPredicate) (result ListCalendarCalendarViewInstancesCompleteResult, err error) {
