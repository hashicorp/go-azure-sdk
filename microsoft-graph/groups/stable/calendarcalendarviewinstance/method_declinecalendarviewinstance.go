...
func (c CalendarCalendarViewInstanceClient) DeclineCalendarViewInstance(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceId, input DeclineCalendarViewInstanceRequest) (result DeclineCalendarViewInstanceOperationResponse, err error) {
