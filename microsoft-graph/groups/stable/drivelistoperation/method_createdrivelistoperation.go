...
func (c DriveListOperationClient) CreateDriveListOperation(ctx context.Context, id stable.GroupIdDriveId, input stable.RichLongRunningOperation) (result CreateDriveListOperationOperationResponse, err error) {
