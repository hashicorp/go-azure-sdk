...
func (c TeamScheduleDayNoteClient) UpdateTeamScheduleDayNote(ctx context.Context, id stable.GroupIdTeamScheduleDayNoteId, input stable.DayNote, options UpdateTeamScheduleDayNoteOperationOptions) (result UpdateTeamScheduleDayNoteOperationResponse, err error) {
