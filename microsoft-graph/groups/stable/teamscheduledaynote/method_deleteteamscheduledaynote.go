...
func (c TeamScheduleDayNoteClient) DeleteTeamScheduleDayNote(ctx context.Context, id stable.GroupIdTeamScheduleDayNoteId, options DeleteTeamScheduleDayNoteOperationOptions) (result DeleteTeamScheduleDayNoteOperationResponse, err error) {
