...
// represents a file.
func (c DriveBundleContentClient) SetDriveBundleContent(ctx context.Context, id stable.GroupIdDriveIdBundleId, input []byte) (result SetDriveBundleContentOperationResponse, err error) {
