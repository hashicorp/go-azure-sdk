...
func (c MemberOfClient) GetMemberOfAdministrativeUnit(ctx context.Context, id stable.GroupIdMemberOfId, options GetMemberOfAdministrativeUnitOperationOptions) (result GetMemberOfAdministrativeUnitOperationResponse, err error) {
