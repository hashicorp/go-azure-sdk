...
// GetMemberOfGroup - List memberOf. Get groups that the group is a direct member of. This operation is not transitive.
// Unlike getting a user's Microsoft 365 groups, this returns all types of groups, not just Microsoft 365 groups.
func (c MemberOfClient) GetMemberOfGroup(ctx context.Context, id stable.GroupIdMemberOfId, options GetMemberOfGroupOperationOptions) (result GetMemberOfGroupOperationResponse, err error) {
