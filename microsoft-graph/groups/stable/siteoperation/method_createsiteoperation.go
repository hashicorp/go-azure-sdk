...
// CreateSiteOperation ...
func (c SiteOperationClient) CreateSiteOperation(ctx context.Context, id GroupIdSiteId, input stable.RichLongRunningOperation) (result CreateSiteOperationOperationResponse, err error) {
