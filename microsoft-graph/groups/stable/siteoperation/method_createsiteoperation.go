...
func (c SiteOperationClient) CreateSiteOperation(ctx context.Context, id stable.GroupIdSiteId, input stable.RichLongRunningOperation) (result CreateSiteOperationOperationResponse, err error) {
