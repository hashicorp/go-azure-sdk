...
func (c TeamPrimaryChannelSharedWithTeamClient) CreateTeamPrimaryChannelSharedWithTeam(ctx context.Context, id GroupId, input stable.SharedWithChannelTeamInfo) (result CreateTeamPrimaryChannelSharedWithTeamOperationResponse, err error) {
