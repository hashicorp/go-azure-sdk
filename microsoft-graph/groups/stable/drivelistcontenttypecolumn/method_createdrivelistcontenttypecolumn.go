...
func (c DriveListContentTypeColumnClient) CreateDriveListContentTypeColumn(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, input stable.ColumnDefinition) (result CreateDriveListContentTypeColumnOperationResponse, err error) {
