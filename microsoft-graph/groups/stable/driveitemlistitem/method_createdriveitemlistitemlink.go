...
func (c DriveItemListItemClient) CreateDriveItemListItemLink(ctx context.Context, id stable.GroupIdDriveIdItemId, input CreateDriveItemListItemLinkRequest) (result CreateDriveItemListItemLinkOperationResponse, err error) {
