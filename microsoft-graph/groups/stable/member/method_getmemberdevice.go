...
func (c MemberClient) GetMemberDevice(ctx context.Context, id stable.GroupIdMemberId, options GetMemberDeviceOperationOptions) (result GetMemberDeviceOperationResponse, err error) {
