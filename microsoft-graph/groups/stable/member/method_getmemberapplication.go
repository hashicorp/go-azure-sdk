...
func (c MemberClient) GetMemberApplication(ctx context.Context, id stable.GroupIdMemberId, options GetMemberApplicationOperationOptions) (result GetMemberApplicationOperationResponse, err error) {
