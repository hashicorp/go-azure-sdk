...
func (c MemberClient) GetMemberDeviceCount(ctx context.Context, id stable.GroupId, options GetMemberDeviceCountOperationOptions) (result GetMemberDeviceCountOperationResponse, err error) {
