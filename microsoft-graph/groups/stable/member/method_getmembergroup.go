...
func (c MemberClient) GetMemberGroup(ctx context.Context, id stable.GroupIdMemberId, options GetMemberGroupOperationOptions) (result GetMemberGroupOperationResponse, err error) {
