...
func (c MemberClient) GetMemberServicePrincipal(ctx context.Context, id stable.GroupIdMemberId, options GetMemberServicePrincipalOperationOptions) (result GetMemberServicePrincipalOperationResponse, err error) {
