...
// ListMemberUsers - List group members. Get a list of the group's direct members. A group can have users,
// organizational contacts, devices, service principals and other groups as members. This operation is not transitive.
func (c MemberClient) ListMemberUsers(ctx context.Context, id stable.GroupId, options ListMemberUsersOperationOptions) (result ListMemberUsersOperationResponse, err error) {
...
func (c MemberClient) ListMemberUsersComplete(ctx context.Context, id stable.GroupId, options ListMemberUsersOperationOptions) (ListMemberUsersCompleteResult, error) {
...
func (c MemberClient) ListMemberUsersCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListMemberUsersOperationOptions, predicate UserOperationPredicate) (result ListMemberUsersCompleteResult, err error) {
