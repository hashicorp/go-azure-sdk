...
func (c EventInstanceAttachmentClient) CreateEventInstanceAttachmentsUploadSession(ctx context.Context, id stable.GroupIdEventIdInstanceId, input CreateEventInstanceAttachmentsUploadSessionRequest) (result CreateEventInstanceAttachmentsUploadSessionOperationResponse, err error) {
