...
func (c EventInstanceAttachmentClient) ListEventInstanceAttachments(ctx context.Context, id GroupIdEventIdInstanceId) (result ListEventInstanceAttachmentsOperationResponse, err error) {
...
func (c EventInstanceAttachmentClient) ListEventInstanceAttachmentsComplete(ctx context.Context, id GroupIdEventIdInstanceId) (ListEventInstanceAttachmentsCompleteResult, error) {
...
func (c EventInstanceAttachmentClient) ListEventInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id GroupIdEventIdInstanceId, predicate AttachmentOperationPredicate) (result ListEventInstanceAttachmentsCompleteResult, err error) {
