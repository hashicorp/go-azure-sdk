...
func (c TeamScheduleTimeCardClient) GetTeamScheduleTimeCardsCount(ctx context.Context, id stable.GroupId, options GetTeamScheduleTimeCardsCountOperationOptions) (result GetTeamScheduleTimeCardsCountOperationResponse, err error) {
