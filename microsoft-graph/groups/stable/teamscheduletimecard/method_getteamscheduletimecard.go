...
func (c TeamScheduleTimeCardClient) GetTeamScheduleTimeCard(ctx context.Context, id stable.GroupIdTeamScheduleTimeCardId, options GetTeamScheduleTimeCardOperationOptions) (result GetTeamScheduleTimeCardOperationResponse, err error) {
