...
func (c TeamScheduleTimeCardClient) UpdateTeamScheduleTimeCard(ctx context.Context, id stable.GroupIdTeamScheduleTimeCardId, input stable.TimeCard, options UpdateTeamScheduleTimeCardOperationOptions) (result UpdateTeamScheduleTimeCardOperationResponse, err error) {
