...
func (c DriveRootVersionContentClient) SetDriveRootVersionContent(ctx context.Context, id stable.GroupIdDriveIdRootVersionId, input []byte) (result SetDriveRootVersionContentOperationResponse, err error) {
