...
func (c SitePermissionClient) CreateSitePermission(ctx context.Context, id stable.GroupIdSiteId, input stable.Permission) (result CreateSitePermissionOperationResponse, err error) {
