...
func (c SitePermissionClient) CreateSitePermission(ctx context.Context, id GroupIdSiteId, input stable.Permission) (result CreateSitePermissionOperationResponse, err error) {
