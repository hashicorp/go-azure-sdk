...
// ListAcceptedSenders ...
func (c AcceptedSenderClient) ListAcceptedSenders(ctx context.Context, id GroupId) (result ListAcceptedSendersOperationResponse, err error) {
...
func (c AcceptedSenderClient) ListAcceptedSendersComplete(ctx context.Context, id GroupId) (ListAcceptedSendersCompleteResult, error) {
	return c.ListAcceptedSendersCompleteMatchingPredicate(ctx, id, DirectoryObjectOperationPredicate{})
}

// ListAcceptedSendersCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AcceptedSenderClient) ListAcceptedSendersCompleteMatchingPredicate(ctx context.Context, id GroupId, predicate DirectoryObjectOperationPredicate) (result ListAcceptedSendersCompleteResult, err error) {
	items := make([]stable.DirectoryObject, 0)

	resp, err := c.ListAcceptedSenders(ctx, id)
	if err != nil {
