...
func (c SitePageSitePageWebPartClient) GetSitePageWebPart(ctx context.Context, id stable.GroupIdSiteIdPageIdSitePageWebPartId, options GetSitePageWebPartOperationOptions) (result GetSitePageWebPartOperationResponse, err error) {
