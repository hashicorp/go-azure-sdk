...
func (c SiteListItemDocumentSetVersionClient) CreateSiteListItemDocumentSetVersion(ctx context.Context, id stable.GroupIdSiteIdListIdItemId, input stable.DocumentSetVersion) (result CreateSiteListItemDocumentSetVersionOperationResponse, err error) {
