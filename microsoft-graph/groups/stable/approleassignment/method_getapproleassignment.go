...
func (c AppRoleAssignmentClient) GetAppRoleAssignment(ctx context.Context, id GroupIdAppRoleAssignmentId) (result GetAppRoleAssignmentOperationResponse, err error) {
