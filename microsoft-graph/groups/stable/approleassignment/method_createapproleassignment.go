...
func (c AppRoleAssignmentClient) CreateAppRoleAssignment(ctx context.Context, id GroupId, input stable.AppRoleAssignment) (result CreateAppRoleAssignmentOperationResponse, err error) {
