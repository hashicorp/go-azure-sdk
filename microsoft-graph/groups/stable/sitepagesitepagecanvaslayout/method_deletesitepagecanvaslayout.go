...
func (c SitePageSitePageCanvasLayoutClient) DeleteSitePageCanvasLayout(ctx context.Context, id stable.GroupIdSiteIdPageId, options DeleteSitePageCanvasLayoutOperationOptions) (result DeleteSitePageCanvasLayoutOperationResponse, err error) {
