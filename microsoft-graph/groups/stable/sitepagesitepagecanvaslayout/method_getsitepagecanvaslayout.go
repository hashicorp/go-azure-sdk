...
func (c SitePageSitePageCanvasLayoutClient) GetSitePageCanvasLayout(ctx context.Context, id stable.GroupIdSiteIdPageId, options GetSitePageCanvasLayoutOperationOptions) (result GetSitePageCanvasLayoutOperationResponse, err error) {
