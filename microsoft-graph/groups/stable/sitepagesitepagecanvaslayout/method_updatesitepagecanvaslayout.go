...
func (c SitePageSitePageCanvasLayoutClient) UpdateSitePageCanvasLayout(ctx context.Context, id stable.GroupIdSiteIdPageId, input stable.CanvasLayout, options UpdateSitePageCanvasLayoutOperationOptions) (result UpdateSitePageCanvasLayoutOperationResponse, err error) {
