...
// the SharePoint page.
func (c SitePageSitePageCanvasLayoutHorizontalSectionClient) GetSitePageCanvasLayoutHorizontalSection(ctx context.Context, id stable.GroupIdSiteIdPageIdSitePageCanvasLayoutHorizontalSectionId, options GetSitePageCanvasLayoutHorizontalSectionOperationOptions) (result GetSitePageCanvasLayoutHorizontalSectionOperationResponse, err error) {
