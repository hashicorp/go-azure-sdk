...
func (c SitePageSitePageCanvasLayoutHorizontalSectionClient) CreateSitePageCanvasLayoutHorizontalSection(ctx context.Context, id stable.GroupIdSiteIdPageId, input stable.HorizontalSection, options CreateSitePageCanvasLayoutHorizontalSectionOperationOptions) (result CreateSitePageCanvasLayoutHorizontalSectionOperationResponse, err error) {
	...
	var model stable.HorizontalSection
	result.Model = &model
