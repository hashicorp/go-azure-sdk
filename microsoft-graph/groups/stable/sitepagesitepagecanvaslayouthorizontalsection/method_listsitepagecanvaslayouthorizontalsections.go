...
// the SharePoint page.
func (c SitePageSitePageCanvasLayoutHorizontalSectionClient) ListSitePageCanvasLayoutHorizontalSections(ctx context.Context, id stable.GroupIdSiteIdPageId, options ListSitePageCanvasLayoutHorizontalSectionsOperationOptions) (result ListSitePageCanvasLayoutHorizontalSectionsOperationResponse, err error) {
	...
	var values struct {
		Values *[]stable.HorizontalSection `json:"value"`
	}
...
func (c SitePageSitePageCanvasLayoutHorizontalSectionClient) ListSitePageCanvasLayoutHorizontalSectionsComplete(ctx context.Context, id stable.GroupIdSiteIdPageId, options ListSitePageCanvasLayoutHorizontalSectionsOperationOptions) (ListSitePageCanvasLayoutHorizontalSectionsCompleteResult, error) {
