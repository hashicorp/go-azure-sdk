...
func (c DriveItemSubscriptionClient) CreateDriveItemSubscriptionReauthorize(ctx context.Context, id stable.GroupIdDriveIdItemIdSubscriptionId) (result CreateDriveItemSubscriptionReauthorizeOperationResponse, err error) {
