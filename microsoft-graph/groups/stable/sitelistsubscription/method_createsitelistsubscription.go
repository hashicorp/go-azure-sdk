...
func (c SiteListSubscriptionClient) CreateSiteListSubscription(ctx context.Context, id stable.GroupIdSiteIdListId, input stable.Subscription) (result CreateSiteListSubscriptionOperationResponse, err error) {
