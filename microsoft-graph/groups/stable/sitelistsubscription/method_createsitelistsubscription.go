...
func (c SiteListSubscriptionClient) CreateSiteListSubscription(ctx context.Context, id GroupIdSiteIdListId, input stable.Subscription) (result CreateSiteListSubscriptionOperationResponse, err error) {
