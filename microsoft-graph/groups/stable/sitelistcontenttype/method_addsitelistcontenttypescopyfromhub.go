...
func (c SiteListContentTypeClient) AddSiteListContentTypesCopyFromHub(ctx context.Context, id stable.GroupIdSiteIdListId, input AddSiteListContentTypesCopyFromHubRequest) (result AddSiteListContentTypesCopyFromHubOperationResponse, err error) {
