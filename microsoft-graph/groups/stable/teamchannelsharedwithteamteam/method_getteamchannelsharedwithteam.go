...
// GetTeamChannelSharedWithTeam - Get team from groups
func (c TeamChannelSharedWithTeamTeamClient) GetTeamChannelSharedWithTeam(ctx context.Context, id stable.GroupIdTeamChannelIdSharedWithTeamId, options GetTeamChannelSharedWithTeamOperationOptions) (result GetTeamChannelSharedWithTeamOperationResponse, err error) {
