...
// Outlook.com account.
func (c CalendarEventInstanceClient) ForwardCalendarEventInstance(ctx context.Context, id stable.GroupIdCalendarEventIdInstanceId, input ForwardCalendarEventInstanceRequest) (result ForwardCalendarEventInstanceOperationResponse, err error) {
