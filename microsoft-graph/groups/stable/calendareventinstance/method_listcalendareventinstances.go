...
func (c CalendarEventInstanceClient) ListCalendarEventInstances(ctx context.Context, id GroupIdCalendarEventId) (result ListCalendarEventInstancesOperationResponse, err error) {
...
func (c CalendarEventInstanceClient) ListCalendarEventInstancesComplete(ctx context.Context, id GroupIdCalendarEventId) (ListCalendarEventInstancesCompleteResult, error) {
...
func (c CalendarEventInstanceClient) ListCalendarEventInstancesCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarEventId, predicate EventOperationPredicate) (result ListCalendarEventInstancesCompleteResult, err error) {
