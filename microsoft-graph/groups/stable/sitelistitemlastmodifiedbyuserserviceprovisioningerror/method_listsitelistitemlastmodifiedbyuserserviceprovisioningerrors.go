...
// ListSiteListItemLastModifiedByUserServiceProvisioningErrors ...
func (c SiteListItemLastModifiedByUserServiceProvisioningErrorClient) ListSiteListItemLastModifiedByUserServiceProvisioningErrors(ctx context.Context, id GroupIdSiteIdListIdItemId) (result ListSiteListItemLastModifiedByUserServiceProvisioningErrorsOperationResponse, err error) {
...
func (c SiteListItemLastModifiedByUserServiceProvisioningErrorClient) ListSiteListItemLastModifiedByUserServiceProvisioningErrorsComplete(ctx context.Context, id GroupIdSiteIdListIdItemId) (ListSiteListItemLastModifiedByUserServiceProvisioningErrorsCompleteResult, error) {
	return c.ListSiteListItemLastModifiedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx, id, ServiceProvisioningErrorOperationPredicate{})
}
...
func (c SiteListItemLastModifiedByUserServiceProvisioningErrorClient) ListSiteListItemLastModifiedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id GroupIdSiteIdListIdItemId, predicate ServiceProvisioningErrorOperationPredicate) (result ListSiteListItemLastModifiedByUserServiceProvisioningErrorsCompleteResult, err error) {
	items := make([]stable.ServiceProvisioningError, 0)

	resp, err := c.ListSiteListItemLastModifiedByUserServiceProvisioningErrors(ctx, id)
	if err != nil {
