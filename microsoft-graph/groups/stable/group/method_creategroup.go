...
// CreateGroup - Create group. Create a new group as specified in the request body. You can create the following types
// of groups: This operation returns by default only a subset of the properties for each group. These default properties
// are noted in the Properties section. To get properties that are not returned by default, do a GET operation and
// specify the properties in a $select OData query option.
