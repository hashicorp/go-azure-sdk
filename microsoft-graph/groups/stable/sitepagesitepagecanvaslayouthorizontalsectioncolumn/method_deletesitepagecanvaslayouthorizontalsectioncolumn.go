...
func (c SitePageSitePageCanvasLayoutHorizontalSectionColumnClient) DeleteSitePageCanvasLayoutHorizontalSectionColumn(ctx context.Context, id stable.GroupIdSiteIdPageIdSitePageCanvasLayoutHorizontalSectionIdColumnId, options DeleteSitePageCanvasLayoutHorizontalSectionColumnOperationOptions) (result DeleteSitePageCanvasLayoutHorizontalSectionColumnOperationResponse, err error) {
