...
// CreateEventPermanentDelete - Invoke action permanentDelete
func (c EventClient) CreateEventPermanentDelete(ctx context.Context, id stable.GroupIdEventId, options CreateEventPermanentDeleteOperationOptions) (result CreateEventPermanentDeleteOperationResponse, err error) {
