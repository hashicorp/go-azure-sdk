...
func (c EventClient) TentativelyAcceptEvent(ctx context.Context, id stable.GroupIdEventId, input TentativelyAcceptEventRequest) (result TentativelyAcceptEventOperationResponse, err error) {
