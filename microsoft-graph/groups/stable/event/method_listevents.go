...
// ListEvents ...
func (c EventClient) ListEvents(ctx context.Context, id GroupId) (result ListEventsOperationResponse, err error) {
...
func (c EventClient) ListEventsComplete(ctx context.Context, id GroupId) (ListEventsCompleteResult, error) {
...
func (c EventClient) ListEventsCompleteMatchingPredicate(ctx context.Context, id GroupId, predicate EventOperationPredicate) (result ListEventsCompleteResult, err error) {
