...
// time.
func (c EventClient) SnoozeEventReminder(ctx context.Context, id stable.GroupIdEventId, input SnoozeEventReminderRequest) (result SnoozeEventReminderOperationResponse, err error) {
