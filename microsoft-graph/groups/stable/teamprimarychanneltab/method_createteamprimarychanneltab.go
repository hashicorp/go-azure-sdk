...
func (c TeamPrimaryChannelTabClient) CreateTeamPrimaryChannelTab(ctx context.Context, id stable.GroupId, input stable.TeamsTab) (result CreateTeamPrimaryChannelTabOperationResponse, err error) {
