...
func (c TeamChannelClient) RemoveTeamChannelEmail(ctx context.Context, id stable.GroupIdTeamChannelId) (result RemoveTeamChannelEmailOperationResponse, err error) {
