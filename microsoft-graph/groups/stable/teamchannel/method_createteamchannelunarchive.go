...
func (c TeamChannelClient) CreateTeamChannelUnarchive(ctx context.Context, id stable.GroupIdTeamChannelId) (result CreateTeamChannelUnarchiveOperationResponse, err error) {
