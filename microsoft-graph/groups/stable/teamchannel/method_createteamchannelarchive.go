...
func (c TeamChannelClient) CreateTeamChannelArchive(ctx context.Context, id stable.GroupIdTeamChannelId, input CreateTeamChannelArchiveRequest) (result CreateTeamChannelArchiveOperationResponse, err error) {
