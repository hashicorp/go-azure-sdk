...
func (c DriveItemListItemDocumentSetVersionClient) CreateDriveItemListItemDocumentSetVersion(ctx context.Context, id stable.GroupIdDriveIdItemId, input stable.DocumentSetVersion) (result CreateDriveItemListItemDocumentSetVersionOperationResponse, err error) {
