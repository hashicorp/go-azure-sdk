...
## `github.com/hashicorp/go-azure-sdk/microsoft-graph/groups/stable/onenotenotebooksection` Documentation

The `onenotenotebooksection` SDK allows for interaction with Microsoft Graph `groups` (API Version `stable`).
...
```go
import "github.com/hashicorp/go-azure-sdk/microsoft-graph/groups/stable/onenotenotebooksection"
```
