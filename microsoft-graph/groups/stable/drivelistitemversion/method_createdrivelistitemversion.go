...
func (c DriveListItemVersionClient) CreateDriveListItemVersion(ctx context.Context, id stable.GroupIdDriveIdListItemId, input stable.ListItemVersion) (result CreateDriveListItemVersionOperationResponse, err error) {
