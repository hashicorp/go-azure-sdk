...
func (c CalendarViewAttachmentClient) ListCalendarViewAttachments(ctx context.Context, id GroupIdCalendarViewId) (result ListCalendarViewAttachmentsOperationResponse, err error) {
...
func (c CalendarViewAttachmentClient) ListCalendarViewAttachmentsComplete(ctx context.Context, id GroupIdCalendarViewId) (ListCalendarViewAttachmentsCompleteResult, error) {
...
func (c CalendarViewAttachmentClient) ListCalendarViewAttachmentsCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarViewId, predicate AttachmentOperationPredicate) (result ListCalendarViewAttachmentsCompleteResult, err error) {
