...
func (c CalendarViewAttachmentClient) CreateCalendarViewAttachment(ctx context.Context, id stable.GroupIdCalendarViewId, input stable.Attachment) (result CreateCalendarViewAttachmentOperationResponse, err error) {
