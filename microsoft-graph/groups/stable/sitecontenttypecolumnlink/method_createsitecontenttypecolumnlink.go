...
func (c SiteContentTypeColumnLinkClient) CreateSiteContentTypeColumnLink(ctx context.Context, id stable.GroupIdSiteIdContentTypeId, input stable.ColumnLink) (result CreateSiteContentTypeColumnLinkOperationResponse, err error) {
