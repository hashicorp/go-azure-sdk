...
// ListTransitiveMemberGroups - List group transitive members. Get a list of the group's members. A group can have
...
func (c TransitiveMemberClient) ListTransitiveMemberGroups(ctx context.Context, id stable.GroupId, options ListTransitiveMemberGroupsOperationOptions) (result ListTransitiveMemberGroupsOperationResponse, err error) {
...
func (c TransitiveMemberClient) ListTransitiveMemberGroupsComplete(ctx context.Context, id stable.GroupId, options ListTransitiveMemberGroupsOperationOptions) (ListTransitiveMemberGroupsCompleteResult, error) {
...
func (c TransitiveMemberClient) ListTransitiveMemberGroupsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListTransitiveMemberGroupsOperationOptions, predicate GroupOperationPredicate) (result ListTransitiveMemberGroupsCompleteResult, err error) {
