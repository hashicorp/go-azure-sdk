...
func (c TransitiveMemberClient) GetTransitiveMemberGroupCount(ctx context.Context, id stable.GroupId, options GetTransitiveMemberGroupCountOperationOptions) (result GetTransitiveMemberGroupCountOperationResponse, err error) {
