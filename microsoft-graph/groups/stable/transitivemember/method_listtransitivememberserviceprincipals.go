...
func (c TransitiveMemberClient) ListTransitiveMemberServicePrincipals(ctx context.Context, id stable.GroupId, options ListTransitiveMemberServicePrincipalsOperationOptions) (result ListTransitiveMemberServicePrincipalsOperationResponse, err error) {
...
func (c TransitiveMemberClient) ListTransitiveMemberServicePrincipalsComplete(ctx context.Context, id stable.GroupId, options ListTransitiveMemberServicePrincipalsOperationOptions) (ListTransitiveMemberServicePrincipalsCompleteResult, error) {
...
func (c TransitiveMemberClient) ListTransitiveMemberServicePrincipalsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListTransitiveMemberServicePrincipalsOperationOptions, predicate ServicePrincipalOperationPredicate) (result ListTransitiveMemberServicePrincipalsCompleteResult, err error) {
