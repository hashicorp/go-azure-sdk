...
func (c TransitiveMemberClient) ListTransitiveMemberOrgContacts(ctx context.Context, id stable.GroupId, options ListTransitiveMemberOrgContactsOperationOptions) (result ListTransitiveMemberOrgContactsOperationResponse, err error) {
...
func (c TransitiveMemberClient) ListTransitiveMemberOrgContactsComplete(ctx context.Context, id stable.GroupId, options ListTransitiveMemberOrgContactsOperationOptions) (ListTransitiveMemberOrgContactsCompleteResult, error) {
...
func (c TransitiveMemberClient) ListTransitiveMemberOrgContactsCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListTransitiveMemberOrgContactsOperationOptions, predicate OrgContactOperationPredicate) (result ListTransitiveMemberOrgContactsCompleteResult, err error) {
