...
func (c TransitiveMemberClient) GetTransitiveMemberApplicationCount(ctx context.Context, id stable.GroupId, options GetTransitiveMemberApplicationCountOperationOptions) (result GetTransitiveMemberApplicationCountOperationResponse, err error) {
