...
func (c TransitiveMemberClient) GetTransitiveMemberDeviceCount(ctx context.Context, id stable.GroupId, options GetTransitiveMemberDeviceCountOperationOptions) (result GetTransitiveMemberDeviceCountOperationResponse, err error) {
