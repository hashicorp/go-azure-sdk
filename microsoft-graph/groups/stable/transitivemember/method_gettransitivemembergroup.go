...
// GetTransitiveMemberGroup - List group transitive members. Get a list of the group's members. A group can have
...
func (c TransitiveMemberClient) GetTransitiveMemberGroup(ctx context.Context, id stable.GroupIdTransitiveMemberId, options GetTransitiveMemberGroupOperationOptions) (result GetTransitiveMemberGroupOperationResponse, err error) {
