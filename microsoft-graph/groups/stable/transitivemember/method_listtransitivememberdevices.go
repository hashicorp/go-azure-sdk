...
// collection
func (c TransitiveMemberClient) ListTransitiveMemberDevices(ctx context.Context, id stable.GroupId, options ListTransitiveMemberDevicesOperationOptions) (result ListTransitiveMemberDevicesOperationResponse, err error) {
...
func (c TransitiveMemberClient) ListTransitiveMemberDevicesComplete(ctx context.Context, id stable.GroupId, options ListTransitiveMemberDevicesOperationOptions) (ListTransitiveMemberDevicesCompleteResult, error) {
...
func (c TransitiveMemberClient) ListTransitiveMemberDevicesCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListTransitiveMemberDevicesOperationOptions, predicate DeviceOperationPredicate) (result ListTransitiveMemberDevicesCompleteResult, err error) {
