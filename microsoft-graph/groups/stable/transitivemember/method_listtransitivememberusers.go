...
// ListTransitiveMemberUsers - List group transitive members. Get a list of the group's members. A group can have
...
func (c TransitiveMemberClient) ListTransitiveMemberUsers(ctx context.Context, id stable.GroupId, options ListTransitiveMemberUsersOperationOptions) (result ListTransitiveMemberUsersOperationResponse, err error) {
...
func (c TransitiveMemberClient) ListTransitiveMemberUsersComplete(ctx context.Context, id stable.GroupId, options ListTransitiveMemberUsersOperationOptions) (ListTransitiveMemberUsersCompleteResult, error) {
...
func (c TransitiveMemberClient) ListTransitiveMemberUsersCompleteMatchingPredicate(ctx context.Context, id stable.GroupId, options ListTransitiveMemberUsersOperationOptions, predicate UserOperationPredicate) (result ListTransitiveMemberUsersCompleteResult, err error) {
