...
// GetTransitiveMemberUser - List group transitive members. Get a list of the group's members. A group can have
...
func (c TransitiveMemberClient) GetTransitiveMemberUser(ctx context.Context, id stable.GroupIdTransitiveMemberId, options GetTransitiveMemberUserOperationOptions) (result GetTransitiveMemberUserOperationResponse, err error) {
