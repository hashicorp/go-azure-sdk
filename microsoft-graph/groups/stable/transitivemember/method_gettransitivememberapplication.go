...
func (c TransitiveMemberClient) GetTransitiveMemberApplication(ctx context.Context, id stable.GroupIdTransitiveMemberId, options GetTransitiveMemberApplicationOperationOptions) (result GetTransitiveMemberApplicationOperationResponse, err error) {
