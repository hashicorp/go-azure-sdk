...
func (c DriveRootListItemClient) CreateDriveRootListItemLink(ctx context.Context, id stable.GroupIdDriveId, input CreateDriveRootListItemLinkRequest) (result CreateDriveRootListItemLinkOperationResponse, err error) {
