...
func (c CalendarCalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, input TentativelyAcceptCalendarViewRequest) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
