...
// Outlook.com account.
func (c CalendarCalendarViewClient) ForwardCalendarView(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, input ForwardCalendarViewRequest) (result ForwardCalendarViewOperationResponse, err error) {
