...
func (c CalendarCalendarViewClient) CancelCalendarView(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, input CancelCalendarViewRequest) (result CancelCalendarViewOperationResponse, err error) {
