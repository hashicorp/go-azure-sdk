...
func (c CalendarCalendarViewClient) DeclineCalendarView(ctx context.Context, id stable.GroupIdCalendarCalendarViewId, input DeclineCalendarViewRequest) (result DeclineCalendarViewOperationResponse, err error) {
