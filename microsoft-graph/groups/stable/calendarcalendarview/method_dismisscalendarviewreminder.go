...
// in a user calendar.
func (c CalendarCalendarViewClient) DismissCalendarViewReminder(ctx context.Context, id stable.GroupIdCalendarCalendarViewId) (result DismissCalendarViewReminderOperationResponse, err error) {
