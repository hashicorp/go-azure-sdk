...
func (c DriveItemListItemVersionClient) CreateDriveItemListItemVersion(ctx context.Context, id stable.GroupIdDriveIdItemId, input stable.ListItemVersion) (result CreateDriveItemListItemVersionOperationResponse, err error) {
