...
func (c DriveRootAnalyticsItemActivityStatClient) CreateDriveRootAnalyticsItemActivityStat(ctx context.Context, id stable.GroupIdDriveId, input stable.ItemActivityStat) (result CreateDriveRootAnalyticsItemActivityStatOperationResponse, err error) {
