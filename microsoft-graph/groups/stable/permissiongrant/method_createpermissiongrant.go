...
func (c PermissionGrantClient) CreatePermissionGrant(ctx context.Context, id stable.GroupId, input stable.ResourceSpecificPermissionGrant) (result CreatePermissionGrantOperationResponse, err error) {
