...
func (c PermissionGrantClient) CreatePermissionGrant(ctx context.Context, id GroupId, input stable.ResourceSpecificPermissionGrant) (result CreatePermissionGrantOperationResponse, err error) {
