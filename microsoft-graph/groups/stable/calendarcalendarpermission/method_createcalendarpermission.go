...
func (c CalendarCalendarPermissionClient) CreateCalendarPermission(ctx context.Context, id stable.GroupId, input stable.CalendarPermission) (result CreateCalendarPermissionOperationResponse, err error) {
