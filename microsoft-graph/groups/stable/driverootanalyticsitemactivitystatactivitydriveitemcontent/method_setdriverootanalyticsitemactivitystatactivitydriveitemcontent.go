...
func (c DriveRootAnalyticsItemActivityStatActivityDriveItemContentClient) SetDriveRootAnalyticsItemActivityStatActivityDriveItemContent(ctx context.Context, id stable.GroupIdDriveIdRootAnalyticsItemActivityStatIdActivityId, input []byte) (result SetDriveRootAnalyticsItemActivityStatActivityDriveItemContentOperationResponse, err error) {
