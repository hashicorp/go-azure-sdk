...
func (c CalendarCalendarViewInstanceExtensionClient) CreateCalendarViewInstanceExtension(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceId, input stable.Extension) (result CreateCalendarViewInstanceExtensionOperationResponse, err error) {
