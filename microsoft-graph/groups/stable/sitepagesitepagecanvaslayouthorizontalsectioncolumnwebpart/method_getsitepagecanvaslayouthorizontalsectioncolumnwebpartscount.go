...
func (c SitePageSitePageCanvasLayoutHorizontalSectionColumnWebpartClient) GetSitePageCanvasLayoutHorizontalSectionColumnWebpartsCount(ctx context.Context, id stable.GroupIdSiteIdPageIdSitePageCanvasLayoutHorizontalSectionIdColumnId, options GetSitePageCanvasLayoutHorizontalSectionColumnWebpartsCountOperationOptions) (result GetSitePageCanvasLayoutHorizontalSectionColumnWebpartsCountOperationResponse, err error) {
