...
func (c SitePageSitePageCanvasLayoutHorizontalSectionColumnWebpartClient) UpdateSitePageCanvasLayoutHorizontalSectionColumnWebpart(ctx context.Context, id stable.GroupIdSiteIdPageIdSitePageCanvasLayoutHorizontalSectionIdColumnIdWebpartId, input stable.WebPart, options UpdateSitePageCanvasLayoutHorizontalSectionColumnWebpartOperationOptions) (result UpdateSitePageCanvasLayoutHorizontalSectionColumnWebpartOperationResponse, err error) {
