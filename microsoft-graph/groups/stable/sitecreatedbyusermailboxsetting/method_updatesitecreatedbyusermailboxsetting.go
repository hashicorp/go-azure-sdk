...
func (c SiteCreatedByUserMailboxSettingClient) UpdateSiteCreatedByUserMailboxSetting(ctx context.Context, id stable.GroupIdSiteId, input stable.MailboxSettings) (result UpdateSiteCreatedByUserMailboxSettingOperationResponse, err error) {
