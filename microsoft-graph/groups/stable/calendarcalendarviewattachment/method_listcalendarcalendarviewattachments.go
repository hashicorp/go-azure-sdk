...
func (c CalendarCalendarViewAttachmentClient) ListCalendarCalendarViewAttachments(ctx context.Context, id GroupIdCalendarCalendarViewId) (result ListCalendarCalendarViewAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewAttachmentClient) ListCalendarCalendarViewAttachmentsComplete(ctx context.Context, id GroupIdCalendarCalendarViewId) (ListCalendarCalendarViewAttachmentsCompleteResult, error) {
...
func (c CalendarCalendarViewAttachmentClient) ListCalendarCalendarViewAttachmentsCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarCalendarViewId, predicate AttachmentOperationPredicate) (result ListCalendarCalendarViewAttachmentsCompleteResult, err error) {
