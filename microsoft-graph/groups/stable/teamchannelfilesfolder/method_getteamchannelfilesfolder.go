...
func (c TeamChannelFilesFolderClient) GetTeamChannelFilesFolder(ctx context.Context, id GroupIdTeamChannelId) (result GetTeamChannelFilesFolderOperationResponse, err error) {
