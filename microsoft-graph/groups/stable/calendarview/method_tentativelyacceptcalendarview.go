...
func (c CalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id stable.GroupIdCalendarViewId, input TentativelyAcceptCalendarViewRequest) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
