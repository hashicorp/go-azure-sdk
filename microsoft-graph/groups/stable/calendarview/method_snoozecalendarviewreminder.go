...
// a new time.
func (c CalendarViewClient) SnoozeCalendarViewReminder(ctx context.Context, id stable.GroupIdCalendarViewId, input SnoozeCalendarViewReminderRequest) (result SnoozeCalendarViewReminderOperationResponse, err error) {
