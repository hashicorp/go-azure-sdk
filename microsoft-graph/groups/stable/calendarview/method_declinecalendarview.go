...
func (c CalendarViewClient) DeclineCalendarView(ctx context.Context, id stable.GroupIdCalendarViewId, input DeclineCalendarViewRequest) (result DeclineCalendarViewOperationResponse, err error) {
