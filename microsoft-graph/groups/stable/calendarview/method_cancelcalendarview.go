...
func (c CalendarViewClient) CancelCalendarView(ctx context.Context, id stable.GroupIdCalendarViewId, input CancelCalendarViewRequest) (result CancelCalendarViewOperationResponse, err error) {
