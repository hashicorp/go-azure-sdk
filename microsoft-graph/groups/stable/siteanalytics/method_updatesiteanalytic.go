...
func (c SiteAnalyticsClient) UpdateSiteAnalytic(ctx context.Context, id stable.GroupIdSiteId, input stable.ItemAnalytics) (result UpdateSiteAnalyticOperationResponse, err error) {
