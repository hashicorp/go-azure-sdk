...
func (c DriveListSubscriptionClient) CreateDriveListSubscription(ctx context.Context, id stable.GroupIdDriveId, input stable.Subscription) (result CreateDriveListSubscriptionOperationResponse, err error) {
