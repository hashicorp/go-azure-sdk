...
func (c SitePageSitePageCreatedByUserMailboxSettingClient) UpdateSitePageCreatedByUserMailboxSetting(ctx context.Context, id stable.GroupIdSiteIdPageId, input stable.MailboxSettings, options UpdateSitePageCreatedByUserMailboxSettingOperationOptions) (result UpdateSitePageCreatedByUserMailboxSettingOperationResponse, err error) {
