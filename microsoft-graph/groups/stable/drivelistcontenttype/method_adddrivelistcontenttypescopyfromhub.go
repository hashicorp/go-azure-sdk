...
func (c DriveListContentTypeClient) AddDriveListContentTypesCopyFromHub(ctx context.Context, id stable.GroupIdDriveId, input AddDriveListContentTypesCopyFromHubRequest) (result AddDriveListContentTypesCopyFromHubOperationResponse, err error) {
