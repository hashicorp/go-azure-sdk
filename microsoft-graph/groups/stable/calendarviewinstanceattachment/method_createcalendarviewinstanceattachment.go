...
func (c CalendarViewInstanceAttachmentClient) CreateCalendarViewInstanceAttachment(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId, input stable.Attachment) (result CreateCalendarViewInstanceAttachmentOperationResponse, err error) {
