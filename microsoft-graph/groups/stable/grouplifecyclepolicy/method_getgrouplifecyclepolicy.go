...
func (c GroupLifecyclePolicyClient) GetGroupLifecyclePolicy(ctx context.Context, id GroupIdGroupLifecyclePolicyId) (result GetGroupLifecyclePolicyOperationResponse, err error) {
