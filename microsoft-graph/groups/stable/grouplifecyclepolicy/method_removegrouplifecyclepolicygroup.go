...
func (c GroupLifecyclePolicyClient) RemoveGroupLifecyclePolicyGroup(ctx context.Context, id stable.GroupIdGroupLifecyclePolicyId, input RemoveGroupLifecyclePolicyGroupRequest) (result RemoveGroupLifecyclePolicyGroupOperationResponse, err error) {
