...
func (c GroupLifecyclePolicyClient) CreateGroupLifecyclePolicy(ctx context.Context, id GroupId, input stable.GroupLifecyclePolicy) (result CreateGroupLifecyclePolicyOperationResponse, err error) {
