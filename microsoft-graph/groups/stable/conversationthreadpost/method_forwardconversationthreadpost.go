...
func (c ConversationThreadPostClient) ForwardConversationThreadPost(ctx context.Context, id stable.GroupIdConversationIdThreadIdPostId, input ForwardConversationThreadPostRequest) (result ForwardConversationThreadPostOperationResponse, err error) {
