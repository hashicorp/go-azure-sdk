...
func (c TeamScheduleTimesOffClient) CreateTeamScheduleTimesOff(ctx context.Context, id stable.GroupId, input stable.TimeOff) (result CreateTeamScheduleTimesOffOperationResponse, err error) {
