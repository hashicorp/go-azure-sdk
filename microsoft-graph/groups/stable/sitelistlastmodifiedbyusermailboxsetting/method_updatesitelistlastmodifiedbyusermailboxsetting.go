...
func (c SiteListLastModifiedByUserMailboxSettingClient) UpdateSiteListLastModifiedByUserMailboxSetting(ctx context.Context, id stable.GroupIdSiteIdListId, input stable.MailboxSettings) (result UpdateSiteListLastModifiedByUserMailboxSettingOperationResponse, err error) {
