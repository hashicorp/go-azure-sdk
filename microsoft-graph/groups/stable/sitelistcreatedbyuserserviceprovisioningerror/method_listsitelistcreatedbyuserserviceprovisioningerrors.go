...
func (c SiteListCreatedByUserServiceProvisioningErrorClient) ListSiteListCreatedByUserServiceProvisioningErrors(ctx context.Context, id GroupIdSiteIdListId) (result ListSiteListCreatedByUserServiceProvisioningErrorsOperationResponse, err error) {
...
func (c SiteListCreatedByUserServiceProvisioningErrorClient) ListSiteListCreatedByUserServiceProvisioningErrorsComplete(ctx context.Context, id GroupIdSiteIdListId) (ListSiteListCreatedByUserServiceProvisioningErrorsCompleteResult, error) {
	return c.ListSiteListCreatedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx, id, ServiceProvisioningErrorOperationPredicate{})
}
...
func (c SiteListCreatedByUserServiceProvisioningErrorClient) ListSiteListCreatedByUserServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id GroupIdSiteIdListId, predicate ServiceProvisioningErrorOperationPredicate) (result ListSiteListCreatedByUserServiceProvisioningErrorsCompleteResult, err error) {
	items := make([]stable.ServiceProvisioningError, 0)

	resp, err := c.ListSiteListCreatedByUserServiceProvisioningErrors(ctx, id)
	if err != nil {
