...
// Outlook.com account.
func (c CalendarViewInstanceClient) ForwardCalendarViewInstance(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId, input ForwardCalendarViewInstanceRequest) (result ForwardCalendarViewInstanceOperationResponse, err error) {
