...
func (c CalendarViewInstanceClient) DeclineCalendarViewInstance(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId, input DeclineCalendarViewInstanceRequest) (result DeclineCalendarViewInstanceOperationResponse, err error) {
