...
func (c CalendarViewInstanceClient) ListCalendarViewInstances(ctx context.Context, id GroupIdCalendarViewId) (result ListCalendarViewInstancesOperationResponse, err error) {
...
func (c CalendarViewInstanceClient) ListCalendarViewInstancesComplete(ctx context.Context, id GroupIdCalendarViewId) (ListCalendarViewInstancesCompleteResult, error) {
...
func (c CalendarViewInstanceClient) ListCalendarViewInstancesCompleteMatchingPredicate(ctx context.Context, id GroupIdCalendarViewId, predicate EventOperationPredicate) (result ListCalendarViewInstancesCompleteResult, err error) {
