...
func (c CalendarViewInstanceClient) DismissCalendarViewInstanceReminder(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId) (result DismissCalendarViewInstanceReminderOperationResponse, err error) {
