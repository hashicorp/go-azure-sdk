...
func (c CalendarViewInstanceClient) CancelCalendarViewInstance(ctx context.Context, id stable.GroupIdCalendarViewIdInstanceId, input CancelCalendarViewInstanceRequest) (result CancelCalendarViewInstanceOperationResponse, err error) {
