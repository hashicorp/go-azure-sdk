...
func (c CalendarEventClient) TentativelyAcceptCalendarEvent(ctx context.Context, id stable.GroupIdCalendarEventId, input TentativelyAcceptCalendarEventRequest) (result TentativelyAcceptCalendarEventOperationResponse, err error) {
