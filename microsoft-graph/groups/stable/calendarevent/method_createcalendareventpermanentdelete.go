...
// CreateCalendarEventPermanentDelete - Invoke action permanentDelete
func (c CalendarEventClient) CreateCalendarEventPermanentDelete(ctx context.Context, id stable.GroupIdCalendarEventId, options CreateCalendarEventPermanentDeleteOperationOptions) (result CreateCalendarEventPermanentDeleteOperationResponse, err error) {
