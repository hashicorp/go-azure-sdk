...
func (c CalendarEventClient) CancelCalendarEvent(ctx context.Context, id stable.GroupIdCalendarEventId, input CancelCalendarEventRequest) (result CancelCalendarEventOperationResponse, err error) {
