...
func (c CalendarEventClient) DeclineCalendarEvent(ctx context.Context, id stable.GroupIdCalendarEventId, input DeclineCalendarEventRequest) (result DeclineCalendarEventOperationResponse, err error) {
