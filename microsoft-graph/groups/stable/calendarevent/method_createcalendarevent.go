...
func (c CalendarEventClient) CreateCalendarEvent(ctx context.Context, id stable.GroupId, input stable.Event) (result CreateCalendarEventOperationResponse, err error) {
