...
func (c DriveListItemDocumentSetVersionClient) CreateDriveListItemDocumentSetVersion(ctx context.Context, id stable.GroupIdDriveIdListItemId, input stable.DocumentSetVersion) (result CreateDriveListItemDocumentSetVersionOperationResponse, err error) {
