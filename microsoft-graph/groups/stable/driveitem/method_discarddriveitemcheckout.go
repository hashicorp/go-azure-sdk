...
// permissions.
func (c DriveItemClient) DiscardDriveItemCheckout(ctx context.Context, id stable.GroupIdDriveIdItemId, options DiscardDriveItemCheckoutOperationOptions) (result DiscardDriveItemCheckoutOperationResponse, err error) {
