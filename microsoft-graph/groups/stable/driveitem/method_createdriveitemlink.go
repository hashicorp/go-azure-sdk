...
func (c DriveItemClient) CreateDriveItemLink(ctx context.Context, id stable.GroupIdDriveIdItemId, input CreateDriveItemLinkRequest) (result CreateDriveItemLinkOperationResponse, err error) {
