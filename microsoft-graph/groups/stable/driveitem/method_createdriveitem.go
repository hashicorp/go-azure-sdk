...
func (c DriveItemClient) CreateDriveItem(ctx context.Context, id stable.GroupIdDriveId, input stable.DriveItem) (result CreateDriveItemOperationResponse, err error) {
