...
func (c DriveItemClient) RestoreDriveItem(ctx context.Context, id stable.GroupIdDriveIdItemId, input RestoreDriveItemRequest) (result RestoreDriveItemOperationResponse, err error) {
