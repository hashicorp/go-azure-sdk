...
func (c DriveItemClient) CreateDriveItemUploadSession(ctx context.Context, id stable.GroupIdDriveIdItemId, input CreateDriveItemUploadSessionRequest) (result CreateDriveItemUploadSessionOperationResponse, err error) {
