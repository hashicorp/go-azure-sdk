...
func (c DriveItemClient) PreviewDriveItem(ctx context.Context, id stable.GroupIdDriveIdItemId, input PreviewDriveItemRequest) (result PreviewDriveItemOperationResponse, err error) {
