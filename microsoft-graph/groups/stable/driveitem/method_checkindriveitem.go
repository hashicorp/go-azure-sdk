...
func (c DriveItemClient) CheckinDriveItem(ctx context.Context, id stable.GroupIdDriveIdItemId, input CheckinDriveItemRequest) (result CheckinDriveItemOperationResponse, err error) {
