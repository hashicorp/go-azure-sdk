...
func (c TeamOperationClient) CreateTeamOperation(ctx context.Context, id stable.GroupId, input stable.TeamsAsyncOperation) (result CreateTeamOperationOperationResponse, err error) {
