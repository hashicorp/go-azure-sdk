...
// CreateTeamOperation ...
func (c TeamOperationClient) CreateTeamOperation(ctx context.Context, id GroupId, input stable.TeamsAsyncOperation) (result CreateTeamOperationOperationResponse, err error) {
