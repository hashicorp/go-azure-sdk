...
func (c DriveRootRetentionLabelClient) UpdateDriveRootRetentionLabel(ctx context.Context, id stable.GroupIdDriveId, input stable.ItemRetentionLabel) (result UpdateDriveRootRetentionLabelOperationResponse, err error) {
