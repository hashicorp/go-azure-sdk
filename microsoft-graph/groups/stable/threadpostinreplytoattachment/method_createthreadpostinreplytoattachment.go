...
func (c ThreadPostInReplyToAttachmentClient) CreateThreadPostInReplyToAttachment(ctx context.Context, id stable.GroupIdThreadIdPostId, input stable.Attachment) (result CreateThreadPostInReplyToAttachmentOperationResponse, err error) {
