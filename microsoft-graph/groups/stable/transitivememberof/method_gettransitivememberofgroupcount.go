...
func (c TransitiveMemberOfClient) GetTransitiveMemberOfGroupCount(ctx context.Context, id stable.GroupId, options GetTransitiveMemberOfGroupCountOperationOptions) (result GetTransitiveMemberOfGroupCountOperationResponse, err error) {
