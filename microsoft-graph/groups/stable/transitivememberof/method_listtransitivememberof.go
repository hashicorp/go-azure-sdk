...
func (c TransitiveMemberOfClient) ListTransitiveMemberOf(ctx context.Context, id GroupId) (result ListTransitiveMemberOfOperationResponse, err error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfComplete(ctx context.Context, id GroupId) (ListTransitiveMemberOfCompleteResult, error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfCompleteMatchingPredicate(ctx context.Context, id GroupId, predicate DirectoryObjectOperationPredicate) (result ListTransitiveMemberOfCompleteResult, err error) {
