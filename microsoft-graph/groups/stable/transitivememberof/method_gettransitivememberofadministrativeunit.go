...
func (c TransitiveMemberOfClient) GetTransitiveMemberOfAdministrativeUnit(ctx context.Context, id stable.GroupIdTransitiveMemberOfId, options GetTransitiveMemberOfAdministrativeUnitOperationOptions) (result GetTransitiveMemberOfAdministrativeUnitOperationResponse, err error) {
