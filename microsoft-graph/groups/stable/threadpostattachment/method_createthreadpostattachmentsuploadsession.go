...
func (c ThreadPostAttachmentClient) CreateThreadPostAttachmentsUploadSession(ctx context.Context, id stable.GroupIdThreadIdPostId, input CreateThreadPostAttachmentsUploadSessionRequest) (result CreateThreadPostAttachmentsUploadSessionOperationResponse, err error) {
