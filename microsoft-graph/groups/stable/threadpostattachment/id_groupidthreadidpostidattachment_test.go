...
func TestNewGroupIdThreadIdPostIdAttachmentID(t *testing.T) {
	id := NewGroupIdThreadIdPostIdAttachmentID("groupIdValue", "conversationThreadIdValue", "postIdValue", "attachmentIdValue")
...
func TestFormatGroupIdThreadIdPostIdAttachmentID(t *testing.T) {
	actual := NewGroupIdThreadIdPostIdAttachmentID("groupIdValue", "conversationThreadIdValue", "postIdValue", "attachmentIdValue").ID()
