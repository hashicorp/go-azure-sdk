...
func (c SiteListColumnClient) CreateSiteListColumn(ctx context.Context, id stable.GroupIdSiteIdListId, input stable.ColumnDefinition) (result CreateSiteListColumnOperationResponse, err error) {
