...
func (c TeamPrimaryChannelClient) CreateTeamPrimaryChannelArchive(ctx context.Context, id stable.GroupId, input CreateTeamPrimaryChannelArchiveRequest) (result CreateTeamPrimaryChannelArchiveOperationResponse, err error) {
