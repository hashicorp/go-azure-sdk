...
func (c TeamPrimaryChannelClient) ProvisionTeamPrimaryChannelEmail(ctx context.Context, id stable.GroupId) (result ProvisionTeamPrimaryChannelEmailOperationResponse, err error) {
