...
func (c TeamPrimaryChannelClient) CreateTeamPrimaryChannelCompleteMigration(ctx context.Context, id stable.GroupId) (result CreateTeamPrimaryChannelCompleteMigrationOperationResponse, err error) {
