...
func (c TeamPrimaryChannelClient) CreateTeamPrimaryChannelUnarchive(ctx context.Context, id stable.GroupId) (result CreateTeamPrimaryChannelUnarchiveOperationResponse, err error) {
