...
func (c TeamPrimaryChannelClient) UpdateTeamPrimaryChannel(ctx context.Context, id stable.GroupId, input stable.Channel) (result UpdateTeamPrimaryChannelOperationResponse, err error) {
