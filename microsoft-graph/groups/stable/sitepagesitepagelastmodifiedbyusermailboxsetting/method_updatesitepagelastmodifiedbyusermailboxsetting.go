...
func (c SitePageSitePageLastModifiedByUserMailboxSettingClient) UpdateSitePageLastModifiedByUserMailboxSetting(ctx context.Context, id stable.GroupIdSiteIdPageId, input stable.MailboxSettings, options UpdateSitePageLastModifiedByUserMailboxSettingOperationOptions) (result UpdateSitePageLastModifiedByUserMailboxSettingOperationResponse, err error) {
