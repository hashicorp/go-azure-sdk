...
func (c DriveListContentTypeColumnLinkClient) CreateDriveListContentTypeColumnLink(ctx context.Context, id stable.GroupIdDriveIdListContentTypeId, input stable.ColumnLink) (result CreateDriveListContentTypeColumnLinkOperationResponse, err error) {
