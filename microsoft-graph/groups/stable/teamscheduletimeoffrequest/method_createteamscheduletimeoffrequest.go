...
func (c TeamScheduleTimeOffRequestClient) CreateTeamScheduleTimeOffRequest(ctx context.Context, id stable.GroupId, input stable.TimeOffRequest) (result CreateTeamScheduleTimeOffRequestOperationResponse, err error) {
