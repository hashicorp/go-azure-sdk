...
func (c DriveListItemDriveItemContentClient) SetDriveListItemDriveItemContent(ctx context.Context, id stable.GroupIdDriveIdListItemId, input []byte) (result SetDriveListItemDriveItemContentOperationResponse, err error) {
