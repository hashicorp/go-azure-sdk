...
## `github.com/hashicorp/go-azure-sdk/microsoft-graph/groups/stable/onenotenotebooksectiongroupsection` Documentation

The `onenotenotebooksectiongroupsection` SDK allows for interaction with Microsoft Graph `groups` (API Version `stable`).
...
```go
import "github.com/hashicorp/go-azure-sdk/microsoft-graph/groups/stable/onenotenotebooksectiongroupsection"
```
