...
func (c DriveListItemClient) CreateDriveListItemLink(ctx context.Context, id stable.GroupIdDriveIdListItemId, input CreateDriveListItemLinkRequest) (result CreateDriveListItemLinkOperationResponse, err error) {
