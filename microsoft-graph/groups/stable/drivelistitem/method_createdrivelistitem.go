...
func (c DriveListItemClient) CreateDriveListItem(ctx context.Context, id stable.GroupIdDriveId, input stable.ListItem) (result CreateDriveListItemOperationResponse, err error) {
