...
func (c DriveRootClient) RestoreDriveRoot(ctx context.Context, id stable.GroupIdDriveId, input RestoreDriveRootRequest) (result RestoreDriveRootOperationResponse, err error) {
