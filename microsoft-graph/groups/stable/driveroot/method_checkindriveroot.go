...
func (c DriveRootClient) CheckinDriveRoot(ctx context.Context, id stable.GroupIdDriveId, input CheckinDriveRootRequest) (result CheckinDriveRootOperationResponse, err error) {
