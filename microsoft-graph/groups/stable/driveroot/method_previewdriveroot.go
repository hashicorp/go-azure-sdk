...
func (c DriveRootClient) PreviewDriveRoot(ctx context.Context, id stable.GroupIdDriveId, input PreviewDriveRootRequest) (result PreviewDriveRootOperationResponse, err error) {
