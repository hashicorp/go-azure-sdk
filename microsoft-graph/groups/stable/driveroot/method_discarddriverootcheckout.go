...
// permissions.
func (c DriveRootClient) DiscardDriveRootCheckout(ctx context.Context, id stable.GroupIdDriveId, options DiscardDriveRootCheckoutOperationOptions) (result DiscardDriveRootCheckoutOperationResponse, err error) {
