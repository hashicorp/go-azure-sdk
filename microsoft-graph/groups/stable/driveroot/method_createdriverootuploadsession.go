...
func (c DriveRootClient) CreateDriveRootUploadSession(ctx context.Context, id stable.GroupIdDriveId, input CreateDriveRootUploadSessionRequest) (result CreateDriveRootUploadSessionOperationResponse, err error) {
