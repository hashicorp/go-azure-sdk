...
func (c CalendarCalendarViewInstanceAttachmentClient) CreateCalendarViewInstanceAttachment(ctx context.Context, id stable.GroupIdCalendarCalendarViewIdInstanceId, input stable.Attachment) (result CreateCalendarViewInstanceAttachmentOperationResponse, err error) {
