...
func (c SitePageClient) ListSitePageSitePages(ctx context.Context, id stable.GroupIdSiteId, options ListSitePageSitePagesOperationOptions) (result ListSitePageSitePagesOperationResponse, err error) {
	...
	var values struct {
		Values *[]stable.SitePage `json:"value"`
	}
...
func (c SitePageClient) ListSitePageSitePagesComplete(ctx context.Context, id stable.GroupIdSiteId, options ListSitePageSitePagesOperationOptions) (ListSitePageSitePagesCompleteResult, error) {
...
func (c SitePageClient) ListSitePageSitePagesCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdSiteId, options ListSitePageSitePagesOperationOptions, predicate SitePageOperationPredicate) (result ListSitePageSitePagesCompleteResult, err error) {
	items := make([]stable.SitePage, 0)
