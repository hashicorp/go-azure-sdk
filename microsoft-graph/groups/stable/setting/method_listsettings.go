...
func (c SettingClient) ListSettingsComplete(ctx context.Context, id GroupId) (ListSettingsCompleteResult, error) {
	return c.ListSettingsCompleteMatchingPredicate(ctx, id, GroupSettingOperationPredicate{})
}

// ListSettingsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c SettingClient) ListSettingsCompleteMatchingPredicate(ctx context.Context, id GroupId, predicate GroupSettingOperationPredicate) (result ListSettingsCompleteResult, err error) {
