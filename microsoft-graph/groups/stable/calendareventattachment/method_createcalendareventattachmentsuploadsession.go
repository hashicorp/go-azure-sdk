...
func (c CalendarEventAttachmentClient) CreateCalendarEventAttachmentsUploadSession(ctx context.Context, id stable.GroupIdCalendarEventId, input CreateCalendarEventAttachmentsUploadSessionRequest) (result CreateCalendarEventAttachmentsUploadSessionOperationResponse, err error) {
