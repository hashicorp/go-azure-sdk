...
func (c CalendarEventAttachmentClient) CreateCalendarEventAttachment(ctx context.Context, id stable.GroupIdCalendarEventId, input stable.Attachment) (result CreateCalendarEventAttachmentOperationResponse, err error) {
