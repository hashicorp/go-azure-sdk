...
func (c SitePageSitePageCanvasLayoutVerticalSectionWebpartClient) ListSitePageCanvasLayoutVerticalSectionWebparts(ctx context.Context, id stable.GroupIdSiteIdPageId, options ListSitePageCanvasLayoutVerticalSectionWebpartsOperationOptions) (result ListSitePageCanvasLayoutVerticalSectionWebpartsOperationResponse, err error) {
...
func (c SitePageSitePageCanvasLayoutVerticalSectionWebpartClient) ListSitePageCanvasLayoutVerticalSectionWebpartsComplete(ctx context.Context, id stable.GroupIdSiteIdPageId, options ListSitePageCanvasLayoutVerticalSectionWebpartsOperationOptions) (ListSitePageCanvasLayoutVerticalSectionWebpartsCompleteResult, error) {
...
func (c SitePageSitePageCanvasLayoutVerticalSectionWebpartClient) ListSitePageCanvasLayoutVerticalSectionWebpartsCompleteMatchingPredicate(ctx context.Context, id stable.GroupIdSiteIdPageId, options ListSitePageCanvasLayoutVerticalSectionWebpartsOperationOptions, predicate WebPartOperationPredicate) (result ListSitePageCanvasLayoutVerticalSectionWebpartsCompleteResult, err error) {
