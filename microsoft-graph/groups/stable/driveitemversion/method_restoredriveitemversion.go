...
func (c DriveItemVersionClient) RestoreDriveItemVersion(ctx context.Context, id stable.GroupIdDriveIdItemIdVersionId) (result RestoreDriveItemVersionOperationResponse, err error) {
