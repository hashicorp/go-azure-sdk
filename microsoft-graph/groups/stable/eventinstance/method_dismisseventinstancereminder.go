...
// in a user calendar.
func (c EventInstanceClient) DismissEventInstanceReminder(ctx context.Context, id stable.GroupIdEventIdInstanceId) (result DismissEventInstanceReminderOperationResponse, err error) {
