...
func (c EventInstanceClient) CancelEventInstance(ctx context.Context, id stable.GroupIdEventIdInstanceId, input CancelEventInstanceRequest) (result CancelEventInstanceOperationResponse, err error) {
