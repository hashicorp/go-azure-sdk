...
func (c EventInstanceClient) DeclineEventInstance(ctx context.Context, id stable.GroupIdEventIdInstanceId, input DeclineEventInstanceRequest) (result DeclineEventInstanceOperationResponse, err error) {
