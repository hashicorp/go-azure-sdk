...
// a new time.
func (c EventInstanceClient) SnoozeEventInstanceReminder(ctx context.Context, id stable.GroupIdEventIdInstanceId, input SnoozeEventInstanceReminderRequest) (result SnoozeEventInstanceReminderOperationResponse, err error) {
