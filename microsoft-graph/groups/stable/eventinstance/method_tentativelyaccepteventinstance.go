...
func (c EventInstanceClient) TentativelyAcceptEventInstance(ctx context.Context, id stable.GroupIdEventIdInstanceId, input TentativelyAcceptEventInstanceRequest) (result TentativelyAcceptEventInstanceOperationResponse, err error) {
