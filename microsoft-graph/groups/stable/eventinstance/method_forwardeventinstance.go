...
// Outlook.com account.
func (c EventInstanceClient) ForwardEventInstance(ctx context.Context, id stable.GroupIdEventIdInstanceId, input ForwardEventInstanceRequest) (result ForwardEventInstanceOperationResponse, err error) {
