...
func (c TeamChannelAllMemberClient) UpdateTeamChannelAllMember(ctx context.Context, id stable.GroupIdTeamChannelIdAllMemberId, input stable.ConversationMember, options UpdateTeamChannelAllMemberOperationOptions) (result UpdateTeamChannelAllMemberOperationResponse, err error) {
