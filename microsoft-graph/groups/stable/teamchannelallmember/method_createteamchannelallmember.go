...
func (c TeamChannelAllMemberClient) CreateTeamChannelAllMember(ctx context.Context, id stable.GroupIdTeamChannelId, input stable.ConversationMember, options CreateTeamChannelAllMemberOperationOptions) (result CreateTeamChannelAllMemberOperationResponse, err error) {
