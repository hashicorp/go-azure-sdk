...
func TestNewGroupSiteTermStoreGroupSetID(t *testing.T) {
	id := NewGroupSiteTermStoreGroupSetID("groupIdValue", "siteIdValue", "storeIdValue", "groupId1Value", "setIdValue")
...
func TestFormatGroupSiteTermStoreGroupSetID(t *testing.T) {
	actual := NewGroupSiteTermStoreGroupSetID("groupIdValue", "siteIdValue", "storeIdValue", "groupId1Value", "setIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue"
	if actual != expected {
...
func TestParseGroupSiteTermStoreGroupSetID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/extra",
			Error: true,
		},
	}
