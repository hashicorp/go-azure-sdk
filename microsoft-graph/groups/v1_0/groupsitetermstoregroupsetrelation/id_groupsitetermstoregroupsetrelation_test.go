...
func TestNewGroupSiteTermStoreGroupSetRelationID(t *testing.T) {
	id := NewGroupSiteTermStoreGroupSetRelationID("groupIdValue", "siteIdValue", "storeIdValue", "groupId1Value", "setIdValue", "relationIdValue")
...
func TestFormatGroupSiteTermStoreGroupSetRelationID(t *testing.T) {
	actual := NewGroupSiteTermStoreGroupSetRelationID("groupIdValue", "siteIdValue", "storeIdValue", "groupId1Value", "setIdValue", "relationIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/relations/relationIdValue"
	if actual != expected {
...
func TestParseGroupSiteTermStoreGroupSetRelationID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/relations",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/relations/relationIdValue",
			Expected: &GroupSiteTermStoreGroupSetRelationId{
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/relations/relationIdValue/extra",
			Error: true,
		},
	}
