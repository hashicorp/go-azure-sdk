...
func NewGroupSiteTermStoreGroupSetID(groupId string, siteId string, storeId string, groupId1 string, setId string) GroupSiteTermStoreGroupSetId {
...
func (id GroupSiteTermStoreGroupSetId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStores/%s/groups/%s/sets/%s"
	return fmt.Sprintf(fmtString, id.GroupId, id.SiteId, id.StoreId, id.GroupId1, id.SetId)
}
