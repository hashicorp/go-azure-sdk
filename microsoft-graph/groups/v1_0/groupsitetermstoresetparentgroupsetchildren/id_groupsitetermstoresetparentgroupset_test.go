...
func TestNewGroupSiteTermStoreSetParentGroupSetID(t *testing.T) {
	id := NewGroupSiteTermStoreSetParentGroupSetID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "setId1Value")
...
func TestFormatGroupSiteTermStoreSetParentGroupSetID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetParentGroupSetID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "setId1Value").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/sets/setIdValue/parentGroup/sets/setId1Value"
	if actual != expected {
...
func TestParseGroupSiteTermStoreSetParentGroupSetID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/sets/setIdValue/parentGroup/sets/setId1Value/extra",
			Error: true,
		},
	}
