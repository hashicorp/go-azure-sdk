...
func NewGroupSiteTermStoreSetParentGroupSetChildrenRelationID(groupId string, siteId string, storeId string, setId string, setId1 string, termId string, relationId string) GroupSiteTermStoreSetParentGroupSetChildrenRelationId {
...
func (id GroupSiteTermStoreSetParentGroupSetChildrenRelationId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStores/%s/sets/%s/parentGroup/sets/%s/children/%s/relations/%s"
