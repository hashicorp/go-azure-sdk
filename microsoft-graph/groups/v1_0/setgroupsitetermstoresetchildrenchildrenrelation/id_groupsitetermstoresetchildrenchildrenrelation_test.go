...
func TestNewGroupSiteTermStoreSetChildrenChildrenRelationID(t *testing.T) {
	id := NewGroupSiteTermStoreSetChildrenChildrenRelationID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "termIdValue", "termId1Value", "relationIdValue")
...
func TestFormatGroupSiteTermStoreSetChildrenChildrenRelationID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetChildrenChildrenRelationID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "termIdValue", "termId1Value", "relationIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/sets/setIdValue/children/termIdValue/children/termId1Value/relations/relationIdValue"
	if actual != expected {
...
func TestParseGroupSiteTermStoreSetChildrenChildrenRelationID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/sets/setIdValue/children/termIdValue/children/termId1Value/relations",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/sets/setIdValue/children/termIdValue/children/termId1Value/relations/relationIdValue",
			Expected: &GroupSiteTermStoreSetChildrenChildrenRelationId{
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/sets/setIdValue/children/termIdValue/children/termId1Value/relations/relationIdValue/extra",
			Error: true,
		},
	}
