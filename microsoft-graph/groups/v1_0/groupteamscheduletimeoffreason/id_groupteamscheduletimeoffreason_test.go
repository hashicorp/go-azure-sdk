...
func TestNewGroupTeamScheduleTimeOffReasonID(t *testing.T) {
	id := NewGroupTeamScheduleTimeOffReasonID("groupIdValue", "timeOffReasonIdValue")
...
func TestFormatGroupTeamScheduleTimeOffReasonID(t *testing.T) {
	actual := NewGroupTeamScheduleTimeOffReasonID("groupIdValue", "timeOffReasonIdValue").ID()
...
func TestParseGroupTeamScheduleTimeOffReasonID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamScheduleTimeOffReasonId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamScheduleTimeOffReasonID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupTeamScheduleTimeOffReasonIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamScheduleTimeOffReasonId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamScheduleTimeOffReasonIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupTeamScheduleTimeOffReasonId(t *testing.T) {
	segments := GroupTeamScheduleTimeOffReasonId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupTeamScheduleTimeOffReasonId has no segments")
	}
