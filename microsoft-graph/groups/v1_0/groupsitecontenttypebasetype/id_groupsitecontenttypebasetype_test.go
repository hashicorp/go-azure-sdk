...
func TestNewGroupSiteContentTypeBaseTypeID(t *testing.T) {
	id := NewGroupSiteContentTypeBaseTypeID("groupIdValue", "siteIdValue", "contentTypeIdValue", "contentTypeId1Value")
...
func TestFormatGroupSiteContentTypeBaseTypeID(t *testing.T) {
	actual := NewGroupSiteContentTypeBaseTypeID("groupIdValue", "siteIdValue", "contentTypeIdValue", "contentTypeId1Value").ID()
...
func TestParseGroupSiteContentTypeBaseTypeID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteContentTypeBaseTypeId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteContentTypeBaseTypeID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteContentTypeBaseTypeIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteContentTypeBaseTypeId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteContentTypeBaseTypeIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteContentTypeBaseTypeId(t *testing.T) {
	segments := GroupSiteContentTypeBaseTypeId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteContentTypeBaseTypeId has no segments")
	}
