...
func TestNewGroupTeamChannelSharedWithTeamAllowedMemberID(t *testing.T) {
	id := NewGroupTeamChannelSharedWithTeamAllowedMemberID("groupIdValue", "channelIdValue", "sharedWithChannelTeamInfoIdValue", "conversationMemberIdValue")
...
func TestFormatGroupTeamChannelSharedWithTeamAllowedMemberID(t *testing.T) {
	actual := NewGroupTeamChannelSharedWithTeamAllowedMemberID("groupIdValue", "channelIdValue", "sharedWithChannelTeamInfoIdValue", "conversationMemberIdValue").ID()
...
func TestParseGroupTeamChannelSharedWithTeamAllowedMemberID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamChannelSharedWithTeamAllowedMemberId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamChannelSharedWithTeamAllowedMemberID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupTeamChannelSharedWithTeamAllowedMemberIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamChannelSharedWithTeamAllowedMemberId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamChannelSharedWithTeamAllowedMemberIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupTeamChannelSharedWithTeamAllowedMemberId(t *testing.T) {
	segments := GroupTeamChannelSharedWithTeamAllowedMemberId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupTeamChannelSharedWithTeamAllowedMemberId has no segments")
	}
