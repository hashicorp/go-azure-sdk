...
func TestNewGroupSiteTermStoreSetTermRelationID(t *testing.T) {
	id := NewGroupSiteTermStoreSetTermRelationID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "termIdValue", "relationIdValue")
...
func TestFormatGroupSiteTermStoreSetTermRelationID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetTermRelationID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "termIdValue", "relationIdValue").ID()
...
func TestParseGroupSiteTermStoreSetTermRelationID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteTermStoreSetTermRelationId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteTermStoreSetTermRelationID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteTermStoreSetTermRelationIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteTermStoreSetTermRelationId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteTermStoreSetTermRelationIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteTermStoreSetTermRelationId(t *testing.T) {
	segments := GroupSiteTermStoreSetTermRelationId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteTermStoreSetTermRelationId has no segments")
	}
