package groupsitelistcolumnsourcecolumn
...
func TestNewGroupSiteListColumnID(t *testing.T) {
	id := NewGroupSiteListColumnID("groupIdValue", "siteIdValue", "listIdValue", "columnDefinitionIdValue")
...
func TestFormatGroupSiteListColumnID(t *testing.T) {
	actual := NewGroupSiteListColumnID("groupIdValue", "siteIdValue", "listIdValue", "columnDefinitionIdValue").ID()
...
func TestParseGroupSiteListColumnID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteListColumnId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteListColumnID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteListColumnIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteListColumnId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteListColumnIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteListColumnId(t *testing.T) {
	segments := GroupSiteListColumnId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteListColumnId has no segments")
	}
