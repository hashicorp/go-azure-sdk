...
func NewGroupSiteTermStoreGroupSetChildrenChildrenID(groupId string, siteId string, storeId string, groupId1 string, setId string, termId string, termId1 string) GroupSiteTermStoreGroupSetChildrenChildrenId {
...
func (id GroupSiteTermStoreGroupSetChildrenChildrenId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStores/%s/groups/%s/sets/%s/children/%s/children/%s"
	return fmt.Sprintf(fmtString, id.GroupId, id.SiteId, id.StoreId, id.GroupId1, id.SetId, id.TermId, id.TermId1)
}
