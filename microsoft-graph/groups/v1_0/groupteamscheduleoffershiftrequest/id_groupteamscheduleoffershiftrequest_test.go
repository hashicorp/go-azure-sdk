...
func TestNewGroupTeamScheduleOfferShiftRequestID(t *testing.T) {
	id := NewGroupTeamScheduleOfferShiftRequestID("groupIdValue", "offerShiftRequestIdValue")
...
func TestFormatGroupTeamScheduleOfferShiftRequestID(t *testing.T) {
	actual := NewGroupTeamScheduleOfferShiftRequestID("groupIdValue", "offerShiftRequestIdValue").ID()
...
func TestParseGroupTeamScheduleOfferShiftRequestID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamScheduleOfferShiftRequestId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamScheduleOfferShiftRequestID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupTeamScheduleOfferShiftRequestIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamScheduleOfferShiftRequestId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamScheduleOfferShiftRequestIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupTeamScheduleOfferShiftRequestId(t *testing.T) {
	segments := GroupTeamScheduleOfferShiftRequestId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupTeamScheduleOfferShiftRequestId has no segments")
	}
