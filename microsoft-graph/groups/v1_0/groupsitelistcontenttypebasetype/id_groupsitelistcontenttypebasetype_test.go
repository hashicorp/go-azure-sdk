...
func TestNewGroupSiteListContentTypeBaseTypeID(t *testing.T) {
	id := NewGroupSiteListContentTypeBaseTypeID("groupIdValue", "siteIdValue", "listIdValue", "contentTypeIdValue", "contentTypeId1Value")
...
func TestFormatGroupSiteListContentTypeBaseTypeID(t *testing.T) {
	actual := NewGroupSiteListContentTypeBaseTypeID("groupIdValue", "siteIdValue", "listIdValue", "contentTypeIdValue", "contentTypeId1Value").ID()
...
func TestParseGroupSiteListContentTypeBaseTypeID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteListContentTypeBaseTypeId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteListContentTypeBaseTypeID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteListContentTypeBaseTypeIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteListContentTypeBaseTypeId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteListContentTypeBaseTypeIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteListContentTypeBaseTypeId(t *testing.T) {
	segments := GroupSiteListContentTypeBaseTypeId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteListContentTypeBaseTypeId has no segments")
	}
