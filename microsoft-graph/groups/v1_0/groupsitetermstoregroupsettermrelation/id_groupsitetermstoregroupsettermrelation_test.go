...
func TestNewGroupSiteTermStoreGroupSetTermRelationID(t *testing.T) {
	id := NewGroupSiteTermStoreGroupSetTermRelationID("groupIdValue", "siteIdValue", "storeIdValue", "groupId1Value", "setIdValue", "termIdValue", "relationIdValue")
...
func TestFormatGroupSiteTermStoreGroupSetTermRelationID(t *testing.T) {
	actual := NewGroupSiteTermStoreGroupSetTermRelationID("groupIdValue", "siteIdValue", "storeIdValue", "groupId1Value", "setIdValue", "termIdValue", "relationIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/terms/termIdValue/relations/relationIdValue"
	if actual != expected {
...
func TestParseGroupSiteTermStoreGroupSetTermRelationID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/terms/termIdValue/relations",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/terms/termIdValue/relations/relationIdValue",
			Expected: &GroupSiteTermStoreGroupSetTermRelationId{
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/terms/termIdValue/relations/relationIdValue/extra",
			Error: true,
		},
	}
