...
func NewGroupSiteTermStoreGroupSetChildrenChildrenRelationID(groupId string, siteId string, storeId string, groupId1 string, setId string, termId string, termId1 string, relationId string) GroupSiteTermStoreGroupSetChildrenChildrenRelationId {
...
func (id GroupSiteTermStoreGroupSetChildrenChildrenRelationId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStores/%s/groups/%s/sets/%s/children/%s/children/%s/relations/%s"
	return fmt.Sprintf(fmtString, id.GroupId, id.SiteId, id.StoreId, id.GroupId1, id.SetId, id.TermId, id.TermId1, id.RelationId)
}
