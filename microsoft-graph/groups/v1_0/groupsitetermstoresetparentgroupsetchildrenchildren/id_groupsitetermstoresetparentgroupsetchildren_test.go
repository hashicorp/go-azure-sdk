...
func TestNewGroupSiteTermStoreSetParentGroupSetChildrenID(t *testing.T) {
	id := NewGroupSiteTermStoreSetParentGroupSetChildrenID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "setId1Value", "termIdValue")
...
func TestFormatGroupSiteTermStoreSetParentGroupSetChildrenID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetParentGroupSetChildrenID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "setId1Value", "termIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/sets/setIdValue/parentGroup/sets/setId1Value/children/termIdValue"
	if actual != expected {
...
func TestParseGroupSiteTermStoreSetParentGroupSetChildrenID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/sets/setIdValue/parentGroup/sets/setId1Value/children/termIdValue/extra",
			Error: true,
		},
	}
