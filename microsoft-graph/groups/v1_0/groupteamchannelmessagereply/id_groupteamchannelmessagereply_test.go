...
func TestNewGroupTeamChannelMessageReplyID(t *testing.T) {
	id := NewGroupTeamChannelMessageReplyID("groupIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageId1Value")
...
func TestFormatGroupTeamChannelMessageReplyID(t *testing.T) {
	actual := NewGroupTeamChannelMessageReplyID("groupIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageId1Value").ID()
...
func TestParseGroupTeamChannelMessageReplyID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamChannelMessageReplyId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamChannelMessageReplyID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupTeamChannelMessageReplyIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamChannelMessageReplyId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamChannelMessageReplyIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupTeamChannelMessageReplyId(t *testing.T) {
	segments := GroupTeamChannelMessageReplyId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupTeamChannelMessageReplyId has no segments")
	}
