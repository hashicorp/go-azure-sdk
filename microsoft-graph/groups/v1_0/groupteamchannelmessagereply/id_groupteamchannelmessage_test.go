...
func TestNewGroupTeamChannelMessageID(t *testing.T) {
	id := NewGroupTeamChannelMessageID("groupIdValue", "channelIdValue", "chatMessageIdValue")
...
func TestFormatGroupTeamChannelMessageID(t *testing.T) {
	actual := NewGroupTeamChannelMessageID("groupIdValue", "channelIdValue", "chatMessageIdValue").ID()
...
func TestParseGroupTeamChannelMessageID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamChannelMessageId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamChannelMessageID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupTeamChannelMessageIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamChannelMessageId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamChannelMessageIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupTeamChannelMessageId(t *testing.T) {
	segments := GroupTeamChannelMessageId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupTeamChannelMessageId has no segments")
	}
