...
func NewGroupSiteTermStoreSetParentGroupSetChildrenChildrenRelationID(groupId string, siteId string, storeId string, setId string, setId1 string, termId string, termId1 string, relationId string) GroupSiteTermStoreSetParentGroupSetChildrenChildrenRelationId {
...
func (id GroupSiteTermStoreSetParentGroupSetChildrenChildrenRelationId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStores/%s/sets/%s/parentGroup/sets/%s/children/%s/children/%s/relations/%s"
