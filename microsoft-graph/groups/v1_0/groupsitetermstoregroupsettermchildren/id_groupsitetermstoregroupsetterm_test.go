...
func TestNewGroupSiteTermStoreGroupSetTermID(t *testing.T) {
	id := NewGroupSiteTermStoreGroupSetTermID("groupIdValue", "siteIdValue", "storeIdValue", "groupId1Value", "setIdValue", "termIdValue")
...
func TestFormatGroupSiteTermStoreGroupSetTermID(t *testing.T) {
	actual := NewGroupSiteTermStoreGroupSetTermID("groupIdValue", "siteIdValue", "storeIdValue", "groupId1Value", "setIdValue", "termIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/terms/termIdValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseGroupSiteTermStoreGroupSetTermID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteTermStoreGroupSetTermId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/terms/termIdValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteTermStoreGroupSetTermID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteTermStoreGroupSetTermIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteTermStoreGroupSetTermId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteTermStoreGroupSetTermIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteTermStoreGroupSetTermId(t *testing.T) {
	segments := GroupSiteTermStoreGroupSetTermId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteTermStoreGroupSetTermId has no segments")
	}
