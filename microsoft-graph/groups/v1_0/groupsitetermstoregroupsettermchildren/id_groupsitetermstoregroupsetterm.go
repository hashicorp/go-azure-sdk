...
func NewGroupSiteTermStoreGroupSetTermID(groupId string, siteId string, storeId string, groupId1 string, setId string, termId string) GroupSiteTermStoreGroupSetTermId {
...
func (id GroupSiteTermStoreGroupSetTermId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStores/%s/groups/%s/sets/%s/terms/%s"
