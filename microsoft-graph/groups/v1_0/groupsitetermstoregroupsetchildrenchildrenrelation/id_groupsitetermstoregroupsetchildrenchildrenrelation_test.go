...
func TestNewGroupSiteTermStoreGroupSetChildrenChildrenRelationID(t *testing.T) {
	id := NewGroupSiteTermStoreGroupSetChildrenChildrenRelationID("groupIdValue", "siteIdValue", "storeIdValue", "groupId1Value", "setIdValue", "termIdValue", "termId1Value", "relationIdValue")
...
func TestFormatGroupSiteTermStoreGroupSetChildrenChildrenRelationID(t *testing.T) {
	actual := NewGroupSiteTermStoreGroupSetChildrenChildrenRelationID("groupIdValue", "siteIdValue", "storeIdValue", "groupId1Value", "setIdValue", "termIdValue", "termId1Value", "relationIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/children/termIdValue/children/termId1Value/relations/relationIdValue"
	if actual != expected {
...
func TestParseGroupSiteTermStoreGroupSetChildrenChildrenRelationID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/children/termIdValue/children/termId1Value/relations",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/children/termIdValue/children/termId1Value/relations/relationIdValue",
			Expected: &GroupSiteTermStoreGroupSetChildrenChildrenRelationId{
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/children/termIdValue/children/termId1Value/relations/relationIdValue/extra",
			Error: true,
		},
	}
