...
func NewGroupSiteTermStoreSetParentGroupSetChildrenChildrenID(groupId string, siteId string, storeId string, setId string, setId1 string, termId string, termId1 string) GroupSiteTermStoreSetParentGroupSetChildrenChildrenId {
...
func (id GroupSiteTermStoreSetParentGroupSetChildrenChildrenId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStores/%s/sets/%s/parentGroup/sets/%s/children/%s/children/%s"
	return fmt.Sprintf(fmtString, id.GroupId, id.SiteId, id.StoreId, id.SetId, id.SetId1, id.TermId, id.TermId1)
}
