...
func TestNewGroupSiteTermStoreSetID(t *testing.T) {
	id := NewGroupSiteTermStoreSetID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue")
...
func TestFormatGroupSiteTermStoreSetID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue").ID()
