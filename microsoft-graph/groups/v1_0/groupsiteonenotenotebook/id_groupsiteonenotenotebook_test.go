...
func TestNewGroupSiteOnenoteNotebookID(t *testing.T) {
	id := NewGroupSiteOnenoteNotebookID("groupIdValue", "siteIdValue", "notebookIdValue")
...
func TestFormatGroupSiteOnenoteNotebookID(t *testing.T) {
	actual := NewGroupSiteOnenoteNotebookID("groupIdValue", "siteIdValue", "notebookIdValue").ID()
...
func TestParseGroupSiteOnenoteNotebookID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteOnenoteNotebookId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteOnenoteNotebookID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteOnenoteNotebookIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteOnenoteNotebookId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteOnenoteNotebookIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteOnenoteNotebookId(t *testing.T) {
	segments := GroupSiteOnenoteNotebookId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteOnenoteNotebookId has no segments")
	}
