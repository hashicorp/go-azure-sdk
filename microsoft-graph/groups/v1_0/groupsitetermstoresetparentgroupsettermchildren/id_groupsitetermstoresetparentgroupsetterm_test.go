...
func TestNewGroupSiteTermStoreSetParentGroupSetTermID(t *testing.T) {
	id := NewGroupSiteTermStoreSetParentGroupSetTermID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "setId1Value", "termIdValue")
...
func TestFormatGroupSiteTermStoreSetParentGroupSetTermID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetParentGroupSetTermID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "setId1Value", "termIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/sets/setIdValue/parentGroup/sets/setId1Value/terms/termIdValue"
	if actual != expected {
...
func TestParseGroupSiteTermStoreSetParentGroupSetTermID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/sets/setIdValue/parentGroup/sets/setId1Value/terms/termIdValue/extra",
			Error: true,
		},
	}
