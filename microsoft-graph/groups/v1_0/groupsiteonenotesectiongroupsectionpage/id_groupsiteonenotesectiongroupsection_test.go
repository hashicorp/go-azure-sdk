...
func TestNewGroupSiteOnenoteSectionGroupSectionID(t *testing.T) {
	id := NewGroupSiteOnenoteSectionGroupSectionID("groupIdValue", "siteIdValue", "sectionGroupIdValue", "onenoteSectionIdValue")
...
func TestFormatGroupSiteOnenoteSectionGroupSectionID(t *testing.T) {
	actual := NewGroupSiteOnenoteSectionGroupSectionID("groupIdValue", "siteIdValue", "sectionGroupIdValue", "onenoteSectionIdValue").ID()
...
func TestParseGroupSiteOnenoteSectionGroupSectionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteOnenoteSectionGroupSectionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteOnenoteSectionGroupSectionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteOnenoteSectionGroupSectionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteOnenoteSectionGroupSectionId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteOnenoteSectionGroupSectionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteOnenoteSectionGroupSectionId(t *testing.T) {
	segments := GroupSiteOnenoteSectionGroupSectionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteOnenoteSectionGroupSectionId has no segments")
	}
