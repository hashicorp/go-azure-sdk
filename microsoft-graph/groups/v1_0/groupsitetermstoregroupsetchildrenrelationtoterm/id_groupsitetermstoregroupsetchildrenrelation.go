...
func NewGroupSiteTermStoreGroupSetChildrenRelationID(groupId string, siteId string, storeId string, groupId1 string, setId string, termId string, relationId string) GroupSiteTermStoreGroupSetChildrenRelationId {
...
func (id GroupSiteTermStoreGroupSetChildrenRelationId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStores/%s/groups/%s/sets/%s/children/%s/relations/%s"
