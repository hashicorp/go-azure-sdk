...
func TestNewGroupSiteTermStoreGroupSetChildrenRelationID(t *testing.T) {
	id := NewGroupSiteTermStoreGroupSetChildrenRelationID("groupIdValue", "siteIdValue", "storeIdValue", "groupId1Value", "setIdValue", "termIdValue", "relationIdValue")
...
func TestFormatGroupSiteTermStoreGroupSetChildrenRelationID(t *testing.T) {
	actual := NewGroupSiteTermStoreGroupSetChildrenRelationID("groupIdValue", "siteIdValue", "storeIdValue", "groupId1Value", "setIdValue", "termIdValue", "relationIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/children/termIdValue/relations/relationIdValue"
	if actual != expected {
...
func TestParseGroupSiteTermStoreGroupSetChildrenRelationID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/children/termIdValue/relations",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/children/termIdValue/relations/relationIdValue",
			Expected: &GroupSiteTermStoreGroupSetChildrenRelationId{
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/groups/groupId1Value/sets/setIdValue/children/termIdValue/relations/relationIdValue/extra",
			Error: true,
		},
	}
