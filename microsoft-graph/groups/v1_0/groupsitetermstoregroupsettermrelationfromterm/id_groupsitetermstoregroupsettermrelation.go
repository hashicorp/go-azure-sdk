...
func NewGroupSiteTermStoreGroupSetTermRelationID(groupId string, siteId string, groupId1 string, setId string, termId string, relationId string) GroupSiteTermStoreGroupSetTermRelationId {
...
func (id GroupSiteTermStoreGroupSetTermRelationId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStore/groups/%s/sets/%s/terms/%s/relations/%s"
