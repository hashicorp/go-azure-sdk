...
func TestNewGroupSiteTermStoreSetChildrenChildrenID(t *testing.T) {
	id := NewGroupSiteTermStoreSetChildrenChildrenID("groupIdValue", "siteIdValue", "setIdValue", "termIdValue", "termId1Value")
...
func TestFormatGroupSiteTermStoreSetChildrenChildrenID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetChildrenChildrenID("groupIdValue", "siteIdValue", "setIdValue", "termIdValue", "termId1Value").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/children/termIdValue/children/termId1Value"
	if actual != expected {
...
func TestParseGroupSiteTermStoreSetChildrenChildrenID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStore/sets/setIdValue/children/termIdValue/children/termId1Value/extra",
			Error: true,
		},
	}
