...
func TestNewGroupSiteTermStoreSetTermRelationID(t *testing.T) {
	id := NewGroupSiteTermStoreSetTermRelationID("groupIdValue", "siteIdValue", "setIdValue", "termIdValue", "relationIdValue")
...
func TestFormatGroupSiteTermStoreSetTermRelationID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetTermRelationID("groupIdValue", "siteIdValue", "setIdValue", "termIdValue", "relationIdValue").ID()
