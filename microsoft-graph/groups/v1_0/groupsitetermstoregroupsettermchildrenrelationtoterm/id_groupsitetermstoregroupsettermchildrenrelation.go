...
func NewGroupSiteTermStoreGroupSetTermChildrenRelationID(groupId string, siteId string, storeId string, groupId1 string, setId string, termId string, termId1 string, relationId string) GroupSiteTermStoreGroupSetTermChildrenRelationId {
...
func (id GroupSiteTermStoreGroupSetTermChildrenRelationId) ID() string {
	fmtString := "/groups/%s/sites/%s/termStores/%s/groups/%s/sets/%s/terms/%s/children/%s/relations/%s"
