...
func TestNewGroupTeamPrimaryChannelMessageReplyHostedContentID(t *testing.T) {
	id := NewGroupTeamPrimaryChannelMessageReplyHostedContentID("groupIdValue", "chatMessageIdValue", "chatMessageId1Value", "chatMessageHostedContentIdValue")
...
func TestFormatGroupTeamPrimaryChannelMessageReplyHostedContentID(t *testing.T) {
	actual := NewGroupTeamPrimaryChannelMessageReplyHostedContentID("groupIdValue", "chatMessageIdValue", "chatMessageId1Value", "chatMessageHostedContentIdValue").ID()
...
func TestParseGroupTeamPrimaryChannelMessageReplyHostedContentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamPrimaryChannelMessageReplyHostedContentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamPrimaryChannelMessageReplyHostedContentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupTeamPrimaryChannelMessageReplyHostedContentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupTeamPrimaryChannelMessageReplyHostedContentId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupTeamPrimaryChannelMessageReplyHostedContentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupTeamPrimaryChannelMessageReplyHostedContentId(t *testing.T) {
	segments := GroupTeamPrimaryChannelMessageReplyHostedContentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupTeamPrimaryChannelMessageReplyHostedContentId has no segments")
	}
