...
func TestNewGroupSiteContentTypeColumnID(t *testing.T) {
	id := NewGroupSiteContentTypeColumnID("groupIdValue", "siteIdValue", "contentTypeIdValue", "columnDefinitionIdValue")
...
func TestFormatGroupSiteContentTypeColumnID(t *testing.T) {
	actual := NewGroupSiteContentTypeColumnID("groupIdValue", "siteIdValue", "contentTypeIdValue", "columnDefinitionIdValue").ID()
...
func TestParseGroupSiteContentTypeColumnID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteContentTypeColumnId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteContentTypeColumnID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteContentTypeColumnIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteContentTypeColumnId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteContentTypeColumnIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteContentTypeColumnId(t *testing.T) {
	segments := GroupSiteContentTypeColumnId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteContentTypeColumnId has no segments")
	}
