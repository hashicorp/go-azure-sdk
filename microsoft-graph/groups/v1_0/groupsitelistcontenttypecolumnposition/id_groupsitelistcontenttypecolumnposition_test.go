...
func TestNewGroupSiteListContentTypeColumnPositionID(t *testing.T) {
	id := NewGroupSiteListContentTypeColumnPositionID("groupIdValue", "siteIdValue", "listIdValue", "contentTypeIdValue", "columnDefinitionIdValue")
...
func TestFormatGroupSiteListContentTypeColumnPositionID(t *testing.T) {
	actual := NewGroupSiteListContentTypeColumnPositionID("groupIdValue", "siteIdValue", "listIdValue", "contentTypeIdValue", "columnDefinitionIdValue").ID()
...
func TestParseGroupSiteListContentTypeColumnPositionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteListContentTypeColumnPositionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteListContentTypeColumnPositionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteListContentTypeColumnPositionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteListContentTypeColumnPositionId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteListContentTypeColumnPositionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteListContentTypeColumnPositionId(t *testing.T) {
	segments := GroupSiteListContentTypeColumnPositionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteListContentTypeColumnPositionId has no segments")
	}
