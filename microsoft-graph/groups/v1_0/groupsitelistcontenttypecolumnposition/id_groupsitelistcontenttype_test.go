...
func TestNewGroupSiteListContentTypeID(t *testing.T) {
	id := NewGroupSiteListContentTypeID("groupIdValue", "siteIdValue", "listIdValue", "contentTypeIdValue")
...
func TestFormatGroupSiteListContentTypeID(t *testing.T) {
	actual := NewGroupSiteListContentTypeID("groupIdValue", "siteIdValue", "listIdValue", "contentTypeIdValue").ID()
...
func TestParseGroupSiteListContentTypeID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteListContentTypeId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteListContentTypeID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteListContentTypeIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteListContentTypeId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteListContentTypeIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteListContentTypeId(t *testing.T) {
	segments := GroupSiteListContentTypeId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteListContentTypeId has no segments")
	}
