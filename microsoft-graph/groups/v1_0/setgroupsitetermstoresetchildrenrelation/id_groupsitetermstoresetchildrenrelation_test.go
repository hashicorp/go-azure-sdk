package setgroupsitetermstoresetchildrenrelation
...
func TestNewGroupSiteTermStoreSetChildrenRelationID(t *testing.T) {
	id := NewGroupSiteTermStoreSetChildrenRelationID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "termIdValue", "relationIdValue")
...
func TestFormatGroupSiteTermStoreSetChildrenRelationID(t *testing.T) {
	actual := NewGroupSiteTermStoreSetChildrenRelationID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "termIdValue", "relationIdValue").ID()
