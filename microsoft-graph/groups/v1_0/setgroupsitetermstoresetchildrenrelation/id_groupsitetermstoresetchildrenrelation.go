...
func NewGroupSiteTermStoreSetChildrenRelationID(groupId string, siteId string, storeId string, setId string, termId string, relationId string) GroupSiteTermStoreSetChildrenRelationId {
