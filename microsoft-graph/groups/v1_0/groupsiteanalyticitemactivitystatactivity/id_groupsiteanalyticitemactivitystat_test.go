...
func TestNewGroupSiteAnalyticItemActivityStatID(t *testing.T) {
	id := NewGroupSiteAnalyticItemActivityStatID("groupIdValue", "siteIdValue", "itemActivityStatIdValue")
...
func TestFormatGroupSiteAnalyticItemActivityStatID(t *testing.T) {
	actual := NewGroupSiteAnalyticItemActivityStatID("groupIdValue", "siteIdValue", "itemActivityStatIdValue").ID()
...
func TestParseGroupSiteAnalyticItemActivityStatID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteAnalyticItemActivityStatId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteAnalyticItemActivityStatID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupSiteAnalyticItemActivityStatIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupSiteAnalyticItemActivityStatId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupSiteAnalyticItemActivityStatIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupSiteAnalyticItemActivityStatId(t *testing.T) {
	segments := GroupSiteAnalyticItemActivityStatId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupSiteAnalyticItemActivityStatId has no segments")
	}
