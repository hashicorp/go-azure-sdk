...
func TestNewRoleManagementDeviceManagementRoleAssignmentAppScopeID(t *testing.T) {
	id := NewRoleManagementDeviceManagementRoleAssignmentAppScopeID("unifiedRoleAssignmentMultipleIdValue", "appScopeIdValue")
...
func TestFormatRoleManagementDeviceManagementRoleAssignmentAppScopeID(t *testing.T) {
	actual := NewRoleManagementDeviceManagementRoleAssignmentAppScopeID("unifiedRoleAssignmentMultipleIdValue", "appScopeIdValue").ID()
...
func TestParseRoleManagementDeviceManagementRoleAssignmentAppScopeID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementDeviceManagementRoleAssignmentAppScopeId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementDeviceManagementRoleAssignmentAppScopeID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseRoleManagementDeviceManagementRoleAssignmentAppScopeIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementDeviceManagementRoleAssignmentAppScopeId
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementDeviceManagementRoleAssignmentAppScopeIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForRoleManagementDeviceManagementRoleAssignmentAppScopeId(t *testing.T) {
	segments := RoleManagementDeviceManagementRoleAssignmentAppScopeId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("RoleManagementDeviceManagementRoleAssignmentAppScopeId has no segments")
	}
