...
// roleManagement
func (c ExchangeResourceNamespaceResourceActionResourceScopeClient) UpdateExchangeResourceNamespaceResourceActionResourceScope(ctx context.Context, id beta.RoleManagementExchangeResourceNamespaceIdResourceActionId, input beta.UnifiedRbacResourceScope) (result UpdateExchangeResourceNamespaceResourceActionResourceScopeOperationResponse, err error) {
