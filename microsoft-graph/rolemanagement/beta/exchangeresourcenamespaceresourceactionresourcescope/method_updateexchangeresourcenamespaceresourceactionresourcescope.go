...
// UpdateExchangeResourceNamespaceResourceActionResourceScope ...
func (c ExchangeResourceNamespaceResourceActionResourceScopeClient) UpdateExchangeResourceNamespaceResourceActionResourceScope(ctx context.Context, id RoleManagementExchangeResourceNamespaceIdResourceActionId, input beta.UnifiedRbacResourceScope) (result UpdateExchangeResourceNamespaceResourceActionResourceScopeOperationResponse, err error) {
