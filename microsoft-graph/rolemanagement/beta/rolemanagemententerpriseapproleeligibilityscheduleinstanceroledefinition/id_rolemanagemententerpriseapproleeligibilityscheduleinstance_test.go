...
func TestNewRoleManagementEnterpriseAppRoleEligibilityScheduleInstanceID(t *testing.T) {
	id := NewRoleManagementEnterpriseAppRoleEligibilityScheduleInstanceID("rbacApplicationIdValue", "unifiedRoleEligibilityScheduleInstanceIdValue")
...
func TestFormatRoleManagementEnterpriseAppRoleEligibilityScheduleInstanceID(t *testing.T) {
	actual := NewRoleManagementEnterpriseAppRoleEligibilityScheduleInstanceID("rbacApplicationIdValue", "unifiedRoleEligibilityScheduleInstanceIdValue").ID()
...
func TestParseRoleManagementEnterpriseAppRoleEligibilityScheduleInstanceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementEnterpriseAppRoleEligibilityScheduleInstanceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementEnterpriseAppRoleEligibilityScheduleInstanceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseRoleManagementEnterpriseAppRoleEligibilityScheduleInstanceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementEnterpriseAppRoleEligibilityScheduleInstanceId
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementEnterpriseAppRoleEligibilityScheduleInstanceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForRoleManagementEnterpriseAppRoleEligibilityScheduleInstanceId(t *testing.T) {
	segments := RoleManagementEnterpriseAppRoleEligibilityScheduleInstanceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("RoleManagementEnterpriseAppRoleEligibilityScheduleInstanceId has no segments")
	}
