...
func (c EntitlementManagementClient) UpdateEntitlementManagement(ctx context.Context, input beta.RbacApplication) (result UpdateEntitlementManagementOperationResponse, err error) {
