...
func (c EnterpriseAppResourceNamespaceResourceActionResourceScopeClient) DeleteEnterpriseAppResourceNamespaceResourceActionResourceScope(ctx context.Context, id RoleManagementEnterpriseAppIdResourceNamespaceIdResourceActionId) (result DeleteEnterpriseAppResourceNamespaceResourceActionResourceScopeOperationResponse, err error) {
