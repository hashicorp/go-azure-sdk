...
func (c EnterpriseAppResourceNamespaceResourceActionResourceScopeClient) UpdateEnterpriseAppResourceNamespaceResourceActionResourceScope(ctx context.Context, id RoleManagementEnterpriseAppIdResourceNamespaceIdResourceActionId, input beta.UnifiedRbacResourceScope) (result UpdateEnterpriseAppResourceNamespaceResourceActionResourceScopeOperationResponse, err error) {
