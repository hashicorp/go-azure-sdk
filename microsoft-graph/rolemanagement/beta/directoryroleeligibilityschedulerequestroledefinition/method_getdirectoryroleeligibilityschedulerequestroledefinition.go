...
func (c DirectoryRoleEligibilityScheduleRequestRoleDefinitionClient) GetDirectoryRoleEligibilityScheduleRequestRoleDefinition(ctx context.Context, id RoleManagementDirectoryRoleEligibilityScheduleRequestId) (result GetDirectoryRoleEligibilityScheduleRequestRoleDefinitionOperationResponse, err error) {
