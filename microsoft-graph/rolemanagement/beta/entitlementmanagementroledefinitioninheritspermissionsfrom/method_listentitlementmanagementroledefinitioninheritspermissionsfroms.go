...
// ListEntitlementManagementRoleDefinitionInheritsPermissionsFroms ...
func (c EntitlementManagementRoleDefinitionInheritsPermissionsFromClient) ListEntitlementManagementRoleDefinitionInheritsPermissionsFroms(ctx context.Context, id RoleManagementEntitlementManagementRoleDefinitionId) (result ListEntitlementManagementRoleDefinitionInheritsPermissionsFromsOperationResponse, err error) {
...
func (c EntitlementManagementRoleDefinitionInheritsPermissionsFromClient) ListEntitlementManagementRoleDefinitionInheritsPermissionsFromsComplete(ctx context.Context, id RoleManagementEntitlementManagementRoleDefinitionId) (ListEntitlementManagementRoleDefinitionInheritsPermissionsFromsCompleteResult, error) {
	return c.ListEntitlementManagementRoleDefinitionInheritsPermissionsFromsCompleteMatchingPredicate(ctx, id, UnifiedRoleDefinitionOperationPredicate{})
}
...
func (c EntitlementManagementRoleDefinitionInheritsPermissionsFromClient) ListEntitlementManagementRoleDefinitionInheritsPermissionsFromsCompleteMatchingPredicate(ctx context.Context, id RoleManagementEntitlementManagementRoleDefinitionId, predicate UnifiedRoleDefinitionOperationPredicate) (result ListEntitlementManagementRoleDefinitionInheritsPermissionsFromsCompleteResult, err error) {
	items := make([]beta.UnifiedRoleDefinition, 0)

	resp, err := c.ListEntitlementManagementRoleDefinitionInheritsPermissionsFroms(ctx, id)
	if err != nil {
