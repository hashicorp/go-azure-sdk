...
func (c EntitlementManagementRoleDefinitionInheritsPermissionsFromClient) UpdateEntitlementManagementRoleDefinitionInheritsPermissionsFrom(ctx context.Context, id beta.RoleManagementEntitlementManagementRoleDefinitionIdInheritsPermissionsFromId, input beta.UnifiedRoleDefinition) (result UpdateEntitlementManagementRoleDefinitionInheritsPermissionsFromOperationResponse, err error) {
