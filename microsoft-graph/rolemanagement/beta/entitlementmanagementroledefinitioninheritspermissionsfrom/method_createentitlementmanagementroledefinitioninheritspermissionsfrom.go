...
func (c EntitlementManagementRoleDefinitionInheritsPermissionsFromClient) CreateEntitlementManagementRoleDefinitionInheritsPermissionsFrom(ctx context.Context, id beta.RoleManagementEntitlementManagementRoleDefinitionId, input beta.UnifiedRoleDefinition) (result CreateEntitlementManagementRoleDefinitionInheritsPermissionsFromOperationResponse, err error) {
