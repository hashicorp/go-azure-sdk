...
// ListEntitlementManagementTransitiveRoleAssignments ...
func (c EntitlementManagementTransitiveRoleAssignmentClient) ListEntitlementManagementTransitiveRoleAssignments(ctx context.Context) (result ListEntitlementManagementTransitiveRoleAssignmentsOperationResponse, err error) {
...
func (c EntitlementManagementTransitiveRoleAssignmentClient) ListEntitlementManagementTransitiveRoleAssignmentsComplete(ctx context.Context) (ListEntitlementManagementTransitiveRoleAssignmentsCompleteResult, error) {
	return c.ListEntitlementManagementTransitiveRoleAssignmentsCompleteMatchingPredicate(ctx, UnifiedRoleAssignmentOperationPredicate{})
}
...
func (c EntitlementManagementTransitiveRoleAssignmentClient) ListEntitlementManagementTransitiveRoleAssignmentsCompleteMatchingPredicate(ctx context.Context, predicate UnifiedRoleAssignmentOperationPredicate) (result ListEntitlementManagementTransitiveRoleAssignmentsCompleteResult, err error) {
	items := make([]beta.UnifiedRoleAssignment, 0)

	resp, err := c.ListEntitlementManagementTransitiveRoleAssignments(ctx)
	if err != nil {
