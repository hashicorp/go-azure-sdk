...
// UpdateEntitlementManagementTransitiveRoleAssignment ...
func (c EntitlementManagementTransitiveRoleAssignmentClient) UpdateEntitlementManagementTransitiveRoleAssignment(ctx context.Context, id RoleManagementEntitlementManagementTransitiveRoleAssignmentId, input beta.UnifiedRoleAssignment) (result UpdateEntitlementManagementTransitiveRoleAssignmentOperationResponse, err error) {
