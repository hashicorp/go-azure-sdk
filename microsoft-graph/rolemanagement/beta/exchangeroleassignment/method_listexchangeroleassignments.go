...
// ListExchangeRoleAssignments ...
func (c ExchangeRoleAssignmentClient) ListExchangeRoleAssignments(ctx context.Context) (result ListExchangeRoleAssignmentsOperationResponse, err error) {
...
func (c ExchangeRoleAssignmentClient) ListExchangeRoleAssignmentsComplete(ctx context.Context) (ListExchangeRoleAssignmentsCompleteResult, error) {
	return c.ListExchangeRoleAssignmentsCompleteMatchingPredicate(ctx, UnifiedRoleAssignmentOperationPredicate{})
}

// ListExchangeRoleAssignmentsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ExchangeRoleAssignmentClient) ListExchangeRoleAssignmentsCompleteMatchingPredicate(ctx context.Context, predicate UnifiedRoleAssignmentOperationPredicate) (result ListExchangeRoleAssignmentsCompleteResult, err error) {
	items := make([]beta.UnifiedRoleAssignment, 0)

	resp, err := c.ListExchangeRoleAssignments(ctx)
	if err != nil {
