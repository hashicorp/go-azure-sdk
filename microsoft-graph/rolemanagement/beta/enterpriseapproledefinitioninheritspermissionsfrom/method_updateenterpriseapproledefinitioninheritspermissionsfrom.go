...
// UpdateEnterpriseAppRoleDefinitionInheritsPermissionsFrom ...
func (c EnterpriseAppRoleDefinitionInheritsPermissionsFromClient) UpdateEnterpriseAppRoleDefinitionInheritsPermissionsFrom(ctx context.Context, id RoleManagementEnterpriseAppIdRoleDefinitionIdInheritsPermissionsFromId, input beta.UnifiedRoleDefinition) (result UpdateEnterpriseAppRoleDefinitionInheritsPermissionsFromOperationResponse, err error) {
