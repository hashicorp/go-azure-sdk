...
// UpdateEnterpriseAppRoleAssignmentScheduleRequest ...
func (c EnterpriseAppRoleAssignmentScheduleRequestClient) UpdateEnterpriseAppRoleAssignmentScheduleRequest(ctx context.Context, id RoleManagementEnterpriseAppIdRoleAssignmentScheduleRequestId, input beta.UnifiedRoleAssignmentScheduleRequest) (result UpdateEnterpriseAppRoleAssignmentScheduleRequestOperationResponse, err error) {
