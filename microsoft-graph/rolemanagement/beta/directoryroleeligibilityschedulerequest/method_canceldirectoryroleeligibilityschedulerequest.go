...
func (c DirectoryRoleEligibilityScheduleRequestClient) CancelDirectoryRoleEligibilityScheduleRequest(ctx context.Context, id beta.RoleManagementDirectoryRoleEligibilityScheduleRequestId) (result CancelDirectoryRoleEligibilityScheduleRequestOperationResponse, err error) {
