...
func TestNewRoleManagementExchangeResourceNamespaceResourceActionID(t *testing.T) {
	id := NewRoleManagementExchangeResourceNamespaceResourceActionID("unifiedRbacResourceNamespaceIdValue", "unifiedRbacResourceActionIdValue")
...
func TestFormatRoleManagementExchangeResourceNamespaceResourceActionID(t *testing.T) {
	actual := NewRoleManagementExchangeResourceNamespaceResourceActionID("unifiedRbacResourceNamespaceIdValue", "unifiedRbacResourceActionIdValue").ID()
...
func TestParseRoleManagementExchangeResourceNamespaceResourceActionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementExchangeResourceNamespaceResourceActionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementExchangeResourceNamespaceResourceActionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseRoleManagementExchangeResourceNamespaceResourceActionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementExchangeResourceNamespaceResourceActionId
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementExchangeResourceNamespaceResourceActionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForRoleManagementExchangeResourceNamespaceResourceActionId(t *testing.T) {
	segments := RoleManagementExchangeResourceNamespaceResourceActionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("RoleManagementExchangeResourceNamespaceResourceActionId has no segments")
	}
