...
// CreateEnterpriseAppResourceNamespaceImportResourceAction ...
func (c EnterpriseAppResourceNamespaceClient) CreateEnterpriseAppResourceNamespaceImportResourceAction(ctx context.Context, id RoleManagementEnterpriseAppIdResourceNamespaceId, input CreateEnterpriseAppResourceNamespaceImportResourceActionRequest) (result CreateEnterpriseAppResourceNamespaceImportResourceActionOperationResponse, err error) {
