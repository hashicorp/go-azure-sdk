...
// ListEnterpriseAppRoleAssignmentScheduleInstances ...
func (c EnterpriseAppRoleAssignmentScheduleInstanceClient) ListEnterpriseAppRoleAssignmentScheduleInstances(ctx context.Context, id RoleManagementEnterpriseAppId) (result ListEnterpriseAppRoleAssignmentScheduleInstancesOperationResponse, err error) {
...
func (c EnterpriseAppRoleAssignmentScheduleInstanceClient) ListEnterpriseAppRoleAssignmentScheduleInstancesComplete(ctx context.Context, id RoleManagementEnterpriseAppId) (ListEnterpriseAppRoleAssignmentScheduleInstancesCompleteResult, error) {
	return c.ListEnterpriseAppRoleAssignmentScheduleInstancesCompleteMatchingPredicate(ctx, id, UnifiedRoleAssignmentScheduleInstanceOperationPredicate{})
}
...
func (c EnterpriseAppRoleAssignmentScheduleInstanceClient) ListEnterpriseAppRoleAssignmentScheduleInstancesCompleteMatchingPredicate(ctx context.Context, id RoleManagementEnterpriseAppId, predicate UnifiedRoleAssignmentScheduleInstanceOperationPredicate) (result ListEnterpriseAppRoleAssignmentScheduleInstancesCompleteResult, err error) {
	items := make([]beta.UnifiedRoleAssignmentScheduleInstance, 0)

	resp, err := c.ListEnterpriseAppRoleAssignmentScheduleInstances(ctx, id)
	if err != nil {
