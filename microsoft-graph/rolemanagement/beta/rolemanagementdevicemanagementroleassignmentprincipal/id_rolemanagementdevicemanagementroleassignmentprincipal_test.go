...
func TestNewRoleManagementDeviceManagementRoleAssignmentPrincipalID(t *testing.T) {
	id := NewRoleManagementDeviceManagementRoleAssignmentPrincipalID("unifiedRoleAssignmentMultipleIdValue", "directoryObjectIdValue")
...
func TestFormatRoleManagementDeviceManagementRoleAssignmentPrincipalID(t *testing.T) {
	actual := NewRoleManagementDeviceManagementRoleAssignmentPrincipalID("unifiedRoleAssignmentMultipleIdValue", "directoryObjectIdValue").ID()
...
func TestParseRoleManagementDeviceManagementRoleAssignmentPrincipalID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementDeviceManagementRoleAssignmentPrincipalId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementDeviceManagementRoleAssignmentPrincipalID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseRoleManagementDeviceManagementRoleAssignmentPrincipalIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementDeviceManagementRoleAssignmentPrincipalId
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementDeviceManagementRoleAssignmentPrincipalIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForRoleManagementDeviceManagementRoleAssignmentPrincipalId(t *testing.T) {
	segments := RoleManagementDeviceManagementRoleAssignmentPrincipalId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("RoleManagementDeviceManagementRoleAssignmentPrincipalId has no segments")
	}
