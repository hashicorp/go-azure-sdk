...
func ParseRoleManagementExchangeCustomAppScopeID(input string) (*RoleManagementExchangeCustomAppScopeId, error) {
	...
	if id.CustomAppScopeId, ok = parsed.Parsed["customAppScopeId"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "customAppScopeId", *parsed)
	}
...
func (id RoleManagementExchangeCustomAppScopeId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.StaticSegment("staticCustomAppScopes", "customAppScopes", "customAppScopes"),
