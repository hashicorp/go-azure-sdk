...
func TestNewRoleManagementDirectoryResourceNamespaceResourceActionID(t *testing.T) {
	id := NewRoleManagementDirectoryResourceNamespaceResourceActionID("unifiedRbacResourceNamespaceIdValue", "unifiedRbacResourceActionIdValue")
...
func TestFormatRoleManagementDirectoryResourceNamespaceResourceActionID(t *testing.T) {
	actual := NewRoleManagementDirectoryResourceNamespaceResourceActionID("unifiedRbacResourceNamespaceIdValue", "unifiedRbacResourceActionIdValue").ID()
...
func TestParseRoleManagementDirectoryResourceNamespaceResourceActionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementDirectoryResourceNamespaceResourceActionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementDirectoryResourceNamespaceResourceActionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseRoleManagementDirectoryResourceNamespaceResourceActionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementDirectoryResourceNamespaceResourceActionId
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementDirectoryResourceNamespaceResourceActionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForRoleManagementDirectoryResourceNamespaceResourceActionId(t *testing.T) {
	segments := RoleManagementDirectoryResourceNamespaceResourceActionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("RoleManagementDirectoryResourceNamespaceResourceActionId has no segments")
	}
