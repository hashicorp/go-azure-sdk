...
func TestNewRoleManagementEnterpriseAppResourceNamespaceID(t *testing.T) {
	id := NewRoleManagementEnterpriseAppResourceNamespaceID("rbacApplicationIdValue", "unifiedRbacResourceNamespaceIdValue")
...
func TestFormatRoleManagementEnterpriseAppResourceNamespaceID(t *testing.T) {
	actual := NewRoleManagementEnterpriseAppResourceNamespaceID("rbacApplicationIdValue", "unifiedRbacResourceNamespaceIdValue").ID()
...
func TestParseRoleManagementEnterpriseAppResourceNamespaceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementEnterpriseAppResourceNamespaceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementEnterpriseAppResourceNamespaceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseRoleManagementEnterpriseAppResourceNamespaceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementEnterpriseAppResourceNamespaceId
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementEnterpriseAppResourceNamespaceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForRoleManagementEnterpriseAppResourceNamespaceId(t *testing.T) {
	segments := RoleManagementEnterpriseAppResourceNamespaceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("RoleManagementEnterpriseAppResourceNamespaceId has no segments")
	}
