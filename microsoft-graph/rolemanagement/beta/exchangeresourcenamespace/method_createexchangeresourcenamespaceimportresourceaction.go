...
// CreateExchangeResourceNamespaceImportResourceAction ...
func (c ExchangeResourceNamespaceClient) CreateExchangeResourceNamespaceImportResourceAction(ctx context.Context, id RoleManagementExchangeResourceNamespaceId, input CreateExchangeResourceNamespaceImportResourceActionRequest) (result CreateExchangeResourceNamespaceImportResourceActionOperationResponse, err error) {
