...
// GetEntitlementManagementResourceNamespaceResourceActionResourceScope ...
func (c EntitlementManagementResourceNamespaceResourceActionResourceScopeClient) GetEntitlementManagementResourceNamespaceResourceActionResourceScope(ctx context.Context, id RoleManagementEntitlementManagementResourceNamespaceIdResourceActionId) (result GetEntitlementManagementResourceNamespaceResourceActionResourceScopeOperationResponse, err error) {
