...
func TestNewRoleManagementDirectoryRoleDefinitionInheritsPermissionsFromID(t *testing.T) {
	id := NewRoleManagementDirectoryRoleDefinitionInheritsPermissionsFromID("unifiedRoleDefinitionIdValue", "unifiedRoleDefinitionId1Value")
...
func TestFormatRoleManagementDirectoryRoleDefinitionInheritsPermissionsFromID(t *testing.T) {
	actual := NewRoleManagementDirectoryRoleDefinitionInheritsPermissionsFromID("unifiedRoleDefinitionIdValue", "unifiedRoleDefinitionId1Value").ID()
...
func TestParseRoleManagementDirectoryRoleDefinitionInheritsPermissionsFromID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementDirectoryRoleDefinitionInheritsPermissionsFromId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementDirectoryRoleDefinitionInheritsPermissionsFromID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseRoleManagementDirectoryRoleDefinitionInheritsPermissionsFromIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementDirectoryRoleDefinitionInheritsPermissionsFromId
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementDirectoryRoleDefinitionInheritsPermissionsFromIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForRoleManagementDirectoryRoleDefinitionInheritsPermissionsFromId(t *testing.T) {
	segments := RoleManagementDirectoryRoleDefinitionInheritsPermissionsFromId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("RoleManagementDirectoryRoleDefinitionInheritsPermissionsFromId has no segments")
	}
