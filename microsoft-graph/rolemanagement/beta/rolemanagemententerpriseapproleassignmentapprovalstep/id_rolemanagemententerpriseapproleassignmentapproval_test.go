...
func TestNewRoleManagementEnterpriseAppRoleAssignmentApprovalID(t *testing.T) {
	id := NewRoleManagementEnterpriseAppRoleAssignmentApprovalID("rbacApplicationIdValue", "approvalIdValue")
...
func TestFormatRoleManagementEnterpriseAppRoleAssignmentApprovalID(t *testing.T) {
	actual := NewRoleManagementEnterpriseAppRoleAssignmentApprovalID("rbacApplicationIdValue", "approvalIdValue").ID()
...
func TestParseRoleManagementEnterpriseAppRoleAssignmentApprovalID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementEnterpriseAppRoleAssignmentApprovalId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementEnterpriseAppRoleAssignmentApprovalID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseRoleManagementEnterpriseAppRoleAssignmentApprovalIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementEnterpriseAppRoleAssignmentApprovalId
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementEnterpriseAppRoleAssignmentApprovalIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForRoleManagementEnterpriseAppRoleAssignmentApprovalId(t *testing.T) {
	segments := RoleManagementEnterpriseAppRoleAssignmentApprovalId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("RoleManagementEnterpriseAppRoleAssignmentApprovalId has no segments")
	}
