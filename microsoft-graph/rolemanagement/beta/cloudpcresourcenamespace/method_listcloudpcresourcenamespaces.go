...
// ListCloudPCResourceNamespaces ...
func (c CloudPCResourceNamespaceClient) ListCloudPCResourceNamespaces(ctx context.Context) (result ListCloudPCResourceNamespacesOperationResponse, err error) {
...
func (c CloudPCResourceNamespaceClient) ListCloudPCResourceNamespacesComplete(ctx context.Context) (ListCloudPCResourceNamespacesCompleteResult, error) {
	return c.ListCloudPCResourceNamespacesCompleteMatchingPredicate(ctx, UnifiedRbacResourceNamespaceOperationPredicate{})
}

// ListCloudPCResourceNamespacesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c CloudPCResourceNamespaceClient) ListCloudPCResourceNamespacesCompleteMatchingPredicate(ctx context.Context, predicate UnifiedRbacResourceNamespaceOperationPredicate) (result ListCloudPCResourceNamespacesCompleteResult, err error) {
	items := make([]beta.UnifiedRbacResourceNamespace, 0)

	resp, err := c.ListCloudPCResourceNamespaces(ctx)
	if err != nil {
