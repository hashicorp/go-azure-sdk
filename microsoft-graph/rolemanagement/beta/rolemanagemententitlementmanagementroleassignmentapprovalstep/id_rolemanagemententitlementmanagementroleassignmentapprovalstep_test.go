...
func TestNewRoleManagementEntitlementManagementRoleAssignmentApprovalStepID(t *testing.T) {
	id := NewRoleManagementEntitlementManagementRoleAssignmentApprovalStepID("approvalIdValue", "approvalStepIdValue")
...
func TestFormatRoleManagementEntitlementManagementRoleAssignmentApprovalStepID(t *testing.T) {
	actual := NewRoleManagementEntitlementManagementRoleAssignmentApprovalStepID("approvalIdValue", "approvalStepIdValue").ID()
...
func TestParseRoleManagementEntitlementManagementRoleAssignmentApprovalStepID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementEntitlementManagementRoleAssignmentApprovalStepId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementEntitlementManagementRoleAssignmentApprovalStepID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseRoleManagementEntitlementManagementRoleAssignmentApprovalStepIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementEntitlementManagementRoleAssignmentApprovalStepId
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementEntitlementManagementRoleAssignmentApprovalStepIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForRoleManagementEntitlementManagementRoleAssignmentApprovalStepId(t *testing.T) {
	segments := RoleManagementEntitlementManagementRoleAssignmentApprovalStepId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("RoleManagementEntitlementManagementRoleAssignmentApprovalStepId has no segments")
	}
