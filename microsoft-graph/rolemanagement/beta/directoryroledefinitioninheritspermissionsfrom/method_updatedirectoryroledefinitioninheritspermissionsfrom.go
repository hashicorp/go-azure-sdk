...
func (c DirectoryRoleDefinitionInheritsPermissionsFromClient) UpdateDirectoryRoleDefinitionInheritsPermissionsFrom(ctx context.Context, id RoleManagementDirectoryRoleDefinitionIdInheritsPermissionsFromId, input beta.UnifiedRoleDefinition) (result UpdateDirectoryRoleDefinitionInheritsPermissionsFromOperationResponse, err error) {
