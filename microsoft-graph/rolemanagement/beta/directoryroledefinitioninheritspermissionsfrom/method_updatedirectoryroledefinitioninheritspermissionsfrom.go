...
// roleManagement
func (c DirectoryRoleDefinitionInheritsPermissionsFromClient) UpdateDirectoryRoleDefinitionInheritsPermissionsFrom(ctx context.Context, id beta.RoleManagementDirectoryRoleDefinitionIdInheritsPermissionsFromId, input beta.UnifiedRoleDefinition) (result UpdateDirectoryRoleDefinitionInheritsPermissionsFromOperationResponse, err error) {
