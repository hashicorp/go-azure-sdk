...
// roleManagement
func (c DirectoryRoleDefinitionInheritsPermissionsFromClient) CreateDirectoryRoleDefinitionInheritsPermissionsFrom(ctx context.Context, id beta.RoleManagementDirectoryRoleDefinitionId, input beta.UnifiedRoleDefinition) (result CreateDirectoryRoleDefinitionInheritsPermissionsFromOperationResponse, err error) {
