...
// GetEnterpriseAppRoleEligibilityScheduleRequestDirectoryScope ...
func (c EnterpriseAppRoleEligibilityScheduleRequestDirectoryScopeClient) GetEnterpriseAppRoleEligibilityScheduleRequestDirectoryScope(ctx context.Context, id RoleManagementEnterpriseAppIdRoleEligibilityScheduleRequestId) (result GetEnterpriseAppRoleEligibilityScheduleRequestDirectoryScopeOperationResponse, err error) {
