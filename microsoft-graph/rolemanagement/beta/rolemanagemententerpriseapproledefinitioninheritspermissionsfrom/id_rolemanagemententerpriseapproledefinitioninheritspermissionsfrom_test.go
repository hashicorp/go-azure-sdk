...
func TestNewRoleManagementEnterpriseAppRoleDefinitionInheritsPermissionsFromID(t *testing.T) {
	id := NewRoleManagementEnterpriseAppRoleDefinitionInheritsPermissionsFromID("rbacApplicationIdValue", "unifiedRoleDefinitionIdValue", "unifiedRoleDefinitionId1Value")
...
func TestFormatRoleManagementEnterpriseAppRoleDefinitionInheritsPermissionsFromID(t *testing.T) {
	actual := NewRoleManagementEnterpriseAppRoleDefinitionInheritsPermissionsFromID("rbacApplicationIdValue", "unifiedRoleDefinitionIdValue", "unifiedRoleDefinitionId1Value").ID()
...
func TestParseRoleManagementEnterpriseAppRoleDefinitionInheritsPermissionsFromID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementEnterpriseAppRoleDefinitionInheritsPermissionsFromId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementEnterpriseAppRoleDefinitionInheritsPermissionsFromID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseRoleManagementEnterpriseAppRoleDefinitionInheritsPermissionsFromIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementEnterpriseAppRoleDefinitionInheritsPermissionsFromId
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementEnterpriseAppRoleDefinitionInheritsPermissionsFromIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForRoleManagementEnterpriseAppRoleDefinitionInheritsPermissionsFromId(t *testing.T) {
	segments := RoleManagementEnterpriseAppRoleDefinitionInheritsPermissionsFromId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("RoleManagementEnterpriseAppRoleDefinitionInheritsPermissionsFromId has no segments")
	}
