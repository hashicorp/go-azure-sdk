...
func (c DirectoryResourceNamespaceResourceActionResourceScopeClient) UpdateDirectoryResourceNamespaceResourceActionResourceScope(ctx context.Context, id RoleManagementDirectoryResourceNamespaceIdResourceActionId, input beta.UnifiedRbacResourceScope) (result UpdateDirectoryResourceNamespaceResourceActionResourceScopeOperationResponse, err error) {
