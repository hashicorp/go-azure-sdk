...
// UpdateExchangeRoleDefinitionInheritsPermissionsFrom ...
func (c ExchangeRoleDefinitionInheritsPermissionsFromClient) UpdateExchangeRoleDefinitionInheritsPermissionsFrom(ctx context.Context, id RoleManagementExchangeRoleDefinitionIdInheritsPermissionsFromId, input beta.UnifiedRoleDefinition) (result UpdateExchangeRoleDefinitionInheritsPermissionsFromOperationResponse, err error) {
