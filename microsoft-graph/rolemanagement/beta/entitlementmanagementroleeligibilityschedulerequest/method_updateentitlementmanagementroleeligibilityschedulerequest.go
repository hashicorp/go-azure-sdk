...
func (c EntitlementManagementRoleEligibilityScheduleRequestClient) UpdateEntitlementManagementRoleEligibilityScheduleRequest(ctx context.Context, id beta.RoleManagementEntitlementManagementRoleEligibilityScheduleRequestId, input beta.UnifiedRoleEligibilityScheduleRequest) (result UpdateEntitlementManagementRoleEligibilityScheduleRequestOperationResponse, err error) {
