...
func (c EntitlementManagementRoleEligibilityScheduleRequestClient) DeleteEntitlementManagementRoleEligibilityScheduleRequest(ctx context.Context, id RoleManagementEntitlementManagementRoleEligibilityScheduleRequestId) (result DeleteEntitlementManagementRoleEligibilityScheduleRequestOperationResponse, err error) {
