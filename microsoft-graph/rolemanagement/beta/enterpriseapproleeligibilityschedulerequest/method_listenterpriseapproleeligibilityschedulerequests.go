...
// ListEnterpriseAppRoleEligibilityScheduleRequests ...
func (c EnterpriseAppRoleEligibilityScheduleRequestClient) ListEnterpriseAppRoleEligibilityScheduleRequests(ctx context.Context, id RoleManagementEnterpriseAppId) (result ListEnterpriseAppRoleEligibilityScheduleRequestsOperationResponse, err error) {
...
func (c EnterpriseAppRoleEligibilityScheduleRequestClient) ListEnterpriseAppRoleEligibilityScheduleRequestsComplete(ctx context.Context, id RoleManagementEnterpriseAppId) (ListEnterpriseAppRoleEligibilityScheduleRequestsCompleteResult, error) {
	return c.ListEnterpriseAppRoleEligibilityScheduleRequestsCompleteMatchingPredicate(ctx, id, UnifiedRoleEligibilityScheduleRequestOperationPredicate{})
}
