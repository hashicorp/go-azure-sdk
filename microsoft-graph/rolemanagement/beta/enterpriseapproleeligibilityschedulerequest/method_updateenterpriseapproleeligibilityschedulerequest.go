...
// UpdateEnterpriseAppRoleEligibilityScheduleRequest ...
func (c EnterpriseAppRoleEligibilityScheduleRequestClient) UpdateEnterpriseAppRoleEligibilityScheduleRequest(ctx context.Context, id RoleManagementEnterpriseAppIdRoleEligibilityScheduleRequestId, input beta.UnifiedRoleEligibilityScheduleRequest) (result UpdateEnterpriseAppRoleEligibilityScheduleRequestOperationResponse, err error) {
