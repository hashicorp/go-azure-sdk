...
// ListEntitlementManagementRoleAssignmentScheduleRequests ...
func (c EntitlementManagementRoleAssignmentScheduleRequestClient) ListEntitlementManagementRoleAssignmentScheduleRequests(ctx context.Context) (result ListEntitlementManagementRoleAssignmentScheduleRequestsOperationResponse, err error) {
...
func (c EntitlementManagementRoleAssignmentScheduleRequestClient) ListEntitlementManagementRoleAssignmentScheduleRequestsComplete(ctx context.Context) (ListEntitlementManagementRoleAssignmentScheduleRequestsCompleteResult, error) {
	return c.ListEntitlementManagementRoleAssignmentScheduleRequestsCompleteMatchingPredicate(ctx, UnifiedRoleAssignmentScheduleRequestOperationPredicate{})
}
