...
func TestNewRoleManagementDeviceManagementRoleAssignmentDirectoryScopeID(t *testing.T) {
	id := NewRoleManagementDeviceManagementRoleAssignmentDirectoryScopeID("unifiedRoleAssignmentMultipleIdValue", "directoryObjectIdValue")
...
func TestFormatRoleManagementDeviceManagementRoleAssignmentDirectoryScopeID(t *testing.T) {
	actual := NewRoleManagementDeviceManagementRoleAssignmentDirectoryScopeID("unifiedRoleAssignmentMultipleIdValue", "directoryObjectIdValue").ID()
...
func TestParseRoleManagementDeviceManagementRoleAssignmentDirectoryScopeID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementDeviceManagementRoleAssignmentDirectoryScopeId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementDeviceManagementRoleAssignmentDirectoryScopeID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseRoleManagementDeviceManagementRoleAssignmentDirectoryScopeIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementDeviceManagementRoleAssignmentDirectoryScopeId
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementDeviceManagementRoleAssignmentDirectoryScopeIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForRoleManagementDeviceManagementRoleAssignmentDirectoryScopeId(t *testing.T) {
	segments := RoleManagementDeviceManagementRoleAssignmentDirectoryScopeId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("RoleManagementDeviceManagementRoleAssignmentDirectoryScopeId has no segments")
	}
