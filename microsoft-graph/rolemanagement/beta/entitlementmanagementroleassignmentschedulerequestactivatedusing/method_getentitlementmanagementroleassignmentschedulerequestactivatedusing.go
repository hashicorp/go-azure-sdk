...
func (c EntitlementManagementRoleAssignmentScheduleRequestActivatedUsingClient) GetEntitlementManagementRoleAssignmentScheduleRequestActivatedUsing(ctx context.Context, id RoleManagementEntitlementManagementRoleAssignmentScheduleRequestId) (result GetEntitlementManagementRoleAssignmentScheduleRequestActivatedUsingOperationResponse, err error) {
