...
// UpdateDeviceManagementResourceNamespaceResourceActionResourceScope ...
func (c DeviceManagementResourceNamespaceResourceActionResourceScopeClient) UpdateDeviceManagementResourceNamespaceResourceActionResourceScope(ctx context.Context, id RoleManagementDeviceManagementResourceNamespaceIdResourceActionId, input beta.UnifiedRbacResourceScope) (result UpdateDeviceManagementResourceNamespaceResourceActionResourceScopeOperationResponse, err error) {
