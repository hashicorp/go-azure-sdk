...
func TestNewRoleManagementEntitlementManagementRoleDefinitionInheritsPermissionsFromID(t *testing.T) {
	id := NewRoleManagementEntitlementManagementRoleDefinitionInheritsPermissionsFromID("unifiedRoleDefinitionIdValue", "unifiedRoleDefinitionId1Value")
...
func TestFormatRoleManagementEntitlementManagementRoleDefinitionInheritsPermissionsFromID(t *testing.T) {
	actual := NewRoleManagementEntitlementManagementRoleDefinitionInheritsPermissionsFromID("unifiedRoleDefinitionIdValue", "unifiedRoleDefinitionId1Value").ID()
...
func TestParseRoleManagementEntitlementManagementRoleDefinitionInheritsPermissionsFromID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementEntitlementManagementRoleDefinitionInheritsPermissionsFromId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementEntitlementManagementRoleDefinitionInheritsPermissionsFromID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseRoleManagementEntitlementManagementRoleDefinitionInheritsPermissionsFromIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *RoleManagementEntitlementManagementRoleDefinitionInheritsPermissionsFromId
	...
	for _, v := range testData {
		...
		actual, err := ParseRoleManagementEntitlementManagementRoleDefinitionInheritsPermissionsFromIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForRoleManagementEntitlementManagementRoleDefinitionInheritsPermissionsFromId(t *testing.T) {
	segments := RoleManagementEntitlementManagementRoleDefinitionInheritsPermissionsFromId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("RoleManagementEntitlementManagementRoleDefinitionInheritsPermissionsFromId has no segments")
	}
