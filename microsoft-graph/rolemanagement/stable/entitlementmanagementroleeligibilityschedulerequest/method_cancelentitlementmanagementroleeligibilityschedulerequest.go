...
func (c EntitlementManagementRoleEligibilityScheduleRequestClient) CancelEntitlementManagementRoleEligibilityScheduleRequest(ctx context.Context, id stable.RoleManagementEntitlementManagementRoleEligibilityScheduleRequestId) (result CancelEntitlementManagementRoleEligibilityScheduleRequestOperationResponse, err error) {
