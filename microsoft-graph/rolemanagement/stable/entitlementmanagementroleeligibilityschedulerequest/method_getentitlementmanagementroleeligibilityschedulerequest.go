...
func (c EntitlementManagementRoleEligibilityScheduleRequestClient) GetEntitlementManagementRoleEligibilityScheduleRequest(ctx context.Context, id RoleManagementEntitlementManagementRoleEligibilityScheduleRequestId) (result GetEntitlementManagementRoleEligibilityScheduleRequestOperationResponse, err error) {
