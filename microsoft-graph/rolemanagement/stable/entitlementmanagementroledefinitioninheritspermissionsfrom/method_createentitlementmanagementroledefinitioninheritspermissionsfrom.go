...
func (c EntitlementManagementRoleDefinitionInheritsPermissionsFromClient) CreateEntitlementManagementRoleDefinitionInheritsPermissionsFrom(ctx context.Context, id RoleManagementEntitlementManagementRoleDefinitionId, input stable.UnifiedRoleDefinition) (result CreateEntitlementManagementRoleDefinitionInheritsPermissionsFromOperationResponse, err error) {
