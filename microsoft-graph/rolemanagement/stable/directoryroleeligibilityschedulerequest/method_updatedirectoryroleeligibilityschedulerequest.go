...
// roleManagement
func (c DirectoryRoleEligibilityScheduleRequestClient) UpdateDirectoryRoleEligibilityScheduleRequest(ctx context.Context, id stable.RoleManagementDirectoryRoleEligibilityScheduleRequestId, input stable.UnifiedRoleEligibilityScheduleRequest) (result UpdateDirectoryRoleEligibilityScheduleRequestOperationResponse, err error) {
