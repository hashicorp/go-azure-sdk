...
// ListEntitlementManagementRoleAssignments ...
...
func (c EntitlementManagementRoleAssignmentClient) ListEntitlementManagementRoleAssignmentsComplete(ctx context.Context) (ListEntitlementManagementRoleAssignmentsCompleteResult, error) {
	return c.ListEntitlementManagementRoleAssignmentsCompleteMatchingPredicate(ctx, UnifiedRoleAssignmentOperationPredicate{})
}
...
func (c EntitlementManagementRoleAssignmentClient) ListEntitlementManagementRoleAssignmentsCompleteMatchingPredicate(ctx context.Context, predicate UnifiedRoleAssignmentOperationPredicate) (result ListEntitlementManagementRoleAssignmentsCompleteResult, err error) {
	items := make([]stable.UnifiedRoleAssignment, 0)

	resp, err := c.ListEntitlementManagementRoleAssignments(ctx)
	if err != nil {
