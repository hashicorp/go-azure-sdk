...
func (c EntitlementManagementRoleAssignmentScheduleDirectoryScopeClient) GetEntitlementManagementRoleAssignmentScheduleDirectoryScope(ctx context.Context, id RoleManagementEntitlementManagementRoleAssignmentScheduleId) (result GetEntitlementManagementRoleAssignmentScheduleDirectoryScopeOperationResponse, err error) {
