...
// roleManagement
func (c DirectoryRoleAssignmentScheduleInstanceClient) UpdateDirectoryRoleAssignmentScheduleInstance(ctx context.Context, id stable.RoleManagementDirectoryRoleAssignmentScheduleInstanceId, input stable.UnifiedRoleAssignmentScheduleInstance) (result UpdateDirectoryRoleAssignmentScheduleInstanceOperationResponse, err error) {
