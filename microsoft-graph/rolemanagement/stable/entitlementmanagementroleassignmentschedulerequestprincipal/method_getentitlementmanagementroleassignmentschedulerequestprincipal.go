...
// GetEntitlementManagementRoleAssignmentScheduleRequestPrincipal ...
func (c EntitlementManagementRoleAssignmentScheduleRequestPrincipalClient) GetEntitlementManagementRoleAssignmentScheduleRequestPrincipal(ctx context.Context, id RoleManagementEntitlementManagementRoleAssignmentScheduleRequestId) (result GetEntitlementManagementRoleAssignmentScheduleRequestPrincipalOperationResponse, err error) {
