...
func (c EntitlementManagementRoleEligibilityScheduleRequestDirectoryScopeClient) GetEntitlementManagementRoleEligibilityScheduleRequestDirectoryScope(ctx context.Context, id RoleManagementEntitlementManagementRoleEligibilityScheduleRequestId) (result GetEntitlementManagementRoleEligibilityScheduleRequestDirectoryScopeOperationResponse, err error) {
