...
func (c DirectoryRoleDefinitionInheritsPermissionsFromClient) CreateDirectoryRoleDefinitionInheritsPermissionsFrom(ctx context.Context, id RoleManagementDirectoryRoleDefinitionId, input stable.UnifiedRoleDefinition) (result CreateDirectoryRoleDefinitionInheritsPermissionsFromOperationResponse, err error) {
