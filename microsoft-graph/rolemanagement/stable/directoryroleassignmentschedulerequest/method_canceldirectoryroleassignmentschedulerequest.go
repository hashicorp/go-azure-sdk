...
func (c DirectoryRoleAssignmentScheduleRequestClient) CancelDirectoryRoleAssignmentScheduleRequest(ctx context.Context, id stable.RoleManagementDirectoryRoleAssignmentScheduleRequestId) (result CancelDirectoryRoleAssignmentScheduleRequestOperationResponse, err error) {
