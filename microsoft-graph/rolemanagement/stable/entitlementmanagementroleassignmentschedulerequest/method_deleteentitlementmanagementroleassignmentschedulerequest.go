...
// DeleteEntitlementManagementRoleAssignmentScheduleRequest ...
func (c EntitlementManagementRoleAssignmentScheduleRequestClient) DeleteEntitlementManagementRoleAssignmentScheduleRequest(ctx context.Context, id RoleManagementEntitlementManagementRoleAssignmentScheduleRequestId) (result DeleteEntitlementManagementRoleAssignmentScheduleRequestOperationResponse, err error) {
