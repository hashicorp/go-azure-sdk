...
func (c DirectoryRoleEligibilityScheduleInstanceRoleDefinitionClient) GetDirectoryRoleEligibilityScheduleInstanceRoleDefinition(ctx context.Context, id RoleManagementDirectoryRoleEligibilityScheduleInstanceId) (result GetDirectoryRoleEligibilityScheduleInstanceRoleDefinitionOperationResponse, err error) {
