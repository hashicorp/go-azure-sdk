...
func (c EntitlementManagementResourceNamespaceClient) UpdateEntitlementManagementResourceNamespace(ctx context.Context, id stable.RoleManagementEntitlementManagementResourceNamespaceId, input stable.UnifiedRbacResourceNamespace) (result UpdateEntitlementManagementResourceNamespaceOperationResponse, err error) {
