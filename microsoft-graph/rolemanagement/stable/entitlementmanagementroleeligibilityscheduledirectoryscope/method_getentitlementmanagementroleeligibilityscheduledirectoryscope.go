...
func (c EntitlementManagementRoleEligibilityScheduleDirectoryScopeClient) GetEntitlementManagementRoleEligibilityScheduleDirectoryScope(ctx context.Context, id RoleManagementEntitlementManagementRoleEligibilityScheduleId) (result GetEntitlementManagementRoleEligibilityScheduleDirectoryScopeOperationResponse, err error) {
