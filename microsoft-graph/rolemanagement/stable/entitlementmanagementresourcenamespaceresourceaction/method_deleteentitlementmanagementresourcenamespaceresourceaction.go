...
// DeleteEntitlementManagementResourceNamespaceResourceAction ...
func (c EntitlementManagementResourceNamespaceResourceActionClient) DeleteEntitlementManagementResourceNamespaceResourceAction(ctx context.Context, id RoleManagementEntitlementManagementResourceNamespaceIdResourceActionId) (result DeleteEntitlementManagementResourceNamespaceResourceActionOperationResponse, err error) {
