...
// GetEntitlementManagementRoleEligibilityScheduleRequestPrincipal ...
func (c EntitlementManagementRoleEligibilityScheduleRequestPrincipalClient) GetEntitlementManagementRoleEligibilityScheduleRequestPrincipal(ctx context.Context, id RoleManagementEntitlementManagementRoleEligibilityScheduleRequestId) (result GetEntitlementManagementRoleEligibilityScheduleRequestPrincipalOperationResponse, err error) {
