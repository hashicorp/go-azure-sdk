...
func (c EntitlementManagementRoleEligibilityScheduleInstanceClient) CreateEntitlementManagementRoleEligibilityScheduleInstance(ctx context.Context, input stable.UnifiedRoleEligibilityScheduleInstance) (result CreateEntitlementManagementRoleEligibilityScheduleInstanceOperationResponse, err error) {
