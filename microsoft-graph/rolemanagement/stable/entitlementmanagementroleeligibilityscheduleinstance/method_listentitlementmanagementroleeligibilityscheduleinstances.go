...
// ListEntitlementManagementRoleEligibilityScheduleInstances ...
func (c EntitlementManagementRoleEligibilityScheduleInstanceClient) ListEntitlementManagementRoleEligibilityScheduleInstances(ctx context.Context) (result ListEntitlementManagementRoleEligibilityScheduleInstancesOperationResponse, err error) {
...
func (c EntitlementManagementRoleEligibilityScheduleInstanceClient) ListEntitlementManagementRoleEligibilityScheduleInstancesComplete(ctx context.Context) (ListEntitlementManagementRoleEligibilityScheduleInstancesCompleteResult, error) {
	return c.ListEntitlementManagementRoleEligibilityScheduleInstancesCompleteMatchingPredicate(ctx, UnifiedRoleEligibilityScheduleInstanceOperationPredicate{})
}
