...
func ParseApplicationTemplateID(input string) (*ApplicationTemplateId, error) {
	...
	if id.ApplicationTemplateId, ok = parsed.Parsed["applicationTemplateId"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "applicationTemplateId", *parsed)
	}
...
func (id ApplicationTemplateId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		resourceids.StaticSegment("staticApplicationTemplates", "applicationTemplates", "applicationTemplates"),
