...
func (c OAuth2PermissionGrantClient) UpdateOAuth2PermissionGrant(ctx context.Context, id stable.OAuth2PermissionGrantId, input stable.OAuth2PermissionGrant) (result UpdateOAuth2PermissionGrantOperationResponse, err error) {
