...
func (c Oauth2PermissionGrantClient) CreateOauth2PermissionGrant(ctx context.Context, input stable.OAuth2PermissionGrant) (result CreateOauth2PermissionGrantOperationResponse, err error) {
