...
// ListNotificationMessageTemplates ...
func (c NotificationMessageTemplateClient) ListNotificationMessageTemplates(ctx context.Context) (result ListNotificationMessageTemplatesOperationResponse, err error) {
...
func (c NotificationMessageTemplateClient) ListNotificationMessageTemplatesComplete(ctx context.Context) (ListNotificationMessageTemplatesCompleteResult, error) {
	return c.ListNotificationMessageTemplatesCompleteMatchingPredicate(ctx, NotificationMessageTemplateOperationPredicate{})
}

// ListNotificationMessageTemplatesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c NotificationMessageTemplateClient) ListNotificationMessageTemplatesCompleteMatchingPredicate(ctx context.Context, predicate NotificationMessageTemplateOperationPredicate) (result ListNotificationMessageTemplatesCompleteResult, err error) {
	items := make([]stable.NotificationMessageTemplate, 0)

	resp, err := c.ListNotificationMessageTemplates(ctx)
	if err != nil {
