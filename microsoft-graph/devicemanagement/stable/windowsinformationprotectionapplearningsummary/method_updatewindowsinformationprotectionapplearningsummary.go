...
// UpdateWindowsInformationProtectionAppLearningSummary ...
func (c WindowsInformationProtectionAppLearningSummaryClient) UpdateWindowsInformationProtectionAppLearningSummary(ctx context.Context, id DeviceManagementWindowsInformationProtectionAppLearningSummaryId, input stable.WindowsInformationProtectionAppLearningSummary) (result UpdateWindowsInformationProtectionAppLearningSummaryOperationResponse, err error) {
