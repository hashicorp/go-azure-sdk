...
func (c ImportedWindowsAutopilotDeviceIdentityClient) UpdateImportedWindowsAutopilotDeviceIdentity(ctx context.Context, id stable.DeviceManagementImportedWindowsAutopilotDeviceIdentityId, input stable.ImportedWindowsAutopilotDeviceIdentity) (result UpdateImportedWindowsAutopilotDeviceIdentityOperationResponse, err error) {
