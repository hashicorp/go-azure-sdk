...
func (c ReportExportJobClient) CreateReportExportJob(ctx context.Context, input stable.DeviceManagementExportJob) (result CreateReportExportJobOperationResponse, err error) {
