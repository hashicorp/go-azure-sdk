...
func TestNewDeviceManagementReportExportJobID(t *testing.T) {
	id := NewDeviceManagementReportExportJobID("deviceManagementExportJobIdValue")
...
func TestFormatDeviceManagementReportExportJobID(t *testing.T) {
	actual := NewDeviceManagementReportExportJobID("deviceManagementExportJobIdValue").ID()
