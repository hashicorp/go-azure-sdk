...
// connector
func (c RemoteAssistancePartnerClient) CreateRemoteAssistancePartnerDisconnect(ctx context.Context, id stable.DeviceManagementRemoteAssistancePartnerId) (result CreateRemoteAssistancePartnerDisconnectOperationResponse, err error) {
