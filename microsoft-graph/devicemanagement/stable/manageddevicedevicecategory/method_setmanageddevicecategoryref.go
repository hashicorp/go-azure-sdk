...
// SetManagedDeviceCategoryRef - Update the ref of navigation property deviceCategory in deviceManagement
func (c ManagedDeviceDeviceCategoryClient) SetManagedDeviceCategoryRef(ctx context.Context, id stable.DeviceManagementManagedDeviceId, input stable.ReferenceUpdate, options SetManagedDeviceCategoryRefOperationOptions) (result SetManagedDeviceCategoryRefOperationResponse, err error) {
