...
func (c ManagedDeviceDeviceCategoryClient) GetManagedDeviceCategoryRef(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options GetManagedDeviceCategoryRefOperationOptions) (result GetManagedDeviceCategoryRefOperationResponse, err error) {
