...
// RemoveManagedDeviceCategoryRef - Delete ref of navigation property deviceCategory for deviceManagement
func (c ManagedDeviceDeviceCategoryClient) RemoveManagedDeviceCategoryRef(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options RemoveManagedDeviceCategoryRefOperationOptions) (result RemoveManagedDeviceCategoryRefOperationResponse, err error) {
