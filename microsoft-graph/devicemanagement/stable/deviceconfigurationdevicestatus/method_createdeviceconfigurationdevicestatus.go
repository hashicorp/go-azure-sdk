...
func (c DeviceConfigurationDeviceStatusClient) CreateDeviceConfigurationDeviceStatus(ctx context.Context, id stable.DeviceManagementDeviceConfigurationId, input stable.DeviceConfigurationDeviceStatus) (result CreateDeviceConfigurationDeviceStatusOperationResponse, err error) {
