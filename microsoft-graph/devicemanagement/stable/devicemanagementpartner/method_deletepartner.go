...
// DeletePartner - Delete deviceManagementPartner. Deletes a deviceManagementPartner.
func (c DeviceManagementPartnerClient) DeletePartner(ctx context.Context, id stable.DeviceManagementDeviceManagementPartnerId, options DeletePartnerOperationOptions) (result DeletePartnerOperationResponse, err error) {
