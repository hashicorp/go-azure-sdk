...
func (c ManagedDeviceClient) CreateManagedDeviceWindowsDefenderUpdateSignature(ctx context.Context, id stable.DeviceManagementManagedDeviceId) (result CreateManagedDeviceWindowsDefenderUpdateSignatureOperationResponse, err error) {
