...
func (c ManagedDeviceClient) RequestManagedDeviceRemoteAssistance(ctx context.Context, id stable.DeviceManagementManagedDeviceId) (result RequestManagedDeviceRemoteAssistanceOperationResponse, err error) {
