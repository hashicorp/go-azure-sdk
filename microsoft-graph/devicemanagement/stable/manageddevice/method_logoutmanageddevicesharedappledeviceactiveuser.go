...
// device active user
func (c ManagedDeviceClient) LogoutManagedDeviceSharedAppleDeviceActiveUser(ctx context.Context, id stable.DeviceManagementManagedDeviceId) (result LogoutManagedDeviceSharedAppleDeviceActiveUserOperationResponse, err error) {
