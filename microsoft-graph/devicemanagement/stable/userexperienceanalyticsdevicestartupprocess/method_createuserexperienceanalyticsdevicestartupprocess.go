...
func (c UserExperienceAnalyticsDeviceStartupProcessClient) CreateUserExperienceAnalyticsDeviceStartupProcess(ctx context.Context, input stable.UserExperienceAnalyticsDeviceStartupProcess) (result CreateUserExperienceAnalyticsDeviceStartupProcessOperationResponse, err error) {
