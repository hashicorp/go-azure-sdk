...
func (c UserExperienceAnalyticsAppHealthApplicationPerformanceByAppVersionDetailClient) UpdateUserExperienceAnalyticsAppHealthApplicationPerformanceByAppVersionDetail(ctx context.Context, id DeviceManagementUserExperienceAnalyticsAppHealthApplicationPerformanceByAppVersionDetailId, input stable.UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetails) (result UpdateUserExperienceAnalyticsAppHealthApplicationPerformanceByAppVersionDetailOperationResponse, err error) {
