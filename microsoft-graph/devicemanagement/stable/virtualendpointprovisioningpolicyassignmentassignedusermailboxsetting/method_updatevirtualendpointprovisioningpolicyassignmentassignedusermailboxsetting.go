...
func (c VirtualEndpointProvisioningPolicyAssignmentAssignedUserMailboxSettingClient) UpdateVirtualEndpointProvisioningPolicyAssignmentAssignedUserMailboxSetting(ctx context.Context, id stable.DeviceManagementVirtualEndpointProvisioningPolicyIdAssignmentIdAssignedUserId, input stable.MailboxSettings) (result UpdateVirtualEndpointProvisioningPolicyAssignmentAssignedUserMailboxSettingOperationResponse, err error) {
