...
func (c ManagedDeviceConfigurationStateClient) ListManagedDeviceConfigurationStates(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions) (result ListManagedDeviceConfigurationStatesOperationResponse, err error) {
...
func (c ManagedDeviceConfigurationStateClient) ListManagedDeviceConfigurationStatesComplete(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions) (ListManagedDeviceConfigurationStatesCompleteResult, error) {
...
func (c ManagedDeviceConfigurationStateClient) ListManagedDeviceConfigurationStatesCompleteMatchingPredicate(ctx context.Context, id stable.DeviceManagementManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions, predicate DeviceConfigurationStateOperationPredicate) (result ListManagedDeviceConfigurationStatesCompleteResult, err error) {
