...
// deviceManagement
func (c ManagedDeviceConfigurationStateClient) CreateManagedDeviceConfigurationState(ctx context.Context, id stable.DeviceManagementManagedDeviceId, input stable.DeviceConfigurationState) (result CreateManagedDeviceConfigurationStateOperationResponse, err error) {
