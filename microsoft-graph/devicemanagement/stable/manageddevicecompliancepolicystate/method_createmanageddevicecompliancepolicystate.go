...
// deviceManagement
func (c ManagedDeviceCompliancePolicyStateClient) CreateManagedDeviceCompliancePolicyState(ctx context.Context, id stable.DeviceManagementManagedDeviceId, input stable.DeviceCompliancePolicyState) (result CreateManagedDeviceCompliancePolicyStateOperationResponse, err error) {
