...
func (c ManagedDeviceLogCollectionRequestClient) CreateManagedDeviceLogCollectionRequestDownloadUrl(ctx context.Context, id stable.DeviceManagementManagedDeviceIdLogCollectionRequestId) (result CreateManagedDeviceLogCollectionRequestDownloadUrlOperationResponse, err error) {
