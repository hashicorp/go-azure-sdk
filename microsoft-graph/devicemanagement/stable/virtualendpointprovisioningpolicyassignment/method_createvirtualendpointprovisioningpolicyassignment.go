...
// deviceManagement
func (c VirtualEndpointProvisioningPolicyAssignmentClient) CreateVirtualEndpointProvisioningPolicyAssignment(ctx context.Context, id stable.DeviceManagementVirtualEndpointProvisioningPolicyId, input stable.CloudPCProvisioningPolicyAssignment) (result CreateVirtualEndpointProvisioningPolicyAssignmentOperationResponse, err error) {
