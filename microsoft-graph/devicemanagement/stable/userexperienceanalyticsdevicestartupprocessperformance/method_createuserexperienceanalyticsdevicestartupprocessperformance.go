...
// CreateUserExperienceAnalyticsDeviceStartupProcessPerformance ...
func (c UserExperienceAnalyticsDeviceStartupProcessPerformanceClient) CreateUserExperienceAnalyticsDeviceStartupProcessPerformance(ctx context.Context, input stable.UserExperienceAnalyticsDeviceStartupProcessPerformance) (result CreateUserExperienceAnalyticsDeviceStartupProcessPerformanceOperationResponse, err error) {
