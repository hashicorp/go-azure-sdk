...
func (c UserExperienceAnalyticsAppHealthDevicePerformanceClient) GetUserExperienceAnalyticsAppHealthDevicePerformance(ctx context.Context, id DeviceManagementUserExperienceAnalyticsAppHealthDevicePerformanceId) (result GetUserExperienceAnalyticsAppHealthDevicePerformanceOperationResponse, err error) {
