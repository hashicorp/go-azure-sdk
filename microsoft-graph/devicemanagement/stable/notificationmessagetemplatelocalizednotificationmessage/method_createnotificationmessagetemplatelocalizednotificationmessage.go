...
// CreateNotificationMessageTemplateLocalizedNotificationMessage ...
func (c NotificationMessageTemplateLocalizedNotificationMessageClient) CreateNotificationMessageTemplateLocalizedNotificationMessage(ctx context.Context, id DeviceManagementNotificationMessageTemplateId, input stable.LocalizedNotificationMessage) (result CreateNotificationMessageTemplateLocalizedNotificationMessageOperationResponse, err error) {
