...
func (c VirtualEndpointOnPremisesConnectionClient) CreateVirtualEndpointOnPremisesConnection(ctx context.Context, input stable.CloudPCOnPremisesConnection) (result CreateVirtualEndpointOnPremisesConnectionOperationResponse, err error) {
