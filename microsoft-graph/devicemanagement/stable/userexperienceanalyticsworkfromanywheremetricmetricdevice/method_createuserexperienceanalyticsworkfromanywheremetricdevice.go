...
// deviceManagement
func (c UserExperienceAnalyticsWorkFromAnywhereMetricMetricDeviceClient) CreateUserExperienceAnalyticsWorkFromAnywhereMetricDevice(ctx context.Context, id stable.DeviceManagementUserExperienceAnalyticsWorkFromAnywhereMetricId, input stable.UserExperienceAnalyticsWorkFromAnywhereDevice) (result CreateUserExperienceAnalyticsWorkFromAnywhereMetricDeviceOperationResponse, err error) {
