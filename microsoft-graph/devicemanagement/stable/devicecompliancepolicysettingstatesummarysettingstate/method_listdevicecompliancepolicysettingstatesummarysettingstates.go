...
func (c DeviceCompliancePolicySettingStateSummarySettingStateClient) ListDeviceCompliancePolicySettingStateSummarySettingStatesComplete(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicySettingStateSummaryId, options ListDeviceCompliancePolicySettingStateSummarySettingStatesOperationOptions) (ListDeviceCompliancePolicySettingStateSummarySettingStatesCompleteResult, error) {
