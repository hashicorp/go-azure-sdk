...
func (c DeviceCompliancePolicySettingStateSummarySettingStateClient) CreateDeviceCompliancePolicySettingStateSummarySettingState(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicySettingStateSummaryId, input stable.DeviceComplianceSettingState) (result CreateDeviceCompliancePolicySettingStateSummarySettingStateOperationResponse, err error) {
