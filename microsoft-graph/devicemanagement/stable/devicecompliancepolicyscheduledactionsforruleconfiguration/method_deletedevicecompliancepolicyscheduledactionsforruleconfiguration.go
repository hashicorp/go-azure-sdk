...
func (c DeviceCompliancePolicyScheduledActionsForRuleConfigurationClient) DeleteDeviceCompliancePolicyScheduledActionsForRuleConfiguration(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleIdScheduledActionConfigurationId, options DeleteDeviceCompliancePolicyScheduledActionsForRuleConfigurationOperationOptions) (result DeleteDeviceCompliancePolicyScheduledActionsForRuleConfigurationOperationResponse, err error) {
