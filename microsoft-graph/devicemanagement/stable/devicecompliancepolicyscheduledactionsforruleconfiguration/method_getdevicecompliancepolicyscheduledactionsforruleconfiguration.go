...
func (c DeviceCompliancePolicyScheduledActionsForRuleConfigurationClient) GetDeviceCompliancePolicyScheduledActionsForRuleConfiguration(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleIdScheduledActionConfigurationId, options GetDeviceCompliancePolicyScheduledActionsForRuleConfigurationOperationOptions) (result GetDeviceCompliancePolicyScheduledActionsForRuleConfigurationOperationResponse, err error) {
