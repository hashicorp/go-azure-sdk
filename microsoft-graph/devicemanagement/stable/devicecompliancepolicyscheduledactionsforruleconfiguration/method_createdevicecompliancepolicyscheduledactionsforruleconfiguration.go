...
func (c DeviceCompliancePolicyScheduledActionsForRuleConfigurationClient) CreateDeviceCompliancePolicyScheduledActionsForRuleConfiguration(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleId, input stable.DeviceComplianceActionItem) (result CreateDeviceCompliancePolicyScheduledActionsForRuleConfigurationOperationResponse, err error) {
