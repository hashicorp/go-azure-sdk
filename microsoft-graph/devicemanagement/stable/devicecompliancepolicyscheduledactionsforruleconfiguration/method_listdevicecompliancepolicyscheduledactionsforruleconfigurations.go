...
func (c DeviceCompliancePolicyScheduledActionsForRuleConfigurationClient) ListDeviceCompliancePolicyScheduledActionsForRuleConfigurations(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleId, options ListDeviceCompliancePolicyScheduledActionsForRuleConfigurationsOperationOptions) (result ListDeviceCompliancePolicyScheduledActionsForRuleConfigurationsOperationResponse, err error) {
...
func (c DeviceCompliancePolicyScheduledActionsForRuleConfigurationClient) ListDeviceCompliancePolicyScheduledActionsForRuleConfigurationsComplete(ctx context.Context, id stable.DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleId, options ListDeviceCompliancePolicyScheduledActionsForRuleConfigurationsOperationOptions) (ListDeviceCompliancePolicyScheduledActionsForRuleConfigurationsCompleteResult, error) {
