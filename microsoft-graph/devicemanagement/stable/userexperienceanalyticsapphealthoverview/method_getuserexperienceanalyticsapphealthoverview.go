...
func (c UserExperienceAnalyticsAppHealthOverviewClient) GetUserExperienceAnalyticsAppHealthOverview(ctx context.Context) (result GetUserExperienceAnalyticsAppHealthOverviewOperationResponse, err error) {
