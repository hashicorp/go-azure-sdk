...
func (c WindowsAutopilotDeviceIdentityClient) CreateWindowsAutopilotDeviceIdentityUnassignUserFromDevice(ctx context.Context, id stable.DeviceManagementWindowsAutopilotDeviceIdentityId) (result CreateWindowsAutopilotDeviceIdentityUnassignUserFromDeviceOperationResponse, err error) {
