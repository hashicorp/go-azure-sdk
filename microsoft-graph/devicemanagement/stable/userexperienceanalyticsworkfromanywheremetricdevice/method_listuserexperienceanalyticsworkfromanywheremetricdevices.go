...
func (c UserExperienceAnalyticsWorkFromAnywhereMetricDeviceClient) ListUserExperienceAnalyticsWorkFromAnywhereMetricDevicesComplete(ctx context.Context, id stable.DeviceManagementUserExperienceAnalyticsWorkFromAnywhereMetricId, options ListUserExperienceAnalyticsWorkFromAnywhereMetricDevicesOperationOptions) (ListUserExperienceAnalyticsWorkFromAnywhereMetricDevicesCompleteResult, error) {
