...
// deviceManagement
func (c UserExperienceAnalyticsWorkFromAnywhereMetricDeviceClient) DeleteUserExperienceAnalyticsWorkFromAnywhereMetricDevice(ctx context.Context, id stable.DeviceManagementUserExperienceAnalyticsWorkFromAnywhereMetricIdMetricDeviceId, options DeleteUserExperienceAnalyticsWorkFromAnywhereMetricDeviceOperationOptions) (result DeleteUserExperienceAnalyticsWorkFromAnywhereMetricDeviceOperationResponse, err error) {
