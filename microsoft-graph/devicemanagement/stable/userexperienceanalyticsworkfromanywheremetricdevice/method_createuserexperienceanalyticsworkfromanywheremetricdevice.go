...
// deviceManagement
func (c UserExperienceAnalyticsWorkFromAnywhereMetricDeviceClient) CreateUserExperienceAnalyticsWorkFromAnywhereMetricDevice(ctx context.Context, id stable.DeviceManagementUserExperienceAnalyticsWorkFromAnywhereMetricId, input stable.UserExperienceAnalyticsWorkFromAnywhereDevice) (result CreateUserExperienceAnalyticsWorkFromAnywhereMetricDeviceOperationResponse, err error) {
