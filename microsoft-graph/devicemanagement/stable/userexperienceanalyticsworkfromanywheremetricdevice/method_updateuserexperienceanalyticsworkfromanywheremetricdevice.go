...
// deviceManagement
func (c UserExperienceAnalyticsWorkFromAnywhereMetricDeviceClient) UpdateUserExperienceAnalyticsWorkFromAnywhereMetricDevice(ctx context.Context, id stable.DeviceManagementUserExperienceAnalyticsWorkFromAnywhereMetricIdMetricDeviceId, input stable.UserExperienceAnalyticsWorkFromAnywhereDevice) (result UpdateUserExperienceAnalyticsWorkFromAnywhereMetricDeviceOperationResponse, err error) {
