...
func (c DeviceCategoryClient) CreateDeviceCategory(ctx context.Context, input stable.DeviceCategory) (result CreateDeviceCategoryOperationResponse, err error) {
