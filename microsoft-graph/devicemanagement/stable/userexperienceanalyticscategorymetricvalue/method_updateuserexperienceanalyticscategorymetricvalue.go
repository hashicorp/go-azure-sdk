...
// UpdateUserExperienceAnalyticsCategoryMetricValue ...
func (c UserExperienceAnalyticsCategoryMetricValueClient) UpdateUserExperienceAnalyticsCategoryMetricValue(ctx context.Context, id DeviceManagementUserExperienceAnalyticsCategoryIdMetricValueId, input stable.UserExperienceAnalyticsMetric) (result UpdateUserExperienceAnalyticsCategoryMetricValueOperationResponse, err error) {
