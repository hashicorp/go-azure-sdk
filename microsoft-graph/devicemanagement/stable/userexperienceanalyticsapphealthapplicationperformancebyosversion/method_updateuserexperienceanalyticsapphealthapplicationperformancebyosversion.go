...
func (c UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionClient) UpdateUserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersion(ctx context.Context, id DeviceManagementUserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionId, input stable.UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion) (result UpdateUserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionOperationResponse, err error) {
