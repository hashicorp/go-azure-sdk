...
func (c UserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionClient) CreateUserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersion(ctx context.Context, input stable.UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion) (result CreateUserExperienceAnalyticsAppHealthApplicationPerformanceByOSVersionOperationResponse, err error) {
