...
// UpdateUserExperienceAnalyticsAppHealthOverviewMetricValue ...
func (c UserExperienceAnalyticsAppHealthOverviewMetricValueClient) UpdateUserExperienceAnalyticsAppHealthOverviewMetricValue(ctx context.Context, id DeviceManagementUserExperienceAnalyticsAppHealthOverviewMetricValueId, input stable.UserExperienceAnalyticsMetric) (result UpdateUserExperienceAnalyticsAppHealthOverviewMetricValueOperationResponse, err error) {
