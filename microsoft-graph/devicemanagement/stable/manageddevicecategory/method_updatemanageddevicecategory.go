...
func (c ManagedDeviceCategoryClient) UpdateManagedDeviceCategory(ctx context.Context, id stable.DeviceManagementManagedDeviceId, input stable.DeviceCategory) (result UpdateManagedDeviceCategoryOperationResponse, err error) {
