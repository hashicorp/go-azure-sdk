...
func (c DeviceConfigurationUserStatusOverviewClient) UpdateDeviceConfigurationUserStatusOverview(ctx context.Context, id stable.DeviceManagementDeviceConfigurationId, input stable.DeviceConfigurationUserOverview) (result UpdateDeviceConfigurationUserStatusOverviewOperationResponse, err error) {
