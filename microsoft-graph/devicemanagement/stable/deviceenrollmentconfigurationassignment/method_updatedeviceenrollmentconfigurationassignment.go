...
func (c DeviceEnrollmentConfigurationAssignmentClient) UpdateDeviceEnrollmentConfigurationAssignment(ctx context.Context, id DeviceManagementDeviceEnrollmentConfigurationIdAssignmentId, input stable.EnrollmentConfigurationAssignment) (result UpdateDeviceEnrollmentConfigurationAssignmentOperationResponse, err error) {
