...
func (c ConfigurationPolicySettingDefinitionClient) GetConfigurationPolicySettingDefinition(ctx context.Context, id beta.DeviceManagementConfigurationPolicyIdSettingIdSettingDefinitionId, options GetConfigurationPolicySettingDefinitionOperationOptions) (result GetConfigurationPolicySettingDefinitionOperationResponse, err error) {
