...
// deviceManagement
func (c ManagedDeviceCompliancePolicyStateClient) DeleteManagedDeviceCompliancePolicyState(ctx context.Context, id beta.DeviceManagementManagedDeviceIdDeviceCompliancePolicyStateId, options DeleteManagedDeviceCompliancePolicyStateOperationOptions) (result DeleteManagedDeviceCompliancePolicyStateOperationResponse, err error) {
