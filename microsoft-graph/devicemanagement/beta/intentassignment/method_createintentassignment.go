...
func (c IntentAssignmentClient) CreateIntentAssignment(ctx context.Context, id beta.DeviceManagementIntentId, input beta.DeviceManagementIntentAssignment) (result CreateIntentAssignmentOperationResponse, err error) {
