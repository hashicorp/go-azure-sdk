...
type GetGroupPolicyDefinitionPreviousVersionDefinitionNextVersionDefinitionPresentationCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetGroupPolicyDefinitionPreviousVersionDefinitionNextVersionDefinitionPresentationCount ...
func (c GroupPolicyDefinitionPreviousVersionDefinitionNextVersionDefinitionPresentationClient) GetGroupPolicyDefinitionPreviousVersionDefinitionNextVersionDefinitionPresentationCount(ctx context.Context, id DeviceManagementGroupPolicyDefinitionId) (result GetGroupPolicyDefinitionPreviousVersionDefinitionNextVersionDefinitionPresentationCountOperationResponse, err error) {
