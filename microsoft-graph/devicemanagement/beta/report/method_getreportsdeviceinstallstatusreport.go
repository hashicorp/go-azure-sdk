...
func (c ReportClient) GetReportsDeviceInstallStatusReport(ctx context.Context, input GetReportsDeviceInstallStatusReportRequest) (result GetReportsDeviceInstallStatusReportOperationResponse, err error) {
