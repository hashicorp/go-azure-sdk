...
func (c ReportClient) GetReportsRelatedAppsStatusReport(ctx context.Context, input GetReportsRelatedAppsStatusReportRequest) (result GetReportsRelatedAppsStatusReportOperationResponse, err error) {
