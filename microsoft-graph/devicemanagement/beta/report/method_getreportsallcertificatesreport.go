...
func (c ReportClient) GetReportsAllCertificatesReport(ctx context.Context, input GetReportsAllCertificatesReportRequest) (result GetReportsAllCertificatesReportOperationResponse, err error) {
