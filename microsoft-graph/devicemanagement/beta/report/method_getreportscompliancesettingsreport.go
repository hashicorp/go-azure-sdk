...
func (c ReportClient) GetReportsComplianceSettingsReport(ctx context.Context, input GetReportsComplianceSettingsReportRequest) (result GetReportsComplianceSettingsReportOperationResponse, err error) {
