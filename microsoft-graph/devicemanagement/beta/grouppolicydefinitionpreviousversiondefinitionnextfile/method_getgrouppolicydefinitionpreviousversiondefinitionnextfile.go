...
func (c GroupPolicyDefinitionPreviousVersionDefinitionNextFileClient) GetGroupPolicyDefinitionPreviousVersionDefinitionNextFile(ctx context.Context, id beta.DeviceManagementGroupPolicyDefinitionId, options GetGroupPolicyDefinitionPreviousVersionDefinitionNextFileOperationOptions) (result GetGroupPolicyDefinitionPreviousVersionDefinitionNextFileOperationResponse, err error) {
