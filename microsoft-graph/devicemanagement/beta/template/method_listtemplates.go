...
// ListTemplates ...
func (c TemplateClient) ListTemplates(ctx context.Context) (result ListTemplatesOperationResponse, err error) {
...
func (c TemplateClient) ListTemplatesComplete(ctx context.Context) (ListTemplatesCompleteResult, error) {
	return c.ListTemplatesCompleteMatchingPredicate(ctx, DeviceManagementTemplateOperationPredicate{})
}

// ListTemplatesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c TemplateClient) ListTemplatesCompleteMatchingPredicate(ctx context.Context, predicate DeviceManagementTemplateOperationPredicate) (result ListTemplatesCompleteResult, err error) {
