...
// ListTemplateMigratableToCategorySettingDefinitions ...
func (c TemplateMigratableToCategorySettingDefinitionClient) ListTemplateMigratableToCategorySettingDefinitions(ctx context.Context, id DeviceManagementTemplateIdMigratableToIdCategoryId) (result ListTemplateMigratableToCategorySettingDefinitionsOperationResponse, err error) {
...
func (c TemplateMigratableToCategorySettingDefinitionClient) ListTemplateMigratableToCategorySettingDefinitionsComplete(ctx context.Context, id DeviceManagementTemplateIdMigratableToIdCategoryId) (ListTemplateMigratableToCategorySettingDefinitionsCompleteResult, error) {
	return c.ListTemplateMigratableToCategorySettingDefinitionsCompleteMatchingPredicate(ctx, id, DeviceManagementSettingDefinitionOperationPredicate{})
}
