...
func (c ManagedDeviceSecurityBaselineStateClient) ListManagedDeviceSecurityBaselineStates(ctx context.Context, id DeviceManagementManagedDeviceId) (result ListManagedDeviceSecurityBaselineStatesOperationResponse, err error) {
...
func (c ManagedDeviceSecurityBaselineStateClient) ListManagedDeviceSecurityBaselineStatesComplete(ctx context.Context, id DeviceManagementManagedDeviceId) (ListManagedDeviceSecurityBaselineStatesCompleteResult, error) {
...
func (c ManagedDeviceSecurityBaselineStateClient) ListManagedDeviceSecurityBaselineStatesCompleteMatchingPredicate(ctx context.Context, id DeviceManagementManagedDeviceId, predicate SecurityBaselineStateOperationPredicate) (result ListManagedDeviceSecurityBaselineStatesCompleteResult, err error) {
