...
// ListMacOSSoftwareUpdateAccountSummaries ...
func (c MacOSSoftwareUpdateAccountSummaryClient) ListMacOSSoftwareUpdateAccountSummaries(ctx context.Context) (result ListMacOSSoftwareUpdateAccountSummariesOperationResponse, err error) {
...
func (c MacOSSoftwareUpdateAccountSummaryClient) ListMacOSSoftwareUpdateAccountSummariesComplete(ctx context.Context) (ListMacOSSoftwareUpdateAccountSummariesCompleteResult, error) {
	return c.ListMacOSSoftwareUpdateAccountSummariesCompleteMatchingPredicate(ctx, MacOSSoftwareUpdateAccountSummaryOperationPredicate{})
}
...
func (c MacOSSoftwareUpdateAccountSummaryClient) ListMacOSSoftwareUpdateAccountSummariesCompleteMatchingPredicate(ctx context.Context, predicate MacOSSoftwareUpdateAccountSummaryOperationPredicate) (result ListMacOSSoftwareUpdateAccountSummariesCompleteResult, err error) {
	items := make([]beta.MacOSSoftwareUpdateAccountSummary, 0)

	resp, err := c.ListMacOSSoftwareUpdateAccountSummaries(ctx)
	if err != nil {
