...
func (c UserExperienceAnalyticsBatteryHealthDeviceAppImpactClient) GetUserExperienceAnalyticsBatteryHealthDeviceAppImpact(ctx context.Context, id DeviceManagementUserExperienceAnalyticsBatteryHealthDeviceAppImpactId) (result GetUserExperienceAnalyticsBatteryHealthDeviceAppImpactOperationResponse, err error) {
