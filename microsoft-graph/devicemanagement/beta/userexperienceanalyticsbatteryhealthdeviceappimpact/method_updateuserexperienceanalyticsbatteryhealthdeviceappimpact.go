...
// UpdateUserExperienceAnalyticsBatteryHealthDeviceAppImpact ...
func (c UserExperienceAnalyticsBatteryHealthDeviceAppImpactClient) UpdateUserExperienceAnalyticsBatteryHealthDeviceAppImpact(ctx context.Context, id DeviceManagementUserExperienceAnalyticsBatteryHealthDeviceAppImpactId, input beta.UserExperienceAnalyticsBatteryHealthDeviceAppImpact) (result UpdateUserExperienceAnalyticsBatteryHealthDeviceAppImpactOperationResponse, err error) {
