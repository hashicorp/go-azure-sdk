...
func (c UserExperienceAnalyticsBatteryHealthDevicePerformanceClient) GetUserExperienceAnalyticsBatteryHealthDevicePerformance(ctx context.Context, id DeviceManagementUserExperienceAnalyticsBatteryHealthDevicePerformanceId) (result GetUserExperienceAnalyticsBatteryHealthDevicePerformanceOperationResponse, err error) {
