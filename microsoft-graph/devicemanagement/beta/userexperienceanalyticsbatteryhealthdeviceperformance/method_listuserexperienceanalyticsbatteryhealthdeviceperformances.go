...
func (c UserExperienceAnalyticsBatteryHealthDevicePerformanceClient) ListUserExperienceAnalyticsBatteryHealthDevicePerformances(ctx context.Context) (result ListUserExperienceAnalyticsBatteryHealthDevicePerformancesOperationResponse, err error) {
...
func (c UserExperienceAnalyticsBatteryHealthDevicePerformanceClient) ListUserExperienceAnalyticsBatteryHealthDevicePerformancesComplete(ctx context.Context) (ListUserExperienceAnalyticsBatteryHealthDevicePerformancesCompleteResult, error) {
	return c.ListUserExperienceAnalyticsBatteryHealthDevicePerformancesCompleteMatchingPredicate(ctx, UserExperienceAnalyticsBatteryHealthDevicePerformanceOperationPredicate{})
}
