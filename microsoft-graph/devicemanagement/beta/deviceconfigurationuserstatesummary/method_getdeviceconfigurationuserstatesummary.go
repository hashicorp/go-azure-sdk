...
// GetDeviceConfigurationUserStateSummary ...
func (c DeviceConfigurationUserStateSummaryClient) GetDeviceConfigurationUserStateSummary(ctx context.Context) (result GetDeviceConfigurationUserStateSummaryOperationResponse, err error) {
