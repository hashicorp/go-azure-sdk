...
func (c DeviceConfigurationConflictSummaryClient) GetDeviceConfigurationConflictSummary(ctx context.Context, id DeviceManagementDeviceConfigurationConflictSummaryId) (result GetDeviceConfigurationConflictSummaryOperationResponse, err error) {
