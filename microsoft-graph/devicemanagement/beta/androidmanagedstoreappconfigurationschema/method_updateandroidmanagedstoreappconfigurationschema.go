...
// UpdateAndroidManagedStoreAppConfigurationSchema ...
func (c AndroidManagedStoreAppConfigurationSchemaClient) UpdateAndroidManagedStoreAppConfigurationSchema(ctx context.Context, id DeviceManagementAndroidManagedStoreAppConfigurationSchemaId, input beta.AndroidManagedStoreAppConfigurationSchema) (result UpdateAndroidManagedStoreAppConfigurationSchemaOperationResponse, err error) {
