...
func (c ConfigurationSettingClient) GetConfigurationSetting(ctx context.Context, id DeviceManagementConfigurationSettingId) (result GetConfigurationSettingOperationResponse, err error) {
