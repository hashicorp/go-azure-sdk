...
// UpdateExchangeOnPremisesPolicyConditionalAccessSetting ...
func (c ExchangeOnPremisesPolicyConditionalAccessSettingClient) UpdateExchangeOnPremisesPolicyConditionalAccessSetting(ctx context.Context, id DeviceManagementExchangeOnPremisesPolicyId, input beta.OnPremisesConditionalAccessSettings) (result UpdateExchangeOnPremisesPolicyConditionalAccessSettingOperationResponse, err error) {
