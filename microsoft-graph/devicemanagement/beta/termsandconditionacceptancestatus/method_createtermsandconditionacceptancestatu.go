...
func (c TermsAndConditionAcceptanceStatusClient) CreateTermsAndConditionAcceptanceStatu(ctx context.Context, id DeviceManagementTermsAndConditionId, input beta.TermsAndConditionsAcceptanceStatus) (result CreateTermsAndConditionAcceptanceStatuOperationResponse, err error) {
