...
func (c TermsAndConditionAcceptanceStatusClient) CreateTermsAndConditionAcceptanceStatus(ctx context.Context, id beta.DeviceManagementTermsAndConditionId, input beta.TermsAndConditionsAcceptanceStatus) (result CreateTermsAndConditionAcceptanceStatusOperationResponse, err error) {
