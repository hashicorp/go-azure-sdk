...
func TestNewDeviceManagementVirtualEndpointReportExportJobID(t *testing.T) {
	id := NewDeviceManagementVirtualEndpointReportExportJobID("cloudPCExportJobIdValue")
...
func TestFormatDeviceManagementVirtualEndpointReportExportJobID(t *testing.T) {
	actual := NewDeviceManagementVirtualEndpointReportExportJobID("cloudPCExportJobIdValue").ID()
