...
func (c UserExperienceAnalyticsDeviceMetricHistoryClient) UpdateUserExperienceAnalyticsDeviceMetricHistory(ctx context.Context, id DeviceManagementUserExperienceAnalyticsDeviceMetricHistoryId, input beta.UserExperienceAnalyticsMetricHistory) (result UpdateUserExperienceAnalyticsDeviceMetricHistoryOperationResponse, err error) {
