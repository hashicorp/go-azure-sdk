...
func (c UserExperienceAnalyticsCategoryMetricValueClient) UpdateUserExperienceAnalyticsCategoryMetricValue(ctx context.Context, id DeviceManagementUserExperienceAnalyticsCategoryIdMetricValueId, input beta.UserExperienceAnalyticsMetric) (result UpdateUserExperienceAnalyticsCategoryMetricValueOperationResponse, err error) {
