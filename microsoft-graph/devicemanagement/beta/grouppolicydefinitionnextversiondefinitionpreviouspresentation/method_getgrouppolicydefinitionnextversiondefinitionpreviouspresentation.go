...
func (c GroupPolicyDefinitionNextVersionDefinitionPreviousPresentationClient) GetGroupPolicyDefinitionNextVersionDefinitionPreviousPresentation(ctx context.Context, id beta.DeviceManagementGroupPolicyDefinitionIdNextVersionDefinitionPreviousVersionDefinitionPresentationId, options GetGroupPolicyDefinitionNextVersionDefinitionPreviousPresentationOperationOptions) (result GetGroupPolicyDefinitionNextVersionDefinitionPreviousPresentationOperationResponse, err error) {
