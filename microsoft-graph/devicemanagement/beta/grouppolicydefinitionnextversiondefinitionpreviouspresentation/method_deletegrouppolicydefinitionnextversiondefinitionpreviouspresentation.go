...
// deviceManagement
func (c GroupPolicyDefinitionNextVersionDefinitionPreviousPresentationClient) DeleteGroupPolicyDefinitionNextVersionDefinitionPreviousPresentation(ctx context.Context, id beta.DeviceManagementGroupPolicyDefinitionIdNextVersionDefinitionPreviousVersionDefinitionPresentationId, options DeleteGroupPolicyDefinitionNextVersionDefinitionPreviousPresentationOperationOptions) (result DeleteGroupPolicyDefinitionNextVersionDefinitionPreviousPresentationOperationResponse, err error) {
