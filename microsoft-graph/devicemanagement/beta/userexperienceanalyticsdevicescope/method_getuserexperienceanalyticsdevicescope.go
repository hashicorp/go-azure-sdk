...
func (c UserExperienceAnalyticsDeviceScopeClient) GetUserExperienceAnalyticsDeviceScope(ctx context.Context, id DeviceManagementUserExperienceAnalyticsDeviceScopeId) (result GetUserExperienceAnalyticsDeviceScopeOperationResponse, err error) {
