...
func (c UserExperienceAnalyticsDeviceScopeClient) CreateUserExperienceAnalyticsDeviceScopeTriggerAction(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsDeviceScopeId, input CreateUserExperienceAnalyticsDeviceScopeTriggerActionRequest) (result CreateUserExperienceAnalyticsDeviceScopeTriggerActionOperationResponse, err error) {
