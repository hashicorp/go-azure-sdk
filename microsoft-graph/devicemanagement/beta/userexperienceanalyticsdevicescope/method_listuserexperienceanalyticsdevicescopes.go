...
// ListUserExperienceAnalyticsDeviceScopes ...
...
func (c UserExperienceAnalyticsDeviceScopeClient) ListUserExperienceAnalyticsDeviceScopesComplete(ctx context.Context) (ListUserExperienceAnalyticsDeviceScopesCompleteResult, error) {
	return c.ListUserExperienceAnalyticsDeviceScopesCompleteMatchingPredicate(ctx, UserExperienceAnalyticsDeviceScopeOperationPredicate{})
}
...
func (c UserExperienceAnalyticsDeviceScopeClient) ListUserExperienceAnalyticsDeviceScopesCompleteMatchingPredicate(ctx context.Context, predicate UserExperienceAnalyticsDeviceScopeOperationPredicate) (result ListUserExperienceAnalyticsDeviceScopesCompleteResult, err error) {
	items := make([]beta.UserExperienceAnalyticsDeviceScope, 0)

	resp, err := c.ListUserExperienceAnalyticsDeviceScopes(ctx)
	if err != nil {
