...
// GetVirtualEndpointCrossCloudGovernmentOrganizationMapping ...
func (c VirtualEndpointCrossCloudGovernmentOrganizationMappingClient) GetVirtualEndpointCrossCloudGovernmentOrganizationMapping(ctx context.Context) (result GetVirtualEndpointCrossCloudGovernmentOrganizationMappingOperationResponse, err error) {
