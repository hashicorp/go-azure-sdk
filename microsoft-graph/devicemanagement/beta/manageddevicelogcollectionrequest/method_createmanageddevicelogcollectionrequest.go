...
// deviceManagement
func (c ManagedDeviceLogCollectionRequestClient) CreateManagedDeviceLogCollectionRequest(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input beta.DeviceLogCollectionResponse) (result CreateManagedDeviceLogCollectionRequestOperationResponse, err error) {
