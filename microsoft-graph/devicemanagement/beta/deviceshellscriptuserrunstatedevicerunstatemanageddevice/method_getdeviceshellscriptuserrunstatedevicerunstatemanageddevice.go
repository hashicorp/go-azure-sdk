...
// GetDeviceShellScriptUserRunStateDeviceRunStateManagedDevice ...
func (c DeviceShellScriptUserRunStateDeviceRunStateManagedDeviceClient) GetDeviceShellScriptUserRunStateDeviceRunStateManagedDevice(ctx context.Context, id DeviceManagementDeviceShellScriptIdUserRunStateIdDeviceRunStateId) (result GetDeviceShellScriptUserRunStateDeviceRunStateManagedDeviceOperationResponse, err error) {
