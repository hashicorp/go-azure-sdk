...
func (c UserExperienceAnalyticsScoreHistoryClient) GetUserExperienceAnalyticsScoreHistory(ctx context.Context, id DeviceManagementUserExperienceAnalyticsScoreHistoryId) (result GetUserExperienceAnalyticsScoreHistoryOperationResponse, err error) {
