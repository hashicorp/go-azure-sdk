...
func (c ComanagedDeviceConfigurationStateClient) DeleteComanagedDeviceConfigurationState(ctx context.Context, id beta.DeviceManagementComanagedDeviceIdDeviceConfigurationStateId, options DeleteComanagedDeviceConfigurationStateOperationOptions) (result DeleteComanagedDeviceConfigurationStateOperationResponse, err error) {
