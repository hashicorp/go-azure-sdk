...
// GetIntentDeviceStateSummary ...
func (c IntentDeviceStateSummaryClient) GetIntentDeviceStateSummary(ctx context.Context, id DeviceManagementIntentId) (result GetIntentDeviceStateSummaryOperationResponse, err error) {
