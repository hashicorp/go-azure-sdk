...
func (c MonitoringAlertRuleClient) GetMonitoringAlertRule(ctx context.Context, id DeviceManagementMonitoringAlertRuleId) (result GetMonitoringAlertRuleOperationResponse, err error) {
