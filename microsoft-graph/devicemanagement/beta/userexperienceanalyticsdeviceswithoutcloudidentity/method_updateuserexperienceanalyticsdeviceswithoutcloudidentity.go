...
func (c UserExperienceAnalyticsDevicesWithoutCloudIdentityClient) UpdateUserExperienceAnalyticsDevicesWithoutCloudIdentity(ctx context.Context, id DeviceManagementUserExperienceAnalyticsDevicesWithoutCloudIdentityId, input beta.UserExperienceAnalyticsDeviceWithoutCloudIdentity) (result UpdateUserExperienceAnalyticsDevicesWithoutCloudIdentityOperationResponse, err error) {
