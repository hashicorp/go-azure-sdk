...
func (c UserExperienceAnalyticsDevicesWithoutCloudIdentityClient) GetUserExperienceAnalyticsDevicesWithoutCloudIdentity(ctx context.Context, id DeviceManagementUserExperienceAnalyticsDevicesWithoutCloudIdentityId) (result GetUserExperienceAnalyticsDevicesWithoutCloudIdentityOperationResponse, err error) {
