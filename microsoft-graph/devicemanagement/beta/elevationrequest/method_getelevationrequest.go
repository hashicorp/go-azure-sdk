...
// GetElevationRequest ...
func (c ElevationRequestClient) GetElevationRequest(ctx context.Context, id DeviceManagementElevationRequestId) (result GetElevationRequestOperationResponse, err error) {
