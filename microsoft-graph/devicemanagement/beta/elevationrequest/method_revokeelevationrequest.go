...
func (c ElevationRequestClient) RevokeElevationRequest(ctx context.Context, id beta.DeviceManagementElevationRequestId, input RevokeElevationRequestRequest) (result RevokeElevationRequestOperationResponse, err error) {
