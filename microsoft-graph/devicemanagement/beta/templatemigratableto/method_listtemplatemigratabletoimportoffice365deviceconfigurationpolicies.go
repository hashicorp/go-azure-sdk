...
// ListTemplateMigratableToImportOffice365DeviceConfigurationPolicies ...
func (c TemplateMigratableToClient) ListTemplateMigratableToImportOffice365DeviceConfigurationPolicies(ctx context.Context, id DeviceManagementTemplateId) (result ListTemplateMigratableToImportOffice365DeviceConfigurationPoliciesOperationResponse, err error) {
...
func (c TemplateMigratableToClient) ListTemplateMigratableToImportOffice365DeviceConfigurationPoliciesComplete(ctx context.Context, id DeviceManagementTemplateId) (ListTemplateMigratableToImportOffice365DeviceConfigurationPoliciesCompleteResult, error) {
	return c.ListTemplateMigratableToImportOffice365DeviceConfigurationPoliciesCompleteMatchingPredicate(ctx, id, DeviceManagementIntentOperationPredicate{})
}
...
func (c TemplateMigratableToClient) ListTemplateMigratableToImportOffice365DeviceConfigurationPoliciesCompleteMatchingPredicate(ctx context.Context, id DeviceManagementTemplateId, predicate DeviceManagementIntentOperationPredicate) (result ListTemplateMigratableToImportOffice365DeviceConfigurationPoliciesCompleteResult, err error) {
	items := make([]beta.DeviceManagementIntent, 0)

	resp, err := c.ListTemplateMigratableToImportOffice365DeviceConfigurationPolicies(ctx, id)
	if err != nil {
