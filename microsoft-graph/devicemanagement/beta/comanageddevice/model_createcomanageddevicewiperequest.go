...
type CreateComanagedDeviceWipeRequest struct {
	...
	ObliterationBehavior *CreateComanagedDeviceWipeRequestObliterationBehavior `json:"obliterationBehavior,omitempty"`
