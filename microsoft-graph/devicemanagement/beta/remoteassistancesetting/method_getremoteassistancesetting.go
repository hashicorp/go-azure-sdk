...
// GetRemoteAssistanceSetting ...
func (c RemoteAssistanceSettingClient) GetRemoteAssistanceSetting(ctx context.Context) (result GetRemoteAssistanceSettingOperationResponse, err error) {
