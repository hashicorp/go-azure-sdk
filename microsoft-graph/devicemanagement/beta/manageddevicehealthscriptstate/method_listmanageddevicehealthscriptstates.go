...
func (c ManagedDeviceHealthScriptStateClient) ListManagedDeviceHealthScriptStates(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options ListManagedDeviceHealthScriptStatesOperationOptions) (result ListManagedDeviceHealthScriptStatesOperationResponse, err error) {
...
func (c ManagedDeviceHealthScriptStateClient) ListManagedDeviceHealthScriptStatesComplete(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options ListManagedDeviceHealthScriptStatesOperationOptions) (ListManagedDeviceHealthScriptStatesCompleteResult, error) {
...
func (c ManagedDeviceHealthScriptStateClient) ListManagedDeviceHealthScriptStatesCompleteMatchingPredicate(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options ListManagedDeviceHealthScriptStatesOperationOptions, predicate DeviceHealthScriptPolicyStateOperationPredicate) (result ListManagedDeviceHealthScriptStatesCompleteResult, err error) {
