...
func (c GroupPolicyDefinitionNextVersionDefinitionPreviousVersionDefinitionClient) UpdateGroupPolicyDefinitionNextVersionDefinitionPreviousVersionDefinition(ctx context.Context, id beta.DeviceManagementGroupPolicyDefinitionId, input beta.GroupPolicyDefinition) (result UpdateGroupPolicyDefinitionNextVersionDefinitionPreviousVersionDefinitionOperationResponse, err error) {
