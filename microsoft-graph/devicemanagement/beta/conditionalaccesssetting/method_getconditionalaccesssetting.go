...
// GetConditionalAccessSetting ...
func (c ConditionalAccessSettingClient) GetConditionalAccessSetting(ctx context.Context) (result GetConditionalAccessSettingOperationResponse, err error) {
