...
func (c TemplateSettingClient) CreateTemplateSetting(ctx context.Context, input beta.DeviceManagementConfigurationSettingTemplate) (result CreateTemplateSettingOperationResponse, err error) {
