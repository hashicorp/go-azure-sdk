...
// ListCloudPCConnectivityIssues ...
func (c CloudPCConnectivityIssueClient) ListCloudPCConnectivityIssues(ctx context.Context) (result ListCloudPCConnectivityIssuesOperationResponse, err error) {
...
func (c CloudPCConnectivityIssueClient) ListCloudPCConnectivityIssuesComplete(ctx context.Context) (ListCloudPCConnectivityIssuesCompleteResult, error) {
	return c.ListCloudPCConnectivityIssuesCompleteMatchingPredicate(ctx, CloudPCConnectivityIssueOperationPredicate{})
}

// ListCloudPCConnectivityIssuesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c CloudPCConnectivityIssueClient) ListCloudPCConnectivityIssuesCompleteMatchingPredicate(ctx context.Context, predicate CloudPCConnectivityIssueOperationPredicate) (result ListCloudPCConnectivityIssuesCompleteResult, err error) {
	items := make([]beta.CloudPCConnectivityIssue, 0)

	resp, err := c.ListCloudPCConnectivityIssues(ctx)
	if err != nil {
