...
// UpdateComanagedDeviceSecurityBaselineStateSettingState ...
func (c ComanagedDeviceSecurityBaselineStateSettingStateClient) UpdateComanagedDeviceSecurityBaselineStateSettingState(ctx context.Context, id DeviceManagementComanagedDeviceIdSecurityBaselineStateIdSettingStateId, input beta.SecurityBaselineSettingState) (result UpdateComanagedDeviceSecurityBaselineStateSettingStateOperationResponse, err error) {
