...
func (c MobileAppTroubleshootingEventClient) ListMobileAppTroubleshootingEventsComplete(ctx context.Context) (ListMobileAppTroubleshootingEventsCompleteResult, error) {
	return c.ListMobileAppTroubleshootingEventsCompleteMatchingPredicate(ctx, MobileAppTroubleshootingEventOperationPredicate{})
}

// ListMobileAppTroubleshootingEventsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c MobileAppTroubleshootingEventClient) ListMobileAppTroubleshootingEventsCompleteMatchingPredicate(ctx context.Context, predicate MobileAppTroubleshootingEventOperationPredicate) (result ListMobileAppTroubleshootingEventsCompleteResult, err error) {
	items := make([]beta.MobileAppTroubleshootingEvent, 0)

	resp, err := c.ListMobileAppTroubleshootingEvents(ctx)
	if err != nil {
