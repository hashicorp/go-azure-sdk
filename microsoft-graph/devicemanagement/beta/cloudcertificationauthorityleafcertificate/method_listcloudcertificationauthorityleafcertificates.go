...
// deviceManagement. Collection of CloudCertificationAuthorityLeafCertificate records associated with account.
func (c CloudCertificationAuthorityLeafCertificateClient) ListCloudCertificationAuthorityLeafCertificates(ctx context.Context, options ListCloudCertificationAuthorityLeafCertificatesOperationOptions) (result ListCloudCertificationAuthorityLeafCertificatesOperationResponse, err error) {
...
func (c CloudCertificationAuthorityLeafCertificateClient) ListCloudCertificationAuthorityLeafCertificatesComplete(ctx context.Context, options ListCloudCertificationAuthorityLeafCertificatesOperationOptions) (ListCloudCertificationAuthorityLeafCertificatesCompleteResult, error) {
	return c.ListCloudCertificationAuthorityLeafCertificatesCompleteMatchingPredicate(ctx, options, CloudCertificationAuthorityLeafCertificateOperationPredicate{})
}
...
func (c CloudCertificationAuthorityLeafCertificateClient) ListCloudCertificationAuthorityLeafCertificatesCompleteMatchingPredicate(ctx context.Context, options ListCloudCertificationAuthorityLeafCertificatesOperationOptions, predicate CloudCertificationAuthorityLeafCertificateOperationPredicate) (result ListCloudCertificationAuthorityLeafCertificatesCompleteResult, err error) {
	items := make([]beta.CloudCertificationAuthorityLeafCertificate, 0)

	resp, err := c.ListCloudCertificationAuthorityLeafCertificates(ctx, options)
	if err != nil {
