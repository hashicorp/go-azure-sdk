...
// CreateDeviceCustomAttributeShellScriptDeviceRunState ...
func (c DeviceCustomAttributeShellScriptDeviceRunStateClient) CreateDeviceCustomAttributeShellScriptDeviceRunState(ctx context.Context, id DeviceManagementDeviceCustomAttributeShellScriptId, input beta.DeviceManagementScriptDeviceState) (result CreateDeviceCustomAttributeShellScriptDeviceRunStateOperationResponse, err error) {
