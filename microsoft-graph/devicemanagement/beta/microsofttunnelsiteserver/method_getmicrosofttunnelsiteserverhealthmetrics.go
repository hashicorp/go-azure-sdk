...
func (c MicrosoftTunnelSiteServerClient) GetMicrosoftTunnelSiteServerHealthMetricsComplete(ctx context.Context, id beta.DeviceManagementMicrosoftTunnelSiteIdMicrosoftTunnelServerId, input GetMicrosoftTunnelSiteServerHealthMetricsRequest, options GetMicrosoftTunnelSiteServerHealthMetricsOperationOptions) (GetMicrosoftTunnelSiteServerHealthMetricsCompleteResult, error) {
...
func (c MicrosoftTunnelSiteServerClient) GetMicrosoftTunnelSiteServerHealthMetricsCompleteMatchingPredicate(ctx context.Context, id beta.DeviceManagementMicrosoftTunnelSiteIdMicrosoftTunnelServerId, input GetMicrosoftTunnelSiteServerHealthMetricsRequest, options GetMicrosoftTunnelSiteServerHealthMetricsOperationOptions, predicate KeyLongValuePairOperationPredicate) (result GetMicrosoftTunnelSiteServerHealthMetricsCompleteResult, err error) {
