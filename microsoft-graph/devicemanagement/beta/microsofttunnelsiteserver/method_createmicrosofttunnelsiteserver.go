...
func (c MicrosoftTunnelSiteServerClient) CreateMicrosoftTunnelSiteServer(ctx context.Context, id beta.DeviceManagementMicrosoftTunnelSiteId, input beta.MicrosoftTunnelServer) (result CreateMicrosoftTunnelSiteServerOperationResponse, err error) {
