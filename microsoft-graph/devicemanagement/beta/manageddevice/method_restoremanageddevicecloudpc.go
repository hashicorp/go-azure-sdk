...
func (c ManagedDeviceClient) RestoreManagedDeviceCloudPC(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input RestoreManagedDeviceCloudPCRequest) (result RestoreManagedDeviceCloudPCOperationResponse, err error) {
