...
func (c ManagedDeviceClient) CreateManagedDeviceExecuteAction(ctx context.Context, input CreateManagedDeviceExecuteActionRequest) (result CreateManagedDeviceExecuteActionOperationResponse, err error) {
