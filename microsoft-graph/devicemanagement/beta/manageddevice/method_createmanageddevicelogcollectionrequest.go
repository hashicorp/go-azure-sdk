...
func (c ManagedDeviceClient) CreateManagedDeviceLogCollectionRequest(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input CreateManagedDeviceLogCollectionRequestRequest) (result CreateManagedDeviceLogCollectionRequestOperationResponse, err error) {
