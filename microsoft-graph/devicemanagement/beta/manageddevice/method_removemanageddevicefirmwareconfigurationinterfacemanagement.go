...
// management
func (c ManagedDeviceClient) RemoveManagedDeviceFirmwareConfigurationInterfaceManagement(ctx context.Context, id beta.DeviceManagementManagedDeviceId) (result RemoveManagedDeviceFirmwareConfigurationInterfaceManagementOperationResponse, err error) {
