...
// device ID.
func (c ManagedDeviceClient) ReprovisionManagedDeviceCloudPC(ctx context.Context, id beta.DeviceManagementManagedDeviceId) (result ReprovisionManagedDeviceCloudPCOperationResponse, err error) {
