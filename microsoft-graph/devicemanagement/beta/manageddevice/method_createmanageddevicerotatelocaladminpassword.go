...
func (c ManagedDeviceClient) CreateManagedDeviceRotateLocalAdminPassword(ctx context.Context, id beta.DeviceManagementManagedDeviceId) (result CreateManagedDeviceRotateLocalAdminPasswordOperationResponse, err error) {
