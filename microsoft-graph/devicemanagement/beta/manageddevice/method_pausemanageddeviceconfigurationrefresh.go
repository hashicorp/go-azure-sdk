...
func (c ManagedDeviceClient) PauseManagedDeviceConfigurationRefresh(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input PauseManagedDeviceConfigurationRefreshRequest) (result PauseManagedDeviceConfigurationRefreshOperationResponse, err error) {
