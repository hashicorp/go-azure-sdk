...
func (c ManagedDeviceClient) ResizeManagedDeviceCloudPC(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input ResizeManagedDeviceCloudPCRequest) (result ResizeManagedDeviceCloudPCOperationResponse, err error) {
