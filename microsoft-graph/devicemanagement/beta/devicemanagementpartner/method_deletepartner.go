...
// DeletePartner - Delete navigation property deviceManagementPartners for deviceManagement
func (c DeviceManagementPartnerClient) DeletePartner(ctx context.Context, id beta.DeviceManagementDeviceManagementPartnerId, options DeletePartnerOperationOptions) (result DeletePartnerOperationResponse, err error) {
