...
func (c UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryClient) UpdateUserExperienceAnalyticsBatteryHealthDeviceRuntimeHistory(ctx context.Context, id DeviceManagementUserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryId, input beta.UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistory) (result UpdateUserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryOperationResponse, err error) {
