...
// ListUserExperienceAnalyticsBatteryHealthDeviceRuntimeHistories ...
func (c UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryClient) ListUserExperienceAnalyticsBatteryHealthDeviceRuntimeHistories(ctx context.Context) (result ListUserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoriesOperationResponse, err error) {
...
func (c UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryClient) ListUserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoriesComplete(ctx context.Context) (ListUserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoriesCompleteResult, error) {
	return c.ListUserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoriesCompleteMatchingPredicate(ctx, UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryOperationPredicate{})
}
...
func (c UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryClient) ListUserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoriesCompleteMatchingPredicate(ctx context.Context, predicate UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryOperationPredicate) (result ListUserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoriesCompleteResult, err error) {
	items := make([]beta.UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistory, 0)

	resp, err := c.ListUserExperienceAnalyticsBatteryHealthDeviceRuntimeHistories(ctx)
	if err != nil {
