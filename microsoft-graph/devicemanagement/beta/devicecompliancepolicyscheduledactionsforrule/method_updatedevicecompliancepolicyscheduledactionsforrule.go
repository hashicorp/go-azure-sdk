...
func (c DeviceCompliancePolicyScheduledActionsForRuleClient) UpdateDeviceCompliancePolicyScheduledActionsForRule(ctx context.Context, id DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleId, input beta.DeviceComplianceScheduledActionForRule) (result UpdateDeviceCompliancePolicyScheduledActionsForRuleOperationResponse, err error) {
