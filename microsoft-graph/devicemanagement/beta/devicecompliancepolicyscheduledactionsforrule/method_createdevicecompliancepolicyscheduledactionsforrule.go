...
// CreateDeviceCompliancePolicyScheduledActionsForRule ...
func (c DeviceCompliancePolicyScheduledActionsForRuleClient) CreateDeviceCompliancePolicyScheduledActionsForRule(ctx context.Context, id DeviceManagementDeviceCompliancePolicyId, input beta.DeviceComplianceScheduledActionForRule) (result CreateDeviceCompliancePolicyScheduledActionsForRuleOperationResponse, err error) {
