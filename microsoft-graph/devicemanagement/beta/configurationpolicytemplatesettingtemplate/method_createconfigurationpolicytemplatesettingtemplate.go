...
func (c ConfigurationPolicyTemplateSettingTemplateClient) CreateConfigurationPolicyTemplateSettingTemplate(ctx context.Context, id DeviceManagementConfigurationPolicyTemplateId, input beta.DeviceManagementConfigurationSettingTemplate) (result CreateConfigurationPolicyTemplateSettingTemplateOperationResponse, err error) {
