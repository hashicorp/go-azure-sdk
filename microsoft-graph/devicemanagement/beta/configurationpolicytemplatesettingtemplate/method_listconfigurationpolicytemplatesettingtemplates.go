...
func (c ConfigurationPolicyTemplateSettingTemplateClient) ListConfigurationPolicyTemplateSettingTemplates(ctx context.Context, id DeviceManagementConfigurationPolicyTemplateId) (result ListConfigurationPolicyTemplateSettingTemplatesOperationResponse, err error) {
...
func (c ConfigurationPolicyTemplateSettingTemplateClient) ListConfigurationPolicyTemplateSettingTemplatesComplete(ctx context.Context, id DeviceManagementConfigurationPolicyTemplateId) (ListConfigurationPolicyTemplateSettingTemplatesCompleteResult, error) {
	return c.ListConfigurationPolicyTemplateSettingTemplatesCompleteMatchingPredicate(ctx, id, DeviceManagementConfigurationSettingTemplateOperationPredicate{})
}
...
func (c ConfigurationPolicyTemplateSettingTemplateClient) ListConfigurationPolicyTemplateSettingTemplatesCompleteMatchingPredicate(ctx context.Context, id DeviceManagementConfigurationPolicyTemplateId, predicate DeviceManagementConfigurationSettingTemplateOperationPredicate) (result ListConfigurationPolicyTemplateSettingTemplatesCompleteResult, err error) {
	items := make([]beta.DeviceManagementConfigurationSettingTemplate, 0)

	resp, err := c.ListConfigurationPolicyTemplateSettingTemplates(ctx, id)
	if err != nil {
