...
// GetUserExperienceAnalyticsAppHealthOverviewMetricValue ...
func (c UserExperienceAnalyticsAppHealthOverviewMetricValueClient) GetUserExperienceAnalyticsAppHealthOverviewMetricValue(ctx context.Context, id DeviceManagementUserExperienceAnalyticsAppHealthOverviewMetricValueId) (result GetUserExperienceAnalyticsAppHealthOverviewMetricValueOperationResponse, err error) {
