...
// deviceManagement
func (c UserExperienceAnalyticsAppHealthOverviewMetricValueClient) UpdateUserExperienceAnalyticsAppHealthOverviewMetricValue(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsAppHealthOverviewMetricValueId, input beta.UserExperienceAnalyticsMetric) (result UpdateUserExperienceAnalyticsAppHealthOverviewMetricValueOperationResponse, err error) {
