...
func (c UserExperienceAnalyticsAppHealthOverviewMetricValueClient) UpdateUserExperienceAnalyticsAppHealthOverviewMetricValue(ctx context.Context, id DeviceManagementUserExperienceAnalyticsAppHealthOverviewMetricValueId, input beta.UserExperienceAnalyticsMetric) (result UpdateUserExperienceAnalyticsAppHealthOverviewMetricValueOperationResponse, err error) {
