...
func (c ConfigurationPolicyClient) ListConfigurationPolicies(ctx context.Context) (result ListConfigurationPoliciesOperationResponse, err error) {
...
func (c ConfigurationPolicyClient) ListConfigurationPoliciesComplete(ctx context.Context) (ListConfigurationPoliciesCompleteResult, error) {
	return c.ListConfigurationPoliciesCompleteMatchingPredicate(ctx, DeviceManagementConfigurationPolicyOperationPredicate{})
}

// ListConfigurationPoliciesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ConfigurationPolicyClient) ListConfigurationPoliciesCompleteMatchingPredicate(ctx context.Context, predicate DeviceManagementConfigurationPolicyOperationPredicate) (result ListConfigurationPoliciesCompleteResult, err error) {
	items := make([]beta.DeviceManagementConfigurationPolicy, 0)

	resp, err := c.ListConfigurationPolicies(ctx)
	if err != nil {
