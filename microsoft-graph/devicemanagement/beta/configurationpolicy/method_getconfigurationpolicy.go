...
func (c ConfigurationPolicyClient) GetConfigurationPolicy(ctx context.Context, id DeviceManagementConfigurationPolicyId) (result GetConfigurationPolicyOperationResponse, err error) {
