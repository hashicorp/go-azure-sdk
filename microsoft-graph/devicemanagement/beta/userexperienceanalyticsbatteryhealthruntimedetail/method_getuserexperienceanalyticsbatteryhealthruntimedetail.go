...
// GetUserExperienceAnalyticsBatteryHealthRuntimeDetail ...
func (c UserExperienceAnalyticsBatteryHealthRuntimeDetailClient) GetUserExperienceAnalyticsBatteryHealthRuntimeDetail(ctx context.Context) (result GetUserExperienceAnalyticsBatteryHealthRuntimeDetailOperationResponse, err error) {
