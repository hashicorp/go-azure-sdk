...
// GetWindowsAutopilotDeploymentProfileAssignedDeviceIntendedDeploymentProfile ...
func (c WindowsAutopilotDeploymentProfileAssignedDeviceIntendedDeploymentProfileClient) GetWindowsAutopilotDeploymentProfileAssignedDeviceIntendedDeploymentProfile(ctx context.Context, id DeviceManagementWindowsAutopilotDeploymentProfileIdAssignedDeviceId) (result GetWindowsAutopilotDeploymentProfileAssignedDeviceIntendedDeploymentProfileOperationResponse, err error) {
