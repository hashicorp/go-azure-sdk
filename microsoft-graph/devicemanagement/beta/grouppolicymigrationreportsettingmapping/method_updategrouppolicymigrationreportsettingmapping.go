...
// deviceManagement
func (c GroupPolicyMigrationReportSettingMappingClient) UpdateGroupPolicyMigrationReportSettingMapping(ctx context.Context, id beta.DeviceManagementGroupPolicyMigrationReportIdGroupPolicySettingMappingId, input beta.GroupPolicySettingMapping) (result UpdateGroupPolicyMigrationReportSettingMappingOperationResponse, err error) {
