...
func (c GroupPolicyMigrationReportSettingMappingClient) ListGroupPolicyMigrationReportSettingMappingsComplete(ctx context.Context, id beta.DeviceManagementGroupPolicyMigrationReportId, options ListGroupPolicyMigrationReportSettingMappingsOperationOptions) (ListGroupPolicyMigrationReportSettingMappingsCompleteResult, error) {
