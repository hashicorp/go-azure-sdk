...
func (c WindowsFeatureUpdateProfileAssignmentClient) CreateWindowsFeatureUpdateProfileAssignment(ctx context.Context, id beta.DeviceManagementWindowsFeatureUpdateProfileId, input beta.WindowsFeatureUpdateProfileAssignment) (result CreateWindowsFeatureUpdateProfileAssignmentOperationResponse, err error) {
