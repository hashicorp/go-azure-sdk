...
func (c GroupPolicyDefinitionNextVersionDefinitionClient) UpdateGroupPolicyDefinitionNextVersionDefinition(ctx context.Context, id DeviceManagementGroupPolicyDefinitionId, input beta.GroupPolicyDefinition) (result UpdateGroupPolicyDefinitionNextVersionDefinitionOperationResponse, err error) {
