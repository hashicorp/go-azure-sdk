...
func (c DeviceEnrollmentConfigurationAssignmentClient) CreateDeviceEnrollmentConfigurationAssignment(ctx context.Context, id beta.DeviceManagementDeviceEnrollmentConfigurationId, input beta.EnrollmentConfigurationAssignment) (result CreateDeviceEnrollmentConfigurationAssignmentOperationResponse, err error) {
