...
func (c DeviceEnrollmentConfigurationAssignmentClient) ListDeviceEnrollmentConfigurationAssignments(ctx context.Context, id DeviceManagementDeviceEnrollmentConfigurationId) (result ListDeviceEnrollmentConfigurationAssignmentsOperationResponse, err error) {
...
func (c DeviceEnrollmentConfigurationAssignmentClient) ListDeviceEnrollmentConfigurationAssignmentsComplete(ctx context.Context, id DeviceManagementDeviceEnrollmentConfigurationId) (ListDeviceEnrollmentConfigurationAssignmentsCompleteResult, error) {
...
func (c DeviceEnrollmentConfigurationAssignmentClient) ListDeviceEnrollmentConfigurationAssignmentsCompleteMatchingPredicate(ctx context.Context, id DeviceManagementDeviceEnrollmentConfigurationId, predicate EnrollmentConfigurationAssignmentOperationPredicate) (result ListDeviceEnrollmentConfigurationAssignmentsCompleteResult, err error) {
