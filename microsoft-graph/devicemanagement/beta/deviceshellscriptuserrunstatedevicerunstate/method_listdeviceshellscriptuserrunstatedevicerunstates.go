...
// ListDeviceShellScriptUserRunStateDeviceRunStates ...
func (c DeviceShellScriptUserRunStateDeviceRunStateClient) ListDeviceShellScriptUserRunStateDeviceRunStates(ctx context.Context, id DeviceManagementDeviceShellScriptIdUserRunStateId) (result ListDeviceShellScriptUserRunStateDeviceRunStatesOperationResponse, err error) {
...
func (c DeviceShellScriptUserRunStateDeviceRunStateClient) ListDeviceShellScriptUserRunStateDeviceRunStatesComplete(ctx context.Context, id DeviceManagementDeviceShellScriptIdUserRunStateId) (ListDeviceShellScriptUserRunStateDeviceRunStatesCompleteResult, error) {
	return c.ListDeviceShellScriptUserRunStateDeviceRunStatesCompleteMatchingPredicate(ctx, id, DeviceManagementScriptDeviceStateOperationPredicate{})
}
...
func (c DeviceShellScriptUserRunStateDeviceRunStateClient) ListDeviceShellScriptUserRunStateDeviceRunStatesCompleteMatchingPredicate(ctx context.Context, id DeviceManagementDeviceShellScriptIdUserRunStateId, predicate DeviceManagementScriptDeviceStateOperationPredicate) (result ListDeviceShellScriptUserRunStateDeviceRunStatesCompleteResult, err error) {
	items := make([]beta.DeviceManagementScriptDeviceState, 0)

	resp, err := c.ListDeviceShellScriptUserRunStateDeviceRunStates(ctx, id)
	if err != nil {
