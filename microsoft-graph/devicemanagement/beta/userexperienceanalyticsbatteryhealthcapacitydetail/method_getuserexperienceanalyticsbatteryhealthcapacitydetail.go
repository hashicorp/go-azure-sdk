...
// GetUserExperienceAnalyticsBatteryHealthCapacityDetail ...
func (c UserExperienceAnalyticsBatteryHealthCapacityDetailClient) GetUserExperienceAnalyticsBatteryHealthCapacityDetail(ctx context.Context) (result GetUserExperienceAnalyticsBatteryHealthCapacityDetailOperationResponse, err error) {
