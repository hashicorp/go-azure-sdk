...
func (c UserExperienceAnalyticsWorkFromAnywhereModelPerformanceClient) UpdateUserExperienceAnalyticsWorkFromAnywhereModelPerformance(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsWorkFromAnywhereModelPerformanceId, input beta.UserExperienceAnalyticsWorkFromAnywhereModelPerformance) (result UpdateUserExperienceAnalyticsWorkFromAnywhereModelPerformanceOperationResponse, err error) {
