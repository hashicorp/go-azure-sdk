...
// CreateComanagedDeviceManagedDeviceMobileAppConfigurationState ...
func (c ComanagedDeviceManagedDeviceMobileAppConfigurationStateClient) CreateComanagedDeviceManagedDeviceMobileAppConfigurationState(ctx context.Context, id DeviceManagementComanagedDeviceId, input beta.ManagedDeviceMobileAppConfigurationState) (result CreateComanagedDeviceManagedDeviceMobileAppConfigurationStateOperationResponse, err error) {
