...
// ListComanagedDeviceManagedDeviceMobileAppConfigurationStates ...
func (c ComanagedDeviceManagedDeviceMobileAppConfigurationStateClient) ListComanagedDeviceManagedDeviceMobileAppConfigurationStates(ctx context.Context, id DeviceManagementComanagedDeviceId) (result ListComanagedDeviceManagedDeviceMobileAppConfigurationStatesOperationResponse, err error) {
...
func (c ComanagedDeviceManagedDeviceMobileAppConfigurationStateClient) ListComanagedDeviceManagedDeviceMobileAppConfigurationStatesComplete(ctx context.Context, id DeviceManagementComanagedDeviceId) (ListComanagedDeviceManagedDeviceMobileAppConfigurationStatesCompleteResult, error) {
	return c.ListComanagedDeviceManagedDeviceMobileAppConfigurationStatesCompleteMatchingPredicate(ctx, id, ManagedDeviceMobileAppConfigurationStateOperationPredicate{})
}
...
func (c ComanagedDeviceManagedDeviceMobileAppConfigurationStateClient) ListComanagedDeviceManagedDeviceMobileAppConfigurationStatesCompleteMatchingPredicate(ctx context.Context, id DeviceManagementComanagedDeviceId, predicate ManagedDeviceMobileAppConfigurationStateOperationPredicate) (result ListComanagedDeviceManagedDeviceMobileAppConfigurationStatesCompleteResult, err error) {
	items := make([]beta.ManagedDeviceMobileAppConfigurationState, 0)

	resp, err := c.ListComanagedDeviceManagedDeviceMobileAppConfigurationStates(ctx, id)
	if err != nil {
