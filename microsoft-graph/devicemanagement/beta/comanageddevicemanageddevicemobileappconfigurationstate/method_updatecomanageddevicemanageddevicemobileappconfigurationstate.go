...
// UpdateComanagedDeviceManagedDeviceMobileAppConfigurationState ...
func (c ComanagedDeviceManagedDeviceMobileAppConfigurationStateClient) UpdateComanagedDeviceManagedDeviceMobileAppConfigurationState(ctx context.Context, id DeviceManagementComanagedDeviceIdManagedDeviceMobileAppConfigurationStateId, input beta.ManagedDeviceMobileAppConfigurationState) (result UpdateComanagedDeviceManagedDeviceMobileAppConfigurationStateOperationResponse, err error) {
