...
func (c ComanagedDeviceManagedDeviceMobileAppConfigurationStateClient) GetComanagedDeviceManagedDeviceMobileAppConfigurationState(ctx context.Context, id DeviceManagementComanagedDeviceIdManagedDeviceMobileAppConfigurationStateId) (result GetComanagedDeviceManagedDeviceMobileAppConfigurationStateOperationResponse, err error) {
