...
// GetGroupPolicyDefinitionPreviousVersionDefinitionPresentationDefinition ...
func (c GroupPolicyDefinitionPreviousVersionDefinitionPresentationDefinitionClient) GetGroupPolicyDefinitionPreviousVersionDefinitionPresentationDefinition(ctx context.Context, id DeviceManagementGroupPolicyDefinitionIdPreviousVersionDefinitionPresentationId) (result GetGroupPolicyDefinitionPreviousVersionDefinitionPresentationDefinitionOperationResponse, err error) {
