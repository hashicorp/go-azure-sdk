...
// CreateUserExperienceAnalyticsAppHealthDeviceModelPerformance ...
func (c UserExperienceAnalyticsAppHealthDeviceModelPerformanceClient) CreateUserExperienceAnalyticsAppHealthDeviceModelPerformance(ctx context.Context, input beta.UserExperienceAnalyticsAppHealthDeviceModelPerformance) (result CreateUserExperienceAnalyticsAppHealthDeviceModelPerformanceOperationResponse, err error) {
