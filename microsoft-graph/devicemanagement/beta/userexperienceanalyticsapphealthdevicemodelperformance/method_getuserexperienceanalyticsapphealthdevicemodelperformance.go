...
func (c UserExperienceAnalyticsAppHealthDeviceModelPerformanceClient) GetUserExperienceAnalyticsAppHealthDeviceModelPerformance(ctx context.Context, id DeviceManagementUserExperienceAnalyticsAppHealthDeviceModelPerformanceId) (result GetUserExperienceAnalyticsAppHealthDeviceModelPerformanceOperationResponse, err error) {
