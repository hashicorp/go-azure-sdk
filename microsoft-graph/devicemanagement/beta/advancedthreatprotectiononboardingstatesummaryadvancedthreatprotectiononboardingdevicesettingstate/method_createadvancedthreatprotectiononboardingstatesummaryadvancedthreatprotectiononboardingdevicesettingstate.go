...
type CreateAdvancedThreatProtectionOnboardingStateSummaryAdvancedThreatProtectionOnboardingDeviceSettingStateOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.AdvancedThreatProtectionOnboardingDeviceSettingState
}

// CreateAdvancedThreatProtectionOnboardingStateSummaryAdvancedThreatProtectionOnboardingDeviceSettingState ...
func (c AdvancedThreatProtectionOnboardingStateSummaryAdvancedThreatProtectionOnboardingDeviceSettingStateClient) CreateAdvancedThreatProtectionOnboardingStateSummaryAdvancedThreatProtectionOnboardingDeviceSettingState(ctx context.Context, input beta.AdvancedThreatProtectionOnboardingDeviceSettingState) (result CreateAdvancedThreatProtectionOnboardingStateSummaryAdvancedThreatProtectionOnboardingDeviceSettingStateOperationResponse, err error) {
