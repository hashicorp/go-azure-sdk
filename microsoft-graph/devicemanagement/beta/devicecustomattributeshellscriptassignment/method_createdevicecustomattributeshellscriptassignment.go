...
func (c DeviceCustomAttributeShellScriptAssignmentClient) CreateDeviceCustomAttributeShellScriptAssignment(ctx context.Context, id beta.DeviceManagementDeviceCustomAttributeShellScriptId, input beta.DeviceManagementScriptAssignment) (result CreateDeviceCustomAttributeShellScriptAssignmentOperationResponse, err error) {
