...
// CreateDeviceCustomAttributeShellScriptAssignment ...
func (c DeviceCustomAttributeShellScriptAssignmentClient) CreateDeviceCustomAttributeShellScriptAssignment(ctx context.Context, id DeviceManagementDeviceCustomAttributeShellScriptId, input beta.DeviceManagementScriptAssignment) (result CreateDeviceCustomAttributeShellScriptAssignmentOperationResponse, err error) {
