...
func (c ReportExportJobClient) CreateReportExportJob(ctx context.Context, input beta.DeviceManagementExportJob) (result CreateReportExportJobOperationResponse, err error) {
