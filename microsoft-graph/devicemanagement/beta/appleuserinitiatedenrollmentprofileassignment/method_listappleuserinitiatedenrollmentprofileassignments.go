...
// ListAppleUserInitiatedEnrollmentProfileAssignments ...
func (c AppleUserInitiatedEnrollmentProfileAssignmentClient) ListAppleUserInitiatedEnrollmentProfileAssignments(ctx context.Context, id DeviceManagementAppleUserInitiatedEnrollmentProfileId) (result ListAppleUserInitiatedEnrollmentProfileAssignmentsOperationResponse, err error) {
...
func (c AppleUserInitiatedEnrollmentProfileAssignmentClient) ListAppleUserInitiatedEnrollmentProfileAssignmentsComplete(ctx context.Context, id DeviceManagementAppleUserInitiatedEnrollmentProfileId) (ListAppleUserInitiatedEnrollmentProfileAssignmentsCompleteResult, error) {
	return c.ListAppleUserInitiatedEnrollmentProfileAssignmentsCompleteMatchingPredicate(ctx, id, AppleEnrollmentProfileAssignmentOperationPredicate{})
}
