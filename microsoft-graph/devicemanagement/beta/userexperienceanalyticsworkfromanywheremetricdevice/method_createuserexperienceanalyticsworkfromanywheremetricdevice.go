...
// deviceManagement
func (c UserExperienceAnalyticsWorkFromAnywhereMetricDeviceClient) CreateUserExperienceAnalyticsWorkFromAnywhereMetricDevice(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsWorkFromAnywhereMetricId, input beta.UserExperienceAnalyticsWorkFromAnywhereDevice) (result CreateUserExperienceAnalyticsWorkFromAnywhereMetricDeviceOperationResponse, err error) {
