...
// deviceManagement
func (c UserExperienceAnalyticsWorkFromAnywhereMetricDeviceClient) DeleteUserExperienceAnalyticsWorkFromAnywhereMetricDevice(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsWorkFromAnywhereMetricIdMetricDeviceId, options DeleteUserExperienceAnalyticsWorkFromAnywhereMetricDeviceOperationOptions) (result DeleteUserExperienceAnalyticsWorkFromAnywhereMetricDeviceOperationResponse, err error) {
