...
func (c UserExperienceAnalyticsWorkFromAnywhereMetricDeviceClient) ListUserExperienceAnalyticsWorkFromAnywhereMetricDevicesComplete(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsWorkFromAnywhereMetricId, options ListUserExperienceAnalyticsWorkFromAnywhereMetricDevicesOperationOptions) (ListUserExperienceAnalyticsWorkFromAnywhereMetricDevicesCompleteResult, error) {
