...
func (c TermsAndConditionClient) CreateTermsAndCondition(ctx context.Context, input beta.TermsAndConditions) (result CreateTermsAndConditionOperationResponse, err error) {
