...
func (c DeviceManagementScriptDeviceRunStateClient) CreateDeviceManagementScriptDeviceRunState(ctx context.Context, id DeviceManagementDeviceManagementScriptId, input beta.DeviceManagementScriptDeviceState) (result CreateDeviceManagementScriptDeviceRunStateOperationResponse, err error) {
