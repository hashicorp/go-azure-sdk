...
func (c DeviceManagementScriptDeviceRunStateClient) GetDeviceManagementScriptDeviceRunState(ctx context.Context, id DeviceManagementDeviceManagementScriptIdDeviceRunStateId) (result GetDeviceManagementScriptDeviceRunStateOperationResponse, err error) {
