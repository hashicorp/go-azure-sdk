...
// GetAutopilotEvent ...
func (c AutopilotEventClient) GetAutopilotEvent(ctx context.Context, id DeviceManagementAutopilotEventId) (result GetAutopilotEventOperationResponse, err error) {
