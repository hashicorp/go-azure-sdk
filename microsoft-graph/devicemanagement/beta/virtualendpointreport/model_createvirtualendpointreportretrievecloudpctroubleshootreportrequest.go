...
type CreateVirtualEndpointReportRetrieveCloudPCTroubleshootReportRequest struct {
	Filter     nullable.Type[string]               `json:"filter,omitempty"`
	GroupBy    *[]string                           `json:"groupBy,omitempty"`
	OrderBy    *[]string                           `json:"orderBy,omitempty"`
	ReportName *beta.CloudPCTroubleshootReportType `json:"reportName,omitempty"`
