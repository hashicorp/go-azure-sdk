...
// GetVirtualEndpointReport ...
func (c VirtualEndpointReportClient) GetVirtualEndpointReport(ctx context.Context) (result GetVirtualEndpointReportOperationResponse, err error) {
