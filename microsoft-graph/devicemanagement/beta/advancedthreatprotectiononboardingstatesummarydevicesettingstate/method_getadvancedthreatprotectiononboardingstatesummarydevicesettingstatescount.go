...
func (c AdvancedThreatProtectionOnboardingStateSummaryDeviceSettingStateClient) GetAdvancedThreatProtectionOnboardingStateSummaryDeviceSettingStatesCount(ctx context.Context, options GetAdvancedThreatProtectionOnboardingStateSummaryDeviceSettingStatesCountOperationOptions) (result GetAdvancedThreatProtectionOnboardingStateSummaryDeviceSettingStatesCountOperationResponse, err error) {
