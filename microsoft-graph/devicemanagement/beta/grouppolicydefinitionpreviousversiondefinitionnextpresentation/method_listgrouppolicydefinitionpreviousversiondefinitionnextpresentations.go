...
func (c GroupPolicyDefinitionPreviousVersionDefinitionNextPresentationClient) ListGroupPolicyDefinitionPreviousVersionDefinitionNextPresentations(ctx context.Context, id beta.DeviceManagementGroupPolicyDefinitionId, options ListGroupPolicyDefinitionPreviousVersionDefinitionNextPresentationsOperationOptions) (result ListGroupPolicyDefinitionPreviousVersionDefinitionNextPresentationsOperationResponse, err error) {
