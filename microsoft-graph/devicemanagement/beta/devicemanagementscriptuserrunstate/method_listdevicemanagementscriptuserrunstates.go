...
// ListDeviceManagementScriptUserRunStates ...
func (c DeviceManagementScriptUserRunStateClient) ListDeviceManagementScriptUserRunStates(ctx context.Context, id DeviceManagementDeviceManagementScriptId) (result ListDeviceManagementScriptUserRunStatesOperationResponse, err error) {
...
func (c DeviceManagementScriptUserRunStateClient) ListDeviceManagementScriptUserRunStatesComplete(ctx context.Context, id DeviceManagementDeviceManagementScriptId) (ListDeviceManagementScriptUserRunStatesCompleteResult, error) {
	return c.ListDeviceManagementScriptUserRunStatesCompleteMatchingPredicate(ctx, id, DeviceManagementScriptUserStateOperationPredicate{})
}
...
func (c DeviceManagementScriptUserRunStateClient) ListDeviceManagementScriptUserRunStatesCompleteMatchingPredicate(ctx context.Context, id DeviceManagementDeviceManagementScriptId, predicate DeviceManagementScriptUserStateOperationPredicate) (result ListDeviceManagementScriptUserRunStatesCompleteResult, err error) {
	items := make([]beta.DeviceManagementScriptUserState, 0)

	resp, err := c.ListDeviceManagementScriptUserRunStates(ctx, id)
	if err != nil {
