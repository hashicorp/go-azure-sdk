...
// GetDeviceManagementScriptUserRunStateDeviceRunStateManagedDevice ...
func (c DeviceManagementScriptUserRunStateDeviceRunStateManagedDeviceClient) GetDeviceManagementScriptUserRunStateDeviceRunStateManagedDevice(ctx context.Context, id DeviceManagementDeviceManagementScriptIdUserRunStateIdDeviceRunStateId) (result GetDeviceManagementScriptUserRunStateDeviceRunStateManagedDeviceOperationResponse, err error) {
