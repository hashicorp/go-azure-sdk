...
// UpdateUserExperienceAnalyticsAppHealthOSVersionPerformance ...
func (c UserExperienceAnalyticsAppHealthOSVersionPerformanceClient) UpdateUserExperienceAnalyticsAppHealthOSVersionPerformance(ctx context.Context, id DeviceManagementUserExperienceAnalyticsAppHealthOSVersionPerformanceId, input beta.UserExperienceAnalyticsAppHealthOSVersionPerformance) (result UpdateUserExperienceAnalyticsAppHealthOSVersionPerformanceOperationResponse, err error) {
