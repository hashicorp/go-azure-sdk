...
func (c UserExperienceAnalyticsAppHealthOSVersionPerformanceClient) GetUserExperienceAnalyticsAppHealthOSVersionPerformance(ctx context.Context, id DeviceManagementUserExperienceAnalyticsAppHealthOSVersionPerformanceId) (result GetUserExperienceAnalyticsAppHealthOSVersionPerformanceOperationResponse, err error) {
