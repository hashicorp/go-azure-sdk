...
// UpdateWindowsAutopilotDeploymentProfileAssignedDevice ...
func (c WindowsAutopilotDeploymentProfileAssignedDeviceClient) UpdateWindowsAutopilotDeploymentProfileAssignedDevice(ctx context.Context, id DeviceManagementWindowsAutopilotDeploymentProfileIdAssignedDeviceId, input beta.WindowsAutopilotDeviceIdentity) (result UpdateWindowsAutopilotDeploymentProfileAssignedDeviceOperationResponse, err error) {
