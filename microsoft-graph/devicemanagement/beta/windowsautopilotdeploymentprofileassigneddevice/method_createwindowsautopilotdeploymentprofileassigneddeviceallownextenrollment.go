...
func (c WindowsAutopilotDeploymentProfileAssignedDeviceClient) CreateWindowsAutopilotDeploymentProfileAssignedDeviceAllowNextEnrollment(ctx context.Context, id DeviceManagementWindowsAutopilotDeploymentProfileIdAssignedDeviceId) (result CreateWindowsAutopilotDeploymentProfileAssignedDeviceAllowNextEnrollmentOperationResponse, err error) {
