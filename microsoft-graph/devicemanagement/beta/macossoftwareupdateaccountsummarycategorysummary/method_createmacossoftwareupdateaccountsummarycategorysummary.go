...
// CreateMacOSSoftwareUpdateAccountSummaryCategorySummary ...
func (c MacOSSoftwareUpdateAccountSummaryCategorySummaryClient) CreateMacOSSoftwareUpdateAccountSummaryCategorySummary(ctx context.Context, id DeviceManagementMacOSSoftwareUpdateAccountSummaryId, input beta.MacOSSoftwareUpdateCategorySummary) (result CreateMacOSSoftwareUpdateAccountSummaryCategorySummaryOperationResponse, err error) {
