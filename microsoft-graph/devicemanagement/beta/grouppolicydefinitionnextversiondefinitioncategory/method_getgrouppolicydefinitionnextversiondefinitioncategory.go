...
func (c GroupPolicyDefinitionNextVersionDefinitionCategoryClient) GetGroupPolicyDefinitionNextVersionDefinitionCategory(ctx context.Context, id DeviceManagementGroupPolicyDefinitionId) (result GetGroupPolicyDefinitionNextVersionDefinitionCategoryOperationResponse, err error) {
