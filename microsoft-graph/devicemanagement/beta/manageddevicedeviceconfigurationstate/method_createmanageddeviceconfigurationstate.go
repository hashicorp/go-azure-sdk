...
// deviceManagement
func (c ManagedDeviceDeviceConfigurationStateClient) CreateManagedDeviceConfigurationState(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input beta.DeviceConfigurationState) (result CreateManagedDeviceConfigurationStateOperationResponse, err error) {
