...
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceDeviceConfigurationStates(ctx context.Context, id DeviceManagementManagedDeviceId) (result ListManagedDeviceDeviceConfigurationStatesOperationResponse, err error) {
...
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceDeviceConfigurationStatesComplete(ctx context.Context, id DeviceManagementManagedDeviceId) (ListManagedDeviceDeviceConfigurationStatesCompleteResult, error) {
...
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceDeviceConfigurationStatesCompleteMatchingPredicate(ctx context.Context, id DeviceManagementManagedDeviceId, predicate DeviceConfigurationStateOperationPredicate) (result ListManagedDeviceDeviceConfigurationStatesCompleteResult, err error) {
