...
func (c ManagedDeviceManagedDeviceMobileAppConfigurationStateClient) ListManagedDeviceManagedDeviceMobileAppConfigurationStates(ctx context.Context, id DeviceManagementManagedDeviceId) (result ListManagedDeviceManagedDeviceMobileAppConfigurationStatesOperationResponse, err error) {
...
func (c ManagedDeviceManagedDeviceMobileAppConfigurationStateClient) ListManagedDeviceManagedDeviceMobileAppConfigurationStatesComplete(ctx context.Context, id DeviceManagementManagedDeviceId) (ListManagedDeviceManagedDeviceMobileAppConfigurationStatesCompleteResult, error) {
...
func (c ManagedDeviceManagedDeviceMobileAppConfigurationStateClient) ListManagedDeviceManagedDeviceMobileAppConfigurationStatesCompleteMatchingPredicate(ctx context.Context, id DeviceManagementManagedDeviceId, predicate ManagedDeviceMobileAppConfigurationStateOperationPredicate) (result ListManagedDeviceManagedDeviceMobileAppConfigurationStatesCompleteResult, err error) {
