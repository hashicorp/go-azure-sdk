...
func (c ManagedDeviceAssignmentFilterEvaluationStatusDetailClient) ListManagedDeviceAssignmentFilterEvaluationStatusDetails(ctx context.Context, id DeviceManagementManagedDeviceId) (result ListManagedDeviceAssignmentFilterEvaluationStatusDetailsOperationResponse, err error) {
...
func (c ManagedDeviceAssignmentFilterEvaluationStatusDetailClient) ListManagedDeviceAssignmentFilterEvaluationStatusDetailsComplete(ctx context.Context, id DeviceManagementManagedDeviceId) (ListManagedDeviceAssignmentFilterEvaluationStatusDetailsCompleteResult, error) {
...
func (c ManagedDeviceAssignmentFilterEvaluationStatusDetailClient) ListManagedDeviceAssignmentFilterEvaluationStatusDetailsCompleteMatchingPredicate(ctx context.Context, id DeviceManagementManagedDeviceId, predicate AssignmentFilterEvaluationStatusDetailsOperationPredicate) (result ListManagedDeviceAssignmentFilterEvaluationStatusDetailsCompleteResult, err error) {
