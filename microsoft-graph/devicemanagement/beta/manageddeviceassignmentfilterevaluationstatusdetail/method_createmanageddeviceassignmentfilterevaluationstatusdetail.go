...
func (c ManagedDeviceAssignmentFilterEvaluationStatusDetailClient) CreateManagedDeviceAssignmentFilterEvaluationStatusDetail(ctx context.Context, id DeviceManagementManagedDeviceId, input beta.AssignmentFilterEvaluationStatusDetails) (result CreateManagedDeviceAssignmentFilterEvaluationStatusDetailOperationResponse, err error) {
