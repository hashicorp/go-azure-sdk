...
func (c GroupPolicyDefinitionNextVersionDefinitionPreviousPresentationDefinitionClient) GetGroupPolicyDefinitionNextVersionDefinitionPreviousPresentationDefinition(ctx context.Context, id beta.DeviceManagementGroupPolicyDefinitionIdNextVersionDefinitionPreviousVersionDefinitionPresentationId, options GetGroupPolicyDefinitionNextVersionDefinitionPreviousPresentationDefinitionOperationOptions) (result GetGroupPolicyDefinitionNextVersionDefinitionPreviousPresentationDefinitionOperationResponse, err error) {
