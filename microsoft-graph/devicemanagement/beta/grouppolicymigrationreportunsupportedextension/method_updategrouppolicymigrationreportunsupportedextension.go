...
func (c GroupPolicyMigrationReportUnsupportedExtensionClient) UpdateGroupPolicyMigrationReportUnsupportedExtension(ctx context.Context, id beta.DeviceManagementGroupPolicyMigrationReportIdUnsupportedGroupPolicyExtensionId, input beta.UnsupportedGroupPolicyExtension) (result UpdateGroupPolicyMigrationReportUnsupportedExtensionOperationResponse, err error) {
