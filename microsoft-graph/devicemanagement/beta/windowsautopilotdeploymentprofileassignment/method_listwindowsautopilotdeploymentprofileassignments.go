...
// ListWindowsAutopilotDeploymentProfileAssignments ...
func (c WindowsAutopilotDeploymentProfileAssignmentClient) ListWindowsAutopilotDeploymentProfileAssignments(ctx context.Context, id DeviceManagementWindowsAutopilotDeploymentProfileId) (result ListWindowsAutopilotDeploymentProfileAssignmentsOperationResponse, err error) {
...
func (c WindowsAutopilotDeploymentProfileAssignmentClient) ListWindowsAutopilotDeploymentProfileAssignmentsComplete(ctx context.Context, id DeviceManagementWindowsAutopilotDeploymentProfileId) (ListWindowsAutopilotDeploymentProfileAssignmentsCompleteResult, error) {
	return c.ListWindowsAutopilotDeploymentProfileAssignmentsCompleteMatchingPredicate(ctx, id, WindowsAutopilotDeploymentProfileAssignmentOperationPredicate{})
}
