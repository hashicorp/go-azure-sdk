...
func (c WindowsAutopilotDeploymentProfileAssignmentClient) UpdateWindowsAutopilotDeploymentProfileAssignment(ctx context.Context, id DeviceManagementWindowsAutopilotDeploymentProfileIdAssignmentId, input beta.WindowsAutopilotDeploymentProfileAssignment) (result UpdateWindowsAutopilotDeploymentProfileAssignmentOperationResponse, err error) {
