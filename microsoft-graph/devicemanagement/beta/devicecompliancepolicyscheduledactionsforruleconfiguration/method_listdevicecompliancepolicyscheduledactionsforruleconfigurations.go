...
func (c DeviceCompliancePolicyScheduledActionsForRuleConfigurationClient) ListDeviceCompliancePolicyScheduledActionsForRuleConfigurations(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleId, options ListDeviceCompliancePolicyScheduledActionsForRuleConfigurationsOperationOptions) (result ListDeviceCompliancePolicyScheduledActionsForRuleConfigurationsOperationResponse, err error) {
