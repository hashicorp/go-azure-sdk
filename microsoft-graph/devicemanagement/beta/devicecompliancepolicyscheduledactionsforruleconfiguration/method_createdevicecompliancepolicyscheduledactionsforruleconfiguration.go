...
func (c DeviceCompliancePolicyScheduledActionsForRuleConfigurationClient) CreateDeviceCompliancePolicyScheduledActionsForRuleConfiguration(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleId, input beta.DeviceComplianceActionItem) (result CreateDeviceCompliancePolicyScheduledActionsForRuleConfigurationOperationResponse, err error) {
