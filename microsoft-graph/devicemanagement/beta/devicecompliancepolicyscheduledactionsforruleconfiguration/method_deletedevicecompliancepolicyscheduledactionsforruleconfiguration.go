...
func (c DeviceCompliancePolicyScheduledActionsForRuleConfigurationClient) DeleteDeviceCompliancePolicyScheduledActionsForRuleConfiguration(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleIdScheduledActionConfigurationId, options DeleteDeviceCompliancePolicyScheduledActionsForRuleConfigurationOperationOptions) (result DeleteDeviceCompliancePolicyScheduledActionsForRuleConfigurationOperationResponse, err error) {
