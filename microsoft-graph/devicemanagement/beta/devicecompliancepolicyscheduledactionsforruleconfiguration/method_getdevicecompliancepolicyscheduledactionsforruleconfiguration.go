...
func (c DeviceCompliancePolicyScheduledActionsForRuleConfigurationClient) GetDeviceCompliancePolicyScheduledActionsForRuleConfiguration(ctx context.Context, id beta.DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleIdScheduledActionConfigurationId, options GetDeviceCompliancePolicyScheduledActionsForRuleConfigurationOperationOptions) (result GetDeviceCompliancePolicyScheduledActionsForRuleConfigurationOperationResponse, err error) {
