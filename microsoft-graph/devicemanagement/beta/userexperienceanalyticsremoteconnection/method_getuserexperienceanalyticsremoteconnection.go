...
func (c UserExperienceAnalyticsRemoteConnectionClient) GetUserExperienceAnalyticsRemoteConnection(ctx context.Context, id DeviceManagementUserExperienceAnalyticsRemoteConnectionId) (result GetUserExperienceAnalyticsRemoteConnectionOperationResponse, err error) {
