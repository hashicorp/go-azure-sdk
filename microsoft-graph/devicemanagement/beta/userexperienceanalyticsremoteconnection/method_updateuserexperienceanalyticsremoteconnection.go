...
// UpdateUserExperienceAnalyticsRemoteConnection ...
func (c UserExperienceAnalyticsRemoteConnectionClient) UpdateUserExperienceAnalyticsRemoteConnection(ctx context.Context, id DeviceManagementUserExperienceAnalyticsRemoteConnectionId, input beta.UserExperienceAnalyticsRemoteConnection) (result UpdateUserExperienceAnalyticsRemoteConnectionOperationResponse, err error) {
