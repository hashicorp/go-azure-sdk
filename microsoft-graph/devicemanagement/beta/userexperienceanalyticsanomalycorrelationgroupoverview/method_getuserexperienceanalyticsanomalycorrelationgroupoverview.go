...
// GetUserExperienceAnalyticsAnomalyCorrelationGroupOverview ...
func (c UserExperienceAnalyticsAnomalyCorrelationGroupOverviewClient) GetUserExperienceAnalyticsAnomalyCorrelationGroupOverview(ctx context.Context, id DeviceManagementUserExperienceAnalyticsAnomalyCorrelationGroupOverviewId) (result GetUserExperienceAnalyticsAnomalyCorrelationGroupOverviewOperationResponse, err error) {
