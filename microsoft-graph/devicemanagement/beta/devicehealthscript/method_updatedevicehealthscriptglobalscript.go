...
func (c DeviceHealthScriptClient) UpdateDeviceHealthScriptGlobalScript(ctx context.Context, id beta.DeviceManagementDeviceHealthScriptId, input UpdateDeviceHealthScriptGlobalScriptRequest) (result UpdateDeviceHealthScriptGlobalScriptOperationResponse, err error) {
