...
func (c ComanagedDeviceHealthScriptStateClient) GetComanagedDeviceHealthScriptStatesCount(ctx context.Context, id beta.DeviceManagementComanagedDeviceId, options GetComanagedDeviceHealthScriptStatesCountOperationOptions) (result GetComanagedDeviceHealthScriptStatesCountOperationResponse, err error) {
