...
func (c ComanagedDeviceCompliancePolicyStateClient) GetComanagedDeviceCompliancePolicyState(ctx context.Context, id beta.DeviceManagementComanagedDeviceIdDeviceCompliancePolicyStateId, options GetComanagedDeviceCompliancePolicyStateOperationOptions) (result GetComanagedDeviceCompliancePolicyStateOperationResponse, err error) {
