...
func (c ComanagedDeviceCompliancePolicyStateClient) ListComanagedDeviceCompliancePolicyStates(ctx context.Context, id beta.DeviceManagementComanagedDeviceId, options ListComanagedDeviceCompliancePolicyStatesOperationOptions) (result ListComanagedDeviceCompliancePolicyStatesOperationResponse, err error) {
...
func (c ComanagedDeviceCompliancePolicyStateClient) ListComanagedDeviceCompliancePolicyStatesComplete(ctx context.Context, id beta.DeviceManagementComanagedDeviceId, options ListComanagedDeviceCompliancePolicyStatesOperationOptions) (ListComanagedDeviceCompliancePolicyStatesCompleteResult, error) {
