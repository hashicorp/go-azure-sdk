...
// deviceManagement
func (c ComanagedDeviceCompliancePolicyStateClient) DeleteComanagedDeviceCompliancePolicyState(ctx context.Context, id beta.DeviceManagementComanagedDeviceIdDeviceCompliancePolicyStateId, options DeleteComanagedDeviceCompliancePolicyStateOperationOptions) (result DeleteComanagedDeviceCompliancePolicyStateOperationResponse, err error) {
