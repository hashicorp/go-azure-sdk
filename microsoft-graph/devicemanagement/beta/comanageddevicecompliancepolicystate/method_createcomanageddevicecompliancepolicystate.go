...
// deviceManagement
func (c ComanagedDeviceCompliancePolicyStateClient) CreateComanagedDeviceCompliancePolicyState(ctx context.Context, id beta.DeviceManagementComanagedDeviceId, input beta.DeviceCompliancePolicyState) (result CreateComanagedDeviceCompliancePolicyStateOperationResponse, err error) {
