...
func (c DeviceCustomAttributeShellScriptUserRunStateDeviceRunStateClient) DeleteDeviceCustomAttributeShellScriptUserRunStateDeviceRunState(ctx context.Context, id DeviceManagementDeviceCustomAttributeShellScriptIdUserRunStateIdDeviceRunStateId) (result DeleteDeviceCustomAttributeShellScriptUserRunStateDeviceRunStateOperationResponse, err error) {
