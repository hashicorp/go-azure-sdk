...
// CreateDeviceCustomAttributeShellScriptUserRunStateDeviceRunState ...
func (c DeviceCustomAttributeShellScriptUserRunStateDeviceRunStateClient) CreateDeviceCustomAttributeShellScriptUserRunStateDeviceRunState(ctx context.Context, id DeviceManagementDeviceCustomAttributeShellScriptIdUserRunStateId, input beta.DeviceManagementScriptDeviceState) (result CreateDeviceCustomAttributeShellScriptUserRunStateDeviceRunStateOperationResponse, err error) {
