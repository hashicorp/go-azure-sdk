...
// GetDeviceCustomAttributeShellScriptUserRunStateDeviceRunState ...
func (c DeviceCustomAttributeShellScriptUserRunStateDeviceRunStateClient) GetDeviceCustomAttributeShellScriptUserRunStateDeviceRunState(ctx context.Context, id DeviceManagementDeviceCustomAttributeShellScriptIdUserRunStateIdDeviceRunStateId) (result GetDeviceCustomAttributeShellScriptUserRunStateDeviceRunStateOperationResponse, err error) {
