...
// GetTemplateCategory ...
func (c TemplateCategoryClient) GetTemplateCategory(ctx context.Context, id DeviceManagementTemplateIdCategoryId) (result GetTemplateCategoryOperationResponse, err error) {
