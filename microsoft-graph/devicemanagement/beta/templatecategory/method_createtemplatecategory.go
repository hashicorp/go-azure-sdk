...
func (c TemplateCategoryClient) CreateTemplateCategory(ctx context.Context, id DeviceManagementTemplateId, input beta.DeviceManagementTemplateSettingCategory) (result CreateTemplateCategoryOperationResponse, err error) {
