...
func (c ComanagedDeviceHealthScriptStateIdPolicyIdPolicyIdDeviceIdDeviceIdClient) UpdateComanagedDeviceHealthScriptStateIdPolicyIdPolicyIdDeviceIdDeviceId(ctx context.Context, id beta.DeviceManagementComanagedDeviceId, input beta.DeviceHealthScriptPolicyState) (result UpdateComanagedDeviceHealthScriptStateIdPolicyIdPolicyIdDeviceIdDeviceIdOperationResponse, err error) {
