...
func (c DeviceManagementScriptGroupAssignmentClient) CreateDeviceManagementScriptGroupAssignment(ctx context.Context, id DeviceManagementDeviceManagementScriptId, input beta.DeviceManagementScriptGroupAssignment) (result CreateDeviceManagementScriptGroupAssignmentOperationResponse, err error) {
