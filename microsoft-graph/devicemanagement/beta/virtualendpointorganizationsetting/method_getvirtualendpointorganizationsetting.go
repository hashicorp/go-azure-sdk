...
// GetVirtualEndpointOrganizationSetting ...
func (c VirtualEndpointOrganizationSettingClient) GetVirtualEndpointOrganizationSetting(ctx context.Context) (result GetVirtualEndpointOrganizationSettingOperationResponse, err error) {
