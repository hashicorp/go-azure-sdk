...
func (c ReusablePolicySettingReferencingConfigurationDefinitionClient) ListReusablePolicySettingReferencingConfigurationDefinitions(ctx context.Context, id beta.DeviceManagementReusablePolicySettingIdReferencingConfigurationPolicyIdSettingId, options ListReusablePolicySettingReferencingConfigurationDefinitionsOperationOptions) (result ListReusablePolicySettingReferencingConfigurationDefinitionsOperationResponse, err error) {
...
func (c ReusablePolicySettingReferencingConfigurationDefinitionClient) ListReusablePolicySettingReferencingConfigurationDefinitionsComplete(ctx context.Context, id beta.DeviceManagementReusablePolicySettingIdReferencingConfigurationPolicyIdSettingId, options ListReusablePolicySettingReferencingConfigurationDefinitionsOperationOptions) (ListReusablePolicySettingReferencingConfigurationDefinitionsCompleteResult, error) {
