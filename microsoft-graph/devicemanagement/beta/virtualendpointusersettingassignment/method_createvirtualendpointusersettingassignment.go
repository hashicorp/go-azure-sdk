...
func (c VirtualEndpointUserSettingAssignmentClient) CreateVirtualEndpointUserSettingAssignment(ctx context.Context, id beta.DeviceManagementVirtualEndpointUserSettingId, input beta.CloudPCUserSettingAssignment) (result CreateVirtualEndpointUserSettingAssignmentOperationResponse, err error) {
