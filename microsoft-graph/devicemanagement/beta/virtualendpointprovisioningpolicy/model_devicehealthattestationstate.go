...
type DeviceHealthAttestationState struct {
	...
	FirmwareProtection                       *DeviceHealthAttestationStateFirmwareProtection          `json:"firmwareProtection,omitempty"`
	...
	MemoryAccessProtection                   *DeviceHealthAttestationStateMemoryAccessProtection      `json:"memoryAccessProtection,omitempty"`
	MemoryIntegrityProtection                *DeviceHealthAttestationStateMemoryIntegrityProtection   `json:"memoryIntegrityProtection,omitempty"`
	...
	SecuredCorePC                            *DeviceHealthAttestationStateSecuredCorePC               `json:"securedCorePC,omitempty"`
	SystemManagementMode                     *DeviceHealthAttestationStateSystemManagementMode        `json:"systemManagementMode,omitempty"`
	...
	VirtualizationBasedSecurity              *DeviceHealthAttestationStateVirtualizationBasedSecurity `json:"virtualizationBasedSecurity,omitempty"`
