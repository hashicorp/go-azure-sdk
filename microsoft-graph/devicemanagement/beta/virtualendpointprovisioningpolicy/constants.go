...
type CreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettings string

const (
	CreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettingsRegion       CreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettings = "region"
	CreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettingsSingleSignOn CreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettings = "singleSignOn"
)

func PossibleValuesForCreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettings() []string {
	return []string{
		string(CreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettingsRegion),
		string(CreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettingsSingleSignOn),
	}
}

func (s *CreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettings) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseCreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettings(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseCreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettings(input string) (*CreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettings, error) {
	vals := map[string]CreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettings{
		"region":       CreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettingsRegion,
		"singlesignon": CreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettingsSingleSignOn,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := CreateVirtualEndpointProvisioningPolicyApplyConfigRequestPolicySettings(input)
	return &out, nil
}

type CreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettings string

const (
	CreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettingsRegion       CreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettings = "region"
	CreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettingsSingleSignOn CreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettings = "singleSignOn"
)

func PossibleValuesForCreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettings() []string {
	return []string{
		string(CreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettingsRegion),
		string(CreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettingsSingleSignOn),
	}
}

func (s *CreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettings) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseCreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettings(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseCreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettings(input string) (*CreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettings, error) {
	vals := map[string]CreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettings{
		"region":       CreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettingsRegion,
		"singlesignon": CreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettingsSingleSignOn,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := CreateVirtualEndpointProvisioningPolicyApplyRequestPolicySettings(input)
	return &out, nil
}
