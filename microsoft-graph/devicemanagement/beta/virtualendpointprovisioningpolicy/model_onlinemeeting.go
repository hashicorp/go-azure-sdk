...
type OnlineMeeting struct {
	...
	AnonymizeIdentityForRoles      *OnlineMeetingAnonymizeIdentityForRoles      `json:"anonymizeIdentityForRoles,omitempty"`
	...
	Capabilities                   *OnlineMeetingCapabilities                   `json:"capabilities,omitempty"`
