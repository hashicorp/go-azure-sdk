...
func (c GroupPolicyDefinitionNextVersionDefinitionPreviousCategoryClient) GetGroupPolicyDefinitionNextVersionDefinitionPreviousCategory(ctx context.Context, id beta.DeviceManagementGroupPolicyDefinitionId, options GetGroupPolicyDefinitionNextVersionDefinitionPreviousCategoryOperationOptions) (result GetGroupPolicyDefinitionNextVersionDefinitionPreviousCategoryOperationResponse, err error) {
