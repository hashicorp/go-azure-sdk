...
func (c UserExperienceAnalyticsMetricHistoryClient) GetUserExperienceAnalyticsMetricHistory(ctx context.Context, id DeviceManagementUserExperienceAnalyticsMetricHistoryId) (result GetUserExperienceAnalyticsMetricHistoryOperationResponse, err error) {
