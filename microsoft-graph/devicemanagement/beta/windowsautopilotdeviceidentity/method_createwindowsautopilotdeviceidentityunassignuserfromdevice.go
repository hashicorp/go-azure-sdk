...
func (c WindowsAutopilotDeviceIdentityClient) CreateWindowsAutopilotDeviceIdentityUnassignUserFromDevice(ctx context.Context, id beta.DeviceManagementWindowsAutopilotDeviceIdentityId) (result CreateWindowsAutopilotDeviceIdentityUnassignUserFromDeviceOperationResponse, err error) {
