...
func (c CompliancePolicyAssignmentClient) CreateCompliancePolicyAssignment(ctx context.Context, id beta.DeviceManagementCompliancePolicyId, input beta.DeviceManagementConfigurationPolicyAssignment) (result CreateCompliancePolicyAssignmentOperationResponse, err error) {
