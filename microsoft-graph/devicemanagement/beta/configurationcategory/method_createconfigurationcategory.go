...
func (c ConfigurationCategoryClient) CreateConfigurationCategory(ctx context.Context, input beta.DeviceManagementConfigurationCategory) (result CreateConfigurationCategoryOperationResponse, err error) {
