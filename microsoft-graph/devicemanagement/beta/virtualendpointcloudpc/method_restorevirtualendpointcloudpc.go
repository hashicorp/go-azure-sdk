...
func (c VirtualEndpointCloudPCClient) RestoreVirtualEndpointCloudPC(ctx context.Context, id beta.DeviceManagementVirtualEndpointCloudPCId, input RestoreVirtualEndpointCloudPCRequest) (result RestoreVirtualEndpointCloudPCOperationResponse, err error) {
