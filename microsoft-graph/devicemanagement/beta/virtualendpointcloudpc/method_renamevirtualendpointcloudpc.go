...
func (c VirtualEndpointCloudPCClient) RenameVirtualEndpointCloudPC(ctx context.Context, id beta.DeviceManagementVirtualEndpointCloudPCId, input RenameVirtualEndpointCloudPCRequest) (result RenameVirtualEndpointCloudPCOperationResponse, err error) {
