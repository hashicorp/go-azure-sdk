...
func (c ManagedDeviceDeviceCategoryClient) RemoveManagedDeviceCategoryRef(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options RemoveManagedDeviceCategoryRefOperationOptions) (result RemoveManagedDeviceCategoryRefOperationResponse, err error) {
