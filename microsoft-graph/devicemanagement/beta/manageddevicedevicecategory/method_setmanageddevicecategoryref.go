...
func (c ManagedDeviceDeviceCategoryClient) SetManagedDeviceCategoryRef(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input beta.ReferenceUpdate, options SetManagedDeviceCategoryRefOperationOptions) (result SetManagedDeviceCategoryRefOperationResponse, err error) {
