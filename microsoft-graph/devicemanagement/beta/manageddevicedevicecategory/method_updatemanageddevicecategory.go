...
func (c ManagedDeviceDeviceCategoryClient) UpdateManagedDeviceCategory(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input beta.DeviceCategory) (result UpdateManagedDeviceCategoryOperationResponse, err error) {
