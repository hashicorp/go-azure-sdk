...
// CreateGroupPolicyConfigurationDefinitionValuePresentationValue ...
func (c GroupPolicyConfigurationDefinitionValuePresentationValueClient) CreateGroupPolicyConfigurationDefinitionValuePresentationValue(ctx context.Context, id DeviceManagementGroupPolicyConfigurationIdDefinitionValueId, input beta.GroupPolicyPresentationValue) (result CreateGroupPolicyConfigurationDefinitionValuePresentationValueOperationResponse, err error) {
