...
func (c MicrosoftTunnelSiteConfigurationClient) DeleteMicrosoftTunnelSiteConfiguration(ctx context.Context, id beta.DeviceManagementMicrosoftTunnelSiteId, options DeleteMicrosoftTunnelSiteConfigurationOperationOptions) (result DeleteMicrosoftTunnelSiteConfigurationOperationResponse, err error) {
