...
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) DeleteMobileAppTroubleshootingEventAppLogCollectionRequest(ctx context.Context, id DeviceManagementMobileAppTroubleshootingEventIdAppLogCollectionRequestId) (result DeleteMobileAppTroubleshootingEventAppLogCollectionRequestOperationResponse, err error) {
