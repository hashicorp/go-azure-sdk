...
// UpdateUserExperienceAnalyticsDeviceTimelineEvent ...
func (c UserExperienceAnalyticsDeviceTimelineEventClient) UpdateUserExperienceAnalyticsDeviceTimelineEvent(ctx context.Context, id DeviceManagementUserExperienceAnalyticsDeviceTimelineEventId, input beta.UserExperienceAnalyticsDeviceTimelineEvent) (result UpdateUserExperienceAnalyticsDeviceTimelineEventOperationResponse, err error) {
