...
// CreateDeviceConfigurationAssignedAccessMultiModeProfile ...
func (c DeviceConfigurationClient) CreateDeviceConfigurationAssignedAccessMultiModeProfile(ctx context.Context, id DeviceManagementDeviceConfigurationId, input CreateDeviceConfigurationAssignedAccessMultiModeProfileRequest) (result CreateDeviceConfigurationAssignedAccessMultiModeProfileOperationResponse, err error) {
