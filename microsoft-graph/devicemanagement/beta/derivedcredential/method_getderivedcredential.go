...
func (c DerivedCredentialClient) GetDerivedCredential(ctx context.Context, id DeviceManagementDerivedCredentialId) (result GetDerivedCredentialOperationResponse, err error) {
