...
// UpdateVirtualEndpointProvisioningPolicyAssignment ...
func (c VirtualEndpointProvisioningPolicyAssignmentClient) UpdateVirtualEndpointProvisioningPolicyAssignment(ctx context.Context, id DeviceManagementVirtualEndpointProvisioningPolicyIdAssignmentId, input beta.CloudPCProvisioningPolicyAssignment) (result UpdateVirtualEndpointProvisioningPolicyAssignmentOperationResponse, err error) {
