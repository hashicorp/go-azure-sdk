...
func (c ComanagedDeviceCategoryClient) GetComanagedDeviceCategory(ctx context.Context, id beta.DeviceManagementComanagedDeviceId, options GetComanagedDeviceCategoryOperationOptions) (result GetComanagedDeviceCategoryOperationResponse, err error) {
