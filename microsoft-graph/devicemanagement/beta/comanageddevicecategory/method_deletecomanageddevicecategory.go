...
func (c ComanagedDeviceCategoryClient) DeleteComanagedDeviceCategory(ctx context.Context, id beta.DeviceManagementComanagedDeviceId, options DeleteComanagedDeviceCategoryOperationOptions) (result DeleteComanagedDeviceCategoryOperationResponse, err error) {
