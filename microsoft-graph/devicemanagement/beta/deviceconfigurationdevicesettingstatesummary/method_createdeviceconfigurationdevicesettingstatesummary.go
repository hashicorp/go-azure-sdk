...
func (c DeviceConfigurationDeviceSettingStateSummaryClient) CreateDeviceConfigurationDeviceSettingStateSummary(ctx context.Context, id DeviceManagementDeviceConfigurationId, input beta.SettingStateDeviceSummary) (result CreateDeviceConfigurationDeviceSettingStateSummaryOperationResponse, err error) {
