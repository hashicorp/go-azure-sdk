...
type EnableUnlicensedAdminstratorOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

// EnableUnlicensedAdminstrator - Invoke action enableUnlicensedAdminstrators. Upon enabling, users assigned as
...
func (c DeviceManagementClient) EnableUnlicensedAdminstrator(ctx context.Context) (result EnableUnlicensedAdminstratorOperationResponse, err error) {
