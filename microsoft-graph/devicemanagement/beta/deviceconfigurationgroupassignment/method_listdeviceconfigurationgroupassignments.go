...
// ListDeviceConfigurationGroupAssignments ...
func (c DeviceConfigurationGroupAssignmentClient) ListDeviceConfigurationGroupAssignments(ctx context.Context, id DeviceManagementDeviceConfigurationId) (result ListDeviceConfigurationGroupAssignmentsOperationResponse, err error) {
...
func (c DeviceConfigurationGroupAssignmentClient) ListDeviceConfigurationGroupAssignmentsComplete(ctx context.Context, id DeviceManagementDeviceConfigurationId) (ListDeviceConfigurationGroupAssignmentsCompleteResult, error) {
	return c.ListDeviceConfigurationGroupAssignmentsCompleteMatchingPredicate(ctx, id, DeviceConfigurationGroupAssignmentOperationPredicate{})
}
...
func (c DeviceConfigurationGroupAssignmentClient) ListDeviceConfigurationGroupAssignmentsCompleteMatchingPredicate(ctx context.Context, id DeviceManagementDeviceConfigurationId, predicate DeviceConfigurationGroupAssignmentOperationPredicate) (result ListDeviceConfigurationGroupAssignmentsCompleteResult, err error) {
	items := make([]beta.DeviceConfigurationGroupAssignment, 0)

	resp, err := c.ListDeviceConfigurationGroupAssignments(ctx, id)
	if err != nil {
