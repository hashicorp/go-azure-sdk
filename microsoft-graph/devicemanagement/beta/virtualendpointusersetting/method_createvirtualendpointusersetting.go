...
func (c VirtualEndpointUserSettingClient) CreateVirtualEndpointUserSetting(ctx context.Context, input beta.CloudPCUserSetting) (result CreateVirtualEndpointUserSettingOperationResponse, err error) {
