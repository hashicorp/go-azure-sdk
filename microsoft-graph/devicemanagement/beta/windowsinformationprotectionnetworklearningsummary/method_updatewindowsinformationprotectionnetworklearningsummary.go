...
// UpdateWindowsInformationProtectionNetworkLearningSummary ...
func (c WindowsInformationProtectionNetworkLearningSummaryClient) UpdateWindowsInformationProtectionNetworkLearningSummary(ctx context.Context, id DeviceManagementWindowsInformationProtectionNetworkLearningSummaryId, input beta.WindowsInformationProtectionNetworkLearningSummary) (result UpdateWindowsInformationProtectionNetworkLearningSummaryOperationResponse, err error) {
