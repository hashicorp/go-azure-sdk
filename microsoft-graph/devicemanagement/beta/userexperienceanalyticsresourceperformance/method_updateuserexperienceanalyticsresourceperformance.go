...
// UpdateUserExperienceAnalyticsResourcePerformance ...
func (c UserExperienceAnalyticsResourcePerformanceClient) UpdateUserExperienceAnalyticsResourcePerformance(ctx context.Context, id DeviceManagementUserExperienceAnalyticsResourcePerformanceId, input beta.UserExperienceAnalyticsResourcePerformance) (result UpdateUserExperienceAnalyticsResourcePerformanceOperationResponse, err error) {
