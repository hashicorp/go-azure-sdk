...
func (c ManagedDeviceCategoryClient) UpdateManagedDeviceCategory(ctx context.Context, id beta.DeviceManagementManagedDeviceId, input beta.DeviceCategory) (result UpdateManagedDeviceCategoryOperationResponse, err error) {
