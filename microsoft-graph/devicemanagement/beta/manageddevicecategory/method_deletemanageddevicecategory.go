...
func (c ManagedDeviceCategoryClient) DeleteManagedDeviceCategory(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options DeleteManagedDeviceCategoryOperationOptions) (result DeleteManagedDeviceCategoryOperationResponse, err error) {
