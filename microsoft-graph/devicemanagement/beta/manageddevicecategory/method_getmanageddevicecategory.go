...
func (c ManagedDeviceCategoryClient) GetManagedDeviceCategory(ctx context.Context, id beta.DeviceManagementManagedDeviceId, options GetManagedDeviceCategoryOperationOptions) (result GetManagedDeviceCategoryOperationResponse, err error) {
