...
func (c GroupPolicyDefinitionNextVersionDefinitionPreviousFileClient) GetGroupPolicyDefinitionNextVersionDefinitionPreviousFile(ctx context.Context, id beta.DeviceManagementGroupPolicyDefinitionId, options GetGroupPolicyDefinitionNextVersionDefinitionPreviousFileOperationOptions) (result GetGroupPolicyDefinitionNextVersionDefinitionPreviousFileOperationResponse, err error) {
