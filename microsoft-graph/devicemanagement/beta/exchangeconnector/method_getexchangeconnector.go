...
func (c ExchangeConnectorClient) GetExchangeConnector(ctx context.Context, id DeviceManagementExchangeConnectorId) (result GetExchangeConnectorOperationResponse, err error) {
