...
// UpdateVirtualEndpointProvisioningPolicyAssignmentAssignedUserMailboxSetting ...
func (c VirtualEndpointProvisioningPolicyAssignmentAssignedUserMailboxSettingClient) UpdateVirtualEndpointProvisioningPolicyAssignmentAssignedUserMailboxSetting(ctx context.Context, id DeviceManagementVirtualEndpointProvisioningPolicyIdAssignmentIdAssignedUserId, input beta.MailboxSettings) (result UpdateVirtualEndpointProvisioningPolicyAssignmentAssignedUserMailboxSettingOperationResponse, err error) {
