...
// GetVirtualEndpointProvisioningPolicyAssignmentAssignedUserMailboxSetting ...
func (c VirtualEndpointProvisioningPolicyAssignmentAssignedUserMailboxSettingClient) GetVirtualEndpointProvisioningPolicyAssignmentAssignedUserMailboxSetting(ctx context.Context, id DeviceManagementVirtualEndpointProvisioningPolicyIdAssignmentIdAssignedUserId) (result GetVirtualEndpointProvisioningPolicyAssignmentAssignedUserMailboxSettingOperationResponse, err error) {
