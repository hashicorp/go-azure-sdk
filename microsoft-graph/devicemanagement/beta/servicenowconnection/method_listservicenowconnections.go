...
// ListServiceNowConnections ...
func (c ServiceNowConnectionClient) ListServiceNowConnections(ctx context.Context) (result ListServiceNowConnectionsOperationResponse, err error) {
...
func (c ServiceNowConnectionClient) ListServiceNowConnectionsComplete(ctx context.Context) (ListServiceNowConnectionsCompleteResult, error) {
	return c.ListServiceNowConnectionsCompleteMatchingPredicate(ctx, ServiceNowConnectionOperationPredicate{})
}

// ListServiceNowConnectionsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ServiceNowConnectionClient) ListServiceNowConnectionsCompleteMatchingPredicate(ctx context.Context, predicate ServiceNowConnectionOperationPredicate) (result ListServiceNowConnectionsCompleteResult, err error) {
	items := make([]beta.ServiceNowConnection, 0)

	resp, err := c.ListServiceNowConnections(ctx)
	if err != nil {
