...
// deviceManagement
func (c UserExperienceAnalyticsWorkFromAnywhereMetricMetricDeviceClient) UpdateUserExperienceAnalyticsWorkFromAnywhereMetricDevice(ctx context.Context, id beta.DeviceManagementUserExperienceAnalyticsWorkFromAnywhereMetricIdMetricDeviceId, input beta.UserExperienceAnalyticsWorkFromAnywhereDevice) (result UpdateUserExperienceAnalyticsWorkFromAnywhereMetricDeviceOperationResponse, err error) {
