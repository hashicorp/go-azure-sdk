...
func (c UserExperienceAnalyticsBatteryHealthModelPerformanceClient) GetUserExperienceAnalyticsBatteryHealthModelPerformance(ctx context.Context, id DeviceManagementUserExperienceAnalyticsBatteryHealthModelPerformanceId) (result GetUserExperienceAnalyticsBatteryHealthModelPerformanceOperationResponse, err error) {
