...
// UpdateUserExperienceAnalyticsBatteryHealthModelPerformance ...
func (c UserExperienceAnalyticsBatteryHealthModelPerformanceClient) UpdateUserExperienceAnalyticsBatteryHealthModelPerformance(ctx context.Context, id DeviceManagementUserExperienceAnalyticsBatteryHealthModelPerformanceId, input beta.UserExperienceAnalyticsBatteryHealthModelPerformance) (result UpdateUserExperienceAnalyticsBatteryHealthModelPerformanceOperationResponse, err error) {
