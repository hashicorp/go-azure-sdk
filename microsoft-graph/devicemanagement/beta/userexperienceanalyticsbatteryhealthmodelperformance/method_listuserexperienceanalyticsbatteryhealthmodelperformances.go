...
func (c UserExperienceAnalyticsBatteryHealthModelPerformanceClient) ListUserExperienceAnalyticsBatteryHealthModelPerformances(ctx context.Context) (result ListUserExperienceAnalyticsBatteryHealthModelPerformancesOperationResponse, err error) {
...
func (c UserExperienceAnalyticsBatteryHealthModelPerformanceClient) ListUserExperienceAnalyticsBatteryHealthModelPerformancesComplete(ctx context.Context) (ListUserExperienceAnalyticsBatteryHealthModelPerformancesCompleteResult, error) {
	return c.ListUserExperienceAnalyticsBatteryHealthModelPerformancesCompleteMatchingPredicate(ctx, UserExperienceAnalyticsBatteryHealthModelPerformanceOperationPredicate{})
}
...
func (c UserExperienceAnalyticsBatteryHealthModelPerformanceClient) ListUserExperienceAnalyticsBatteryHealthModelPerformancesCompleteMatchingPredicate(ctx context.Context, predicate UserExperienceAnalyticsBatteryHealthModelPerformanceOperationPredicate) (result ListUserExperienceAnalyticsBatteryHealthModelPerformancesCompleteResult, err error) {
	items := make([]beta.UserExperienceAnalyticsBatteryHealthModelPerformance, 0)

	resp, err := c.ListUserExperienceAnalyticsBatteryHealthModelPerformances(ctx)
	if err != nil {
