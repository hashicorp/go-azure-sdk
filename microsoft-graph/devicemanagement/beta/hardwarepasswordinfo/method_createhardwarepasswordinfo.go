...
func (c HardwarePasswordInfoClient) CreateHardwarePasswordInfo(ctx context.Context, input beta.HardwarePasswordInfo) (result CreateHardwarePasswordInfoOperationResponse, err error) {
