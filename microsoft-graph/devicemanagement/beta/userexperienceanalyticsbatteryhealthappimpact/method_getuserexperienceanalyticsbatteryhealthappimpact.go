...
func (c UserExperienceAnalyticsBatteryHealthAppImpactClient) GetUserExperienceAnalyticsBatteryHealthAppImpact(ctx context.Context, id DeviceManagementUserExperienceAnalyticsBatteryHealthAppImpactId) (result GetUserExperienceAnalyticsBatteryHealthAppImpactOperationResponse, err error) {
