...
func (c GroupPolicyUploadedDefinitionFileOperationClient) GetGroupPolicyUploadedDefinitionFileOperation(ctx context.Context, id beta.DeviceManagementGroupPolicyUploadedDefinitionFileIdGroupPolicyOperationId, options GetGroupPolicyUploadedDefinitionFileOperationOperationOptions) (result GetGroupPolicyUploadedDefinitionFileOperationOperationResponse, err error) {
