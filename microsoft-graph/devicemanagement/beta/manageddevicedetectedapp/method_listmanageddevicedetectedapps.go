...
func (c ManagedDeviceDetectedAppClient) ListManagedDeviceDetectedApps(ctx context.Context, id DeviceManagementManagedDeviceId) (result ListManagedDeviceDetectedAppsOperationResponse, err error) {
...
func (c ManagedDeviceDetectedAppClient) ListManagedDeviceDetectedAppsComplete(ctx context.Context, id DeviceManagementManagedDeviceId) (ListManagedDeviceDetectedAppsCompleteResult, error) {
...
func (c ManagedDeviceDetectedAppClient) ListManagedDeviceDetectedAppsCompleteMatchingPredicate(ctx context.Context, id DeviceManagementManagedDeviceId, predicate DetectedAppOperationPredicate) (result ListManagedDeviceDetectedAppsCompleteResult, err error) {
