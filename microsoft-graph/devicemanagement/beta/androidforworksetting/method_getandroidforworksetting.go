...
// GetAndroidForWorkSetting ...
func (c AndroidForWorkSettingClient) GetAndroidForWorkSetting(ctx context.Context) (result GetAndroidForWorkSettingOperationResponse, err error) {
