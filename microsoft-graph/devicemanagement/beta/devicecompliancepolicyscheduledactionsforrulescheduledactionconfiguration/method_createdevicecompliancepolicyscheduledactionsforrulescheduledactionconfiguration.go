...
func (c DeviceCompliancePolicyScheduledActionsForRuleScheduledActionConfigurationClient) CreateDeviceCompliancePolicyScheduledActionsForRuleScheduledActionConfiguration(ctx context.Context, id DeviceManagementDeviceCompliancePolicyIdScheduledActionsForRuleId, input beta.DeviceComplianceActionItem) (result CreateDeviceCompliancePolicyScheduledActionsForRuleScheduledActionConfigurationOperationResponse, err error) {
