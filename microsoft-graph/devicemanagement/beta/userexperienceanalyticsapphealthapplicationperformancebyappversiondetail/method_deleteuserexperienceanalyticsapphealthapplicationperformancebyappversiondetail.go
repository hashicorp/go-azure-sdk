...
// DeleteUserExperienceAnalyticsAppHealthApplicationPerformanceByAppVersionDetail ...
func (c UserExperienceAnalyticsAppHealthApplicationPerformanceByAppVersionDetailClient) DeleteUserExperienceAnalyticsAppHealthApplicationPerformanceByAppVersionDetail(ctx context.Context, id DeviceManagementUserExperienceAnalyticsAppHealthApplicationPerformanceByAppVersionDetailId) (result DeleteUserExperienceAnalyticsAppHealthApplicationPerformanceByAppVersionDetailOperationResponse, err error) {
