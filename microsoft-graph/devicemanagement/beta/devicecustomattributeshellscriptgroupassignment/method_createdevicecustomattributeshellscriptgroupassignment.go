...
// CreateDeviceCustomAttributeShellScriptGroupAssignment ...
func (c DeviceCustomAttributeShellScriptGroupAssignmentClient) CreateDeviceCustomAttributeShellScriptGroupAssignment(ctx context.Context, id DeviceManagementDeviceCustomAttributeShellScriptId, input beta.DeviceManagementScriptGroupAssignment) (result CreateDeviceCustomAttributeShellScriptGroupAssignmentOperationResponse, err error) {
