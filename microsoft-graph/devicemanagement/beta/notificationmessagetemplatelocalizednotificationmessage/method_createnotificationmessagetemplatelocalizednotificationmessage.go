...
func (c NotificationMessageTemplateLocalizedNotificationMessageClient) CreateNotificationMessageTemplateLocalizedNotificationMessage(ctx context.Context, id DeviceManagementNotificationMessageTemplateId, input beta.LocalizedNotificationMessage) (result CreateNotificationMessageTemplateLocalizedNotificationMessageOperationResponse, err error) {
