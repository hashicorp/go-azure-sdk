...
func (c TemplateSettingDefinitionClient) GetTemplateSettingDefinitionsCount(ctx context.Context, id beta.DeviceManagementTemplateSettingId, options GetTemplateSettingDefinitionsCountOperationOptions) (result GetTemplateSettingDefinitionsCountOperationResponse, err error) {
