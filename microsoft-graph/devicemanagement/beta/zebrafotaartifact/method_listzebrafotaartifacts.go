...
func (c ZebraFotaArtifactClient) ListZebraFotaArtifacts(ctx context.Context) (result ListZebraFotaArtifactsOperationResponse, err error) {
...
func (c ZebraFotaArtifactClient) ListZebraFotaArtifactsComplete(ctx context.Context) (ListZebraFotaArtifactsCompleteResult, error) {
	return c.ListZebraFotaArtifactsCompleteMatchingPredicate(ctx, ZebraFotaArtifactOperationPredicate{})
}

// ListZebraFotaArtifactsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ZebraFotaArtifactClient) ListZebraFotaArtifactsCompleteMatchingPredicate(ctx context.Context, predicate ZebraFotaArtifactOperationPredicate) (result ListZebraFotaArtifactsCompleteResult, err error) {
	items := make([]beta.ZebraFotaArtifact, 0)

	resp, err := c.ListZebraFotaArtifacts(ctx)
	if err != nil {
