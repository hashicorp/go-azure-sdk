...
type CreateConfigurationPolicyTemplateSettingTemplateSettingDefinitionOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.DeviceManagementConfigurationSettingDefinition
}

// CreateConfigurationPolicyTemplateSettingTemplateSettingDefinition ...
func (c ConfigurationPolicyTemplateSettingTemplateSettingDefinitionClient) CreateConfigurationPolicyTemplateSettingTemplateSettingDefinition(ctx context.Context, id DeviceManagementConfigurationPolicyTemplateIdSettingTemplateId, input beta.DeviceManagementConfigurationSettingDefinition) (result CreateConfigurationPolicyTemplateSettingTemplateSettingDefinitionOperationResponse, err error) {
