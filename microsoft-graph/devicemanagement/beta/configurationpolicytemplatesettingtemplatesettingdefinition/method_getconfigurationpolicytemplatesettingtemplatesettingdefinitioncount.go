...
type GetConfigurationPolicyTemplateSettingTemplateSettingDefinitionCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetConfigurationPolicyTemplateSettingTemplateSettingDefinitionCount ...
func (c ConfigurationPolicyTemplateSettingTemplateSettingDefinitionClient) GetConfigurationPolicyTemplateSettingTemplateSettingDefinitionCount(ctx context.Context, id DeviceManagementConfigurationPolicyTemplateIdSettingTemplateId) (result GetConfigurationPolicyTemplateSettingTemplateSettingDefinitionCountOperationResponse, err error) {
