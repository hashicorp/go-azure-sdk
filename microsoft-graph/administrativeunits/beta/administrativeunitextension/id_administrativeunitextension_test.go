...
func TestNewAdministrativeUnitExtensionID(t *testing.T) {
	id := NewAdministrativeUnitExtensionID("administrativeUnitIdValue", "extensionIdValue")
...
func TestFormatAdministrativeUnitExtensionID(t *testing.T) {
	actual := NewAdministrativeUnitExtensionID("administrativeUnitIdValue", "extensionIdValue").ID()
...
func TestParseAdministrativeUnitExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *AdministrativeUnitExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseAdministrativeUnitExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseAdministrativeUnitExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *AdministrativeUnitExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseAdministrativeUnitExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForAdministrativeUnitExtensionId(t *testing.T) {
	segments := AdministrativeUnitExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("AdministrativeUnitExtensionId has no segments")
	}
