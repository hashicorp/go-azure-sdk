...
func NewAdministrativeUnitExtensionClientWithBaseURI(api sdkEnv.Api) (*AdministrativeUnitExtensionClient, error) {
	client, err := msgraph.NewMsGraphClient(api, "administrativeunitextension", defaultApiVersion)
	if err != nil {
