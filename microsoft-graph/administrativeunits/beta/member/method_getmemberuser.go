...
func (c MemberClient) GetMemberUser(ctx context.Context, id beta.AdministrativeUnitIdMemberId, options GetMemberUserOperationOptions) (result GetMemberUserOperationResponse, err error) {
