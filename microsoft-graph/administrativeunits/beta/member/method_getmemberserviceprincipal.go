...
func (c MemberClient) GetMemberServicePrincipal(ctx context.Context, id beta.AdministrativeUnitIdMemberId, options GetMemberServicePrincipalOperationOptions) (result GetMemberServicePrincipalOperationResponse, err error) {
