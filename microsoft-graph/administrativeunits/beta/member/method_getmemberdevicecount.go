...
func (c MemberClient) GetMemberDeviceCount(ctx context.Context, id beta.AdministrativeUnitId, options GetMemberDeviceCountOperationOptions) (result GetMemberDeviceCountOperationResponse, err error) {
