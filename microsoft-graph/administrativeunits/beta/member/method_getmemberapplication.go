...
func (c MemberClient) GetMemberApplication(ctx context.Context, id beta.AdministrativeUnitIdMemberId, options GetMemberApplicationOperationOptions) (result GetMemberApplicationOperationResponse, err error) {
