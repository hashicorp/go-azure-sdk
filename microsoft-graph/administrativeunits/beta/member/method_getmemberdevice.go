...
func (c MemberClient) GetMemberDevice(ctx context.Context, id beta.AdministrativeUnitIdMemberId, options GetMemberDeviceOperationOptions) (result GetMemberDeviceOperationResponse, err error) {
