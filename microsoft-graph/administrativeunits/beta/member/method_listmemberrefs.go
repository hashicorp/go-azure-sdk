...
// ListMemberRefs ...
func (c MemberClient) ListMemberRefs(ctx context.Context, id AdministrativeUnitId) (result ListMemberRefsOperationResponse, err error) {
...
func (c MemberClient) ListMemberRefsComplete(ctx context.Context, id AdministrativeUnitId) (result ListMemberRefsCompleteResult, err error) {
	items := make([]string, 0)
