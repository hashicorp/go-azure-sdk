...
func (c MemberClient) GetMemberGroup(ctx context.Context, id beta.AdministrativeUnitIdMemberId, options GetMemberGroupOperationOptions) (result GetMemberGroupOperationResponse, err error) {
