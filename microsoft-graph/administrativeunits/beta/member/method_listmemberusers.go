...
func (c MemberClient) ListMemberUsers(ctx context.Context, id beta.AdministrativeUnitId, options ListMemberUsersOperationOptions) (result ListMemberUsersOperationResponse, err error) {
...
func (c MemberClient) ListMemberUsersComplete(ctx context.Context, id beta.AdministrativeUnitId, options ListMemberUsersOperationOptions) (ListMemberUsersCompleteResult, error) {
...
func (c MemberClient) ListMemberUsersCompleteMatchingPredicate(ctx context.Context, id beta.AdministrativeUnitId, options ListMemberUsersOperationOptions, predicate UserOperationPredicate) (result ListMemberUsersCompleteResult, err error) {
