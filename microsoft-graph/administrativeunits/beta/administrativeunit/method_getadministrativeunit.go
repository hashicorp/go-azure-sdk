...
func (c AdministrativeUnitClient) GetAdministrativeUnit(ctx context.Context, id AdministrativeUnitId) (result GetAdministrativeUnitOperationResponse, err error) {
