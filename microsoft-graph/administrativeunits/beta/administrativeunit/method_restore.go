...
func (c AdministrativeUnitClient) Restore(ctx context.Context, id beta.AdministrativeUnitId, input RestoreRequest) (result RestoreOperationResponse, err error) {
