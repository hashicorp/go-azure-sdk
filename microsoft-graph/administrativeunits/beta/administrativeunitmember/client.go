...
func NewAdministrativeUnitMemberClientWithBaseURI(api sdkEnv.Api) (*AdministrativeUnitMemberClient, error) {
	client, err := msgraph.NewMsGraphClient(api, "administrativeunitmember", defaultApiVersion)
	if err != nil {
