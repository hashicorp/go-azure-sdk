...
func (c DirectoryRoleClient) Restore(ctx context.Context, id beta.DirectoryRoleId, options RestoreOperationOptions) (result RestoreOperationResponse, err error) {
