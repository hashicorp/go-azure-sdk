...
func (c MemberClient) GetMemberDevice(ctx context.Context, id beta.DirectoryRoleIdMemberId, options GetMemberDeviceOperationOptions) (result GetMemberDeviceOperationResponse, err error) {
