...
func (c MemberClient) GetMemberApplication(ctx context.Context, id beta.DirectoryRoleIdMemberId, options GetMemberApplicationOperationOptions) (result GetMemberApplicationOperationResponse, err error) {
