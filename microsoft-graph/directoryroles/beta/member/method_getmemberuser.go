...
func (c MemberClient) GetMemberUser(ctx context.Context, id beta.DirectoryRoleIdMemberId, options GetMemberUserOperationOptions) (result GetMemberUserOperationResponse, err error) {
