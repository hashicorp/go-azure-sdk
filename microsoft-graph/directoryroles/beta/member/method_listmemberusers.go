...
func (c MemberClient) ListMemberUsers(ctx context.Context, id beta.DirectoryRoleId, options ListMemberUsersOperationOptions) (result ListMemberUsersOperationResponse, err error) {
...
func (c MemberClient) ListMemberUsersComplete(ctx context.Context, id beta.DirectoryRoleId, options ListMemberUsersOperationOptions) (ListMemberUsersCompleteResult, error) {
...
func (c MemberClient) ListMemberUsersCompleteMatchingPredicate(ctx context.Context, id beta.DirectoryRoleId, options ListMemberUsersOperationOptions, predicate UserOperationPredicate) (result ListMemberUsersCompleteResult, err error) {
