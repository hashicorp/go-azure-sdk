...
func (c MemberClient) GetMemberGroup(ctx context.Context, id beta.DirectoryRoleIdMemberId, options GetMemberGroupOperationOptions) (result GetMemberGroupOperationResponse, err error) {
