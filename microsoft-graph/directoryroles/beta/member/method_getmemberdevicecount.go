...
func (c MemberClient) GetMemberDeviceCount(ctx context.Context, id beta.DirectoryRoleId, options GetMemberDeviceCountOperationOptions) (result GetMemberDeviceCountOperationResponse, err error) {
