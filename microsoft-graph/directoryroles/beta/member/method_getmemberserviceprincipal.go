...
func (c MemberClient) GetMemberServicePrincipal(ctx context.Context, id beta.DirectoryRoleIdMemberId, options GetMemberServicePrincipalOperationOptions) (result GetMemberServicePrincipalOperationResponse, err error) {
