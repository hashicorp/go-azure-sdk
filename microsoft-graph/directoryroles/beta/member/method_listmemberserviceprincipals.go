...
func (c MemberClient) ListMemberServicePrincipals(ctx context.Context, id beta.DirectoryRoleId, options ListMemberServicePrincipalsOperationOptions) (result ListMemberServicePrincipalsOperationResponse, err error) {
...
func (c MemberClient) ListMemberServicePrincipalsComplete(ctx context.Context, id beta.DirectoryRoleId, options ListMemberServicePrincipalsOperationOptions) (ListMemberServicePrincipalsCompleteResult, error) {
...
func (c MemberClient) ListMemberServicePrincipalsCompleteMatchingPredicate(ctx context.Context, id beta.DirectoryRoleId, options ListMemberServicePrincipalsOperationOptions, predicate ServicePrincipalOperationPredicate) (result ListMemberServicePrincipalsCompleteResult, err error) {
