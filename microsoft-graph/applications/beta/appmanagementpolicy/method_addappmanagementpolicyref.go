...
func (c AppManagementPolicyClient) AddAppManagementPolicyRef(ctx context.Context, id beta.ApplicationId, input beta.ReferenceCreate) (result AddAppManagementPolicyRefOperationResponse, err error) {
