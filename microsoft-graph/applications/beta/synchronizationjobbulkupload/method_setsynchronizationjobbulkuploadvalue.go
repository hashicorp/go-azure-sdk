...
func (c SynchronizationJobBulkUploadClient) SetSynchronizationJobBulkUploadValue(ctx context.Context, id beta.ApplicationIdSynchronizationJobId, input []byte) (result SetSynchronizationJobBulkUploadValueOperationResponse, err error) {
