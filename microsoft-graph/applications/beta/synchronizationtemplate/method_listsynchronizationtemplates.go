...
func (c SynchronizationTemplateClient) ListSynchronizationTemplates(ctx context.Context, id ApplicationId) (result ListSynchronizationTemplatesOperationResponse, err error) {
...
func (c SynchronizationTemplateClient) ListSynchronizationTemplatesComplete(ctx context.Context, id ApplicationId) (ListSynchronizationTemplatesCompleteResult, error) {
...
func (c SynchronizationTemplateClient) ListSynchronizationTemplatesCompleteMatchingPredicate(ctx context.Context, id ApplicationId, predicate SynchronizationTemplateOperationPredicate) (result ListSynchronizationTemplatesCompleteResult, err error) {
