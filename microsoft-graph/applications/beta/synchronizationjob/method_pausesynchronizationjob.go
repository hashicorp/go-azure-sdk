...
func (c SynchronizationJobClient) PauseSynchronizationJob(ctx context.Context, id beta.ApplicationIdSynchronizationJobId) (result PauseSynchronizationJobOperationResponse, err error) {
