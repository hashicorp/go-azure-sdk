...
func (c SynchronizationJobClient) StartSynchronizationJob(ctx context.Context, id beta.ApplicationIdSynchronizationJobId) (result StartSynchronizationJobOperationResponse, err error) {
