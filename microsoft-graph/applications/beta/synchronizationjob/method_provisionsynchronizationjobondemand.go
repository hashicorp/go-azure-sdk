...
func (c SynchronizationJobClient) ProvisionSynchronizationJobOnDemand(ctx context.Context, id beta.ApplicationIdSynchronizationJobId, input ProvisionSynchronizationJobOnDemandRequest) (result ProvisionSynchronizationJobOnDemandOperationResponse, err error) {
