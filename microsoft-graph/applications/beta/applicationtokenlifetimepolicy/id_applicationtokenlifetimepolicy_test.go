...
func TestNewApplicationTokenLifetimePolicyID(t *testing.T) {
	id := NewApplicationTokenLifetimePolicyID("applicationIdValue", "tokenLifetimePolicyIdValue")
...
func TestFormatApplicationTokenLifetimePolicyID(t *testing.T) {
	actual := NewApplicationTokenLifetimePolicyID("applicationIdValue", "tokenLifetimePolicyIdValue").ID()
...
func TestParseApplicationTokenLifetimePolicyID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ApplicationTokenLifetimePolicyId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseApplicationTokenLifetimePolicyID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseApplicationTokenLifetimePolicyIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ApplicationTokenLifetimePolicyId
	...
	for _, v := range testData {
		...
		actual, err := ParseApplicationTokenLifetimePolicyIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForApplicationTokenLifetimePolicyId(t *testing.T) {
	segments := ApplicationTokenLifetimePolicyId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ApplicationTokenLifetimePolicyId has no segments")
	}
