...
// function are to:
func (c ApplicationClient) GetByIds(ctx context.Context, input GetByIdsRequest, options GetByIdsOperationOptions) (result GetByIdsOperationResponse, err error) {
...
func (c ApplicationClient) GetByIdsComplete(ctx context.Context, input GetByIdsRequest, options GetByIdsOperationOptions) (GetByIdsCompleteResult, error) {
...
func (c ApplicationClient) GetByIdsCompleteMatchingPredicate(ctx context.Context, input GetByIdsRequest, options GetByIdsOperationOptions, predicate DirectoryObjectOperationPredicate) (result GetByIdsCompleteResult, err error) {
