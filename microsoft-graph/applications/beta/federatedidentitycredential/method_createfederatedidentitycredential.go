...
func (c FederatedIdentityCredentialClient) CreateFederatedIdentityCredential(ctx context.Context, id ApplicationId, input beta.FederatedIdentityCredential) (result CreateFederatedIdentityCredentialOperationResponse, err error) {
