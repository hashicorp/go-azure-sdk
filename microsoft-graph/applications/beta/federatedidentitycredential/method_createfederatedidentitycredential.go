...
// application.
func (c FederatedIdentityCredentialClient) CreateFederatedIdentityCredential(ctx context.Context, id beta.ApplicationId, input beta.FederatedIdentityCredential) (result CreateFederatedIdentityCredentialOperationResponse, err error) {
