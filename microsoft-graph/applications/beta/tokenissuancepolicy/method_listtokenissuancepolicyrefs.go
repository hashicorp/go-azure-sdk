...
// ListTokenIssuancePolicyRefs ...
func (c TokenIssuancePolicyClient) ListTokenIssuancePolicyRefs(ctx context.Context, id ApplicationId) (result ListTokenIssuancePolicyRefsOperationResponse, err error) {
...
func (c TokenIssuancePolicyClient) ListTokenIssuancePolicyRefsComplete(ctx context.Context, id ApplicationId) (result ListTokenIssuancePolicyRefsCompleteResult, err error) {
	items := make([]string, 0)

	resp, err := c.ListTokenIssuancePolicyRefs(ctx, id)
	if err != nil {
