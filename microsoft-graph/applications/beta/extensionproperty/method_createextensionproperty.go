...
func (c ExtensionPropertyClient) CreateExtensionProperty(ctx context.Context, id ApplicationId, input beta.ExtensionProperty) (result CreateExtensionPropertyOperationResponse, err error) {
