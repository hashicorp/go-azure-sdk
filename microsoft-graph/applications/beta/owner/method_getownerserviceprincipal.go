...
func (c OwnerClient) GetOwnerServicePrincipal(ctx context.Context, id beta.ApplicationIdOwnerId, options GetOwnerServicePrincipalOperationOptions) (result GetOwnerServicePrincipalOperationResponse, err error) {
