...
func (c OwnerClient) GetOwnerAppRoleAssignmentCount(ctx context.Context, id beta.ApplicationId, options GetOwnerAppRoleAssignmentCountOperationOptions) (result GetOwnerAppRoleAssignmentCountOperationResponse, err error) {
