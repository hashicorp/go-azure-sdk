...
func (c OwnerClient) GetOwnerServicePrincipalCount(ctx context.Context, id beta.ApplicationId, options GetOwnerServicePrincipalCountOperationOptions) (result GetOwnerServicePrincipalCountOperationResponse, err error) {
