...
func (c OwnerClient) GetOwnerAppRoleAssignment(ctx context.Context, id beta.ApplicationIdOwnerId, options GetOwnerAppRoleAssignmentOperationOptions) (result GetOwnerAppRoleAssignmentOperationResponse, err error) {
