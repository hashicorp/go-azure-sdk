...
func TestNewApplicationTokenIssuancePolicyID(t *testing.T) {
	id := NewApplicationTokenIssuancePolicyID("applicationIdValue", "tokenIssuancePolicyIdValue")
...
func TestFormatApplicationTokenIssuancePolicyID(t *testing.T) {
	actual := NewApplicationTokenIssuancePolicyID("applicationIdValue", "tokenIssuancePolicyIdValue").ID()
...
func TestParseApplicationTokenIssuancePolicyID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ApplicationTokenIssuancePolicyId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseApplicationTokenIssuancePolicyID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseApplicationTokenIssuancePolicyIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ApplicationTokenIssuancePolicyId
	...
	for _, v := range testData {
		...
		actual, err := ParseApplicationTokenIssuancePolicyIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForApplicationTokenIssuancePolicyId(t *testing.T) {
	segments := ApplicationTokenIssuancePolicyId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ApplicationTokenIssuancePolicyId has no segments")
	}
