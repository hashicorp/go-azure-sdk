...
func (c SynchronizationTemplateSchemaDirectoryClient) CreateSynchronizationTemplateSchemaDirectory(ctx context.Context, id beta.ApplicationIdSynchronizationTemplateId, input beta.DirectoryDefinition) (result CreateSynchronizationTemplateSchemaDirectoryOperationResponse, err error) {
