...
func (c SynchronizationClient) AcquireSynchronizationAccessToken(ctx context.Context, id stable.ApplicationId, input AcquireSynchronizationAccessTokenRequest) (result AcquireSynchronizationAccessTokenOperationResponse, err error) {
