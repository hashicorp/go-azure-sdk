...
// ListTokenLifetimePolicyRefs ...
func (c TokenLifetimePolicyClient) ListTokenLifetimePolicyRefs(ctx context.Context, id ApplicationId) (result ListTokenLifetimePolicyRefsOperationResponse, err error) {
...
func (c TokenLifetimePolicyClient) ListTokenLifetimePolicyRefsComplete(ctx context.Context, id ApplicationId) (result ListTokenLifetimePolicyRefsCompleteResult, err error) {
	items := make([]string, 0)

	resp, err := c.ListTokenLifetimePolicyRefs(ctx, id)
	if err != nil {
