...
func (c ApplicationClient) UpdateApplication(ctx context.Context, id stable.ApplicationId, input stable.Application) (result UpdateApplicationOperationResponse, err error) {
