...
func (c ApplicationClient) GetAvailableExtensionProperties(ctx context.Context, input GetAvailableExtensionPropertiesRequest, options GetAvailableExtensionPropertiesOperationOptions) (result GetAvailableExtensionPropertiesOperationResponse, err error) {
...
func (c ApplicationClient) GetAvailableExtensionPropertiesComplete(ctx context.Context, input GetAvailableExtensionPropertiesRequest, options GetAvailableExtensionPropertiesOperationOptions) (GetAvailableExtensionPropertiesCompleteResult, error) {
