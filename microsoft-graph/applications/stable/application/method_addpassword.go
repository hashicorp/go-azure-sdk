...
func (c ApplicationClient) AddPassword(ctx context.Context, id stable.ApplicationId, input AddPasswordRequest) (result AddPasswordOperationResponse, err error) {
