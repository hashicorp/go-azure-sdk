...
func (c SynchronizationJobSchemaDirectoryClient) DiscoverSynchronizationJobSchemaDirectory(ctx context.Context, id stable.ApplicationIdSynchronizationJobIdSchemaDirectoryId) (result DiscoverSynchronizationJobSchemaDirectoryOperationResponse, err error) {
