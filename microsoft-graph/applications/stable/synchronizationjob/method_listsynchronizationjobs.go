...
func (c SynchronizationJobClient) ListSynchronizationJobs(ctx context.Context, id ApplicationId) (result ListSynchronizationJobsOperationResponse, err error) {
...
func (c SynchronizationJobClient) ListSynchronizationJobsComplete(ctx context.Context, id ApplicationId) (ListSynchronizationJobsCompleteResult, error) {
...
func (c SynchronizationJobClient) ListSynchronizationJobsCompleteMatchingPredicate(ctx context.Context, id ApplicationId, predicate SynchronizationJobOperationPredicate) (result ListSynchronizationJobsCompleteResult, err error) {
