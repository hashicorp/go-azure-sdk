...
func (c SynchronizationJobClient) CreateSynchronizationJob(ctx context.Context, id ApplicationId, input stable.SynchronizationJob) (result CreateSynchronizationJobOperationResponse, err error) {
