...
func (c ExtensionPropertyClient) CreateExtensionProperty(ctx context.Context, id ApplicationId, input stable.ExtensionProperty) (result CreateExtensionPropertyOperationResponse, err error) {
