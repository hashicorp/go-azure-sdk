...
func (c ExtensionPropertyClient) CreateExtensionProperty(ctx context.Context, id stable.ApplicationId, input stable.ExtensionProperty) (result CreateExtensionPropertyOperationResponse, err error) {
