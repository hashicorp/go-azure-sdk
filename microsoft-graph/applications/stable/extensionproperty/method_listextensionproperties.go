...
func (c ExtensionPropertyClient) ListExtensionProperties(ctx context.Context, id ApplicationId) (result ListExtensionPropertiesOperationResponse, err error) {
...
func (c ExtensionPropertyClient) ListExtensionPropertiesComplete(ctx context.Context, id ApplicationId) (ListExtensionPropertiesCompleteResult, error) {
	return c.ListExtensionPropertiesCompleteMatchingPredicate(ctx, id, ExtensionPropertyOperationPredicate{})
}

// ListExtensionPropertiesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ExtensionPropertyClient) ListExtensionPropertiesCompleteMatchingPredicate(ctx context.Context, id ApplicationId, predicate ExtensionPropertyOperationPredicate) (result ListExtensionPropertiesCompleteResult, err error) {
	items := make([]stable.ExtensionProperty, 0)

	resp, err := c.ListExtensionProperties(ctx, id)
	if err != nil {
