...
func (c FederatedIdentityCredentialClient) ListFederatedIdentityCredentials(ctx context.Context, id ApplicationId) (result ListFederatedIdentityCredentialsOperationResponse, err error) {
...
func (c FederatedIdentityCredentialClient) ListFederatedIdentityCredentialsComplete(ctx context.Context, id ApplicationId) (ListFederatedIdentityCredentialsCompleteResult, error) {
...
func (c FederatedIdentityCredentialClient) ListFederatedIdentityCredentialsCompleteMatchingPredicate(ctx context.Context, id ApplicationId, predicate FederatedIdentityCredentialOperationPredicate) (result ListFederatedIdentityCredentialsCompleteResult, err error) {
