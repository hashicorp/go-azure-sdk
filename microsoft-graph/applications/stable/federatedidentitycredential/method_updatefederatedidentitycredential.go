...
func (c FederatedIdentityCredentialClient) UpdateFederatedIdentityCredential(ctx context.Context, id stable.ApplicationIdFederatedIdentityCredentialId, input stable.FederatedIdentityCredential) (result UpdateFederatedIdentityCredentialOperationResponse, err error) {
