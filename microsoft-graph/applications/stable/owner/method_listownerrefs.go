...
// ListOwnerRefs ...
func (c OwnerClient) ListOwnerRefs(ctx context.Context, id ApplicationId) (result ListOwnerRefsOperationResponse, err error) {
...
func (c OwnerClient) ListOwnerRefsComplete(ctx context.Context, id ApplicationId) (result ListOwnerRefsCompleteResult, err error) {
	items := make([]string, 0)
