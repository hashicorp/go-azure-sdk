...
// ListOwners ...
func (c OwnerClient) ListOwners(ctx context.Context, id ApplicationId) (result ListOwnersOperationResponse, err error) {
...
func (c OwnerClient) ListOwnersComplete(ctx context.Context, id ApplicationId) (ListOwnersCompleteResult, error) {
...
func (c OwnerClient) ListOwnersCompleteMatchingPredicate(ctx context.Context, id ApplicationId, predicate DirectoryObjectOperationPredicate) (result ListOwnersCompleteResult, err error) {
