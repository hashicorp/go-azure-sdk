...
func TestNewApplicationSynchronizationJobSchemaDirectoryID(t *testing.T) {
	id := NewApplicationSynchronizationJobSchemaDirectoryID("applicationIdValue", "synchronizationJobIdValue", "directoryDefinitionIdValue")
...
func TestFormatApplicationSynchronizationJobSchemaDirectoryID(t *testing.T) {
	actual := NewApplicationSynchronizationJobSchemaDirectoryID("applicationIdValue", "synchronizationJobIdValue", "directoryDefinitionIdValue").ID()
...
func TestParseApplicationSynchronizationJobSchemaDirectoryID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ApplicationSynchronizationJobSchemaDirectoryId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseApplicationSynchronizationJobSchemaDirectoryID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseApplicationSynchronizationJobSchemaDirectoryIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ApplicationSynchronizationJobSchemaDirectoryId
	...
	for _, v := range testData {
		...
		actual, err := ParseApplicationSynchronizationJobSchemaDirectoryIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForApplicationSynchronizationJobSchemaDirectoryId(t *testing.T) {
	segments := ApplicationSynchronizationJobSchemaDirectoryId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ApplicationSynchronizationJobSchemaDirectoryId has no segments")
	}
