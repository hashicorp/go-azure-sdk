...
func ParsePolicyCrossTenantAccessPolicyPartnerID(input string) (*PolicyCrossTenantAccessPolicyPartnerId, error) {
	...
	if id.CrossTenantAccessPolicyConfigurationPartnerTenantId, ok = parsed.Parsed["crossTenantAccessPolicyConfigurationPartnerTenantId"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "crossTenantAccessPolicyConfigurationPartnerTenantId", *parsed)
	}
...
func (id PolicyCrossTenantAccessPolicyPartnerId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.StaticSegment("staticCrossTenantAccessPolicy", "crossTenantAccessPolicy", "crossTenantAccessPolicy"),
