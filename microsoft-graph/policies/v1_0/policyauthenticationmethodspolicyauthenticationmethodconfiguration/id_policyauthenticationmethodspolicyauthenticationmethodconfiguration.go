...
func ParsePolicyAuthenticationMethodsPolicyAuthenticationMethodConfigurationID(input string) (*PolicyAuthenticationMethodsPolicyAuthenticationMethodConfigurationId, error) {
	...
	if id.AuthenticationMethodConfigurationId, ok = parsed.Parsed["authenticationMethodConfigurationId"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "authenticationMethodConfigurationId", *parsed)
	}
...
func (id PolicyAuthenticationMethodsPolicyAuthenticationMethodConfigurationId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.StaticSegment("staticAuthenticationMethodsPolicy", "authenticationMethodsPolicy", "authenticationMethodsPolicy"),
		resourceids.StaticSegment("staticAuthenticationMethodConfigurations", "authenticationMethodConfigurations", "authenticationMethodConfigurations"),
