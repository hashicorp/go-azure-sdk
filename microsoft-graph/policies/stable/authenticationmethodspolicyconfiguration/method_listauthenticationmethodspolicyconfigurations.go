...
func (c AuthenticationMethodsPolicyConfigurationClient) ListAuthenticationMethodsPolicyConfigurations(ctx context.Context, options ListAuthenticationMethodsPolicyConfigurationsOperationOptions) (result ListAuthenticationMethodsPolicyConfigurationsOperationResponse, err error) {
...
func (c AuthenticationMethodsPolicyConfigurationClient) ListAuthenticationMethodsPolicyConfigurationsComplete(ctx context.Context, options ListAuthenticationMethodsPolicyConfigurationsOperationOptions) (ListAuthenticationMethodsPolicyConfigurationsCompleteResult, error) {
...
func (c AuthenticationMethodsPolicyConfigurationClient) ListAuthenticationMethodsPolicyConfigurationsCompleteMatchingPredicate(ctx context.Context, options ListAuthenticationMethodsPolicyConfigurationsOperationOptions, predicate AuthenticationMethodConfigurationOperationPredicate) (result ListAuthenticationMethodsPolicyConfigurationsCompleteResult, err error) {
