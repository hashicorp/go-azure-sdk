...
// for policies
func (c AuthenticationMethodsPolicyConfigurationClient) CreateAuthenticationMethodsPolicyConfiguration(ctx context.Context, input stable.AuthenticationMethodConfiguration) (result CreateAuthenticationMethodsPolicyConfigurationOperationResponse, err error) {
