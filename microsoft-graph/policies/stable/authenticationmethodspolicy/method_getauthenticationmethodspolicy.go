...
func (c AuthenticationMethodsPolicyClient) GetAuthenticationMethodsPolicy(ctx context.Context) (result GetAuthenticationMethodsPolicyOperationResponse, err error) {
