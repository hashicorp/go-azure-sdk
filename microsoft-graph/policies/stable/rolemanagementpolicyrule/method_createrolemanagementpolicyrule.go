...
func (c RoleManagementPolicyRuleClient) CreateRoleManagementPolicyRule(ctx context.Context, id stable.PolicyRoleManagementPolicyId, input stable.UnifiedRoleManagementPolicyRule) (result CreateRoleManagementPolicyRuleOperationResponse, err error) {
