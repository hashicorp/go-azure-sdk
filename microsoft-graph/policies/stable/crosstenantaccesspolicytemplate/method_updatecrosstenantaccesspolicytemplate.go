...
func (c CrossTenantAccessPolicyTemplateClient) UpdateCrossTenantAccessPolicyTemplate(ctx context.Context, input stable.PolicyTemplate) (result UpdateCrossTenantAccessPolicyTemplateOperationResponse, err error) {
