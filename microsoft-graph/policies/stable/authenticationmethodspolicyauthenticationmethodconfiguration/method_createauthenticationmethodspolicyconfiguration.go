...
// for policies
func (c AuthenticationMethodsPolicyAuthenticationMethodConfigurationClient) CreateAuthenticationMethodsPolicyConfiguration(ctx context.Context, input stable.AuthenticationMethodConfiguration) (result CreateAuthenticationMethodsPolicyConfigurationOperationResponse, err error) {
