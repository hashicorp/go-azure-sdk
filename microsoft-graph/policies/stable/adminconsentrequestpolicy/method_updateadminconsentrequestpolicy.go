...
func (c AdminConsentRequestPolicyClient) UpdateAdminConsentRequestPolicy(ctx context.Context, input stable.AdminConsentRequestPolicy) (result UpdateAdminConsentRequestPolicyOperationResponse, err error) {
