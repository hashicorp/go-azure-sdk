...
func (c TokenLifetimePolicyClient) ListTokenLifetimePolicies(ctx context.Context) (result ListTokenLifetimePoliciesOperationResponse, err error) {
...
func (c TokenLifetimePolicyClient) ListTokenLifetimePoliciesComplete(ctx context.Context) (ListTokenLifetimePoliciesCompleteResult, error) {
	return c.ListTokenLifetimePoliciesCompleteMatchingPredicate(ctx, TokenLifetimePolicyOperationPredicate{})
}

// ListTokenLifetimePoliciesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c TokenLifetimePolicyClient) ListTokenLifetimePoliciesCompleteMatchingPredicate(ctx context.Context, predicate TokenLifetimePolicyOperationPredicate) (result ListTokenLifetimePoliciesCompleteResult, err error) {
	items := make([]stable.TokenLifetimePolicy, 0)

	resp, err := c.ListTokenLifetimePolicies(ctx)
	if err != nil {
