...
// UpdateCrossTenantAccessPolicyDefault ...
func (c CrossTenantAccessPolicyDefaultClient) UpdateCrossTenantAccessPolicyDefault(ctx context.Context, input stable.CrossTenantAccessPolicyConfigurationDefault) (result UpdateCrossTenantAccessPolicyDefaultOperationResponse, err error) {
