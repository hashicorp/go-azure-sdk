...
func (c DefaultAppManagementPolicyClient) DeleteDefaultAppManagementPolicy(ctx context.Context) (result DeleteDefaultAppManagementPolicyOperationResponse, err error) {
