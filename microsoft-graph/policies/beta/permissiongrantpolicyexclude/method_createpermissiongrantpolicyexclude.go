...
func (c PermissionGrantPolicyExcludeClient) CreatePermissionGrantPolicyExclude(ctx context.Context, id beta.PolicyPermissionGrantPolicyId, input beta.PermissionGrantConditionSet) (result CreatePermissionGrantPolicyExcludeOperationResponse, err error) {
