...
func (c AppManagementPolicyClient) ListAppManagementPolicies(ctx context.Context) (result ListAppManagementPoliciesOperationResponse, err error) {
...
func (c AppManagementPolicyClient) ListAppManagementPoliciesComplete(ctx context.Context) (ListAppManagementPoliciesCompleteResult, error) {
	return c.ListAppManagementPoliciesCompleteMatchingPredicate(ctx, AppManagementPolicyOperationPredicate{})
}

// ListAppManagementPoliciesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AppManagementPolicyClient) ListAppManagementPoliciesCompleteMatchingPredicate(ctx context.Context, predicate AppManagementPolicyOperationPredicate) (result ListAppManagementPoliciesCompleteResult, err error) {
	items := make([]beta.AppManagementPolicy, 0)

	resp, err := c.ListAppManagementPolicies(ctx)
	if err != nil {
