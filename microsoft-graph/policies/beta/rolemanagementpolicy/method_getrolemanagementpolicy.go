...
func (c RoleManagementPolicyClient) GetRoleManagementPolicy(ctx context.Context, id PolicyRoleManagementPolicyId) (result GetRoleManagementPolicyOperationResponse, err error) {
