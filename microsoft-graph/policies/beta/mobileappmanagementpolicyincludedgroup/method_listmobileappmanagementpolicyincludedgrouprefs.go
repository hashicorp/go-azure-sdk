...
// ListMobileAppManagementPolicyIncludedGroupRefs ...
func (c MobileAppManagementPolicyIncludedGroupClient) ListMobileAppManagementPolicyIncludedGroupRefs(ctx context.Context, id PolicyMobileAppManagementPolicyId) (result ListMobileAppManagementPolicyIncludedGroupRefsOperationResponse, err error) {
...
func (c MobileAppManagementPolicyIncludedGroupClient) ListMobileAppManagementPolicyIncludedGroupRefsComplete(ctx context.Context, id PolicyMobileAppManagementPolicyId) (result ListMobileAppManagementPolicyIncludedGroupRefsCompleteResult, err error) {
	items := make([]string, 0)

	resp, err := c.ListMobileAppManagementPolicyIncludedGroupRefs(ctx, id)
	if err != nil {
