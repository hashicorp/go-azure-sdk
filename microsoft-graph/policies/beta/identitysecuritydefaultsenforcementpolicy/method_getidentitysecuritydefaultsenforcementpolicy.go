...
func (c IdentitySecurityDefaultsEnforcementPolicyClient) GetIdentitySecurityDefaultsEnforcementPolicy(ctx context.Context) (result GetIdentitySecurityDefaultsEnforcementPolicyOperationResponse, err error) {
