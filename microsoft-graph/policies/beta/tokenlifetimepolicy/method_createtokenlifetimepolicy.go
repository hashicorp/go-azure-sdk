...
func (c TokenLifetimePolicyClient) CreateTokenLifetimePolicy(ctx context.Context, input beta.TokenLifetimePolicy) (result CreateTokenLifetimePolicyOperationResponse, err error) {
