...
func (c TokenLifetimePolicyClient) GetTokenLifetimePolicy(ctx context.Context, id PolicyTokenLifetimePolicyId) (result GetTokenLifetimePolicyOperationResponse, err error) {
