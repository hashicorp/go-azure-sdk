...
func ParsePolicyRoleManagementPolicyAssignmentID(input string) (*PolicyRoleManagementPolicyAssignmentId, error) {
	...
	if id.UnifiedRoleManagementPolicyAssignmentId, ok = parsed.Parsed["unifiedRoleManagementPolicyAssignmentId"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "unifiedRoleManagementPolicyAssignmentId", *parsed)
	}
