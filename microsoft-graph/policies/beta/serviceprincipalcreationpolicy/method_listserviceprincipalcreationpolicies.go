...
// ListServicePrincipalCreationPolicies ...
func (c ServicePrincipalCreationPolicyClient) ListServicePrincipalCreationPolicies(ctx context.Context) (result ListServicePrincipalCreationPoliciesOperationResponse, err error) {
...
func (c ServicePrincipalCreationPolicyClient) ListServicePrincipalCreationPoliciesComplete(ctx context.Context) (ListServicePrincipalCreationPoliciesCompleteResult, error) {
	return c.ListServicePrincipalCreationPoliciesCompleteMatchingPredicate(ctx, ServicePrincipalCreationPolicyOperationPredicate{})
}

// ListServicePrincipalCreationPoliciesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ServicePrincipalCreationPolicyClient) ListServicePrincipalCreationPoliciesCompleteMatchingPredicate(ctx context.Context, predicate ServicePrincipalCreationPolicyOperationPredicate) (result ListServicePrincipalCreationPoliciesCompleteResult, err error) {
	items := make([]beta.ServicePrincipalCreationPolicy, 0)

	resp, err := c.ListServicePrincipalCreationPolicies(ctx)
	if err != nil {
