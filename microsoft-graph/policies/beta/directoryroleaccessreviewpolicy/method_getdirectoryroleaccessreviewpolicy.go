...
func (c DirectoryRoleAccessReviewPolicyClient) GetDirectoryRoleAccessReviewPolicy(ctx context.Context) (result GetDirectoryRoleAccessReviewPolicyOperationResponse, err error) {
