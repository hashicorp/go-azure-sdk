...
func (c AuthenticationStrengthPolicyCombinationConfigurationClient) CreateAuthenticationStrengthPolicyCombinationConfiguration(ctx context.Context, id beta.PolicyAuthenticationStrengthPolicyId, input beta.AuthenticationCombinationConfiguration) (result CreateAuthenticationStrengthPolicyCombinationConfigurationOperationResponse, err error) {
