...
func (c AuthenticationStrengthPolicyCombinationConfigurationClient) DeleteAuthenticationStrengthPolicyCombinationConfiguration(ctx context.Context, id PolicyAuthenticationStrengthPolicyIdCombinationConfigurationId) (result DeleteAuthenticationStrengthPolicyCombinationConfigurationOperationResponse, err error) {
