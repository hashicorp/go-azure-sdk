...
func (c AdminConsentRequestPolicyClient) UpdateAdminConsentRequestPolicy(ctx context.Context, input beta.AdminConsentRequestPolicy) (result UpdateAdminConsentRequestPolicyOperationResponse, err error) {
