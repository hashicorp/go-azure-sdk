...
func TestNewPolicyServicePrincipalCreationPolicyExcludeID(t *testing.T) {
	id := NewPolicyServicePrincipalCreationPolicyExcludeID("servicePrincipalCreationPolicyIdValue", "servicePrincipalCreationConditionSetIdValue")
...
func TestFormatPolicyServicePrincipalCreationPolicyExcludeID(t *testing.T) {
	actual := NewPolicyServicePrincipalCreationPolicyExcludeID("servicePrincipalCreationPolicyIdValue", "servicePrincipalCreationConditionSetIdValue").ID()
...
func TestParsePolicyServicePrincipalCreationPolicyExcludeID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *PolicyServicePrincipalCreationPolicyExcludeId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParsePolicyServicePrincipalCreationPolicyExcludeID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParsePolicyServicePrincipalCreationPolicyExcludeIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *PolicyServicePrincipalCreationPolicyExcludeId
	...
	for _, v := range testData {
		...
		actual, err := ParsePolicyServicePrincipalCreationPolicyExcludeIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForPolicyServicePrincipalCreationPolicyExcludeId(t *testing.T) {
	segments := PolicyServicePrincipalCreationPolicyExcludeId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("PolicyServicePrincipalCreationPolicyExcludeId has no segments")
	}
