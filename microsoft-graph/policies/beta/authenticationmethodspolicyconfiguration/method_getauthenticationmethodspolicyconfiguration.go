...
func (c AuthenticationMethodsPolicyConfigurationClient) GetAuthenticationMethodsPolicyConfiguration(ctx context.Context, id beta.PolicyAuthenticationMethodsPolicyAuthenticationMethodConfigurationId, options GetAuthenticationMethodsPolicyConfigurationOperationOptions) (result GetAuthenticationMethodsPolicyConfigurationOperationResponse, err error) {
