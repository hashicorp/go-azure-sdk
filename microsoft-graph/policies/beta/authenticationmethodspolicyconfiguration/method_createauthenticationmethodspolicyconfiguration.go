...
// for policies
func (c AuthenticationMethodsPolicyConfigurationClient) CreateAuthenticationMethodsPolicyConfiguration(ctx context.Context, input beta.AuthenticationMethodConfiguration) (result CreateAuthenticationMethodsPolicyConfigurationOperationResponse, err error) {
