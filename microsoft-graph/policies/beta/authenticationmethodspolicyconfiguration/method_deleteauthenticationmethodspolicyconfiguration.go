...
func (c AuthenticationMethodsPolicyConfigurationClient) DeleteAuthenticationMethodsPolicyConfiguration(ctx context.Context, id beta.PolicyAuthenticationMethodsPolicyAuthenticationMethodConfigurationId, options DeleteAuthenticationMethodsPolicyConfigurationOperationOptions) (result DeleteAuthenticationMethodsPolicyConfigurationOperationResponse, err error) {
