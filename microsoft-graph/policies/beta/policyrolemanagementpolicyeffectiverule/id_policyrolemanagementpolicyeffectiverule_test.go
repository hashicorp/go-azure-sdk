...
func TestNewPolicyRoleManagementPolicyEffectiveRuleID(t *testing.T) {
	id := NewPolicyRoleManagementPolicyEffectiveRuleID("unifiedRoleManagementPolicyIdValue", "unifiedRoleManagementPolicyRuleIdValue")
...
func TestFormatPolicyRoleManagementPolicyEffectiveRuleID(t *testing.T) {
	actual := NewPolicyRoleManagementPolicyEffectiveRuleID("unifiedRoleManagementPolicyIdValue", "unifiedRoleManagementPolicyRuleIdValue").ID()
...
func TestParsePolicyRoleManagementPolicyEffectiveRuleID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *PolicyRoleManagementPolicyEffectiveRuleId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParsePolicyRoleManagementPolicyEffectiveRuleID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParsePolicyRoleManagementPolicyEffectiveRuleIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *PolicyRoleManagementPolicyEffectiveRuleId
	...
	for _, v := range testData {
		...
		actual, err := ParsePolicyRoleManagementPolicyEffectiveRuleIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForPolicyRoleManagementPolicyEffectiveRuleId(t *testing.T) {
	segments := PolicyRoleManagementPolicyEffectiveRuleId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("PolicyRoleManagementPolicyEffectiveRuleId has no segments")
	}
