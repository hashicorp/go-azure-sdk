...
func (c MobileDeviceManagementPolicyIncludedGroupClient) ListMobileDeviceManagementPolicyIncludedGroupRefs(ctx context.Context, id PolicyMobileDeviceManagementPolicyId) (result ListMobileDeviceManagementPolicyIncludedGroupRefsOperationResponse, err error) {
...
func (c MobileDeviceManagementPolicyIncludedGroupClient) ListMobileDeviceManagementPolicyIncludedGroupRefsComplete(ctx context.Context, id PolicyMobileDeviceManagementPolicyId) (result ListMobileDeviceManagementPolicyIncludedGroupRefsCompleteResult, err error) {
	items := make([]string, 0)

	resp, err := c.ListMobileDeviceManagementPolicyIncludedGroupRefs(ctx, id)
	if err != nil {
