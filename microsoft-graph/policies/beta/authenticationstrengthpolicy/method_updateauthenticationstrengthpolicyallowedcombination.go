...
func (c AuthenticationStrengthPolicyClient) UpdateAuthenticationStrengthPolicyAllowedCombination(ctx context.Context, id beta.PolicyAuthenticationStrengthPolicyId, input UpdateAuthenticationStrengthPolicyAllowedCombinationRequest) (result UpdateAuthenticationStrengthPolicyAllowedCombinationOperationResponse, err error) {
