...
func (c AuthenticationStrengthPolicyClient) UpdateAuthenticationStrengthPolicy(ctx context.Context, id beta.PolicyAuthenticationStrengthPolicyId, input beta.AuthenticationStrengthPolicy) (result UpdateAuthenticationStrengthPolicyOperationResponse, err error) {
