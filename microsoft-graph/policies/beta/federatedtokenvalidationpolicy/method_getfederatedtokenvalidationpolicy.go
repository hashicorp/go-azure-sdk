...
func (c FederatedTokenValidationPolicyClient) GetFederatedTokenValidationPolicy(ctx context.Context) (result GetFederatedTokenValidationPolicyOperationResponse, err error) {
