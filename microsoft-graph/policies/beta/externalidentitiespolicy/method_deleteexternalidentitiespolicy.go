...
func (c ExternalIdentitiesPolicyClient) DeleteExternalIdentitiesPolicy(ctx context.Context) (result DeleteExternalIdentitiesPolicyOperationResponse, err error) {
