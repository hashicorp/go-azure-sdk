...
func (c RoleManagementPolicyRuleClient) CreateRoleManagementPolicyRule(ctx context.Context, id beta.PolicyRoleManagementPolicyId, input beta.UnifiedRoleManagementPolicyRule) (result CreateRoleManagementPolicyRuleOperationResponse, err error) {
