...
// GetB2cAuthenticationMethodsPolicy ...
func (c B2cAuthenticationMethodsPolicyClient) GetB2cAuthenticationMethodsPolicy(ctx context.Context) (result GetB2cAuthenticationMethodsPolicyOperationResponse, err error) {
