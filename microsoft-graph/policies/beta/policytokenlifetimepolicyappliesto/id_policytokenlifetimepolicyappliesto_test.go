...
func TestNewPolicyTokenLifetimePolicyAppliesToID(t *testing.T) {
	id := NewPolicyTokenLifetimePolicyAppliesToID("tokenLifetimePolicyIdValue", "directoryObjectIdValue")
...
func TestFormatPolicyTokenLifetimePolicyAppliesToID(t *testing.T) {
	actual := NewPolicyTokenLifetimePolicyAppliesToID("tokenLifetimePolicyIdValue", "directoryObjectIdValue").ID()
...
func TestParsePolicyTokenLifetimePolicyAppliesToID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *PolicyTokenLifetimePolicyAppliesToId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParsePolicyTokenLifetimePolicyAppliesToID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParsePolicyTokenLifetimePolicyAppliesToIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *PolicyTokenLifetimePolicyAppliesToId
	...
	for _, v := range testData {
		...
		actual, err := ParsePolicyTokenLifetimePolicyAppliesToIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForPolicyTokenLifetimePolicyAppliesToId(t *testing.T) {
	segments := PolicyTokenLifetimePolicyAppliesToId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("PolicyTokenLifetimePolicyAppliesToId has no segments")
	}
