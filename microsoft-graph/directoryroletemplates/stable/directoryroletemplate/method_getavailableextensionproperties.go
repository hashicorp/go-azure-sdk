...
func (c DirectoryRoleTemplateClient) GetAvailableExtensionProperties(ctx context.Context, input GetAvailableExtensionPropertiesRequest, options GetAvailableExtensionPropertiesOperationOptions) (result GetAvailableExtensionPropertiesOperationResponse, err error) {
...
func (c DirectoryRoleTemplateClient) GetAvailableExtensionPropertiesComplete(ctx context.Context, input GetAvailableExtensionPropertiesRequest, options GetAvailableExtensionPropertiesOperationOptions) (GetAvailableExtensionPropertiesCompleteResult, error) {
