...
// GetByIds - Invoke action getByIds. Return the directory objects specified in a list of IDs. Some common uses for this
// function are to:
func (c DirectoryRoleTemplateClient) GetByIds(ctx context.Context, input GetByIdsRequest, options GetByIdsOperationOptions) (result GetByIdsOperationResponse, err error) {
...
func (c DirectoryRoleTemplateClient) GetByIdsComplete(ctx context.Context, input GetByIdsRequest, options GetByIdsOperationOptions) (GetByIdsCompleteResult, error) {
...
func (c DirectoryRoleTemplateClient) GetByIdsCompleteMatchingPredicate(ctx context.Context, input GetByIdsRequest, options GetByIdsOperationOptions, predicate DirectoryObjectOperationPredicate) (result GetByIdsCompleteResult, err error) {
