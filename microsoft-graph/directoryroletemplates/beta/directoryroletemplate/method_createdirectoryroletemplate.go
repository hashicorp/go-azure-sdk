...
func (c DirectoryRoleTemplateClient) CreateDirectoryRoleTemplate(ctx context.Context, input beta.DirectoryRoleTemplate) (result CreateDirectoryRoleTemplateOperationResponse, err error) {
