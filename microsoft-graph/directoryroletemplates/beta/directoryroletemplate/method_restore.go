...
func (c DirectoryRoleTemplateClient) Restore(ctx context.Context, id beta.DirectoryRoleTemplateId, input RestoreRequest) (result RestoreOperationResponse, err error) {
