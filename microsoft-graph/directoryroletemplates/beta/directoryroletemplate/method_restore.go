...
func (c DirectoryRoleTemplateClient) Restore(ctx context.Context, id beta.DirectoryRoleTemplateId, options RestoreOperationOptions) (result RestoreOperationResponse, err error) {
