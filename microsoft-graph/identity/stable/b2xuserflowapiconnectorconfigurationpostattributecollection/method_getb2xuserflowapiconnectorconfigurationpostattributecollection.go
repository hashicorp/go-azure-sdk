...
func (c B2xUserFlowApiConnectorConfigurationPostAttributeCollectionClient) GetB2xUserFlowApiConnectorConfigurationPostAttributeCollection(ctx context.Context, id IdentityB2xUserFlowId) (result GetB2xUserFlowApiConnectorConfigurationPostAttributeCollectionOperationResponse, err error) {
