...
func (c B2xUserFlowApiConnectorConfigurationPostAttributeCollectionClient) GetB2xUserFlowApiConnectorConfigurationPostAttributeCollectionRef(ctx context.Context, id IdentityB2xUserFlowId) (result GetB2xUserFlowApiConnectorConfigurationPostAttributeCollectionRefOperationResponse, err error) {
