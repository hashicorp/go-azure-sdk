...
func (c B2xUserFlowApiConnectorConfigurationPostFederationSignupClient) GetB2xUserFlowApiConnectorConfigurationPostFederationSignupRef(ctx context.Context, id stable.IdentityB2xUserFlowId) (result GetB2xUserFlowApiConnectorConfigurationPostFederationSignupRefOperationResponse, err error) {
