...
func (c B2xUserFlowApiConnectorConfigurationPostFederationSignupClient) UpdateB2xUserFlowApiConnectorConfigurationPostFederationSignup(ctx context.Context, id IdentityB2xUserFlowId, input stable.IdentityApiConnector) (result UpdateB2xUserFlowApiConnectorConfigurationPostFederationSignupOperationResponse, err error) {
