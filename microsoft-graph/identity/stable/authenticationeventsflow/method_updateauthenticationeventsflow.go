...
func (c AuthenticationEventsFlowClient) UpdateAuthenticationEventsFlow(ctx context.Context, id stable.IdentityAuthenticationEventsFlowId, input stable.AuthenticationEventsFlow) (result UpdateAuthenticationEventsFlowOperationResponse, err error) {
