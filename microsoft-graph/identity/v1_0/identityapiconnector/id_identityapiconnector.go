...
func ParseIdentityApiConnectorID(input string) (*IdentityApiConnectorId, error) {
	...
	if id.IdentityApiConnectorId, ok = parsed.Parsed["identityApiConnectorId"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "identityApiConnectorId", *parsed)
	}
...
func (id IdentityApiConnectorId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.StaticSegment("staticApiConnectors", "apiConnectors", "apiConnectors"),
