...
func TestNewIdentityB2xUserFlowIdentityProviderID(t *testing.T) {
	id := NewIdentityB2xUserFlowIdentityProviderID("b2xIdentityUserFlowIdValue", "identityProviderIdValue")
...
func TestFormatIdentityB2xUserFlowIdentityProviderID(t *testing.T) {
	actual := NewIdentityB2xUserFlowIdentityProviderID("b2xIdentityUserFlowIdValue", "identityProviderIdValue").ID()
...
func TestParseIdentityB2xUserFlowIdentityProviderID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *IdentityB2xUserFlowIdentityProviderId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseIdentityB2xUserFlowIdentityProviderID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseIdentityB2xUserFlowIdentityProviderIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *IdentityB2xUserFlowIdentityProviderId
	...
	for _, v := range testData {
		...
		actual, err := ParseIdentityB2xUserFlowIdentityProviderIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForIdentityB2xUserFlowIdentityProviderId(t *testing.T) {
	segments := IdentityB2xUserFlowIdentityProviderId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("IdentityB2xUserFlowIdentityProviderId has no segments")
	}
