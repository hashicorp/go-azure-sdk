...
func TestNewIdentityB2xUserFlowLanguageOverridesPageID(t *testing.T) {
	id := NewIdentityB2xUserFlowLanguageOverridesPageID("b2xIdentityUserFlowIdValue", "userFlowLanguageConfigurationIdValue", "userFlowLanguagePageIdValue")
...
func TestFormatIdentityB2xUserFlowLanguageOverridesPageID(t *testing.T) {
	actual := NewIdentityB2xUserFlowLanguageOverridesPageID("b2xIdentityUserFlowIdValue", "userFlowLanguageConfigurationIdValue", "userFlowLanguagePageIdValue").ID()
...
func TestParseIdentityB2xUserFlowLanguageOverridesPageID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *IdentityB2xUserFlowLanguageOverridesPageId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseIdentityB2xUserFlowLanguageOverridesPageID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseIdentityB2xUserFlowLanguageOverridesPageIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *IdentityB2xUserFlowLanguageOverridesPageId
	...
	for _, v := range testData {
		...
		actual, err := ParseIdentityB2xUserFlowLanguageOverridesPageIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForIdentityB2xUserFlowLanguageOverridesPageId(t *testing.T) {
	segments := IdentityB2xUserFlowLanguageOverridesPageId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("IdentityB2xUserFlowLanguageOverridesPageId has no segments")
	}
