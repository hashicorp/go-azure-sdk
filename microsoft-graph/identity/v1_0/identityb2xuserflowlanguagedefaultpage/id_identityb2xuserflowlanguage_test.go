...
func TestNewIdentityB2xUserFlowLanguageID(t *testing.T) {
	id := NewIdentityB2xUserFlowLanguageID("b2xIdentityUserFlowIdValue", "userFlowLanguageConfigurationIdValue")
...
func TestFormatIdentityB2xUserFlowLanguageID(t *testing.T) {
	actual := NewIdentityB2xUserFlowLanguageID("b2xIdentityUserFlowIdValue", "userFlowLanguageConfigurationIdValue").ID()
...
func TestParseIdentityB2xUserFlowLanguageID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *IdentityB2xUserFlowLanguageId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseIdentityB2xUserFlowLanguageID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseIdentityB2xUserFlowLanguageIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *IdentityB2xUserFlowLanguageId
	...
	for _, v := range testData {
		...
		actual, err := ParseIdentityB2xUserFlowLanguageIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForIdentityB2xUserFlowLanguageId(t *testing.T) {
	segments := IdentityB2xUserFlowLanguageId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("IdentityB2xUserFlowLanguageId has no segments")
	}
