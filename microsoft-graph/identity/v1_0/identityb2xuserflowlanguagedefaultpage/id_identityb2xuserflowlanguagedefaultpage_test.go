...
func TestNewIdentityB2xUserFlowLanguageDefaultPageID(t *testing.T) {
	id := NewIdentityB2xUserFlowLanguageDefaultPageID("b2xIdentityUserFlowIdValue", "userFlowLanguageConfigurationIdValue", "userFlowLanguagePageIdValue")
...
func TestFormatIdentityB2xUserFlowLanguageDefaultPageID(t *testing.T) {
	actual := NewIdentityB2xUserFlowLanguageDefaultPageID("b2xIdentityUserFlowIdValue", "userFlowLanguageConfigurationIdValue", "userFlowLanguagePageIdValue").ID()
	expected := "/identity/b2xUserFlows/b2xIdentityUserFlowIdValue/languages/userFlowLanguageConfigurationIdValue/defaultPages/userFlowLanguagePageIdValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseIdentityB2xUserFlowLanguageDefaultPageID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *IdentityB2xUserFlowLanguageDefaultPageId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		{
			// Incomplete URI
			Input: "/identity/b2xUserFlows/b2xIdentityUserFlowIdValue/languages/userFlowLanguageConfigurationIdValue/defaultPages",
			Error: true,
		},
		{
			// Valid URI
			Input: "/identity/b2xUserFlows/b2xIdentityUserFlowIdValue/languages/userFlowLanguageConfigurationIdValue/defaultPages/userFlowLanguagePageIdValue",
			Expected: &IdentityB2xUserFlowLanguageDefaultPageId{
		...
		},
		{
			...
			Input: "/identity/b2xUserFlows/b2xIdentityUserFlowIdValue/languages/userFlowLanguageConfigurationIdValue/defaultPages/userFlowLanguagePageIdValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseIdentityB2xUserFlowLanguageDefaultPageID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseIdentityB2xUserFlowLanguageDefaultPageIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *IdentityB2xUserFlowLanguageDefaultPageId
	...
	for _, v := range testData {
		...
		actual, err := ParseIdentityB2xUserFlowLanguageDefaultPageIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForIdentityB2xUserFlowLanguageDefaultPageId(t *testing.T) {
	segments := IdentityB2xUserFlowLanguageDefaultPageId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("IdentityB2xUserFlowLanguageDefaultPageId has no segments")
	}
