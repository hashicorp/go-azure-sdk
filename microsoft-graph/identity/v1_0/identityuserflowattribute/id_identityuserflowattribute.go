...
func ParseIdentityUserFlowAttributeID(input string) (*IdentityUserFlowAttributeId, error) {
	...
	if id.IdentityUserFlowAttributeId, ok = parsed.Parsed["identityUserFlowAttributeId"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "identityUserFlowAttributeId", *parsed)
	}
...
func (id IdentityUserFlowAttributeId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.StaticSegment("staticUserFlowAttributes", "userFlowAttributes", "userFlowAttributes"),
		resourceids.UserSpecifiedSegment("identityUserFlowAttributeId", "identityUserFlowAttributeIdValue"),
	}
}
