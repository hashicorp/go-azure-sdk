...
func (c TodoListExtensionClient) CreateTodoListExtension(ctx context.Context, id stable.MeTodoListId, input stable.Extension) (result CreateTodoListExtensionOperationResponse, err error) {
