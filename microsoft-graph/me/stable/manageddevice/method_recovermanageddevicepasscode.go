...
func (c ManagedDeviceClient) RecoverManagedDevicePasscode(ctx context.Context, id stable.MeManagedDeviceId) (result RecoverManagedDevicePasscodeOperationResponse, err error) {
