...
func (c ManagedDeviceClient) ResetManagedDevicePasscode(ctx context.Context, id stable.MeManagedDeviceId) (result ResetManagedDevicePasscodeOperationResponse, err error) {
