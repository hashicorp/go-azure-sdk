...
func (c ManagedDeviceClient) RequestManagedDeviceRemoteAssistance(ctx context.Context, id stable.MeManagedDeviceId) (result RequestManagedDeviceRemoteAssistanceOperationResponse, err error) {
