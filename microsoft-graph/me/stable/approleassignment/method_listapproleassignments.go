...
func (c AppRoleAssignmentClient) ListAppRoleAssignmentsComplete(ctx context.Context) (ListAppRoleAssignmentsCompleteResult, error) {
	return c.ListAppRoleAssignmentsCompleteMatchingPredicate(ctx, AppRoleAssignmentOperationPredicate{})
}

// ListAppRoleAssignmentsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AppRoleAssignmentClient) ListAppRoleAssignmentsCompleteMatchingPredicate(ctx context.Context, predicate AppRoleAssignmentOperationPredicate) (result ListAppRoleAssignmentsCompleteResult, err error) {
