...
func (c AppRoleAssignmentClient) GetAppRoleAssignment(ctx context.Context, id MeAppRoleAssignmentId) (result GetAppRoleAssignmentOperationResponse, err error) {
