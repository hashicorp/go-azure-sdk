...
func (c ManagedDeviceCompliancePolicyStateClient) CreateManagedDeviceCompliancePolicyState(ctx context.Context, id stable.MeManagedDeviceId, input stable.DeviceCompliancePolicyState) (result CreateManagedDeviceCompliancePolicyStateOperationResponse, err error) {
