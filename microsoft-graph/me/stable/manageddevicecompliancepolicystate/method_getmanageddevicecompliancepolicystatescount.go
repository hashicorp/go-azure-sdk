...
func (c ManagedDeviceCompliancePolicyStateClient) GetManagedDeviceCompliancePolicyStatesCount(ctx context.Context, id stable.MeManagedDeviceId, options GetManagedDeviceCompliancePolicyStatesCountOperationOptions) (result GetManagedDeviceCompliancePolicyStatesCountOperationResponse, err error) {
