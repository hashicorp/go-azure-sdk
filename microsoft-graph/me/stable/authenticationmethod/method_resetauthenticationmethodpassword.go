...
func (c AuthenticationMethodClient) ResetAuthenticationMethodPassword(ctx context.Context, id stable.MeAuthenticationMethodId, input ResetAuthenticationMethodPasswordRequest) (result ResetAuthenticationMethodPasswordOperationResponse, err error) {
