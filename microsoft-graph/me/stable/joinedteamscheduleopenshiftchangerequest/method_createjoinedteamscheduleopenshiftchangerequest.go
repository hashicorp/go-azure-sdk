...
func (c JoinedTeamScheduleOpenShiftChangeRequestClient) CreateJoinedTeamScheduleOpenShiftChangeRequest(ctx context.Context, id stable.MeJoinedTeamId, input stable.OpenShiftChangeRequest) (result CreateJoinedTeamScheduleOpenShiftChangeRequestOperationResponse, err error) {
