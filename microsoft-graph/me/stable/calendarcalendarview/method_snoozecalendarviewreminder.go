...
// a new time.
func (c CalendarCalendarViewClient) SnoozeCalendarViewReminder(ctx context.Context, id stable.MeCalendarIdCalendarViewId, input SnoozeCalendarViewReminderRequest) (result SnoozeCalendarViewReminderOperationResponse, err error) {
