...
// in a user calendar.
func (c CalendarCalendarViewClient) DismissCalendarViewReminder(ctx context.Context, id stable.MeCalendarCalendarViewId) (result DismissCalendarViewReminderOperationResponse, err error) {
