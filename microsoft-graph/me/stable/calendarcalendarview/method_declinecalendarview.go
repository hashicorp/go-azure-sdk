...
func (c CalendarCalendarViewClient) DeclineCalendarView(ctx context.Context, id stable.MeCalendarCalendarViewId, input DeclineCalendarViewRequest) (result DeclineCalendarViewOperationResponse, err error) {
