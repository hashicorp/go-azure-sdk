...
func (c CalendarCalendarViewClient) CancelCalendarView(ctx context.Context, id stable.MeCalendarCalendarViewId, input CancelCalendarViewRequest) (result CancelCalendarViewOperationResponse, err error) {
