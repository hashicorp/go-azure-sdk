...
func (c CalendarCalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id stable.MeCalendarCalendarViewId, input TentativelyAcceptCalendarViewRequest) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
