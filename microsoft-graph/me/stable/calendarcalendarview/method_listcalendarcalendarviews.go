...
func (c CalendarCalendarViewClient) ListCalendarCalendarViews(ctx context.Context) (result ListCalendarCalendarViewsOperationResponse, err error) {
...
func (c CalendarCalendarViewClient) ListCalendarCalendarViewsComplete(ctx context.Context) (ListCalendarCalendarViewsCompleteResult, error) {
	return c.ListCalendarCalendarViewsCompleteMatchingPredicate(ctx, EventOperationPredicate{})
}

// ListCalendarCalendarViewsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c CalendarCalendarViewClient) ListCalendarCalendarViewsCompleteMatchingPredicate(ctx context.Context, predicate EventOperationPredicate) (result ListCalendarCalendarViewsCompleteResult, err error) {
	items := make([]stable.Event, 0)

	resp, err := c.ListCalendarCalendarViews(ctx)
	if err != nil {
