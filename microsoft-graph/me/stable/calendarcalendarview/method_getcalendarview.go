...
func (c CalendarCalendarViewClient) GetCalendarView(ctx context.Context, id stable.MeCalendarCalendarViewId, options GetCalendarViewOperationOptions) (result GetCalendarViewOperationResponse, err error) {
