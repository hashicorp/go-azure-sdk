...
func (c CalendarCalendarViewClient) GetCalendarViewCount(ctx context.Context, id stable.MeCalendarId, options GetCalendarViewCountOperationOptions) (result GetCalendarViewCountOperationResponse, err error) {
