...
// Outlook.com account.
func (c CalendarCalendarViewClient) ForwardCalendarView(ctx context.Context, id stable.MeCalendarCalendarViewId, input ForwardCalendarViewRequest) (result ForwardCalendarViewOperationResponse, err error) {
