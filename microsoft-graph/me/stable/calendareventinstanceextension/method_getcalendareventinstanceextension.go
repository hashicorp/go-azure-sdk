...
// GetCalendarEventInstanceExtension - Get extensions from me. The collection of open extensions defined for the event.
// Nullable.
func (c CalendarEventInstanceExtensionClient) GetCalendarEventInstanceExtension(ctx context.Context, id stable.MeCalendarEventIdInstanceIdExtensionId, options GetCalendarEventInstanceExtensionOperationOptions) (result GetCalendarEventInstanceExtensionOperationResponse, err error) {
