...
// DeleteCalendarEventInstanceExtension - Delete navigation property extensions for me
func (c CalendarEventInstanceExtensionClient) DeleteCalendarEventInstanceExtension(ctx context.Context, id stable.MeCalendarEventIdInstanceIdExtensionId, options DeleteCalendarEventInstanceExtensionOperationOptions) (result DeleteCalendarEventInstanceExtensionOperationResponse, err error) {
