...
// ListCalendarEventInstanceExtensions - Get extensions from me. The collection of open extensions defined for the
// event. Nullable.
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensions(ctx context.Context, id stable.MeCalendarEventIdInstanceId, options ListCalendarEventInstanceExtensionsOperationOptions) (result ListCalendarEventInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensionsComplete(ctx context.Context, id stable.MeCalendarEventIdInstanceId, options ListCalendarEventInstanceExtensionsOperationOptions) (ListCalendarEventInstanceExtensionsCompleteResult, error) {
...
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.MeCalendarEventIdInstanceId, options ListCalendarEventInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarEventInstanceExtensionsCompleteResult, err error) {
