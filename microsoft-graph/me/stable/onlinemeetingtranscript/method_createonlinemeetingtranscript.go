...
func (c OnlineMeetingTranscriptClient) CreateOnlineMeetingTranscript(ctx context.Context, id stable.MeOnlineMeetingId, input stable.CallTranscript) (result CreateOnlineMeetingTranscriptOperationResponse, err error) {
