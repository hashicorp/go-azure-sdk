...
func (c SolutionWorkingTimeScheduleClient) UpdateSolutionWorkingTimeSchedule(ctx context.Context, input stable.WorkingTimeSchedule, options UpdateSolutionWorkingTimeScheduleOperationOptions) (result UpdateSolutionWorkingTimeScheduleOperationResponse, err error) {
