...
// GetCalendarEventAttachment - Get attachments from me. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarEventAttachmentClient) GetCalendarEventAttachment(ctx context.Context, id stable.MeCalendarIdEventIdAttachmentId, options GetCalendarEventAttachmentOperationOptions) (result GetCalendarEventAttachmentOperationResponse, err error) {
