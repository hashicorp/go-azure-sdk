...
func (c CalendarEventAttachmentClient) GetCalendarEventAttachmentsCount(ctx context.Context, id stable.MeCalendarIdEventId, options GetCalendarEventAttachmentsCountOperationOptions) (result GetCalendarEventAttachmentsCountOperationResponse, err error) {
