...
func (c PlannerPlanBucketClient) CreatePlannerPlanBucket(ctx context.Context, id stable.MePlannerPlanId, input stable.PlannerBucket) (result CreatePlannerPlanBucketOperationResponse, err error) {
