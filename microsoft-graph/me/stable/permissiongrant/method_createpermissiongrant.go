...
func (c PermissionGrantClient) CreatePermissionGrant(ctx context.Context, input stable.ResourceSpecificPermissionGrant) (result CreatePermissionGrantOperationResponse, err error) {
