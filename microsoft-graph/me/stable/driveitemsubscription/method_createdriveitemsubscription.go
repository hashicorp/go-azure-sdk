...
func (c DriveItemSubscriptionClient) CreateDriveItemSubscription(ctx context.Context, id stable.MeDriveIdItemId, input stable.Subscription) (result CreateDriveItemSubscriptionOperationResponse, err error) {
