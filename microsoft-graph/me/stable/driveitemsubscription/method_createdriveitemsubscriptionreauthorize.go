...
func (c DriveItemSubscriptionClient) CreateDriveItemSubscriptionReauthorize(ctx context.Context, id stable.MeDriveIdItemIdSubscriptionId) (result CreateDriveItemSubscriptionReauthorizeOperationResponse, err error) {
