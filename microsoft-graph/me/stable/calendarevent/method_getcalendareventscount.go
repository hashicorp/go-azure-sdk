...
func (c CalendarEventClient) GetCalendarEventsCount(ctx context.Context, options GetCalendarEventsCountOperationOptions) (result GetCalendarEventsCountOperationResponse, err error) {
