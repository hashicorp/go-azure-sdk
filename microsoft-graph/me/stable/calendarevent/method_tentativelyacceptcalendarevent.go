...
func (c CalendarEventClient) TentativelyAcceptCalendarEvent(ctx context.Context, id stable.MeCalendarEventId, input TentativelyAcceptCalendarEventRequest) (result TentativelyAcceptCalendarEventOperationResponse, err error) {
