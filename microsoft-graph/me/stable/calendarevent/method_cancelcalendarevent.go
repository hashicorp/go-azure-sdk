...
func (c CalendarEventClient) CancelCalendarEvent(ctx context.Context, id stable.MeCalendarEventId, input CancelCalendarEventRequest) (result CancelCalendarEventOperationResponse, err error) {
