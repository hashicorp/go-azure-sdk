...
// DeleteCalendarEvent - Delete navigation property events for me
func (c CalendarEventClient) DeleteCalendarEvent(ctx context.Context, id stable.MeCalendarIdEventId, options DeleteCalendarEventOperationOptions) (result DeleteCalendarEventOperationResponse, err error) {
