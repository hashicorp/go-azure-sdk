...
// GetCalendarEvent - Get events from me. The events in the calendar. Navigation property. Read-only.
func (c CalendarEventClient) GetCalendarEvent(ctx context.Context, id stable.MeCalendarIdEventId, options GetCalendarEventOperationOptions) (result GetCalendarEventOperationResponse, err error) {
