...
// a new time.
func (c CalendarEventClient) SnoozeCalendarEventReminder(ctx context.Context, id stable.MeCalendarEventId, input SnoozeCalendarEventReminderRequest) (result SnoozeCalendarEventReminderOperationResponse, err error) {
