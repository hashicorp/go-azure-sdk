...
// Outlook.com account.
func (c CalendarEventClient) ForwardCalendarEvent(ctx context.Context, id stable.MeCalendarIdEventId, input ForwardCalendarEventRequest) (result ForwardCalendarEventOperationResponse, err error) {
