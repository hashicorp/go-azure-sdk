...
func (c CalendarEventClient) DeclineCalendarEvent(ctx context.Context, id stable.MeCalendarEventId, input DeclineCalendarEventRequest) (result DeclineCalendarEventOperationResponse, err error) {
