...
// represents a file.
func (c DriveItemContentClient) SetDriveItemContent(ctx context.Context, id stable.MeDriveIdItemId, input []byte) (result SetDriveItemContentOperationResponse, err error) {
