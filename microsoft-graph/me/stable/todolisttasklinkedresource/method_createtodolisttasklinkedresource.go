...
func (c TodoListTaskLinkedResourceClient) CreateTodoListTaskLinkedResource(ctx context.Context, id stable.MeTodoListIdTaskId, input stable.LinkedResource) (result CreateTodoListTaskLinkedResourceOperationResponse, err error) {
