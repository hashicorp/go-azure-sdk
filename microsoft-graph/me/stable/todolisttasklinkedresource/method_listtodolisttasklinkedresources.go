...
func (c TodoListTaskLinkedResourceClient) ListTodoListTaskLinkedResources(ctx context.Context, id MeTodoListIdTaskId) (result ListTodoListTaskLinkedResourcesOperationResponse, err error) {
...
func (c TodoListTaskLinkedResourceClient) ListTodoListTaskLinkedResourcesComplete(ctx context.Context, id MeTodoListIdTaskId) (ListTodoListTaskLinkedResourcesCompleteResult, error) {
...
func (c TodoListTaskLinkedResourceClient) ListTodoListTaskLinkedResourcesCompleteMatchingPredicate(ctx context.Context, id MeTodoListIdTaskId, predicate LinkedResourceOperationPredicate) (result ListTodoListTaskLinkedResourcesCompleteResult, err error) {
