...
// GetJoinedTeamScheduleTimeCard - Get timeCards from me. The time cards in the schedule.
func (c JoinedTeamScheduleTimeCardClient) GetJoinedTeamScheduleTimeCard(ctx context.Context, id stable.MeJoinedTeamIdScheduleTimeCardId, options GetJoinedTeamScheduleTimeCardOperationOptions) (result GetJoinedTeamScheduleTimeCardOperationResponse, err error) {
