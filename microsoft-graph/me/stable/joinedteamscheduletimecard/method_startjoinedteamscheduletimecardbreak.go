...
func (c JoinedTeamScheduleTimeCardClient) StartJoinedTeamScheduleTimeCardBreak(ctx context.Context, id stable.MeJoinedTeamIdScheduleTimeCardId, input StartJoinedTeamScheduleTimeCardBreakRequest, options StartJoinedTeamScheduleTimeCardBreakOperationOptions) (result StartJoinedTeamScheduleTimeCardBreakOperationResponse, err error) {
