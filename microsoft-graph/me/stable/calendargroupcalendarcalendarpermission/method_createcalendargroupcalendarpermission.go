...
func (c CalendarGroupCalendarCalendarPermissionClient) CreateCalendarGroupCalendarPermission(ctx context.Context, id stable.MeCalendarGroupIdCalendarId, input stable.CalendarPermission) (result CreateCalendarGroupCalendarPermissionOperationResponse, err error) {
