...
func (c ContactFolderChildFolderContactClient) CreateContactFolderChildFolderContact(ctx context.Context, id stable.MeContactFolderIdChildFolderId, input stable.Contact) (result CreateContactFolderChildFolderContactOperationResponse, err error) {
