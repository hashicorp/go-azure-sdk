...
// shared.
func (c CalendarPermissionClient) GetCalendarPermission(ctx context.Context, id stable.MeCalendarCalendarPermissionId, options GetCalendarPermissionOperationOptions) (result GetCalendarPermissionOperationResponse, err error) {
