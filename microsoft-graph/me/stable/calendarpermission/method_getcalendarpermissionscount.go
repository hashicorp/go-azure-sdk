...
func (c CalendarPermissionClient) GetCalendarPermissionsCount(ctx context.Context, id stable.MeCalendarId, options GetCalendarPermissionsCountOperationOptions) (result GetCalendarPermissionsCountOperationResponse, err error) {
