...
func (c DriveItemClient) CheckinDriveItem(ctx context.Context, id stable.MeDriveIdItemId, input CheckinDriveItemRequest) (result CheckinDriveItemOperationResponse, err error) {
