...
// permissions.
func (c DriveItemClient) DiscardDriveItemCheckout(ctx context.Context, id stable.MeDriveIdItemId, options DiscardDriveItemCheckoutOperationOptions) (result DiscardDriveItemCheckoutOperationResponse, err error) {
