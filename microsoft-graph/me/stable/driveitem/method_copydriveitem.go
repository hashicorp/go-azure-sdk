...
func (c DriveItemClient) CopyDriveItem(ctx context.Context, id stable.MeDriveIdItemId, input CopyDriveItemRequest) (result CopyDriveItemOperationResponse, err error) {
