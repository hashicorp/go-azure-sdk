...
func (c DriveItemClient) CreateDriveItem(ctx context.Context, id stable.MeDriveId, input stable.DriveItem) (result CreateDriveItemOperationResponse, err error) {
