...
func (c DriveItemClient) RestoreDriveItem(ctx context.Context, id stable.MeDriveIdItemId, input RestoreDriveItemRequest) (result RestoreDriveItemOperationResponse, err error) {
