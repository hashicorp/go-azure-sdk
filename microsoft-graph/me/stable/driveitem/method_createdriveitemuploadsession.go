...
func (c DriveItemClient) CreateDriveItemUploadSession(ctx context.Context, id stable.MeDriveIdItemId, input CreateDriveItemUploadSessionRequest) (result CreateDriveItemUploadSessionOperationResponse, err error) {
