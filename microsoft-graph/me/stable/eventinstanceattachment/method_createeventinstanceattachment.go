...
func (c EventInstanceAttachmentClient) CreateEventInstanceAttachment(ctx context.Context, id stable.MeEventIdInstanceId, input stable.Attachment) (result CreateEventInstanceAttachmentOperationResponse, err error) {
