...
func (c DriveRootAnalyticsItemActivityStatClient) CreateDriveRootAnalyticsItemActivityStat(ctx context.Context, id stable.MeDriveId, input stable.ItemActivityStat) (result CreateDriveRootAnalyticsItemActivityStatOperationResponse, err error) {
