...
// GetTeamworkAssociatedTeam - Get team from me
func (c TeamworkAssociatedTeamTeamClient) GetTeamworkAssociatedTeam(ctx context.Context, id stable.MeTeamworkAssociatedTeamId, options GetTeamworkAssociatedTeamOperationOptions) (result GetTeamworkAssociatedTeamOperationResponse, err error) {
