...
// shared.
func (c CalendarCalendarPermissionClient) ListCalendarPermissions(ctx context.Context, options ListCalendarPermissionsOperationOptions) (result ListCalendarPermissionsOperationResponse, err error) {
...
func (c CalendarCalendarPermissionClient) ListCalendarPermissionsComplete(ctx context.Context, options ListCalendarPermissionsOperationOptions) (ListCalendarPermissionsCompleteResult, error) {
	return c.ListCalendarPermissionsCompleteMatchingPredicate(ctx, options, CalendarPermissionOperationPredicate{})
}

// ListCalendarPermissionsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c CalendarCalendarPermissionClient) ListCalendarPermissionsCompleteMatchingPredicate(ctx context.Context, options ListCalendarPermissionsOperationOptions, predicate CalendarPermissionOperationPredicate) (result ListCalendarPermissionsCompleteResult, err error) {
	items := make([]stable.CalendarPermission, 0)

	resp, err := c.ListCalendarPermissions(ctx, options)
	if err != nil {
