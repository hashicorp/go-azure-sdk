...
## `github.com/hashicorp/go-azure-sdk/microsoft-graph/me/stable/onenotesection` Documentation

The `onenotesection` SDK allows for interaction with Microsoft Graph `me` (API Version `stable`).
...
```go
import "github.com/hashicorp/go-azure-sdk/microsoft-graph/me/stable/onenotesection"
```
