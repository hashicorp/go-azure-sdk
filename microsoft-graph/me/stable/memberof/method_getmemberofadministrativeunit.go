...
func (c MemberOfClient) GetMemberOfAdministrativeUnit(ctx context.Context, id stable.MeMemberOfId, options GetMemberOfAdministrativeUnitOperationOptions) (result GetMemberOfAdministrativeUnitOperationResponse, err error) {
