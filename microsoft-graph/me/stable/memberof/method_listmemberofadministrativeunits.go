...
func (c MemberOfClient) ListMemberOfAdministrativeUnits(ctx context.Context, options ListMemberOfAdministrativeUnitsOperationOptions) (result ListMemberOfAdministrativeUnitsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/memberOf/administrativeUnit",
...
func (c MemberOfClient) ListMemberOfAdministrativeUnitsComplete(ctx context.Context, options ListMemberOfAdministrativeUnitsOperationOptions) (ListMemberOfAdministrativeUnitsCompleteResult, error) {
	return c.ListMemberOfAdministrativeUnitsCompleteMatchingPredicate(ctx, options, AdministrativeUnitOperationPredicate{})
}

// ListMemberOfAdministrativeUnitsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c MemberOfClient) ListMemberOfAdministrativeUnitsCompleteMatchingPredicate(ctx context.Context, options ListMemberOfAdministrativeUnitsOperationOptions, predicate AdministrativeUnitOperationPredicate) (result ListMemberOfAdministrativeUnitsCompleteResult, err error) {
	items := make([]stable.AdministrativeUnit, 0)

	resp, err := c.ListMemberOfAdministrativeUnits(ctx, options)
	if err != nil {
