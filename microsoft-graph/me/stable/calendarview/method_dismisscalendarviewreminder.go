...
// in a user calendar.
func (c CalendarViewClient) DismissCalendarViewReminder(ctx context.Context, id stable.MeCalendarViewId) (result DismissCalendarViewReminderOperationResponse, err error) {
