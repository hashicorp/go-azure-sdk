...
// Outlook.com account.
func (c CalendarViewClient) ForwardCalendarView(ctx context.Context, id stable.MeCalendarViewId, input ForwardCalendarViewRequest) (result ForwardCalendarViewOperationResponse, err error) {
