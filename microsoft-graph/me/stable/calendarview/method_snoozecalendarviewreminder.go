...
// a new time.
func (c CalendarViewClient) SnoozeCalendarViewReminder(ctx context.Context, id stable.MeCalendarViewId, input SnoozeCalendarViewReminderRequest) (result SnoozeCalendarViewReminderOperationResponse, err error) {
