...
func (c CalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id stable.MeCalendarViewId, input TentativelyAcceptCalendarViewRequest) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
