...
// GetCalendarView - Get calendarView from me. The calendar view for the calendar. Read-only. Nullable.
func (c CalendarViewClient) GetCalendarView(ctx context.Context, id stable.MeCalendarViewId, options GetCalendarViewOperationOptions) (result GetCalendarViewOperationResponse, err error) {
