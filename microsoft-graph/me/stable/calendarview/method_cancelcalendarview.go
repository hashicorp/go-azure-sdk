...
func (c CalendarViewClient) CancelCalendarView(ctx context.Context, id stable.MeCalendarViewId, input CancelCalendarViewRequest) (result CancelCalendarViewOperationResponse, err error) {
