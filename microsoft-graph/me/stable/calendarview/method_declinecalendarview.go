...
func (c CalendarViewClient) DeclineCalendarView(ctx context.Context, id stable.MeCalendarViewId, input DeclineCalendarViewRequest) (result DeclineCalendarViewOperationResponse, err error) {
