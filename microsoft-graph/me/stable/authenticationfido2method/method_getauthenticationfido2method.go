...
func (c AuthenticationFido2MethodClient) GetAuthenticationFido2Method(ctx context.Context, id MeAuthenticationFido2MethodId) (result GetAuthenticationFido2MethodOperationResponse, err error) {
