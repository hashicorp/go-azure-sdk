...
func (c CalendarGroupCalendarViewExtensionClient) GetCalendarGroupCalendarViewExtensionsCount(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, options GetCalendarGroupCalendarViewExtensionsCountOperationOptions) (result GetCalendarGroupCalendarViewExtensionsCountOperationResponse, err error) {
