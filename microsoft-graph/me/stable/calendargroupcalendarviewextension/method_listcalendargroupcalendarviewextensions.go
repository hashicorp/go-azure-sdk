...
// ListCalendarGroupCalendarViewExtensions - Get extensions from me. The collection of open extensions defined for the
// event. Nullable.
func (c CalendarGroupCalendarViewExtensionClient) ListCalendarGroupCalendarViewExtensions(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewExtensionsOperationOptions) (result ListCalendarGroupCalendarViewExtensionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarViewExtensionClient) ListCalendarGroupCalendarViewExtensionsComplete(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewExtensionsOperationOptions) (ListCalendarGroupCalendarViewExtensionsCompleteResult, error) {
...
func (c CalendarGroupCalendarViewExtensionClient) ListCalendarGroupCalendarViewExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarGroupCalendarViewExtensionsCompleteResult, err error) {
