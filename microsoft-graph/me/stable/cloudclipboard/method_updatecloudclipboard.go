...
func (c CloudClipboardClient) UpdateCloudClipboard(ctx context.Context, input stable.CloudClipboardRoot) (result UpdateCloudClipboardOperationResponse, err error) {
