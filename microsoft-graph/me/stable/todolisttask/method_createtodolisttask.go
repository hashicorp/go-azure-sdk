...
func (c TodoListTaskClient) CreateTodoListTask(ctx context.Context, id stable.MeTodoListId, input stable.TodoTask) (result CreateTodoListTaskOperationResponse, err error) {
