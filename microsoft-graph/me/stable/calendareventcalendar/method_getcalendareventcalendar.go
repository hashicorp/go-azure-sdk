...
// GetCalendarEventCalendar - Get calendar from me. The calendar that contains the event. Navigation property.
// Read-only.
func (c CalendarEventCalendarClient) GetCalendarEventCalendar(ctx context.Context, id stable.MeCalendarEventId, options GetCalendarEventCalendarOperationOptions) (result GetCalendarEventCalendarOperationResponse, err error) {
