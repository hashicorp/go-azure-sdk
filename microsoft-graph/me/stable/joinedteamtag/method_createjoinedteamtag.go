...
func (c JoinedTeamTagClient) CreateJoinedTeamTag(ctx context.Context, id stable.MeJoinedTeamId, input stable.TeamworkTag) (result CreateJoinedTeamTagOperationResponse, err error) {
