...
// ListJoinedTeamPrimaryChannelAllMembers - Get allMembers from me. A collection of membership records associated with
// the channel, including both direct and indirect members of shared channels.
func (c JoinedTeamPrimaryChannelAllMemberClient) ListJoinedTeamPrimaryChannelAllMembers(ctx context.Context, id stable.MeJoinedTeamId, options ListJoinedTeamPrimaryChannelAllMembersOperationOptions) (result ListJoinedTeamPrimaryChannelAllMembersOperationResponse, err error) {
...
func (c JoinedTeamPrimaryChannelAllMemberClient) ListJoinedTeamPrimaryChannelAllMembersComplete(ctx context.Context, id stable.MeJoinedTeamId, options ListJoinedTeamPrimaryChannelAllMembersOperationOptions) (ListJoinedTeamPrimaryChannelAllMembersCompleteResult, error) {
