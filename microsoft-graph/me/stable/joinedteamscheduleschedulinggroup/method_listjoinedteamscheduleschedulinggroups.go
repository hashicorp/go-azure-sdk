...
func (c JoinedTeamScheduleSchedulingGroupClient) ListJoinedTeamScheduleSchedulingGroups(ctx context.Context, id MeJoinedTeamId) (result ListJoinedTeamScheduleSchedulingGroupsOperationResponse, err error) {
...
func (c JoinedTeamScheduleSchedulingGroupClient) ListJoinedTeamScheduleSchedulingGroupsComplete(ctx context.Context, id MeJoinedTeamId) (ListJoinedTeamScheduleSchedulingGroupsCompleteResult, error) {
...
func (c JoinedTeamScheduleSchedulingGroupClient) ListJoinedTeamScheduleSchedulingGroupsCompleteMatchingPredicate(ctx context.Context, id MeJoinedTeamId, predicate SchedulingGroupOperationPredicate) (result ListJoinedTeamScheduleSchedulingGroupsCompleteResult, err error) {
