...
func (c CalendarCalendarViewInstanceExtensionClient) ListCalendarCalendarViewInstanceExtensions(ctx context.Context, id MeCalendarIdCalendarViewIdInstanceId) (result ListCalendarCalendarViewInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceExtensionClient) ListCalendarCalendarViewInstanceExtensionsComplete(ctx context.Context, id MeCalendarIdCalendarViewIdInstanceId) (ListCalendarCalendarViewInstanceExtensionsCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceExtensionClient) ListCalendarCalendarViewInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id MeCalendarIdCalendarViewIdInstanceId, predicate ExtensionOperationPredicate) (result ListCalendarCalendarViewInstanceExtensionsCompleteResult, err error) {
