...
func (c DriveItemVersionClient) CreateDriveItemVersion(ctx context.Context, id stable.MeDriveIdItemId, input stable.DriveItemVersion) (result CreateDriveItemVersionOperationResponse, err error) {
