...
func (c TodoListTaskAttachmentClient) ListTodoListTaskAttachments(ctx context.Context, id MeTodoListIdTaskId) (result ListTodoListTaskAttachmentsOperationResponse, err error) {
	...
	var values struct {
		Values *[]stable.AttachmentBase `json:"value"`
	}
...
func (c TodoListTaskAttachmentClient) ListTodoListTaskAttachmentsComplete(ctx context.Context, id MeTodoListIdTaskId) (ListTodoListTaskAttachmentsCompleteResult, error) {
...
func (c TodoListTaskAttachmentClient) ListTodoListTaskAttachmentsCompleteMatchingPredicate(ctx context.Context, id MeTodoListIdTaskId, predicate AttachmentBaseOperationPredicate) (result ListTodoListTaskAttachmentsCompleteResult, err error) {
