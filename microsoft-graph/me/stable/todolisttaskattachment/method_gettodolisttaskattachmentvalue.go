...
// contentBytes.
func (c TodoListTaskAttachmentClient) GetTodoListTaskAttachmentValue(ctx context.Context, id stable.MeTodoListIdTaskIdAttachmentId) (result GetTodoListTaskAttachmentValueOperationResponse, err error) {
