...
func (c TodoListTaskAttachmentClient) SetTodoListTaskAttachmentValue(ctx context.Context, id stable.MeTodoListIdTaskIdAttachmentId, input []byte) (result SetTodoListTaskAttachmentValueOperationResponse, err error) {
