...
func (c CalendarEventExtensionClient) DeleteCalendarEventExtension(ctx context.Context, id stable.MeCalendarIdEventIdExtensionId, options DeleteCalendarEventExtensionOperationOptions) (result DeleteCalendarEventExtensionOperationResponse, err error) {
