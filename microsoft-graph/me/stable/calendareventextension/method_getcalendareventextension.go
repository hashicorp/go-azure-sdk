...
// GetCalendarEventExtension - Get extensions from me. The collection of open extensions defined for the event.
// Nullable.
func (c CalendarEventExtensionClient) GetCalendarEventExtension(ctx context.Context, id stable.MeCalendarIdEventIdExtensionId, options GetCalendarEventExtensionOperationOptions) (result GetCalendarEventExtensionOperationResponse, err error) {
