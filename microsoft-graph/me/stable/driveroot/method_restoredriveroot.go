...
func (c DriveRootClient) RestoreDriveRoot(ctx context.Context, id stable.MeDriveId, input RestoreDriveRootRequest) (result RestoreDriveRootOperationResponse, err error) {
