...
// permissions.
func (c DriveRootClient) DiscardDriveRootCheckout(ctx context.Context, id stable.MeDriveId, options DiscardDriveRootCheckoutOperationOptions) (result DiscardDriveRootCheckoutOperationResponse, err error) {
