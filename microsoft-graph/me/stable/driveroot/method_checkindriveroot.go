...
func (c DriveRootClient) CheckinDriveRoot(ctx context.Context, id stable.MeDriveId, input CheckinDriveRootRequest) (result CheckinDriveRootOperationResponse, err error) {
