...
func (c DriveRootClient) PreviewDriveRoot(ctx context.Context, id stable.MeDriveId, input PreviewDriveRootRequest) (result PreviewDriveRootOperationResponse, err error) {
