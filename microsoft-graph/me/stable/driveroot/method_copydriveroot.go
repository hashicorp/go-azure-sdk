...
func (c DriveRootClient) CopyDriveRoot(ctx context.Context, id stable.MeDriveId, input CopyDriveRootRequest) (result CopyDriveRootOperationResponse, err error) {
