...
func (c JoinedTeamPrimaryChannelFilesFolderContentClient) SetJoinedTeamPrimaryChannelFilesFolderContent(ctx context.Context, id stable.MeJoinedTeamId, input []byte) (result SetJoinedTeamPrimaryChannelFilesFolderContentOperationResponse, err error) {
