...
func (c CalendarGroupCalendarCalendarViewClient) ListCalendarGroupCalendarCalendarViews(ctx context.Context, id MeCalendarGroupIdCalendarId) (result ListCalendarGroupCalendarCalendarViewsOperationResponse, err error) {
...
func (c CalendarGroupCalendarCalendarViewClient) ListCalendarGroupCalendarCalendarViewsComplete(ctx context.Context, id MeCalendarGroupIdCalendarId) (ListCalendarGroupCalendarCalendarViewsCompleteResult, error) {
...
func (c CalendarGroupCalendarCalendarViewClient) ListCalendarGroupCalendarCalendarViewsCompleteMatchingPredicate(ctx context.Context, id MeCalendarGroupIdCalendarId, predicate EventOperationPredicate) (result ListCalendarGroupCalendarCalendarViewsCompleteResult, err error) {
