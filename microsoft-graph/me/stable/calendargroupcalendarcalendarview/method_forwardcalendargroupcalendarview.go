...
func (c CalendarGroupCalendarCalendarViewClient) ForwardCalendarGroupCalendarView(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, input ForwardCalendarGroupCalendarViewRequest) (result ForwardCalendarGroupCalendarViewOperationResponse, err error) {
