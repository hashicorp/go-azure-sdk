...
// Read-only.
func (c CalendarGroupCalendarCalendarViewClient) GetCalendarGroupCalendarView(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, options GetCalendarGroupCalendarViewOperationOptions) (result GetCalendarGroupCalendarViewOperationResponse, err error) {
