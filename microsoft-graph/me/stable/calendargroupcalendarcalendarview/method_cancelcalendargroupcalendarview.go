...
func (c CalendarGroupCalendarCalendarViewClient) CancelCalendarGroupCalendarView(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, input CancelCalendarGroupCalendarViewRequest) (result CancelCalendarGroupCalendarViewOperationResponse, err error) {
