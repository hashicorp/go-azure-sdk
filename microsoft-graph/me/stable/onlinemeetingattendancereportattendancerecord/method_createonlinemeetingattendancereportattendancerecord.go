...
func (c OnlineMeetingAttendanceReportAttendanceRecordClient) CreateOnlineMeetingAttendanceReportAttendanceRecord(ctx context.Context, id stable.MeOnlineMeetingIdAttendanceReportId, input stable.AttendanceRecord) (result CreateOnlineMeetingAttendanceReportAttendanceRecordOperationResponse, err error) {
