...
// CreateJoinedTeamScheduleDayNote - Create new navigation property to dayNotes for me
func (c JoinedTeamScheduleDayNoteClient) CreateJoinedTeamScheduleDayNote(ctx context.Context, id stable.MeJoinedTeamId, input stable.DayNote, options CreateJoinedTeamScheduleDayNoteOperationOptions) (result CreateJoinedTeamScheduleDayNoteOperationResponse, err error) {
