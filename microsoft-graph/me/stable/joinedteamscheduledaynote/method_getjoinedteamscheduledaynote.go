...
// GetJoinedTeamScheduleDayNote - Get dayNotes from me. The day notes in the schedule.
func (c JoinedTeamScheduleDayNoteClient) GetJoinedTeamScheduleDayNote(ctx context.Context, id stable.MeJoinedTeamIdScheduleDayNoteId, options GetJoinedTeamScheduleDayNoteOperationOptions) (result GetJoinedTeamScheduleDayNoteOperationResponse, err error) {
