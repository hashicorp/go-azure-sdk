...
func (c OnlineMeetingRecordingClient) CreateOnlineMeetingRecording(ctx context.Context, id stable.MeOnlineMeetingId, input stable.CallRecording) (result CreateOnlineMeetingRecordingOperationResponse, err error) {
