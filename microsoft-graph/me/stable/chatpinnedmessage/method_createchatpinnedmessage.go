...
func (c ChatPinnedMessageClient) CreateChatPinnedMessage(ctx context.Context, id stable.MeChatId, input stable.PinnedChatMessageInfo) (result CreateChatPinnedMessageOperationResponse, err error) {
