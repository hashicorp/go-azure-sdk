...
func (c CalendarGroupCalendarEventInstanceClient) GetCalendarGroupCalendarEventInstancesCount(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdEventId, options GetCalendarGroupCalendarEventInstancesCountOperationOptions) (result GetCalendarGroupCalendarEventInstancesCountOperationResponse, err error) {
