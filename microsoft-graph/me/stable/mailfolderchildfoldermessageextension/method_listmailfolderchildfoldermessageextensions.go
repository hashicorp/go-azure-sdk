...
func (c MailFolderChildFolderMessageExtensionClient) ListMailFolderChildFolderMessageExtensions(ctx context.Context, id MeMailFolderIdChildFolderIdMessageId) (result ListMailFolderChildFolderMessageExtensionsOperationResponse, err error) {
...
func (c MailFolderChildFolderMessageExtensionClient) ListMailFolderChildFolderMessageExtensionsComplete(ctx context.Context, id MeMailFolderIdChildFolderIdMessageId) (ListMailFolderChildFolderMessageExtensionsCompleteResult, error) {
...
func (c MailFolderChildFolderMessageExtensionClient) ListMailFolderChildFolderMessageExtensionsCompleteMatchingPredicate(ctx context.Context, id MeMailFolderIdChildFolderIdMessageId, predicate ExtensionOperationPredicate) (result ListMailFolderChildFolderMessageExtensionsCompleteResult, err error) {
