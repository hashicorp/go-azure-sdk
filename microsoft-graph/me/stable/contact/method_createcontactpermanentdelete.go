...
func (c ContactClient) CreateContactPermanentDelete(ctx context.Context, id stable.MeContactId, options CreateContactPermanentDeleteOperationOptions) (result CreateContactPermanentDeleteOperationResponse, err error) {
