...
// event. Nullable.
func (c CalendarGroupCalendarCalendarViewExtensionClient) ListCalendarGroupCalendarViewExtensions(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewExtensionsOperationOptions) (result ListCalendarGroupCalendarViewExtensionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarCalendarViewExtensionClient) ListCalendarGroupCalendarViewExtensionsComplete(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewExtensionsOperationOptions) (ListCalendarGroupCalendarViewExtensionsCompleteResult, error) {
