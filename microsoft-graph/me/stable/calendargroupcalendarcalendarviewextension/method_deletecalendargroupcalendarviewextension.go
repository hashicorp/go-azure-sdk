...
// DeleteCalendarGroupCalendarViewExtension - Delete navigation property extensions for me
func (c CalendarGroupCalendarCalendarViewExtensionClient) DeleteCalendarGroupCalendarViewExtension(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewIdExtensionId, options DeleteCalendarGroupCalendarViewExtensionOperationOptions) (result DeleteCalendarGroupCalendarViewExtensionOperationResponse, err error) {
