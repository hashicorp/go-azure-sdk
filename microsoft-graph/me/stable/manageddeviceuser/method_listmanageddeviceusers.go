...
func (c ManagedDeviceUserClient) ListManagedDeviceUsers(ctx context.Context, id MeManagedDeviceId) (result ListManagedDeviceUsersOperationResponse, err error) {
...
func (c ManagedDeviceUserClient) ListManagedDeviceUsersComplete(ctx context.Context, id MeManagedDeviceId) (ListManagedDeviceUsersCompleteResult, error) {
...
func (c ManagedDeviceUserClient) ListManagedDeviceUsersCompleteMatchingPredicate(ctx context.Context, id MeManagedDeviceId, predicate UserOperationPredicate) (result ListManagedDeviceUsersCompleteResult, err error) {
