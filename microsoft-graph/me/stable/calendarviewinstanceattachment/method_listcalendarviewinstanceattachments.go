...
func (c CalendarViewInstanceAttachmentClient) ListCalendarViewInstanceAttachments(ctx context.Context, id stable.MeCalendarViewIdInstanceId, options ListCalendarViewInstanceAttachmentsOperationOptions) (result ListCalendarViewInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarViewInstanceAttachmentClient) ListCalendarViewInstanceAttachmentsComplete(ctx context.Context, id stable.MeCalendarViewIdInstanceId, options ListCalendarViewInstanceAttachmentsOperationOptions) (ListCalendarViewInstanceAttachmentsCompleteResult, error) {
