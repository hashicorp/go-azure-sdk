...
func (c MailFolderMessageClient) CreateMailFolderMessageReplyAll(ctx context.Context, id stable.MeMailFolderIdMessageId, input CreateMailFolderMessageReplyAllRequest) (result CreateMailFolderMessageReplyAllOperationResponse, err error) {
