...
func (c MailFolderMessageClient) CreateMailFolderMessageForward(ctx context.Context, id stable.MeMailFolderIdMessageId, input CreateMailFolderMessageForwardRequest) (result CreateMailFolderMessageForwardOperationResponse, err error) {
