...
// later.
func (c MailFolderMessageClient) ReplyMailFolderMessage(ctx context.Context, id stable.MeMailFolderIdMessageId, input ReplyMailFolderMessageRequest) (result ReplyMailFolderMessageOperationResponse, err error) {
