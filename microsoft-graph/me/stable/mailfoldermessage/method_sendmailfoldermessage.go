...
func (c MailFolderMessageClient) SendMailFolderMessage(ctx context.Context, id stable.MeMailFolderIdMessageId) (result SendMailFolderMessageOperationResponse, err error) {
