...
func (c MailFolderMessageClient) SetMailFolderMessageValue(ctx context.Context, id stable.MeMailFolderIdMessageId, input []byte) (result SetMailFolderMessageValueOperationResponse, err error) {
