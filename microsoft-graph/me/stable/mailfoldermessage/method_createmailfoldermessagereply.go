...
func (c MailFolderMessageClient) CreateMailFolderMessageReply(ctx context.Context, id stable.MeMailFolderIdMessageId, input CreateMailFolderMessageReplyRequest) (result CreateMailFolderMessageReplyOperationResponse, err error) {
