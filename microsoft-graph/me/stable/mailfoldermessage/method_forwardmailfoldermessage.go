...
func (c MailFolderMessageClient) ForwardMailFolderMessage(ctx context.Context, id stable.MeMailFolderIdMessageId, input ForwardMailFolderMessageRequest) (result ForwardMailFolderMessageOperationResponse, err error) {
