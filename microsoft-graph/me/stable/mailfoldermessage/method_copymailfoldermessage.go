...
func (c MailFolderMessageClient) CopyMailFolderMessage(ctx context.Context, id stable.MeMailFolderIdMessageId, input CopyMailFolderMessageRequest) (result CopyMailFolderMessageOperationResponse, err error) {
