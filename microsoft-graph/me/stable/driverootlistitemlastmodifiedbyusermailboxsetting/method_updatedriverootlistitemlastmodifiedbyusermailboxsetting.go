...
func (c DriveRootListItemLastModifiedByUserMailboxSettingClient) UpdateDriveRootListItemLastModifiedByUserMailboxSetting(ctx context.Context, id stable.MeDriveId, input stable.MailboxSettings) (result UpdateDriveRootListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
