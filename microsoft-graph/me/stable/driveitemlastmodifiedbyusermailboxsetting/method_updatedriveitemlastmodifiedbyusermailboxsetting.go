...
func (c DriveItemLastModifiedByUserMailboxSettingClient) UpdateDriveItemLastModifiedByUserMailboxSetting(ctx context.Context, id stable.MeDriveIdItemId, input stable.MailboxSettings) (result UpdateDriveItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
