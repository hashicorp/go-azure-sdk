...
type CreateCreatessageAttachmentsUploadSessionOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.UploadSession
}

// CreateCreatessageAttachmentsUploadSession - Invoke action createUploadSession. Create an upload session that allows
...
func (c MessageAttachmentClient) CreateCreatessageAttachmentsUploadSession(ctx context.Context, id stable.MeMessageId, input CreateCreatessageAttachmentsUploadSessionRequest) (result CreateCreatessageAttachmentsUploadSessionOperationResponse, err error) {
