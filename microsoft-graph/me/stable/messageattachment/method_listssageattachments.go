...
// ListssageAttachments - List attachments. Retrieve a list of attachment objects.
func (c MessageAttachmentClient) ListssageAttachments(ctx context.Context, id stable.MeMessageId, options ListssageAttachmentsOperationOptions) (result ListssageAttachmentsOperationResponse, err error) {
...
func (c MessageAttachmentClient) ListssageAttachmentsComplete(ctx context.Context, id stable.MeMessageId, options ListssageAttachmentsOperationOptions) (ListssageAttachmentsCompleteResult, error) {
...
func (c MessageAttachmentClient) ListssageAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.MeMessageId, options ListssageAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListssageAttachmentsCompleteResult, err error) {
