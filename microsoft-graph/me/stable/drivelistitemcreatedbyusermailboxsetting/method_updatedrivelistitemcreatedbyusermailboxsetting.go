...
func (c DriveListItemCreatedByUserMailboxSettingClient) UpdateDriveListItemCreatedByUserMailboxSetting(ctx context.Context, id stable.MeDriveIdListItemId, input stable.MailboxSettings) (result UpdateDriveListItemCreatedByUserMailboxSettingOperationResponse, err error) {
