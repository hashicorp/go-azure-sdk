...
// DeleteCalendarGroupCalendarEventAttachment - Delete navigation property attachments for me
func (c CalendarGroupCalendarEventAttachmentClient) DeleteCalendarGroupCalendarEventAttachment(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdEventIdAttachmentId, options DeleteCalendarGroupCalendarEventAttachmentOperationOptions) (result DeleteCalendarGroupCalendarEventAttachmentOperationResponse, err error) {
