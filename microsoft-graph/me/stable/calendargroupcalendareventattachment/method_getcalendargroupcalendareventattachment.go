...
// GetCalendarGroupCalendarEventAttachment - Get attachments from me. The collection of FileAttachment, ItemAttachment,
// and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarGroupCalendarEventAttachmentClient) GetCalendarGroupCalendarEventAttachment(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdEventIdAttachmentId, options GetCalendarGroupCalendarEventAttachmentOperationOptions) (result GetCalendarGroupCalendarEventAttachmentOperationResponse, err error) {
