...
// GetCalendarEventInstanceCalendar - Get calendar from me. The calendar that contains the event. Navigation property.
// Read-only.
func (c CalendarEventInstanceCalendarClient) GetCalendarEventInstanceCalendar(ctx context.Context, id stable.MeCalendarIdEventIdInstanceId, options GetCalendarEventInstanceCalendarOperationOptions) (result GetCalendarEventInstanceCalendarOperationResponse, err error) {
