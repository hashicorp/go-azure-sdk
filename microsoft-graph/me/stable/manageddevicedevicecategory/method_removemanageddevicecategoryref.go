...
func (c ManagedDeviceDeviceCategoryClient) RemoveManagedDeviceCategoryRef(ctx context.Context, id stable.MeManagedDeviceId, options RemoveManagedDeviceCategoryRefOperationOptions) (result RemoveManagedDeviceCategoryRefOperationResponse, err error) {
