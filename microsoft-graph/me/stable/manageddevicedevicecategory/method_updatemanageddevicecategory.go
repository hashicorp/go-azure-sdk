...
func (c ManagedDeviceDeviceCategoryClient) UpdateManagedDeviceCategory(ctx context.Context, id stable.MeManagedDeviceId, input stable.DeviceCategory) (result UpdateManagedDeviceCategoryOperationResponse, err error) {
