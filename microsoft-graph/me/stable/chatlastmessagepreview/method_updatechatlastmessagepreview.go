...
func (c ChatLastMessagePreviewClient) UpdateChatLastMessagePreview(ctx context.Context, id stable.MeChatId, input stable.ChatMessageInfo) (result UpdateChatLastMessagePreviewOperationResponse, err error) {
