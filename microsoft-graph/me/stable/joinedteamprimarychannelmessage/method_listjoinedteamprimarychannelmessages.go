...
func (c JoinedTeamPrimaryChannelMessageClient) ListJoinedTeamPrimaryChannelMessages(ctx context.Context, id MeJoinedTeamId) (result ListJoinedTeamPrimaryChannelMessagesOperationResponse, err error) {
...
func (c JoinedTeamPrimaryChannelMessageClient) ListJoinedTeamPrimaryChannelMessagesComplete(ctx context.Context, id MeJoinedTeamId) (ListJoinedTeamPrimaryChannelMessagesCompleteResult, error) {
...
func (c JoinedTeamPrimaryChannelMessageClient) ListJoinedTeamPrimaryChannelMessagesCompleteMatchingPredicate(ctx context.Context, id MeJoinedTeamId, predicate ChatMessageOperationPredicate) (result ListJoinedTeamPrimaryChannelMessagesCompleteResult, err error) {
