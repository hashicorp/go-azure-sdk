...
func (c PlannerPlanBucketTaskDetailClient) UpdatePlannerPlanBucketTaskDetail(ctx context.Context, id MePlannerPlanIdBucketIdTaskId, input stable.PlannerTaskDetails) (result UpdatePlannerPlanBucketTaskDetailOperationResponse, err error) {
