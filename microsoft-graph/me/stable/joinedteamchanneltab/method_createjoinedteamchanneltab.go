...
func (c JoinedTeamChannelTabClient) CreateJoinedTeamChannelTab(ctx context.Context, id stable.MeJoinedTeamIdChannelId, input stable.TeamsTab) (result CreateJoinedTeamChannelTabOperationResponse, err error) {
