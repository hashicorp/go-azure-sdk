...
func (c CalendarGroupCalendarViewInstanceClient) GetCalendarGroupCalendarViewInstancesCount(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, options GetCalendarGroupCalendarViewInstancesCountOperationOptions) (result GetCalendarGroupCalendarViewInstancesCountOperationResponse, err error) {
