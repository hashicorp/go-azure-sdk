...
func (c ContactFolderClient) CreateContactFolderPermanentDelete(ctx context.Context, id stable.MeContactFolderId, options CreateContactFolderPermanentDeleteOperationOptions) (result CreateContactFolderPermanentDeleteOperationResponse, err error) {
