...
func (c DriveCreatedByUserMailboxSettingClient) UpdateDriveCreatedByUserMailboxSetting(ctx context.Context, id stable.MeDriveId, input stable.MailboxSettings) (result UpdateDriveCreatedByUserMailboxSettingOperationResponse, err error) {
