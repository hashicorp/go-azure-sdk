...
func (c JoinedTeamPrimaryChannelSharedWithTeamAllowedMemberClient) ListJoinedTeamPrimaryChannelSharedWithTeamAllowedMembers(ctx context.Context, id MeJoinedTeamIdPrimaryChannelSharedWithTeamId) (result ListJoinedTeamPrimaryChannelSharedWithTeamAllowedMembersOperationResponse, err error) {
...
func (c JoinedTeamPrimaryChannelSharedWithTeamAllowedMemberClient) ListJoinedTeamPrimaryChannelSharedWithTeamAllowedMembersComplete(ctx context.Context, id MeJoinedTeamIdPrimaryChannelSharedWithTeamId) (ListJoinedTeamPrimaryChannelSharedWithTeamAllowedMembersCompleteResult, error) {
