...
// successful response.
func (c JoinedTeamClient) CreateJoinedTeamCompleteMigration(ctx context.Context, id stable.MeJoinedTeamId) (result CreateJoinedTeamCompleteMigrationOperationResponse, err error) {
