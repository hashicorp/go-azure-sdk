...
func (c JoinedTeamClient) CreateJoinedTeamClone(ctx context.Context, id stable.MeJoinedTeamId, input CreateJoinedTeamCloneRequest) (result CreateJoinedTeamCloneOperationResponse, err error) {
