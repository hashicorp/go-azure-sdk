...
func (c JoinedTeamClient) CreateJoinedTeamUnarchive(ctx context.Context, id stable.MeJoinedTeamId) (result CreateJoinedTeamUnarchiveOperationResponse, err error) {
