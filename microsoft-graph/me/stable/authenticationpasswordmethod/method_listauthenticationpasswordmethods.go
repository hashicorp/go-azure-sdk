...
func (c AuthenticationPasswordMethodClient) ListAuthenticationPasswordMethods(ctx context.Context) (result ListAuthenticationPasswordMethodsOperationResponse, err error) {
...
func (c AuthenticationPasswordMethodClient) ListAuthenticationPasswordMethodsComplete(ctx context.Context) (ListAuthenticationPasswordMethodsCompleteResult, error) {
	return c.ListAuthenticationPasswordMethodsCompleteMatchingPredicate(ctx, PasswordAuthenticationMethodOperationPredicate{})
}

// ListAuthenticationPasswordMethodsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AuthenticationPasswordMethodClient) ListAuthenticationPasswordMethodsCompleteMatchingPredicate(ctx context.Context, predicate PasswordAuthenticationMethodOperationPredicate) (result ListAuthenticationPasswordMethodsCompleteResult, err error) {
	items := make([]stable.PasswordAuthenticationMethod, 0)

	resp, err := c.ListAuthenticationPasswordMethods(ctx)
	if err != nil {
