...
func (c AuthenticationPlatformCredentialMethodClient) GetAuthenticationPlatformCredentialMethod(ctx context.Context, id stable.MeAuthenticationPlatformCredentialMethodId, options GetAuthenticationPlatformCredentialMethodOperationOptions) (result GetAuthenticationPlatformCredentialMethodOperationResponse, err error) {
