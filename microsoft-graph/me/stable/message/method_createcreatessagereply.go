...
type CreateCreatessageReplyOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        stable.Message
}

// CreateCreatessageReply - Invoke action createReply. Create a draft to reply to the sender of a message in either JSON
...
func (c MessageClient) CreateCreatessageReply(ctx context.Context, id stable.MeMessageId, input CreateCreatessageReplyRequest) (result CreateCreatessageReplyOperationResponse, err error) {
