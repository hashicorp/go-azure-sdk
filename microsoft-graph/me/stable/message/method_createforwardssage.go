...
type CreateForwardssageOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

// CreateForwardssage - Invoke action forward. Forward a message using either JSON or MIME format. When using JSON
...
func (c MessageClient) CreateForwardssage(ctx context.Context, id stable.MeMessageId, input CreateForwardssageRequest) (result CreateForwardssageOperationResponse, err error) {
