...
func (c MessageClient) CreateMessagePermanentDelete(ctx context.Context, id stable.MeMessageId, options CreateMessagePermanentDeleteOperationOptions) (result CreateMessagePermanentDeleteOperationResponse, err error) {
