...
type CreateCreatessageForwardOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        stable.Message
}

// CreateCreatessageForward - Invoke action createForward. Create a draft to forward an existing message, in either JSON
// or MIME format. When using JSON format, you can: - Specify either a comment or the body property of the message
...
func (c MessageClient) CreateCreatessageForward(ctx context.Context, id stable.MeMessageId, input CreateCreatessageForwardRequest) (result CreateCreatessageForwardOperationResponse, err error) {
