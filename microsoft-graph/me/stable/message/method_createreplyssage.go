...
type CreateReplyssageOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

// CreateReplyssage - Invoke action reply. Reply to the sender of a message using either JSON or MIME format. When using
...
func (c MessageClient) CreateReplyssage(ctx context.Context, id stable.MeMessageId, input CreateReplyssageRequest) (result CreateReplyssageOperationResponse, err error) {
