...
// GetCalendarGroupCalendarViewInstanceExtension - Get extensions from me. The collection of open extensions defined for
// the event. Nullable.
func (c CalendarGroupCalendarCalendarViewInstanceExtensionClient) GetCalendarGroupCalendarViewInstanceExtension(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExtensionId, options GetCalendarGroupCalendarViewInstanceExtensionOperationOptions) (result GetCalendarGroupCalendarViewInstanceExtensionOperationResponse, err error) {
