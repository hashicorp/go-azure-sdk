...
// Nullable.
func (c CalendarViewInstanceExtensionClient) ListCalendarViewInstanceExtensions(ctx context.Context, id stable.MeCalendarViewIdInstanceId, options ListCalendarViewInstanceExtensionsOperationOptions) (result ListCalendarViewInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarViewInstanceExtensionClient) ListCalendarViewInstanceExtensionsComplete(ctx context.Context, id stable.MeCalendarViewIdInstanceId, options ListCalendarViewInstanceExtensionsOperationOptions) (ListCalendarViewInstanceExtensionsCompleteResult, error) {
...
func (c CalendarViewInstanceExtensionClient) ListCalendarViewInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.MeCalendarViewIdInstanceId, options ListCalendarViewInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarViewInstanceExtensionsCompleteResult, err error) {
