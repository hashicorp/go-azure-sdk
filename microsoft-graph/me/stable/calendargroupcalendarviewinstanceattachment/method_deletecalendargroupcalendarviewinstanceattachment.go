...
// DeleteCalendarGroupCalendarViewInstanceAttachment - Delete navigation property attachments for me
func (c CalendarGroupCalendarViewInstanceAttachmentClient) DeleteCalendarGroupCalendarViewInstanceAttachment(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewIdInstanceIdAttachmentId, options DeleteCalendarGroupCalendarViewInstanceAttachmentOperationOptions) (result DeleteCalendarGroupCalendarViewInstanceAttachmentOperationResponse, err error) {
