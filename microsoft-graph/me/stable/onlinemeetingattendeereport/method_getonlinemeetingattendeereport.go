...
func (c OnlineMeetingAttendeeReportClient) GetOnlineMeetingAttendeeReport(ctx context.Context, id stable.MeOnlineMeetingId) (result GetOnlineMeetingAttendeeReportOperationResponse, err error) {
