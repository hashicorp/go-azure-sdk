...
func (c JoinedTeamChannelSharedWithTeamAllowedMemberClient) ListJoinedTeamChannelSharedWithTeamAllowedMembers(ctx context.Context, id MeJoinedTeamIdChannelIdSharedWithTeamId) (result ListJoinedTeamChannelSharedWithTeamAllowedMembersOperationResponse, err error) {
...
func (c JoinedTeamChannelSharedWithTeamAllowedMemberClient) ListJoinedTeamChannelSharedWithTeamAllowedMembersComplete(ctx context.Context, id MeJoinedTeamIdChannelIdSharedWithTeamId) (ListJoinedTeamChannelSharedWithTeamAllowedMembersCompleteResult, error) {
