...
// represents a file.
func (c DriveBundleContentClient) SetDriveBundleContent(ctx context.Context, id stable.MeDriveIdBundleId, input []byte) (result SetDriveBundleContentOperationResponse, err error) {
