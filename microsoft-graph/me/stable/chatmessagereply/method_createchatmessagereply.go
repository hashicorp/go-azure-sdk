...
func (c ChatMessageReplyClient) CreateChatMessageReply(ctx context.Context, id stable.MeChatIdMessageId, input stable.ChatMessage) (result CreateChatMessageReplyOperationResponse, err error) {
