...
func (c JoinedTeamChannelMessageClient) CreateJoinedTeamChannelMessage(ctx context.Context, id stable.MeJoinedTeamIdChannelId, input stable.ChatMessage) (result CreateJoinedTeamChannelMessageOperationResponse, err error) {
