...
func (c ContactFolderChildFolderClient) ListContactFolderChildFolders(ctx context.Context, id MeContactFolderId) (result ListContactFolderChildFoldersOperationResponse, err error) {
...
func (c ContactFolderChildFolderClient) ListContactFolderChildFoldersComplete(ctx context.Context, id MeContactFolderId) (ListContactFolderChildFoldersCompleteResult, error) {
...
func (c ContactFolderChildFolderClient) ListContactFolderChildFoldersCompleteMatchingPredicate(ctx context.Context, id MeContactFolderId, predicate ContactFolderOperationPredicate) (result ListContactFolderChildFoldersCompleteResult, err error) {
