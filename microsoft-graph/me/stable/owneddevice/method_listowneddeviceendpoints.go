...
// collection
func (c OwnedDeviceClient) ListOwnedDeviceEndpoints(ctx context.Context, options ListOwnedDeviceEndpointsOperationOptions) (result ListOwnedDeviceEndpointsOperationResponse, err error) {
...
func (c OwnedDeviceClient) ListOwnedDeviceEndpointsComplete(ctx context.Context, options ListOwnedDeviceEndpointsOperationOptions) (ListOwnedDeviceEndpointsCompleteResult, error) {
	return c.ListOwnedDeviceEndpointsCompleteMatchingPredicate(ctx, options, EndpointOperationPredicate{})
}

// ListOwnedDeviceEndpointsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c OwnedDeviceClient) ListOwnedDeviceEndpointsCompleteMatchingPredicate(ctx context.Context, options ListOwnedDeviceEndpointsOperationOptions, predicate EndpointOperationPredicate) (result ListOwnedDeviceEndpointsCompleteResult, err error) {
	items := make([]stable.Endpoint, 0)

	resp, err := c.ListOwnedDeviceEndpoints(ctx, options)
	if err != nil {
