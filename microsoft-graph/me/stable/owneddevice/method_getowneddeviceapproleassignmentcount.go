...
func (c OwnedDeviceClient) GetOwnedDeviceAppRoleAssignmentCount(ctx context.Context, options GetOwnedDeviceAppRoleAssignmentCountOperationOptions) (result GetOwnedDeviceAppRoleAssignmentCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/ownedDevices/appRoleAssignment/$count",
