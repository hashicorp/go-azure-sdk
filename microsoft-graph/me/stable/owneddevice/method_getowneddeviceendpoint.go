...
func (c OwnedDeviceClient) GetOwnedDeviceEndpoint(ctx context.Context, id stable.MeOwnedDeviceId, options GetOwnedDeviceEndpointOperationOptions) (result GetOwnedDeviceEndpointOperationResponse, err error) {
