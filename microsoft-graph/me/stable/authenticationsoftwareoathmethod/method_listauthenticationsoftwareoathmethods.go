...
func (c AuthenticationSoftwareOathMethodClient) ListAuthenticationSoftwareOathMethods(ctx context.Context) (result ListAuthenticationSoftwareOathMethodsOperationResponse, err error) {
...
func (c AuthenticationSoftwareOathMethodClient) ListAuthenticationSoftwareOathMethodsComplete(ctx context.Context) (ListAuthenticationSoftwareOathMethodsCompleteResult, error) {
	return c.ListAuthenticationSoftwareOathMethodsCompleteMatchingPredicate(ctx, SoftwareOathAuthenticationMethodOperationPredicate{})
}

// ListAuthenticationSoftwareOathMethodsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AuthenticationSoftwareOathMethodClient) ListAuthenticationSoftwareOathMethodsCompleteMatchingPredicate(ctx context.Context, predicate SoftwareOathAuthenticationMethodOperationPredicate) (result ListAuthenticationSoftwareOathMethodsCompleteResult, err error) {
	items := make([]stable.SoftwareOathAuthenticationMethod, 0)

	resp, err := c.ListAuthenticationSoftwareOathMethods(ctx)
	if err != nil {
