...
func (c PlannerTaskBucketTaskBoardFormatClient) UpdatePlannerTaskBucketTaskBoardFormat(ctx context.Context, id MePlannerTaskId, input stable.PlannerBucketTaskBoardTaskFormat) (result UpdatePlannerTaskBucketTaskBoardFormatOperationResponse, err error) {
