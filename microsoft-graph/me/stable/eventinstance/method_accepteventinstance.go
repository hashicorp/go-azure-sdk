...
func (c EventInstanceClient) AcceptEventInstance(ctx context.Context, id stable.MeEventIdInstanceId, input AcceptEventInstanceRequest) (result AcceptEventInstanceOperationResponse, err error) {
