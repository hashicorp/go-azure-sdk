...
// in a user calendar.
func (c EventInstanceClient) DismissEventInstanceReminder(ctx context.Context, id stable.MeEventIdInstanceId) (result DismissEventInstanceReminderOperationResponse, err error) {
