...
// Outlook.com account.
func (c EventInstanceClient) ForwardEventInstance(ctx context.Context, id stable.MeEventIdInstanceId, input ForwardEventInstanceRequest) (result ForwardEventInstanceOperationResponse, err error) {
