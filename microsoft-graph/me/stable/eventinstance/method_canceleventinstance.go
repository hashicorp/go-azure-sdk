...
func (c EventInstanceClient) CancelEventInstance(ctx context.Context, id stable.MeEventIdInstanceId, input CancelEventInstanceRequest) (result CancelEventInstanceOperationResponse, err error) {
