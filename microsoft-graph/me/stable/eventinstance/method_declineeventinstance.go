...
func (c EventInstanceClient) DeclineEventInstance(ctx context.Context, id stable.MeEventIdInstanceId, input DeclineEventInstanceRequest) (result DeclineEventInstanceOperationResponse, err error) {
