...
func (c JoinedTeamAllChannelClient) ListJoinedTeamAllChannels(ctx context.Context, id MeJoinedTeamId) (result ListJoinedTeamAllChannelsOperationResponse, err error) {
...
func (c JoinedTeamAllChannelClient) ListJoinedTeamAllChannelsComplete(ctx context.Context, id MeJoinedTeamId) (ListJoinedTeamAllChannelsCompleteResult, error) {
...
func (c JoinedTeamAllChannelClient) ListJoinedTeamAllChannelsCompleteMatchingPredicate(ctx context.Context, id MeJoinedTeamId, predicate ChannelOperationPredicate) (result ListJoinedTeamAllChannelsCompleteResult, err error) {
