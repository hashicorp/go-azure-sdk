...
func (c ChatMemberClient) CreateChatMember(ctx context.Context, id stable.MeChatId, input stable.ConversationMember) (result CreateChatMemberOperationResponse, err error) {
