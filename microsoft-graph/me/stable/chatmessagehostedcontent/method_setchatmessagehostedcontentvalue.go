...
func (c ChatMessageHostedContentClient) SetChatMessageHostedContentValue(ctx context.Context, id stable.MeChatIdMessageIdHostedContentId, input []byte) (result SetChatMessageHostedContentValueOperationResponse, err error) {
