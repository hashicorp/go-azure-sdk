...
func (c ChatMessageHostedContentClient) GetChatMessageHostedContentValue(ctx context.Context, id stable.MeChatIdMessageIdHostedContentId) (result GetChatMessageHostedContentValueOperationResponse, err error) {
