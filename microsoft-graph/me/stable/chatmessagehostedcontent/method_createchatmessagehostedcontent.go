...
func (c ChatMessageHostedContentClient) CreateChatMessageHostedContent(ctx context.Context, id stable.MeChatIdMessageId, input stable.ChatMessageHostedContent) (result CreateChatMessageHostedContentOperationResponse, err error) {
