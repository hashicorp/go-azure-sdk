...
// collection
func (c TransitiveMemberOfClient) ListTransitiveMemberOfGroups(ctx context.Context, options ListTransitiveMemberOfGroupsOperationOptions) (result ListTransitiveMemberOfGroupsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/transitiveMemberOf/group",
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfGroupsComplete(ctx context.Context, options ListTransitiveMemberOfGroupsOperationOptions) (ListTransitiveMemberOfGroupsCompleteResult, error) {
	return c.ListTransitiveMemberOfGroupsCompleteMatchingPredicate(ctx, options, GroupOperationPredicate{})
}

// ListTransitiveMemberOfGroupsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c TransitiveMemberOfClient) ListTransitiveMemberOfGroupsCompleteMatchingPredicate(ctx context.Context, options ListTransitiveMemberOfGroupsOperationOptions, predicate GroupOperationPredicate) (result ListTransitiveMemberOfGroupsCompleteResult, err error) {
	items := make([]stable.Group, 0)

	resp, err := c.ListTransitiveMemberOfGroups(ctx, options)
	if err != nil {
