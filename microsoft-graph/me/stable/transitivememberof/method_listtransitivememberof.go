...
func (c TransitiveMemberOfClient) ListTransitiveMemberOf(ctx context.Context) (result ListTransitiveMemberOfOperationResponse, err error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfComplete(ctx context.Context) (ListTransitiveMemberOfCompleteResult, error) {
	return c.ListTransitiveMemberOfCompleteMatchingPredicate(ctx, DirectoryObjectOperationPredicate{})
}

// ListTransitiveMemberOfCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c TransitiveMemberOfClient) ListTransitiveMemberOfCompleteMatchingPredicate(ctx context.Context, predicate DirectoryObjectOperationPredicate) (result ListTransitiveMemberOfCompleteResult, err error) {
	items := make([]stable.DirectoryObject, 0)

	resp, err := c.ListTransitiveMemberOf(ctx)
	if err != nil {
