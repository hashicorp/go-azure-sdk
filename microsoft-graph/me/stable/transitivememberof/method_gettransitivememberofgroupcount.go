...
func (c TransitiveMemberOfClient) GetTransitiveMemberOfGroupCount(ctx context.Context, options GetTransitiveMemberOfGroupCountOperationOptions) (result GetTransitiveMemberOfGroupCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/transitiveMemberOf/group/$count",
