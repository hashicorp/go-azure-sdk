...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfAdministrativeUnits(ctx context.Context, options ListTransitiveMemberOfAdministrativeUnitsOperationOptions) (result ListTransitiveMemberOfAdministrativeUnitsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/transitiveMemberOf/administrativeUnit",
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfAdministrativeUnitsComplete(ctx context.Context, options ListTransitiveMemberOfAdministrativeUnitsOperationOptions) (ListTransitiveMemberOfAdministrativeUnitsCompleteResult, error) {
	return c.ListTransitiveMemberOfAdministrativeUnitsCompleteMatchingPredicate(ctx, options, AdministrativeUnitOperationPredicate{})
}
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfAdministrativeUnitsCompleteMatchingPredicate(ctx context.Context, options ListTransitiveMemberOfAdministrativeUnitsOperationOptions, predicate AdministrativeUnitOperationPredicate) (result ListTransitiveMemberOfAdministrativeUnitsCompleteResult, err error) {
	items := make([]stable.AdministrativeUnit, 0)

	resp, err := c.ListTransitiveMemberOfAdministrativeUnits(ctx, options)
	if err != nil {
