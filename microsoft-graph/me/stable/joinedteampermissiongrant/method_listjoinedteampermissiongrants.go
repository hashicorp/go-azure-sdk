...
func (c JoinedTeamPermissionGrantClient) ListJoinedTeamPermissionGrants(ctx context.Context, id MeJoinedTeamId) (result ListJoinedTeamPermissionGrantsOperationResponse, err error) {
...
func (c JoinedTeamPermissionGrantClient) ListJoinedTeamPermissionGrantsComplete(ctx context.Context, id MeJoinedTeamId) (ListJoinedTeamPermissionGrantsCompleteResult, error) {
...
func (c JoinedTeamPermissionGrantClient) ListJoinedTeamPermissionGrantsCompleteMatchingPredicate(ctx context.Context, id MeJoinedTeamId, predicate ResourceSpecificPermissionGrantOperationPredicate) (result ListJoinedTeamPermissionGrantsCompleteResult, err error) {
