...
// ListCalendarGroupCalendarEventInstanceExtensions - Get extensions from me. The collection of open extensions defined
// for the event. Nullable.
func (c CalendarGroupCalendarEventInstanceExtensionClient) ListCalendarGroupCalendarEventInstanceExtensions(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdEventIdInstanceId, options ListCalendarGroupCalendarEventInstanceExtensionsOperationOptions) (result ListCalendarGroupCalendarEventInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventInstanceExtensionClient) ListCalendarGroupCalendarEventInstanceExtensionsComplete(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdEventIdInstanceId, options ListCalendarGroupCalendarEventInstanceExtensionsOperationOptions) (ListCalendarGroupCalendarEventInstanceExtensionsCompleteResult, error) {
...
func (c CalendarGroupCalendarEventInstanceExtensionClient) ListCalendarGroupCalendarEventInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdEventIdInstanceId, options ListCalendarGroupCalendarEventInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarGroupCalendarEventInstanceExtensionsCompleteResult, err error) {
