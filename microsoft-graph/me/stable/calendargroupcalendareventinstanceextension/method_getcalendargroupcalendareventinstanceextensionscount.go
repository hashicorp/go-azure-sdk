...
func (c CalendarGroupCalendarEventInstanceExtensionClient) GetCalendarGroupCalendarEventInstanceExtensionsCount(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdEventIdInstanceId, options GetCalendarGroupCalendarEventInstanceExtensionsCountOperationOptions) (result GetCalendarGroupCalendarEventInstanceExtensionsCountOperationResponse, err error) {
