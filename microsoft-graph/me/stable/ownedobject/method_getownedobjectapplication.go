...
func (c OwnedObjectClient) GetOwnedObjectApplication(ctx context.Context, id stable.MeOwnedObjectId, options GetOwnedObjectApplicationOperationOptions) (result GetOwnedObjectApplicationOperationResponse, err error) {
