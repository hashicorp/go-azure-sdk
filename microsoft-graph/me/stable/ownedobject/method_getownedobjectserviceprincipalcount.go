...
func (c OwnedObjectClient) GetOwnedObjectServicePrincipalCount(ctx context.Context, options GetOwnedObjectServicePrincipalCountOperationOptions) (result GetOwnedObjectServicePrincipalCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/ownedObjects/servicePrincipal/$count",
