...
// DeleteCalendarGroupCalendarEventInstanceAttachment - Delete navigation property attachments for me
func (c CalendarGroupCalendarEventInstanceAttachmentClient) DeleteCalendarGroupCalendarEventInstanceAttachment(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentId, options DeleteCalendarGroupCalendarEventInstanceAttachmentOperationOptions) (result DeleteCalendarGroupCalendarEventInstanceAttachmentOperationResponse, err error) {
