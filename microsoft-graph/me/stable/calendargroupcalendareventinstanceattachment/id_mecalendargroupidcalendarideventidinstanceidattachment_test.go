...
func TestNewMeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentID(t *testing.T) {
	id := NewMeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue")
...
func TestFormatMeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentID(t *testing.T) {
	actual := NewMeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue").ID()
...
func TestParseMeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentId(t *testing.T) {
	segments := MeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentId has no segments")
	}
