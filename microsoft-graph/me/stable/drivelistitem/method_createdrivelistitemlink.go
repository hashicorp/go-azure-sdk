...
func (c DriveListItemClient) CreateDriveListItemLink(ctx context.Context, id stable.MeDriveIdListItemId, input CreateDriveListItemLinkRequest) (result CreateDriveListItemLinkOperationResponse, err error) {
