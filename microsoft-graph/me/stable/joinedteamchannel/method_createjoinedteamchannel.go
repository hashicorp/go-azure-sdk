...
func (c JoinedTeamChannelClient) CreateJoinedTeamChannel(ctx context.Context, id stable.MeJoinedTeamId, input stable.Channel) (result CreateJoinedTeamChannelOperationResponse, err error) {
