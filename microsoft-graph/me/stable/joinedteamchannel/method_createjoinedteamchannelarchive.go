...
func (c JoinedTeamChannelClient) CreateJoinedTeamChannelArchive(ctx context.Context, id stable.MeJoinedTeamIdChannelId, input CreateJoinedTeamChannelArchiveRequest) (result CreateJoinedTeamChannelArchiveOperationResponse, err error) {
