...
func (c JoinedTeamChannelClient) RemoveJoinedTeamChannelEmail(ctx context.Context, id stable.MeJoinedTeamIdChannelId) (result RemoveJoinedTeamChannelEmailOperationResponse, err error) {
