...
func (c JoinedTeamChannelClient) CreateJoinedTeamChannelUnarchive(ctx context.Context, id stable.MeJoinedTeamIdChannelId) (result CreateJoinedTeamChannelUnarchiveOperationResponse, err error) {
