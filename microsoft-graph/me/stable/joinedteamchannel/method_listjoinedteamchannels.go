...
func (c JoinedTeamChannelClient) ListJoinedTeamChannels(ctx context.Context, id MeJoinedTeamId) (result ListJoinedTeamChannelsOperationResponse, err error) {
...
func (c JoinedTeamChannelClient) ListJoinedTeamChannelsComplete(ctx context.Context, id MeJoinedTeamId) (ListJoinedTeamChannelsCompleteResult, error) {
...
func (c JoinedTeamChannelClient) ListJoinedTeamChannelsCompleteMatchingPredicate(ctx context.Context, id MeJoinedTeamId, predicate ChannelOperationPredicate) (result ListJoinedTeamChannelsCompleteResult, err error) {
