...
// GetCalendarViewInstance - Get instances from me. The occurrences of a recurring series, if the event is a series
...
// Nullable.
func (c CalendarCalendarViewInstanceClient) GetCalendarViewInstance(ctx context.Context, id stable.MeCalendarIdCalendarViewIdInstanceId, options GetCalendarViewInstanceOperationOptions) (result GetCalendarViewInstanceOperationResponse, err error) {
