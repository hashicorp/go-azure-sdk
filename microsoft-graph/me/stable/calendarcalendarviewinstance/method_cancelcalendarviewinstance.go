...
func (c CalendarCalendarViewInstanceClient) CancelCalendarViewInstance(ctx context.Context, id stable.MeCalendarCalendarViewIdInstanceId, input CancelCalendarViewInstanceRequest) (result CancelCalendarViewInstanceOperationResponse, err error) {
