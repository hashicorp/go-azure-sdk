...
func (c EventAttachmentClient) CreateEventAttachmentsUploadSession(ctx context.Context, id stable.MeEventId, input CreateEventAttachmentsUploadSessionRequest) (result CreateEventAttachmentsUploadSessionOperationResponse, err error) {
