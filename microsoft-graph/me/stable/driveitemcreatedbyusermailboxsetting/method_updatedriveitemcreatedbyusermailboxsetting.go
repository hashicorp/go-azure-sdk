...
func (c DriveItemCreatedByUserMailboxSettingClient) UpdateDriveItemCreatedByUserMailboxSetting(ctx context.Context, id stable.MeDriveIdItemId, input stable.MailboxSettings) (result UpdateDriveItemCreatedByUserMailboxSettingOperationResponse, err error) {
