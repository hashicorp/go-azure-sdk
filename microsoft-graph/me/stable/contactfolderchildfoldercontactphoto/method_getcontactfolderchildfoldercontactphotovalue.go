...
func (c ContactFolderChildFolderContactPhotoClient) GetContactFolderChildFolderContactPhotoValue(ctx context.Context, id stable.MeContactFolderIdChildFolderIdContactId) (result GetContactFolderChildFolderContactPhotoValueOperationResponse, err error) {
