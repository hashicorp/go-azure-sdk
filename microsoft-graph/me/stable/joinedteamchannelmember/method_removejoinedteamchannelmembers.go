...
func (c JoinedTeamChannelMemberClient) RemoveJoinedTeamChannelMembers(ctx context.Context, id stable.MeJoinedTeamIdChannelId, input RemoveJoinedTeamChannelMembersRequest, options RemoveJoinedTeamChannelMembersOperationOptions) (result RemoveJoinedTeamChannelMembersOperationResponse, err error) {
...
func (c JoinedTeamChannelMemberClient) RemoveJoinedTeamChannelMembersComplete(ctx context.Context, id stable.MeJoinedTeamIdChannelId, input RemoveJoinedTeamChannelMembersRequest, options RemoveJoinedTeamChannelMembersOperationOptions) (RemoveJoinedTeamChannelMembersCompleteResult, error) {
...
func (c JoinedTeamChannelMemberClient) RemoveJoinedTeamChannelMembersCompleteMatchingPredicate(ctx context.Context, id stable.MeJoinedTeamIdChannelId, input RemoveJoinedTeamChannelMembersRequest, options RemoveJoinedTeamChannelMembersOperationOptions, predicate ActionResultPartOperationPredicate) (result RemoveJoinedTeamChannelMembersCompleteResult, err error) {
