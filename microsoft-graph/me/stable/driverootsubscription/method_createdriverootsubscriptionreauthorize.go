...
func (c DriveRootSubscriptionClient) CreateDriveRootSubscriptionReauthorize(ctx context.Context, id stable.MeDriveIdRootSubscriptionId) (result CreateDriveRootSubscriptionReauthorizeOperationResponse, err error) {
