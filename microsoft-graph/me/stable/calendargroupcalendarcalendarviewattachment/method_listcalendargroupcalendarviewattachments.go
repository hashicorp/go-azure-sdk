...
func (c CalendarGroupCalendarCalendarViewAttachmentClient) ListCalendarGroupCalendarViewAttachments(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewAttachmentsOperationOptions) (result ListCalendarGroupCalendarViewAttachmentsOperationResponse, err error) {
...
func (c CalendarGroupCalendarCalendarViewAttachmentClient) ListCalendarGroupCalendarViewAttachmentsComplete(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewAttachmentsOperationOptions) (ListCalendarGroupCalendarViewAttachmentsCompleteResult, error) {
...
func (c CalendarGroupCalendarCalendarViewAttachmentClient) ListCalendarGroupCalendarViewAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarGroupCalendarViewAttachmentsCompleteResult, err error) {
