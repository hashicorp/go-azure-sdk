...
func (c EventClient) CreateEventPermanentDelete(ctx context.Context, id stable.MeEventId, options CreateEventPermanentDeleteOperationOptions) (result CreateEventPermanentDeleteOperationResponse, err error) {
