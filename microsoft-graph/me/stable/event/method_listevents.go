...
// ListEvents ...
func (c EventClient) ListEvents(ctx context.Context) (result ListEventsOperationResponse, err error) {
...
func (c EventClient) ListEventsComplete(ctx context.Context) (ListEventsCompleteResult, error) {
	return c.ListEventsCompleteMatchingPredicate(ctx, EventOperationPredicate{})
}

// ListEventsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c EventClient) ListEventsCompleteMatchingPredicate(ctx context.Context, predicate EventOperationPredicate) (result ListEventsCompleteResult, err error) {
	items := make([]stable.Event, 0)

	resp, err := c.ListEvents(ctx)
	if err != nil {
