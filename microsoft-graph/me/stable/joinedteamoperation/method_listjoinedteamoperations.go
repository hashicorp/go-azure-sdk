...
func (c JoinedTeamOperationClient) ListJoinedTeamOperations(ctx context.Context, id MeJoinedTeamId) (result ListJoinedTeamOperationsOperationResponse, err error) {
...
func (c JoinedTeamOperationClient) ListJoinedTeamOperationsComplete(ctx context.Context, id MeJoinedTeamId) (ListJoinedTeamOperationsCompleteResult, error) {
...
func (c JoinedTeamOperationClient) ListJoinedTeamOperationsCompleteMatchingPredicate(ctx context.Context, id MeJoinedTeamId, predicate TeamsAsyncOperationOperationPredicate) (result ListJoinedTeamOperationsCompleteResult, err error) {
