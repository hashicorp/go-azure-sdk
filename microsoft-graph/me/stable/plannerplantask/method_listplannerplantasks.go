...
func (c PlannerPlanTaskClient) ListPlannerPlanTasks(ctx context.Context, id MePlannerPlanId) (result ListPlannerPlanTasksOperationResponse, err error) {
...
func (c PlannerPlanTaskClient) ListPlannerPlanTasksComplete(ctx context.Context, id MePlannerPlanId) (ListPlannerPlanTasksCompleteResult, error) {
...
func (c PlannerPlanTaskClient) ListPlannerPlanTasksCompleteMatchingPredicate(ctx context.Context, id MePlannerPlanId, predicate PlannerTaskOperationPredicate) (result ListPlannerPlanTasksCompleteResult, err error) {
