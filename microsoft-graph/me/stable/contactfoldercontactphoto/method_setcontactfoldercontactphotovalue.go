...
func (c ContactFolderContactPhotoClient) SetContactFolderContactPhotoValue(ctx context.Context, id stable.MeContactFolderIdContactId, input []byte) (result SetContactFolderContactPhotoValueOperationResponse, err error) {
