...
func (c ContactFolderContactPhotoClient) GetContactFolderContactPhotoValue(ctx context.Context, id stable.MeContactFolderIdContactId) (result GetContactFolderContactPhotoValueOperationResponse, err error) {
