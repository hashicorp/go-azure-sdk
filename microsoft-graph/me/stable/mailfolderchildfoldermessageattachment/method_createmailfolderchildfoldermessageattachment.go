...
func (c MailFolderChildFolderMessageAttachmentClient) CreateMailFolderChildFolderMessageAttachment(ctx context.Context, id stable.MeMailFolderIdChildFolderIdMessageId, input stable.Attachment) (result CreateMailFolderChildFolderMessageAttachmentOperationResponse, err error) {
