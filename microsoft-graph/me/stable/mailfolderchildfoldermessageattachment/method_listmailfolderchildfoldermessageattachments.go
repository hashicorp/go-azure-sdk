...
func (c MailFolderChildFolderMessageAttachmentClient) ListMailFolderChildFolderMessageAttachments(ctx context.Context, id MeMailFolderIdChildFolderIdMessageId) (result ListMailFolderChildFolderMessageAttachmentsOperationResponse, err error) {
...
func (c MailFolderChildFolderMessageAttachmentClient) ListMailFolderChildFolderMessageAttachmentsComplete(ctx context.Context, id MeMailFolderIdChildFolderIdMessageId) (ListMailFolderChildFolderMessageAttachmentsCompleteResult, error) {
...
func (c MailFolderChildFolderMessageAttachmentClient) ListMailFolderChildFolderMessageAttachmentsCompleteMatchingPredicate(ctx context.Context, id MeMailFolderIdChildFolderIdMessageId, predicate AttachmentOperationPredicate) (result ListMailFolderChildFolderMessageAttachmentsCompleteResult, err error) {
