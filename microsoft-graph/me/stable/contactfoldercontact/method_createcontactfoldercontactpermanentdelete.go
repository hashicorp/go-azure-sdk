...
func (c ContactFolderContactClient) CreateContactFolderContactPermanentDelete(ctx context.Context, id stable.MeContactFolderIdContactId, options CreateContactFolderContactPermanentDeleteOperationOptions) (result CreateContactFolderContactPermanentDeleteOperationResponse, err error) {
