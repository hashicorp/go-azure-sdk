...
func (c ContactFolderContactClient) CreateContactFolderContact(ctx context.Context, id stable.MeContactFolderId, input stable.Contact) (result CreateContactFolderContactOperationResponse, err error) {
