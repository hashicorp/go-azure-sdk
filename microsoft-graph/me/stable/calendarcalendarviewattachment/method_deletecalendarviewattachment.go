...
// DeleteCalendarViewAttachment - Delete navigation property attachments for me
func (c CalendarCalendarViewAttachmentClient) DeleteCalendarViewAttachment(ctx context.Context, id stable.MeCalendarIdCalendarViewIdAttachmentId, options DeleteCalendarViewAttachmentOperationOptions) (result DeleteCalendarViewAttachmentOperationResponse, err error) {
