...
// GetCalendarViewAttachment - Get attachments from me. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarCalendarViewAttachmentClient) GetCalendarViewAttachment(ctx context.Context, id stable.MeCalendarIdCalendarViewIdAttachmentId, options GetCalendarViewAttachmentOperationOptions) (result GetCalendarViewAttachmentOperationResponse, err error) {
