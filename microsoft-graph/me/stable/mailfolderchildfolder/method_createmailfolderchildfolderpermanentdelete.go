...
func (c MailFolderChildFolderClient) CreateMailFolderChildFolderPermanentDelete(ctx context.Context, id stable.MeMailFolderIdChildFolderId, options CreateMailFolderChildFolderPermanentDeleteOperationOptions) (result CreateMailFolderChildFolderPermanentDeleteOperationResponse, err error) {
