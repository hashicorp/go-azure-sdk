...
func (c JoinedTeamChannelMessageReplyClient) CreateJoinedTeamChannelMessageReplySoftDelete(ctx context.Context, id stable.MeJoinedTeamIdChannelIdMessageIdReplyId) (result CreateJoinedTeamChannelMessageReplySoftDeleteOperationResponse, err error) {
