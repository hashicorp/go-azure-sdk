...
func (c MailboxSettingClient) UpdateMailboxSetting(ctx context.Context, input stable.MailboxSettings) (result UpdateMailboxSettingOperationResponse, err error) {
