...
func (c ChatMessageReplyHostedContentClient) SetChatMessageReplyHostedContentValue(ctx context.Context, id stable.MeChatIdMessageIdReplyIdHostedContentId, input []byte) (result SetChatMessageReplyHostedContentValueOperationResponse, err error) {
