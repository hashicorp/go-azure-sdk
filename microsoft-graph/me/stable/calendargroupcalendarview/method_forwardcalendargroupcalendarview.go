...
func (c CalendarGroupCalendarViewClient) ForwardCalendarGroupCalendarView(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, input ForwardCalendarGroupCalendarViewRequest) (result ForwardCalendarGroupCalendarViewOperationResponse, err error) {
