...
func (c CalendarGroupCalendarViewClient) GetCalendarGroupCalendarViewCount(ctx context.Context, id stable.MeCalendarGroupIdCalendarId, options GetCalendarGroupCalendarViewCountOperationOptions) (result GetCalendarGroupCalendarViewCountOperationResponse, err error) {
