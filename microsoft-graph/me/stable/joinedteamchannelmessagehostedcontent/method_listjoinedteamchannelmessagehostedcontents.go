...
func (c JoinedTeamChannelMessageHostedContentClient) ListJoinedTeamChannelMessageHostedContents(ctx context.Context, id MeJoinedTeamIdChannelIdMessageId) (result ListJoinedTeamChannelMessageHostedContentsOperationResponse, err error) {
...
func (c JoinedTeamChannelMessageHostedContentClient) ListJoinedTeamChannelMessageHostedContentsComplete(ctx context.Context, id MeJoinedTeamIdChannelIdMessageId) (ListJoinedTeamChannelMessageHostedContentsCompleteResult, error) {
