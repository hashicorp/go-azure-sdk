...
func (c CalendarGroupCalendarCalendarViewInstanceClient) GetCalendarGroupCalendarViewInstancesCount(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, options GetCalendarGroupCalendarViewInstancesCountOperationOptions) (result GetCalendarGroupCalendarViewInstancesCountOperationResponse, err error) {
