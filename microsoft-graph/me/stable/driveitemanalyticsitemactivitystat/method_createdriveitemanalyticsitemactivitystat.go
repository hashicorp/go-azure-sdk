...
func (c DriveItemAnalyticsItemActivityStatClient) CreateDriveItemAnalyticsItemActivityStat(ctx context.Context, id stable.MeDriveIdItemId, input stable.ItemActivityStat) (result CreateDriveItemAnalyticsItemActivityStatOperationResponse, err error) {
