...
func (c CalendarViewInstanceClient) CancelCalendarViewInstance(ctx context.Context, id stable.MeCalendarViewIdInstanceId, input CancelCalendarViewInstanceRequest) (result CancelCalendarViewInstanceOperationResponse, err error) {
