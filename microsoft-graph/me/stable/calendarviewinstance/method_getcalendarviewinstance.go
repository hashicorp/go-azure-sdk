...
// Nullable.
func (c CalendarViewInstanceClient) GetCalendarViewInstance(ctx context.Context, id stable.MeCalendarViewIdInstanceId, options GetCalendarViewInstanceOperationOptions) (result GetCalendarViewInstanceOperationResponse, err error) {
