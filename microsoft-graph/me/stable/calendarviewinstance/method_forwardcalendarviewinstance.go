...
// Outlook.com account.
func (c CalendarViewInstanceClient) ForwardCalendarViewInstance(ctx context.Context, id stable.MeCalendarViewIdInstanceId, input ForwardCalendarViewInstanceRequest) (result ForwardCalendarViewInstanceOperationResponse, err error) {
