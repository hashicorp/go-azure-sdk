...
func (c CalendarEventInstanceAttachmentClient) CreateCalendarEventInstanceAttachmentsUploadSession(ctx context.Context, id stable.MeCalendarIdEventIdInstanceId, input CreateCalendarEventInstanceAttachmentsUploadSessionRequest) (result CreateCalendarEventInstanceAttachmentsUploadSessionOperationResponse, err error) {
