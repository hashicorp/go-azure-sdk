...
func (c CalendarEventInstanceAttachmentClient) DeleteCalendarEventInstanceAttachment(ctx context.Context, id stable.MeCalendarIdEventIdInstanceIdAttachmentId, options DeleteCalendarEventInstanceAttachmentOperationOptions) (result DeleteCalendarEventInstanceAttachmentOperationResponse, err error) {
