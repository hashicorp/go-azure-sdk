...
func (c CalendarEventInstanceAttachmentClient) GetCalendarEventInstanceAttachmentsCount(ctx context.Context, id stable.MeCalendarEventIdInstanceId, options GetCalendarEventInstanceAttachmentsCountOperationOptions) (result GetCalendarEventInstanceAttachmentsCountOperationResponse, err error) {
