...
// ListCalendarEventInstanceAttachments - Get attachments from me. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachments(ctx context.Context, id stable.MeCalendarIdEventIdInstanceId, options ListCalendarEventInstanceAttachmentsOperationOptions) (result ListCalendarEventInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachmentsComplete(ctx context.Context, id stable.MeCalendarIdEventIdInstanceId, options ListCalendarEventInstanceAttachmentsOperationOptions) (ListCalendarEventInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.MeCalendarIdEventIdInstanceId, options ListCalendarEventInstanceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarEventInstanceAttachmentsCompleteResult, err error) {
