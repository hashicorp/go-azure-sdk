...
// GetCalendarEventInstanceAttachment - Get attachments from me. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarEventInstanceAttachmentClient) GetCalendarEventInstanceAttachment(ctx context.Context, id stable.MeCalendarIdEventIdInstanceIdAttachmentId, options GetCalendarEventInstanceAttachmentOperationOptions) (result GetCalendarEventInstanceAttachmentOperationResponse, err error) {
