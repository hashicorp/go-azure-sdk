...
// ListCalendarViewAttachments - Get attachments from me. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarViewAttachmentClient) ListCalendarViewAttachments(ctx context.Context, id stable.MeCalendarViewId, options ListCalendarViewAttachmentsOperationOptions) (result ListCalendarViewAttachmentsOperationResponse, err error) {
...
func (c CalendarViewAttachmentClient) ListCalendarViewAttachmentsComplete(ctx context.Context, id stable.MeCalendarViewId, options ListCalendarViewAttachmentsOperationOptions) (ListCalendarViewAttachmentsCompleteResult, error) {
...
func (c CalendarViewAttachmentClient) ListCalendarViewAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.MeCalendarViewId, options ListCalendarViewAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarViewAttachmentsCompleteResult, err error) {
