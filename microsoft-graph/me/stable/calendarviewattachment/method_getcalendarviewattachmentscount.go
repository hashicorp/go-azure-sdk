...
func (c CalendarViewAttachmentClient) GetCalendarViewAttachmentsCount(ctx context.Context, id stable.MeCalendarViewId, options GetCalendarViewAttachmentsCountOperationOptions) (result GetCalendarViewAttachmentsCountOperationResponse, err error) {
