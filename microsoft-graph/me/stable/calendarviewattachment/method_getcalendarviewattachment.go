...
func (c CalendarViewAttachmentClient) GetCalendarViewAttachment(ctx context.Context, id stable.MeCalendarViewIdAttachmentId, options GetCalendarViewAttachmentOperationOptions) (result GetCalendarViewAttachmentOperationResponse, err error) {
