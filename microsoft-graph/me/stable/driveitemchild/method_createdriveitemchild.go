...
func (c DriveItemChildClient) CreateDriveItemChild(ctx context.Context, id stable.MeDriveIdItemId, input stable.DriveItem) (result CreateDriveItemChildOperationResponse, err error) {
