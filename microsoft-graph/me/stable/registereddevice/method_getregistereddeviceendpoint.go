...
func (c RegisteredDeviceClient) GetRegisteredDeviceEndpoint(ctx context.Context, id stable.MeRegisteredDeviceId, options GetRegisteredDeviceEndpointOperationOptions) (result GetRegisteredDeviceEndpointOperationResponse, err error) {
