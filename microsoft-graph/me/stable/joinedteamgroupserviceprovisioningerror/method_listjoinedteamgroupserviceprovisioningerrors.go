...
func (c JoinedTeamGroupServiceProvisioningErrorClient) ListJoinedTeamGroupServiceProvisioningErrors(ctx context.Context, id MeJoinedTeamId) (result ListJoinedTeamGroupServiceProvisioningErrorsOperationResponse, err error) {
...
func (c JoinedTeamGroupServiceProvisioningErrorClient) ListJoinedTeamGroupServiceProvisioningErrorsComplete(ctx context.Context, id MeJoinedTeamId) (ListJoinedTeamGroupServiceProvisioningErrorsCompleteResult, error) {
...
func (c JoinedTeamGroupServiceProvisioningErrorClient) ListJoinedTeamGroupServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id MeJoinedTeamId, predicate ServiceProvisioningErrorOperationPredicate) (result ListJoinedTeamGroupServiceProvisioningErrorsCompleteResult, err error) {
