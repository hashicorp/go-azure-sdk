...
func (c DriveRootRetentionLabelClient) UpdateDriveRootRetentionLabel(ctx context.Context, id stable.MeDriveId, input stable.ItemRetentionLabel) (result UpdateDriveRootRetentionLabelOperationResponse, err error) {
