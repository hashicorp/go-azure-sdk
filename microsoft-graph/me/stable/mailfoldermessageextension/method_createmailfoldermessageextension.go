...
func (c MailFolderMessageExtensionClient) CreateMailFolderMessageExtension(ctx context.Context, id stable.MeMailFolderIdMessageId, input stable.Extension) (result CreateMailFolderMessageExtensionOperationResponse, err error) {
