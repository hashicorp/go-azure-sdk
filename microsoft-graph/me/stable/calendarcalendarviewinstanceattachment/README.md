...
```go
ctx := context.TODO()
id := calendarcalendarviewinstanceattachment.NewMeCalendarIdCalendarViewIdInstanceIdAttachmentID("calendarIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue")
