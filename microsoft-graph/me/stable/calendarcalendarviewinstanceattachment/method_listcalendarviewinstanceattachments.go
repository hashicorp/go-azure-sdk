...
// ListCalendarViewInstanceAttachments - Get attachments from me. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarViewInstanceAttachments(ctx context.Context, id stable.MeCalendarIdCalendarViewIdInstanceId, options ListCalendarViewInstanceAttachmentsOperationOptions) (result ListCalendarViewInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarViewInstanceAttachmentsComplete(ctx context.Context, id stable.MeCalendarIdCalendarViewIdInstanceId, options ListCalendarViewInstanceAttachmentsOperationOptions) (ListCalendarViewInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarViewInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.MeCalendarIdCalendarViewIdInstanceId, options ListCalendarViewInstanceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarViewInstanceAttachmentsCompleteResult, err error) {
