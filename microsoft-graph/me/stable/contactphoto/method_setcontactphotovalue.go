...
func (c ContactPhotoClient) SetContactPhotoValue(ctx context.Context, id stable.MeContactId, input []byte) (result SetContactPhotoValueOperationResponse, err error) {
