...
func (c MessageExtensionClient) GetssageExtensionsCount(ctx context.Context, id stable.MeMessageId, options GetssageExtensionsCountOperationOptions) (result GetssageExtensionsCountOperationResponse, err error) {
