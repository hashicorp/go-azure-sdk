...
type CreatessageExtensionOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        stable.Extension
}

// CreatessageExtension - Create open extension. Create an open extension (openTypeExtension object) and add custom
...
func (c MessageExtensionClient) CreatessageExtension(ctx context.Context, id stable.MeMessageId, input stable.Extension) (result CreatessageExtensionOperationResponse, err error) {
