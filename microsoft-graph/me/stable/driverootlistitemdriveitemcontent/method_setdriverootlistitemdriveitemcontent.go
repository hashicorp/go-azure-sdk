...
func (c DriveRootListItemDriveItemContentClient) SetDriveRootListItemDriveItemContent(ctx context.Context, id stable.MeDriveId, input []byte) (result SetDriveRootListItemDriveItemContentOperationResponse, err error) {
