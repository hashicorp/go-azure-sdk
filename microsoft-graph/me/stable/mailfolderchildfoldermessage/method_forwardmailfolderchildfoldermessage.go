...
func (c MailFolderChildFolderMessageClient) ForwardMailFolderChildFolderMessage(ctx context.Context, id stable.MeMailFolderIdChildFolderIdMessageId, input ForwardMailFolderChildFolderMessageRequest) (result ForwardMailFolderChildFolderMessageOperationResponse, err error) {
