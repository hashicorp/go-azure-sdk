...
func (c MailFolderChildFolderMessageClient) CreateMailFolderChildFolderMessage(ctx context.Context, id stable.MeMailFolderIdChildFolderId, input stable.Message) (result CreateMailFolderChildFolderMessageOperationResponse, err error) {
