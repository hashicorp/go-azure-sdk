...
func (c MailFolderChildFolderMessageClient) CreateMailFolderChildFolderMessageForward(ctx context.Context, id stable.MeMailFolderIdChildFolderIdMessageId, input CreateMailFolderChildFolderMessageForwardRequest) (result CreateMailFolderChildFolderMessageForwardOperationResponse, err error) {
