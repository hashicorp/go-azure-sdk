...
func (c DriveRootPermissionClient) CreateDriveRootPermission(ctx context.Context, id stable.MeDriveId, input stable.Permission) (result CreateDriveRootPermissionOperationResponse, err error) {
