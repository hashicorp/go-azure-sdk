...
func (c OutlookMasterCategoryClient) UpdateOutlookMasterCategory(ctx context.Context, id stable.MeOutlookMasterCategoryId, input stable.OutlookCategory) (result UpdateOutlookMasterCategoryOperationResponse, err error) {
