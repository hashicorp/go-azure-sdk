...
func (c OnlineMeetingTranscriptMetadataContentClient) SetOnlineMeetingTranscriptMetadataContent(ctx context.Context, id stable.MeOnlineMeetingIdTranscriptId, input []byte) (result SetOnlineMeetingTranscriptMetadataContentOperationResponse, err error) {
