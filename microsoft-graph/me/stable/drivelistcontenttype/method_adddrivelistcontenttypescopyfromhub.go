...
func (c DriveListContentTypeClient) AddDriveListContentTypesCopyFromHub(ctx context.Context, id stable.MeDriveId, input AddDriveListContentTypesCopyFromHubRequest) (result AddDriveListContentTypesCopyFromHubOperationResponse, err error) {
