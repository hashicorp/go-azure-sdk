...
func (c DriveListContentTypeClient) CreateDriveListContentType(ctx context.Context, id stable.MeDriveId, input stable.ContentType) (result CreateDriveListContentTypeOperationResponse, err error) {
