...
// operation.
func (c DriveListContentTypeClient) CopyDriveListContentTypeToDefaultContentLocation(ctx context.Context, id stable.MeDriveIdListContentTypeId, input CopyDriveListContentTypeToDefaultContentLocationRequest) (result CopyDriveListContentTypeToDefaultContentLocationOperationResponse, err error) {
