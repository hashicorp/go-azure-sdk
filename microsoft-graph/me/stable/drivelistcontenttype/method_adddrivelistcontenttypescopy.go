...
func (c DriveListContentTypeClient) AddDriveListContentTypesCopy(ctx context.Context, id stable.MeDriveId, input AddDriveListContentTypesCopyRequest) (result AddDriveListContentTypesCopyOperationResponse, err error) {
