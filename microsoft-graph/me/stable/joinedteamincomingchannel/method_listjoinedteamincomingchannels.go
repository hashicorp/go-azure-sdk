...
func (c JoinedTeamIncomingChannelClient) ListJoinedTeamIncomingChannels(ctx context.Context, id MeJoinedTeamId) (result ListJoinedTeamIncomingChannelsOperationResponse, err error) {
...
func (c JoinedTeamIncomingChannelClient) ListJoinedTeamIncomingChannelsComplete(ctx context.Context, id MeJoinedTeamId) (ListJoinedTeamIncomingChannelsCompleteResult, error) {
...
func (c JoinedTeamIncomingChannelClient) ListJoinedTeamIncomingChannelsCompleteMatchingPredicate(ctx context.Context, id MeJoinedTeamId, predicate ChannelOperationPredicate) (result ListJoinedTeamIncomingChannelsCompleteResult, err error) {
