...
// channel or a chat.
func (c ChatMessageClient) CreateChatMessageSoftDelete(ctx context.Context, id stable.MeChatIdMessageId) (result CreateChatMessageSoftDeleteOperationResponse, err error) {
