...
func (c ChatMessageClient) CreateChatMessageUndoSoftDelete(ctx context.Context, id stable.MeChatIdMessageId) (result CreateChatMessageUndoSoftDeleteOperationResponse, err error) {
