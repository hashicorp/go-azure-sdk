...
// Outlook.com account.
func (c CalendarEventInstanceClient) ForwardCalendarEventInstance(ctx context.Context, id stable.MeCalendarEventIdInstanceId, input ForwardCalendarEventInstanceRequest) (result ForwardCalendarEventInstanceOperationResponse, err error) {
