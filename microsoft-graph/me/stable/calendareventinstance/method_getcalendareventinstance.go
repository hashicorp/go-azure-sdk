...
// GetCalendarEventInstance - Get instances from me. The occurrences of a recurring series, if the event is a series
...
// Nullable.
func (c CalendarEventInstanceClient) GetCalendarEventInstance(ctx context.Context, id stable.MeCalendarEventIdInstanceId, options GetCalendarEventInstanceOperationOptions) (result GetCalendarEventInstanceOperationResponse, err error) {
