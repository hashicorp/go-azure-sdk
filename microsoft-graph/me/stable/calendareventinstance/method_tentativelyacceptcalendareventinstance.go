...
func (c CalendarEventInstanceClient) TentativelyAcceptCalendarEventInstance(ctx context.Context, id stable.MeCalendarEventIdInstanceId, input TentativelyAcceptCalendarEventInstanceRequest) (result TentativelyAcceptCalendarEventInstanceOperationResponse, err error) {
