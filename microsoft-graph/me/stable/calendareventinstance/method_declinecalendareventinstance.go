...
func (c CalendarEventInstanceClient) DeclineCalendarEventInstance(ctx context.Context, id stable.MeCalendarEventIdInstanceId, input DeclineCalendarEventInstanceRequest) (result DeclineCalendarEventInstanceOperationResponse, err error) {
