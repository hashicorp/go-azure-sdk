...
func (c CalendarEventInstanceClient) SnoozeCalendarEventInstanceReminder(ctx context.Context, id stable.MeCalendarIdEventIdInstanceId, input SnoozeCalendarEventInstanceReminderRequest) (result SnoozeCalendarEventInstanceReminderOperationResponse, err error) {
