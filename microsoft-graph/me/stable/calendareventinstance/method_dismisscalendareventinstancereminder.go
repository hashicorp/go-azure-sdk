...
func (c CalendarEventInstanceClient) DismissCalendarEventInstanceReminder(ctx context.Context, id stable.MeCalendarIdEventIdInstanceId) (result DismissCalendarEventInstanceReminderOperationResponse, err error) {
