...
func (c CalendarEventInstanceClient) ListCalendarEventInstances(ctx context.Context, id MeCalendarEventId) (result ListCalendarEventInstancesOperationResponse, err error) {
...
func (c CalendarEventInstanceClient) ListCalendarEventInstancesComplete(ctx context.Context, id MeCalendarEventId) (ListCalendarEventInstancesCompleteResult, error) {
...
func (c CalendarEventInstanceClient) ListCalendarEventInstancesCompleteMatchingPredicate(ctx context.Context, id MeCalendarEventId, predicate EventOperationPredicate) (result ListCalendarEventInstancesCompleteResult, err error) {
