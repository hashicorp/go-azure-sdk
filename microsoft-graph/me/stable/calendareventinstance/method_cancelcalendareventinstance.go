...
func (c CalendarEventInstanceClient) CancelCalendarEventInstance(ctx context.Context, id stable.MeCalendarIdEventIdInstanceId, input CancelCalendarEventInstanceRequest) (result CancelCalendarEventInstanceOperationResponse, err error) {
