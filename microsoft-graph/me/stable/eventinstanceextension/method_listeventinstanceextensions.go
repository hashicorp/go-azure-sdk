...
func (c EventInstanceExtensionClient) ListEventInstanceExtensions(ctx context.Context, id MeEventIdInstanceId) (result ListEventInstanceExtensionsOperationResponse, err error) {
...
func (c EventInstanceExtensionClient) ListEventInstanceExtensionsComplete(ctx context.Context, id MeEventIdInstanceId) (ListEventInstanceExtensionsCompleteResult, error) {
...
func (c EventInstanceExtensionClient) ListEventInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id MeEventIdInstanceId, predicate ExtensionOperationPredicate) (result ListEventInstanceExtensionsCompleteResult, err error) {
