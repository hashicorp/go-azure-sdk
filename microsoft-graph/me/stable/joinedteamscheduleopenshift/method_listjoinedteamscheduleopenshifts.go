...
func (c JoinedTeamScheduleOpenShiftClient) ListJoinedTeamScheduleOpenShifts(ctx context.Context, id MeJoinedTeamId) (result ListJoinedTeamScheduleOpenShiftsOperationResponse, err error) {
...
func (c JoinedTeamScheduleOpenShiftClient) ListJoinedTeamScheduleOpenShiftsComplete(ctx context.Context, id MeJoinedTeamId) (ListJoinedTeamScheduleOpenShiftsCompleteResult, error) {
...
func (c JoinedTeamScheduleOpenShiftClient) ListJoinedTeamScheduleOpenShiftsCompleteMatchingPredicate(ctx context.Context, id MeJoinedTeamId, predicate OpenShiftOperationPredicate) (result ListJoinedTeamScheduleOpenShiftsCompleteResult, err error) {
