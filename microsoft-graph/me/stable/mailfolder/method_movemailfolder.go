...
func (c MailFolderClient) MoveMailFolder(ctx context.Context, id stable.MeMailFolderId, input MoveMailFolderRequest) (result MoveMailFolderOperationResponse, err error) {
