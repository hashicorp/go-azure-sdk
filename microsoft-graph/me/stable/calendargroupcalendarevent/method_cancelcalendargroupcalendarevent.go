...
func (c CalendarGroupCalendarEventClient) CancelCalendarGroupCalendarEvent(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdEventId, input CancelCalendarGroupCalendarEventRequest) (result CancelCalendarGroupCalendarEventOperationResponse, err error) {
