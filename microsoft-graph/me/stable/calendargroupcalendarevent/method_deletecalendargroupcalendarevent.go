...
// DeleteCalendarGroupCalendarEvent - Delete navigation property events for me
func (c CalendarGroupCalendarEventClient) DeleteCalendarGroupCalendarEvent(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdEventId, options DeleteCalendarGroupCalendarEventOperationOptions) (result DeleteCalendarGroupCalendarEventOperationResponse, err error) {
