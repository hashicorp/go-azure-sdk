...
func (c CalendarGroupCalendarEventClient) ForwardCalendarGroupCalendarEvent(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdEventId, input ForwardCalendarGroupCalendarEventRequest) (result ForwardCalendarGroupCalendarEventOperationResponse, err error) {
