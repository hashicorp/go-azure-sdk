...
func (c CalendarGroupCalendarViewAttachmentClient) ListCalendarGroupCalendarViewAttachments(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewAttachmentsOperationOptions) (result ListCalendarGroupCalendarViewAttachmentsOperationResponse, err error) {
...
func (c CalendarGroupCalendarViewAttachmentClient) ListCalendarGroupCalendarViewAttachmentsComplete(ctx context.Context, id stable.MeCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewAttachmentsOperationOptions) (ListCalendarGroupCalendarViewAttachmentsCompleteResult, error) {
