...
func (c TodoListTaskLinkedResourceClient) CreateTodoListTaskLinkedResource(ctx context.Context, id MeTodoListIdTaskId, input beta.LinkedResource) (result CreateTodoListTaskLinkedResourceOperationResponse, err error) {
