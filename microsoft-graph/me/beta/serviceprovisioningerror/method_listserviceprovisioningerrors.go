...
func (c ServiceProvisioningErrorClient) ListServiceProvisioningErrors(ctx context.Context) (result ListServiceProvisioningErrorsOperationResponse, err error) {
...
func (c ServiceProvisioningErrorClient) ListServiceProvisioningErrorsComplete(ctx context.Context) (ListServiceProvisioningErrorsCompleteResult, error) {
	return c.ListServiceProvisioningErrorsCompleteMatchingPredicate(ctx, ServiceProvisioningErrorOperationPredicate{})
}

// ListServiceProvisioningErrorsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ServiceProvisioningErrorClient) ListServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, predicate ServiceProvisioningErrorOperationPredicate) (result ListServiceProvisioningErrorsCompleteResult, err error) {
	items := make([]beta.ServiceProvisioningError, 0)

	resp, err := c.ListServiceProvisioningErrors(ctx)
	if err != nil {
