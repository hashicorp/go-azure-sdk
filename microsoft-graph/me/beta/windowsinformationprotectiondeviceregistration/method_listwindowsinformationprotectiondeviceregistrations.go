...
func (c WindowsInformationProtectionDeviceRegistrationClient) ListWindowsInformationProtectionDeviceRegistrations(ctx context.Context) (result ListWindowsInformationProtectionDeviceRegistrationsOperationResponse, err error) {
...
func (c WindowsInformationProtectionDeviceRegistrationClient) ListWindowsInformationProtectionDeviceRegistrationsComplete(ctx context.Context) (ListWindowsInformationProtectionDeviceRegistrationsCompleteResult, error) {
	return c.ListWindowsInformationProtectionDeviceRegistrationsCompleteMatchingPredicate(ctx, WindowsInformationProtectionDeviceRegistrationOperationPredicate{})
}
...
func (c WindowsInformationProtectionDeviceRegistrationClient) ListWindowsInformationProtectionDeviceRegistrationsCompleteMatchingPredicate(ctx context.Context, predicate WindowsInformationProtectionDeviceRegistrationOperationPredicate) (result ListWindowsInformationProtectionDeviceRegistrationsCompleteResult, err error) {
	items := make([]beta.WindowsInformationProtectionDeviceRegistration, 0)

	resp, err := c.ListWindowsInformationProtectionDeviceRegistrations(ctx)
	if err != nil {
