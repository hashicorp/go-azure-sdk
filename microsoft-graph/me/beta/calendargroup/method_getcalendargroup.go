...
func (c CalendarGroupClient) GetCalendarGroup(ctx context.Context, id beta.MeCalendarGroupId, options GetCalendarGroupOperationOptions) (result GetCalendarGroupOperationResponse, err error) {
