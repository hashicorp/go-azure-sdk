...
// ListCalendarGroups ...
func (c CalendarGroupClient) ListCalendarGroups(ctx context.Context) (result ListCalendarGroupsOperationResponse, err error) {
...
func (c CalendarGroupClient) ListCalendarGroupsComplete(ctx context.Context) (ListCalendarGroupsCompleteResult, error) {
	return c.ListCalendarGroupsCompleteMatchingPredicate(ctx, CalendarGroupOperationPredicate{})
}

// ListCalendarGroupsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c CalendarGroupClient) ListCalendarGroupsCompleteMatchingPredicate(ctx context.Context, predicate CalendarGroupOperationPredicate) (result ListCalendarGroupsCompleteResult, err error) {
	items := make([]beta.CalendarGroup, 0)

	resp, err := c.ListCalendarGroups(ctx)
	if err != nil {
