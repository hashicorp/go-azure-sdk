...
func (c EventExceptionOccurrenceExtensionClient) ListEventExceptionOccurrenceExtensions(ctx context.Context, id MeEventIdExceptionOccurrenceId) (result ListEventExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceExtensionClient) ListEventExceptionOccurrenceExtensionsComplete(ctx context.Context, id MeEventIdExceptionOccurrenceId) (ListEventExceptionOccurrenceExtensionsCompleteResult, error) {
...
func (c EventExceptionOccurrenceExtensionClient) ListEventExceptionOccurrenceExtensionsCompleteMatchingPredicate(ctx context.Context, id MeEventIdExceptionOccurrenceId, predicate ExtensionOperationPredicate) (result ListEventExceptionOccurrenceExtensionsCompleteResult, err error) {
