...
func (c ChatPinnedMessageMessageClient) GetChatPinnedMessage(ctx context.Context, id beta.MeChatIdPinnedMessageId, options GetChatPinnedMessageOperationOptions) (result GetChatPinnedMessageOperationResponse, err error) {
