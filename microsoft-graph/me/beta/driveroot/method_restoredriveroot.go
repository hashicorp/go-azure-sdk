...
// bin.
func (c DriveRootClient) RestoreDriveRoot(ctx context.Context, id beta.MeDriveId, input RestoreDriveRootRequest) (result RestoreDriveRootOperationResponse, err error) {
