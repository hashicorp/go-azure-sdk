...
func (c DriveRootClient) CreateDriveRootLink(ctx context.Context, id beta.MeDriveId, input CreateDriveRootLinkRequest) (result CreateDriveRootLinkOperationResponse, err error) {
