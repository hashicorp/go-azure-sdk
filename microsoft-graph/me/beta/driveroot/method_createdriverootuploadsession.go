...
func (c DriveRootClient) CreateDriveRootUploadSession(ctx context.Context, id beta.MeDriveId, input CreateDriveRootUploadSessionRequest) (result CreateDriveRootUploadSessionOperationResponse, err error) {
