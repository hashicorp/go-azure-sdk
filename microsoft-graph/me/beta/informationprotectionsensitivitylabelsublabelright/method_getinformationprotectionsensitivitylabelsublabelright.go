...
// GetInformationProtectionSensitivityLabelSublabelRight - Get rights from me
func (c InformationProtectionSensitivityLabelSublabelRightClient) GetInformationProtectionSensitivityLabelSublabelRight(ctx context.Context, id beta.MeInformationProtectionSensitivityLabelIdSublabelId, options GetInformationProtectionSensitivityLabelSublabelRightOperationOptions) (result GetInformationProtectionSensitivityLabelSublabelRightOperationResponse, err error) {
