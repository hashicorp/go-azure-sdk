...
func (c InformationProtectionDataLossPreventionPolicyClient) ListInformationProtectionDataLossPreventionPolicies(ctx context.Context) (result ListInformationProtectionDataLossPreventionPoliciesOperationResponse, err error) {
...
func (c InformationProtectionDataLossPreventionPolicyClient) ListInformationProtectionDataLossPreventionPoliciesComplete(ctx context.Context) (ListInformationProtectionDataLossPreventionPoliciesCompleteResult, error) {
	return c.ListInformationProtectionDataLossPreventionPoliciesCompleteMatchingPredicate(ctx, DataLossPreventionPolicyOperationPredicate{})
}
...
func (c InformationProtectionDataLossPreventionPolicyClient) ListInformationProtectionDataLossPreventionPoliciesCompleteMatchingPredicate(ctx context.Context, predicate DataLossPreventionPolicyOperationPredicate) (result ListInformationProtectionDataLossPreventionPoliciesCompleteResult, err error) {
	items := make([]beta.DataLossPreventionPolicy, 0)

	resp, err := c.ListInformationProtectionDataLossPreventionPolicies(ctx)
	if err != nil {
