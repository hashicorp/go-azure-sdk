...
func (c MemberOfClient) GetMemberOfDirectoryRoleCount(ctx context.Context, options GetMemberOfDirectoryRoleCountOperationOptions) (result GetMemberOfDirectoryRoleCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/memberOf/directoryRole/$count",
