...
func (c MemberOfClient) GetMemberOfAdministrativeUnit(ctx context.Context, id beta.MeMemberOfId, options GetMemberOfAdministrativeUnitOperationOptions) (result GetMemberOfAdministrativeUnitOperationResponse, err error) {
