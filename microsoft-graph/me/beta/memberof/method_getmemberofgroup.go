...
func (c MemberOfClient) GetMemberOfGroup(ctx context.Context, id beta.MeMemberOfId, options GetMemberOfGroupOperationOptions) (result GetMemberOfGroupOperationResponse, err error) {
