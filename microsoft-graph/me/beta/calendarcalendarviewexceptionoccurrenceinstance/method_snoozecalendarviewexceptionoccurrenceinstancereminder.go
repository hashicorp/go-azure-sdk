...
func (c CalendarCalendarViewExceptionOccurrenceInstanceClient) SnoozeCalendarViewExceptionOccurrenceInstanceReminder(ctx context.Context, id beta.MeCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId, input SnoozeCalendarViewExceptionOccurrenceInstanceReminderRequest) (result SnoozeCalendarViewExceptionOccurrenceInstanceReminderOperationResponse, err error) {
