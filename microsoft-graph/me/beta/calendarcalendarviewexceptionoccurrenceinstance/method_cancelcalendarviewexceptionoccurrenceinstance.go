...
// cancellation.
func (c CalendarCalendarViewExceptionOccurrenceInstanceClient) CancelCalendarViewExceptionOccurrenceInstance(ctx context.Context, id beta.MeCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId, input CancelCalendarViewExceptionOccurrenceInstanceRequest) (result CancelCalendarViewExceptionOccurrenceInstanceOperationResponse, err error) {
