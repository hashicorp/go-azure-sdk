...
func (c CalendarCalendarViewExceptionOccurrenceInstanceClient) AcceptCalendarViewExceptionOccurrenceInstance(ctx context.Context, id beta.MeCalendarCalendarViewIdExceptionOccurrenceIdInstanceId, input AcceptCalendarViewExceptionOccurrenceInstanceRequest) (result AcceptCalendarViewExceptionOccurrenceInstanceOperationResponse, err error) {
