...
// CreateCalendarViewInstanceExceptionOccurrenceAttachment - Create new navigation property to attachments for me
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) CreateCalendarViewInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.MeCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId, input beta.Attachment) (result CreateCalendarViewInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
