...
// DeleteCalendarViewInstanceExceptionOccurrenceAttachment - Delete navigation property attachments for me
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) DeleteCalendarViewInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.MeCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarViewInstanceExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarViewInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
