...
// GetCalendarViewInstanceExceptionOccurrenceAttachment - Get attachments from me. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) GetCalendarViewInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.MeCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceIdAttachmentId, options GetCalendarViewInstanceExceptionOccurrenceAttachmentOperationOptions) (result GetCalendarViewInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
