...
// ListCalendarViewInstanceExceptionOccurrenceAttachments - Get attachments from me. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) ListCalendarViewInstanceExceptionOccurrenceAttachments(ctx context.Context, id beta.MeCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId, options ListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationOptions) (result ListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) ListCalendarViewInstanceExceptionOccurrenceAttachmentsComplete(ctx context.Context, id beta.MeCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId, options ListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationOptions) (ListCalendarViewInstanceExceptionOccurrenceAttachmentsCompleteResult, error) {
