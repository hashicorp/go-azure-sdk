...
func (c DeviceExtensionClient) ListDeviceExtensions(ctx context.Context, id MeDeviceId) (result ListDeviceExtensionsOperationResponse, err error) {
...
func (c DeviceExtensionClient) ListDeviceExtensionsComplete(ctx context.Context, id MeDeviceId) (ListDeviceExtensionsCompleteResult, error) {
...
func (c DeviceExtensionClient) ListDeviceExtensionsCompleteMatchingPredicate(ctx context.Context, id MeDeviceId, predicate ExtensionOperationPredicate) (result ListDeviceExtensionsCompleteResult, err error) {
