...
func (c MailFolderChildFolderMessageMentionClient) ListMailFolderChildFolderMessageMentions(ctx context.Context, id MeMailFolderIdChildFolderIdMessageId) (result ListMailFolderChildFolderMessageMentionsOperationResponse, err error) {
...
func (c MailFolderChildFolderMessageMentionClient) ListMailFolderChildFolderMessageMentionsComplete(ctx context.Context, id MeMailFolderIdChildFolderIdMessageId) (ListMailFolderChildFolderMessageMentionsCompleteResult, error) {
...
func (c MailFolderChildFolderMessageMentionClient) ListMailFolderChildFolderMessageMentionsCompleteMatchingPredicate(ctx context.Context, id MeMailFolderIdChildFolderIdMessageId, predicate MentionOperationPredicate) (result ListMailFolderChildFolderMessageMentionsCompleteResult, err error) {
