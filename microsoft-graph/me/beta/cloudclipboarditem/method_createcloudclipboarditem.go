...
func (c CloudClipboardItemClient) CreateCloudClipboardItem(ctx context.Context, input beta.CloudClipboardItem) (result CreateCloudClipboardItemOperationResponse, err error) {
