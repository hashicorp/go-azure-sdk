...
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) UpdateManagedDeviceSecurityBaselineStateSettingState(ctx context.Context, id MeManagedDeviceIdSecurityBaselineStateIdSettingStateId, input beta.SecurityBaselineSettingState) (result UpdateManagedDeviceSecurityBaselineStateSettingStateOperationResponse, err error) {
