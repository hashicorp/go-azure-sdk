...
func (c PendingAccessReviewInstanceStageDecisionInstanceClient) AcceptPendingAccessReviewInstanceStageDecisionInstanceRecommendation(ctx context.Context, id beta.MePendingAccessReviewInstanceIdStageIdDecisionId) (result AcceptPendingAccessReviewInstanceStageDecisionInstanceRecommendationOperationResponse, err error) {
