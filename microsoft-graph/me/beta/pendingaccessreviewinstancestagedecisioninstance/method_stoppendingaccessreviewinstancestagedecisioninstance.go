...
func (c PendingAccessReviewInstanceStageDecisionInstanceClient) StopPendingAccessReviewInstanceStageDecisionInstance(ctx context.Context, id beta.MePendingAccessReviewInstanceIdStageIdDecisionId) (result StopPendingAccessReviewInstanceStageDecisionInstanceOperationResponse, err error) {
