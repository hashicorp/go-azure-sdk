...
func (c RegisteredDeviceClient) ListRegisteredDeviceAppRoleAssignments(ctx context.Context, options ListRegisteredDeviceAppRoleAssignmentsOperationOptions) (result ListRegisteredDeviceAppRoleAssignmentsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/registeredDevices/appRoleAssignment",
...
func (c RegisteredDeviceClient) ListRegisteredDeviceAppRoleAssignmentsComplete(ctx context.Context, options ListRegisteredDeviceAppRoleAssignmentsOperationOptions) (ListRegisteredDeviceAppRoleAssignmentsCompleteResult, error) {
	return c.ListRegisteredDeviceAppRoleAssignmentsCompleteMatchingPredicate(ctx, options, AppRoleAssignmentOperationPredicate{})
}

// ListRegisteredDeviceAppRoleAssignmentsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c RegisteredDeviceClient) ListRegisteredDeviceAppRoleAssignmentsCompleteMatchingPredicate(ctx context.Context, options ListRegisteredDeviceAppRoleAssignmentsOperationOptions, predicate AppRoleAssignmentOperationPredicate) (result ListRegisteredDeviceAppRoleAssignmentsCompleteResult, err error) {
	items := make([]beta.AppRoleAssignment, 0)

	resp, err := c.ListRegisteredDeviceAppRoleAssignments(ctx, options)
	if err != nil {
