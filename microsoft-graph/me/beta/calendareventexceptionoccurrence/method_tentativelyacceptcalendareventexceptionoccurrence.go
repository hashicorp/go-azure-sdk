...
func (c CalendarEventExceptionOccurrenceClient) TentativelyAcceptCalendarEventExceptionOccurrence(ctx context.Context, id beta.MeCalendarIdEventIdExceptionOccurrenceId, input TentativelyAcceptCalendarEventExceptionOccurrenceRequest) (result TentativelyAcceptCalendarEventExceptionOccurrenceOperationResponse, err error) {
