...
func (c CalendarEventExceptionOccurrenceClient) GetCalendarEventExceptionOccurrencesCount(ctx context.Context, id beta.MeCalendarIdEventId, options GetCalendarEventExceptionOccurrencesCountOperationOptions) (result GetCalendarEventExceptionOccurrencesCountOperationResponse, err error) {
