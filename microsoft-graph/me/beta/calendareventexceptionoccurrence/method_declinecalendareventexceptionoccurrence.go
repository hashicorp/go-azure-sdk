...
func (c CalendarEventExceptionOccurrenceClient) DeclineCalendarEventExceptionOccurrence(ctx context.Context, id beta.MeCalendarIdEventIdExceptionOccurrenceId, input DeclineCalendarEventExceptionOccurrenceRequest) (result DeclineCalendarEventExceptionOccurrenceOperationResponse, err error) {
