...
func (c CalendarEventExceptionOccurrenceClient) ForwardCalendarEventExceptionOccurrence(ctx context.Context, id beta.MeCalendarEventIdExceptionOccurrenceId, input ForwardCalendarEventExceptionOccurrenceRequest) (result ForwardCalendarEventExceptionOccurrenceOperationResponse, err error) {
