...
// GetCalendarEventExceptionOccurrence - Get exceptionOccurrences from me
func (c CalendarEventExceptionOccurrenceClient) GetCalendarEventExceptionOccurrence(ctx context.Context, id beta.MeCalendarIdEventIdExceptionOccurrenceId, options GetCalendarEventExceptionOccurrenceOperationOptions) (result GetCalendarEventExceptionOccurrenceOperationResponse, err error) {
