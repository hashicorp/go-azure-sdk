...
func (c AuthenticationHardwareOathMethodClient) GetAuthenticationHardwareOathMethodsCount(ctx context.Context, options GetAuthenticationHardwareOathMethodsCountOperationOptions) (result GetAuthenticationHardwareOathMethodsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/authentication/hardwareOathMethods/$count",
