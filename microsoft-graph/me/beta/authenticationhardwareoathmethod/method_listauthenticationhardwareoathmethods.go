...
// ListAuthenticationHardwareOathMethods - List hardwareOathAuthenticationMethod objects. Get a list of the hardware
// tokens assigned to a user.
func (c AuthenticationHardwareOathMethodClient) ListAuthenticationHardwareOathMethods(ctx context.Context, options ListAuthenticationHardwareOathMethodsOperationOptions) (result ListAuthenticationHardwareOathMethodsOperationResponse, err error) {
...
func (c AuthenticationHardwareOathMethodClient) ListAuthenticationHardwareOathMethodsComplete(ctx context.Context, options ListAuthenticationHardwareOathMethodsOperationOptions) (ListAuthenticationHardwareOathMethodsCompleteResult, error) {
	return c.ListAuthenticationHardwareOathMethodsCompleteMatchingPredicate(ctx, options, HardwareOathAuthenticationMethodOperationPredicate{})
}

// ListAuthenticationHardwareOathMethodsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AuthenticationHardwareOathMethodClient) ListAuthenticationHardwareOathMethodsCompleteMatchingPredicate(ctx context.Context, options ListAuthenticationHardwareOathMethodsOperationOptions, predicate HardwareOathAuthenticationMethodOperationPredicate) (result ListAuthenticationHardwareOathMethodsCompleteResult, err error) {
	items := make([]beta.HardwareOathAuthenticationMethod, 0)

	resp, err := c.ListAuthenticationHardwareOathMethods(ctx, options)
	if err != nil {
