...
// ListProfileSkills ...
func (c ProfileSkillClient) ListProfileSkills(ctx context.Context) (result ListProfileSkillsOperationResponse, err error) {
...
func (c ProfileSkillClient) ListProfileSkillsComplete(ctx context.Context) (ListProfileSkillsCompleteResult, error) {
	return c.ListProfileSkillsCompleteMatchingPredicate(ctx, SkillProficiencyOperationPredicate{})
}

// ListProfileSkillsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileSkillClient) ListProfileSkillsCompleteMatchingPredicate(ctx context.Context, predicate SkillProficiencyOperationPredicate) (result ListProfileSkillsCompleteResult, err error) {
	items := make([]beta.SkillProficiency, 0)

	resp, err := c.ListProfileSkills(ctx)
	if err != nil {
