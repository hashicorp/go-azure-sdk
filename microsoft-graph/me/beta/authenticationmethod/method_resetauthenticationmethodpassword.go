...
func (c AuthenticationMethodClient) ResetAuthenticationMethodPassword(ctx context.Context, id beta.MeAuthenticationMethodId, input ResetAuthenticationMethodPasswordRequest) (result ResetAuthenticationMethodPasswordOperationResponse, err error) {
