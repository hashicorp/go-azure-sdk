...
func (c AuthenticationMethodClient) DisableAuthenticationMethodSmsSignIn(ctx context.Context, id beta.MeAuthenticationMethodId) (result DisableAuthenticationMethodSmsSignInOperationResponse, err error) {
