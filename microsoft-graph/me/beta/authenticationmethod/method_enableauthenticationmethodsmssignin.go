...
func (c AuthenticationMethodClient) EnableAuthenticationMethodSmsSignIn(ctx context.Context, id beta.MeAuthenticationMethodId) (result EnableAuthenticationMethodSmsSignInOperationResponse, err error) {
