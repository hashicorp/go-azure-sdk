...
func (c DeviceEnrollmentConfigurationAssignmentClient) ListDeviceEnrollmentConfigurationAssignments(ctx context.Context, id MeDeviceEnrollmentConfigurationId) (result ListDeviceEnrollmentConfigurationAssignmentsOperationResponse, err error) {
...
func (c DeviceEnrollmentConfigurationAssignmentClient) ListDeviceEnrollmentConfigurationAssignmentsComplete(ctx context.Context, id MeDeviceEnrollmentConfigurationId) (ListDeviceEnrollmentConfigurationAssignmentsCompleteResult, error) {
...
func (c DeviceEnrollmentConfigurationAssignmentClient) ListDeviceEnrollmentConfigurationAssignmentsCompleteMatchingPredicate(ctx context.Context, id MeDeviceEnrollmentConfigurationId, predicate EnrollmentConfigurationAssignmentOperationPredicate) (result ListDeviceEnrollmentConfigurationAssignmentsCompleteResult, err error) {
