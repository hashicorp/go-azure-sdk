...
func (c CalendarGroupCalendarViewInstanceExceptionOccurrenceClient) GetCalendarGroupCalendarViewInstanceExceptionOccurrence(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId, options GetCalendarGroupCalendarViewInstanceExceptionOccurrenceOperationOptions) (result GetCalendarGroupCalendarViewInstanceExceptionOccurrenceOperationResponse, err error) {
