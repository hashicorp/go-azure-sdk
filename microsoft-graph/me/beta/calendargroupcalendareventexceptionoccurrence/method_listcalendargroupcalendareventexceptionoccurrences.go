...
func (c CalendarGroupCalendarEventExceptionOccurrenceClient) ListCalendarGroupCalendarEventExceptionOccurrences(ctx context.Context, id MeCalendarGroupIdCalendarIdEventId) (result ListCalendarGroupCalendarEventExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventExceptionOccurrenceClient) ListCalendarGroupCalendarEventExceptionOccurrencesComplete(ctx context.Context, id MeCalendarGroupIdCalendarIdEventId) (ListCalendarGroupCalendarEventExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarGroupCalendarEventExceptionOccurrenceClient) ListCalendarGroupCalendarEventExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id MeCalendarGroupIdCalendarIdEventId, predicate EventOperationPredicate) (result ListCalendarGroupCalendarEventExceptionOccurrencesCompleteResult, err error) {
