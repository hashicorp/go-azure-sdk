...
// cancellation.
func (c CalendarGroupCalendarEventExceptionOccurrenceClient) CancelCalendarGroupCalendarEventExceptionOccurrence(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventIdExceptionOccurrenceId, input CancelCalendarGroupCalendarEventExceptionOccurrenceRequest) (result CancelCalendarGroupCalendarEventExceptionOccurrenceOperationResponse, err error) {
