...
func (c OutlookTaskFolderTaskClient) CreateOutlookTaskFolderTask(ctx context.Context, id beta.MeOutlookTaskFolderId, input beta.OutlookTask) (result CreateOutlookTaskFolderTaskOperationResponse, err error) {
