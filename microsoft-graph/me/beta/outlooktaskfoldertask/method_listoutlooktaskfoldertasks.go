...
func (c OutlookTaskFolderTaskClient) ListOutlookTaskFolderTasks(ctx context.Context, id MeOutlookTaskFolderId) (result ListOutlookTaskFolderTasksOperationResponse, err error) {
...
func (c OutlookTaskFolderTaskClient) ListOutlookTaskFolderTasksComplete(ctx context.Context, id MeOutlookTaskFolderId) (ListOutlookTaskFolderTasksCompleteResult, error) {
...
func (c OutlookTaskFolderTaskClient) ListOutlookTaskFolderTasksCompleteMatchingPredicate(ctx context.Context, id MeOutlookTaskFolderId, predicate OutlookTaskOperationPredicate) (result ListOutlookTaskFolderTasksCompleteResult, err error) {
