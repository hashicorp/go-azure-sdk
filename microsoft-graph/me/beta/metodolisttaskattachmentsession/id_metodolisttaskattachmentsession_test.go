...
func TestNewMeTodoListTaskAttachmentSessionID(t *testing.T) {
	id := NewMeTodoListTaskAttachmentSessionID("todoTaskListIdValue", "todoTaskIdValue", "attachmentSessionIdValue")
...
func TestFormatMeTodoListTaskAttachmentSessionID(t *testing.T) {
	actual := NewMeTodoListTaskAttachmentSessionID("todoTaskListIdValue", "todoTaskIdValue", "attachmentSessionIdValue").ID()
...
func TestParseMeTodoListTaskAttachmentSessionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeTodoListTaskAttachmentSessionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeTodoListTaskAttachmentSessionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeTodoListTaskAttachmentSessionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeTodoListTaskAttachmentSessionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeTodoListTaskAttachmentSessionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeTodoListTaskAttachmentSessionId(t *testing.T) {
	segments := MeTodoListTaskAttachmentSessionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeTodoListTaskAttachmentSessionId has no segments")
	}
