...
func TestNewMeOutlookTaskFolderTaskAttachmentID(t *testing.T) {
	id := NewMeOutlookTaskFolderTaskAttachmentID("outlookTaskFolderIdValue", "outlookTaskIdValue", "attachmentIdValue")
...
func TestFormatMeOutlookTaskFolderTaskAttachmentID(t *testing.T) {
	actual := NewMeOutlookTaskFolderTaskAttachmentID("outlookTaskFolderIdValue", "outlookTaskIdValue", "attachmentIdValue").ID()
...
func TestParseMeOutlookTaskFolderTaskAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeOutlookTaskFolderTaskAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeOutlookTaskFolderTaskAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeOutlookTaskFolderTaskAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeOutlookTaskFolderTaskAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeOutlookTaskFolderTaskAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeOutlookTaskFolderTaskAttachmentId(t *testing.T) {
	segments := MeOutlookTaskFolderTaskAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeOutlookTaskFolderTaskAttachmentId has no segments")
	}
