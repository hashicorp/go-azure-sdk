...
// UpdateDataSecurityAndGovernance - Update the navigation property dataSecurityAndGovernance in me
func (c DataSecurityAndGovernanceClient) UpdateDataSecurityAndGovernance(ctx context.Context, input beta.UserDataSecurityAndGovernance, options UpdateDataSecurityAndGovernanceOperationOptions) (result UpdateDataSecurityAndGovernanceOperationResponse, err error) {
