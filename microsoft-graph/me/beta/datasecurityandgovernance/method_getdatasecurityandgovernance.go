...
// GetDataSecurityAndGovernance - Get dataSecurityAndGovernance from me. The data security and governance settings for
// the user. Read-only. Nullable.
func (c DataSecurityAndGovernanceClient) GetDataSecurityAndGovernance(ctx context.Context, options GetDataSecurityAndGovernanceOperationOptions) (result GetDataSecurityAndGovernanceOperationResponse, err error) {
