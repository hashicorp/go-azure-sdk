...
// event. Nullable.
func (c CalendarGroupCalendarViewExtensionClient) ListCalendarGroupCalendarViewExtensions(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewExtensionsOperationOptions) (result ListCalendarGroupCalendarViewExtensionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarViewExtensionClient) ListCalendarGroupCalendarViewExtensionsComplete(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewExtensionsOperationOptions) (ListCalendarGroupCalendarViewExtensionsCompleteResult, error) {
