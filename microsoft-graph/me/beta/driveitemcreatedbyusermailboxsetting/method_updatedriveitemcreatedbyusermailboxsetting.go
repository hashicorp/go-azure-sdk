...
func (c DriveItemCreatedByUserMailboxSettingClient) UpdateDriveItemCreatedByUserMailboxSetting(ctx context.Context, id beta.MeDriveIdItemId, input beta.MailboxSettings) (result UpdateDriveItemCreatedByUserMailboxSettingOperationResponse, err error) {
