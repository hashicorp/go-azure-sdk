...
func (c DriveListPermissionClient) CreateDriveListPermission(ctx context.Context, id beta.MeDriveId, input beta.Permission) (result CreateDriveListPermissionOperationResponse, err error) {
