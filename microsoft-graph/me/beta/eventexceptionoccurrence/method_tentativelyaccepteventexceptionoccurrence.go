...
func (c EventExceptionOccurrenceClient) TentativelyAcceptEventExceptionOccurrence(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, input TentativelyAcceptEventExceptionOccurrenceRequest) (result TentativelyAcceptEventExceptionOccurrenceOperationResponse, err error) {
