...
func (c EventExceptionOccurrenceClient) ForwardEventExceptionOccurrence(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, input ForwardEventExceptionOccurrenceRequest) (result ForwardEventExceptionOccurrenceOperationResponse, err error) {
