...
func (c EventExceptionOccurrenceClient) ListEventExceptionOccurrences(ctx context.Context, id MeEventId) (result ListEventExceptionOccurrencesOperationResponse, err error) {
...
func (c EventExceptionOccurrenceClient) ListEventExceptionOccurrencesComplete(ctx context.Context, id MeEventId) (ListEventExceptionOccurrencesCompleteResult, error) {
...
func (c EventExceptionOccurrenceClient) ListEventExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id MeEventId, predicate EventOperationPredicate) (result ListEventExceptionOccurrencesCompleteResult, err error) {
