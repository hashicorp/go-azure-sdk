...
func (c EventExceptionOccurrenceClient) DeclineEventExceptionOccurrence(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, input DeclineEventExceptionOccurrenceRequest) (result DeclineEventExceptionOccurrenceOperationResponse, err error) {
