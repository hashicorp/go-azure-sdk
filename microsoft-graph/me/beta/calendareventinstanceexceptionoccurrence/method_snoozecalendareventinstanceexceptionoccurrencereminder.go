...
func (c CalendarEventInstanceExceptionOccurrenceClient) SnoozeCalendarEventInstanceExceptionOccurrenceReminder(ctx context.Context, id beta.MeCalendarEventIdInstanceIdExceptionOccurrenceId, input SnoozeCalendarEventInstanceExceptionOccurrenceReminderRequest) (result SnoozeCalendarEventInstanceExceptionOccurrenceReminderOperationResponse, err error) {
