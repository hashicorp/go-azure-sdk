...
func (c CalendarEventInstanceExceptionOccurrenceClient) DeclineCalendarEventInstanceExceptionOccurrence(ctx context.Context, id beta.MeCalendarEventIdInstanceIdExceptionOccurrenceId, input DeclineCalendarEventInstanceExceptionOccurrenceRequest) (result DeclineCalendarEventInstanceExceptionOccurrenceOperationResponse, err error) {
