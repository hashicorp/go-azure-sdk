...
// times.
func (c CalendarEventInstanceExceptionOccurrenceClient) TentativelyAcceptCalendarEventInstanceExceptionOccurrence(ctx context.Context, id beta.MeCalendarEventIdInstanceIdExceptionOccurrenceId, input TentativelyAcceptCalendarEventInstanceExceptionOccurrenceRequest) (result TentativelyAcceptCalendarEventInstanceExceptionOccurrenceOperationResponse, err error) {
