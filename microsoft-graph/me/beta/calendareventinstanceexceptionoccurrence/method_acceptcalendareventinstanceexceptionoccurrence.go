...
func (c CalendarEventInstanceExceptionOccurrenceClient) AcceptCalendarEventInstanceExceptionOccurrence(ctx context.Context, id beta.MeCalendarEventIdInstanceIdExceptionOccurrenceId, input AcceptCalendarEventInstanceExceptionOccurrenceRequest) (result AcceptCalendarEventInstanceExceptionOccurrenceOperationResponse, err error) {
