...
func (c CalendarEventInstanceExceptionOccurrenceClient) DismissCalendarEventInstanceExceptionOccurrenceReminder(ctx context.Context, id beta.MeCalendarIdEventIdInstanceIdExceptionOccurrenceId) (result DismissCalendarEventInstanceExceptionOccurrenceReminderOperationResponse, err error) {
