...
func (c ChatPermissionGrantClient) ListChatPermissionGrants(ctx context.Context, id MeChatId) (result ListChatPermissionGrantsOperationResponse, err error) {
...
func (c ChatPermissionGrantClient) ListChatPermissionGrantsComplete(ctx context.Context, id MeChatId) (ListChatPermissionGrantsCompleteResult, error) {
...
func (c ChatPermissionGrantClient) ListChatPermissionGrantsCompleteMatchingPredicate(ctx context.Context, id MeChatId, predicate ResourceSpecificPermissionGrantOperationPredicate) (result ListChatPermissionGrantsCompleteResult, err error) {
