...
func (c ChatPermissionGrantClient) CreateChatPermissionGrant(ctx context.Context, id beta.MeChatId, input beta.ResourceSpecificPermissionGrant) (result CreateChatPermissionGrantOperationResponse, err error) {
