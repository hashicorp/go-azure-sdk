...
func TestNewMeContactFolderChildFolderContactID(t *testing.T) {
	id := NewMeContactFolderChildFolderContactID("contactFolderIdValue", "contactFolderId1Value", "contactIdValue")
...
func TestFormatMeContactFolderChildFolderContactID(t *testing.T) {
	actual := NewMeContactFolderChildFolderContactID("contactFolderIdValue", "contactFolderId1Value", "contactIdValue").ID()
...
func TestParseMeContactFolderChildFolderContactID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeContactFolderChildFolderContactId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeContactFolderChildFolderContactID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeContactFolderChildFolderContactIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeContactFolderChildFolderContactId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeContactFolderChildFolderContactIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeContactFolderChildFolderContactId(t *testing.T) {
	segments := MeContactFolderChildFolderContactId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeContactFolderChildFolderContactId has no segments")
	}
