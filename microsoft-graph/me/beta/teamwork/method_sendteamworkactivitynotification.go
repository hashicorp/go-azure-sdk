...
func (c TeamworkClient) SendTeamworkActivityNotification(ctx context.Context, input SendTeamworkActivityNotificationRequest) (result SendTeamworkActivityNotificationOperationResponse, err error) {
