...
// UpdateAuthenticationQrCodePinMethodPin - Update the navigation property pin in me
func (c AuthenticationQrCodePinMethodPinClient) UpdateAuthenticationQrCodePinMethodPin(ctx context.Context, input beta.QrPin, options UpdateAuthenticationQrCodePinMethodPinOperationOptions) (result UpdateAuthenticationQrCodePinMethodPinOperationResponse, err error) {
