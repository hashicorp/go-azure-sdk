...
func NewMeCalendarCalendarViewInstanceExceptionOccurrenceID(calendarId string, eventId string, eventId1 string, eventId2 string) MeCalendarCalendarViewInstanceExceptionOccurrenceId {
