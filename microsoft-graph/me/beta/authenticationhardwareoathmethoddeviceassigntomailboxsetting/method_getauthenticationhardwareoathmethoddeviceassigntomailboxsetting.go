...
func (c AuthenticationHardwareOathMethodDeviceAssignToMailboxSettingClient) GetAuthenticationHardwareOathMethodDeviceAssignToMailboxSetting(ctx context.Context, id beta.MeAuthenticationHardwareOathMethodId, options GetAuthenticationHardwareOathMethodDeviceAssignToMailboxSettingOperationOptions) (result GetAuthenticationHardwareOathMethodDeviceAssignToMailboxSettingOperationResponse, err error) {
