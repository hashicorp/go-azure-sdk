...
func (c TransitiveReportClient) ListTransitiveReports(ctx context.Context) (result ListTransitiveReportsOperationResponse, err error) {
...
func (c TransitiveReportClient) ListTransitiveReportsComplete(ctx context.Context) (ListTransitiveReportsCompleteResult, error) {
	return c.ListTransitiveReportsCompleteMatchingPredicate(ctx, DirectoryObjectOperationPredicate{})
}

// ListTransitiveReportsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c TransitiveReportClient) ListTransitiveReportsCompleteMatchingPredicate(ctx context.Context, predicate DirectoryObjectOperationPredicate) (result ListTransitiveReportsCompleteResult, err error) {
	items := make([]beta.DirectoryObject, 0)

	resp, err := c.ListTransitiveReports(ctx)
	if err != nil {
