...
// and retry.
func (c CloudPCClient) RetryCloudPCPartnerAgentInstallation(ctx context.Context, id beta.MeCloudPCId) (result RetryCloudPCPartnerAgentInstallationOperationResponse, err error) {
