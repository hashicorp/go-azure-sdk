...
func (c CloudPCClient) RestoreCloudPC(ctx context.Context, id beta.MeCloudPCId, input RestoreCloudPCRequest) (result RestoreCloudPCOperationResponse, err error) {
