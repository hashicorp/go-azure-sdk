...
func (c CloudPCClient) ValidateMeCloudPCsBulkResize(ctx context.Context, input ValidateMeCloudPCsBulkResizeRequest) (result ValidateMeCloudPCsBulkResizeOperationResponse, err error) {
