...
func (c CloudPCClient) CreateCloudPCSnapshot(ctx context.Context, id beta.MeCloudPCId, input CreateCloudPCSnapshotRequest, options CreateCloudPCSnapshotOperationOptions) (result CreateCloudPCSnapshotOperationResponse, err error) {
