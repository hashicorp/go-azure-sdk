...
// Cloud PC.
func (c CloudPCClient) ChangeCloudPCUserAccountType(ctx context.Context, id beta.MeCloudPCId, input ChangeCloudPCUserAccountTypeRequest) (result ChangeCloudPCUserAccountTypeOperationResponse, err error) {
