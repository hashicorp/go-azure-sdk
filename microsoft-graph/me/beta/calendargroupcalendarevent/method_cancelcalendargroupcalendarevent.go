...
func (c CalendarGroupCalendarEventClient) CancelCalendarGroupCalendarEvent(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventId, input CancelCalendarGroupCalendarEventRequest) (result CancelCalendarGroupCalendarEventOperationResponse, err error) {
