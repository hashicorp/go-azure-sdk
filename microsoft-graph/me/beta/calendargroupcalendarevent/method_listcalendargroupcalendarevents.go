...
func (c CalendarGroupCalendarEventClient) ListCalendarGroupCalendarEvents(ctx context.Context, id beta.MeCalendarGroupIdCalendarId, options ListCalendarGroupCalendarEventsOperationOptions) (result ListCalendarGroupCalendarEventsOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventClient) ListCalendarGroupCalendarEventsComplete(ctx context.Context, id beta.MeCalendarGroupIdCalendarId, options ListCalendarGroupCalendarEventsOperationOptions) (ListCalendarGroupCalendarEventsCompleteResult, error) {
...
func (c CalendarGroupCalendarEventClient) ListCalendarGroupCalendarEventsCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarGroupIdCalendarId, options ListCalendarGroupCalendarEventsOperationOptions, predicate EventOperationPredicate) (result ListCalendarGroupCalendarEventsCompleteResult, err error) {
