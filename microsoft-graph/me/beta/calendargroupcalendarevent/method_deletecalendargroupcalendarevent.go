...
func (c CalendarGroupCalendarEventClient) DeleteCalendarGroupCalendarEvent(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventId, options DeleteCalendarGroupCalendarEventOperationOptions) (result DeleteCalendarGroupCalendarEventOperationResponse, err error) {
