...
func (c CalendarGroupCalendarEventClient) ForwardCalendarGroupCalendarEvent(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventId, input ForwardCalendarGroupCalendarEventRequest) (result ForwardCalendarGroupCalendarEventOperationResponse, err error) {
