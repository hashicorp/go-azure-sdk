...
func (c DriveItemListItemDocumentSetVersionClient) RestoreDriveItemListItemDocumentSetVersion(ctx context.Context, id beta.MeDriveIdItemIdListItemDocumentSetVersionId) (result RestoreDriveItemListItemDocumentSetVersionOperationResponse, err error) {
