...
func (c CalendarGroupCalendarPermissionClient) DeleteCalendarGroupCalendarPermission(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarPermissionId, options DeleteCalendarGroupCalendarPermissionOperationOptions) (result DeleteCalendarGroupCalendarPermissionOperationResponse, err error) {
