...
func (c CalendarGroupCalendarPermissionClient) CreateCalendarGroupCalendarPermission(ctx context.Context, id beta.MeCalendarGroupIdCalendarId, input beta.CalendarPermission) (result CreateCalendarGroupCalendarPermissionOperationResponse, err error) {
