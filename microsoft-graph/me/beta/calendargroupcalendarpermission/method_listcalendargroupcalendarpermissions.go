...
// calendar is shared.
func (c CalendarGroupCalendarPermissionClient) ListCalendarGroupCalendarPermissions(ctx context.Context, id beta.MeCalendarGroupIdCalendarId, options ListCalendarGroupCalendarPermissionsOperationOptions) (result ListCalendarGroupCalendarPermissionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarPermissionClient) ListCalendarGroupCalendarPermissionsComplete(ctx context.Context, id beta.MeCalendarGroupIdCalendarId, options ListCalendarGroupCalendarPermissionsOperationOptions) (ListCalendarGroupCalendarPermissionsCompleteResult, error) {
