...
func (c ContactFolderChildFolderContactPhotoClient) SetContactFolderChildFolderContactPhotoValue(ctx context.Context, id beta.MeContactFolderIdChildFolderIdContactId, input []byte) (result SetContactFolderChildFolderContactPhotoValueOperationResponse, err error) {
