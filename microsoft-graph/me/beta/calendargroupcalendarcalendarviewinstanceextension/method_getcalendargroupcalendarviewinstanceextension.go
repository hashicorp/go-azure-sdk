...
// the event. Nullable.
func (c CalendarGroupCalendarCalendarViewInstanceExtensionClient) GetCalendarGroupCalendarViewInstanceExtension(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExtensionId, options GetCalendarGroupCalendarViewInstanceExtensionOperationOptions) (result GetCalendarGroupCalendarViewInstanceExtensionOperationResponse, err error) {
