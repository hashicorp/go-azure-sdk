...
// ListCalendarViewExceptionOccurrenceInstances - Get instances from me. The occurrences of a recurring series, if the
...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstances(ctx context.Context, id beta.MeCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceInstancesOperationOptions) (result ListCalendarViewExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstancesComplete(ctx context.Context, id beta.MeCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceInstancesOperationOptions) (ListCalendarViewExceptionOccurrenceInstancesCompleteResult, error) {
...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewExceptionOccurrenceInstancesCompleteResult, err error) {
