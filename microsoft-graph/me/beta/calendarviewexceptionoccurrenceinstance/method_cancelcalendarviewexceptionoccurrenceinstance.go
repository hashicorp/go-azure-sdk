...
// cancellation.
func (c CalendarViewExceptionOccurrenceInstanceClient) CancelCalendarViewExceptionOccurrenceInstance(ctx context.Context, id beta.MeCalendarViewIdExceptionOccurrenceIdInstanceId, input CancelCalendarViewExceptionOccurrenceInstanceRequest) (result CancelCalendarViewExceptionOccurrenceInstanceOperationResponse, err error) {
