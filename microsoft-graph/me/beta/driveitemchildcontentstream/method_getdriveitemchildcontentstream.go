...
func (c DriveItemChildContentStreamClient) GetDriveItemChildContentStream(ctx context.Context, id beta.MeDriveIdItemIdChildId) (result GetDriveItemChildContentStreamOperationResponse, err error) {
