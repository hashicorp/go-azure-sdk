...
func (c DriveItemChildContentStreamClient) SetDriveItemChildContentStream(ctx context.Context, id beta.MeDriveIdItemIdChildId, input []byte) (result SetDriveItemChildContentStreamOperationResponse, err error) {
