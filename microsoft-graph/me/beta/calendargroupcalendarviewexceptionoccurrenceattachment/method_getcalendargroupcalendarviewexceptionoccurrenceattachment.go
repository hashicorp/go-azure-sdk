...
// Nullable.
func (c CalendarGroupCalendarViewExceptionOccurrenceAttachmentClient) GetCalendarGroupCalendarViewExceptionOccurrenceAttachment(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdAttachmentId, options GetCalendarGroupCalendarViewExceptionOccurrenceAttachmentOperationOptions) (result GetCalendarGroupCalendarViewExceptionOccurrenceAttachmentOperationResponse, err error) {
