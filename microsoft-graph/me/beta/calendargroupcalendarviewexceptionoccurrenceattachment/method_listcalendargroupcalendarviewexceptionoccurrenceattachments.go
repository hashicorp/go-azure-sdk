...
func (c CalendarGroupCalendarViewExceptionOccurrenceAttachmentClient) ListCalendarGroupCalendarViewExceptionOccurrenceAttachmentsComplete(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, options ListCalendarGroupCalendarViewExceptionOccurrenceAttachmentsOperationOptions) (ListCalendarGroupCalendarViewExceptionOccurrenceAttachmentsCompleteResult, error) {
