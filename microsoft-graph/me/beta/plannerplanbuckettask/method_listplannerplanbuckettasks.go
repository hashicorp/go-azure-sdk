...
func (c PlannerPlanBucketTaskClient) ListPlannerPlanBucketTasks(ctx context.Context, id MePlannerPlanIdBucketId) (result ListPlannerPlanBucketTasksOperationResponse, err error) {
...
func (c PlannerPlanBucketTaskClient) ListPlannerPlanBucketTasksComplete(ctx context.Context, id MePlannerPlanIdBucketId) (ListPlannerPlanBucketTasksCompleteResult, error) {
...
func (c PlannerPlanBucketTaskClient) ListPlannerPlanBucketTasksCompleteMatchingPredicate(ctx context.Context, id MePlannerPlanIdBucketId, predicate PlannerTaskOperationPredicate) (result ListPlannerPlanBucketTasksCompleteResult, err error) {
