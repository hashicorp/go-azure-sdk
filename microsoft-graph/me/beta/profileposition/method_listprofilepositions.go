...
func (c ProfilePositionClient) ListProfilePositions(ctx context.Context) (result ListProfilePositionsOperationResponse, err error) {
...
func (c ProfilePositionClient) ListProfilePositionsComplete(ctx context.Context) (ListProfilePositionsCompleteResult, error) {
	return c.ListProfilePositionsCompleteMatchingPredicate(ctx, WorkPositionOperationPredicate{})
}

// ListProfilePositionsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfilePositionClient) ListProfilePositionsCompleteMatchingPredicate(ctx context.Context, predicate WorkPositionOperationPredicate) (result ListProfilePositionsCompleteResult, err error) {
	items := make([]beta.WorkPosition, 0)

	resp, err := c.ListProfilePositions(ctx)
	if err != nil {
