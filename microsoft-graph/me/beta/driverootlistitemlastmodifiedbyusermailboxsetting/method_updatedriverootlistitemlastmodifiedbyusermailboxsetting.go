...
func (c DriveRootListItemLastModifiedByUserMailboxSettingClient) UpdateDriveRootListItemLastModifiedByUserMailboxSetting(ctx context.Context, id beta.MeDriveId, input beta.MailboxSettings) (result UpdateDriveRootListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
