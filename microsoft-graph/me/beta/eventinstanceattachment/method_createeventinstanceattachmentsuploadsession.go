...
func (c EventInstanceAttachmentClient) CreateEventInstanceAttachmentsUploadSession(ctx context.Context, id beta.MeEventIdInstanceId, input CreateEventInstanceAttachmentsUploadSessionRequest) (result CreateEventInstanceAttachmentsUploadSessionOperationResponse, err error) {
