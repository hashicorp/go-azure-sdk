...
func (c EventInstanceAttachmentClient) CreateEventInstanceAttachment(ctx context.Context, id beta.MeEventIdInstanceId, input beta.Attachment) (result CreateEventInstanceAttachmentOperationResponse, err error) {
