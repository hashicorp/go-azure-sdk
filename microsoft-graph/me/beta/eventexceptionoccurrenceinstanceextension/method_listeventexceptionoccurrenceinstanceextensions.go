...
// ListEventExceptionOccurrenceInstanceExtensions ...
func (c EventExceptionOccurrenceInstanceExtensionClient) ListEventExceptionOccurrenceInstanceExtensions(ctx context.Context, id MeEventIdExceptionOccurrenceIdInstanceId) (result ListEventExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceInstanceExtensionClient) ListEventExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id MeEventIdExceptionOccurrenceIdInstanceId) (ListEventExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
	return c.ListEventExceptionOccurrenceInstanceExtensionsCompleteMatchingPredicate(ctx, id, ExtensionOperationPredicate{})
}
...
func (c EventExceptionOccurrenceInstanceExtensionClient) ListEventExceptionOccurrenceInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id MeEventIdExceptionOccurrenceIdInstanceId, predicate ExtensionOperationPredicate) (result ListEventExceptionOccurrenceInstanceExtensionsCompleteResult, err error) {
	items := make([]beta.Extension, 0)

	resp, err := c.ListEventExceptionOccurrenceInstanceExtensions(ctx, id)
	if err != nil {
