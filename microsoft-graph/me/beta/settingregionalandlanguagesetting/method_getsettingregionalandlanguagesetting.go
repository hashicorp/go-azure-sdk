...
func (c SettingRegionalAndLanguageSettingClient) GetSettingRegionalAndLanguageSetting(ctx context.Context) (result GetSettingRegionalAndLanguageSettingOperationResponse, err error) {
