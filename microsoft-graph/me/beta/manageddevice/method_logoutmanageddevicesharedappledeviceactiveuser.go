...
// device active user
func (c ManagedDeviceClient) LogoutManagedDeviceSharedAppleDeviceActiveUser(ctx context.Context, id beta.MeManagedDeviceId) (result LogoutManagedDeviceSharedAppleDeviceActiveUserOperationResponse, err error) {
