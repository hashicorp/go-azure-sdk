...
func (c ManagedDeviceClient) RequestManagedDeviceRemoteAssistance(ctx context.Context, id beta.MeManagedDeviceId) (result RequestManagedDeviceRemoteAssistanceOperationResponse, err error) {
