...
// device ID.
func (c ManagedDeviceClient) ReprovisionManagedDeviceCloudPC(ctx context.Context, id beta.MeManagedDeviceId) (result ReprovisionManagedDeviceCloudPCOperationResponse, err error) {
