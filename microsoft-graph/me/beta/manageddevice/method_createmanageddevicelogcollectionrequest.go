...
func (c ManagedDeviceClient) CreateManagedDeviceLogCollectionRequest(ctx context.Context, id beta.MeManagedDeviceId, input CreateManagedDeviceLogCollectionRequestRequest) (result CreateManagedDeviceLogCollectionRequestOperationResponse, err error) {
