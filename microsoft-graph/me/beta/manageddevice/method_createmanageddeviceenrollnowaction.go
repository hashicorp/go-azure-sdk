...
func (c ManagedDeviceClient) CreateManagedDeviceEnrollNowAction(ctx context.Context, id beta.MeManagedDeviceId) (result CreateManagedDeviceEnrollNowActionOperationResponse, err error) {
