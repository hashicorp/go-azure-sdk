...
func (c ManagedDeviceClient) ResetManagedDevicePasscode(ctx context.Context, id beta.MeManagedDeviceId) (result ResetManagedDevicePasscodeOperationResponse, err error) {
