...
func (c ManagedDeviceClient) CreateManagedDeviceInitiateMobileDeviceManagementKeyRecovery(ctx context.Context, id beta.MeManagedDeviceId) (result CreateManagedDeviceInitiateMobileDeviceManagementKeyRecoveryOperationResponse, err error) {
