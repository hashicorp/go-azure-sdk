...
func (c ManagedDeviceClient) CreateManagedDeviceRotateBitLockerKey(ctx context.Context, id beta.MeManagedDeviceId) (result CreateManagedDeviceRotateBitLockerKeyOperationResponse, err error) {
