...
func (c ManagedDeviceClient) CreateManagedDeviceInitiateDeviceAttestation(ctx context.Context, id beta.MeManagedDeviceId) (result CreateManagedDeviceInitiateDeviceAttestationOperationResponse, err error) {
