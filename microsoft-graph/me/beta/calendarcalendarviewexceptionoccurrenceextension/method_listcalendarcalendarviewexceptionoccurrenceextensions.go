...
func (c CalendarCalendarViewExceptionOccurrenceExtensionClient) ListCalendarCalendarViewExceptionOccurrenceExtensions(ctx context.Context, id MeCalendarCalendarViewIdExceptionOccurrenceId) (result ListCalendarCalendarViewExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceExtensionClient) ListCalendarCalendarViewExceptionOccurrenceExtensionsComplete(ctx context.Context, id MeCalendarCalendarViewIdExceptionOccurrenceId) (ListCalendarCalendarViewExceptionOccurrenceExtensionsCompleteResult, error) {
...
func (c CalendarCalendarViewExceptionOccurrenceExtensionClient) ListCalendarCalendarViewExceptionOccurrenceExtensionsCompleteMatchingPredicate(ctx context.Context, id MeCalendarCalendarViewIdExceptionOccurrenceId, predicate ExtensionOperationPredicate) (result ListCalendarCalendarViewExceptionOccurrenceExtensionsCompleteResult, err error) {
