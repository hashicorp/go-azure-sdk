...
func (c OnlineMeetingRegistrationRegistrantClient) CreateOnlineMeetingRegistrationRegistrant(ctx context.Context, id MeOnlineMeetingId, input beta.MeetingRegistrantBase) (result CreateOnlineMeetingRegistrationRegistrantOperationResponse, err error) {
