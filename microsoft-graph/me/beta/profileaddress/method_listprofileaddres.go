...
// ListProfileAddres ...
func (c ProfileAddressClient) ListProfileAddres(ctx context.Context) (result ListProfileAddresOperationResponse, err error) {
...
func (c ProfileAddressClient) ListProfileAddresComplete(ctx context.Context) (ListProfileAddresCompleteResult, error) {
	return c.ListProfileAddresCompleteMatchingPredicate(ctx, ItemAddressOperationPredicate{})
}

// ListProfileAddresCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileAddressClient) ListProfileAddresCompleteMatchingPredicate(ctx context.Context, predicate ItemAddressOperationPredicate) (result ListProfileAddresCompleteResult, err error) {
	items := make([]beta.ItemAddress, 0)

	resp, err := c.ListProfileAddres(ctx)
	if err != nil {
