...
func (c TransitiveMemberOfClient) GetTransitiveMemberOfAdministrativeUnit(ctx context.Context, id beta.MeTransitiveMemberOfId, options GetTransitiveMemberOfAdministrativeUnitOperationOptions) (result GetTransitiveMemberOfAdministrativeUnitOperationResponse, err error) {
