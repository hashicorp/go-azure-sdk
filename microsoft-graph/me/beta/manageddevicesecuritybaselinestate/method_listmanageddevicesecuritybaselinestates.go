...
func (c ManagedDeviceSecurityBaselineStateClient) ListManagedDeviceSecurityBaselineStates(ctx context.Context, id MeManagedDeviceId) (result ListManagedDeviceSecurityBaselineStatesOperationResponse, err error) {
...
func (c ManagedDeviceSecurityBaselineStateClient) ListManagedDeviceSecurityBaselineStatesComplete(ctx context.Context, id MeManagedDeviceId) (ListManagedDeviceSecurityBaselineStatesCompleteResult, error) {
...
func (c ManagedDeviceSecurityBaselineStateClient) ListManagedDeviceSecurityBaselineStatesCompleteMatchingPredicate(ctx context.Context, id MeManagedDeviceId, predicate SecurityBaselineStateOperationPredicate) (result ListManagedDeviceSecurityBaselineStatesCompleteResult, err error) {
