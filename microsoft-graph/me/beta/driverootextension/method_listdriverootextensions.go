...
// ListDriveRootExtensions - Get extensions from me. The collection of open extensions defined for this item. Nullable.
func (c DriveRootExtensionClient) ListDriveRootExtensions(ctx context.Context, id beta.MeDriveId, options ListDriveRootExtensionsOperationOptions) (result ListDriveRootExtensionsOperationResponse, err error) {
...
func (c DriveRootExtensionClient) ListDriveRootExtensionsComplete(ctx context.Context, id beta.MeDriveId, options ListDriveRootExtensionsOperationOptions) (ListDriveRootExtensionsCompleteResult, error) {
...
func (c DriveRootExtensionClient) ListDriveRootExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.MeDriveId, options ListDriveRootExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListDriveRootExtensionsCompleteResult, err error) {
