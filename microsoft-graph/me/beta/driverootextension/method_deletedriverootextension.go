...
// DeleteDriveRootExtension - Delete navigation property extensions for me
func (c DriveRootExtensionClient) DeleteDriveRootExtension(ctx context.Context, id beta.MeDriveIdRootExtensionId, options DeleteDriveRootExtensionOperationOptions) (result DeleteDriveRootExtensionOperationResponse, err error) {
