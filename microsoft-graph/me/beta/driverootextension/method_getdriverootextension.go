...
// GetDriveRootExtension - Get extensions from me. The collection of open extensions defined for this item. Nullable.
func (c DriveRootExtensionClient) GetDriveRootExtension(ctx context.Context, id beta.MeDriveIdRootExtensionId, options GetDriveRootExtensionOperationOptions) (result GetDriveRootExtensionOperationResponse, err error) {
