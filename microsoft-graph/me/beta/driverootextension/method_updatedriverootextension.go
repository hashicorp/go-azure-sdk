...
// UpdateDriveRootExtension - Update the navigation property extensions in me
func (c DriveRootExtensionClient) UpdateDriveRootExtension(ctx context.Context, id beta.MeDriveIdRootExtensionId, input beta.Extension, options UpdateDriveRootExtensionOperationOptions) (result UpdateDriveRootExtensionOperationResponse, err error) {
