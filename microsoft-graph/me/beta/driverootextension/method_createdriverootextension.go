...
// CreateDriveRootExtension - Create new navigation property to extensions for me
func (c DriveRootExtensionClient) CreateDriveRootExtension(ctx context.Context, id beta.MeDriveId, input beta.Extension, options CreateDriveRootExtensionOperationOptions) (result CreateDriveRootExtensionOperationResponse, err error) {
