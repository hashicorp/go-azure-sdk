...
func (c CalendarCalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id beta.MeCalendarCalendarViewId, input TentativelyAcceptCalendarViewRequest) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
