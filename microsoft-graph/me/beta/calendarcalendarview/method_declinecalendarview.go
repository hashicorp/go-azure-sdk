...
func (c CalendarCalendarViewClient) DeclineCalendarView(ctx context.Context, id beta.MeCalendarCalendarViewId, input DeclineCalendarViewRequest) (result DeclineCalendarViewOperationResponse, err error) {
