...
func (c CalendarCalendarViewClient) AcceptCalendarView(ctx context.Context, id beta.MeCalendarCalendarViewId, input AcceptCalendarViewRequest) (result AcceptCalendarViewOperationResponse, err error) {
