...
func (c CalendarCalendarViewClient) GetCalendarViewCount(ctx context.Context, options GetCalendarViewCountOperationOptions) (result GetCalendarViewCountOperationResponse, err error) {
