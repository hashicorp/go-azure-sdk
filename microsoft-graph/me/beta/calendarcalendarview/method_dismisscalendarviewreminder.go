...
// in a user calendar.
func (c CalendarCalendarViewClient) DismissCalendarViewReminder(ctx context.Context, id beta.MeCalendarCalendarViewId) (result DismissCalendarViewReminderOperationResponse, err error) {
