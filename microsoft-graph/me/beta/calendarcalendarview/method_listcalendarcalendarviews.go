...
func (c CalendarCalendarViewClient) ListCalendarCalendarViews(ctx context.Context, id MeCalendarId) (result ListCalendarCalendarViewsOperationResponse, err error) {
...
func (c CalendarCalendarViewClient) ListCalendarCalendarViewsComplete(ctx context.Context, id MeCalendarId) (ListCalendarCalendarViewsCompleteResult, error) {
...
func (c CalendarCalendarViewClient) ListCalendarCalendarViewsCompleteMatchingPredicate(ctx context.Context, id MeCalendarId, predicate EventOperationPredicate) (result ListCalendarCalendarViewsCompleteResult, err error) {
