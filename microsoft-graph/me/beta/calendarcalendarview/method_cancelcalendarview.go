...
func (c CalendarCalendarViewClient) CancelCalendarView(ctx context.Context, id beta.MeCalendarCalendarViewId, input CancelCalendarViewRequest) (result CancelCalendarViewOperationResponse, err error) {
