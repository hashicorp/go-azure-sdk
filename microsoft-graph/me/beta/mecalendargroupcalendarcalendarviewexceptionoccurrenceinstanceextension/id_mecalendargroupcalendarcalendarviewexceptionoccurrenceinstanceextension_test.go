...
func TestNewMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	id := NewMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceExtensionID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue")
...
func TestFormatMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	actual := NewMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceExtensionID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue").ID()
...
func TestParseMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceExtensionId(t *testing.T) {
	segments := MeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceExtensionId has no segments")
	}
