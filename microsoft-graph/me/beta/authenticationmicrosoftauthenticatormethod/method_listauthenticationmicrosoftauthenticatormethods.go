...
func (c AuthenticationMicrosoftAuthenticatorMethodClient) ListAuthenticationMicrosoftAuthenticatorMethods(ctx context.Context) (result ListAuthenticationMicrosoftAuthenticatorMethodsOperationResponse, err error) {
...
func (c AuthenticationMicrosoftAuthenticatorMethodClient) ListAuthenticationMicrosoftAuthenticatorMethodsComplete(ctx context.Context) (ListAuthenticationMicrosoftAuthenticatorMethodsCompleteResult, error) {
	return c.ListAuthenticationMicrosoftAuthenticatorMethodsCompleteMatchingPredicate(ctx, MicrosoftAuthenticatorAuthenticationMethodOperationPredicate{})
}
...
func (c AuthenticationMicrosoftAuthenticatorMethodClient) ListAuthenticationMicrosoftAuthenticatorMethodsCompleteMatchingPredicate(ctx context.Context, predicate MicrosoftAuthenticatorAuthenticationMethodOperationPredicate) (result ListAuthenticationMicrosoftAuthenticatorMethodsCompleteResult, err error) {
	items := make([]beta.MicrosoftAuthenticatorAuthenticationMethod, 0)

	resp, err := c.ListAuthenticationMicrosoftAuthenticatorMethods(ctx)
	if err != nil {
