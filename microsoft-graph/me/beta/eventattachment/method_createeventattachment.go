...
func (c EventAttachmentClient) CreateEventAttachment(ctx context.Context, id beta.MeEventId, input beta.Attachment) (result CreateEventAttachmentOperationResponse, err error) {
