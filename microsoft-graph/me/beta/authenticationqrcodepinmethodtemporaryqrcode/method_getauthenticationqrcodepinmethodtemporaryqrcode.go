...
// GetAuthenticationQrCodePinMethodTemporaryQRCode - Get temporaryQRCode from me. Temporary QR code has lifetime up to
// 12 hours. It can be issued when the user doesn't have access to their standard QR code. There can be only one active
// temporary QR code for the user.
func (c AuthenticationQrCodePinMethodTemporaryQRCodeClient) GetAuthenticationQrCodePinMethodTemporaryQRCode(ctx context.Context, options GetAuthenticationQrCodePinMethodTemporaryQRCodeOperationOptions) (result GetAuthenticationQrCodePinMethodTemporaryQRCodeOperationResponse, err error) {
