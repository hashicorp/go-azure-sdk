...
// DeleteAuthenticationQrCodePinMethodTemporaryQRCode - Delete navigation property temporaryQRCode for me
func (c AuthenticationQrCodePinMethodTemporaryQRCodeClient) DeleteAuthenticationQrCodePinMethodTemporaryQRCode(ctx context.Context, options DeleteAuthenticationQrCodePinMethodTemporaryQRCodeOperationOptions) (result DeleteAuthenticationQrCodePinMethodTemporaryQRCodeOperationResponse, err error) {
