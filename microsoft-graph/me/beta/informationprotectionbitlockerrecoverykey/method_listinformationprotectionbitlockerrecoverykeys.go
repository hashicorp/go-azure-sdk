...
func (c InformationProtectionBitlockerRecoveryKeyClient) ListInformationProtectionBitlockerRecoveryKeys(ctx context.Context) (result ListInformationProtectionBitlockerRecoveryKeysOperationResponse, err error) {
...
func (c InformationProtectionBitlockerRecoveryKeyClient) ListInformationProtectionBitlockerRecoveryKeysComplete(ctx context.Context) (ListInformationProtectionBitlockerRecoveryKeysCompleteResult, error) {
	return c.ListInformationProtectionBitlockerRecoveryKeysCompleteMatchingPredicate(ctx, BitlockerRecoveryKeyOperationPredicate{})
}
...
func (c InformationProtectionBitlockerRecoveryKeyClient) ListInformationProtectionBitlockerRecoveryKeysCompleteMatchingPredicate(ctx context.Context, predicate BitlockerRecoveryKeyOperationPredicate) (result ListInformationProtectionBitlockerRecoveryKeysCompleteResult, err error) {
	items := make([]beta.BitlockerRecoveryKey, 0)

	resp, err := c.ListInformationProtectionBitlockerRecoveryKeys(ctx)
	if err != nil {
