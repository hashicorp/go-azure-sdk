...
func (c CalendarCalendarViewInstanceExtensionClient) ListCalendarCalendarViewInstanceExtensions(ctx context.Context, id MeCalendarCalendarViewIdInstanceId) (result ListCalendarCalendarViewInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceExtensionClient) ListCalendarCalendarViewInstanceExtensionsComplete(ctx context.Context, id MeCalendarCalendarViewIdInstanceId) (ListCalendarCalendarViewInstanceExtensionsCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceExtensionClient) ListCalendarCalendarViewInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id MeCalendarCalendarViewIdInstanceId, predicate ExtensionOperationPredicate) (result ListCalendarCalendarViewInstanceExtensionsCompleteResult, err error) {
