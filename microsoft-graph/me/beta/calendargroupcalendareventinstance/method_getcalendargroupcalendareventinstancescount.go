...
func (c CalendarGroupCalendarEventInstanceClient) GetCalendarGroupCalendarEventInstancesCount(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventId, options GetCalendarGroupCalendarEventInstancesCountOperationOptions) (result GetCalendarGroupCalendarEventInstancesCountOperationResponse, err error) {
