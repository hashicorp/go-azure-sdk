...
func (c ChatLastMessagePreviewClient) GetChatLastMessagePreview(ctx context.Context, id MeChatId) (result GetChatLastMessagePreviewOperationResponse, err error) {
