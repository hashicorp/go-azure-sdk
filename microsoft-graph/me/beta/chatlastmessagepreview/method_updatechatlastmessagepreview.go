...
func (c ChatLastMessagePreviewClient) UpdateChatLastMessagePreview(ctx context.Context, id MeChatId, input beta.ChatMessageInfo) (result UpdateChatLastMessagePreviewOperationResponse, err error) {
