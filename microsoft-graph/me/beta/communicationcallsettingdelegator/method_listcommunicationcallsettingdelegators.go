...
// ListCommunicationCallSettingDelegators - List delegators. Get a list of all delegators for a user.
func (c CommunicationCallSettingDelegatorClient) ListCommunicationCallSettingDelegators(ctx context.Context, options ListCommunicationCallSettingDelegatorsOperationOptions) (result ListCommunicationCallSettingDelegatorsOperationResponse, err error) {
...
func (c CommunicationCallSettingDelegatorClient) ListCommunicationCallSettingDelegatorsComplete(ctx context.Context, options ListCommunicationCallSettingDelegatorsOperationOptions) (ListCommunicationCallSettingDelegatorsCompleteResult, error) {
	return c.ListCommunicationCallSettingDelegatorsCompleteMatchingPredicate(ctx, options, DelegationSettingsOperationPredicate{})
}

// ListCommunicationCallSettingDelegatorsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c CommunicationCallSettingDelegatorClient) ListCommunicationCallSettingDelegatorsCompleteMatchingPredicate(ctx context.Context, options ListCommunicationCallSettingDelegatorsOperationOptions, predicate DelegationSettingsOperationPredicate) (result ListCommunicationCallSettingDelegatorsCompleteResult, err error) {
	items := make([]beta.DelegationSettings, 0)

	resp, err := c.ListCommunicationCallSettingDelegators(ctx, options)
	if err != nil {
