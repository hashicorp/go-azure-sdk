...
// UpdateCommunicationCallSettingDelegator - Update the navigation property delegators in me
func (c CommunicationCallSettingDelegatorClient) UpdateCommunicationCallSettingDelegator(ctx context.Context, id beta.MeCommunicationCallSettingDelegatorId, input beta.DelegationSettings, options UpdateCommunicationCallSettingDelegatorOperationOptions) (result UpdateCommunicationCallSettingDelegatorOperationResponse, err error) {
