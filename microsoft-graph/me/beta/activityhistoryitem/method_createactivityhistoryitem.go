...
func (c ActivityHistoryItemClient) CreateActivityHistoryItem(ctx context.Context, id beta.MeActivityId, input beta.ActivityHistoryItem) (result CreateActivityHistoryItemOperationResponse, err error) {
