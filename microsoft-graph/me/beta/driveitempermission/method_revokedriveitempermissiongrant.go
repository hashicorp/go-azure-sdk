...
func (c DriveItemPermissionClient) RevokeDriveItemPermissionGrant(ctx context.Context, id beta.MeDriveIdItemIdPermissionId, input RevokeDriveItemPermissionGrantRequest) (result RevokeDriveItemPermissionGrantOperationResponse, err error) {
