...
func (c MailFolderChildFolderClient) UpdateMailFolderChildFolderAllMessagesReadState(ctx context.Context, id beta.MeMailFolderIdChildFolderId, input UpdateMailFolderChildFolderAllMessagesReadStateRequest, options UpdateMailFolderChildFolderAllMessagesReadStateOperationOptions) (result UpdateMailFolderChildFolderAllMessagesReadStateOperationResponse, err error) {
