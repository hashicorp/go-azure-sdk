...
func (c MailFolderChildFolderClient) CreateMailFolderChildFolderPermanentDelete(ctx context.Context, id beta.MeMailFolderIdChildFolderId, options CreateMailFolderChildFolderPermanentDeleteOperationOptions) (result CreateMailFolderChildFolderPermanentDeleteOperationResponse, err error) {
