...
func (c MailFolderChildFolderClient) CopyMailFolderChildFolder(ctx context.Context, id beta.MeMailFolderIdChildFolderId, input CopyMailFolderChildFolderRequest) (result CopyMailFolderChildFolderOperationResponse, err error) {
