...
func (c MailFolderChildFolderClient) MoveMailFolderChildFolder(ctx context.Context, id beta.MeMailFolderIdChildFolderId, input MoveMailFolderChildFolderRequest) (result MoveMailFolderChildFolderOperationResponse, err error) {
