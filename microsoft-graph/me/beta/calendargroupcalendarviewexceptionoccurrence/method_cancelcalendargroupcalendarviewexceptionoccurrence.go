...
// cancellation.
func (c CalendarGroupCalendarViewExceptionOccurrenceClient) CancelCalendarGroupCalendarViewExceptionOccurrence(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, input CancelCalendarGroupCalendarViewExceptionOccurrenceRequest) (result CancelCalendarGroupCalendarViewExceptionOccurrenceOperationResponse, err error) {
