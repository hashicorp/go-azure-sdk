...
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) ListCalendarViewExceptionOccurrenceInstanceAttachmentsComplete(ctx context.Context, id beta.MeCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId, options ListCalendarViewExceptionOccurrenceInstanceAttachmentsOperationOptions) (ListCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteResult, error) {
