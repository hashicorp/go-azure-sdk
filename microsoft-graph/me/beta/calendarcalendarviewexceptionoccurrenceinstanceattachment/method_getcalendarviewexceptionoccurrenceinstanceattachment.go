...
// GetCalendarViewExceptionOccurrenceInstanceAttachment - Get attachments from me. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) GetCalendarViewExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.MeCalendarCalendarViewIdExceptionOccurrenceIdInstanceIdAttachmentId, options GetCalendarViewExceptionOccurrenceInstanceAttachmentOperationOptions) (result GetCalendarViewExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
