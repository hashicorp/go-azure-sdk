...
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) CreateCalendarViewExceptionOccurrenceInstanceAttachmentsUploadSession(ctx context.Context, id beta.MeCalendarCalendarViewIdExceptionOccurrenceIdInstanceId, input CreateCalendarViewExceptionOccurrenceInstanceAttachmentsUploadSessionRequest) (result CreateCalendarViewExceptionOccurrenceInstanceAttachmentsUploadSessionOperationResponse, err error) {
