...
// DeleteCalendarViewExceptionOccurrenceInstanceAttachment - Delete navigation property attachments for me
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) DeleteCalendarViewExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.MeCalendarCalendarViewIdExceptionOccurrenceIdInstanceIdAttachmentId, options DeleteCalendarViewExceptionOccurrenceInstanceAttachmentOperationOptions) (result DeleteCalendarViewExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
