...
// ListTodoListTasks ...
func (c TodoListTaskClient) ListTodoListTasks(ctx context.Context, id MeTodoListId) (result ListTodoListTasksOperationResponse, err error) {
...
func (c TodoListTaskClient) ListTodoListTasksComplete(ctx context.Context, id MeTodoListId) (ListTodoListTasksCompleteResult, error) {
...
func (c TodoListTaskClient) ListTodoListTasksCompleteMatchingPredicate(ctx context.Context, id MeTodoListId, predicate TodoTaskOperationPredicate) (result ListTodoListTasksCompleteResult, err error) {
