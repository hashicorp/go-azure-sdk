...
func (c DriveItemContentClient) SetDriveItemContent(ctx context.Context, id beta.MeDriveIdItemId, input []byte) (result SetDriveItemContentOperationResponse, err error) {
