...
// DeleteCommunicationCallSettingDelegate - Delete navigation property delegates for me
func (c CommunicationCallSettingDelegateClient) DeleteCommunicationCallSettingDelegate(ctx context.Context, id beta.MeCommunicationCallSettingDelegateId, options DeleteCommunicationCallSettingDelegateOperationOptions) (result DeleteCommunicationCallSettingDelegateOperationResponse, err error) {
