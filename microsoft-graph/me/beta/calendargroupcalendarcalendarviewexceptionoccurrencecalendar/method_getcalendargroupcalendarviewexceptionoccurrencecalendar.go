...
// GetCalendarGroupCalendarViewExceptionOccurrenceCalendar - Get calendar from me. The calendar that contains the event.
// Navigation property. Read-only.
func (c CalendarGroupCalendarCalendarViewExceptionOccurrenceCalendarClient) GetCalendarGroupCalendarViewExceptionOccurrenceCalendar(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, options GetCalendarGroupCalendarViewExceptionOccurrenceCalendarOperationOptions) (result GetCalendarGroupCalendarViewExceptionOccurrenceCalendarOperationResponse, err error) {
