...
func TestNewMeContactFolderContactID(t *testing.T) {
	id := NewMeContactFolderContactID("contactFolderIdValue", "contactIdValue")
...
func TestFormatMeContactFolderContactID(t *testing.T) {
	actual := NewMeContactFolderContactID("contactFolderIdValue", "contactIdValue").ID()
...
func TestParseMeContactFolderContactID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeContactFolderContactId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeContactFolderContactID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeContactFolderContactIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeContactFolderContactId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeContactFolderContactIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeContactFolderContactId(t *testing.T) {
	segments := MeContactFolderContactId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeContactFolderContactId has no segments")
	}
