...
func (c EventExceptionOccurrenceInstanceAttachmentClient) ListEventExceptionOccurrenceInstanceAttachments(ctx context.Context, id MeEventIdExceptionOccurrenceIdInstanceId) (result ListEventExceptionOccurrenceInstanceAttachmentsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceInstanceAttachmentClient) ListEventExceptionOccurrenceInstanceAttachmentsComplete(ctx context.Context, id MeEventIdExceptionOccurrenceIdInstanceId) (ListEventExceptionOccurrenceInstanceAttachmentsCompleteResult, error) {
...
func (c EventExceptionOccurrenceInstanceAttachmentClient) ListEventExceptionOccurrenceInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id MeEventIdExceptionOccurrenceIdInstanceId, predicate AttachmentOperationPredicate) (result ListEventExceptionOccurrenceInstanceAttachmentsCompleteResult, err error) {
