...
func (c ChatMessageReplyClient) ReplyChatMessageRepliesWithQuote(ctx context.Context, id beta.MeChatIdMessageId, input ReplyChatMessageRepliesWithQuoteRequest, options ReplyChatMessageRepliesWithQuoteOperationOptions) (result ReplyChatMessageRepliesWithQuoteOperationResponse, err error) {
