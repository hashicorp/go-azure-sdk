...
func (c ChatMessageReplyHostedContentClient) CreateChatMessageReplyHostedContent(ctx context.Context, id beta.MeChatIdMessageIdReplyId, input beta.ChatMessageHostedContent) (result CreateChatMessageReplyHostedContentOperationResponse, err error) {
