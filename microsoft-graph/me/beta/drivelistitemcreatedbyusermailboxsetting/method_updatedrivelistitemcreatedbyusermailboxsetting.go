...
func (c DriveListItemCreatedByUserMailboxSettingClient) UpdateDriveListItemCreatedByUserMailboxSetting(ctx context.Context, id beta.MeDriveIdListItemId, input beta.MailboxSettings) (result UpdateDriveListItemCreatedByUserMailboxSettingOperationResponse, err error) {
