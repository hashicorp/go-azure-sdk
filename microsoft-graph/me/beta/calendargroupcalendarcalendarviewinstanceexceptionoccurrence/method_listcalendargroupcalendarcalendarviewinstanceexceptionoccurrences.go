...
func (c CalendarGroupCalendarCalendarViewInstanceExceptionOccurrenceClient) ListCalendarGroupCalendarCalendarViewInstanceExceptionOccurrences(ctx context.Context, id MeCalendarGroupIdCalendarIdCalendarViewIdInstanceId) (result ListCalendarGroupCalendarCalendarViewInstanceExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarGroupCalendarCalendarViewInstanceExceptionOccurrenceClient) ListCalendarGroupCalendarCalendarViewInstanceExceptionOccurrencesComplete(ctx context.Context, id MeCalendarGroupIdCalendarIdCalendarViewIdInstanceId) (ListCalendarGroupCalendarCalendarViewInstanceExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarGroupCalendarCalendarViewInstanceExceptionOccurrenceClient) ListCalendarGroupCalendarCalendarViewInstanceExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id MeCalendarGroupIdCalendarIdCalendarViewIdInstanceId, predicate EventOperationPredicate) (result ListCalendarGroupCalendarCalendarViewInstanceExceptionOccurrencesCompleteResult, err error) {
