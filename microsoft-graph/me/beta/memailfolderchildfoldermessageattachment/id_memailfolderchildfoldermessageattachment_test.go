...
func TestNewMeMailFolderChildFolderMessageAttachmentID(t *testing.T) {
	id := NewMeMailFolderChildFolderMessageAttachmentID("mailFolderIdValue", "mailFolderId1Value", "messageIdValue", "attachmentIdValue")
...
func TestFormatMeMailFolderChildFolderMessageAttachmentID(t *testing.T) {
	actual := NewMeMailFolderChildFolderMessageAttachmentID("mailFolderIdValue", "mailFolderId1Value", "messageIdValue", "attachmentIdValue").ID()
	expected := "/me/mailFolders/mailFolderIdValue/childFolders/mailFolderId1Value/messages/messageIdValue/attachments/attachmentIdValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseMeMailFolderChildFolderMessageAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeMailFolderChildFolderMessageAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		{
			// Incomplete URI
			Input: "/me/mailFolders/mailFolderIdValue/childFolders/mailFolderId1Value/messages/messageIdValue/attachments",
			Error: true,
		},
		{
			// Valid URI
			Input: "/me/mailFolders/mailFolderIdValue/childFolders/mailFolderId1Value/messages/messageIdValue/attachments/attachmentIdValue",
			Expected: &MeMailFolderChildFolderMessageAttachmentId{
		...
		},
		{
			...
			Input: "/me/mailFolders/mailFolderIdValue/childFolders/mailFolderId1Value/messages/messageIdValue/attachments/attachmentIdValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseMeMailFolderChildFolderMessageAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeMailFolderChildFolderMessageAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeMailFolderChildFolderMessageAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeMailFolderChildFolderMessageAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeMailFolderChildFolderMessageAttachmentId(t *testing.T) {
	segments := MeMailFolderChildFolderMessageAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeMailFolderChildFolderMessageAttachmentId has no segments")
	}
