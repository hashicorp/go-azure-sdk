...
// DeleteAuthenticationHardwareOathMethodDeviceDevice - Delete navigation property hardwareOathDevices for me
func (c AuthenticationHardwareOathMethodDeviceHardwareOathDeviceClient) DeleteAuthenticationHardwareOathMethodDeviceDevice(ctx context.Context, id beta.MeAuthenticationHardwareOathMethodIdDeviceHardwareOathDeviceId, options DeleteAuthenticationHardwareOathMethodDeviceDeviceOperationOptions) (result DeleteAuthenticationHardwareOathMethodDeviceDeviceOperationResponse, err error) {
