...
func (c EventInstanceExceptionOccurrenceClient) ListEventInstanceExceptionOccurrences(ctx context.Context, id MeEventIdInstanceId) (result ListEventInstanceExceptionOccurrencesOperationResponse, err error) {
...
func (c EventInstanceExceptionOccurrenceClient) ListEventInstanceExceptionOccurrencesComplete(ctx context.Context, id MeEventIdInstanceId) (ListEventInstanceExceptionOccurrencesCompleteResult, error) {
...
func (c EventInstanceExceptionOccurrenceClient) ListEventInstanceExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id MeEventIdInstanceId, predicate EventOperationPredicate) (result ListEventInstanceExceptionOccurrencesCompleteResult, err error) {
