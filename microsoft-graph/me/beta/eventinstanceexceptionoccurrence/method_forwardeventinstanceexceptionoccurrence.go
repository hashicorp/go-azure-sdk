...
func (c EventInstanceExceptionOccurrenceClient) ForwardEventInstanceExceptionOccurrence(ctx context.Context, id beta.MeEventIdInstanceIdExceptionOccurrenceId, input ForwardEventInstanceExceptionOccurrenceRequest) (result ForwardEventInstanceExceptionOccurrenceOperationResponse, err error) {
