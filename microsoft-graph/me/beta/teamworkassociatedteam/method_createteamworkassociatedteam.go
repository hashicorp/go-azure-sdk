...
func (c TeamworkAssociatedTeamClient) CreateTeamworkAssociatedTeam(ctx context.Context, input beta.AssociatedTeamInfo) (result CreateTeamworkAssociatedTeamOperationResponse, err error) {
