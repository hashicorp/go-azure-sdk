...
func (c DriveItemThumbnailClient) CreateDriveItemThumbnail(ctx context.Context, id beta.MeDriveIdItemId, input beta.ThumbnailSet) (result CreateDriveItemThumbnailOperationResponse, err error) {
