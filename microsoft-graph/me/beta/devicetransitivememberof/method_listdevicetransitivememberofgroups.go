...
func (c DeviceTransitiveMemberOfClient) ListDeviceTransitiveMemberOfGroups(ctx context.Context, id beta.MeDeviceId, options ListDeviceTransitiveMemberOfGroupsOperationOptions) (result ListDeviceTransitiveMemberOfGroupsOperationResponse, err error) {
...
func (c DeviceTransitiveMemberOfClient) ListDeviceTransitiveMemberOfGroupsComplete(ctx context.Context, id beta.MeDeviceId, options ListDeviceTransitiveMemberOfGroupsOperationOptions) (ListDeviceTransitiveMemberOfGroupsCompleteResult, error) {
...
func (c DeviceTransitiveMemberOfClient) ListDeviceTransitiveMemberOfGroupsCompleteMatchingPredicate(ctx context.Context, id beta.MeDeviceId, options ListDeviceTransitiveMemberOfGroupsOperationOptions, predicate GroupOperationPredicate) (result ListDeviceTransitiveMemberOfGroupsCompleteResult, err error) {
