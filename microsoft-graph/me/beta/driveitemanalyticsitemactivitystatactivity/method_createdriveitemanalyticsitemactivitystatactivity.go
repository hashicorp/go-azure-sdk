...
func (c DriveItemAnalyticsItemActivityStatActivityClient) CreateDriveItemAnalyticsItemActivityStatActivity(ctx context.Context, id beta.MeDriveIdItemIdAnalyticsItemActivityStatId, input beta.ItemActivity) (result CreateDriveItemAnalyticsItemActivityStatActivityOperationResponse, err error) {
