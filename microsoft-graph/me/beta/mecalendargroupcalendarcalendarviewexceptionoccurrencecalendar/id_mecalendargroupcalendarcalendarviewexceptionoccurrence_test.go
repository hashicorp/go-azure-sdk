...
func TestNewMeCalendarGroupCalendarCalendarViewExceptionOccurrenceID(t *testing.T) {
	id := NewMeCalendarGroupCalendarCalendarViewExceptionOccurrenceID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value")
...
func TestFormatMeCalendarGroupCalendarCalendarViewExceptionOccurrenceID(t *testing.T) {
	actual := NewMeCalendarGroupCalendarCalendarViewExceptionOccurrenceID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value").ID()
...
func TestParseMeCalendarGroupCalendarCalendarViewExceptionOccurrenceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupCalendarCalendarViewExceptionOccurrenceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupCalendarCalendarViewExceptionOccurrenceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarGroupCalendarCalendarViewExceptionOccurrenceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupCalendarCalendarViewExceptionOccurrenceId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupCalendarCalendarViewExceptionOccurrenceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarGroupCalendarCalendarViewExceptionOccurrenceId(t *testing.T) {
	segments := MeCalendarGroupCalendarCalendarViewExceptionOccurrenceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarGroupCalendarCalendarViewExceptionOccurrenceId has no segments")
	}
