...
func (c DataSecurityAndGovernanceSensitivityLabelSublabelClient) GetDataSecurityAndGovernanceSensitivityLabelSublabelsCount(ctx context.Context, id beta.MeDataSecurityAndGovernanceSensitivityLabelId, options GetDataSecurityAndGovernanceSensitivityLabelSublabelsCountOperationOptions) (result GetDataSecurityAndGovernanceSensitivityLabelSublabelsCountOperationResponse, err error) {
