...
func (c PendingAccessReviewInstanceStageClient) ListPendingAccessReviewInstanceStages(ctx context.Context, id MePendingAccessReviewInstanceId) (result ListPendingAccessReviewInstanceStagesOperationResponse, err error) {
...
func (c PendingAccessReviewInstanceStageClient) ListPendingAccessReviewInstanceStagesComplete(ctx context.Context, id MePendingAccessReviewInstanceId) (ListPendingAccessReviewInstanceStagesCompleteResult, error) {
...
func (c PendingAccessReviewInstanceStageClient) ListPendingAccessReviewInstanceStagesCompleteMatchingPredicate(ctx context.Context, id MePendingAccessReviewInstanceId, predicate AccessReviewStageOperationPredicate) (result ListPendingAccessReviewInstanceStagesCompleteResult, err error) {
