...
func (c MessageAttachmentClient) CreateCreatessageAttachmentsUploadSession(ctx context.Context, id beta.MeMessageId, input CreateCreatessageAttachmentsUploadSessionRequest) (result CreateCreatessageAttachmentsUploadSessionOperationResponse, err error) {
