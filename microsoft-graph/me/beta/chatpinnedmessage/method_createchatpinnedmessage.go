...
func (c ChatPinnedMessageClient) CreateChatPinnedMessage(ctx context.Context, id beta.MeChatId, input beta.PinnedChatMessageInfo) (result CreateChatPinnedMessageOperationResponse, err error) {
