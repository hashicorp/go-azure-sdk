...
func TestNewMeCalendarViewInstanceExceptionOccurrenceExtensionID(t *testing.T) {
	id := NewMeCalendarViewInstanceExceptionOccurrenceExtensionID("eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue")
...
func TestFormatMeCalendarViewInstanceExceptionOccurrenceExtensionID(t *testing.T) {
	actual := NewMeCalendarViewInstanceExceptionOccurrenceExtensionID("eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue").ID()
...
func TestParseMeCalendarViewInstanceExceptionOccurrenceExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarViewInstanceExceptionOccurrenceExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarViewInstanceExceptionOccurrenceExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarViewInstanceExceptionOccurrenceExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarViewInstanceExceptionOccurrenceExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarViewInstanceExceptionOccurrenceExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarViewInstanceExceptionOccurrenceExtensionId(t *testing.T) {
	segments := MeCalendarViewInstanceExceptionOccurrenceExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarViewInstanceExceptionOccurrenceExtensionId has no segments")
	}
