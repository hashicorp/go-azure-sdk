...
func (c ContactFolderContactPhotoClient) SetContactFolderContactPhotoValue(ctx context.Context, id beta.MeContactFolderIdContactId, input []byte) (result SetContactFolderContactPhotoValueOperationResponse, err error) {
