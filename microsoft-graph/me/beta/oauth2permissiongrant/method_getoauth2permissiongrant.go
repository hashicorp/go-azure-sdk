...
func (c Oauth2PermissionGrantClient) GetOauth2PermissionGrant(ctx context.Context, id MeOauth2PermissionGrantId) (result GetOauth2PermissionGrantOperationResponse, err error) {
