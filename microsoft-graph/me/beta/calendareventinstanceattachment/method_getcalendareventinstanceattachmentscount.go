...
func (c CalendarEventInstanceAttachmentClient) GetCalendarEventInstanceAttachmentsCount(ctx context.Context, id beta.MeCalendarIdEventIdInstanceId, options GetCalendarEventInstanceAttachmentsCountOperationOptions) (result GetCalendarEventInstanceAttachmentsCountOperationResponse, err error) {
