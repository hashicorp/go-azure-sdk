...
func (c CalendarEventInstanceAttachmentClient) GetCalendarEventInstanceAttachment(ctx context.Context, id beta.MeCalendarEventIdInstanceIdAttachmentId, options GetCalendarEventInstanceAttachmentOperationOptions) (result GetCalendarEventInstanceAttachmentOperationResponse, err error) {
