...
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachments(ctx context.Context, id beta.MeCalendarEventIdInstanceId, options ListCalendarEventInstanceAttachmentsOperationOptions) (result ListCalendarEventInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachmentsComplete(ctx context.Context, id beta.MeCalendarEventIdInstanceId, options ListCalendarEventInstanceAttachmentsOperationOptions) (ListCalendarEventInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarEventIdInstanceId, options ListCalendarEventInstanceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarEventInstanceAttachmentsCompleteResult, err error) {
