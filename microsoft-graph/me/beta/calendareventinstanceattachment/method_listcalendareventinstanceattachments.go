...
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachments(ctx context.Context, id MeCalendarIdEventIdInstanceId) (result ListCalendarEventInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachmentsComplete(ctx context.Context, id MeCalendarIdEventIdInstanceId) (ListCalendarEventInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id MeCalendarIdEventIdInstanceId, predicate AttachmentOperationPredicate) (result ListCalendarEventInstanceAttachmentsCompleteResult, err error) {
