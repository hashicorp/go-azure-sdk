...
func (c CalendarEventAttachmentClient) DeleteCalendarEventAttachment(ctx context.Context, id beta.MeCalendarEventIdAttachmentId, options DeleteCalendarEventAttachmentOperationOptions) (result DeleteCalendarEventAttachmentOperationResponse, err error) {
