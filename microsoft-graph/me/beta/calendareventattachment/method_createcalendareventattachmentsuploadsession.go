...
func (c CalendarEventAttachmentClient) CreateCalendarEventAttachmentsUploadSession(ctx context.Context, id beta.MeCalendarIdEventId, input CreateCalendarEventAttachmentsUploadSessionRequest) (result CreateCalendarEventAttachmentsUploadSessionOperationResponse, err error) {
