...
func (c CalendarEventAttachmentClient) GetCalendarEventAttachment(ctx context.Context, id beta.MeCalendarEventIdAttachmentId, options GetCalendarEventAttachmentOperationOptions) (result GetCalendarEventAttachmentOperationResponse, err error) {
