...
func (c CalendarEventAttachmentClient) GetCalendarEventAttachmentsCount(ctx context.Context, id beta.MeCalendarIdEventId, options GetCalendarEventAttachmentsCountOperationOptions) (result GetCalendarEventAttachmentsCountOperationResponse, err error) {
