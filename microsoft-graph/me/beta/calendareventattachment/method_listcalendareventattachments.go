...
func (c CalendarEventAttachmentClient) ListCalendarEventAttachments(ctx context.Context, id beta.MeCalendarEventId, options ListCalendarEventAttachmentsOperationOptions) (result ListCalendarEventAttachmentsOperationResponse, err error) {
...
func (c CalendarEventAttachmentClient) ListCalendarEventAttachmentsComplete(ctx context.Context, id beta.MeCalendarEventId, options ListCalendarEventAttachmentsOperationOptions) (ListCalendarEventAttachmentsCompleteResult, error) {
...
func (c CalendarEventAttachmentClient) ListCalendarEventAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarEventId, options ListCalendarEventAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarEventAttachmentsCompleteResult, err error) {
