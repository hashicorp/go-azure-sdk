...
// UpdateCommunicationCallSetting - Update the navigation property callSettings in me
func (c CommunicationCallSettingClient) UpdateCommunicationCallSetting(ctx context.Context, input beta.CallSettings, options UpdateCommunicationCallSettingOperationOptions) (result UpdateCommunicationCallSettingOperationResponse, err error) {
