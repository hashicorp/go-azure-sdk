...
func (c ManagedDeviceHealthScriptStateIdPolicyIdPolicyIdDeviceIdDeviceIdClient) UpdateManagedDeviceHealthScriptStateIdPolicyIdPolicyIdDeviceIdDeviceId(ctx context.Context, id beta.MeManagedDeviceId, input beta.DeviceHealthScriptPolicyState) (result UpdateManagedDeviceHealthScriptStateIdPolicyIdPolicyIdDeviceIdDeviceIdOperationResponse, err error) {
