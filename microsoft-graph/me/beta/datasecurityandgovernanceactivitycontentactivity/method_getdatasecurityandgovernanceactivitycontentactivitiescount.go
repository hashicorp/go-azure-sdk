...
func (c DataSecurityAndGovernanceActivityContentActivityClient) GetDataSecurityAndGovernanceActivityContentActivitiesCount(ctx context.Context, options GetDataSecurityAndGovernanceActivityContentActivitiesCountOperationOptions) (result GetDataSecurityAndGovernanceActivityContentActivitiesCountOperationResponse, err error) {
