...
func (c DriveRootListItemClient) CreateDriveRootListItemLink(ctx context.Context, id beta.MeDriveId, input CreateDriveRootListItemLinkRequest) (result CreateDriveRootListItemLinkOperationResponse, err error) {
