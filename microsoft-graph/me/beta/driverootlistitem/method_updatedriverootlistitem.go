...
func (c DriveRootListItemClient) UpdateDriveRootListItem(ctx context.Context, id beta.MeDriveId, input beta.ListItem) (result UpdateDriveRootListItemOperationResponse, err error) {
