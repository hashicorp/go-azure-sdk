...
func (c DriveItemLastModifiedByUserMailboxSettingClient) UpdateDriveItemLastModifiedByUserMailboxSetting(ctx context.Context, id beta.MeDriveIdItemId, input beta.MailboxSettings) (result UpdateDriveItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
