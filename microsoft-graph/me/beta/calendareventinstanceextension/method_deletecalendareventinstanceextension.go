...
func (c CalendarEventInstanceExtensionClient) DeleteCalendarEventInstanceExtension(ctx context.Context, id beta.MeCalendarEventIdInstanceIdExtensionId, options DeleteCalendarEventInstanceExtensionOperationOptions) (result DeleteCalendarEventInstanceExtensionOperationResponse, err error) {
