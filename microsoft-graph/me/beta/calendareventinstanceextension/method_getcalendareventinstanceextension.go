...
// Nullable.
func (c CalendarEventInstanceExtensionClient) GetCalendarEventInstanceExtension(ctx context.Context, id beta.MeCalendarEventIdInstanceIdExtensionId, options GetCalendarEventInstanceExtensionOperationOptions) (result GetCalendarEventInstanceExtensionOperationResponse, err error) {
