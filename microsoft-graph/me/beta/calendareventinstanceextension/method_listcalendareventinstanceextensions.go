...
// event. Nullable.
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensions(ctx context.Context, id beta.MeCalendarEventIdInstanceId, options ListCalendarEventInstanceExtensionsOperationOptions) (result ListCalendarEventInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensionsComplete(ctx context.Context, id beta.MeCalendarEventIdInstanceId, options ListCalendarEventInstanceExtensionsOperationOptions) (ListCalendarEventInstanceExtensionsCompleteResult, error) {
...
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarEventIdInstanceId, options ListCalendarEventInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarEventInstanceExtensionsCompleteResult, err error) {
