...
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensions(ctx context.Context, id MeCalendarEventIdInstanceId) (result ListCalendarEventInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensionsComplete(ctx context.Context, id MeCalendarEventIdInstanceId) (ListCalendarEventInstanceExtensionsCompleteResult, error) {
...
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id MeCalendarEventIdInstanceId, predicate ExtensionOperationPredicate) (result ListCalendarEventInstanceExtensionsCompleteResult, err error) {
