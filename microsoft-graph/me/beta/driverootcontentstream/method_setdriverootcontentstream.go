...
func (c DriveRootContentStreamClient) SetDriveRootContentStream(ctx context.Context, id beta.MeDriveId, input []byte) (result SetDriveRootContentStreamOperationResponse, err error) {
