...
func (c ContactFolderChildFolderContactClient) CreateContactFolderChildFolderContact(ctx context.Context, id beta.MeContactFolderIdChildFolderId, input beta.Contact) (result CreateContactFolderChildFolderContactOperationResponse, err error) {
