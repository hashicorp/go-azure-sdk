...
func (c DriveRootListItemActivityDriveItemContentClient) SetDriveRootListItemActivityDriveItemContent(ctx context.Context, id beta.MeDriveIdRootListItemActivityId, input []byte) (result SetDriveRootListItemActivityDriveItemContentOperationResponse, err error) {
