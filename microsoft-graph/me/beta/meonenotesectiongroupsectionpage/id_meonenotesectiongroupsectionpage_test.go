...
func TestNewMeOnenoteSectionGroupSectionPageID(t *testing.T) {
	id := NewMeOnenoteSectionGroupSectionPageID("sectionGroupIdValue", "onenoteSectionIdValue", "onenotePageIdValue")
...
func TestFormatMeOnenoteSectionGroupSectionPageID(t *testing.T) {
	actual := NewMeOnenoteSectionGroupSectionPageID("sectionGroupIdValue", "onenoteSectionIdValue", "onenotePageIdValue").ID()
	expected := "/me/onenote/sectionGroups/sectionGroupIdValue/sections/onenoteSectionIdValue/pages/onenotePageIdValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseMeOnenoteSectionGroupSectionPageID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeOnenoteSectionGroupSectionPageId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		{
			// Incomplete URI
			Input: "/me/onenote/sectionGroups/sectionGroupIdValue/sections/onenoteSectionIdValue/pages",
			Error: true,
		},
		{
			// Valid URI
			Input: "/me/onenote/sectionGroups/sectionGroupIdValue/sections/onenoteSectionIdValue/pages/onenotePageIdValue",
			Expected: &MeOnenoteSectionGroupSectionPageId{
		...
		},
		{
			...
			Input: "/me/onenote/sectionGroups/sectionGroupIdValue/sections/onenoteSectionIdValue/pages/onenotePageIdValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseMeOnenoteSectionGroupSectionPageID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeOnenoteSectionGroupSectionPageIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeOnenoteSectionGroupSectionPageId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeOnenoteSectionGroupSectionPageIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeOnenoteSectionGroupSectionPageId(t *testing.T) {
	segments := MeOnenoteSectionGroupSectionPageId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeOnenoteSectionGroupSectionPageId has no segments")
	}
