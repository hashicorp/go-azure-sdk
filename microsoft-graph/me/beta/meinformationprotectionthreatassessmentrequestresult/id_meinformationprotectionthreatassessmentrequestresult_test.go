...
func TestNewMeInformationProtectionThreatAssessmentRequestResultID(t *testing.T) {
	id := NewMeInformationProtectionThreatAssessmentRequestResultID("threatAssessmentRequestIdValue", "threatAssessmentResultIdValue")
...
func TestFormatMeInformationProtectionThreatAssessmentRequestResultID(t *testing.T) {
	actual := NewMeInformationProtectionThreatAssessmentRequestResultID("threatAssessmentRequestIdValue", "threatAssessmentResultIdValue").ID()
...
func TestParseMeInformationProtectionThreatAssessmentRequestResultID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeInformationProtectionThreatAssessmentRequestResultId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeInformationProtectionThreatAssessmentRequestResultID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeInformationProtectionThreatAssessmentRequestResultIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeInformationProtectionThreatAssessmentRequestResultId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeInformationProtectionThreatAssessmentRequestResultIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeInformationProtectionThreatAssessmentRequestResultId(t *testing.T) {
	segments := MeInformationProtectionThreatAssessmentRequestResultId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeInformationProtectionThreatAssessmentRequestResultId has no segments")
	}
