...
func TestNewMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceID(t *testing.T) {
	id := NewMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value")
...
func TestFormatMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceID(t *testing.T) {
	actual := NewMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value").ID()
...
func TestParseMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceId(t *testing.T) {
	segments := MeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceId has no segments")
	}
