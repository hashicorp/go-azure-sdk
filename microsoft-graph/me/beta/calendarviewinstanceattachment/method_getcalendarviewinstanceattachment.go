...
func (c CalendarViewInstanceAttachmentClient) GetCalendarViewInstanceAttachment(ctx context.Context, id beta.MeCalendarViewIdInstanceIdAttachmentId, options GetCalendarViewInstanceAttachmentOperationOptions) (result GetCalendarViewInstanceAttachmentOperationResponse, err error) {
