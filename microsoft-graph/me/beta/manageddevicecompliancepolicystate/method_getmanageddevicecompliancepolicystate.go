...
// this device.
func (c ManagedDeviceCompliancePolicyStateClient) GetManagedDeviceCompliancePolicyState(ctx context.Context, id beta.MeManagedDeviceIdDeviceCompliancePolicyStateId, options GetManagedDeviceCompliancePolicyStateOperationOptions) (result GetManagedDeviceCompliancePolicyStateOperationResponse, err error) {
