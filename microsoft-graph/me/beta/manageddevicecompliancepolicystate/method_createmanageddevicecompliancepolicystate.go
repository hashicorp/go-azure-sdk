...
func (c ManagedDeviceCompliancePolicyStateClient) CreateManagedDeviceCompliancePolicyState(ctx context.Context, id beta.MeManagedDeviceId, input beta.DeviceCompliancePolicyState) (result CreateManagedDeviceCompliancePolicyStateOperationResponse, err error) {
