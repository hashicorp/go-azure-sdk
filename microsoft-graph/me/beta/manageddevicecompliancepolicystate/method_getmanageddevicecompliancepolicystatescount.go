...
func (c ManagedDeviceCompliancePolicyStateClient) GetManagedDeviceCompliancePolicyStatesCount(ctx context.Context, id beta.MeManagedDeviceId, options GetManagedDeviceCompliancePolicyStatesCountOperationOptions) (result GetManagedDeviceCompliancePolicyStatesCountOperationResponse, err error) {
