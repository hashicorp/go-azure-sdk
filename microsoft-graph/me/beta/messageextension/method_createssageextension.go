...
// CreatessageExtension - Create openTypeExtension. Create an open extension (openTypeExtension object) and add custom
...
func (c MessageExtensionClient) CreatessageExtension(ctx context.Context, id beta.MeMessageId, input beta.Extension) (result CreatessageExtensionOperationResponse, err error) {
