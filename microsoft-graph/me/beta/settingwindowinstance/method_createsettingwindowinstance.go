...
func (c SettingWindowInstanceClient) CreateSettingWindowInstance(ctx context.Context, id beta.MeSettingWindowId, input beta.WindowsSettingInstance) (result CreateSettingWindowInstanceOperationResponse, err error) {
