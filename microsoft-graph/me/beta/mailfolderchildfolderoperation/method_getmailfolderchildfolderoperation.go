...
// GetMailFolderChildFolderOperation - Get operations from me. The collection of long-running operations in the
// mailFolder.
func (c MailFolderChildFolderOperationClient) GetMailFolderChildFolderOperation(ctx context.Context, id beta.MeMailFolderIdChildFolderIdOperationId, options GetMailFolderChildFolderOperationOperationOptions) (result GetMailFolderChildFolderOperationOperationResponse, err error) {
