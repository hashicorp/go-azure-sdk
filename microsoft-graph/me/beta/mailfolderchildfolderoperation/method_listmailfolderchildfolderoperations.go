...
// ListMailFolderChildFolderOperations - Get operations from me. The collection of long-running operations in the
// mailFolder.
func (c MailFolderChildFolderOperationClient) ListMailFolderChildFolderOperations(ctx context.Context, id beta.MeMailFolderIdChildFolderId, options ListMailFolderChildFolderOperationsOperationOptions) (result ListMailFolderChildFolderOperationsOperationResponse, err error) {
...
func (c MailFolderChildFolderOperationClient) ListMailFolderChildFolderOperationsComplete(ctx context.Context, id beta.MeMailFolderIdChildFolderId, options ListMailFolderChildFolderOperationsOperationOptions) (ListMailFolderChildFolderOperationsCompleteResult, error) {
...
func (c MailFolderChildFolderOperationClient) ListMailFolderChildFolderOperationsCompleteMatchingPredicate(ctx context.Context, id beta.MeMailFolderIdChildFolderId, options ListMailFolderChildFolderOperationsOperationOptions, predicate MailFolderOperationOperationPredicate) (result ListMailFolderChildFolderOperationsCompleteResult, err error) {
