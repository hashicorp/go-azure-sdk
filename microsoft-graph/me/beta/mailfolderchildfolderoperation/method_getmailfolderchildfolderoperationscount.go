...
func (c MailFolderChildFolderOperationClient) GetMailFolderChildFolderOperationsCount(ctx context.Context, id beta.MeMailFolderIdChildFolderId, options GetMailFolderChildFolderOperationsCountOperationOptions) (result GetMailFolderChildFolderOperationsCountOperationResponse, err error) {
