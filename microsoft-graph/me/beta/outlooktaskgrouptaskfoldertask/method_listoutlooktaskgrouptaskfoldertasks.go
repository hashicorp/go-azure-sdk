...
func (c OutlookTaskGroupTaskFolderTaskClient) ListOutlookTaskGroupTaskFolderTasks(ctx context.Context, id MeOutlookTaskGroupIdTaskFolderId) (result ListOutlookTaskGroupTaskFolderTasksOperationResponse, err error) {
...
func (c OutlookTaskGroupTaskFolderTaskClient) ListOutlookTaskGroupTaskFolderTasksComplete(ctx context.Context, id MeOutlookTaskGroupIdTaskFolderId) (ListOutlookTaskGroupTaskFolderTasksCompleteResult, error) {
...
func (c OutlookTaskGroupTaskFolderTaskClient) ListOutlookTaskGroupTaskFolderTasksCompleteMatchingPredicate(ctx context.Context, id MeOutlookTaskGroupIdTaskFolderId, predicate OutlookTaskOperationPredicate) (result ListOutlookTaskGroupTaskFolderTasksCompleteResult, err error) {
