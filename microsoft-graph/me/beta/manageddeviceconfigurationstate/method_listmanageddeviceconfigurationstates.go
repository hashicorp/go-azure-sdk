...
// device.
func (c ManagedDeviceConfigurationStateClient) ListManagedDeviceConfigurationStates(ctx context.Context, id beta.MeManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions) (result ListManagedDeviceConfigurationStatesOperationResponse, err error) {
...
func (c ManagedDeviceConfigurationStateClient) ListManagedDeviceConfigurationStatesComplete(ctx context.Context, id beta.MeManagedDeviceId, options ListManagedDeviceConfigurationStatesOperationOptions) (ListManagedDeviceConfigurationStatesCompleteResult, error) {
