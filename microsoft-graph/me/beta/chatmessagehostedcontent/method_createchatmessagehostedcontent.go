...
func (c ChatMessageHostedContentClient) CreateChatMessageHostedContent(ctx context.Context, id beta.MeChatIdMessageId, input beta.ChatMessageHostedContent) (result CreateChatMessageHostedContentOperationResponse, err error) {
