...
func (c ChatMessageHostedContentClient) GetChatMessageHostedContentValue(ctx context.Context, id beta.MeChatIdMessageIdHostedContentId) (result GetChatMessageHostedContentValueOperationResponse, err error) {
