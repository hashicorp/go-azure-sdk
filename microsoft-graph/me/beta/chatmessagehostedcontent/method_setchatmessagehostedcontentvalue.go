...
func (c ChatMessageHostedContentClient) SetChatMessageHostedContentValue(ctx context.Context, id beta.MeChatIdMessageIdHostedContentId, input []byte) (result SetChatMessageHostedContentValueOperationResponse, err error) {
