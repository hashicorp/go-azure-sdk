...
func (c CalendarViewInstanceClient) ListCalendarViewInstances(ctx context.Context, id MeCalendarViewId) (result ListCalendarViewInstancesOperationResponse, err error) {
...
func (c CalendarViewInstanceClient) ListCalendarViewInstancesComplete(ctx context.Context, id MeCalendarViewId) (ListCalendarViewInstancesCompleteResult, error) {
...
func (c CalendarViewInstanceClient) ListCalendarViewInstancesCompleteMatchingPredicate(ctx context.Context, id MeCalendarViewId, predicate EventOperationPredicate) (result ListCalendarViewInstancesCompleteResult, err error) {
