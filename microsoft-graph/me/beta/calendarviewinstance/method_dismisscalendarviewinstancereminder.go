...
func (c CalendarViewInstanceClient) DismissCalendarViewInstanceReminder(ctx context.Context, id beta.MeCalendarViewIdInstanceId) (result DismissCalendarViewInstanceReminderOperationResponse, err error) {
