...
func (c CalendarViewInstanceClient) TentativelyAcceptCalendarViewInstance(ctx context.Context, id beta.MeCalendarViewIdInstanceId, input TentativelyAcceptCalendarViewInstanceRequest) (result TentativelyAcceptCalendarViewInstanceOperationResponse, err error) {
