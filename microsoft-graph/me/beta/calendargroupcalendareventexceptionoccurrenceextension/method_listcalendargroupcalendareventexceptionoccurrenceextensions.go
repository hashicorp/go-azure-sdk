...
func (c CalendarGroupCalendarEventExceptionOccurrenceExtensionClient) ListCalendarGroupCalendarEventExceptionOccurrenceExtensions(ctx context.Context, id MeCalendarGroupIdCalendarIdEventIdExceptionOccurrenceId) (result ListCalendarGroupCalendarEventExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventExceptionOccurrenceExtensionClient) ListCalendarGroupCalendarEventExceptionOccurrenceExtensionsComplete(ctx context.Context, id MeCalendarGroupIdCalendarIdEventIdExceptionOccurrenceId) (ListCalendarGroupCalendarEventExceptionOccurrenceExtensionsCompleteResult, error) {
