...
func (c DriveItemContentStreamClient) SetDriveItemContentStream(ctx context.Context, id beta.MeDriveIdItemId, input []byte) (result SetDriveItemContentStreamOperationResponse, err error) {
