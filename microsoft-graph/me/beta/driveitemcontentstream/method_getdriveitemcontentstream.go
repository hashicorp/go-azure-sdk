...
func (c DriveItemContentStreamClient) GetDriveItemContentStream(ctx context.Context, id beta.MeDriveIdItemId) (result GetDriveItemContentStreamOperationResponse, err error) {
