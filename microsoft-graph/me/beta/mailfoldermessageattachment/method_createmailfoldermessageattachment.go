...
func (c MailFolderMessageAttachmentClient) CreateMailFolderMessageAttachment(ctx context.Context, id beta.MeMailFolderIdMessageId, input beta.Attachment) (result CreateMailFolderMessageAttachmentOperationResponse, err error) {
