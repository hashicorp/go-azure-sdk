...
func (c MailFolderMessageAttachmentClient) CreateMailFolderMessageAttachmentsUploadSession(ctx context.Context, id beta.MeMailFolderIdMessageId, input CreateMailFolderMessageAttachmentsUploadSessionRequest) (result CreateMailFolderMessageAttachmentsUploadSessionOperationResponse, err error) {
