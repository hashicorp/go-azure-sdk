...
func (c EventExceptionOccurrenceAttachmentClient) ListEventExceptionOccurrenceAttachments(ctx context.Context, id MeEventIdExceptionOccurrenceId) (result ListEventExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceAttachmentClient) ListEventExceptionOccurrenceAttachmentsComplete(ctx context.Context, id MeEventIdExceptionOccurrenceId) (ListEventExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c EventExceptionOccurrenceAttachmentClient) ListEventExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id MeEventIdExceptionOccurrenceId, predicate AttachmentOperationPredicate) (result ListEventExceptionOccurrenceAttachmentsCompleteResult, err error) {
