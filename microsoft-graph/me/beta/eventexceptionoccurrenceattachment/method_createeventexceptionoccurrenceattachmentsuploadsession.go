...
func (c EventExceptionOccurrenceAttachmentClient) CreateEventExceptionOccurrenceAttachmentsUploadSession(ctx context.Context, id beta.MeEventIdExceptionOccurrenceId, input CreateEventExceptionOccurrenceAttachmentsUploadSessionRequest) (result CreateEventExceptionOccurrenceAttachmentsUploadSessionOperationResponse, err error) {
