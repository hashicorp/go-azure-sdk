...
func TestNewMeTodoListTaskLinkedResourceID(t *testing.T) {
	id := NewMeTodoListTaskLinkedResourceID("todoTaskListIdValue", "todoTaskIdValue", "linkedResourceIdValue")
...
func TestFormatMeTodoListTaskLinkedResourceID(t *testing.T) {
	actual := NewMeTodoListTaskLinkedResourceID("todoTaskListIdValue", "todoTaskIdValue", "linkedResourceIdValue").ID()
...
func TestParseMeTodoListTaskLinkedResourceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeTodoListTaskLinkedResourceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeTodoListTaskLinkedResourceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeTodoListTaskLinkedResourceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeTodoListTaskLinkedResourceId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeTodoListTaskLinkedResourceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeTodoListTaskLinkedResourceId(t *testing.T) {
	segments := MeTodoListTaskLinkedResourceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeTodoListTaskLinkedResourceId has no segments")
	}
