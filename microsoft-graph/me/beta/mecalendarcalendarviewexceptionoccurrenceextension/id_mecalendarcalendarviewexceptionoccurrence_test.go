...
func TestNewMeCalendarCalendarViewExceptionOccurrenceID(t *testing.T) {
	id := NewMeCalendarCalendarViewExceptionOccurrenceID("calendarIdValue", "eventIdValue", "eventId1Value")
...
func TestFormatMeCalendarCalendarViewExceptionOccurrenceID(t *testing.T) {
	actual := NewMeCalendarCalendarViewExceptionOccurrenceID("calendarIdValue", "eventIdValue", "eventId1Value").ID()
...
func TestParseMeCalendarCalendarViewExceptionOccurrenceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarCalendarViewExceptionOccurrenceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarCalendarViewExceptionOccurrenceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarCalendarViewExceptionOccurrenceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarCalendarViewExceptionOccurrenceId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarCalendarViewExceptionOccurrenceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarCalendarViewExceptionOccurrenceId(t *testing.T) {
	segments := MeCalendarCalendarViewExceptionOccurrenceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarCalendarViewExceptionOccurrenceId has no segments")
	}
