...
func TestNewMeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceID(t *testing.T) {
	id := NewMeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value")
...
func TestFormatMeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceID(t *testing.T) {
	actual := NewMeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value").ID()
	expected := "/me/calendarGroups/calendarGroupIdValue/calendars/calendarIdValue/calendarView/eventIdValue/exceptionOccurrences/eventId1Value/instances/eventId2Value"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseMeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/me/calendarGroups/calendarGroupIdValue/calendars/calendarIdValue/calendarView/eventIdValue/exceptionOccurrences/eventId1Value/instances/eventId2Value/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId(t *testing.T) {
	segments := MeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId has no segments")
	}
