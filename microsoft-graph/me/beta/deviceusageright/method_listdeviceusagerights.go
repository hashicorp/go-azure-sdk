...
func (c DeviceUsageRightClient) ListDeviceUsageRights(ctx context.Context, id MeDeviceId) (result ListDeviceUsageRightsOperationResponse, err error) {
...
func (c DeviceUsageRightClient) ListDeviceUsageRightsComplete(ctx context.Context, id MeDeviceId) (ListDeviceUsageRightsCompleteResult, error) {
...
func (c DeviceUsageRightClient) ListDeviceUsageRightsCompleteMatchingPredicate(ctx context.Context, id MeDeviceId, predicate UsageRightOperationPredicate) (result ListDeviceUsageRightsCompleteResult, err error) {
