...
func (c DeviceUsageRightClient) CreateDeviceUsageRight(ctx context.Context, id beta.MeDeviceId, input beta.UsageRight) (result CreateDeviceUsageRightOperationResponse, err error) {
