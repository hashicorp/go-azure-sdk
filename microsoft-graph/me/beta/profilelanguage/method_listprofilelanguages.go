...
func (c ProfileLanguageClient) ListProfileLanguages(ctx context.Context) (result ListProfileLanguagesOperationResponse, err error) {
...
func (c ProfileLanguageClient) ListProfileLanguagesComplete(ctx context.Context) (ListProfileLanguagesCompleteResult, error) {
	return c.ListProfileLanguagesCompleteMatchingPredicate(ctx, LanguageProficiencyOperationPredicate{})
}

// ListProfileLanguagesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileLanguageClient) ListProfileLanguagesCompleteMatchingPredicate(ctx context.Context, predicate LanguageProficiencyOperationPredicate) (result ListProfileLanguagesCompleteResult, err error) {
	items := make([]beta.LanguageProficiency, 0)

	resp, err := c.ListProfileLanguages(ctx)
	if err != nil {
