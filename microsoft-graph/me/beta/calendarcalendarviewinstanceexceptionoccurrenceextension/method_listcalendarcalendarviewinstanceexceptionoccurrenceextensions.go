...
func (c CalendarCalendarViewInstanceExceptionOccurrenceExtensionClient) ListCalendarCalendarViewInstanceExceptionOccurrenceExtensions(ctx context.Context, id MeCalendarCalendarViewIdInstanceIdExceptionOccurrenceId) (result ListCalendarCalendarViewInstanceExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceExtensionClient) ListCalendarCalendarViewInstanceExceptionOccurrenceExtensionsComplete(ctx context.Context, id MeCalendarCalendarViewIdInstanceIdExceptionOccurrenceId) (ListCalendarCalendarViewInstanceExceptionOccurrenceExtensionsCompleteResult, error) {
