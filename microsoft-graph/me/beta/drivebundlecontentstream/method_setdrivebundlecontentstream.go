...
func (c DriveBundleContentStreamClient) SetDriveBundleContentStream(ctx context.Context, id beta.MeDriveIdBundleId, input []byte) (result SetDriveBundleContentStreamOperationResponse, err error) {
