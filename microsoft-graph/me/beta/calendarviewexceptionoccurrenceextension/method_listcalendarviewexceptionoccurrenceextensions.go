...
func (c CalendarViewExceptionOccurrenceExtensionClient) ListCalendarViewExceptionOccurrenceExtensions(ctx context.Context, id MeCalendarViewIdExceptionOccurrenceId) (result ListCalendarViewExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceExtensionClient) ListCalendarViewExceptionOccurrenceExtensionsComplete(ctx context.Context, id MeCalendarViewIdExceptionOccurrenceId) (ListCalendarViewExceptionOccurrenceExtensionsCompleteResult, error) {
...
func (c CalendarViewExceptionOccurrenceExtensionClient) ListCalendarViewExceptionOccurrenceExtensionsCompleteMatchingPredicate(ctx context.Context, id MeCalendarViewIdExceptionOccurrenceId, predicate ExtensionOperationPredicate) (result ListCalendarViewExceptionOccurrenceExtensionsCompleteResult, err error) {
