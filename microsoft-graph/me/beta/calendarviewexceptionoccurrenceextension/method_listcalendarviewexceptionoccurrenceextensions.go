...
func (c CalendarViewExceptionOccurrenceExtensionClient) ListCalendarViewExceptionOccurrenceExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarViewExceptionOccurrenceExtensionsCompleteResult, err error) {
