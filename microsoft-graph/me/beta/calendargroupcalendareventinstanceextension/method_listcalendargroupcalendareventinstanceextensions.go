...
func (c CalendarGroupCalendarEventInstanceExtensionClient) ListCalendarGroupCalendarEventInstanceExtensions(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventIdInstanceId, options ListCalendarGroupCalendarEventInstanceExtensionsOperationOptions) (result ListCalendarGroupCalendarEventInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventInstanceExtensionClient) ListCalendarGroupCalendarEventInstanceExtensionsComplete(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventIdInstanceId, options ListCalendarGroupCalendarEventInstanceExtensionsOperationOptions) (ListCalendarGroupCalendarEventInstanceExtensionsCompleteResult, error) {
...
func (c CalendarGroupCalendarEventInstanceExtensionClient) ListCalendarGroupCalendarEventInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventIdInstanceId, options ListCalendarGroupCalendarEventInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarGroupCalendarEventInstanceExtensionsCompleteResult, err error) {
