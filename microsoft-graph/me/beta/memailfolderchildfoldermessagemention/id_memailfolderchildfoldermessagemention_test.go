...
func TestNewMeMailFolderChildFolderMessageMentionID(t *testing.T) {
	id := NewMeMailFolderChildFolderMessageMentionID("mailFolderIdValue", "mailFolderId1Value", "messageIdValue", "mentionIdValue")
...
func TestFormatMeMailFolderChildFolderMessageMentionID(t *testing.T) {
	actual := NewMeMailFolderChildFolderMessageMentionID("mailFolderIdValue", "mailFolderId1Value", "messageIdValue", "mentionIdValue").ID()
...
func TestParseMeMailFolderChildFolderMessageMentionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeMailFolderChildFolderMessageMentionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeMailFolderChildFolderMessageMentionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeMailFolderChildFolderMessageMentionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeMailFolderChildFolderMessageMentionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeMailFolderChildFolderMessageMentionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeMailFolderChildFolderMessageMentionId(t *testing.T) {
	segments := MeMailFolderChildFolderMessageMentionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeMailFolderChildFolderMessageMentionId has no segments")
	}
