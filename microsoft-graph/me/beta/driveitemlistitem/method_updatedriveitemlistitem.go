...
func (c DriveItemListItemClient) UpdateDriveItemListItem(ctx context.Context, id beta.MeDriveIdItemId, input beta.ListItem) (result UpdateDriveItemListItemOperationResponse, err error) {
