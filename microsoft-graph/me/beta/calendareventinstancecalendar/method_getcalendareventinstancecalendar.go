...
// Read-only.
func (c CalendarEventInstanceCalendarClient) GetCalendarEventInstanceCalendar(ctx context.Context, id beta.MeCalendarIdEventIdInstanceId, options GetCalendarEventInstanceCalendarOperationOptions) (result GetCalendarEventInstanceCalendarOperationResponse, err error) {
