...
// GetInformationProtectionSensitivityLabelRight - Get rights from me
func (c InformationProtectionSensitivityLabelRightClient) GetInformationProtectionSensitivityLabelRight(ctx context.Context, id beta.MeInformationProtectionSensitivityLabelId, options GetInformationProtectionSensitivityLabelRightOperationOptions) (result GetInformationProtectionSensitivityLabelRightOperationResponse, err error) {
