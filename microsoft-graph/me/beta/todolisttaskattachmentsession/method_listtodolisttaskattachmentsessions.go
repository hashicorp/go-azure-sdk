...
func (c TodoListTaskAttachmentSessionClient) ListTodoListTaskAttachmentSessions(ctx context.Context, id MeTodoListIdTaskId) (result ListTodoListTaskAttachmentSessionsOperationResponse, err error) {
...
func (c TodoListTaskAttachmentSessionClient) ListTodoListTaskAttachmentSessionsComplete(ctx context.Context, id MeTodoListIdTaskId) (ListTodoListTaskAttachmentSessionsCompleteResult, error) {
...
func (c TodoListTaskAttachmentSessionClient) ListTodoListTaskAttachmentSessionsCompleteMatchingPredicate(ctx context.Context, id MeTodoListIdTaskId, predicate AttachmentSessionOperationPredicate) (result ListTodoListTaskAttachmentSessionsCompleteResult, err error) {
