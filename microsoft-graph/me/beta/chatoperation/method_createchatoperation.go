...
// CreateChatOperation ...
func (c ChatOperationClient) CreateChatOperation(ctx context.Context, id MeChatId, input beta.TeamsAsyncOperation) (result CreateChatOperationOperationResponse, err error) {
