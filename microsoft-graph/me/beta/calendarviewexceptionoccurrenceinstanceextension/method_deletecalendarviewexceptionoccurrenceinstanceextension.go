...
func (c CalendarViewExceptionOccurrenceInstanceExtensionClient) DeleteCalendarViewExceptionOccurrenceInstanceExtension(ctx context.Context, id beta.MeCalendarViewIdExceptionOccurrenceIdInstanceIdExtensionId, options DeleteCalendarViewExceptionOccurrenceInstanceExtensionOperationOptions) (result DeleteCalendarViewExceptionOccurrenceInstanceExtensionOperationResponse, err error) {
