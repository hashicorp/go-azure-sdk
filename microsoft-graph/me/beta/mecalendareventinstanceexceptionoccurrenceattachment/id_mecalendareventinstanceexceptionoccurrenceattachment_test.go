...
func TestNewMeCalendarEventInstanceExceptionOccurrenceAttachmentID(t *testing.T) {
	id := NewMeCalendarEventInstanceExceptionOccurrenceAttachmentID("eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue")
...
func TestFormatMeCalendarEventInstanceExceptionOccurrenceAttachmentID(t *testing.T) {
	actual := NewMeCalendarEventInstanceExceptionOccurrenceAttachmentID("eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue").ID()
...
func TestParseMeCalendarEventInstanceExceptionOccurrenceAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarEventInstanceExceptionOccurrenceAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarEventInstanceExceptionOccurrenceAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarEventInstanceExceptionOccurrenceAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarEventInstanceExceptionOccurrenceAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarEventInstanceExceptionOccurrenceAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarEventInstanceExceptionOccurrenceAttachmentId(t *testing.T) {
	segments := MeCalendarEventInstanceExceptionOccurrenceAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarEventInstanceExceptionOccurrenceAttachmentId has no segments")
	}
