...
func (c DriveCreatedByUserMailboxSettingClient) UpdateDriveCreatedByUserMailboxSetting(ctx context.Context, id beta.MeDriveId, input beta.MailboxSettings) (result UpdateDriveCreatedByUserMailboxSettingOperationResponse, err error) {
