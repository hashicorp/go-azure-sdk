...
func (c DeviceDeviceTemplateClient) GetDeviceTemplateCount(ctx context.Context, id beta.MeDeviceId, options GetDeviceTemplateCountOperationOptions) (result GetDeviceTemplateCountOperationResponse, err error) {
