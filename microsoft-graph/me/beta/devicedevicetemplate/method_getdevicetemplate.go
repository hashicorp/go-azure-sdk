...
// GetDeviceTemplate - Get deviceTemplate from me. Device template used to instantiate this device. Nullable. Read-only.
func (c DeviceDeviceTemplateClient) GetDeviceTemplate(ctx context.Context, id beta.MeDeviceIdDeviceTemplateId, options GetDeviceTemplateOperationOptions) (result GetDeviceTemplateOperationResponse, err error) {
