...
func (c DriveRootChildContentClient) SetDriveRootChildContent(ctx context.Context, id beta.MeDriveIdRootChildId, input []byte) (result SetDriveRootChildContentOperationResponse, err error) {
