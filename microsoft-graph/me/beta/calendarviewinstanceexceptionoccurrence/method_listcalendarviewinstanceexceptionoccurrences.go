...
// ListCalendarViewInstanceExceptionOccurrences - Get exceptionOccurrences from me
func (c CalendarViewInstanceExceptionOccurrenceClient) ListCalendarViewInstanceExceptionOccurrences(ctx context.Context, id beta.MeCalendarViewIdInstanceId, options ListCalendarViewInstanceExceptionOccurrencesOperationOptions) (result ListCalendarViewInstanceExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarViewInstanceExceptionOccurrenceClient) ListCalendarViewInstanceExceptionOccurrencesComplete(ctx context.Context, id beta.MeCalendarViewIdInstanceId, options ListCalendarViewInstanceExceptionOccurrencesOperationOptions) (ListCalendarViewInstanceExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarViewInstanceExceptionOccurrenceClient) ListCalendarViewInstanceExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarViewIdInstanceId, options ListCalendarViewInstanceExceptionOccurrencesOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewInstanceExceptionOccurrencesCompleteResult, err error) {
