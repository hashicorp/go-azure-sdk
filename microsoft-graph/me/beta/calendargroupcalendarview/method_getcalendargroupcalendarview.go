...
// Read-only.
func (c CalendarGroupCalendarViewClient) GetCalendarGroupCalendarView(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewId, options GetCalendarGroupCalendarViewOperationOptions) (result GetCalendarGroupCalendarViewOperationResponse, err error) {
