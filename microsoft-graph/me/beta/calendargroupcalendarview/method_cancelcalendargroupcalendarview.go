...
func (c CalendarGroupCalendarViewClient) CancelCalendarGroupCalendarView(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewId, input CancelCalendarGroupCalendarViewRequest) (result CancelCalendarGroupCalendarViewOperationResponse, err error) {
