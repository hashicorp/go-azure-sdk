...
func (c DriveSpecialContentClient) SetDriveSpecialContent(ctx context.Context, id beta.MeDriveIdSpecialId, input []byte) (result SetDriveSpecialContentOperationResponse, err error) {
