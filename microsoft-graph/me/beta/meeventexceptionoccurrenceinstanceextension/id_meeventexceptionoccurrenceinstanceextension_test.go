...
func TestNewMeEventExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	id := NewMeEventExceptionOccurrenceInstanceExtensionID("eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue")
...
func TestFormatMeEventExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	actual := NewMeEventExceptionOccurrenceInstanceExtensionID("eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue").ID()
...
func TestParseMeEventExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeEventExceptionOccurrenceInstanceExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeEventExceptionOccurrenceInstanceExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeEventExceptionOccurrenceInstanceExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeEventExceptionOccurrenceInstanceExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeEventExceptionOccurrenceInstanceExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeEventExceptionOccurrenceInstanceExtensionId(t *testing.T) {
	segments := MeEventExceptionOccurrenceInstanceExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeEventExceptionOccurrenceInstanceExtensionId has no segments")
	}
