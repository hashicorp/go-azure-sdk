...
// CreateDriveItemExtension - Create new navigation property to extensions for me
func (c DriveItemExtensionClient) CreateDriveItemExtension(ctx context.Context, id beta.MeDriveIdItemId, input beta.Extension, options CreateDriveItemExtensionOperationOptions) (result CreateDriveItemExtensionOperationResponse, err error) {
