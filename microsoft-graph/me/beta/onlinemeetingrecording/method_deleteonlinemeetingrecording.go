...
// DeleteOnlineMeetingRecording - Delete recording for the navigation property onlineMeetings in me. The content stream
// of the recording of a Teams live event. Read-only.
func (c OnlineMeetingRecordingClient) DeleteOnlineMeetingRecording(ctx context.Context, id beta.MeOnlineMeetingId, options DeleteOnlineMeetingRecordingOperationOptions) (result DeleteOnlineMeetingRecordingOperationResponse, err error) {
