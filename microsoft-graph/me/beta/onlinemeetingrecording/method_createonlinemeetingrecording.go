...
func (c OnlineMeetingRecordingClient) CreateOnlineMeetingRecording(ctx context.Context, id beta.MeOnlineMeetingId, input beta.CallRecording) (result CreateOnlineMeetingRecordingOperationResponse, err error) {
