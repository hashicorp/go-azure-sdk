...
// UpdateSecurityInformationProtectionSensitivityLabelParent ...
func (c SecurityInformationProtectionSensitivityLabelParentClient) UpdateSecurityInformationProtectionSensitivityLabelParent(ctx context.Context, id MeSecurityInformationProtectionSensitivityLabelId, input beta.SecuritySensitivityLabel) (result UpdateSecurityInformationProtectionSensitivityLabelParentOperationResponse, err error) {
