...
func (c DriveLastModifiedByUserMailboxSettingClient) UpdateDriveLastModifiedByUserMailboxSetting(ctx context.Context, id beta.MeDriveId, input beta.MailboxSettings) (result UpdateDriveLastModifiedByUserMailboxSettingOperationResponse, err error) {
