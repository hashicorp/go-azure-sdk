...
func (c AppConsentRequestsForApprovalClient) ListAppConsentRequestsForApprovals(ctx context.Context) (result ListAppConsentRequestsForApprovalsOperationResponse, err error) {
...
func (c AppConsentRequestsForApprovalClient) ListAppConsentRequestsForApprovalsComplete(ctx context.Context) (ListAppConsentRequestsForApprovalsCompleteResult, error) {
	return c.ListAppConsentRequestsForApprovalsCompleteMatchingPredicate(ctx, AppConsentRequestOperationPredicate{})
}

// ListAppConsentRequestsForApprovalsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AppConsentRequestsForApprovalClient) ListAppConsentRequestsForApprovalsCompleteMatchingPredicate(ctx context.Context, predicate AppConsentRequestOperationPredicate) (result ListAppConsentRequestsForApprovalsCompleteResult, err error) {
	items := make([]beta.AppConsentRequest, 0)

	resp, err := c.ListAppConsentRequestsForApprovals(ctx)
	if err != nil {
