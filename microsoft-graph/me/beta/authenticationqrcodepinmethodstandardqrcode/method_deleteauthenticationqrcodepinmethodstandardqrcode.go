...
// DeleteAuthenticationQrCodePinMethodStandardQRCode - Delete navigation property standardQRCode for me
func (c AuthenticationQrCodePinMethodStandardQRCodeClient) DeleteAuthenticationQrCodePinMethodStandardQRCode(ctx context.Context, options DeleteAuthenticationQrCodePinMethodStandardQRCodeOperationOptions) (result DeleteAuthenticationQrCodePinMethodStandardQRCodeOperationResponse, err error) {
