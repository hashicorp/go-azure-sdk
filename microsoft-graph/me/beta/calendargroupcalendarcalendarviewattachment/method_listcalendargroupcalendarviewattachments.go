...
func (c CalendarGroupCalendarCalendarViewAttachmentClient) ListCalendarGroupCalendarViewAttachments(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewAttachmentsOperationOptions) (result ListCalendarGroupCalendarViewAttachmentsOperationResponse, err error) {
...
func (c CalendarGroupCalendarCalendarViewAttachmentClient) ListCalendarGroupCalendarViewAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarGroupCalendarViewAttachmentsCompleteResult, err error) {
