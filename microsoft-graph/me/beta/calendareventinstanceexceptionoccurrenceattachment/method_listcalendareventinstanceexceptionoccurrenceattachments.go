...
func (c CalendarEventInstanceExceptionOccurrenceAttachmentClient) ListCalendarEventInstanceExceptionOccurrenceAttachments(ctx context.Context, id MeCalendarIdEventIdInstanceIdExceptionOccurrenceId) (result ListCalendarEventInstanceExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarEventInstanceExceptionOccurrenceAttachmentClient) ListCalendarEventInstanceExceptionOccurrenceAttachmentsComplete(ctx context.Context, id MeCalendarIdEventIdInstanceIdExceptionOccurrenceId) (ListCalendarEventInstanceExceptionOccurrenceAttachmentsCompleteResult, error) {
