...
// GetCalendarEventInstanceExceptionOccurrenceAttachment - Get attachments from me. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarEventInstanceExceptionOccurrenceAttachmentClient) GetCalendarEventInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.MeCalendarIdEventIdInstanceIdExceptionOccurrenceIdAttachmentId, options GetCalendarEventInstanceExceptionOccurrenceAttachmentOperationOptions) (result GetCalendarEventInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
