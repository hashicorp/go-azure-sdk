...
// DeleteCalendarEventInstanceExceptionOccurrenceAttachment - Delete navigation property attachments for me
func (c CalendarEventInstanceExceptionOccurrenceAttachmentClient) DeleteCalendarEventInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.MeCalendarIdEventIdInstanceIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarEventInstanceExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarEventInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
