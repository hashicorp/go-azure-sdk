...
func TestNewMeCalendarCalendarViewInstanceExceptionOccurrenceAttachmentID(t *testing.T) {
	id := NewMeCalendarCalendarViewInstanceExceptionOccurrenceAttachmentID("calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue")
...
func TestFormatMeCalendarCalendarViewInstanceExceptionOccurrenceAttachmentID(t *testing.T) {
	actual := NewMeCalendarCalendarViewInstanceExceptionOccurrenceAttachmentID("calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue").ID()
...
func TestParseMeCalendarCalendarViewInstanceExceptionOccurrenceAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarCalendarViewInstanceExceptionOccurrenceAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarCalendarViewInstanceExceptionOccurrenceAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarCalendarViewInstanceExceptionOccurrenceAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarCalendarViewInstanceExceptionOccurrenceAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarCalendarViewInstanceExceptionOccurrenceAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarCalendarViewInstanceExceptionOccurrenceAttachmentId(t *testing.T) {
	segments := MeCalendarCalendarViewInstanceExceptionOccurrenceAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarCalendarViewInstanceExceptionOccurrenceAttachmentId has no segments")
	}
