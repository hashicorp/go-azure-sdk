...
// DeleteDataSecurityAndGovernanceProtectionScope - Delete navigation property protectionScopes for me
func (c DataSecurityAndGovernanceProtectionScopeClient) DeleteDataSecurityAndGovernanceProtectionScope(ctx context.Context, options DeleteDataSecurityAndGovernanceProtectionScopeOperationOptions) (result DeleteDataSecurityAndGovernanceProtectionScopeOperationResponse, err error) {
