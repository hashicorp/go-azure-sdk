...
// UpdateDataSecurityAndGovernanceProtectionScope - Update the navigation property protectionScopes in me
func (c DataSecurityAndGovernanceProtectionScopeClient) UpdateDataSecurityAndGovernanceProtectionScope(ctx context.Context, input beta.UserProtectionScopeContainer, options UpdateDataSecurityAndGovernanceProtectionScopeOperationOptions) (result UpdateDataSecurityAndGovernanceProtectionScopeOperationResponse, err error) {
