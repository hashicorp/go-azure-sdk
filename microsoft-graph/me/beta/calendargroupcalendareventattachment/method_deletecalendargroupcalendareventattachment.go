...
func (c CalendarGroupCalendarEventAttachmentClient) DeleteCalendarGroupCalendarEventAttachment(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventIdAttachmentId, options DeleteCalendarGroupCalendarEventAttachmentOperationOptions) (result DeleteCalendarGroupCalendarEventAttachmentOperationResponse, err error) {
