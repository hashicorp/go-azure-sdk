...
func (c CalendarGroupCalendarEventAttachmentClient) CreateCalendarGroupCalendarEventAttachmentsUploadSession(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventId, input CreateCalendarGroupCalendarEventAttachmentsUploadSessionRequest) (result CreateCalendarGroupCalendarEventAttachmentsUploadSessionOperationResponse, err error) {
