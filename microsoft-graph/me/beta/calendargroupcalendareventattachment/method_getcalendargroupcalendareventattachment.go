...
func (c CalendarGroupCalendarEventAttachmentClient) GetCalendarGroupCalendarEventAttachment(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventIdAttachmentId, options GetCalendarGroupCalendarEventAttachmentOperationOptions) (result GetCalendarGroupCalendarEventAttachmentOperationResponse, err error) {
