...
// ListTodoLists ...
func (c TodoListClient) ListTodoLists(ctx context.Context) (result ListTodoListsOperationResponse, err error) {
...
func (c TodoListClient) ListTodoListsComplete(ctx context.Context) (ListTodoListsCompleteResult, error) {
	return c.ListTodoListsCompleteMatchingPredicate(ctx, TodoTaskListOperationPredicate{})
}

// ListTodoListsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c TodoListClient) ListTodoListsCompleteMatchingPredicate(ctx context.Context, predicate TodoTaskListOperationPredicate) (result ListTodoListsCompleteResult, err error) {
	items := make([]beta.TodoTaskList, 0)

	resp, err := c.ListTodoLists(ctx)
	if err != nil {
