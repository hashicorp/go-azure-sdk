...
func (c DriveRootContentClient) SetDriveRootContent(ctx context.Context, id beta.MeDriveId, input []byte) (result SetDriveRootContentOperationResponse, err error) {
