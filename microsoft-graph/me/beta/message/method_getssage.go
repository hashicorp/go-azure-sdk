...
type GetssageOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        beta.Message
}

type GetssageOperationOptions struct {
	Expand *odata.Expand
	Select *[]string
}

func DefaultGetssageOperationOptions() GetssageOperationOptions {
	return GetssageOperationOptions{}
}

func (o GetssageOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o GetssageOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Expand != nil {
		out.Expand = *o.Expand
	}
...
func (o GetssageOperationOptions) ToQuery() *client.QueryParams {
	out := client.QueryParams{}

	return &out
}

// Getssage - Get singleValueLegacyExtendedProperty. You can get a single resource instance expanded with a specific
...
func (c MessageClient) Getssage(ctx context.Context, id beta.MeMessageId, options GetssageOperationOptions) (result GetssageOperationResponse, err error) {
