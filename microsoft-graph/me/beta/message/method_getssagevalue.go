...
// GetssageValue - Get openTypeExtension. Get an open extension (openTypeExtension object) identified by name or fully
...
func (c MessageClient) GetssageValue(ctx context.Context, id beta.MeMessageId, options GetssageValueOperationOptions) (result GetssageValueOperationResponse, err error) {
