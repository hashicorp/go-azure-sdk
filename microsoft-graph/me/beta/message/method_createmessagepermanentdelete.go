...
// quotas.
func (c MessageClient) CreateMessagePermanentDelete(ctx context.Context, id beta.MeMessageId, options CreateMessagePermanentDeleteOperationOptions) (result CreateMessagePermanentDeleteOperationResponse, err error) {
