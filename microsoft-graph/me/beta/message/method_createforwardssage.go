...
func (c MessageClient) CreateForwardssage(ctx context.Context, id beta.MeMessageId, input CreateForwardssageRequest) (result CreateForwardssageOperationResponse, err error) {
