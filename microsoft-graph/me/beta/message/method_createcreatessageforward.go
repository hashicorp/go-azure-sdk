...
func (c MessageClient) CreateCreatessageForward(ctx context.Context, id beta.MeMessageId, input CreateCreatessageForwardRequest) (result CreateCreatessageForwardOperationResponse, err error) {
