...
// DeleteEmployeeExperienceAssignedRole - Delete navigation property assignedRoles for me
func (c EmployeeExperienceAssignedRoleClient) DeleteEmployeeExperienceAssignedRole(ctx context.Context, id beta.MeEmployeeExperienceAssignedRoleId, options DeleteEmployeeExperienceAssignedRoleOperationOptions) (result DeleteEmployeeExperienceAssignedRoleOperationResponse, err error) {
