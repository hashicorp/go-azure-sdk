...
// UpdateEmployeeExperienceAssignedRole - Update the navigation property assignedRoles in me
func (c EmployeeExperienceAssignedRoleClient) UpdateEmployeeExperienceAssignedRole(ctx context.Context, id beta.MeEmployeeExperienceAssignedRoleId, input beta.EngagementRole, options UpdateEmployeeExperienceAssignedRoleOperationOptions) (result UpdateEmployeeExperienceAssignedRoleOperationResponse, err error) {
