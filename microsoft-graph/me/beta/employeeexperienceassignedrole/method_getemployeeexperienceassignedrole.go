...
// GetEmployeeExperienceAssignedRole - Get assignedRoles from me. Represents the collection of Viva Engage roles
// assigned to a user.
func (c EmployeeExperienceAssignedRoleClient) GetEmployeeExperienceAssignedRole(ctx context.Context, id beta.MeEmployeeExperienceAssignedRoleId, options GetEmployeeExperienceAssignedRoleOperationOptions) (result GetEmployeeExperienceAssignedRoleOperationResponse, err error) {
