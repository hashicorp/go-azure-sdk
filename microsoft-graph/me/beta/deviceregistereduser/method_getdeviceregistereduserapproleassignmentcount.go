...
func (c DeviceRegisteredUserClient) GetDeviceRegisteredUserAppRoleAssignmentCount(ctx context.Context, id beta.MeDeviceId, options GetDeviceRegisteredUserAppRoleAssignmentCountOperationOptions) (result GetDeviceRegisteredUserAppRoleAssignmentCountOperationResponse, err error) {
