...
func (c DeviceRegisteredUserClient) GetDeviceRegisteredUserServicePrincipal(ctx context.Context, id beta.MeDeviceIdRegisteredUserId, options GetDeviceRegisteredUserServicePrincipalOperationOptions) (result GetDeviceRegisteredUserServicePrincipalOperationResponse, err error) {
