...
// collection
func (c DeviceRegisteredUserClient) ListDeviceRegisteredUserUsers(ctx context.Context, id beta.MeDeviceId, options ListDeviceRegisteredUserUsersOperationOptions) (result ListDeviceRegisteredUserUsersOperationResponse, err error) {
...
func (c DeviceRegisteredUserClient) ListDeviceRegisteredUserUsersComplete(ctx context.Context, id beta.MeDeviceId, options ListDeviceRegisteredUserUsersOperationOptions) (ListDeviceRegisteredUserUsersCompleteResult, error) {
...
func (c DeviceRegisteredUserClient) ListDeviceRegisteredUserUsersCompleteMatchingPredicate(ctx context.Context, id beta.MeDeviceId, options ListDeviceRegisteredUserUsersOperationOptions, predicate UserOperationPredicate) (result ListDeviceRegisteredUserUsersCompleteResult, err error) {
