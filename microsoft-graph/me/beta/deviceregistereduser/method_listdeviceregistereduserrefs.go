...
func (c DeviceRegisteredUserClient) ListDeviceRegisteredUserRefs(ctx context.Context, id MeDeviceId) (result ListDeviceRegisteredUserRefsOperationResponse, err error) {
...
func (c DeviceRegisteredUserClient) ListDeviceRegisteredUserRefsComplete(ctx context.Context, id MeDeviceId) (result ListDeviceRegisteredUserRefsCompleteResult, err error) {
	items := make([]string, 0)
