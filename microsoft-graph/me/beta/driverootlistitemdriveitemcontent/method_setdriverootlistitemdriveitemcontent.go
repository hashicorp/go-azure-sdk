...
func (c DriveRootListItemDriveItemContentClient) SetDriveRootListItemDriveItemContent(ctx context.Context, id beta.MeDriveId, input []byte) (result SetDriveRootListItemDriveItemContentOperationResponse, err error) {
