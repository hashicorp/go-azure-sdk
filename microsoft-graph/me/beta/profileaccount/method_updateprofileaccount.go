...
// user's profile.
func (c ProfileAccountClient) UpdateProfileAccount(ctx context.Context, id beta.MeProfileAccountId, input beta.UserAccountInformation) (result UpdateProfileAccountOperationResponse, err error) {
