...
// ListProfileAccounts ...
func (c ProfileAccountClient) ListProfileAccounts(ctx context.Context) (result ListProfileAccountsOperationResponse, err error) {
...
func (c ProfileAccountClient) ListProfileAccountsComplete(ctx context.Context) (ListProfileAccountsCompleteResult, error) {
	return c.ListProfileAccountsCompleteMatchingPredicate(ctx, UserAccountInformationOperationPredicate{})
}

// ListProfileAccountsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileAccountClient) ListProfileAccountsCompleteMatchingPredicate(ctx context.Context, predicate UserAccountInformationOperationPredicate) (result ListProfileAccountsCompleteResult, err error) {
	items := make([]beta.UserAccountInformation, 0)

	resp, err := c.ListProfileAccounts(ctx)
	if err != nil {
