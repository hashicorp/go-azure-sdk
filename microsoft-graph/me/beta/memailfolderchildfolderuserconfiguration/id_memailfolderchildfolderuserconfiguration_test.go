...
func TestNewMeMailFolderChildFolderUserConfigurationID(t *testing.T) {
	id := NewMeMailFolderChildFolderUserConfigurationID("mailFolderIdValue", "mailFolderId1Value", "userConfigurationIdValue")
...
func TestFormatMeMailFolderChildFolderUserConfigurationID(t *testing.T) {
	actual := NewMeMailFolderChildFolderUserConfigurationID("mailFolderIdValue", "mailFolderId1Value", "userConfigurationIdValue").ID()
...
func TestParseMeMailFolderChildFolderUserConfigurationID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeMailFolderChildFolderUserConfigurationId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeMailFolderChildFolderUserConfigurationID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeMailFolderChildFolderUserConfigurationIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeMailFolderChildFolderUserConfigurationId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeMailFolderChildFolderUserConfigurationIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeMailFolderChildFolderUserConfigurationId(t *testing.T) {
	segments := MeMailFolderChildFolderUserConfigurationId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeMailFolderChildFolderUserConfigurationId has no segments")
	}
