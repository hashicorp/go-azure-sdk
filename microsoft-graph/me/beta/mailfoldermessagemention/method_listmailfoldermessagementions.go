...
func (c MailFolderMessageMentionClient) ListMailFolderMessageMentions(ctx context.Context, id MeMailFolderIdMessageId) (result ListMailFolderMessageMentionsOperationResponse, err error) {
...
func (c MailFolderMessageMentionClient) ListMailFolderMessageMentionsComplete(ctx context.Context, id MeMailFolderIdMessageId) (ListMailFolderMessageMentionsCompleteResult, error) {
...
func (c MailFolderMessageMentionClient) ListMailFolderMessageMentionsCompleteMatchingPredicate(ctx context.Context, id MeMailFolderIdMessageId, predicate MentionOperationPredicate) (result ListMailFolderMessageMentionsCompleteResult, err error) {
