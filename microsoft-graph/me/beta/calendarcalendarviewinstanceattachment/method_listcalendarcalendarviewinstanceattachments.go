...
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarCalendarViewInstanceAttachments(ctx context.Context, id MeCalendarIdCalendarViewIdInstanceId) (result ListCalendarCalendarViewInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarCalendarViewInstanceAttachmentsComplete(ctx context.Context, id MeCalendarIdCalendarViewIdInstanceId) (ListCalendarCalendarViewInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarCalendarViewInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id MeCalendarIdCalendarViewIdInstanceId, predicate AttachmentOperationPredicate) (result ListCalendarCalendarViewInstanceAttachmentsCompleteResult, err error) {
