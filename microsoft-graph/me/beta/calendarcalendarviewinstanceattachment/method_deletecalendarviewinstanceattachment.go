...
func (c CalendarCalendarViewInstanceAttachmentClient) DeleteCalendarViewInstanceAttachment(ctx context.Context, id beta.MeCalendarCalendarViewIdInstanceIdAttachmentId, options DeleteCalendarViewInstanceAttachmentOperationOptions) (result DeleteCalendarViewInstanceAttachmentOperationResponse, err error) {
