...
func (c EventClient) TentativelyAcceptEvent(ctx context.Context, id beta.MeEventId, input TentativelyAcceptEventRequest) (result TentativelyAcceptEventOperationResponse, err error) {
