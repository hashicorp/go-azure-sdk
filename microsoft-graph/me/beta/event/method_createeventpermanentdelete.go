...
// quotas.
func (c EventClient) CreateEventPermanentDelete(ctx context.Context, id beta.MeEventId, options CreateEventPermanentDeleteOperationOptions) (result CreateEventPermanentDeleteOperationResponse, err error) {
