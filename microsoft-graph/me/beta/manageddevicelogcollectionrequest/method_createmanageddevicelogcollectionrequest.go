...
func (c ManagedDeviceLogCollectionRequestClient) CreateManagedDeviceLogCollectionRequest(ctx context.Context, id beta.MeManagedDeviceId, input beta.DeviceLogCollectionResponse) (result CreateManagedDeviceLogCollectionRequestOperationResponse, err error) {
