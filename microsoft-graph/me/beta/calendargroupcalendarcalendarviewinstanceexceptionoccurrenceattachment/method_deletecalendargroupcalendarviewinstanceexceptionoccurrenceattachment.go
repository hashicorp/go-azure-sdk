...
// DeleteCalendarGroupCalendarViewInstanceExceptionOccurrenceAttachment - Delete navigation property attachments for me
func (c CalendarGroupCalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) DeleteCalendarGroupCalendarViewInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarGroupCalendarViewInstanceExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarGroupCalendarViewInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
