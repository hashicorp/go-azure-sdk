...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachments(ctx context.Context, id MeCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId) (result ListCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentsComplete(ctx context.Context, id MeCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId) (ListCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id MeCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId, predicate AttachmentOperationPredicate) (result ListCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentsCompleteResult, err error) {
