...
func (c SecurityInformationProtectionClient) GetSecurityInformationProtection(ctx context.Context) (result GetSecurityInformationProtectionOperationResponse, err error) {
