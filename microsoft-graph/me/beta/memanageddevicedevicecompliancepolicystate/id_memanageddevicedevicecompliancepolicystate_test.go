...
func TestNewMeManagedDeviceDeviceCompliancePolicyStateID(t *testing.T) {
	id := NewMeManagedDeviceDeviceCompliancePolicyStateID("managedDeviceIdValue", "deviceCompliancePolicyStateIdValue")
...
func TestFormatMeManagedDeviceDeviceCompliancePolicyStateID(t *testing.T) {
	actual := NewMeManagedDeviceDeviceCompliancePolicyStateID("managedDeviceIdValue", "deviceCompliancePolicyStateIdValue").ID()
...
func TestParseMeManagedDeviceDeviceCompliancePolicyStateID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeManagedDeviceDeviceCompliancePolicyStateId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeManagedDeviceDeviceCompliancePolicyStateID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeManagedDeviceDeviceCompliancePolicyStateIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeManagedDeviceDeviceCompliancePolicyStateId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeManagedDeviceDeviceCompliancePolicyStateIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeManagedDeviceDeviceCompliancePolicyStateId(t *testing.T) {
	segments := MeManagedDeviceDeviceCompliancePolicyStateId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeManagedDeviceDeviceCompliancePolicyStateId has no segments")
	}
