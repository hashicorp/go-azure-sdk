...
func (c ManagedDeviceAssignmentFilterEvaluationStatusDetailClient) CreateManagedDeviceAssignmentFilterEvaluationStatusDetail(ctx context.Context, id MeManagedDeviceId, input beta.AssignmentFilterEvaluationStatusDetails) (result CreateManagedDeviceAssignmentFilterEvaluationStatusDetailOperationResponse, err error) {
