...
func (c AuthenticationEmailMethodClient) ListAuthenticationEmailMethods(ctx context.Context) (result ListAuthenticationEmailMethodsOperationResponse, err error) {
...
func (c AuthenticationEmailMethodClient) ListAuthenticationEmailMethodsComplete(ctx context.Context) (ListAuthenticationEmailMethodsCompleteResult, error) {
	return c.ListAuthenticationEmailMethodsCompleteMatchingPredicate(ctx, EmailAuthenticationMethodOperationPredicate{})
}

// ListAuthenticationEmailMethodsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AuthenticationEmailMethodClient) ListAuthenticationEmailMethodsCompleteMatchingPredicate(ctx context.Context, predicate EmailAuthenticationMethodOperationPredicate) (result ListAuthenticationEmailMethodsCompleteResult, err error) {
	items := make([]beta.EmailAuthenticationMethod, 0)

	resp, err := c.ListAuthenticationEmailMethods(ctx)
	if err != nil {
