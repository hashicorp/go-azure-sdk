...
func (c OnlineMeetingMeetingAttendanceReportAttendanceRecordClient) ListOnlineMeetingMeetingAttendanceReportAttendanceRecords(ctx context.Context, id MeOnlineMeetingId) (result ListOnlineMeetingMeetingAttendanceReportAttendanceRecordsOperationResponse, err error) {
...
func (c OnlineMeetingMeetingAttendanceReportAttendanceRecordClient) ListOnlineMeetingMeetingAttendanceReportAttendanceRecordsComplete(ctx context.Context, id MeOnlineMeetingId) (ListOnlineMeetingMeetingAttendanceReportAttendanceRecordsCompleteResult, error) {
...
func (c OnlineMeetingMeetingAttendanceReportAttendanceRecordClient) ListOnlineMeetingMeetingAttendanceReportAttendanceRecordsCompleteMatchingPredicate(ctx context.Context, id MeOnlineMeetingId, predicate AttendanceRecordOperationPredicate) (result ListOnlineMeetingMeetingAttendanceReportAttendanceRecordsCompleteResult, err error) {
