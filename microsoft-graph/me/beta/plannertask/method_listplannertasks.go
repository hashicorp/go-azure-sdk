...
// ListPlannerTasks ...
func (c PlannerTaskClient) ListPlannerTasks(ctx context.Context) (result ListPlannerTasksOperationResponse, err error) {
...
func (c PlannerTaskClient) ListPlannerTasksComplete(ctx context.Context) (ListPlannerTasksCompleteResult, error) {
	return c.ListPlannerTasksCompleteMatchingPredicate(ctx, PlannerTaskOperationPredicate{})
}

// ListPlannerTasksCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c PlannerTaskClient) ListPlannerTasksCompleteMatchingPredicate(ctx context.Context, predicate PlannerTaskOperationPredicate) (result ListPlannerTasksCompleteResult, err error) {
	items := make([]beta.PlannerTask, 0)

	resp, err := c.ListPlannerTasks(ctx)
	if err != nil {
