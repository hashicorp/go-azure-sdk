...
func (c ManagedDeviceDeviceHealthScriptStateClient) ListManagedDeviceDeviceHealthScriptStates(ctx context.Context, id MeManagedDeviceId) (result ListManagedDeviceDeviceHealthScriptStatesOperationResponse, err error) {
...
func (c ManagedDeviceDeviceHealthScriptStateClient) ListManagedDeviceDeviceHealthScriptStatesComplete(ctx context.Context, id MeManagedDeviceId) (ListManagedDeviceDeviceHealthScriptStatesCompleteResult, error) {
...
func (c ManagedDeviceDeviceHealthScriptStateClient) ListManagedDeviceDeviceHealthScriptStatesCompleteMatchingPredicate(ctx context.Context, id MeManagedDeviceId, predicate DeviceHealthScriptPolicyStateOperationPredicate) (result ListManagedDeviceDeviceHealthScriptStatesCompleteResult, err error) {
