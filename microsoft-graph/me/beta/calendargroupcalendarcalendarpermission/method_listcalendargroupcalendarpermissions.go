...
// calendar is shared.
func (c CalendarGroupCalendarCalendarPermissionClient) ListCalendarGroupCalendarPermissions(ctx context.Context, id beta.MeCalendarGroupIdCalendarId, options ListCalendarGroupCalendarPermissionsOperationOptions) (result ListCalendarGroupCalendarPermissionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarCalendarPermissionClient) ListCalendarGroupCalendarPermissionsComplete(ctx context.Context, id beta.MeCalendarGroupIdCalendarId, options ListCalendarGroupCalendarPermissionsOperationOptions) (ListCalendarGroupCalendarPermissionsCompleteResult, error) {
...
func (c CalendarGroupCalendarCalendarPermissionClient) ListCalendarGroupCalendarPermissionsCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarGroupIdCalendarId, options ListCalendarGroupCalendarPermissionsOperationOptions, predicate CalendarPermissionOperationPredicate) (result ListCalendarGroupCalendarPermissionsCompleteResult, err error) {
