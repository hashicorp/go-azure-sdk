...
func (c CalendarGroupCalendarCalendarPermissionClient) CreateCalendarGroupCalendarPermission(ctx context.Context, id beta.MeCalendarGroupIdCalendarId, input beta.CalendarPermission) (result CreateCalendarGroupCalendarPermissionOperationResponse, err error) {
