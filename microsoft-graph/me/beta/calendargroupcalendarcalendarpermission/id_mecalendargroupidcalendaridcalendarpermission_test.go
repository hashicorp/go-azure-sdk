...
func TestNewMeCalendarGroupIdCalendarIdCalendarPermissionID(t *testing.T) {
	id := NewMeCalendarGroupIdCalendarIdCalendarPermissionID("calendarGroupIdValue", "calendarIdValue", "calendarPermissionIdValue")
...
func TestFormatMeCalendarGroupIdCalendarIdCalendarPermissionID(t *testing.T) {
	actual := NewMeCalendarGroupIdCalendarIdCalendarPermissionID("calendarGroupIdValue", "calendarIdValue", "calendarPermissionIdValue").ID()
...
func TestParseMeCalendarGroupIdCalendarIdCalendarPermissionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupIdCalendarIdCalendarPermissionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupIdCalendarIdCalendarPermissionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarGroupIdCalendarIdCalendarPermissionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupIdCalendarIdCalendarPermissionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupIdCalendarIdCalendarPermissionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarGroupIdCalendarIdCalendarPermissionId(t *testing.T) {
	segments := MeCalendarGroupIdCalendarIdCalendarPermissionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarGroupIdCalendarIdCalendarPermissionId has no segments")
	}
