...
// DeleteCalendarGroupCalendarPermission - Delete navigation property calendarPermissions for me
func (c CalendarGroupCalendarCalendarPermissionClient) DeleteCalendarGroupCalendarPermission(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarPermissionId, options DeleteCalendarGroupCalendarPermissionOperationOptions) (result DeleteCalendarGroupCalendarPermissionOperationResponse, err error) {
