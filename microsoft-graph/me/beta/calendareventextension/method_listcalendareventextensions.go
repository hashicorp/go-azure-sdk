...
// ListCalendarEventExtensions - Get extensions from me. The collection of open extensions defined for the event.
// Nullable.
func (c CalendarEventExtensionClient) ListCalendarEventExtensions(ctx context.Context, id beta.MeCalendarIdEventId, options ListCalendarEventExtensionsOperationOptions) (result ListCalendarEventExtensionsOperationResponse, err error) {
...
func (c CalendarEventExtensionClient) ListCalendarEventExtensionsComplete(ctx context.Context, id beta.MeCalendarIdEventId, options ListCalendarEventExtensionsOperationOptions) (ListCalendarEventExtensionsCompleteResult, error) {
...
func (c CalendarEventExtensionClient) ListCalendarEventExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarIdEventId, options ListCalendarEventExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarEventExtensionsCompleteResult, err error) {
