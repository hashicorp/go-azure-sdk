...
// Nullable.
func (c CalendarEventExtensionClient) GetCalendarEventExtension(ctx context.Context, id beta.MeCalendarIdEventIdExtensionId, options GetCalendarEventExtensionOperationOptions) (result GetCalendarEventExtensionOperationResponse, err error) {
