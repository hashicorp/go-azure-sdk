...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceClient) CreateCalendarGroupCalendarEventExceptionOccurrenceInstanceAccept(ctx context.Context, id MeCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId, input CreateCalendarGroupCalendarEventExceptionOccurrenceInstanceAcceptRequest) (result CreateCalendarGroupCalendarEventExceptionOccurrenceInstanceAcceptOperationResponse, err error) {
