...
// ListCalendarGroupCalendarEventExceptionOccurrenceInstances - Get instances from me. The occurrences of a recurring
...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstances(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventIdExceptionOccurrenceId, options ListCalendarGroupCalendarEventExceptionOccurrenceInstancesOperationOptions) (result ListCalendarGroupCalendarEventExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstancesComplete(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventIdExceptionOccurrenceId, options ListCalendarGroupCalendarEventExceptionOccurrenceInstancesOperationOptions) (ListCalendarGroupCalendarEventExceptionOccurrenceInstancesCompleteResult, error) {
...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventIdExceptionOccurrenceId, options ListCalendarGroupCalendarEventExceptionOccurrenceInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarGroupCalendarEventExceptionOccurrenceInstancesCompleteResult, err error) {
