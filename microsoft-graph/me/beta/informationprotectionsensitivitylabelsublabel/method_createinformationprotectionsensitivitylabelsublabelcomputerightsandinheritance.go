...
// and labels.
func (c InformationProtectionSensitivityLabelSublabelClient) CreateInformationProtectionSensitivityLabelSublabelComputeRightsAndInheritance(ctx context.Context, id beta.MeInformationProtectionSensitivityLabelId, input CreateInformationProtectionSensitivityLabelSublabelComputeRightsAndInheritanceRequest, options CreateInformationProtectionSensitivityLabelSublabelComputeRightsAndInheritanceOperationOptions) (result CreateInformationProtectionSensitivityLabelSublabelComputeRightsAndInheritanceOperationResponse, err error) {
