...
func (c DriveRootLastModifiedByUserMailboxSettingClient) UpdateDriveRootLastModifiedByUserMailboxSetting(ctx context.Context, id beta.MeDriveId, input beta.MailboxSettings) (result UpdateDriveRootLastModifiedByUserMailboxSettingOperationResponse, err error) {
