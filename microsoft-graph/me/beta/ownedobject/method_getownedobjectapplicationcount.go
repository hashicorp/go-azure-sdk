...
func (c OwnedObjectClient) GetOwnedObjectApplicationCount(ctx context.Context, options GetOwnedObjectApplicationCountOperationOptions) (result GetOwnedObjectApplicationCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/ownedObjects/application/$count",
