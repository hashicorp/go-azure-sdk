...
func (c InformationProtectionSensitivityLabelClient) ListInformationProtectionSensitivityLabelsComplete(ctx context.Context) (ListInformationProtectionSensitivityLabelsCompleteResult, error) {
	return c.ListInformationProtectionSensitivityLabelsCompleteMatchingPredicate(ctx, SensitivityLabelOperationPredicate{})
}
...
func (c InformationProtectionSensitivityLabelClient) ListInformationProtectionSensitivityLabelsCompleteMatchingPredicate(ctx context.Context, predicate SensitivityLabelOperationPredicate) (result ListInformationProtectionSensitivityLabelsCompleteResult, err error) {
	items := make([]beta.SensitivityLabel, 0)

	resp, err := c.ListInformationProtectionSensitivityLabels(ctx)
	if err != nil {
