...
func TestNewMeCalendarGroupIdCalendarID(t *testing.T) {
	id := NewMeCalendarGroupIdCalendarID("calendarGroupIdValue", "calendarIdValue")
...
func TestFormatMeCalendarGroupIdCalendarID(t *testing.T) {
	actual := NewMeCalendarGroupIdCalendarID("calendarGroupIdValue", "calendarIdValue").ID()
	expected := "/me/calendarGroups/calendarGroupIdValue/calendars/calendarIdValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseMeCalendarGroupIdCalendarID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupIdCalendarId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/me/calendarGroups/calendarGroupIdValue/calendars/calendarIdValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupIdCalendarID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarGroupIdCalendarIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupIdCalendarId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupIdCalendarIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarGroupIdCalendarId(t *testing.T) {
	segments := MeCalendarGroupIdCalendarId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarGroupIdCalendarId has no segments")
	}
