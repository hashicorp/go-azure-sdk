...
func (c CalendarGroupCalendarCalendarViewClient) ForwardCalendarGroupCalendarView(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewId, input ForwardCalendarGroupCalendarViewRequest) (result ForwardCalendarGroupCalendarViewOperationResponse, err error) {
