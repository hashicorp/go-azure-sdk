...
// Read-only.
func (c CalendarGroupCalendarCalendarViewClient) GetCalendarGroupCalendarView(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewId, options GetCalendarGroupCalendarViewOperationOptions) (result GetCalendarGroupCalendarViewOperationResponse, err error) {
