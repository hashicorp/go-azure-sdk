...
func (c CalendarGroupCalendarCalendarViewClient) GetCalendarGroupCalendarViewCount(ctx context.Context, id beta.MeCalendarGroupIdCalendarId, options GetCalendarGroupCalendarViewCountOperationOptions) (result GetCalendarGroupCalendarViewCountOperationResponse, err error) {
