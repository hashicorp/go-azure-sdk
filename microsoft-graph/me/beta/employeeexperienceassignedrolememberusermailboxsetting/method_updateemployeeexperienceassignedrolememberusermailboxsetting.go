...
func (c EmployeeExperienceAssignedRoleMemberUserMailboxSettingClient) UpdateEmployeeExperienceAssignedRoleMemberUserMailboxSetting(ctx context.Context, id beta.MeEmployeeExperienceAssignedRoleIdMemberId, input beta.MailboxSettings, options UpdateEmployeeExperienceAssignedRoleMemberUserMailboxSettingOperationOptions) (result UpdateEmployeeExperienceAssignedRoleMemberUserMailboxSettingOperationResponse, err error) {
