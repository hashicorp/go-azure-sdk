...
func (c EmployeeExperienceAssignedRoleMemberUserMailboxSettingClient) GetEmployeeExperienceAssignedRoleMemberUserMailboxSetting(ctx context.Context, id beta.MeEmployeeExperienceAssignedRoleIdMemberId, options GetEmployeeExperienceAssignedRoleMemberUserMailboxSettingOperationOptions) (result GetEmployeeExperienceAssignedRoleMemberUserMailboxSettingOperationResponse, err error) {
