...
func (c AuthenticationPasswordlessMicrosoftAuthenticatorMethodDeviceClient) GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodDevice(ctx context.Context, id MeAuthenticationPasswordlessMicrosoftAuthenticatorMethodId) (result GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodDeviceOperationResponse, err error) {
