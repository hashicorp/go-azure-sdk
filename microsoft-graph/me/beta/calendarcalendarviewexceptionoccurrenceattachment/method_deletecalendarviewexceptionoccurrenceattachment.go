...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) DeleteCalendarViewExceptionOccurrenceAttachment(ctx context.Context, id beta.MeCalendarCalendarViewIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarViewExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarViewExceptionOccurrenceAttachmentOperationResponse, err error) {
