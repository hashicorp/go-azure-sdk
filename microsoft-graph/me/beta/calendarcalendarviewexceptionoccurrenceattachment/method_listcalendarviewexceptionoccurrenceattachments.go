...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) ListCalendarViewExceptionOccurrenceAttachmentsComplete(ctx context.Context, id beta.MeCalendarCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceAttachmentsOperationOptions) (ListCalendarViewExceptionOccurrenceAttachmentsCompleteResult, error) {
