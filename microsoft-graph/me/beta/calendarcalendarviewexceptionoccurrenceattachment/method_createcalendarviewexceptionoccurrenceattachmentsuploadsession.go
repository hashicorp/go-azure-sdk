...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) CreateCalendarViewExceptionOccurrenceAttachmentsUploadSession(ctx context.Context, id beta.MeCalendarCalendarViewIdExceptionOccurrenceId, input CreateCalendarViewExceptionOccurrenceAttachmentsUploadSessionRequest) (result CreateCalendarViewExceptionOccurrenceAttachmentsUploadSessionOperationResponse, err error) {
