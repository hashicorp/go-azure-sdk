...
// GetCalendarViewExceptionOccurrenceAttachment - Get attachments from me. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) GetCalendarViewExceptionOccurrenceAttachment(ctx context.Context, id beta.MeCalendarCalendarViewIdExceptionOccurrenceIdAttachmentId, options GetCalendarViewExceptionOccurrenceAttachmentOperationOptions) (result GetCalendarViewExceptionOccurrenceAttachmentOperationResponse, err error) {
