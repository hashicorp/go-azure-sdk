...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) GetCalendarViewExceptionOccurrenceAttachmentsCount(ctx context.Context, id beta.MeCalendarIdCalendarViewIdExceptionOccurrenceId, options GetCalendarViewExceptionOccurrenceAttachmentsCountOperationOptions) (result GetCalendarViewExceptionOccurrenceAttachmentsCountOperationResponse, err error) {
