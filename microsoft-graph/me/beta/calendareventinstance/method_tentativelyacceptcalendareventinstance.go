...
func (c CalendarEventInstanceClient) TentativelyAcceptCalendarEventInstance(ctx context.Context, id beta.MeCalendarEventIdInstanceId, input TentativelyAcceptCalendarEventInstanceRequest) (result TentativelyAcceptCalendarEventInstanceOperationResponse, err error) {
