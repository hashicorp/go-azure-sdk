...
func (c CalendarEventInstanceClient) DeclineCalendarEventInstance(ctx context.Context, id beta.MeCalendarIdEventIdInstanceId, input DeclineCalendarEventInstanceRequest) (result DeclineCalendarEventInstanceOperationResponse, err error) {
