...
func (c CalendarEventInstanceClient) CancelCalendarEventInstance(ctx context.Context, id beta.MeCalendarEventIdInstanceId, input CancelCalendarEventInstanceRequest) (result CancelCalendarEventInstanceOperationResponse, err error) {
