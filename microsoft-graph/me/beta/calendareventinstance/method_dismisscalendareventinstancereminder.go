...
func (c CalendarEventInstanceClient) DismissCalendarEventInstanceReminder(ctx context.Context, id beta.MeCalendarEventIdInstanceId) (result DismissCalendarEventInstanceReminderOperationResponse, err error) {
