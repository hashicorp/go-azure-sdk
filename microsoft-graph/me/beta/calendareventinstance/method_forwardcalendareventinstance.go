...
// Outlook.com account.
func (c CalendarEventInstanceClient) ForwardCalendarEventInstance(ctx context.Context, id beta.MeCalendarEventIdInstanceId, input ForwardCalendarEventInstanceRequest) (result ForwardCalendarEventInstanceOperationResponse, err error) {
