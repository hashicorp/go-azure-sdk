...
// Nullable.
func (c CalendarEventInstanceClient) ListCalendarEventInstances(ctx context.Context, id beta.MeCalendarIdEventId, options ListCalendarEventInstancesOperationOptions) (result ListCalendarEventInstancesOperationResponse, err error) {
...
func (c CalendarEventInstanceClient) ListCalendarEventInstancesComplete(ctx context.Context, id beta.MeCalendarIdEventId, options ListCalendarEventInstancesOperationOptions) (ListCalendarEventInstancesCompleteResult, error) {
...
func (c CalendarEventInstanceClient) ListCalendarEventInstancesCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarIdEventId, options ListCalendarEventInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarEventInstancesCompleteResult, err error) {
