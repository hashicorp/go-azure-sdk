...
func (c CalendarEventInstanceClient) SnoozeCalendarEventInstanceReminder(ctx context.Context, id beta.MeCalendarIdEventIdInstanceId, input SnoozeCalendarEventInstanceReminderRequest) (result SnoozeCalendarEventInstanceReminderOperationResponse, err error) {
