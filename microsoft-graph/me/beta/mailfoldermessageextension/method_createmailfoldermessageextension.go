...
func (c MailFolderMessageExtensionClient) CreateMailFolderMessageExtension(ctx context.Context, id beta.MeMailFolderIdMessageId, input beta.Extension) (result CreateMailFolderMessageExtensionOperationResponse, err error) {
