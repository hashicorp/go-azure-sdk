...
func (c PlannerPlanClient) MovePlannerPlanToContainer(ctx context.Context, id beta.MePlannerPlanId, input MovePlannerPlanToContainerRequest) (result MovePlannerPlanToContainerOperationResponse, err error) {
