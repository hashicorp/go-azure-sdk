...
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) CreateMobileAppTroubleshootingEventAppLogCollectionRequest(ctx context.Context, id beta.MeMobileAppTroubleshootingEventId, input beta.AppLogCollectionRequest) (result CreateMobileAppTroubleshootingEventAppLogCollectionRequestOperationResponse, err error) {
