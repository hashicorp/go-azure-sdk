...
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) ListMobileAppTroubleshootingEventAppLogCollectionRequests(ctx context.Context, id MeMobileAppTroubleshootingEventId) (result ListMobileAppTroubleshootingEventAppLogCollectionRequestsOperationResponse, err error) {
...
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) ListMobileAppTroubleshootingEventAppLogCollectionRequestsComplete(ctx context.Context, id MeMobileAppTroubleshootingEventId) (ListMobileAppTroubleshootingEventAppLogCollectionRequestsCompleteResult, error) {
...
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) ListMobileAppTroubleshootingEventAppLogCollectionRequestsCompleteMatchingPredicate(ctx context.Context, id MeMobileAppTroubleshootingEventId, predicate AppLogCollectionRequestOperationPredicate) (result ListMobileAppTroubleshootingEventAppLogCollectionRequestsCompleteResult, err error) {
