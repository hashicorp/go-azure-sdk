...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) GetCalendarViewInstanceExceptionOccurrencesCount(ctx context.Context, id beta.MeCalendarCalendarViewIdInstanceId, options GetCalendarViewInstanceExceptionOccurrencesCountOperationOptions) (result GetCalendarViewInstanceExceptionOccurrencesCountOperationResponse, err error) {
