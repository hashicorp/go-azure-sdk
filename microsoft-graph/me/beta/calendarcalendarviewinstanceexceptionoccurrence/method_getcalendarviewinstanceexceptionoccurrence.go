...
// GetCalendarViewInstanceExceptionOccurrence - Get exceptionOccurrences from me
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) GetCalendarViewInstanceExceptionOccurrence(ctx context.Context, id beta.MeCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId, options GetCalendarViewInstanceExceptionOccurrenceOperationOptions) (result GetCalendarViewInstanceExceptionOccurrenceOperationResponse, err error) {
