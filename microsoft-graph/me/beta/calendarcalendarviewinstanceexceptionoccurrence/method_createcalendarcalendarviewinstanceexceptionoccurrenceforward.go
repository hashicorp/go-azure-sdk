...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) CreateCalendarCalendarViewInstanceExceptionOccurrenceForward(ctx context.Context, id MeCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId, input CreateCalendarCalendarViewInstanceExceptionOccurrenceForwardRequest) (result CreateCalendarCalendarViewInstanceExceptionOccurrenceForwardOperationResponse, err error) {
