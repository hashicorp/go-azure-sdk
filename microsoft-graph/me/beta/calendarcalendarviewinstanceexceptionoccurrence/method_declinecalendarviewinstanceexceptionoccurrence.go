...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) DeclineCalendarViewInstanceExceptionOccurrence(ctx context.Context, id beta.MeCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId, input DeclineCalendarViewInstanceExceptionOccurrenceRequest) (result DeclineCalendarViewInstanceExceptionOccurrenceOperationResponse, err error) {
