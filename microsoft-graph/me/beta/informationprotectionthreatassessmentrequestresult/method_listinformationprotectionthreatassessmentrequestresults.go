...
func (c InformationProtectionThreatAssessmentRequestResultClient) ListInformationProtectionThreatAssessmentRequestResults(ctx context.Context, id MeInformationProtectionThreatAssessmentRequestId) (result ListInformationProtectionThreatAssessmentRequestResultsOperationResponse, err error) {
...
func (c InformationProtectionThreatAssessmentRequestResultClient) ListInformationProtectionThreatAssessmentRequestResultsComplete(ctx context.Context, id MeInformationProtectionThreatAssessmentRequestId) (ListInformationProtectionThreatAssessmentRequestResultsCompleteResult, error) {
