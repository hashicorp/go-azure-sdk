...
func (c CalendarViewExceptionOccurrenceAttachmentClient) ListCalendarViewExceptionOccurrenceAttachments(ctx context.Context, id MeCalendarViewIdExceptionOccurrenceId) (result ListCalendarViewExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceAttachmentClient) ListCalendarViewExceptionOccurrenceAttachmentsComplete(ctx context.Context, id MeCalendarViewIdExceptionOccurrenceId) (ListCalendarViewExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c CalendarViewExceptionOccurrenceAttachmentClient) ListCalendarViewExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id MeCalendarViewIdExceptionOccurrenceId, predicate AttachmentOperationPredicate) (result ListCalendarViewExceptionOccurrenceAttachmentsCompleteResult, err error) {
