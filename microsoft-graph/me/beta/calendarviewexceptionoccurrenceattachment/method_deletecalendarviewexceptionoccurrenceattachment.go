...
// DeleteCalendarViewExceptionOccurrenceAttachment - Delete navigation property attachments for me
func (c CalendarViewExceptionOccurrenceAttachmentClient) DeleteCalendarViewExceptionOccurrenceAttachment(ctx context.Context, id beta.MeCalendarViewIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarViewExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarViewExceptionOccurrenceAttachmentOperationResponse, err error) {
