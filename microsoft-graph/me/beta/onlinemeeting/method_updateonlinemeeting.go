...
func (c OnlineMeetingClient) UpdateOnlineMeeting(ctx context.Context, id beta.MeOnlineMeetingId, input beta.OnlineMeeting) (result UpdateOnlineMeetingOperationResponse, err error) {
