...
func TestNewMeCalendarCalendarViewInstanceExceptionOccurrenceID(t *testing.T) {
	id := NewMeCalendarCalendarViewInstanceExceptionOccurrenceID("calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value")
...
func TestFormatMeCalendarCalendarViewInstanceExceptionOccurrenceID(t *testing.T) {
	actual := NewMeCalendarCalendarViewInstanceExceptionOccurrenceID("calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value").ID()
