...
func TestNewMeManagedDeviceDetectedAppID(t *testing.T) {
	id := NewMeManagedDeviceDetectedAppID("managedDeviceIdValue", "detectedAppIdValue")
...
func TestFormatMeManagedDeviceDetectedAppID(t *testing.T) {
	actual := NewMeManagedDeviceDetectedAppID("managedDeviceIdValue", "detectedAppIdValue").ID()
...
func TestParseMeManagedDeviceDetectedAppID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeManagedDeviceDetectedAppId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeManagedDeviceDetectedAppID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeManagedDeviceDetectedAppIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeManagedDeviceDetectedAppId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeManagedDeviceDetectedAppIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeManagedDeviceDetectedAppId(t *testing.T) {
	segments := MeManagedDeviceDetectedAppId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeManagedDeviceDetectedAppId has no segments")
	}
