...
func TestNewMePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerID(t *testing.T) {
	id := NewMePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerID("accessReviewInstanceIdValue", "accessReviewStageIdValue", "accessReviewInstanceDecisionItemIdValue", "accessReviewReviewerIdValue")
...
func TestFormatMePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerID(t *testing.T) {
	actual := NewMePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerID("accessReviewInstanceIdValue", "accessReviewStageIdValue", "accessReviewInstanceDecisionItemIdValue", "accessReviewReviewerIdValue").ID()
...
func TestParseMePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerId
	...
	for _, v := range testData {
		...
		actual, err := ParseMePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerId(t *testing.T) {
	segments := MePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerId has no segments")
	}
