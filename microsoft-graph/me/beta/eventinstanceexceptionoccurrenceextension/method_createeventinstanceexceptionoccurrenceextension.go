...
func (c EventInstanceExceptionOccurrenceExtensionClient) CreateEventInstanceExceptionOccurrenceExtension(ctx context.Context, id beta.MeEventIdInstanceIdExceptionOccurrenceId, input beta.Extension) (result CreateEventInstanceExceptionOccurrenceExtensionOperationResponse, err error) {
