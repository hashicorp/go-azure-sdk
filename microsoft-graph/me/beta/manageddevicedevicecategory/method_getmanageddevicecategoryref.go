...
func (c ManagedDeviceDeviceCategoryClient) GetManagedDeviceCategoryRef(ctx context.Context, id beta.MeManagedDeviceId, options GetManagedDeviceCategoryRefOperationOptions) (result GetManagedDeviceCategoryRefOperationResponse, err error) {
