...
// quotas.
func (c ContactClient) CreateContactPermanentDelete(ctx context.Context, id beta.MeContactId, options CreateContactPermanentDeleteOperationOptions) (result CreateContactPermanentDeleteOperationResponse, err error) {
