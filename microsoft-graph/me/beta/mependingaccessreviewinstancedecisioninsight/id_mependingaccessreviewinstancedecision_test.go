...
func TestNewMePendingAccessReviewInstanceDecisionID(t *testing.T) {
	id := NewMePendingAccessReviewInstanceDecisionID("accessReviewInstanceIdValue", "accessReviewInstanceDecisionItemIdValue")
...
func TestFormatMePendingAccessReviewInstanceDecisionID(t *testing.T) {
	actual := NewMePendingAccessReviewInstanceDecisionID("accessReviewInstanceIdValue", "accessReviewInstanceDecisionItemIdValue").ID()
...
func TestParseMePendingAccessReviewInstanceDecisionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MePendingAccessReviewInstanceDecisionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMePendingAccessReviewInstanceDecisionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMePendingAccessReviewInstanceDecisionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MePendingAccessReviewInstanceDecisionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMePendingAccessReviewInstanceDecisionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMePendingAccessReviewInstanceDecisionId(t *testing.T) {
	segments := MePendingAccessReviewInstanceDecisionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MePendingAccessReviewInstanceDecisionId has no segments")
	}
