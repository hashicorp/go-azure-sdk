...
func TestNewMePendingAccessReviewInstanceDecisionInsightID(t *testing.T) {
	id := NewMePendingAccessReviewInstanceDecisionInsightID("accessReviewInstanceIdValue", "accessReviewInstanceDecisionItemIdValue", "governanceInsightIdValue")
...
func TestFormatMePendingAccessReviewInstanceDecisionInsightID(t *testing.T) {
	actual := NewMePendingAccessReviewInstanceDecisionInsightID("accessReviewInstanceIdValue", "accessReviewInstanceDecisionItemIdValue", "governanceInsightIdValue").ID()
	expected := "/me/pendingAccessReviewInstances/accessReviewInstanceIdValue/decisions/accessReviewInstanceDecisionItemIdValue/insights/governanceInsightIdValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseMePendingAccessReviewInstanceDecisionInsightID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MePendingAccessReviewInstanceDecisionInsightId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		{
			// Incomplete URI
			Input: "/me/pendingAccessReviewInstances/accessReviewInstanceIdValue/decisions/accessReviewInstanceDecisionItemIdValue/insights",
			Error: true,
		},
		{
			// Valid URI
			Input: "/me/pendingAccessReviewInstances/accessReviewInstanceIdValue/decisions/accessReviewInstanceDecisionItemIdValue/insights/governanceInsightIdValue",
			Expected: &MePendingAccessReviewInstanceDecisionInsightId{
		...
		},
		{
			...
			Input: "/me/pendingAccessReviewInstances/accessReviewInstanceIdValue/decisions/accessReviewInstanceDecisionItemIdValue/insights/governanceInsightIdValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseMePendingAccessReviewInstanceDecisionInsightID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMePendingAccessReviewInstanceDecisionInsightIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MePendingAccessReviewInstanceDecisionInsightId
	...
	for _, v := range testData {
		...
		actual, err := ParseMePendingAccessReviewInstanceDecisionInsightIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMePendingAccessReviewInstanceDecisionInsightId(t *testing.T) {
	segments := MePendingAccessReviewInstanceDecisionInsightId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MePendingAccessReviewInstanceDecisionInsightId has no segments")
	}
