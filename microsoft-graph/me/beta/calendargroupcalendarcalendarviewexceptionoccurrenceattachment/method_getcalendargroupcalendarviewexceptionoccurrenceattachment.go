...
// GetCalendarGroupCalendarViewExceptionOccurrenceAttachment - Get attachments from me. The collection of
// FileAttachment, ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only.
// Nullable.
func (c CalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentClient) GetCalendarGroupCalendarViewExceptionOccurrenceAttachment(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdAttachmentId, options GetCalendarGroupCalendarViewExceptionOccurrenceAttachmentOperationOptions) (result GetCalendarGroupCalendarViewExceptionOccurrenceAttachmentOperationResponse, err error) {
