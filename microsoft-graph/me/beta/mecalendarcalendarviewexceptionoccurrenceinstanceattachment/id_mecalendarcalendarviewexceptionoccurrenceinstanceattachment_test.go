...
func TestNewMeCalendarCalendarViewExceptionOccurrenceInstanceAttachmentID(t *testing.T) {
	id := NewMeCalendarCalendarViewExceptionOccurrenceInstanceAttachmentID("eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue")
...
func TestFormatMeCalendarCalendarViewExceptionOccurrenceInstanceAttachmentID(t *testing.T) {
	actual := NewMeCalendarCalendarViewExceptionOccurrenceInstanceAttachmentID("eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue").ID()
...
func TestParseMeCalendarCalendarViewExceptionOccurrenceInstanceAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarCalendarViewExceptionOccurrenceInstanceAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarCalendarViewExceptionOccurrenceInstanceAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarCalendarViewExceptionOccurrenceInstanceAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarCalendarViewExceptionOccurrenceInstanceAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarCalendarViewExceptionOccurrenceInstanceAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarCalendarViewExceptionOccurrenceInstanceAttachmentId(t *testing.T) {
	segments := MeCalendarCalendarViewExceptionOccurrenceInstanceAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarCalendarViewExceptionOccurrenceInstanceAttachmentId has no segments")
	}
