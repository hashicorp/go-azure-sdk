...
func (c OwnedDeviceClient) GetOwnedDeviceEndpoint(ctx context.Context, id beta.MeOwnedDeviceId, options GetOwnedDeviceEndpointOperationOptions) (result GetOwnedDeviceEndpointOperationResponse, err error) {
