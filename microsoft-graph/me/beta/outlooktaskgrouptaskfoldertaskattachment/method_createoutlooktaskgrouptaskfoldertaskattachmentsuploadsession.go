...
func (c OutlookTaskGroupTaskFolderTaskAttachmentClient) CreateOutlookTaskGroupTaskFolderTaskAttachmentsUploadSession(ctx context.Context, id beta.MeOutlookTaskGroupIdTaskFolderIdTaskId, input CreateOutlookTaskGroupTaskFolderTaskAttachmentsUploadSessionRequest) (result CreateOutlookTaskGroupTaskFolderTaskAttachmentsUploadSessionOperationResponse, err error) {
