...
func TestNewMeCalendarGroupCalendarID(t *testing.T) {
	id := NewMeCalendarGroupCalendarID("calendarGroupIdValue", "calendarIdValue")
...
func TestFormatMeCalendarGroupCalendarID(t *testing.T) {
	actual := NewMeCalendarGroupCalendarID("calendarGroupIdValue", "calendarIdValue").ID()
...
func TestParseMeCalendarGroupCalendarID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupCalendarId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupCalendarID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarGroupCalendarIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupCalendarId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupCalendarIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarGroupCalendarId(t *testing.T) {
	segments := MeCalendarGroupCalendarId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarGroupCalendarId has no segments")
	}
