...
// collection
func (c DeviceRegisteredOwnerClient) ListDeviceRegisteredOwnerUsers(ctx context.Context, id beta.MeDeviceId, options ListDeviceRegisteredOwnerUsersOperationOptions) (result ListDeviceRegisteredOwnerUsersOperationResponse, err error) {
...
func (c DeviceRegisteredOwnerClient) ListDeviceRegisteredOwnerUsersComplete(ctx context.Context, id beta.MeDeviceId, options ListDeviceRegisteredOwnerUsersOperationOptions) (ListDeviceRegisteredOwnerUsersCompleteResult, error) {
...
func (c DeviceRegisteredOwnerClient) ListDeviceRegisteredOwnerUsersCompleteMatchingPredicate(ctx context.Context, id beta.MeDeviceId, options ListDeviceRegisteredOwnerUsersOperationOptions, predicate UserOperationPredicate) (result ListDeviceRegisteredOwnerUsersCompleteResult, err error) {
