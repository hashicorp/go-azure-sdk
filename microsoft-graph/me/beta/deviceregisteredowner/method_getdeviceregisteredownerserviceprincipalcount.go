...
func (c DeviceRegisteredOwnerClient) GetDeviceRegisteredOwnerServicePrincipalCount(ctx context.Context, id beta.MeDeviceId, options GetDeviceRegisteredOwnerServicePrincipalCountOperationOptions) (result GetDeviceRegisteredOwnerServicePrincipalCountOperationResponse, err error) {
