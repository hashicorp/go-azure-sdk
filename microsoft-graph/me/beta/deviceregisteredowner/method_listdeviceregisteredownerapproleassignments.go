...
func (c DeviceRegisteredOwnerClient) ListDeviceRegisteredOwnerAppRoleAssignments(ctx context.Context, id beta.MeDeviceId, options ListDeviceRegisteredOwnerAppRoleAssignmentsOperationOptions) (result ListDeviceRegisteredOwnerAppRoleAssignmentsOperationResponse, err error) {
...
func (c DeviceRegisteredOwnerClient) ListDeviceRegisteredOwnerAppRoleAssignmentsComplete(ctx context.Context, id beta.MeDeviceId, options ListDeviceRegisteredOwnerAppRoleAssignmentsOperationOptions) (ListDeviceRegisteredOwnerAppRoleAssignmentsCompleteResult, error) {
