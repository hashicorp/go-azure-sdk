...
func (c DeviceRegisteredOwnerClient) ListDeviceRegisteredOwnerEndpoints(ctx context.Context, id beta.MeDeviceId, options ListDeviceRegisteredOwnerEndpointsOperationOptions) (result ListDeviceRegisteredOwnerEndpointsOperationResponse, err error) {
...
func (c DeviceRegisteredOwnerClient) ListDeviceRegisteredOwnerEndpointsComplete(ctx context.Context, id beta.MeDeviceId, options ListDeviceRegisteredOwnerEndpointsOperationOptions) (ListDeviceRegisteredOwnerEndpointsCompleteResult, error) {
...
func (c DeviceRegisteredOwnerClient) ListDeviceRegisteredOwnerEndpointsCompleteMatchingPredicate(ctx context.Context, id beta.MeDeviceId, options ListDeviceRegisteredOwnerEndpointsOperationOptions, predicate EndpointOperationPredicate) (result ListDeviceRegisteredOwnerEndpointsCompleteResult, err error) {
