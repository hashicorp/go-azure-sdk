...
func (c DeviceRegisteredOwnerClient) GetDeviceRegisteredOwnerEndpoint(ctx context.Context, id beta.MeDeviceIdRegisteredOwnerId, options GetDeviceRegisteredOwnerEndpointOperationOptions) (result GetDeviceRegisteredOwnerEndpointOperationResponse, err error) {
