...
func (c DeviceRegisteredOwnerClient) ListDeviceRegisteredOwnerServicePrincipals(ctx context.Context, id beta.MeDeviceId, options ListDeviceRegisteredOwnerServicePrincipalsOperationOptions) (result ListDeviceRegisteredOwnerServicePrincipalsOperationResponse, err error) {
...
func (c DeviceRegisteredOwnerClient) ListDeviceRegisteredOwnerServicePrincipalsComplete(ctx context.Context, id beta.MeDeviceId, options ListDeviceRegisteredOwnerServicePrincipalsOperationOptions) (ListDeviceRegisteredOwnerServicePrincipalsCompleteResult, error) {
...
func (c DeviceRegisteredOwnerClient) ListDeviceRegisteredOwnerServicePrincipalsCompleteMatchingPredicate(ctx context.Context, id beta.MeDeviceId, options ListDeviceRegisteredOwnerServicePrincipalsOperationOptions, predicate ServicePrincipalOperationPredicate) (result ListDeviceRegisteredOwnerServicePrincipalsCompleteResult, err error) {
