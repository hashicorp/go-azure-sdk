...
// ListApprovalSteps ...
func (c ApprovalStepClient) ListApprovalSteps(ctx context.Context, id MeApprovalId) (result ListApprovalStepsOperationResponse, err error) {
...
func (c ApprovalStepClient) ListApprovalStepsComplete(ctx context.Context, id MeApprovalId) (ListApprovalStepsCompleteResult, error) {
...
func (c ApprovalStepClient) ListApprovalStepsCompleteMatchingPredicate(ctx context.Context, id MeApprovalId, predicate ApprovalStepOperationPredicate) (result ListApprovalStepsCompleteResult, err error) {
