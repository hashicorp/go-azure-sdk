...
func (c DriveActivityDriveItemContentClient) SetDriveActivityDriveItemContent(ctx context.Context, id beta.MeDriveIdActivityId, input []byte) (result SetDriveActivityDriveItemContentOperationResponse, err error) {
