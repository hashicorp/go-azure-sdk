...
func (c MailFolderClient) CreateMailFolderPermanentDelete(ctx context.Context, id beta.MeMailFolderId, options CreateMailFolderPermanentDeleteOperationOptions) (result CreateMailFolderPermanentDeleteOperationResponse, err error) {
