...
func TestNewMePendingAccessReviewInstanceDecisionInstanceStageDecisionID(t *testing.T) {
	id := NewMePendingAccessReviewInstanceDecisionInstanceStageDecisionID("accessReviewInstanceIdValue", "accessReviewInstanceDecisionItemIdValue", "accessReviewStageIdValue", "accessReviewInstanceDecisionItemId1Value")
...
func TestFormatMePendingAccessReviewInstanceDecisionInstanceStageDecisionID(t *testing.T) {
	actual := NewMePendingAccessReviewInstanceDecisionInstanceStageDecisionID("accessReviewInstanceIdValue", "accessReviewInstanceDecisionItemIdValue", "accessReviewStageIdValue", "accessReviewInstanceDecisionItemId1Value").ID()
	expected := "/me/pendingAccessReviewInstances/accessReviewInstanceIdValue/decisions/accessReviewInstanceDecisionItemIdValue/instance/stages/accessReviewStageIdValue/decisions/accessReviewInstanceDecisionItemId1Value"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseMePendingAccessReviewInstanceDecisionInstanceStageDecisionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MePendingAccessReviewInstanceDecisionInstanceStageDecisionId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/me/pendingAccessReviewInstances/accessReviewInstanceIdValue/decisions/accessReviewInstanceDecisionItemIdValue/instance/stages/accessReviewStageIdValue/decisions/accessReviewInstanceDecisionItemId1Value/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseMePendingAccessReviewInstanceDecisionInstanceStageDecisionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMePendingAccessReviewInstanceDecisionInstanceStageDecisionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MePendingAccessReviewInstanceDecisionInstanceStageDecisionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMePendingAccessReviewInstanceDecisionInstanceStageDecisionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMePendingAccessReviewInstanceDecisionInstanceStageDecisionId(t *testing.T) {
	segments := MePendingAccessReviewInstanceDecisionInstanceStageDecisionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MePendingAccessReviewInstanceDecisionInstanceStageDecisionId has no segments")
	}
