...
func (c DriveListItemClient) CreateDriveListItem(ctx context.Context, id beta.MeDriveId, input beta.ListItem) (result CreateDriveListItemOperationResponse, err error) {
