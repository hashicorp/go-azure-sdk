...
// Items quotas.
func (c ContactFolderContactClient) CreateContactFolderContactPermanentDelete(ctx context.Context, id beta.MeContactFolderIdContactId, options CreateContactFolderContactPermanentDeleteOperationOptions) (result CreateContactFolderContactPermanentDeleteOperationResponse, err error) {
