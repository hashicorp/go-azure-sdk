...
func (c SettingContactMergeSuggestionClient) GetSettingContactMergeSuggestion(ctx context.Context) (result GetSettingContactMergeSuggestionOperationResponse, err error) {
