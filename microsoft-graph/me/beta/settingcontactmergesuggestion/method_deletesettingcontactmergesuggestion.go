...
func (c SettingContactMergeSuggestionClient) DeleteSettingContactMergeSuggestion(ctx context.Context) (result DeleteSettingContactMergeSuggestionOperationResponse, err error) {
