...
func (c ManagedDeviceHealthScriptStateClient) GetManagedDeviceHealthScriptStatesCount(ctx context.Context, id beta.MeManagedDeviceId, options GetManagedDeviceHealthScriptStatesCountOperationOptions) (result GetManagedDeviceHealthScriptStatesCountOperationResponse, err error) {
