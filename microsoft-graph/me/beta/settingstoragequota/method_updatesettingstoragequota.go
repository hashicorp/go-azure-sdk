...
func (c SettingStorageQuotaClient) UpdateSettingStorageQuota(ctx context.Context, input beta.UnifiedStorageQuota) (result UpdateSettingStorageQuotaOperationResponse, err error) {
