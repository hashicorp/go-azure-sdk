...
func TestNewMeOutlookTaskFolderTaskID(t *testing.T) {
	id := NewMeOutlookTaskFolderTaskID("outlookTaskFolderIdValue", "outlookTaskIdValue")
...
func TestFormatMeOutlookTaskFolderTaskID(t *testing.T) {
	actual := NewMeOutlookTaskFolderTaskID("outlookTaskFolderIdValue", "outlookTaskIdValue").ID()
...
func TestParseMeOutlookTaskFolderTaskID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeOutlookTaskFolderTaskId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeOutlookTaskFolderTaskID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeOutlookTaskFolderTaskIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeOutlookTaskFolderTaskId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeOutlookTaskFolderTaskIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeOutlookTaskFolderTaskId(t *testing.T) {
	segments := MeOutlookTaskFolderTaskId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeOutlookTaskFolderTaskId has no segments")
	}
