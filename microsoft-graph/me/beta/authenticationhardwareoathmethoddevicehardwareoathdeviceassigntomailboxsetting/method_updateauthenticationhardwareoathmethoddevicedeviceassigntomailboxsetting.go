...
func (c AuthenticationHardwareOathMethodDeviceHardwareOathDeviceAssignToMailboxSettingClient) UpdateAuthenticationHardwareOathMethodDeviceDeviceAssignToMailboxSetting(ctx context.Context, id beta.MeAuthenticationHardwareOathMethodIdDeviceHardwareOathDeviceId, input beta.MailboxSettings, options UpdateAuthenticationHardwareOathMethodDeviceDeviceAssignToMailboxSettingOperationOptions) (result UpdateAuthenticationHardwareOathMethodDeviceDeviceAssignToMailboxSettingOperationResponse, err error) {
