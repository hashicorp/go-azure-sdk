...
func (c MailFolderMessageClient) ReplyMailFolderMessage(ctx context.Context, id beta.MeMailFolderIdMessageId, input ReplyMailFolderMessageRequest) (result ReplyMailFolderMessageOperationResponse, err error) {
