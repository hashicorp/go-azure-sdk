...
func (c MailFolderMessageClient) CreateMailFolderMessageUnsubscribe(ctx context.Context, id beta.MeMailFolderIdMessageId) (result CreateMailFolderMessageUnsubscribeOperationResponse, err error) {
