...
func (c MailFolderMessageClient) ForwardMailFolderMessage(ctx context.Context, id beta.MeMailFolderIdMessageId, input ForwardMailFolderMessageRequest) (result ForwardMailFolderMessageOperationResponse, err error) {
