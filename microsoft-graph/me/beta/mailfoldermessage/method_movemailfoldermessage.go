...
func (c MailFolderMessageClient) MoveMailFolderMessage(ctx context.Context, id beta.MeMailFolderIdMessageId, input MoveMailFolderMessageRequest) (result MoveMailFolderMessageOperationResponse, err error) {
