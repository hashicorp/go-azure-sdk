...
func (c MailFolderMessageClient) CreateMailFolderMessageReply(ctx context.Context, id beta.MeMailFolderIdMessageId, input CreateMailFolderMessageReplyRequest) (result CreateMailFolderMessageReplyOperationResponse, err error) {
