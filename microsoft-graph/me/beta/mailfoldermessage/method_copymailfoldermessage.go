...
func (c MailFolderMessageClient) CopyMailFolderMessage(ctx context.Context, id beta.MeMailFolderIdMessageId, input CopyMailFolderMessageRequest) (result CopyMailFolderMessageOperationResponse, err error) {
