...
func (c MailFolderMessageClient) CreateMailFolderMessageReplyAll(ctx context.Context, id beta.MeMailFolderIdMessageId, input CreateMailFolderMessageReplyAllRequest) (result CreateMailFolderMessageReplyAllOperationResponse, err error) {
