...
func (c MailFolderMessageClient) SendMailFolderMessage(ctx context.Context, id beta.MeMailFolderIdMessageId) (result SendMailFolderMessageOperationResponse, err error) {
