...
func (c MailFolderMessageClient) ListMailFolderMessages(ctx context.Context, id MeMailFolderId) (result ListMailFolderMessagesOperationResponse, err error) {
...
func (c MailFolderMessageClient) ListMailFolderMessagesComplete(ctx context.Context, id MeMailFolderId) (ListMailFolderMessagesCompleteResult, error) {
...
func (c MailFolderMessageClient) ListMailFolderMessagesCompleteMatchingPredicate(ctx context.Context, id MeMailFolderId, predicate MessageOperationPredicate) (result ListMailFolderMessagesCompleteResult, err error) {
