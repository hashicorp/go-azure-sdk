...
// send it later.
func (c MailFolderMessageClient) ReplyAllMailFolderMessage(ctx context.Context, id beta.MeMailFolderIdMessageId, input ReplyAllMailFolderMessageRequest) (result ReplyAllMailFolderMessageOperationResponse, err error) {
