...
func (c ContactFolderChildFolderContactExtensionClient) ListContactFolderChildFolderContactExtensions(ctx context.Context, id MeContactFolderIdChildFolderIdContactId) (result ListContactFolderChildFolderContactExtensionsOperationResponse, err error) {
...
func (c ContactFolderChildFolderContactExtensionClient) ListContactFolderChildFolderContactExtensionsComplete(ctx context.Context, id MeContactFolderIdChildFolderIdContactId) (ListContactFolderChildFolderContactExtensionsCompleteResult, error) {
