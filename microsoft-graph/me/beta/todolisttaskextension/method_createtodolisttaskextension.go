...
func (c TodoListTaskExtensionClient) CreateTodoListTaskExtension(ctx context.Context, id beta.MeTodoListIdTaskId, input beta.Extension) (result CreateTodoListTaskExtensionOperationResponse, err error) {
