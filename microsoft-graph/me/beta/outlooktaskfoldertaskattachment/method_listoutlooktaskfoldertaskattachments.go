...
func (c OutlookTaskFolderTaskAttachmentClient) ListOutlookTaskFolderTaskAttachments(ctx context.Context, id MeOutlookTaskFolderIdTaskId) (result ListOutlookTaskFolderTaskAttachmentsOperationResponse, err error) {
...
func (c OutlookTaskFolderTaskAttachmentClient) ListOutlookTaskFolderTaskAttachmentsComplete(ctx context.Context, id MeOutlookTaskFolderIdTaskId) (ListOutlookTaskFolderTaskAttachmentsCompleteResult, error) {
...
func (c OutlookTaskFolderTaskAttachmentClient) ListOutlookTaskFolderTaskAttachmentsCompleteMatchingPredicate(ctx context.Context, id MeOutlookTaskFolderIdTaskId, predicate AttachmentOperationPredicate) (result ListOutlookTaskFolderTaskAttachmentsCompleteResult, err error) {
