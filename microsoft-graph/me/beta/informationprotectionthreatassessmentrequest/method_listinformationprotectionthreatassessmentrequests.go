...
func (c InformationProtectionThreatAssessmentRequestClient) ListInformationProtectionThreatAssessmentRequests(ctx context.Context) (result ListInformationProtectionThreatAssessmentRequestsOperationResponse, err error) {
...
func (c InformationProtectionThreatAssessmentRequestClient) ListInformationProtectionThreatAssessmentRequestsComplete(ctx context.Context) (ListInformationProtectionThreatAssessmentRequestsCompleteResult, error) {
	return c.ListInformationProtectionThreatAssessmentRequestsCompleteMatchingPredicate(ctx, ThreatAssessmentRequestOperationPredicate{})
}
...
func (c InformationProtectionThreatAssessmentRequestClient) ListInformationProtectionThreatAssessmentRequestsCompleteMatchingPredicate(ctx context.Context, predicate ThreatAssessmentRequestOperationPredicate) (result ListInformationProtectionThreatAssessmentRequestsCompleteResult, err error) {
	items := make([]beta.ThreatAssessmentRequest, 0)

	resp, err := c.ListInformationProtectionThreatAssessmentRequests(ctx)
	if err != nil {
