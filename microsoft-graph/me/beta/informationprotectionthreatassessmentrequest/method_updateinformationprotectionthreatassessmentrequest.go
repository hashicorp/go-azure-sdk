...
func (c InformationProtectionThreatAssessmentRequestClient) UpdateInformationProtectionThreatAssessmentRequest(ctx context.Context, id beta.MeInformationProtectionThreatAssessmentRequestId, input beta.ThreatAssessmentRequest) (result UpdateInformationProtectionThreatAssessmentRequestOperationResponse, err error) {
