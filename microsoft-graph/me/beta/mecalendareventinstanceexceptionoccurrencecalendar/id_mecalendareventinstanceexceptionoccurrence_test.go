...
func TestNewMeCalendarEventInstanceExceptionOccurrenceID(t *testing.T) {
	id := NewMeCalendarEventInstanceExceptionOccurrenceID("calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value")
...
func TestFormatMeCalendarEventInstanceExceptionOccurrenceID(t *testing.T) {
	actual := NewMeCalendarEventInstanceExceptionOccurrenceID("calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value").ID()
