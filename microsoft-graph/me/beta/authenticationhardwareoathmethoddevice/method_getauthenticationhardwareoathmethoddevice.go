...
// GetAuthenticationHardwareOathMethodDevice - Get device from me. Exposes the hardware OATH method in the directory.
func (c AuthenticationHardwareOathMethodDeviceClient) GetAuthenticationHardwareOathMethodDevice(ctx context.Context, id beta.MeAuthenticationHardwareOathMethodId, options GetAuthenticationHardwareOathMethodDeviceOperationOptions) (result GetAuthenticationHardwareOathMethodDeviceOperationResponse, err error) {
