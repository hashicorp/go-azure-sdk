...
// ListCalendarEventExceptionOccurrenceExtensions - Get extensions from me. The collection of open extensions defined
// for the event. Nullable.
func (c CalendarEventExceptionOccurrenceExtensionClient) ListCalendarEventExceptionOccurrenceExtensions(ctx context.Context, id beta.MeCalendarIdEventIdExceptionOccurrenceId, options ListCalendarEventExceptionOccurrenceExtensionsOperationOptions) (result ListCalendarEventExceptionOccurrenceExtensionsOperationResponse, err error) {
