...
func (c CalendarEventExceptionOccurrenceExtensionClient) GetCalendarEventExceptionOccurrenceExtensionsCount(ctx context.Context, id beta.MeCalendarIdEventIdExceptionOccurrenceId, options GetCalendarEventExceptionOccurrenceExtensionsCountOperationOptions) (result GetCalendarEventExceptionOccurrenceExtensionsCountOperationResponse, err error) {
