...
// GetCalendarEventExceptionOccurrenceExtension - Get extensions from me. The collection of open extensions defined for
// the event. Nullable.
func (c CalendarEventExceptionOccurrenceExtensionClient) GetCalendarEventExceptionOccurrenceExtension(ctx context.Context, id beta.MeCalendarIdEventIdExceptionOccurrenceIdExtensionId, options GetCalendarEventExceptionOccurrenceExtensionOperationOptions) (result GetCalendarEventExceptionOccurrenceExtensionOperationResponse, err error) {
