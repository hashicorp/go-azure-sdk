...
// DeleteCalendarEventExceptionOccurrenceExtension - Delete navigation property extensions for me
func (c CalendarEventExceptionOccurrenceExtensionClient) DeleteCalendarEventExceptionOccurrenceExtension(ctx context.Context, id beta.MeCalendarIdEventIdExceptionOccurrenceIdExtensionId, options DeleteCalendarEventExceptionOccurrenceExtensionOperationOptions) (result DeleteCalendarEventExceptionOccurrenceExtensionOperationResponse, err error) {
