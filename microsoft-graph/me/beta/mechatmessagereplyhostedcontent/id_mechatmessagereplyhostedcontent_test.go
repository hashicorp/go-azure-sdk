...
func TestNewMeChatMessageReplyHostedContentID(t *testing.T) {
	id := NewMeChatMessageReplyHostedContentID("chatIdValue", "chatMessageIdValue", "chatMessageId1Value", "chatMessageHostedContentIdValue")
...
func TestFormatMeChatMessageReplyHostedContentID(t *testing.T) {
	actual := NewMeChatMessageReplyHostedContentID("chatIdValue", "chatMessageIdValue", "chatMessageId1Value", "chatMessageHostedContentIdValue").ID()
...
func TestParseMeChatMessageReplyHostedContentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeChatMessageReplyHostedContentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeChatMessageReplyHostedContentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeChatMessageReplyHostedContentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeChatMessageReplyHostedContentId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeChatMessageReplyHostedContentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeChatMessageReplyHostedContentId(t *testing.T) {
	segments := MeChatMessageReplyHostedContentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeChatMessageReplyHostedContentId has no segments")
	}
