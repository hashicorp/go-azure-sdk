...
// Outlook.com account.
func (c CalendarCalendarViewInstanceClient) ForwardCalendarViewInstance(ctx context.Context, id beta.MeCalendarIdCalendarViewIdInstanceId, input ForwardCalendarViewInstanceRequest) (result ForwardCalendarViewInstanceOperationResponse, err error) {
