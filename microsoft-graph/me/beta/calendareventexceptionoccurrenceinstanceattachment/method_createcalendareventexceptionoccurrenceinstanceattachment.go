...
// CreateCalendarEventExceptionOccurrenceInstanceAttachment - Create new navigation property to attachments for me
func (c CalendarEventExceptionOccurrenceInstanceAttachmentClient) CreateCalendarEventExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.MeCalendarEventIdExceptionOccurrenceIdInstanceId, input beta.Attachment) (result CreateCalendarEventExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
