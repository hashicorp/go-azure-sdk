...
// DeleteCalendarEventExceptionOccurrenceInstanceAttachment - Delete navigation property attachments for me
func (c CalendarEventExceptionOccurrenceInstanceAttachmentClient) DeleteCalendarEventExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.MeCalendarEventIdExceptionOccurrenceIdInstanceIdAttachmentId, options DeleteCalendarEventExceptionOccurrenceInstanceAttachmentOperationOptions) (result DeleteCalendarEventExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
