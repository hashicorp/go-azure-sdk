...
func (c CalendarEventExceptionOccurrenceInstanceAttachmentClient) GetCalendarEventExceptionOccurrenceInstanceAttachmentsCount(ctx context.Context, id beta.MeCalendarEventIdExceptionOccurrenceIdInstanceId, options GetCalendarEventExceptionOccurrenceInstanceAttachmentsCountOperationOptions) (result GetCalendarEventExceptionOccurrenceInstanceAttachmentsCountOperationResponse, err error) {
