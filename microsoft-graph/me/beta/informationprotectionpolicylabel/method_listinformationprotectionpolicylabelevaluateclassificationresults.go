...
// following:
func (c InformationProtectionPolicyLabelClient) ListInformationProtectionPolicyLabelEvaluateClassificationResults(ctx context.Context, input ListInformationProtectionPolicyLabelEvaluateClassificationResultsRequest, options ListInformationProtectionPolicyLabelEvaluateClassificationResultsOperationOptions) (result ListInformationProtectionPolicyLabelEvaluateClassificationResultsOperationResponse, err error) {
...
func (c InformationProtectionPolicyLabelClient) ListInformationProtectionPolicyLabelEvaluateClassificationResultsComplete(ctx context.Context, input ListInformationProtectionPolicyLabelEvaluateClassificationResultsRequest, options ListInformationProtectionPolicyLabelEvaluateClassificationResultsOperationOptions) (ListInformationProtectionPolicyLabelEvaluateClassificationResultsCompleteResult, error) {
	return c.ListInformationProtectionPolicyLabelEvaluateClassificationResultsCompleteMatchingPredicate(ctx, input, options, InformationProtectionActionOperationPredicate{})
}
...
func (c InformationProtectionPolicyLabelClient) ListInformationProtectionPolicyLabelEvaluateClassificationResultsCompleteMatchingPredicate(ctx context.Context, input ListInformationProtectionPolicyLabelEvaluateClassificationResultsRequest, options ListInformationProtectionPolicyLabelEvaluateClassificationResultsOperationOptions, predicate InformationProtectionActionOperationPredicate) (result ListInformationProtectionPolicyLabelEvaluateClassificationResultsCompleteResult, err error) {
	items := make([]beta.InformationProtectionAction, 0)

	resp, err := c.ListInformationProtectionPolicyLabelEvaluateClassificationResults(ctx, input, options)
	if err != nil {
