...
// DeleteCalendarGroupCalendarEventExceptionOccurrenceAttachment - Delete navigation property attachments for me
func (c CalendarGroupCalendarEventExceptionOccurrenceAttachmentClient) DeleteCalendarGroupCalendarEventExceptionOccurrenceAttachment(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarGroupCalendarEventExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarGroupCalendarEventExceptionOccurrenceAttachmentOperationResponse, err error) {
