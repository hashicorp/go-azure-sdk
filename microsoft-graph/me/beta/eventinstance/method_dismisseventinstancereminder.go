...
// in a user calendar.
func (c EventInstanceClient) DismissEventInstanceReminder(ctx context.Context, id beta.MeEventIdInstanceId) (result DismissEventInstanceReminderOperationResponse, err error) {
