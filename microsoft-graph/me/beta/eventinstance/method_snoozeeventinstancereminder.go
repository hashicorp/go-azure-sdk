...
// a new time.
func (c EventInstanceClient) SnoozeEventInstanceReminder(ctx context.Context, id beta.MeEventIdInstanceId, input SnoozeEventInstanceReminderRequest) (result SnoozeEventInstanceReminderOperationResponse, err error) {
