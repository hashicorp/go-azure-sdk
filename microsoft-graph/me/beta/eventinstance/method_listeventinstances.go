...
// ListEventInstances ...
func (c EventInstanceClient) ListEventInstances(ctx context.Context, id MeEventId) (result ListEventInstancesOperationResponse, err error) {
...
func (c EventInstanceClient) ListEventInstancesComplete(ctx context.Context, id MeEventId) (ListEventInstancesCompleteResult, error) {
...
func (c EventInstanceClient) ListEventInstancesCompleteMatchingPredicate(ctx context.Context, id MeEventId, predicate EventOperationPredicate) (result ListEventInstancesCompleteResult, err error) {
