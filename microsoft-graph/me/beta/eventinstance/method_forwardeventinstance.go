...
// Outlook.com account.
func (c EventInstanceClient) ForwardEventInstance(ctx context.Context, id beta.MeEventIdInstanceId, input ForwardEventInstanceRequest) (result ForwardEventInstanceOperationResponse, err error) {
