...
func (c EventInstanceClient) TentativelyAcceptEventInstance(ctx context.Context, id beta.MeEventIdInstanceId, input TentativelyAcceptEventInstanceRequest) (result TentativelyAcceptEventInstanceOperationResponse, err error) {
