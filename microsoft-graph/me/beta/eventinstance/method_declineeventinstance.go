...
func (c EventInstanceClient) DeclineEventInstance(ctx context.Context, id beta.MeEventIdInstanceId, input DeclineEventInstanceRequest) (result DeclineEventInstanceOperationResponse, err error) {
