...
func (c EventInstanceClient) AcceptEventInstance(ctx context.Context, id beta.MeEventIdInstanceId, input AcceptEventInstanceRequest) (result AcceptEventInstanceOperationResponse, err error) {
