...
func (c CalendarCalendarPermissionClient) ListCalendarCalendarPermissions(ctx context.Context) (result ListCalendarCalendarPermissionsOperationResponse, err error) {
...
func (c CalendarCalendarPermissionClient) ListCalendarCalendarPermissionsComplete(ctx context.Context) (ListCalendarCalendarPermissionsCompleteResult, error) {
	return c.ListCalendarCalendarPermissionsCompleteMatchingPredicate(ctx, CalendarPermissionOperationPredicate{})
}

// ListCalendarCalendarPermissionsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c CalendarCalendarPermissionClient) ListCalendarCalendarPermissionsCompleteMatchingPredicate(ctx context.Context, predicate CalendarPermissionOperationPredicate) (result ListCalendarCalendarPermissionsCompleteResult, err error) {
	items := make([]beta.CalendarPermission, 0)

	resp, err := c.ListCalendarCalendarPermissions(ctx)
	if err != nil {
