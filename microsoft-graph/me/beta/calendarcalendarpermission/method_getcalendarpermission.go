...
// shared.
func (c CalendarCalendarPermissionClient) GetCalendarPermission(ctx context.Context, id beta.MeCalendarIdCalendarPermissionId, options GetCalendarPermissionOperationOptions) (result GetCalendarPermissionOperationResponse, err error) {
