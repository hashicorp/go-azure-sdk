...
func (c CalendarCalendarPermissionClient) GetCalendarPermissionsCount(ctx context.Context, options GetCalendarPermissionsCountOperationOptions) (result GetCalendarPermissionsCountOperationResponse, err error) {
