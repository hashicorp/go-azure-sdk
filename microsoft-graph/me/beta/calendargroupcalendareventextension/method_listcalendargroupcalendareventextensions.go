...
func (c CalendarGroupCalendarEventExtensionClient) ListCalendarGroupCalendarEventExtensions(ctx context.Context, id MeCalendarGroupIdCalendarIdEventId) (result ListCalendarGroupCalendarEventExtensionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventExtensionClient) ListCalendarGroupCalendarEventExtensionsComplete(ctx context.Context, id MeCalendarGroupIdCalendarIdEventId) (ListCalendarGroupCalendarEventExtensionsCompleteResult, error) {
...
func (c CalendarGroupCalendarEventExtensionClient) ListCalendarGroupCalendarEventExtensionsCompleteMatchingPredicate(ctx context.Context, id MeCalendarGroupIdCalendarIdEventId, predicate ExtensionOperationPredicate) (result ListCalendarGroupCalendarEventExtensionsCompleteResult, err error) {
