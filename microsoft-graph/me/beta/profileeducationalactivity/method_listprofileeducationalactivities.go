...
func (c ProfileEducationalActivityClient) ListProfileEducationalActivities(ctx context.Context) (result ListProfileEducationalActivitiesOperationResponse, err error) {
...
func (c ProfileEducationalActivityClient) ListProfileEducationalActivitiesComplete(ctx context.Context) (ListProfileEducationalActivitiesCompleteResult, error) {
	return c.ListProfileEducationalActivitiesCompleteMatchingPredicate(ctx, EducationalActivityOperationPredicate{})
}

// ListProfileEducationalActivitiesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileEducationalActivityClient) ListProfileEducationalActivitiesCompleteMatchingPredicate(ctx context.Context, predicate EducationalActivityOperationPredicate) (result ListProfileEducationalActivitiesCompleteResult, err error) {
	items := make([]beta.EducationalActivity, 0)

	resp, err := c.ListProfileEducationalActivities(ctx)
	if err != nil {
