...
// permissions.
func (c DriveItemClient) DiscardDriveItemCheckout(ctx context.Context, id beta.MeDriveIdItemId) (result DiscardDriveItemCheckoutOperationResponse, err error) {
