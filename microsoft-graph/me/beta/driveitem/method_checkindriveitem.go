...
func (c DriveItemClient) CheckinDriveItem(ctx context.Context, id beta.MeDriveIdItemId, input CheckinDriveItemRequest) (result CheckinDriveItemOperationResponse, err error) {
