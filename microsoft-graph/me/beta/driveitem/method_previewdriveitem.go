...
func (c DriveItemClient) PreviewDriveItem(ctx context.Context, id beta.MeDriveIdItemId, input PreviewDriveItemRequest) (result PreviewDriveItemOperationResponse, err error) {
