...
// progress.
func (c DriveItemClient) CopyDriveItem(ctx context.Context, id beta.MeDriveIdItemId, input CopyDriveItemRequest) (result CopyDriveItemOperationResponse, err error) {
