...
func (c DriveItemClient) CreateDriveItemLink(ctx context.Context, id beta.MeDriveIdItemId, input CreateDriveItemLinkRequest) (result CreateDriveItemLinkOperationResponse, err error) {
