...
// shared.
func (c CalendarPermissionClient) GetCalendarPermission(ctx context.Context, id beta.MeCalendarIdCalendarPermissionId, options GetCalendarPermissionOperationOptions) (result GetCalendarPermissionOperationResponse, err error) {
