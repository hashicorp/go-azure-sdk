...
func (c CreatedObjectClient) GetCreatedObjectServicePrincipalCount(ctx context.Context, options GetCreatedObjectServicePrincipalCountOperationOptions) (result GetCreatedObjectServicePrincipalCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          "/me/createdObjects/servicePrincipal/$count",
