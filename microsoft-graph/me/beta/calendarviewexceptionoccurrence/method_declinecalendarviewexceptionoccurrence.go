...
func (c CalendarViewExceptionOccurrenceClient) DeclineCalendarViewExceptionOccurrence(ctx context.Context, id beta.MeCalendarViewIdExceptionOccurrenceId, input DeclineCalendarViewExceptionOccurrenceRequest) (result DeclineCalendarViewExceptionOccurrenceOperationResponse, err error) {
