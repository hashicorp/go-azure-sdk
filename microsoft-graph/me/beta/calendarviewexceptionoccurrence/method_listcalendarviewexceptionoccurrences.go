...
func (c CalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrences(ctx context.Context, id beta.MeCalendarViewId, options ListCalendarViewExceptionOccurrencesOperationOptions) (result ListCalendarViewExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrencesComplete(ctx context.Context, id beta.MeCalendarViewId, options ListCalendarViewExceptionOccurrencesOperationOptions) (ListCalendarViewExceptionOccurrencesCompleteResult, error) {
