...
func (c CalendarViewExceptionOccurrenceClient) GetCalendarViewExceptionOccurrencesCount(ctx context.Context, id beta.MeCalendarViewId, options GetCalendarViewExceptionOccurrencesCountOperationOptions) (result GetCalendarViewExceptionOccurrencesCountOperationResponse, err error) {
