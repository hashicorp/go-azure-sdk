...
func (c CalendarViewExceptionOccurrenceClient) GetCalendarViewExceptionOccurrence(ctx context.Context, id beta.MeCalendarViewIdExceptionOccurrenceId, options GetCalendarViewExceptionOccurrenceOperationOptions) (result GetCalendarViewExceptionOccurrenceOperationResponse, err error) {
