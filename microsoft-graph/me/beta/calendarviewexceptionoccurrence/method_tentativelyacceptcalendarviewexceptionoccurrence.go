...
func (c CalendarViewExceptionOccurrenceClient) TentativelyAcceptCalendarViewExceptionOccurrence(ctx context.Context, id beta.MeCalendarViewIdExceptionOccurrenceId, input TentativelyAcceptCalendarViewExceptionOccurrenceRequest) (result TentativelyAcceptCalendarViewExceptionOccurrenceOperationResponse, err error) {
