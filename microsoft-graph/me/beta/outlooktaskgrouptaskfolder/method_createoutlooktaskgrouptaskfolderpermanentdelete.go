...
func (c OutlookTaskGroupTaskFolderClient) CreateOutlookTaskGroupTaskFolderPermanentDelete(ctx context.Context, id beta.MeOutlookTaskGroupIdTaskFolderId, options CreateOutlookTaskGroupTaskFolderPermanentDeleteOperationOptions) (result CreateOutlookTaskGroupTaskFolderPermanentDeleteOperationResponse, err error) {
