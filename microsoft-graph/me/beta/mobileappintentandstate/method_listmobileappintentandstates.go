...
func (c MobileAppIntentAndStateClient) ListMobileAppIntentAndStates(ctx context.Context) (result ListMobileAppIntentAndStatesOperationResponse, err error) {
...
func (c MobileAppIntentAndStateClient) ListMobileAppIntentAndStatesComplete(ctx context.Context) (ListMobileAppIntentAndStatesCompleteResult, error) {
	return c.ListMobileAppIntentAndStatesCompleteMatchingPredicate(ctx, MobileAppIntentAndStateOperationPredicate{})
}

// ListMobileAppIntentAndStatesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c MobileAppIntentAndStateClient) ListMobileAppIntentAndStatesCompleteMatchingPredicate(ctx context.Context, predicate MobileAppIntentAndStateOperationPredicate) (result ListMobileAppIntentAndStatesCompleteResult, err error) {
	items := make([]beta.MobileAppIntentAndState, 0)

	resp, err := c.ListMobileAppIntentAndStates(ctx)
	if err != nil {
