...
func (c PlannerTaskBucketTaskBoardFormatClient) UpdatePlannerTaskBucketTaskBoardFormat(ctx context.Context, id MePlannerTaskId, input beta.PlannerBucketTaskBoardTaskFormat) (result UpdatePlannerTaskBucketTaskBoardFormatOperationResponse, err error) {
