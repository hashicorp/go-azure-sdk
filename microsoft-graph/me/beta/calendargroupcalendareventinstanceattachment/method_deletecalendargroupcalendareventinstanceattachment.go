...
func (c CalendarGroupCalendarEventInstanceAttachmentClient) DeleteCalendarGroupCalendarEventInstanceAttachment(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentId, options DeleteCalendarGroupCalendarEventInstanceAttachmentOperationOptions) (result DeleteCalendarGroupCalendarEventInstanceAttachmentOperationResponse, err error) {
