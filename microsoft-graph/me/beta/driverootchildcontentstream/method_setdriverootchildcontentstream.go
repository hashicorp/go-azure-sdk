...
func (c DriveRootChildContentStreamClient) SetDriveRootChildContentStream(ctx context.Context, id beta.MeDriveIdRootChildId, input []byte) (result SetDriveRootChildContentStreamOperationResponse, err error) {
