...
func (c DriveRootChildContentStreamClient) GetDriveRootChildContentStream(ctx context.Context, id beta.MeDriveIdRootChildId) (result GetDriveRootChildContentStreamOperationResponse, err error) {
