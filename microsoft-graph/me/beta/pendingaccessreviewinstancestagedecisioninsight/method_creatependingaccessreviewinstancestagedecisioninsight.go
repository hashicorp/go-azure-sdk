...
func (c PendingAccessReviewInstanceStageDecisionInsightClient) CreatePendingAccessReviewInstanceStageDecisionInsight(ctx context.Context, id MePendingAccessReviewInstanceIdStageIdDecisionId, input beta.GovernanceInsight) (result CreatePendingAccessReviewInstanceStageDecisionInsightOperationResponse, err error) {
