...
func (c PendingAccessReviewInstanceStageDecisionInsightClient) ListPendingAccessReviewInstanceStageDecisionInsights(ctx context.Context, id MePendingAccessReviewInstanceIdStageIdDecisionId) (result ListPendingAccessReviewInstanceStageDecisionInsightsOperationResponse, err error) {
...
func (c PendingAccessReviewInstanceStageDecisionInsightClient) ListPendingAccessReviewInstanceStageDecisionInsightsComplete(ctx context.Context, id MePendingAccessReviewInstanceIdStageIdDecisionId) (ListPendingAccessReviewInstanceStageDecisionInsightsCompleteResult, error) {
