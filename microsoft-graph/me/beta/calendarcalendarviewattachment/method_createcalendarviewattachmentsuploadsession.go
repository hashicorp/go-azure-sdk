...
func (c CalendarCalendarViewAttachmentClient) CreateCalendarViewAttachmentsUploadSession(ctx context.Context, id beta.MeCalendarCalendarViewId, input CreateCalendarViewAttachmentsUploadSessionRequest) (result CreateCalendarViewAttachmentsUploadSessionOperationResponse, err error) {
