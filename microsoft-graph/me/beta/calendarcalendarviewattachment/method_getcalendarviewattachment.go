...
func (c CalendarCalendarViewAttachmentClient) GetCalendarViewAttachment(ctx context.Context, id beta.MeCalendarIdCalendarViewIdAttachmentId, options GetCalendarViewAttachmentOperationOptions) (result GetCalendarViewAttachmentOperationResponse, err error) {
