...
func (c SettingStorageQuotaServiceClient) CreateSettingStorageQuotaService(ctx context.Context, input beta.ServiceStorageQuotaBreakdown) (result CreateSettingStorageQuotaServiceOperationResponse, err error) {
