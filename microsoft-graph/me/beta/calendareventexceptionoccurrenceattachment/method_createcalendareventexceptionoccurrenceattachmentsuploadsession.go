...
func (c CalendarEventExceptionOccurrenceAttachmentClient) CreateCalendarEventExceptionOccurrenceAttachmentsUploadSession(ctx context.Context, id beta.MeCalendarIdEventIdExceptionOccurrenceId, input CreateCalendarEventExceptionOccurrenceAttachmentsUploadSessionRequest) (result CreateCalendarEventExceptionOccurrenceAttachmentsUploadSessionOperationResponse, err error) {
