...
// DeleteCalendarEventExceptionOccurrenceAttachment - Delete navigation property attachments for me
func (c CalendarEventExceptionOccurrenceAttachmentClient) DeleteCalendarEventExceptionOccurrenceAttachment(ctx context.Context, id beta.MeCalendarEventIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarEventExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarEventExceptionOccurrenceAttachmentOperationResponse, err error) {
