...
func (c CalendarEventExceptionOccurrenceAttachmentClient) ListCalendarEventExceptionOccurrenceAttachmentsComplete(ctx context.Context, id beta.MeCalendarEventIdExceptionOccurrenceId, options ListCalendarEventExceptionOccurrenceAttachmentsOperationOptions) (ListCalendarEventExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c CalendarEventExceptionOccurrenceAttachmentClient) ListCalendarEventExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarEventIdExceptionOccurrenceId, options ListCalendarEventExceptionOccurrenceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarEventExceptionOccurrenceAttachmentsCompleteResult, err error) {
