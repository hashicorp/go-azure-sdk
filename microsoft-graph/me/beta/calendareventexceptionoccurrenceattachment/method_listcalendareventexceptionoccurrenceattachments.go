...
func (c CalendarEventExceptionOccurrenceAttachmentClient) ListCalendarEventExceptionOccurrenceAttachments(ctx context.Context, id MeCalendarIdEventIdExceptionOccurrenceId) (result ListCalendarEventExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceAttachmentClient) ListCalendarEventExceptionOccurrenceAttachmentsComplete(ctx context.Context, id MeCalendarIdEventIdExceptionOccurrenceId) (ListCalendarEventExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c CalendarEventExceptionOccurrenceAttachmentClient) ListCalendarEventExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id MeCalendarIdEventIdExceptionOccurrenceId, predicate AttachmentOperationPredicate) (result ListCalendarEventExceptionOccurrenceAttachmentsCompleteResult, err error) {
