...
// Updates – August 2021.
func (c DriveListContentTypeClient) AddDriveListContentTypesCopyFromHub(ctx context.Context, id beta.MeDriveId, input AddDriveListContentTypesCopyFromHubRequest) (result AddDriveListContentTypesCopyFromHubOperationResponse, err error) {
