...
func (c DriveListContentTypeClient) AddDriveListContentTypesCopy(ctx context.Context, id beta.MeDriveId, input AddDriveListContentTypesCopyRequest) (result AddDriveListContentTypesCopyOperationResponse, err error) {
