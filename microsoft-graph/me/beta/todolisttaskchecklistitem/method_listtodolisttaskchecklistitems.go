...
func (c TodoListTaskChecklistItemClient) ListTodoListTaskChecklistItems(ctx context.Context, id MeTodoListIdTaskId) (result ListTodoListTaskChecklistItemsOperationResponse, err error) {
...
func (c TodoListTaskChecklistItemClient) ListTodoListTaskChecklistItemsComplete(ctx context.Context, id MeTodoListIdTaskId) (ListTodoListTaskChecklistItemsCompleteResult, error) {
...
func (c TodoListTaskChecklistItemClient) ListTodoListTaskChecklistItemsCompleteMatchingPredicate(ctx context.Context, id MeTodoListIdTaskId, predicate ChecklistItemOperationPredicate) (result ListTodoListTaskChecklistItemsCompleteResult, err error) {
