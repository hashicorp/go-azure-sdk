...
func (c ChatClient) MarkChatReadForUser(ctx context.Context, id beta.MeChatId, input MarkChatReadForUserRequest) (result MarkChatReadForUserOperationResponse, err error) {
