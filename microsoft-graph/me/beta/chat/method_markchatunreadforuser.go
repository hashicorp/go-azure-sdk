...
func (c ChatClient) MarkChatUnreadForUser(ctx context.Context, id beta.MeChatId, input MarkChatUnreadForUserRequest) (result MarkChatUnreadForUserOperationResponse, err error) {
