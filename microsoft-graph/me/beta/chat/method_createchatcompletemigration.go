...
func (c ChatClient) CreateChatCompleteMigration(ctx context.Context, id beta.MeChatId, options CreateChatCompleteMigrationOperationOptions) (result CreateChatCompleteMigrationOperationResponse, err error) {
