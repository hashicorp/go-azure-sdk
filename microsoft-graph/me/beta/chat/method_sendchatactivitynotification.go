...
func (c ChatClient) SendChatActivityNotification(ctx context.Context, id beta.MeChatId, input SendChatActivityNotificationRequest) (result SendChatActivityNotificationOperationResponse, err error) {
