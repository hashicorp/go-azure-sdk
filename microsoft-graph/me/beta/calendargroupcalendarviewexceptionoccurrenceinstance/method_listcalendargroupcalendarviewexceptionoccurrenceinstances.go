...
func (c CalendarGroupCalendarViewExceptionOccurrenceInstanceClient) ListCalendarGroupCalendarViewExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, options ListCalendarGroupCalendarViewExceptionOccurrenceInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarGroupCalendarViewExceptionOccurrenceInstancesCompleteResult, err error) {
