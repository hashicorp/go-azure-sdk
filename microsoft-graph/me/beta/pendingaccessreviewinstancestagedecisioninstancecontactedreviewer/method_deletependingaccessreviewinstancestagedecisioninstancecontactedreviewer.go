...
func (c PendingAccessReviewInstanceStageDecisionInstanceContactedReviewerClient) DeletePendingAccessReviewInstanceStageDecisionInstanceContactedReviewer(ctx context.Context, id MePendingAccessReviewInstanceIdStageIdDecisionIdInstanceContactedReviewerId) (result DeletePendingAccessReviewInstanceStageDecisionInstanceContactedReviewerOperationResponse, err error) {
