...
func (c CalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) ListCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id MeCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId, predicate AttachmentOperationPredicate) (result ListCalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteResult, err error) {
