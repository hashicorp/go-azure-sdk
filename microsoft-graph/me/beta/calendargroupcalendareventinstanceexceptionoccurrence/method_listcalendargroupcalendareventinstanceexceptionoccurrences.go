...
// ListCalendarGroupCalendarEventInstanceExceptionOccurrences - Get exceptionOccurrences from me
func (c CalendarGroupCalendarEventInstanceExceptionOccurrenceClient) ListCalendarGroupCalendarEventInstanceExceptionOccurrences(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventIdInstanceId, options ListCalendarGroupCalendarEventInstanceExceptionOccurrencesOperationOptions) (result ListCalendarGroupCalendarEventInstanceExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventInstanceExceptionOccurrenceClient) ListCalendarGroupCalendarEventInstanceExceptionOccurrencesComplete(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdEventIdInstanceId, options ListCalendarGroupCalendarEventInstanceExceptionOccurrencesOperationOptions) (ListCalendarGroupCalendarEventInstanceExceptionOccurrencesCompleteResult, error) {
