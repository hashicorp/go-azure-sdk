...
// UpdateSecurityInformationProtectionSensitivityLabel ...
func (c SecurityInformationProtectionSensitivityLabelClient) UpdateSecurityInformationProtectionSensitivityLabel(ctx context.Context, id MeSecurityInformationProtectionSensitivityLabelId, input beta.SecuritySensitivityLabel) (result UpdateSecurityInformationProtectionSensitivityLabelOperationResponse, err error) {
