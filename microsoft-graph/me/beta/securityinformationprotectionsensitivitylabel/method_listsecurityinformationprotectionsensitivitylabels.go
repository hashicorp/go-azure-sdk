...
func (c SecurityInformationProtectionSensitivityLabelClient) ListSecurityInformationProtectionSensitivityLabels(ctx context.Context) (result ListSecurityInformationProtectionSensitivityLabelsOperationResponse, err error) {
...
func (c SecurityInformationProtectionSensitivityLabelClient) ListSecurityInformationProtectionSensitivityLabelsComplete(ctx context.Context) (ListSecurityInformationProtectionSensitivityLabelsCompleteResult, error) {
	return c.ListSecurityInformationProtectionSensitivityLabelsCompleteMatchingPredicate(ctx, SecuritySensitivityLabelOperationPredicate{})
}
...
func (c SecurityInformationProtectionSensitivityLabelClient) ListSecurityInformationProtectionSensitivityLabelsCompleteMatchingPredicate(ctx context.Context, predicate SecuritySensitivityLabelOperationPredicate) (result ListSecurityInformationProtectionSensitivityLabelsCompleteResult, err error) {
	items := make([]beta.SecuritySensitivityLabel, 0)

	resp, err := c.ListSecurityInformationProtectionSensitivityLabels(ctx)
	if err != nil {
