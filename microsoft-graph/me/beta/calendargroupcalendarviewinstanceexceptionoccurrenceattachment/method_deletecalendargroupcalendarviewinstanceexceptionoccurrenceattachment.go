...
func (c CalendarGroupCalendarViewInstanceExceptionOccurrenceAttachmentClient) DeleteCalendarGroupCalendarViewInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.MeCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarGroupCalendarViewInstanceExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarGroupCalendarViewInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
