...
func (c DriveRootAnalyticsItemActivityStatClient) CreateDriveRootAnalyticsItemActivityStat(ctx context.Context, id beta.MeDriveId, input beta.ItemActivityStat) (result CreateDriveRootAnalyticsItemActivityStatOperationResponse, err error) {
