...
func (c EventInstanceExceptionOccurrenceAttachmentClient) ListEventInstanceExceptionOccurrenceAttachments(ctx context.Context, id MeEventIdInstanceIdExceptionOccurrenceId) (result ListEventInstanceExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c EventInstanceExceptionOccurrenceAttachmentClient) ListEventInstanceExceptionOccurrenceAttachmentsComplete(ctx context.Context, id MeEventIdInstanceIdExceptionOccurrenceId) (ListEventInstanceExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c EventInstanceExceptionOccurrenceAttachmentClient) ListEventInstanceExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id MeEventIdInstanceIdExceptionOccurrenceId, predicate AttachmentOperationPredicate) (result ListEventInstanceExceptionOccurrenceAttachmentsCompleteResult, err error) {
