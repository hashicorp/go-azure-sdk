...
func (c CalendarViewExceptionOccurrenceInstanceAttachmentClient) CreateCalendarViewExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.MeCalendarViewIdExceptionOccurrenceIdInstanceId, input beta.Attachment) (result CreateCalendarViewExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
