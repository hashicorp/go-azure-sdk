...
func (c CalendarViewExceptionOccurrenceInstanceAttachmentClient) GetCalendarViewExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.MeCalendarViewIdExceptionOccurrenceIdInstanceIdAttachmentId, options GetCalendarViewExceptionOccurrenceInstanceAttachmentOperationOptions) (result GetCalendarViewExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
