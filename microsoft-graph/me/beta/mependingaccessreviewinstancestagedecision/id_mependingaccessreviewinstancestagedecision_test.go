...
func TestNewMePendingAccessReviewInstanceStageDecisionID(t *testing.T) {
	id := NewMePendingAccessReviewInstanceStageDecisionID("accessReviewInstanceIdValue", "accessReviewStageIdValue", "accessReviewInstanceDecisionItemIdValue")
...
func TestFormatMePendingAccessReviewInstanceStageDecisionID(t *testing.T) {
	actual := NewMePendingAccessReviewInstanceStageDecisionID("accessReviewInstanceIdValue", "accessReviewStageIdValue", "accessReviewInstanceDecisionItemIdValue").ID()
...
func TestParseMePendingAccessReviewInstanceStageDecisionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MePendingAccessReviewInstanceStageDecisionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMePendingAccessReviewInstanceStageDecisionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMePendingAccessReviewInstanceStageDecisionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MePendingAccessReviewInstanceStageDecisionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMePendingAccessReviewInstanceStageDecisionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMePendingAccessReviewInstanceStageDecisionId(t *testing.T) {
	segments := MePendingAccessReviewInstanceStageDecisionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MePendingAccessReviewInstanceStageDecisionId has no segments")
	}
