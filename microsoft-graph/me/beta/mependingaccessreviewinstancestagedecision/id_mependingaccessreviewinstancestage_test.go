...
func TestNewMePendingAccessReviewInstanceStageID(t *testing.T) {
	id := NewMePendingAccessReviewInstanceStageID("accessReviewInstanceIdValue", "accessReviewStageIdValue")
...
func TestFormatMePendingAccessReviewInstanceStageID(t *testing.T) {
	actual := NewMePendingAccessReviewInstanceStageID("accessReviewInstanceIdValue", "accessReviewStageIdValue").ID()
...
func TestParseMePendingAccessReviewInstanceStageID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MePendingAccessReviewInstanceStageId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMePendingAccessReviewInstanceStageID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMePendingAccessReviewInstanceStageIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MePendingAccessReviewInstanceStageId
	...
	for _, v := range testData {
		...
		actual, err := ParseMePendingAccessReviewInstanceStageIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMePendingAccessReviewInstanceStageId(t *testing.T) {
	segments := MePendingAccessReviewInstanceStageId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MePendingAccessReviewInstanceStageId has no segments")
	}
