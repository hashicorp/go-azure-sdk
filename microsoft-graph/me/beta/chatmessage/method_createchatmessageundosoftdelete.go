...
func (c ChatMessageClient) CreateChatMessageUndoSoftDelete(ctx context.Context, id beta.MeChatIdMessageId) (result CreateChatMessageUndoSoftDeleteOperationResponse, err error) {
