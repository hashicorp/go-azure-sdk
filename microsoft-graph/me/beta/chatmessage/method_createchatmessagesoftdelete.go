...
// channel or a chat.
func (c ChatMessageClient) CreateChatMessageSoftDelete(ctx context.Context, id beta.MeChatIdMessageId) (result CreateChatMessageSoftDeleteOperationResponse, err error) {
