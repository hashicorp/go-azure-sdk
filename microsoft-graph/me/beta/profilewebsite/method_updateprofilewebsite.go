...
func (c ProfileWebsiteClient) UpdateProfileWebsite(ctx context.Context, id beta.MeProfileWebsiteId, input beta.PersonWebsite) (result UpdateProfileWebsiteOperationResponse, err error) {
