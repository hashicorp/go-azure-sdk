...
func (c MailFolderChildFolderMessageClient) SetMailFolderChildFolderMessageValue(ctx context.Context, id beta.MeMailFolderIdChildFolderIdMessageId, input []byte) (result SetMailFolderChildFolderMessageValueOperationResponse, err error) {
