...
func (c MailFolderChildFolderMessageClient) MarkMailFolderChildFolderMessageAsJunk(ctx context.Context, id beta.MeMailFolderIdChildFolderIdMessageId, input MarkMailFolderChildFolderMessageAsJunkRequest) (result MarkMailFolderChildFolderMessageAsJunkOperationResponse, err error) {
