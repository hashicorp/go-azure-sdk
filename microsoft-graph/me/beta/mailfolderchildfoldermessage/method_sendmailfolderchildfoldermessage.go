...
func (c MailFolderChildFolderMessageClient) SendMailFolderChildFolderMessage(ctx context.Context, id beta.MeMailFolderIdChildFolderIdMessageId) (result SendMailFolderChildFolderMessageOperationResponse, err error) {
