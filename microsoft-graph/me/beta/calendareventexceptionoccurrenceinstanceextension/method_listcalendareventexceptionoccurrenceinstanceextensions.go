...
// ListCalendarEventExceptionOccurrenceInstanceExtensions ...
func (c CalendarEventExceptionOccurrenceInstanceExtensionClient) ListCalendarEventExceptionOccurrenceInstanceExtensions(ctx context.Context, id MeCalendarEventIdExceptionOccurrenceIdInstanceId) (result ListCalendarEventExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceInstanceExtensionClient) ListCalendarEventExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id MeCalendarEventIdExceptionOccurrenceIdInstanceId) (ListCalendarEventExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
	return c.ListCalendarEventExceptionOccurrenceInstanceExtensionsCompleteMatchingPredicate(ctx, id, ExtensionOperationPredicate{})
}
