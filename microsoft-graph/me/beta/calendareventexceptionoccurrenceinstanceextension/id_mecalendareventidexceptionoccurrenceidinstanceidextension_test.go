...
func TestNewMeCalendarEventIdExceptionOccurrenceIdInstanceIdExtensionID(t *testing.T) {
	id := NewMeCalendarEventIdExceptionOccurrenceIdInstanceIdExtensionID("eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue")
...
func TestFormatMeCalendarEventIdExceptionOccurrenceIdInstanceIdExtensionID(t *testing.T) {
	actual := NewMeCalendarEventIdExceptionOccurrenceIdInstanceIdExtensionID("eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue").ID()
...
func TestParseMeCalendarEventIdExceptionOccurrenceIdInstanceIdExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarEventIdExceptionOccurrenceIdInstanceIdExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarEventIdExceptionOccurrenceIdInstanceIdExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarEventIdExceptionOccurrenceIdInstanceIdExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarEventIdExceptionOccurrenceIdInstanceIdExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarEventIdExceptionOccurrenceIdInstanceIdExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarEventIdExceptionOccurrenceIdInstanceIdExtensionId(t *testing.T) {
	segments := MeCalendarEventIdExceptionOccurrenceIdInstanceIdExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarEventIdExceptionOccurrenceIdInstanceIdExtensionId has no segments")
	}
