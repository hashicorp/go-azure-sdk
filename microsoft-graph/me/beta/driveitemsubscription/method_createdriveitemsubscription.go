...
func (c DriveItemSubscriptionClient) CreateDriveItemSubscription(ctx context.Context, id beta.MeDriveIdItemId, input beta.Subscription) (result CreateDriveItemSubscriptionOperationResponse, err error) {
