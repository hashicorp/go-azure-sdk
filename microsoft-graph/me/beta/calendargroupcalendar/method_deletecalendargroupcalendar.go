...
func (c CalendarGroupCalendarClient) DeleteCalendarGroupCalendar(ctx context.Context, id beta.MeCalendarGroupIdCalendarId, options DeleteCalendarGroupCalendarOperationOptions) (result DeleteCalendarGroupCalendarOperationResponse, err error) {
