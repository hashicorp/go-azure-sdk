...
func (c ProfileCertificationClient) GetProfileCertification(ctx context.Context, id MeProfileCertificationId) (result GetProfileCertificationOperationResponse, err error) {
