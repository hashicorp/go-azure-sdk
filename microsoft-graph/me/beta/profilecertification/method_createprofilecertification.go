...
func (c ProfileCertificationClient) CreateProfileCertification(ctx context.Context, input beta.PersonCertification) (result CreateProfileCertificationOperationResponse, err error) {
