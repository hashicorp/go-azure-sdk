...
// ListCalendarViewExceptionOccurrences - Get exceptionOccurrences from me
func (c CalendarCalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrences(ctx context.Context, id beta.MeCalendarCalendarViewId, options ListCalendarViewExceptionOccurrencesOperationOptions) (result ListCalendarViewExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrencesComplete(ctx context.Context, id beta.MeCalendarCalendarViewId, options ListCalendarViewExceptionOccurrencesOperationOptions) (ListCalendarViewExceptionOccurrencesCompleteResult, error) {
