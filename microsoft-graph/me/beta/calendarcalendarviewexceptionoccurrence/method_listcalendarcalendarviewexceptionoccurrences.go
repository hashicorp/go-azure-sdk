...
func (c CalendarCalendarViewExceptionOccurrenceClient) ListCalendarCalendarViewExceptionOccurrences(ctx context.Context, id MeCalendarIdCalendarViewId) (result ListCalendarCalendarViewExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceClient) ListCalendarCalendarViewExceptionOccurrencesComplete(ctx context.Context, id MeCalendarIdCalendarViewId) (ListCalendarCalendarViewExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarCalendarViewExceptionOccurrenceClient) ListCalendarCalendarViewExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id MeCalendarIdCalendarViewId, predicate EventOperationPredicate) (result ListCalendarCalendarViewExceptionOccurrencesCompleteResult, err error) {
