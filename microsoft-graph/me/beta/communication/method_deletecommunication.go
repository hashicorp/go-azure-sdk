...
// DeleteCommunication - Delete navigation property communications for me
func (c CommunicationClient) DeleteCommunication(ctx context.Context, options DeleteCommunicationOperationOptions) (result DeleteCommunicationOperationResponse, err error) {
