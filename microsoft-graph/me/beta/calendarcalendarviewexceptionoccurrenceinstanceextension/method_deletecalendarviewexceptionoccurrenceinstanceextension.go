...
// DeleteCalendarViewExceptionOccurrenceInstanceExtension - Delete navigation property extensions for me
func (c CalendarCalendarViewExceptionOccurrenceInstanceExtensionClient) DeleteCalendarViewExceptionOccurrenceInstanceExtension(ctx context.Context, id beta.MeCalendarCalendarViewIdExceptionOccurrenceIdInstanceIdExtensionId, options DeleteCalendarViewExceptionOccurrenceInstanceExtensionOperationOptions) (result DeleteCalendarViewExceptionOccurrenceInstanceExtensionOperationResponse, err error) {
