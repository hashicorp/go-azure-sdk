...
func (c ManagedDeviceCategoryClient) UpdateManagedDeviceCategory(ctx context.Context, id beta.MeManagedDeviceId, input beta.DeviceCategory) (result UpdateManagedDeviceCategoryOperationResponse, err error) {
