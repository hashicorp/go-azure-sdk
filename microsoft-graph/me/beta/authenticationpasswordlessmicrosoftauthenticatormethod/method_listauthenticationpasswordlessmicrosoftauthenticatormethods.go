...
func (c AuthenticationPasswordlessMicrosoftAuthenticatorMethodClient) ListAuthenticationPasswordlessMicrosoftAuthenticatorMethods(ctx context.Context) (result ListAuthenticationPasswordlessMicrosoftAuthenticatorMethodsOperationResponse, err error) {
...
func (c AuthenticationPasswordlessMicrosoftAuthenticatorMethodClient) ListAuthenticationPasswordlessMicrosoftAuthenticatorMethodsComplete(ctx context.Context) (ListAuthenticationPasswordlessMicrosoftAuthenticatorMethodsCompleteResult, error) {
	return c.ListAuthenticationPasswordlessMicrosoftAuthenticatorMethodsCompleteMatchingPredicate(ctx, PasswordlessMicrosoftAuthenticatorAuthenticationMethodOperationPredicate{})
}
...
func (c AuthenticationPasswordlessMicrosoftAuthenticatorMethodClient) ListAuthenticationPasswordlessMicrosoftAuthenticatorMethodsCompleteMatchingPredicate(ctx context.Context, predicate PasswordlessMicrosoftAuthenticatorAuthenticationMethodOperationPredicate) (result ListAuthenticationPasswordlessMicrosoftAuthenticatorMethodsCompleteResult, err error) {
	items := make([]beta.PasswordlessMicrosoftAuthenticatorAuthenticationMethod, 0)

	resp, err := c.ListAuthenticationPasswordlessMicrosoftAuthenticatorMethods(ctx)
	if err != nil {
