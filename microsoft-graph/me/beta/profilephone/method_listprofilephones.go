...
// ListProfilePhones ...
func (c ProfilePhoneClient) ListProfilePhones(ctx context.Context) (result ListProfilePhonesOperationResponse, err error) {
...
func (c ProfilePhoneClient) ListProfilePhonesComplete(ctx context.Context) (ListProfilePhonesCompleteResult, error) {
	return c.ListProfilePhonesCompleteMatchingPredicate(ctx, ItemPhoneOperationPredicate{})
}

// ListProfilePhonesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfilePhoneClient) ListProfilePhonesCompleteMatchingPredicate(ctx context.Context, predicate ItemPhoneOperationPredicate) (result ListProfilePhonesCompleteResult, err error) {
	items := make([]beta.ItemPhone, 0)

	resp, err := c.ListProfilePhones(ctx)
	if err != nil {
