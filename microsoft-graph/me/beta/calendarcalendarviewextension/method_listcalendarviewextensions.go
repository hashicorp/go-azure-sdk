...
// Nullable.
func (c CalendarCalendarViewExtensionClient) ListCalendarViewExtensions(ctx context.Context, id beta.MeCalendarCalendarViewId, options ListCalendarViewExtensionsOperationOptions) (result ListCalendarViewExtensionsOperationResponse, err error) {
...
func (c CalendarCalendarViewExtensionClient) ListCalendarViewExtensionsComplete(ctx context.Context, id beta.MeCalendarCalendarViewId, options ListCalendarViewExtensionsOperationOptions) (ListCalendarViewExtensionsCompleteResult, error) {
...
func (c CalendarCalendarViewExtensionClient) ListCalendarViewExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.MeCalendarCalendarViewId, options ListCalendarViewExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarViewExtensionsCompleteResult, err error) {
