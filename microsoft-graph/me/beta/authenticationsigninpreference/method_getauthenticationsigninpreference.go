...
func (c AuthenticationSignInPreferenceClient) GetAuthenticationSignInPreference(ctx context.Context) (result GetAuthenticationSignInPreferenceOperationResponse, err error) {
