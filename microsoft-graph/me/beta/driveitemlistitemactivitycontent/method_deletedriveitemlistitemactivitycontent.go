...
func (c DriveItemListItemActivityContentClient) DeleteDriveItemListItemActivityContent(ctx context.Context, id beta.MeDriveIdItemIdListItemActivityId, options DeleteDriveItemListItemActivityContentOperationOptions) (result DeleteDriveItemListItemActivityContentOperationResponse, err error) {
