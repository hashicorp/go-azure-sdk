...
func (c DriveItemListItemActivityContentClient) GetDriveItemListItemActivityContent(ctx context.Context, id beta.MeDriveIdItemIdListItemActivityId, options GetDriveItemListItemActivityContentOperationOptions) (result GetDriveItemListItemActivityContentOperationResponse, err error) {
