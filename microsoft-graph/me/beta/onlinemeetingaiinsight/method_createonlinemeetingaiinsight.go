...
// CreateOnlineMeetingAiInsight - Create new navigation property to aiInsights for me
func (c OnlineMeetingAiInsightClient) CreateOnlineMeetingAiInsight(ctx context.Context, id beta.MeOnlineMeetingId, input beta.CallAiInsight, options CreateOnlineMeetingAiInsightOperationOptions) (result CreateOnlineMeetingAiInsightOperationResponse, err error) {
