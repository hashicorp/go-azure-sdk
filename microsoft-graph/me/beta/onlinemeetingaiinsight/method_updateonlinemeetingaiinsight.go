...
// UpdateOnlineMeetingAiInsight - Update the navigation property aiInsights in me
func (c OnlineMeetingAiInsightClient) UpdateOnlineMeetingAiInsight(ctx context.Context, id beta.MeOnlineMeetingIdAiInsightId, input beta.CallAiInsight, options UpdateOnlineMeetingAiInsightOperationOptions) (result UpdateOnlineMeetingAiInsightOperationResponse, err error) {
