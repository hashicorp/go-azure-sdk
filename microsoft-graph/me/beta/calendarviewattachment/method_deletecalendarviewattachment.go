...
func (c CalendarViewAttachmentClient) DeleteCalendarViewAttachment(ctx context.Context, id beta.MeCalendarViewIdAttachmentId, options DeleteCalendarViewAttachmentOperationOptions) (result DeleteCalendarViewAttachmentOperationResponse, err error) {
