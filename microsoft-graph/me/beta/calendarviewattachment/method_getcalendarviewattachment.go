...
func (c CalendarViewAttachmentClient) GetCalendarViewAttachment(ctx context.Context, id beta.MeCalendarViewIdAttachmentId, options GetCalendarViewAttachmentOperationOptions) (result GetCalendarViewAttachmentOperationResponse, err error) {
