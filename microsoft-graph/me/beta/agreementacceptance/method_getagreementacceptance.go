...
func (c AgreementAcceptanceClient) GetAgreementAcceptance(ctx context.Context, id MeAgreementAcceptanceId) (result GetAgreementAcceptanceOperationResponse, err error) {
