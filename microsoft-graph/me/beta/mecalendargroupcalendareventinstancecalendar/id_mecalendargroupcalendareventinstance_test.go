package mecalendargroupcalendareventinstancecalendar
...
func TestNewMeCalendarGroupCalendarEventInstanceID(t *testing.T) {
	id := NewMeCalendarGroupCalendarEventInstanceID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value")
...
func TestFormatMeCalendarGroupCalendarEventInstanceID(t *testing.T) {
	actual := NewMeCalendarGroupCalendarEventInstanceID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value").ID()
...
func TestParseMeCalendarGroupCalendarEventInstanceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupCalendarEventInstanceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupCalendarEventInstanceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarGroupCalendarEventInstanceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupCalendarEventInstanceId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupCalendarEventInstanceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarGroupCalendarEventInstanceId(t *testing.T) {
	segments := MeCalendarGroupCalendarEventInstanceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarGroupCalendarEventInstanceId has no segments")
	}
