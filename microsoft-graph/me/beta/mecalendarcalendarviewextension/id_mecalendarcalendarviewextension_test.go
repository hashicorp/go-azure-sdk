...
func TestNewMeCalendarCalendarViewExtensionID(t *testing.T) {
	id := NewMeCalendarCalendarViewExtensionID("calendarIdValue", "eventIdValue", "extensionIdValue")
...
func TestFormatMeCalendarCalendarViewExtensionID(t *testing.T) {
	actual := NewMeCalendarCalendarViewExtensionID("calendarIdValue", "eventIdValue", "extensionIdValue").ID()
...
func TestParseMeCalendarCalendarViewExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarCalendarViewExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarCalendarViewExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarCalendarViewExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarCalendarViewExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarCalendarViewExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarCalendarViewExtensionId(t *testing.T) {
	segments := MeCalendarCalendarViewExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarCalendarViewExtensionId has no segments")
	}
