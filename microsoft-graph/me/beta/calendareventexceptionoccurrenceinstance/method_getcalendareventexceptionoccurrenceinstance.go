...
// GetCalendarEventExceptionOccurrenceInstance - Get instances from me. The occurrences of a recurring series, if the
...
func (c CalendarEventExceptionOccurrenceInstanceClient) GetCalendarEventExceptionOccurrenceInstance(ctx context.Context, id beta.MeCalendarIdEventIdExceptionOccurrenceIdInstanceId, options GetCalendarEventExceptionOccurrenceInstanceOperationOptions) (result GetCalendarEventExceptionOccurrenceInstanceOperationResponse, err error) {
