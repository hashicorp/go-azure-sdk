...
func (c CalendarEventExceptionOccurrenceInstanceClient) DismissCalendarEventExceptionOccurrenceInstanceReminder(ctx context.Context, id beta.MeCalendarEventIdExceptionOccurrenceIdInstanceId) (result DismissCalendarEventExceptionOccurrenceInstanceReminderOperationResponse, err error) {
