...
// times.
func (c CalendarEventExceptionOccurrenceInstanceClient) TentativelyAcceptCalendarEventExceptionOccurrenceInstance(ctx context.Context, id beta.MeCalendarEventIdExceptionOccurrenceIdInstanceId, input TentativelyAcceptCalendarEventExceptionOccurrenceInstanceRequest) (result TentativelyAcceptCalendarEventExceptionOccurrenceInstanceOperationResponse, err error) {
