...
func (c CalendarEventExceptionOccurrenceInstanceClient) SnoozeCalendarEventExceptionOccurrenceInstanceReminder(ctx context.Context, id beta.MeCalendarEventIdExceptionOccurrenceIdInstanceId, input SnoozeCalendarEventExceptionOccurrenceInstanceReminderRequest) (result SnoozeCalendarEventExceptionOccurrenceInstanceReminderOperationResponse, err error) {
