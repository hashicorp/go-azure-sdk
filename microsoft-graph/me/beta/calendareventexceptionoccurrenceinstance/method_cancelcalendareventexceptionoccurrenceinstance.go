...
// cancellation.
func (c CalendarEventExceptionOccurrenceInstanceClient) CancelCalendarEventExceptionOccurrenceInstance(ctx context.Context, id beta.MeCalendarEventIdExceptionOccurrenceIdInstanceId, input CancelCalendarEventExceptionOccurrenceInstanceRequest) (result CancelCalendarEventExceptionOccurrenceInstanceOperationResponse, err error) {
