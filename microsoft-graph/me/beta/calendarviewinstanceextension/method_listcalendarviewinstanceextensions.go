...
func (c CalendarViewInstanceExtensionClient) ListCalendarViewInstanceExtensions(ctx context.Context, id MeCalendarViewIdInstanceId) (result ListCalendarViewInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarViewInstanceExtensionClient) ListCalendarViewInstanceExtensionsComplete(ctx context.Context, id MeCalendarViewIdInstanceId) (ListCalendarViewInstanceExtensionsCompleteResult, error) {
...
func (c CalendarViewInstanceExtensionClient) ListCalendarViewInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id MeCalendarViewIdInstanceId, predicate ExtensionOperationPredicate) (result ListCalendarViewInstanceExtensionsCompleteResult, err error) {
