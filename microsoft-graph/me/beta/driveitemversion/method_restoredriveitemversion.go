...
func (c DriveItemVersionClient) RestoreDriveItemVersion(ctx context.Context, id beta.MeDriveIdItemIdVersionId) (result RestoreDriveItemVersionOperationResponse, err error) {
