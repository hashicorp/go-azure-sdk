...
func (c DriveItemVersionClient) CreateDriveItemVersion(ctx context.Context, id beta.MeDriveIdItemId, input beta.DriveItemVersion) (result CreateDriveItemVersionOperationResponse, err error) {
