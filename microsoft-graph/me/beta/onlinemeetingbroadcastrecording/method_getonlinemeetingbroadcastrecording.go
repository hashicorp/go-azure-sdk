...
func (c OnlineMeetingBroadcastRecordingClient) GetOnlineMeetingBroadcastRecording(ctx context.Context, id beta.MeOnlineMeetingId) (result GetOnlineMeetingBroadcastRecordingOperationResponse, err error) {
