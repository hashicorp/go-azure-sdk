...
// ListDeviceMemberOf ...
func (c DeviceMemberOfClient) ListDeviceMemberOf(ctx context.Context, id MeDeviceId) (result ListDeviceMemberOfOperationResponse, err error) {
...
func (c DeviceMemberOfClient) ListDeviceMemberOfComplete(ctx context.Context, id MeDeviceId) (ListDeviceMemberOfCompleteResult, error) {
...
func (c DeviceMemberOfClient) ListDeviceMemberOfCompleteMatchingPredicate(ctx context.Context, id MeDeviceId, predicate DirectoryObjectOperationPredicate) (result ListDeviceMemberOfCompleteResult, err error) {
