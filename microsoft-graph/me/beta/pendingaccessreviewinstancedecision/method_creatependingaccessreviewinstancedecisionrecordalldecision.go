...
func (c PendingAccessReviewInstanceDecisionClient) CreatePendingAccessReviewInstanceDecisionRecordAllDecision(ctx context.Context, id MePendingAccessReviewInstanceId, input CreatePendingAccessReviewInstanceDecisionRecordAllDecisionRequest) (result CreatePendingAccessReviewInstanceDecisionRecordAllDecisionOperationResponse, err error) {
