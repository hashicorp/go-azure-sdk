...
func (c DriveItemListItemDriveItemContentClient) SetDriveItemListItemDriveItemContent(ctx context.Context, id beta.MeDriveIdItemId, input []byte) (result SetDriveItemListItemDriveItemContentOperationResponse, err error) {
