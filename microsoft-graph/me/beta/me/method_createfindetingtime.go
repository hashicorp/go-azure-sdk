...
type CreateFindetingTimeOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *beta.MeetingTimeSuggestionsResult
}

// CreateFindetingTime - Invoke action findMeetingTimes. Suggest meeting times and locations based on organizer and
...
func (c MeClient) CreateFindetingTime(ctx context.Context, input CreateFindetingTimeRequest) (result CreateFindetingTimeOperationResponse, err error) {
