...
// Read-only.
func (c CalendarEventCalendarClient) GetCalendarEventCalendar(ctx context.Context, id beta.MeCalendarIdEventId, options GetCalendarEventCalendarOperationOptions) (result GetCalendarEventCalendarOperationResponse, err error) {
