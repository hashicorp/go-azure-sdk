...
// a new time.
func (c CalendarEventClient) SnoozeCalendarEventReminder(ctx context.Context, id beta.MeCalendarEventId, input SnoozeCalendarEventReminderRequest) (result SnoozeCalendarEventReminderOperationResponse, err error) {
