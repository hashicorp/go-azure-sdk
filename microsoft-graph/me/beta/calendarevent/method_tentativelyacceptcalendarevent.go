...
func (c CalendarEventClient) TentativelyAcceptCalendarEvent(ctx context.Context, id beta.MeCalendarIdEventId, input TentativelyAcceptCalendarEventRequest) (result TentativelyAcceptCalendarEventOperationResponse, err error) {
