...
func (c CalendarEventClient) GetCalendarEvent(ctx context.Context, id beta.MeCalendarEventId, options GetCalendarEventOperationOptions) (result GetCalendarEventOperationResponse, err error) {
