...
// Outlook.com account.
func (c CalendarEventClient) ForwardCalendarEvent(ctx context.Context, id beta.MeCalendarIdEventId, input ForwardCalendarEventRequest) (result ForwardCalendarEventOperationResponse, err error) {
