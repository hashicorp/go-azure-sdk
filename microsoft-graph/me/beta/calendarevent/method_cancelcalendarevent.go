...
func (c CalendarEventClient) CancelCalendarEvent(ctx context.Context, id beta.MeCalendarEventId, input CancelCalendarEventRequest) (result CancelCalendarEventOperationResponse, err error) {
