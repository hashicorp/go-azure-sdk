...
func (c CalendarEventClient) DeclineCalendarEvent(ctx context.Context, id beta.MeCalendarEventId, input DeclineCalendarEventRequest) (result DeclineCalendarEventOperationResponse, err error) {
