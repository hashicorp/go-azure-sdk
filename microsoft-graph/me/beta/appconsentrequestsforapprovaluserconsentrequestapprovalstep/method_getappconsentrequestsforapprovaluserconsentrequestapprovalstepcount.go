...
func (c AppConsentRequestsForApprovalUserConsentRequestApprovalStepClient) GetAppConsentRequestsForApprovalUserConsentRequestApprovalStepCount(ctx context.Context, id MeAppConsentRequestsForApprovalIdUserConsentRequestId) (result GetAppConsentRequestsForApprovalUserConsentRequestApprovalStepCountOperationResponse, err error) {
