...
func TestNewMeMailFolderMessageMentionID(t *testing.T) {
	id := NewMeMailFolderMessageMentionID("mailFolderIdValue", "messageIdValue", "mentionIdValue")
...
func TestFormatMeMailFolderMessageMentionID(t *testing.T) {
	actual := NewMeMailFolderMessageMentionID("mailFolderIdValue", "messageIdValue", "mentionIdValue").ID()
...
func TestParseMeMailFolderMessageMentionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeMailFolderMessageMentionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeMailFolderMessageMentionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeMailFolderMessageMentionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeMailFolderMessageMentionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeMailFolderMessageMentionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeMailFolderMessageMentionId(t *testing.T) {
	segments := MeMailFolderMessageMentionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeMailFolderMessageMentionId has no segments")
	}
