...
func (c OutlookTaskGroupClient) ListOutlookTaskGroups(ctx context.Context) (result ListOutlookTaskGroupsOperationResponse, err error) {
...
func (c OutlookTaskGroupClient) ListOutlookTaskGroupsComplete(ctx context.Context) (ListOutlookTaskGroupsCompleteResult, error) {
	return c.ListOutlookTaskGroupsCompleteMatchingPredicate(ctx, OutlookTaskGroupOperationPredicate{})
}

// ListOutlookTaskGroupsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c OutlookTaskGroupClient) ListOutlookTaskGroupsCompleteMatchingPredicate(ctx context.Context, predicate OutlookTaskGroupOperationPredicate) (result ListOutlookTaskGroupsCompleteResult, err error) {
	items := make([]beta.OutlookTaskGroup, 0)

	resp, err := c.ListOutlookTaskGroups(ctx)
	if err != nil {
