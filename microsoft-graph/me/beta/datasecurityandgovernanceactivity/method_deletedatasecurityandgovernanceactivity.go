...
// DeleteDataSecurityAndGovernanceActivity - Delete navigation property activities for me
func (c DataSecurityAndGovernanceActivityClient) DeleteDataSecurityAndGovernanceActivity(ctx context.Context, options DeleteDataSecurityAndGovernanceActivityOperationOptions) (result DeleteDataSecurityAndGovernanceActivityOperationResponse, err error) {
