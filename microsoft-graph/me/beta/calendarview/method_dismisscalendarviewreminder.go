...
// in a user calendar.
func (c CalendarViewClient) DismissCalendarViewReminder(ctx context.Context, id beta.MeCalendarViewId) (result DismissCalendarViewReminderOperationResponse, err error) {
