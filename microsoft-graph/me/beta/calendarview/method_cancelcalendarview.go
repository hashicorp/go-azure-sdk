...
func (c CalendarViewClient) CancelCalendarView(ctx context.Context, id beta.MeCalendarViewId, input CancelCalendarViewRequest) (result CancelCalendarViewOperationResponse, err error) {
