...
// view defined by a time range, from the user's default calendar, or from some other calendar of the user's.
func (c CalendarViewClient) ListCalendarViews(ctx context.Context, options ListCalendarViewsOperationOptions) (result ListCalendarViewsOperationResponse, err error) {
...
func (c CalendarViewClient) ListCalendarViewsComplete(ctx context.Context, options ListCalendarViewsOperationOptions) (ListCalendarViewsCompleteResult, error) {
...
func (c CalendarViewClient) ListCalendarViewsCompleteMatchingPredicate(ctx context.Context, options ListCalendarViewsOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewsCompleteResult, err error) {
