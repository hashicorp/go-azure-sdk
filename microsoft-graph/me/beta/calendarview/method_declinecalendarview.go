...
func (c CalendarViewClient) DeclineCalendarView(ctx context.Context, id beta.MeCalendarViewId, input DeclineCalendarViewRequest) (result DeclineCalendarViewOperationResponse, err error) {
