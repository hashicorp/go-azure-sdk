...
func (c CalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id beta.MeCalendarViewId, input TentativelyAcceptCalendarViewRequest) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
