...
// a new time.
func (c CalendarViewClient) SnoozeCalendarViewReminder(ctx context.Context, id beta.MeCalendarViewId, input SnoozeCalendarViewReminderRequest) (result SnoozeCalendarViewReminderOperationResponse, err error) {
