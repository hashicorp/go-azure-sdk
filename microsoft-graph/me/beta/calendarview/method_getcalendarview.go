...
func (c CalendarViewClient) GetCalendarView(ctx context.Context, id beta.MeCalendarViewId, options GetCalendarViewOperationOptions) (result GetCalendarViewOperationResponse, err error) {
