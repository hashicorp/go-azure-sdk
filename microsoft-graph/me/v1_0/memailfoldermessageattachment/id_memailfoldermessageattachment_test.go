...
func TestNewMeMailFolderMessageAttachmentID(t *testing.T) {
	id := NewMeMailFolderMessageAttachmentID("mailFolderIdValue", "messageIdValue", "attachmentIdValue")
...
func TestFormatMeMailFolderMessageAttachmentID(t *testing.T) {
	actual := NewMeMailFolderMessageAttachmentID("mailFolderIdValue", "messageIdValue", "attachmentIdValue").ID()
...
func TestParseMeMailFolderMessageAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeMailFolderMessageAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeMailFolderMessageAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeMailFolderMessageAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeMailFolderMessageAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeMailFolderMessageAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeMailFolderMessageAttachmentId(t *testing.T) {
	segments := MeMailFolderMessageAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeMailFolderMessageAttachmentId has no segments")
	}
