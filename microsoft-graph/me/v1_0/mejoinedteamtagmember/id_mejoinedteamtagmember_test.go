...
func TestNewMeJoinedTeamTagMemberID(t *testing.T) {
	id := NewMeJoinedTeamTagMemberID("teamIdValue", "teamworkTagIdValue", "teamworkTagMemberIdValue")
...
func TestFormatMeJoinedTeamTagMemberID(t *testing.T) {
	actual := NewMeJoinedTeamTagMemberID("teamIdValue", "teamworkTagIdValue", "teamworkTagMemberIdValue").ID()
...
func TestParseMeJoinedTeamTagMemberID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamTagMemberId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamTagMemberID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeJoinedTeamTagMemberIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamTagMemberId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamTagMemberIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeJoinedTeamTagMemberId(t *testing.T) {
	segments := MeJoinedTeamTagMemberId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeJoinedTeamTagMemberId has no segments")
	}
