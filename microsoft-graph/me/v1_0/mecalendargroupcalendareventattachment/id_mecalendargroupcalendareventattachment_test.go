...
func TestNewMeCalendarGroupCalendarEventAttachmentID(t *testing.T) {
	id := NewMeCalendarGroupCalendarEventAttachmentID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "attachmentIdValue")
...
func TestFormatMeCalendarGroupCalendarEventAttachmentID(t *testing.T) {
	actual := NewMeCalendarGroupCalendarEventAttachmentID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "attachmentIdValue").ID()
...
func TestParseMeCalendarGroupCalendarEventAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupCalendarEventAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupCalendarEventAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarGroupCalendarEventAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupCalendarEventAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupCalendarEventAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarGroupCalendarEventAttachmentId(t *testing.T) {
	segments := MeCalendarGroupCalendarEventAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarGroupCalendarEventAttachmentId has no segments")
	}
