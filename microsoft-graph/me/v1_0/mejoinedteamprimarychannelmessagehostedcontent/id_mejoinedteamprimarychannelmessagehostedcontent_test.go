...
func TestNewMeJoinedTeamPrimaryChannelMessageHostedContentID(t *testing.T) {
	id := NewMeJoinedTeamPrimaryChannelMessageHostedContentID("teamIdValue", "chatMessageIdValue", "chatMessageHostedContentIdValue")
...
func TestFormatMeJoinedTeamPrimaryChannelMessageHostedContentID(t *testing.T) {
	actual := NewMeJoinedTeamPrimaryChannelMessageHostedContentID("teamIdValue", "chatMessageIdValue", "chatMessageHostedContentIdValue").ID()
...
func TestParseMeJoinedTeamPrimaryChannelMessageHostedContentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamPrimaryChannelMessageHostedContentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamPrimaryChannelMessageHostedContentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeJoinedTeamPrimaryChannelMessageHostedContentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamPrimaryChannelMessageHostedContentId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamPrimaryChannelMessageHostedContentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeJoinedTeamPrimaryChannelMessageHostedContentId(t *testing.T) {
	segments := MeJoinedTeamPrimaryChannelMessageHostedContentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeJoinedTeamPrimaryChannelMessageHostedContentId has no segments")
	}
