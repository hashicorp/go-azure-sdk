...
func TestNewMePlannerPlanBucketTaskID(t *testing.T) {
	id := NewMePlannerPlanBucketTaskID("plannerPlanIdValue", "plannerBucketIdValue", "plannerTaskIdValue")
...
func TestFormatMePlannerPlanBucketTaskID(t *testing.T) {
	actual := NewMePlannerPlanBucketTaskID("plannerPlanIdValue", "plannerBucketIdValue", "plannerTaskIdValue").ID()
...
func TestParseMePlannerPlanBucketTaskID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MePlannerPlanBucketTaskId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMePlannerPlanBucketTaskID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMePlannerPlanBucketTaskIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MePlannerPlanBucketTaskId
	...
	for _, v := range testData {
		...
		actual, err := ParseMePlannerPlanBucketTaskIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMePlannerPlanBucketTaskId(t *testing.T) {
	segments := MePlannerPlanBucketTaskId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MePlannerPlanBucketTaskId has no segments")
	}
