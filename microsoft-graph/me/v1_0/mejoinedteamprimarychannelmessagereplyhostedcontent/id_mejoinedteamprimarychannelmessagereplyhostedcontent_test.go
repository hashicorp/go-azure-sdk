...
func TestNewMeJoinedTeamPrimaryChannelMessageReplyHostedContentID(t *testing.T) {
	id := NewMeJoinedTeamPrimaryChannelMessageReplyHostedContentID("teamIdValue", "chatMessageIdValue", "chatMessageId1Value", "chatMessageHostedContentIdValue")
...
func TestFormatMeJoinedTeamPrimaryChannelMessageReplyHostedContentID(t *testing.T) {
	actual := NewMeJoinedTeamPrimaryChannelMessageReplyHostedContentID("teamIdValue", "chatMessageIdValue", "chatMessageId1Value", "chatMessageHostedContentIdValue").ID()
...
func TestParseMeJoinedTeamPrimaryChannelMessageReplyHostedContentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamPrimaryChannelMessageReplyHostedContentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamPrimaryChannelMessageReplyHostedContentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeJoinedTeamPrimaryChannelMessageReplyHostedContentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamPrimaryChannelMessageReplyHostedContentId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamPrimaryChannelMessageReplyHostedContentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeJoinedTeamPrimaryChannelMessageReplyHostedContentId(t *testing.T) {
	segments := MeJoinedTeamPrimaryChannelMessageReplyHostedContentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeJoinedTeamPrimaryChannelMessageReplyHostedContentId has no segments")
	}
