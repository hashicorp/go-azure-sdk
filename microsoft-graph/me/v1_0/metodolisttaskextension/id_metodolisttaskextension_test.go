...
func TestNewMeTodoListTaskExtensionID(t *testing.T) {
	id := NewMeTodoListTaskExtensionID("todoTaskListIdValue", "todoTaskIdValue", "extensionIdValue")
...
func TestFormatMeTodoListTaskExtensionID(t *testing.T) {
	actual := NewMeTodoListTaskExtensionID("todoTaskListIdValue", "todoTaskIdValue", "extensionIdValue").ID()
...
func TestParseMeTodoListTaskExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeTodoListTaskExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeTodoListTaskExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeTodoListTaskExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeTodoListTaskExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeTodoListTaskExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeTodoListTaskExtensionId(t *testing.T) {
	segments := MeTodoListTaskExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeTodoListTaskExtensionId has no segments")
	}
