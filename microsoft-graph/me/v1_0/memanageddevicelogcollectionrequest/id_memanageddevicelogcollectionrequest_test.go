...
func TestNewMeManagedDeviceLogCollectionRequestID(t *testing.T) {
	id := NewMeManagedDeviceLogCollectionRequestID("managedDeviceIdValue", "deviceLogCollectionResponseIdValue")
...
func TestFormatMeManagedDeviceLogCollectionRequestID(t *testing.T) {
	actual := NewMeManagedDeviceLogCollectionRequestID("managedDeviceIdValue", "deviceLogCollectionResponseIdValue").ID()
...
func TestParseMeManagedDeviceLogCollectionRequestID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeManagedDeviceLogCollectionRequestId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeManagedDeviceLogCollectionRequestID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeManagedDeviceLogCollectionRequestIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeManagedDeviceLogCollectionRequestId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeManagedDeviceLogCollectionRequestIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeManagedDeviceLogCollectionRequestId(t *testing.T) {
	segments := MeManagedDeviceLogCollectionRequestId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeManagedDeviceLogCollectionRequestId has no segments")
	}
