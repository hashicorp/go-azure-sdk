...
func TestNewMeJoinedTeamPrimaryChannelMemberID(t *testing.T) {
	id := NewMeJoinedTeamPrimaryChannelMemberID("teamIdValue", "conversationMemberIdValue")
...
func TestFormatMeJoinedTeamPrimaryChannelMemberID(t *testing.T) {
	actual := NewMeJoinedTeamPrimaryChannelMemberID("teamIdValue", "conversationMemberIdValue").ID()
...
func TestParseMeJoinedTeamPrimaryChannelMemberID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamPrimaryChannelMemberId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamPrimaryChannelMemberID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeJoinedTeamPrimaryChannelMemberIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamPrimaryChannelMemberId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamPrimaryChannelMemberIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeJoinedTeamPrimaryChannelMemberId(t *testing.T) {
	segments := MeJoinedTeamPrimaryChannelMemberId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeJoinedTeamPrimaryChannelMemberId has no segments")
	}
