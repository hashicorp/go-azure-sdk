...
func TestNewMeCalendarGroupCalendarCalendarViewExtensionID(t *testing.T) {
	id := NewMeCalendarGroupCalendarCalendarViewExtensionID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "extensionIdValue")
...
func TestFormatMeCalendarGroupCalendarCalendarViewExtensionID(t *testing.T) {
	actual := NewMeCalendarGroupCalendarCalendarViewExtensionID("calendarGroupIdValue", "calendarIdValue", "eventIdValue", "extensionIdValue").ID()
...
func TestParseMeCalendarGroupCalendarCalendarViewExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupCalendarCalendarViewExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupCalendarCalendarViewExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeCalendarGroupCalendarCalendarViewExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeCalendarGroupCalendarCalendarViewExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeCalendarGroupCalendarCalendarViewExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeCalendarGroupCalendarCalendarViewExtensionId(t *testing.T) {
	segments := MeCalendarGroupCalendarCalendarViewExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeCalendarGroupCalendarCalendarViewExtensionId has no segments")
	}
