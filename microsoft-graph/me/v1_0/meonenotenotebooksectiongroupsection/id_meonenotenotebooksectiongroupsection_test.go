...
func TestNewMeOnenoteNotebookSectionGroupSectionID(t *testing.T) {
	id := NewMeOnenoteNotebookSectionGroupSectionID("notebookIdValue", "sectionGroupIdValue", "onenoteSectionIdValue")
...
func TestFormatMeOnenoteNotebookSectionGroupSectionID(t *testing.T) {
	actual := NewMeOnenoteNotebookSectionGroupSectionID("notebookIdValue", "sectionGroupIdValue", "onenoteSectionIdValue").ID()
...
func TestParseMeOnenoteNotebookSectionGroupSectionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeOnenoteNotebookSectionGroupSectionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeOnenoteNotebookSectionGroupSectionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeOnenoteNotebookSectionGroupSectionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeOnenoteNotebookSectionGroupSectionId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeOnenoteNotebookSectionGroupSectionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeOnenoteNotebookSectionGroupSectionId(t *testing.T) {
	segments := MeOnenoteNotebookSectionGroupSectionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeOnenoteNotebookSectionGroupSectionId has no segments")
	}
