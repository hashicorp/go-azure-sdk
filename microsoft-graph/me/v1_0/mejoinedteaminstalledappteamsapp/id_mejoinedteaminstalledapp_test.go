...
func TestNewMeJoinedTeamInstalledAppID(t *testing.T) {
	id := NewMeJoinedTeamInstalledAppID("teamIdValue", "teamsAppInstallationIdValue")
...
func TestFormatMeJoinedTeamInstalledAppID(t *testing.T) {
	actual := NewMeJoinedTeamInstalledAppID("teamIdValue", "teamsAppInstallationIdValue").ID()
...
func TestParseMeJoinedTeamInstalledAppID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamInstalledAppId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamInstalledAppID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeJoinedTeamInstalledAppIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamInstalledAppId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamInstalledAppIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeJoinedTeamInstalledAppId(t *testing.T) {
	segments := MeJoinedTeamInstalledAppId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeJoinedTeamInstalledAppId has no segments")
	}
