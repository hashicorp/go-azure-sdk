...
func TestNewMeCalendarEventExtensionID(t *testing.T) {
	id := NewMeCalendarEventExtensionID("calendarIdValue", "eventIdValue", "extensionIdValue")
...
func TestFormatMeCalendarEventExtensionID(t *testing.T) {
	actual := NewMeCalendarEventExtensionID("calendarIdValue", "eventIdValue", "extensionIdValue").ID()
