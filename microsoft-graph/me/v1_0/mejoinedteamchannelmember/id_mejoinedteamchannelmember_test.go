...
func TestNewMeJoinedTeamChannelMemberID(t *testing.T) {
	id := NewMeJoinedTeamChannelMemberID("teamIdValue", "channelIdValue", "conversationMemberIdValue")
...
func TestFormatMeJoinedTeamChannelMemberID(t *testing.T) {
	actual := NewMeJoinedTeamChannelMemberID("teamIdValue", "channelIdValue", "conversationMemberIdValue").ID()
...
func TestParseMeJoinedTeamChannelMemberID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamChannelMemberId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamChannelMemberID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeJoinedTeamChannelMemberIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamChannelMemberId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamChannelMemberIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeJoinedTeamChannelMemberId(t *testing.T) {
	segments := MeJoinedTeamChannelMemberId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeJoinedTeamChannelMemberId has no segments")
	}
