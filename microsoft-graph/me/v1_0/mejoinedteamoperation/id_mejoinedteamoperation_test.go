...
func TestNewMeJoinedTeamOperationID(t *testing.T) {
	id := NewMeJoinedTeamOperationID("teamIdValue", "teamsAsyncOperationIdValue")
...
func TestFormatMeJoinedTeamOperationID(t *testing.T) {
	actual := NewMeJoinedTeamOperationID("teamIdValue", "teamsAsyncOperationIdValue").ID()
...
func TestParseMeJoinedTeamOperationID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamOperationId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamOperationID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeJoinedTeamOperationIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamOperationId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamOperationIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeJoinedTeamOperationId(t *testing.T) {
	segments := MeJoinedTeamOperationId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeJoinedTeamOperationId has no segments")
	}
