...
func TestNewMeJoinedTeamChannelMessageReplyHostedContentID(t *testing.T) {
	id := NewMeJoinedTeamChannelMessageReplyHostedContentID("teamIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageId1Value", "chatMessageHostedContentIdValue")
...
func TestFormatMeJoinedTeamChannelMessageReplyHostedContentID(t *testing.T) {
	actual := NewMeJoinedTeamChannelMessageReplyHostedContentID("teamIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageId1Value", "chatMessageHostedContentIdValue").ID()
...
func TestParseMeJoinedTeamChannelMessageReplyHostedContentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamChannelMessageReplyHostedContentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamChannelMessageReplyHostedContentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeJoinedTeamChannelMessageReplyHostedContentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamChannelMessageReplyHostedContentId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamChannelMessageReplyHostedContentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeJoinedTeamChannelMessageReplyHostedContentId(t *testing.T) {
	segments := MeJoinedTeamChannelMessageReplyHostedContentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeJoinedTeamChannelMessageReplyHostedContentId has no segments")
	}
