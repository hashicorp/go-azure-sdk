...
func TestNewMeJoinedTeamChannelMessageReplyID(t *testing.T) {
	id := NewMeJoinedTeamChannelMessageReplyID("teamIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageId1Value")
...
func TestFormatMeJoinedTeamChannelMessageReplyID(t *testing.T) {
	actual := NewMeJoinedTeamChannelMessageReplyID("teamIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageId1Value").ID()
...
func TestParseMeJoinedTeamChannelMessageReplyID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamChannelMessageReplyId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamChannelMessageReplyID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeJoinedTeamChannelMessageReplyIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamChannelMessageReplyId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamChannelMessageReplyIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeJoinedTeamChannelMessageReplyId(t *testing.T) {
	segments := MeJoinedTeamChannelMessageReplyId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeJoinedTeamChannelMessageReplyId has no segments")
	}
