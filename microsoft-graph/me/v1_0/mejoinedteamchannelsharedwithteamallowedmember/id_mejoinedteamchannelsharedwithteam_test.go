...
func TestNewMeJoinedTeamChannelSharedWithTeamID(t *testing.T) {
	id := NewMeJoinedTeamChannelSharedWithTeamID("teamIdValue", "channelIdValue", "sharedWithChannelTeamInfoIdValue")
...
func TestFormatMeJoinedTeamChannelSharedWithTeamID(t *testing.T) {
	actual := NewMeJoinedTeamChannelSharedWithTeamID("teamIdValue", "channelIdValue", "sharedWithChannelTeamInfoIdValue").ID()
...
func TestParseMeJoinedTeamChannelSharedWithTeamID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamChannelSharedWithTeamId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamChannelSharedWithTeamID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeJoinedTeamChannelSharedWithTeamIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamChannelSharedWithTeamId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamChannelSharedWithTeamIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeJoinedTeamChannelSharedWithTeamId(t *testing.T) {
	segments := MeJoinedTeamChannelSharedWithTeamId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeJoinedTeamChannelSharedWithTeamId has no segments")
	}
