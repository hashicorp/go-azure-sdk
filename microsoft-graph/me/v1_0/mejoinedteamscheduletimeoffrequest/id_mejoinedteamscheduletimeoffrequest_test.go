...
func TestNewMeJoinedTeamScheduleTimeOffRequestID(t *testing.T) {
	id := NewMeJoinedTeamScheduleTimeOffRequestID("teamIdValue", "timeOffRequestIdValue")
...
func TestFormatMeJoinedTeamScheduleTimeOffRequestID(t *testing.T) {
	actual := NewMeJoinedTeamScheduleTimeOffRequestID("teamIdValue", "timeOffRequestIdValue").ID()
...
func TestParseMeJoinedTeamScheduleTimeOffRequestID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamScheduleTimeOffRequestId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamScheduleTimeOffRequestID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeJoinedTeamScheduleTimeOffRequestIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamScheduleTimeOffRequestId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamScheduleTimeOffRequestIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeJoinedTeamScheduleTimeOffRequestId(t *testing.T) {
	segments := MeJoinedTeamScheduleTimeOffRequestId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeJoinedTeamScheduleTimeOffRequestId has no segments")
	}
