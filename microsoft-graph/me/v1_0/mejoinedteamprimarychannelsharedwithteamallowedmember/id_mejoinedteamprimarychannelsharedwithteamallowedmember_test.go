...
func TestNewMeJoinedTeamPrimaryChannelSharedWithTeamAllowedMemberID(t *testing.T) {
	id := NewMeJoinedTeamPrimaryChannelSharedWithTeamAllowedMemberID("teamIdValue", "sharedWithChannelTeamInfoIdValue", "conversationMemberIdValue")
...
func TestFormatMeJoinedTeamPrimaryChannelSharedWithTeamAllowedMemberID(t *testing.T) {
	actual := NewMeJoinedTeamPrimaryChannelSharedWithTeamAllowedMemberID("teamIdValue", "sharedWithChannelTeamInfoIdValue", "conversationMemberIdValue").ID()
...
func TestParseMeJoinedTeamPrimaryChannelSharedWithTeamAllowedMemberID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamPrimaryChannelSharedWithTeamAllowedMemberId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamPrimaryChannelSharedWithTeamAllowedMemberID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeJoinedTeamPrimaryChannelSharedWithTeamAllowedMemberIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeJoinedTeamPrimaryChannelSharedWithTeamAllowedMemberId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeJoinedTeamPrimaryChannelSharedWithTeamAllowedMemberIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeJoinedTeamPrimaryChannelSharedWithTeamAllowedMemberId(t *testing.T) {
	segments := MeJoinedTeamPrimaryChannelSharedWithTeamAllowedMemberId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeJoinedTeamPrimaryChannelSharedWithTeamAllowedMemberId has no segments")
	}
