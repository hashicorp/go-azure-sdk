...
func TestNewUserIdEventIdInstanceIdAttachmentID(t *testing.T) {
	id := NewUserIdEventIdInstanceIdAttachmentID("userIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue")
...
func TestFormatUserIdEventIdInstanceIdAttachmentID(t *testing.T) {
	actual := NewUserIdEventIdInstanceIdAttachmentID("userIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue").ID()
