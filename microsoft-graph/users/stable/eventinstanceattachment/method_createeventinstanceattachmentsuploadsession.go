...
func (c EventInstanceAttachmentClient) CreateEventInstanceAttachmentsUploadSession(ctx context.Context, id stable.UserIdEventIdInstanceId, input CreateEventInstanceAttachmentsUploadSessionRequest) (result CreateEventInstanceAttachmentsUploadSessionOperationResponse, err error) {
