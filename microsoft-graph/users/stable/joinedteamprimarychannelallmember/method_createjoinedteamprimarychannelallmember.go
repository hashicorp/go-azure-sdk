...
// CreateJoinedTeamPrimaryChannelAllMember - Create new navigation property to allMembers for users
func (c JoinedTeamPrimaryChannelAllMemberClient) CreateJoinedTeamPrimaryChannelAllMember(ctx context.Context, id stable.UserIdJoinedTeamId, input stable.ConversationMember, options CreateJoinedTeamPrimaryChannelAllMemberOperationOptions) (result CreateJoinedTeamPrimaryChannelAllMemberOperationResponse, err error) {
