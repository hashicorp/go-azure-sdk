...
// GetJoinedTeamPrimaryChannelAllMember - Get allMembers from users. A collection of membership records associated with
// the channel, including both direct and indirect members of shared channels.
func (c JoinedTeamPrimaryChannelAllMemberClient) GetJoinedTeamPrimaryChannelAllMember(ctx context.Context, id stable.UserIdJoinedTeamIdPrimaryChannelAllMemberId, options GetJoinedTeamPrimaryChannelAllMemberOperationOptions) (result GetJoinedTeamPrimaryChannelAllMemberOperationResponse, err error) {
