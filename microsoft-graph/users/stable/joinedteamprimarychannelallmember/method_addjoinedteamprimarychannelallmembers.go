...
func (c JoinedTeamPrimaryChannelAllMemberClient) AddJoinedTeamPrimaryChannelAllMembers(ctx context.Context, id stable.UserIdJoinedTeamId, input AddJoinedTeamPrimaryChannelAllMembersRequest, options AddJoinedTeamPrimaryChannelAllMembersOperationOptions) (result AddJoinedTeamPrimaryChannelAllMembersOperationResponse, err error) {
...
func (c JoinedTeamPrimaryChannelAllMemberClient) AddJoinedTeamPrimaryChannelAllMembersComplete(ctx context.Context, id stable.UserIdJoinedTeamId, input AddJoinedTeamPrimaryChannelAllMembersRequest, options AddJoinedTeamPrimaryChannelAllMembersOperationOptions) (AddJoinedTeamPrimaryChannelAllMembersCompleteResult, error) {
...
func (c JoinedTeamPrimaryChannelAllMemberClient) AddJoinedTeamPrimaryChannelAllMembersCompleteMatchingPredicate(ctx context.Context, id stable.UserIdJoinedTeamId, input AddJoinedTeamPrimaryChannelAllMembersRequest, options AddJoinedTeamPrimaryChannelAllMembersOperationOptions, predicate ActionResultPartOperationPredicate) (result AddJoinedTeamPrimaryChannelAllMembersCompleteResult, err error) {
