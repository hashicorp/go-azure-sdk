...
// UpdateJoinedTeamPrimaryChannelAllMember - Update the navigation property allMembers in users
func (c JoinedTeamPrimaryChannelAllMemberClient) UpdateJoinedTeamPrimaryChannelAllMember(ctx context.Context, id stable.UserIdJoinedTeamIdPrimaryChannelAllMemberId, input stable.ConversationMember, options UpdateJoinedTeamPrimaryChannelAllMemberOperationOptions) (result UpdateJoinedTeamPrimaryChannelAllMemberOperationResponse, err error) {
