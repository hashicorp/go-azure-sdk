...
func (c DriveItemListItemClient) CreateDriveItemListItemLink(ctx context.Context, id stable.UserIdDriveIdItemId, input CreateDriveItemListItemLinkRequest) (result CreateDriveItemListItemLinkOperationResponse, err error) {
