...
func (c TeamworkAssociatedTeamClient) CreateTeamworkAssociatedTeam(ctx context.Context, id UserId, input stable.AssociatedTeamInfo) (result CreateTeamworkAssociatedTeamOperationResponse, err error) {
