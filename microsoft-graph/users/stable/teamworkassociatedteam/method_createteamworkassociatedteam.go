...
func (c TeamworkAssociatedTeamClient) CreateTeamworkAssociatedTeam(ctx context.Context, id stable.UserId, input stable.AssociatedTeamInfo) (result CreateTeamworkAssociatedTeamOperationResponse, err error) {
