...
func (c DriveRootAnalyticsItemActivityStatActivityClient) CreateDriveRootAnalyticsItemActivityStatActivity(ctx context.Context, id stable.UserIdDriveIdRootAnalyticsItemActivityStatId, input stable.ItemActivity) (result CreateDriveRootAnalyticsItemActivityStatActivityOperationResponse, err error) {
