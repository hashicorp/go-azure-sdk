...
func (c ActivityHistoryItemClient) CreateActivityHistoryItem(ctx context.Context, id stable.UserIdActivityId, input stable.ActivityHistoryItem) (result CreateActivityHistoryItemOperationResponse, err error) {
