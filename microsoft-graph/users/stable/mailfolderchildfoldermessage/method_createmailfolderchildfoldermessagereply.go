...
func (c MailFolderChildFolderMessageClient) CreateMailFolderChildFolderMessageReply(ctx context.Context, id stable.UserIdMailFolderIdChildFolderIdMessageId, input CreateMailFolderChildFolderMessageReplyRequest) (result CreateMailFolderChildFolderMessageReplyOperationResponse, err error) {
