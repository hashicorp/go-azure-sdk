...
// CreateMailFolderChildFolderMessagePermanentDelete - Invoke action permanentDelete
func (c MailFolderChildFolderMessageClient) CreateMailFolderChildFolderMessagePermanentDelete(ctx context.Context, id stable.UserIdMailFolderIdChildFolderIdMessageId, options CreateMailFolderChildFolderMessagePermanentDeleteOperationOptions) (result CreateMailFolderChildFolderMessagePermanentDeleteOperationResponse, err error) {
