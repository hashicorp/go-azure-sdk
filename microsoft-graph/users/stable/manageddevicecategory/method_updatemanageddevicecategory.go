...
func (c ManagedDeviceCategoryClient) UpdateManagedDeviceCategory(ctx context.Context, id stable.UserIdManagedDeviceId, input stable.DeviceCategory) (result UpdateManagedDeviceCategoryOperationResponse, err error) {
