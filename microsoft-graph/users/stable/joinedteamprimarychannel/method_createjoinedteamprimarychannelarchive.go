...
// archived.
func (c JoinedTeamPrimaryChannelClient) CreateJoinedTeamPrimaryChannelArchive(ctx context.Context, id stable.UserIdJoinedTeamId, input CreateJoinedTeamPrimaryChannelArchiveRequest) (result CreateJoinedTeamPrimaryChannelArchiveOperationResponse, err error) {
