...
// client.
func (c JoinedTeamPrimaryChannelClient) RemoveJoinedTeamPrimaryChannelEmail(ctx context.Context, id stable.UserIdJoinedTeamId) (result RemoveJoinedTeamPrimaryChannelEmailOperationResponse, err error) {
