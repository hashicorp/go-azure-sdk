...
func (c JoinedTeamPrimaryChannelClient) ProvisionJoinedTeamPrimaryChannelEmail(ctx context.Context, id stable.UserIdJoinedTeamId) (result ProvisionJoinedTeamPrimaryChannelEmailOperationResponse, err error) {
