...
func (c JoinedTeamPrimaryChannelClient) UpdateJoinedTeamPrimaryChannel(ctx context.Context, id stable.UserIdJoinedTeamId, input stable.Channel) (result UpdateJoinedTeamPrimaryChannelOperationResponse, err error) {
