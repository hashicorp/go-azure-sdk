...
// CreateLicenseDetail ...
func (c LicenseDetailClient) CreateLicenseDetail(ctx context.Context, id UserId, input stable.LicenseDetails) (result CreateLicenseDetailOperationResponse, err error) {
