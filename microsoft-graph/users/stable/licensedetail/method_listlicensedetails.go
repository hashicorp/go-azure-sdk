...
// ListLicenseDetails ...
func (c LicenseDetailClient) ListLicenseDetails(ctx context.Context, id UserId) (result ListLicenseDetailsOperationResponse, err error) {
...
func (c LicenseDetailClient) ListLicenseDetailsComplete(ctx context.Context, id UserId) (ListLicenseDetailsCompleteResult, error) {
...
func (c LicenseDetailClient) ListLicenseDetailsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate LicenseDetailsOperationPredicate) (result ListLicenseDetailsCompleteResult, err error) {
