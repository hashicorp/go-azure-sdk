...
func (c ChatMessageHostedContentClient) ListChatMessageHostedContents(ctx context.Context, id UserIdChatIdMessageId) (result ListChatMessageHostedContentsOperationResponse, err error) {
...
func (c ChatMessageHostedContentClient) ListChatMessageHostedContentsComplete(ctx context.Context, id UserIdChatIdMessageId) (ListChatMessageHostedContentsCompleteResult, error) {
...
func (c ChatMessageHostedContentClient) ListChatMessageHostedContentsCompleteMatchingPredicate(ctx context.Context, id UserIdChatIdMessageId, predicate ChatMessageHostedContentOperationPredicate) (result ListChatMessageHostedContentsCompleteResult, err error) {
