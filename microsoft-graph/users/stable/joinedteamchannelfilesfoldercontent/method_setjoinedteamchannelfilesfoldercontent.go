...
func (c JoinedTeamChannelFilesFolderContentClient) SetJoinedTeamChannelFilesFolderContent(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, input []byte) (result SetJoinedTeamChannelFilesFolderContentOperationResponse, err error) {
