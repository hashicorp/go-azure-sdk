...
// SetManagedDeviceCategoryRef - Update the ref of navigation property deviceCategory in users
func (c ManagedDeviceDeviceCategoryClient) SetManagedDeviceCategoryRef(ctx context.Context, id stable.UserIdManagedDeviceId, input stable.ReferenceUpdate, options SetManagedDeviceCategoryRefOperationOptions) (result SetManagedDeviceCategoryRefOperationResponse, err error) {
