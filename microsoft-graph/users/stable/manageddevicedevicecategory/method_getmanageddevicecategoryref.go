...
// GetManagedDeviceCategoryRef - Get ref of deviceCategory from users. Device category
func (c ManagedDeviceDeviceCategoryClient) GetManagedDeviceCategoryRef(ctx context.Context, id stable.UserIdManagedDeviceId, options GetManagedDeviceCategoryRefOperationOptions) (result GetManagedDeviceCategoryRefOperationResponse, err error) {
