...
func (c MailFolderClient) CopyMailFolder(ctx context.Context, id stable.UserIdMailFolderId, input CopyMailFolderRequest) (result CopyMailFolderOperationResponse, err error) {
