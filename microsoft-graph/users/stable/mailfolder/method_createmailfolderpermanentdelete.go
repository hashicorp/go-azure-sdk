...
func (c MailFolderClient) CreateMailFolderPermanentDelete(ctx context.Context, id stable.UserIdMailFolderId, options CreateMailFolderPermanentDeleteOperationOptions) (result CreateMailFolderPermanentDeleteOperationResponse, err error) {
