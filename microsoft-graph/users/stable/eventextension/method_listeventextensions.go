...
// ListEventExtensions ...
func (c EventExtensionClient) ListEventExtensions(ctx context.Context, id UserIdEventId) (result ListEventExtensionsOperationResponse, err error) {
...
func (c EventExtensionClient) ListEventExtensionsComplete(ctx context.Context, id UserIdEventId) (ListEventExtensionsCompleteResult, error) {
...
func (c EventExtensionClient) ListEventExtensionsCompleteMatchingPredicate(ctx context.Context, id UserIdEventId, predicate ExtensionOperationPredicate) (result ListEventExtensionsCompleteResult, err error) {
