...
func (c ChatPermissionGrantClient) CreateChatPermissionGrant(ctx context.Context, id stable.UserIdChatId, input stable.ResourceSpecificPermissionGrant) (result CreateChatPermissionGrantOperationResponse, err error) {
