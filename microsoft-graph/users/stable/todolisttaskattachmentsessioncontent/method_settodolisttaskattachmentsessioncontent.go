...
func (c TodoListTaskAttachmentSessionContentClient) SetTodoListTaskAttachmentSessionContent(ctx context.Context, id stable.UserIdTodoListIdTaskIdAttachmentSessionId, input []byte) (result SetTodoListTaskAttachmentSessionContentOperationResponse, err error) {
