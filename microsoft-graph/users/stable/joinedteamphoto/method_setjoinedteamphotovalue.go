...
// team.
func (c JoinedTeamPhotoClient) SetJoinedTeamPhotoValue(ctx context.Context, id stable.UserIdJoinedTeamId, input []byte) (result SetJoinedTeamPhotoValueOperationResponse, err error) {
