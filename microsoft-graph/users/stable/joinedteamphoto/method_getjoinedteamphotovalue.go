...
// team.
func (c JoinedTeamPhotoClient) GetJoinedTeamPhotoValue(ctx context.Context, id stable.UserIdJoinedTeamId) (result GetJoinedTeamPhotoValueOperationResponse, err error) {
