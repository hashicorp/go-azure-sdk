...
func (c DriveItemThumbnailClient) CreateDriveItemThumbnail(ctx context.Context, id stable.UserIdDriveIdItemId, input stable.ThumbnailSet) (result CreateDriveItemThumbnailOperationResponse, err error) {
