...
func (c JoinedTeamMemberClient) ListJoinedTeamMembers(ctx context.Context, id UserIdJoinedTeamId) (result ListJoinedTeamMembersOperationResponse, err error) {
...
func (c JoinedTeamMemberClient) ListJoinedTeamMembersComplete(ctx context.Context, id UserIdJoinedTeamId) (ListJoinedTeamMembersCompleteResult, error) {
...
func (c JoinedTeamMemberClient) ListJoinedTeamMembersCompleteMatchingPredicate(ctx context.Context, id UserIdJoinedTeamId, predicate ConversationMemberOperationPredicate) (result ListJoinedTeamMembersCompleteResult, err error) {
