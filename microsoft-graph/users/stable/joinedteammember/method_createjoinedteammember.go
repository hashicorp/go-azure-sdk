...
func (c JoinedTeamMemberClient) CreateJoinedTeamMember(ctx context.Context, id stable.UserIdJoinedTeamId, input stable.ConversationMember) (result CreateJoinedTeamMemberOperationResponse, err error) {
