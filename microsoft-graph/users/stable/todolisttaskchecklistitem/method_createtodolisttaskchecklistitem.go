...
func (c TodoListTaskChecklistItemClient) CreateTodoListTaskChecklistItem(ctx context.Context, id stable.UserIdTodoListIdTaskId, input stable.ChecklistItem) (result CreateTodoListTaskChecklistItemOperationResponse, err error) {
