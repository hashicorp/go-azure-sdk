...
type GetSolutionWorkingTimeScheduleOperationResponse struct {
	...
	OData        *odata.OData
	Model        *stable.WorkingTimeSchedule
}
...
// GetSolutionWorkingTimeSchedule - Get workingTimeSchedule from users. The working time schedule entity associated with
// the solution.
func (c SolutionWorkingTimeScheduleClient) GetSolutionWorkingTimeSchedule(ctx context.Context, id stable.UserId, options GetSolutionWorkingTimeScheduleOperationOptions) (result GetSolutionWorkingTimeScheduleOperationResponse, err error) {
	...
	var model stable.WorkingTimeSchedule
	result.Model = &model
