...
func (c SolutionWorkingTimeScheduleClient) UpdateSolutionWorkingTimeSchedule(ctx context.Context, id stable.UserId, input stable.WorkingTimeSchedule, options UpdateSolutionWorkingTimeScheduleOperationOptions) (result UpdateSolutionWorkingTimeScheduleOperationResponse, err error) {
