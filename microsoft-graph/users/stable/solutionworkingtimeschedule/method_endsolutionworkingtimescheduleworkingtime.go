...
func (c SolutionWorkingTimeScheduleClient) EndSolutionWorkingTimeScheduleWorkingTime(ctx context.Context, id stable.UserId, options EndSolutionWorkingTimeScheduleWorkingTimeOperationOptions) (result EndSolutionWorkingTimeScheduleWorkingTimeOperationResponse, err error) {
