...
func (c SolutionWorkingTimeScheduleClient) StartSolutionWorkingTimeScheduleWorkingTime(ctx context.Context, id stable.UserId, options StartSolutionWorkingTimeScheduleWorkingTimeOperationOptions) (result StartSolutionWorkingTimeScheduleWorkingTimeOperationResponse, err error) {
