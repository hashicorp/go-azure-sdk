...
func (c CalendarCalendarViewInstanceExtensionClient) ListCalendarCalendarViewInstanceExtensions(ctx context.Context, id UserIdCalendarIdCalendarViewIdInstanceId) (result ListCalendarCalendarViewInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceExtensionClient) ListCalendarCalendarViewInstanceExtensionsComplete(ctx context.Context, id UserIdCalendarIdCalendarViewIdInstanceId) (ListCalendarCalendarViewInstanceExtensionsCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceExtensionClient) ListCalendarCalendarViewInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarIdCalendarViewIdInstanceId, predicate ExtensionOperationPredicate) (result ListCalendarCalendarViewInstanceExtensionsCompleteResult, err error) {
