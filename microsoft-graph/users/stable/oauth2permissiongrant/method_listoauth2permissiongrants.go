...
func (c Oauth2PermissionGrantClient) ListOauth2PermissionGrants(ctx context.Context, id UserId) (result ListOauth2PermissionGrantsOperationResponse, err error) {
...
func (c Oauth2PermissionGrantClient) ListOauth2PermissionGrantsComplete(ctx context.Context, id UserId) (ListOauth2PermissionGrantsCompleteResult, error) {
...
func (c Oauth2PermissionGrantClient) ListOauth2PermissionGrantsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate OAuth2PermissionGrantOperationPredicate) (result ListOauth2PermissionGrantsCompleteResult, err error) {
