...
func (c DriveItemListItemVersionClient) CreateDriveItemListItemVersion(ctx context.Context, id stable.UserIdDriveIdItemId, input stable.ListItemVersion) (result CreateDriveItemListItemVersionOperationResponse, err error) {
