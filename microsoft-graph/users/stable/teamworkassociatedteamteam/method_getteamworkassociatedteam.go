...
// GetTeamworkAssociatedTeam - Get team from users
func (c TeamworkAssociatedTeamTeamClient) GetTeamworkAssociatedTeam(ctx context.Context, id stable.UserIdTeamworkAssociatedTeamId, options GetTeamworkAssociatedTeamOperationOptions) (result GetTeamworkAssociatedTeamOperationResponse, err error) {
