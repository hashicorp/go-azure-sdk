...
func (c DriveListItemDriveItemContentClient) SetDriveListItemDriveItemContent(ctx context.Context, id stable.UserIdDriveIdListItemId, input []byte) (result SetDriveListItemDriveItemContentOperationResponse, err error) {
