...
// ListJoinedTeamTags ...
func (c JoinedTeamTagClient) ListJoinedTeamTags(ctx context.Context, id UserIdJoinedTeamId) (result ListJoinedTeamTagsOperationResponse, err error) {
...
func (c JoinedTeamTagClient) ListJoinedTeamTagsComplete(ctx context.Context, id UserIdJoinedTeamId) (ListJoinedTeamTagsCompleteResult, error) {
...
func (c JoinedTeamTagClient) ListJoinedTeamTagsCompleteMatchingPredicate(ctx context.Context, id UserIdJoinedTeamId, predicate TeamworkTagOperationPredicate) (result ListJoinedTeamTagsCompleteResult, err error) {
