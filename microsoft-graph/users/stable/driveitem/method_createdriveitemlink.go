...
func (c DriveItemClient) CreateDriveItemLink(ctx context.Context, id stable.UserIdDriveIdItemId, input CreateDriveItemLinkRequest) (result CreateDriveItemLinkOperationResponse, err error) {
