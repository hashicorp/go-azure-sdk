...
func (c DriveItemClient) CopyDriveItem(ctx context.Context, id stable.UserIdDriveIdItemId, input CopyDriveItemRequest) (result CopyDriveItemOperationResponse, err error) {
