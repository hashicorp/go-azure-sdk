...
func (c DriveItemClient) CheckinDriveItem(ctx context.Context, id stable.UserIdDriveIdItemId, input CheckinDriveItemRequest) (result CheckinDriveItemOperationResponse, err error) {
