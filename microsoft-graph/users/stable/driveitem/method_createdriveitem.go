...
func (c DriveItemClient) CreateDriveItem(ctx context.Context, id stable.UserIdDriveId, input stable.DriveItem) (result CreateDriveItemOperationResponse, err error) {
