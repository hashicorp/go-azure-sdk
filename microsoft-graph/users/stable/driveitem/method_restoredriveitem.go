...
func (c DriveItemClient) RestoreDriveItem(ctx context.Context, id stable.UserIdDriveIdItemId, input RestoreDriveItemRequest) (result RestoreDriveItemOperationResponse, err error) {
