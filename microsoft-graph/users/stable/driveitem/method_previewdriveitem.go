...
func (c DriveItemClient) PreviewDriveItem(ctx context.Context, id stable.UserIdDriveIdItemId, input PreviewDriveItemRequest) (result PreviewDriveItemOperationResponse, err error) {
