...
// Nullable.
func (c CalendarCalendarViewExtensionClient) ListCalendarViewExtensions(ctx context.Context, id stable.UserIdCalendarIdCalendarViewId, options ListCalendarViewExtensionsOperationOptions) (result ListCalendarViewExtensionsOperationResponse, err error) {
...
func (c CalendarCalendarViewExtensionClient) ListCalendarViewExtensionsComplete(ctx context.Context, id stable.UserIdCalendarIdCalendarViewId, options ListCalendarViewExtensionsOperationOptions) (ListCalendarViewExtensionsCompleteResult, error) {
