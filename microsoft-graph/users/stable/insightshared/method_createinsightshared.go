...
// CreateInsightShared ...
func (c InsightSharedClient) CreateInsightShared(ctx context.Context, id UserId, input stable.SharedInsight) (result CreateInsightSharedOperationResponse, err error) {
