...
func (c JoinedTeamScheduleClient) ShareJoinedTeamSchedule(ctx context.Context, id stable.UserIdJoinedTeamId, input ShareJoinedTeamScheduleRequest) (result ShareJoinedTeamScheduleOperationResponse, err error) {
