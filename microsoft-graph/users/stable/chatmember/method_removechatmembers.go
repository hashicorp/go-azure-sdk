...
func (c ChatMemberClient) RemoveChatMembers(ctx context.Context, id stable.UserIdChatId, input RemoveChatMembersRequest, options RemoveChatMembersOperationOptions) (result RemoveChatMembersOperationResponse, err error) {
...
func (c ChatMemberClient) RemoveChatMembersComplete(ctx context.Context, id stable.UserIdChatId, input RemoveChatMembersRequest, options RemoveChatMembersOperationOptions) (RemoveChatMembersCompleteResult, error) {
...
func (c ChatMemberClient) RemoveChatMembersCompleteMatchingPredicate(ctx context.Context, id stable.UserIdChatId, input RemoveChatMembersRequest, options RemoveChatMembersOperationOptions, predicate ActionResultPartOperationPredicate) (result RemoveChatMembersCompleteResult, err error) {
