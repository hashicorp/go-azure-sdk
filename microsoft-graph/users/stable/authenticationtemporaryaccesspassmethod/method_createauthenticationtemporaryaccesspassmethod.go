...
func (c AuthenticationTemporaryAccessPassMethodClient) CreateAuthenticationTemporaryAccessPassMethod(ctx context.Context, id stable.UserId, input stable.TemporaryAccessPassAuthenticationMethod) (result CreateAuthenticationTemporaryAccessPassMethodOperationResponse, err error) {
