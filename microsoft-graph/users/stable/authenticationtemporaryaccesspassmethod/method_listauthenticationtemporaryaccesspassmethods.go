...
func (c AuthenticationTemporaryAccessPassMethodClient) ListAuthenticationTemporaryAccessPassMethods(ctx context.Context, id UserId) (result ListAuthenticationTemporaryAccessPassMethodsOperationResponse, err error) {
...
func (c AuthenticationTemporaryAccessPassMethodClient) ListAuthenticationTemporaryAccessPassMethodsComplete(ctx context.Context, id UserId) (ListAuthenticationTemporaryAccessPassMethodsCompleteResult, error) {
	return c.ListAuthenticationTemporaryAccessPassMethodsCompleteMatchingPredicate(ctx, id, TemporaryAccessPassAuthenticationMethodOperationPredicate{})
}
...
func (c AuthenticationTemporaryAccessPassMethodClient) ListAuthenticationTemporaryAccessPassMethodsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate TemporaryAccessPassAuthenticationMethodOperationPredicate) (result ListAuthenticationTemporaryAccessPassMethodsCompleteResult, err error) {
	items := make([]stable.TemporaryAccessPassAuthenticationMethod, 0)

	resp, err := c.ListAuthenticationTemporaryAccessPassMethods(ctx, id)
	if err != nil {
