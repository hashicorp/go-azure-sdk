...
func (c DriveListItemLastModifiedByUserMailboxSettingClient) UpdateDriveListItemLastModifiedByUserMailboxSetting(ctx context.Context, id stable.UserIdDriveIdListItemId, input stable.MailboxSettings) (result UpdateDriveListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
