...
func (c DriveListItemDocumentSetVersionClient) CreateDriveListItemDocumentSetVersion(ctx context.Context, id stable.UserIdDriveIdListItemId, input stable.DocumentSetVersion) (result CreateDriveListItemDocumentSetVersionOperationResponse, err error) {
