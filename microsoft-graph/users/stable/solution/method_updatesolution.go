...
func (c SolutionClient) UpdateSolution(ctx context.Context, id stable.UserId, input stable.UserSolutionRoot, options UpdateSolutionOperationOptions) (result UpdateSolutionOperationResponse, err error) {
