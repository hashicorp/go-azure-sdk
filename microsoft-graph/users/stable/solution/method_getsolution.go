...
// GetSolution - Get solutions from users. The identifier that relates the user to the working time schedule triggers.
// Read-Only. Nullable
func (c SolutionClient) GetSolution(ctx context.Context, id stable.UserId, options GetSolutionOperationOptions) (result GetSolutionOperationResponse, err error) {
	...
	var model stable.UserSolutionRoot
	result.Model = &model
