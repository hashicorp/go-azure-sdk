...
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceDeviceConfigurationStates(ctx context.Context, id UserIdManagedDeviceId) (result ListManagedDeviceDeviceConfigurationStatesOperationResponse, err error) {
...
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceDeviceConfigurationStatesComplete(ctx context.Context, id UserIdManagedDeviceId) (ListManagedDeviceDeviceConfigurationStatesCompleteResult, error) {
...
func (c ManagedDeviceDeviceConfigurationStateClient) ListManagedDeviceDeviceConfigurationStatesCompleteMatchingPredicate(ctx context.Context, id UserIdManagedDeviceId, predicate DeviceConfigurationStateOperationPredicate) (result ListManagedDeviceDeviceConfigurationStatesCompleteResult, err error) {
