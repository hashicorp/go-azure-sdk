...
func TestNewUserIdJoinedTeamIdChannelIdMessageID(t *testing.T) {
	id := NewUserIdJoinedTeamIdChannelIdMessageID("userIdValue", "teamIdValue", "channelIdValue", "chatMessageIdValue")
...
func TestFormatUserIdJoinedTeamIdChannelIdMessageID(t *testing.T) {
	actual := NewUserIdJoinedTeamIdChannelIdMessageID("userIdValue", "teamIdValue", "channelIdValue", "chatMessageIdValue").ID()
