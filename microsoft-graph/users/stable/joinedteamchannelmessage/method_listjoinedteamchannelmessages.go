...
func (c JoinedTeamChannelMessageClient) ListJoinedTeamChannelMessages(ctx context.Context, id UserIdJoinedTeamIdChannelId) (result ListJoinedTeamChannelMessagesOperationResponse, err error) {
...
func (c JoinedTeamChannelMessageClient) ListJoinedTeamChannelMessagesComplete(ctx context.Context, id UserIdJoinedTeamIdChannelId) (ListJoinedTeamChannelMessagesCompleteResult, error) {
...
func (c JoinedTeamChannelMessageClient) ListJoinedTeamChannelMessagesCompleteMatchingPredicate(ctx context.Context, id UserIdJoinedTeamIdChannelId, predicate ChatMessageOperationPredicate) (result ListJoinedTeamChannelMessagesCompleteResult, err error) {
