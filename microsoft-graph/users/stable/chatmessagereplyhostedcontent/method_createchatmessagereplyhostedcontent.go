...
func (c ChatMessageReplyHostedContentClient) CreateChatMessageReplyHostedContent(ctx context.Context, id stable.UserIdChatIdMessageIdReplyId, input stable.ChatMessageHostedContent) (result CreateChatMessageReplyHostedContentOperationResponse, err error) {
