...
func (c ChatMessageReplyHostedContentClient) GetChatMessageReplyHostedContentValue(ctx context.Context, id stable.UserIdChatIdMessageIdReplyIdHostedContentId) (result GetChatMessageReplyHostedContentValueOperationResponse, err error) {
