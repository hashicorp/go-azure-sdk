...
func (c ChatMessageReplyHostedContentClient) SetChatMessageReplyHostedContentValue(ctx context.Context, id stable.UserIdChatIdMessageIdReplyIdHostedContentId, input []byte) (result SetChatMessageReplyHostedContentValueOperationResponse, err error) {
