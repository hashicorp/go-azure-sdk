...
func (c EmployeeExperienceClient) UpdateEmployeeExperience(ctx context.Context, id UserId, input stable.EmployeeExperienceUser) (result UpdateEmployeeExperienceOperationResponse, err error) {
