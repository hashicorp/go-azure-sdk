...
func (c InferenceClassificationClient) GetInferenceClassification(ctx context.Context, id UserId) (result GetInferenceClassificationOperationResponse, err error) {
