...
func (c InferenceClassificationClient) UpdateInferenceClassification(ctx context.Context, id stable.UserId, input stable.InferenceClassification) (result UpdateInferenceClassificationOperationResponse, err error) {
