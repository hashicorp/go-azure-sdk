...
func (c InferenceClassificationClient) UpdateInferenceClassification(ctx context.Context, id UserId, input stable.InferenceClassification) (result UpdateInferenceClassificationOperationResponse, err error) {
