...
// CreateContactFolderContactPermanentDelete - Invoke action permanentDelete
func (c ContactFolderContactClient) CreateContactFolderContactPermanentDelete(ctx context.Context, id stable.UserIdContactFolderIdContactId, options CreateContactFolderContactPermanentDeleteOperationOptions) (result CreateContactFolderContactPermanentDeleteOperationResponse, err error) {
