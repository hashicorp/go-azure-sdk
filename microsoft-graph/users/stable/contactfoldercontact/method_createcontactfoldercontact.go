...
func (c ContactFolderContactClient) CreateContactFolderContact(ctx context.Context, id stable.UserIdContactFolderId, input stable.Contact) (result CreateContactFolderContactOperationResponse, err error) {
