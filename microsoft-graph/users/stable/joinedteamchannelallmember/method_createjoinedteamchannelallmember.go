...
// CreateJoinedTeamChannelAllMember - Create new navigation property to allMembers for users
func (c JoinedTeamChannelAllMemberClient) CreateJoinedTeamChannelAllMember(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, input stable.ConversationMember, options CreateJoinedTeamChannelAllMemberOperationOptions) (result CreateJoinedTeamChannelAllMemberOperationResponse, err error) {
