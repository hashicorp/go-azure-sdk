...
func (c JoinedTeamChannelAllMemberClient) RemoveJoinedTeamChannelAllMembers(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, input RemoveJoinedTeamChannelAllMembersRequest, options RemoveJoinedTeamChannelAllMembersOperationOptions) (result RemoveJoinedTeamChannelAllMembersOperationResponse, err error) {
...
func (c JoinedTeamChannelAllMemberClient) RemoveJoinedTeamChannelAllMembersComplete(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, input RemoveJoinedTeamChannelAllMembersRequest, options RemoveJoinedTeamChannelAllMembersOperationOptions) (RemoveJoinedTeamChannelAllMembersCompleteResult, error) {
...
func (c JoinedTeamChannelAllMemberClient) RemoveJoinedTeamChannelAllMembersCompleteMatchingPredicate(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, input RemoveJoinedTeamChannelAllMembersRequest, options RemoveJoinedTeamChannelAllMembersOperationOptions, predicate ActionResultPartOperationPredicate) (result RemoveJoinedTeamChannelAllMembersCompleteResult, err error) {
