...
func (c PermissionGrantClient) CreatePermissionGrant(ctx context.Context, id UserId, input stable.ResourceSpecificPermissionGrant) (result CreatePermissionGrantOperationResponse, err error) {
