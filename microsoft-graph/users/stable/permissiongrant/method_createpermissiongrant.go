...
func (c PermissionGrantClient) CreatePermissionGrant(ctx context.Context, id stable.UserId, input stable.ResourceSpecificPermissionGrant) (result CreatePermissionGrantOperationResponse, err error) {
