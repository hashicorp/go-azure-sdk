...
func (c EventAttachmentClient) CreateEventAttachment(ctx context.Context, id stable.UserIdEventId, input stable.Attachment) (result CreateEventAttachmentOperationResponse, err error) {
