...
func (c EventAttachmentClient) CreateEventAttachmentsUploadSession(ctx context.Context, id stable.UserIdEventId, input CreateEventAttachmentsUploadSessionRequest) (result CreateEventAttachmentsUploadSessionOperationResponse, err error) {
