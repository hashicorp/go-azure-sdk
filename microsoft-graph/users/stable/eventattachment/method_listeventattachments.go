...
func (c EventAttachmentClient) ListEventAttachments(ctx context.Context, id UserIdEventId) (result ListEventAttachmentsOperationResponse, err error) {
...
func (c EventAttachmentClient) ListEventAttachmentsComplete(ctx context.Context, id UserIdEventId) (ListEventAttachmentsCompleteResult, error) {
...
func (c EventAttachmentClient) ListEventAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdEventId, predicate AttachmentOperationPredicate) (result ListEventAttachmentsCompleteResult, err error) {
