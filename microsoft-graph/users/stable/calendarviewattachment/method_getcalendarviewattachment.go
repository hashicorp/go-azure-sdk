...
func (c CalendarViewAttachmentClient) GetCalendarViewAttachment(ctx context.Context, id stable.UserIdCalendarViewIdAttachmentId, options GetCalendarViewAttachmentOperationOptions) (result GetCalendarViewAttachmentOperationResponse, err error) {
