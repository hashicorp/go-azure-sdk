...
func (c DriveItemSubscriptionClient) CreateDriveItemSubscriptionReauthorize(ctx context.Context, id stable.UserIdDriveIdItemIdSubscriptionId) (result CreateDriveItemSubscriptionReauthorizeOperationResponse, err error) {
