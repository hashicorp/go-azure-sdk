...
func (c OutlookMasterCategoryClient) CreateOutlookMasterCategory(ctx context.Context, id UserId, input stable.OutlookCategory) (result CreateOutlookMasterCategoryOperationResponse, err error) {
