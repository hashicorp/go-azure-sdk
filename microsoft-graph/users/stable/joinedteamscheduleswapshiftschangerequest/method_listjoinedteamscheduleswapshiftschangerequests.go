...
func (c JoinedTeamScheduleSwapShiftsChangeRequestClient) ListJoinedTeamScheduleSwapShiftsChangeRequests(ctx context.Context, id UserIdJoinedTeamId) (result ListJoinedTeamScheduleSwapShiftsChangeRequestsOperationResponse, err error) {
...
func (c JoinedTeamScheduleSwapShiftsChangeRequestClient) ListJoinedTeamScheduleSwapShiftsChangeRequestsComplete(ctx context.Context, id UserIdJoinedTeamId) (ListJoinedTeamScheduleSwapShiftsChangeRequestsCompleteResult, error) {
...
func (c JoinedTeamScheduleSwapShiftsChangeRequestClient) ListJoinedTeamScheduleSwapShiftsChangeRequestsCompleteMatchingPredicate(ctx context.Context, id UserIdJoinedTeamId, predicate SwapShiftsChangeRequestOperationPredicate) (result ListJoinedTeamScheduleSwapShiftsChangeRequestsCompleteResult, err error) {
