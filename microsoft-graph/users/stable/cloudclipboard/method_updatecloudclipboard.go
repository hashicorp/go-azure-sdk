...
func (c CloudClipboardClient) UpdateCloudClipboard(ctx context.Context, id stable.UserId, input stable.CloudClipboardRoot) (result UpdateCloudClipboardOperationResponse, err error) {
