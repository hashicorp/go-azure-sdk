...
// GetCalendar - Get calendar from users. The user's primary calendar. Read-only.
func (c CalendarClient) GetCalendar(ctx context.Context, id stable.UserId, options GetCalendarOperationOptions) (result GetCalendarOperationResponse, err error) {
