...
func (c OwnedDeviceClient) GetOwnedDeviceEndpointCount(ctx context.Context, id stable.UserId, options GetOwnedDeviceEndpointCountOperationOptions) (result GetOwnedDeviceEndpointCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/ownedDevices/endpoint/$count", id.ID()),
