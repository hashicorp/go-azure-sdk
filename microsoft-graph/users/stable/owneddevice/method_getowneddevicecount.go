...
func (c OwnedDeviceClient) GetOwnedDeviceCount(ctx context.Context, id stable.UserId, options GetOwnedDeviceCountOperationOptions) (result GetOwnedDeviceCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/ownedDevices/device/$count", id.ID()),
