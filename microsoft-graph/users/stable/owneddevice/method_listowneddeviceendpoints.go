...
// collection
func (c OwnedDeviceClient) ListOwnedDeviceEndpoints(ctx context.Context, id stable.UserId, options ListOwnedDeviceEndpointsOperationOptions) (result ListOwnedDeviceEndpointsOperationResponse, err error) {
...
func (c OwnedDeviceClient) ListOwnedDeviceEndpointsComplete(ctx context.Context, id stable.UserId, options ListOwnedDeviceEndpointsOperationOptions) (ListOwnedDeviceEndpointsCompleteResult, error) {
...
func (c OwnedDeviceClient) ListOwnedDeviceEndpointsCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListOwnedDeviceEndpointsOperationOptions, predicate EndpointOperationPredicate) (result ListOwnedDeviceEndpointsCompleteResult, err error) {
