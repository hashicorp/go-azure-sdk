...
func (c OwnedDeviceClient) GetOwnedDeviceAppRoleAssignmentCount(ctx context.Context, id stable.UserId, options GetOwnedDeviceAppRoleAssignmentCountOperationOptions) (result GetOwnedDeviceAppRoleAssignmentCountOperationResponse, err error) {
