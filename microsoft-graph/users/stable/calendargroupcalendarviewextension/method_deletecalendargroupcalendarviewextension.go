...
func (c CalendarGroupCalendarViewExtensionClient) DeleteCalendarGroupCalendarViewExtension(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarIdCalendarViewIdExtensionId, options DeleteCalendarGroupCalendarViewExtensionOperationOptions) (result DeleteCalendarGroupCalendarViewExtensionOperationResponse, err error) {
