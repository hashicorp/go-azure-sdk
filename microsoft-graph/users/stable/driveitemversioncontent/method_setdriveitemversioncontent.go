...
func (c DriveItemVersionContentClient) SetDriveItemVersionContent(ctx context.Context, id stable.UserIdDriveIdItemIdVersionId, input []byte) (result SetDriveItemVersionContentOperationResponse, err error) {
