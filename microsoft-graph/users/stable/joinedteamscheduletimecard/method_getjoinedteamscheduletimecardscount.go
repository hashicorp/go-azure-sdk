...
func (c JoinedTeamScheduleTimeCardClient) GetJoinedTeamScheduleTimeCardsCount(ctx context.Context, id stable.UserIdJoinedTeamId, options GetJoinedTeamScheduleTimeCardsCountOperationOptions) (result GetJoinedTeamScheduleTimeCardsCountOperationResponse, err error) {
