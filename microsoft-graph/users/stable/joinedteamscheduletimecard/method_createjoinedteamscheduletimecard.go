...
// CreateJoinedTeamScheduleTimeCard - Create new navigation property to timeCards for users
func (c JoinedTeamScheduleTimeCardClient) CreateJoinedTeamScheduleTimeCard(ctx context.Context, id stable.UserIdJoinedTeamId, input stable.TimeCard, options CreateJoinedTeamScheduleTimeCardOperationOptions) (result CreateJoinedTeamScheduleTimeCardOperationResponse, err error) {
