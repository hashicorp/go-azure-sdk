...
func (c JoinedTeamScheduleTimeCardClient) CreateJoinedTeamScheduleTimeCardClockOut(ctx context.Context, id stable.UserIdJoinedTeamIdScheduleTimeCardId, input CreateJoinedTeamScheduleTimeCardClockOutRequest, options CreateJoinedTeamScheduleTimeCardClockOutOperationOptions) (result CreateJoinedTeamScheduleTimeCardClockOutOperationResponse, err error) {
