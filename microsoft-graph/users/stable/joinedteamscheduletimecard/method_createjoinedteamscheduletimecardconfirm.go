...
func (c JoinedTeamScheduleTimeCardClient) CreateJoinedTeamScheduleTimeCardConfirm(ctx context.Context, id stable.UserIdJoinedTeamIdScheduleTimeCardId, options CreateJoinedTeamScheduleTimeCardConfirmOperationOptions) (result CreateJoinedTeamScheduleTimeCardConfirmOperationResponse, err error) {
