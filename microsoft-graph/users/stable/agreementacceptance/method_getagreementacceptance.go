...
func (c AgreementAcceptanceClient) GetAgreementAcceptance(ctx context.Context, id UserIdAgreementAcceptanceId) (result GetAgreementAcceptanceOperationResponse, err error) {
