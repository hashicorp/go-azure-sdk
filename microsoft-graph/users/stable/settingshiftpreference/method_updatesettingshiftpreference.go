...
// object.
func (c SettingShiftPreferenceClient) UpdateSettingShiftPreference(ctx context.Context, id stable.UserId, input stable.ShiftPreferences) (result UpdateSettingShiftPreferenceOperationResponse, err error) {
