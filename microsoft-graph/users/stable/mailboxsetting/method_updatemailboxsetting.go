...
func (c MailboxSettingClient) UpdateMailboxSetting(ctx context.Context, id UserId, input stable.MailboxSettings) (result UpdateMailboxSettingOperationResponse, err error) {
