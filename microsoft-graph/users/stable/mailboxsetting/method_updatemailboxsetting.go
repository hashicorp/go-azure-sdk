...
func (c MailboxSettingClient) UpdateMailboxSetting(ctx context.Context, id stable.UserId, input stable.MailboxSettings) (result UpdateMailboxSettingOperationResponse, err error) {
