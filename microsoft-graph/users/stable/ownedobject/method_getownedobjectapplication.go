...
func (c OwnedObjectClient) GetOwnedObjectApplication(ctx context.Context, id stable.UserIdOwnedObjectId, options GetOwnedObjectApplicationOperationOptions) (result GetOwnedObjectApplicationOperationResponse, err error) {
