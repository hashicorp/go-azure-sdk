...
func (c OwnedObjectClient) GetOwnedObjectGroupCount(ctx context.Context, id stable.UserId, options GetOwnedObjectGroupCountOperationOptions) (result GetOwnedObjectGroupCountOperationResponse, err error) {
