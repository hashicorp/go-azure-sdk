...
func (c OwnedObjectClient) GetOwnedObjectApplicationCount(ctx context.Context, id stable.UserId, options GetOwnedObjectApplicationCountOperationOptions) (result GetOwnedObjectApplicationCountOperationResponse, err error) {
