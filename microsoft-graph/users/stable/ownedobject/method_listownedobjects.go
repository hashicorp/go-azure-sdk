...
// ListOwnedObjects ...
func (c OwnedObjectClient) ListOwnedObjects(ctx context.Context, id UserId) (result ListOwnedObjectsOperationResponse, err error) {
...
func (c OwnedObjectClient) ListOwnedObjectsComplete(ctx context.Context, id UserId) (ListOwnedObjectsCompleteResult, error) {
...
func (c OwnedObjectClient) ListOwnedObjectsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate DirectoryObjectOperationPredicate) (result ListOwnedObjectsCompleteResult, err error) {
