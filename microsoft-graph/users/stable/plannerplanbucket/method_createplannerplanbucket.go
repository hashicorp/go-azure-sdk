...
func (c PlannerPlanBucketClient) CreatePlannerPlanBucket(ctx context.Context, id stable.UserIdPlannerPlanId, input stable.PlannerBucket) (result CreatePlannerPlanBucketOperationResponse, err error) {
