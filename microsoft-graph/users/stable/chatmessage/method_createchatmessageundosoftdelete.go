...
func (c ChatMessageClient) CreateChatMessageUndoSoftDelete(ctx context.Context, id stable.UserIdChatIdMessageId) (result CreateChatMessageUndoSoftDeleteOperationResponse, err error) {
