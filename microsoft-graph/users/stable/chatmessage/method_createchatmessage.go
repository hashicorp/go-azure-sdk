...
func (c ChatMessageClient) CreateChatMessage(ctx context.Context, id stable.UserIdChatId, input stable.ChatMessage) (result CreateChatMessageOperationResponse, err error) {
