...
func (c CalendarGroupClient) GetCalendarGroupsCount(ctx context.Context, id stable.UserId, options GetCalendarGroupsCountOperationOptions) (result GetCalendarGroupsCountOperationResponse, err error) {
