...
func (c CalendarGroupClient) GetCalendarGroup(ctx context.Context, id stable.UserIdCalendarGroupId, options GetCalendarGroupOperationOptions) (result GetCalendarGroupOperationResponse, err error) {
