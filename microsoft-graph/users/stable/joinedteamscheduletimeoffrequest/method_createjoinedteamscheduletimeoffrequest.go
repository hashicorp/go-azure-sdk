...
func (c JoinedTeamScheduleTimeOffRequestClient) CreateJoinedTeamScheduleTimeOffRequest(ctx context.Context, id UserIdJoinedTeamId, input stable.TimeOffRequest) (result CreateJoinedTeamScheduleTimeOffRequestOperationResponse, err error) {
