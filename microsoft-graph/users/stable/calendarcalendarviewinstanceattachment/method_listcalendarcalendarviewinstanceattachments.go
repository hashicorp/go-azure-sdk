...
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarCalendarViewInstanceAttachments(ctx context.Context, id UserIdCalendarCalendarViewIdInstanceId) (result ListCalendarCalendarViewInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarCalendarViewInstanceAttachmentsComplete(ctx context.Context, id UserIdCalendarCalendarViewIdInstanceId) (ListCalendarCalendarViewInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarCalendarViewInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarCalendarViewIdInstanceId, predicate AttachmentOperationPredicate) (result ListCalendarCalendarViewInstanceAttachmentsCompleteResult, err error) {
