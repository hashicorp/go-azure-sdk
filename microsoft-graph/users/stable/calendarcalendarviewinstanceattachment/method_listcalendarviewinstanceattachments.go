...
// ListCalendarViewInstanceAttachments - Get attachments from users. The collection of FileAttachment, ItemAttachment,
// and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarViewInstanceAttachments(ctx context.Context, id stable.UserIdCalendarCalendarViewIdInstanceId, options ListCalendarViewInstanceAttachmentsOperationOptions) (result ListCalendarViewInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarViewInstanceAttachmentsComplete(ctx context.Context, id stable.UserIdCalendarCalendarViewIdInstanceId, options ListCalendarViewInstanceAttachmentsOperationOptions) (ListCalendarViewInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarViewInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdCalendarCalendarViewIdInstanceId, options ListCalendarViewInstanceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarViewInstanceAttachmentsCompleteResult, err error) {
