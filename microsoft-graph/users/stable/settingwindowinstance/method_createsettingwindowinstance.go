...
func (c SettingWindowInstanceClient) CreateSettingWindowInstance(ctx context.Context, id stable.UserIdSettingWindowId, input stable.WindowsSettingInstance) (result CreateSettingWindowInstanceOperationResponse, err error) {
