...
func (c JoinedTeamPrimaryChannelMessageClient) CreateJoinedTeamPrimaryChannelMessageSoftDelete(ctx context.Context, id stable.UserIdJoinedTeamIdPrimaryChannelMessageId) (result CreateJoinedTeamPrimaryChannelMessageSoftDeleteOperationResponse, err error) {
