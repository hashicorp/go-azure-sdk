...
func (c DriveListItemClient) CreateDriveListItemLink(ctx context.Context, id stable.UserIdDriveIdListItemId, input CreateDriveListItemLinkRequest) (result CreateDriveListItemLinkOperationResponse, err error) {
