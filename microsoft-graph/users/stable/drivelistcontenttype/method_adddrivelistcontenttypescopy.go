...
func (c DriveListContentTypeClient) AddDriveListContentTypesCopy(ctx context.Context, id stable.UserIdDriveId, input AddDriveListContentTypesCopyRequest) (result AddDriveListContentTypesCopyOperationResponse, err error) {
