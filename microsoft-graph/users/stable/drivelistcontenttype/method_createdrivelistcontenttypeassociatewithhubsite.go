...
func (c DriveListContentTypeClient) CreateDriveListContentTypeAssociateWithHubSite(ctx context.Context, id stable.UserIdDriveIdListContentTypeId, input CreateDriveListContentTypeAssociateWithHubSiteRequest) (result CreateDriveListContentTypeAssociateWithHubSiteOperationResponse, err error) {
