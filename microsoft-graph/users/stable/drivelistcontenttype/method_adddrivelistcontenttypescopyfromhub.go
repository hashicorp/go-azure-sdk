...
func (c DriveListContentTypeClient) AddDriveListContentTypesCopyFromHub(ctx context.Context, id stable.UserIdDriveId, input AddDriveListContentTypesCopyFromHubRequest) (result AddDriveListContentTypesCopyFromHubOperationResponse, err error) {
