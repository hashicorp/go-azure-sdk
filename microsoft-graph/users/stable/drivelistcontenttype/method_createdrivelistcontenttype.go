...
func (c DriveListContentTypeClient) CreateDriveListContentType(ctx context.Context, id stable.UserIdDriveId, input stable.ContentType) (result CreateDriveListContentTypeOperationResponse, err error) {
