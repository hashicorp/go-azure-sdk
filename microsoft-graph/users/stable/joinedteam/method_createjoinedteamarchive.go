...
func (c JoinedTeamClient) CreateJoinedTeamArchive(ctx context.Context, id stable.UserIdJoinedTeamId, input CreateJoinedTeamArchiveRequest) (result CreateJoinedTeamArchiveOperationResponse, err error) {
