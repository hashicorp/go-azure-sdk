...
func (c JoinedTeamClient) SendJoinedTeamActivityNotification(ctx context.Context, id stable.UserIdJoinedTeamId, input SendJoinedTeamActivityNotificationRequest) (result SendJoinedTeamActivityNotificationOperationResponse, err error) {
