...
func (c RegisteredDeviceClient) GetRegisteredDeviceEndpoint(ctx context.Context, id stable.UserIdRegisteredDeviceId, options GetRegisteredDeviceEndpointOperationOptions) (result GetRegisteredDeviceEndpointOperationResponse, err error) {
