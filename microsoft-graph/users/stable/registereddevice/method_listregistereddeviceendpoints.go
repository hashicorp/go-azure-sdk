...
// collection
func (c RegisteredDeviceClient) ListRegisteredDeviceEndpoints(ctx context.Context, id stable.UserId, options ListRegisteredDeviceEndpointsOperationOptions) (result ListRegisteredDeviceEndpointsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/registeredDevices/endpoint", id.ID()),
...
func (c RegisteredDeviceClient) ListRegisteredDeviceEndpointsComplete(ctx context.Context, id stable.UserId, options ListRegisteredDeviceEndpointsOperationOptions) (ListRegisteredDeviceEndpointsCompleteResult, error) {
	return c.ListRegisteredDeviceEndpointsCompleteMatchingPredicate(ctx, id, options, EndpointOperationPredicate{})
}

// ListRegisteredDeviceEndpointsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c RegisteredDeviceClient) ListRegisteredDeviceEndpointsCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListRegisteredDeviceEndpointsOperationOptions, predicate EndpointOperationPredicate) (result ListRegisteredDeviceEndpointsCompleteResult, err error) {
	items := make([]stable.Endpoint, 0)

	resp, err := c.ListRegisteredDeviceEndpoints(ctx, id, options)
	if err != nil {
