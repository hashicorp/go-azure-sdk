...
func (c RegisteredDeviceClient) GetRegisteredDeviceEndpointCount(ctx context.Context, id stable.UserId, options GetRegisteredDeviceEndpointCountOperationOptions) (result GetRegisteredDeviceEndpointCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/registeredDevices/endpoint/$count", id.ID()),
