...
func (c RegisteredDeviceClient) ListRegisteredDeviceAppRoleAssignments(ctx context.Context, id stable.UserId, options ListRegisteredDeviceAppRoleAssignmentsOperationOptions) (result ListRegisteredDeviceAppRoleAssignmentsOperationResponse, err error) {
...
func (c RegisteredDeviceClient) ListRegisteredDeviceAppRoleAssignmentsComplete(ctx context.Context, id stable.UserId, options ListRegisteredDeviceAppRoleAssignmentsOperationOptions) (ListRegisteredDeviceAppRoleAssignmentsCompleteResult, error) {
