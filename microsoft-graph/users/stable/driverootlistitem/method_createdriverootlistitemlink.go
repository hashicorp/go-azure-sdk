...
func (c DriveRootListItemClient) CreateDriveRootListItemLink(ctx context.Context, id stable.UserIdDriveId, input CreateDriveRootListItemLinkRequest) (result CreateDriveRootListItemLinkOperationResponse, err error) {
