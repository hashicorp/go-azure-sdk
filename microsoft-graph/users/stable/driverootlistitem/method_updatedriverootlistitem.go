...
func (c DriveRootListItemClient) UpdateDriveRootListItem(ctx context.Context, id stable.UserIdDriveId, input stable.ListItem) (result UpdateDriveRootListItemOperationResponse, err error) {
