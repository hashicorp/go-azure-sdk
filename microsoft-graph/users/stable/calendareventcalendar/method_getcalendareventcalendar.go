...
// Read-only.
func (c CalendarEventCalendarClient) GetCalendarEventCalendar(ctx context.Context, id stable.UserIdCalendarEventId, options GetCalendarEventCalendarOperationOptions) (result GetCalendarEventCalendarOperationResponse, err error) {
