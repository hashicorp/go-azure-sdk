...
func (c JoinedTeamChannelMemberClient) ListJoinedTeamChannelMembers(ctx context.Context, id UserIdJoinedTeamIdChannelId) (result ListJoinedTeamChannelMembersOperationResponse, err error) {
...
func (c JoinedTeamChannelMemberClient) ListJoinedTeamChannelMembersComplete(ctx context.Context, id UserIdJoinedTeamIdChannelId) (ListJoinedTeamChannelMembersCompleteResult, error) {
...
func (c JoinedTeamChannelMemberClient) ListJoinedTeamChannelMembersCompleteMatchingPredicate(ctx context.Context, id UserIdJoinedTeamIdChannelId, predicate ConversationMemberOperationPredicate) (result ListJoinedTeamChannelMembersCompleteResult, err error) {
