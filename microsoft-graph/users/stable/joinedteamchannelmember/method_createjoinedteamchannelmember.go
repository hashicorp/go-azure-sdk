...
func (c JoinedTeamChannelMemberClient) CreateJoinedTeamChannelMember(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId, input stable.ConversationMember) (result CreateJoinedTeamChannelMemberOperationResponse, err error) {
