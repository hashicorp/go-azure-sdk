...
func (c JoinedTeamChannelMessageReplyHostedContentClient) ListJoinedTeamChannelMessageReplyHostedContents(ctx context.Context, id UserIdJoinedTeamIdChannelIdMessageIdReplyId) (result ListJoinedTeamChannelMessageReplyHostedContentsOperationResponse, err error) {
...
func (c JoinedTeamChannelMessageReplyHostedContentClient) ListJoinedTeamChannelMessageReplyHostedContentsComplete(ctx context.Context, id UserIdJoinedTeamIdChannelIdMessageIdReplyId) (ListJoinedTeamChannelMessageReplyHostedContentsCompleteResult, error) {
...
func (c JoinedTeamChannelMessageReplyHostedContentClient) ListJoinedTeamChannelMessageReplyHostedContentsCompleteMatchingPredicate(ctx context.Context, id UserIdJoinedTeamIdChannelIdMessageIdReplyId, predicate ChatMessageHostedContentOperationPredicate) (result ListJoinedTeamChannelMessageReplyHostedContentsCompleteResult, err error) {
