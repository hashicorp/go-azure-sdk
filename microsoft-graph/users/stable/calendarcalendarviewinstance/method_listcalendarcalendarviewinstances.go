...
func (c CalendarCalendarViewInstanceClient) ListCalendarCalendarViewInstances(ctx context.Context, id UserIdCalendarCalendarViewId) (result ListCalendarCalendarViewInstancesOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceClient) ListCalendarCalendarViewInstancesComplete(ctx context.Context, id UserIdCalendarCalendarViewId) (ListCalendarCalendarViewInstancesCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceClient) ListCalendarCalendarViewInstancesCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarCalendarViewId, predicate EventOperationPredicate) (result ListCalendarCalendarViewInstancesCompleteResult, err error) {
