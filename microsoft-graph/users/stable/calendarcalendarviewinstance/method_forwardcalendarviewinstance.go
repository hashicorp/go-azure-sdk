...
// Outlook.com account.
func (c CalendarCalendarViewInstanceClient) ForwardCalendarViewInstance(ctx context.Context, id stable.UserIdCalendarIdCalendarViewIdInstanceId, input ForwardCalendarViewInstanceRequest) (result ForwardCalendarViewInstanceOperationResponse, err error) {
