...
func (c CalendarCalendarViewInstanceClient) CancelCalendarViewInstance(ctx context.Context, id stable.UserIdCalendarIdCalendarViewIdInstanceId, input CancelCalendarViewInstanceRequest) (result CancelCalendarViewInstanceOperationResponse, err error) {
