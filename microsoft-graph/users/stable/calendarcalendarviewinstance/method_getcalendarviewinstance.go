...
// GetCalendarViewInstance - Get instances from users. The occurrences of a recurring series, if the event is a series
...
// Nullable.
func (c CalendarCalendarViewInstanceClient) GetCalendarViewInstance(ctx context.Context, id stable.UserIdCalendarIdCalendarViewIdInstanceId, options GetCalendarViewInstanceOperationOptions) (result GetCalendarViewInstanceOperationResponse, err error) {
