...
func (c CalendarCalendarViewInstanceClient) DeclineCalendarViewInstance(ctx context.Context, id stable.UserIdCalendarIdCalendarViewIdInstanceId, input DeclineCalendarViewInstanceRequest) (result DeclineCalendarViewInstanceOperationResponse, err error) {
