...
func (c CalendarGroupCalendarEventInstanceClient) GetCalendarGroupCalendarEventInstancesCount(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarIdEventId, options GetCalendarGroupCalendarEventInstancesCountOperationOptions) (result GetCalendarGroupCalendarEventInstancesCountOperationResponse, err error) {
