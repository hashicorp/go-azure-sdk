...
func (c MessageExtensionClient) ListMessageExtensions(ctx context.Context, id UserIdMessageId) (result ListMessageExtensionsOperationResponse, err error) {
...
func (c MessageExtensionClient) ListMessageExtensionsComplete(ctx context.Context, id UserIdMessageId) (ListMessageExtensionsCompleteResult, error) {
...
func (c MessageExtensionClient) ListMessageExtensionsCompleteMatchingPredicate(ctx context.Context, id UserIdMessageId, predicate ExtensionOperationPredicate) (result ListMessageExtensionsCompleteResult, err error) {
