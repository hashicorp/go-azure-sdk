...
func (c PlannerPlanClient) CreatePlannerPlan(ctx context.Context, id stable.UserId, input stable.PlannerPlan) (result CreatePlannerPlanOperationResponse, err error) {
