...
// ListPlannerPlans ...
func (c PlannerPlanClient) ListPlannerPlans(ctx context.Context, id UserId) (result ListPlannerPlansOperationResponse, err error) {
...
func (c PlannerPlanClient) ListPlannerPlansComplete(ctx context.Context, id UserId) (ListPlannerPlansCompleteResult, error) {
...
func (c PlannerPlanClient) ListPlannerPlansCompleteMatchingPredicate(ctx context.Context, id UserId, predicate PlannerPlanOperationPredicate) (result ListPlannerPlansCompleteResult, err error) {
