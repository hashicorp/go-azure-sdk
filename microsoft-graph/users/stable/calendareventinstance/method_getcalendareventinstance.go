...
// Nullable.
func (c CalendarEventInstanceClient) GetCalendarEventInstance(ctx context.Context, id stable.UserIdCalendarEventIdInstanceId, options GetCalendarEventInstanceOperationOptions) (result GetCalendarEventInstanceOperationResponse, err error) {
