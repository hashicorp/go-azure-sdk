...
func (c CalendarEventInstanceClient) TentativelyAcceptCalendarEventInstance(ctx context.Context, id stable.UserIdCalendarIdEventIdInstanceId, input TentativelyAcceptCalendarEventInstanceRequest) (result TentativelyAcceptCalendarEventInstanceOperationResponse, err error) {
