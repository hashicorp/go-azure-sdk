...
func (c CalendarEventInstanceClient) DismissCalendarEventInstanceReminder(ctx context.Context, id stable.UserIdCalendarEventIdInstanceId) (result DismissCalendarEventInstanceReminderOperationResponse, err error) {
