...
// Outlook.com account.
func (c CalendarEventInstanceClient) ForwardCalendarEventInstance(ctx context.Context, id stable.UserIdCalendarEventIdInstanceId, input ForwardCalendarEventInstanceRequest) (result ForwardCalendarEventInstanceOperationResponse, err error) {
