...
func (c CalendarEventInstanceClient) DeclineCalendarEventInstance(ctx context.Context, id stable.UserIdCalendarEventIdInstanceId, input DeclineCalendarEventInstanceRequest) (result DeclineCalendarEventInstanceOperationResponse, err error) {
