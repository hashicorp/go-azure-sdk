...
// ListCalendarEventInstances - Get instances from users. The occurrences of a recurring series, if the event is a
...
// Read-only. Nullable.
func (c CalendarEventInstanceClient) ListCalendarEventInstances(ctx context.Context, id stable.UserIdCalendarIdEventId, options ListCalendarEventInstancesOperationOptions) (result ListCalendarEventInstancesOperationResponse, err error) {
...
func (c CalendarEventInstanceClient) ListCalendarEventInstancesComplete(ctx context.Context, id stable.UserIdCalendarIdEventId, options ListCalendarEventInstancesOperationOptions) (ListCalendarEventInstancesCompleteResult, error) {
...
func (c CalendarEventInstanceClient) ListCalendarEventInstancesCompleteMatchingPredicate(ctx context.Context, id stable.UserIdCalendarIdEventId, options ListCalendarEventInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarEventInstancesCompleteResult, err error) {
