...
func (c CalendarEventInstanceClient) SnoozeCalendarEventInstanceReminder(ctx context.Context, id stable.UserIdCalendarEventIdInstanceId, input SnoozeCalendarEventInstanceReminderRequest) (result SnoozeCalendarEventInstanceReminderOperationResponse, err error) {
