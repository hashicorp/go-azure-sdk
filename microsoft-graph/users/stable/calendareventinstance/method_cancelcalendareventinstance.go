...
func (c CalendarEventInstanceClient) CancelCalendarEventInstance(ctx context.Context, id stable.UserIdCalendarIdEventIdInstanceId, input CancelCalendarEventInstanceRequest) (result CancelCalendarEventInstanceOperationResponse, err error) {
