...
func (c DriveRootThumbnailClient) CreateDriveRootThumbnail(ctx context.Context, id stable.UserIdDriveId, input stable.ThumbnailSet) (result CreateDriveRootThumbnailOperationResponse, err error) {
