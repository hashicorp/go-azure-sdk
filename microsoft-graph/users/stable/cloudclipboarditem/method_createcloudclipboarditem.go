...
func (c CloudClipboardItemClient) CreateCloudClipboardItem(ctx context.Context, id stable.UserId, input stable.CloudClipboardItem) (result CreateCloudClipboardItemOperationResponse, err error) {
