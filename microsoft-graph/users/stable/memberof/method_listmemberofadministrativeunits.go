...
func (c MemberOfClient) ListMemberOfAdministrativeUnits(ctx context.Context, id stable.UserId, options ListMemberOfAdministrativeUnitsOperationOptions) (result ListMemberOfAdministrativeUnitsOperationResponse, err error) {
...
func (c MemberOfClient) ListMemberOfAdministrativeUnitsComplete(ctx context.Context, id stable.UserId, options ListMemberOfAdministrativeUnitsOperationOptions) (ListMemberOfAdministrativeUnitsCompleteResult, error) {
...
func (c MemberOfClient) ListMemberOfAdministrativeUnitsCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListMemberOfAdministrativeUnitsOperationOptions, predicate AdministrativeUnitOperationPredicate) (result ListMemberOfAdministrativeUnitsCompleteResult, err error) {
