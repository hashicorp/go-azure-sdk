...
// ListMemberOfGroups - List a user's direct memberships. Get groups, directory roles, and administrative units that the
// user is a direct member of. This operation isn't transitive. To retrieve groups, directory roles, and administrative
// units that the user is a member through transitive membership, use the List user transitive memberOf API.
func (c MemberOfClient) ListMemberOfGroups(ctx context.Context, id stable.UserId, options ListMemberOfGroupsOperationOptions) (result ListMemberOfGroupsOperationResponse, err error) {
...
func (c MemberOfClient) ListMemberOfGroupsComplete(ctx context.Context, id stable.UserId, options ListMemberOfGroupsOperationOptions) (ListMemberOfGroupsCompleteResult, error) {
...
func (c MemberOfClient) ListMemberOfGroupsCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListMemberOfGroupsOperationOptions, predicate GroupOperationPredicate) (result ListMemberOfGroupsCompleteResult, err error) {
