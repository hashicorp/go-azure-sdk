...
func (c MemberOfClient) GetMemberOfDirectoryRoleCount(ctx context.Context, id stable.UserId, options GetMemberOfDirectoryRoleCountOperationOptions) (result GetMemberOfDirectoryRoleCountOperationResponse, err error) {
