...
// CreateAppRoleAssignment - Grant an appRoleAssignment to a user. Assign an app role to a user, creating an
// appRoleAssignment object. To grant an app role assignment to a user, you need three identifiers
