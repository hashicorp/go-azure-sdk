...
func (c AppRoleAssignmentClient) CreateAppRoleAssignment(ctx context.Context, id UserId, input stable.AppRoleAssignment) (result CreateAppRoleAssignmentOperationResponse, err error) {
