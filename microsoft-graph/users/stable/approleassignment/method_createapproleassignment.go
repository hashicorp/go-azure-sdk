...
func (c AppRoleAssignmentClient) CreateAppRoleAssignment(ctx context.Context, id stable.UserId, input stable.AppRoleAssignment) (result CreateAppRoleAssignmentOperationResponse, err error) {
