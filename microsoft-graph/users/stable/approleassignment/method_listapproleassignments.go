...
func (c AppRoleAssignmentClient) ListAppRoleAssignments(ctx context.Context, id UserId) (result ListAppRoleAssignmentsOperationResponse, err error) {
...
func (c AppRoleAssignmentClient) ListAppRoleAssignmentsComplete(ctx context.Context, id UserId) (ListAppRoleAssignmentsCompleteResult, error) {
...
func (c AppRoleAssignmentClient) ListAppRoleAssignmentsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate AppRoleAssignmentOperationPredicate) (result ListAppRoleAssignmentsCompleteResult, err error) {
