...
func (c JoinedTeamInstalledAppClient) ListJoinedTeamInstalledApps(ctx context.Context, id UserIdJoinedTeamId) (result ListJoinedTeamInstalledAppsOperationResponse, err error) {
...
func (c JoinedTeamInstalledAppClient) ListJoinedTeamInstalledAppsComplete(ctx context.Context, id UserIdJoinedTeamId) (ListJoinedTeamInstalledAppsCompleteResult, error) {
...
func (c JoinedTeamInstalledAppClient) ListJoinedTeamInstalledAppsCompleteMatchingPredicate(ctx context.Context, id UserIdJoinedTeamId, predicate TeamsAppInstallationOperationPredicate) (result ListJoinedTeamInstalledAppsCompleteResult, err error) {
