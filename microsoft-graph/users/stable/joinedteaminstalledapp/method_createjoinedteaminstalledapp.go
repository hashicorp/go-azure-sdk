...
func (c JoinedTeamInstalledAppClient) CreateJoinedTeamInstalledApp(ctx context.Context, id stable.UserIdJoinedTeamId, input stable.TeamsAppInstallation) (result CreateJoinedTeamInstalledAppOperationResponse, err error) {
