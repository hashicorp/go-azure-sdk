...
func (c ManagedDeviceDeviceCompliancePolicyStateClient) ListManagedDeviceDeviceCompliancePolicyStates(ctx context.Context, id UserIdManagedDeviceId) (result ListManagedDeviceDeviceCompliancePolicyStatesOperationResponse, err error) {
...
func (c ManagedDeviceDeviceCompliancePolicyStateClient) ListManagedDeviceDeviceCompliancePolicyStatesComplete(ctx context.Context, id UserIdManagedDeviceId) (ListManagedDeviceDeviceCompliancePolicyStatesCompleteResult, error) {
