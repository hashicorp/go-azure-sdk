...
func (c TeamworkInstalledAppClient) CreateTeamworkInstalledApp(ctx context.Context, id stable.UserId, input stable.UserScopeTeamsAppInstallation) (result CreateTeamworkInstalledAppOperationResponse, err error) {
