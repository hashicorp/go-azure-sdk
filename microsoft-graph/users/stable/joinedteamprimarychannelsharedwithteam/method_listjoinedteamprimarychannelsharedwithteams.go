...
func (c JoinedTeamPrimaryChannelSharedWithTeamClient) ListJoinedTeamPrimaryChannelSharedWithTeams(ctx context.Context, id UserIdJoinedTeamId) (result ListJoinedTeamPrimaryChannelSharedWithTeamsOperationResponse, err error) {
...
func (c JoinedTeamPrimaryChannelSharedWithTeamClient) ListJoinedTeamPrimaryChannelSharedWithTeamsComplete(ctx context.Context, id UserIdJoinedTeamId) (ListJoinedTeamPrimaryChannelSharedWithTeamsCompleteResult, error) {
...
func (c JoinedTeamPrimaryChannelSharedWithTeamClient) ListJoinedTeamPrimaryChannelSharedWithTeamsCompleteMatchingPredicate(ctx context.Context, id UserIdJoinedTeamId, predicate SharedWithChannelTeamInfoOperationPredicate) (result ListJoinedTeamPrimaryChannelSharedWithTeamsCompleteResult, err error) {
