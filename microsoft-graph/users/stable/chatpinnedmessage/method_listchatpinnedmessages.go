...
func (c ChatPinnedMessageClient) ListChatPinnedMessages(ctx context.Context, id UserIdChatId) (result ListChatPinnedMessagesOperationResponse, err error) {
...
func (c ChatPinnedMessageClient) ListChatPinnedMessagesComplete(ctx context.Context, id UserIdChatId) (ListChatPinnedMessagesCompleteResult, error) {
...
func (c ChatPinnedMessageClient) ListChatPinnedMessagesCompleteMatchingPredicate(ctx context.Context, id UserIdChatId, predicate PinnedChatMessageInfoOperationPredicate) (result ListChatPinnedMessagesCompleteResult, err error) {
