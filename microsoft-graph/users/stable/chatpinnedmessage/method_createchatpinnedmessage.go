...
func (c ChatPinnedMessageClient) CreateChatPinnedMessage(ctx context.Context, id stable.UserIdChatId, input stable.PinnedChatMessageInfo) (result CreateChatPinnedMessageOperationResponse, err error) {
