...
func (c PlannerTaskClient) CreatePlannerTask(ctx context.Context, id stable.UserId, input stable.PlannerTask) (result CreatePlannerTaskOperationResponse, err error) {
