...
func (c ChatLastMessagePreviewClient) UpdateChatLastMessagePreview(ctx context.Context, id stable.UserIdChatId, input stable.ChatMessageInfo) (result UpdateChatLastMessagePreviewOperationResponse, err error) {
