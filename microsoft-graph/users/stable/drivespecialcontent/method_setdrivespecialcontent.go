...
// represents a file.
func (c DriveSpecialContentClient) SetDriveSpecialContent(ctx context.Context, id stable.UserIdDriveIdSpecialId, input []byte) (result SetDriveSpecialContentOperationResponse, err error) {
