...
func (c MailFolderMessageRuleClient) CreateMailFolderMessageRule(ctx context.Context, id stable.UserIdMailFolderId, input stable.MessageRule) (result CreateMailFolderMessageRuleOperationResponse, err error) {
