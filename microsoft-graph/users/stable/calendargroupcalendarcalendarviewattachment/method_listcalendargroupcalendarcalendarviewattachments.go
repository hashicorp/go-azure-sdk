...
func (c CalendarGroupCalendarCalendarViewAttachmentClient) ListCalendarGroupCalendarCalendarViewAttachments(ctx context.Context, id UserIdCalendarGroupIdCalendarIdCalendarViewId) (result ListCalendarGroupCalendarCalendarViewAttachmentsOperationResponse, err error) {
...
func (c CalendarGroupCalendarCalendarViewAttachmentClient) ListCalendarGroupCalendarCalendarViewAttachmentsComplete(ctx context.Context, id UserIdCalendarGroupIdCalendarIdCalendarViewId) (ListCalendarGroupCalendarCalendarViewAttachmentsCompleteResult, error) {
...
func (c CalendarGroupCalendarCalendarViewAttachmentClient) ListCalendarGroupCalendarCalendarViewAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarGroupIdCalendarIdCalendarViewId, predicate AttachmentOperationPredicate) (result ListCalendarGroupCalendarCalendarViewAttachmentsCompleteResult, err error) {
