...
func (c UserClient) WipeManagedAppRegistrationsByDeviceTag(ctx context.Context, id stable.UserId, input WipeManagedAppRegistrationsByDeviceTagRequest) (result WipeManagedAppRegistrationsByDeviceTagOperationResponse, err error) {
