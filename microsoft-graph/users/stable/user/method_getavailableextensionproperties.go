...
func (c UserClient) GetAvailableExtensionProperties(ctx context.Context, input GetAvailableExtensionPropertiesRequest, options GetAvailableExtensionPropertiesOperationOptions) (result GetAvailableExtensionPropertiesOperationResponse, err error) {
...
func (c UserClient) GetAvailableExtensionPropertiesComplete(ctx context.Context, input GetAvailableExtensionPropertiesRequest, options GetAvailableExtensionPropertiesOperationOptions) (GetAvailableExtensionPropertiesCompleteResult, error) {
