...
// this user
func (c UserClient) RemoveAllDevicesFromManagement(ctx context.Context, id stable.UserId) (result RemoveAllDevicesFromManagementOperationResponse, err error) {
