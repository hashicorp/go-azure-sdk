...
func (c DriveRootListItemLastModifiedByUserMailboxSettingClient) UpdateDriveRootListItemLastModifiedByUserMailboxSetting(ctx context.Context, id stable.UserIdDriveId, input stable.MailboxSettings) (result UpdateDriveRootListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
