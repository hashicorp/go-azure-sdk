...
func (c CalendarViewInstanceAttachmentClient) CreateCalendarViewInstanceAttachmentsUploadSession(ctx context.Context, id stable.UserIdCalendarViewIdInstanceId, input CreateCalendarViewInstanceAttachmentsUploadSessionRequest) (result CreateCalendarViewInstanceAttachmentsUploadSessionOperationResponse, err error) {
