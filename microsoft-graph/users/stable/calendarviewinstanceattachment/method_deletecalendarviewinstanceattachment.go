...
func (c CalendarViewInstanceAttachmentClient) DeleteCalendarViewInstanceAttachment(ctx context.Context, id stable.UserIdCalendarViewIdInstanceIdAttachmentId, options DeleteCalendarViewInstanceAttachmentOperationOptions) (result DeleteCalendarViewInstanceAttachmentOperationResponse, err error) {
