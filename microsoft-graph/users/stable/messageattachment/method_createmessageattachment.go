...
func (c MessageAttachmentClient) CreateMessageAttachment(ctx context.Context, id stable.UserIdMessageId, input stable.Attachment) (result CreateMessageAttachmentOperationResponse, err error) {
