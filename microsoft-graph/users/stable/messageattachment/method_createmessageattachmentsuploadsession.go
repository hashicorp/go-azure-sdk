...
func (c MessageAttachmentClient) CreateMessageAttachmentsUploadSession(ctx context.Context, id stable.UserIdMessageId, input CreateMessageAttachmentsUploadSessionRequest) (result CreateMessageAttachmentsUploadSessionOperationResponse, err error) {
