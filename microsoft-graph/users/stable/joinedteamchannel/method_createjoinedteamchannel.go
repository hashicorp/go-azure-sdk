...
func (c JoinedTeamChannelClient) CreateJoinedTeamChannel(ctx context.Context, id stable.UserIdJoinedTeamId, input stable.Channel) (result CreateJoinedTeamChannelOperationResponse, err error) {
