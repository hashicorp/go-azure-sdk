...
func (c JoinedTeamChannelClient) ProvisionJoinedTeamChannelEmail(ctx context.Context, id stable.UserIdJoinedTeamIdChannelId) (result ProvisionJoinedTeamChannelEmailOperationResponse, err error) {
