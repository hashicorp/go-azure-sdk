...
func (c EventClient) CreateEventPermanentDelete(ctx context.Context, id stable.UserIdEventId, options CreateEventPermanentDeleteOperationOptions) (result CreateEventPermanentDeleteOperationResponse, err error) {
