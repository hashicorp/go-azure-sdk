...
func (c EventClient) TentativelyAcceptEvent(ctx context.Context, id stable.UserIdEventId, input TentativelyAcceptEventRequest) (result TentativelyAcceptEventOperationResponse, err error) {
