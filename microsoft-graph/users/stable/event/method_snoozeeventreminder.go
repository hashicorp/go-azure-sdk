...
// time.
func (c EventClient) SnoozeEventReminder(ctx context.Context, id stable.UserIdEventId, input SnoozeEventReminderRequest) (result SnoozeEventReminderOperationResponse, err error) {
