...
// ListEvents ...
func (c EventClient) ListEvents(ctx context.Context, id UserId) (result ListEventsOperationResponse, err error) {
...
func (c EventClient) ListEventsComplete(ctx context.Context, id UserId) (ListEventsCompleteResult, error) {
...
func (c EventClient) ListEventsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate EventOperationPredicate) (result ListEventsCompleteResult, err error) {
