...
// device active user
func (c ManagedDeviceClient) LogoutManagedDeviceSharedAppleDeviceActiveUser(ctx context.Context, id stable.UserIdManagedDeviceId) (result LogoutManagedDeviceSharedAppleDeviceActiveUserOperationResponse, err error) {
