...
func (c ManagedDeviceClient) RequestManagedDeviceRemoteAssistance(ctx context.Context, id stable.UserIdManagedDeviceId) (result RequestManagedDeviceRemoteAssistanceOperationResponse, err error) {
