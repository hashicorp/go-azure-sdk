...
func (c ManagedDeviceClient) RecoverManagedDevicePasscode(ctx context.Context, id stable.UserIdManagedDeviceId) (result RecoverManagedDevicePasscodeOperationResponse, err error) {
