...
func (c ManagedDeviceClient) CreateManagedDevice(ctx context.Context, id stable.UserId, input stable.ManagedDevice) (result CreateManagedDeviceOperationResponse, err error) {
