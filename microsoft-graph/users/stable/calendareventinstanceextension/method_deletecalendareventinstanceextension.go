...
// DeleteCalendarEventInstanceExtension - Delete navigation property extensions for users
func (c CalendarEventInstanceExtensionClient) DeleteCalendarEventInstanceExtension(ctx context.Context, id stable.UserIdCalendarIdEventIdInstanceIdExtensionId, options DeleteCalendarEventInstanceExtensionOperationOptions) (result DeleteCalendarEventInstanceExtensionOperationResponse, err error) {
