...
// GetCalendarEventInstanceExtension - Get extensions from users. The collection of open extensions defined for the
// event. Nullable.
func (c CalendarEventInstanceExtensionClient) GetCalendarEventInstanceExtension(ctx context.Context, id stable.UserIdCalendarIdEventIdInstanceIdExtensionId, options GetCalendarEventInstanceExtensionOperationOptions) (result GetCalendarEventInstanceExtensionOperationResponse, err error) {
