...
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensions(ctx context.Context, id UserIdCalendarIdEventIdInstanceId) (result ListCalendarEventInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensionsComplete(ctx context.Context, id UserIdCalendarIdEventIdInstanceId) (ListCalendarEventInstanceExtensionsCompleteResult, error) {
...
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarIdEventIdInstanceId, predicate ExtensionOperationPredicate) (result ListCalendarEventInstanceExtensionsCompleteResult, err error) {
