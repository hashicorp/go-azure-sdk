...
// event. Nullable.
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensions(ctx context.Context, id stable.UserIdCalendarEventIdInstanceId, options ListCalendarEventInstanceExtensionsOperationOptions) (result ListCalendarEventInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensionsComplete(ctx context.Context, id stable.UserIdCalendarEventIdInstanceId, options ListCalendarEventInstanceExtensionsOperationOptions) (ListCalendarEventInstanceExtensionsCompleteResult, error) {
...
func (c CalendarEventInstanceExtensionClient) ListCalendarEventInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdCalendarEventIdInstanceId, options ListCalendarEventInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarEventInstanceExtensionsCompleteResult, err error) {
