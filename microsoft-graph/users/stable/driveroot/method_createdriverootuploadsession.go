...
func (c DriveRootClient) CreateDriveRootUploadSession(ctx context.Context, id stable.UserIdDriveId, input CreateDriveRootUploadSessionRequest) (result CreateDriveRootUploadSessionOperationResponse, err error) {
