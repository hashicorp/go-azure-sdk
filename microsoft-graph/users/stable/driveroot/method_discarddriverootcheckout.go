...
// permissions.
func (c DriveRootClient) DiscardDriveRootCheckout(ctx context.Context, id stable.UserIdDriveId, options DiscardDriveRootCheckoutOperationOptions) (result DiscardDriveRootCheckoutOperationResponse, err error) {
