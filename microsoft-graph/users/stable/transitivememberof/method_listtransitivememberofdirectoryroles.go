...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfDirectoryRoles(ctx context.Context, id stable.UserId, options ListTransitiveMemberOfDirectoryRolesOperationOptions) (result ListTransitiveMemberOfDirectoryRolesOperationResponse, err error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfDirectoryRolesComplete(ctx context.Context, id stable.UserId, options ListTransitiveMemberOfDirectoryRolesOperationOptions) (ListTransitiveMemberOfDirectoryRolesCompleteResult, error) {
