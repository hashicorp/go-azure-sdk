...
func (c JoinedTeamPrimaryChannelMemberClient) RemoveJoinedTeamPrimaryChannelMembers(ctx context.Context, id stable.UserIdJoinedTeamId, input RemoveJoinedTeamPrimaryChannelMembersRequest, options RemoveJoinedTeamPrimaryChannelMembersOperationOptions) (result RemoveJoinedTeamPrimaryChannelMembersOperationResponse, err error) {
...
func (c JoinedTeamPrimaryChannelMemberClient) RemoveJoinedTeamPrimaryChannelMembersComplete(ctx context.Context, id stable.UserIdJoinedTeamId, input RemoveJoinedTeamPrimaryChannelMembersRequest, options RemoveJoinedTeamPrimaryChannelMembersOperationOptions) (RemoveJoinedTeamPrimaryChannelMembersCompleteResult, error) {
...
func (c JoinedTeamPrimaryChannelMemberClient) RemoveJoinedTeamPrimaryChannelMembersCompleteMatchingPredicate(ctx context.Context, id stable.UserIdJoinedTeamId, input RemoveJoinedTeamPrimaryChannelMembersRequest, options RemoveJoinedTeamPrimaryChannelMembersOperationOptions, predicate ActionResultPartOperationPredicate) (result RemoveJoinedTeamPrimaryChannelMembersCompleteResult, err error) {
