...
func (c JoinedTeamPrimaryChannelMemberClient) ListJoinedTeamPrimaryChannelMembers(ctx context.Context, id UserIdJoinedTeamId) (result ListJoinedTeamPrimaryChannelMembersOperationResponse, err error) {
...
func (c JoinedTeamPrimaryChannelMemberClient) ListJoinedTeamPrimaryChannelMembersComplete(ctx context.Context, id UserIdJoinedTeamId) (ListJoinedTeamPrimaryChannelMembersCompleteResult, error) {
...
func (c JoinedTeamPrimaryChannelMemberClient) ListJoinedTeamPrimaryChannelMembersCompleteMatchingPredicate(ctx context.Context, id UserIdJoinedTeamId, predicate ConversationMemberOperationPredicate) (result ListJoinedTeamPrimaryChannelMembersCompleteResult, err error) {
