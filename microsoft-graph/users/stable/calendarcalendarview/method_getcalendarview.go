...
// GetCalendarView - Get calendarView from users. The calendar view for the calendar. Navigation property. Read-only.
func (c CalendarCalendarViewClient) GetCalendarView(ctx context.Context, id stable.UserIdCalendarIdCalendarViewId, options GetCalendarViewOperationOptions) (result GetCalendarViewOperationResponse, err error) {
