...
func (c CalendarCalendarViewClient) DeclineCalendarView(ctx context.Context, id stable.UserIdCalendarIdCalendarViewId, input DeclineCalendarViewRequest) (result DeclineCalendarViewOperationResponse, err error) {
