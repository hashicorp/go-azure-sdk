...
func (c CalendarCalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id stable.UserIdCalendarIdCalendarViewId, input TentativelyAcceptCalendarViewRequest) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
