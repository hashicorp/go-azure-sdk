...
// Outlook.com account.
func (c CalendarCalendarViewClient) ForwardCalendarView(ctx context.Context, id stable.UserIdCalendarIdCalendarViewId, input ForwardCalendarViewRequest) (result ForwardCalendarViewOperationResponse, err error) {
