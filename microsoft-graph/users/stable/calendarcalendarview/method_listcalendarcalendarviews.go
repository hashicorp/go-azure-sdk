...
func (c CalendarCalendarViewClient) ListCalendarCalendarViews(ctx context.Context, id UserId) (result ListCalendarCalendarViewsOperationResponse, err error) {
...
func (c CalendarCalendarViewClient) ListCalendarCalendarViewsComplete(ctx context.Context, id UserId) (ListCalendarCalendarViewsCompleteResult, error) {
...
func (c CalendarCalendarViewClient) ListCalendarCalendarViewsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate EventOperationPredicate) (result ListCalendarCalendarViewsCompleteResult, err error) {
