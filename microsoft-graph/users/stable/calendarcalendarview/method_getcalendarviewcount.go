...
func (c CalendarCalendarViewClient) GetCalendarViewCount(ctx context.Context, id stable.UserIdCalendarId, options GetCalendarViewCountOperationOptions) (result GetCalendarViewCountOperationResponse, err error) {
