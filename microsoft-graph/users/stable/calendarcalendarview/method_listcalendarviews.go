...
func (c CalendarCalendarViewClient) ListCalendarViews(ctx context.Context, id stable.UserId, options ListCalendarViewsOperationOptions) (result ListCalendarViewsOperationResponse, err error) {
...
func (c CalendarCalendarViewClient) ListCalendarViewsComplete(ctx context.Context, id stable.UserId, options ListCalendarViewsOperationOptions) (ListCalendarViewsCompleteResult, error) {
...
func (c CalendarCalendarViewClient) ListCalendarViewsCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListCalendarViewsOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewsCompleteResult, err error) {
