...
func (c CalendarCalendarViewClient) CancelCalendarView(ctx context.Context, id stable.UserIdCalendarIdCalendarViewId, input CancelCalendarViewRequest) (result CancelCalendarViewOperationResponse, err error) {
