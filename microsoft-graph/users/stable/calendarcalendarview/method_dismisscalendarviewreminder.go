...
// in a user calendar.
func (c CalendarCalendarViewClient) DismissCalendarViewReminder(ctx context.Context, id stable.UserIdCalendarIdCalendarViewId) (result DismissCalendarViewReminderOperationResponse, err error) {
