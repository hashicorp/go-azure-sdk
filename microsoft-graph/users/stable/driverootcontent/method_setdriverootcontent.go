...
// represents a file.
func (c DriveRootContentClient) SetDriveRootContent(ctx context.Context, id stable.UserIdDriveId, input []byte) (result SetDriveRootContentOperationResponse, err error) {
