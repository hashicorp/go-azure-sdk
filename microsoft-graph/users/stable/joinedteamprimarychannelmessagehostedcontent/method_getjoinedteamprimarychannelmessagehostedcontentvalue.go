...
func (c JoinedTeamPrimaryChannelMessageHostedContentClient) GetJoinedTeamPrimaryChannelMessageHostedContentValue(ctx context.Context, id stable.UserIdJoinedTeamIdPrimaryChannelMessageIdHostedContentId) (result GetJoinedTeamPrimaryChannelMessageHostedContentValueOperationResponse, err error) {
