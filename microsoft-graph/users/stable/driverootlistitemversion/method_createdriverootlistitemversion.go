...
func (c DriveRootListItemVersionClient) CreateDriveRootListItemVersion(ctx context.Context, id stable.UserIdDriveId, input stable.ListItemVersion) (result CreateDriveRootListItemVersionOperationResponse, err error) {
