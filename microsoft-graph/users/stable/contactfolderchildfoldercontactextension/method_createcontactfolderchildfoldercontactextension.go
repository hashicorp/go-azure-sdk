...
func (c ContactFolderChildFolderContactExtensionClient) CreateContactFolderChildFolderContactExtension(ctx context.Context, id stable.UserIdContactFolderIdChildFolderIdContactId, input stable.Extension) (result CreateContactFolderChildFolderContactExtensionOperationResponse, err error) {
