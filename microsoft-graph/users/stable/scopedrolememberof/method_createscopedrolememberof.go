...
func (c ScopedRoleMemberOfClient) CreateScopedRoleMemberOf(ctx context.Context, id stable.UserId, input stable.ScopedRoleMembership) (result CreateScopedRoleMemberOfOperationResponse, err error) {
