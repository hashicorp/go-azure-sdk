...
func (c CalendarViewClient) CancelCalendarView(ctx context.Context, id stable.UserIdCalendarViewId, input CancelCalendarViewRequest) (result CancelCalendarViewOperationResponse, err error) {
