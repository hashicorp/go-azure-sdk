...
func (c CalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id stable.UserIdCalendarViewId, input TentativelyAcceptCalendarViewRequest) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
