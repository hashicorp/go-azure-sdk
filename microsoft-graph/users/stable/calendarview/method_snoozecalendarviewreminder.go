...
// a new time.
func (c CalendarViewClient) SnoozeCalendarViewReminder(ctx context.Context, id stable.UserIdCalendarViewId, input SnoozeCalendarViewReminderRequest) (result SnoozeCalendarViewReminderOperationResponse, err error) {
