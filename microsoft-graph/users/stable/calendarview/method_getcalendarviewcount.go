...
func (c CalendarViewClient) GetCalendarViewCount(ctx context.Context, id stable.UserId, options GetCalendarViewCountOperationOptions) (result GetCalendarViewCountOperationResponse, err error) {
