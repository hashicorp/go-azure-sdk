...
// in a user calendar.
func (c CalendarViewClient) DismissCalendarViewReminder(ctx context.Context, id stable.UserIdCalendarViewId) (result DismissCalendarViewReminderOperationResponse, err error) {
