...
// ListCalendarViews - Get calendarView from users. The calendar view for the calendar. Read-only. Nullable.
func (c CalendarViewClient) ListCalendarViews(ctx context.Context, id stable.UserId, options ListCalendarViewsOperationOptions) (result ListCalendarViewsOperationResponse, err error) {
...
func (c CalendarViewClient) ListCalendarViewsComplete(ctx context.Context, id stable.UserId, options ListCalendarViewsOperationOptions) (ListCalendarViewsCompleteResult, error) {
...
func (c CalendarViewClient) ListCalendarViewsCompleteMatchingPredicate(ctx context.Context, id stable.UserId, options ListCalendarViewsOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewsCompleteResult, err error) {
