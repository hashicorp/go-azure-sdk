...
// Outlook.com account.
func (c CalendarViewClient) ForwardCalendarView(ctx context.Context, id stable.UserIdCalendarViewId, input ForwardCalendarViewRequest) (result ForwardCalendarViewOperationResponse, err error) {
