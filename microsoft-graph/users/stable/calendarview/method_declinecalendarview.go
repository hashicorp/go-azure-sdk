...
func (c CalendarViewClient) DeclineCalendarView(ctx context.Context, id stable.UserIdCalendarViewId, input DeclineCalendarViewRequest) (result DeclineCalendarViewOperationResponse, err error) {
