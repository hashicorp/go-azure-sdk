...
// GetCalendarView - Get calendarView from users. The calendar view for the calendar. Read-only. Nullable.
func (c CalendarViewClient) GetCalendarView(ctx context.Context, id stable.UserIdCalendarViewId, options GetCalendarViewOperationOptions) (result GetCalendarViewOperationResponse, err error) {
