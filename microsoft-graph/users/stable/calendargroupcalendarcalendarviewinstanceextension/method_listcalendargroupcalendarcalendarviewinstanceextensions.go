...
func (c CalendarGroupCalendarCalendarViewInstanceExtensionClient) ListCalendarGroupCalendarCalendarViewInstanceExtensions(ctx context.Context, id UserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceId) (result ListCalendarGroupCalendarCalendarViewInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarCalendarViewInstanceExtensionClient) ListCalendarGroupCalendarCalendarViewInstanceExtensionsComplete(ctx context.Context, id UserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceId) (ListCalendarGroupCalendarCalendarViewInstanceExtensionsCompleteResult, error) {
...
func (c CalendarGroupCalendarCalendarViewInstanceExtensionClient) ListCalendarGroupCalendarCalendarViewInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceId, predicate ExtensionOperationPredicate) (result ListCalendarGroupCalendarCalendarViewInstanceExtensionsCompleteResult, err error) {
