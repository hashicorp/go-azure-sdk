...
func (c CalendarGroupCalendarCalendarViewInstanceExtensionClient) GetCalendarGroupCalendarViewInstanceExtension(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExtensionId, options GetCalendarGroupCalendarViewInstanceExtensionOperationOptions) (result GetCalendarGroupCalendarViewInstanceExtensionOperationResponse, err error) {
