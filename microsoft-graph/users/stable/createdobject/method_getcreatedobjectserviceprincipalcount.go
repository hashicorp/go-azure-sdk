...
func (c CreatedObjectClient) GetCreatedObjectServicePrincipalCount(ctx context.Context, id stable.UserId, options GetCreatedObjectServicePrincipalCountOperationOptions) (result GetCreatedObjectServicePrincipalCountOperationResponse, err error) {
