...
// ListCalendarEventExtensions - Get extensions from users. The collection of open extensions defined for the event.
// Nullable.
func (c CalendarEventExtensionClient) ListCalendarEventExtensions(ctx context.Context, id stable.UserIdCalendarEventId, options ListCalendarEventExtensionsOperationOptions) (result ListCalendarEventExtensionsOperationResponse, err error) {
...
func (c CalendarEventExtensionClient) ListCalendarEventExtensionsComplete(ctx context.Context, id stable.UserIdCalendarEventId, options ListCalendarEventExtensionsOperationOptions) (ListCalendarEventExtensionsCompleteResult, error) {
...
func (c CalendarEventExtensionClient) ListCalendarEventExtensionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdCalendarEventId, options ListCalendarEventExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarEventExtensionsCompleteResult, err error) {
