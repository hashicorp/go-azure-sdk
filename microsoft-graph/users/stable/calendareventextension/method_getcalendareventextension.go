...
// GetCalendarEventExtension - Get extensions from users. The collection of open extensions defined for the event.
// Nullable.
func (c CalendarEventExtensionClient) GetCalendarEventExtension(ctx context.Context, id stable.UserIdCalendarEventIdExtensionId, options GetCalendarEventExtensionOperationOptions) (result GetCalendarEventExtensionOperationResponse, err error) {
