...
// DeleteCalendarEventExtension - Delete navigation property extensions for users
func (c CalendarEventExtensionClient) DeleteCalendarEventExtension(ctx context.Context, id stable.UserIdCalendarEventIdExtensionId, options DeleteCalendarEventExtensionOperationOptions) (result DeleteCalendarEventExtensionOperationResponse, err error) {
