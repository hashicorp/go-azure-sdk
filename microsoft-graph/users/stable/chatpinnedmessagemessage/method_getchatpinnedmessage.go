...
// GetChatPinnedMessage - Get message from users. Represents details about the chat message that is pinned.
func (c ChatPinnedMessageMessageClient) GetChatPinnedMessage(ctx context.Context, id stable.UserIdChatIdPinnedMessageId, options GetChatPinnedMessageOperationOptions) (result GetChatPinnedMessageOperationResponse, err error) {
