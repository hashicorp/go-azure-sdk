...
// CreateContactFolderPermanentDelete - Invoke action permanentDelete
func (c ContactFolderClient) CreateContactFolderPermanentDelete(ctx context.Context, id stable.UserIdContactFolderId, options CreateContactFolderPermanentDeleteOperationOptions) (result CreateContactFolderPermanentDeleteOperationResponse, err error) {
