...
// CreateContactFolder ...
func (c ContactFolderClient) CreateContactFolder(ctx context.Context, id UserId, input stable.ContactFolder) (result CreateContactFolderOperationResponse, err error) {
