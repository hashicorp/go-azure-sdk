...
// Read-only.
func (c CalendarGroupCalendarViewClient) GetCalendarGroupCalendarView(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarIdCalendarViewId, options GetCalendarGroupCalendarViewOperationOptions) (result GetCalendarGroupCalendarViewOperationResponse, err error) {
