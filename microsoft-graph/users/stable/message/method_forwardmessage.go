...
func (c MessageClient) ForwardMessage(ctx context.Context, id stable.UserIdMessageId, input ForwardMessageRequest) (result ForwardMessageOperationResponse, err error) {
