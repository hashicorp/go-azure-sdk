...
func (c MessageClient) ReplyMessage(ctx context.Context, id stable.UserIdMessageId, input ReplyMessageRequest) (result ReplyMessageOperationResponse, err error) {
