...
func (c MessageClient) CreateMessageForward(ctx context.Context, id stable.UserIdMessageId, input CreateMessageForwardRequest) (result CreateMessageForwardOperationResponse, err error) {
