...
func (c MessageClient) CreateMessageReplyAll(ctx context.Context, id stable.UserIdMessageId, input CreateMessageReplyAllRequest) (result CreateMessageReplyAllOperationResponse, err error) {
