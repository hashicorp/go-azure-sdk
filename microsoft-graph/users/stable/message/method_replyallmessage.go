...
// later.
func (c MessageClient) ReplyAllMessage(ctx context.Context, id stable.UserIdMessageId, input ReplyAllMessageRequest) (result ReplyAllMessageOperationResponse, err error) {
