...
func (c SettingWindowClient) CreateSettingWindow(ctx context.Context, id stable.UserId, input stable.WindowsSetting) (result CreateSettingWindowOperationResponse, err error) {
