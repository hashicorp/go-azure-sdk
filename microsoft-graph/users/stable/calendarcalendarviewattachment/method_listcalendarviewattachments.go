...
func (c CalendarCalendarViewAttachmentClient) ListCalendarViewAttachments(ctx context.Context, id stable.UserIdCalendarIdCalendarViewId, options ListCalendarViewAttachmentsOperationOptions) (result ListCalendarViewAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewAttachmentClient) ListCalendarViewAttachmentsComplete(ctx context.Context, id stable.UserIdCalendarIdCalendarViewId, options ListCalendarViewAttachmentsOperationOptions) (ListCalendarViewAttachmentsCompleteResult, error) {
