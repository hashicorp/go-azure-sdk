...
func (c CalendarCalendarViewAttachmentClient) DeleteCalendarViewAttachment(ctx context.Context, id stable.UserIdCalendarCalendarViewIdAttachmentId, options DeleteCalendarViewAttachmentOperationOptions) (result DeleteCalendarViewAttachmentOperationResponse, err error) {
