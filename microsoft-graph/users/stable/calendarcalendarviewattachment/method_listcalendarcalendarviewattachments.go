...
func (c CalendarCalendarViewAttachmentClient) ListCalendarCalendarViewAttachments(ctx context.Context, id UserIdCalendarIdCalendarViewId) (result ListCalendarCalendarViewAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewAttachmentClient) ListCalendarCalendarViewAttachmentsComplete(ctx context.Context, id UserIdCalendarIdCalendarViewId) (ListCalendarCalendarViewAttachmentsCompleteResult, error) {
...
func (c CalendarCalendarViewAttachmentClient) ListCalendarCalendarViewAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarIdCalendarViewId, predicate AttachmentOperationPredicate) (result ListCalendarCalendarViewAttachmentsCompleteResult, err error) {
