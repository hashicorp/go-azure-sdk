...
func (c PlannerTaskBucketTaskBoardFormatClient) UpdatePlannerTaskBucketTaskBoardFormat(ctx context.Context, id UserIdPlannerTaskId, input stable.PlannerBucketTaskBoardTaskFormat) (result UpdatePlannerTaskBucketTaskBoardFormatOperationResponse, err error) {
