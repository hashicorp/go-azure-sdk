...
func (c CalendarGroupCalendarEventClient) ListCalendarGroupCalendarEvents(ctx context.Context, id UserIdCalendarGroupIdCalendarId) (result ListCalendarGroupCalendarEventsOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventClient) ListCalendarGroupCalendarEventsComplete(ctx context.Context, id UserIdCalendarGroupIdCalendarId) (ListCalendarGroupCalendarEventsCompleteResult, error) {
...
func (c CalendarGroupCalendarEventClient) ListCalendarGroupCalendarEventsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarGroupIdCalendarId, predicate EventOperationPredicate) (result ListCalendarGroupCalendarEventsCompleteResult, err error) {
