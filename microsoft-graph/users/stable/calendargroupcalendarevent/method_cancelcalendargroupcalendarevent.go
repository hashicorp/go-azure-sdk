...
type CancelCalendarGroupCalendarEventOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

// CancelCalendarGroupCalendarEvent - Invoke action cancel. This action allows the organizer of a meeting to send a
...
func (c CalendarGroupCalendarEventClient) CancelCalendarGroupCalendarEvent(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarIdEventId, input CancelCalendarGroupCalendarEventRequest) (result CancelCalendarGroupCalendarEventOperationResponse, err error) {
