...
func (c CalendarGroupCalendarEventClient) DeleteCalendarGroupCalendarEvent(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarIdEventId, options DeleteCalendarGroupCalendarEventOperationOptions) (result DeleteCalendarGroupCalendarEventOperationResponse, err error) {
