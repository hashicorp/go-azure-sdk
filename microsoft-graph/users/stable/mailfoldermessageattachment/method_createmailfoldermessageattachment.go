...
func (c MailFolderMessageAttachmentClient) CreateMailFolderMessageAttachment(ctx context.Context, id stable.UserIdMailFolderIdMessageId, input stable.Attachment) (result CreateMailFolderMessageAttachmentOperationResponse, err error) {
