...
func (c MailFolderMessageAttachmentClient) CreateMailFolderMessageAttachmentsUploadSession(ctx context.Context, id stable.UserIdMailFolderIdMessageId, input CreateMailFolderMessageAttachmentsUploadSessionRequest) (result CreateMailFolderMessageAttachmentsUploadSessionOperationResponse, err error) {
