...
func (c CalendarGroupCalendarEventInstanceExtensionClient) GetCalendarGroupCalendarEventInstanceExtensionsCount(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarIdEventIdInstanceId, options GetCalendarGroupCalendarEventInstanceExtensionsCountOperationOptions) (result GetCalendarGroupCalendarEventInstanceExtensionsCountOperationResponse, err error) {
