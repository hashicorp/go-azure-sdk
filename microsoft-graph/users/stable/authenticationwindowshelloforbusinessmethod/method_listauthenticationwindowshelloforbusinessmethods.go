...
func (c AuthenticationWindowsHelloForBusinessMethodClient) ListAuthenticationWindowsHelloForBusinessMethods(ctx context.Context, id UserId) (result ListAuthenticationWindowsHelloForBusinessMethodsOperationResponse, err error) {
...
func (c AuthenticationWindowsHelloForBusinessMethodClient) ListAuthenticationWindowsHelloForBusinessMethodsComplete(ctx context.Context, id UserId) (ListAuthenticationWindowsHelloForBusinessMethodsCompleteResult, error) {
	return c.ListAuthenticationWindowsHelloForBusinessMethodsCompleteMatchingPredicate(ctx, id, WindowsHelloForBusinessAuthenticationMethodOperationPredicate{})
}
