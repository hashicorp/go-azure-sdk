...
func (c MailFolderChildFolderClient) MoveMailFolderChildFolder(ctx context.Context, id stable.UserIdMailFolderIdChildFolderId, input MoveMailFolderChildFolderRequest) (result MoveMailFolderChildFolderOperationResponse, err error) {
