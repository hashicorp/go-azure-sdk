...
func (c MailFolderChildFolderClient) CreateMailFolderChildFolder(ctx context.Context, id stable.UserIdMailFolderId, input stable.MailFolder) (result CreateMailFolderChildFolderOperationResponse, err error) {
