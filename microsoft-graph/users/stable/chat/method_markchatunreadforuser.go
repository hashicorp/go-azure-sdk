...
func (c ChatClient) MarkChatUnreadForUser(ctx context.Context, id stable.UserIdChatId, input MarkChatUnreadForUserRequest) (result MarkChatUnreadForUserOperationResponse, err error) {
