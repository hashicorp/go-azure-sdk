...
func (c InferenceClassificationOverrideClient) CreateInferenceClassificationOverride(ctx context.Context, id UserId, input stable.InferenceClassificationOverride) (result CreateInferenceClassificationOverrideOperationResponse, err error) {
