...
// recording. Read-only.
func (c OnlineMeetingRecordingContentClient) GetOnlineMeetingRecordingContent(ctx context.Context, id stable.UserIdOnlineMeetingIdRecordingId) (result GetOnlineMeetingRecordingContentOperationResponse, err error) {
