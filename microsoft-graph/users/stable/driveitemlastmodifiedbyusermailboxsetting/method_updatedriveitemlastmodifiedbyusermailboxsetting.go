...
func (c DriveItemLastModifiedByUserMailboxSettingClient) UpdateDriveItemLastModifiedByUserMailboxSetting(ctx context.Context, id stable.UserIdDriveIdItemId, input stable.MailboxSettings) (result UpdateDriveItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
