...
// DeleteCalendarEventInstanceAttachment - Delete navigation property attachments for users
func (c CalendarEventInstanceAttachmentClient) DeleteCalendarEventInstanceAttachment(ctx context.Context, id stable.UserIdCalendarIdEventIdInstanceIdAttachmentId, options DeleteCalendarEventInstanceAttachmentOperationOptions) (result DeleteCalendarEventInstanceAttachmentOperationResponse, err error) {
