...
// ListCalendarEventInstanceAttachments - Get attachments from users. The collection of FileAttachment, ItemAttachment,
// and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachments(ctx context.Context, id stable.UserIdCalendarEventIdInstanceId, options ListCalendarEventInstanceAttachmentsOperationOptions) (result ListCalendarEventInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachmentsComplete(ctx context.Context, id stable.UserIdCalendarEventIdInstanceId, options ListCalendarEventInstanceAttachmentsOperationOptions) (ListCalendarEventInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarEventInstanceAttachmentClient) ListCalendarEventInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdCalendarEventIdInstanceId, options ListCalendarEventInstanceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarEventInstanceAttachmentsCompleteResult, err error) {
