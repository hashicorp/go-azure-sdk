...
func (c CalendarEventInstanceAttachmentClient) GetCalendarEventInstanceAttachmentsCount(ctx context.Context, id stable.UserIdCalendarEventIdInstanceId, options GetCalendarEventInstanceAttachmentsCountOperationOptions) (result GetCalendarEventInstanceAttachmentsCountOperationResponse, err error) {
