...
func (c CalendarEventInstanceAttachmentClient) CreateCalendarEventInstanceAttachmentsUploadSession(ctx context.Context, id stable.UserIdCalendarEventIdInstanceId, input CreateCalendarEventInstanceAttachmentsUploadSessionRequest) (result CreateCalendarEventInstanceAttachmentsUploadSessionOperationResponse, err error) {
