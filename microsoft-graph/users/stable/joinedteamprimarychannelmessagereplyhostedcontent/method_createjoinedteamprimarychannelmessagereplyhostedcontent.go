...
func (c JoinedTeamPrimaryChannelMessageReplyHostedContentClient) CreateJoinedTeamPrimaryChannelMessageReplyHostedContent(ctx context.Context, id UserIdJoinedTeamIdPrimaryChannelMessageIdReplyId, input stable.ChatMessageHostedContent) (result CreateJoinedTeamPrimaryChannelMessageReplyHostedContentOperationResponse, err error) {
