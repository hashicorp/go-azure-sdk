...
func (c JoinedTeamPrimaryChannelMessageReplyHostedContentClient) ListJoinedTeamPrimaryChannelMessageReplyHostedContents(ctx context.Context, id UserIdJoinedTeamIdPrimaryChannelMessageIdReplyId) (result ListJoinedTeamPrimaryChannelMessageReplyHostedContentsOperationResponse, err error) {
...
func (c JoinedTeamPrimaryChannelMessageReplyHostedContentClient) ListJoinedTeamPrimaryChannelMessageReplyHostedContentsComplete(ctx context.Context, id UserIdJoinedTeamIdPrimaryChannelMessageIdReplyId) (ListJoinedTeamPrimaryChannelMessageReplyHostedContentsCompleteResult, error) {
...
func (c JoinedTeamPrimaryChannelMessageReplyHostedContentClient) ListJoinedTeamPrimaryChannelMessageReplyHostedContentsCompleteMatchingPredicate(ctx context.Context, id UserIdJoinedTeamIdPrimaryChannelMessageIdReplyId, predicate ChatMessageHostedContentOperationPredicate) (result ListJoinedTeamPrimaryChannelMessageReplyHostedContentsCompleteResult, err error) {
