...
func (c DriveListSubscriptionClient) CreateDriveListSubscription(ctx context.Context, id stable.UserIdDriveId, input stable.Subscription) (result CreateDriveListSubscriptionOperationResponse, err error) {
