...
func (c DriveListSubscriptionClient) CreateDriveListSubscriptionReauthorize(ctx context.Context, id stable.UserIdDriveIdListSubscriptionId) (result CreateDriveListSubscriptionReauthorizeOperationResponse, err error) {
