...
func (c MailFolderMessageClient) CopyMailFolderMessage(ctx context.Context, id stable.UserIdMailFolderIdMessageId, input CopyMailFolderMessageRequest) (result CopyMailFolderMessageOperationResponse, err error) {
