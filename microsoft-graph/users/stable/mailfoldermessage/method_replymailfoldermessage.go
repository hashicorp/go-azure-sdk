...
// later.
func (c MailFolderMessageClient) ReplyMailFolderMessage(ctx context.Context, id stable.UserIdMailFolderIdMessageId, input ReplyMailFolderMessageRequest) (result ReplyMailFolderMessageOperationResponse, err error) {
