...
func (c MailFolderMessageClient) CreateMailFolderMessageForward(ctx context.Context, id stable.UserIdMailFolderIdMessageId, input CreateMailFolderMessageForwardRequest) (result CreateMailFolderMessageForwardOperationResponse, err error) {
