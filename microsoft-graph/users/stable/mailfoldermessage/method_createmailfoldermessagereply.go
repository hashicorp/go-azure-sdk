...
func (c MailFolderMessageClient) CreateMailFolderMessageReply(ctx context.Context, id stable.UserIdMailFolderIdMessageId, input CreateMailFolderMessageReplyRequest) (result CreateMailFolderMessageReplyOperationResponse, err error) {
