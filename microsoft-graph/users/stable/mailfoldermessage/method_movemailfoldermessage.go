...
func (c MailFolderMessageClient) MoveMailFolderMessage(ctx context.Context, id stable.UserIdMailFolderIdMessageId, input MoveMailFolderMessageRequest) (result MoveMailFolderMessageOperationResponse, err error) {
