...
func (c MailFolderMessageClient) CreateMailFolderMessagePermanentDelete(ctx context.Context, id stable.UserIdMailFolderIdMessageId, options CreateMailFolderMessagePermanentDeleteOperationOptions) (result CreateMailFolderMessagePermanentDeleteOperationResponse, err error) {
