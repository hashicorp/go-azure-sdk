...
func (c MailFolderMessageClient) CreateMailFolderMessage(ctx context.Context, id stable.UserIdMailFolderId, input stable.Message) (result CreateMailFolderMessageOperationResponse, err error) {
