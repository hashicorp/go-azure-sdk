...
func (c MailFolderMessageClient) ForwardMailFolderMessage(ctx context.Context, id stable.UserIdMailFolderIdMessageId, input ForwardMailFolderMessageRequest) (result ForwardMailFolderMessageOperationResponse, err error) {
