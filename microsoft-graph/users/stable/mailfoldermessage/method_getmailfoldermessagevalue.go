...
func (c MailFolderMessageClient) GetMailFolderMessageValue(ctx context.Context, id stable.UserIdMailFolderIdMessageId) (result GetMailFolderMessageValueOperationResponse, err error) {
