...
func (c MailFolderMessageClient) SendMailFolderMessage(ctx context.Context, id stable.UserIdMailFolderIdMessageId) (result SendMailFolderMessageOperationResponse, err error) {
