...
// CreateOnlineMeeting ...
func (c OnlineMeetingClient) CreateOnlineMeeting(ctx context.Context, id UserId, input stable.OnlineMeeting) (result CreateOnlineMeetingOperationResponse, err error) {
