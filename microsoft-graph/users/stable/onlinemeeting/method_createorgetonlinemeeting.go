...
func (c OnlineMeetingClient) CreateOrGetOnlineMeeting(ctx context.Context, id stable.UserId, input CreateOrGetOnlineMeetingRequest) (result CreateOrGetOnlineMeetingOperationResponse, err error) {
