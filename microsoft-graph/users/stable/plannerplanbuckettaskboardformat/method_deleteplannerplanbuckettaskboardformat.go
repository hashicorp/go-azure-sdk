...
func (c PlannerPlanBucketTaskBoardFormatClient) DeletePlannerPlanBucketTaskBoardFormat(ctx context.Context, id stable.UserIdPlannerPlanIdBucketIdTaskId, options DeletePlannerPlanBucketTaskBoardFormatOperationOptions) (result DeletePlannerPlanBucketTaskBoardFormatOperationResponse, err error) {
