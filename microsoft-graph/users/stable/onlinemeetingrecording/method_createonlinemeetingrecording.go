...
func (c OnlineMeetingRecordingClient) CreateOnlineMeetingRecording(ctx context.Context, id stable.UserIdOnlineMeetingId, input stable.CallRecording) (result CreateOnlineMeetingRecordingOperationResponse, err error) {
