...
func (c OnlineMeetingRecordingClient) ListOnlineMeetingRecordings(ctx context.Context, id UserIdOnlineMeetingId) (result ListOnlineMeetingRecordingsOperationResponse, err error) {
...
func (c OnlineMeetingRecordingClient) ListOnlineMeetingRecordingsComplete(ctx context.Context, id UserIdOnlineMeetingId) (ListOnlineMeetingRecordingsCompleteResult, error) {
...
func (c OnlineMeetingRecordingClient) ListOnlineMeetingRecordingsCompleteMatchingPredicate(ctx context.Context, id UserIdOnlineMeetingId, predicate CallRecordingOperationPredicate) (result ListOnlineMeetingRecordingsCompleteResult, err error) {
