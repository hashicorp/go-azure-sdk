...
func (c CalendarEventAttachmentClient) GetCalendarEventAttachmentsCount(ctx context.Context, id stable.UserIdCalendarIdEventId, options GetCalendarEventAttachmentsCountOperationOptions) (result GetCalendarEventAttachmentsCountOperationResponse, err error) {
