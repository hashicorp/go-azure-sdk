...
// DeleteCalendarEventAttachment - Delete navigation property attachments for users
func (c CalendarEventAttachmentClient) DeleteCalendarEventAttachment(ctx context.Context, id stable.UserIdCalendarIdEventIdAttachmentId, options DeleteCalendarEventAttachmentOperationOptions) (result DeleteCalendarEventAttachmentOperationResponse, err error) {
