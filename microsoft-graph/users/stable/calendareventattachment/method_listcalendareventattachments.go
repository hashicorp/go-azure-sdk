...
func (c CalendarEventAttachmentClient) ListCalendarEventAttachments(ctx context.Context, id UserIdCalendarIdEventId) (result ListCalendarEventAttachmentsOperationResponse, err error) {
...
func (c CalendarEventAttachmentClient) ListCalendarEventAttachmentsComplete(ctx context.Context, id UserIdCalendarIdEventId) (ListCalendarEventAttachmentsCompleteResult, error) {
...
func (c CalendarEventAttachmentClient) ListCalendarEventAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarIdEventId, predicate AttachmentOperationPredicate) (result ListCalendarEventAttachmentsCompleteResult, err error) {
