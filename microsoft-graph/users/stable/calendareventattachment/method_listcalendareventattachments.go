...
// ListCalendarEventAttachments - Get attachments from users. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarEventAttachmentClient) ListCalendarEventAttachments(ctx context.Context, id stable.UserIdCalendarEventId, options ListCalendarEventAttachmentsOperationOptions) (result ListCalendarEventAttachmentsOperationResponse, err error) {
...
func (c CalendarEventAttachmentClient) ListCalendarEventAttachmentsComplete(ctx context.Context, id stable.UserIdCalendarEventId, options ListCalendarEventAttachmentsOperationOptions) (ListCalendarEventAttachmentsCompleteResult, error) {
...
func (c CalendarEventAttachmentClient) ListCalendarEventAttachmentsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdCalendarEventId, options ListCalendarEventAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarEventAttachmentsCompleteResult, err error) {
