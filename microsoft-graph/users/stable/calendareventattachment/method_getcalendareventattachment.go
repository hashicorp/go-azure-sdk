...
// GetCalendarEventAttachment - Get attachments from users. The collection of FileAttachment, ItemAttachment, and
// referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarEventAttachmentClient) GetCalendarEventAttachment(ctx context.Context, id stable.UserIdCalendarIdEventIdAttachmentId, options GetCalendarEventAttachmentOperationOptions) (result GetCalendarEventAttachmentOperationResponse, err error) {
