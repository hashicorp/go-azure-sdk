...
func (c CalendarEventAttachmentClient) CreateCalendarEventAttachmentsUploadSession(ctx context.Context, id stable.UserIdCalendarEventId, input CreateCalendarEventAttachmentsUploadSessionRequest) (result CreateCalendarEventAttachmentsUploadSessionOperationResponse, err error) {
