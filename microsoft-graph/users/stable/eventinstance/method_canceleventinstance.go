...
func (c EventInstanceClient) CancelEventInstance(ctx context.Context, id stable.UserIdEventIdInstanceId, input CancelEventInstanceRequest) (result CancelEventInstanceOperationResponse, err error) {
