...
func (c EventInstanceClient) TentativelyAcceptEventInstance(ctx context.Context, id stable.UserIdEventIdInstanceId, input TentativelyAcceptEventInstanceRequest) (result TentativelyAcceptEventInstanceOperationResponse, err error) {
