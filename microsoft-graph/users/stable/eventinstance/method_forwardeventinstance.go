...
// Outlook.com account.
func (c EventInstanceClient) ForwardEventInstance(ctx context.Context, id stable.UserIdEventIdInstanceId, input ForwardEventInstanceRequest) (result ForwardEventInstanceOperationResponse, err error) {
