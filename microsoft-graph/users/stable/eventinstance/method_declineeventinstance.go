...
func (c EventInstanceClient) DeclineEventInstance(ctx context.Context, id stable.UserIdEventIdInstanceId, input DeclineEventInstanceRequest) (result DeclineEventInstanceOperationResponse, err error) {
