...
// ListEventInstances ...
func (c EventInstanceClient) ListEventInstances(ctx context.Context, id UserIdEventId) (result ListEventInstancesOperationResponse, err error) {
...
func (c EventInstanceClient) ListEventInstancesComplete(ctx context.Context, id UserIdEventId) (ListEventInstancesCompleteResult, error) {
...
func (c EventInstanceClient) ListEventInstancesCompleteMatchingPredicate(ctx context.Context, id UserIdEventId, predicate EventOperationPredicate) (result ListEventInstancesCompleteResult, err error) {
