...
// in a user calendar.
func (c EventInstanceClient) DismissEventInstanceReminder(ctx context.Context, id stable.UserIdEventIdInstanceId) (result DismissEventInstanceReminderOperationResponse, err error) {
