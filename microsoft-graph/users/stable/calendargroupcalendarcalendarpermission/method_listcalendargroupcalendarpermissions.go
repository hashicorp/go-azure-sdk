...
// ListCalendarGroupCalendarPermissions - Get calendarPermissions from users. The permissions of the users with whom the
// calendar is shared.
func (c CalendarGroupCalendarCalendarPermissionClient) ListCalendarGroupCalendarPermissions(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarId, options ListCalendarGroupCalendarPermissionsOperationOptions) (result ListCalendarGroupCalendarPermissionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarCalendarPermissionClient) ListCalendarGroupCalendarPermissionsComplete(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarId, options ListCalendarGroupCalendarPermissionsOperationOptions) (ListCalendarGroupCalendarPermissionsCompleteResult, error) {
...
func (c CalendarGroupCalendarCalendarPermissionClient) ListCalendarGroupCalendarPermissionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarId, options ListCalendarGroupCalendarPermissionsOperationOptions, predicate CalendarPermissionOperationPredicate) (result ListCalendarGroupCalendarPermissionsCompleteResult, err error) {
