...
func (c CalendarGroupCalendarCalendarViewClient) GetCalendarGroupCalendarViewCount(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarId, options GetCalendarGroupCalendarViewCountOperationOptions) (result GetCalendarGroupCalendarViewCountOperationResponse, err error) {
