...
// GetCalendarGroupCalendarView - Get calendarView from users. The calendar view for the calendar. Navigation property.
// Read-only.
func (c CalendarGroupCalendarCalendarViewClient) GetCalendarGroupCalendarView(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarIdCalendarViewId, options GetCalendarGroupCalendarViewOperationOptions) (result GetCalendarGroupCalendarViewOperationResponse, err error) {
