...
type ForwardCalendarGroupCalendarViewOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

// ForwardCalendarGroupCalendarView - Invoke action forward. This action allows the organizer or attendee of a meeting
...
func (c CalendarGroupCalendarCalendarViewClient) ForwardCalendarGroupCalendarView(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarIdCalendarViewId, input ForwardCalendarGroupCalendarViewRequest) (result ForwardCalendarGroupCalendarViewOperationResponse, err error) {
