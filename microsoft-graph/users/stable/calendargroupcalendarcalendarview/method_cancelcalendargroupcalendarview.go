...
type CancelCalendarGroupCalendarViewOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

// CancelCalendarGroupCalendarView - Invoke action cancel. This action allows the organizer of a meeting to send a
...
func (c CalendarGroupCalendarCalendarViewClient) CancelCalendarGroupCalendarView(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarIdCalendarViewId, input CancelCalendarGroupCalendarViewRequest) (result CancelCalendarGroupCalendarViewOperationResponse, err error) {
