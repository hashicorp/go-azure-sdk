...
func (c TodoListTaskExtensionClient) CreateTodoListTaskExtension(ctx context.Context, id stable.UserIdTodoListIdTaskId, input stable.Extension) (result CreateTodoListTaskExtensionOperationResponse, err error) {
