...
func (c ContactFolderContactExtensionClient) CreateContactFolderContactExtension(ctx context.Context, id stable.UserIdContactFolderIdContactId, input stable.Extension) (result CreateContactFolderContactExtensionOperationResponse, err error) {
