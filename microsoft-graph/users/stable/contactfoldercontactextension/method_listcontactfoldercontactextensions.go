...
func (c ContactFolderContactExtensionClient) ListContactFolderContactExtensions(ctx context.Context, id UserIdContactFolderIdContactId) (result ListContactFolderContactExtensionsOperationResponse, err error) {
...
func (c ContactFolderContactExtensionClient) ListContactFolderContactExtensionsComplete(ctx context.Context, id UserIdContactFolderIdContactId) (ListContactFolderContactExtensionsCompleteResult, error) {
...
func (c ContactFolderContactExtensionClient) ListContactFolderContactExtensionsCompleteMatchingPredicate(ctx context.Context, id UserIdContactFolderIdContactId, predicate ExtensionOperationPredicate) (result ListContactFolderContactExtensionsCompleteResult, err error) {
