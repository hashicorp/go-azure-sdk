...
// GetJoinedTeamPrimaryChannelSharedWithTeam - Get team from users
func (c JoinedTeamPrimaryChannelSharedWithTeamTeamClient) GetJoinedTeamPrimaryChannelSharedWithTeam(ctx context.Context, id stable.UserIdJoinedTeamIdPrimaryChannelSharedWithTeamId, options GetJoinedTeamPrimaryChannelSharedWithTeamOperationOptions) (result GetJoinedTeamPrimaryChannelSharedWithTeamOperationResponse, err error) {
