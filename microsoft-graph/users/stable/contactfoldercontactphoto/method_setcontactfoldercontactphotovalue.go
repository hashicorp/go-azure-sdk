...
func (c ContactFolderContactPhotoClient) SetContactFolderContactPhotoValue(ctx context.Context, id stable.UserIdContactFolderIdContactId, input []byte) (result SetContactFolderContactPhotoValueOperationResponse, err error) {
