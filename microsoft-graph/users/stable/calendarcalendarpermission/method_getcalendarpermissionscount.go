...
func (c CalendarCalendarPermissionClient) GetCalendarPermissionsCount(ctx context.Context, id stable.UserIdCalendarId, options GetCalendarPermissionsCountOperationOptions) (result GetCalendarPermissionsCountOperationResponse, err error) {
