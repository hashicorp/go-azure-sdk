...
// ListCalendarPermissions - Get calendarPermissions from users. The permissions of the users with whom the calendar is
// shared.
func (c CalendarCalendarPermissionClient) ListCalendarPermissions(ctx context.Context, id stable.UserIdCalendarId, options ListCalendarPermissionsOperationOptions) (result ListCalendarPermissionsOperationResponse, err error) {
...
func (c CalendarCalendarPermissionClient) ListCalendarPermissionsComplete(ctx context.Context, id stable.UserIdCalendarId, options ListCalendarPermissionsOperationOptions) (ListCalendarPermissionsCompleteResult, error) {
...
func (c CalendarCalendarPermissionClient) ListCalendarPermissionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdCalendarId, options ListCalendarPermissionsOperationOptions, predicate CalendarPermissionOperationPredicate) (result ListCalendarPermissionsCompleteResult, err error) {
