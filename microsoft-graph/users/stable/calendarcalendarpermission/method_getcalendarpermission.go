...
// GetCalendarPermission - Get calendarPermissions from users. The permissions of the users with whom the calendar is
// shared.
func (c CalendarCalendarPermissionClient) GetCalendarPermission(ctx context.Context, id stable.UserIdCalendarIdCalendarPermissionId, options GetCalendarPermissionOperationOptions) (result GetCalendarPermissionOperationResponse, err error) {
