...
func (c ManagedDeviceLogCollectionRequestClient) CreateManagedDeviceLogCollectionRequestDownloadUrl(ctx context.Context, id stable.UserIdManagedDeviceIdLogCollectionRequestId) (result CreateManagedDeviceLogCollectionRequestDownloadUrlOperationResponse, err error) {
