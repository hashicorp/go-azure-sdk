...
## `github.com/hashicorp/go-azure-sdk/microsoft-graph/users/stable/manageddevicelogcollectionrequest` Documentation

The `manageddevicelogcollectionrequest` SDK allows for interaction with the Azure Resource Manager Service `users` (API Version `stable`).
...
```go
import "github.com/hashicorp/go-azure-sdk/microsoft-graph/users/stable/manageddevicelogcollectionrequest"
```
