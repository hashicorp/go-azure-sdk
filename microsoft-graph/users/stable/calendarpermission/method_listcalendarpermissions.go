...
// shared.
func (c CalendarPermissionClient) ListCalendarPermissions(ctx context.Context, id stable.UserIdCalendarId, options ListCalendarPermissionsOperationOptions) (result ListCalendarPermissionsOperationResponse, err error) {
...
func (c CalendarPermissionClient) ListCalendarPermissionsComplete(ctx context.Context, id stable.UserIdCalendarId, options ListCalendarPermissionsOperationOptions) (ListCalendarPermissionsCompleteResult, error) {
...
func (c CalendarPermissionClient) ListCalendarPermissionsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdCalendarId, options ListCalendarPermissionsOperationOptions, predicate CalendarPermissionOperationPredicate) (result ListCalendarPermissionsCompleteResult, err error) {
