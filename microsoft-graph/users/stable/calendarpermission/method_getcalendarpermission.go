...
// shared.
func (c CalendarPermissionClient) GetCalendarPermission(ctx context.Context, id stable.UserIdCalendarIdCalendarPermissionId, options GetCalendarPermissionOperationOptions) (result GetCalendarPermissionOperationResponse, err error) {
