...
func (c CalendarPermissionClient) GetCalendarPermissionsCount(ctx context.Context, id stable.UserId, options GetCalendarPermissionsCountOperationOptions) (result GetCalendarPermissionsCountOperationResponse, err error) {
