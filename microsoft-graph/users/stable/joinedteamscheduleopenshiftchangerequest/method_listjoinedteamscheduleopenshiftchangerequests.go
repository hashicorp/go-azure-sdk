...
func (c JoinedTeamScheduleOpenShiftChangeRequestClient) ListJoinedTeamScheduleOpenShiftChangeRequests(ctx context.Context, id UserIdJoinedTeamId) (result ListJoinedTeamScheduleOpenShiftChangeRequestsOperationResponse, err error) {
...
func (c JoinedTeamScheduleOpenShiftChangeRequestClient) ListJoinedTeamScheduleOpenShiftChangeRequestsComplete(ctx context.Context, id UserIdJoinedTeamId) (ListJoinedTeamScheduleOpenShiftChangeRequestsCompleteResult, error) {
...
func (c JoinedTeamScheduleOpenShiftChangeRequestClient) ListJoinedTeamScheduleOpenShiftChangeRequestsCompleteMatchingPredicate(ctx context.Context, id UserIdJoinedTeamId, predicate OpenShiftChangeRequestOperationPredicate) (result ListJoinedTeamScheduleOpenShiftChangeRequestsCompleteResult, err error) {
