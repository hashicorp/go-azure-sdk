...
func (c DriveRootAnalyticsClient) UpdateDriveRootAnalytic(ctx context.Context, id stable.UserIdDriveId, input stable.ItemAnalytics) (result UpdateDriveRootAnalyticOperationResponse, err error) {
