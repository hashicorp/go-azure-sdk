...
func (c TodoListTaskAttachmentClient) CreateTodoListTaskAttachment(ctx context.Context, id stable.UserIdTodoListIdTaskId, input stable.AttachmentBase) (result CreateTodoListTaskAttachmentOperationResponse, err error) {
