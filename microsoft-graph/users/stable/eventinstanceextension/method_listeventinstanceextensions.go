...
func (c EventInstanceExtensionClient) ListEventInstanceExtensions(ctx context.Context, id UserIdEventIdInstanceId) (result ListEventInstanceExtensionsOperationResponse, err error) {
...
func (c EventInstanceExtensionClient) ListEventInstanceExtensionsComplete(ctx context.Context, id UserIdEventIdInstanceId) (ListEventInstanceExtensionsCompleteResult, error) {
...
func (c EventInstanceExtensionClient) ListEventInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id UserIdEventIdInstanceId, predicate ExtensionOperationPredicate) (result ListEventInstanceExtensionsCompleteResult, err error) {
