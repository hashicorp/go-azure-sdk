...
func (c EventInstanceExtensionClient) CreateEventInstanceExtension(ctx context.Context, id stable.UserIdEventIdInstanceId, input stable.Extension) (result CreateEventInstanceExtensionOperationResponse, err error) {
