...
// ListJoinedTeamScheduleDayNotes - Get dayNotes from users. The day notes in the schedule.
func (c JoinedTeamScheduleDayNoteClient) ListJoinedTeamScheduleDayNotes(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamScheduleDayNotesOperationOptions) (result ListJoinedTeamScheduleDayNotesOperationResponse, err error) {
...
func (c JoinedTeamScheduleDayNoteClient) ListJoinedTeamScheduleDayNotesComplete(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamScheduleDayNotesOperationOptions) (ListJoinedTeamScheduleDayNotesCompleteResult, error) {
...
func (c JoinedTeamScheduleDayNoteClient) ListJoinedTeamScheduleDayNotesCompleteMatchingPredicate(ctx context.Context, id stable.UserIdJoinedTeamId, options ListJoinedTeamScheduleDayNotesOperationOptions, predicate DayNoteOperationPredicate) (result ListJoinedTeamScheduleDayNotesCompleteResult, err error) {
