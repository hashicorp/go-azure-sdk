...
// UpdateJoinedTeamScheduleDayNote - Update the navigation property dayNotes in users
func (c JoinedTeamScheduleDayNoteClient) UpdateJoinedTeamScheduleDayNote(ctx context.Context, id stable.UserIdJoinedTeamIdScheduleDayNoteId, input stable.DayNote, options UpdateJoinedTeamScheduleDayNoteOperationOptions) (result UpdateJoinedTeamScheduleDayNoteOperationResponse, err error) {
