...
func (c ContactFolderChildFolderContactClient) ListContactFolderChildFolderContacts(ctx context.Context, id UserIdContactFolderIdChildFolderId) (result ListContactFolderChildFolderContactsOperationResponse, err error) {
...
func (c ContactFolderChildFolderContactClient) ListContactFolderChildFolderContactsComplete(ctx context.Context, id UserIdContactFolderIdChildFolderId) (ListContactFolderChildFolderContactsCompleteResult, error) {
...
func (c ContactFolderChildFolderContactClient) ListContactFolderChildFolderContactsCompleteMatchingPredicate(ctx context.Context, id UserIdContactFolderIdChildFolderId, predicate ContactOperationPredicate) (result ListContactFolderChildFolderContactsCompleteResult, err error) {
