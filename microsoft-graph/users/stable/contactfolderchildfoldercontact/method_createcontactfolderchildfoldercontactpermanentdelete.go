...
func (c ContactFolderChildFolderContactClient) CreateContactFolderChildFolderContactPermanentDelete(ctx context.Context, id stable.UserIdContactFolderIdChildFolderIdContactId, options CreateContactFolderChildFolderContactPermanentDeleteOperationOptions) (result CreateContactFolderChildFolderContactPermanentDeleteOperationResponse, err error) {
