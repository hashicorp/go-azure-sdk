...
func (c ChatMessageReplyClient) ListChatMessageReplies(ctx context.Context, id UserIdChatIdMessageId) (result ListChatMessageRepliesOperationResponse, err error) {
...
func (c ChatMessageReplyClient) ListChatMessageRepliesComplete(ctx context.Context, id UserIdChatIdMessageId) (ListChatMessageRepliesCompleteResult, error) {
...
func (c ChatMessageReplyClient) ListChatMessageRepliesCompleteMatchingPredicate(ctx context.Context, id UserIdChatIdMessageId, predicate ChatMessageOperationPredicate) (result ListChatMessageRepliesCompleteResult, err error) {
