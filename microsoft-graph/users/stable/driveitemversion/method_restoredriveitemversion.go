...
func (c DriveItemVersionClient) RestoreDriveItemVersion(ctx context.Context, id stable.UserIdDriveIdItemIdVersionId) (result RestoreDriveItemVersionOperationResponse, err error) {
