...
func (c PlannerPlanTaskDetailClient) GetPlannerPlanTaskDetail(ctx context.Context, id UserIdPlannerPlanIdTaskId) (result GetPlannerPlanTaskDetailOperationResponse, err error) {
