...
func (c DriveListColumnClient) CreateDriveListColumn(ctx context.Context, id stable.UserIdDriveId, input stable.ColumnDefinition) (result CreateDriveListColumnOperationResponse, err error) {
