...
func (c CalendarEventClient) GetCalendarEventsCount(ctx context.Context, id stable.UserId, options GetCalendarEventsCountOperationOptions) (result GetCalendarEventsCountOperationResponse, err error) {
