...
// a new time.
func (c CalendarEventClient) SnoozeCalendarEventReminder(ctx context.Context, id stable.UserIdCalendarEventId, input SnoozeCalendarEventReminderRequest) (result SnoozeCalendarEventReminderOperationResponse, err error) {
