...
// Outlook.com account.
func (c CalendarEventClient) ForwardCalendarEvent(ctx context.Context, id stable.UserIdCalendarEventId, input ForwardCalendarEventRequest) (result ForwardCalendarEventOperationResponse, err error) {
