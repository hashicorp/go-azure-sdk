...
func (c CalendarEventClient) TentativelyAcceptCalendarEvent(ctx context.Context, id stable.UserIdCalendarEventId, input TentativelyAcceptCalendarEventRequest) (result TentativelyAcceptCalendarEventOperationResponse, err error) {
