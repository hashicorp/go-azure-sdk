...
func (c CalendarEventClient) DeclineCalendarEvent(ctx context.Context, id stable.UserIdCalendarIdEventId, input DeclineCalendarEventRequest) (result DeclineCalendarEventOperationResponse, err error) {
