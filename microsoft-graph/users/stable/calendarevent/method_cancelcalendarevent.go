...
func (c CalendarEventClient) CancelCalendarEvent(ctx context.Context, id stable.UserIdCalendarEventId, input CancelCalendarEventRequest) (result CancelCalendarEventOperationResponse, err error) {
