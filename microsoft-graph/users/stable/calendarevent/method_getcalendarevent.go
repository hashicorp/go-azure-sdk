...
func (c CalendarEventClient) GetCalendarEvent(ctx context.Context, id stable.UserIdCalendarEventId, options GetCalendarEventOperationOptions) (result GetCalendarEventOperationResponse, err error) {
