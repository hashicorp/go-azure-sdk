...
func (c CalendarEventClient) DeleteCalendarEvent(ctx context.Context, id stable.UserIdCalendarEventId, options DeleteCalendarEventOperationOptions) (result DeleteCalendarEventOperationResponse, err error) {
