...
// represents a file.
func (c DriveBundleContentClient) SetDriveBundleContent(ctx context.Context, id stable.UserIdDriveIdBundleId, input []byte) (result SetDriveBundleContentOperationResponse, err error) {
