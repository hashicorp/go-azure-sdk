...
func (c DriveListContentTypeColumnLinkClient) CreateDriveListContentTypeColumnLink(ctx context.Context, id stable.UserIdDriveIdListContentTypeId, input stable.ColumnLink) (result CreateDriveListContentTypeColumnLinkOperationResponse, err error) {
