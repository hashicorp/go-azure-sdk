...
func (c CalendarGroupCalendarClient) GetCalendarGroupCalendarSchedules(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarId, input GetCalendarGroupCalendarSchedulesRequest, options GetCalendarGroupCalendarSchedulesOperationOptions) (result GetCalendarGroupCalendarSchedulesOperationResponse, err error) {
...
func (c CalendarGroupCalendarClient) GetCalendarGroupCalendarSchedulesComplete(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarId, input GetCalendarGroupCalendarSchedulesRequest, options GetCalendarGroupCalendarSchedulesOperationOptions) (GetCalendarGroupCalendarSchedulesCompleteResult, error) {
...
func (c CalendarGroupCalendarClient) GetCalendarGroupCalendarSchedulesCompleteMatchingPredicate(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarId, input GetCalendarGroupCalendarSchedulesRequest, options GetCalendarGroupCalendarSchedulesOperationOptions, predicate ScheduleInformationOperationPredicate) (result GetCalendarGroupCalendarSchedulesCompleteResult, err error) {
