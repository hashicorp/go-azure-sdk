...
// DeleteCalendarGroupCalendar - Delete navigation property calendars for users
func (c CalendarGroupCalendarClient) DeleteCalendarGroupCalendar(ctx context.Context, id stable.UserIdCalendarGroupIdCalendarId, options DeleteCalendarGroupCalendarOperationOptions) (result DeleteCalendarGroupCalendarOperationResponse, err error) {
