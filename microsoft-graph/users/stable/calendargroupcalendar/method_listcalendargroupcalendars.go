...
// Read-only. Nullable.
func (c CalendarGroupCalendarClient) ListCalendarGroupCalendars(ctx context.Context, id stable.UserIdCalendarGroupId, options ListCalendarGroupCalendarsOperationOptions) (result ListCalendarGroupCalendarsOperationResponse, err error) {
...
func (c CalendarGroupCalendarClient) ListCalendarGroupCalendarsComplete(ctx context.Context, id stable.UserIdCalendarGroupId, options ListCalendarGroupCalendarsOperationOptions) (ListCalendarGroupCalendarsCompleteResult, error) {
...
func (c CalendarGroupCalendarClient) ListCalendarGroupCalendarsCompleteMatchingPredicate(ctx context.Context, id stable.UserIdCalendarGroupId, options ListCalendarGroupCalendarsOperationOptions, predicate CalendarOperationPredicate) (result ListCalendarGroupCalendarsCompleteResult, err error) {
