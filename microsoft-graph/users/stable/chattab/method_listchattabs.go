...
// ListChatTabs ...
func (c ChatTabClient) ListChatTabs(ctx context.Context, id UserIdChatId) (result ListChatTabsOperationResponse, err error) {
...
func (c ChatTabClient) ListChatTabsComplete(ctx context.Context, id UserIdChatId) (ListChatTabsCompleteResult, error) {
...
func (c ChatTabClient) ListChatTabsCompleteMatchingPredicate(ctx context.Context, id UserIdChatId, predicate TeamsTabOperationPredicate) (result ListChatTabsCompleteResult, err error) {
