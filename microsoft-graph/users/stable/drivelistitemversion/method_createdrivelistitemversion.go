...
func (c DriveListItemVersionClient) CreateDriveListItemVersion(ctx context.Context, id stable.UserIdDriveIdListItemId, input stable.ListItemVersion) (result CreateDriveListItemVersionOperationResponse, err error) {
