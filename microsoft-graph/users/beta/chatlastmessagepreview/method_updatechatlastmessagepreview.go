...
func (c ChatLastMessagePreviewClient) UpdateChatLastMessagePreview(ctx context.Context, id beta.UserIdChatId, input beta.ChatMessageInfo) (result UpdateChatLastMessagePreviewOperationResponse, err error) {
