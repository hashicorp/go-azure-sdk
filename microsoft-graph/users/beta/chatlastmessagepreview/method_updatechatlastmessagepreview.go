...
func (c ChatLastMessagePreviewClient) UpdateChatLastMessagePreview(ctx context.Context, id UserIdChatId, input beta.ChatMessageInfo) (result UpdateChatLastMessagePreviewOperationResponse, err error) {
