...
func (c DriveListSubscriptionClient) CreateDriveListSubscriptionReauthorize(ctx context.Context, id beta.UserIdDriveIdListSubscriptionId) (result CreateDriveListSubscriptionReauthorizeOperationResponse, err error) {
