...
func (c DriveListSubscriptionClient) CreateDriveListSubscription(ctx context.Context, id beta.UserIdDriveId, input beta.Subscription) (result CreateDriveListSubscriptionOperationResponse, err error) {
