...
// GetCalendarEventExceptionOccurrenceAttachment - Get attachments from users. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarEventExceptionOccurrenceAttachmentClient) GetCalendarEventExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceIdAttachmentId, options GetCalendarEventExceptionOccurrenceAttachmentOperationOptions) (result GetCalendarEventExceptionOccurrenceAttachmentOperationResponse, err error) {
