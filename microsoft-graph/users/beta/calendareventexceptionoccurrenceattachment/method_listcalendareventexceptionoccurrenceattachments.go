...
// ListCalendarEventExceptionOccurrenceAttachments - Get attachments from users. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarEventExceptionOccurrenceAttachmentClient) ListCalendarEventExceptionOccurrenceAttachments(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceId, options ListCalendarEventExceptionOccurrenceAttachmentsOperationOptions) (result ListCalendarEventExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceAttachmentClient) ListCalendarEventExceptionOccurrenceAttachmentsComplete(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceId, options ListCalendarEventExceptionOccurrenceAttachmentsOperationOptions) (ListCalendarEventExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c CalendarEventExceptionOccurrenceAttachmentClient) ListCalendarEventExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceId, options ListCalendarEventExceptionOccurrenceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarEventExceptionOccurrenceAttachmentsCompleteResult, err error) {
