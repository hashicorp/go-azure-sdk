...
func (c CalendarEventExceptionOccurrenceAttachmentClient) ListCalendarEventExceptionOccurrenceAttachments(ctx context.Context, id UserIdCalendarIdEventIdExceptionOccurrenceId) (result ListCalendarEventExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceAttachmentClient) ListCalendarEventExceptionOccurrenceAttachmentsComplete(ctx context.Context, id UserIdCalendarIdEventIdExceptionOccurrenceId) (ListCalendarEventExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c CalendarEventExceptionOccurrenceAttachmentClient) ListCalendarEventExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarIdEventIdExceptionOccurrenceId, predicate AttachmentOperationPredicate) (result ListCalendarEventExceptionOccurrenceAttachmentsCompleteResult, err error) {
