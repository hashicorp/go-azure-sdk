...
func (c CalendarEventExceptionOccurrenceAttachmentClient) CreateCalendarEventExceptionOccurrenceAttachmentsUploadSession(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceId, input CreateCalendarEventExceptionOccurrenceAttachmentsUploadSessionRequest) (result CreateCalendarEventExceptionOccurrenceAttachmentsUploadSessionOperationResponse, err error) {
