...
func (c CalendarCalendarViewInstanceAttachmentClient) GetCalendarViewInstanceAttachmentsCount(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdInstanceId, options GetCalendarViewInstanceAttachmentsCountOperationOptions) (result GetCalendarViewInstanceAttachmentsCountOperationResponse, err error) {
