...
// DeleteCalendarViewInstanceAttachment - Delete navigation property attachments for users
func (c CalendarCalendarViewInstanceAttachmentClient) DeleteCalendarViewInstanceAttachment(ctx context.Context, id beta.UserIdCalendarCalendarViewIdInstanceIdAttachmentId, options DeleteCalendarViewInstanceAttachmentOperationOptions) (result DeleteCalendarViewInstanceAttachmentOperationResponse, err error) {
