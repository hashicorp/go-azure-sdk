...
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarCalendarViewInstanceAttachments(ctx context.Context, id UserIdCalendarIdCalendarViewIdInstanceId) (result ListCalendarCalendarViewInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarCalendarViewInstanceAttachmentsComplete(ctx context.Context, id UserIdCalendarIdCalendarViewIdInstanceId) (ListCalendarCalendarViewInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceAttachmentClient) ListCalendarCalendarViewInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarIdCalendarViewIdInstanceId, predicate AttachmentOperationPredicate) (result ListCalendarCalendarViewInstanceAttachmentsCompleteResult, err error) {
