...
func (c EventAttachmentClient) CreateEventAttachmentsUploadSession(ctx context.Context, id beta.UserIdEventId, input CreateEventAttachmentsUploadSessionRequest) (result CreateEventAttachmentsUploadSessionOperationResponse, err error) {
