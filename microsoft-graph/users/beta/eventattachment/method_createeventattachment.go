...
func (c EventAttachmentClient) CreateEventAttachment(ctx context.Context, id beta.UserIdEventId, input beta.Attachment) (result CreateEventAttachmentOperationResponse, err error) {
