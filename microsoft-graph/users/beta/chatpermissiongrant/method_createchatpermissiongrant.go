...
func (c ChatPermissionGrantClient) CreateChatPermissionGrant(ctx context.Context, id beta.UserIdChatId, input beta.ResourceSpecificPermissionGrant) (result CreateChatPermissionGrantOperationResponse, err error) {
