...
func (c ManagedDeviceDeviceHealthScriptStateClient) ListManagedDeviceDeviceHealthScriptStates(ctx context.Context, id UserIdManagedDeviceId) (result ListManagedDeviceDeviceHealthScriptStatesOperationResponse, err error) {
...
func (c ManagedDeviceDeviceHealthScriptStateClient) ListManagedDeviceDeviceHealthScriptStatesComplete(ctx context.Context, id UserIdManagedDeviceId) (ListManagedDeviceDeviceHealthScriptStatesCompleteResult, error) {
...
func (c ManagedDeviceDeviceHealthScriptStateClient) ListManagedDeviceDeviceHealthScriptStatesCompleteMatchingPredicate(ctx context.Context, id UserIdManagedDeviceId, predicate DeviceHealthScriptPolicyStateOperationPredicate) (result ListManagedDeviceDeviceHealthScriptStatesCompleteResult, err error) {
