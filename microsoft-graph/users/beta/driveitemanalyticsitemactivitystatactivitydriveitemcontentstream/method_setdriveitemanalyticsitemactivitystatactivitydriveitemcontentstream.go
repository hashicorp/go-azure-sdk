...
func (c DriveItemAnalyticsItemActivityStatActivityDriveItemContentStreamClient) SetDriveItemAnalyticsItemActivityStatActivityDriveItemContentStream(ctx context.Context, id beta.UserIdDriveIdItemIdAnalyticsItemActivityStatIdActivityId, input []byte) (result SetDriveItemAnalyticsItemActivityStatActivityDriveItemContentStreamOperationResponse, err error) {
