...
func (c CalendarViewAttachmentClient) GetCalendarViewAttachment(ctx context.Context, id beta.UserIdCalendarViewIdAttachmentId, options GetCalendarViewAttachmentOperationOptions) (result GetCalendarViewAttachmentOperationResponse, err error) {
