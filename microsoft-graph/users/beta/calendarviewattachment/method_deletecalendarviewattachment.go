...
func (c CalendarViewAttachmentClient) DeleteCalendarViewAttachment(ctx context.Context, id beta.UserIdCalendarViewIdAttachmentId, options DeleteCalendarViewAttachmentOperationOptions) (result DeleteCalendarViewAttachmentOperationResponse, err error) {
