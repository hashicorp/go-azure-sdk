...
func (c CalendarViewAttachmentClient) GetCalendarViewAttachmentsCount(ctx context.Context, id beta.UserIdCalendarViewId, options GetCalendarViewAttachmentsCountOperationOptions) (result GetCalendarViewAttachmentsCountOperationResponse, err error) {
