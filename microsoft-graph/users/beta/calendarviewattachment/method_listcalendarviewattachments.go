...
func (c CalendarViewAttachmentClient) ListCalendarViewAttachments(ctx context.Context, id UserIdCalendarViewId) (result ListCalendarViewAttachmentsOperationResponse, err error) {
...
func (c CalendarViewAttachmentClient) ListCalendarViewAttachmentsComplete(ctx context.Context, id UserIdCalendarViewId) (ListCalendarViewAttachmentsCompleteResult, error) {
...
func (c CalendarViewAttachmentClient) ListCalendarViewAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarViewId, predicate AttachmentOperationPredicate) (result ListCalendarViewAttachmentsCompleteResult, err error) {
