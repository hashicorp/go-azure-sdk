...
func (c CalendarViewAttachmentClient) CreateCalendarViewAttachmentsUploadSession(ctx context.Context, id beta.UserIdCalendarViewId, input CreateCalendarViewAttachmentsUploadSessionRequest) (result CreateCalendarViewAttachmentsUploadSessionOperationResponse, err error) {
