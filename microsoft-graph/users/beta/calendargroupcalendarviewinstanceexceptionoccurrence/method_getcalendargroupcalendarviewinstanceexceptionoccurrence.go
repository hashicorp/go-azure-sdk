...
// GetCalendarGroupCalendarViewInstanceExceptionOccurrence - Get exceptionOccurrences from users
func (c CalendarGroupCalendarViewInstanceExceptionOccurrenceClient) GetCalendarGroupCalendarViewInstanceExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId, options GetCalendarGroupCalendarViewInstanceExceptionOccurrenceOperationOptions) (result GetCalendarGroupCalendarViewInstanceExceptionOccurrenceOperationResponse, err error) {
