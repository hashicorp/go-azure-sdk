...
func (c MailFolderChildFolderMessageAttachmentClient) CreateMailFolderChildFolderMessageAttachment(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, input beta.Attachment) (result CreateMailFolderChildFolderMessageAttachmentOperationResponse, err error) {
