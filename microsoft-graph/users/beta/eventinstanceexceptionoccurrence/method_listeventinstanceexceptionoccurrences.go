...
func (c EventInstanceExceptionOccurrenceClient) ListEventInstanceExceptionOccurrences(ctx context.Context, id UserIdEventIdInstanceId) (result ListEventInstanceExceptionOccurrencesOperationResponse, err error) {
...
func (c EventInstanceExceptionOccurrenceClient) ListEventInstanceExceptionOccurrencesComplete(ctx context.Context, id UserIdEventIdInstanceId) (ListEventInstanceExceptionOccurrencesCompleteResult, error) {
...
func (c EventInstanceExceptionOccurrenceClient) ListEventInstanceExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id UserIdEventIdInstanceId, predicate EventOperationPredicate) (result ListEventInstanceExceptionOccurrencesCompleteResult, err error) {
