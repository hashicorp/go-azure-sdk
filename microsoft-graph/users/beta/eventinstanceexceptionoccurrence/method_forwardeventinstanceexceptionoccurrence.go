...
func (c EventInstanceExceptionOccurrenceClient) ForwardEventInstanceExceptionOccurrence(ctx context.Context, id beta.UserIdEventIdInstanceIdExceptionOccurrenceId, input ForwardEventInstanceExceptionOccurrenceRequest) (result ForwardEventInstanceExceptionOccurrenceOperationResponse, err error) {
