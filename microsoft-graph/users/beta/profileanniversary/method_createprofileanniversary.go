...
func (c ProfileAnniversaryClient) CreateProfileAnniversary(ctx context.Context, id beta.UserId, input beta.PersonAnnualEvent) (result CreateProfileAnniversaryOperationResponse, err error) {
