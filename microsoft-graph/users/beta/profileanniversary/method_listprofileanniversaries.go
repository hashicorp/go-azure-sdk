...
// ListProfileAnniversaries ...
func (c ProfileAnniversaryClient) ListProfileAnniversaries(ctx context.Context, id UserId) (result ListProfileAnniversariesOperationResponse, err error) {
...
func (c ProfileAnniversaryClient) ListProfileAnniversariesComplete(ctx context.Context, id UserId) (ListProfileAnniversariesCompleteResult, error) {
	return c.ListProfileAnniversariesCompleteMatchingPredicate(ctx, id, PersonAnnualEventOperationPredicate{})
}

// ListProfileAnniversariesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileAnniversaryClient) ListProfileAnniversariesCompleteMatchingPredicate(ctx context.Context, id UserId, predicate PersonAnnualEventOperationPredicate) (result ListProfileAnniversariesCompleteResult, err error) {
	items := make([]beta.PersonAnnualEvent, 0)

	resp, err := c.ListProfileAnniversaries(ctx, id)
	if err != nil {
