...
func TestNewUserManagedDeviceDeviceConfigurationStateID(t *testing.T) {
	id := NewUserManagedDeviceDeviceConfigurationStateID("userIdValue", "managedDeviceIdValue", "deviceConfigurationStateIdValue")
...
func TestFormatUserManagedDeviceDeviceConfigurationStateID(t *testing.T) {
	actual := NewUserManagedDeviceDeviceConfigurationStateID("userIdValue", "managedDeviceIdValue", "deviceConfigurationStateIdValue").ID()
...
func TestParseUserManagedDeviceDeviceConfigurationStateID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserManagedDeviceDeviceConfigurationStateId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserManagedDeviceDeviceConfigurationStateID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserManagedDeviceDeviceConfigurationStateIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserManagedDeviceDeviceConfigurationStateId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserManagedDeviceDeviceConfigurationStateIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserManagedDeviceDeviceConfigurationStateId(t *testing.T) {
	segments := UserManagedDeviceDeviceConfigurationStateId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserManagedDeviceDeviceConfigurationStateId has no segments")
	}
