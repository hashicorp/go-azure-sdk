...
func (c AuthenticationHardwareOathMethodDeviceAssignToServiceProvisioningErrorClient) ListAuthenticationHardwareOathMethodDeviceAssignToServiceProvisioningErrors(ctx context.Context, id beta.UserIdAuthenticationHardwareOathMethodId, options ListAuthenticationHardwareOathMethodDeviceAssignToServiceProvisioningErrorsOperationOptions) (result ListAuthenticationHardwareOathMethodDeviceAssignToServiceProvisioningErrorsOperationResponse, err error) {
