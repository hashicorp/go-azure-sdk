...
func (c OnlineMeetingAttendeeReportClient) GetOnlineMeetingAttendeeReport(ctx context.Context, id beta.UserIdOnlineMeetingId) (result GetOnlineMeetingAttendeeReportOperationResponse, err error) {
