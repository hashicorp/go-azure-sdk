...
// ListInformationProtectionThreatAssessmentRequestResults ...
func (c InformationProtectionThreatAssessmentRequestResultClient) ListInformationProtectionThreatAssessmentRequestResults(ctx context.Context, id UserIdInformationProtectionThreatAssessmentRequestId) (result ListInformationProtectionThreatAssessmentRequestResultsOperationResponse, err error) {
...
func (c InformationProtectionThreatAssessmentRequestResultClient) ListInformationProtectionThreatAssessmentRequestResultsComplete(ctx context.Context, id UserIdInformationProtectionThreatAssessmentRequestId) (ListInformationProtectionThreatAssessmentRequestResultsCompleteResult, error) {
	return c.ListInformationProtectionThreatAssessmentRequestResultsCompleteMatchingPredicate(ctx, id, ThreatAssessmentResultOperationPredicate{})
}
