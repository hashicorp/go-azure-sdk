...
func TestNewUserCalendarEventExceptionOccurrenceExtensionID(t *testing.T) {
	id := NewUserCalendarEventExceptionOccurrenceExtensionID("userIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "extensionIdValue")
...
func TestFormatUserCalendarEventExceptionOccurrenceExtensionID(t *testing.T) {
	actual := NewUserCalendarEventExceptionOccurrenceExtensionID("userIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "extensionIdValue").ID()
...
func TestParseUserCalendarEventExceptionOccurrenceExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarEventExceptionOccurrenceExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarEventExceptionOccurrenceExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarEventExceptionOccurrenceExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarEventExceptionOccurrenceExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarEventExceptionOccurrenceExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarEventExceptionOccurrenceExtensionId(t *testing.T) {
	segments := UserCalendarEventExceptionOccurrenceExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarEventExceptionOccurrenceExtensionId has no segments")
	}
