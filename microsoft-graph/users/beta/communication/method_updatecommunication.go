...
// UpdateCommunication - Update the navigation property communications in users
func (c CommunicationClient) UpdateCommunication(ctx context.Context, id beta.UserId, input beta.UserCloudCommunication, options UpdateCommunicationOperationOptions) (result UpdateCommunicationOperationResponse, err error) {
