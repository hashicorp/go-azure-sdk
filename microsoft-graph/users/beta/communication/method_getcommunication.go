...
// GetCommunication - Get communications from users. The user's communications settings on Teams.
func (c CommunicationClient) GetCommunication(ctx context.Context, id beta.UserId, options GetCommunicationOperationOptions) (result GetCommunicationOperationResponse, err error) {
