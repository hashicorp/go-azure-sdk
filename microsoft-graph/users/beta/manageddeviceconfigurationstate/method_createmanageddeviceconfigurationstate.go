...
func (c ManagedDeviceConfigurationStateClient) CreateManagedDeviceConfigurationState(ctx context.Context, id beta.UserIdManagedDeviceId, input beta.DeviceConfigurationState) (result CreateManagedDeviceConfigurationStateOperationResponse, err error) {
