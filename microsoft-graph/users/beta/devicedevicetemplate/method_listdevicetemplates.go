...
// ListDeviceTemplates - Get deviceTemplate from users. Device template used to instantiate this device. Nullable.
// Read-only.
func (c DeviceDeviceTemplateClient) ListDeviceTemplates(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceTemplatesOperationOptions) (result ListDeviceTemplatesOperationResponse, err error) {
...
func (c DeviceDeviceTemplateClient) ListDeviceTemplatesComplete(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceTemplatesOperationOptions) (ListDeviceTemplatesCompleteResult, error) {
...
func (c DeviceDeviceTemplateClient) ListDeviceTemplatesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceTemplatesOperationOptions, predicate DeviceTemplateOperationPredicate) (result ListDeviceTemplatesCompleteResult, err error) {
