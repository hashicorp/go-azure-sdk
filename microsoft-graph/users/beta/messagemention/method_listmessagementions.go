...
// ListMessageMentions ...
func (c MessageMentionClient) ListMessageMentions(ctx context.Context, id UserIdMessageId) (result ListMessageMentionsOperationResponse, err error) {
...
func (c MessageMentionClient) ListMessageMentionsComplete(ctx context.Context, id UserIdMessageId) (ListMessageMentionsCompleteResult, error) {
...
func (c MessageMentionClient) ListMessageMentionsCompleteMatchingPredicate(ctx context.Context, id UserIdMessageId, predicate MentionOperationPredicate) (result ListMessageMentionsCompleteResult, err error) {
