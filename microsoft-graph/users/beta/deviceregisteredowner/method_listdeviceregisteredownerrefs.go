...
func (c DeviceRegisteredOwnerClient) ListDeviceRegisteredOwnerRefs(ctx context.Context, id UserIdDeviceId) (result ListDeviceRegisteredOwnerRefsOperationResponse, err error) {
...
func (c DeviceRegisteredOwnerClient) ListDeviceRegisteredOwnerRefsComplete(ctx context.Context, id UserIdDeviceId) (result ListDeviceRegisteredOwnerRefsCompleteResult, err error) {
	items := make([]string, 0)
