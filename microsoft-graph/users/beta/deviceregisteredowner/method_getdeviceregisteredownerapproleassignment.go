...
func (c DeviceRegisteredOwnerClient) GetDeviceRegisteredOwnerAppRoleAssignment(ctx context.Context, id beta.UserIdDeviceIdRegisteredOwnerId, options GetDeviceRegisteredOwnerAppRoleAssignmentOperationOptions) (result GetDeviceRegisteredOwnerAppRoleAssignmentOperationResponse, err error) {
