...
func TestNewUserInformationProtectionBitlockerRecoveryKeyID(t *testing.T) {
	id := NewUserInformationProtectionBitlockerRecoveryKeyID("userIdValue", "bitlockerRecoveryKeyIdValue")
...
func TestFormatUserInformationProtectionBitlockerRecoveryKeyID(t *testing.T) {
	actual := NewUserInformationProtectionBitlockerRecoveryKeyID("userIdValue", "bitlockerRecoveryKeyIdValue").ID()
...
func TestParseUserInformationProtectionBitlockerRecoveryKeyID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserInformationProtectionBitlockerRecoveryKeyId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserInformationProtectionBitlockerRecoveryKeyID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserInformationProtectionBitlockerRecoveryKeyIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserInformationProtectionBitlockerRecoveryKeyId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserInformationProtectionBitlockerRecoveryKeyIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserInformationProtectionBitlockerRecoveryKeyId(t *testing.T) {
	segments := UserInformationProtectionBitlockerRecoveryKeyId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserInformationProtectionBitlockerRecoveryKeyId has no segments")
	}
