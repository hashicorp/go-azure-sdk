...
func (c MailFolderMessageAttachmentClient) CreateMailFolderMessageAttachmentsUploadSession(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input CreateMailFolderMessageAttachmentsUploadSessionRequest) (result CreateMailFolderMessageAttachmentsUploadSessionOperationResponse, err error) {
