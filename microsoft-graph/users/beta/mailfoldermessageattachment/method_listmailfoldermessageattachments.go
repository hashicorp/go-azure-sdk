...
func (c MailFolderMessageAttachmentClient) ListMailFolderMessageAttachments(ctx context.Context, id UserIdMailFolderIdMessageId) (result ListMailFolderMessageAttachmentsOperationResponse, err error) {
...
func (c MailFolderMessageAttachmentClient) ListMailFolderMessageAttachmentsComplete(ctx context.Context, id UserIdMailFolderIdMessageId) (ListMailFolderMessageAttachmentsCompleteResult, error) {
...
func (c MailFolderMessageAttachmentClient) ListMailFolderMessageAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdMailFolderIdMessageId, predicate AttachmentOperationPredicate) (result ListMailFolderMessageAttachmentsCompleteResult, err error) {
