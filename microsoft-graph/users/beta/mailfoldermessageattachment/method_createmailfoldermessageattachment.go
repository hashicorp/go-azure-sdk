...
func (c MailFolderMessageAttachmentClient) CreateMailFolderMessageAttachment(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input beta.Attachment) (result CreateMailFolderMessageAttachmentOperationResponse, err error) {
