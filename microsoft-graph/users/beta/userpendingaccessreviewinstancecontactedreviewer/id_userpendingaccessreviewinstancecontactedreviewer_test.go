...
func TestNewUserPendingAccessReviewInstanceContactedReviewerID(t *testing.T) {
	id := NewUserPendingAccessReviewInstanceContactedReviewerID("userIdValue", "accessReviewInstanceIdValue", "accessReviewReviewerIdValue")
...
func TestFormatUserPendingAccessReviewInstanceContactedReviewerID(t *testing.T) {
	actual := NewUserPendingAccessReviewInstanceContactedReviewerID("userIdValue", "accessReviewInstanceIdValue", "accessReviewReviewerIdValue").ID()
...
func TestParseUserPendingAccessReviewInstanceContactedReviewerID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceContactedReviewerId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceContactedReviewerID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserPendingAccessReviewInstanceContactedReviewerIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceContactedReviewerId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceContactedReviewerIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserPendingAccessReviewInstanceContactedReviewerId(t *testing.T) {
	segments := UserPendingAccessReviewInstanceContactedReviewerId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserPendingAccessReviewInstanceContactedReviewerId has no segments")
	}
