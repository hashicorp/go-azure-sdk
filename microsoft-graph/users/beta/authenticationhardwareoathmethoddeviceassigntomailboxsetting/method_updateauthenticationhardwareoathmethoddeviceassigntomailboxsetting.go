...
func (c AuthenticationHardwareOathMethodDeviceAssignToMailboxSettingClient) UpdateAuthenticationHardwareOathMethodDeviceAssignToMailboxSetting(ctx context.Context, id beta.UserIdAuthenticationHardwareOathMethodId, input beta.MailboxSettings, options UpdateAuthenticationHardwareOathMethodDeviceAssignToMailboxSettingOperationOptions) (result UpdateAuthenticationHardwareOathMethodDeviceAssignToMailboxSettingOperationResponse, err error) {
