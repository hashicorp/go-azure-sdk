...
func TestNewUserScopedRoleMemberOfID(t *testing.T) {
	id := NewUserScopedRoleMemberOfID("userIdValue", "scopedRoleMembershipIdValue")
...
func TestFormatUserScopedRoleMemberOfID(t *testing.T) {
	actual := NewUserScopedRoleMemberOfID("userIdValue", "scopedRoleMembershipIdValue").ID()
...
func TestParseUserScopedRoleMemberOfID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserScopedRoleMemberOfId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserScopedRoleMemberOfID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserScopedRoleMemberOfIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserScopedRoleMemberOfId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserScopedRoleMemberOfIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserScopedRoleMemberOfId(t *testing.T) {
	segments := UserScopedRoleMemberOfId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserScopedRoleMemberOfId has no segments")
	}
