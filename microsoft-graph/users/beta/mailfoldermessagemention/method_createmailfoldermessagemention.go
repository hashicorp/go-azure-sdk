...
func (c MailFolderMessageMentionClient) CreateMailFolderMessageMention(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input beta.Mention) (result CreateMailFolderMessageMentionOperationResponse, err error) {
