...
// DeleteCalendarViewAttachment - Delete navigation property attachments for users
func (c CalendarCalendarViewAttachmentClient) DeleteCalendarViewAttachment(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdAttachmentId, options DeleteCalendarViewAttachmentOperationOptions) (result DeleteCalendarViewAttachmentOperationResponse, err error) {
