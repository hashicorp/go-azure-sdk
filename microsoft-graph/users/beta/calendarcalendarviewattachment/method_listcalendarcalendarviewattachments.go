...
func (c CalendarCalendarViewAttachmentClient) ListCalendarCalendarViewAttachments(ctx context.Context, id UserIdCalendarCalendarViewId) (result ListCalendarCalendarViewAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewAttachmentClient) ListCalendarCalendarViewAttachmentsComplete(ctx context.Context, id UserIdCalendarCalendarViewId) (ListCalendarCalendarViewAttachmentsCompleteResult, error) {
...
func (c CalendarCalendarViewAttachmentClient) ListCalendarCalendarViewAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarCalendarViewId, predicate AttachmentOperationPredicate) (result ListCalendarCalendarViewAttachmentsCompleteResult, err error) {
