...
func (c CalendarCalendarViewAttachmentClient) CreateCalendarViewAttachmentsUploadSession(ctx context.Context, id beta.UserIdCalendarIdCalendarViewId, input CreateCalendarViewAttachmentsUploadSessionRequest) (result CreateCalendarViewAttachmentsUploadSessionOperationResponse, err error) {
