...
func (c CalendarCalendarViewAttachmentClient) GetCalendarViewAttachment(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdAttachmentId, options GetCalendarViewAttachmentOperationOptions) (result GetCalendarViewAttachmentOperationResponse, err error) {
