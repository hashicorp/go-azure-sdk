...
// permissions.
func (c DriveItemClient) DiscardDriveItemCheckout(ctx context.Context, id beta.UserIdDriveIdItemId) (result DiscardDriveItemCheckoutOperationResponse, err error) {
