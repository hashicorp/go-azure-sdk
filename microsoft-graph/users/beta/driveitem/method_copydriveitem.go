...
// progress.
func (c DriveItemClient) CopyDriveItem(ctx context.Context, id beta.UserIdDriveIdItemId, input CopyDriveItemRequest) (result CopyDriveItemOperationResponse, err error) {
