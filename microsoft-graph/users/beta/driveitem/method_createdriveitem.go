...
func (c DriveItemClient) CreateDriveItem(ctx context.Context, id beta.UserIdDriveId, input beta.DriveItem) (result CreateDriveItemOperationResponse, err error) {
