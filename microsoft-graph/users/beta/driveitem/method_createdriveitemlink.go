...
func (c DriveItemClient) CreateDriveItemLink(ctx context.Context, id beta.UserIdDriveIdItemId, input CreateDriveItemLinkRequest) (result CreateDriveItemLinkOperationResponse, err error) {
