...
func (c DriveItemClient) PreviewDriveItem(ctx context.Context, id beta.UserIdDriveIdItemId, input PreviewDriveItemRequest) (result PreviewDriveItemOperationResponse, err error) {
