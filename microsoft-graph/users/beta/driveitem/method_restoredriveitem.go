...
// bin.
func (c DriveItemClient) RestoreDriveItem(ctx context.Context, id beta.UserIdDriveIdItemId, input RestoreDriveItemRequest) (result RestoreDriveItemOperationResponse, err error) {
