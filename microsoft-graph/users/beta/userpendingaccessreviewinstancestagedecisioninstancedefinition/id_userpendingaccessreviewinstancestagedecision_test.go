...
func TestNewUserPendingAccessReviewInstanceStageDecisionID(t *testing.T) {
	id := NewUserPendingAccessReviewInstanceStageDecisionID("userIdValue", "accessReviewInstanceIdValue", "accessReviewStageIdValue", "accessReviewInstanceDecisionItemIdValue")
...
func TestFormatUserPendingAccessReviewInstanceStageDecisionID(t *testing.T) {
	actual := NewUserPendingAccessReviewInstanceStageDecisionID("userIdValue", "accessReviewInstanceIdValue", "accessReviewStageIdValue", "accessReviewInstanceDecisionItemIdValue").ID()
...
func TestParseUserPendingAccessReviewInstanceStageDecisionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceStageDecisionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceStageDecisionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserPendingAccessReviewInstanceStageDecisionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceStageDecisionId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceStageDecisionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserPendingAccessReviewInstanceStageDecisionId(t *testing.T) {
	segments := UserPendingAccessReviewInstanceStageDecisionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserPendingAccessReviewInstanceStageDecisionId has no segments")
	}
