...
func (c MailFolderUserConfigurationClient) ListMailFolderUserConfigurations(ctx context.Context, id UserIdMailFolderId) (result ListMailFolderUserConfigurationsOperationResponse, err error) {
...
func (c MailFolderUserConfigurationClient) ListMailFolderUserConfigurationsComplete(ctx context.Context, id UserIdMailFolderId) (ListMailFolderUserConfigurationsCompleteResult, error) {
...
func (c MailFolderUserConfigurationClient) ListMailFolderUserConfigurationsCompleteMatchingPredicate(ctx context.Context, id UserIdMailFolderId, predicate UserConfigurationOperationPredicate) (result ListMailFolderUserConfigurationsCompleteResult, err error) {
