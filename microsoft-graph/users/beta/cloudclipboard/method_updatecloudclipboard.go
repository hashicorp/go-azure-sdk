...
func (c CloudClipboardClient) UpdateCloudClipboard(ctx context.Context, id beta.UserId, input beta.CloudClipboardRoot) (result UpdateCloudClipboardOperationResponse, err error) {
