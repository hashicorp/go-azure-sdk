...
func (c AnalyticActivityStatisticClient) ListAnalyticActivityStatistics(ctx context.Context, id UserId) (result ListAnalyticActivityStatisticsOperationResponse, err error) {
...
func (c AnalyticActivityStatisticClient) ListAnalyticActivityStatisticsComplete(ctx context.Context, id UserId) (ListAnalyticActivityStatisticsCompleteResult, error) {
	return c.ListAnalyticActivityStatisticsCompleteMatchingPredicate(ctx, id, ActivityStatisticsOperationPredicate{})
}

// ListAnalyticActivityStatisticsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AnalyticActivityStatisticClient) ListAnalyticActivityStatisticsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate ActivityStatisticsOperationPredicate) (result ListAnalyticActivityStatisticsCompleteResult, err error) {
	items := make([]beta.ActivityStatistics, 0)

	resp, err := c.ListAnalyticActivityStatistics(ctx, id)
	if err != nil {
