...
func TestNewUserCalendarEventInstanceExceptionOccurrenceID(t *testing.T) {
	id := NewUserCalendarEventInstanceExceptionOccurrenceID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value")
...
func TestFormatUserCalendarEventInstanceExceptionOccurrenceID(t *testing.T) {
	actual := NewUserCalendarEventInstanceExceptionOccurrenceID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value").ID()
