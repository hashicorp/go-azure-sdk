...
func (c OnlineMeetingMeetingAttendanceReportClient) UpdateOnlineMeetingAttendanceReport(ctx context.Context, id beta.UserIdOnlineMeetingId, input beta.MeetingAttendanceReport) (result UpdateOnlineMeetingAttendanceReportOperationResponse, err error) {
