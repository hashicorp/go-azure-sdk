...
func (c AuthenticationPlatformCredentialMethodClient) ListAuthenticationPlatformCredentialMethods(ctx context.Context, id UserId) (result ListAuthenticationPlatformCredentialMethodsOperationResponse, err error) {
...
func (c AuthenticationPlatformCredentialMethodClient) ListAuthenticationPlatformCredentialMethodsComplete(ctx context.Context, id UserId) (ListAuthenticationPlatformCredentialMethodsCompleteResult, error) {
	return c.ListAuthenticationPlatformCredentialMethodsCompleteMatchingPredicate(ctx, id, PlatformCredentialAuthenticationMethodOperationPredicate{})
}
...
func (c AuthenticationPlatformCredentialMethodClient) ListAuthenticationPlatformCredentialMethodsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate PlatformCredentialAuthenticationMethodOperationPredicate) (result ListAuthenticationPlatformCredentialMethodsCompleteResult, err error) {
	items := make([]beta.PlatformCredentialAuthenticationMethod, 0)

	resp, err := c.ListAuthenticationPlatformCredentialMethods(ctx, id)
	if err != nil {
