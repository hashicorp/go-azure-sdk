...
func (c ManagedDeviceWindowsProtectionStateClient) UpdateManagedDeviceWindowsProtectionState(ctx context.Context, id beta.UserIdManagedDeviceId, input beta.WindowsProtectionState) (result UpdateManagedDeviceWindowsProtectionStateOperationResponse, err error) {
