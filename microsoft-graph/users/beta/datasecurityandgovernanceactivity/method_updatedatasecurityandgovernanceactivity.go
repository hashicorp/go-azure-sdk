...
// UpdateDataSecurityAndGovernanceActivity - Update the navigation property activities in users
func (c DataSecurityAndGovernanceActivityClient) UpdateDataSecurityAndGovernanceActivity(ctx context.Context, id beta.UserId, input beta.ActivitiesContainer, options UpdateDataSecurityAndGovernanceActivityOperationOptions) (result UpdateDataSecurityAndGovernanceActivityOperationResponse, err error) {
