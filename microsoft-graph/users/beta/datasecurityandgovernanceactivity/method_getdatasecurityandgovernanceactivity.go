...
// GetDataSecurityAndGovernanceActivity - Get activities from users. Container for activity logs (content processing and
// audit) related to this user. ContainsTarget: true.
func (c DataSecurityAndGovernanceActivityClient) GetDataSecurityAndGovernanceActivity(ctx context.Context, id beta.UserId, options GetDataSecurityAndGovernanceActivityOperationOptions) (result GetDataSecurityAndGovernanceActivityOperationResponse, err error) {
