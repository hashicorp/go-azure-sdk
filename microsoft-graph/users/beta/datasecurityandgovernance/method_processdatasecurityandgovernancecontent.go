...
func (c DataSecurityAndGovernanceClient) ProcessDataSecurityAndGovernanceContent(ctx context.Context, id beta.UserId, input ProcessDataSecurityAndGovernanceContentRequest, options ProcessDataSecurityAndGovernanceContentOperationOptions) (result ProcessDataSecurityAndGovernanceContentOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/dataSecurityAndGovernance/processContent", id.ID()),
