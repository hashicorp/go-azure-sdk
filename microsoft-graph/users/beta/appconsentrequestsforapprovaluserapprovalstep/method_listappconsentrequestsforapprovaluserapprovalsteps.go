...
func (c AppConsentRequestsForApprovalUserApprovalStepClient) ListAppConsentRequestsForApprovalUserApprovalSteps(ctx context.Context, id beta.UserIdAppConsentRequestsForApprovalIdUserConsentRequestId, options ListAppConsentRequestsForApprovalUserApprovalStepsOperationOptions) (result ListAppConsentRequestsForApprovalUserApprovalStepsOperationResponse, err error) {
...
func (c AppConsentRequestsForApprovalUserApprovalStepClient) ListAppConsentRequestsForApprovalUserApprovalStepsComplete(ctx context.Context, id beta.UserIdAppConsentRequestsForApprovalIdUserConsentRequestId, options ListAppConsentRequestsForApprovalUserApprovalStepsOperationOptions) (ListAppConsentRequestsForApprovalUserApprovalStepsCompleteResult, error) {
...
func (c AppConsentRequestsForApprovalUserApprovalStepClient) ListAppConsentRequestsForApprovalUserApprovalStepsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdAppConsentRequestsForApprovalIdUserConsentRequestId, options ListAppConsentRequestsForApprovalUserApprovalStepsOperationOptions, predicate ApprovalStepOperationPredicate) (result ListAppConsentRequestsForApprovalUserApprovalStepsCompleteResult, err error) {
