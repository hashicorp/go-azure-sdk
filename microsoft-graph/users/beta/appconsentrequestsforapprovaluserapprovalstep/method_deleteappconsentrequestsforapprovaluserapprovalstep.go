...
func (c AppConsentRequestsForApprovalUserApprovalStepClient) DeleteAppConsentRequestsForApprovalUserApprovalStep(ctx context.Context, id beta.UserIdAppConsentRequestsForApprovalIdUserConsentRequestIdApprovalStepId, options DeleteAppConsentRequestsForApprovalUserApprovalStepOperationOptions) (result DeleteAppConsentRequestsForApprovalUserApprovalStepOperationResponse, err error) {
