...
func (c CalendarGroupCalendarViewAttachmentClient) ListCalendarGroupCalendarViewAttachmentsComplete(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewId, options ListCalendarGroupCalendarViewAttachmentsOperationOptions) (ListCalendarGroupCalendarViewAttachmentsCompleteResult, error) {
