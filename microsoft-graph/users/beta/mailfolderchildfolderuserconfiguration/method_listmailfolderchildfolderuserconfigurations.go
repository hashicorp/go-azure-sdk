...
func (c MailFolderChildFolderUserConfigurationClient) ListMailFolderChildFolderUserConfigurations(ctx context.Context, id UserIdMailFolderIdChildFolderId) (result ListMailFolderChildFolderUserConfigurationsOperationResponse, err error) {
...
func (c MailFolderChildFolderUserConfigurationClient) ListMailFolderChildFolderUserConfigurationsComplete(ctx context.Context, id UserIdMailFolderIdChildFolderId) (ListMailFolderChildFolderUserConfigurationsCompleteResult, error) {
...
func (c MailFolderChildFolderUserConfigurationClient) ListMailFolderChildFolderUserConfigurationsCompleteMatchingPredicate(ctx context.Context, id UserIdMailFolderIdChildFolderId, predicate UserConfigurationOperationPredicate) (result ListMailFolderChildFolderUserConfigurationsCompleteResult, err error) {
