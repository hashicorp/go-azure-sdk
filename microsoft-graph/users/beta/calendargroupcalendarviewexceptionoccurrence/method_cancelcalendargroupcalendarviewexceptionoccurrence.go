...
// cancellation.
func (c CalendarGroupCalendarViewExceptionOccurrenceClient) CancelCalendarGroupCalendarViewExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, input CancelCalendarGroupCalendarViewExceptionOccurrenceRequest) (result CancelCalendarGroupCalendarViewExceptionOccurrenceOperationResponse, err error) {
