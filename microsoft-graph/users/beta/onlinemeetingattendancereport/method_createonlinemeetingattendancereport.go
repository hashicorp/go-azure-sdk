...
func (c OnlineMeetingAttendanceReportClient) CreateOnlineMeetingAttendanceReport(ctx context.Context, id beta.UserIdOnlineMeetingId, input beta.MeetingAttendanceReport) (result CreateOnlineMeetingAttendanceReportOperationResponse, err error) {
