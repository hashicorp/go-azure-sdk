...
func (c DriveRootListItemActivityClient) CreateDriveRootListItemActivity(ctx context.Context, id beta.UserIdDriveId, input beta.ItemActivityOLD) (result CreateDriveRootListItemActivityOperationResponse, err error) {
