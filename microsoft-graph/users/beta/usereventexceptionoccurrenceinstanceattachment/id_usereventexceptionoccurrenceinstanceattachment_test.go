...
func TestNewUserEventExceptionOccurrenceInstanceAttachmentID(t *testing.T) {
	id := NewUserEventExceptionOccurrenceInstanceAttachmentID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue")
...
func TestFormatUserEventExceptionOccurrenceInstanceAttachmentID(t *testing.T) {
	actual := NewUserEventExceptionOccurrenceInstanceAttachmentID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue").ID()
...
func TestParseUserEventExceptionOccurrenceInstanceAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserEventExceptionOccurrenceInstanceAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserEventExceptionOccurrenceInstanceAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserEventExceptionOccurrenceInstanceAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserEventExceptionOccurrenceInstanceAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserEventExceptionOccurrenceInstanceAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserEventExceptionOccurrenceInstanceAttachmentId(t *testing.T) {
	segments := UserEventExceptionOccurrenceInstanceAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserEventExceptionOccurrenceInstanceAttachmentId has no segments")
	}
