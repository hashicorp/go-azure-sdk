...
func (c DriveItemLastModifiedByUserMailboxSettingClient) UpdateDriveItemLastModifiedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.MailboxSettings) (result UpdateDriveItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
