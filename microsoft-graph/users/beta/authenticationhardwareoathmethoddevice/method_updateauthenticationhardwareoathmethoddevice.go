...
// UpdateAuthenticationHardwareOathMethodDevice - Update the navigation property device in users
func (c AuthenticationHardwareOathMethodDeviceClient) UpdateAuthenticationHardwareOathMethodDevice(ctx context.Context, id beta.UserIdAuthenticationHardwareOathMethodId, input beta.HardwareOathTokenAuthenticationMethodDevice, options UpdateAuthenticationHardwareOathMethodDeviceOperationOptions) (result UpdateAuthenticationHardwareOathMethodDeviceOperationResponse, err error) {
