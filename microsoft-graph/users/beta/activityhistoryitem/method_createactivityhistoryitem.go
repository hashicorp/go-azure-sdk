...
func (c ActivityHistoryItemClient) CreateActivityHistoryItem(ctx context.Context, id beta.UserIdActivityId, input beta.ActivityHistoryItem) (result CreateActivityHistoryItemOperationResponse, err error) {
