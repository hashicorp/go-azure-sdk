...
// GetAuthenticationQrCodePinMethodPin - Get pin from users. The PIN linked to the QR Code auth method of the user.
func (c AuthenticationQrCodePinMethodPinClient) GetAuthenticationQrCodePinMethodPin(ctx context.Context, id beta.UserId, options GetAuthenticationQrCodePinMethodPinOperationOptions) (result GetAuthenticationQrCodePinMethodPinOperationResponse, err error) {
