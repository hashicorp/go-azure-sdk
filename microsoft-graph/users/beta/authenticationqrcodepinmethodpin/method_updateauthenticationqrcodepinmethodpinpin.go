...
func (c AuthenticationQrCodePinMethodPinClient) UpdateAuthenticationQrCodePinMethodPinPin(ctx context.Context, id beta.UserId, input UpdateAuthenticationQrCodePinMethodPinPinRequest, options UpdateAuthenticationQrCodePinMethodPinPinOperationOptions) (result UpdateAuthenticationQrCodePinMethodPinPinOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/authentication/qrCodePinMethod/pin/updatePin", id.ID()),
