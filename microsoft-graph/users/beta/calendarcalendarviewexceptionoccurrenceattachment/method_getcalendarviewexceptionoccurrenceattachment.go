...
// GetCalendarViewExceptionOccurrenceAttachment - Get attachments from users. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) GetCalendarViewExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdExceptionOccurrenceIdAttachmentId, options GetCalendarViewExceptionOccurrenceAttachmentOperationOptions) (result GetCalendarViewExceptionOccurrenceAttachmentOperationResponse, err error) {
