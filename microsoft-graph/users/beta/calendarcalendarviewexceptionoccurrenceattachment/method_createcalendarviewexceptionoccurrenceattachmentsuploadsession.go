...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) CreateCalendarViewExceptionOccurrenceAttachmentsUploadSession(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdExceptionOccurrenceId, input CreateCalendarViewExceptionOccurrenceAttachmentsUploadSessionRequest) (result CreateCalendarViewExceptionOccurrenceAttachmentsUploadSessionOperationResponse, err error) {
