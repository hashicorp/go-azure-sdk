...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) ListCalendarCalendarViewExceptionOccurrenceAttachments(ctx context.Context, id UserIdCalendarCalendarViewIdExceptionOccurrenceId) (result ListCalendarCalendarViewExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) ListCalendarCalendarViewExceptionOccurrenceAttachmentsComplete(ctx context.Context, id UserIdCalendarCalendarViewIdExceptionOccurrenceId) (ListCalendarCalendarViewExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) ListCalendarCalendarViewExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarCalendarViewIdExceptionOccurrenceId, predicate AttachmentOperationPredicate) (result ListCalendarCalendarViewExceptionOccurrenceAttachmentsCompleteResult, err error) {
