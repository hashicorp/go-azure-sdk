...
func (c CalendarCalendarViewExceptionOccurrenceAttachmentClient) GetCalendarViewExceptionOccurrenceAttachmentsCount(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdExceptionOccurrenceId, options GetCalendarViewExceptionOccurrenceAttachmentsCountOperationOptions) (result GetCalendarViewExceptionOccurrenceAttachmentsCountOperationResponse, err error) {
