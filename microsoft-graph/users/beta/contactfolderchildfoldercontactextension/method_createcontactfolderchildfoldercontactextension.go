...
func (c ContactFolderChildFolderContactExtensionClient) CreateContactFolderChildFolderContactExtension(ctx context.Context, id beta.UserIdContactFolderIdChildFolderIdContactId, input beta.Extension) (result CreateContactFolderChildFolderContactExtensionOperationResponse, err error) {
