...
func TestNewUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdExtensionID(t *testing.T) {
	id := NewUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdExtensionID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue")
...
func TestFormatUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdExtensionID(t *testing.T) {
	actual := NewUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdExtensionID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue").ID()
...
func TestParseUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdExtensionId(t *testing.T) {
	segments := UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdExtensionId has no segments")
	}
