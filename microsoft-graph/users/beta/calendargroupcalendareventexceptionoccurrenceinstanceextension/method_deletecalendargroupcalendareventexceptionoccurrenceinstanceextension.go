...
// DeleteCalendarGroupCalendarEventExceptionOccurrenceInstanceExtension - Delete navigation property extensions for
// users
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionClient) DeleteCalendarGroupCalendarEventExceptionOccurrenceInstanceExtension(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdExtensionId, options DeleteCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionOperationOptions) (result DeleteCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionOperationResponse, err error) {
