...
func TestNewUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceID(t *testing.T) {
	id := NewUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value")
...
func TestFormatUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceID(t *testing.T) {
	actual := NewUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value").ID()
	expected := "/users/userIdValue/calendarGroups/calendarGroupIdValue/calendars/calendarIdValue/events/eventIdValue/exceptionOccurrences/eventId1Value/instances/eventId2Value"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/users/userIdValue/calendarGroups/calendarGroupIdValue/calendars/calendarIdValue/events/eventIdValue/exceptionOccurrences/eventId1Value/instances/eventId2Value/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId(t *testing.T) {
	segments := UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId has no segments")
	}
