...
type ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsOperationOptions struct {
	Count   *bool
	Expand  *odata.Expand
	Filter  *string
...
func DefaultListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsOperationOptions() ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsOperationOptions {
	return ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsOperationOptions{}
}

func (o ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Count != nil {
		out.Count = *o.Count
	}
...
func (o ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsOperationOptions) ToQuery() *client.QueryParams {
...
// ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensions - Get extensions from users. The collection of
// open extensions defined for the event. Nullable.
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensions(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId, options ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsOperationOptions) (result ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId, options ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsOperationOptions) (ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
	return c.ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsCompleteMatchingPredicate(ctx, id, options, ExtensionOperationPredicate{})
}
...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId, options ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsCompleteResult, err error) {
	...
	resp, err := c.ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensions(ctx, id, options)
	if err != nil {
