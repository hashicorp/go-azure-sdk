...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensions(ctx context.Context, id UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId) (result ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId) (ListCalendarGroupCalendarEventExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
