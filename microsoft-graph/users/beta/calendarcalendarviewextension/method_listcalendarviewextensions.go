...
// ListCalendarViewExtensions - Get extensions from users. The collection of open extensions defined for the event.
// Nullable.
func (c CalendarCalendarViewExtensionClient) ListCalendarViewExtensions(ctx context.Context, id beta.UserIdCalendarCalendarViewId, options ListCalendarViewExtensionsOperationOptions) (result ListCalendarViewExtensionsOperationResponse, err error) {
...
func (c CalendarCalendarViewExtensionClient) ListCalendarViewExtensionsComplete(ctx context.Context, id beta.UserIdCalendarCalendarViewId, options ListCalendarViewExtensionsOperationOptions) (ListCalendarViewExtensionsCompleteResult, error) {
...
func (c CalendarCalendarViewExtensionClient) ListCalendarViewExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarCalendarViewId, options ListCalendarViewExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarViewExtensionsCompleteResult, err error) {
