...
func (c DeviceExtensionClient) CreateDeviceExtension(ctx context.Context, id beta.UserIdDeviceId, input beta.Extension) (result CreateDeviceExtensionOperationResponse, err error) {
