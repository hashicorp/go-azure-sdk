...
func (c ManagedDeviceClient) CreateManagedDeviceInitiateMobileDeviceManagementKeyRecovery(ctx context.Context, id beta.UserIdManagedDeviceId) (result CreateManagedDeviceInitiateMobileDeviceManagementKeyRecoveryOperationResponse, err error) {
