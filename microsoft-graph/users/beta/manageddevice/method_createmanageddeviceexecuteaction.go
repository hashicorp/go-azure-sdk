...
func (c ManagedDeviceClient) CreateManagedDeviceExecuteAction(ctx context.Context, id UserId, input CreateManagedDeviceExecuteActionRequest) (result CreateManagedDeviceExecuteActionOperationResponse, err error) {
