...
func (c ManagedDeviceClient) CreateManagedDeviceWindowsDefenderUpdateSignature(ctx context.Context, id beta.UserIdManagedDeviceId) (result CreateManagedDeviceWindowsDefenderUpdateSignatureOperationResponse, err error) {
