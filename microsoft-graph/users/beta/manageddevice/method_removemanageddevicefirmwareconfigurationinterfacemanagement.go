...
// management
func (c ManagedDeviceClient) RemoveManagedDeviceFirmwareConfigurationInterfaceManagement(ctx context.Context, id beta.UserIdManagedDeviceId) (result RemoveManagedDeviceFirmwareConfigurationInterfaceManagementOperationResponse, err error) {
