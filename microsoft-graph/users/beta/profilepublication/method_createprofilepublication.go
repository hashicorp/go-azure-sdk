...
func (c ProfilePublicationClient) CreateProfilePublication(ctx context.Context, id UserId, input beta.ItemPublication) (result CreateProfilePublicationOperationResponse, err error) {
