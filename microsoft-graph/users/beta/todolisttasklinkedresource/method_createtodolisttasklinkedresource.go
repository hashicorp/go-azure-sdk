...
func (c TodoListTaskLinkedResourceClient) CreateTodoListTaskLinkedResource(ctx context.Context, id UserIdTodoListIdTaskId, input beta.LinkedResource) (result CreateTodoListTaskLinkedResourceOperationResponse, err error) {
