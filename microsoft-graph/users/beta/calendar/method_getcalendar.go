...
// GetCalendar - Get calendars from users. The user's calendars. Read-only. Nullable.
func (c CalendarClient) GetCalendar(ctx context.Context, id beta.UserIdCalendarId, options GetCalendarOperationOptions) (result GetCalendarOperationResponse, err error) {
