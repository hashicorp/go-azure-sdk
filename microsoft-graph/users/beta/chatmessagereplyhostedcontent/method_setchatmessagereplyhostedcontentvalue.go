...
func (c ChatMessageReplyHostedContentClient) SetChatMessageReplyHostedContentValue(ctx context.Context, id beta.UserIdChatIdMessageIdReplyIdHostedContentId, input []byte) (result SetChatMessageReplyHostedContentValueOperationResponse, err error) {
