...
func (c ChatMessageReplyHostedContentClient) GetChatMessageReplyHostedContentValue(ctx context.Context, id beta.UserIdChatIdMessageIdReplyIdHostedContentId) (result GetChatMessageReplyHostedContentValueOperationResponse, err error) {
