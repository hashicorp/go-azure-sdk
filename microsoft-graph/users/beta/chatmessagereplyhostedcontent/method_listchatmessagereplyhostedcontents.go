...
func (c ChatMessageReplyHostedContentClient) ListChatMessageReplyHostedContents(ctx context.Context, id UserIdChatIdMessageIdReplyId) (result ListChatMessageReplyHostedContentsOperationResponse, err error) {
...
func (c ChatMessageReplyHostedContentClient) ListChatMessageReplyHostedContentsComplete(ctx context.Context, id UserIdChatIdMessageIdReplyId) (ListChatMessageReplyHostedContentsCompleteResult, error) {
...
func (c ChatMessageReplyHostedContentClient) ListChatMessageReplyHostedContentsCompleteMatchingPredicate(ctx context.Context, id UserIdChatIdMessageIdReplyId, predicate ChatMessageHostedContentOperationPredicate) (result ListChatMessageReplyHostedContentsCompleteResult, err error) {
