...
func (c AppRoleAssignmentClient) CreateAppRoleAssignment(ctx context.Context, id UserId, input beta.AppRoleAssignment) (result CreateAppRoleAssignmentOperationResponse, err error) {
