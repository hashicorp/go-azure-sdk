...
// GetAuthenticationSignInPreference ...
func (c AuthenticationSignInPreferenceClient) GetAuthenticationSignInPreference(ctx context.Context, id UserId) (result GetAuthenticationSignInPreferenceOperationResponse, err error) {
