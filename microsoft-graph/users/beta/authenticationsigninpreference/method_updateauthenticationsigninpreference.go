...
func (c AuthenticationSignInPreferenceClient) UpdateAuthenticationSignInPreference(ctx context.Context, id beta.UserId, input beta.SignInPreferences) (result UpdateAuthenticationSignInPreferenceOperationResponse, err error) {
