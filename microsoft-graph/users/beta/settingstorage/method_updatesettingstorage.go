...
func (c SettingStorageClient) UpdateSettingStorage(ctx context.Context, id beta.UserId, input beta.UserStorage) (result UpdateSettingStorageOperationResponse, err error) {
