...
// GetAssignAuthenticationHardwareOathMethodDeviceTo - Get assignTo from users. Assign the hardware OATH token to a
// user.
func (c AssignUserAuthenticationHardwareOathMethodDeviceToClient) GetAssignAuthenticationHardwareOathMethodDeviceTo(ctx context.Context, id beta.UserIdAuthenticationHardwareOathMethodId, options GetAssignAuthenticationHardwareOathMethodDeviceToOperationOptions) (result GetAssignAuthenticationHardwareOathMethodDeviceToOperationResponse, err error) {
