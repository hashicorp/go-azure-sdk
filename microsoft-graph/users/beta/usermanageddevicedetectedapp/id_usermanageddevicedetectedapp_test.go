...
func TestNewUserManagedDeviceDetectedAppID(t *testing.T) {
	id := NewUserManagedDeviceDetectedAppID("userIdValue", "managedDeviceIdValue", "detectedAppIdValue")
...
func TestFormatUserManagedDeviceDetectedAppID(t *testing.T) {
	actual := NewUserManagedDeviceDetectedAppID("userIdValue", "managedDeviceIdValue", "detectedAppIdValue").ID()
...
func TestParseUserManagedDeviceDetectedAppID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserManagedDeviceDetectedAppId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserManagedDeviceDetectedAppID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserManagedDeviceDetectedAppIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserManagedDeviceDetectedAppId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserManagedDeviceDetectedAppIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserManagedDeviceDetectedAppId(t *testing.T) {
	segments := UserManagedDeviceDetectedAppId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserManagedDeviceDetectedAppId has no segments")
	}
