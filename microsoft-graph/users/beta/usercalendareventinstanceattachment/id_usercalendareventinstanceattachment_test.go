...
func TestNewUserCalendarEventInstanceAttachmentID(t *testing.T) {
	id := NewUserCalendarEventInstanceAttachmentID("userIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue")
...
func TestFormatUserCalendarEventInstanceAttachmentID(t *testing.T) {
	actual := NewUserCalendarEventInstanceAttachmentID("userIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue").ID()
...
func TestParseUserCalendarEventInstanceAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarEventInstanceAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarEventInstanceAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarEventInstanceAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarEventInstanceAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarEventInstanceAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarEventInstanceAttachmentId(t *testing.T) {
	segments := UserCalendarEventInstanceAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarEventInstanceAttachmentId has no segments")
	}
