...
// CreateLicenseDetail ...
func (c LicenseDetailClient) CreateLicenseDetail(ctx context.Context, id UserId, input beta.LicenseDetails) (result CreateLicenseDetailOperationResponse, err error) {
