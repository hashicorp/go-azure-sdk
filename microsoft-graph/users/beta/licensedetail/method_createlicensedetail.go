...
func (c LicenseDetailClient) CreateLicenseDetail(ctx context.Context, id beta.UserId, input beta.LicenseDetails) (result CreateLicenseDetailOperationResponse, err error) {
