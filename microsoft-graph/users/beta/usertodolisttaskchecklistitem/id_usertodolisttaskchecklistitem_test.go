...
func TestNewUserTodoListTaskChecklistItemID(t *testing.T) {
	id := NewUserTodoListTaskChecklistItemID("userIdValue", "todoTaskListIdValue", "todoTaskIdValue", "checklistItemIdValue")
...
func TestFormatUserTodoListTaskChecklistItemID(t *testing.T) {
	actual := NewUserTodoListTaskChecklistItemID("userIdValue", "todoTaskListIdValue", "todoTaskIdValue", "checklistItemIdValue").ID()
...
func TestParseUserTodoListTaskChecklistItemID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserTodoListTaskChecklistItemId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserTodoListTaskChecklistItemID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserTodoListTaskChecklistItemIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserTodoListTaskChecklistItemId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserTodoListTaskChecklistItemIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserTodoListTaskChecklistItemId(t *testing.T) {
	segments := UserTodoListTaskChecklistItemId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserTodoListTaskChecklistItemId has no segments")
	}
