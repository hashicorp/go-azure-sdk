...
func (c ChatMessageHostedContentClient) GetChatMessageHostedContentValue(ctx context.Context, id beta.UserIdChatIdMessageIdHostedContentId) (result GetChatMessageHostedContentValueOperationResponse, err error) {
