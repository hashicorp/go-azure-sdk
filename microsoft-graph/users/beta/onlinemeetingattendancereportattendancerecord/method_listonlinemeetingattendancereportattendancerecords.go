...
func (c OnlineMeetingAttendanceReportAttendanceRecordClient) ListOnlineMeetingAttendanceReportAttendanceRecords(ctx context.Context, id UserIdOnlineMeetingIdAttendanceReportId) (result ListOnlineMeetingAttendanceReportAttendanceRecordsOperationResponse, err error) {
...
func (c OnlineMeetingAttendanceReportAttendanceRecordClient) ListOnlineMeetingAttendanceReportAttendanceRecordsComplete(ctx context.Context, id UserIdOnlineMeetingIdAttendanceReportId) (ListOnlineMeetingAttendanceReportAttendanceRecordsCompleteResult, error) {
...
func (c OnlineMeetingAttendanceReportAttendanceRecordClient) ListOnlineMeetingAttendanceReportAttendanceRecordsCompleteMatchingPredicate(ctx context.Context, id UserIdOnlineMeetingIdAttendanceReportId, predicate AttendanceRecordOperationPredicate) (result ListOnlineMeetingAttendanceReportAttendanceRecordsCompleteResult, err error) {
