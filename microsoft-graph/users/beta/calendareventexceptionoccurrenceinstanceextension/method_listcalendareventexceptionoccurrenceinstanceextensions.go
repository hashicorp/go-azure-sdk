...
func (c CalendarEventExceptionOccurrenceInstanceExtensionClient) ListCalendarEventExceptionOccurrenceInstanceExtensions(ctx context.Context, id UserIdCalendarEventIdExceptionOccurrenceIdInstanceId) (result ListCalendarEventExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceInstanceExtensionClient) ListCalendarEventExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id UserIdCalendarEventIdExceptionOccurrenceIdInstanceId) (ListCalendarEventExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
