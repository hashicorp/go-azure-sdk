...
// ListCalendarEventExceptionOccurrenceInstanceExtensions - Get extensions from users. The collection of open extensions
// defined for the event. Nullable.
func (c CalendarEventExceptionOccurrenceInstanceExtensionClient) ListCalendarEventExceptionOccurrenceInstanceExtensions(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceIdInstanceId, options ListCalendarEventExceptionOccurrenceInstanceExtensionsOperationOptions) (result ListCalendarEventExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceInstanceExtensionClient) ListCalendarEventExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceIdInstanceId, options ListCalendarEventExceptionOccurrenceInstanceExtensionsOperationOptions) (ListCalendarEventExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
