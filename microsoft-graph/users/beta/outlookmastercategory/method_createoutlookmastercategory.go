...
func (c OutlookMasterCategoryClient) CreateOutlookMasterCategory(ctx context.Context, id UserId, input beta.OutlookCategory) (result CreateOutlookMasterCategoryOperationResponse, err error) {
