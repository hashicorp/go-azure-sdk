...
func (c ProfileNoteClient) CreateProfileNote(ctx context.Context, id beta.UserId, input beta.PersonAnnotation) (result CreateProfileNoteOperationResponse, err error) {
