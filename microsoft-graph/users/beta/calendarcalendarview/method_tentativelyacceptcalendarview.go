...
func (c CalendarCalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id beta.UserIdCalendarIdCalendarViewId, input TentativelyAcceptCalendarViewRequest) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
