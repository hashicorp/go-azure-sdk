...
func (c CalendarCalendarViewClient) GetCalendarViewCount(ctx context.Context, id beta.UserIdCalendarId, options GetCalendarViewCountOperationOptions) (result GetCalendarViewCountOperationResponse, err error) {
