...
func (c CalendarCalendarViewClient) ListCalendarCalendarViews(ctx context.Context, id UserIdCalendarId) (result ListCalendarCalendarViewsOperationResponse, err error) {
...
func (c CalendarCalendarViewClient) ListCalendarCalendarViewsComplete(ctx context.Context, id UserIdCalendarId) (ListCalendarCalendarViewsCompleteResult, error) {
...
func (c CalendarCalendarViewClient) ListCalendarCalendarViewsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarId, predicate EventOperationPredicate) (result ListCalendarCalendarViewsCompleteResult, err error) {
