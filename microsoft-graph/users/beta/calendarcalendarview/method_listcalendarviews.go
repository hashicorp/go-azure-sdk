...
// ListCalendarViews - Get calendarView from users. The calendar view for the calendar. Navigation property. Read-only.
func (c CalendarCalendarViewClient) ListCalendarViews(ctx context.Context, id beta.UserIdCalendarId, options ListCalendarViewsOperationOptions) (result ListCalendarViewsOperationResponse, err error) {
...
func (c CalendarCalendarViewClient) ListCalendarViewsComplete(ctx context.Context, id beta.UserIdCalendarId, options ListCalendarViewsOperationOptions) (ListCalendarViewsCompleteResult, error) {
...
func (c CalendarCalendarViewClient) ListCalendarViewsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarId, options ListCalendarViewsOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewsCompleteResult, err error) {
