...
func (c CalendarCalendarViewClient) DeclineCalendarView(ctx context.Context, id beta.UserIdCalendarCalendarViewId, input DeclineCalendarViewRequest) (result DeclineCalendarViewOperationResponse, err error) {
