...
func (c CalendarCalendarViewClient) GetCalendarView(ctx context.Context, id beta.UserIdCalendarCalendarViewId, options GetCalendarViewOperationOptions) (result GetCalendarViewOperationResponse, err error) {
