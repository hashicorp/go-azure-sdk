...
func (c CalendarCalendarViewClient) CancelCalendarView(ctx context.Context, id beta.UserIdCalendarIdCalendarViewId, input CancelCalendarViewRequest) (result CancelCalendarViewOperationResponse, err error) {
