...
// in a user calendar.
func (c CalendarCalendarViewClient) DismissCalendarViewReminder(ctx context.Context, id beta.UserIdCalendarCalendarViewId) (result DismissCalendarViewReminderOperationResponse, err error) {
