...
// a new time.
func (c CalendarCalendarViewClient) SnoozeCalendarViewReminder(ctx context.Context, id beta.UserIdCalendarCalendarViewId, input SnoozeCalendarViewReminderRequest) (result SnoozeCalendarViewReminderOperationResponse, err error) {
