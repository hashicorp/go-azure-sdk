...
func (c DriveRootPermissionClient) CreateDriveRootPermission(ctx context.Context, id beta.UserIdDriveId, input beta.Permission) (result CreateDriveRootPermissionOperationResponse, err error) {
