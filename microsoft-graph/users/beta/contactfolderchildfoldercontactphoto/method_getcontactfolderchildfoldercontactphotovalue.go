...
func (c ContactFolderChildFolderContactPhotoClient) GetContactFolderChildFolderContactPhotoValue(ctx context.Context, id beta.UserIdContactFolderIdChildFolderIdContactId) (result GetContactFolderChildFolderContactPhotoValueOperationResponse, err error) {
