...
func (c ContactFolderChildFolderContactPhotoClient) SetContactFolderChildFolderContactPhotoValue(ctx context.Context, id beta.UserIdContactFolderIdChildFolderIdContactId, input []byte) (result SetContactFolderChildFolderContactPhotoValueOperationResponse, err error) {
