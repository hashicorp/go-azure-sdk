...
func (c CreatedObjectClient) GetCreatedObjectServicePrincipalCount(ctx context.Context, id beta.UserId, options GetCreatedObjectServicePrincipalCountOperationOptions) (result GetCreatedObjectServicePrincipalCountOperationResponse, err error) {
