...
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) UpdateManagedDeviceSecurityBaselineStateSettingState(ctx context.Context, id UserIdManagedDeviceIdSecurityBaselineStateIdSettingStateId, input beta.SecurityBaselineSettingState) (result UpdateManagedDeviceSecurityBaselineStateSettingStateOperationResponse, err error) {
