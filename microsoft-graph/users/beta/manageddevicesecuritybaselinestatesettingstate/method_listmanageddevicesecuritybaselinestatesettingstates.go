...
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) ListManagedDeviceSecurityBaselineStateSettingStates(ctx context.Context, id UserIdManagedDeviceIdSecurityBaselineStateId) (result ListManagedDeviceSecurityBaselineStateSettingStatesOperationResponse, err error) {
...
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) ListManagedDeviceSecurityBaselineStateSettingStatesComplete(ctx context.Context, id UserIdManagedDeviceIdSecurityBaselineStateId) (ListManagedDeviceSecurityBaselineStateSettingStatesCompleteResult, error) {
...
func (c ManagedDeviceSecurityBaselineStateSettingStateClient) ListManagedDeviceSecurityBaselineStateSettingStatesCompleteMatchingPredicate(ctx context.Context, id UserIdManagedDeviceIdSecurityBaselineStateId, predicate SecurityBaselineSettingStateOperationPredicate) (result ListManagedDeviceSecurityBaselineStateSettingStatesCompleteResult, err error) {
