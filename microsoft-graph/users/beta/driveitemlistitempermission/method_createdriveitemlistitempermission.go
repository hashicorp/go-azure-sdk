...
func (c DriveItemListItemPermissionClient) CreateDriveItemListItemPermission(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.Permission) (result CreateDriveItemListItemPermissionOperationResponse, err error) {
