...
func (c MailFolderChildFolderClient) CopyMailFolderChildFolder(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, input CopyMailFolderChildFolderRequest) (result CopyMailFolderChildFolderOperationResponse, err error) {
