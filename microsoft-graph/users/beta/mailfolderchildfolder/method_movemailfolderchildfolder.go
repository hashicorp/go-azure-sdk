...
func (c MailFolderChildFolderClient) MoveMailFolderChildFolder(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, input MoveMailFolderChildFolderRequest) (result MoveMailFolderChildFolderOperationResponse, err error) {
