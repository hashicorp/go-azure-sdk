...
// CreateMailFolderChildFolderPermanentDelete - Invoke action permanentDelete. Permanently delete a mail folder and
...
func (c MailFolderChildFolderClient) CreateMailFolderChildFolderPermanentDelete(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, options CreateMailFolderChildFolderPermanentDeleteOperationOptions) (result CreateMailFolderChildFolderPermanentDeleteOperationResponse, err error) {
