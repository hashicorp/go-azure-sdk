...
func (c MailFolderChildFolderClient) CreateMailFolderChildFolder(ctx context.Context, id beta.UserIdMailFolderId, input beta.MailFolder) (result CreateMailFolderChildFolderOperationResponse, err error) {
