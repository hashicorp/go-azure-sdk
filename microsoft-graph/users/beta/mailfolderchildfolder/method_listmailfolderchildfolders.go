...
func (c MailFolderChildFolderClient) ListMailFolderChildFolders(ctx context.Context, id UserIdMailFolderId) (result ListMailFolderChildFoldersOperationResponse, err error) {
...
func (c MailFolderChildFolderClient) ListMailFolderChildFoldersComplete(ctx context.Context, id UserIdMailFolderId) (ListMailFolderChildFoldersCompleteResult, error) {
...
func (c MailFolderChildFolderClient) ListMailFolderChildFoldersCompleteMatchingPredicate(ctx context.Context, id UserIdMailFolderId, predicate MailFolderOperationPredicate) (result ListMailFolderChildFoldersCompleteResult, err error) {
