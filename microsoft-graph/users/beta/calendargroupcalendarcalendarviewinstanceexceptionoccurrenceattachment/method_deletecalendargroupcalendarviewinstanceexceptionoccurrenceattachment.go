...
// users
func (c CalendarGroupCalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) DeleteCalendarGroupCalendarViewInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarGroupCalendarViewInstanceExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarGroupCalendarViewInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
