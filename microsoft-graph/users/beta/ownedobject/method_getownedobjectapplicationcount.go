...
func (c OwnedObjectClient) GetOwnedObjectApplicationCount(ctx context.Context, id beta.UserId, options GetOwnedObjectApplicationCountOperationOptions) (result GetOwnedObjectApplicationCountOperationResponse, err error) {
