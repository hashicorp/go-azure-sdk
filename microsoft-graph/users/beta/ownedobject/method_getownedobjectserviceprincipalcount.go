...
func (c OwnedObjectClient) GetOwnedObjectServicePrincipalCount(ctx context.Context, id beta.UserId, options GetOwnedObjectServicePrincipalCountOperationOptions) (result GetOwnedObjectServicePrincipalCountOperationResponse, err error) {
