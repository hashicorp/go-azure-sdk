...
func (c OwnedObjectClient) GetOwnedObjectGroupCount(ctx context.Context, id beta.UserId, options GetOwnedObjectGroupCountOperationOptions) (result GetOwnedObjectGroupCountOperationResponse, err error) {
