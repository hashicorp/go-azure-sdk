...
// CreatePendingAccessReviewInstanceDecisionRecordAllDecision ...
func (c PendingAccessReviewInstanceDecisionClient) CreatePendingAccessReviewInstanceDecisionRecordAllDecision(ctx context.Context, id UserIdPendingAccessReviewInstanceId, input CreatePendingAccessReviewInstanceDecisionRecordAllDecisionRequest) (result CreatePendingAccessReviewInstanceDecisionRecordAllDecisionOperationResponse, err error) {
