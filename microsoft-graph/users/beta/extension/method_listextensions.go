...
// ListExtensions ...
func (c ExtensionClient) ListExtensions(ctx context.Context, id UserId) (result ListExtensionsOperationResponse, err error) {
...
func (c ExtensionClient) ListExtensionsComplete(ctx context.Context, id UserId) (ListExtensionsCompleteResult, error) {
...
func (c ExtensionClient) ListExtensionsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate ExtensionOperationPredicate) (result ListExtensionsCompleteResult, err error) {
