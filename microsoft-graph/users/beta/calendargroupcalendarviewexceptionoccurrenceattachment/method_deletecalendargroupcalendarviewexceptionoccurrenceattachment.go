...
func (c CalendarGroupCalendarViewExceptionOccurrenceAttachmentClient) DeleteCalendarGroupCalendarViewExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarGroupCalendarViewExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarGroupCalendarViewExceptionOccurrenceAttachmentOperationResponse, err error) {
