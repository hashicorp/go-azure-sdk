...
func (c CalendarGroupCalendarViewExceptionOccurrenceAttachmentClient) ListCalendarGroupCalendarViewExceptionOccurrenceAttachmentsComplete(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, options ListCalendarGroupCalendarViewExceptionOccurrenceAttachmentsOperationOptions) (ListCalendarGroupCalendarViewExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c CalendarGroupCalendarViewExceptionOccurrenceAttachmentClient) ListCalendarGroupCalendarViewExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, options ListCalendarGroupCalendarViewExceptionOccurrenceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarGroupCalendarViewExceptionOccurrenceAttachmentsCompleteResult, err error) {
