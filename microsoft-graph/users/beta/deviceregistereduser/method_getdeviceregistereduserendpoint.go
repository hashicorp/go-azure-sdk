...
func (c DeviceRegisteredUserClient) GetDeviceRegisteredUserEndpoint(ctx context.Context, id beta.UserIdDeviceIdRegisteredUserId, options GetDeviceRegisteredUserEndpointOperationOptions) (result GetDeviceRegisteredUserEndpointOperationResponse, err error) {
