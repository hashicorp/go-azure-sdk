...
func (c CalendarGroupCalendarEventInstanceAttachmentClient) DeleteCalendarGroupCalendarEventInstanceAttachment(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdInstanceIdAttachmentId, options DeleteCalendarGroupCalendarEventInstanceAttachmentOperationOptions) (result DeleteCalendarGroupCalendarEventInstanceAttachmentOperationResponse, err error) {
