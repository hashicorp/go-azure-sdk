...
func (c ContactPhotoClient) SetContactPhotoValue(ctx context.Context, id beta.UserIdContactId, input []byte) (result SetContactPhotoValueOperationResponse, err error) {
