...
func (c CalendarCalendarViewExceptionOccurrenceInstanceClient) SnoozeCalendarViewExceptionOccurrenceInstanceReminder(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId, input SnoozeCalendarViewExceptionOccurrenceInstanceReminderRequest) (result SnoozeCalendarViewExceptionOccurrenceInstanceReminderOperationResponse, err error) {
