...
func (c CalendarCalendarViewExceptionOccurrenceInstanceClient) AcceptCalendarViewExceptionOccurrenceInstance(ctx context.Context, id beta.UserIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceId, input AcceptCalendarViewExceptionOccurrenceInstanceRequest) (result AcceptCalendarViewExceptionOccurrenceInstanceOperationResponse, err error) {
