...
// cancellation.
func (c CalendarCalendarViewExceptionOccurrenceInstanceClient) CancelCalendarViewExceptionOccurrenceInstance(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId, input CancelCalendarViewExceptionOccurrenceInstanceRequest) (result CancelCalendarViewExceptionOccurrenceInstanceOperationResponse, err error) {
