...
func (c CalendarCalendarViewExceptionOccurrenceInstanceClient) DeclineCalendarViewExceptionOccurrenceInstance(ctx context.Context, id beta.UserIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceId, input DeclineCalendarViewExceptionOccurrenceInstanceRequest) (result DeclineCalendarViewExceptionOccurrenceInstanceOperationResponse, err error) {
