...
// times.
func (c CalendarCalendarViewExceptionOccurrenceInstanceClient) TentativelyAcceptCalendarViewExceptionOccurrenceInstance(ctx context.Context, id beta.UserIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceId, input TentativelyAcceptCalendarViewExceptionOccurrenceInstanceRequest) (result TentativelyAcceptCalendarViewExceptionOccurrenceInstanceOperationResponse, err error) {
