...
// ListCalendarViewExceptionOccurrenceInstances - Get instances from users. The occurrences of a recurring series, if
...
func (c CalendarCalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstances(ctx context.Context, id beta.UserIdCalendarCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceInstancesOperationOptions) (result ListCalendarViewExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstancesComplete(ctx context.Context, id beta.UserIdCalendarCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceInstancesOperationOptions) (ListCalendarViewExceptionOccurrenceInstancesCompleteResult, error) {
...
func (c CalendarCalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewExceptionOccurrenceInstancesCompleteResult, err error) {
