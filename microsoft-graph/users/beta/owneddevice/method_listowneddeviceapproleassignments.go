...
func (c OwnedDeviceClient) ListOwnedDeviceAppRoleAssignments(ctx context.Context, id beta.UserId, options ListOwnedDeviceAppRoleAssignmentsOperationOptions) (result ListOwnedDeviceAppRoleAssignmentsOperationResponse, err error) {
...
func (c OwnedDeviceClient) ListOwnedDeviceAppRoleAssignmentsComplete(ctx context.Context, id beta.UserId, options ListOwnedDeviceAppRoleAssignmentsOperationOptions) (ListOwnedDeviceAppRoleAssignmentsCompleteResult, error) {
...
func (c OwnedDeviceClient) ListOwnedDeviceAppRoleAssignmentsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListOwnedDeviceAppRoleAssignmentsOperationOptions, predicate AppRoleAssignmentOperationPredicate) (result ListOwnedDeviceAppRoleAssignmentsCompleteResult, err error) {
