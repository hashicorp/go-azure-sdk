...
func (c OwnedDeviceClient) GetOwnedDeviceEndpoint(ctx context.Context, id beta.UserIdOwnedDeviceId, options GetOwnedDeviceEndpointOperationOptions) (result GetOwnedDeviceEndpointOperationResponse, err error) {
