...
func (c OwnedDeviceClient) GetOwnedDeviceEndpointCount(ctx context.Context, id beta.UserId, options GetOwnedDeviceEndpointCountOperationOptions) (result GetOwnedDeviceEndpointCountOperationResponse, err error) {
