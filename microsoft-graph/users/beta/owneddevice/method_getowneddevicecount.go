...
func (c OwnedDeviceClient) GetOwnedDeviceCount(ctx context.Context, id beta.UserId, options GetOwnedDeviceCountOperationOptions) (result GetOwnedDeviceCountOperationResponse, err error) {
