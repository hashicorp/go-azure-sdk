...
func (c OnlineMeetingRegistrationRegistrantClient) ListOnlineMeetingRegistrationRegistrants(ctx context.Context, id UserIdOnlineMeetingId) (result ListOnlineMeetingRegistrationRegistrantsOperationResponse, err error) {
...
func (c OnlineMeetingRegistrationRegistrantClient) ListOnlineMeetingRegistrationRegistrantsComplete(ctx context.Context, id UserIdOnlineMeetingId) (ListOnlineMeetingRegistrationRegistrantsCompleteResult, error) {
...
func (c OnlineMeetingRegistrationRegistrantClient) ListOnlineMeetingRegistrationRegistrantsCompleteMatchingPredicate(ctx context.Context, id UserIdOnlineMeetingId, predicate MeetingRegistrantBaseOperationPredicate) (result ListOnlineMeetingRegistrationRegistrantsCompleteResult, err error) {
