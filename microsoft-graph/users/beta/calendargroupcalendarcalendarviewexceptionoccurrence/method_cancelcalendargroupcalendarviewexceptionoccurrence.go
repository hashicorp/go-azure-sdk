...
type CancelCalendarGroupCalendarViewExceptionOccurrenceOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

// CancelCalendarGroupCalendarViewExceptionOccurrence - Invoke action cancel. This action allows the organizer of a
...
// cancellation.
func (c CalendarGroupCalendarCalendarViewExceptionOccurrenceClient) CancelCalendarGroupCalendarViewExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, input CancelCalendarGroupCalendarViewExceptionOccurrenceRequest) (result CancelCalendarGroupCalendarViewExceptionOccurrenceOperationResponse, err error) {
