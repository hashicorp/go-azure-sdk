...
func (c MemberOfClient) ListMemberOfDirectoryRoles(ctx context.Context, id beta.UserId, options ListMemberOfDirectoryRolesOperationOptions) (result ListMemberOfDirectoryRolesOperationResponse, err error) {
...
func (c MemberOfClient) ListMemberOfDirectoryRolesComplete(ctx context.Context, id beta.UserId, options ListMemberOfDirectoryRolesOperationOptions) (ListMemberOfDirectoryRolesCompleteResult, error) {
...
func (c MemberOfClient) ListMemberOfDirectoryRolesCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListMemberOfDirectoryRolesOperationOptions, predicate DirectoryRoleOperationPredicate) (result ListMemberOfDirectoryRolesCompleteResult, err error) {
