...
func (c MemberOfClient) GetMemberOfDirectoryRoleCount(ctx context.Context, id beta.UserId, options GetMemberOfDirectoryRoleCountOperationOptions) (result GetMemberOfDirectoryRoleCountOperationResponse, err error) {
