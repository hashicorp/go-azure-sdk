...
func (c MemberOfClient) ListMemberOfGroups(ctx context.Context, id beta.UserId, options ListMemberOfGroupsOperationOptions) (result ListMemberOfGroupsOperationResponse, err error) {
...
func (c MemberOfClient) ListMemberOfGroupsComplete(ctx context.Context, id beta.UserId, options ListMemberOfGroupsOperationOptions) (ListMemberOfGroupsCompleteResult, error) {
...
func (c MemberOfClient) ListMemberOfGroupsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListMemberOfGroupsOperationOptions, predicate GroupOperationPredicate) (result ListMemberOfGroupsCompleteResult, err error) {
