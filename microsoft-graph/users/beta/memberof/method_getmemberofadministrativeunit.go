...
func (c MemberOfClient) GetMemberOfAdministrativeUnit(ctx context.Context, id beta.UserIdMemberOfId, options GetMemberOfAdministrativeUnitOperationOptions) (result GetMemberOfAdministrativeUnitOperationResponse, err error) {
