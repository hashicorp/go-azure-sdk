...
func TestNewUserInformationProtectionSensitivityLabelSublabelID(t *testing.T) {
	id := NewUserInformationProtectionSensitivityLabelSublabelID("userIdValue", "sensitivityLabelIdValue", "sensitivityLabelId1Value")
...
func TestFormatUserInformationProtectionSensitivityLabelSublabelID(t *testing.T) {
	actual := NewUserInformationProtectionSensitivityLabelSublabelID("userIdValue", "sensitivityLabelIdValue", "sensitivityLabelId1Value").ID()
...
func TestParseUserInformationProtectionSensitivityLabelSublabelID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserInformationProtectionSensitivityLabelSublabelId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserInformationProtectionSensitivityLabelSublabelID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserInformationProtectionSensitivityLabelSublabelIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserInformationProtectionSensitivityLabelSublabelId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserInformationProtectionSensitivityLabelSublabelIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserInformationProtectionSensitivityLabelSublabelId(t *testing.T) {
	segments := UserInformationProtectionSensitivityLabelSublabelId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserInformationProtectionSensitivityLabelSublabelId has no segments")
	}
