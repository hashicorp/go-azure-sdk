...
func TestNewUserInformationProtectionSensitivityLabelID(t *testing.T) {
	id := NewUserInformationProtectionSensitivityLabelID("userIdValue", "sensitivityLabelIdValue")
...
func TestFormatUserInformationProtectionSensitivityLabelID(t *testing.T) {
	actual := NewUserInformationProtectionSensitivityLabelID("userIdValue", "sensitivityLabelIdValue").ID()
...
func TestParseUserInformationProtectionSensitivityLabelID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserInformationProtectionSensitivityLabelId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserInformationProtectionSensitivityLabelID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserInformationProtectionSensitivityLabelIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserInformationProtectionSensitivityLabelId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserInformationProtectionSensitivityLabelIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserInformationProtectionSensitivityLabelId(t *testing.T) {
	segments := UserInformationProtectionSensitivityLabelId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserInformationProtectionSensitivityLabelId has no segments")
	}
