...
// GetCommunicationCallSetting - Get callSettings from users. The call settings assigned to the user.
func (c CommunicationCallSettingClient) GetCommunicationCallSetting(ctx context.Context, id beta.UserId, options GetCommunicationCallSettingOperationOptions) (result GetCommunicationCallSettingOperationResponse, err error) {
