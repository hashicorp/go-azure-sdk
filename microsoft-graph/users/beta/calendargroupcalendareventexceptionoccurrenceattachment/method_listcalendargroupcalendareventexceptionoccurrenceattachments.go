...
// ListCalendarGroupCalendarEventExceptionOccurrenceAttachments - Get attachments from users. The collection of
// FileAttachment, ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only.
// Nullable.
func (c CalendarGroupCalendarEventExceptionOccurrenceAttachmentClient) ListCalendarGroupCalendarEventExceptionOccurrenceAttachments(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceId, options ListCalendarGroupCalendarEventExceptionOccurrenceAttachmentsOperationOptions) (result ListCalendarGroupCalendarEventExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventExceptionOccurrenceAttachmentClient) ListCalendarGroupCalendarEventExceptionOccurrenceAttachmentsComplete(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceId, options ListCalendarGroupCalendarEventExceptionOccurrenceAttachmentsOperationOptions) (ListCalendarGroupCalendarEventExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c CalendarGroupCalendarEventExceptionOccurrenceAttachmentClient) ListCalendarGroupCalendarEventExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceId, options ListCalendarGroupCalendarEventExceptionOccurrenceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarGroupCalendarEventExceptionOccurrenceAttachmentsCompleteResult, err error) {
