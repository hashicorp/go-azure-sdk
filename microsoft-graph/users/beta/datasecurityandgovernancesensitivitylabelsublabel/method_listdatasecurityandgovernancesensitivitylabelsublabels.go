...
// ListDataSecurityAndGovernanceSensitivityLabelSublabels - Get sublabels from users
func (c DataSecurityAndGovernanceSensitivityLabelSublabelClient) ListDataSecurityAndGovernanceSensitivityLabelSublabels(ctx context.Context, id beta.UserIdDataSecurityAndGovernanceSensitivityLabelId, options ListDataSecurityAndGovernanceSensitivityLabelSublabelsOperationOptions) (result ListDataSecurityAndGovernanceSensitivityLabelSublabelsOperationResponse, err error) {
