...
func (c DataSecurityAndGovernanceSensitivityLabelSublabelClient) EvaluateDataSecurityAndGovernanceSensitivityLabelSublabels(ctx context.Context, id beta.UserIdDataSecurityAndGovernanceSensitivityLabelId, input EvaluateDataSecurityAndGovernanceSensitivityLabelSublabelsRequest, options EvaluateDataSecurityAndGovernanceSensitivityLabelSublabelsOperationOptions) (result EvaluateDataSecurityAndGovernanceSensitivityLabelSublabelsOperationResponse, err error) {
