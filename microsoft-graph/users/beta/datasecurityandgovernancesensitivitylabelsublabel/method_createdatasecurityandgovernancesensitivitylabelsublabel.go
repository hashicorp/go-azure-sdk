...
// CreateDataSecurityAndGovernanceSensitivityLabelSublabel - Create new navigation property to sublabels for users
func (c DataSecurityAndGovernanceSensitivityLabelSublabelClient) CreateDataSecurityAndGovernanceSensitivityLabelSublabel(ctx context.Context, id beta.UserIdDataSecurityAndGovernanceSensitivityLabelId, input beta.SensitivityLabel, options CreateDataSecurityAndGovernanceSensitivityLabelSublabelOperationOptions) (result CreateDataSecurityAndGovernanceSensitivityLabelSublabelOperationResponse, err error) {
