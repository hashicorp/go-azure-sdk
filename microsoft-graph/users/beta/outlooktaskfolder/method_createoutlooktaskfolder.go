...
func (c OutlookTaskFolderClient) CreateOutlookTaskFolder(ctx context.Context, id UserId, input beta.OutlookTaskFolder) (result CreateOutlookTaskFolderOperationResponse, err error) {
