...
func (c OutlookTaskFolderClient) CreateOutlookTaskFolderPermanentDelete(ctx context.Context, id beta.UserIdOutlookTaskFolderId, options CreateOutlookTaskFolderPermanentDeleteOperationOptions) (result CreateOutlookTaskFolderPermanentDeleteOperationResponse, err error) {
