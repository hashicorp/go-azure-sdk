...
func (c DriveItemListItemDriveItemContentClient) SetDriveItemListItemDriveItemContent(ctx context.Context, id beta.UserIdDriveIdItemId, input []byte) (result SetDriveItemListItemDriveItemContentOperationResponse, err error) {
