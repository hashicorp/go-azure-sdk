...
func TestNewUserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceID(t *testing.T) {
	id := NewUserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value")
...
func TestFormatUserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceID(t *testing.T) {
	actual := NewUserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value").ID()
...
func TestParseUserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId(t *testing.T) {
	segments := UserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId has no segments")
	}
