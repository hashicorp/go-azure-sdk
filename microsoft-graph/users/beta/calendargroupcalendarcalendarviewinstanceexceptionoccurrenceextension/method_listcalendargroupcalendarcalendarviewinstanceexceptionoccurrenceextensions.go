...
func (c CalendarGroupCalendarCalendarViewInstanceExceptionOccurrenceExtensionClient) ListCalendarGroupCalendarCalendarViewInstanceExceptionOccurrenceExtensions(ctx context.Context, id UserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId) (result ListCalendarGroupCalendarCalendarViewInstanceExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarCalendarViewInstanceExceptionOccurrenceExtensionClient) ListCalendarGroupCalendarCalendarViewInstanceExceptionOccurrenceExtensionsComplete(ctx context.Context, id UserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId) (ListCalendarGroupCalendarCalendarViewInstanceExceptionOccurrenceExtensionsCompleteResult, error) {
