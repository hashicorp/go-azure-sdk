...
// ListProfileAwards ...
func (c ProfileAwardClient) ListProfileAwards(ctx context.Context, id UserId) (result ListProfileAwardsOperationResponse, err error) {
...
func (c ProfileAwardClient) ListProfileAwardsComplete(ctx context.Context, id UserId) (ListProfileAwardsCompleteResult, error) {
	return c.ListProfileAwardsCompleteMatchingPredicate(ctx, id, PersonAwardOperationPredicate{})
}

// ListProfileAwardsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileAwardClient) ListProfileAwardsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate PersonAwardOperationPredicate) (result ListProfileAwardsCompleteResult, err error) {
	items := make([]beta.PersonAward, 0)

	resp, err := c.ListProfileAwards(ctx, id)
	if err != nil {
