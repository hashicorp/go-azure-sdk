...
// CreateProfileAward ...
func (c ProfileAwardClient) CreateProfileAward(ctx context.Context, id UserId, input beta.PersonAward) (result CreateProfileAwardOperationResponse, err error) {
