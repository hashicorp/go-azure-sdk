...
func (c CalendarViewInstanceExceptionOccurrenceExtensionClient) ListCalendarViewInstanceExceptionOccurrenceExtensions(ctx context.Context, id UserIdCalendarViewIdInstanceIdExceptionOccurrenceId) (result ListCalendarViewInstanceExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c CalendarViewInstanceExceptionOccurrenceExtensionClient) ListCalendarViewInstanceExceptionOccurrenceExtensionsComplete(ctx context.Context, id UserIdCalendarViewIdInstanceIdExceptionOccurrenceId) (ListCalendarViewInstanceExceptionOccurrenceExtensionsCompleteResult, error) {
...
func (c CalendarViewInstanceExceptionOccurrenceExtensionClient) ListCalendarViewInstanceExceptionOccurrenceExtensionsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarViewIdInstanceIdExceptionOccurrenceId, predicate ExtensionOperationPredicate) (result ListCalendarViewInstanceExceptionOccurrenceExtensionsCompleteResult, err error) {
