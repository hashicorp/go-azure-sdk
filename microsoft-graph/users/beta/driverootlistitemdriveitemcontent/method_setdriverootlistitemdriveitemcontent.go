...
func (c DriveRootListItemDriveItemContentClient) SetDriveRootListItemDriveItemContent(ctx context.Context, id beta.UserIdDriveId, input []byte) (result SetDriveRootListItemDriveItemContentOperationResponse, err error) {
