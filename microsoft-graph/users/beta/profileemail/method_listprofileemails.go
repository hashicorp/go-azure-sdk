...
// ListProfileEmails ...
func (c ProfileEmailClient) ListProfileEmails(ctx context.Context, id UserId) (result ListProfileEmailsOperationResponse, err error) {
...
func (c ProfileEmailClient) ListProfileEmailsComplete(ctx context.Context, id UserId) (ListProfileEmailsCompleteResult, error) {
	return c.ListProfileEmailsCompleteMatchingPredicate(ctx, id, ItemEmailOperationPredicate{})
}

// ListProfileEmailsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileEmailClient) ListProfileEmailsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate ItemEmailOperationPredicate) (result ListProfileEmailsCompleteResult, err error) {
	items := make([]beta.ItemEmail, 0)

	resp, err := c.ListProfileEmails(ctx, id)
	if err != nil {
