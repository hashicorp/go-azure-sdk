...
func (c ProfileWebAccountClient) ListProfileWebAccounts(ctx context.Context, id UserId) (result ListProfileWebAccountsOperationResponse, err error) {
...
func (c ProfileWebAccountClient) ListProfileWebAccountsComplete(ctx context.Context, id UserId) (ListProfileWebAccountsCompleteResult, error) {
	return c.ListProfileWebAccountsCompleteMatchingPredicate(ctx, id, WebAccountOperationPredicate{})
}

// ListProfileWebAccountsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileWebAccountClient) ListProfileWebAccountsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate WebAccountOperationPredicate) (result ListProfileWebAccountsCompleteResult, err error) {
	items := make([]beta.WebAccount, 0)

	resp, err := c.ListProfileWebAccounts(ctx, id)
	if err != nil {
