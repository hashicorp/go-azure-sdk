...
func (c EventExceptionOccurrenceInstanceExtensionClient) ListEventExceptionOccurrenceInstanceExtensions(ctx context.Context, id UserIdEventIdExceptionOccurrenceIdInstanceId) (result ListEventExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceInstanceExtensionClient) ListEventExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id UserIdEventIdExceptionOccurrenceIdInstanceId) (ListEventExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
