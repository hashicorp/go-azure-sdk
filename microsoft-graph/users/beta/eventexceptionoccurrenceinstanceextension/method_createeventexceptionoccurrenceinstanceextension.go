...
func (c EventExceptionOccurrenceInstanceExtensionClient) CreateEventExceptionOccurrenceInstanceExtension(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceIdInstanceId, input beta.Extension) (result CreateEventExceptionOccurrenceInstanceExtensionOperationResponse, err error) {
