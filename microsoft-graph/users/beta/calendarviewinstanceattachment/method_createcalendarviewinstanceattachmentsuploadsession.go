...
func (c CalendarViewInstanceAttachmentClient) CreateCalendarViewInstanceAttachmentsUploadSession(ctx context.Context, id beta.UserIdCalendarViewIdInstanceId, input CreateCalendarViewInstanceAttachmentsUploadSessionRequest) (result CreateCalendarViewInstanceAttachmentsUploadSessionOperationResponse, err error) {
