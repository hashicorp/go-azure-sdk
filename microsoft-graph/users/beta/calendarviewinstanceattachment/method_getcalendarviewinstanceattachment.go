...
func (c CalendarViewInstanceAttachmentClient) GetCalendarViewInstanceAttachment(ctx context.Context, id beta.UserIdCalendarViewIdInstanceIdAttachmentId, options GetCalendarViewInstanceAttachmentOperationOptions) (result GetCalendarViewInstanceAttachmentOperationResponse, err error) {
