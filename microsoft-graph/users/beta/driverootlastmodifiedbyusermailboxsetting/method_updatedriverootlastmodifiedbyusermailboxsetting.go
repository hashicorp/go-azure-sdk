...
func (c DriveRootLastModifiedByUserMailboxSettingClient) UpdateDriveRootLastModifiedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveId, input beta.MailboxSettings) (result UpdateDriveRootLastModifiedByUserMailboxSettingOperationResponse, err error) {
