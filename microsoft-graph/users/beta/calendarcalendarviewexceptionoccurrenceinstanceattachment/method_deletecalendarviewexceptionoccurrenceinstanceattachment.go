...
// DeleteCalendarViewExceptionOccurrenceInstanceAttachment - Delete navigation property attachments for users
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) DeleteCalendarViewExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceIdAttachmentId, options DeleteCalendarViewExceptionOccurrenceInstanceAttachmentOperationOptions) (result DeleteCalendarViewExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
