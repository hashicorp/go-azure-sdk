...
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) ListCalendarViewExceptionOccurrenceInstanceAttachmentsComplete(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId, options ListCalendarViewExceptionOccurrenceInstanceAttachmentsOperationOptions) (ListCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteResult, error) {
