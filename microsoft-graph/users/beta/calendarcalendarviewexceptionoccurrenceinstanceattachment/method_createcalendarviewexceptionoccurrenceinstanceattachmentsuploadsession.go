...
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) CreateCalendarViewExceptionOccurrenceInstanceAttachmentsUploadSession(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId, input CreateCalendarViewExceptionOccurrenceInstanceAttachmentsUploadSessionRequest) (result CreateCalendarViewExceptionOccurrenceInstanceAttachmentsUploadSessionOperationResponse, err error) {
