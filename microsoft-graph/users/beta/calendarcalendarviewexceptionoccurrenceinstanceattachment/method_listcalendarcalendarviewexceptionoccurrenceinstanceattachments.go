...
func (c CalendarCalendarViewExceptionOccurrenceInstanceAttachmentClient) ListCalendarCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId, predicate AttachmentOperationPredicate) (result ListCalendarCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteResult, err error) {
