...
func (c CalendarEventInstanceClient) DismissCalendarEventInstanceReminder(ctx context.Context, id beta.UserIdCalendarIdEventIdInstanceId) (result DismissCalendarEventInstanceReminderOperationResponse, err error) {
