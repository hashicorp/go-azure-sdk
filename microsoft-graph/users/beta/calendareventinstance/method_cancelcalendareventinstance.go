...
func (c CalendarEventInstanceClient) CancelCalendarEventInstance(ctx context.Context, id beta.UserIdCalendarEventIdInstanceId, input CancelCalendarEventInstanceRequest) (result CancelCalendarEventInstanceOperationResponse, err error) {
