...
// Read-only. Nullable.
func (c CalendarEventInstanceClient) ListCalendarEventInstances(ctx context.Context, id beta.UserIdCalendarEventId, options ListCalendarEventInstancesOperationOptions) (result ListCalendarEventInstancesOperationResponse, err error) {
...
func (c CalendarEventInstanceClient) ListCalendarEventInstancesComplete(ctx context.Context, id beta.UserIdCalendarEventId, options ListCalendarEventInstancesOperationOptions) (ListCalendarEventInstancesCompleteResult, error) {
...
func (c CalendarEventInstanceClient) ListCalendarEventInstancesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarEventId, options ListCalendarEventInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarEventInstancesCompleteResult, err error) {
