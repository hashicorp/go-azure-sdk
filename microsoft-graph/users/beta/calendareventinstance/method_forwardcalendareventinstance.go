...
// Outlook.com account.
func (c CalendarEventInstanceClient) ForwardCalendarEventInstance(ctx context.Context, id beta.UserIdCalendarIdEventIdInstanceId, input ForwardCalendarEventInstanceRequest) (result ForwardCalendarEventInstanceOperationResponse, err error) {
