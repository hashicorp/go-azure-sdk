...
// GetCalendarEventInstance - Get instances from users. The occurrences of a recurring series, if the event is a series
...
// Nullable.
func (c CalendarEventInstanceClient) GetCalendarEventInstance(ctx context.Context, id beta.UserIdCalendarIdEventIdInstanceId, options GetCalendarEventInstanceOperationOptions) (result GetCalendarEventInstanceOperationResponse, err error) {
