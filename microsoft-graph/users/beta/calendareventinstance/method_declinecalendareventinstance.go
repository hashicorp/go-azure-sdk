...
func (c CalendarEventInstanceClient) DeclineCalendarEventInstance(ctx context.Context, id beta.UserIdCalendarIdEventIdInstanceId, input DeclineCalendarEventInstanceRequest) (result DeclineCalendarEventInstanceOperationResponse, err error) {
