...
func (c CalendarEventInstanceClient) TentativelyAcceptCalendarEventInstance(ctx context.Context, id beta.UserIdCalendarIdEventIdInstanceId, input TentativelyAcceptCalendarEventInstanceRequest) (result TentativelyAcceptCalendarEventInstanceOperationResponse, err error) {
