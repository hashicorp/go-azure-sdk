...
func (c DriveListColumnClient) CreateDriveListColumn(ctx context.Context, id beta.UserIdDriveId, input beta.ColumnDefinition) (result CreateDriveListColumnOperationResponse, err error) {
