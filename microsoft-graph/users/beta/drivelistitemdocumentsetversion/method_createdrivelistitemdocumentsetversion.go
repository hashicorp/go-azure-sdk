...
func (c DriveListItemDocumentSetVersionClient) CreateDriveListItemDocumentSetVersion(ctx context.Context, id beta.UserIdDriveIdListItemId, input beta.DocumentSetVersion) (result CreateDriveListItemDocumentSetVersionOperationResponse, err error) {
