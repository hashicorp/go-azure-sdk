...
func (c DeviceEnrollmentConfigurationClient) ListDeviceEnrollmentConfigurations(ctx context.Context, id UserId) (result ListDeviceEnrollmentConfigurationsOperationResponse, err error) {
...
func (c DeviceEnrollmentConfigurationClient) ListDeviceEnrollmentConfigurationsComplete(ctx context.Context, id UserId) (ListDeviceEnrollmentConfigurationsCompleteResult, error) {
	return c.ListDeviceEnrollmentConfigurationsCompleteMatchingPredicate(ctx, id, DeviceEnrollmentConfigurationOperationPredicate{})
}

// ListDeviceEnrollmentConfigurationsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c DeviceEnrollmentConfigurationClient) ListDeviceEnrollmentConfigurationsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate DeviceEnrollmentConfigurationOperationPredicate) (result ListDeviceEnrollmentConfigurationsCompleteResult, err error) {
	items := make([]beta.DeviceEnrollmentConfiguration, 0)

	resp, err := c.ListDeviceEnrollmentConfigurations(ctx, id)
	if err != nil {
