...
func (c ScopedRoleMemberOfClient) ListScopedRoleMemberOf(ctx context.Context, id UserId) (result ListScopedRoleMemberOfOperationResponse, err error) {
...
func (c ScopedRoleMemberOfClient) ListScopedRoleMemberOfComplete(ctx context.Context, id UserId) (ListScopedRoleMemberOfCompleteResult, error) {
	return c.ListScopedRoleMemberOfCompleteMatchingPredicate(ctx, id, ScopedRoleMembershipOperationPredicate{})
}

// ListScopedRoleMemberOfCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ScopedRoleMemberOfClient) ListScopedRoleMemberOfCompleteMatchingPredicate(ctx context.Context, id UserId, predicate ScopedRoleMembershipOperationPredicate) (result ListScopedRoleMemberOfCompleteResult, err error) {
	items := make([]beta.ScopedRoleMembership, 0)

	resp, err := c.ListScopedRoleMemberOf(ctx, id)
	if err != nil {
