...
func (c CalendarViewInstanceExceptionOccurrenceClient) ListCalendarViewInstanceExceptionOccurrences(ctx context.Context, id UserIdCalendarViewIdInstanceId) (result ListCalendarViewInstanceExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarViewInstanceExceptionOccurrenceClient) ListCalendarViewInstanceExceptionOccurrencesComplete(ctx context.Context, id UserIdCalendarViewIdInstanceId) (ListCalendarViewInstanceExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarViewInstanceExceptionOccurrenceClient) ListCalendarViewInstanceExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarViewIdInstanceId, predicate EventOperationPredicate) (result ListCalendarViewInstanceExceptionOccurrencesCompleteResult, err error) {
