...
func (c CalendarViewInstanceExceptionOccurrenceClient) SnoozeCalendarViewInstanceExceptionOccurrenceReminder(ctx context.Context, id beta.UserIdCalendarViewIdInstanceIdExceptionOccurrenceId, input SnoozeCalendarViewInstanceExceptionOccurrenceReminderRequest) (result SnoozeCalendarViewInstanceExceptionOccurrenceReminderOperationResponse, err error) {
