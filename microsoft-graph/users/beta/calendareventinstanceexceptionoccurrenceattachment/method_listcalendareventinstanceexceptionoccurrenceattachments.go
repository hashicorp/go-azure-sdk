...
func (c CalendarEventInstanceExceptionOccurrenceAttachmentClient) ListCalendarEventInstanceExceptionOccurrenceAttachments(ctx context.Context, id UserIdCalendarEventIdInstanceIdExceptionOccurrenceId) (result ListCalendarEventInstanceExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarEventInstanceExceptionOccurrenceAttachmentClient) ListCalendarEventInstanceExceptionOccurrenceAttachmentsComplete(ctx context.Context, id UserIdCalendarEventIdInstanceIdExceptionOccurrenceId) (ListCalendarEventInstanceExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c CalendarEventInstanceExceptionOccurrenceAttachmentClient) ListCalendarEventInstanceExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarEventIdInstanceIdExceptionOccurrenceId, predicate AttachmentOperationPredicate) (result ListCalendarEventInstanceExceptionOccurrenceAttachmentsCompleteResult, err error) {
