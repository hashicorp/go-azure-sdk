...
// GetCalendarEventInstanceExceptionOccurrenceAttachment - Get attachments from users. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarEventInstanceExceptionOccurrenceAttachmentClient) GetCalendarEventInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdAttachmentId, options GetCalendarEventInstanceExceptionOccurrenceAttachmentOperationOptions) (result GetCalendarEventInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
