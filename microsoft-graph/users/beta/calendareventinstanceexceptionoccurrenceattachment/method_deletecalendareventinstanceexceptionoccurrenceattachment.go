...
// DeleteCalendarEventInstanceExceptionOccurrenceAttachment - Delete navigation property attachments for users
func (c CalendarEventInstanceExceptionOccurrenceAttachmentClient) DeleteCalendarEventInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarEventInstanceExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarEventInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
