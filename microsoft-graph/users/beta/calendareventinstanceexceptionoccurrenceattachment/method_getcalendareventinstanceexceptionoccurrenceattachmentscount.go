...
func (c CalendarEventInstanceExceptionOccurrenceAttachmentClient) GetCalendarEventInstanceExceptionOccurrenceAttachmentsCount(ctx context.Context, id beta.UserIdCalendarIdEventIdInstanceIdExceptionOccurrenceId, options GetCalendarEventInstanceExceptionOccurrenceAttachmentsCountOperationOptions) (result GetCalendarEventInstanceExceptionOccurrenceAttachmentsCountOperationResponse, err error) {
