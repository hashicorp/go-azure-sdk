...
// Outlook.com account.
func (c CalendarViewClient) ForwardCalendarView(ctx context.Context, id beta.UserIdCalendarViewId, input ForwardCalendarViewRequest) (result ForwardCalendarViewOperationResponse, err error) {
