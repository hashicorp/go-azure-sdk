...
func (c CalendarViewClient) GetCalendarView(ctx context.Context, id beta.UserIdCalendarViewId, options GetCalendarViewOperationOptions) (result GetCalendarViewOperationResponse, err error) {
