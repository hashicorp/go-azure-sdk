...
// a new time.
func (c CalendarViewClient) SnoozeCalendarViewReminder(ctx context.Context, id beta.UserIdCalendarViewId, input SnoozeCalendarViewReminderRequest) (result SnoozeCalendarViewReminderOperationResponse, err error) {
