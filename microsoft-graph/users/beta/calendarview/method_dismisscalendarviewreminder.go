...
// in a user calendar.
func (c CalendarViewClient) DismissCalendarViewReminder(ctx context.Context, id beta.UserIdCalendarViewId) (result DismissCalendarViewReminderOperationResponse, err error) {
