...
func (c CalendarViewClient) DeclineCalendarView(ctx context.Context, id beta.UserIdCalendarViewId, input DeclineCalendarViewRequest) (result DeclineCalendarViewOperationResponse, err error) {
