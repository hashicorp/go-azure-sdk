...
func (c CalendarViewClient) GetCalendarViewCount(ctx context.Context, id beta.UserId, options GetCalendarViewCountOperationOptions) (result GetCalendarViewCountOperationResponse, err error) {
