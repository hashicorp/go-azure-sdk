...
func (c CalendarViewClient) TentativelyAcceptCalendarView(ctx context.Context, id beta.UserIdCalendarViewId, input TentativelyAcceptCalendarViewRequest) (result TentativelyAcceptCalendarViewOperationResponse, err error) {
