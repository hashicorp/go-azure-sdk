...
func (c CalendarViewClient) CancelCalendarView(ctx context.Context, id beta.UserIdCalendarViewId, input CancelCalendarViewRequest) (result CancelCalendarViewOperationResponse, err error) {
