...
func TestNewUserOutlookTaskFolderTaskAttachmentID(t *testing.T) {
	id := NewUserOutlookTaskFolderTaskAttachmentID("userIdValue", "outlookTaskFolderIdValue", "outlookTaskIdValue", "attachmentIdValue")
...
func TestFormatUserOutlookTaskFolderTaskAttachmentID(t *testing.T) {
	actual := NewUserOutlookTaskFolderTaskAttachmentID("userIdValue", "outlookTaskFolderIdValue", "outlookTaskIdValue", "attachmentIdValue").ID()
...
func TestParseUserOutlookTaskFolderTaskAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserOutlookTaskFolderTaskAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserOutlookTaskFolderTaskAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserOutlookTaskFolderTaskAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserOutlookTaskFolderTaskAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserOutlookTaskFolderTaskAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserOutlookTaskFolderTaskAttachmentId(t *testing.T) {
	segments := UserOutlookTaskFolderTaskAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserOutlookTaskFolderTaskAttachmentId has no segments")
	}
