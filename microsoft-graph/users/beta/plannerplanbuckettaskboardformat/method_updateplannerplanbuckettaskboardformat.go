...
func (c PlannerPlanBucketTaskBoardFormatClient) UpdatePlannerPlanBucketTaskBoardFormat(ctx context.Context, id beta.UserIdPlannerPlanIdBucketIdTaskId, input beta.PlannerBucketTaskBoardTaskFormat, options UpdatePlannerPlanBucketTaskBoardFormatOperationOptions) (result UpdatePlannerPlanBucketTaskBoardFormatOperationResponse, err error) {
