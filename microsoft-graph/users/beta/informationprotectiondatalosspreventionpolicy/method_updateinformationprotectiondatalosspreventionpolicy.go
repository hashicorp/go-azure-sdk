...
func (c InformationProtectionDataLossPreventionPolicyClient) UpdateInformationProtectionDataLossPreventionPolicy(ctx context.Context, id UserIdInformationProtectionDataLossPreventionPolicyId, input beta.DataLossPreventionPolicy) (result UpdateInformationProtectionDataLossPreventionPolicyOperationResponse, err error) {
