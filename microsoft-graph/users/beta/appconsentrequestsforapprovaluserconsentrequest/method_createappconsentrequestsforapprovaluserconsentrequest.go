...
func (c AppConsentRequestsForApprovalUserConsentRequestClient) CreateAppConsentRequestsForApprovalUserConsentRequest(ctx context.Context, id UserIdAppConsentRequestsForApprovalId, input beta.UserConsentRequest) (result CreateAppConsentRequestsForApprovalUserConsentRequestOperationResponse, err error) {
