...
// GetDriveRootExtension - Get extensions from users. The collection of open extensions defined for this item. Nullable.
func (c DriveRootExtensionClient) GetDriveRootExtension(ctx context.Context, id beta.UserIdDriveIdRootExtensionId, options GetDriveRootExtensionOperationOptions) (result GetDriveRootExtensionOperationResponse, err error) {
