...
// CreateDriveRootExtension - Create new navigation property to extensions for users
func (c DriveRootExtensionClient) CreateDriveRootExtension(ctx context.Context, id beta.UserIdDriveId, input beta.Extension, options CreateDriveRootExtensionOperationOptions) (result CreateDriveRootExtensionOperationResponse, err error) {
