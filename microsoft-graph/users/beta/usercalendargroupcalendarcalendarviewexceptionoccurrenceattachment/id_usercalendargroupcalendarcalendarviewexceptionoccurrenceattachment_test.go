...
func TestNewUserCalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentID(t *testing.T) {
	id := NewUserCalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue")
...
func TestFormatUserCalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentID(t *testing.T) {
	actual := NewUserCalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue").ID()
...
func TestParseUserCalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentId(t *testing.T) {
	segments := UserCalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentId has no segments")
	}
