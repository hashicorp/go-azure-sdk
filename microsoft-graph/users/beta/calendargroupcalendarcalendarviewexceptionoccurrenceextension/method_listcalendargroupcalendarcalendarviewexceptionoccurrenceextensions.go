...
func (c CalendarGroupCalendarCalendarViewExceptionOccurrenceExtensionClient) ListCalendarGroupCalendarCalendarViewExceptionOccurrenceExtensionsComplete(ctx context.Context, id UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId) (ListCalendarGroupCalendarCalendarViewExceptionOccurrenceExtensionsCompleteResult, error) {
