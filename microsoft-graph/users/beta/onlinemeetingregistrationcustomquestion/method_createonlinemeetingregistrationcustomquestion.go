...
func (c OnlineMeetingRegistrationCustomQuestionClient) CreateOnlineMeetingRegistrationCustomQuestion(ctx context.Context, id beta.UserIdOnlineMeetingId, input beta.MeetingRegistrationQuestion) (result CreateOnlineMeetingRegistrationCustomQuestionOperationResponse, err error) {
