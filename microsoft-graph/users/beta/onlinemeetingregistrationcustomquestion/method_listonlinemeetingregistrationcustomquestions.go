...
func (c OnlineMeetingRegistrationCustomQuestionClient) ListOnlineMeetingRegistrationCustomQuestions(ctx context.Context, id UserIdOnlineMeetingId) (result ListOnlineMeetingRegistrationCustomQuestionsOperationResponse, err error) {
...
func (c OnlineMeetingRegistrationCustomQuestionClient) ListOnlineMeetingRegistrationCustomQuestionsComplete(ctx context.Context, id UserIdOnlineMeetingId) (ListOnlineMeetingRegistrationCustomQuestionsCompleteResult, error) {
...
func (c OnlineMeetingRegistrationCustomQuestionClient) ListOnlineMeetingRegistrationCustomQuestionsCompleteMatchingPredicate(ctx context.Context, id UserIdOnlineMeetingId, predicate MeetingRegistrationQuestionOperationPredicate) (result ListOnlineMeetingRegistrationCustomQuestionsCompleteResult, err error) {
