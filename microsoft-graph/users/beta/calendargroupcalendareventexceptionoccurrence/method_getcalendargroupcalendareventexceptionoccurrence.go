...
// GetCalendarGroupCalendarEventExceptionOccurrence - Get exceptionOccurrences from users
func (c CalendarGroupCalendarEventExceptionOccurrenceClient) GetCalendarGroupCalendarEventExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceId, options GetCalendarGroupCalendarEventExceptionOccurrenceOperationOptions) (result GetCalendarGroupCalendarEventExceptionOccurrenceOperationResponse, err error) {
