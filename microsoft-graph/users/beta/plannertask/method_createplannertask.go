...
func (c PlannerTaskClient) CreatePlannerTask(ctx context.Context, id beta.UserId, input beta.PlannerTask) (result CreatePlannerTaskOperationResponse, err error) {
