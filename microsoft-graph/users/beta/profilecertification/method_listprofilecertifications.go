...
func (c ProfileCertificationClient) ListProfileCertifications(ctx context.Context, id UserId) (result ListProfileCertificationsOperationResponse, err error) {
...
func (c ProfileCertificationClient) ListProfileCertificationsComplete(ctx context.Context, id UserId) (ListProfileCertificationsCompleteResult, error) {
	return c.ListProfileCertificationsCompleteMatchingPredicate(ctx, id, PersonCertificationOperationPredicate{})
}

// ListProfileCertificationsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileCertificationClient) ListProfileCertificationsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate PersonCertificationOperationPredicate) (result ListProfileCertificationsCompleteResult, err error) {
	items := make([]beta.PersonCertification, 0)

	resp, err := c.ListProfileCertifications(ctx, id)
	if err != nil {
