...
func (c ProfileCertificationClient) GetProfileCertification(ctx context.Context, id UserIdProfileCertificationId) (result GetProfileCertificationOperationResponse, err error) {
