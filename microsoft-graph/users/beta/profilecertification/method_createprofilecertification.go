...
func (c ProfileCertificationClient) CreateProfileCertification(ctx context.Context, id UserId, input beta.PersonCertification) (result CreateProfileCertificationOperationResponse, err error) {
