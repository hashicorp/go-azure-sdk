...
func (c ChatInstalledAppClient) ListChatInstalledApps(ctx context.Context, id UserIdChatId) (result ListChatInstalledAppsOperationResponse, err error) {
	...
	var values struct {
		Values *[]beta.TeamsAppInstallation `json:"value"`
	}
...
func (c ChatInstalledAppClient) ListChatInstalledAppsComplete(ctx context.Context, id UserIdChatId) (ListChatInstalledAppsCompleteResult, error) {
...
func (c ChatInstalledAppClient) ListChatInstalledAppsCompleteMatchingPredicate(ctx context.Context, id UserIdChatId, predicate TeamsAppInstallationOperationPredicate) (result ListChatInstalledAppsCompleteResult, err error) {
