...
func NewUserCalendarCalendarViewInstanceExtensionID(userId string, calendarId string, eventId string, eventId1 string, extensionId string) UserCalendarCalendarViewInstanceExtensionId {
