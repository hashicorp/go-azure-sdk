...
func (c AuthenticationMethodClient) ResetAuthenticationMethodPassword(ctx context.Context, id beta.UserIdAuthenticationMethodId, input ResetAuthenticationMethodPasswordRequest) (result ResetAuthenticationMethodPasswordOperationResponse, err error) {
