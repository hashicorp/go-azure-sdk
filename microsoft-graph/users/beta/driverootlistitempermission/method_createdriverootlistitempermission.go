...
func (c DriveRootListItemPermissionClient) CreateDriveRootListItemPermission(ctx context.Context, id beta.UserIdDriveId, input beta.Permission) (result CreateDriveRootListItemPermissionOperationResponse, err error) {
