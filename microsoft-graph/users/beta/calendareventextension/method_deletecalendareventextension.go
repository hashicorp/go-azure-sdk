...
func (c CalendarEventExtensionClient) DeleteCalendarEventExtension(ctx context.Context, id beta.UserIdCalendarEventIdExtensionId, options DeleteCalendarEventExtensionOperationOptions) (result DeleteCalendarEventExtensionOperationResponse, err error) {
