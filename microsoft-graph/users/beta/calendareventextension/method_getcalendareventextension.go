...
// Nullable.
func (c CalendarEventExtensionClient) GetCalendarEventExtension(ctx context.Context, id beta.UserIdCalendarEventIdExtensionId, options GetCalendarEventExtensionOperationOptions) (result GetCalendarEventExtensionOperationResponse, err error) {
