...
func (c CalendarEventExtensionClient) ListCalendarEventExtensions(ctx context.Context, id UserIdCalendarIdEventId) (result ListCalendarEventExtensionsOperationResponse, err error) {
...
func (c CalendarEventExtensionClient) ListCalendarEventExtensionsComplete(ctx context.Context, id UserIdCalendarIdEventId) (ListCalendarEventExtensionsCompleteResult, error) {
...
func (c CalendarEventExtensionClient) ListCalendarEventExtensionsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarIdEventId, predicate ExtensionOperationPredicate) (result ListCalendarEventExtensionsCompleteResult, err error) {
