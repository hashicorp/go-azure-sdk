...
// Nullable.
func (c CalendarEventExtensionClient) ListCalendarEventExtensions(ctx context.Context, id beta.UserIdCalendarIdEventId, options ListCalendarEventExtensionsOperationOptions) (result ListCalendarEventExtensionsOperationResponse, err error) {
...
func (c CalendarEventExtensionClient) ListCalendarEventExtensionsComplete(ctx context.Context, id beta.UserIdCalendarIdEventId, options ListCalendarEventExtensionsOperationOptions) (ListCalendarEventExtensionsCompleteResult, error) {
...
func (c CalendarEventExtensionClient) ListCalendarEventExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarIdEventId, options ListCalendarEventExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarEventExtensionsCompleteResult, err error) {
