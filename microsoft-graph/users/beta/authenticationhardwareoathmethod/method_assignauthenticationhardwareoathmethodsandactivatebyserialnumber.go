...
func (c AuthenticationHardwareOathMethodClient) AssignAuthenticationHardwareOathMethodsAndActivateBySerialNumber(ctx context.Context, id beta.UserId, input AssignAuthenticationHardwareOathMethodsAndActivateBySerialNumberRequest, options AssignAuthenticationHardwareOathMethodsAndActivateBySerialNumberOperationOptions) (result AssignAuthenticationHardwareOathMethodsAndActivateBySerialNumberOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/authentication/hardwareOathMethods/assignAndActivateBySerialNumber", id.ID()),
