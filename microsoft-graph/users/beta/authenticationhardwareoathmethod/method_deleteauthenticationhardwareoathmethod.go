...
// DeleteAuthenticationHardwareOathMethod - Delete navigation property hardwareOathMethods for users
func (c AuthenticationHardwareOathMethodClient) DeleteAuthenticationHardwareOathMethod(ctx context.Context, id beta.UserIdAuthenticationHardwareOathMethodId, options DeleteAuthenticationHardwareOathMethodOperationOptions) (result DeleteAuthenticationHardwareOathMethodOperationResponse, err error) {
