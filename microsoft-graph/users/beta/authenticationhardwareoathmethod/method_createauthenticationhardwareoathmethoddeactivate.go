...
func (c AuthenticationHardwareOathMethodClient) CreateAuthenticationHardwareOathMethodDeactivate(ctx context.Context, id beta.UserIdAuthenticationHardwareOathMethodId, options CreateAuthenticationHardwareOathMethodDeactivateOperationOptions) (result CreateAuthenticationHardwareOathMethodDeactivateOperationResponse, err error) {
