...
// Engage.
func (c EmployeeExperienceAssignedRoleClient) ListEmployeeExperienceAssignedRoles(ctx context.Context, id beta.UserId, options ListEmployeeExperienceAssignedRolesOperationOptions) (result ListEmployeeExperienceAssignedRolesOperationResponse, err error) {
...
func (c EmployeeExperienceAssignedRoleClient) ListEmployeeExperienceAssignedRolesComplete(ctx context.Context, id beta.UserId, options ListEmployeeExperienceAssignedRolesOperationOptions) (ListEmployeeExperienceAssignedRolesCompleteResult, error) {
	return c.ListEmployeeExperienceAssignedRolesCompleteMatchingPredicate(ctx, id, options, EngagementRoleOperationPredicate{})
}

// ListEmployeeExperienceAssignedRolesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c EmployeeExperienceAssignedRoleClient) ListEmployeeExperienceAssignedRolesCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListEmployeeExperienceAssignedRolesOperationOptions, predicate EngagementRoleOperationPredicate) (result ListEmployeeExperienceAssignedRolesCompleteResult, err error) {
	items := make([]beta.EngagementRole, 0)

	resp, err := c.ListEmployeeExperienceAssignedRoles(ctx, id, options)
	if err != nil {
