...
func (c TransitiveMemberOfClient) GetTransitiveMemberOfGroupCount(ctx context.Context, id beta.UserId, options GetTransitiveMemberOfGroupCountOperationOptions) (result GetTransitiveMemberOfGroupCountOperationResponse, err error) {
