...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfDirectoryRoles(ctx context.Context, id beta.UserId, options ListTransitiveMemberOfDirectoryRolesOperationOptions) (result ListTransitiveMemberOfDirectoryRolesOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/transitiveMemberOf/directoryRole", id.ID()),
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfDirectoryRolesComplete(ctx context.Context, id beta.UserId, options ListTransitiveMemberOfDirectoryRolesOperationOptions) (ListTransitiveMemberOfDirectoryRolesCompleteResult, error) {
	return c.ListTransitiveMemberOfDirectoryRolesCompleteMatchingPredicate(ctx, id, options, DirectoryRoleOperationPredicate{})
}

// ListTransitiveMemberOfDirectoryRolesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c TransitiveMemberOfClient) ListTransitiveMemberOfDirectoryRolesCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListTransitiveMemberOfDirectoryRolesOperationOptions, predicate DirectoryRoleOperationPredicate) (result ListTransitiveMemberOfDirectoryRolesCompleteResult, err error) {
	items := make([]beta.DirectoryRole, 0)

	resp, err := c.ListTransitiveMemberOfDirectoryRoles(ctx, id, options)
	if err != nil {
