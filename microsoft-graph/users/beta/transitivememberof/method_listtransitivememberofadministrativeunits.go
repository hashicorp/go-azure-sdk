...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfAdministrativeUnits(ctx context.Context, id beta.UserId, options ListTransitiveMemberOfAdministrativeUnitsOperationOptions) (result ListTransitiveMemberOfAdministrativeUnitsOperationResponse, err error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfAdministrativeUnitsComplete(ctx context.Context, id beta.UserId, options ListTransitiveMemberOfAdministrativeUnitsOperationOptions) (ListTransitiveMemberOfAdministrativeUnitsCompleteResult, error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfAdministrativeUnitsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListTransitiveMemberOfAdministrativeUnitsOperationOptions, predicate AdministrativeUnitOperationPredicate) (result ListTransitiveMemberOfAdministrativeUnitsCompleteResult, err error) {
