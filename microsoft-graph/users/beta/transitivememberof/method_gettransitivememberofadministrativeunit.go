...
func (c TransitiveMemberOfClient) GetTransitiveMemberOfAdministrativeUnit(ctx context.Context, id beta.UserIdTransitiveMemberOfId, options GetTransitiveMemberOfAdministrativeUnitOperationOptions) (result GetTransitiveMemberOfAdministrativeUnitOperationResponse, err error) {
