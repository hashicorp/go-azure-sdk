...
func TestNewUserContactFolderChildFolderContactID(t *testing.T) {
	id := NewUserContactFolderChildFolderContactID("userIdValue", "contactFolderIdValue", "contactFolderId1Value", "contactIdValue")
...
func TestFormatUserContactFolderChildFolderContactID(t *testing.T) {
	actual := NewUserContactFolderChildFolderContactID("userIdValue", "contactFolderIdValue", "contactFolderId1Value", "contactIdValue").ID()
...
func TestParseUserContactFolderChildFolderContactID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserContactFolderChildFolderContactId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserContactFolderChildFolderContactID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserContactFolderChildFolderContactIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserContactFolderChildFolderContactId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserContactFolderChildFolderContactIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserContactFolderChildFolderContactId(t *testing.T) {
	segments := UserContactFolderChildFolderContactId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserContactFolderChildFolderContactId has no segments")
	}
