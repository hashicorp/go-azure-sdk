...
func (c AuthenticationPhoneMethodClient) ListAuthenticationPhoneMethods(ctx context.Context, id UserId) (result ListAuthenticationPhoneMethodsOperationResponse, err error) {
...
func (c AuthenticationPhoneMethodClient) ListAuthenticationPhoneMethodsComplete(ctx context.Context, id UserId) (ListAuthenticationPhoneMethodsCompleteResult, error) {
	return c.ListAuthenticationPhoneMethodsCompleteMatchingPredicate(ctx, id, PhoneAuthenticationMethodOperationPredicate{})
}

// ListAuthenticationPhoneMethodsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AuthenticationPhoneMethodClient) ListAuthenticationPhoneMethodsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate PhoneAuthenticationMethodOperationPredicate) (result ListAuthenticationPhoneMethodsCompleteResult, err error) {
	items := make([]beta.PhoneAuthenticationMethod, 0)

	resp, err := c.ListAuthenticationPhoneMethods(ctx, id)
	if err != nil {
