...
func (c MailFolderMessageRuleClient) CreateMailFolderMessageRule(ctx context.Context, id beta.UserIdMailFolderId, input beta.MessageRule) (result CreateMailFolderMessageRuleOperationResponse, err error) {
