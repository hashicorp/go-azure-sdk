...
func (c MailFolderOperationClient) GetMailFolderOperationsCount(ctx context.Context, id beta.UserIdMailFolderId, options GetMailFolderOperationsCountOperationOptions) (result GetMailFolderOperationsCountOperationResponse, err error) {
