...
// ListMailFolderOperations - Get operations from users. The collection of long-running operations in the mailFolder.
func (c MailFolderOperationClient) ListMailFolderOperations(ctx context.Context, id beta.UserIdMailFolderId, options ListMailFolderOperationsOperationOptions) (result ListMailFolderOperationsOperationResponse, err error) {
...
func (c MailFolderOperationClient) ListMailFolderOperationsComplete(ctx context.Context, id beta.UserIdMailFolderId, options ListMailFolderOperationsOperationOptions) (ListMailFolderOperationsCompleteResult, error) {
...
func (c MailFolderOperationClient) ListMailFolderOperationsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdMailFolderId, options ListMailFolderOperationsOperationOptions, predicate MailFolderOperationOperationPredicate) (result ListMailFolderOperationsCompleteResult, err error) {
