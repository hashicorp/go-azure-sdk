...
// GetMailFolderOperation - Get operations from users. The collection of long-running operations in the mailFolder.
func (c MailFolderOperationClient) GetMailFolderOperation(ctx context.Context, id beta.UserIdMailFolderIdOperationId, options GetMailFolderOperationOperationOptions) (result GetMailFolderOperationOperationResponse, err error) {
