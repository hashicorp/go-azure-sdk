...
// messages in a chat.
func (c ChatMessageClient) ReplyChatMessagesWithQuote(ctx context.Context, id beta.UserIdChatId, input ReplyChatMessagesWithQuoteRequest, options ReplyChatMessagesWithQuoteOperationOptions) (result ReplyChatMessagesWithQuoteOperationResponse, err error) {
