...
// ListChatMessages ...
func (c ChatMessageClient) ListChatMessages(ctx context.Context, id UserIdChatId) (result ListChatMessagesOperationResponse, err error) {
...
func (c ChatMessageClient) ListChatMessagesComplete(ctx context.Context, id UserIdChatId) (ListChatMessagesCompleteResult, error) {
...
func (c ChatMessageClient) ListChatMessagesCompleteMatchingPredicate(ctx context.Context, id UserIdChatId, predicate ChatMessageOperationPredicate) (result ListChatMessagesCompleteResult, err error) {
