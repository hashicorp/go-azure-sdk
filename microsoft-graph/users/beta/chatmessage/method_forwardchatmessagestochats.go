...
func (c ChatMessageClient) ForwardChatMessagesToChats(ctx context.Context, id beta.UserIdChatId, input ForwardChatMessagesToChatsRequest, options ForwardChatMessagesToChatsOperationOptions) (result ForwardChatMessagesToChatsOperationResponse, err error) {
...
func (c ChatMessageClient) ForwardChatMessagesToChatsComplete(ctx context.Context, id beta.UserIdChatId, input ForwardChatMessagesToChatsRequest, options ForwardChatMessagesToChatsOperationOptions) (ForwardChatMessagesToChatsCompleteResult, error) {
