...
// ListCalendarEventInstanceExceptionOccurrenceExtensions - Get extensions from users. The collection of open extensions
// defined for the event. Nullable.
func (c CalendarEventInstanceExceptionOccurrenceExtensionClient) ListCalendarEventInstanceExceptionOccurrenceExtensions(ctx context.Context, id beta.UserIdCalendarIdEventIdInstanceIdExceptionOccurrenceId, options ListCalendarEventInstanceExceptionOccurrenceExtensionsOperationOptions) (result ListCalendarEventInstanceExceptionOccurrenceExtensionsOperationResponse, err error) {
