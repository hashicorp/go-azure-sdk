...
func (c ManagedDeviceHealthScriptStateClient) GetManagedDeviceHealthScriptStatesCount(ctx context.Context, id beta.UserIdManagedDeviceId, options GetManagedDeviceHealthScriptStatesCountOperationOptions) (result GetManagedDeviceHealthScriptStatesCountOperationResponse, err error) {
