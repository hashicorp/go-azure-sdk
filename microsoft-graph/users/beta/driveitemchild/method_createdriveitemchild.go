...
func (c DriveItemChildClient) CreateDriveItemChild(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.DriveItem) (result CreateDriveItemChildOperationResponse, err error) {
