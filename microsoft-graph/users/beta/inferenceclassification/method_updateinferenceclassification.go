...
func (c InferenceClassificationClient) UpdateInferenceClassification(ctx context.Context, id UserId, input beta.InferenceClassification) (result UpdateInferenceClassificationOperationResponse, err error) {
