...
func (c EventInstanceAttachmentClient) ListEventInstanceAttachments(ctx context.Context, id UserIdEventIdInstanceId) (result ListEventInstanceAttachmentsOperationResponse, err error) {
...
func (c EventInstanceAttachmentClient) ListEventInstanceAttachmentsComplete(ctx context.Context, id UserIdEventIdInstanceId) (ListEventInstanceAttachmentsCompleteResult, error) {
...
func (c EventInstanceAttachmentClient) ListEventInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdEventIdInstanceId, predicate AttachmentOperationPredicate) (result ListEventInstanceAttachmentsCompleteResult, err error) {
