...
func (c EventInstanceAttachmentClient) CreateEventInstanceAttachmentsUploadSession(ctx context.Context, id beta.UserIdEventIdInstanceId, input CreateEventInstanceAttachmentsUploadSessionRequest) (result CreateEventInstanceAttachmentsUploadSessionOperationResponse, err error) {
