...
func (c DriveItemListItemActivityContentStreamClient) DeleteDriveItemListItemActivityContentStream(ctx context.Context, id beta.UserIdDriveIdItemIdListItemActivityId, options DeleteDriveItemListItemActivityContentStreamOperationOptions) (result DeleteDriveItemListItemActivityContentStreamOperationResponse, err error) {
