...
func (c MailFolderChildFolderMessageRuleClient) CreateMailFolderChildFolderMessageRule(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, input beta.MessageRule) (result CreateMailFolderChildFolderMessageRuleOperationResponse, err error) {
