...
func (c MailFolderChildFolderMessageRuleClient) ListMailFolderChildFolderMessageRules(ctx context.Context, id UserIdMailFolderIdChildFolderId) (result ListMailFolderChildFolderMessageRulesOperationResponse, err error) {
...
func (c MailFolderChildFolderMessageRuleClient) ListMailFolderChildFolderMessageRulesComplete(ctx context.Context, id UserIdMailFolderIdChildFolderId) (ListMailFolderChildFolderMessageRulesCompleteResult, error) {
...
func (c MailFolderChildFolderMessageRuleClient) ListMailFolderChildFolderMessageRulesCompleteMatchingPredicate(ctx context.Context, id UserIdMailFolderIdChildFolderId, predicate MessageRuleOperationPredicate) (result ListMailFolderChildFolderMessageRulesCompleteResult, err error) {
