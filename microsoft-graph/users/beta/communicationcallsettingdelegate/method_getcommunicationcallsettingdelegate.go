...
// GetCommunicationCallSettingDelegate - Get delegates from users. Represents the delegate settings.
func (c CommunicationCallSettingDelegateClient) GetCommunicationCallSettingDelegate(ctx context.Context, id beta.UserIdCommunicationCallSettingDelegateId, options GetCommunicationCallSettingDelegateOperationOptions) (result GetCommunicationCallSettingDelegateOperationResponse, err error) {
