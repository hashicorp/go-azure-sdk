...
// UpdateCommunicationCallSettingDelegate - Update the navigation property delegates in users
func (c CommunicationCallSettingDelegateClient) UpdateCommunicationCallSettingDelegate(ctx context.Context, id beta.UserIdCommunicationCallSettingDelegateId, input beta.DelegationSettings, options UpdateCommunicationCallSettingDelegateOperationOptions) (result UpdateCommunicationCallSettingDelegateOperationResponse, err error) {
