...
// ListCommunicationCallSettingDelegates - Get delegates from users. Represents the delegate settings.
func (c CommunicationCallSettingDelegateClient) ListCommunicationCallSettingDelegates(ctx context.Context, id beta.UserId, options ListCommunicationCallSettingDelegatesOperationOptions) (result ListCommunicationCallSettingDelegatesOperationResponse, err error) {
...
func (c CommunicationCallSettingDelegateClient) ListCommunicationCallSettingDelegatesComplete(ctx context.Context, id beta.UserId, options ListCommunicationCallSettingDelegatesOperationOptions) (ListCommunicationCallSettingDelegatesCompleteResult, error) {
	return c.ListCommunicationCallSettingDelegatesCompleteMatchingPredicate(ctx, id, options, DelegationSettingsOperationPredicate{})
}

// ListCommunicationCallSettingDelegatesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c CommunicationCallSettingDelegateClient) ListCommunicationCallSettingDelegatesCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListCommunicationCallSettingDelegatesOperationOptions, predicate DelegationSettingsOperationPredicate) (result ListCommunicationCallSettingDelegatesCompleteResult, err error) {
	items := make([]beta.DelegationSettings, 0)

	resp, err := c.ListCommunicationCallSettingDelegates(ctx, id, options)
	if err != nil {
