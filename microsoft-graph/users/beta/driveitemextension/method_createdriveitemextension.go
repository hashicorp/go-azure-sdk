...
// CreateDriveItemExtension - Create new navigation property to extensions for users
func (c DriveItemExtensionClient) CreateDriveItemExtension(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.Extension, options CreateDriveItemExtensionOperationOptions) (result CreateDriveItemExtensionOperationResponse, err error) {
