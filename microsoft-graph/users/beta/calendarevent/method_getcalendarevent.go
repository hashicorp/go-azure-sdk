...
// GetCalendarEvent - Get events from users. The events in the calendar. Navigation property. Read-only.
func (c CalendarEventClient) GetCalendarEvent(ctx context.Context, id beta.UserIdCalendarIdEventId, options GetCalendarEventOperationOptions) (result GetCalendarEventOperationResponse, err error) {
