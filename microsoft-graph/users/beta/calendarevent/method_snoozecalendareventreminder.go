...
// a new time.
func (c CalendarEventClient) SnoozeCalendarEventReminder(ctx context.Context, id beta.UserIdCalendarEventId, input SnoozeCalendarEventReminderRequest) (result SnoozeCalendarEventReminderOperationResponse, err error) {
