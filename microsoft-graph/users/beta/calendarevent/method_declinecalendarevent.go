...
func (c CalendarEventClient) DeclineCalendarEvent(ctx context.Context, id beta.UserIdCalendarIdEventId, input DeclineCalendarEventRequest) (result DeclineCalendarEventOperationResponse, err error) {
