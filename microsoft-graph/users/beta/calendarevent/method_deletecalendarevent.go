...
// DeleteCalendarEvent - Delete navigation property events for users
func (c CalendarEventClient) DeleteCalendarEvent(ctx context.Context, id beta.UserIdCalendarIdEventId, options DeleteCalendarEventOperationOptions) (result DeleteCalendarEventOperationResponse, err error) {
