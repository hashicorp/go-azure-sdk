...
func (c CalendarEventClient) TentativelyAcceptCalendarEvent(ctx context.Context, id beta.UserIdCalendarEventId, input TentativelyAcceptCalendarEventRequest) (result TentativelyAcceptCalendarEventOperationResponse, err error) {
