...
func (c CalendarEventClient) CancelCalendarEvent(ctx context.Context, id beta.UserIdCalendarEventId, input CancelCalendarEventRequest) (result CancelCalendarEventOperationResponse, err error) {
