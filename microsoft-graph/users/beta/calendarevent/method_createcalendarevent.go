...
func (c CalendarEventClient) CreateCalendarEvent(ctx context.Context, id beta.UserId, input beta.Event) (result CreateCalendarEventOperationResponse, err error) {
