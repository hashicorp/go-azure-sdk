...
// ListProfileProjects ...
func (c ProfileProjectClient) ListProfileProjects(ctx context.Context, id UserId) (result ListProfileProjectsOperationResponse, err error) {
...
func (c ProfileProjectClient) ListProfileProjectsComplete(ctx context.Context, id UserId) (ListProfileProjectsCompleteResult, error) {
	return c.ListProfileProjectsCompleteMatchingPredicate(ctx, id, ProjectParticipationOperationPredicate{})
}

// ListProfileProjectsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileProjectClient) ListProfileProjectsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate ProjectParticipationOperationPredicate) (result ListProfileProjectsCompleteResult, err error) {
	items := make([]beta.ProjectParticipation, 0)

	resp, err := c.ListProfileProjects(ctx, id)
	if err != nil {
