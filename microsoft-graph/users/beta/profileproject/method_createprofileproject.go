...
func (c ProfileProjectClient) CreateProfileProject(ctx context.Context, id UserId, input beta.ProjectParticipation) (result CreateProfileProjectOperationResponse, err error) {
