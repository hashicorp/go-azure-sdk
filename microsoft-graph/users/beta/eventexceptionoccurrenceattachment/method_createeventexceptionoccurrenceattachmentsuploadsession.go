...
func (c EventExceptionOccurrenceAttachmentClient) CreateEventExceptionOccurrenceAttachmentsUploadSession(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, input CreateEventExceptionOccurrenceAttachmentsUploadSessionRequest) (result CreateEventExceptionOccurrenceAttachmentsUploadSessionOperationResponse, err error) {
