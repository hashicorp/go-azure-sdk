...
func (c EventExceptionOccurrenceAttachmentClient) ListEventExceptionOccurrenceAttachments(ctx context.Context, id UserIdEventIdExceptionOccurrenceId) (result ListEventExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c EventExceptionOccurrenceAttachmentClient) ListEventExceptionOccurrenceAttachmentsComplete(ctx context.Context, id UserIdEventIdExceptionOccurrenceId) (ListEventExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c EventExceptionOccurrenceAttachmentClient) ListEventExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdEventIdExceptionOccurrenceId, predicate AttachmentOperationPredicate) (result ListEventExceptionOccurrenceAttachmentsCompleteResult, err error) {
