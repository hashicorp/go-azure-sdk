...
// times.
func (c CalendarEventExceptionOccurrenceInstanceClient) TentativelyAcceptCalendarEventExceptionOccurrenceInstance(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceIdInstanceId, input TentativelyAcceptCalendarEventExceptionOccurrenceInstanceRequest) (result TentativelyAcceptCalendarEventExceptionOccurrenceInstanceOperationResponse, err error) {
