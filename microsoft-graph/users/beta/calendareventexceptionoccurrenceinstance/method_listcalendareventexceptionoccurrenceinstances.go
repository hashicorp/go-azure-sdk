...
// ListCalendarEventExceptionOccurrenceInstances - Get instances from users. The occurrences of a recurring series, if
...
func (c CalendarEventExceptionOccurrenceInstanceClient) ListCalendarEventExceptionOccurrenceInstances(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceId, options ListCalendarEventExceptionOccurrenceInstancesOperationOptions) (result ListCalendarEventExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceInstanceClient) ListCalendarEventExceptionOccurrenceInstancesComplete(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceId, options ListCalendarEventExceptionOccurrenceInstancesOperationOptions) (ListCalendarEventExceptionOccurrenceInstancesCompleteResult, error) {
...
func (c CalendarEventExceptionOccurrenceInstanceClient) ListCalendarEventExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceId, options ListCalendarEventExceptionOccurrenceInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarEventExceptionOccurrenceInstancesCompleteResult, err error) {
