...
func (c CalendarEventExceptionOccurrenceInstanceClient) ListCalendarEventExceptionOccurrenceInstances(ctx context.Context, id UserIdCalendarEventIdExceptionOccurrenceId) (result ListCalendarEventExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceInstanceClient) ListCalendarEventExceptionOccurrenceInstancesComplete(ctx context.Context, id UserIdCalendarEventIdExceptionOccurrenceId) (ListCalendarEventExceptionOccurrenceInstancesCompleteResult, error) {
...
func (c CalendarEventExceptionOccurrenceInstanceClient) ListCalendarEventExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarEventIdExceptionOccurrenceId, predicate EventOperationPredicate) (result ListCalendarEventExceptionOccurrenceInstancesCompleteResult, err error) {
