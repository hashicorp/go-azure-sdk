...
func (c CalendarEventExceptionOccurrenceInstanceClient) SnoozeCalendarEventExceptionOccurrenceInstanceReminder(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceIdInstanceId, input SnoozeCalendarEventExceptionOccurrenceInstanceReminderRequest) (result SnoozeCalendarEventExceptionOccurrenceInstanceReminderOperationResponse, err error) {
