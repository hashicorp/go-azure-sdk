...
// GetCalendarEventExceptionOccurrenceInstance - Get instances from users. The occurrences of a recurring series, if the
...
func (c CalendarEventExceptionOccurrenceInstanceClient) GetCalendarEventExceptionOccurrenceInstance(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceIdInstanceId, options GetCalendarEventExceptionOccurrenceInstanceOperationOptions) (result GetCalendarEventExceptionOccurrenceInstanceOperationResponse, err error) {
