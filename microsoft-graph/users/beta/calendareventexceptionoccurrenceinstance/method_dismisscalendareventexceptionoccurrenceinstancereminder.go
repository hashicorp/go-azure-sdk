...
func (c CalendarEventExceptionOccurrenceInstanceClient) DismissCalendarEventExceptionOccurrenceInstanceReminder(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceIdInstanceId) (result DismissCalendarEventExceptionOccurrenceInstanceReminderOperationResponse, err error) {
