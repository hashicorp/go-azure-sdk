...
func (c CalendarEventExceptionOccurrenceInstanceClient) DeclineCalendarEventExceptionOccurrenceInstance(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceIdInstanceId, input DeclineCalendarEventExceptionOccurrenceInstanceRequest) (result DeclineCalendarEventExceptionOccurrenceInstanceOperationResponse, err error) {
