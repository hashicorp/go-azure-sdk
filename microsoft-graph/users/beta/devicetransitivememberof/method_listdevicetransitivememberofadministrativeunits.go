...
func (c DeviceTransitiveMemberOfClient) ListDeviceTransitiveMemberOfAdministrativeUnits(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceTransitiveMemberOfAdministrativeUnitsOperationOptions) (result ListDeviceTransitiveMemberOfAdministrativeUnitsOperationResponse, err error) {
...
func (c DeviceTransitiveMemberOfClient) ListDeviceTransitiveMemberOfAdministrativeUnitsComplete(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceTransitiveMemberOfAdministrativeUnitsOperationOptions) (ListDeviceTransitiveMemberOfAdministrativeUnitsCompleteResult, error) {
...
func (c DeviceTransitiveMemberOfClient) ListDeviceTransitiveMemberOfAdministrativeUnitsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceTransitiveMemberOfAdministrativeUnitsOperationOptions, predicate AdministrativeUnitOperationPredicate) (result ListDeviceTransitiveMemberOfAdministrativeUnitsCompleteResult, err error) {
