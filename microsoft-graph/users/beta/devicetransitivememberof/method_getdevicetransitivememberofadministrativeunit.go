...
func (c DeviceTransitiveMemberOfClient) GetDeviceTransitiveMemberOfAdministrativeUnit(ctx context.Context, id beta.UserIdDeviceIdTransitiveMemberOfId, options GetDeviceTransitiveMemberOfAdministrativeUnitOperationOptions) (result GetDeviceTransitiveMemberOfAdministrativeUnitOperationResponse, err error) {
