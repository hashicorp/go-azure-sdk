...
func (c DeviceTransitiveMemberOfClient) GetDeviceTransitiveMemberOfGroupCount(ctx context.Context, id beta.UserIdDeviceId, options GetDeviceTransitiveMemberOfGroupCountOperationOptions) (result GetDeviceTransitiveMemberOfGroupCountOperationResponse, err error) {
