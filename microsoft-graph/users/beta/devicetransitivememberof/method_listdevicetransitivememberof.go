...
func (c DeviceTransitiveMemberOfClient) ListDeviceTransitiveMemberOf(ctx context.Context, id UserIdDeviceId) (result ListDeviceTransitiveMemberOfOperationResponse, err error) {
...
func (c DeviceTransitiveMemberOfClient) ListDeviceTransitiveMemberOfComplete(ctx context.Context, id UserIdDeviceId) (ListDeviceTransitiveMemberOfCompleteResult, error) {
...
func (c DeviceTransitiveMemberOfClient) ListDeviceTransitiveMemberOfCompleteMatchingPredicate(ctx context.Context, id UserIdDeviceId, predicate DirectoryObjectOperationPredicate) (result ListDeviceTransitiveMemberOfCompleteResult, err error) {
