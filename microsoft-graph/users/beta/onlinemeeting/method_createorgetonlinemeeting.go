...
func (c OnlineMeetingClient) CreateOrGetOnlineMeeting(ctx context.Context, id beta.UserId, input CreateOrGetOnlineMeetingRequest) (result CreateOrGetOnlineMeetingOperationResponse, err error) {
