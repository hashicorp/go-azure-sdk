...
// CreateOnlineMeeting ...
func (c OnlineMeetingClient) CreateOnlineMeeting(ctx context.Context, id UserId, input beta.OnlineMeeting) (result CreateOnlineMeetingOperationResponse, err error) {
