...
func (c OnlineMeetingClient) CreateOnlineMeeting(ctx context.Context, id beta.UserId, input beta.OnlineMeeting) (result CreateOnlineMeetingOperationResponse, err error) {
