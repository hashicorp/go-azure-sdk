...
func (c OnlineMeetingClient) SendOnlineMeetingVirtualAppointmentReminderSms(ctx context.Context, id beta.UserIdOnlineMeetingId, input SendOnlineMeetingVirtualAppointmentReminderSmsRequest) (result SendOnlineMeetingVirtualAppointmentReminderSmsOperationResponse, err error) {
