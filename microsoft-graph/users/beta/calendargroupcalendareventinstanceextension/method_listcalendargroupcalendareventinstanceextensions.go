...
func (c CalendarGroupCalendarEventInstanceExtensionClient) ListCalendarGroupCalendarEventInstanceExtensions(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdInstanceId, options ListCalendarGroupCalendarEventInstanceExtensionsOperationOptions) (result ListCalendarGroupCalendarEventInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventInstanceExtensionClient) ListCalendarGroupCalendarEventInstanceExtensionsComplete(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdInstanceId, options ListCalendarGroupCalendarEventInstanceExtensionsOperationOptions) (ListCalendarGroupCalendarEventInstanceExtensionsCompleteResult, error) {
...
func (c CalendarGroupCalendarEventInstanceExtensionClient) ListCalendarGroupCalendarEventInstanceExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdInstanceId, options ListCalendarGroupCalendarEventInstanceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarGroupCalendarEventInstanceExtensionsCompleteResult, err error) {
