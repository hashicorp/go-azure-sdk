...
func (c DriveRootThumbnailClient) CreateDriveRootThumbnail(ctx context.Context, id beta.UserIdDriveId, input beta.ThumbnailSet) (result CreateDriveRootThumbnailOperationResponse, err error) {
