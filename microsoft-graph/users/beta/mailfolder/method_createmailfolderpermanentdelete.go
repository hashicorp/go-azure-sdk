...
// CreateMailFolderPermanentDelete - Invoke action permanentDelete. Permanently delete a mail folder and remove its
// items from the user's mailbox. For more information about item retention, see Configure Deleted Item retention and
// Recoverable Items quotas.
func (c MailFolderClient) CreateMailFolderPermanentDelete(ctx context.Context, id beta.UserIdMailFolderId, options CreateMailFolderPermanentDeleteOperationOptions) (result CreateMailFolderPermanentDeleteOperationResponse, err error) {
