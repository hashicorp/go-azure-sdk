...
func (c MailFolderClient) UpdateMailFolderAllMessagesReadState(ctx context.Context, id beta.UserIdMailFolderId, input UpdateMailFolderAllMessagesReadStateRequest, options UpdateMailFolderAllMessagesReadStateOperationOptions) (result UpdateMailFolderAllMessagesReadStateOperationResponse, err error) {
