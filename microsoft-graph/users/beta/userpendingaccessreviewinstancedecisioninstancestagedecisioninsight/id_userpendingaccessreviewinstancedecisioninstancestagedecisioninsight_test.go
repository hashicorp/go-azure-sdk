...
func TestNewUserPendingAccessReviewInstanceDecisionInstanceStageDecisionInsightID(t *testing.T) {
	id := NewUserPendingAccessReviewInstanceDecisionInstanceStageDecisionInsightID("userIdValue", "accessReviewInstanceIdValue", "accessReviewInstanceDecisionItemIdValue", "accessReviewStageIdValue", "accessReviewInstanceDecisionItemId1Value", "governanceInsightIdValue")
...
func TestFormatUserPendingAccessReviewInstanceDecisionInstanceStageDecisionInsightID(t *testing.T) {
	actual := NewUserPendingAccessReviewInstanceDecisionInstanceStageDecisionInsightID("userIdValue", "accessReviewInstanceIdValue", "accessReviewInstanceDecisionItemIdValue", "accessReviewStageIdValue", "accessReviewInstanceDecisionItemId1Value", "governanceInsightIdValue").ID()
	expected := "/users/userIdValue/pendingAccessReviewInstances/accessReviewInstanceIdValue/decisions/accessReviewInstanceDecisionItemIdValue/instance/stages/accessReviewStageIdValue/decisions/accessReviewInstanceDecisionItemId1Value/insights/governanceInsightIdValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseUserPendingAccessReviewInstanceDecisionInstanceStageDecisionInsightID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceDecisionInstanceStageDecisionInsightId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		{
			// Incomplete URI
			Input: "/users/userIdValue/pendingAccessReviewInstances/accessReviewInstanceIdValue/decisions/accessReviewInstanceDecisionItemIdValue/instance/stages/accessReviewStageIdValue/decisions/accessReviewInstanceDecisionItemId1Value/insights",
			Error: true,
		},
		{
			// Valid URI
			Input: "/users/userIdValue/pendingAccessReviewInstances/accessReviewInstanceIdValue/decisions/accessReviewInstanceDecisionItemIdValue/instance/stages/accessReviewStageIdValue/decisions/accessReviewInstanceDecisionItemId1Value/insights/governanceInsightIdValue",
			Expected: &UserPendingAccessReviewInstanceDecisionInstanceStageDecisionInsightId{
				UserId:                              "userIdValue",
		...
		},
		{
			...
			Input: "",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceDecisionInstanceStageDecisionInsightID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserPendingAccessReviewInstanceDecisionInstanceStageDecisionInsightIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceDecisionInstanceStageDecisionInsightId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceDecisionInstanceStageDecisionInsightIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserPendingAccessReviewInstanceDecisionInstanceStageDecisionInsightId(t *testing.T) {
	segments := UserPendingAccessReviewInstanceDecisionInstanceStageDecisionInsightId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserPendingAccessReviewInstanceDecisionInstanceStageDecisionInsightId has no segments")
	}
