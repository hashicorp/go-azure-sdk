...
func (c ContactFolderChildFolderContactClient) CreateContactFolderChildFolderContactPermanentDelete(ctx context.Context, id beta.UserIdContactFolderIdChildFolderIdContactId, options CreateContactFolderChildFolderContactPermanentDeleteOperationOptions) (result CreateContactFolderChildFolderContactPermanentDeleteOperationResponse, err error) {
