...
func (c MailFolderMessageClient) CreateMailFolderMessageReply(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input CreateMailFolderMessageReplyRequest) (result CreateMailFolderMessageReplyOperationResponse, err error) {
