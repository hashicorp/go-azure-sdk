...
func (c MailFolderMessageClient) CopyMailFolderMessage(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input CopyMailFolderMessageRequest) (result CopyMailFolderMessageOperationResponse, err error) {
