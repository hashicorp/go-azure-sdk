...
func (c MailFolderMessageClient) MarkMailFolderMessageAsNotJunk(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input MarkMailFolderMessageAsNotJunkRequest) (result MarkMailFolderMessageAsNotJunkOperationResponse, err error) {
