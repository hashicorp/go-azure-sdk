...
func (c MailFolderMessageClient) MoveMailFolderMessage(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input MoveMailFolderMessageRequest) (result MoveMailFolderMessageOperationResponse, err error) {
