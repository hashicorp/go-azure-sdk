...
func (c MailFolderMessageClient) CreateMailFolderMessageForward(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input CreateMailFolderMessageForwardRequest) (result CreateMailFolderMessageForwardOperationResponse, err error) {
