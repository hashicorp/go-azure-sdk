...
func (c MailFolderMessageClient) CreateMailFolderMessageReplyAll(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input CreateMailFolderMessageReplyAllRequest) (result CreateMailFolderMessageReplyAllOperationResponse, err error) {
