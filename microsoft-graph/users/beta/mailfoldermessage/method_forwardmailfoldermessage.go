...
func (c MailFolderMessageClient) ForwardMailFolderMessage(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input ForwardMailFolderMessageRequest) (result ForwardMailFolderMessageOperationResponse, err error) {
