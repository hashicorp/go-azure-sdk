...
func (c MailFolderMessageClient) MarkMailFolderMessageAsJunk(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input MarkMailFolderMessageAsJunkRequest) (result MarkMailFolderMessageAsJunkOperationResponse, err error) {
