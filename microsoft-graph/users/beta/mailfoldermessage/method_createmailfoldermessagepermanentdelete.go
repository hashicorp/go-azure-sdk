...
// Items quotas.
func (c MailFolderMessageClient) CreateMailFolderMessagePermanentDelete(ctx context.Context, id beta.UserIdMailFolderIdMessageId, options CreateMailFolderMessagePermanentDeleteOperationOptions) (result CreateMailFolderMessagePermanentDeleteOperationResponse, err error) {
