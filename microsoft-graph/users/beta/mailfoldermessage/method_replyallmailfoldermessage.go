...
// send it later.
func (c MailFolderMessageClient) ReplyAllMailFolderMessage(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input ReplyAllMailFolderMessageRequest) (result ReplyAllMailFolderMessageOperationResponse, err error) {
