...
func TestNewUserIdCalendarIdEventIdExceptionOccurrenceID(t *testing.T) {
	id := NewUserIdCalendarIdEventIdExceptionOccurrenceID("userIdValue", "calendarIdValue", "eventIdValue", "eventId1Value")
...
func TestFormatUserIdCalendarIdEventIdExceptionOccurrenceID(t *testing.T) {
	actual := NewUserIdCalendarIdEventIdExceptionOccurrenceID("userIdValue", "calendarIdValue", "eventIdValue", "eventId1Value").ID()
...
func TestParseUserIdCalendarIdEventIdExceptionOccurrenceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarIdEventIdExceptionOccurrenceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarIdEventIdExceptionOccurrenceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserIdCalendarIdEventIdExceptionOccurrenceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarIdEventIdExceptionOccurrenceId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarIdEventIdExceptionOccurrenceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserIdCalendarIdEventIdExceptionOccurrenceId(t *testing.T) {
	segments := UserIdCalendarIdEventIdExceptionOccurrenceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserIdCalendarIdEventIdExceptionOccurrenceId has no segments")
	}
