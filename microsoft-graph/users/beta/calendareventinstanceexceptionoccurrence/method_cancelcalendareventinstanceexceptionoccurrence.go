...
// cancellation.
func (c CalendarEventInstanceExceptionOccurrenceClient) CancelCalendarEventInstanceExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarIdEventIdInstanceIdExceptionOccurrenceId, input CancelCalendarEventInstanceExceptionOccurrenceRequest) (result CancelCalendarEventInstanceExceptionOccurrenceOperationResponse, err error) {
