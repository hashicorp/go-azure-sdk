...
func (c CalendarEventInstanceExceptionOccurrenceClient) SnoozeCalendarEventInstanceExceptionOccurrenceReminder(ctx context.Context, id beta.UserIdCalendarEventIdInstanceIdExceptionOccurrenceId, input SnoozeCalendarEventInstanceExceptionOccurrenceReminderRequest) (result SnoozeCalendarEventInstanceExceptionOccurrenceReminderOperationResponse, err error) {
