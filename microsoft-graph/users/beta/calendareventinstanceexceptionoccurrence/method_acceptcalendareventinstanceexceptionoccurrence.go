...
func (c CalendarEventInstanceExceptionOccurrenceClient) AcceptCalendarEventInstanceExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarIdEventIdInstanceIdExceptionOccurrenceId, input AcceptCalendarEventInstanceExceptionOccurrenceRequest) (result AcceptCalendarEventInstanceExceptionOccurrenceOperationResponse, err error) {
