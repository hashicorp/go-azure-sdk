...
func (c TodoListTaskExtensionClient) CreateTodoListTaskExtension(ctx context.Context, id beta.UserIdTodoListIdTaskId, input beta.Extension) (result CreateTodoListTaskExtensionOperationResponse, err error) {
