...
func (c CalendarGroupCalendarCalendarViewInstanceExtensionClient) GetCalendarGroupCalendarViewInstanceExtension(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdInstanceIdExtensionId, options GetCalendarGroupCalendarViewInstanceExtensionOperationOptions) (result GetCalendarGroupCalendarViewInstanceExtensionOperationResponse, err error) {
