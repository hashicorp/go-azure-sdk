...
func TestNewUserCalendarEventExceptionOccurrenceID(t *testing.T) {
	id := NewUserCalendarEventExceptionOccurrenceID("userIdValue", "eventIdValue", "eventId1Value")
...
func TestFormatUserCalendarEventExceptionOccurrenceID(t *testing.T) {
	actual := NewUserCalendarEventExceptionOccurrenceID("userIdValue", "eventIdValue", "eventId1Value").ID()
