...
func TestNewUserCalendarCalendarViewAttachmentID(t *testing.T) {
	id := NewUserCalendarCalendarViewAttachmentID("userIdValue", "calendarIdValue", "eventIdValue", "attachmentIdValue")
...
func TestFormatUserCalendarCalendarViewAttachmentID(t *testing.T) {
	actual := NewUserCalendarCalendarViewAttachmentID("userIdValue", "calendarIdValue", "eventIdValue", "attachmentIdValue").ID()
...
func TestParseUserCalendarCalendarViewAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarCalendarViewAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarCalendarViewAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarCalendarViewAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarCalendarViewAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarCalendarViewAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarCalendarViewAttachmentId(t *testing.T) {
	segments := UserCalendarCalendarViewAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarCalendarViewAttachmentId has no segments")
	}
