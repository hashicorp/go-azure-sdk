...
func (c CalendarEventExceptionOccurrenceClient) ForwardCalendarEventExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceId, input ForwardCalendarEventExceptionOccurrenceRequest) (result ForwardCalendarEventExceptionOccurrenceOperationResponse, err error) {
