...
func (c CalendarEventExceptionOccurrenceClient) SnoozeCalendarEventExceptionOccurrenceReminder(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceId, input SnoozeCalendarEventExceptionOccurrenceReminderRequest) (result SnoozeCalendarEventExceptionOccurrenceReminderOperationResponse, err error) {
