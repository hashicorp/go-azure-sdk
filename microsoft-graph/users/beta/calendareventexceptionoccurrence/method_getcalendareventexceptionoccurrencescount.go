...
func (c CalendarEventExceptionOccurrenceClient) GetCalendarEventExceptionOccurrencesCount(ctx context.Context, id beta.UserIdCalendarEventId, options GetCalendarEventExceptionOccurrencesCountOperationOptions) (result GetCalendarEventExceptionOccurrencesCountOperationResponse, err error) {
