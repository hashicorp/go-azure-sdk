...
func (c CalendarEventExceptionOccurrenceClient) DeclineCalendarEventExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceId, input DeclineCalendarEventExceptionOccurrenceRequest) (result DeclineCalendarEventExceptionOccurrenceOperationResponse, err error) {
