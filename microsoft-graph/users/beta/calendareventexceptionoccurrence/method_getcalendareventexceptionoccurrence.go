...
// GetCalendarEventExceptionOccurrence - Get exceptionOccurrences from users
func (c CalendarEventExceptionOccurrenceClient) GetCalendarEventExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceId, options GetCalendarEventExceptionOccurrenceOperationOptions) (result GetCalendarEventExceptionOccurrenceOperationResponse, err error) {
