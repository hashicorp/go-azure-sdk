...
func (c CalendarEventExceptionOccurrenceClient) ListCalendarEventExceptionOccurrences(ctx context.Context, id UserIdCalendarEventId) (result ListCalendarEventExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceClient) ListCalendarEventExceptionOccurrencesComplete(ctx context.Context, id UserIdCalendarEventId) (ListCalendarEventExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarEventExceptionOccurrenceClient) ListCalendarEventExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarEventId, predicate EventOperationPredicate) (result ListCalendarEventExceptionOccurrencesCompleteResult, err error) {
