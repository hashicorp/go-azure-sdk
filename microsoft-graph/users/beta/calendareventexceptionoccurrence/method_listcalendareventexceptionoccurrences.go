...
// ListCalendarEventExceptionOccurrences - Get exceptionOccurrences from users
func (c CalendarEventExceptionOccurrenceClient) ListCalendarEventExceptionOccurrences(ctx context.Context, id beta.UserIdCalendarEventId, options ListCalendarEventExceptionOccurrencesOperationOptions) (result ListCalendarEventExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceClient) ListCalendarEventExceptionOccurrencesComplete(ctx context.Context, id beta.UserIdCalendarEventId, options ListCalendarEventExceptionOccurrencesOperationOptions) (ListCalendarEventExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarEventExceptionOccurrenceClient) ListCalendarEventExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarEventId, options ListCalendarEventExceptionOccurrencesOperationOptions, predicate EventOperationPredicate) (result ListCalendarEventExceptionOccurrencesCompleteResult, err error) {
