...
func (c CalendarEventExceptionOccurrenceClient) TentativelyAcceptCalendarEventExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceId, input TentativelyAcceptCalendarEventExceptionOccurrenceRequest) (result TentativelyAcceptCalendarEventExceptionOccurrenceOperationResponse, err error) {
