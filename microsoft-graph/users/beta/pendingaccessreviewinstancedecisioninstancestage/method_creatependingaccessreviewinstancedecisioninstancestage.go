...
func (c PendingAccessReviewInstanceDecisionInstanceStageClient) CreatePendingAccessReviewInstanceDecisionInstanceStage(ctx context.Context, id UserIdPendingAccessReviewInstanceIdDecisionId, input beta.AccessReviewStage) (result CreatePendingAccessReviewInstanceDecisionInstanceStageOperationResponse, err error) {
