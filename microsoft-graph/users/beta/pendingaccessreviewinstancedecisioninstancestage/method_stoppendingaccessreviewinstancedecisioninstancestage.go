...
func (c PendingAccessReviewInstanceDecisionInstanceStageClient) StopPendingAccessReviewInstanceDecisionInstanceStage(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdDecisionIdInstanceStageId) (result StopPendingAccessReviewInstanceDecisionInstanceStageOperationResponse, err error) {
