...
func (c CalendarEventExceptionOccurrenceInstanceAttachmentClient) GetCalendarEventExceptionOccurrenceInstanceAttachmentsCount(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceIdInstanceId, options GetCalendarEventExceptionOccurrenceInstanceAttachmentsCountOperationOptions) (result GetCalendarEventExceptionOccurrenceInstanceAttachmentsCountOperationResponse, err error) {
