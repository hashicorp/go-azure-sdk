...
// ListCalendarEventExceptionOccurrenceInstanceAttachments - Get attachments from users. The collection of
// FileAttachment, ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only.
// Nullable.
func (c CalendarEventExceptionOccurrenceInstanceAttachmentClient) ListCalendarEventExceptionOccurrenceInstanceAttachments(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceIdInstanceId, options ListCalendarEventExceptionOccurrenceInstanceAttachmentsOperationOptions) (result ListCalendarEventExceptionOccurrenceInstanceAttachmentsOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceInstanceAttachmentClient) ListCalendarEventExceptionOccurrenceInstanceAttachmentsComplete(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceIdInstanceId, options ListCalendarEventExceptionOccurrenceInstanceAttachmentsOperationOptions) (ListCalendarEventExceptionOccurrenceInstanceAttachmentsCompleteResult, error) {
...
func (c CalendarEventExceptionOccurrenceInstanceAttachmentClient) ListCalendarEventExceptionOccurrenceInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceIdInstanceId, options ListCalendarEventExceptionOccurrenceInstanceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarEventExceptionOccurrenceInstanceAttachmentsCompleteResult, err error) {
