...
// CreateCalendarEventExceptionOccurrenceInstanceAttachment - Create new navigation property to attachments for users
func (c CalendarEventExceptionOccurrenceInstanceAttachmentClient) CreateCalendarEventExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceIdInstanceId, input beta.Attachment) (result CreateCalendarEventExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
