...
// DeleteCalendarEventExceptionOccurrenceInstanceAttachment - Delete navigation property attachments for users
func (c CalendarEventExceptionOccurrenceInstanceAttachmentClient) DeleteCalendarEventExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceIdInstanceIdAttachmentId, options DeleteCalendarEventExceptionOccurrenceInstanceAttachmentOperationOptions) (result DeleteCalendarEventExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
