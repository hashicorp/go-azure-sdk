...
func TestNewUserInferenceClassificationOverrideID(t *testing.T) {
	id := NewUserInferenceClassificationOverrideID("userIdValue", "inferenceClassificationOverrideIdValue")
...
func TestFormatUserInferenceClassificationOverrideID(t *testing.T) {
	actual := NewUserInferenceClassificationOverrideID("userIdValue", "inferenceClassificationOverrideIdValue").ID()
...
func TestParseUserInferenceClassificationOverrideID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserInferenceClassificationOverrideId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserInferenceClassificationOverrideID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserInferenceClassificationOverrideIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserInferenceClassificationOverrideId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserInferenceClassificationOverrideIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserInferenceClassificationOverrideId(t *testing.T) {
	segments := UserInferenceClassificationOverrideId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserInferenceClassificationOverrideId has no segments")
	}
