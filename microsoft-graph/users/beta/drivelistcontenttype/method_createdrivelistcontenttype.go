...
func (c DriveListContentTypeClient) CreateDriveListContentType(ctx context.Context, id beta.UserIdDriveId, input beta.ContentType) (result CreateDriveListContentTypeOperationResponse, err error) {
