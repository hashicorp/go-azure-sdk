...
// GetSettingRegionalAndLanguageSetting ...
func (c SettingRegionalAndLanguageSettingClient) GetSettingRegionalAndLanguageSetting(ctx context.Context, id UserId) (result GetSettingRegionalAndLanguageSettingOperationResponse, err error) {
