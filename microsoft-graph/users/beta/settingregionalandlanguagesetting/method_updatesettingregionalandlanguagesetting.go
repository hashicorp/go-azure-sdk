...
func (c SettingRegionalAndLanguageSettingClient) UpdateSettingRegionalAndLanguageSetting(ctx context.Context, id beta.UserId, input beta.RegionalAndLanguageSettings) (result UpdateSettingRegionalAndLanguageSettingOperationResponse, err error) {
