...
func (c PlannerPlanDetailClient) UpdatePlannerPlanDetail(ctx context.Context, id UserIdPlannerPlanId, input beta.PlannerPlanDetails) (result UpdatePlannerPlanDetailOperationResponse, err error) {
