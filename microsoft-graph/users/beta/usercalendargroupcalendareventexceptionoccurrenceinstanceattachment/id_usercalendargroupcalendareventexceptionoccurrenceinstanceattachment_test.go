...
func TestNewUserCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentID(t *testing.T) {
	id := NewUserCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue")
...
func TestFormatUserCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentID(t *testing.T) {
	actual := NewUserCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue").ID()
...
func TestParseUserCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentId(t *testing.T) {
	segments := UserCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentId has no segments")
	}
