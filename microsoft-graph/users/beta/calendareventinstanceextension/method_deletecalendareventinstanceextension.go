...
func (c CalendarEventInstanceExtensionClient) DeleteCalendarEventInstanceExtension(ctx context.Context, id beta.UserIdCalendarEventIdInstanceIdExtensionId, options DeleteCalendarEventInstanceExtensionOperationOptions) (result DeleteCalendarEventInstanceExtensionOperationResponse, err error) {
