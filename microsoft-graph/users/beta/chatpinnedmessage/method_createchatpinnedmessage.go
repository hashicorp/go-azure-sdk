...
func (c ChatPinnedMessageClient) CreateChatPinnedMessage(ctx context.Context, id beta.UserIdChatId, input beta.PinnedChatMessageInfo) (result CreateChatPinnedMessageOperationResponse, err error) {
