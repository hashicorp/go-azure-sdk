...
func (c CalendarGroupCalendarPermissionClient) DeleteCalendarGroupCalendarPermission(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarPermissionId, options DeleteCalendarGroupCalendarPermissionOperationOptions) (result DeleteCalendarGroupCalendarPermissionOperationResponse, err error) {
