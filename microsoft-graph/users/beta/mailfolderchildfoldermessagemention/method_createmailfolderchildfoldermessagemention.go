...
func (c MailFolderChildFolderMessageMentionClient) CreateMailFolderChildFolderMessageMention(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, input beta.Mention) (result CreateMailFolderChildFolderMessageMentionOperationResponse, err error) {
