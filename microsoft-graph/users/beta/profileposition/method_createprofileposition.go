...
func (c ProfilePositionClient) CreateProfilePosition(ctx context.Context, id UserId, input beta.WorkPosition) (result CreateProfilePositionOperationResponse, err error) {
