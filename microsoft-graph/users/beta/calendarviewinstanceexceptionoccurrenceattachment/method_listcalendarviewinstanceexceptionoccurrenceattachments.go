...
func (c CalendarViewInstanceExceptionOccurrenceAttachmentClient) ListCalendarViewInstanceExceptionOccurrenceAttachments(ctx context.Context, id UserIdCalendarViewIdInstanceIdExceptionOccurrenceId) (result ListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarViewInstanceExceptionOccurrenceAttachmentClient) ListCalendarViewInstanceExceptionOccurrenceAttachmentsComplete(ctx context.Context, id UserIdCalendarViewIdInstanceIdExceptionOccurrenceId) (ListCalendarViewInstanceExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c CalendarViewInstanceExceptionOccurrenceAttachmentClient) ListCalendarViewInstanceExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarViewIdInstanceIdExceptionOccurrenceId, predicate AttachmentOperationPredicate) (result ListCalendarViewInstanceExceptionOccurrenceAttachmentsCompleteResult, err error) {
