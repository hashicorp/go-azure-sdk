...
// GetCalendarViewInstanceExceptionOccurrenceAttachment - Get attachments from users. The collection of FileAttachment,
// ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
func (c CalendarViewInstanceExceptionOccurrenceAttachmentClient) GetCalendarViewInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdCalendarViewIdInstanceIdExceptionOccurrenceIdAttachmentId, options GetCalendarViewInstanceExceptionOccurrenceAttachmentOperationOptions) (result GetCalendarViewInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
