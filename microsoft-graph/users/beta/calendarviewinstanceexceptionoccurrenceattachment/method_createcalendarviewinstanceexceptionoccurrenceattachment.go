...
func (c CalendarViewInstanceExceptionOccurrenceAttachmentClient) CreateCalendarViewInstanceExceptionOccurrenceAttachment(ctx context.Context, id UserIdCalendarViewIdInstanceIdExceptionOccurrenceId, input beta.Attachment) (result CreateCalendarViewInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
