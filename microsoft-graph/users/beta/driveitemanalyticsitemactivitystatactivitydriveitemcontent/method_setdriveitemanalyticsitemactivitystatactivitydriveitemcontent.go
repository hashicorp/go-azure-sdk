...
func (c DriveItemAnalyticsItemActivityStatActivityDriveItemContentClient) SetDriveItemAnalyticsItemActivityStatActivityDriveItemContent(ctx context.Context, id beta.UserIdDriveIdItemIdAnalyticsItemActivityStatIdActivityId, input []byte) (result SetDriveItemAnalyticsItemActivityStatActivityDriveItemContentOperationResponse, err error) {
