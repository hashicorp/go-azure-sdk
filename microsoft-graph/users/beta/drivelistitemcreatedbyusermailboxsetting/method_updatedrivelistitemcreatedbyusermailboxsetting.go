...
func (c DriveListItemCreatedByUserMailboxSettingClient) UpdateDriveListItemCreatedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveIdListItemId, input beta.MailboxSettings) (result UpdateDriveListItemCreatedByUserMailboxSettingOperationResponse, err error) {
