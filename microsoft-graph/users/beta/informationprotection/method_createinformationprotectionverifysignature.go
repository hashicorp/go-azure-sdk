...
func (c InformationProtectionClient) CreateInformationProtectionVerifySignature(ctx context.Context, id beta.UserId, input CreateInformationProtectionVerifySignatureRequest) (result CreateInformationProtectionVerifySignatureOperationResponse, err error) {
