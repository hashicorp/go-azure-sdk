...
func TestNewUserCalendarCalendarViewExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	id := NewUserCalendarCalendarViewExceptionOccurrenceInstanceExtensionID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue")
...
func TestFormatUserCalendarCalendarViewExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	actual := NewUserCalendarCalendarViewExceptionOccurrenceInstanceExtensionID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue").ID()
...
func TestParseUserCalendarCalendarViewExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarCalendarViewExceptionOccurrenceInstanceExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarCalendarViewExceptionOccurrenceInstanceExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarCalendarViewExceptionOccurrenceInstanceExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarCalendarViewExceptionOccurrenceInstanceExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarCalendarViewExceptionOccurrenceInstanceExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarCalendarViewExceptionOccurrenceInstanceExtensionId(t *testing.T) {
	segments := UserCalendarCalendarViewExceptionOccurrenceInstanceExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarCalendarViewExceptionOccurrenceInstanceExtensionId has no segments")
	}
