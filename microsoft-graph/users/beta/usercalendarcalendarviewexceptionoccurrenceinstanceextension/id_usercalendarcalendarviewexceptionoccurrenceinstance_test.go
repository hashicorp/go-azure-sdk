...
func TestNewUserCalendarCalendarViewExceptionOccurrenceInstanceID(t *testing.T) {
	id := NewUserCalendarCalendarViewExceptionOccurrenceInstanceID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value")
...
func TestFormatUserCalendarCalendarViewExceptionOccurrenceInstanceID(t *testing.T) {
	actual := NewUserCalendarCalendarViewExceptionOccurrenceInstanceID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value").ID()
