...
func NewUserCalendarCalendarViewExceptionOccurrenceInstanceID(userId string, eventId string, eventId1 string, eventId2 string) UserCalendarCalendarViewExceptionOccurrenceInstanceId {
