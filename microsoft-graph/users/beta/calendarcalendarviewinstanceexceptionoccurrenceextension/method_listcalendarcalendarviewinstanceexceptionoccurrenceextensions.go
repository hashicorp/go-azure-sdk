...
func (c CalendarCalendarViewInstanceExceptionOccurrenceExtensionClient) ListCalendarCalendarViewInstanceExceptionOccurrenceExtensions(ctx context.Context, id UserIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId) (result ListCalendarCalendarViewInstanceExceptionOccurrenceExtensionsOperationResponse, err error) {
