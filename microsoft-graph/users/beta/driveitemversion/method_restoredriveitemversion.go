...
func (c DriveItemVersionClient) RestoreDriveItemVersion(ctx context.Context, id beta.UserIdDriveIdItemIdVersionId) (result RestoreDriveItemVersionOperationResponse, err error) {
