...
func (c EventExceptionOccurrenceClient) ListEventExceptionOccurrences(ctx context.Context, id UserIdEventId) (result ListEventExceptionOccurrencesOperationResponse, err error) {
...
func (c EventExceptionOccurrenceClient) ListEventExceptionOccurrencesComplete(ctx context.Context, id UserIdEventId) (ListEventExceptionOccurrencesCompleteResult, error) {
...
func (c EventExceptionOccurrenceClient) ListEventExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id UserIdEventId, predicate EventOperationPredicate) (result ListEventExceptionOccurrencesCompleteResult, err error) {
