...
func (c EventExceptionOccurrenceClient) ForwardEventExceptionOccurrence(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, input ForwardEventExceptionOccurrenceRequest) (result ForwardEventExceptionOccurrenceOperationResponse, err error) {
