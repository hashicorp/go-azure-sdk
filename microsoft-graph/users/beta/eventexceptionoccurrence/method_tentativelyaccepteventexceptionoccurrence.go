...
func (c EventExceptionOccurrenceClient) TentativelyAcceptEventExceptionOccurrence(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, input TentativelyAcceptEventExceptionOccurrenceRequest) (result TentativelyAcceptEventExceptionOccurrenceOperationResponse, err error) {
