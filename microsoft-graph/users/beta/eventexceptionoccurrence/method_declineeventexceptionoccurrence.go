...
func (c EventExceptionOccurrenceClient) DeclineEventExceptionOccurrence(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, input DeclineEventExceptionOccurrenceRequest) (result DeclineEventExceptionOccurrenceOperationResponse, err error) {
