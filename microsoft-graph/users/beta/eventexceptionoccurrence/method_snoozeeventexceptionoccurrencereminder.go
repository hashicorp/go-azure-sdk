...
func (c EventExceptionOccurrenceClient) SnoozeEventExceptionOccurrenceReminder(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceId, input SnoozeEventExceptionOccurrenceReminderRequest) (result SnoozeEventExceptionOccurrenceReminderOperationResponse, err error) {
