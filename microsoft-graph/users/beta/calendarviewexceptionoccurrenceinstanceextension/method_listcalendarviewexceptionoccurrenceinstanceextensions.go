...
func (c CalendarViewExceptionOccurrenceInstanceExtensionClient) ListCalendarViewExceptionOccurrenceInstanceExtensions(ctx context.Context, id UserIdCalendarViewIdExceptionOccurrenceIdInstanceId) (result ListCalendarViewExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceInstanceExtensionClient) ListCalendarViewExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id UserIdCalendarViewIdExceptionOccurrenceIdInstanceId) (ListCalendarViewExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
