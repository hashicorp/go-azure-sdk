...
// ListCalendarViewExceptionOccurrenceExtensions - Get extensions from users. The collection of open extensions defined
// for the event. Nullable.
func (c CalendarCalendarViewExceptionOccurrenceExtensionClient) ListCalendarViewExceptionOccurrenceExtensions(ctx context.Context, id beta.UserIdCalendarCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceExtensionsOperationOptions) (result ListCalendarViewExceptionOccurrenceExtensionsOperationResponse, err error) {
