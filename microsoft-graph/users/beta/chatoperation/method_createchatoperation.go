...
// CreateChatOperation ...
func (c ChatOperationClient) CreateChatOperation(ctx context.Context, id UserIdChatId, input beta.TeamsAsyncOperation) (result CreateChatOperationOperationResponse, err error) {
