...
// ListChatOperations ...
func (c ChatOperationClient) ListChatOperations(ctx context.Context, id UserIdChatId) (result ListChatOperationsOperationResponse, err error) {
...
func (c ChatOperationClient) ListChatOperationsComplete(ctx context.Context, id UserIdChatId) (ListChatOperationsCompleteResult, error) {
	return c.ListChatOperationsCompleteMatchingPredicate(ctx, id, TeamsAsyncOperationOperationPredicate{})
}

// ListChatOperationsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ChatOperationClient) ListChatOperationsCompleteMatchingPredicate(ctx context.Context, id UserIdChatId, predicate TeamsAsyncOperationOperationPredicate) (result ListChatOperationsCompleteResult, err error) {
	items := make([]beta.TeamsAsyncOperation, 0)

	resp, err := c.ListChatOperations(ctx, id)
	if err != nil {
