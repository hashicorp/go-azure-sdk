...
// ListOnlineMeetingAiInsights - Get aiInsights from users. The AI insights generated for an online meeting. Read-only.
func (c OnlineMeetingAiInsightClient) ListOnlineMeetingAiInsights(ctx context.Context, id beta.UserIdOnlineMeetingId, options ListOnlineMeetingAiInsightsOperationOptions) (result ListOnlineMeetingAiInsightsOperationResponse, err error) {
...
func (c OnlineMeetingAiInsightClient) ListOnlineMeetingAiInsightsComplete(ctx context.Context, id beta.UserIdOnlineMeetingId, options ListOnlineMeetingAiInsightsOperationOptions) (ListOnlineMeetingAiInsightsCompleteResult, error) {
...
func (c OnlineMeetingAiInsightClient) ListOnlineMeetingAiInsightsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdOnlineMeetingId, options ListOnlineMeetingAiInsightsOperationOptions, predicate CallAiInsightOperationPredicate) (result ListOnlineMeetingAiInsightsCompleteResult, err error) {
