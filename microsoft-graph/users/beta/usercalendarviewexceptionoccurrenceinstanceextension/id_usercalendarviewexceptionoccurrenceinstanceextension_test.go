...
func TestNewUserCalendarViewExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	id := NewUserCalendarViewExceptionOccurrenceInstanceExtensionID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue")
...
func TestFormatUserCalendarViewExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	actual := NewUserCalendarViewExceptionOccurrenceInstanceExtensionID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue").ID()
...
func TestParseUserCalendarViewExceptionOccurrenceInstanceExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarViewExceptionOccurrenceInstanceExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarViewExceptionOccurrenceInstanceExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarViewExceptionOccurrenceInstanceExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarViewExceptionOccurrenceInstanceExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarViewExceptionOccurrenceInstanceExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarViewExceptionOccurrenceInstanceExtensionId(t *testing.T) {
	segments := UserCalendarViewExceptionOccurrenceInstanceExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarViewExceptionOccurrenceInstanceExtensionId has no segments")
	}
