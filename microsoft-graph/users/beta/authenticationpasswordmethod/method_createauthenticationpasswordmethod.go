...
func (c AuthenticationPasswordMethodClient) CreateAuthenticationPasswordMethod(ctx context.Context, id beta.UserId, input beta.PasswordAuthenticationMethod) (result CreateAuthenticationPasswordMethodOperationResponse, err error) {
