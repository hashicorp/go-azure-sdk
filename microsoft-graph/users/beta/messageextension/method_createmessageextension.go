...
func (c MessageExtensionClient) CreateMessageExtension(ctx context.Context, id beta.UserIdMessageId, input beta.Extension) (result CreateMessageExtensionOperationResponse, err error) {
