...
// GetSecurityInformationProtection ...
func (c SecurityInformationProtectionClient) GetSecurityInformationProtection(ctx context.Context, id UserId) (result GetSecurityInformationProtectionOperationResponse, err error) {
