...
func (c ProfileWebsiteClient) CreateProfileWebsite(ctx context.Context, id UserId, input beta.PersonWebsite) (result CreateProfileWebsiteOperationResponse, err error) {
