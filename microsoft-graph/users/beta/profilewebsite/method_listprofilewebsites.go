...
// ListProfileWebsites ...
func (c ProfileWebsiteClient) ListProfileWebsites(ctx context.Context, id UserId) (result ListProfileWebsitesOperationResponse, err error) {
...
func (c ProfileWebsiteClient) ListProfileWebsitesComplete(ctx context.Context, id UserId) (ListProfileWebsitesCompleteResult, error) {
	return c.ListProfileWebsitesCompleteMatchingPredicate(ctx, id, PersonWebsiteOperationPredicate{})
}

// ListProfileWebsitesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileWebsiteClient) ListProfileWebsitesCompleteMatchingPredicate(ctx context.Context, id UserId, predicate PersonWebsiteOperationPredicate) (result ListProfileWebsitesCompleteResult, err error) {
	items := make([]beta.PersonWebsite, 0)

	resp, err := c.ListProfileWebsites(ctx, id)
	if err != nil {
