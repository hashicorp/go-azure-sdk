...
func (c PendingAccessReviewInstanceDecisionInsightClient) ListPendingAccessReviewInstanceDecisionInsights(ctx context.Context, id UserIdPendingAccessReviewInstanceIdDecisionId) (result ListPendingAccessReviewInstanceDecisionInsightsOperationResponse, err error) {
...
func (c PendingAccessReviewInstanceDecisionInsightClient) ListPendingAccessReviewInstanceDecisionInsightsComplete(ctx context.Context, id UserIdPendingAccessReviewInstanceIdDecisionId) (ListPendingAccessReviewInstanceDecisionInsightsCompleteResult, error) {
