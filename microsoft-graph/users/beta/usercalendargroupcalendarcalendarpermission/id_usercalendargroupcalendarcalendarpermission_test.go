...
func TestNewUserCalendarGroupCalendarCalendarPermissionID(t *testing.T) {
	id := NewUserCalendarGroupCalendarCalendarPermissionID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "calendarPermissionIdValue")
...
func TestFormatUserCalendarGroupCalendarCalendarPermissionID(t *testing.T) {
	actual := NewUserCalendarGroupCalendarCalendarPermissionID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "calendarPermissionIdValue").ID()
...
func TestParseUserCalendarGroupCalendarCalendarPermissionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarCalendarPermissionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarCalendarPermissionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarGroupCalendarCalendarPermissionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarCalendarPermissionId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarCalendarPermissionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarGroupCalendarCalendarPermissionId(t *testing.T) {
	segments := UserCalendarGroupCalendarCalendarPermissionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarGroupCalendarCalendarPermissionId has no segments")
	}
