...
func (c ChatMessageReplyClient) CreateChatMessageReply(ctx context.Context, id UserIdChatIdMessageId, input beta.ChatMessage) (result CreateChatMessageReplyOperationResponse, err error) {
