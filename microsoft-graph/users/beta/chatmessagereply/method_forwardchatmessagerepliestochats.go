...
func (c ChatMessageReplyClient) ForwardChatMessageRepliesToChats(ctx context.Context, id beta.UserIdChatIdMessageId, input ForwardChatMessageRepliesToChatsRequest, options ForwardChatMessageRepliesToChatsOperationOptions) (result ForwardChatMessageRepliesToChatsOperationResponse, err error) {
...
func (c ChatMessageReplyClient) ForwardChatMessageRepliesToChatsComplete(ctx context.Context, id beta.UserIdChatIdMessageId, input ForwardChatMessageRepliesToChatsRequest, options ForwardChatMessageRepliesToChatsOperationOptions) (ForwardChatMessageRepliesToChatsCompleteResult, error) {
