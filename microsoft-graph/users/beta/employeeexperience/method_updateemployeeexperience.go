...
func (c EmployeeExperienceClient) UpdateEmployeeExperience(ctx context.Context, id UserId, input beta.EmployeeExperienceUser) (result UpdateEmployeeExperienceOperationResponse, err error) {
