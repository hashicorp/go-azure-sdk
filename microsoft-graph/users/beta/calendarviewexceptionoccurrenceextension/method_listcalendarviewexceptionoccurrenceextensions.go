...
func (c CalendarViewExceptionOccurrenceExtensionClient) ListCalendarViewExceptionOccurrenceExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarViewExceptionOccurrenceExtensionsCompleteResult, err error) {
