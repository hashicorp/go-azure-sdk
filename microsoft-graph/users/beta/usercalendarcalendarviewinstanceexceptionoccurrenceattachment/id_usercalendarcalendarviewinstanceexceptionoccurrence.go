...
func NewUserCalendarCalendarViewInstanceExceptionOccurrenceID(userId string, calendarId string, eventId string, eventId1 string, eventId2 string) UserCalendarCalendarViewInstanceExceptionOccurrenceId {
