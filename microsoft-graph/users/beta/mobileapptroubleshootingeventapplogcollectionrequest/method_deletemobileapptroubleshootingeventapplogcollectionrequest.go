...
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) DeleteMobileAppTroubleshootingEventAppLogCollectionRequest(ctx context.Context, id UserIdMobileAppTroubleshootingEventIdAppLogCollectionRequestId) (result DeleteMobileAppTroubleshootingEventAppLogCollectionRequestOperationResponse, err error) {
