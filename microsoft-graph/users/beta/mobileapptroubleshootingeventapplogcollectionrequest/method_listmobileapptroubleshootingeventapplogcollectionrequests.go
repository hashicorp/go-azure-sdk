...
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) ListMobileAppTroubleshootingEventAppLogCollectionRequests(ctx context.Context, id UserIdMobileAppTroubleshootingEventId) (result ListMobileAppTroubleshootingEventAppLogCollectionRequestsOperationResponse, err error) {
...
func (c MobileAppTroubleshootingEventAppLogCollectionRequestClient) ListMobileAppTroubleshootingEventAppLogCollectionRequestsComplete(ctx context.Context, id UserIdMobileAppTroubleshootingEventId) (ListMobileAppTroubleshootingEventAppLogCollectionRequestsCompleteResult, error) {
