...
func TestNewUserPendingAccessReviewInstanceDecisionInstanceStageID(t *testing.T) {
	id := NewUserPendingAccessReviewInstanceDecisionInstanceStageID("userIdValue", "accessReviewInstanceIdValue", "accessReviewInstanceDecisionItemIdValue", "accessReviewStageIdValue")
...
func TestFormatUserPendingAccessReviewInstanceDecisionInstanceStageID(t *testing.T) {
	actual := NewUserPendingAccessReviewInstanceDecisionInstanceStageID("userIdValue", "accessReviewInstanceIdValue", "accessReviewInstanceDecisionItemIdValue", "accessReviewStageIdValue").ID()
...
func TestParseUserPendingAccessReviewInstanceDecisionInstanceStageID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceDecisionInstanceStageId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceDecisionInstanceStageID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserPendingAccessReviewInstanceDecisionInstanceStageIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceDecisionInstanceStageId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceDecisionInstanceStageIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserPendingAccessReviewInstanceDecisionInstanceStageId(t *testing.T) {
	segments := UserPendingAccessReviewInstanceDecisionInstanceStageId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserPendingAccessReviewInstanceDecisionInstanceStageId has no segments")
	}
