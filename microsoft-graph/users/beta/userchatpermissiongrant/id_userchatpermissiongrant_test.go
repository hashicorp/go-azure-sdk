...
func TestNewUserChatPermissionGrantID(t *testing.T) {
	id := NewUserChatPermissionGrantID("userIdValue", "chatIdValue", "resourceSpecificPermissionGrantIdValue")
...
func TestFormatUserChatPermissionGrantID(t *testing.T) {
	actual := NewUserChatPermissionGrantID("userIdValue", "chatIdValue", "resourceSpecificPermissionGrantIdValue").ID()
...
func TestParseUserChatPermissionGrantID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserChatPermissionGrantId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserChatPermissionGrantID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserChatPermissionGrantIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserChatPermissionGrantId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserChatPermissionGrantIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserChatPermissionGrantId(t *testing.T) {
	segments := UserChatPermissionGrantId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserChatPermissionGrantId has no segments")
	}
