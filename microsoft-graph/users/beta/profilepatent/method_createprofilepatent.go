...
// CreateProfilePatent ...
func (c ProfilePatentClient) CreateProfilePatent(ctx context.Context, id UserId, input beta.ItemPatent) (result CreateProfilePatentOperationResponse, err error) {
