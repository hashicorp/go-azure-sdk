...
func TestNewUserPendingAccessReviewInstanceDecisionInstanceContactedReviewerID(t *testing.T) {
	id := NewUserPendingAccessReviewInstanceDecisionInstanceContactedReviewerID("userIdValue", "accessReviewInstanceIdValue", "accessReviewInstanceDecisionItemIdValue", "accessReviewReviewerIdValue")
...
func TestFormatUserPendingAccessReviewInstanceDecisionInstanceContactedReviewerID(t *testing.T) {
	actual := NewUserPendingAccessReviewInstanceDecisionInstanceContactedReviewerID("userIdValue", "accessReviewInstanceIdValue", "accessReviewInstanceDecisionItemIdValue", "accessReviewReviewerIdValue").ID()
...
func TestParseUserPendingAccessReviewInstanceDecisionInstanceContactedReviewerID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceDecisionInstanceContactedReviewerId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceDecisionInstanceContactedReviewerID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserPendingAccessReviewInstanceDecisionInstanceContactedReviewerIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceDecisionInstanceContactedReviewerId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceDecisionInstanceContactedReviewerIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserPendingAccessReviewInstanceDecisionInstanceContactedReviewerId(t *testing.T) {
	segments := UserPendingAccessReviewInstanceDecisionInstanceContactedReviewerId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserPendingAccessReviewInstanceDecisionInstanceContactedReviewerId has no segments")
	}
