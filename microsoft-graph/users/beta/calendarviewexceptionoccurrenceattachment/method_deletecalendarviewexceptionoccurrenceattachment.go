...
// DeleteCalendarViewExceptionOccurrenceAttachment - Delete navigation property attachments for users
func (c CalendarViewExceptionOccurrenceAttachmentClient) DeleteCalendarViewExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdCalendarViewIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarViewExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarViewExceptionOccurrenceAttachmentOperationResponse, err error) {
