...
func (c DriveListItemVersionClient) CreateDriveListItemVersion(ctx context.Context, id beta.UserIdDriveIdListItemId, input beta.ListItemVersion) (result CreateDriveListItemVersionOperationResponse, err error) {
