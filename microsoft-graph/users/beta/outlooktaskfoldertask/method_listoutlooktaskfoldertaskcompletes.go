...
func (c OutlookTaskFolderTaskClient) ListOutlookTaskFolderTaskCompletes(ctx context.Context, id UserIdOutlookTaskFolderIdTaskId) (result ListOutlookTaskFolderTaskCompletesOperationResponse, err error) {
...
func (c OutlookTaskFolderTaskClient) ListOutlookTaskFolderTaskCompletesComplete(ctx context.Context, id UserIdOutlookTaskFolderIdTaskId) (ListOutlookTaskFolderTaskCompletesCompleteResult, error) {
...
func (c OutlookTaskFolderTaskClient) ListOutlookTaskFolderTaskCompletesCompleteMatchingPredicate(ctx context.Context, id UserIdOutlookTaskFolderIdTaskId, predicate OutlookTaskOperationPredicate) (result ListOutlookTaskFolderTaskCompletesCompleteResult, err error) {
