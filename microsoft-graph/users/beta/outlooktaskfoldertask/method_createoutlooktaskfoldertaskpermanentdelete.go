...
// Items quotas.
func (c OutlookTaskFolderTaskClient) CreateOutlookTaskFolderTaskPermanentDelete(ctx context.Context, id beta.UserIdOutlookTaskFolderIdTaskId, options CreateOutlookTaskFolderTaskPermanentDeleteOperationOptions) (result CreateOutlookTaskFolderTaskPermanentDeleteOperationResponse, err error) {
