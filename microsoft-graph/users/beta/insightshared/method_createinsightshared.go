...
func (c InsightSharedClient) CreateInsightShared(ctx context.Context, id beta.UserId, input beta.SharedInsight) (result CreateInsightSharedOperationResponse, err error) {
