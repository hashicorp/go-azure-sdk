...
// CreateInsightShared ...
func (c InsightSharedClient) CreateInsightShared(ctx context.Context, id UserId, input beta.SharedInsight) (result CreateInsightSharedOperationResponse, err error) {
