...
func (c OnlineMeetingTranscriptContentClient) SetOnlineMeetingTranscriptContent(ctx context.Context, id beta.UserIdOnlineMeetingIdTranscriptId, input []byte) (result SetOnlineMeetingTranscriptContentOperationResponse, err error) {
