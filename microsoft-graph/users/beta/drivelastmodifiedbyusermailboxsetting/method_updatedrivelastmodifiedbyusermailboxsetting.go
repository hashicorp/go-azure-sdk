...
func (c DriveLastModifiedByUserMailboxSettingClient) UpdateDriveLastModifiedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveId, input beta.MailboxSettings) (result UpdateDriveLastModifiedByUserMailboxSettingOperationResponse, err error) {
