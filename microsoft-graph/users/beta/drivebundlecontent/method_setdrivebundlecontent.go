...
func (c DriveBundleContentClient) SetDriveBundleContent(ctx context.Context, id beta.UserIdDriveIdBundleId, input []byte) (result SetDriveBundleContentOperationResponse, err error) {
