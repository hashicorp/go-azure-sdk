...
func TestNewUserCalendarGroupCalendarCalendarViewInstanceID(t *testing.T) {
	id := NewUserCalendarGroupCalendarCalendarViewInstanceID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value")
...
func TestFormatUserCalendarGroupCalendarCalendarViewInstanceID(t *testing.T) {
	actual := NewUserCalendarGroupCalendarCalendarViewInstanceID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value").ID()
...
func TestParseUserCalendarGroupCalendarCalendarViewInstanceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarCalendarViewInstanceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarCalendarViewInstanceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarGroupCalendarCalendarViewInstanceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarCalendarViewInstanceId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarCalendarViewInstanceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarGroupCalendarCalendarViewInstanceId(t *testing.T) {
	segments := UserCalendarGroupCalendarCalendarViewInstanceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarGroupCalendarCalendarViewInstanceId has no segments")
	}
