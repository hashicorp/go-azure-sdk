...
func (c InferenceClassificationOverrideClient) CreateInferenceClassificationOverride(ctx context.Context, id UserId, input beta.InferenceClassificationOverride) (result CreateInferenceClassificationOverrideOperationResponse, err error) {
