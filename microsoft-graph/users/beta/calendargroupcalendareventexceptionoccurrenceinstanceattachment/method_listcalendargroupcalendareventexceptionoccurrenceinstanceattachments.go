...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentsComplete(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdInstanceId, options ListCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentsOperationOptions) (ListCalendarGroupCalendarEventExceptionOccurrenceInstanceAttachmentsCompleteResult, error) {
