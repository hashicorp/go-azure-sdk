...
// DeleteCalendarViewInstanceExceptionOccurrenceAttachment - Delete navigation property attachments for users
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) DeleteCalendarViewInstanceExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarViewInstanceExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarViewInstanceExceptionOccurrenceAttachmentOperationResponse, err error) {
