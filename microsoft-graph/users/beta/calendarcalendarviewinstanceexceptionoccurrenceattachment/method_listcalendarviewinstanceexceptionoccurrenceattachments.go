...
// ListCalendarViewInstanceExceptionOccurrenceAttachments - Get attachments from users. The collection of
// FileAttachment, ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only.
// Nullable.
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) ListCalendarViewInstanceExceptionOccurrenceAttachments(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId, options ListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationOptions) (result ListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) ListCalendarViewInstanceExceptionOccurrenceAttachmentsComplete(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId, options ListCalendarViewInstanceExceptionOccurrenceAttachmentsOperationOptions) (ListCalendarViewInstanceExceptionOccurrenceAttachmentsCompleteResult, error) {
