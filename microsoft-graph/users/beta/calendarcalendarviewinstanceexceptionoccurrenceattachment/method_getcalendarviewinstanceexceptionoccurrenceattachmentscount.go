...
func (c CalendarCalendarViewInstanceExceptionOccurrenceAttachmentClient) GetCalendarViewInstanceExceptionOccurrenceAttachmentsCount(ctx context.Context, id beta.UserIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceId, options GetCalendarViewInstanceExceptionOccurrenceAttachmentsCountOperationOptions) (result GetCalendarViewInstanceExceptionOccurrenceAttachmentsCountOperationResponse, err error) {
