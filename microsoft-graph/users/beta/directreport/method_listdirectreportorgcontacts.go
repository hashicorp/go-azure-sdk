...
// collection
func (c DirectReportClient) ListDirectReportOrgContacts(ctx context.Context, id beta.UserId, options ListDirectReportOrgContactsOperationOptions) (result ListDirectReportOrgContactsOperationResponse, err error) {
...
func (c DirectReportClient) ListDirectReportOrgContactsComplete(ctx context.Context, id beta.UserId, options ListDirectReportOrgContactsOperationOptions) (ListDirectReportOrgContactsCompleteResult, error) {
...
func (c DirectReportClient) ListDirectReportOrgContactsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListDirectReportOrgContactsOperationOptions, predicate OrgContactOperationPredicate) (result ListDirectReportOrgContactsCompleteResult, err error) {
