...
func (c DirectReportClient) ListDirectReportUsers(ctx context.Context, id beta.UserId, options ListDirectReportUsersOperationOptions) (result ListDirectReportUsersOperationResponse, err error) {
...
func (c DirectReportClient) ListDirectReportUsersComplete(ctx context.Context, id beta.UserId, options ListDirectReportUsersOperationOptions) (ListDirectReportUsersCompleteResult, error) {
...
func (c DirectReportClient) ListDirectReportUsersCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListDirectReportUsersOperationOptions, predicate UserOperationPredicate) (result ListDirectReportUsersCompleteResult, err error) {
