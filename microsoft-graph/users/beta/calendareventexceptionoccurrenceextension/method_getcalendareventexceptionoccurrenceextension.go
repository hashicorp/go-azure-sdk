...
// GetCalendarEventExceptionOccurrenceExtension - Get extensions from users. The collection of open extensions defined
// for the event. Nullable.
func (c CalendarEventExceptionOccurrenceExtensionClient) GetCalendarEventExceptionOccurrenceExtension(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceIdExtensionId, options GetCalendarEventExceptionOccurrenceExtensionOperationOptions) (result GetCalendarEventExceptionOccurrenceExtensionOperationResponse, err error) {
