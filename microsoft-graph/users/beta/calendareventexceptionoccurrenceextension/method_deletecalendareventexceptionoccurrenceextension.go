...
// DeleteCalendarEventExceptionOccurrenceExtension - Delete navigation property extensions for users
func (c CalendarEventExceptionOccurrenceExtensionClient) DeleteCalendarEventExceptionOccurrenceExtension(ctx context.Context, id beta.UserIdCalendarEventIdExceptionOccurrenceIdExtensionId, options DeleteCalendarEventExceptionOccurrenceExtensionOperationOptions) (result DeleteCalendarEventExceptionOccurrenceExtensionOperationResponse, err error) {
