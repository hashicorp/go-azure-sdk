...
// ListCalendarEventExceptionOccurrenceExtensions - Get extensions from users. The collection of open extensions defined
// for the event. Nullable.
func (c CalendarEventExceptionOccurrenceExtensionClient) ListCalendarEventExceptionOccurrenceExtensions(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceId, options ListCalendarEventExceptionOccurrenceExtensionsOperationOptions) (result ListCalendarEventExceptionOccurrenceExtensionsOperationResponse, err error) {
