...
func (c CalendarEventExceptionOccurrenceExtensionClient) ListCalendarEventExceptionOccurrenceExtensions(ctx context.Context, id UserIdCalendarIdEventIdExceptionOccurrenceId) (result ListCalendarEventExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c CalendarEventExceptionOccurrenceExtensionClient) ListCalendarEventExceptionOccurrenceExtensionsComplete(ctx context.Context, id UserIdCalendarIdEventIdExceptionOccurrenceId) (ListCalendarEventExceptionOccurrenceExtensionsCompleteResult, error) {
