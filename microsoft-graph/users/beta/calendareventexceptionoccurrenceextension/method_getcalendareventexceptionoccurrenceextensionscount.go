...
func (c CalendarEventExceptionOccurrenceExtensionClient) GetCalendarEventExceptionOccurrenceExtensionsCount(ctx context.Context, id beta.UserIdCalendarIdEventIdExceptionOccurrenceId, options GetCalendarEventExceptionOccurrenceExtensionsCountOperationOptions) (result GetCalendarEventExceptionOccurrenceExtensionsCountOperationResponse, err error) {
