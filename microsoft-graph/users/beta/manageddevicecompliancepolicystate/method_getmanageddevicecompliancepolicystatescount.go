...
func (c ManagedDeviceCompliancePolicyStateClient) GetManagedDeviceCompliancePolicyStatesCount(ctx context.Context, id beta.UserIdManagedDeviceId, options GetManagedDeviceCompliancePolicyStatesCountOperationOptions) (result GetManagedDeviceCompliancePolicyStatesCountOperationResponse, err error) {
