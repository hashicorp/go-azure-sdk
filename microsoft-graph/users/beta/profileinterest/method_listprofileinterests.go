...
func (c ProfileInterestClient) ListProfileInterests(ctx context.Context, id UserId) (result ListProfileInterestsOperationResponse, err error) {
...
func (c ProfileInterestClient) ListProfileInterestsComplete(ctx context.Context, id UserId) (ListProfileInterestsCompleteResult, error) {
	return c.ListProfileInterestsCompleteMatchingPredicate(ctx, id, PersonInterestOperationPredicate{})
}

// ListProfileInterestsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ProfileInterestClient) ListProfileInterestsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate PersonInterestOperationPredicate) (result ListProfileInterestsCompleteResult, err error) {
	items := make([]beta.PersonInterest, 0)

	resp, err := c.ListProfileInterests(ctx, id)
	if err != nil {
