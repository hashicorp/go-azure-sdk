...
func (c ProfileInterestClient) CreateProfileInterest(ctx context.Context, id beta.UserId, input beta.PersonInterest) (result CreateProfileInterestOperationResponse, err error) {
