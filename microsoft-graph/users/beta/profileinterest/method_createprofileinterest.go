...
func (c ProfileInterestClient) CreateProfileInterest(ctx context.Context, id UserId, input beta.PersonInterest) (result CreateProfileInterestOperationResponse, err error) {
