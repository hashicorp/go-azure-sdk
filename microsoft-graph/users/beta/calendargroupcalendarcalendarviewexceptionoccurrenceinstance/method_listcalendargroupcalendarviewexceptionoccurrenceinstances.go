...
func (c CalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceClient) ListCalendarGroupCalendarViewExceptionOccurrenceInstances(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, options ListCalendarGroupCalendarViewExceptionOccurrenceInstancesOperationOptions) (result ListCalendarGroupCalendarViewExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c CalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceClient) ListCalendarGroupCalendarViewExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, options ListCalendarGroupCalendarViewExceptionOccurrenceInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarGroupCalendarViewExceptionOccurrenceInstancesCompleteResult, err error) {
