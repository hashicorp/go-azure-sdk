...
func (c CalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceClient) ListCalendarGroupCalendarCalendarViewExceptionOccurrenceInstancesComplete(ctx context.Context, id UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId) (ListCalendarGroupCalendarCalendarViewExceptionOccurrenceInstancesCompleteResult, error) {
...
func (c CalendarGroupCalendarCalendarViewExceptionOccurrenceInstanceClient) ListCalendarGroupCalendarCalendarViewExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, predicate EventOperationPredicate) (result ListCalendarGroupCalendarCalendarViewExceptionOccurrenceInstancesCompleteResult, err error) {
