...
func (c CalendarGroupCalendarEventAttachmentClient) DeleteCalendarGroupCalendarEventAttachment(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdAttachmentId, options DeleteCalendarGroupCalendarEventAttachmentOperationOptions) (result DeleteCalendarGroupCalendarEventAttachmentOperationResponse, err error) {
