...
func (c CalendarGroupCalendarEventAttachmentClient) CreateCalendarGroupCalendarEventAttachmentsUploadSession(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventId, input CreateCalendarGroupCalendarEventAttachmentsUploadSessionRequest) (result CreateCalendarGroupCalendarEventAttachmentsUploadSessionOperationResponse, err error) {
