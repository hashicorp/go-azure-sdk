...
func (c CalendarGroupCalendarEventAttachmentClient) GetCalendarGroupCalendarEventAttachment(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdAttachmentId, options GetCalendarGroupCalendarEventAttachmentOperationOptions) (result GetCalendarGroupCalendarEventAttachmentOperationResponse, err error) {
