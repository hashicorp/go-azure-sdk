...
func TestNewUserPendingAccessReviewInstanceDecisionInsightID(t *testing.T) {
	id := NewUserPendingAccessReviewInstanceDecisionInsightID("userIdValue", "accessReviewInstanceIdValue", "accessReviewInstanceDecisionItemIdValue", "governanceInsightIdValue")
...
func TestFormatUserPendingAccessReviewInstanceDecisionInsightID(t *testing.T) {
	actual := NewUserPendingAccessReviewInstanceDecisionInsightID("userIdValue", "accessReviewInstanceIdValue", "accessReviewInstanceDecisionItemIdValue", "governanceInsightIdValue").ID()
...
func TestParseUserPendingAccessReviewInstanceDecisionInsightID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceDecisionInsightId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceDecisionInsightID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserPendingAccessReviewInstanceDecisionInsightIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceDecisionInsightId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceDecisionInsightIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserPendingAccessReviewInstanceDecisionInsightId(t *testing.T) {
	segments := UserPendingAccessReviewInstanceDecisionInsightId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserPendingAccessReviewInstanceDecisionInsightId has no segments")
	}
