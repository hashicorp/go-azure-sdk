...
func (c DriveItemThumbnailClient) CreateDriveItemThumbnail(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.ThumbnailSet) (result CreateDriveItemThumbnailOperationResponse, err error) {
