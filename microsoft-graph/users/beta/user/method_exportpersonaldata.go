...
func (c UserClient) ExportPersonalData(ctx context.Context, id beta.UserId, input ExportPersonalDataRequest) (result ExportPersonalDataOperationResponse, err error) {
