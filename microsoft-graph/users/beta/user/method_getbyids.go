...
// function are to:
func (c UserClient) GetByIds(ctx context.Context, input GetByIdsRequest, options GetByIdsOperationOptions) (result GetByIdsOperationResponse, err error) {
...
func (c UserClient) GetByIdsComplete(ctx context.Context, input GetByIdsRequest, options GetByIdsOperationOptions) (GetByIdsCompleteResult, error) {
...
func (c UserClient) GetByIdsCompleteMatchingPredicate(ctx context.Context, input GetByIdsRequest, options GetByIdsOperationOptions, predicate DirectoryObjectOperationPredicate) (result GetByIdsCompleteResult, err error) {
