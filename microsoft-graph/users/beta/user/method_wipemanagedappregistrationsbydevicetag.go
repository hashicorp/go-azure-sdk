...
func (c UserClient) WipeManagedAppRegistrationsByDeviceTag(ctx context.Context, id beta.UserId, input WipeManagedAppRegistrationsByDeviceTagRequest) (result WipeManagedAppRegistrationsByDeviceTagOperationResponse, err error) {
