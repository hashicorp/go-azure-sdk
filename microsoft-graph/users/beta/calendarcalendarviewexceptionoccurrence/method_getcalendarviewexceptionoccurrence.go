...
func (c CalendarCalendarViewExceptionOccurrenceClient) GetCalendarViewExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarCalendarViewIdExceptionOccurrenceId, options GetCalendarViewExceptionOccurrenceOperationOptions) (result GetCalendarViewExceptionOccurrenceOperationResponse, err error) {
