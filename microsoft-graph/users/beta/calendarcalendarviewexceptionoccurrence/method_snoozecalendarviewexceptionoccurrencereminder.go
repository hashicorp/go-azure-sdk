...
func (c CalendarCalendarViewExceptionOccurrenceClient) SnoozeCalendarViewExceptionOccurrenceReminder(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdExceptionOccurrenceId, input SnoozeCalendarViewExceptionOccurrenceReminderRequest) (result SnoozeCalendarViewExceptionOccurrenceReminderOperationResponse, err error) {
