...
// ListCalendarViewExceptionOccurrences - Get exceptionOccurrences from users
func (c CalendarCalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrences(ctx context.Context, id beta.UserIdCalendarCalendarViewId, options ListCalendarViewExceptionOccurrencesOperationOptions) (result ListCalendarViewExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrencesComplete(ctx context.Context, id beta.UserIdCalendarCalendarViewId, options ListCalendarViewExceptionOccurrencesOperationOptions) (ListCalendarViewExceptionOccurrencesCompleteResult, error) {
