...
func (c CalendarCalendarViewExceptionOccurrenceClient) TentativelyAcceptCalendarViewExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarCalendarViewIdExceptionOccurrenceId, input TentativelyAcceptCalendarViewExceptionOccurrenceRequest) (result TentativelyAcceptCalendarViewExceptionOccurrenceOperationResponse, err error) {
