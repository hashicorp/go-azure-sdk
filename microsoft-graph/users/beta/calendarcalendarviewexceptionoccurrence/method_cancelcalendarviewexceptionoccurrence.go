...
func (c CalendarCalendarViewExceptionOccurrenceClient) CancelCalendarViewExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdExceptionOccurrenceId, input CancelCalendarViewExceptionOccurrenceRequest) (result CancelCalendarViewExceptionOccurrenceOperationResponse, err error) {
