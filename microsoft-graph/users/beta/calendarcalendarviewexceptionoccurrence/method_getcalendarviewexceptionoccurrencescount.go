...
func (c CalendarCalendarViewExceptionOccurrenceClient) GetCalendarViewExceptionOccurrencesCount(ctx context.Context, id beta.UserIdCalendarIdCalendarViewId, options GetCalendarViewExceptionOccurrencesCountOperationOptions) (result GetCalendarViewExceptionOccurrencesCountOperationResponse, err error) {
