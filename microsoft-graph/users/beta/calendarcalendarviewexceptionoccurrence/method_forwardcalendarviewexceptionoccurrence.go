...
func (c CalendarCalendarViewExceptionOccurrenceClient) ForwardCalendarViewExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdExceptionOccurrenceId, input ForwardCalendarViewExceptionOccurrenceRequest) (result ForwardCalendarViewExceptionOccurrenceOperationResponse, err error) {
