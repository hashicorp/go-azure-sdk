...
func TestNewUserCalendarEventInstanceExceptionOccurrenceID(t *testing.T) {
	id := NewUserCalendarEventInstanceExceptionOccurrenceID("userIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value")
...
func TestFormatUserCalendarEventInstanceExceptionOccurrenceID(t *testing.T) {
	actual := NewUserCalendarEventInstanceExceptionOccurrenceID("userIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value").ID()
...
func TestParseUserCalendarEventInstanceExceptionOccurrenceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarEventInstanceExceptionOccurrenceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarEventInstanceExceptionOccurrenceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarEventInstanceExceptionOccurrenceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarEventInstanceExceptionOccurrenceId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarEventInstanceExceptionOccurrenceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarEventInstanceExceptionOccurrenceId(t *testing.T) {
	segments := UserCalendarEventInstanceExceptionOccurrenceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarEventInstanceExceptionOccurrenceId has no segments")
	}
