...
func (c SettingWindowInstanceClient) CreateSettingWindowInstance(ctx context.Context, id beta.UserIdSettingWindowId, input beta.WindowsSettingInstance) (result CreateSettingWindowInstanceOperationResponse, err error) {
