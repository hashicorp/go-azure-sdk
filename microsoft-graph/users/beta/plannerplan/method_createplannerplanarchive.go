...
func (c PlannerPlanClient) CreatePlannerPlanArchive(ctx context.Context, id beta.UserIdPlannerPlanId, input CreatePlannerPlanArchiveRequest) (result CreatePlannerPlanArchiveOperationResponse, err error) {
