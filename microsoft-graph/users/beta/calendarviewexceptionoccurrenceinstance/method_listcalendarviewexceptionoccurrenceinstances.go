...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstances(ctx context.Context, id beta.UserIdCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceInstancesOperationOptions) (result ListCalendarViewExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstancesComplete(ctx context.Context, id beta.UserIdCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceInstancesOperationOptions) (ListCalendarViewExceptionOccurrenceInstancesCompleteResult, error) {
...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarViewIdExceptionOccurrenceId, options ListCalendarViewExceptionOccurrenceInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewExceptionOccurrenceInstancesCompleteResult, err error) {
