...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstances(ctx context.Context, id UserIdCalendarViewIdExceptionOccurrenceId) (result ListCalendarViewExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstancesComplete(ctx context.Context, id UserIdCalendarViewIdExceptionOccurrenceId) (ListCalendarViewExceptionOccurrenceInstancesCompleteResult, error) {
...
func (c CalendarViewExceptionOccurrenceInstanceClient) ListCalendarViewExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarViewIdExceptionOccurrenceId, predicate EventOperationPredicate) (result ListCalendarViewExceptionOccurrenceInstancesCompleteResult, err error) {
