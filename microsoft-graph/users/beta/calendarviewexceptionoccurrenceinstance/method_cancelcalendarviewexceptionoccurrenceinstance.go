...
// cancellation.
func (c CalendarViewExceptionOccurrenceInstanceClient) CancelCalendarViewExceptionOccurrenceInstance(ctx context.Context, id beta.UserIdCalendarViewIdExceptionOccurrenceIdInstanceId, input CancelCalendarViewExceptionOccurrenceInstanceRequest) (result CancelCalendarViewExceptionOccurrenceInstanceOperationResponse, err error) {
