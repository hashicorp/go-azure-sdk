...
func TestNewUserManagedDeviceAssignmentFilterEvaluationStatusDetailID(t *testing.T) {
	id := NewUserManagedDeviceAssignmentFilterEvaluationStatusDetailID("userIdValue", "managedDeviceIdValue", "assignmentFilterEvaluationStatusDetailsIdValue")
...
func TestFormatUserManagedDeviceAssignmentFilterEvaluationStatusDetailID(t *testing.T) {
	actual := NewUserManagedDeviceAssignmentFilterEvaluationStatusDetailID("userIdValue", "managedDeviceIdValue", "assignmentFilterEvaluationStatusDetailsIdValue").ID()
...
func TestParseUserManagedDeviceAssignmentFilterEvaluationStatusDetailID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserManagedDeviceAssignmentFilterEvaluationStatusDetailId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserManagedDeviceAssignmentFilterEvaluationStatusDetailID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserManagedDeviceAssignmentFilterEvaluationStatusDetailIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserManagedDeviceAssignmentFilterEvaluationStatusDetailId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserManagedDeviceAssignmentFilterEvaluationStatusDetailIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserManagedDeviceAssignmentFilterEvaluationStatusDetailId(t *testing.T) {
	segments := UserManagedDeviceAssignmentFilterEvaluationStatusDetailId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserManagedDeviceAssignmentFilterEvaluationStatusDetailId has no segments")
	}
