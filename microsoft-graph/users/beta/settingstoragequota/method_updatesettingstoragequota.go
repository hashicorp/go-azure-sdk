...
func (c SettingStorageQuotaClient) UpdateSettingStorageQuota(ctx context.Context, id beta.UserId, input beta.UnifiedStorageQuota) (result UpdateSettingStorageQuotaOperationResponse, err error) {
