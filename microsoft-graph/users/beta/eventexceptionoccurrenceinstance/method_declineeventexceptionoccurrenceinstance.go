...
func (c EventExceptionOccurrenceInstanceClient) DeclineEventExceptionOccurrenceInstance(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceIdInstanceId, input DeclineEventExceptionOccurrenceInstanceRequest) (result DeclineEventExceptionOccurrenceInstanceOperationResponse, err error) {
