...
func (c DriveItemSubscriptionClient) CreateDriveItemSubscription(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.Subscription) (result CreateDriveItemSubscriptionOperationResponse, err error) {
