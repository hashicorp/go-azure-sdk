...
func (c DriveItemSubscriptionClient) CreateDriveItemSubscriptionReauthorize(ctx context.Context, id beta.UserIdDriveIdItemIdSubscriptionId) (result CreateDriveItemSubscriptionReauthorizeOperationResponse, err error) {
