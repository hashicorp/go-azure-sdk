...
func (c ChatClient) RemoveChatAllAccessForUser(ctx context.Context, id beta.UserIdChatId, input RemoveChatAllAccessForUserRequest) (result RemoveChatAllAccessForUserOperationResponse, err error) {
