...
func (c CalendarCalendarPermissionClient) ListCalendarCalendarPermissions(ctx context.Context, id UserIdCalendarId) (result ListCalendarCalendarPermissionsOperationResponse, err error) {
...
func (c CalendarCalendarPermissionClient) ListCalendarCalendarPermissionsComplete(ctx context.Context, id UserIdCalendarId) (ListCalendarCalendarPermissionsCompleteResult, error) {
...
func (c CalendarCalendarPermissionClient) ListCalendarCalendarPermissionsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarId, predicate CalendarPermissionOperationPredicate) (result ListCalendarCalendarPermissionsCompleteResult, err error) {
