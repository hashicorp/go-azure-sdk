...
// GetCalendarPermission - Get calendarPermission. Get the specified permissions object of a user or group calendar that
// has been shared.
func (c CalendarCalendarPermissionClient) GetCalendarPermission(ctx context.Context, id beta.UserIdCalendarCalendarPermissionId, options GetCalendarPermissionOperationOptions) (result GetCalendarPermissionOperationResponse, err error) {
