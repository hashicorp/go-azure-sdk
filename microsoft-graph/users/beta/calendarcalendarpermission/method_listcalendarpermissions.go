...
// ListCalendarPermissions - Get calendarPermission. Get the specified permissions object of a user or group calendar
// that has been shared.
func (c CalendarCalendarPermissionClient) ListCalendarPermissions(ctx context.Context, id beta.UserId, options ListCalendarPermissionsOperationOptions) (result ListCalendarPermissionsOperationResponse, err error) {
...
func (c CalendarCalendarPermissionClient) ListCalendarPermissionsComplete(ctx context.Context, id beta.UserId, options ListCalendarPermissionsOperationOptions) (ListCalendarPermissionsCompleteResult, error) {
...
func (c CalendarCalendarPermissionClient) ListCalendarPermissionsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListCalendarPermissionsOperationOptions, predicate CalendarPermissionOperationPredicate) (result ListCalendarPermissionsCompleteResult, err error) {
