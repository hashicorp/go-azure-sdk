...
func (c InsightUsedClient) CreateInsightUsed(ctx context.Context, id beta.UserId, input beta.UsedInsight) (result CreateInsightUsedOperationResponse, err error) {
