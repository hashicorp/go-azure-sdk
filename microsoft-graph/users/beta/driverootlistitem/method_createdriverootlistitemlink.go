...
func (c DriveRootListItemClient) CreateDriveRootListItemLink(ctx context.Context, id beta.UserIdDriveId, input CreateDriveRootListItemLinkRequest) (result CreateDriveRootListItemLinkOperationResponse, err error) {
