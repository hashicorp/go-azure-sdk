...
func (c DriveListItemLastModifiedByUserMailboxSettingClient) UpdateDriveListItemLastModifiedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveIdListItemId, input beta.MailboxSettings) (result UpdateDriveListItemLastModifiedByUserMailboxSettingOperationResponse, err error) {
