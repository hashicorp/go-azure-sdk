...
func TestNewUserPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerID(t *testing.T) {
	id := NewUserPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerID("userIdValue", "accessReviewInstanceIdValue", "accessReviewStageIdValue", "accessReviewInstanceDecisionItemIdValue", "accessReviewReviewerIdValue")
...
func TestFormatUserPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerID(t *testing.T) {
	actual := NewUserPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerID("userIdValue", "accessReviewInstanceIdValue", "accessReviewStageIdValue", "accessReviewInstanceDecisionItemIdValue", "accessReviewReviewerIdValue").ID()
...
func TestParseUserPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerId(t *testing.T) {
	segments := UserPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserPendingAccessReviewInstanceStageDecisionInstanceContactedReviewerId has no segments")
	}
