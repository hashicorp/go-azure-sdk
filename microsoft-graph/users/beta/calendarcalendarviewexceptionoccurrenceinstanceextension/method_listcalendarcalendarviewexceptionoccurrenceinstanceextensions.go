...
func (c CalendarCalendarViewExceptionOccurrenceInstanceExtensionClient) ListCalendarCalendarViewExceptionOccurrenceInstanceExtensions(ctx context.Context, id UserIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId) (result ListCalendarCalendarViewExceptionOccurrenceInstanceExtensionsOperationResponse, err error) {
...
func (c CalendarCalendarViewExceptionOccurrenceInstanceExtensionClient) ListCalendarCalendarViewExceptionOccurrenceInstanceExtensionsComplete(ctx context.Context, id UserIdCalendarIdCalendarViewIdExceptionOccurrenceIdInstanceId) (ListCalendarCalendarViewExceptionOccurrenceInstanceExtensionsCompleteResult, error) {
