...
// DeleteCalendarViewExceptionOccurrenceInstanceExtension - Delete navigation property extensions for users
func (c CalendarCalendarViewExceptionOccurrenceInstanceExtensionClient) DeleteCalendarViewExceptionOccurrenceInstanceExtension(ctx context.Context, id beta.UserIdCalendarCalendarViewIdExceptionOccurrenceIdInstanceIdExtensionId, options DeleteCalendarViewExceptionOccurrenceInstanceExtensionOperationOptions) (result DeleteCalendarViewExceptionOccurrenceInstanceExtensionOperationResponse, err error) {
