...
func (c PermissionGrantClient) CreatePermissionGrant(ctx context.Context, id beta.UserId, input beta.ResourceSpecificPermissionGrant) (result CreatePermissionGrantOperationResponse, err error) {
