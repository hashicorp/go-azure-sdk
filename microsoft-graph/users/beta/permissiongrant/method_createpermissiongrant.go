...
func (c PermissionGrantClient) CreatePermissionGrant(ctx context.Context, id UserId, input beta.ResourceSpecificPermissionGrant) (result CreatePermissionGrantOperationResponse, err error) {
