...
func (c PermissionGrantClient) ListPermissionGrants(ctx context.Context, id UserId) (result ListPermissionGrantsOperationResponse, err error) {
...
func (c PermissionGrantClient) ListPermissionGrantsComplete(ctx context.Context, id UserId) (ListPermissionGrantsCompleteResult, error) {
...
func (c PermissionGrantClient) ListPermissionGrantsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate ResourceSpecificPermissionGrantOperationPredicate) (result ListPermissionGrantsCompleteResult, err error) {
