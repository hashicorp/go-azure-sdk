...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstances(ctx context.Context, id UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceId) (result ListCalendarGroupCalendarEventExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstancesComplete(ctx context.Context, id UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceId) (ListCalendarGroupCalendarEventExceptionOccurrenceInstancesCompleteResult, error) {
...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceClient) ListCalendarGroupCalendarEventExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceId, predicate EventOperationPredicate) (result ListCalendarGroupCalendarEventExceptionOccurrenceInstancesCompleteResult, err error) {
