...
func (c CalendarGroupCalendarEventExceptionOccurrenceInstanceClient) GetCalendarGroupCalendarEventExceptionOccurrenceInstancesCount(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceId, options GetCalendarGroupCalendarEventExceptionOccurrenceInstancesCountOperationOptions) (result GetCalendarGroupCalendarEventExceptionOccurrenceInstancesCountOperationResponse, err error) {
