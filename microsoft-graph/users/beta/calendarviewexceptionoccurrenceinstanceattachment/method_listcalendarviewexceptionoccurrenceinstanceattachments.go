...
func (c CalendarViewExceptionOccurrenceInstanceAttachmentClient) ListCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarViewIdExceptionOccurrenceIdInstanceId, options ListCalendarViewExceptionOccurrenceInstanceAttachmentsOperationOptions, predicate AttachmentOperationPredicate) (result ListCalendarViewExceptionOccurrenceInstanceAttachmentsCompleteResult, err error) {
