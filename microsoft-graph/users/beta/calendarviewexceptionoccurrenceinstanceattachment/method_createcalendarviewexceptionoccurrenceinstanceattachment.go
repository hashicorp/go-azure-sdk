...
func (c CalendarViewExceptionOccurrenceInstanceAttachmentClient) CreateCalendarViewExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.UserIdCalendarViewIdExceptionOccurrenceIdInstanceId, input beta.Attachment) (result CreateCalendarViewExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
