...
func (c ManagedDeviceUserClient) ListManagedDeviceUsers(ctx context.Context, id UserIdManagedDeviceId) (result ListManagedDeviceUsersOperationResponse, err error) {
...
func (c ManagedDeviceUserClient) ListManagedDeviceUsersComplete(ctx context.Context, id UserIdManagedDeviceId) (ListManagedDeviceUsersCompleteResult, error) {
...
func (c ManagedDeviceUserClient) ListManagedDeviceUsersCompleteMatchingPredicate(ctx context.Context, id UserIdManagedDeviceId, predicate UserOperationPredicate) (result ListManagedDeviceUsersCompleteResult, err error) {
