...
func (c TodoListTaskAttachmentClient) CreateTodoListTaskAttachmentsUploadSession(ctx context.Context, id beta.UserIdTodoListIdTaskId, input CreateTodoListTaskAttachmentsUploadSessionRequest) (result CreateTodoListTaskAttachmentsUploadSessionOperationResponse, err error) {
