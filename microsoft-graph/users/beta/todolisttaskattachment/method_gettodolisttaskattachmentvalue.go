...
func (c TodoListTaskAttachmentClient) GetTodoListTaskAttachmentValue(ctx context.Context, id beta.UserIdTodoListIdTaskIdAttachmentId) (result GetTodoListTaskAttachmentValueOperationResponse, err error) {
