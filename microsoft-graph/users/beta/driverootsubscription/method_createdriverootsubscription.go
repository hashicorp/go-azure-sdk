...
func (c DriveRootSubscriptionClient) CreateDriveRootSubscription(ctx context.Context, id beta.UserIdDriveId, input beta.Subscription) (result CreateDriveRootSubscriptionOperationResponse, err error) {
