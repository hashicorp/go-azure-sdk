...
// GetDataSecurityAndGovernanceSensitivityLabelSublabelRight - Get rights from users
func (c DataSecurityAndGovernanceSensitivityLabelSublabelRightClient) GetDataSecurityAndGovernanceSensitivityLabelSublabelRight(ctx context.Context, id beta.UserIdDataSecurityAndGovernanceSensitivityLabelIdSublabelId, options GetDataSecurityAndGovernanceSensitivityLabelSublabelRightOperationOptions) (result GetDataSecurityAndGovernanceSensitivityLabelSublabelRightOperationResponse, err error) {
