...
func (c InsightTrendingClient) CreateInsightTrending(ctx context.Context, id beta.UserId, input beta.Trending) (result CreateInsightTrendingOperationResponse, err error) {
