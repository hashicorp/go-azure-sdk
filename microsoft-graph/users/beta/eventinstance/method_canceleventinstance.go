...
func (c EventInstanceClient) CancelEventInstance(ctx context.Context, id beta.UserIdEventIdInstanceId, input CancelEventInstanceRequest) (result CancelEventInstanceOperationResponse, err error) {
