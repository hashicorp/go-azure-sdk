...
func (c EventInstanceClient) DeclineEventInstance(ctx context.Context, id beta.UserIdEventIdInstanceId, input DeclineEventInstanceRequest) (result DeclineEventInstanceOperationResponse, err error) {
