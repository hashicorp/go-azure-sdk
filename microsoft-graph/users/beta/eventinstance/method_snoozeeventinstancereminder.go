...
// a new time.
func (c EventInstanceClient) SnoozeEventInstanceReminder(ctx context.Context, id beta.UserIdEventIdInstanceId, input SnoozeEventInstanceReminderRequest) (result SnoozeEventInstanceReminderOperationResponse, err error) {
