...
func (c EventInstanceClient) TentativelyAcceptEventInstance(ctx context.Context, id beta.UserIdEventIdInstanceId, input TentativelyAcceptEventInstanceRequest) (result TentativelyAcceptEventInstanceOperationResponse, err error) {
