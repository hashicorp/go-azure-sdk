...
func (c EventInstanceClient) AcceptEventInstance(ctx context.Context, id beta.UserIdEventIdInstanceId, input AcceptEventInstanceRequest) (result AcceptEventInstanceOperationResponse, err error) {
