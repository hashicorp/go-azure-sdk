...
// in a user calendar.
func (c EventInstanceClient) DismissEventInstanceReminder(ctx context.Context, id beta.UserIdEventIdInstanceId) (result DismissEventInstanceReminderOperationResponse, err error) {
