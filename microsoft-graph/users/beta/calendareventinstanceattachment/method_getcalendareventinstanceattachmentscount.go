...
func (c CalendarEventInstanceAttachmentClient) GetCalendarEventInstanceAttachmentsCount(ctx context.Context, id beta.UserIdCalendarEventIdInstanceId, options GetCalendarEventInstanceAttachmentsCountOperationOptions) (result GetCalendarEventInstanceAttachmentsCountOperationResponse, err error) {
