...
func (c CalendarEventInstanceAttachmentClient) GetCalendarEventInstanceAttachment(ctx context.Context, id beta.UserIdCalendarEventIdInstanceIdAttachmentId, options GetCalendarEventInstanceAttachmentOperationOptions) (result GetCalendarEventInstanceAttachmentOperationResponse, err error) {
