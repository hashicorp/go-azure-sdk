...
func (c CalendarEventInstanceAttachmentClient) CreateCalendarEventInstanceAttachmentsUploadSession(ctx context.Context, id beta.UserIdCalendarEventIdInstanceId, input CreateCalendarEventInstanceAttachmentsUploadSessionRequest) (result CreateCalendarEventInstanceAttachmentsUploadSessionOperationResponse, err error) {
