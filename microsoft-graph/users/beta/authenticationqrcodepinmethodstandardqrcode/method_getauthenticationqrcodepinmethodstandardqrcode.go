...
// GetAuthenticationQrCodePinMethodStandardQRCode - Get qrCode. Read the properties and relationships of a qrCode
// object.
func (c AuthenticationQrCodePinMethodStandardQRCodeClient) GetAuthenticationQrCodePinMethodStandardQRCode(ctx context.Context, id beta.UserId, options GetAuthenticationQrCodePinMethodStandardQRCodeOperationOptions) (result GetAuthenticationQrCodePinMethodStandardQRCodeOperationResponse, err error) {
