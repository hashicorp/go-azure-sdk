...
// standard QR code.
func (c AuthenticationQrCodePinMethodStandardQRCodeClient) UpdateAuthenticationQrCodePinMethodStandardQRCode(ctx context.Context, id beta.UserId, input beta.QrCode, options UpdateAuthenticationQrCodePinMethodStandardQRCodeOperationOptions) (result UpdateAuthenticationQrCodePinMethodStandardQRCodeOperationResponse, err error) {
