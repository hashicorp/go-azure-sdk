...
func TestNewUserCalendarGroupCalendarEventExceptionOccurrenceID(t *testing.T) {
	id := NewUserCalendarGroupCalendarEventExceptionOccurrenceID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value")
...
func TestFormatUserCalendarGroupCalendarEventExceptionOccurrenceID(t *testing.T) {
	actual := NewUserCalendarGroupCalendarEventExceptionOccurrenceID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value").ID()
...
func TestParseUserCalendarGroupCalendarEventExceptionOccurrenceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventExceptionOccurrenceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventExceptionOccurrenceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarGroupCalendarEventExceptionOccurrenceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventExceptionOccurrenceId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventExceptionOccurrenceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarGroupCalendarEventExceptionOccurrenceId(t *testing.T) {
	segments := UserCalendarGroupCalendarEventExceptionOccurrenceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarGroupCalendarEventExceptionOccurrenceId has no segments")
	}
