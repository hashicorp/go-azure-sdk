...
func TestNewUserAuthenticationEmailMethodID(t *testing.T) {
	id := NewUserAuthenticationEmailMethodID("userIdValue", "emailAuthenticationMethodIdValue")
...
func TestFormatUserAuthenticationEmailMethodID(t *testing.T) {
	actual := NewUserAuthenticationEmailMethodID("userIdValue", "emailAuthenticationMethodIdValue").ID()
...
func TestParseUserAuthenticationEmailMethodID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserAuthenticationEmailMethodId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserAuthenticationEmailMethodID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserAuthenticationEmailMethodIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserAuthenticationEmailMethodId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserAuthenticationEmailMethodIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserAuthenticationEmailMethodId(t *testing.T) {
	segments := UserAuthenticationEmailMethodId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserAuthenticationEmailMethodId has no segments")
	}
