...
// expiration.
func (c PresenceClient) SetPresenceUserPreferredPresence(ctx context.Context, id beta.UserId, input SetPresenceUserPreferredPresenceRequest) (result SetPresenceUserPreferredPresenceOperationResponse, err error) {
