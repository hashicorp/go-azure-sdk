...
func TestNewUserCalendarGroupCalendarEventInstanceID(t *testing.T) {
	id := NewUserCalendarGroupCalendarEventInstanceID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value")
...
func TestFormatUserCalendarGroupCalendarEventInstanceID(t *testing.T) {
	actual := NewUserCalendarGroupCalendarEventInstanceID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value").ID()
...
func TestParseUserCalendarGroupCalendarEventInstanceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventInstanceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventInstanceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarGroupCalendarEventInstanceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventInstanceId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventInstanceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarGroupCalendarEventInstanceId(t *testing.T) {
	segments := UserCalendarGroupCalendarEventInstanceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarGroupCalendarEventInstanceId has no segments")
	}
