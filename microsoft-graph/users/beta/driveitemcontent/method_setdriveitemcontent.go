...
func (c DriveItemContentClient) SetDriveItemContent(ctx context.Context, id beta.UserIdDriveIdItemId, input []byte) (result SetDriveItemContentOperationResponse, err error) {
