...
// DeleteCalendarGroupCalendarViewExceptionOccurrenceAttachment - Delete navigation property attachments for users
func (c CalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentClient) DeleteCalendarGroupCalendarViewExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdAttachmentId, options DeleteCalendarGroupCalendarViewExceptionOccurrenceAttachmentOperationOptions) (result DeleteCalendarGroupCalendarViewExceptionOccurrenceAttachmentOperationResponse, err error) {
