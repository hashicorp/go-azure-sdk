...
// ListCalendarGroupCalendarViewExceptionOccurrenceAttachments - Get attachments from users. The collection of
// FileAttachment, ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only.
// Nullable.
func (c CalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentClient) ListCalendarGroupCalendarViewExceptionOccurrenceAttachments(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, options ListCalendarGroupCalendarViewExceptionOccurrenceAttachmentsOperationOptions) (result ListCalendarGroupCalendarViewExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c CalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentClient) ListCalendarGroupCalendarViewExceptionOccurrenceAttachmentsComplete(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, options ListCalendarGroupCalendarViewExceptionOccurrenceAttachmentsOperationOptions) (ListCalendarGroupCalendarViewExceptionOccurrenceAttachmentsCompleteResult, error) {
