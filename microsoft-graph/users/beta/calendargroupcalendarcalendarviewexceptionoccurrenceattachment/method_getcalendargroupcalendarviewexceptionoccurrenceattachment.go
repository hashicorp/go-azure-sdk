...
// Nullable.
func (c CalendarGroupCalendarCalendarViewExceptionOccurrenceAttachmentClient) GetCalendarGroupCalendarViewExceptionOccurrenceAttachment(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceIdAttachmentId, options GetCalendarGroupCalendarViewExceptionOccurrenceAttachmentOperationOptions) (result GetCalendarGroupCalendarViewExceptionOccurrenceAttachmentOperationResponse, err error) {
