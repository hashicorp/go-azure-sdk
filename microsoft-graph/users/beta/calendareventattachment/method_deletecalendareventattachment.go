...
func (c CalendarEventAttachmentClient) DeleteCalendarEventAttachment(ctx context.Context, id beta.UserIdCalendarEventIdAttachmentId, options DeleteCalendarEventAttachmentOperationOptions) (result DeleteCalendarEventAttachmentOperationResponse, err error) {
