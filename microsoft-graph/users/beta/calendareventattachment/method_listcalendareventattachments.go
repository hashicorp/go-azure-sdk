...
func (c CalendarEventAttachmentClient) ListCalendarEventAttachments(ctx context.Context, id UserIdCalendarEventId) (result ListCalendarEventAttachmentsOperationResponse, err error) {
...
func (c CalendarEventAttachmentClient) ListCalendarEventAttachmentsComplete(ctx context.Context, id UserIdCalendarEventId) (ListCalendarEventAttachmentsCompleteResult, error) {
...
func (c CalendarEventAttachmentClient) ListCalendarEventAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarEventId, predicate AttachmentOperationPredicate) (result ListCalendarEventAttachmentsCompleteResult, err error) {
