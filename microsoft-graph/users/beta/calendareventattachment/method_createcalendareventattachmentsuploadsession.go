...
func (c CalendarEventAttachmentClient) CreateCalendarEventAttachmentsUploadSession(ctx context.Context, id beta.UserIdCalendarIdEventId, input CreateCalendarEventAttachmentsUploadSessionRequest) (result CreateCalendarEventAttachmentsUploadSessionOperationResponse, err error) {
