...
// CreateCommunicationCallSettingDelegator - Create new navigation property to delegators for users
func (c CommunicationCallSettingDelegatorClient) CreateCommunicationCallSettingDelegator(ctx context.Context, id beta.UserId, input beta.DelegationSettings, options CreateCommunicationCallSettingDelegatorOperationOptions) (result CreateCommunicationCallSettingDelegatorOperationResponse, err error) {
