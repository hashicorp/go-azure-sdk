...
func (c CommunicationCallSettingDelegatorClient) GetCommunicationCallSettingDelegatorsCount(ctx context.Context, id beta.UserId, options GetCommunicationCallSettingDelegatorsCountOperationOptions) (result GetCommunicationCallSettingDelegatorsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/communications/callSettings/delegators/$count", id.ID()),
