...
func (c OnlineMeetingTranscriptClient) ListOnlineMeetingTranscripts(ctx context.Context, id UserIdOnlineMeetingId) (result ListOnlineMeetingTranscriptsOperationResponse, err error) {
...
func (c OnlineMeetingTranscriptClient) ListOnlineMeetingTranscriptsComplete(ctx context.Context, id UserIdOnlineMeetingId) (ListOnlineMeetingTranscriptsCompleteResult, error) {
...
func (c OnlineMeetingTranscriptClient) ListOnlineMeetingTranscriptsCompleteMatchingPredicate(ctx context.Context, id UserIdOnlineMeetingId, predicate CallTranscriptOperationPredicate) (result ListOnlineMeetingTranscriptsCompleteResult, err error) {
