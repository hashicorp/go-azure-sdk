...
// progress.
func (c DriveRootClient) CopyDriveRoot(ctx context.Context, id beta.UserIdDriveId, input CopyDriveRootRequest) (result CopyDriveRootOperationResponse, err error) {
