...
func (c DriveRootClient) CreateDriveRootUploadSession(ctx context.Context, id beta.UserIdDriveId, input CreateDriveRootUploadSessionRequest) (result CreateDriveRootUploadSessionOperationResponse, err error) {
