...
func (c DriveRootClient) CheckinDriveRoot(ctx context.Context, id beta.UserIdDriveId, input CheckinDriveRootRequest) (result CheckinDriveRootOperationResponse, err error) {
