...
// bin.
func (c DriveRootClient) RestoreDriveRoot(ctx context.Context, id beta.UserIdDriveId, input RestoreDriveRootRequest) (result RestoreDriveRootOperationResponse, err error) {
