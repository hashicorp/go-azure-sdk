...
func (c ContactFolderClient) CreateContactFolderPermanentDelete(ctx context.Context, id beta.UserIdContactFolderId, options CreateContactFolderPermanentDeleteOperationOptions) (result CreateContactFolderPermanentDeleteOperationResponse, err error) {
