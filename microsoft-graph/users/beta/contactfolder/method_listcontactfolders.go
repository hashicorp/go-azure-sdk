...
// ListContactFolders ...
func (c ContactFolderClient) ListContactFolders(ctx context.Context, id UserId) (result ListContactFoldersOperationResponse, err error) {
...
func (c ContactFolderClient) ListContactFoldersComplete(ctx context.Context, id UserId) (ListContactFoldersCompleteResult, error) {
	return c.ListContactFoldersCompleteMatchingPredicate(ctx, id, ContactFolderOperationPredicate{})
}

// ListContactFoldersCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ContactFolderClient) ListContactFoldersCompleteMatchingPredicate(ctx context.Context, id UserId, predicate ContactFolderOperationPredicate) (result ListContactFoldersCompleteResult, err error) {
	items := make([]beta.ContactFolder, 0)

	resp, err := c.ListContactFolders(ctx, id)
	if err != nil {
