...
// CreateContactFolder ...
func (c ContactFolderClient) CreateContactFolder(ctx context.Context, id UserId, input beta.ContactFolder) (result CreateContactFolderOperationResponse, err error) {
