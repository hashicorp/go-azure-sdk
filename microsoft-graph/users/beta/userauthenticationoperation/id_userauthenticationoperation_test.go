...
func TestNewUserAuthenticationOperationID(t *testing.T) {
	id := NewUserAuthenticationOperationID("userIdValue", "longRunningOperationIdValue")
...
func TestFormatUserAuthenticationOperationID(t *testing.T) {
	actual := NewUserAuthenticationOperationID("userIdValue", "longRunningOperationIdValue").ID()
...
func TestParseUserAuthenticationOperationID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserAuthenticationOperationId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserAuthenticationOperationID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserAuthenticationOperationIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserAuthenticationOperationId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserAuthenticationOperationIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserAuthenticationOperationId(t *testing.T) {
	segments := UserAuthenticationOperationId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserAuthenticationOperationId has no segments")
	}
