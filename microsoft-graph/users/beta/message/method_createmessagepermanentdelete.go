...
// CreateMessagePermanentDelete - Invoke action permanentDelete. Permanently delete a message and place it in the Purges
...
// quotas.
func (c MessageClient) CreateMessagePermanentDelete(ctx context.Context, id beta.UserIdMessageId, options CreateMessagePermanentDeleteOperationOptions) (result CreateMessagePermanentDeleteOperationResponse, err error) {
