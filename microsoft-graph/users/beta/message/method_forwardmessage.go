...
func (c MessageClient) ForwardMessage(ctx context.Context, id beta.UserIdMessageId, input ForwardMessageRequest) (result ForwardMessageOperationResponse, err error) {
