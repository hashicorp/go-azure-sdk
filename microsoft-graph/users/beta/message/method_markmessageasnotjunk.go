...
func (c MessageClient) MarkMessageAsNotJunk(ctx context.Context, id beta.UserIdMessageId, input MarkMessageAsNotJunkRequest) (result MarkMessageAsNotJunkOperationResponse, err error) {
