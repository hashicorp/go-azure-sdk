...
// ListPlannerAlls ...
func (c PlannerAllClient) ListPlannerAlls(ctx context.Context, id UserId) (result ListPlannerAllsOperationResponse, err error) {
...
func (c PlannerAllClient) ListPlannerAllsComplete(ctx context.Context, id UserId) (ListPlannerAllsCompleteResult, error) {
	return c.ListPlannerAllsCompleteMatchingPredicate(ctx, id, PlannerDeltaOperationPredicate{})
}

// ListPlannerAllsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c PlannerAllClient) ListPlannerAllsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate PlannerDeltaOperationPredicate) (result ListPlannerAllsCompleteResult, err error) {
	items := make([]beta.PlannerDelta, 0)

	resp, err := c.ListPlannerAlls(ctx, id)
	if err != nil {
