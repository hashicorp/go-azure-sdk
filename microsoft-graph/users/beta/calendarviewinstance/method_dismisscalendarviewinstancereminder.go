...
func (c CalendarViewInstanceClient) DismissCalendarViewInstanceReminder(ctx context.Context, id beta.UserIdCalendarViewIdInstanceId) (result DismissCalendarViewInstanceReminderOperationResponse, err error) {
