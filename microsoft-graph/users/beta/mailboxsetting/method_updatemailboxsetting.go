...
func (c MailboxSettingClient) UpdateMailboxSetting(ctx context.Context, id UserId, input beta.MailboxSettings) (result UpdateMailboxSettingOperationResponse, err error) {
