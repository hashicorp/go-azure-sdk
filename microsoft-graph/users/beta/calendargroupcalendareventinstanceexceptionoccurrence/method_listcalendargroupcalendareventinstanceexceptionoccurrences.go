...
func (c CalendarGroupCalendarEventInstanceExceptionOccurrenceClient) ListCalendarGroupCalendarEventInstanceExceptionOccurrences(ctx context.Context, id UserIdCalendarGroupIdCalendarIdEventIdInstanceId) (result ListCalendarGroupCalendarEventInstanceExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventInstanceExceptionOccurrenceClient) ListCalendarGroupCalendarEventInstanceExceptionOccurrencesComplete(ctx context.Context, id UserIdCalendarGroupIdCalendarIdEventIdInstanceId) (ListCalendarGroupCalendarEventInstanceExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarGroupCalendarEventInstanceExceptionOccurrenceClient) ListCalendarGroupCalendarEventInstanceExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarGroupIdCalendarIdEventIdInstanceId, predicate EventOperationPredicate) (result ListCalendarGroupCalendarEventInstanceExceptionOccurrencesCompleteResult, err error) {
