...
func (c SettingWindowClient) CreateSettingWindow(ctx context.Context, id beta.UserId, input beta.WindowsSetting) (result CreateSettingWindowOperationResponse, err error) {
