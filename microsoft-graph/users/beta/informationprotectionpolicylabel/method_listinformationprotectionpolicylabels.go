...
// ListInformationProtectionPolicyLabels ...
func (c InformationProtectionPolicyLabelClient) ListInformationProtectionPolicyLabels(ctx context.Context, id UserId) (result ListInformationProtectionPolicyLabelsOperationResponse, err error) {
...
func (c InformationProtectionPolicyLabelClient) ListInformationProtectionPolicyLabelsComplete(ctx context.Context, id UserId) (ListInformationProtectionPolicyLabelsCompleteResult, error) {
	return c.ListInformationProtectionPolicyLabelsCompleteMatchingPredicate(ctx, id, InformationProtectionLabelOperationPredicate{})
}

// ListInformationProtectionPolicyLabelsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c InformationProtectionPolicyLabelClient) ListInformationProtectionPolicyLabelsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate InformationProtectionLabelOperationPredicate) (result ListInformationProtectionPolicyLabelsCompleteResult, err error) {
	items := make([]beta.InformationProtectionLabel, 0)

	resp, err := c.ListInformationProtectionPolicyLabels(ctx, id)
	if err != nil {
