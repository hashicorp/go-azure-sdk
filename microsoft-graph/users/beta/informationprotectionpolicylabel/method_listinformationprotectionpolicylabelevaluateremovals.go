...
func (c InformationProtectionPolicyLabelClient) ListInformationProtectionPolicyLabelEvaluateRemovalsComplete(ctx context.Context, id beta.UserId, input ListInformationProtectionPolicyLabelEvaluateRemovalsRequest, options ListInformationProtectionPolicyLabelEvaluateRemovalsOperationOptions) (ListInformationProtectionPolicyLabelEvaluateRemovalsCompleteResult, error) {
	return c.ListInformationProtectionPolicyLabelEvaluateRemovalsCompleteMatchingPredicate(ctx, id, input, options, InformationProtectionActionOperationPredicate{})
}
...
func (c InformationProtectionPolicyLabelClient) ListInformationProtectionPolicyLabelEvaluateRemovalsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, input ListInformationProtectionPolicyLabelEvaluateRemovalsRequest, options ListInformationProtectionPolicyLabelEvaluateRemovalsOperationOptions, predicate InformationProtectionActionOperationPredicate) (result ListInformationProtectionPolicyLabelEvaluateRemovalsCompleteResult, err error) {
	...
	resp, err := c.ListInformationProtectionPolicyLabelEvaluateRemovals(ctx, id, input, options)
	if err != nil {
