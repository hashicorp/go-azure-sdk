...
// GetPlannerTaskAssignedToTaskBoardFormat ...
func (c PlannerTaskAssignedToTaskBoardFormatClient) GetPlannerTaskAssignedToTaskBoardFormat(ctx context.Context, id UserIdPlannerTaskId) (result GetPlannerTaskAssignedToTaskBoardFormatOperationResponse, err error) {
