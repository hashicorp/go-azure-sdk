...
func (c ProfileLanguageClient) CreateProfileLanguage(ctx context.Context, id UserId, input beta.LanguageProficiency) (result CreateProfileLanguageOperationResponse, err error) {
