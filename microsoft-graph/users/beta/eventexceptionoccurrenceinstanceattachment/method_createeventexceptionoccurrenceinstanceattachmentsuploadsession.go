...
func (c EventExceptionOccurrenceInstanceAttachmentClient) CreateEventExceptionOccurrenceInstanceAttachmentsUploadSession(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceIdInstanceId, input CreateEventExceptionOccurrenceInstanceAttachmentsUploadSessionRequest) (result CreateEventExceptionOccurrenceInstanceAttachmentsUploadSessionOperationResponse, err error) {
