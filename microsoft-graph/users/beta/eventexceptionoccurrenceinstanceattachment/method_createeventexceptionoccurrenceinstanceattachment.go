...
func (c EventExceptionOccurrenceInstanceAttachmentClient) CreateEventExceptionOccurrenceInstanceAttachment(ctx context.Context, id beta.UserIdEventIdExceptionOccurrenceIdInstanceId, input beta.Attachment) (result CreateEventExceptionOccurrenceInstanceAttachmentOperationResponse, err error) {
