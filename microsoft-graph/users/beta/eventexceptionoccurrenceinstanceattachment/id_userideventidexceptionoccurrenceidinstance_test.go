...
func TestNewUserIdEventIdExceptionOccurrenceIdInstanceID(t *testing.T) {
	id := NewUserIdEventIdExceptionOccurrenceIdInstanceID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value")
...
func TestFormatUserIdEventIdExceptionOccurrenceIdInstanceID(t *testing.T) {
	actual := NewUserIdEventIdExceptionOccurrenceIdInstanceID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value").ID()
