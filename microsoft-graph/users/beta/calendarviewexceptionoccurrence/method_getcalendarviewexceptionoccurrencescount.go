...
func (c CalendarViewExceptionOccurrenceClient) GetCalendarViewExceptionOccurrencesCount(ctx context.Context, id beta.UserIdCalendarViewId, options GetCalendarViewExceptionOccurrencesCountOperationOptions) (result GetCalendarViewExceptionOccurrencesCountOperationResponse, err error) {
