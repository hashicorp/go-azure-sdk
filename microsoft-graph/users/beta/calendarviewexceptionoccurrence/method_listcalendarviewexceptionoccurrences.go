...
func (c CalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrences(ctx context.Context, id beta.UserIdCalendarViewId, options ListCalendarViewExceptionOccurrencesOperationOptions) (result ListCalendarViewExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrencesComplete(ctx context.Context, id beta.UserIdCalendarViewId, options ListCalendarViewExceptionOccurrencesOperationOptions) (ListCalendarViewExceptionOccurrencesCompleteResult, error) {
