...
func (c CalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrences(ctx context.Context, id UserIdCalendarViewId) (result ListCalendarViewExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrencesComplete(ctx context.Context, id UserIdCalendarViewId) (ListCalendarViewExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarViewExceptionOccurrenceClient) ListCalendarViewExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarViewId, predicate EventOperationPredicate) (result ListCalendarViewExceptionOccurrencesCompleteResult, err error) {
