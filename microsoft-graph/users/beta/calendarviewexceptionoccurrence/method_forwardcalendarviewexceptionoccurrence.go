...
func (c CalendarViewExceptionOccurrenceClient) ForwardCalendarViewExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarViewIdExceptionOccurrenceId, input ForwardCalendarViewExceptionOccurrenceRequest) (result ForwardCalendarViewExceptionOccurrenceOperationResponse, err error) {
