...
func (c CalendarViewExceptionOccurrenceClient) TentativelyAcceptCalendarViewExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarViewIdExceptionOccurrenceId, input TentativelyAcceptCalendarViewExceptionOccurrenceRequest) (result TentativelyAcceptCalendarViewExceptionOccurrenceOperationResponse, err error) {
