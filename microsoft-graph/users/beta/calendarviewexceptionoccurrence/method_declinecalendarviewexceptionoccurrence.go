...
func (c CalendarViewExceptionOccurrenceClient) DeclineCalendarViewExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarViewIdExceptionOccurrenceId, input DeclineCalendarViewExceptionOccurrenceRequest) (result DeclineCalendarViewExceptionOccurrenceOperationResponse, err error) {
