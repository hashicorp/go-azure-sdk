...
// for users
func (c DeviceManagementTroubleshootingEventClient) CreateDeviceManagementTroubleshootingEvent(ctx context.Context, id beta.UserId, input beta.DeviceManagementTroubleshootingEvent) (result CreateDeviceManagementTroubleshootingEventOperationResponse, err error) {
