...
func (c InformationProtectionThreatAssessmentRequestClient) UpdateInformationProtectionThreatAssessmentRequest(ctx context.Context, id UserIdInformationProtectionThreatAssessmentRequestId, input beta.ThreatAssessmentRequest) (result UpdateInformationProtectionThreatAssessmentRequestOperationResponse, err error) {
