...
type ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsOperationOptions struct {
	Count   *bool
	Expand  *odata.Expand
	Filter  *string
...
func DefaultListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsOperationOptions() ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsOperationOptions {
	return ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsOperationOptions{}
}

func (o ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}
	if o.Count != nil {
		out.Count = *o.Count
	}
...
func (o ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsOperationOptions) ToQuery() *client.QueryParams {
...
// ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensions - Get extensions from users. The collection of
// open extensions defined for the event. Nullable.
func (c CalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionClient) ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensions(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdInstanceIdExceptionOccurrenceId, options ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsOperationOptions) (result ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionClient) ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsComplete(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdInstanceIdExceptionOccurrenceId, options ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsOperationOptions) (ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsCompleteResult, error) {
	return c.ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsCompleteMatchingPredicate(ctx, id, options, ExtensionOperationPredicate{})
}
...
func (c CalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionClient) ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdInstanceIdExceptionOccurrenceId, options ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsOperationOptions, predicate ExtensionOperationPredicate) (result ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsCompleteResult, err error) {
	...
	resp, err := c.ListCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensions(ctx, id, options)
	if err != nil {
