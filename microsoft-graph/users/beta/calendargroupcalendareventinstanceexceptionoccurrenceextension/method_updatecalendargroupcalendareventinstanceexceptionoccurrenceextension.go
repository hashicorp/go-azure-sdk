...
// users
func (c CalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionClient) UpdateCalendarGroupCalendarEventInstanceExceptionOccurrenceExtension(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionId, input beta.Extension) (result UpdateCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionOperationResponse, err error) {
