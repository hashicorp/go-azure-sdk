...
func (c CalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionClient) GetCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsCount(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventIdInstanceIdExceptionOccurrenceId, options GetCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsCountOperationOptions) (result GetCalendarGroupCalendarEventInstanceExceptionOccurrenceExtensionsCountOperationResponse, err error) {
