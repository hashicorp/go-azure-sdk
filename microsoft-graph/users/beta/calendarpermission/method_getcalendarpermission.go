...
// shared.
func (c CalendarPermissionClient) GetCalendarPermission(ctx context.Context, id beta.UserIdCalendarIdCalendarPermissionId, options GetCalendarPermissionOperationOptions) (result GetCalendarPermissionOperationResponse, err error) {
