...
func (c CalendarPermissionClient) GetCalendarPermissionsCount(ctx context.Context, id beta.UserId, options GetCalendarPermissionsCountOperationOptions) (result GetCalendarPermissionsCountOperationResponse, err error) {
