...
func (c CalendarPermissionClient) ListCalendarPermissions(ctx context.Context, id beta.UserId, options ListCalendarPermissionsOperationOptions) (result ListCalendarPermissionsOperationResponse, err error) {
...
func (c CalendarPermissionClient) ListCalendarPermissionsComplete(ctx context.Context, id beta.UserId, options ListCalendarPermissionsOperationOptions) (ListCalendarPermissionsCompleteResult, error) {
...
func (c CalendarPermissionClient) ListCalendarPermissionsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListCalendarPermissionsOperationOptions, predicate CalendarPermissionOperationPredicate) (result ListCalendarPermissionsCompleteResult, err error) {
