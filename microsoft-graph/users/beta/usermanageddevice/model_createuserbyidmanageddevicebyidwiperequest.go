...
type CreateUserByIdManagedDeviceByIdWipeRequest struct {
	...
	ObliterationBehavior *CreateUserByIdManagedDeviceByIdWipeRequestObliterationBehavior `json:"obliterationBehavior,omitempty"`
