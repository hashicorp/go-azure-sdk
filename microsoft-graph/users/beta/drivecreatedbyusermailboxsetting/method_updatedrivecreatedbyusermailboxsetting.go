...
func (c DriveCreatedByUserMailboxSettingClient) UpdateDriveCreatedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveId, input beta.MailboxSettings) (result UpdateDriveCreatedByUserMailboxSettingOperationResponse, err error) {
