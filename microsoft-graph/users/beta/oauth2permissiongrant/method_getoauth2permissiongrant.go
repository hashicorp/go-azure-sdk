...
func (c Oauth2PermissionGrantClient) GetOauth2PermissionGrant(ctx context.Context, id UserIdOauth2PermissionGrantId) (result GetOauth2PermissionGrantOperationResponse, err error) {
