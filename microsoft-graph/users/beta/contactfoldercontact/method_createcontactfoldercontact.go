...
func (c ContactFolderContactClient) CreateContactFolderContact(ctx context.Context, id beta.UserIdContactFolderId, input beta.Contact) (result CreateContactFolderContactOperationResponse, err error) {
