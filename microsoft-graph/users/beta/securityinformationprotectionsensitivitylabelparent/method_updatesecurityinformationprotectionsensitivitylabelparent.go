...
func (c SecurityInformationProtectionSensitivityLabelParentClient) UpdateSecurityInformationProtectionSensitivityLabelParent(ctx context.Context, id UserIdSecurityInformationProtectionSensitivityLabelId, input beta.SecuritySensitivityLabel) (result UpdateSecurityInformationProtectionSensitivityLabelParentOperationResponse, err error) {
