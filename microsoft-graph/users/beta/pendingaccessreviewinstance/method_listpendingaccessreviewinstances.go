...
func (c PendingAccessReviewInstanceClient) ListPendingAccessReviewInstances(ctx context.Context, id UserId) (result ListPendingAccessReviewInstancesOperationResponse, err error) {
...
func (c PendingAccessReviewInstanceClient) ListPendingAccessReviewInstancesComplete(ctx context.Context, id UserId) (ListPendingAccessReviewInstancesCompleteResult, error) {
	return c.ListPendingAccessReviewInstancesCompleteMatchingPredicate(ctx, id, AccessReviewInstanceOperationPredicate{})
}

// ListPendingAccessReviewInstancesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c PendingAccessReviewInstanceClient) ListPendingAccessReviewInstancesCompleteMatchingPredicate(ctx context.Context, id UserId, predicate AccessReviewInstanceOperationPredicate) (result ListPendingAccessReviewInstancesCompleteResult, err error) {
	items := make([]beta.AccessReviewInstance, 0)

	resp, err := c.ListPendingAccessReviewInstances(ctx, id)
	if err != nil {
