...
type AcceptPendingAccessReviewInstanceRecommendationOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

// AcceptPendingAccessReviewInstanceRecommendation - Invoke action acceptRecommendations. Allows the acceptance of
...
func (c PendingAccessReviewInstanceClient) AcceptPendingAccessReviewInstanceRecommendation(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceId) (result AcceptPendingAccessReviewInstanceRecommendationOperationResponse, err error) {
