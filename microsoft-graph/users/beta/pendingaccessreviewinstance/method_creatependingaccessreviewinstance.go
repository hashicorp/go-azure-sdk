...
func (c PendingAccessReviewInstanceClient) CreatePendingAccessReviewInstance(ctx context.Context, id beta.UserId, input beta.AccessReviewInstance) (result CreatePendingAccessReviewInstanceOperationResponse, err error) {
