...
func (c PendingAccessReviewInstanceClient) CreatePendingAccessReviewInstanceBatchRecordDecision(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceId, input CreatePendingAccessReviewInstanceBatchRecordDecisionRequest) (result CreatePendingAccessReviewInstanceBatchRecordDecisionOperationResponse, err error) {
