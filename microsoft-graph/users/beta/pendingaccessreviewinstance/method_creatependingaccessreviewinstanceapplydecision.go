...
// call this method.
func (c PendingAccessReviewInstanceClient) CreatePendingAccessReviewInstanceApplyDecision(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceId) (result CreatePendingAccessReviewInstanceApplyDecisionOperationResponse, err error) {
