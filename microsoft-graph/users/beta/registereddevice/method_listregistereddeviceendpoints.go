...
// collection
func (c RegisteredDeviceClient) ListRegisteredDeviceEndpoints(ctx context.Context, id beta.UserId, options ListRegisteredDeviceEndpointsOperationOptions) (result ListRegisteredDeviceEndpointsOperationResponse, err error) {
...
func (c RegisteredDeviceClient) ListRegisteredDeviceEndpointsComplete(ctx context.Context, id beta.UserId, options ListRegisteredDeviceEndpointsOperationOptions) (ListRegisteredDeviceEndpointsCompleteResult, error) {
...
func (c RegisteredDeviceClient) ListRegisteredDeviceEndpointsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListRegisteredDeviceEndpointsOperationOptions, predicate EndpointOperationPredicate) (result ListRegisteredDeviceEndpointsCompleteResult, err error) {
