...
func (c RegisteredDeviceClient) GetRegisteredDeviceEndpoint(ctx context.Context, id beta.UserIdRegisteredDeviceId, options GetRegisteredDeviceEndpointOperationOptions) (result GetRegisteredDeviceEndpointOperationResponse, err error) {
