...
func (c RegisteredDeviceClient) GetRegisteredDeviceEndpointCount(ctx context.Context, id beta.UserId, options GetRegisteredDeviceEndpointCountOperationOptions) (result GetRegisteredDeviceEndpointCountOperationResponse, err error) {
