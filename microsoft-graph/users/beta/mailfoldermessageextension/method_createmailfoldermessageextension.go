...
func (c MailFolderMessageExtensionClient) CreateMailFolderMessageExtension(ctx context.Context, id beta.UserIdMailFolderIdMessageId, input beta.Extension) (result CreateMailFolderMessageExtensionOperationResponse, err error) {
