...
// ListCalendarGroupCalendarViewExceptionOccurrenceInstances - Get instances from users. The occurrences of a recurring
...
func (c CalendarGroupCalendarViewExceptionOccurrenceInstanceClient) ListCalendarGroupCalendarViewExceptionOccurrenceInstances(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, options ListCalendarGroupCalendarViewExceptionOccurrenceInstancesOperationOptions) (result ListCalendarGroupCalendarViewExceptionOccurrenceInstancesOperationResponse, err error) {
...
func (c CalendarGroupCalendarViewExceptionOccurrenceInstanceClient) ListCalendarGroupCalendarViewExceptionOccurrenceInstancesComplete(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, options ListCalendarGroupCalendarViewExceptionOccurrenceInstancesOperationOptions) (ListCalendarGroupCalendarViewExceptionOccurrenceInstancesCompleteResult, error) {
...
func (c CalendarGroupCalendarViewExceptionOccurrenceInstanceClient) ListCalendarGroupCalendarViewExceptionOccurrenceInstancesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, options ListCalendarGroupCalendarViewExceptionOccurrenceInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarGroupCalendarViewExceptionOccurrenceInstancesCompleteResult, err error) {
