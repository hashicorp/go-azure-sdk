...
type AcceptPendingAccessReviewInstanceDecisionInstanceRecommendationOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

// AcceptPendingAccessReviewInstanceDecisionInstanceRecommendation - Invoke action acceptRecommendations. Allows the
...
func (c PendingAccessReviewInstanceDecisionInstanceClient) AcceptPendingAccessReviewInstanceDecisionInstanceRecommendation(ctx context.Context, id beta.UserIdPendingAccessReviewInstanceIdDecisionId) (result AcceptPendingAccessReviewInstanceDecisionInstanceRecommendationOperationResponse, err error) {
