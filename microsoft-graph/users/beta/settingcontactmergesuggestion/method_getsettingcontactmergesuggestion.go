...
// GetSettingContactMergeSuggestion ...
func (c SettingContactMergeSuggestionClient) GetSettingContactMergeSuggestion(ctx context.Context, id UserId) (result GetSettingContactMergeSuggestionOperationResponse, err error) {
