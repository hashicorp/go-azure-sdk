...
func (c AppRoleAssignedResourceClient) ListAppRoleAssignedResources(ctx context.Context, id UserId) (result ListAppRoleAssignedResourcesOperationResponse, err error) {
...
func (c AppRoleAssignedResourceClient) ListAppRoleAssignedResourcesComplete(ctx context.Context, id UserId) (ListAppRoleAssignedResourcesCompleteResult, error) {
	return c.ListAppRoleAssignedResourcesCompleteMatchingPredicate(ctx, id, ServicePrincipalOperationPredicate{})
}

// ListAppRoleAssignedResourcesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c AppRoleAssignedResourceClient) ListAppRoleAssignedResourcesCompleteMatchingPredicate(ctx context.Context, id UserId, predicate ServicePrincipalOperationPredicate) (result ListAppRoleAssignedResourcesCompleteResult, err error) {
	items := make([]beta.ServicePrincipal, 0)

	resp, err := c.ListAppRoleAssignedResources(ctx, id)
	if err != nil {
