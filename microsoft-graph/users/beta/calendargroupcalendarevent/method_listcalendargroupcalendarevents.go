...
func (c CalendarGroupCalendarEventClient) ListCalendarGroupCalendarEvents(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarId, options ListCalendarGroupCalendarEventsOperationOptions) (result ListCalendarGroupCalendarEventsOperationResponse, err error) {
...
func (c CalendarGroupCalendarEventClient) ListCalendarGroupCalendarEventsComplete(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarId, options ListCalendarGroupCalendarEventsOperationOptions) (ListCalendarGroupCalendarEventsCompleteResult, error) {
...
func (c CalendarGroupCalendarEventClient) ListCalendarGroupCalendarEventsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarId, options ListCalendarGroupCalendarEventsOperationOptions, predicate EventOperationPredicate) (result ListCalendarGroupCalendarEventsCompleteResult, err error) {
