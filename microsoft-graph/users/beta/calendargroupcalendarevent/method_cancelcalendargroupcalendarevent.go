...
func (c CalendarGroupCalendarEventClient) CancelCalendarGroupCalendarEvent(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventId, input CancelCalendarGroupCalendarEventRequest) (result CancelCalendarGroupCalendarEventOperationResponse, err error) {
