...
func (c CalendarGroupCalendarEventClient) ForwardCalendarGroupCalendarEvent(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdEventId, input ForwardCalendarGroupCalendarEventRequest) (result ForwardCalendarGroupCalendarEventOperationResponse, err error) {
