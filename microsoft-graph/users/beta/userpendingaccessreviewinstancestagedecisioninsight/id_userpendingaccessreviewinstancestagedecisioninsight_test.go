...
func TestNewUserPendingAccessReviewInstanceStageDecisionInsightID(t *testing.T) {
	id := NewUserPendingAccessReviewInstanceStageDecisionInsightID("userIdValue", "accessReviewInstanceIdValue", "accessReviewStageIdValue", "accessReviewInstanceDecisionItemIdValue", "governanceInsightIdValue")
...
func TestFormatUserPendingAccessReviewInstanceStageDecisionInsightID(t *testing.T) {
	actual := NewUserPendingAccessReviewInstanceStageDecisionInsightID("userIdValue", "accessReviewInstanceIdValue", "accessReviewStageIdValue", "accessReviewInstanceDecisionItemIdValue", "governanceInsightIdValue").ID()
...
func TestParseUserPendingAccessReviewInstanceStageDecisionInsightID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceStageDecisionInsightId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceStageDecisionInsightID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserPendingAccessReviewInstanceStageDecisionInsightIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserPendingAccessReviewInstanceStageDecisionInsightId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserPendingAccessReviewInstanceStageDecisionInsightIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserPendingAccessReviewInstanceStageDecisionInsightId(t *testing.T) {
	segments := UserPendingAccessReviewInstanceStageDecisionInsightId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserPendingAccessReviewInstanceStageDecisionInsightId has no segments")
	}
