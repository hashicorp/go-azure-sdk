...
// Nullable.
func (c CalendarCalendarViewInstanceClient) ListCalendarViewInstances(ctx context.Context, id beta.UserIdCalendarIdCalendarViewId, options ListCalendarViewInstancesOperationOptions) (result ListCalendarViewInstancesOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceClient) ListCalendarViewInstancesComplete(ctx context.Context, id beta.UserIdCalendarIdCalendarViewId, options ListCalendarViewInstancesOperationOptions) (ListCalendarViewInstancesCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceClient) ListCalendarViewInstancesCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarIdCalendarViewId, options ListCalendarViewInstancesOperationOptions, predicate EventOperationPredicate) (result ListCalendarViewInstancesCompleteResult, err error) {
