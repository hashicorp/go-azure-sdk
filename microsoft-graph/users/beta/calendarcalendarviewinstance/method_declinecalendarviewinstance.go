...
func (c CalendarCalendarViewInstanceClient) DeclineCalendarViewInstance(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdInstanceId, input DeclineCalendarViewInstanceRequest) (result DeclineCalendarViewInstanceOperationResponse, err error) {
