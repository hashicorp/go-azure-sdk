...
// Nullable.
func (c CalendarCalendarViewInstanceClient) GetCalendarViewInstance(ctx context.Context, id beta.UserIdCalendarCalendarViewIdInstanceId, options GetCalendarViewInstanceOperationOptions) (result GetCalendarViewInstanceOperationResponse, err error) {
