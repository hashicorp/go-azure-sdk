...
func (c CalendarCalendarViewInstanceClient) DismissCalendarViewInstanceReminder(ctx context.Context, id beta.UserIdCalendarCalendarViewIdInstanceId) (result DismissCalendarViewInstanceReminderOperationResponse, err error) {
