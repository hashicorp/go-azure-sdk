...
func (c ManagedDeviceCategoryClient) DeleteManagedDeviceCategory(ctx context.Context, id beta.UserIdManagedDeviceId, options DeleteManagedDeviceCategoryOperationOptions) (result DeleteManagedDeviceCategoryOperationResponse, err error) {
