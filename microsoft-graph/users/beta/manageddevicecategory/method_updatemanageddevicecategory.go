...
func (c ManagedDeviceCategoryClient) UpdateManagedDeviceCategory(ctx context.Context, id beta.UserIdManagedDeviceId, input beta.DeviceCategory) (result UpdateManagedDeviceCategoryOperationResponse, err error) {
