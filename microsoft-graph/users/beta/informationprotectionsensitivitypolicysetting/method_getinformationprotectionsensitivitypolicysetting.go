...
func (c InformationProtectionSensitivityPolicySettingClient) GetInformationProtectionSensitivityPolicySetting(ctx context.Context, id UserId) (result GetInformationProtectionSensitivityPolicySettingOperationResponse, err error) {
