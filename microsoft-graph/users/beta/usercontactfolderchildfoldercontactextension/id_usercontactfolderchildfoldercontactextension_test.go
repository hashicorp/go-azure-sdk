...
func TestNewUserContactFolderChildFolderContactExtensionID(t *testing.T) {
	id := NewUserContactFolderChildFolderContactExtensionID("userIdValue", "contactFolderIdValue", "contactFolderId1Value", "contactIdValue", "extensionIdValue")
...
func TestFormatUserContactFolderChildFolderContactExtensionID(t *testing.T) {
	actual := NewUserContactFolderChildFolderContactExtensionID("userIdValue", "contactFolderIdValue", "contactFolderId1Value", "contactIdValue", "extensionIdValue").ID()
...
func TestParseUserContactFolderChildFolderContactExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserContactFolderChildFolderContactExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserContactFolderChildFolderContactExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserContactFolderChildFolderContactExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserContactFolderChildFolderContactExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserContactFolderChildFolderContactExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserContactFolderChildFolderContactExtensionId(t *testing.T) {
	segments := UserContactFolderChildFolderContactExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserContactFolderChildFolderContactExtensionId has no segments")
	}
