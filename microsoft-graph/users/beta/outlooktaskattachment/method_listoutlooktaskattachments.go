...
func (c OutlookTaskAttachmentClient) ListOutlookTaskAttachments(ctx context.Context, id UserIdOutlookTaskId) (result ListOutlookTaskAttachmentsOperationResponse, err error) {
...
func (c OutlookTaskAttachmentClient) ListOutlookTaskAttachmentsComplete(ctx context.Context, id UserIdOutlookTaskId) (ListOutlookTaskAttachmentsCompleteResult, error) {
...
func (c OutlookTaskAttachmentClient) ListOutlookTaskAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdOutlookTaskId, predicate AttachmentOperationPredicate) (result ListOutlookTaskAttachmentsCompleteResult, err error) {
