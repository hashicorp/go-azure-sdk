...
func (c DataSecurityAndGovernanceSensitivityLabelClient) CreateDataSecurityAndGovernanceSensitivityLabelComputeRightsAndInheritance(ctx context.Context, id beta.UserId, input CreateDataSecurityAndGovernanceSensitivityLabelComputeRightsAndInheritanceRequest, options CreateDataSecurityAndGovernanceSensitivityLabelComputeRightsAndInheritanceOperationOptions) (result CreateDataSecurityAndGovernanceSensitivityLabelComputeRightsAndInheritanceOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/dataSecurityAndGovernance/sensitivityLabels/computeRightsAndInheritance", id.ID()),
