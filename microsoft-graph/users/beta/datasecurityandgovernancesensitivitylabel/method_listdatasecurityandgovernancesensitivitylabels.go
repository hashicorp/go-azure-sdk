...
// ListDataSecurityAndGovernanceSensitivityLabels - Get sensitivityLabels from users
func (c DataSecurityAndGovernanceSensitivityLabelClient) ListDataSecurityAndGovernanceSensitivityLabels(ctx context.Context, id beta.UserId, options ListDataSecurityAndGovernanceSensitivityLabelsOperationOptions) (result ListDataSecurityAndGovernanceSensitivityLabelsOperationResponse, err error) {
...
func (c DataSecurityAndGovernanceSensitivityLabelClient) ListDataSecurityAndGovernanceSensitivityLabelsComplete(ctx context.Context, id beta.UserId, options ListDataSecurityAndGovernanceSensitivityLabelsOperationOptions) (ListDataSecurityAndGovernanceSensitivityLabelsCompleteResult, error) {
	return c.ListDataSecurityAndGovernanceSensitivityLabelsCompleteMatchingPredicate(ctx, id, options, SensitivityLabelOperationPredicate{})
}
...
func (c DataSecurityAndGovernanceSensitivityLabelClient) ListDataSecurityAndGovernanceSensitivityLabelsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListDataSecurityAndGovernanceSensitivityLabelsOperationOptions, predicate SensitivityLabelOperationPredicate) (result ListDataSecurityAndGovernanceSensitivityLabelsCompleteResult, err error) {
	items := make([]beta.SensitivityLabel, 0)

	resp, err := c.ListDataSecurityAndGovernanceSensitivityLabels(ctx, id, options)
	if err != nil {
