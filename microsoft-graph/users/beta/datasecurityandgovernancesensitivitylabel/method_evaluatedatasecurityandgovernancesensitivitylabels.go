...
func (c DataSecurityAndGovernanceSensitivityLabelClient) EvaluateDataSecurityAndGovernanceSensitivityLabels(ctx context.Context, id beta.UserId, input EvaluateDataSecurityAndGovernanceSensitivityLabelsRequest, options EvaluateDataSecurityAndGovernanceSensitivityLabelsOperationOptions) (result EvaluateDataSecurityAndGovernanceSensitivityLabelsOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/dataSecurityAndGovernance/sensitivityLabels/evaluate", id.ID()),
