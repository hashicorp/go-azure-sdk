...
func (c DataSecurityAndGovernanceSensitivityLabelClient) GetDataSecurityAndGovernanceSensitivityLabelsCount(ctx context.Context, id beta.UserId, options GetDataSecurityAndGovernanceSensitivityLabelsCountOperationOptions) (result GetDataSecurityAndGovernanceSensitivityLabelsCountOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/dataSecurityAndGovernance/sensitivityLabels/$count", id.ID()),
