...
func TestNewUserEventInstanceExceptionOccurrenceExtensionID(t *testing.T) {
	id := NewUserEventInstanceExceptionOccurrenceExtensionID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue")
...
func TestFormatUserEventInstanceExceptionOccurrenceExtensionID(t *testing.T) {
	actual := NewUserEventInstanceExceptionOccurrenceExtensionID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue").ID()
...
func TestParseUserEventInstanceExceptionOccurrenceExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserEventInstanceExceptionOccurrenceExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserEventInstanceExceptionOccurrenceExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserEventInstanceExceptionOccurrenceExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserEventInstanceExceptionOccurrenceExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserEventInstanceExceptionOccurrenceExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserEventInstanceExceptionOccurrenceExtensionId(t *testing.T) {
	segments := UserEventInstanceExceptionOccurrenceExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserEventInstanceExceptionOccurrenceExtensionId has no segments")
	}
