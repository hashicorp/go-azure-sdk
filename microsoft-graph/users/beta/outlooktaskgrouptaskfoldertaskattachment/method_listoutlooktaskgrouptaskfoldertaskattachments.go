...
func (c OutlookTaskGroupTaskFolderTaskAttachmentClient) ListOutlookTaskGroupTaskFolderTaskAttachments(ctx context.Context, id UserIdOutlookTaskGroupIdTaskFolderIdTaskId) (result ListOutlookTaskGroupTaskFolderTaskAttachmentsOperationResponse, err error) {
...
func (c OutlookTaskGroupTaskFolderTaskAttachmentClient) ListOutlookTaskGroupTaskFolderTaskAttachmentsComplete(ctx context.Context, id UserIdOutlookTaskGroupIdTaskFolderIdTaskId) (ListOutlookTaskGroupTaskFolderTaskAttachmentsCompleteResult, error) {
...
func (c OutlookTaskGroupTaskFolderTaskAttachmentClient) ListOutlookTaskGroupTaskFolderTaskAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdOutlookTaskGroupIdTaskFolderIdTaskId, predicate AttachmentOperationPredicate) (result ListOutlookTaskGroupTaskFolderTaskAttachmentsCompleteResult, err error) {
