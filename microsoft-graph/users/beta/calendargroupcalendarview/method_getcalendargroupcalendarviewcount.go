...
func (c CalendarGroupCalendarViewClient) GetCalendarGroupCalendarViewCount(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarId, options GetCalendarGroupCalendarViewCountOperationOptions) (result GetCalendarGroupCalendarViewCountOperationResponse, err error) {
