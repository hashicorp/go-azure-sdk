...
// Read-only.
func (c CalendarGroupCalendarViewClient) GetCalendarGroupCalendarView(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewId, options GetCalendarGroupCalendarViewOperationOptions) (result GetCalendarGroupCalendarViewOperationResponse, err error) {
