...
func (c SecurityInformationProtectionSensitivityLabelClient) UpdateSecurityInformationProtectionSensitivityLabel(ctx context.Context, id UserIdSecurityInformationProtectionSensitivityLabelId, input beta.SecuritySensitivityLabel) (result UpdateSecurityInformationProtectionSensitivityLabelOperationResponse, err error) {
