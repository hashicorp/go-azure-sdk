...
func (c SecurityInformationProtectionSensitivityLabelClient) CreateSecurityInformationProtectionSensitivityLabelSecurityExtractContentLabel(ctx context.Context, id UserId, input CreateSecurityInformationProtectionSensitivityLabelSecurityExtractContentLabelRequest) (result CreateSecurityInformationProtectionSensitivityLabelSecurityExtractContentLabelOperationResponse, err error) {
