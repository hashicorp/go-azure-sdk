...
func (c CalendarGroupCalendarCalendarViewExceptionOccurrenceCalendarClient) GetCalendarGroupCalendarViewExceptionOccurrenceCalendar(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewIdExceptionOccurrenceId, options GetCalendarGroupCalendarViewExceptionOccurrenceCalendarOperationOptions) (result GetCalendarGroupCalendarViewExceptionOccurrenceCalendarOperationResponse, err error) {
