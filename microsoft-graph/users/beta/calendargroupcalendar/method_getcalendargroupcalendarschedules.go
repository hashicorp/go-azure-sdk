...
func (c CalendarGroupCalendarClient) GetCalendarGroupCalendarSchedulesComplete(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarId, input GetCalendarGroupCalendarSchedulesRequest, options GetCalendarGroupCalendarSchedulesOperationOptions) (GetCalendarGroupCalendarSchedulesCompleteResult, error) {
