...
func (c CalendarGroupCalendarClient) DeleteCalendarGroupCalendar(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarId, options DeleteCalendarGroupCalendarOperationOptions) (result DeleteCalendarGroupCalendarOperationResponse, err error) {
