...
// ListCalendarGroupCalendars - Get calendars from users. The calendars in the calendar group. Navigation property.
// Read-only. Nullable.
func (c CalendarGroupCalendarClient) ListCalendarGroupCalendars(ctx context.Context, id beta.UserIdCalendarGroupId, options ListCalendarGroupCalendarsOperationOptions) (result ListCalendarGroupCalendarsOperationResponse, err error) {
...
func (c CalendarGroupCalendarClient) ListCalendarGroupCalendarsComplete(ctx context.Context, id beta.UserIdCalendarGroupId, options ListCalendarGroupCalendarsOperationOptions) (ListCalendarGroupCalendarsCompleteResult, error) {
...
func (c CalendarGroupCalendarClient) ListCalendarGroupCalendarsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdCalendarGroupId, options ListCalendarGroupCalendarsOperationOptions, predicate CalendarOperationPredicate) (result ListCalendarGroupCalendarsCompleteResult, err error) {
