...
func (c AuthenticationPasswordlessMicrosoftAuthenticatorMethodDeviceClient) GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodDevice(ctx context.Context, id UserIdAuthenticationPasswordlessMicrosoftAuthenticatorMethodId) (result GetAuthenticationPasswordlessMicrosoftAuthenticatorMethodDeviceOperationResponse, err error) {
