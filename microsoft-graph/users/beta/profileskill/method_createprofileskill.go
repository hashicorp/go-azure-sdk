...
func (c ProfileSkillClient) CreateProfileSkill(ctx context.Context, id beta.UserId, input beta.SkillProficiency) (result CreateProfileSkillOperationResponse, err error) {
