...
// CreateProfileSkill ...
func (c ProfileSkillClient) CreateProfileSkill(ctx context.Context, id UserId, input beta.SkillProficiency) (result CreateProfileSkillOperationResponse, err error) {
