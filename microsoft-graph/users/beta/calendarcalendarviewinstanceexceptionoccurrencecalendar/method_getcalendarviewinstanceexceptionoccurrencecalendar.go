...
// GetCalendarViewInstanceExceptionOccurrenceCalendar - Get calendar from users. The calendar that contains the event.
// Navigation property. Read-only.
func (c CalendarCalendarViewInstanceExceptionOccurrenceCalendarClient) GetCalendarViewInstanceExceptionOccurrenceCalendar(ctx context.Context, id beta.UserIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceId, options GetCalendarViewInstanceExceptionOccurrenceCalendarOperationOptions) (result GetCalendarViewInstanceExceptionOccurrenceCalendarOperationResponse, err error) {
