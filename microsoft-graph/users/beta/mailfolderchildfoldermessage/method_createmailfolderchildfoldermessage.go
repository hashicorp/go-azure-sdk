...
func (c MailFolderChildFolderMessageClient) CreateMailFolderChildFolderMessage(ctx context.Context, id beta.UserIdMailFolderIdChildFolderId, input beta.Message) (result CreateMailFolderChildFolderMessageOperationResponse, err error) {
