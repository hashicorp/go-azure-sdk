...
func (c MailFolderChildFolderMessageClient) SendMailFolderChildFolderMessage(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId) (result SendMailFolderChildFolderMessageOperationResponse, err error) {
