...
func (c MailFolderChildFolderMessageClient) ReplyAllMailFolderChildFolderMessage(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, input ReplyAllMailFolderChildFolderMessageRequest) (result ReplyAllMailFolderChildFolderMessageOperationResponse, err error) {
