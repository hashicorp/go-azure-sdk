...
func (c MailFolderChildFolderMessageClient) ForwardMailFolderChildFolderMessage(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, input ForwardMailFolderChildFolderMessageRequest) (result ForwardMailFolderChildFolderMessageOperationResponse, err error) {
