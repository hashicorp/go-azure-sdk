...
func (c MailFolderChildFolderMessageClient) SetMailFolderChildFolderMessageValue(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, input []byte) (result SetMailFolderChildFolderMessageValueOperationResponse, err error) {
