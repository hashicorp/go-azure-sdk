...
func (c MailFolderChildFolderMessageClient) MarkMailFolderChildFolderMessageAsNotJunk(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, input MarkMailFolderChildFolderMessageAsNotJunkRequest) (result MarkMailFolderChildFolderMessageAsNotJunkOperationResponse, err error) {
