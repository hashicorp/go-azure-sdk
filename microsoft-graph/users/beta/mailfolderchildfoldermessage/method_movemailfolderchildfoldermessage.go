...
func (c MailFolderChildFolderMessageClient) MoveMailFolderChildFolderMessage(ctx context.Context, id beta.UserIdMailFolderIdChildFolderIdMessageId, input MoveMailFolderChildFolderMessageRequest) (result MoveMailFolderChildFolderMessageOperationResponse, err error) {
