...
func (c ManagedDeviceDeviceCategoryClient) GetManagedDeviceCategoryRef(ctx context.Context, id beta.UserIdManagedDeviceId, options GetManagedDeviceCategoryRefOperationOptions) (result GetManagedDeviceCategoryRefOperationResponse, err error) {
