...
func (c ManagedDeviceDeviceCategoryClient) RemoveManagedDeviceCategoryRef(ctx context.Context, id beta.UserIdManagedDeviceId, options RemoveManagedDeviceCategoryRefOperationOptions) (result RemoveManagedDeviceCategoryRefOperationResponse, err error) {
