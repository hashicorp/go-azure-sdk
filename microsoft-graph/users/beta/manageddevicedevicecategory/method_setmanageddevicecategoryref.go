...
func (c ManagedDeviceDeviceCategoryClient) SetManagedDeviceCategoryRef(ctx context.Context, id beta.UserIdManagedDeviceId, input beta.ReferenceUpdate, options SetManagedDeviceCategoryRefOperationOptions) (result SetManagedDeviceCategoryRefOperationResponse, err error) {
