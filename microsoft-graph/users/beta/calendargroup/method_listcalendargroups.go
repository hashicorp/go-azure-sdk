...
func (c CalendarGroupClient) ListCalendarGroups(ctx context.Context, id beta.UserId, options ListCalendarGroupsOperationOptions) (result ListCalendarGroupsOperationResponse, err error) {
...
func (c CalendarGroupClient) ListCalendarGroupsComplete(ctx context.Context, id beta.UserId, options ListCalendarGroupsOperationOptions) (ListCalendarGroupsCompleteResult, error) {
...
func (c CalendarGroupClient) ListCalendarGroupsCompleteMatchingPredicate(ctx context.Context, id beta.UserId, options ListCalendarGroupsOperationOptions, predicate CalendarGroupOperationPredicate) (result ListCalendarGroupsCompleteResult, err error) {
