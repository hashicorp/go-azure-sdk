...
func (c CalendarGroupClient) GetCalendarGroupsCount(ctx context.Context, id beta.UserId, options GetCalendarGroupsCountOperationOptions) (result GetCalendarGroupsCountOperationResponse, err error) {
