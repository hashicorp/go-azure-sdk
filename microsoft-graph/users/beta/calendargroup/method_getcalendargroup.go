...
// GetCalendarGroup - Get calendarGroups from users. The user's calendar groups. Read-only. Nullable.
func (c CalendarGroupClient) GetCalendarGroup(ctx context.Context, id beta.UserIdCalendarGroupId, options GetCalendarGroupOperationOptions) (result GetCalendarGroupOperationResponse, err error) {
