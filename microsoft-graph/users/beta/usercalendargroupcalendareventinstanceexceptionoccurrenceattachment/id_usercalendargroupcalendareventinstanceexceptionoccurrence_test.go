...
func TestNewUserCalendarGroupCalendarEventInstanceExceptionOccurrenceID(t *testing.T) {
	id := NewUserCalendarGroupCalendarEventInstanceExceptionOccurrenceID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value")
...
func TestFormatUserCalendarGroupCalendarEventInstanceExceptionOccurrenceID(t *testing.T) {
	actual := NewUserCalendarGroupCalendarEventInstanceExceptionOccurrenceID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value").ID()
...
func TestParseUserCalendarGroupCalendarEventInstanceExceptionOccurrenceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventInstanceExceptionOccurrenceId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventInstanceExceptionOccurrenceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarGroupCalendarEventInstanceExceptionOccurrenceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventInstanceExceptionOccurrenceId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventInstanceExceptionOccurrenceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarGroupCalendarEventInstanceExceptionOccurrenceId(t *testing.T) {
	segments := UserCalendarGroupCalendarEventInstanceExceptionOccurrenceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarGroupCalendarEventInstanceExceptionOccurrenceId has no segments")
	}
