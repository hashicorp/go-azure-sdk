...
func TestNewUserCalendarGroupCalendarEventInstanceExceptionOccurrenceAttachmentID(t *testing.T) {
	id := NewUserCalendarGroupCalendarEventInstanceExceptionOccurrenceAttachmentID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue")
...
func TestFormatUserCalendarGroupCalendarEventInstanceExceptionOccurrenceAttachmentID(t *testing.T) {
	actual := NewUserCalendarGroupCalendarEventInstanceExceptionOccurrenceAttachmentID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue").ID()
...
func TestParseUserCalendarGroupCalendarEventInstanceExceptionOccurrenceAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventInstanceExceptionOccurrenceAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventInstanceExceptionOccurrenceAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarGroupCalendarEventInstanceExceptionOccurrenceAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventInstanceExceptionOccurrenceAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventInstanceExceptionOccurrenceAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarGroupCalendarEventInstanceExceptionOccurrenceAttachmentId(t *testing.T) {
	segments := UserCalendarGroupCalendarEventInstanceExceptionOccurrenceAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarGroupCalendarEventInstanceExceptionOccurrenceAttachmentId has no segments")
	}
