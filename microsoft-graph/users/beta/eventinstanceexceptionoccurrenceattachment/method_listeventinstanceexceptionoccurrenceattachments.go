...
func (c EventInstanceExceptionOccurrenceAttachmentClient) ListEventInstanceExceptionOccurrenceAttachments(ctx context.Context, id UserIdEventIdInstanceIdExceptionOccurrenceId) (result ListEventInstanceExceptionOccurrenceAttachmentsOperationResponse, err error) {
...
func (c EventInstanceExceptionOccurrenceAttachmentClient) ListEventInstanceExceptionOccurrenceAttachmentsComplete(ctx context.Context, id UserIdEventIdInstanceIdExceptionOccurrenceId) (ListEventInstanceExceptionOccurrenceAttachmentsCompleteResult, error) {
...
func (c EventInstanceExceptionOccurrenceAttachmentClient) ListEventInstanceExceptionOccurrenceAttachmentsCompleteMatchingPredicate(ctx context.Context, id UserIdEventIdInstanceIdExceptionOccurrenceId, predicate AttachmentOperationPredicate) (result ListEventInstanceExceptionOccurrenceAttachmentsCompleteResult, err error) {
