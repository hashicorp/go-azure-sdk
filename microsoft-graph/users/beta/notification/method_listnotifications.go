...
// ListNotifications ...
func (c NotificationClient) ListNotifications(ctx context.Context, id UserId) (result ListNotificationsOperationResponse, err error) {
...
func (c NotificationClient) ListNotificationsComplete(ctx context.Context, id UserId) (ListNotificationsCompleteResult, error) {
	return c.ListNotificationsCompleteMatchingPredicate(ctx, id, NotificationOperationPredicate{})
}

// ListNotificationsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c NotificationClient) ListNotificationsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate NotificationOperationPredicate) (result ListNotificationsCompleteResult, err error) {
	items := make([]beta.Notification, 0)

	resp, err := c.ListNotifications(ctx, id)
	if err != nil {
