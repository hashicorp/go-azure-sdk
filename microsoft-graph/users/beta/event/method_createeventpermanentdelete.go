...
// quotas.
func (c EventClient) CreateEventPermanentDelete(ctx context.Context, id beta.UserIdEventId, options CreateEventPermanentDeleteOperationOptions) (result CreateEventPermanentDeleteOperationResponse, err error) {
