...
// time.
func (c EventClient) SnoozeEventReminder(ctx context.Context, id beta.UserIdEventId, input SnoozeEventReminderRequest) (result SnoozeEventReminderOperationResponse, err error) {
