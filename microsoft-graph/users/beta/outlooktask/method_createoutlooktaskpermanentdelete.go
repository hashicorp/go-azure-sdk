...
// quotas.
func (c OutlookTaskClient) CreateOutlookTaskPermanentDelete(ctx context.Context, id beta.UserIdOutlookTaskId, options CreateOutlookTaskPermanentDeleteOperationOptions) (result CreateOutlookTaskPermanentDeleteOperationResponse, err error) {
