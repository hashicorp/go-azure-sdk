...
func (c OutlookTaskClient) ListOutlookTaskCompletes(ctx context.Context, id UserIdOutlookTaskId) (result ListOutlookTaskCompletesOperationResponse, err error) {
...
func (c OutlookTaskClient) ListOutlookTaskCompletesComplete(ctx context.Context, id UserIdOutlookTaskId) (ListOutlookTaskCompletesCompleteResult, error) {
...
func (c OutlookTaskClient) ListOutlookTaskCompletesCompleteMatchingPredicate(ctx context.Context, id UserIdOutlookTaskId, predicate OutlookTaskOperationPredicate) (result ListOutlookTaskCompletesCompleteResult, err error) {
