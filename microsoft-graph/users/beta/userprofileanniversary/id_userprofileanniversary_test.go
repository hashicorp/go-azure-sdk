...
func TestNewUserProfileAnniversaryID(t *testing.T) {
	id := NewUserProfileAnniversaryID("userIdValue", "personAnnualEventIdValue")
...
func TestFormatUserProfileAnniversaryID(t *testing.T) {
	actual := NewUserProfileAnniversaryID("userIdValue", "personAnnualEventIdValue").ID()
...
func TestParseUserProfileAnniversaryID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserProfileAnniversaryId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserProfileAnniversaryID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserProfileAnniversaryIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserProfileAnniversaryId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserProfileAnniversaryIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserProfileAnniversaryId(t *testing.T) {
	segments := UserProfileAnniversaryId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserProfileAnniversaryId has no segments")
	}
