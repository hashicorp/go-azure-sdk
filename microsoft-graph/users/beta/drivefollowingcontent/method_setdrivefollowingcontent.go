...
func (c DriveFollowingContentClient) SetDriveFollowingContent(ctx context.Context, id beta.UserIdDriveIdFollowingId, input []byte) (result SetDriveFollowingContentOperationResponse, err error) {
