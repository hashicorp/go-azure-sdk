...
func (c TeamworkAssociatedTeamClient) ListTeamworkAssociatedTeams(ctx context.Context, id UserId) (result ListTeamworkAssociatedTeamsOperationResponse, err error) {
...
func (c TeamworkAssociatedTeamClient) ListTeamworkAssociatedTeamsComplete(ctx context.Context, id UserId) (ListTeamworkAssociatedTeamsCompleteResult, error) {
	return c.ListTeamworkAssociatedTeamsCompleteMatchingPredicate(ctx, id, AssociatedTeamInfoOperationPredicate{})
}

// ListTeamworkAssociatedTeamsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c TeamworkAssociatedTeamClient) ListTeamworkAssociatedTeamsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate AssociatedTeamInfoOperationPredicate) (result ListTeamworkAssociatedTeamsCompleteResult, err error) {
	items := make([]beta.AssociatedTeamInfo, 0)

	resp, err := c.ListTeamworkAssociatedTeams(ctx, id)
	if err != nil {
