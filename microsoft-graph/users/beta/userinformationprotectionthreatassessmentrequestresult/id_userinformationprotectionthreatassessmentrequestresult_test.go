...
func TestNewUserInformationProtectionThreatAssessmentRequestResultID(t *testing.T) {
	id := NewUserInformationProtectionThreatAssessmentRequestResultID("userIdValue", "threatAssessmentRequestIdValue", "threatAssessmentResultIdValue")
...
func TestFormatUserInformationProtectionThreatAssessmentRequestResultID(t *testing.T) {
	actual := NewUserInformationProtectionThreatAssessmentRequestResultID("userIdValue", "threatAssessmentRequestIdValue", "threatAssessmentResultIdValue").ID()
...
func TestParseUserInformationProtectionThreatAssessmentRequestResultID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserInformationProtectionThreatAssessmentRequestResultId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserInformationProtectionThreatAssessmentRequestResultID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserInformationProtectionThreatAssessmentRequestResultIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserInformationProtectionThreatAssessmentRequestResultId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserInformationProtectionThreatAssessmentRequestResultIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserInformationProtectionThreatAssessmentRequestResultId(t *testing.T) {
	segments := UserInformationProtectionThreatAssessmentRequestResultId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserInformationProtectionThreatAssessmentRequestResultId has no segments")
	}
