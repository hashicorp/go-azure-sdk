...
// collection
func (c DeviceMemberOfClient) ListDeviceMemberOfGroups(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceMemberOfGroupsOperationOptions) (result ListDeviceMemberOfGroupsOperationResponse, err error) {
...
func (c DeviceMemberOfClient) ListDeviceMemberOfGroupsComplete(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceMemberOfGroupsOperationOptions) (ListDeviceMemberOfGroupsCompleteResult, error) {
...
func (c DeviceMemberOfClient) ListDeviceMemberOfGroupsCompleteMatchingPredicate(ctx context.Context, id beta.UserIdDeviceId, options ListDeviceMemberOfGroupsOperationOptions, predicate GroupOperationPredicate) (result ListDeviceMemberOfGroupsCompleteResult, err error) {
