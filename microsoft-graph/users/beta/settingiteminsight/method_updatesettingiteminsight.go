...
func (c SettingItemInsightClient) UpdateSettingItemInsight(ctx context.Context, id beta.UserId, input beta.UserInsightsSettings) (result UpdateSettingItemInsightOperationResponse, err error) {
