...
// GetCalendarViewInstanceExceptionOccurrence - Get exceptionOccurrences from users
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) GetCalendarViewInstanceExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId, options GetCalendarViewInstanceExceptionOccurrenceOperationOptions) (result GetCalendarViewInstanceExceptionOccurrenceOperationResponse, err error) {
