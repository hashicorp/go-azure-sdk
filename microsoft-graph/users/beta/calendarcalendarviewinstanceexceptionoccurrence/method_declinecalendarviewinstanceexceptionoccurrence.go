...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) DeclineCalendarViewInstanceExceptionOccurrence(ctx context.Context, id beta.UserIdCalendarIdCalendarViewIdInstanceIdExceptionOccurrenceId, input DeclineCalendarViewInstanceExceptionOccurrenceRequest) (result DeclineCalendarViewInstanceExceptionOccurrenceOperationResponse, err error) {
