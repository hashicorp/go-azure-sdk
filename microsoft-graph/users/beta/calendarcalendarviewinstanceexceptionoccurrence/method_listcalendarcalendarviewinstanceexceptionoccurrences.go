...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) ListCalendarCalendarViewInstanceExceptionOccurrences(ctx context.Context, id UserIdCalendarIdCalendarViewIdInstanceId) (result ListCalendarCalendarViewInstanceExceptionOccurrencesOperationResponse, err error) {
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) ListCalendarCalendarViewInstanceExceptionOccurrencesComplete(ctx context.Context, id UserIdCalendarIdCalendarViewIdInstanceId) (ListCalendarCalendarViewInstanceExceptionOccurrencesCompleteResult, error) {
...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) ListCalendarCalendarViewInstanceExceptionOccurrencesCompleteMatchingPredicate(ctx context.Context, id UserIdCalendarIdCalendarViewIdInstanceId, predicate EventOperationPredicate) (result ListCalendarCalendarViewInstanceExceptionOccurrencesCompleteResult, err error) {
