...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) CreateCalendarCalendarViewInstanceExceptionOccurrenceForward(ctx context.Context, id UserIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceId, input CreateCalendarCalendarViewInstanceExceptionOccurrenceForwardRequest) (result CreateCalendarCalendarViewInstanceExceptionOccurrenceForwardOperationResponse, err error) {
