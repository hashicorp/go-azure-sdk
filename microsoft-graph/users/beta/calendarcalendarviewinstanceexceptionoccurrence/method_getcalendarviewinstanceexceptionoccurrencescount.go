...
func (c CalendarCalendarViewInstanceExceptionOccurrenceClient) GetCalendarViewInstanceExceptionOccurrencesCount(ctx context.Context, id beta.UserIdCalendarCalendarViewIdInstanceId, options GetCalendarViewInstanceExceptionOccurrencesCountOperationOptions) (result GetCalendarViewInstanceExceptionOccurrencesCountOperationResponse, err error) {
