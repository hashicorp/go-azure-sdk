...
// ListUsageRights ...
func (c UsageRightClient) ListUsageRights(ctx context.Context, id UserId) (result ListUsageRightsOperationResponse, err error) {
...
func (c UsageRightClient) ListUsageRightsComplete(ctx context.Context, id UserId) (ListUsageRightsCompleteResult, error) {
	return c.ListUsageRightsCompleteMatchingPredicate(ctx, id, UsageRightOperationPredicate{})
}

// ListUsageRightsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c UsageRightClient) ListUsageRightsCompleteMatchingPredicate(ctx context.Context, id UserId, predicate UsageRightOperationPredicate) (result ListUsageRightsCompleteResult, err error) {
	items := make([]beta.UsageRight, 0)

	resp, err := c.ListUsageRights(ctx, id)
	if err != nil {
