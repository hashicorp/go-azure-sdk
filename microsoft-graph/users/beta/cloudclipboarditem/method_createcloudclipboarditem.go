...
func (c CloudClipboardItemClient) CreateCloudClipboardItem(ctx context.Context, id beta.UserId, input beta.CloudClipboardItem) (result CreateCloudClipboardItemOperationResponse, err error) {
