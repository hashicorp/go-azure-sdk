...
func (c DriveItemCreatedByUserMailboxSettingClient) UpdateDriveItemCreatedByUserMailboxSetting(ctx context.Context, id beta.UserIdDriveIdItemId, input beta.MailboxSettings) (result UpdateDriveItemCreatedByUserMailboxSettingOperationResponse, err error) {
