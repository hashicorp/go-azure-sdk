...
func (c PendingAccessReviewInstanceDecisionInstanceContactedReviewerClient) ListPendingAccessReviewInstanceDecisionInstanceContactedReviewers(ctx context.Context, id UserIdPendingAccessReviewInstanceIdDecisionId) (result ListPendingAccessReviewInstanceDecisionInstanceContactedReviewersOperationResponse, err error) {
...
func (c PendingAccessReviewInstanceDecisionInstanceContactedReviewerClient) ListPendingAccessReviewInstanceDecisionInstanceContactedReviewersComplete(ctx context.Context, id UserIdPendingAccessReviewInstanceIdDecisionId) (ListPendingAccessReviewInstanceDecisionInstanceContactedReviewersCompleteResult, error) {
...
func (c PendingAccessReviewInstanceDecisionInstanceContactedReviewerClient) ListPendingAccessReviewInstanceDecisionInstanceContactedReviewersCompleteMatchingPredicate(ctx context.Context, id UserIdPendingAccessReviewInstanceIdDecisionId, predicate AccessReviewReviewerOperationPredicate) (result ListPendingAccessReviewInstanceDecisionInstanceContactedReviewersCompleteResult, err error) {
