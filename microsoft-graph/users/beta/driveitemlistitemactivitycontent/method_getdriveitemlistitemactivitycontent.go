...
func (c DriveItemListItemActivityContentClient) GetDriveItemListItemActivityContent(ctx context.Context, id beta.UserIdDriveIdItemIdListItemActivityId, options GetDriveItemListItemActivityContentOperationOptions) (result GetDriveItemListItemActivityContentOperationResponse, err error) {
