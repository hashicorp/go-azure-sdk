...
func (c DriveItemListItemActivityContentClient) DeleteDriveItemListItemActivityContent(ctx context.Context, id beta.UserIdDriveIdItemIdListItemActivityId, options DeleteDriveItemListItemActivityContentOperationOptions) (result DeleteDriveItemListItemActivityContentOperationResponse, err error) {
