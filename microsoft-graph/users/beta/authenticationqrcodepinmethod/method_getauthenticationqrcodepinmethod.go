...
// GetAuthenticationQrCodePinMethod - Get qrCodePinAuthenticationMethod. Retrieve a user's qrCodePinAuthenticationMethod
// object.
func (c AuthenticationQrCodePinMethodClient) GetAuthenticationQrCodePinMethod(ctx context.Context, id beta.UserId, options GetAuthenticationQrCodePinMethodOperationOptions) (result GetAuthenticationQrCodePinMethodOperationResponse, err error) {
