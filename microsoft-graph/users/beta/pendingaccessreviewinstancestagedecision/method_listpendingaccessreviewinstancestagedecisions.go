...
func (c PendingAccessReviewInstanceStageDecisionClient) ListPendingAccessReviewInstanceStageDecisions(ctx context.Context, id UserIdPendingAccessReviewInstanceIdStageId) (result ListPendingAccessReviewInstanceStageDecisionsOperationResponse, err error) {
...
func (c PendingAccessReviewInstanceStageDecisionClient) ListPendingAccessReviewInstanceStageDecisionsComplete(ctx context.Context, id UserIdPendingAccessReviewInstanceIdStageId) (ListPendingAccessReviewInstanceStageDecisionsCompleteResult, error) {
...
func (c PendingAccessReviewInstanceStageDecisionClient) ListPendingAccessReviewInstanceStageDecisionsCompleteMatchingPredicate(ctx context.Context, id UserIdPendingAccessReviewInstanceIdStageId, predicate AccessReviewInstanceDecisionItemOperationPredicate) (result ListPendingAccessReviewInstanceStageDecisionsCompleteResult, err error) {
