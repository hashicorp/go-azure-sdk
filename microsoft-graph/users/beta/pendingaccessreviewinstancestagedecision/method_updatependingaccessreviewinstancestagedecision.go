...
func (c PendingAccessReviewInstanceStageDecisionClient) UpdatePendingAccessReviewInstanceStageDecision(ctx context.Context, id UserIdPendingAccessReviewInstanceIdStageIdDecisionId, input beta.AccessReviewInstanceDecisionItem) (result UpdatePendingAccessReviewInstanceStageDecisionOperationResponse, err error) {
