...
func (c ManagedDeviceDetectedAppClient) ListManagedDeviceDetectedApps(ctx context.Context, id UserIdManagedDeviceId) (result ListManagedDeviceDetectedAppsOperationResponse, err error) {
...
func (c ManagedDeviceDetectedAppClient) ListManagedDeviceDetectedAppsComplete(ctx context.Context, id UserIdManagedDeviceId) (ListManagedDeviceDetectedAppsCompleteResult, error) {
...
func (c ManagedDeviceDetectedAppClient) ListManagedDeviceDetectedAppsCompleteMatchingPredicate(ctx context.Context, id UserIdManagedDeviceId, predicate DetectedAppOperationPredicate) (result ListManagedDeviceDetectedAppsCompleteResult, err error) {
