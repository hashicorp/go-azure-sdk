...
func (c CalendarGroupCalendarCalendarViewClient) CancelCalendarGroupCalendarView(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewId, input CancelCalendarGroupCalendarViewRequest) (result CancelCalendarGroupCalendarViewOperationResponse, err error) {
