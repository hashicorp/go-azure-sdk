...
func (c CalendarGroupCalendarCalendarViewClient) GetCalendarGroupCalendarViewCount(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarId, options GetCalendarGroupCalendarViewCountOperationOptions) (result GetCalendarGroupCalendarViewCountOperationResponse, err error) {
