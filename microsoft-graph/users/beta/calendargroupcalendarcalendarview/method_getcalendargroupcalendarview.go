...
// Read-only.
func (c CalendarGroupCalendarCalendarViewClient) GetCalendarGroupCalendarView(ctx context.Context, id beta.UserIdCalendarGroupIdCalendarIdCalendarViewId, options GetCalendarGroupCalendarViewOperationOptions) (result GetCalendarGroupCalendarViewOperationResponse, err error) {
