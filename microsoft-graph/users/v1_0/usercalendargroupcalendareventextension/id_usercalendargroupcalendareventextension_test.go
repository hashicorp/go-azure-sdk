...
func TestNewUserCalendarGroupCalendarEventExtensionID(t *testing.T) {
	id := NewUserCalendarGroupCalendarEventExtensionID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "extensionIdValue")
...
func TestFormatUserCalendarGroupCalendarEventExtensionID(t *testing.T) {
	actual := NewUserCalendarGroupCalendarEventExtensionID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "extensionIdValue").ID()
...
func TestParseUserCalendarGroupCalendarEventExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarGroupCalendarEventExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarGroupCalendarEventExtensionId(t *testing.T) {
	segments := UserCalendarGroupCalendarEventExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarGroupCalendarEventExtensionId has no segments")
	}
