...
func TestNewUserJoinedTeamChannelMessageHostedContentID(t *testing.T) {
	id := NewUserJoinedTeamChannelMessageHostedContentID("userIdValue", "teamIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageHostedContentIdValue")
...
func TestFormatUserJoinedTeamChannelMessageHostedContentID(t *testing.T) {
	actual := NewUserJoinedTeamChannelMessageHostedContentID("userIdValue", "teamIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageHostedContentIdValue").ID()
...
func TestParseUserJoinedTeamChannelMessageHostedContentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamChannelMessageHostedContentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamChannelMessageHostedContentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamChannelMessageHostedContentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamChannelMessageHostedContentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamChannelMessageHostedContentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamChannelMessageHostedContentId(t *testing.T) {
	segments := UserJoinedTeamChannelMessageHostedContentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamChannelMessageHostedContentId has no segments")
	}
