...
func TestNewUserJoinedTeamPrimaryChannelSharedWithTeamID(t *testing.T) {
	id := NewUserJoinedTeamPrimaryChannelSharedWithTeamID("userIdValue", "teamIdValue", "sharedWithChannelTeamInfoIdValue")
...
func TestFormatUserJoinedTeamPrimaryChannelSharedWithTeamID(t *testing.T) {
	actual := NewUserJoinedTeamPrimaryChannelSharedWithTeamID("userIdValue", "teamIdValue", "sharedWithChannelTeamInfoIdValue").ID()
...
func TestParseUserJoinedTeamPrimaryChannelSharedWithTeamID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamPrimaryChannelSharedWithTeamId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamPrimaryChannelSharedWithTeamID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamPrimaryChannelSharedWithTeamIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamPrimaryChannelSharedWithTeamId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamPrimaryChannelSharedWithTeamIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamPrimaryChannelSharedWithTeamId(t *testing.T) {
	segments := UserJoinedTeamPrimaryChannelSharedWithTeamId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamPrimaryChannelSharedWithTeamId has no segments")
	}
