...
func TestNewUserJoinedTeamPermissionGrantID(t *testing.T) {
	id := NewUserJoinedTeamPermissionGrantID("userIdValue", "teamIdValue", "resourceSpecificPermissionGrantIdValue")
...
func TestFormatUserJoinedTeamPermissionGrantID(t *testing.T) {
	actual := NewUserJoinedTeamPermissionGrantID("userIdValue", "teamIdValue", "resourceSpecificPermissionGrantIdValue").ID()
...
func TestParseUserJoinedTeamPermissionGrantID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamPermissionGrantId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamPermissionGrantID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamPermissionGrantIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamPermissionGrantId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamPermissionGrantIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamPermissionGrantId(t *testing.T) {
	segments := UserJoinedTeamPermissionGrantId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamPermissionGrantId has no segments")
	}
