...
func TestNewUserJoinedTeamScheduleOpenShiftChangeRequestID(t *testing.T) {
	id := NewUserJoinedTeamScheduleOpenShiftChangeRequestID("userIdValue", "teamIdValue", "openShiftChangeRequestIdValue")
...
func TestFormatUserJoinedTeamScheduleOpenShiftChangeRequestID(t *testing.T) {
	actual := NewUserJoinedTeamScheduleOpenShiftChangeRequestID("userIdValue", "teamIdValue", "openShiftChangeRequestIdValue").ID()
...
func TestParseUserJoinedTeamScheduleOpenShiftChangeRequestID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamScheduleOpenShiftChangeRequestId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamScheduleOpenShiftChangeRequestID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamScheduleOpenShiftChangeRequestIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamScheduleOpenShiftChangeRequestId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamScheduleOpenShiftChangeRequestIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamScheduleOpenShiftChangeRequestId(t *testing.T) {
	segments := UserJoinedTeamScheduleOpenShiftChangeRequestId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamScheduleOpenShiftChangeRequestId has no segments")
	}
