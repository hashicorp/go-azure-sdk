...
func TestNewUserChatPinnedMessageID(t *testing.T) {
	id := NewUserChatPinnedMessageID("userIdValue", "chatIdValue", "pinnedChatMessageInfoIdValue")
...
func TestFormatUserChatPinnedMessageID(t *testing.T) {
	actual := NewUserChatPinnedMessageID("userIdValue", "chatIdValue", "pinnedChatMessageInfoIdValue").ID()
...
func TestParseUserChatPinnedMessageID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserChatPinnedMessageId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserChatPinnedMessageID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserChatPinnedMessageIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserChatPinnedMessageId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserChatPinnedMessageIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserChatPinnedMessageId(t *testing.T) {
	segments := UserChatPinnedMessageId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserChatPinnedMessageId has no segments")
	}
