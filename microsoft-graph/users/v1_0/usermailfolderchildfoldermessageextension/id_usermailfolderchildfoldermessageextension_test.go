...
func TestNewUserMailFolderChildFolderMessageExtensionID(t *testing.T) {
	id := NewUserMailFolderChildFolderMessageExtensionID("userIdValue", "mailFolderIdValue", "mailFolderId1Value", "messageIdValue", "extensionIdValue")
...
func TestFormatUserMailFolderChildFolderMessageExtensionID(t *testing.T) {
	actual := NewUserMailFolderChildFolderMessageExtensionID("userIdValue", "mailFolderIdValue", "mailFolderId1Value", "messageIdValue", "extensionIdValue").ID()
...
func TestParseUserMailFolderChildFolderMessageExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserMailFolderChildFolderMessageExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserMailFolderChildFolderMessageExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserMailFolderChildFolderMessageExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserMailFolderChildFolderMessageExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserMailFolderChildFolderMessageExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserMailFolderChildFolderMessageExtensionId(t *testing.T) {
	segments := UserMailFolderChildFolderMessageExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserMailFolderChildFolderMessageExtensionId has no segments")
	}
