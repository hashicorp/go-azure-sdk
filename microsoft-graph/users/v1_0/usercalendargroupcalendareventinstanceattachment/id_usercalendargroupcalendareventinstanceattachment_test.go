...
var _ resourceids.ResourceId = UserCalendarGroupCalendarEventInstanceAttachmentId{}

func TestNewUserCalendarGroupCalendarEventInstanceAttachmentID(t *testing.T) {
	id := NewUserCalendarGroupCalendarEventInstanceAttachmentID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue")
...
func TestFormatUserCalendarGroupCalendarEventInstanceAttachmentID(t *testing.T) {
	actual := NewUserCalendarGroupCalendarEventInstanceAttachmentID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue").ID()
...
func TestParseUserCalendarGroupCalendarEventInstanceAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventInstanceAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventInstanceAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarGroupCalendarEventInstanceAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventInstanceAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventInstanceAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarGroupCalendarEventInstanceAttachmentId(t *testing.T) {
	segments := UserCalendarGroupCalendarEventInstanceAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarGroupCalendarEventInstanceAttachmentId has no segments")
	}
