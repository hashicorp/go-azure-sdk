...
func TestNewUserJoinedTeamPrimaryChannelMessageReplyID(t *testing.T) {
	id := NewUserJoinedTeamPrimaryChannelMessageReplyID("userIdValue", "teamIdValue", "chatMessageIdValue", "chatMessageId1Value")
...
func TestFormatUserJoinedTeamPrimaryChannelMessageReplyID(t *testing.T) {
	actual := NewUserJoinedTeamPrimaryChannelMessageReplyID("userIdValue", "teamIdValue", "chatMessageIdValue", "chatMessageId1Value").ID()
...
func TestParseUserJoinedTeamPrimaryChannelMessageReplyID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamPrimaryChannelMessageReplyId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamPrimaryChannelMessageReplyID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamPrimaryChannelMessageReplyIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamPrimaryChannelMessageReplyId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamPrimaryChannelMessageReplyIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamPrimaryChannelMessageReplyId(t *testing.T) {
	segments := UserJoinedTeamPrimaryChannelMessageReplyId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamPrimaryChannelMessageReplyId has no segments")
	}
