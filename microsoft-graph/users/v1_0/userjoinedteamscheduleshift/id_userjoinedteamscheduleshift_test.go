...
func TestNewUserJoinedTeamScheduleShiftID(t *testing.T) {
	id := NewUserJoinedTeamScheduleShiftID("userIdValue", "teamIdValue", "shiftIdValue")
...
func TestFormatUserJoinedTeamScheduleShiftID(t *testing.T) {
	actual := NewUserJoinedTeamScheduleShiftID("userIdValue", "teamIdValue", "shiftIdValue").ID()
...
func TestParseUserJoinedTeamScheduleShiftID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamScheduleShiftId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamScheduleShiftID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamScheduleShiftIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamScheduleShiftId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamScheduleShiftIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamScheduleShiftId(t *testing.T) {
	segments := UserJoinedTeamScheduleShiftId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamScheduleShiftId has no segments")
	}
