...
func TestNewUserJoinedTeamScheduleSwapShiftsChangeRequestID(t *testing.T) {
	id := NewUserJoinedTeamScheduleSwapShiftsChangeRequestID("userIdValue", "teamIdValue", "swapShiftsChangeRequestIdValue")
...
func TestFormatUserJoinedTeamScheduleSwapShiftsChangeRequestID(t *testing.T) {
	actual := NewUserJoinedTeamScheduleSwapShiftsChangeRequestID("userIdValue", "teamIdValue", "swapShiftsChangeRequestIdValue").ID()
...
func TestParseUserJoinedTeamScheduleSwapShiftsChangeRequestID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamScheduleSwapShiftsChangeRequestId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamScheduleSwapShiftsChangeRequestID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamScheduleSwapShiftsChangeRequestIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamScheduleSwapShiftsChangeRequestId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamScheduleSwapShiftsChangeRequestIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamScheduleSwapShiftsChangeRequestId(t *testing.T) {
	segments := UserJoinedTeamScheduleSwapShiftsChangeRequestId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamScheduleSwapShiftsChangeRequestId has no segments")
	}
