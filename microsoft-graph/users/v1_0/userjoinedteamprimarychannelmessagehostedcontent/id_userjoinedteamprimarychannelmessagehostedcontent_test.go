...
func TestNewUserJoinedTeamPrimaryChannelMessageHostedContentID(t *testing.T) {
	id := NewUserJoinedTeamPrimaryChannelMessageHostedContentID("userIdValue", "teamIdValue", "chatMessageIdValue", "chatMessageHostedContentIdValue")
...
func TestFormatUserJoinedTeamPrimaryChannelMessageHostedContentID(t *testing.T) {
	actual := NewUserJoinedTeamPrimaryChannelMessageHostedContentID("userIdValue", "teamIdValue", "chatMessageIdValue", "chatMessageHostedContentIdValue").ID()
...
func TestParseUserJoinedTeamPrimaryChannelMessageHostedContentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamPrimaryChannelMessageHostedContentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamPrimaryChannelMessageHostedContentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamPrimaryChannelMessageHostedContentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamPrimaryChannelMessageHostedContentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamPrimaryChannelMessageHostedContentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamPrimaryChannelMessageHostedContentId(t *testing.T) {
	segments := UserJoinedTeamPrimaryChannelMessageHostedContentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamPrimaryChannelMessageHostedContentId has no segments")
	}
