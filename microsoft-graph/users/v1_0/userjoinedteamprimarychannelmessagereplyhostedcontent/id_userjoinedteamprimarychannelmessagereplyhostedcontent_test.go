...
func TestNewUserJoinedTeamPrimaryChannelMessageReplyHostedContentID(t *testing.T) {
	id := NewUserJoinedTeamPrimaryChannelMessageReplyHostedContentID("userIdValue", "teamIdValue", "chatMessageIdValue", "chatMessageId1Value", "chatMessageHostedContentIdValue")
...
func TestFormatUserJoinedTeamPrimaryChannelMessageReplyHostedContentID(t *testing.T) {
	actual := NewUserJoinedTeamPrimaryChannelMessageReplyHostedContentID("userIdValue", "teamIdValue", "chatMessageIdValue", "chatMessageId1Value", "chatMessageHostedContentIdValue").ID()
...
func TestParseUserJoinedTeamPrimaryChannelMessageReplyHostedContentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamPrimaryChannelMessageReplyHostedContentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamPrimaryChannelMessageReplyHostedContentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamPrimaryChannelMessageReplyHostedContentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamPrimaryChannelMessageReplyHostedContentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamPrimaryChannelMessageReplyHostedContentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamPrimaryChannelMessageReplyHostedContentId(t *testing.T) {
	segments := UserJoinedTeamPrimaryChannelMessageReplyHostedContentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamPrimaryChannelMessageReplyHostedContentId has no segments")
	}
