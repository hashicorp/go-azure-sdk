...
func TestNewUserJoinedTeamTagMemberID(t *testing.T) {
	id := NewUserJoinedTeamTagMemberID("userIdValue", "teamIdValue", "teamworkTagIdValue", "teamworkTagMemberIdValue")
...
func TestFormatUserJoinedTeamTagMemberID(t *testing.T) {
	actual := NewUserJoinedTeamTagMemberID("userIdValue", "teamIdValue", "teamworkTagIdValue", "teamworkTagMemberIdValue").ID()
...
func TestParseUserJoinedTeamTagMemberID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamTagMemberId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamTagMemberID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamTagMemberIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamTagMemberId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamTagMemberIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamTagMemberId(t *testing.T) {
	segments := UserJoinedTeamTagMemberId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamTagMemberId has no segments")
	}
