...
func TestNewUserJoinedTeamScheduleSchedulingGroupID(t *testing.T) {
	id := NewUserJoinedTeamScheduleSchedulingGroupID("userIdValue", "teamIdValue", "schedulingGroupIdValue")
...
func TestFormatUserJoinedTeamScheduleSchedulingGroupID(t *testing.T) {
	actual := NewUserJoinedTeamScheduleSchedulingGroupID("userIdValue", "teamIdValue", "schedulingGroupIdValue").ID()
...
func TestParseUserJoinedTeamScheduleSchedulingGroupID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamScheduleSchedulingGroupId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamScheduleSchedulingGroupID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamScheduleSchedulingGroupIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamScheduleSchedulingGroupId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamScheduleSchedulingGroupIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamScheduleSchedulingGroupId(t *testing.T) {
	segments := UserJoinedTeamScheduleSchedulingGroupId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamScheduleSchedulingGroupId has no segments")
	}
