...
func TestNewUserJoinedTeamInstalledAppID(t *testing.T) {
	id := NewUserJoinedTeamInstalledAppID("userIdValue", "teamIdValue", "teamsAppInstallationIdValue")
...
func TestFormatUserJoinedTeamInstalledAppID(t *testing.T) {
	actual := NewUserJoinedTeamInstalledAppID("userIdValue", "teamIdValue", "teamsAppInstallationIdValue").ID()
...
func TestParseUserJoinedTeamInstalledAppID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamInstalledAppId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamInstalledAppID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamInstalledAppIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamInstalledAppId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamInstalledAppIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamInstalledAppId(t *testing.T) {
	segments := UserJoinedTeamInstalledAppId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamInstalledAppId has no segments")
	}
