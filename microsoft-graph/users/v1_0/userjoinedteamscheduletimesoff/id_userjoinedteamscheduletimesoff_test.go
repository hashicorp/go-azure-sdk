...
func TestNewUserJoinedTeamScheduleTimesOffID(t *testing.T) {
	id := NewUserJoinedTeamScheduleTimesOffID("userIdValue", "teamIdValue", "timeOffIdValue")
...
func TestFormatUserJoinedTeamScheduleTimesOffID(t *testing.T) {
	actual := NewUserJoinedTeamScheduleTimesOffID("userIdValue", "teamIdValue", "timeOffIdValue").ID()
...
func TestParseUserJoinedTeamScheduleTimesOffID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamScheduleTimesOffId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamScheduleTimesOffID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamScheduleTimesOffIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamScheduleTimesOffId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamScheduleTimesOffIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamScheduleTimesOffId(t *testing.T) {
	segments := UserJoinedTeamScheduleTimesOffId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamScheduleTimesOffId has no segments")
	}
