...
func TestNewUserJoinedTeamOperationID(t *testing.T) {
	id := NewUserJoinedTeamOperationID("userIdValue", "teamIdValue", "teamsAsyncOperationIdValue")
...
func TestFormatUserJoinedTeamOperationID(t *testing.T) {
	actual := NewUserJoinedTeamOperationID("userIdValue", "teamIdValue", "teamsAsyncOperationIdValue").ID()
...
func TestParseUserJoinedTeamOperationID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamOperationId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamOperationID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamOperationIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamOperationId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamOperationIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamOperationId(t *testing.T) {
	segments := UserJoinedTeamOperationId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamOperationId has no segments")
	}
