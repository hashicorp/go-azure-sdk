...
func TestNewUserChatMessageHostedContentID(t *testing.T) {
	id := NewUserChatMessageHostedContentID("userIdValue", "chatIdValue", "chatMessageIdValue", "chatMessageHostedContentIdValue")
...
func TestFormatUserChatMessageHostedContentID(t *testing.T) {
	actual := NewUserChatMessageHostedContentID("userIdValue", "chatIdValue", "chatMessageIdValue", "chatMessageHostedContentIdValue").ID()
...
func TestParseUserChatMessageHostedContentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserChatMessageHostedContentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserChatMessageHostedContentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserChatMessageHostedContentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserChatMessageHostedContentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserChatMessageHostedContentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserChatMessageHostedContentId(t *testing.T) {
	segments := UserChatMessageHostedContentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserChatMessageHostedContentId has no segments")
	}
