...
func TestNewUserJoinedTeamChannelMessageReplyHostedContentID(t *testing.T) {
	id := NewUserJoinedTeamChannelMessageReplyHostedContentID("userIdValue", "teamIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageId1Value", "chatMessageHostedContentIdValue")
...
func TestFormatUserJoinedTeamChannelMessageReplyHostedContentID(t *testing.T) {
	actual := NewUserJoinedTeamChannelMessageReplyHostedContentID("userIdValue", "teamIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageId1Value", "chatMessageHostedContentIdValue").ID()
...
func TestParseUserJoinedTeamChannelMessageReplyHostedContentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamChannelMessageReplyHostedContentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamChannelMessageReplyHostedContentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamChannelMessageReplyHostedContentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamChannelMessageReplyHostedContentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamChannelMessageReplyHostedContentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamChannelMessageReplyHostedContentId(t *testing.T) {
	segments := UserJoinedTeamChannelMessageReplyHostedContentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamChannelMessageReplyHostedContentId has no segments")
	}
