...
func TestNewUserJoinedTeamChannelMessageReplyID(t *testing.T) {
	id := NewUserJoinedTeamChannelMessageReplyID("userIdValue", "teamIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageId1Value")
...
func TestFormatUserJoinedTeamChannelMessageReplyID(t *testing.T) {
	actual := NewUserJoinedTeamChannelMessageReplyID("userIdValue", "teamIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageId1Value").ID()
	expected := "/users/userIdValue/joinedTeams/teamIdValue/channels/channelIdValue/messages/chatMessageIdValue/replies/chatMessageId1Value"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseUserJoinedTeamChannelMessageReplyID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamChannelMessageReplyId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/users/userIdValue/joinedTeams/teamIdValue/channels/channelIdValue/messages/chatMessageIdValue/replies/chatMessageId1Value/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamChannelMessageReplyID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamChannelMessageReplyIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamChannelMessageReplyId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamChannelMessageReplyIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamChannelMessageReplyId(t *testing.T) {
	segments := UserJoinedTeamChannelMessageReplyId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamChannelMessageReplyId has no segments")
	}
