...
func TestNewUserMailFolderMessageAttachmentID(t *testing.T) {
	id := NewUserMailFolderMessageAttachmentID("userIdValue", "mailFolderIdValue", "messageIdValue", "attachmentIdValue")
...
func TestFormatUserMailFolderMessageAttachmentID(t *testing.T) {
	actual := NewUserMailFolderMessageAttachmentID("userIdValue", "mailFolderIdValue", "messageIdValue", "attachmentIdValue").ID()
...
func TestParseUserMailFolderMessageAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserMailFolderMessageAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserMailFolderMessageAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserMailFolderMessageAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserMailFolderMessageAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserMailFolderMessageAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserMailFolderMessageAttachmentId(t *testing.T) {
	segments := UserMailFolderMessageAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserMailFolderMessageAttachmentId has no segments")
	}
