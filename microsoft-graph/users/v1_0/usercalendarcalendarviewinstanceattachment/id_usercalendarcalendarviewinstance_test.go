...
func TestNewUserCalendarCalendarViewInstanceID(t *testing.T) {
	id := NewUserCalendarCalendarViewInstanceID("userIdValue", "calendarIdValue", "eventIdValue", "eventId1Value")
...
func TestFormatUserCalendarCalendarViewInstanceID(t *testing.T) {
	actual := NewUserCalendarCalendarViewInstanceID("userIdValue", "calendarIdValue", "eventIdValue", "eventId1Value").ID()
