...
func TestNewUserTodoListTaskAttachmentSessionID(t *testing.T) {
	id := NewUserTodoListTaskAttachmentSessionID("userIdValue", "todoTaskListIdValue", "todoTaskIdValue", "attachmentSessionIdValue")
...
func TestFormatUserTodoListTaskAttachmentSessionID(t *testing.T) {
	actual := NewUserTodoListTaskAttachmentSessionID("userIdValue", "todoTaskListIdValue", "todoTaskIdValue", "attachmentSessionIdValue").ID()
...
func TestParseUserTodoListTaskAttachmentSessionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserTodoListTaskAttachmentSessionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserTodoListTaskAttachmentSessionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserTodoListTaskAttachmentSessionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserTodoListTaskAttachmentSessionId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserTodoListTaskAttachmentSessionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserTodoListTaskAttachmentSessionId(t *testing.T) {
	segments := UserTodoListTaskAttachmentSessionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserTodoListTaskAttachmentSessionId has no segments")
	}
