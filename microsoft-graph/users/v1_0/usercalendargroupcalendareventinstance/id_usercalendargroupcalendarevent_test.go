...
func TestNewUserCalendarGroupCalendarEventID(t *testing.T) {
	id := NewUserCalendarGroupCalendarEventID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue")
...
func TestFormatUserCalendarGroupCalendarEventID(t *testing.T) {
	actual := NewUserCalendarGroupCalendarEventID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue").ID()
...
func TestParseUserCalendarGroupCalendarEventID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarGroupCalendarEventIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarGroupCalendarEventId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarGroupCalendarEventIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarGroupCalendarEventId(t *testing.T) {
	segments := UserCalendarGroupCalendarEventId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarGroupCalendarEventId has no segments")
	}
