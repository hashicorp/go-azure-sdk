...
func TestNewUserCalendarEventExtensionID(t *testing.T) {
	id := NewUserCalendarEventExtensionID("userIdValue", "calendarIdValue", "eventIdValue", "extensionIdValue")
...
func TestFormatUserCalendarEventExtensionID(t *testing.T) {
	actual := NewUserCalendarEventExtensionID("userIdValue", "calendarIdValue", "eventIdValue", "extensionIdValue").ID()
...
func TestParseUserCalendarEventExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarEventExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarEventExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserCalendarEventExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserCalendarEventExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserCalendarEventExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserCalendarEventExtensionId(t *testing.T) {
	segments := UserCalendarEventExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserCalendarEventExtensionId has no segments")
	}
