...
func TestNewUserTeamworkAssociatedTeamID(t *testing.T) {
	id := NewUserTeamworkAssociatedTeamID("userIdValue", "associatedTeamInfoIdValue")
...
func TestFormatUserTeamworkAssociatedTeamID(t *testing.T) {
	actual := NewUserTeamworkAssociatedTeamID("userIdValue", "associatedTeamInfoIdValue").ID()
...
func TestParseUserTeamworkAssociatedTeamID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserTeamworkAssociatedTeamId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserTeamworkAssociatedTeamID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserTeamworkAssociatedTeamIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserTeamworkAssociatedTeamId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserTeamworkAssociatedTeamIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserTeamworkAssociatedTeamId(t *testing.T) {
	segments := UserTeamworkAssociatedTeamId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserTeamworkAssociatedTeamId has no segments")
	}
