package userjoinedteamchanneltabteamsapp
...
func TestNewUserJoinedTeamChannelTabID(t *testing.T) {
	id := NewUserJoinedTeamChannelTabID("userIdValue", "teamIdValue", "channelIdValue", "teamsTabIdValue")
...
func TestFormatUserJoinedTeamChannelTabID(t *testing.T) {
	actual := NewUserJoinedTeamChannelTabID("userIdValue", "teamIdValue", "channelIdValue", "teamsTabIdValue").ID()
...
func TestParseUserJoinedTeamChannelTabID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamChannelTabId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamChannelTabID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamChannelTabIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamChannelTabId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamChannelTabIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamChannelTabId(t *testing.T) {
	segments := UserJoinedTeamChannelTabId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamChannelTabId has no segments")
	}
