...
func TestNewUserOnlineMeetingAttendanceReportID(t *testing.T) {
	id := NewUserOnlineMeetingAttendanceReportID("userIdValue", "onlineMeetingIdValue", "meetingAttendanceReportIdValue")
...
func TestFormatUserOnlineMeetingAttendanceReportID(t *testing.T) {
	actual := NewUserOnlineMeetingAttendanceReportID("userIdValue", "onlineMeetingIdValue", "meetingAttendanceReportIdValue").ID()
...
func TestParseUserOnlineMeetingAttendanceReportID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserOnlineMeetingAttendanceReportId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserOnlineMeetingAttendanceReportID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserOnlineMeetingAttendanceReportIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserOnlineMeetingAttendanceReportId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserOnlineMeetingAttendanceReportIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserOnlineMeetingAttendanceReportId(t *testing.T) {
	segments := UserOnlineMeetingAttendanceReportId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserOnlineMeetingAttendanceReportId has no segments")
	}
