...
func TestNewUserJoinedTeamChannelSharedWithTeamID(t *testing.T) {
	id := NewUserJoinedTeamChannelSharedWithTeamID("userIdValue", "teamIdValue", "channelIdValue", "sharedWithChannelTeamInfoIdValue")
...
func TestFormatUserJoinedTeamChannelSharedWithTeamID(t *testing.T) {
	actual := NewUserJoinedTeamChannelSharedWithTeamID("userIdValue", "teamIdValue", "channelIdValue", "sharedWithChannelTeamInfoIdValue").ID()
	expected := "/users/userIdValue/joinedTeams/teamIdValue/channels/channelIdValue/sharedWithTeams/sharedWithChannelTeamInfoIdValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseUserJoinedTeamChannelSharedWithTeamID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamChannelSharedWithTeamId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/users/userIdValue/joinedTeams/teamIdValue/channels/channelIdValue/sharedWithTeams/sharedWithChannelTeamInfoIdValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamChannelSharedWithTeamID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamChannelSharedWithTeamIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamChannelSharedWithTeamId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamChannelSharedWithTeamIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamChannelSharedWithTeamId(t *testing.T) {
	segments := UserJoinedTeamChannelSharedWithTeamId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamChannelSharedWithTeamId has no segments")
	}
