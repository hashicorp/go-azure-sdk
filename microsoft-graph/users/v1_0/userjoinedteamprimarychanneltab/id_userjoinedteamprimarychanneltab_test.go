...
func TestNewUserJoinedTeamPrimaryChannelTabID(t *testing.T) {
	id := NewUserJoinedTeamPrimaryChannelTabID("userIdValue", "teamIdValue", "teamsTabIdValue")
...
func TestFormatUserJoinedTeamPrimaryChannelTabID(t *testing.T) {
	actual := NewUserJoinedTeamPrimaryChannelTabID("userIdValue", "teamIdValue", "teamsTabIdValue").ID()
...
func TestParseUserJoinedTeamPrimaryChannelTabID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamPrimaryChannelTabId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamPrimaryChannelTabID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamPrimaryChannelTabIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamPrimaryChannelTabId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamPrimaryChannelTabIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamPrimaryChannelTabId(t *testing.T) {
	segments := UserJoinedTeamPrimaryChannelTabId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamPrimaryChannelTabId has no segments")
	}
