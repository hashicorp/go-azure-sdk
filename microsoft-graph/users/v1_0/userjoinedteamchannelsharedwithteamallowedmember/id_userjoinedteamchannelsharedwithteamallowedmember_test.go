...
func TestNewUserJoinedTeamChannelSharedWithTeamAllowedMemberID(t *testing.T) {
	id := NewUserJoinedTeamChannelSharedWithTeamAllowedMemberID("userIdValue", "teamIdValue", "channelIdValue", "sharedWithChannelTeamInfoIdValue", "conversationMemberIdValue")
...
func TestFormatUserJoinedTeamChannelSharedWithTeamAllowedMemberID(t *testing.T) {
	actual := NewUserJoinedTeamChannelSharedWithTeamAllowedMemberID("userIdValue", "teamIdValue", "channelIdValue", "sharedWithChannelTeamInfoIdValue", "conversationMemberIdValue").ID()
...
func TestParseUserJoinedTeamChannelSharedWithTeamAllowedMemberID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamChannelSharedWithTeamAllowedMemberId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamChannelSharedWithTeamAllowedMemberID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamChannelSharedWithTeamAllowedMemberIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamChannelSharedWithTeamAllowedMemberId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamChannelSharedWithTeamAllowedMemberIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamChannelSharedWithTeamAllowedMemberId(t *testing.T) {
	segments := UserJoinedTeamChannelSharedWithTeamAllowedMemberId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamChannelSharedWithTeamAllowedMemberId has no segments")
	}
