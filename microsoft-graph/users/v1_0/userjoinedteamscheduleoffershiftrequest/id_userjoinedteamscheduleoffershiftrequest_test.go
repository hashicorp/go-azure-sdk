...
func TestNewUserJoinedTeamScheduleOfferShiftRequestID(t *testing.T) {
	id := NewUserJoinedTeamScheduleOfferShiftRequestID("userIdValue", "teamIdValue", "offerShiftRequestIdValue")
...
func TestFormatUserJoinedTeamScheduleOfferShiftRequestID(t *testing.T) {
	actual := NewUserJoinedTeamScheduleOfferShiftRequestID("userIdValue", "teamIdValue", "offerShiftRequestIdValue").ID()
...
func TestParseUserJoinedTeamScheduleOfferShiftRequestID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamScheduleOfferShiftRequestId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamScheduleOfferShiftRequestID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserJoinedTeamScheduleOfferShiftRequestIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserJoinedTeamScheduleOfferShiftRequestId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserJoinedTeamScheduleOfferShiftRequestIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserJoinedTeamScheduleOfferShiftRequestId(t *testing.T) {
	segments := UserJoinedTeamScheduleOfferShiftRequestId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserJoinedTeamScheduleOfferShiftRequestId has no segments")
	}
