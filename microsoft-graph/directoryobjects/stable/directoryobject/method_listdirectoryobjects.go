...
func (c DirectoryObjectClient) ListDirectoryObjectsComplete(ctx context.Context) (ListDirectoryObjectsCompleteResult, error) {
	return c.ListDirectoryObjectsCompleteMatchingPredicate(ctx, DirectoryObjectOperationPredicate{})
}

// ListDirectoryObjectsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c DirectoryObjectClient) ListDirectoryObjectsCompleteMatchingPredicate(ctx context.Context, predicate DirectoryObjectOperationPredicate) (result ListDirectoryObjectsCompleteResult, err error) {
