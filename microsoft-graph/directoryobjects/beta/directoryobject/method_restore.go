...
func (c DirectoryObjectClient) Restore(ctx context.Context, id beta.DirectoryObjectId, options RestoreOperationOptions) (result RestoreOperationResponse, err error) {
