...
func (c SchemaExtensionClient) UpdateSchemaExtension(ctx context.Context, id stable.SchemaExtensionId, input stable.SchemaExtension) (result UpdateSchemaExtensionOperationResponse, err error) {
