...
func (c PartnerBillingReconciliationBilledClient) UpdatePartnerBillingReconciliationBilled(ctx context.Context, input beta.PartnersBillingBilledReconciliation) (result UpdatePartnerBillingReconciliationBilledOperationResponse, err error) {
