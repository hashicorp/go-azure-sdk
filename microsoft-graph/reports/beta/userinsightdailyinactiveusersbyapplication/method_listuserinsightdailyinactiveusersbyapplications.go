...
// ListUserInsightDailyInactiveUsersByApplications ...
func (c UserInsightDailyInactiveUsersByApplicationClient) ListUserInsightDailyInactiveUsersByApplications(ctx context.Context) (result ListUserInsightDailyInactiveUsersByApplicationsOperationResponse, err error) {
...
func (c UserInsightDailyInactiveUsersByApplicationClient) ListUserInsightDailyInactiveUsersByApplicationsComplete(ctx context.Context) (ListUserInsightDailyInactiveUsersByApplicationsCompleteResult, error) {
	return c.ListUserInsightDailyInactiveUsersByApplicationsCompleteMatchingPredicate(ctx, DailyInactiveUsersByApplicationMetricOperationPredicate{})
}
...
func (c UserInsightDailyInactiveUsersByApplicationClient) ListUserInsightDailyInactiveUsersByApplicationsCompleteMatchingPredicate(ctx context.Context, predicate DailyInactiveUsersByApplicationMetricOperationPredicate) (result ListUserInsightDailyInactiveUsersByApplicationsCompleteResult, err error) {
	items := make([]beta.DailyInactiveUsersByApplicationMetric, 0)

	resp, err := c.ListUserInsightDailyInactiveUsersByApplications(ctx)
	if err != nil {
