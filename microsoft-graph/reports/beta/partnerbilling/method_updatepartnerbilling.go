...
func (c PartnerBillingClient) UpdatePartnerBilling(ctx context.Context, input beta.PartnersBillingBilling) (result UpdatePartnerBillingOperationResponse, err error) {
