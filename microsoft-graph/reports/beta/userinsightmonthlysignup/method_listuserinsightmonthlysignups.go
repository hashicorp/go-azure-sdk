...
// ListUserInsightMonthlySignUps ...
func (c UserInsightMonthlySignUpClient) ListUserInsightMonthlySignUps(ctx context.Context) (result ListUserInsightMonthlySignUpsOperationResponse, err error) {
...
func (c UserInsightMonthlySignUpClient) ListUserInsightMonthlySignUpsComplete(ctx context.Context) (ListUserInsightMonthlySignUpsCompleteResult, error) {
	return c.ListUserInsightMonthlySignUpsCompleteMatchingPredicate(ctx, UserSignUpMetricOperationPredicate{})
}

// ListUserInsightMonthlySignUpsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c UserInsightMonthlySignUpClient) ListUserInsightMonthlySignUpsCompleteMatchingPredicate(ctx context.Context, predicate UserSignUpMetricOperationPredicate) (result ListUserInsightMonthlySignUpsCompleteResult, err error) {
	items := make([]beta.UserSignUpMetric, 0)

	resp, err := c.ListUserInsightMonthlySignUps(ctx)
	if err != nil {
