...
func (c PartnerBillingUsageClient) UpdatePartnerBillingUsage(ctx context.Context, input beta.PartnersBillingAzureUsage) (result UpdatePartnerBillingUsageOperationResponse, err error) {
