...
// GetSlaAzureADAuthentication ...
func (c SlaAzureADAuthenticationClient) GetSlaAzureADAuthentication(ctx context.Context) (result GetSlaAzureADAuthenticationOperationResponse, err error) {
