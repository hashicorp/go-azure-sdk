...
// GetUserInsightMonthly ...
func (c UserInsightMonthlyClient) GetUserInsightMonthly(ctx context.Context) (result GetUserInsightMonthlyOperationResponse, err error) {
