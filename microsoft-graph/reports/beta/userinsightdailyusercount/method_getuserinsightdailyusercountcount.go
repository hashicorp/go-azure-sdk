...
func (c UserInsightDailyUserCountClient) GetUserInsightDailyUserCountCount(ctx context.Context) (result GetUserInsightDailyUserCountCountOperationResponse, err error) {
