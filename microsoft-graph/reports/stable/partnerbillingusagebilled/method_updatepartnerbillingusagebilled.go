...
func (c PartnerBillingUsageBilledClient) UpdatePartnerBillingUsageBilled(ctx context.Context, input stable.PartnersBillingBilledUsage) (result UpdatePartnerBillingUsageBilledOperationResponse, err error) {
