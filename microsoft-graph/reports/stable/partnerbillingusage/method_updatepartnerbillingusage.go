...
func (c PartnerBillingUsageClient) UpdatePartnerBillingUsage(ctx context.Context, input stable.PartnersBillingAzureUsage) (result UpdatePartnerBillingUsageOperationResponse, err error) {
