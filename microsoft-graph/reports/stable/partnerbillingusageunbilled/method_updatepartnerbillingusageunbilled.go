...
func (c PartnerBillingUsageUnbilledClient) UpdatePartnerBillingUsageUnbilled(ctx context.Context, input stable.PartnersBillingUnbilledUsage) (result UpdatePartnerBillingUsageUnbilledOperationResponse, err error) {
