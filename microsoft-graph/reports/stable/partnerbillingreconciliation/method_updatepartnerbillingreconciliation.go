...
func (c PartnerBillingReconciliationClient) UpdatePartnerBillingReconciliation(ctx context.Context, input stable.PartnersBillingBillingReconciliation) (result UpdatePartnerBillingReconciliationOperationResponse, err error) {
