...
func (c PartnerBillingClient) UpdatePartnerBilling(ctx context.Context, input stable.PartnersBillingBilling) (result UpdatePartnerBillingOperationResponse, err error) {
