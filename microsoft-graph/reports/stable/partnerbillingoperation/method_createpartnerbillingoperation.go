...
func (c PartnerBillingOperationClient) CreatePartnerBillingOperation(ctx context.Context, input stable.PartnersBillingOperation) (result CreatePartnerBillingOperationOperationResponse, err error) {
