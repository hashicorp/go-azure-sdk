...
func (c AuthenticationMethodClient) UpdateAuthenticationMethod(ctx context.Context, input stable.AuthenticationMethodsRoot) (result UpdateAuthenticationMethodOperationResponse, err error) {
