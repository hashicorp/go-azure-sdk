...
func (c LifecycleWorkflowDeletedItemWorkflowLastModifiedByServiceProvisioningErrorClient) ListLifecycleWorkflowDeletedItemWorkflowLastModifiedByServiceProvisioningErrors(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId) (result ListLifecycleWorkflowDeletedItemWorkflowLastModifiedByServiceProvisioningErrorsOperationResponse, err error) {
...
func (c LifecycleWorkflowDeletedItemWorkflowLastModifiedByServiceProvisioningErrorClient) ListLifecycleWorkflowDeletedItemWorkflowLastModifiedByServiceProvisioningErrorsComplete(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId) (ListLifecycleWorkflowDeletedItemWorkflowLastModifiedByServiceProvisioningErrorsCompleteResult, error) {
	return c.ListLifecycleWorkflowDeletedItemWorkflowLastModifiedByServiceProvisioningErrorsCompleteMatchingPredicate(ctx, id, ServiceProvisioningErrorOperationPredicate{})
}
...
func (c LifecycleWorkflowDeletedItemWorkflowLastModifiedByServiceProvisioningErrorClient) ListLifecycleWorkflowDeletedItemWorkflowLastModifiedByServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, predicate ServiceProvisioningErrorOperationPredicate) (result ListLifecycleWorkflowDeletedItemWorkflowLastModifiedByServiceProvisioningErrorsCompleteResult, err error) {
	items := make([]stable.ServiceProvisioningError, 0)

	resp, err := c.ListLifecycleWorkflowDeletedItemWorkflowLastModifiedByServiceProvisioningErrors(ctx, id)
	if err != nil {
