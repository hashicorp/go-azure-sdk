...
// value.
func (c LifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubjectMailboxSettingClient) UpdateLifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubjectMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdUserProcessingResultId, input stable.MailboxSettings) (result UpdateLifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubjectMailboxSettingOperationResponse, err error) {
