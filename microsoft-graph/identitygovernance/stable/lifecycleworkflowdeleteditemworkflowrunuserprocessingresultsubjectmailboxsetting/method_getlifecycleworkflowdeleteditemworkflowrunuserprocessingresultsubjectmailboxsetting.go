...
func (c LifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingClient) GetLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSetting(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdRunIdUserProcessingResultId) (result GetLifecycleWorkflowDeletedItemWorkflowRunUserProcessingResultSubjectMailboxSettingOperationResponse, err error) {
