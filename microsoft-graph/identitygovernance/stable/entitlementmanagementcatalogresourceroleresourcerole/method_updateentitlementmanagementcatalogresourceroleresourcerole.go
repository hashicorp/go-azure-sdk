...
// UpdateEntitlementManagementCatalogResourceRoleResourceRole ...
func (c EntitlementManagementCatalogResourceRoleResourceRoleClient) UpdateEntitlementManagementCatalogResourceRoleResourceRole(ctx context.Context, id IdentityGovernanceEntitlementManagementCatalogIdResourceRoleIdResourceRoleId, input stable.AccessPackageResourceRole) (result UpdateEntitlementManagementCatalogResourceRoleResourceRoleOperationResponse, err error) {
