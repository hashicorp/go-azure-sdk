...
// properties.
func (c LifecycleWorkflowVersionClient) ListLifecycleWorkflowVersions(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowVersionsOperationOptions) (result ListLifecycleWorkflowVersionsOperationResponse, err error) {
...
func (c LifecycleWorkflowVersionClient) ListLifecycleWorkflowVersionsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowVersionsOperationOptions) (ListLifecycleWorkflowVersionsCompleteResult, error) {
