...
func (c LifecycleWorkflowVersionClient) GetLifecycleWorkflowVersion(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options GetLifecycleWorkflowVersionOperationOptions) (result GetLifecycleWorkflowVersionOperationResponse, err error) {
