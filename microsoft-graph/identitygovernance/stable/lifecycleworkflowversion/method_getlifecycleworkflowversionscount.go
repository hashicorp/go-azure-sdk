...
func (c LifecycleWorkflowVersionClient) GetLifecycleWorkflowVersionsCount(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowVersionsCountOperationOptions) (result GetLifecycleWorkflowVersionsCountOperationResponse, err error) {
