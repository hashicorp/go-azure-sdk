...
// RemoveEntitlementManagementConnectedOrganizationExternalSponsorRef ...
func (c EntitlementManagementConnectedOrganizationExternalSponsorClient) RemoveEntitlementManagementConnectedOrganizationExternalSponsorRef(ctx context.Context, id IdentityGovernanceEntitlementManagementConnectedOrganizationIdExternalSponsorId) (result RemoveEntitlementManagementConnectedOrganizationExternalSponsorRefOperationResponse, err error) {
