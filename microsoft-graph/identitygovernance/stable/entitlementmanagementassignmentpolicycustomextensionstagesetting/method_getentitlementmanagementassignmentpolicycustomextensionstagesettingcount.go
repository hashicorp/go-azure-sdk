...
type GetEntitlementManagementAssignmentPolicyCustomExtensionStageSettingCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetEntitlementManagementAssignmentPolicyCustomExtensionStageSettingCount ...
func (c EntitlementManagementAssignmentPolicyCustomExtensionStageSettingClient) GetEntitlementManagementAssignmentPolicyCustomExtensionStageSettingCount(ctx context.Context, id IdentityGovernanceEntitlementManagementAssignmentPolicyId) (result GetEntitlementManagementAssignmentPolicyCustomExtensionStageSettingCountOperationResponse, err error) {
