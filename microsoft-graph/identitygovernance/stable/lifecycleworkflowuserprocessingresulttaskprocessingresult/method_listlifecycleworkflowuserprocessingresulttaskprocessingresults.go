...
func (c LifecycleWorkflowUserProcessingResultTaskProcessingResultClient) ListLifecycleWorkflowUserProcessingResultTaskProcessingResults(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultId, options ListLifecycleWorkflowUserProcessingResultTaskProcessingResultsOperationOptions) (result ListLifecycleWorkflowUserProcessingResultTaskProcessingResultsOperationResponse, err error) {
...
func (c LifecycleWorkflowUserProcessingResultTaskProcessingResultClient) ListLifecycleWorkflowUserProcessingResultTaskProcessingResultsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultId, options ListLifecycleWorkflowUserProcessingResultTaskProcessingResultsOperationOptions) (ListLifecycleWorkflowUserProcessingResultTaskProcessingResultsCompleteResult, error) {
...
func (c LifecycleWorkflowUserProcessingResultTaskProcessingResultClient) ListLifecycleWorkflowUserProcessingResultTaskProcessingResultsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultId, options ListLifecycleWorkflowUserProcessingResultTaskProcessingResultsOperationOptions, predicate IdentityGovernanceTaskProcessingResultOperationPredicate) (result ListLifecycleWorkflowUserProcessingResultTaskProcessingResultsCompleteResult, err error) {
