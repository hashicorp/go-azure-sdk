...
func (c LifecycleWorkflowUserProcessingResultTaskProcessingResultClient) GetLifecycleWorkflowUserProcessingResultTaskCount(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultId, options GetLifecycleWorkflowUserProcessingResultTaskCountOperationOptions) (result GetLifecycleWorkflowUserProcessingResultTaskCountOperationResponse, err error) {
