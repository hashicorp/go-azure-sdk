...
func (c TermsOfUseAgreementFileClient) CreateTermsOfUseAgreementFile(ctx context.Context, id stable.IdentityGovernanceTermsOfUseAgreementId, input stable.AgreementFileLocalization) (result CreateTermsOfUseAgreementFileOperationResponse, err error) {
