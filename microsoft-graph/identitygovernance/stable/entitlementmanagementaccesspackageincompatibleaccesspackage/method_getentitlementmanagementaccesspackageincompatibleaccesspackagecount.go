...
type GetEntitlementManagementAccessPackageIncompatibleAccessPackageCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetEntitlementManagementAccessPackageIncompatibleAccessPackageCount ...
func (c EntitlementManagementAccessPackageIncompatibleAccessPackageClient) GetEntitlementManagementAccessPackageIncompatibleAccessPackageCount(ctx context.Context, id IdentityGovernanceEntitlementManagementAccessPackageId) (result GetEntitlementManagementAccessPackageIncompatibleAccessPackageCountOperationResponse, err error) {
