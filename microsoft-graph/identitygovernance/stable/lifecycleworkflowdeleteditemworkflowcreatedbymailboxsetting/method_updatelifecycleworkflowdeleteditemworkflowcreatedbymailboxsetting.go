...
func (c LifecycleWorkflowDeletedItemWorkflowCreatedByMailboxSettingClient) UpdateLifecycleWorkflowDeletedItemWorkflowCreatedByMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, input stable.MailboxSettings) (result UpdateLifecycleWorkflowDeletedItemWorkflowCreatedByMailboxSettingOperationResponse, err error) {
