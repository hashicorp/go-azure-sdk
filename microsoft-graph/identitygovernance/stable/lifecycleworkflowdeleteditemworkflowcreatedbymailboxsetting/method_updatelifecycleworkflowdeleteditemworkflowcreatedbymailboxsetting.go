...
func (c LifecycleWorkflowDeletedItemWorkflowCreatedByMailboxSettingClient) UpdateLifecycleWorkflowDeletedItemWorkflowCreatedByMailboxSetting(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, input stable.MailboxSettings) (result UpdateLifecycleWorkflowDeletedItemWorkflowCreatedByMailboxSettingOperationResponse, err error) {
