...
func (c LifecycleWorkflowUserProcessingResultTaskSubjectMailboxSettingClient) GetLifecycleWorkflowUserProcessingResultTaskSubjectMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultIdTaskProcessingResultId, options GetLifecycleWorkflowUserProcessingResultTaskSubjectMailboxSettingOperationOptions) (result GetLifecycleWorkflowUserProcessingResultTaskSubjectMailboxSettingOperationResponse, err error) {
