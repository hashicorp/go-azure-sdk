...
func (c LifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingClient) GetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSetting(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdRunIdTaskProcessingResultId) (result GetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultSubjectMailboxSettingOperationResponse, err error) {
