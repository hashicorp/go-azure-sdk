...
func (c EntitlementManagementClient) UpdateEntitlementManagement(ctx context.Context, input stable.EntitlementManagement) (result UpdateEntitlementManagementOperationResponse, err error) {
