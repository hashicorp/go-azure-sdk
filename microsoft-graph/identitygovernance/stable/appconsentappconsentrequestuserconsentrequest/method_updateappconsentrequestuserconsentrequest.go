...
func (c AppConsentAppConsentRequestUserConsentRequestClient) UpdateAppConsentRequestUserConsentRequest(ctx context.Context, id stable.IdentityGovernanceAppConsentAppConsentRequestIdUserConsentRequestId, input stable.UserConsentRequest) (result UpdateAppConsentRequestUserConsentRequestOperationResponse, err error) {
