...
func (c EntitlementManagementAssignmentPolicyAccessPackageClient) GetEntitlementManagementAssignmentPolicyAccessPackage(ctx context.Context, id IdentityGovernanceEntitlementManagementAssignmentPolicyId) (result GetEntitlementManagementAssignmentPolicyAccessPackageOperationResponse, err error) {
