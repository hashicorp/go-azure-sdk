...
func (c EntitlementManagementAccessPackageResourceRoleScopeScopeResourceClient) CreateEntitlementManagementAccessPackageResourceRoleScopeResourceRefresh(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageIdResourceRoleScopeId, options CreateEntitlementManagementAccessPackageResourceRoleScopeResourceRefreshOperationOptions) (result CreateEntitlementManagementAccessPackageResourceRoleScopeResourceRefreshOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/scope/resource/refresh", id.ID()),
