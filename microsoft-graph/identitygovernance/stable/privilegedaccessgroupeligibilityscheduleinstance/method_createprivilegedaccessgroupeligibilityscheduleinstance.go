...
func (c PrivilegedAccessGroupEligibilityScheduleInstanceClient) CreatePrivilegedAccessGroupEligibilityScheduleInstance(ctx context.Context, input stable.PrivilegedAccessGroupEligibilityScheduleInstance) (result CreatePrivilegedAccessGroupEligibilityScheduleInstanceOperationResponse, err error) {
