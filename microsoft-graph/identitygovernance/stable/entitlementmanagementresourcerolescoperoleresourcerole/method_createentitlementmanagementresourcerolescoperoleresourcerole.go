...
// CreateEntitlementManagementResourceRoleScopeRoleResourceRole ...
func (c EntitlementManagementResourceRoleScopeRoleResourceRoleClient) CreateEntitlementManagementResourceRoleScopeRoleResourceRole(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRoleScopeId, input stable.AccessPackageResourceRole) (result CreateEntitlementManagementResourceRoleScopeRoleResourceRoleOperationResponse, err error) {
