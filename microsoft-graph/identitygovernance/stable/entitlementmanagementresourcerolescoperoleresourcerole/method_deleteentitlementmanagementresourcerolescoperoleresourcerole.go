...
// DeleteEntitlementManagementResourceRoleScopeRoleResourceRole ...
func (c EntitlementManagementResourceRoleScopeRoleResourceRoleClient) DeleteEntitlementManagementResourceRoleScopeRoleResourceRole(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRoleScopeIdRoleResourceRoleId) (result DeleteEntitlementManagementResourceRoleScopeRoleResourceRoleOperationResponse, err error) {
