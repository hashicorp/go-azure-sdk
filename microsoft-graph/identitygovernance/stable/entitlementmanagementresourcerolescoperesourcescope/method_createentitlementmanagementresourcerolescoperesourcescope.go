...
// identityGovernance
func (c EntitlementManagementResourceRoleScopeResourceScopeClient) CreateEntitlementManagementResourceRoleScopeResourceScope(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, input stable.AccessPackageResourceScope) (result CreateEntitlementManagementResourceRoleScopeResourceScopeOperationResponse, err error) {
