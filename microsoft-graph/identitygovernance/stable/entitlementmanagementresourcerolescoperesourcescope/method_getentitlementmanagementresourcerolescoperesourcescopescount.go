...
func (c EntitlementManagementResourceRoleScopeResourceScopeClient) GetEntitlementManagementResourceRoleScopeResourceScopesCount(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, options GetEntitlementManagementResourceRoleScopeResourceScopesCountOperationOptions) (result GetEntitlementManagementResourceRoleScopeResourceScopesCountOperationResponse, err error) {
