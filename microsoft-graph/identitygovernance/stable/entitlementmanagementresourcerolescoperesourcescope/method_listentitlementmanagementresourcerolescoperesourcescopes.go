...
// Supports $expand.
func (c EntitlementManagementResourceRoleScopeResourceScopeClient) ListEntitlementManagementResourceRoleScopeResourceScopes(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, options ListEntitlementManagementResourceRoleScopeResourceScopesOperationOptions) (result ListEntitlementManagementResourceRoleScopeResourceScopesOperationResponse, err error) {
...
func (c EntitlementManagementResourceRoleScopeResourceScopeClient) ListEntitlementManagementResourceRoleScopeResourceScopesCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, options ListEntitlementManagementResourceRoleScopeResourceScopesOperationOptions, predicate AccessPackageResourceScopeOperationPredicate) (result ListEntitlementManagementResourceRoleScopeResourceScopesCompleteResult, err error) {
