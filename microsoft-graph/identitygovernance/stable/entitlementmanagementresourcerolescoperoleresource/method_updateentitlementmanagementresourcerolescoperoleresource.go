...
// identityGovernance
func (c EntitlementManagementResourceRoleScopeRoleResourceClient) UpdateEntitlementManagementResourceRoleScopeRoleResource(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, input stable.AccessPackageResource) (result UpdateEntitlementManagementResourceRoleScopeRoleResourceOperationResponse, err error) {
