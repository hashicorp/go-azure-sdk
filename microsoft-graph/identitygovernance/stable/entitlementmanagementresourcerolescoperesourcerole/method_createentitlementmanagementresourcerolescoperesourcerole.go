...
// identityGovernance
func (c EntitlementManagementResourceRoleScopeResourceRoleClient) CreateEntitlementManagementResourceRoleScopeResourceRole(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, input stable.AccessPackageResourceRole) (result CreateEntitlementManagementResourceRoleScopeResourceRoleOperationResponse, err error) {
