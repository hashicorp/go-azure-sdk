...
// GetEntitlementManagementResourceRequestCatalogResourceScopeResource ...
func (c EntitlementManagementResourceRequestCatalogResourceScopeResourceClient) GetEntitlementManagementResourceRequestCatalogResourceScopeResource(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdCatalogResourceScopeId) (result GetEntitlementManagementResourceRequestCatalogResourceScopeResourceOperationResponse, err error) {
