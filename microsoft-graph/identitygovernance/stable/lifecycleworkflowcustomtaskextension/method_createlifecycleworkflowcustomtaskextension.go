...
// CreateLifecycleWorkflowCustomTaskExtension ...
func (c LifecycleWorkflowCustomTaskExtensionClient) CreateLifecycleWorkflowCustomTaskExtension(ctx context.Context, input stable.IdentityGovernanceCustomTaskExtension) (result CreateLifecycleWorkflowCustomTaskExtensionOperationResponse, err error) {
