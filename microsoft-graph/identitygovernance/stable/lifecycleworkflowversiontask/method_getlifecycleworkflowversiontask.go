...
func (c LifecycleWorkflowVersionTaskClient) GetLifecycleWorkflowVersionTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskId, options GetLifecycleWorkflowVersionTaskOperationOptions) (result GetLifecycleWorkflowVersionTaskOperationResponse, err error) {
