...
// GetEntitlementManagementResourceRequestCatalogResourceScopeResourceRoleResourceEnvironment ...
func (c EntitlementManagementResourceRequestCatalogResourceScopeResourceRoleResourceEnvironmentClient) GetEntitlementManagementResourceRequestCatalogResourceScopeResourceRoleResourceEnvironment(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdCatalogResourceIdScopeIdResourceRoleId) (result GetEntitlementManagementResourceRequestCatalogResourceScopeResourceRoleResourceEnvironmentOperationResponse, err error) {
