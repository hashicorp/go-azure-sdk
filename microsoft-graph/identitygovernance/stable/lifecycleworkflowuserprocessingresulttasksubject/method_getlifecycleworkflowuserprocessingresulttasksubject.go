...
func (c LifecycleWorkflowUserProcessingResultTaskSubjectClient) GetLifecycleWorkflowUserProcessingResultTaskSubject(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultIdTaskProcessingResultId, options GetLifecycleWorkflowUserProcessingResultTaskSubjectOperationOptions) (result GetLifecycleWorkflowUserProcessingResultTaskSubjectOperationResponse, err error) {
