...
func (c LifecycleWorkflowUserProcessingResultClient) ListLifecycleWorkflowUserProcessingResultsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowUserProcessingResultsOperationOptions) (ListLifecycleWorkflowUserProcessingResultsCompleteResult, error) {
...
func (c LifecycleWorkflowUserProcessingResultClient) ListLifecycleWorkflowUserProcessingResultsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowUserProcessingResultsOperationOptions, predicate IdentityGovernanceUserProcessingResultOperationPredicate) (result ListLifecycleWorkflowUserProcessingResultsCompleteResult, err error) {
