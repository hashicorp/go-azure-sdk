...
func (c LifecycleWorkflowCreatedByClient) GetLifecycleWorkflowCreatedBy(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowCreatedByOperationOptions) (result GetLifecycleWorkflowCreatedByOperationResponse, err error) {
