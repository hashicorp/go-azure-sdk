...
// GetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultTask ...
func (c LifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultTaskClient) GetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultTask(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdRunIdTaskProcessingResultId) (result GetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultTaskOperationResponse, err error) {
