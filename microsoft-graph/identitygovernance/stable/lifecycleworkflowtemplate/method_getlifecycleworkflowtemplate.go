...
// object.
func (c LifecycleWorkflowTemplateClient) GetLifecycleWorkflowTemplate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowTemplateId, options GetLifecycleWorkflowTemplateOperationOptions) (result GetLifecycleWorkflowTemplateOperationResponse, err error) {
