package lifecycleworkflowtemplate
...
// properties.
func (c LifecycleWorkflowTemplateClient) ListLifecycleWorkflowTemplates(ctx context.Context, options ListLifecycleWorkflowTemplatesOperationOptions) (result ListLifecycleWorkflowTemplatesOperationResponse, err error) {
...
func (c LifecycleWorkflowTemplateClient) ListLifecycleWorkflowTemplatesComplete(ctx context.Context, options ListLifecycleWorkflowTemplatesOperationOptions) (ListLifecycleWorkflowTemplatesCompleteResult, error) {
...
func (c LifecycleWorkflowTemplateClient) ListLifecycleWorkflowTemplatesCompleteMatchingPredicate(ctx context.Context, options ListLifecycleWorkflowTemplatesOperationOptions, predicate IdentityGovernanceWorkflowTemplateOperationPredicate) (result ListLifecycleWorkflowTemplatesCompleteResult, err error) {
