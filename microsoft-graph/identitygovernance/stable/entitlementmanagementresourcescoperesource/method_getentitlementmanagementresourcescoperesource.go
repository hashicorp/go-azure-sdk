...
func (c EntitlementManagementResourceScopeResourceClient) GetEntitlementManagementResourceScopeResource(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceIdScopeId) (result GetEntitlementManagementResourceScopeResourceOperationResponse, err error) {
