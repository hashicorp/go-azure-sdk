...
func (c EntitlementManagementAccessPackageResourceRoleScopeRoleResourceRoleClient) UpdateEntitlementManagementAccessPackageResourceRoleScopeRoleResourceRole(ctx context.Context, id IdentityGovernanceEntitlementManagementAccessPackageIdResourceRoleScopeIdRoleResourceRoleId, input stable.AccessPackageResourceRole) (result UpdateEntitlementManagementAccessPackageResourceRoleScopeRoleResourceRoleOperationResponse, err error) {
