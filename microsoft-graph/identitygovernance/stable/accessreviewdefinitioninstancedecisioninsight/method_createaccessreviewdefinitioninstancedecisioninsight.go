...
// CreateAccessReviewDefinitionInstanceDecisionInsight ...
func (c AccessReviewDefinitionInstanceDecisionInsightClient) CreateAccessReviewDefinitionInstanceDecisionInsight(ctx context.Context, id IdentityGovernanceAccessReviewDefinitionIdInstanceIdDecisionId, input stable.GovernanceInsight) (result CreateAccessReviewDefinitionInstanceDecisionInsightOperationResponse, err error) {
