...
func (c EntitlementManagementResourceEnvironmentResourceScopeResourceRoleResourceClient) GetEntitlementManagementResourceEnvironmentResourceScopeResourceRoleResource(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceEnvironmentIdResourceIdScopeIdResourceRoleId) (result GetEntitlementManagementResourceEnvironmentResourceScopeResourceRoleResourceOperationResponse, err error) {
