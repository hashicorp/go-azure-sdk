...
func (c EntitlementManagementAccessPackageAssignmentPolicyAccessPackageClient) GetEntitlementManagementAccessPackageAssignmentPolicyAccessPackage(ctx context.Context, id IdentityGovernanceEntitlementManagementAccessPackageIdAssignmentPolicyId) (result GetEntitlementManagementAccessPackageAssignmentPolicyAccessPackageOperationResponse, err error) {
