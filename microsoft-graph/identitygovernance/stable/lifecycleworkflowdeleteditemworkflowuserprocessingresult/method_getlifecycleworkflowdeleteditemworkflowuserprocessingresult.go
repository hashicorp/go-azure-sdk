...
// GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResult ...
func (c LifecycleWorkflowDeletedItemWorkflowUserProcessingResultClient) GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResult(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdUserProcessingResultId) (result GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultOperationResponse, err error) {
