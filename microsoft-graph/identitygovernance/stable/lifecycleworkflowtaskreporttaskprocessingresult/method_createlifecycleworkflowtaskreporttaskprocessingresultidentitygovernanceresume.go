...
func (c LifecycleWorkflowTaskReportTaskProcessingResultClient) CreateLifecycleWorkflowTaskReportTaskProcessingResultIdentityGovernanceResume(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskReportIdTaskProcessingResultId, input CreateLifecycleWorkflowTaskReportTaskProcessingResultIdentityGovernanceResumeRequest) (result CreateLifecycleWorkflowTaskReportTaskProcessingResultIdentityGovernanceResumeOperationResponse, err error) {
