...
// GetEntitlementManagementResourceRoleScope - Get scope from identityGovernance
func (c EntitlementManagementResourceRoleScopeScopeClient) GetEntitlementManagementResourceRoleScope(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, options GetEntitlementManagementResourceRoleScopeOperationOptions) (result GetEntitlementManagementResourceRoleScopeOperationResponse, err error) {
