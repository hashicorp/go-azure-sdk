...
func (c LifecycleWorkflowTaskClient) GetLifecycleWorkflowTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskId, options GetLifecycleWorkflowTaskOperationOptions) (result GetLifecycleWorkflowTaskOperationResponse, err error) {
