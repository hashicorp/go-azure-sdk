...
func (c LifecycleWorkflowTaskClient) DeleteLifecycleWorkflowTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskId, options DeleteLifecycleWorkflowTaskOperationOptions) (result DeleteLifecycleWorkflowTaskOperationResponse, err error) {
