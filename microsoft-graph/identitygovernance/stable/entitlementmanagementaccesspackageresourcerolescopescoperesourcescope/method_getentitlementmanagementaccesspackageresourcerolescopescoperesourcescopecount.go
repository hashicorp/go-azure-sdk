...
type GetEntitlementManagementAccessPackageResourceRoleScopeScopeResourceScopeCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetEntitlementManagementAccessPackageResourceRoleScopeScopeResourceScopeCount ...
func (c EntitlementManagementAccessPackageResourceRoleScopeScopeResourceScopeClient) GetEntitlementManagementAccessPackageResourceRoleScopeScopeResourceScopeCount(ctx context.Context, id IdentityGovernanceEntitlementManagementAccessPackageIdResourceRoleScopeId) (result GetEntitlementManagementAccessPackageResourceRoleScopeScopeResourceScopeCountOperationResponse, err error) {
