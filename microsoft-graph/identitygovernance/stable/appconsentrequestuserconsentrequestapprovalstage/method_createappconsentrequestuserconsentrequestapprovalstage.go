...
// identityGovernance
func (c AppConsentRequestUserConsentRequestApprovalStageClient) CreateAppConsentRequestUserConsentRequestApprovalStage(ctx context.Context, id stable.IdentityGovernanceAppConsentAppConsentRequestIdUserConsentRequestId, input stable.ApprovalStage) (result CreateAppConsentRequestUserConsentRequestApprovalStageOperationResponse, err error) {
