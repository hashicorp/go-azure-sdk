...
// UpdateLifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSetting ...
func (c LifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSettingClient) UpdateLifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSetting(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdVersionId, input stable.MailboxSettings) (result UpdateLifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSettingOperationResponse, err error) {
