...
func (c LifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSettingClient) UpdateLifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdVersionId, input stable.MailboxSettings) (result UpdateLifecycleWorkflowDeletedItemWorkflowVersionCreatedByMailboxSettingOperationResponse, err error) {
