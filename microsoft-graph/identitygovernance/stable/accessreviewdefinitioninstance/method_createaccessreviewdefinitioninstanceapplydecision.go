...
// call this method.
func (c AccessReviewDefinitionInstanceClient) CreateAccessReviewDefinitionInstanceApplyDecision(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId) (result CreateAccessReviewDefinitionInstanceApplyDecisionOperationResponse, err error) {
