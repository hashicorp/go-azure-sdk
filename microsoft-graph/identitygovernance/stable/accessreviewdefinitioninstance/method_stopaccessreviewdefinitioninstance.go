...
func (c AccessReviewDefinitionInstanceClient) StopAccessReviewDefinitionInstance(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId) (result StopAccessReviewDefinitionInstanceOperationResponse, err error) {
