...
func (c AccessReviewDefinitionInstanceClient) UpdateAccessReviewDefinitionInstance(ctx context.Context, id stable.IdentityGovernanceAccessReviewDefinitionIdInstanceId, input stable.AccessReviewInstance) (result UpdateAccessReviewDefinitionInstanceOperationResponse, err error) {
