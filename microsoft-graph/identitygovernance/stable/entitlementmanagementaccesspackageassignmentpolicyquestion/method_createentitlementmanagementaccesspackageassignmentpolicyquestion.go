...
// CreateEntitlementManagementAccessPackageAssignmentPolicyQuestion ...
func (c EntitlementManagementAccessPackageAssignmentPolicyQuestionClient) CreateEntitlementManagementAccessPackageAssignmentPolicyQuestion(ctx context.Context, id IdentityGovernanceEntitlementManagementAccessPackageIdAssignmentPolicyId, input stable.AccessPackageQuestion) (result CreateEntitlementManagementAccessPackageAssignmentPolicyQuestionOperationResponse, err error) {
