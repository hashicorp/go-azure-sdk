...
func (c EntitlementManagementAccessPackageAssignmentPolicyQuestionClient) ListEntitlementManagementAccessPackageAssignmentPolicyQuestionsComplete(ctx context.Context, id IdentityGovernanceEntitlementManagementAccessPackageIdAssignmentPolicyId) (ListEntitlementManagementAccessPackageAssignmentPolicyQuestionsCompleteResult, error) {
	return c.ListEntitlementManagementAccessPackageAssignmentPolicyQuestionsCompleteMatchingPredicate(ctx, id, AccessPackageQuestionOperationPredicate{})
}
