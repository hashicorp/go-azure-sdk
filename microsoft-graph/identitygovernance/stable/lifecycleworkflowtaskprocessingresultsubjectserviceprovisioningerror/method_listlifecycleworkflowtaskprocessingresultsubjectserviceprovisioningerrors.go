...
func (c LifecycleWorkflowTaskProcessingResultSubjectServiceProvisioningErrorClient) ListLifecycleWorkflowTaskProcessingResultSubjectServiceProvisioningErrorsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskIdTaskProcessingResultId, options ListLifecycleWorkflowTaskProcessingResultSubjectServiceProvisioningErrorsOperationOptions) (ListLifecycleWorkflowTaskProcessingResultSubjectServiceProvisioningErrorsCompleteResult, error) {
...
func (c LifecycleWorkflowTaskProcessingResultSubjectServiceProvisioningErrorClient) ListLifecycleWorkflowTaskProcessingResultSubjectServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskIdTaskProcessingResultId, options ListLifecycleWorkflowTaskProcessingResultSubjectServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListLifecycleWorkflowTaskProcessingResultSubjectServiceProvisioningErrorsCompleteResult, err error) {
