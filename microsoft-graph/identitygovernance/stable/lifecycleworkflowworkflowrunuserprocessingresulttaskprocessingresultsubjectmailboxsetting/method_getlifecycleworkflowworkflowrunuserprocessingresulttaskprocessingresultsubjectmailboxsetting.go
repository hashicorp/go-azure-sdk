...
type GetLifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultSubjectMailboxSettingOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.MailboxSettings
}

// GetLifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultSubjectMailboxSetting ...
func (c LifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultSubjectMailboxSettingClient) GetLifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultSubjectMailboxSetting(ctx context.Context, id IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultIdTaskProcessingResultId) (result GetLifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultSubjectMailboxSettingOperationResponse, err error) {
