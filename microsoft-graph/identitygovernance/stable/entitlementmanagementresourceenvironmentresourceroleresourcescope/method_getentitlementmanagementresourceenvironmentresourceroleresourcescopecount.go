...
type GetEntitlementManagementResourceEnvironmentResourceRoleResourceScopeCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetEntitlementManagementResourceEnvironmentResourceRoleResourceScopeCount ...
func (c EntitlementManagementResourceEnvironmentResourceRoleResourceScopeClient) GetEntitlementManagementResourceEnvironmentResourceRoleResourceScopeCount(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceEnvironmentIdResourceIdRoleId) (result GetEntitlementManagementResourceEnvironmentResourceRoleResourceScopeCountOperationResponse, err error) {
