...
// GetEntitlementManagementResourceEnvironmentResourceRoleResourceScope ...
func (c EntitlementManagementResourceEnvironmentResourceRoleResourceScopeClient) GetEntitlementManagementResourceEnvironmentResourceRoleResourceScope(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceEnvironmentIdResourceIdRoleIdResourceScopeId) (result GetEntitlementManagementResourceEnvironmentResourceRoleResourceScopeOperationResponse, err error) {
