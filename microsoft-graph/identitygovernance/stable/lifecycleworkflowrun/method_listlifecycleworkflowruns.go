...
func (c LifecycleWorkflowRunClient) ListLifecycleWorkflowRuns(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowRunsOperationOptions) (result ListLifecycleWorkflowRunsOperationResponse, err error) {
...
func (c LifecycleWorkflowRunClient) ListLifecycleWorkflowRunsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowRunsOperationOptions) (ListLifecycleWorkflowRunsCompleteResult, error) {
...
func (c LifecycleWorkflowRunClient) ListLifecycleWorkflowRunsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowRunsOperationOptions, predicate IdentityGovernanceRunOperationPredicate) (result ListLifecycleWorkflowRunsCompleteResult, err error) {
