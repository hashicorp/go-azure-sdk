...
// AddEntitlementManagementConnectedOrganizationInternalSponsorRef ...
func (c EntitlementManagementConnectedOrganizationInternalSponsorClient) AddEntitlementManagementConnectedOrganizationInternalSponsorRef(ctx context.Context, id IdentityGovernanceEntitlementManagementConnectedOrganizationId, input stable.ReferenceCreate) (result AddEntitlementManagementConnectedOrganizationInternalSponsorRefOperationResponse, err error) {
