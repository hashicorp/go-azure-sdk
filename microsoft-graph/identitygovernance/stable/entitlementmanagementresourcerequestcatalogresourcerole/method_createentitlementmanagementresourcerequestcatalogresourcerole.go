...
func (c EntitlementManagementResourceRequestCatalogResourceRoleClient) CreateEntitlementManagementResourceRequestCatalogResourceRole(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestId, input stable.AccessPackageResourceRole) (result CreateEntitlementManagementResourceRequestCatalogResourceRoleOperationResponse, err error) {
