...
func (c EntitlementManagementAccessPackageIncompatibleWithClient) GetEntitlementManagementAccessPackageIncompatibleWithCount(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageId, options GetEntitlementManagementAccessPackageIncompatibleWithCountOperationOptions) (result GetEntitlementManagementAccessPackageIncompatibleWithCountOperationResponse, err error) {
