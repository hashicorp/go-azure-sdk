...
func (c EntitlementManagementCatalogCustomWorkflowExtensionClient) DeleteEntitlementManagementCatalogCustomWorkflowExtension(ctx context.Context, id IdentityGovernanceEntitlementManagementCatalogIdCustomWorkflowExtensionId) (result DeleteEntitlementManagementCatalogCustomWorkflowExtensionOperationResponse, err error) {
