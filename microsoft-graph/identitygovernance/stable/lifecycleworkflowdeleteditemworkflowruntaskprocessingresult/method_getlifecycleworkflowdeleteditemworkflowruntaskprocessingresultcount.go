...
type GetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultCount ...
func (c LifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultClient) GetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultCount(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdRunId) (result GetLifecycleWorkflowDeletedItemWorkflowRunTaskProcessingResultCountOperationResponse, err error) {
