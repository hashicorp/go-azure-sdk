...
func (c LifecycleWorkflowRunUserProcessingResultClient) ListLifecycleWorkflowRunUserProcessingResultsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options ListLifecycleWorkflowRunUserProcessingResultsOperationOptions) (ListLifecycleWorkflowRunUserProcessingResultsCompleteResult, error) {
