...
// GetEntitlementManagementResourceScopeResourceRoleResourceEnvironment ...
func (c EntitlementManagementResourceScopeResourceRoleResourceEnvironmentClient) GetEntitlementManagementResourceScopeResourceRoleResourceEnvironment(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceIdScopeIdResourceRoleId) (result GetEntitlementManagementResourceScopeResourceRoleResourceEnvironmentOperationResponse, err error) {
