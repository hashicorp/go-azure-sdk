...
type GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingCount ...
func (c EntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingClient) GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingCount(ctx context.Context, id IdentityGovernanceEntitlementManagementAccessPackageIdAssignmentPolicyId) (result GetEntitlementManagementAccessPackageAssignmentPolicyCustomExtensionStageSettingCountOperationResponse, err error) {
