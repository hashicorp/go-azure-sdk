...
// CreateEntitlementManagementCatalogResourceScopeResourceScope ...
func (c EntitlementManagementCatalogResourceScopeResourceScopeClient) CreateEntitlementManagementCatalogResourceScopeResourceScope(ctx context.Context, id IdentityGovernanceEntitlementManagementCatalogIdResourceScopeId, input stable.AccessPackageResourceScope) (result CreateEntitlementManagementCatalogResourceScopeResourceScopeOperationResponse, err error) {
