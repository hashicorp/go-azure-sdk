...
// GetEntitlementManagementResourceRoleScopeRoleResourceScopeResource ...
func (c EntitlementManagementResourceRoleScopeRoleResourceScopeResourceClient) GetEntitlementManagementResourceRoleScopeRoleResourceScopeResource(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRoleScopeIdRoleResourceScopeId) (result GetEntitlementManagementResourceRoleScopeRoleResourceScopeResourceOperationResponse, err error) {
