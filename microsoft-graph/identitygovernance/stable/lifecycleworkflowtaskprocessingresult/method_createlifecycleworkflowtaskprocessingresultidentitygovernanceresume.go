...
func (c LifecycleWorkflowTaskProcessingResultClient) CreateLifecycleWorkflowTaskProcessingResultIdentityGovernanceResume(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskIdTaskProcessingResultId, input CreateLifecycleWorkflowTaskProcessingResultIdentityGovernanceResumeRequest) (result CreateLifecycleWorkflowTaskProcessingResultIdentityGovernanceResumeOperationResponse, err error) {
