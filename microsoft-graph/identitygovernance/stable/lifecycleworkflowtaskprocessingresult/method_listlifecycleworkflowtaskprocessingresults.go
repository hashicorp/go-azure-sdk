...
// processing the task.
func (c LifecycleWorkflowTaskProcessingResultClient) ListLifecycleWorkflowTaskProcessingResults(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskId, options ListLifecycleWorkflowTaskProcessingResultsOperationOptions) (result ListLifecycleWorkflowTaskProcessingResultsOperationResponse, err error) {
...
func (c LifecycleWorkflowTaskProcessingResultClient) ListLifecycleWorkflowTaskProcessingResultsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskId, options ListLifecycleWorkflowTaskProcessingResultsOperationOptions) (ListLifecycleWorkflowTaskProcessingResultsCompleteResult, error) {
