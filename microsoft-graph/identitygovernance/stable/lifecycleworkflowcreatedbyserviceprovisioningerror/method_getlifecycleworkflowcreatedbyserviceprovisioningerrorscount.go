...
func (c LifecycleWorkflowCreatedByServiceProvisioningErrorClient) GetLifecycleWorkflowCreatedByServiceProvisioningErrorsCount(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowCreatedByServiceProvisioningErrorsCountOperationOptions) (result GetLifecycleWorkflowCreatedByServiceProvisioningErrorsCountOperationResponse, err error) {
