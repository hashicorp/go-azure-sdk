...
// GetEntitlementManagementResourceEnvironmentResourceRoleResourceScopeResource ...
func (c EntitlementManagementResourceEnvironmentResourceRoleResourceScopeResourceClient) GetEntitlementManagementResourceEnvironmentResourceRoleResourceScopeResource(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceEnvironmentIdResourceIdRoleIdResourceScopeId) (result GetEntitlementManagementResourceEnvironmentResourceRoleResourceScopeResourceOperationResponse, err error) {
