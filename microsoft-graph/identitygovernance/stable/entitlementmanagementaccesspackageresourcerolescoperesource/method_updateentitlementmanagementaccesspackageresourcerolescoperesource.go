...
// identityGovernance
func (c EntitlementManagementAccessPackageResourceRoleScopeResourceClient) UpdateEntitlementManagementAccessPackageResourceRoleScopeResource(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementAccessPackageIdResourceRoleScopeId, input stable.AccessPackageResource) (result UpdateEntitlementManagementAccessPackageResourceRoleScopeResourceOperationResponse, err error) {
