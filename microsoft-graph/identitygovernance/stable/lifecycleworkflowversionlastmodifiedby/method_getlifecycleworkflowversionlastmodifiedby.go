...
func (c LifecycleWorkflowVersionLastModifiedByClient) GetLifecycleWorkflowVersionLastModifiedBy(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options GetLifecycleWorkflowVersionLastModifiedByOperationOptions) (result GetLifecycleWorkflowVersionLastModifiedByOperationResponse, err error) {
