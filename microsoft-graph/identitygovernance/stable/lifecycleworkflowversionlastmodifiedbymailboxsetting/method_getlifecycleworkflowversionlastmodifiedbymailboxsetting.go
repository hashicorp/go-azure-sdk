...
func (c LifecycleWorkflowVersionLastModifiedByMailboxSettingClient) GetLifecycleWorkflowVersionLastModifiedByMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options GetLifecycleWorkflowVersionLastModifiedByMailboxSettingOperationOptions) (result GetLifecycleWorkflowVersionLastModifiedByMailboxSettingOperationResponse, err error) {
