...
func (c EntitlementManagementAssignmentPolicyQuestionClient) UpdateEntitlementManagementAssignmentPolicyQuestion(ctx context.Context, id IdentityGovernanceEntitlementManagementAssignmentPolicyIdQuestionId, input stable.AccessPackageQuestion) (result UpdateEntitlementManagementAssignmentPolicyQuestionOperationResponse, err error) {
