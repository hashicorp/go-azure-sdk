...
func (c EntitlementManagementResourceRoleScopeResourceClient) GetEntitlementManagementResourceRoleScopeResource(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeIdScopeResourceRoleId, options GetEntitlementManagementResourceRoleScopeResourceOperationOptions) (result GetEntitlementManagementResourceRoleScopeResourceOperationResponse, err error) {
