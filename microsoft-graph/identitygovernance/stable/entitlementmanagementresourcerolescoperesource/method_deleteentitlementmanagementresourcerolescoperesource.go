...
func (c EntitlementManagementResourceRoleScopeResourceClient) DeleteEntitlementManagementResourceRoleScopeResource(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeIdScopeResourceRoleId, options DeleteEntitlementManagementResourceRoleScopeResourceOperationOptions) (result DeleteEntitlementManagementResourceRoleScopeResourceOperationResponse, err error) {
