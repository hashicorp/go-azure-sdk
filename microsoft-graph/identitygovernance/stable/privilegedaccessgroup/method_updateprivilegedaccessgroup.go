...
func (c PrivilegedAccessGroupClient) UpdatePrivilegedAccessGroup(ctx context.Context, input stable.PrivilegedAccessGroup) (result UpdatePrivilegedAccessGroupOperationResponse, err error) {
