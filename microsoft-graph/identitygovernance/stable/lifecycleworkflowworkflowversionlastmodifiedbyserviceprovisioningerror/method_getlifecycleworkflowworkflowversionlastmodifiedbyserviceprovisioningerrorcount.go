...
type GetLifecycleWorkflowWorkflowVersionLastModifiedByServiceProvisioningErrorCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetLifecycleWorkflowWorkflowVersionLastModifiedByServiceProvisioningErrorCount ...
func (c LifecycleWorkflowWorkflowVersionLastModifiedByServiceProvisioningErrorClient) GetLifecycleWorkflowWorkflowVersionLastModifiedByServiceProvisioningErrorCount(ctx context.Context, id IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId) (result GetLifecycleWorkflowWorkflowVersionLastModifiedByServiceProvisioningErrorCountOperationResponse, err error) {
