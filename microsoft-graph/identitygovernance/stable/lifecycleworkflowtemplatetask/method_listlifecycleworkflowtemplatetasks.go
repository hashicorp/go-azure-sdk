...
func (c LifecycleWorkflowTemplateTaskClient) ListLifecycleWorkflowTemplateTasks(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowTemplateId, options ListLifecycleWorkflowTemplateTasksOperationOptions) (result ListLifecycleWorkflowTemplateTasksOperationResponse, err error) {
...
func (c LifecycleWorkflowTemplateTaskClient) ListLifecycleWorkflowTemplateTasksComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowTemplateId, options ListLifecycleWorkflowTemplateTasksOperationOptions) (ListLifecycleWorkflowTemplateTasksCompleteResult, error) {
