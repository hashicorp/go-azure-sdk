...
// value.
func (c LifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByMailboxSettingClient) UpdateLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdVersionId, input stable.MailboxSettings) (result UpdateLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByMailboxSettingOperationResponse, err error) {
