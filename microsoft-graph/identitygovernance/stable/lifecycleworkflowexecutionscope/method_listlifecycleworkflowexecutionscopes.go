...
func (c LifecycleWorkflowExecutionScopeClient) ListLifecycleWorkflowExecutionScopes(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowExecutionScopesOperationOptions) (result ListLifecycleWorkflowExecutionScopesOperationResponse, err error) {
...
func (c LifecycleWorkflowExecutionScopeClient) ListLifecycleWorkflowExecutionScopesComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowExecutionScopesOperationOptions) (ListLifecycleWorkflowExecutionScopesCompleteResult, error) {
...
func (c LifecycleWorkflowExecutionScopeClient) ListLifecycleWorkflowExecutionScopesCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowExecutionScopesOperationOptions, predicate IdentityGovernanceUserProcessingResultOperationPredicate) (result ListLifecycleWorkflowExecutionScopesCompleteResult, err error) {
