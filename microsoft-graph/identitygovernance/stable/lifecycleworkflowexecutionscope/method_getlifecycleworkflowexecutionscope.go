...
func (c LifecycleWorkflowExecutionScopeClient) GetLifecycleWorkflowExecutionScope(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdExecutionScopeId, options GetLifecycleWorkflowExecutionScopeOperationOptions) (result GetLifecycleWorkflowExecutionScopeOperationResponse, err error) {
