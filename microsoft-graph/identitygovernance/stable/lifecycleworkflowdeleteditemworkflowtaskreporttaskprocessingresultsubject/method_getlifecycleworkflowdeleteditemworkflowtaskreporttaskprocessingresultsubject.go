...
func (c LifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultSubjectClient) GetLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultSubject(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdTaskReportIdTaskProcessingResultId) (result GetLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultSubjectOperationResponse, err error) {
