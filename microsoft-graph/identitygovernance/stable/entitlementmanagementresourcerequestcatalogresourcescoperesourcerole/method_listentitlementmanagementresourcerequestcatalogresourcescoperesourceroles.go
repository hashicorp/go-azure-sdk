...
func (c EntitlementManagementResourceRequestCatalogResourceScopeResourceRoleClient) ListEntitlementManagementResourceRequestCatalogResourceScopeResourceRoles(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdCatalogResourceIdScopeId) (result ListEntitlementManagementResourceRequestCatalogResourceScopeResourceRolesOperationResponse, err error) {
...
func (c EntitlementManagementResourceRequestCatalogResourceScopeResourceRoleClient) ListEntitlementManagementResourceRequestCatalogResourceScopeResourceRolesComplete(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdCatalogResourceIdScopeId) (ListEntitlementManagementResourceRequestCatalogResourceScopeResourceRolesCompleteResult, error) {
	return c.ListEntitlementManagementResourceRequestCatalogResourceScopeResourceRolesCompleteMatchingPredicate(ctx, id, AccessPackageResourceRoleOperationPredicate{})
}
...
func (c EntitlementManagementResourceRequestCatalogResourceScopeResourceRoleClient) ListEntitlementManagementResourceRequestCatalogResourceScopeResourceRolesCompleteMatchingPredicate(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdCatalogResourceIdScopeId, predicate AccessPackageResourceRoleOperationPredicate) (result ListEntitlementManagementResourceRequestCatalogResourceScopeResourceRolesCompleteResult, err error) {
	items := make([]stable.AccessPackageResourceRole, 0)

	resp, err := c.ListEntitlementManagementResourceRequestCatalogResourceScopeResourceRoles(ctx, id)
	if err != nil {
