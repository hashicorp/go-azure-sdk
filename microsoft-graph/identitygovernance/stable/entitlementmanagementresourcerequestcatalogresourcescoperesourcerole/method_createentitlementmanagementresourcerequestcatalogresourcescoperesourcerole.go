...
func (c EntitlementManagementResourceRequestCatalogResourceScopeResourceRoleClient) CreateEntitlementManagementResourceRequestCatalogResourceScopeResourceRole(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdCatalogResourceIdScopeId, input stable.AccessPackageResourceRole) (result CreateEntitlementManagementResourceRequestCatalogResourceScopeResourceRoleOperationResponse, err error) {
