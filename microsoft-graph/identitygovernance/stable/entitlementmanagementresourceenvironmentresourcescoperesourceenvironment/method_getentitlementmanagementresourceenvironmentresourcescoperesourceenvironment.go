...
// GetEntitlementManagementResourceEnvironmentResourceScopeResourceEnvironment ...
func (c EntitlementManagementResourceEnvironmentResourceScopeResourceEnvironmentClient) GetEntitlementManagementResourceEnvironmentResourceScopeResourceEnvironment(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceEnvironmentIdResourceIdScopeId) (result GetEntitlementManagementResourceEnvironmentResourceScopeResourceEnvironmentOperationResponse, err error) {
