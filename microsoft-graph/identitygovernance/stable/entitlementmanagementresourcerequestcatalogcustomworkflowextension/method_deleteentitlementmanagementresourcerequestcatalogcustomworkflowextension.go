...
// DeleteEntitlementManagementResourceRequestCatalogCustomWorkflowExtension ...
func (c EntitlementManagementResourceRequestCatalogCustomWorkflowExtensionClient) DeleteEntitlementManagementResourceRequestCatalogCustomWorkflowExtension(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdCatalogCustomWorkflowExtensionId) (result DeleteEntitlementManagementResourceRequestCatalogCustomWorkflowExtensionOperationResponse, err error) {
