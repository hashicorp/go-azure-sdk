...
func (c LifecycleWorkflowWorkflowVersionTaskClient) CreateLifecycleWorkflowVersionTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, input stable.IdentityGovernanceTask) (result CreateLifecycleWorkflowVersionTaskOperationResponse, err error) {
