...
type GetPrivilegedAccesGroupAssignmentScheduleGroupServiceProvisioningErrorCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetPrivilegedAccesGroupAssignmentScheduleGroupServiceProvisioningErrorCount ...
func (c PrivilegedAccesGroupAssignmentScheduleGroupServiceProvisioningErrorClient) GetPrivilegedAccesGroupAssignmentScheduleGroupServiceProvisioningErrorCount(ctx context.Context, id IdentityGovernancePrivilegedAccesGroupAssignmentScheduleId) (result GetPrivilegedAccesGroupAssignmentScheduleGroupServiceProvisioningErrorCountOperationResponse, err error) {
