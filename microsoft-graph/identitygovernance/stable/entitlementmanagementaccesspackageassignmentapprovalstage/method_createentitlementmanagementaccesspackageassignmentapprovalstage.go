...
// CreateEntitlementManagementAccessPackageAssignmentApprovalStage ...
func (c EntitlementManagementAccessPackageAssignmentApprovalStageClient) CreateEntitlementManagementAccessPackageAssignmentApprovalStage(ctx context.Context, id IdentityGovernanceEntitlementManagementAccessPackageAssignmentApprovalId, input stable.ApprovalStage) (result CreateEntitlementManagementAccessPackageAssignmentApprovalStageOperationResponse, err error) {
