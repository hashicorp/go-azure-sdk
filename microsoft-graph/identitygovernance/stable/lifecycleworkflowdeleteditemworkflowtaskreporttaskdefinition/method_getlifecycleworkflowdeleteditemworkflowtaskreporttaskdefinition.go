...
// GetLifecycleWorkflowDeletedItemWorkflowTaskReportTaskDefinition ...
func (c LifecycleWorkflowDeletedItemWorkflowTaskReportTaskDefinitionClient) GetLifecycleWorkflowDeletedItemWorkflowTaskReportTaskDefinition(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdTaskReportId) (result GetLifecycleWorkflowDeletedItemWorkflowTaskReportTaskDefinitionOperationResponse, err error) {
