...
type GetLifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultSubjectServiceProvisioningErrorCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetLifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultSubjectServiceProvisioningErrorCount ...
func (c LifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultSubjectServiceProvisioningErrorClient) GetLifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultSubjectServiceProvisioningErrorCount(ctx context.Context, id IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultIdTaskProcessingResultId) (result GetLifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultSubjectServiceProvisioningErrorCountOperationResponse, err error) {
