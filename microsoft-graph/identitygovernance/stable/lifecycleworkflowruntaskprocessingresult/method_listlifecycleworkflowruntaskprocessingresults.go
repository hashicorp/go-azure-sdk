...
// for a run.
func (c LifecycleWorkflowRunTaskProcessingResultClient) ListLifecycleWorkflowRunTaskProcessingResults(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options ListLifecycleWorkflowRunTaskProcessingResultsOperationOptions) (result ListLifecycleWorkflowRunTaskProcessingResultsOperationResponse, err error) {
...
func (c LifecycleWorkflowRunTaskProcessingResultClient) ListLifecycleWorkflowRunTaskProcessingResultsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options ListLifecycleWorkflowRunTaskProcessingResultsOperationOptions) (ListLifecycleWorkflowRunTaskProcessingResultsCompleteResult, error) {
