...
// UpdateEntitlementManagementCatalogResourceRoleResourceScope ...
func (c EntitlementManagementCatalogResourceRoleResourceScopeClient) UpdateEntitlementManagementCatalogResourceRoleResourceScope(ctx context.Context, id IdentityGovernanceEntitlementManagementCatalogIdResourceIdRoleIdResourceScopeId, input stable.AccessPackageResourceScope) (result UpdateEntitlementManagementCatalogResourceRoleResourceScopeOperationResponse, err error) {
