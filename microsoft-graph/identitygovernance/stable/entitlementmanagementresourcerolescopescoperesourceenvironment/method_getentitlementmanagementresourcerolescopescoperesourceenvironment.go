...
type GetEntitlementManagementResourceRoleScopeScopeResourceEnvironmentOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.AccessPackageResourceEnvironment
}

// GetEntitlementManagementResourceRoleScopeScopeResourceEnvironment ...
func (c EntitlementManagementResourceRoleScopeScopeResourceEnvironmentClient) GetEntitlementManagementResourceRoleScopeScopeResourceEnvironment(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRoleScopeId) (result GetEntitlementManagementResourceRoleScopeScopeResourceEnvironmentOperationResponse, err error) {
