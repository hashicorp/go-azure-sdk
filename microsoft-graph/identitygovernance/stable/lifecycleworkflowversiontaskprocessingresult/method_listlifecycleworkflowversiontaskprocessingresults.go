...
// processing the task.
func (c LifecycleWorkflowVersionTaskProcessingResultClient) ListLifecycleWorkflowVersionTaskProcessingResults(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskId, options ListLifecycleWorkflowVersionTaskProcessingResultsOperationOptions) (result ListLifecycleWorkflowVersionTaskProcessingResultsOperationResponse, err error) {
...
func (c LifecycleWorkflowVersionTaskProcessingResultClient) ListLifecycleWorkflowVersionTaskProcessingResultsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskId, options ListLifecycleWorkflowVersionTaskProcessingResultsOperationOptions) (ListLifecycleWorkflowVersionTaskProcessingResultsCompleteResult, error) {
...
func (c LifecycleWorkflowVersionTaskProcessingResultClient) ListLifecycleWorkflowVersionTaskProcessingResultsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskId, options ListLifecycleWorkflowVersionTaskProcessingResultsOperationOptions, predicate IdentityGovernanceTaskProcessingResultOperationPredicate) (result ListLifecycleWorkflowVersionTaskProcessingResultsCompleteResult, err error) {
