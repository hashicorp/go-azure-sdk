...
// processing the task.
func (c LifecycleWorkflowVersionTaskProcessingResultClient) GetLifecycleWorkflowVersionTaskProcessingResult(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskIdTaskProcessingResultId, options GetLifecycleWorkflowVersionTaskProcessingResultOperationOptions) (result GetLifecycleWorkflowVersionTaskProcessingResultOperationResponse, err error) {
