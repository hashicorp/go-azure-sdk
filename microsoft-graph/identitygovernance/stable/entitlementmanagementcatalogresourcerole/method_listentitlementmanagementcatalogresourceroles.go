...
// ListEntitlementManagementCatalogResourceRoles ...
func (c EntitlementManagementCatalogResourceRoleClient) ListEntitlementManagementCatalogResourceRoles(ctx context.Context, id IdentityGovernanceEntitlementManagementCatalogIdResourceId) (result ListEntitlementManagementCatalogResourceRolesOperationResponse, err error) {
...
func (c EntitlementManagementCatalogResourceRoleClient) ListEntitlementManagementCatalogResourceRolesComplete(ctx context.Context, id IdentityGovernanceEntitlementManagementCatalogIdResourceId) (ListEntitlementManagementCatalogResourceRolesCompleteResult, error) {
	return c.ListEntitlementManagementCatalogResourceRolesCompleteMatchingPredicate(ctx, id, AccessPackageResourceRoleOperationPredicate{})
}
...
func (c EntitlementManagementCatalogResourceRoleClient) ListEntitlementManagementCatalogResourceRolesCompleteMatchingPredicate(ctx context.Context, id IdentityGovernanceEntitlementManagementCatalogIdResourceId, predicate AccessPackageResourceRoleOperationPredicate) (result ListEntitlementManagementCatalogResourceRolesCompleteResult, err error) {
	items := make([]stable.AccessPackageResourceRole, 0)

	resp, err := c.ListEntitlementManagementCatalogResourceRoles(ctx, id)
	if err != nil {
