...
// GetEntitlementManagementResourceRequestResourceScopeResourceEnvironment ...
func (c EntitlementManagementResourceRequestResourceScopeResourceEnvironmentClient) GetEntitlementManagementResourceRequestResourceScopeResourceEnvironment(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdResourceScopeId) (result GetEntitlementManagementResourceRequestResourceScopeResourceEnvironmentOperationResponse, err error) {
