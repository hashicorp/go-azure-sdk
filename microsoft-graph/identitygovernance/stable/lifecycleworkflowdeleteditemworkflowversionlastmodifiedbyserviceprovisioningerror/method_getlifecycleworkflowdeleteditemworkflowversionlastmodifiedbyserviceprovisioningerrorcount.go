...
type GetLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByServiceProvisioningErrorCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByServiceProvisioningErrorCount ...
func (c LifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByServiceProvisioningErrorClient) GetLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByServiceProvisioningErrorCount(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdVersionId) (result GetLifecycleWorkflowDeletedItemWorkflowVersionLastModifiedByServiceProvisioningErrorCountOperationResponse, err error) {
