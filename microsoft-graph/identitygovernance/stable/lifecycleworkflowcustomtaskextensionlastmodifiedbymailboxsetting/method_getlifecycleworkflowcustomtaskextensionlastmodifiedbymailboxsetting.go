...
func (c LifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSettingClient) GetLifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSetting(ctx context.Context, id IdentityGovernanceLifecycleWorkflowCustomTaskExtensionId) (result GetLifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSettingOperationResponse, err error) {
