...
// GetLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResult ...
func (c LifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultClient) GetLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResult(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdTaskReportIdTaskProcessingResultId) (result GetLifecycleWorkflowDeletedItemWorkflowTaskReportTaskProcessingResultOperationResponse, err error) {
