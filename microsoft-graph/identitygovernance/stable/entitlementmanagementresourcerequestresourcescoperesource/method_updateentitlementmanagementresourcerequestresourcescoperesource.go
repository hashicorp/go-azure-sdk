...
// UpdateEntitlementManagementResourceRequestResourceScopeResource ...
func (c EntitlementManagementResourceRequestResourceScopeResourceClient) UpdateEntitlementManagementResourceRequestResourceScopeResource(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdResourceScopeId, input stable.AccessPackageResource) (result UpdateEntitlementManagementResourceRequestResourceScopeResourceOperationResponse, err error) {
