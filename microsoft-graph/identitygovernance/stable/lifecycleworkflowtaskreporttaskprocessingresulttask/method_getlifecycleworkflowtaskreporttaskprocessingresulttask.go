...
func (c LifecycleWorkflowTaskReportTaskProcessingResultTaskClient) GetLifecycleWorkflowTaskReportTaskProcessingResultTask(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskReportIdTaskProcessingResultId, options GetLifecycleWorkflowTaskReportTaskProcessingResultTaskOperationOptions) (result GetLifecycleWorkflowTaskReportTaskProcessingResultTaskOperationResponse, err error) {
