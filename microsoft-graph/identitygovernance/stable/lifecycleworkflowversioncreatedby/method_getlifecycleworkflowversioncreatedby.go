...
func (c LifecycleWorkflowVersionCreatedByClient) GetLifecycleWorkflowVersionCreatedBy(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options GetLifecycleWorkflowVersionCreatedByOperationOptions) (result GetLifecycleWorkflowVersionCreatedByOperationResponse, err error) {
