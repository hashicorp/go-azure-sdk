...
func (c LifecycleWorkflowRunUserProcessingResultTaskSubjectClient) GetLifecycleWorkflowRunUserProcessingResultTaskSubject(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultIdTaskProcessingResultId, options GetLifecycleWorkflowRunUserProcessingResultTaskSubjectOperationOptions) (result GetLifecycleWorkflowRunUserProcessingResultTaskSubjectOperationResponse, err error) {
