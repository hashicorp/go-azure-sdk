...
// CreateAccessReviewDefinitionInstanceStageDecision ...
func (c AccessReviewDefinitionInstanceStageDecisionClient) CreateAccessReviewDefinitionInstanceStageDecision(ctx context.Context, id IdentityGovernanceAccessReviewDefinitionIdInstanceIdStageId, input stable.AccessReviewInstanceDecisionItem) (result CreateAccessReviewDefinitionInstanceStageDecisionOperationResponse, err error) {
