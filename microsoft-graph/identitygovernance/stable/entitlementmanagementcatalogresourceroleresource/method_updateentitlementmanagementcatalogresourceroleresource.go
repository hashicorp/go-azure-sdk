...
func (c EntitlementManagementCatalogResourceRoleResourceClient) UpdateEntitlementManagementCatalogResourceRoleResource(ctx context.Context, id IdentityGovernanceEntitlementManagementCatalogIdResourceRoleId, input stable.AccessPackageResource) (result UpdateEntitlementManagementCatalogResourceRoleResourceOperationResponse, err error) {
