...
type GetLifecycleWorkflowDeletedItemWorkflowVersionTaskTaskProcessingResultCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetLifecycleWorkflowDeletedItemWorkflowVersionTaskTaskProcessingResultCount ...
func (c LifecycleWorkflowDeletedItemWorkflowVersionTaskTaskProcessingResultClient) GetLifecycleWorkflowDeletedItemWorkflowVersionTaskTaskProcessingResultCount(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdVersionIdTaskId) (result GetLifecycleWorkflowDeletedItemWorkflowVersionTaskTaskProcessingResultCountOperationResponse, err error) {
