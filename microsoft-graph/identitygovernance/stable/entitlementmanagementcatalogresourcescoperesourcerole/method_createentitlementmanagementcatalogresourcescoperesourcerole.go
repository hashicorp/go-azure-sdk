...
// CreateEntitlementManagementCatalogResourceScopeResourceRole ...
func (c EntitlementManagementCatalogResourceScopeResourceRoleClient) CreateEntitlementManagementCatalogResourceScopeResourceRole(ctx context.Context, id IdentityGovernanceEntitlementManagementCatalogIdResourceScopeId, input stable.AccessPackageResourceRole) (result CreateEntitlementManagementCatalogResourceScopeResourceRoleOperationResponse, err error) {
