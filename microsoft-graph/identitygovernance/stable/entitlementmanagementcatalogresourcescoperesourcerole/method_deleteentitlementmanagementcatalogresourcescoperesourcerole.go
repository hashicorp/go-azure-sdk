...
// DeleteEntitlementManagementCatalogResourceScopeResourceRole ...
func (c EntitlementManagementCatalogResourceScopeResourceRoleClient) DeleteEntitlementManagementCatalogResourceScopeResourceRole(ctx context.Context, id IdentityGovernanceEntitlementManagementCatalogIdResourceIdScopeIdResourceRoleId) (result DeleteEntitlementManagementCatalogResourceScopeResourceRoleOperationResponse, err error) {
