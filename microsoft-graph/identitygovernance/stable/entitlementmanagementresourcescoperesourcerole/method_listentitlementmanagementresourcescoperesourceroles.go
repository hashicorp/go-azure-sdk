...
// ListEntitlementManagementResourceScopeResourceRoles ...
func (c EntitlementManagementResourceScopeResourceRoleClient) ListEntitlementManagementResourceScopeResourceRoles(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceIdScopeId) (result ListEntitlementManagementResourceScopeResourceRolesOperationResponse, err error) {
...
func (c EntitlementManagementResourceScopeResourceRoleClient) ListEntitlementManagementResourceScopeResourceRolesComplete(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceIdScopeId) (ListEntitlementManagementResourceScopeResourceRolesCompleteResult, error) {
	return c.ListEntitlementManagementResourceScopeResourceRolesCompleteMatchingPredicate(ctx, id, AccessPackageResourceRoleOperationPredicate{})
}
...
func (c EntitlementManagementResourceScopeResourceRoleClient) ListEntitlementManagementResourceScopeResourceRolesCompleteMatchingPredicate(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceIdScopeId, predicate AccessPackageResourceRoleOperationPredicate) (result ListEntitlementManagementResourceScopeResourceRolesCompleteResult, err error) {
	items := make([]stable.AccessPackageResourceRole, 0)

	resp, err := c.ListEntitlementManagementResourceScopeResourceRoles(ctx, id)
	if err != nil {
