...
// CreateEntitlementManagementResourceScopeResourceRole ...
func (c EntitlementManagementResourceScopeResourceRoleClient) CreateEntitlementManagementResourceScopeResourceRole(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceIdScopeId, input stable.AccessPackageResourceRole) (result CreateEntitlementManagementResourceScopeResourceRoleOperationResponse, err error) {
