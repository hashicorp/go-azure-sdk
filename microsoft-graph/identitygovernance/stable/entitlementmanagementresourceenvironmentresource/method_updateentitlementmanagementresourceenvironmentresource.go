...
// UpdateEntitlementManagementResourceEnvironmentResource ...
func (c EntitlementManagementResourceEnvironmentResourceClient) UpdateEntitlementManagementResourceEnvironmentResource(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceEnvironmentIdResourceId, input stable.AccessPackageResource) (result UpdateEntitlementManagementResourceEnvironmentResourceOperationResponse, err error) {
