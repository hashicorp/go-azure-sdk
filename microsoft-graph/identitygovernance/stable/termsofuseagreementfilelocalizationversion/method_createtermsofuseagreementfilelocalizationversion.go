...
// CreateTermsOfUseAgreementFileLocalizationVersion ...
func (c TermsOfUseAgreementFileLocalizationVersionClient) CreateTermsOfUseAgreementFileLocalizationVersion(ctx context.Context, id IdentityGovernanceTermsOfUseAgreementIdFileLocalizationId, input stable.AgreementFileVersion) (result CreateTermsOfUseAgreementFileLocalizationVersionOperationResponse, err error) {
