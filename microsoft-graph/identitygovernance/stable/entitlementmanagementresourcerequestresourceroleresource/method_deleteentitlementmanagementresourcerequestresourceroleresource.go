...
// DeleteEntitlementManagementResourceRequestResourceRoleResource ...
func (c EntitlementManagementResourceRequestResourceRoleResourceClient) DeleteEntitlementManagementResourceRequestResourceRoleResource(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdResourceRoleId) (result DeleteEntitlementManagementResourceRequestResourceRoleResourceOperationResponse, err error) {
