...
func (c EntitlementManagementResourceRequestResourceRoleResourceClient) UpdateEntitlementManagementResourceRequestResourceRoleResource(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdResourceRoleId, input stable.AccessPackageResource) (result UpdateEntitlementManagementResourceRequestResourceRoleResourceOperationResponse, err error) {
