...
func (c EntitlementManagementResourceRoleScopeResourceEnvironmentClient) GetEntitlementManagementResourceRoleScopeResourceEnvironment(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeIdScopeResourceRoleId, options GetEntitlementManagementResourceRoleScopeResourceEnvironmentOperationOptions) (result GetEntitlementManagementResourceRoleScopeResourceEnvironmentOperationResponse, err error) {
