...
type CreateEntitlementManagementResourceRoleScopeScopeResourceScopeOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *stable.AccessPackageResourceScope
}

// CreateEntitlementManagementResourceRoleScopeScopeResourceScope ...
func (c EntitlementManagementResourceRoleScopeScopeResourceScopeClient) CreateEntitlementManagementResourceRoleScopeScopeResourceScope(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRoleScopeId, input stable.AccessPackageResourceScope) (result CreateEntitlementManagementResourceRoleScopeScopeResourceScopeOperationResponse, err error) {
