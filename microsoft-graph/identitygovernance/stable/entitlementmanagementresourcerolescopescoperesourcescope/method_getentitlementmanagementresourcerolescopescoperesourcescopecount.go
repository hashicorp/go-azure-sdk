...
type GetEntitlementManagementResourceRoleScopeScopeResourceScopeCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetEntitlementManagementResourceRoleScopeScopeResourceScopeCount ...
func (c EntitlementManagementResourceRoleScopeScopeResourceScopeClient) GetEntitlementManagementResourceRoleScopeScopeResourceScopeCount(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRoleScopeId) (result GetEntitlementManagementResourceRoleScopeScopeResourceScopeCountOperationResponse, err error) {
