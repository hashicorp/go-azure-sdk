...
// GetLifecycleWorkflowDeletedItemWorkflowExecutionScope ...
func (c LifecycleWorkflowDeletedItemWorkflowExecutionScopeClient) GetLifecycleWorkflowDeletedItemWorkflowExecutionScope(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdExecutionScopeId) (result GetLifecycleWorkflowDeletedItemWorkflowExecutionScopeOperationResponse, err error) {
