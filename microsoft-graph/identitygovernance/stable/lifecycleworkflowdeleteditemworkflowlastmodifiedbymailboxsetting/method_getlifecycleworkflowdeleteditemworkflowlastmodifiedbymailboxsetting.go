...
func (c LifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingClient) GetLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSetting(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId) (result GetLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingOperationResponse, err error) {
