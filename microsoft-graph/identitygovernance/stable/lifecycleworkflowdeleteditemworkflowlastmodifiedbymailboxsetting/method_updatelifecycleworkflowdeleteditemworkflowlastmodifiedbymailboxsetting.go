...
func (c LifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingClient) UpdateLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSetting(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, input stable.MailboxSettings) (result UpdateLifecycleWorkflowDeletedItemWorkflowLastModifiedByMailboxSettingOperationResponse, err error) {
