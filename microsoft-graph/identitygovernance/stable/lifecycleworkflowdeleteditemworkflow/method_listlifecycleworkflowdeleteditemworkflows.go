...
// ListLifecycleWorkflowDeletedItemWorkflows ...
func (c LifecycleWorkflowDeletedItemWorkflowClient) ListLifecycleWorkflowDeletedItemWorkflows(ctx context.Context) (result ListLifecycleWorkflowDeletedItemWorkflowsOperationResponse, err error) {
...
func (c LifecycleWorkflowDeletedItemWorkflowClient) ListLifecycleWorkflowDeletedItemWorkflowsComplete(ctx context.Context) (ListLifecycleWorkflowDeletedItemWorkflowsCompleteResult, error) {
	return c.ListLifecycleWorkflowDeletedItemWorkflowsCompleteMatchingPredicate(ctx, IdentityGovernanceWorkflowOperationPredicate{})
}
...
func (c LifecycleWorkflowDeletedItemWorkflowClient) ListLifecycleWorkflowDeletedItemWorkflowsCompleteMatchingPredicate(ctx context.Context, predicate IdentityGovernanceWorkflowOperationPredicate) (result ListLifecycleWorkflowDeletedItemWorkflowsCompleteResult, err error) {
	items := make([]stable.IdentityGovernanceWorkflow, 0)

	resp, err := c.ListLifecycleWorkflowDeletedItemWorkflows(ctx)
	if err != nil {
