...
// UpdateEntitlementManagementCatalogResourceRoleResourceScopeResource ...
func (c EntitlementManagementCatalogResourceRoleResourceScopeResourceClient) UpdateEntitlementManagementCatalogResourceRoleResourceScopeResource(ctx context.Context, id IdentityGovernanceEntitlementManagementCatalogIdResourceRoleIdResourceScopeId, input stable.AccessPackageResource) (result UpdateEntitlementManagementCatalogResourceRoleResourceScopeResourceOperationResponse, err error) {
