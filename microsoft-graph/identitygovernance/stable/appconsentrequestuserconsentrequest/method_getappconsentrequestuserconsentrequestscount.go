...
func (c AppConsentRequestUserConsentRequestClient) GetAppConsentRequestUserConsentRequestsCount(ctx context.Context, id stable.IdentityGovernanceAppConsentAppConsentRequestId, options GetAppConsentRequestUserConsentRequestsCountOperationOptions) (result GetAppConsentRequestUserConsentRequestsCountOperationResponse, err error) {
