...
func (c AppConsentRequestUserConsentRequestClient) ListAppConsentRequestUserConsentRequests(ctx context.Context, id stable.IdentityGovernanceAppConsentAppConsentRequestId, options ListAppConsentRequestUserConsentRequestsOperationOptions) (result ListAppConsentRequestUserConsentRequestsOperationResponse, err error) {
...
func (c AppConsentRequestUserConsentRequestClient) ListAppConsentRequestUserConsentRequestsComplete(ctx context.Context, id stable.IdentityGovernanceAppConsentAppConsentRequestId, options ListAppConsentRequestUserConsentRequestsOperationOptions) (ListAppConsentRequestUserConsentRequestsCompleteResult, error) {
...
func (c AppConsentRequestUserConsentRequestClient) ListAppConsentRequestUserConsentRequestsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceAppConsentAppConsentRequestId, options ListAppConsentRequestUserConsentRequestsOperationOptions, predicate UserConsentRequestOperationPredicate) (result ListAppConsentRequestUserConsentRequestsCompleteResult, err error) {
