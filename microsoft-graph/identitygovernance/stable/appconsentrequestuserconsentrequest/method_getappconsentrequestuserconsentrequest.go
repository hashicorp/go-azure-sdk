...
func (c AppConsentRequestUserConsentRequestClient) GetAppConsentRequestUserConsentRequest(ctx context.Context, id stable.IdentityGovernanceAppConsentAppConsentRequestIdUserConsentRequestId, options GetAppConsentRequestUserConsentRequestOperationOptions) (result GetAppConsentRequestUserConsentRequestOperationResponse, err error) {
