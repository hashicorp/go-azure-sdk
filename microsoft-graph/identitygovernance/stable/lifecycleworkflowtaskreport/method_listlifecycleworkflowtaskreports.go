...
func (c LifecycleWorkflowTaskReportClient) ListLifecycleWorkflowTaskReports(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowTaskReportsOperationOptions) (result ListLifecycleWorkflowTaskReportsOperationResponse, err error) {
...
func (c LifecycleWorkflowTaskReportClient) ListLifecycleWorkflowTaskReportsComplete(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowTaskReportsOperationOptions) (ListLifecycleWorkflowTaskReportsCompleteResult, error) {
...
func (c LifecycleWorkflowTaskReportClient) ListLifecycleWorkflowTaskReportsCompleteMatchingPredicate(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowTaskReportsOperationOptions, predicate IdentityGovernanceTaskReportOperationPredicate) (result ListLifecycleWorkflowTaskReportsCompleteResult, err error) {
