...
type GetLifecycleWorkflowWorkflowTemplateTaskTaskProcessingResultCountOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *int64
}

// GetLifecycleWorkflowWorkflowTemplateTaskTaskProcessingResultCount ...
func (c LifecycleWorkflowWorkflowTemplateTaskTaskProcessingResultClient) GetLifecycleWorkflowWorkflowTemplateTaskTaskProcessingResultCount(ctx context.Context, id IdentityGovernanceLifecycleWorkflowWorkflowTemplateIdTaskId) (result GetLifecycleWorkflowWorkflowTemplateTaskTaskProcessingResultCountOperationResponse, err error) {
