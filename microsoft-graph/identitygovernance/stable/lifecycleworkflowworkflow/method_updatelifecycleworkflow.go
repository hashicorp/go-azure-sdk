...
func (c LifecycleWorkflowWorkflowClient) UpdateLifecycleWorkflow(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, input stable.IdentityGovernanceWorkflow) (result UpdateLifecycleWorkflowOperationResponse, err error) {
