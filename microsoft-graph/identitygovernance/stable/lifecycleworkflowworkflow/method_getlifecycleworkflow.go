...
// GetLifecycleWorkflow - Get workflow. Read the properties and relationships of a workflow object.
func (c LifecycleWorkflowWorkflowClient) GetLifecycleWorkflow(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowOperationOptions) (result GetLifecycleWorkflowOperationResponse, err error) {
