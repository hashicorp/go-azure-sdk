...
// CreateLifecycleWorkflowWorkflow ...
func (c LifecycleWorkflowWorkflowClient) CreateLifecycleWorkflowWorkflow(ctx context.Context, input stable.IdentityGovernanceWorkflow) (result CreateLifecycleWorkflowWorkflowOperationResponse, err error) {
