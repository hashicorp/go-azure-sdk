...
// ListEntitlementManagementResourceEnvironmentResourceScopes ...
func (c EntitlementManagementResourceEnvironmentResourceScopeClient) ListEntitlementManagementResourceEnvironmentResourceScopes(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceEnvironmentIdResourceId) (result ListEntitlementManagementResourceEnvironmentResourceScopesOperationResponse, err error) {
...
func (c EntitlementManagementResourceEnvironmentResourceScopeClient) ListEntitlementManagementResourceEnvironmentResourceScopesComplete(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceEnvironmentIdResourceId) (ListEntitlementManagementResourceEnvironmentResourceScopesCompleteResult, error) {
	return c.ListEntitlementManagementResourceEnvironmentResourceScopesCompleteMatchingPredicate(ctx, id, AccessPackageResourceScopeOperationPredicate{})
}
...
func (c EntitlementManagementResourceEnvironmentResourceScopeClient) ListEntitlementManagementResourceEnvironmentResourceScopesCompleteMatchingPredicate(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceEnvironmentIdResourceId, predicate AccessPackageResourceScopeOperationPredicate) (result ListEntitlementManagementResourceEnvironmentResourceScopesCompleteResult, err error) {
	...
	resp, err := c.ListEntitlementManagementResourceEnvironmentResourceScopes(ctx, id)
	if err != nil {
