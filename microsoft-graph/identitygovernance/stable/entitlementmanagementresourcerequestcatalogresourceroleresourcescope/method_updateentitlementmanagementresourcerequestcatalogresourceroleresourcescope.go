...
// UpdateEntitlementManagementResourceRequestCatalogResourceRoleResourceScope ...
func (c EntitlementManagementResourceRequestCatalogResourceRoleResourceScopeClient) UpdateEntitlementManagementResourceRequestCatalogResourceRoleResourceScope(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdCatalogResourceRoleIdResourceScopeId, input stable.AccessPackageResourceScope) (result UpdateEntitlementManagementResourceRequestCatalogResourceRoleResourceScopeOperationResponse, err error) {
