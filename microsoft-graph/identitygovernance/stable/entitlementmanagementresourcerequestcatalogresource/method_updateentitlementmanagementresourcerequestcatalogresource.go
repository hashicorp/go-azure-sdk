...
func (c EntitlementManagementResourceRequestCatalogResourceClient) UpdateEntitlementManagementResourceRequestCatalogResource(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdCatalogResourceId, input stable.AccessPackageResource) (result UpdateEntitlementManagementResourceRequestCatalogResourceOperationResponse, err error) {
