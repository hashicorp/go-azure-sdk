...
// GetEntitlementManagementResourceRequestCatalogResourceScopeResourceRoleResource ...
func (c EntitlementManagementResourceRequestCatalogResourceScopeResourceRoleResourceClient) GetEntitlementManagementResourceRequestCatalogResourceScopeResourceRoleResource(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdCatalogResourceScopeIdResourceRoleId) (result GetEntitlementManagementResourceRequestCatalogResourceScopeResourceRoleResourceOperationResponse, err error) {
