...
func (c EntitlementManagementResourceEnvironmentResourceScopeResourceRoleClient) UpdateEntitlementManagementResourceEnvironmentResourceScopeResourceRole(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceEnvironmentIdResourceIdScopeIdResourceRoleId, input stable.AccessPackageResourceRole) (result UpdateEntitlementManagementResourceEnvironmentResourceScopeResourceRoleOperationResponse, err error) {
