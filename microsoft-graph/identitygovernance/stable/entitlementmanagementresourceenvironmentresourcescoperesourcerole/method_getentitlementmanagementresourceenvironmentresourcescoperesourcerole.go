...
// GetEntitlementManagementResourceEnvironmentResourceScopeResourceRole ...
func (c EntitlementManagementResourceEnvironmentResourceScopeResourceRoleClient) GetEntitlementManagementResourceEnvironmentResourceScopeResourceRole(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceEnvironmentIdResourceIdScopeIdResourceRoleId) (result GetEntitlementManagementResourceEnvironmentResourceScopeResourceRoleOperationResponse, err error) {
