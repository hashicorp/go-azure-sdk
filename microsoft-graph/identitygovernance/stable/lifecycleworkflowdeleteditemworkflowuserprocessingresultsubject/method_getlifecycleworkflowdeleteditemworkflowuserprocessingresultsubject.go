...
// GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubject ...
func (c LifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubjectClient) GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubject(ctx context.Context, id IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowIdUserProcessingResultId) (result GetLifecycleWorkflowDeletedItemWorkflowUserProcessingResultSubjectOperationResponse, err error) {
