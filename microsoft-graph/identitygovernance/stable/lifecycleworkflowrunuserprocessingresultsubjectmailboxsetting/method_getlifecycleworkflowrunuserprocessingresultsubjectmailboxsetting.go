...
func (c LifecycleWorkflowRunUserProcessingResultSubjectMailboxSettingClient) GetLifecycleWorkflowRunUserProcessingResultSubjectMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultId, options GetLifecycleWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions) (result GetLifecycleWorkflowRunUserProcessingResultSubjectMailboxSettingOperationResponse, err error) {
