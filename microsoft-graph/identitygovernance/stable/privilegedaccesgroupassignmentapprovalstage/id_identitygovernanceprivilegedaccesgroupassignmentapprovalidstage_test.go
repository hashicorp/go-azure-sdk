...
func TestNewIdentityGovernancePrivilegedAccesGroupAssignmentApprovalIdStageID(t *testing.T) {
	id := NewIdentityGovernancePrivilegedAccesGroupAssignmentApprovalIdStageID("approvalIdValue", "approvalStageIdValue")
...
func TestFormatIdentityGovernancePrivilegedAccesGroupAssignmentApprovalIdStageID(t *testing.T) {
	actual := NewIdentityGovernancePrivilegedAccesGroupAssignmentApprovalIdStageID("approvalIdValue", "approvalStageIdValue").ID()
...
func TestParseIdentityGovernancePrivilegedAccesGroupAssignmentApprovalIdStageID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *IdentityGovernancePrivilegedAccesGroupAssignmentApprovalIdStageId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseIdentityGovernancePrivilegedAccesGroupAssignmentApprovalIdStageID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseIdentityGovernancePrivilegedAccesGroupAssignmentApprovalIdStageIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *IdentityGovernancePrivilegedAccesGroupAssignmentApprovalIdStageId
	...
	for _, v := range testData {
		...
		actual, err := ParseIdentityGovernancePrivilegedAccesGroupAssignmentApprovalIdStageIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForIdentityGovernancePrivilegedAccesGroupAssignmentApprovalIdStageId(t *testing.T) {
	segments := IdentityGovernancePrivilegedAccesGroupAssignmentApprovalIdStageId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("IdentityGovernancePrivilegedAccesGroupAssignmentApprovalIdStageId has no segments")
	}
