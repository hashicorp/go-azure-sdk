...
func (c EntitlementManagementResourceRequestCatalogResourceScopeResourceScopeClient) UpdateEntitlementManagementResourceRequestCatalogResourceScopeResourceScope(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestIdCatalogResourceScopeIdResourceScopeId, input stable.AccessPackageResourceScope) (result UpdateEntitlementManagementResourceRequestCatalogResourceScopeResourceScopeOperationResponse, err error) {
