...
func (c LifecycleWorkflowSettingClient) UpdateLifecycleWorkflowSetting(ctx context.Context, input stable.IdentityGovernanceLifecycleManagementSettings) (result UpdateLifecycleWorkflowSettingOperationResponse, err error) {
