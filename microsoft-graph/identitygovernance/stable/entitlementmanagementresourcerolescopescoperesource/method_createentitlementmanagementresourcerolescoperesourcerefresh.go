...
func (c EntitlementManagementResourceRoleScopeScopeResourceClient) CreateEntitlementManagementResourceRoleScopeResourceRefresh(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, options CreateEntitlementManagementResourceRoleScopeResourceRefreshOperationOptions) (result CreateEntitlementManagementResourceRoleScopeResourceRefreshOperationResponse, err error) {
