...
func (c EntitlementManagementResourceRoleScopeScopeResourceClient) UpdateEntitlementManagementResourceRoleScopeResource(ctx context.Context, id stable.IdentityGovernanceEntitlementManagementResourceRoleScopeId, input stable.AccessPackageResource) (result UpdateEntitlementManagementResourceRoleScopeResourceOperationResponse, err error) {
