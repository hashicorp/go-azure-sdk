...
// CreateAccessReviewDefinition ...
func (c AccessReviewDefinitionClient) CreateAccessReviewDefinition(ctx context.Context, input stable.AccessReviewScheduleDefinition) (result CreateAccessReviewDefinitionOperationResponse, err error) {
