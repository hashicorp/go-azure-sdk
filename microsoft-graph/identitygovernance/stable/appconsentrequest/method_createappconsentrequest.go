...
func (c AppConsentRequestClient) CreateAppConsentRequest(ctx context.Context, input stable.AppConsentRequest) (result CreateAppConsentRequestOperationResponse, err error) {
