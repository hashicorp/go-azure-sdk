...
func (c AppConsentRequestClient) DeleteAppConsentRequest(ctx context.Context, id stable.IdentityGovernanceAppConsentAppConsentRequestId, options DeleteAppConsentRequestOperationOptions) (result DeleteAppConsentRequestOperationResponse, err error) {
