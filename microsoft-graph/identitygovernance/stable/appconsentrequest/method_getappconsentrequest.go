...
func (c AppConsentRequestClient) GetAppConsentRequest(ctx context.Context, id stable.IdentityGovernanceAppConsentAppConsentRequestId, options GetAppConsentRequestOperationOptions) (result GetAppConsentRequestOperationResponse, err error) {
