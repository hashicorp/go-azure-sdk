...
func (c LifecycleWorkflowCreatedByMailboxSettingClient) GetLifecycleWorkflowCreatedByMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowCreatedByMailboxSettingOperationOptions) (result GetLifecycleWorkflowCreatedByMailboxSettingOperationResponse, err error) {
