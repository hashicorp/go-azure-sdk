...
func (c LifecycleWorkflowLastModifiedByMailboxSettingClient) GetLifecycleWorkflowLastModifiedByMailboxSetting(ctx context.Context, id stable.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowLastModifiedByMailboxSettingOperationOptions) (result GetLifecycleWorkflowLastModifiedByMailboxSettingOperationResponse, err error) {
