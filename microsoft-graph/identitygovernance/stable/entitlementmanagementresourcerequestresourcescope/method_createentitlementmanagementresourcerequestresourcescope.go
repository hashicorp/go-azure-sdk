...
// CreateEntitlementManagementResourceRequestResourceScope ...
func (c EntitlementManagementResourceRequestResourceScopeClient) CreateEntitlementManagementResourceRequestResourceScope(ctx context.Context, id IdentityGovernanceEntitlementManagementResourceRequestId, input stable.AccessPackageResourceScope) (result CreateEntitlementManagementResourceRequestResourceScopeOperationResponse, err error) {
