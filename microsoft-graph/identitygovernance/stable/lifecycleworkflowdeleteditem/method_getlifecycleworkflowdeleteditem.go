...
// GetLifecycleWorkflowDeletedItem ...
func (c LifecycleWorkflowDeletedItemClient) GetLifecycleWorkflowDeletedItem(ctx context.Context) (result GetLifecycleWorkflowDeletedItemOperationResponse, err error) {
