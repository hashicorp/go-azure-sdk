...
// identityGovernance
func (c EntitlementManagementAccessPackageAssignmentResourceRoleResourceRoleClient) GetEntitlementManagementAccessPackageAssignmentResourceRoleResourceRole(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentResourceRoleId, options GetEntitlementManagementAccessPackageAssignmentResourceRoleResourceRoleOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentResourceRoleResourceRoleOperationResponse, err error) {
