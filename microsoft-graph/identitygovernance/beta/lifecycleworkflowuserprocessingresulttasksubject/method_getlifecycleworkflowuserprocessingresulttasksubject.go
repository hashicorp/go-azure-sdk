...
func (c LifecycleWorkflowUserProcessingResultTaskSubjectClient) GetLifecycleWorkflowUserProcessingResultTaskSubject(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultIdTaskProcessingResultId, options GetLifecycleWorkflowUserProcessingResultTaskSubjectOperationOptions) (result GetLifecycleWorkflowUserProcessingResultTaskSubjectOperationResponse, err error) {
