...
func (c LifecycleWorkflowCreatedByClient) GetLifecycleWorkflowCreatedBy(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowCreatedByOperationOptions) (result GetLifecycleWorkflowCreatedByOperationResponse, err error) {
