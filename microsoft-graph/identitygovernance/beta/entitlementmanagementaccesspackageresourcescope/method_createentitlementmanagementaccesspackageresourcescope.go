...
func (c EntitlementManagementAccessPackageResourceScopeClient) CreateEntitlementManagementAccessPackageResourceScope(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceId, input beta.AccessPackageResourceScope) (result CreateEntitlementManagementAccessPackageResourceScopeOperationResponse, err error) {
