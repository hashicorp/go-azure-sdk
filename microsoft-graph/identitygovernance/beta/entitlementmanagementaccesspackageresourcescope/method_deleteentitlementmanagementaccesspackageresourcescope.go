...
// identityGovernance
func (c EntitlementManagementAccessPackageResourceScopeClient) DeleteEntitlementManagementAccessPackageResourceScope(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceIdAccessPackageResourceScopeId, options DeleteEntitlementManagementAccessPackageResourceScopeOperationOptions) (result DeleteEntitlementManagementAccessPackageResourceScopeOperationResponse, err error) {
