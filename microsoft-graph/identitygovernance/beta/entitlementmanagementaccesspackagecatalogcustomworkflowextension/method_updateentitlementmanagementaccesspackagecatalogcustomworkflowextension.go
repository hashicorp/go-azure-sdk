...
func (c EntitlementManagementAccessPackageCatalogCustomWorkflowExtensionClient) UpdateEntitlementManagementAccessPackageCatalogCustomWorkflowExtension(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogIdCustomAccessPackageWorkflowExtensionId, input beta.CustomAccessPackageWorkflowExtension) (result UpdateEntitlementManagementAccessPackageCatalogCustomWorkflowExtensionOperationResponse, err error) {
