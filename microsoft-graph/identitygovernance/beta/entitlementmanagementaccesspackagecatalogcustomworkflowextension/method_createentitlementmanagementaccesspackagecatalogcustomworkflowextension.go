...
func (c EntitlementManagementAccessPackageCatalogCustomWorkflowExtensionClient) CreateEntitlementManagementAccessPackageCatalogCustomWorkflowExtension(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogId, input beta.CustomAccessPackageWorkflowExtension) (result CreateEntitlementManagementAccessPackageCatalogCustomWorkflowExtensionOperationResponse, err error) {
