...
func userAgent() string {
	return "hashicorp/go-azure-sdk/entitlementmanagementaccesspackageresourcerolescopeaccesspackageresourceroleaccesspackageresourceaccesspackageresourcescope/beta"
}
