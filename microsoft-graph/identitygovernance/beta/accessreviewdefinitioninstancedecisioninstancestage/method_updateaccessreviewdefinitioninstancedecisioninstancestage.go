...
// identityGovernance
func (c AccessReviewDefinitionInstanceDecisionInstanceStageClient) UpdateAccessReviewDefinitionInstanceDecisionInstanceStage(ctx context.Context, id beta.IdentityGovernanceAccessReviewDefinitionIdInstanceIdDecisionIdInstanceStageId, input beta.AccessReviewStage) (result UpdateAccessReviewDefinitionInstanceDecisionInstanceStageOperationResponse, err error) {
