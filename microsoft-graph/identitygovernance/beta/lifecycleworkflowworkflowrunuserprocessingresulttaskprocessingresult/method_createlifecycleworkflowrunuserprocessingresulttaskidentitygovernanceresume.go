...
func (c LifecycleWorkflowWorkflowRunUserProcessingResultTaskProcessingResultClient) CreateLifecycleWorkflowRunUserProcessingResultTaskIdentityGovernanceResume(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultIdTaskProcessingResultId, input CreateLifecycleWorkflowRunUserProcessingResultTaskIdentityGovernanceResumeRequest) (result CreateLifecycleWorkflowRunUserProcessingResultTaskIdentityGovernanceResumeOperationResponse, err error) {
