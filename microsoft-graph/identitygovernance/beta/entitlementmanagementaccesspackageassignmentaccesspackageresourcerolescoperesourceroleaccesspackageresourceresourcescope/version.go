...
func userAgent() string {
	return "hashicorp/go-azure-sdk/entitlementmanagementaccesspackageassignmentaccesspackageresourcerolescoperesourceroleaccesspackageresourceresourcescope/beta"
}
