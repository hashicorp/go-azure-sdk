...
func (c EntitlementManagementAccessPackageResourceRoleScopeScopeAccessAccessAccessEnvironmentClient) GetEntitlementManagementAccessPackageResourceRoleScopeScopeAccessAccessAccessEnvironment(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopeIdAccessPackageResourceScopeAccessPackageResourceAccessPackageResourceRoleId, options GetEntitlementManagementAccessPackageResourceRoleScopeScopeAccessAccessAccessEnvironmentOperationOptions) (result GetEntitlementManagementAccessPackageResourceRoleScopeScopeAccessAccessAccessEnvironmentOperationResponse, err error) {
