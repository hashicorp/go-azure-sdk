...
// object.
func (c LifecycleWorkflowTemplateClient) GetLifecycleWorkflowTemplate(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowTemplateId, options GetLifecycleWorkflowTemplateOperationOptions) (result GetLifecycleWorkflowTemplateOperationResponse, err error) {
