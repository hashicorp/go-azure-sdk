...
func (c LifecycleWorkflowTemplateClient) GetLifecycleWorkflowTemplatesCount(ctx context.Context, options GetLifecycleWorkflowTemplatesCountOperationOptions) (result GetLifecycleWorkflowTemplatesCountOperationResponse, err error) {
