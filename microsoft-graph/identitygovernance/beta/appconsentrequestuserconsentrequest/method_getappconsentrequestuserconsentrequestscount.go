...
func (c AppConsentRequestUserConsentRequestClient) GetAppConsentRequestUserConsentRequestsCount(ctx context.Context, id beta.IdentityGovernanceAppConsentAppConsentRequestId, options GetAppConsentRequestUserConsentRequestsCountOperationOptions) (result GetAppConsentRequestUserConsentRequestsCountOperationResponse, err error) {
