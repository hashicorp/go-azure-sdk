...
func (c AppConsentRequestUserConsentRequestClient) GetAppConsentRequestUserConsentRequest(ctx context.Context, id beta.IdentityGovernanceAppConsentAppConsentRequestIdUserConsentRequestId, options GetAppConsentRequestUserConsentRequestOperationOptions) (result GetAppConsentRequestUserConsentRequestOperationResponse, err error) {
