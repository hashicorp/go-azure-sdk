...
// identityGovernance
func (c AppConsentRequestUserConsentRequestClient) CreateAppConsentRequestUserConsentRequest(ctx context.Context, id beta.IdentityGovernanceAppConsentAppConsentRequestId, input beta.UserConsentRequest) (result CreateAppConsentRequestUserConsentRequestOperationResponse, err error) {
