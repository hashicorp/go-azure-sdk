...
func (c AppConsentRequestClient) DeleteAppConsentRequest(ctx context.Context, id beta.IdentityGovernanceAppConsentAppConsentRequestId, options DeleteAppConsentRequestOperationOptions) (result DeleteAppConsentRequestOperationResponse, err error) {
