...
func (c AppConsentRequestClient) CreateAppConsentRequest(ctx context.Context, input beta.AppConsentRequest) (result CreateAppConsentRequestOperationResponse, err error) {
