...
func (c AppConsentRequestClient) ListAppConsentRequests(ctx context.Context, options ListAppConsentRequestsOperationOptions) (result ListAppConsentRequestsOperationResponse, err error) {
...
func (c AppConsentRequestClient) ListAppConsentRequestsComplete(ctx context.Context, options ListAppConsentRequestsOperationOptions) (ListAppConsentRequestsCompleteResult, error) {
...
func (c AppConsentRequestClient) ListAppConsentRequestsCompleteMatchingPredicate(ctx context.Context, options ListAppConsentRequestsOperationOptions, predicate AppConsentRequestOperationPredicate) (result ListAppConsentRequestsCompleteResult, err error) {
