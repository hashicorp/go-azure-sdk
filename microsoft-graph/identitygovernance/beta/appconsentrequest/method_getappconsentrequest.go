...
func (c AppConsentRequestClient) GetAppConsentRequest(ctx context.Context, id beta.IdentityGovernanceAppConsentAppConsentRequestId, options GetAppConsentRequestOperationOptions) (result GetAppConsentRequestOperationResponse, err error) {
