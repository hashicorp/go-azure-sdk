...
func (c EntitlementManagementAccessPackageResourceRoleScopeAccessAccessPackageResourceRoleClient) CreateEntitlementManagementAccessPackageResourceRoleScopeAccessAccessPackageResourceRole(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopeId, input beta.AccessPackageResourceRole) (result CreateEntitlementManagementAccessPackageResourceRoleScopeAccessAccessPackageResourceRoleOperationResponse, err error) {
