...
func (c EntitlementManagementAccessPackageAssignmentIncompatibleGroupClient) RemoveEntitlementManagementAccessPackageAssignmentIncompatibleGroupRefs(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options RemoveEntitlementManagementAccessPackageAssignmentIncompatibleGroupRefsOperationOptions) (result RemoveEntitlementManagementAccessPackageAssignmentIncompatibleGroupRefsOperationResponse, err error) {
