...
func (c LifecycleWorkflowTaskReportTaskProcessingResultSubjectClient) GetLifecycleWorkflowTaskReportTaskProcessingResultSubject(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskReportIdTaskProcessingResultId, options GetLifecycleWorkflowTaskReportTaskProcessingResultSubjectOperationOptions) (result GetLifecycleWorkflowTaskReportTaskProcessingResultSubjectOperationResponse, err error) {
