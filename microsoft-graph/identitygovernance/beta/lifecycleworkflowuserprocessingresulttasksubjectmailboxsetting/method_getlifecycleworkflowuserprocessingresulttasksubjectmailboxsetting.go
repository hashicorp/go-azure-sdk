...
func (c LifecycleWorkflowUserProcessingResultTaskSubjectMailboxSettingClient) GetLifecycleWorkflowUserProcessingResultTaskSubjectMailboxSetting(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultIdTaskProcessingResultId, options GetLifecycleWorkflowUserProcessingResultTaskSubjectMailboxSettingOperationOptions) (result GetLifecycleWorkflowUserProcessingResultTaskSubjectMailboxSettingOperationResponse, err error) {
