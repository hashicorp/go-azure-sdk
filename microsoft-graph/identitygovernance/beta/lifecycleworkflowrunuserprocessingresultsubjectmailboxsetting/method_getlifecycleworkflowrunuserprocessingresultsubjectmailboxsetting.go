...
func (c LifecycleWorkflowRunUserProcessingResultSubjectMailboxSettingClient) GetLifecycleWorkflowRunUserProcessingResultSubjectMailboxSetting(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultId, options GetLifecycleWorkflowRunUserProcessingResultSubjectMailboxSettingOperationOptions) (result GetLifecycleWorkflowRunUserProcessingResultSubjectMailboxSettingOperationResponse, err error) {
