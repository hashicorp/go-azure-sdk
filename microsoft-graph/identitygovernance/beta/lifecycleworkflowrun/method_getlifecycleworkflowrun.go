...
func (c LifecycleWorkflowRunClient) GetLifecycleWorkflowRun(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options GetLifecycleWorkflowRunOperationOptions) (result GetLifecycleWorkflowRunOperationResponse, err error) {
