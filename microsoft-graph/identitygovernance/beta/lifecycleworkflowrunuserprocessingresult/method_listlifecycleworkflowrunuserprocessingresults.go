...
// run object.
func (c LifecycleWorkflowRunUserProcessingResultClient) ListLifecycleWorkflowRunUserProcessingResults(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options ListLifecycleWorkflowRunUserProcessingResultsOperationOptions) (result ListLifecycleWorkflowRunUserProcessingResultsOperationResponse, err error) {
...
func (c LifecycleWorkflowRunUserProcessingResultClient) ListLifecycleWorkflowRunUserProcessingResultsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options ListLifecycleWorkflowRunUserProcessingResultsOperationOptions) (ListLifecycleWorkflowRunUserProcessingResultsCompleteResult, error) {
...
func (c LifecycleWorkflowRunUserProcessingResultClient) ListLifecycleWorkflowRunUserProcessingResultsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options ListLifecycleWorkflowRunUserProcessingResultsOperationOptions, predicate IdentityGovernanceUserProcessingResultOperationPredicate) (result ListLifecycleWorkflowRunUserProcessingResultsCompleteResult, err error) {
