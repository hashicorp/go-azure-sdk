...
func (c LifecycleWorkflowRunUserProcessingResultClient) GetLifecycleWorkflowRunUserProcessingResultsCount(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options GetLifecycleWorkflowRunUserProcessingResultsCountOperationOptions) (result GetLifecycleWorkflowRunUserProcessingResultsCountOperationResponse, err error) {
