...
func (c EntitlementManagementAccessPackageResourceScopeRoleClient) GetEntitlementManagementAccessPackageResourceScopeRole(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceIdAccessPackageResourceScopeIdAccessPackageResourceAccessPackageResourceRoleId, options GetEntitlementManagementAccessPackageResourceScopeRoleOperationOptions) (result GetEntitlementManagementAccessPackageResourceScopeRoleOperationResponse, err error) {
