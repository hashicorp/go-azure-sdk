...
func (c LifecycleWorkflowRunUserProcessingResultSubjectServiceProvisioningErrorClient) ListLifecycleWorkflowRunUserProcessingResultSubjectServiceProvisioningErrorsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultId, options ListLifecycleWorkflowRunUserProcessingResultSubjectServiceProvisioningErrorsOperationOptions) (ListLifecycleWorkflowRunUserProcessingResultSubjectServiceProvisioningErrorsCompleteResult, error) {
...
func (c LifecycleWorkflowRunUserProcessingResultSubjectServiceProvisioningErrorClient) ListLifecycleWorkflowRunUserProcessingResultSubjectServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultId, options ListLifecycleWorkflowRunUserProcessingResultSubjectServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListLifecycleWorkflowRunUserProcessingResultSubjectServiceProvisioningErrorsCompleteResult, err error) {
