...
func (c AppConsentRequestUserConsentRequestApprovalClient) UpdateAppConsentRequestUserConsentRequestApproval(ctx context.Context, id beta.IdentityGovernanceAppConsentAppConsentRequestIdUserConsentRequestId, input beta.Approval) (result UpdateAppConsentRequestUserConsentRequestApprovalOperationResponse, err error) {
