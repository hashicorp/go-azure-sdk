...
func (c EntitlementManagementAccessPackageAssignmentRequestClient) UpdateEntitlementManagementAccessPackageAssignmentRequest(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentRequestId, input beta.AccessPackageAssignmentRequest) (result UpdateEntitlementManagementAccessPackageAssignmentRequestOperationResponse, err error) {
