...
// from a user object.
func (c LifecycleWorkflowVersionCreatedByServiceProvisioningErrorClient) ListLifecycleWorkflowVersionCreatedByServiceProvisioningErrors(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options ListLifecycleWorkflowVersionCreatedByServiceProvisioningErrorsOperationOptions) (result ListLifecycleWorkflowVersionCreatedByServiceProvisioningErrorsOperationResponse, err error) {
...
func (c LifecycleWorkflowVersionCreatedByServiceProvisioningErrorClient) ListLifecycleWorkflowVersionCreatedByServiceProvisioningErrorsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options ListLifecycleWorkflowVersionCreatedByServiceProvisioningErrorsOperationOptions) (ListLifecycleWorkflowVersionCreatedByServiceProvisioningErrorsCompleteResult, error) {
...
func (c LifecycleWorkflowVersionCreatedByServiceProvisioningErrorClient) ListLifecycleWorkflowVersionCreatedByServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options ListLifecycleWorkflowVersionCreatedByServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListLifecycleWorkflowVersionCreatedByServiceProvisioningErrorsCompleteResult, err error) {
