...
func (c AppConsentRequestUserConsentRequestApprovalStepClient) ListAppConsentRequestUserConsentRequestApprovalStepsComplete(ctx context.Context, id beta.IdentityGovernanceAppConsentAppConsentRequestIdUserConsentRequestId, options ListAppConsentRequestUserConsentRequestApprovalStepsOperationOptions) (ListAppConsentRequestUserConsentRequestApprovalStepsCompleteResult, error) {
...
func (c AppConsentRequestUserConsentRequestApprovalStepClient) ListAppConsentRequestUserConsentRequestApprovalStepsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceAppConsentAppConsentRequestIdUserConsentRequestId, options ListAppConsentRequestUserConsentRequestApprovalStepsOperationOptions, predicate ApprovalStepOperationPredicate) (result ListAppConsentRequestUserConsentRequestApprovalStepsCompleteResult, err error) {
