...
func (c AppConsentRequestUserConsentRequestApprovalStepClient) GetAppConsentRequestUserConsentRequestApprovalStepsCount(ctx context.Context, id beta.IdentityGovernanceAppConsentAppConsentRequestIdUserConsentRequestId, options GetAppConsentRequestUserConsentRequestApprovalStepsCountOperationOptions) (result GetAppConsentRequestUserConsentRequestApprovalStepsCountOperationResponse, err error) {
