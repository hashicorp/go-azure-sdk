...
func (c LifecycleWorkflowVersionLastModifiedByMailboxSettingClient) GetLifecycleWorkflowVersionLastModifiedByMailboxSetting(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options GetLifecycleWorkflowVersionLastModifiedByMailboxSettingOperationOptions) (result GetLifecycleWorkflowVersionLastModifiedByMailboxSettingOperationResponse, err error) {
