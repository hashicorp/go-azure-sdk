...
func (c LifecycleWorkflowTaskClient) ListLifecycleWorkflowTasks(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowTasksOperationOptions) (result ListLifecycleWorkflowTasksOperationResponse, err error) {
...
func (c LifecycleWorkflowTaskClient) ListLifecycleWorkflowTasksComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowTasksOperationOptions) (ListLifecycleWorkflowTasksCompleteResult, error) {
...
func (c LifecycleWorkflowTaskClient) ListLifecycleWorkflowTasksCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowTasksOperationOptions, predicate IdentityGovernanceTaskOperationPredicate) (result ListLifecycleWorkflowTasksCompleteResult, err error) {
