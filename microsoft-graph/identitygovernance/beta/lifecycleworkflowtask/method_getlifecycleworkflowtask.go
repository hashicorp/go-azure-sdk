...
func (c LifecycleWorkflowTaskClient) GetLifecycleWorkflowTask(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdTaskId, options GetLifecycleWorkflowTaskOperationOptions) (result GetLifecycleWorkflowTaskOperationResponse, err error) {
