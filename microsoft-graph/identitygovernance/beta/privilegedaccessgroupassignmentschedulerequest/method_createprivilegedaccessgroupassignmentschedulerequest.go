...
func (c PrivilegedAccessGroupAssignmentScheduleRequestClient) CreatePrivilegedAccessGroupAssignmentScheduleRequest(ctx context.Context, input beta.PrivilegedAccessGroupAssignmentScheduleRequest) (result CreatePrivilegedAccessGroupAssignmentScheduleRequestOperationResponse, err error) {
