...
func (c EntitlementManagementAccessPackageResourceScopeAccessPackageResourceClient) CreateEntitlementManagementAccessPackageResourceScopeRefresh(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceIdAccessPackageResourceScopeId) (result CreateEntitlementManagementAccessPackageResourceScopeRefreshOperationResponse, err error) {
