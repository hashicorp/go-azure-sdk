...
func (c EntitlementManagementAccessPackageAssignmentResourceRoleSubjectClient) UpdateEntitlementManagementAccessPackageAssignmentResourceRoleSubject(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentIdAccessPackageAssignmentResourceRoleId, input beta.AccessPackageSubject) (result UpdateEntitlementManagementAccessPackageAssignmentResourceRoleSubjectOperationResponse, err error) {
