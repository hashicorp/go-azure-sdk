...
func (c EntitlementManagementAccessPackageCatalogResourceResourceScopeClient) CreateEntitlementManagementAccessPackageCatalogResourceResourceScope(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogIdAccessPackageResourceId, input beta.AccessPackageResourceScope) (result CreateEntitlementManagementAccessPackageCatalogResourceResourceScopeOperationResponse, err error) {
