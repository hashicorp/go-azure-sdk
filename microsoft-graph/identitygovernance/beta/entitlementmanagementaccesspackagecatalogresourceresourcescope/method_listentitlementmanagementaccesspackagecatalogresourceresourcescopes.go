...
func (c EntitlementManagementAccessPackageCatalogResourceResourceScopeClient) ListEntitlementManagementAccessPackageCatalogResourceResourceScopes(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogIdAccessPackageResourceId, options ListEntitlementManagementAccessPackageCatalogResourceResourceScopesOperationOptions) (result ListEntitlementManagementAccessPackageCatalogResourceResourceScopesOperationResponse, err error) {
...
func (c EntitlementManagementAccessPackageCatalogResourceResourceScopeClient) ListEntitlementManagementAccessPackageCatalogResourceResourceScopesCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogIdAccessPackageResourceId, options ListEntitlementManagementAccessPackageCatalogResourceResourceScopesOperationOptions, predicate AccessPackageResourceScopeOperationPredicate) (result ListEntitlementManagementAccessPackageCatalogResourceResourceScopesCompleteResult, err error) {
