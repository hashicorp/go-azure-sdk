...
func (c EntitlementManagementAccessPackageCatalogResourceResourceRoleClient) GetEntitlementManagementAccessPackageCatalogResourceResourceRolesCount(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogIdAccessPackageResourceId, options GetEntitlementManagementAccessPackageCatalogResourceResourceRolesCountOperationOptions) (result GetEntitlementManagementAccessPackageCatalogResourceResourceRolesCountOperationResponse, err error) {
