...
func (c EntitlementManagementAssignmentRequestClient) CreateEntitlementManagementAssignmentRequest(ctx context.Context, input beta.AccessPackageAssignmentRequest) (result CreateEntitlementManagementAssignmentRequestOperationResponse, err error) {
