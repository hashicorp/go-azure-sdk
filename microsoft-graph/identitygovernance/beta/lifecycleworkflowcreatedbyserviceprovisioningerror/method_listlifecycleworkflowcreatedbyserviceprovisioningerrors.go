...
// from a user object.
func (c LifecycleWorkflowCreatedByServiceProvisioningErrorClient) ListLifecycleWorkflowCreatedByServiceProvisioningErrors(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowCreatedByServiceProvisioningErrorsOperationOptions) (result ListLifecycleWorkflowCreatedByServiceProvisioningErrorsOperationResponse, err error) {
...
func (c LifecycleWorkflowCreatedByServiceProvisioningErrorClient) ListLifecycleWorkflowCreatedByServiceProvisioningErrorsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowCreatedByServiceProvisioningErrorsOperationOptions) (ListLifecycleWorkflowCreatedByServiceProvisioningErrorsCompleteResult, error) {
...
func (c LifecycleWorkflowCreatedByServiceProvisioningErrorClient) ListLifecycleWorkflowCreatedByServiceProvisioningErrorsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowCreatedByServiceProvisioningErrorsOperationOptions, predicate ServiceProvisioningErrorOperationPredicate) (result ListLifecycleWorkflowCreatedByServiceProvisioningErrorsCompleteResult, err error) {
