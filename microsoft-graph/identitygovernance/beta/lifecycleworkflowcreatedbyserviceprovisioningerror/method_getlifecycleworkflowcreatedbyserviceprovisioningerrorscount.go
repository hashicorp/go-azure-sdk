...
func (c LifecycleWorkflowCreatedByServiceProvisioningErrorClient) GetLifecycleWorkflowCreatedByServiceProvisioningErrorsCount(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowCreatedByServiceProvisioningErrorsCountOperationOptions) (result GetLifecycleWorkflowCreatedByServiceProvisioningErrorsCountOperationResponse, err error) {
