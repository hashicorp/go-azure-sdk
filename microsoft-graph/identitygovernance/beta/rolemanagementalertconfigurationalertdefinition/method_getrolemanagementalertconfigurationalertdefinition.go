...
func (c RoleManagementAlertConfigurationAlertDefinitionClient) GetRoleManagementAlertConfigurationAlertDefinition(ctx context.Context, id beta.IdentityGovernanceRoleManagementAlertAlertConfigurationId, options GetRoleManagementAlertConfigurationAlertDefinitionOperationOptions) (result GetRoleManagementAlertConfigurationAlertDefinitionOperationResponse, err error) {
