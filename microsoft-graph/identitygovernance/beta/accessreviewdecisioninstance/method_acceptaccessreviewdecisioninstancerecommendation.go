...
type AcceptAccessReviewDecisionInstanceRecommendationOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

// AcceptAccessReviewDecisionInstanceRecommendation - Invoke action acceptRecommendations. Allows the acceptance of
...
func (c AccessReviewDecisionInstanceClient) AcceptAccessReviewDecisionInstanceRecommendation(ctx context.Context, id beta.IdentityGovernanceAccessReviewDecisionId) (result AcceptAccessReviewDecisionInstanceRecommendationOperationResponse, err error) {
