...
func (c LifecycleWorkflowVersionClient) GetLifecycleWorkflowVersionsCount(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowVersionsCountOperationOptions) (result GetLifecycleWorkflowVersionsCountOperationResponse, err error) {
