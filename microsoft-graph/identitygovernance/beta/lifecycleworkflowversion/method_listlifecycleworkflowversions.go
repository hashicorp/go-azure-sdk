...
// properties.
func (c LifecycleWorkflowVersionClient) ListLifecycleWorkflowVersions(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowVersionsOperationOptions) (result ListLifecycleWorkflowVersionsOperationResponse, err error) {
...
func (c LifecycleWorkflowVersionClient) ListLifecycleWorkflowVersionsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowVersionsOperationOptions) (ListLifecycleWorkflowVersionsCompleteResult, error) {
