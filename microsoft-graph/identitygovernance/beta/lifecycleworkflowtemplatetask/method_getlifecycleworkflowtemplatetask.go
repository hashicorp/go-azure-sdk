...
func (c LifecycleWorkflowTemplateTaskClient) GetLifecycleWorkflowTemplateTask(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowTemplateIdTaskId, options GetLifecycleWorkflowTemplateTaskOperationOptions) (result GetLifecycleWorkflowTemplateTaskOperationResponse, err error) {
