...
func (c LifecycleWorkflowTemplateTaskClient) ListLifecycleWorkflowTemplateTasks(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowTemplateId, options ListLifecycleWorkflowTemplateTasksOperationOptions) (result ListLifecycleWorkflowTemplateTasksOperationResponse, err error) {
...
func (c LifecycleWorkflowTemplateTaskClient) ListLifecycleWorkflowTemplateTasksComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowTemplateId, options ListLifecycleWorkflowTemplateTasksOperationOptions) (ListLifecycleWorkflowTemplateTasksCompleteResult, error) {
