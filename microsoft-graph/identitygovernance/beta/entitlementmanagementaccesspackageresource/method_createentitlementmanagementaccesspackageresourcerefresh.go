...
func (c EntitlementManagementAccessPackageResourceClient) CreateEntitlementManagementAccessPackageResourceRefresh(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceId) (result CreateEntitlementManagementAccessPackageResourceRefreshOperationResponse, err error) {
