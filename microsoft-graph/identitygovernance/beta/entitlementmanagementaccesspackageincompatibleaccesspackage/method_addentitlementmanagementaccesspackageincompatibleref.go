...
func (c EntitlementManagementAccessPackageIncompatibleAccessPackageClient) AddEntitlementManagementAccessPackageIncompatibleRef(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageId, input beta.ReferenceCreate) (result AddEntitlementManagementAccessPackageIncompatibleRefOperationResponse, err error) {
