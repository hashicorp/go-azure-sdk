...
// identityGovernance
func (c PrivilegedAccessGroupEligibilityScheduleClient) CreatePrivilegedAccessGroupEligibilitySchedule(ctx context.Context, input beta.PrivilegedAccessGroupEligibilitySchedule) (result CreatePrivilegedAccessGroupEligibilityScheduleOperationResponse, err error) {
