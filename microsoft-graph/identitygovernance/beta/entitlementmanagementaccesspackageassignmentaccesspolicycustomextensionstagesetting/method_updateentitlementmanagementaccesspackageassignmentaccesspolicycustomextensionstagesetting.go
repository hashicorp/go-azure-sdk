...
func (c EntitlementManagementAccessPackageAssignmentAccessPolicyCustomExtensionStageSettingClient) UpdateEntitlementManagementAccessPackageAssignmentAccessPolicyCustomExtensionStageSetting(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentIdAccessPackageAccessPackageAssignmentPolicyIdCustomExtensionStageSettingId, input beta.CustomExtensionStageSetting) (result UpdateEntitlementManagementAccessPackageAssignmentAccessPolicyCustomExtensionStageSettingOperationResponse, err error) {
