...
func (c LifecycleWorkflowUserProcessingResultTaskProcessingResultClient) ListLifecycleWorkflowUserProcessingResultTaskProcessingResults(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultId, options ListLifecycleWorkflowUserProcessingResultTaskProcessingResultsOperationOptions) (result ListLifecycleWorkflowUserProcessingResultTaskProcessingResultsOperationResponse, err error) {
...
func (c LifecycleWorkflowUserProcessingResultTaskProcessingResultClient) ListLifecycleWorkflowUserProcessingResultTaskProcessingResultsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultId, options ListLifecycleWorkflowUserProcessingResultTaskProcessingResultsOperationOptions) (ListLifecycleWorkflowUserProcessingResultTaskProcessingResultsCompleteResult, error) {
