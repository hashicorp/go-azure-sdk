...
func (c LifecycleWorkflowUserProcessingResultTaskProcessingResultClient) GetLifecycleWorkflowUserProcessingResultTaskCount(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultId, options GetLifecycleWorkflowUserProcessingResultTaskCountOperationOptions) (result GetLifecycleWorkflowUserProcessingResultTaskCountOperationResponse, err error) {
