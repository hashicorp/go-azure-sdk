...
func (c EntitlementManagementAccessPackageResourceRoleClient) CreateEntitlementManagementAccessPackageResourceRole(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceId, input beta.AccessPackageResourceRole) (result CreateEntitlementManagementAccessPackageResourceRoleOperationResponse, err error) {
