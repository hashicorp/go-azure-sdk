...
func userAgent() string {
	return "hashicorp/go-azure-sdk/entitlementmanagementaccesspackageresourcerolescoperesourceaccesspackageresourceroleaccesspackageresourceresourceenvironment/beta"
}
