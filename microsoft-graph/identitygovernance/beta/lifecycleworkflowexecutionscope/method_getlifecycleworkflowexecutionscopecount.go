...
func (c LifecycleWorkflowExecutionScopeClient) GetLifecycleWorkflowExecutionScopeCount(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowExecutionScopeCountOperationOptions) (result GetLifecycleWorkflowExecutionScopeCountOperationResponse, err error) {
