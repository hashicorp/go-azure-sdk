...
func (c LifecycleWorkflowExecutionScopeClient) ListLifecycleWorkflowExecutionScopes(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowExecutionScopesOperationOptions) (result ListLifecycleWorkflowExecutionScopesOperationResponse, err error) {
...
func (c LifecycleWorkflowExecutionScopeClient) ListLifecycleWorkflowExecutionScopesComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowExecutionScopesOperationOptions) (ListLifecycleWorkflowExecutionScopesCompleteResult, error) {
