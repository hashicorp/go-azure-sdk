...
func (c PrivilegedAccessGroupClient) UpdatePrivilegedAccessGroup(ctx context.Context, input beta.PrivilegedAccessGroup) (result UpdatePrivilegedAccessGroupOperationResponse, err error) {
