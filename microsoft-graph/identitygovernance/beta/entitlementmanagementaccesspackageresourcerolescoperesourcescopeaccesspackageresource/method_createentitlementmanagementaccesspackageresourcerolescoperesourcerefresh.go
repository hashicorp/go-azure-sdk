...
func (c EntitlementManagementAccessPackageResourceRoleScopeResourceScopeAccessPackageResourceClient) CreateEntitlementManagementAccessPackageResourceRoleScopeResourceRefresh(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageIdAccessPackageResourceRoleScopeId) (result CreateEntitlementManagementAccessPackageResourceRoleScopeResourceRefreshOperationResponse, err error) {
