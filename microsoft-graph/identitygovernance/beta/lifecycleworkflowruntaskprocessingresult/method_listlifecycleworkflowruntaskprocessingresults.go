...
// for a run.
func (c LifecycleWorkflowRunTaskProcessingResultClient) ListLifecycleWorkflowRunTaskProcessingResults(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options ListLifecycleWorkflowRunTaskProcessingResultsOperationOptions) (result ListLifecycleWorkflowRunTaskProcessingResultsOperationResponse, err error) {
...
func (c LifecycleWorkflowRunTaskProcessingResultClient) ListLifecycleWorkflowRunTaskProcessingResultsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options ListLifecycleWorkflowRunTaskProcessingResultsOperationOptions) (ListLifecycleWorkflowRunTaskProcessingResultsCompleteResult, error) {
...
func (c LifecycleWorkflowRunTaskProcessingResultClient) ListLifecycleWorkflowRunTaskProcessingResultsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunId, options ListLifecycleWorkflowRunTaskProcessingResultsOperationOptions, predicate IdentityGovernanceTaskProcessingResultOperationPredicate) (result ListLifecycleWorkflowRunTaskProcessingResultsCompleteResult, err error) {
