package rolemanagementalertdefinition
...
func (c RoleManagementAlertDefinitionClient) ListRoleManagementAlertDefinitions(ctx context.Context, options ListRoleManagementAlertDefinitionsOperationOptions) (result ListRoleManagementAlertDefinitionsOperationResponse, err error) {
...
func (c RoleManagementAlertDefinitionClient) ListRoleManagementAlertDefinitionsComplete(ctx context.Context, options ListRoleManagementAlertDefinitionsOperationOptions) (ListRoleManagementAlertDefinitionsCompleteResult, error) {
...
func (c RoleManagementAlertDefinitionClient) ListRoleManagementAlertDefinitionsCompleteMatchingPredicate(ctx context.Context, options ListRoleManagementAlertDefinitionsOperationOptions, predicate UnifiedRoleManagementAlertDefinitionOperationPredicate) (result ListRoleManagementAlertDefinitionsCompleteResult, err error) {
