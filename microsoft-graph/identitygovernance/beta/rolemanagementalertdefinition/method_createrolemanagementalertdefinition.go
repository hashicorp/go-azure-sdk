...
func (c RoleManagementAlertDefinitionClient) CreateRoleManagementAlertDefinition(ctx context.Context, input beta.UnifiedRoleManagementAlertDefinition) (result CreateRoleManagementAlertDefinitionOperationResponse, err error) {
