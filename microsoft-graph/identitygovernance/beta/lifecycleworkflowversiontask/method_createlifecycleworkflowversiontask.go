...
func (c LifecycleWorkflowVersionTaskClient) CreateLifecycleWorkflowVersionTask(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, input beta.IdentityGovernanceTask) (result CreateLifecycleWorkflowVersionTaskOperationResponse, err error) {
