...
// workflowVersion.
func (c LifecycleWorkflowVersionTaskClient) ListLifecycleWorkflowVersionTasks(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options ListLifecycleWorkflowVersionTasksOperationOptions) (result ListLifecycleWorkflowVersionTasksOperationResponse, err error) {
...
func (c LifecycleWorkflowVersionTaskClient) ListLifecycleWorkflowVersionTasksComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options ListLifecycleWorkflowVersionTasksOperationOptions) (ListLifecycleWorkflowVersionTasksCompleteResult, error) {
