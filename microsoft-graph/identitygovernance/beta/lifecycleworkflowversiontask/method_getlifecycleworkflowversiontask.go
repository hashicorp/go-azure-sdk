...
func (c LifecycleWorkflowVersionTaskClient) GetLifecycleWorkflowVersionTask(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskId, options GetLifecycleWorkflowVersionTaskOperationOptions) (result GetLifecycleWorkflowVersionTaskOperationResponse, err error) {
