...
// the workflow.
func (c LifecycleWorkflowVersionLastModifiedByClient) GetLifecycleWorkflowVersionLastModifiedBy(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options GetLifecycleWorkflowVersionLastModifiedByOperationOptions) (result GetLifecycleWorkflowVersionLastModifiedByOperationResponse, err error) {
