...
func (c EntitlementManagementAccessPackageCatalogResourceResourceRoleResourceResourceScopeClient) DeleteEntitlementManagementAccessPackageCatalogResourceResourceRoleResourceResourceScope(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogIdAccessPackageResourceIdAccessPackageResourceRoleIdAccessPackageResourceAccessPackageResourceScopeId, options DeleteEntitlementManagementAccessPackageCatalogResourceResourceRoleResourceResourceScopeOperationOptions) (result DeleteEntitlementManagementAccessPackageCatalogResourceResourceRoleResourceResourceScopeOperationResponse, err error) {
