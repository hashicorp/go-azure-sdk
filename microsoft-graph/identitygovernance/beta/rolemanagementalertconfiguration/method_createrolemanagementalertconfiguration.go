...
func (c RoleManagementAlertConfigurationClient) CreateRoleManagementAlertConfiguration(ctx context.Context, input beta.UnifiedRoleManagementAlertConfiguration) (result CreateRoleManagementAlertConfigurationOperationResponse, err error) {
