...
func (c EntitlementManagementAccessPackageAssignmentAccessPolicyCustomExtensionHandlerClient) CreateEntitlementManagementAccessPackageAssignmentAccessPolicyCustomExtensionHandler(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentIdAccessPackageAccessPackageAssignmentPolicyId, input beta.CustomExtensionHandler) (result CreateEntitlementManagementAccessPackageAssignmentAccessPolicyCustomExtensionHandlerOperationResponse, err error) {
