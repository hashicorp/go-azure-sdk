...
func (c TermsOfUseAgreementAcceptanceClient) CreateTermsOfUseAgreementAcceptance(ctx context.Context, input beta.AgreementAcceptance) (result CreateTermsOfUseAgreementAcceptanceOperationResponse, err error) {
