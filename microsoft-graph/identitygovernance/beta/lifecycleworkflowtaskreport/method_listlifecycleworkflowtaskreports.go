...
func (c LifecycleWorkflowTaskReportClient) ListLifecycleWorkflowTaskReports(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowTaskReportsOperationOptions) (result ListLifecycleWorkflowTaskReportsOperationResponse, err error) {
...
func (c LifecycleWorkflowTaskReportClient) ListLifecycleWorkflowTaskReportsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options ListLifecycleWorkflowTaskReportsOperationOptions) (ListLifecycleWorkflowTaskReportsCompleteResult, error) {
