...
func userAgent() string {
	return "hashicorp/go-azure-sdk/entitlementmanagementaccesspackageresourcerolescoperesourceroleaccesspackageresourceresourceaccesspackageresourceenvironment/beta"
}
