...
// DeleteRoleManagementAlert - Delete navigation property alerts for identityGovernance
func (c RoleManagementAlertAlertClient) DeleteRoleManagementAlert(ctx context.Context, id beta.IdentityGovernanceRoleManagementAlertAlertId, options DeleteRoleManagementAlertOperationOptions) (result DeleteRoleManagementAlertOperationResponse, err error) {
