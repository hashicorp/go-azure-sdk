...
func (c LifecycleWorkflowRunUserProcessingResultTaskProcessingResultClient) GetLifecycleWorkflowRunUserProcessingResultTaskProcessingResult(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdUserProcessingResultIdTaskProcessingResultId, options GetLifecycleWorkflowRunUserProcessingResultTaskProcessingResultOperationOptions) (result GetLifecycleWorkflowRunUserProcessingResultTaskProcessingResultOperationResponse, err error) {
