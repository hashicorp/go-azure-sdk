...
func (c EntitlementManagementAccessPackageAssignmentIncompatibleAccessPackageClient) ListEntitlementManagementAccessPackageAssignmentIncompatibleRefs(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options ListEntitlementManagementAccessPackageAssignmentIncompatibleRefsOperationOptions) (result ListEntitlementManagementAccessPackageAssignmentIncompatibleRefsOperationResponse, err error) {
...
func (c EntitlementManagementAccessPackageAssignmentIncompatibleAccessPackageClient) ListEntitlementManagementAccessPackageAssignmentIncompatibleRefsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options ListEntitlementManagementAccessPackageAssignmentIncompatibleRefsOperationOptions, predicate DirectoryObjectOperationPredicate) (result ListEntitlementManagementAccessPackageAssignmentIncompatibleRefsCompleteResult, err error) {
