...
func (c EntitlementManagementAccessPackageAssignmentIncompatibleAccessPackageClient) GetEntitlementManagementAccessPackageAssignmentIncompatibleCount(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, options GetEntitlementManagementAccessPackageAssignmentIncompatibleCountOperationOptions) (result GetEntitlementManagementAccessPackageAssignmentIncompatibleCountOperationResponse, err error) {
