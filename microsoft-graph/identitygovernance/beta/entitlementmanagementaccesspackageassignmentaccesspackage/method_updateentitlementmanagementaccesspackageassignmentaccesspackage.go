...
// identityGovernance
func (c EntitlementManagementAccessPackageAssignmentAccessPackageClient) UpdateEntitlementManagementAccessPackageAssignmentAccessPackage(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, input beta.AccessPackage) (result UpdateEntitlementManagementAccessPackageAssignmentAccessPackageOperationResponse, err error) {
