...
func (c LifecycleWorkflowRunTaskProcessingResultTaskClient) GetLifecycleWorkflowRunTaskProcessingResultTask(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdRunIdTaskProcessingResultId, options GetLifecycleWorkflowRunTaskProcessingResultTaskOperationOptions) (result GetLifecycleWorkflowRunTaskProcessingResultTaskOperationResponse, err error) {
