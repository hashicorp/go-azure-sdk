...
func (c LifecycleWorkflowWorkflowClient) GetLifecycleWorkflow(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowOperationOptions) (result GetLifecycleWorkflowOperationResponse, err error) {
