...
func (c EntitlementManagementAccessPackageResourceRoleScopeScopeAccessPackageResourceClient) UpdateEntitlementManagementAccessPackageResourceRoleScopeScopeAccessPackageResource(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopeId, input beta.AccessPackageResource) (result UpdateEntitlementManagementAccessPackageResourceRoleScopeScopeAccessPackageResourceOperationResponse, err error) {
