...
func (c EntitlementManagementAccessPackageResourceRoleScopeScopeAccessPackageResourceClient) CreateEntitlementManagementAccessPackageResourceRoleScopeScopeRefresh(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopeId) (result CreateEntitlementManagementAccessPackageResourceRoleScopeScopeRefreshOperationResponse, err error) {
