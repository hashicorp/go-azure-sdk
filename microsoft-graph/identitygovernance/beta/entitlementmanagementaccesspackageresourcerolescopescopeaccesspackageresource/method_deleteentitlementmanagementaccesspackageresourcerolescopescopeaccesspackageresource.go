...
func (c EntitlementManagementAccessPackageResourceRoleScopeScopeAccessPackageResourceClient) DeleteEntitlementManagementAccessPackageResourceRoleScopeScopeAccessPackageResource(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopeId, options DeleteEntitlementManagementAccessPackageResourceRoleScopeScopeAccessPackageResourceOperationOptions) (result DeleteEntitlementManagementAccessPackageResourceRoleScopeScopeAccessPackageResourceOperationResponse, err error) {
