...
func (c EntitlementManagementAccessPackageCatalogResourceResourceRoleResourceClient) CreateEntitlementManagementAccessPackageCatalogResourceResourceRoleResourceRefresh(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogIdAccessPackageResourceIdAccessPackageResourceRoleId) (result CreateEntitlementManagementAccessPackageCatalogResourceResourceRoleResourceRefreshOperationResponse, err error) {
