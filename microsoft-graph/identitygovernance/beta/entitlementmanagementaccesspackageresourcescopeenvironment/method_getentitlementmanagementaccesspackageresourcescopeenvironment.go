...
func (c EntitlementManagementAccessPackageResourceScopeEnvironmentClient) GetEntitlementManagementAccessPackageResourceScopeEnvironment(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceIdAccessPackageResourceScopeId, options GetEntitlementManagementAccessPackageResourceScopeEnvironmentOperationOptions) (result GetEntitlementManagementAccessPackageResourceScopeEnvironmentOperationResponse, err error) {
