...
func (c EntitlementManagementAccessPackageAssignmentAccessPolicyClient) DeleteEntitlementManagementAccessPackageAssignmentAccessPolicy(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentIdAccessPackageAccessPackageAssignmentPolicyId, options DeleteEntitlementManagementAccessPackageAssignmentAccessPolicyOperationOptions) (result DeleteEntitlementManagementAccessPackageAssignmentAccessPolicyOperationResponse, err error) {
