...
func (c EntitlementManagementAccessPackageAssignmentAccessPolicyClient) CreateEntitlementManagementAccessPackageAssignmentAccessPolicy(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentId, input beta.AccessPackageAssignmentPolicy) (result CreateEntitlementManagementAccessPackageAssignmentAccessPolicyOperationResponse, err error) {
