...
func (c EntitlementManagementAccessPackageResourceRoleScopeScopeAccessAccessAccessScopeClient) ListEntitlementManagementAccessPackageResourceRoleScopeScopeAccessAccessAccessScopesComplete(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopeIdAccessPackageResourceScopeAccessPackageResourceAccessPackageResourceRoleId, options ListEntitlementManagementAccessPackageResourceRoleScopeScopeAccessAccessAccessScopesOperationOptions) (ListEntitlementManagementAccessPackageResourceRoleScopeScopeAccessAccessAccessScopesCompleteResult, error) {
...
func (c EntitlementManagementAccessPackageResourceRoleScopeScopeAccessAccessAccessScopeClient) ListEntitlementManagementAccessPackageResourceRoleScopeScopeAccessAccessAccessScopesCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopeIdAccessPackageResourceScopeAccessPackageResourceAccessPackageResourceRoleId, options ListEntitlementManagementAccessPackageResourceRoleScopeScopeAccessAccessAccessScopesOperationOptions, predicate AccessPackageResourceScopeOperationPredicate) (result ListEntitlementManagementAccessPackageResourceRoleScopeScopeAccessAccessAccessScopesCompleteResult, err error) {
