...
func (c EntitlementManagementAccessPackageCatalogResourceRoleResourceClient) UpdateEntitlementManagementAccessPackageCatalogResourceRoleResource(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogIdAccessPackageResourceRoleId, input beta.AccessPackageResource) (result UpdateEntitlementManagementAccessPackageCatalogResourceRoleResourceOperationResponse, err error) {
