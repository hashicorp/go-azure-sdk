...
func (c LifecycleWorkflowWorkflowVersionTaskTaskProcessingResultSubjectMailboxSettingClient) UpdateLifecycleWorkflowVersionTaskProcessingResultSubjectMailboxSetting(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskIdTaskProcessingResultId, input beta.MailboxSettings) (result UpdateLifecycleWorkflowVersionTaskProcessingResultSubjectMailboxSettingOperationResponse, err error) {
