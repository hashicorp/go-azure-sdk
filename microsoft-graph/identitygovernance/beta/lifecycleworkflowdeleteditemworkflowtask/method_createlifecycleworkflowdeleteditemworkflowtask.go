...
func (c LifecycleWorkflowDeletedItemWorkflowTaskClient) CreateLifecycleWorkflowDeletedItemWorkflowTask(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowDeletedItemWorkflowId, input beta.IdentityGovernanceTask) (result CreateLifecycleWorkflowDeletedItemWorkflowTaskOperationResponse, err error) {
