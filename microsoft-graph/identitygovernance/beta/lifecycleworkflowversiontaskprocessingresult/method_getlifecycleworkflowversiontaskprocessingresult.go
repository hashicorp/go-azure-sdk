...
// processing the task.
func (c LifecycleWorkflowVersionTaskProcessingResultClient) GetLifecycleWorkflowVersionTaskProcessingResult(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskIdTaskProcessingResultId, options GetLifecycleWorkflowVersionTaskProcessingResultOperationOptions) (result GetLifecycleWorkflowVersionTaskProcessingResultOperationResponse, err error) {
