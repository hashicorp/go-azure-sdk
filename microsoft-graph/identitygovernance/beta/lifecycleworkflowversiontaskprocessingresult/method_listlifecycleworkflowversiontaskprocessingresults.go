...
func (c LifecycleWorkflowVersionTaskProcessingResultClient) ListLifecycleWorkflowVersionTaskProcessingResultsComplete(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskId, options ListLifecycleWorkflowVersionTaskProcessingResultsOperationOptions) (ListLifecycleWorkflowVersionTaskProcessingResultsCompleteResult, error) {
...
func (c LifecycleWorkflowVersionTaskProcessingResultClient) ListLifecycleWorkflowVersionTaskProcessingResultsCompleteMatchingPredicate(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskId, options ListLifecycleWorkflowVersionTaskProcessingResultsOperationOptions, predicate IdentityGovernanceTaskProcessingResultOperationPredicate) (result ListLifecycleWorkflowVersionTaskProcessingResultsCompleteResult, err error) {
