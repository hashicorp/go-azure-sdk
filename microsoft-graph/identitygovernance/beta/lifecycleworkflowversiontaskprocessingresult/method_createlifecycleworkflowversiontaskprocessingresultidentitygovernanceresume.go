...
func (c LifecycleWorkflowVersionTaskProcessingResultClient) CreateLifecycleWorkflowVersionTaskProcessingResultIdentityGovernanceResume(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionIdTaskIdTaskProcessingResultId, input CreateLifecycleWorkflowVersionTaskProcessingResultIdentityGovernanceResumeRequest) (result CreateLifecycleWorkflowVersionTaskProcessingResultIdentityGovernanceResumeOperationResponse, err error) {
