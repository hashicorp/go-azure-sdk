...
func (c EntitlementManagementAccessPackageCatalogResourceClient) CreateEntitlementManagementAccessPackageCatalogResourceRefresh(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogIdAccessPackageResourceId) (result CreateEntitlementManagementAccessPackageCatalogResourceRefreshOperationResponse, err error) {
