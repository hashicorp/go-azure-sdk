...
// identityGovernance
func (c EntitlementManagementAccessPackageCatalogResourceClient) DeleteEntitlementManagementAccessPackageCatalogResource(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogIdAccessPackageResourceId, options DeleteEntitlementManagementAccessPackageCatalogResourceOperationOptions) (result DeleteEntitlementManagementAccessPackageCatalogResourceOperationResponse, err error) {
