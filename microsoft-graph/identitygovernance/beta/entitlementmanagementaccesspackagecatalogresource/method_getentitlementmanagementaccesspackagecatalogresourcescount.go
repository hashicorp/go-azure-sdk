...
func (c EntitlementManagementAccessPackageCatalogResourceClient) GetEntitlementManagementAccessPackageCatalogResourcesCount(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogId, options GetEntitlementManagementAccessPackageCatalogResourcesCountOperationOptions) (result GetEntitlementManagementAccessPackageCatalogResourcesCountOperationResponse, err error) {
