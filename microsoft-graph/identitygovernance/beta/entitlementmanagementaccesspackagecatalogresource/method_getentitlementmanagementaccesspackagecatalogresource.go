...
func (c EntitlementManagementAccessPackageCatalogResourceClient) GetEntitlementManagementAccessPackageCatalogResource(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogIdAccessPackageResourceId, options GetEntitlementManagementAccessPackageCatalogResourceOperationOptions) (result GetEntitlementManagementAccessPackageCatalogResourceOperationResponse, err error) {
