...
func (c EntitlementManagementAccessPackageCatalogResourceClient) CreateEntitlementManagementAccessPackageCatalogResource(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogId, input beta.AccessPackageResource) (result CreateEntitlementManagementAccessPackageCatalogResourceOperationResponse, err error) {
