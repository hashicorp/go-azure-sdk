...
func (c EntitlementManagementAccessPackageCatalogResourceClient) ListEntitlementManagementAccessPackageCatalogResources(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogId, options ListEntitlementManagementAccessPackageCatalogResourcesOperationOptions) (result ListEntitlementManagementAccessPackageCatalogResourcesOperationResponse, err error) {
...
func (c EntitlementManagementAccessPackageCatalogResourceClient) ListEntitlementManagementAccessPackageCatalogResourcesComplete(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageCatalogId, options ListEntitlementManagementAccessPackageCatalogResourcesOperationOptions) (ListEntitlementManagementAccessPackageCatalogResourcesCompleteResult, error) {
