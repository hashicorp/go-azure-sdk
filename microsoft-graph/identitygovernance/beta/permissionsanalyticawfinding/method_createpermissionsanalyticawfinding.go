...
func (c PermissionsAnalyticAwFindingClient) CreatePermissionsAnalyticAwFinding(ctx context.Context, input beta.Finding) (result CreatePermissionsAnalyticAwFindingOperationResponse, err error) {
