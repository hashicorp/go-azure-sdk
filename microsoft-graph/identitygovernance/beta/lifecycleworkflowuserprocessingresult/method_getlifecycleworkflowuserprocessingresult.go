...
// execution results.
func (c LifecycleWorkflowUserProcessingResultClient) GetLifecycleWorkflowUserProcessingResult(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdUserProcessingResultId, options GetLifecycleWorkflowUserProcessingResultOperationOptions) (result GetLifecycleWorkflowUserProcessingResultOperationResponse, err error) {
