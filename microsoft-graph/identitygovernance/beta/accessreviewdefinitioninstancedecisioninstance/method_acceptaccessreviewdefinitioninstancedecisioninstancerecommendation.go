...
type AcceptAccessReviewDefinitionInstanceDecisionInstanceRecommendationOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

// AcceptAccessReviewDefinitionInstanceDecisionInstanceRecommendation - Invoke action acceptRecommendations. Allows the
...
func (c AccessReviewDefinitionInstanceDecisionInstanceClient) AcceptAccessReviewDefinitionInstanceDecisionInstanceRecommendation(ctx context.Context, id beta.IdentityGovernanceAccessReviewDefinitionIdInstanceIdDecisionId) (result AcceptAccessReviewDefinitionInstanceDecisionInstanceRecommendationOperationResponse, err error) {
