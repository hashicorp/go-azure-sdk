...
func (c LifecycleWorkflowVersionCreatedByClient) GetLifecycleWorkflowVersionCreatedBy(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowIdVersionId, options GetLifecycleWorkflowVersionCreatedByOperationOptions) (result GetLifecycleWorkflowVersionCreatedByOperationResponse, err error) {
