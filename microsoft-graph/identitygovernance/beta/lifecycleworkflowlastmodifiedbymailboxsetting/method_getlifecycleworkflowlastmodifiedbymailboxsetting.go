...
// on $select.
func (c LifecycleWorkflowLastModifiedByMailboxSettingClient) GetLifecycleWorkflowLastModifiedByMailboxSetting(ctx context.Context, id beta.IdentityGovernanceLifecycleWorkflowWorkflowId, options GetLifecycleWorkflowLastModifiedByMailboxSettingOperationOptions) (result GetLifecycleWorkflowLastModifiedByMailboxSettingOperationResponse, err error) {
