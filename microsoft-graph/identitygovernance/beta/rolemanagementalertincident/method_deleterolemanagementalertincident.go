...
func (c RoleManagementAlertIncidentClient) DeleteRoleManagementAlertIncident(ctx context.Context, id beta.IdentityGovernanceRoleManagementAlertAlertIdAlertIncidentId, options DeleteRoleManagementAlertIncidentOperationOptions) (result DeleteRoleManagementAlertIncidentOperationResponse, err error) {
