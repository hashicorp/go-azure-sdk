...
func (c RoleManagementAlertIncidentClient) GetRoleManagementAlertIncidentsCount(ctx context.Context, id beta.IdentityGovernanceRoleManagementAlertAlertId, options GetRoleManagementAlertIncidentsCountOperationOptions) (result GetRoleManagementAlertIncidentsCountOperationResponse, err error) {
