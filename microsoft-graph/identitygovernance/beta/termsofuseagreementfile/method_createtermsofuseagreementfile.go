...
func (c TermsOfUseAgreementFileClient) CreateTermsOfUseAgreementFile(ctx context.Context, id beta.IdentityGovernanceTermsOfUseAgreementId, input beta.AgreementFileLocalization) (result CreateTermsOfUseAgreementFileOperationResponse, err error) {
