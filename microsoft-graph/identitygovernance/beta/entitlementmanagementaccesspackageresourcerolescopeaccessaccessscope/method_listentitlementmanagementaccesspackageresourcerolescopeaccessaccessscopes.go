...
func (c EntitlementManagementAccessPackageResourceRoleScopeAccessAccessScopeClient) ListEntitlementManagementAccessPackageResourceRoleScopeAccessAccessScopesComplete(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopeId, options ListEntitlementManagementAccessPackageResourceRoleScopeAccessAccessScopesOperationOptions) (ListEntitlementManagementAccessPackageResourceRoleScopeAccessAccessScopesCompleteResult, error) {
