...
func (c EntitlementManagementAccessPackageResourceRoleScopeAccessAccessScopeClient) DeleteEntitlementManagementAccessPackageResourceRoleScopeAccessAccessScope(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageResourceRoleScopeIdAccessPackageResourceRoleAccessPackageResourceAccessPackageResourceScopeId, options DeleteEntitlementManagementAccessPackageResourceRoleScopeAccessAccessScopeOperationOptions) (result DeleteEntitlementManagementAccessPackageResourceRoleScopeAccessAccessScopeOperationResponse, err error) {
