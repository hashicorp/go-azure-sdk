...
func (c PermissionsAnalyticClient) UpdatePermissionsAnalytic(ctx context.Context, input beta.PermissionsAnalyticsAggregation) (result UpdatePermissionsAnalyticOperationResponse, err error) {
