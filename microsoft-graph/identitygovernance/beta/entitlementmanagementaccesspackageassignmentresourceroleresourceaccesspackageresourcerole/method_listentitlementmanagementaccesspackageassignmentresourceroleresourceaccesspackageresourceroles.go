...
func (c EntitlementManagementAccessPackageAssignmentResourceRoleResourceAccessPackageResourceRoleClient) ListEntitlementManagementAccessPackageAssignmentResourceRoleResourceAccessPackageResourceRolesComplete(ctx context.Context, id beta.IdentityGovernanceEntitlementManagementAccessPackageAssignmentIdAccessPackageAssignmentResourceRoleId, options ListEntitlementManagementAccessPackageAssignmentResourceRoleResourceAccessPackageResourceRolesOperationOptions) (ListEntitlementManagementAccessPackageAssignmentResourceRoleResourceAccessPackageResourceRolesCompleteResult, error) {
