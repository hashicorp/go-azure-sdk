...
type TeamsAppRemovedEventMessageDetailOperationPredicate struct {
	ODataType           *string
	TeamsAppDisplayName *string
	TeamsAppId          *string
}

func (p TeamsAppRemovedEventMessageDetailOperationPredicate) Matches(input TeamsAppRemovedEventMessageDetail) bool {
