...
type DeviceConfigurationDeviceStateSummaryOperationPredicate struct {
...
func (p DeviceConfigurationDeviceStateSummaryOperationPredicate) Matches(input DeviceConfigurationDeviceStateSummary) bool {
