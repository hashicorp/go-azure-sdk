...
type MicrosoftStoreForBusinessAppOperationPredicate struct {
...
func (p MicrosoftStoreForBusinessAppOperationPredicate) Matches(input MicrosoftStoreForBusinessApp) bool {
	...
	if p.PackageIdentityName != nil && (input.PackageIdentityName == nil || *p.PackageIdentityName != *input.PackageIdentityName) {
		return false
	}
