...
type TenantAppManagementPolicyOperationPredicate struct {
...
func (p TenantAppManagementPolicyOperationPredicate) Matches(input TenantAppManagementPolicy) bool {
