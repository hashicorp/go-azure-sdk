...
type SecurityEdiscoveryPurgeDataOperationOperationPredicate struct {
...
func (p SecurityEdiscoveryPurgeDataOperationOperationPredicate) Matches(input SecurityEdiscoveryPurgeDataOperation) bool {
