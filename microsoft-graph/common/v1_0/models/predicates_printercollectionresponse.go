...
type PrinterCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p PrinterCollectionResponseOperationPredicate) Matches(input PrinterCollectionResponse) bool {
