...
type TeleconferenceDeviceScreenSharingQualityOperationPredicate struct {
...
func (p TeleconferenceDeviceScreenSharingQualityOperationPredicate) Matches(input TeleconferenceDeviceScreenSharingQuality) bool {
