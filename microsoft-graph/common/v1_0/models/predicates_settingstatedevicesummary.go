...
func (p SettingStateDeviceSummaryOperationPredicate) Matches(input SettingStateDeviceSummary) bool {
	...
	if p.InstancePath != nil && (input.InstancePath == nil || *p.InstancePath != *input.InstancePath) {
		return false
	}
