...
type DeviceCompliancePolicyDeviceStateSummaryOperationPredicate struct {
	CompliantDeviceCount     *int64
	ConfigManagerCount       *int64
	ConflictDeviceCount      *int64
	ErrorDeviceCount         *int64
	Id                       *string
	InGracePeriodCount       *int64
...
func (p DeviceCompliancePolicyDeviceStateSummaryOperationPredicate) Matches(input DeviceCompliancePolicyDeviceStateSummary) bool {

	if p.CompliantDeviceCount != nil && (input.CompliantDeviceCount == nil || *p.CompliantDeviceCount != *input.CompliantDeviceCount) {
		return false
	}

	if p.ConfigManagerCount != nil && (input.ConfigManagerCount == nil || *p.ConfigManagerCount != *input.ConfigManagerCount) {
		return false
	}
	...
	if p.InGracePeriodCount != nil && (input.InGracePeriodCount == nil || *p.InGracePeriodCount != *input.InGracePeriodCount) {
		return false
	}
