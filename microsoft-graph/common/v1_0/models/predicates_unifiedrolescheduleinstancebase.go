...
type UnifiedRoleScheduleInstanceBaseOperationPredicate struct {
	AppScopeId       *string
...
func (p UnifiedRoleScheduleInstanceBaseOperationPredicate) Matches(input UnifiedRoleScheduleInstanceBase) bool {
