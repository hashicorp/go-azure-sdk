...
type DeviceCompliancePolicySettingStateOperationPredicate struct {
	CurrentValue        *string
	ErrorCode           *int64
...
func (p DeviceCompliancePolicySettingStateOperationPredicate) Matches(input DeviceCompliancePolicySettingState) bool {
