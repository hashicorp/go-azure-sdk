...
type WindowsUniversalAppXOperationPredicate struct {
...
func (p WindowsUniversalAppXOperationPredicate) Matches(input WindowsUniversalAppX) bool {
	...
	if p.IsBundle != nil && (input.IsBundle == nil || *p.IsBundle != *input.IsBundle) {
		return false
	}
