...
type DeviceConfigurationUserOverviewOperationPredicate struct {
...
func (p DeviceConfigurationUserOverviewOperationPredicate) Matches(input DeviceConfigurationUserOverview) bool {
