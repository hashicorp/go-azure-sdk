...
func (p AccessReviewHistoryInstanceOperationPredicate) Matches(input AccessReviewHistoryInstance) bool {
	...
	if p.RunDateTime != nil && (input.RunDateTime == nil || *p.RunDateTime != *input.RunDateTime) {
		return false
	}
