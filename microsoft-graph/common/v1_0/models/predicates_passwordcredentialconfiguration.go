...
type PasswordCredentialConfigurationOperationPredicate struct {
	MaxLifetime                         *string
	ODataType                           *string
	RestrictForAppsCreatedAfterDateTime *string
}

func (p PasswordCredentialConfigurationOperationPredicate) Matches(input PasswordCredentialConfiguration) bool {
