...
type ContactCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p ContactCollectionResponseOperationPredicate) Matches(input ContactCollectionResponse) bool {
