...
func (p OpenShiftChangeRequestOperationPredicate) Matches(input OpenShiftChangeRequest) bool {
	...
	if p.OpenShiftId != nil && (input.OpenShiftId == nil || *p.OpenShiftId != *input.OpenShiftId) {
		return false
	}
