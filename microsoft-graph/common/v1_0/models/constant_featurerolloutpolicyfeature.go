...
const (
	...
	FeatureRolloutPolicyFeaturemultiFactorAuthentication      FeatureRolloutPolicyFeature = "MultiFactorAuthentication"
...
func PossibleValuesForFeatureRolloutPolicyFeature() []string {
	return []string{
		...
		string(FeatureRolloutPolicyFeaturemultiFactorAuthentication),
...
func parseFeatureRolloutPolicyFeature(input string) (*FeatureRolloutPolicyFeature, error) {
	vals := map[string]FeatureRolloutPolicyFeature{
		...
		"multifactorauthentication":      FeatureRolloutPolicyFeaturemultiFactorAuthentication,
