...
type IdentityGovernanceUsersProcessingSummaryOperationPredicate struct {
	FailedTasks     *int64
	FailedUsers     *int64
	ODataType       *string
...
func (p IdentityGovernanceUsersProcessingSummaryOperationPredicate) Matches(input IdentityGovernanceUsersProcessingSummary) bool {
