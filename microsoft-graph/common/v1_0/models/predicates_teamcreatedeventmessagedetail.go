...
type TeamCreatedEventMessageDetailOperationPredicate struct {
	ODataType       *string
...
func (p TeamCreatedEventMessageDetailOperationPredicate) Matches(input TeamCreatedEventMessageDetail) bool {
