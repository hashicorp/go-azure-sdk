...
type DomainDnsUnavailableRecordOperationPredicate struct {
	Description      *string
	Id               *string
	IsOptional       *bool
	Label            *string
...
func (p DomainDnsUnavailableRecordOperationPredicate) Matches(input DomainDnsUnavailableRecord) bool {
