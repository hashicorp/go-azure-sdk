...
type WebsiteCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p WebsiteCollectionResponseOperationPredicate) Matches(input WebsiteCollectionResponse) bool {
