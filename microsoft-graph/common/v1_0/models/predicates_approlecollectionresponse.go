...
type AppRoleCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p AppRoleCollectionResponseOperationPredicate) Matches(input AppRoleCollectionResponse) bool {
