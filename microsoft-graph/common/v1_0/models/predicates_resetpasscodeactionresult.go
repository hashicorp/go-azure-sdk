...
type ResetPasscodeActionResultOperationPredicate struct {
	ActionName          *string
...
func (p ResetPasscodeActionResultOperationPredicate) Matches(input ResetPasscodeActionResult) bool {
