...
type ProcessCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p ProcessCollectionResponseOperationPredicate) Matches(input ProcessCollectionResponse) bool {
