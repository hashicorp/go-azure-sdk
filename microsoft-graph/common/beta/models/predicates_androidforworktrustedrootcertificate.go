...
type AndroidForWorkTrustedRootCertificateOperationPredicate struct {
	CertFileName           *string
...
func (p AndroidForWorkTrustedRootCertificateOperationPredicate) Matches(input AndroidForWorkTrustedRootCertificate) bool {
