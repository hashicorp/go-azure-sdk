...
type DeviceOperatingSystemSummaryOperationPredicate struct {
	...
	AospUserAssociatedCount          *int64
	AospUserlessCount                *int64
	ChromeOSCount                    *int64
...
func (p DeviceOperatingSystemSummaryOperationPredicate) Matches(input DeviceOperatingSystemSummary) bool {
	...
	if p.AospUserAssociatedCount != nil && (input.AospUserAssociatedCount == nil || *p.AospUserAssociatedCount != *input.AospUserAssociatedCount) {
		return false
	}

	if p.AospUserlessCount != nil && (input.AospUserlessCount == nil || *p.AospUserlessCount != *input.AospUserlessCount) {
		return false
	}

	if p.ChromeOSCount != nil && (input.ChromeOSCount == nil || *p.ChromeOSCount != *input.ChromeOSCount) {
		return false
	}
	...
	if p.LinuxCount != nil && (input.LinuxCount == nil || *p.LinuxCount != *input.LinuxCount) {
		return false
	}
