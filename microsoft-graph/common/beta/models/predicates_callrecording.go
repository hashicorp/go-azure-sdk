...
func (p CallRecordingOperationPredicate) Matches(input CallRecording) bool {
	...
	if p.RecordingContentUrl != nil && (input.RecordingContentUrl == nil || *p.RecordingContentUrl != *input.RecordingContentUrl) {
		return false
	}
