...
type Windows81TrustedRootCertificateOperationPredicate struct {
	CertFileName           *string
...
func (p Windows81TrustedRootCertificateOperationPredicate) Matches(input Windows81TrustedRootCertificate) bool {
