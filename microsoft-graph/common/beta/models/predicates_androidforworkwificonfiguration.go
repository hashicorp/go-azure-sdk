...
type AndroidForWorkWiFiConfigurationOperationPredicate struct {
...
func (p AndroidForWorkWiFiConfigurationOperationPredicate) Matches(input AndroidForWorkWiFiConfiguration) bool {
