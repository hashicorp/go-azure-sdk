...
type AndroidForWorkCertificateProfileBaseOperationPredicate struct {
...
func (p AndroidForWorkCertificateProfileBaseOperationPredicate) Matches(input AndroidForWorkCertificateProfileBase) bool {
