...
type OrganizationalBrandingPropertiesOperationPredicate struct {
...
func (p OrganizationalBrandingPropertiesOperationPredicate) Matches(input OrganizationalBrandingProperties) bool {
