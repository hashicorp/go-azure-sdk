...
type AndroidWorkProfileGmailEasConfigurationOperationPredicate struct {
...
func (p AndroidWorkProfileGmailEasConfigurationOperationPredicate) Matches(input AndroidWorkProfileGmailEasConfiguration) bool {
