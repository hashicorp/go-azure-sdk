...
type PlannerExternalTaskSourceOperationPredicate struct {
...
func (p PlannerExternalTaskSourceOperationPredicate) Matches(input PlannerExternalTaskSource) bool {
