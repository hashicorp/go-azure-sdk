...
type SecurityEmailContentThreatSubmissionOperationPredicate struct {
...
func (p SecurityEmailContentThreatSubmissionOperationPredicate) Matches(input SecurityEmailContentThreatSubmission) bool {

	if p.CreatedDateTime != nil && (input.CreatedDateTime == nil || *p.CreatedDateTime != *input.CreatedDateTime) {
		return false
	}

	if p.FileContent != nil && (input.FileContent == nil || *p.FileContent != *input.FileContent) {
		return false
	}
