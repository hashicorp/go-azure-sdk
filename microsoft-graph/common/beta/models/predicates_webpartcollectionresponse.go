...
type WebPartCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p WebPartCollectionResponseOperationPredicate) Matches(input WebPartCollectionResponse) bool {
