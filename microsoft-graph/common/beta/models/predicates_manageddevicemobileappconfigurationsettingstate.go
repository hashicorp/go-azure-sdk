...
type ManagedDeviceMobileAppConfigurationSettingStateOperationPredicate struct {
	CurrentValue        *string
	ErrorCode           *int64
...
func (p ManagedDeviceMobileAppConfigurationSettingStateOperationPredicate) Matches(input ManagedDeviceMobileAppConfigurationSettingState) bool {
	...
	if p.SettingInstanceId != nil && (input.SettingInstanceId == nil || *p.SettingInstanceId != *input.SettingInstanceId) {
		return false
	}
