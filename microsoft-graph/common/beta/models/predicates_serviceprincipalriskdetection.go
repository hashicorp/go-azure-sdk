...
type ServicePrincipalRiskDetectionOperationPredicate struct {
...
func (p ServicePrincipalRiskDetectionOperationPredicate) Matches(input ServicePrincipalRiskDetection) bool {
