...
type IosVppAppRevokeLicensesActionResultOperationPredicate struct {
	ActionName          *string
...
func (p IosVppAppRevokeLicensesActionResultOperationPredicate) Matches(input IosVppAppRevokeLicensesActionResult) bool {
