...
const (
	...
	VppTokenStateduplicateLocationId   VppTokenState = "DuplicateLocationId"
...
func PossibleValuesForVppTokenState() []string {
	return []string{
		...
		string(VppTokenStateduplicateLocationId),
...
func parseVppTokenState(input string) (*VppTokenState, error) {
	vals := map[string]VppTokenState{
		...
		"duplicatelocationid":   VppTokenStateduplicateLocationId,
