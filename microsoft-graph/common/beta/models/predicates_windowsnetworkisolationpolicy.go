...
type WindowsNetworkIsolationPolicyOperationPredicate struct {
	EnterpriseIPRangesAreAuthoritative     *bool
	EnterpriseProxyServersAreAuthoritative *bool
	ODataType                              *string
}

func (p WindowsNetworkIsolationPolicyOperationPredicate) Matches(input WindowsNetworkIsolationPolicy) bool {
