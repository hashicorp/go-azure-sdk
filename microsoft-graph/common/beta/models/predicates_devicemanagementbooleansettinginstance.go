...
type DeviceManagementBooleanSettingInstanceOperationPredicate struct {
	DefinitionId *string
	Id           *string
	ODataType    *string
	Value        *bool
...
func (p DeviceManagementBooleanSettingInstanceOperationPredicate) Matches(input DeviceManagementBooleanSettingInstance) bool {
