...
type Windows81CompliancePolicyOperationPredicate struct {
...
func (p Windows81CompliancePolicyOperationPredicate) Matches(input Windows81CompliancePolicy) bool {
