...
type MobileAppTroubleshootingAppTargetHistoryOperationPredicate struct {
	ErrorCode          *string
	ODataType          *string
...
func (p MobileAppTroubleshootingAppTargetHistoryOperationPredicate) Matches(input MobileAppTroubleshootingAppTargetHistory) bool {
