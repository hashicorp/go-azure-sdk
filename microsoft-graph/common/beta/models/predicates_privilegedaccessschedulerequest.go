...
type PrivilegedAccessScheduleRequestOperationPredicate struct {
	ApprovalId        *string
...
func (p PrivilegedAccessScheduleRequestOperationPredicate) Matches(input PrivilegedAccessScheduleRequest) bool {
