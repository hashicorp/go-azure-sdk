...
type IosPkcsCertificateProfile struct {
	...
	CertificateStore                            *IosPkcsCertificateProfileCertificateStore               `json:"certificateStore,omitempty"`
	CertificateTemplateName                     *string                                                  `json:"certificateTemplateName,omitempty"`
	CertificateValidityPeriodScale              *IosPkcsCertificateProfileCertificateValidityPeriodScale `json:"certificateValidityPeriodScale,omitempty"`
	...
	SubjectAlternativeNameType                  *IosPkcsCertificateProfileSubjectAlternativeNameType     `json:"subjectAlternativeNameType,omitempty"`
	SubjectNameFormat                           *IosPkcsCertificateProfileSubjectNameFormat              `json:"subjectNameFormat,omitempty"`
