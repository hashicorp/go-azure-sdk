...
const (
	...
	Win32LobAppFileSystemRuleOperationTypedoesNotExist  Win32LobAppFileSystemRuleOperationType = "DoesNotExist"
...
func PossibleValuesForWin32LobAppFileSystemRuleOperationType() []string {
	return []string{
		...
		string(Win32LobAppFileSystemRuleOperationTypedoesNotExist),
...
func parseWin32LobAppFileSystemRuleOperationType(input string) (*Win32LobAppFileSystemRuleOperationType, error) {
	vals := map[string]Win32LobAppFileSystemRuleOperationType{
		...
		"doesnotexist":  Win32LobAppFileSystemRuleOperationTypedoesNotExist,
