...
type RoomOperationPredicate struct {
...
func (p RoomOperationPredicate) Matches(input Room) bool {

	if p.AudioDeviceName != nil && (input.AudioDeviceName == nil || *p.AudioDeviceName != *input.AudioDeviceName) {
		return false
	}
	...
	if p.DisplayDeviceName != nil && (input.DisplayDeviceName == nil || *p.DisplayDeviceName != *input.DisplayDeviceName) {
		return false
	}
	...
	if p.VideoDeviceName != nil && (input.VideoDeviceName == nil || *p.VideoDeviceName != *input.VideoDeviceName) {
		return false
	}
