...
type DeviceManagementConfigurationSettingGroupCollectionDefinition struct {
	AccessTypes                    *DeviceManagementConfigurationSettingGroupCollectionDefinitionAccessTypes  `json:"accessTypes,omitempty"`
	...
	SettingUsage                   *DeviceManagementConfigurationSettingGroupCollectionDefinitionSettingUsage `json:"settingUsage,omitempty"`
	UxBehavior                     *DeviceManagementConfigurationSettingGroupCollectionDefinitionUxBehavior   `json:"uxBehavior,omitempty"`
	Version                        *string                                                                    `json:"version,omitempty"`
	Visibility                     *DeviceManagementConfigurationSettingGroupCollectionDefinitionVisibility   `json:"visibility,omitempty"`
}
