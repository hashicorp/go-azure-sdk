...
type MacOSMicrosoftDefenderAppOperationPredicate struct {
...
func (p MacOSMicrosoftDefenderAppOperationPredicate) Matches(input MacOSMicrosoftDefenderApp) bool {
