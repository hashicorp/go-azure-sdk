...
type AndroidFotaDeploymentAssignmentTargetOperationPredicate struct {
	DeviceAndAppManagementAssignmentFilterId *string
	GroupId                                  *string
	ODataType                                *string
}

func (p AndroidFotaDeploymentAssignmentTargetOperationPredicate) Matches(input AndroidFotaDeploymentAssignmentTarget) bool {
