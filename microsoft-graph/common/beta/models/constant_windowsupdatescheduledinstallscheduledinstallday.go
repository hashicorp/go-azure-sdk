...
const (
	...
	WindowsUpdateScheduledInstallScheduledInstallDaynoScheduledScan WindowsUpdateScheduledInstallScheduledInstallDay = "NoScheduledScan"
...
func PossibleValuesForWindowsUpdateScheduledInstallScheduledInstallDay() []string {
	return []string{
		...
		string(WindowsUpdateScheduledInstallScheduledInstallDaynoScheduledScan),
...
func parseWindowsUpdateScheduledInstallScheduledInstallDay(input string) (*WindowsUpdateScheduledInstallScheduledInstallDay, error) {
	vals := map[string]WindowsUpdateScheduledInstallScheduledInstallDay{
		...
		"noscheduledscan": WindowsUpdateScheduledInstallScheduledInstallDaynoScheduledScan,
