...
type CompanyCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p CompanyCollectionResponseOperationPredicate) Matches(input CompanyCollectionResponse) bool {
