...
type IndustryDataIndustryDataRunOperationPredicate struct {
	DisplayName   *string
	EndDateTime   *string
	Id            *string
	ODataType     *string
...
func (p IndustryDataIndustryDataRunOperationPredicate) Matches(input IndustryDataIndustryDataRun) bool {
