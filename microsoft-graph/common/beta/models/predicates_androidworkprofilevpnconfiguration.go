...
type AndroidWorkProfileVpnConfigurationOperationPredicate struct {
	AlwaysOn              *bool
...
func (p AndroidWorkProfileVpnConfigurationOperationPredicate) Matches(input AndroidWorkProfileVpnConfiguration) bool {

	if p.AlwaysOn != nil && (input.AlwaysOn == nil || *p.AlwaysOn != *input.AlwaysOn) {
		return false
	}

	if p.AlwaysOnLockdown != nil && (input.AlwaysOnLockdown == nil || *p.AlwaysOnLockdown != *input.AlwaysOnLockdown) {
		return false
	}
