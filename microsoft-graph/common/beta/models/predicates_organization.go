...
func (p OrganizationOperationPredicate) Matches(input Organization) bool {
	...
	if p.IsMultipleDataLocationsForServicesEnabled != nil && (input.IsMultipleDataLocationsForServicesEnabled == nil || *p.IsMultipleDataLocationsForServicesEnabled != *input.IsMultipleDataLocationsForServicesEnabled) {
		return false
	}
	...
	if p.OnPremisesLastPasswordSyncDateTime != nil && (input.OnPremisesLastPasswordSyncDateTime == nil || *p.OnPremisesLastPasswordSyncDateTime != *input.OnPremisesLastPasswordSyncDateTime) {
		return false
	}
