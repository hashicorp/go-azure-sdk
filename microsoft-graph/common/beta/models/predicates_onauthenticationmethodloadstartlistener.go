...
type OnAuthenticationMethodLoadStartListenerOperationPredicate struct {
...
func (p OnAuthenticationMethodLoadStartListenerOperationPredicate) Matches(input OnAuthenticationMethodLoadStartListener) bool {
