...
type Windows10EasEmailProfileConfigurationOperationPredicate struct {
	AccountName          *string
...
func (p Windows10EasEmailProfileConfigurationOperationPredicate) Matches(input Windows10EasEmailProfileConfiguration) bool {
