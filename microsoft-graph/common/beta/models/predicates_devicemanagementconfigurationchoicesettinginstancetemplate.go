...
type DeviceManagementConfigurationChoiceSettingInstanceTemplateOperationPredicate struct {
	IsRequired                *bool
	ODataType                 *string
...
func (p DeviceManagementConfigurationChoiceSettingInstanceTemplateOperationPredicate) Matches(input DeviceManagementConfigurationChoiceSettingInstanceTemplate) bool {
