...
type AndroidDeviceOwnerVpnConfigurationOperationPredicate struct {
	AlwaysOn              *bool
...
func (p AndroidDeviceOwnerVpnConfigurationOperationPredicate) Matches(input AndroidDeviceOwnerVpnConfiguration) bool {
