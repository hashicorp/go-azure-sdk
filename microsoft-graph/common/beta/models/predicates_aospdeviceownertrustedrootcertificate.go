...
type AospDeviceOwnerTrustedRootCertificateOperationPredicate struct {
	CertFileName           *string
...
func (p AospDeviceOwnerTrustedRootCertificateOperationPredicate) Matches(input AospDeviceOwnerTrustedRootCertificate) bool {
