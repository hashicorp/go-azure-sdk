...
type SecurityEmailThreatSubmissionOperationPredicate struct {
...
func (p SecurityEmailThreatSubmissionOperationPredicate) Matches(input SecurityEmailThreatSubmission) bool {
