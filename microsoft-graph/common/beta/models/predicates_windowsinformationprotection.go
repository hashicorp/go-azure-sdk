...
type WindowsInformationProtectionOperationPredicate struct {
...
func (p WindowsInformationProtectionOperationPredicate) Matches(input WindowsInformationProtection) bool {
