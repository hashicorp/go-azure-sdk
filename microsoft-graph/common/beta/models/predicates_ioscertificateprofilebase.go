...
type IosCertificateProfileBaseOperationPredicate struct {
...
func (p IosCertificateProfileBaseOperationPredicate) Matches(input IosCertificateProfileBase) bool {
