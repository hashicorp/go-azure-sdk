...
type ClassificationJobResponseOperationPredicate struct {
...
func (p ClassificationJobResponseOperationPredicate) Matches(input ClassificationJobResponse) bool {
