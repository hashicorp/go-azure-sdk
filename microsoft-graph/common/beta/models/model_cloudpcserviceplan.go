...
type CloudPCServicePlan struct {
	...
	ProvisioningType  *CloudPCServicePlanProvisioningType  `json:"provisioningType,omitempty"`
	RamInGB           *int64                               `json:"ramInGB,omitempty"`
	StorageInGB       *int64                               `json:"storageInGB,omitempty"`
	SupportedSolution *CloudPCServicePlanSupportedSolution `json:"supportedSolution,omitempty"`
