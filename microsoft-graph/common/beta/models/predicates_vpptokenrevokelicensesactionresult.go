...
type VppTokenRevokeLicensesActionResultOperationPredicate struct {
	ActionName          *string
...
func (p VppTokenRevokeLicensesActionResultOperationPredicate) Matches(input VppTokenRevokeLicensesActionResult) bool {
