...
const (
	...
	DefaultManagedAppProtectionAllowedDataStorageLocationsphotoLibrary        DefaultManagedAppProtectionAllowedDataStorageLocations = "PhotoLibrary"
...
func PossibleValuesForDefaultManagedAppProtectionAllowedDataStorageLocations() []string {
	return []string{
		...
		string(DefaultManagedAppProtectionAllowedDataStorageLocationsphotoLibrary),
...
func parseDefaultManagedAppProtectionAllowedDataStorageLocations(input string) (*DefaultManagedAppProtectionAllowedDataStorageLocations, error) {
	vals := map[string]DefaultManagedAppProtectionAllowedDataStorageLocations{
		...
		"photolibrary":        DefaultManagedAppProtectionAllowedDataStorageLocationsphotoLibrary,
