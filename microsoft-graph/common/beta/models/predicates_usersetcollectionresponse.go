...
type UserSetCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p UserSetCollectionResponseOperationPredicate) Matches(input UserSetCollectionResponse) bool {
