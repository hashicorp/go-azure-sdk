...
type EventMessage struct {
	...
	Importance                    *EventMessageImportance              `json:"importance,omitempty"`
	InferenceClassification       *EventMessageInferenceClassification `json:"inferenceClassification,omitempty"`
	...
	MeetingMessageType            *EventMessageMeetingMessageType      `json:"meetingMessageType,omitempty"`
	...
	Type                          *EventMessageType                    `json:"type,omitempty"`
