...
type MacOSCompliancePolicyOperationPredicate struct {
...
func (p MacOSCompliancePolicyOperationPredicate) Matches(input MacOSCompliancePolicy) bool {
	...
	if p.OsMaximumBuildVersion != nil && (input.OsMaximumBuildVersion == nil || *p.OsMaximumBuildVersion != *input.OsMaximumBuildVersion) {
		return false
	}
	...
	if p.OsMinimumBuildVersion != nil && (input.OsMinimumBuildVersion == nil || *p.OsMinimumBuildVersion != *input.OsMinimumBuildVersion) {
		return false
	}
	...
	if p.SystemIntegrityProtectionEnabled != nil && (input.SystemIntegrityProtectionEnabled == nil || *p.SystemIntegrityProtectionEnabled != *input.SystemIntegrityProtectionEnabled) {
		return false
	}
