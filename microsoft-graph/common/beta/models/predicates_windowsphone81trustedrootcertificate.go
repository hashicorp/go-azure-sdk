...
type WindowsPhone81TrustedRootCertificateOperationPredicate struct {
	CertFileName           *string
...
func (p WindowsPhone81TrustedRootCertificateOperationPredicate) Matches(input WindowsPhone81TrustedRootCertificate) bool {
