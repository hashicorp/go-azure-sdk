...
type DeviceManagementAbstractComplexSettingDefinitionOperationPredicate struct {
	Description      *string
	DisplayName      *string
...
func (p DeviceManagementAbstractComplexSettingDefinitionOperationPredicate) Matches(input DeviceManagementAbstractComplexSettingDefinition) bool {
