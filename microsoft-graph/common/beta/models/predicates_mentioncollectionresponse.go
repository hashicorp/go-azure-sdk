...
type MentionCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p MentionCollectionResponseOperationPredicate) Matches(input MentionCollectionResponse) bool {
