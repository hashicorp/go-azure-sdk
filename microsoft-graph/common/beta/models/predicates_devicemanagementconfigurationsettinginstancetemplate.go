...
type DeviceManagementConfigurationSettingInstanceTemplateOperationPredicate struct {
	IsRequired                *bool
	ODataType                 *string
...
func (p DeviceManagementConfigurationSettingInstanceTemplateOperationPredicate) Matches(input DeviceManagementConfigurationSettingInstanceTemplate) bool {
