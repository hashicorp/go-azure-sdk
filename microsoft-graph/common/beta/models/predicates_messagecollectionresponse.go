...
type MessageCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p MessageCollectionResponseOperationPredicate) Matches(input MessageCollectionResponse) bool {
