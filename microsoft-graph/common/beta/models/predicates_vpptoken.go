...
func (p VppTokenOperationPredicate) Matches(input VppToken) bool {
	...
	if p.ClaimTokenManagementFromExternalMdm != nil && (input.ClaimTokenManagementFromExternalMdm == nil || *p.ClaimTokenManagementFromExternalMdm != *input.ClaimTokenManagementFromExternalMdm) {
		return false
	}
	...
	if p.LocationName != nil && (input.LocationName == nil || *p.LocationName != *input.LocationName) {
		return false
	}
