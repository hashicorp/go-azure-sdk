...
type MacOsVppAppAssignmentSettingsOperationPredicate struct {
	ODataType                *string
...
func (p MacOsVppAppAssignmentSettingsOperationPredicate) Matches(input MacOsVppAppAssignmentSettings) bool {
