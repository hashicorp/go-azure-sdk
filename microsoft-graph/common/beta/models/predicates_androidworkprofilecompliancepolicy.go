...
type AndroidWorkProfileCompliancePolicyOperationPredicate struct {
...
func (p AndroidWorkProfileCompliancePolicyOperationPredicate) Matches(input AndroidWorkProfileCompliancePolicy) bool {
