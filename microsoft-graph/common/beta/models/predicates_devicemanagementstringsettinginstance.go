...
type DeviceManagementStringSettingInstanceOperationPredicate struct {
	DefinitionId *string
	Id           *string
	ODataType    *string
	Value        *string
...
func (p DeviceManagementStringSettingInstanceOperationPredicate) Matches(input DeviceManagementStringSettingInstance) bool {
