...
type Windows10CertificateProfileBaseOperationPredicate struct {
...
func (p Windows10CertificateProfileBaseOperationPredicate) Matches(input Windows10CertificateProfileBase) bool {
