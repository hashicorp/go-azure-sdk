...
type MacOSRedirectSingleSignOnExtensionOperationPredicate struct {
	ExtensionIdentifier *string
	ODataType           *string
	TeamIdentifier      *string
}

func (p MacOSRedirectSingleSignOnExtensionOperationPredicate) Matches(input MacOSRedirectSingleSignOnExtension) bool {
