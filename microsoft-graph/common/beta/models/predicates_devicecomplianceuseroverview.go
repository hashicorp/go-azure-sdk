...
type DeviceComplianceUserOverviewOperationPredicate struct {
...
func (p DeviceComplianceUserOverviewOperationPredicate) Matches(input DeviceComplianceUserOverview) bool {
