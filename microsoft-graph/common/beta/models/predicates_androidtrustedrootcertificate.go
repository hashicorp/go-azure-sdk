...
type AndroidTrustedRootCertificateOperationPredicate struct {
	CertFileName           *string
...
func (p AndroidTrustedRootCertificateOperationPredicate) Matches(input AndroidTrustedRootCertificate) bool {
