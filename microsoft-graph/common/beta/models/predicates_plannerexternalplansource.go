...
type PlannerExternalPlanSourceOperationPredicate struct {
...
func (p PlannerExternalPlanSourceOperationPredicate) Matches(input PlannerExternalPlanSource) bool {
