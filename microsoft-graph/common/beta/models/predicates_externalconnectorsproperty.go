...
type ExternalConnectorsPropertyOperationPredicate struct {
...
func (p ExternalConnectorsPropertyOperationPredicate) Matches(input ExternalConnectorsProperty) bool {

	if p.IsExactMatchRequired != nil && (input.IsExactMatchRequired == nil || *p.IsExactMatchRequired != *input.IsExactMatchRequired) {
		return false
	}
