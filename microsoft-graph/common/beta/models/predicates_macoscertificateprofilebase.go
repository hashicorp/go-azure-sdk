...
type MacOSCertificateProfileBaseOperationPredicate struct {
...
func (p MacOSCertificateProfileBaseOperationPredicate) Matches(input MacOSCertificateProfileBase) bool {
