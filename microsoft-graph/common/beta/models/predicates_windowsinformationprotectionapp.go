...
type WindowsInformationProtectionAppOperationPredicate struct {
	Denied        *bool
	Description   *string
	DisplayName   *string
	ODataType     *string
...
func (p WindowsInformationProtectionAppOperationPredicate) Matches(input WindowsInformationProtectionApp) bool {
