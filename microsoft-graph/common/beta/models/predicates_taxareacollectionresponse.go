...
type TaxAreaCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p TaxAreaCollectionResponseOperationPredicate) Matches(input TaxAreaCollectionResponse) bool {
