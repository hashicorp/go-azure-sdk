...
type AndroidWorkProfileTrustedRootCertificateOperationPredicate struct {
	CertFileName           *string
...
func (p AndroidWorkProfileTrustedRootCertificateOperationPredicate) Matches(input AndroidWorkProfileTrustedRootCertificate) bool {
