...
type IosWiFiConfiguration struct {
	...
	ProxySettings                               *IosWiFiConfigurationProxySettings           `json:"proxySettings,omitempty"`
	...
	WiFiSecurityType                            *IosWiFiConfigurationWiFiSecurityType        `json:"wiFiSecurityType,omitempty"`
}
