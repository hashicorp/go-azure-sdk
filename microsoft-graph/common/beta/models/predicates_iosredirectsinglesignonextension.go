...
type IosRedirectSingleSignOnExtensionOperationPredicate struct {
	ExtensionIdentifier *string
	ODataType           *string
	TeamIdentifier      *string
}

func (p IosRedirectSingleSignOnExtensionOperationPredicate) Matches(input IosRedirectSingleSignOnExtension) bool {
