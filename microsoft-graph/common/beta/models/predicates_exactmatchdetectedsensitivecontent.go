...
type ExactMatchDetectedSensitiveContentOperationPredicate struct {
	Confidence            *int64
	DisplayName           *string
	Id                    *string
	ODataType             *string
...
func (p ExactMatchDetectedSensitiveContentOperationPredicate) Matches(input ExactMatchDetectedSensitiveContent) bool {
