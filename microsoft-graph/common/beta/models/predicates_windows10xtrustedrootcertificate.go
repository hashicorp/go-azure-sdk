...
type Windows10XTrustedRootCertificateOperationPredicate struct {
	CertFileName           *string
...
func (p Windows10XTrustedRootCertificateOperationPredicate) Matches(input Windows10XTrustedRootCertificate) bool {
