...
type Windows81CertificateProfileBaseOperationPredicate struct {
...
func (p Windows81CertificateProfileBaseOperationPredicate) Matches(input Windows81CertificateProfileBase) bool {
