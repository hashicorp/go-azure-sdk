...
type DeviceManagementCollectionSettingDefinitionOperationPredicate struct {
	Description         *string
	DisplayName         *string
...
func (p DeviceManagementCollectionSettingDefinitionOperationPredicate) Matches(input DeviceManagementCollectionSettingDefinition) bool {
	...
	if p.ElementDefinitionId != nil && (input.ElementDefinitionId == nil || *p.ElementDefinitionId != *input.ElementDefinitionId) {
		return false
	}
