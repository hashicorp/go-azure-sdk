...
type AndroidForWorkCompliancePolicyOperationPredicate struct {
...
func (p AndroidForWorkCompliancePolicyOperationPredicate) Matches(input AndroidForWorkCompliancePolicy) bool {
