...
type GroupPolicyPresentationTextBoxOperationPredicate struct {
	DefaultValue         *string
	Id                   *string
	Label                *string
...
func (p GroupPolicyPresentationTextBoxOperationPredicate) Matches(input GroupPolicyPresentationTextBox) bool {
