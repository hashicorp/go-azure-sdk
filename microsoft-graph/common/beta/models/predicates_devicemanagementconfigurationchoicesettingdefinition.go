...
type DeviceManagementConfigurationChoiceSettingDefinitionOperationPredicate struct {
	BaseUri          *string
	CategoryId       *string
...
func (p DeviceManagementConfigurationChoiceSettingDefinitionOperationPredicate) Matches(input DeviceManagementConfigurationChoiceSettingDefinition) bool {
