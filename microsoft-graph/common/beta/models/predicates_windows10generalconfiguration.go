...
type Windows10GeneralConfigurationOperationPredicate struct {
	...
	DefenderCloudExtendedTimeout                          *int64
	...
	EdgeKioskResetAfterIdleTimeInMinutes                  *int64
	...
	EnergySaverOnBatteryThresholdPercentage               *int64
	EnergySaverPluggedInThresholdPercentage               *int64
	...
	PasswordMinimumAgeInDays                              *int64
...
func (p Windows10GeneralConfigurationOperationPredicate) Matches(input Windows10GeneralConfiguration) bool {
	...
	if p.AppManagementMSIAllowUserControlOverInstall != nil && (input.AppManagementMSIAllowUserControlOverInstall == nil || *p.AppManagementMSIAllowUserControlOverInstall != *input.AppManagementMSIAllowUserControlOverInstall) {
		return false
	}

	if p.AppManagementMSIAlwaysInstallWithElevatedPrivileges != nil && (input.AppManagementMSIAlwaysInstallWithElevatedPrivileges == nil || *p.AppManagementMSIAlwaysInstallWithElevatedPrivileges != *input.AppManagementMSIAlwaysInstallWithElevatedPrivileges) {
		return false
	}
	...
	if p.AuthenticationAllowSecondaryDevice != nil && (input.AuthenticationAllowSecondaryDevice == nil || *p.AuthenticationAllowSecondaryDevice != *input.AuthenticationAllowSecondaryDevice) {
		return false
	}

	if p.AuthenticationPreferredAzureADTenantDomainName != nil && (input.AuthenticationPreferredAzureADTenantDomainName == nil || *p.AuthenticationPreferredAzureADTenantDomainName != *input.AuthenticationPreferredAzureADTenantDomainName) {
		return false
	}
	...
	if p.BluetoothBlockPromptedProximalConnections != nil && (input.BluetoothBlockPromptedProximalConnections == nil || *p.BluetoothBlockPromptedProximalConnections != *input.BluetoothBlockPromptedProximalConnections) {
		return false
	}
	...
	if p.ConfigureTimeZone != nil && (input.ConfigureTimeZone == nil || *p.ConfigureTimeZone != *input.ConfigureTimeZone) {
		return false
	}
	...
	if p.CryptographyAllowFipsAlgorithmPolicy != nil && (input.CryptographyAllowFipsAlgorithmPolicy == nil || *p.CryptographyAllowFipsAlgorithmPolicy != *input.CryptographyAllowFipsAlgorithmPolicy) {
		return false
	}

	if p.DataProtectionBlockDirectMemoryAccess != nil && (input.DataProtectionBlockDirectMemoryAccess == nil || *p.DataProtectionBlockDirectMemoryAccess != *input.DataProtectionBlockDirectMemoryAccess) {
		return false
	}
	...
	if p.DefenderBlockOnAccessProtection != nil && (input.DefenderBlockOnAccessProtection == nil || *p.DefenderBlockOnAccessProtection != *input.DefenderBlockOnAccessProtection) {
		return false
	}

	if p.DefenderCloudExtendedTimeout != nil && (input.DefenderCloudExtendedTimeout == nil || *p.DefenderCloudExtendedTimeout != *input.DefenderCloudExtendedTimeout) {
		return false
	}
	...
	if p.DefenderScheduleScanEnableLowCpuPriority != nil && (input.DefenderScheduleScanEnableLowCpuPriority == nil || *p.DefenderScheduleScanEnableLowCpuPriority != *input.DefenderScheduleScanEnableLowCpuPriority) {
		return false
	}
	...
	if p.EdgeBlockEditFavorites != nil && (input.EdgeBlockEditFavorites == nil || *p.EdgeBlockEditFavorites != *input.EdgeBlockEditFavorites) {
		return false
	}
	...
	if p.EdgeBlockFullScreenMode != nil && (input.EdgeBlockFullScreenMode == nil || *p.EdgeBlockFullScreenMode != *input.EdgeBlockFullScreenMode) {
		return false
	}
	...
	if p.EdgeBlockPrelaunch != nil && (input.EdgeBlockPrelaunch == nil || *p.EdgeBlockPrelaunch != *input.EdgeBlockPrelaunch) {
		return false
	}

	if p.EdgeBlockPrinting != nil && (input.EdgeBlockPrinting == nil || *p.EdgeBlockPrinting != *input.EdgeBlockPrinting) {
		return false
	}

	if p.EdgeBlockSavingHistory != nil && (input.EdgeBlockSavingHistory == nil || *p.EdgeBlockSavingHistory != *input.EdgeBlockSavingHistory) {
		return false
	}

	if p.EdgeBlockSearchEngineCustomization != nil && (input.EdgeBlockSearchEngineCustomization == nil || *p.EdgeBlockSearchEngineCustomization != *input.EdgeBlockSearchEngineCustomization) {
		return false
	}
	...
	if p.EdgeBlockSideloadingExtensions != nil && (input.EdgeBlockSideloadingExtensions == nil || *p.EdgeBlockSideloadingExtensions != *input.EdgeBlockSideloadingExtensions) {
		return false
	}

	if p.EdgeBlockTabPreloading != nil && (input.EdgeBlockTabPreloading == nil || *p.EdgeBlockTabPreloading != *input.EdgeBlockTabPreloading) {
		return false
	}

	if p.EdgeBlockWebContentOnNewTabPage != nil && (input.EdgeBlockWebContentOnNewTabPage == nil || *p.EdgeBlockWebContentOnNewTabPage != *input.EdgeBlockWebContentOnNewTabPage) {
		return false
	}
	...
	if p.EdgeFavoritesListLocation != nil && (input.EdgeFavoritesListLocation == nil || *p.EdgeFavoritesListLocation != *input.EdgeFavoritesListLocation) {
		return false
	}
	...
	if p.EdgeHomeButtonConfigurationEnabled != nil && (input.EdgeHomeButtonConfigurationEnabled == nil || *p.EdgeHomeButtonConfigurationEnabled != *input.EdgeHomeButtonConfigurationEnabled) {
		return false
	}

	if p.EdgeKioskResetAfterIdleTimeInMinutes != nil && (input.EdgeKioskResetAfterIdleTimeInMinutes == nil || *p.EdgeKioskResetAfterIdleTimeInMinutes != *input.EdgeKioskResetAfterIdleTimeInMinutes) {
		return false
	}

	if p.EdgeNewTabPageURL != nil && (input.EdgeNewTabPageURL == nil || *p.EdgeNewTabPageURL != *input.EdgeNewTabPageURL) {
		return false
	}

	if p.EdgePreventCertificateErrorOverride != nil && (input.EdgePreventCertificateErrorOverride == nil || *p.EdgePreventCertificateErrorOverride != *input.EdgePreventCertificateErrorOverride) {
		return false
	}
	...
	if p.EnableAutomaticRedeployment != nil && (input.EnableAutomaticRedeployment == nil || *p.EnableAutomaticRedeployment != *input.EnableAutomaticRedeployment) {
		return false
	}

	if p.EnergySaverOnBatteryThresholdPercentage != nil && (input.EnergySaverOnBatteryThresholdPercentage == nil || *p.EnergySaverOnBatteryThresholdPercentage != *input.EnergySaverOnBatteryThresholdPercentage) {
		return false
	}

	if p.EnergySaverPluggedInThresholdPercentage != nil && (input.EnergySaverPluggedInThresholdPercentage == nil || *p.EnergySaverPluggedInThresholdPercentage != *input.EnergySaverPluggedInThresholdPercentage) {
		return false
	}
	...
	if p.InkWorkspaceBlockSuggestedApps != nil && (input.InkWorkspaceBlockSuggestedApps == nil || *p.InkWorkspaceBlockSuggestedApps != *input.InkWorkspaceBlockSuggestedApps) {
		return false
	}
	...
	if p.MessagingBlockMMS != nil && (input.MessagingBlockMMS == nil || *p.MessagingBlockMMS != *input.MessagingBlockMMS) {
		return false
	}

	if p.MessagingBlockRichCommunicationServices != nil && (input.MessagingBlockRichCommunicationServices == nil || *p.MessagingBlockRichCommunicationServices != *input.MessagingBlockRichCommunicationServices) {
		return false
	}

	if p.MessagingBlockSync != nil && (input.MessagingBlockSync == nil || *p.MessagingBlockSync != *input.MessagingBlockSync) {
		return false
	}
	...
	if p.PasswordMinimumAgeInDays != nil && (input.PasswordMinimumAgeInDays == nil || *p.PasswordMinimumAgeInDays != *input.PasswordMinimumAgeInDays) {
		return false
	}
	...
	if p.PrinterBlockAddition != nil && (input.PrinterBlockAddition == nil || *p.PrinterBlockAddition != *input.PrinterBlockAddition) {
		return false
	}

	if p.PrinterDefaultName != nil && (input.PrinterDefaultName == nil || *p.PrinterDefaultName != *input.PrinterDefaultName) {
		return false
	}
	...
	if p.PrivacyBlockActivityFeed != nil && (input.PrivacyBlockActivityFeed == nil || *p.PrivacyBlockActivityFeed != *input.PrivacyBlockActivityFeed) {
		return false
	}
	...
	if p.PrivacyBlockPublishUserActivities != nil && (input.PrivacyBlockPublishUserActivities == nil || *p.PrivacyBlockPublishUserActivities != *input.PrivacyBlockPublishUserActivities) {
		return false
	}

	if p.PrivacyDisableLaunchExperience != nil && (input.PrivacyDisableLaunchExperience == nil || *p.PrivacyDisableLaunchExperience != *input.PrivacyDisableLaunchExperience) {
		return false
	}
	...
	if p.SearchBlockWebResults != nil && (input.SearchBlockWebResults == nil || *p.SearchBlockWebResults != *input.SearchBlockWebResults) {
		return false
	}
	...
	if p.SearchDisableLocation != nil && (input.SearchDisableLocation == nil || *p.SearchDisableLocation != *input.SearchDisableLocation) {
		return false
	}

	if p.SearchDisableUseLocation != nil && (input.SearchDisableUseLocation == nil || *p.SearchDisableUseLocation != *input.SearchDisableUseLocation) {
		return false
	}
	...
	if p.SecurityBlockAzureADJoinedDevicesAutoEncryption != nil && (input.SecurityBlockAzureADJoinedDevicesAutoEncryption == nil || *p.SecurityBlockAzureADJoinedDevicesAutoEncryption != *input.SecurityBlockAzureADJoinedDevicesAutoEncryption) {
		return false
	}
	...
	if p.SystemTelemetryProxyServer != nil && (input.SystemTelemetryProxyServer == nil || *p.SystemTelemetryProxyServer != *input.SystemTelemetryProxyServer) {
		return false
	}

	if p.TaskManagerBlockEndTask != nil && (input.TaskManagerBlockEndTask == nil || *p.TaskManagerBlockEndTask != *input.TaskManagerBlockEndTask) {
		return false
	}
	...
	if p.UninstallBuiltInApps != nil && (input.UninstallBuiltInApps == nil || *p.UninstallBuiltInApps != *input.UninstallBuiltInApps) {
		return false
	}
