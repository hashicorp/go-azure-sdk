...
type OnTokenIssuanceStartListenerOperationPredicate struct {
...
func (p OnTokenIssuanceStartListenerOperationPredicate) Matches(input OnTokenIssuanceStartListener) bool {
