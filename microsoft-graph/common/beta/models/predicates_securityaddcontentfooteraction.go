...
type SecurityAddContentFooterActionOperationPredicate struct {
	FontColor     *string
	FontName      *string
	FontSize      *int64
	Margin        *int64
...
func (p SecurityAddContentFooterActionOperationPredicate) Matches(input SecurityAddContentFooterAction) bool {
