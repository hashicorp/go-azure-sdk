...
type KerberosSingleSignOnExtensionOperationPredicate struct {
...
func (p KerberosSingleSignOnExtensionOperationPredicate) Matches(input KerberosSingleSignOnExtension) bool {
