...
type ProgramCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p ProgramCollectionResponseOperationPredicate) Matches(input ProgramCollectionResponse) bool {
