...
type SamlOrWsFedExternalDomainFederationOperationPredicate struct {
	DisplayName         *string
	Id                  *string
	IssuerUri           *string
...
func (p SamlOrWsFedExternalDomainFederationOperationPredicate) Matches(input SamlOrWsFedExternalDomainFederation) bool {
