...
type SecurityEdiscoveryFile struct {
	...
	ProcessingStatus     *SecurityEdiscoveryFileProcessingStatus `json:"processingStatus,omitempty"`
	SenderOrAuthors      *[]string                               `json:"senderOrAuthors,omitempty"`
	Size                 *int64                                  `json:"size,omitempty"`
	SourceType           *SecurityEdiscoveryFileSourceType       `json:"sourceType,omitempty"`
