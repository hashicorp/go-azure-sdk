...
type Windows10XVpnConfigurationOperationPredicate struct {
...
func (p Windows10XVpnConfigurationOperationPredicate) Matches(input Windows10XVpnConfiguration) bool {
