...
type SecurityEdiscoveryEstimateOperationOperationPredicate struct {
...
func (p SecurityEdiscoveryEstimateOperationOperationPredicate) Matches(input SecurityEdiscoveryEstimateOperation) bool {
