...
const (
	...
	WindowsUpdateForBusinessConfigurationAutomaticUpdateModewindowsDefault                            WindowsUpdateForBusinessConfigurationAutomaticUpdateMode = "WindowsDefault"
)
...
func PossibleValuesForWindowsUpdateForBusinessConfigurationAutomaticUpdateMode() []string {
	return []string{
		...
		string(WindowsUpdateForBusinessConfigurationAutomaticUpdateModewindowsDefault),
	}
}
...
func parseWindowsUpdateForBusinessConfigurationAutomaticUpdateMode(input string) (*WindowsUpdateForBusinessConfigurationAutomaticUpdateMode, error) {
	vals := map[string]WindowsUpdateForBusinessConfigurationAutomaticUpdateMode{
		...
		"windowsdefault":                            WindowsUpdateForBusinessConfigurationAutomaticUpdateModewindowsDefault,
	}
