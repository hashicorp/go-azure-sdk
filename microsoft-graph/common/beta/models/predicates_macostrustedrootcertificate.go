...
type MacOSTrustedRootCertificateOperationPredicate struct {
	CertFileName           *string
...
func (p MacOSTrustedRootCertificateOperationPredicate) Matches(input MacOSTrustedRootCertificate) bool {
