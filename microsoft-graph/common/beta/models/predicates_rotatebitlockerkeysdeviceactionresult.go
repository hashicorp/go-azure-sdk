...
type RotateBitLockerKeysDeviceActionResultOperationPredicate struct {
	ActionName          *string
	ErrorCode           *int64
...
func (p RotateBitLockerKeysDeviceActionResultOperationPredicate) Matches(input RotateBitLockerKeysDeviceActionResult) bool {
