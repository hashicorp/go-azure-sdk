...
const (
	...
	Windows10GeneralConfigurationDefenderSystemScanSchedulenoScheduledScan Windows10GeneralConfigurationDefenderSystemScanSchedule = "NoScheduledScan"
...
func PossibleValuesForWindows10GeneralConfigurationDefenderSystemScanSchedule() []string {
	return []string{
		...
		string(Windows10GeneralConfigurationDefenderSystemScanSchedulenoScheduledScan),
...
func parseWindows10GeneralConfigurationDefenderSystemScanSchedule(input string) (*Windows10GeneralConfigurationDefenderSystemScanSchedule, error) {
	vals := map[string]Windows10GeneralConfigurationDefenderSystemScanSchedule{
		...
		"noscheduledscan": Windows10GeneralConfigurationDefenderSystemScanSchedulenoScheduledScan,
