...
type MacOSCredentialSingleSignOnExtensionOperationPredicate struct {
...
func (p MacOSCredentialSingleSignOnExtensionOperationPredicate) Matches(input MacOSCredentialSingleSignOnExtension) bool {
