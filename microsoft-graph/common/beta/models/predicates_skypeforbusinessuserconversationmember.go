...
type SkypeForBusinessUserConversationMemberOperationPredicate struct {
	DisplayName                 *string
	Id                          *string
	ODataType                   *string
	TenantId                    *string
...
func (p SkypeForBusinessUserConversationMemberOperationPredicate) Matches(input SkypeForBusinessUserConversationMember) bool {
