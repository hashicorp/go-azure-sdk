...
type TimeOffCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p TimeOffCollectionResponseOperationPredicate) Matches(input TimeOffCollectionResponse) bool {
