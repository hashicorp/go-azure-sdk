...
type WindowsFeatureUpdateCatalogItemOperationPredicate struct {
	DisplayName      *string
...
func (p WindowsFeatureUpdateCatalogItemOperationPredicate) Matches(input WindowsFeatureUpdateCatalogItem) bool {
