...
type AndroidDeviceOwnerTrustedRootCertificateOperationPredicate struct {
	CertFileName           *string
...
func (p AndroidDeviceOwnerTrustedRootCertificateOperationPredicate) Matches(input AndroidDeviceOwnerTrustedRootCertificate) bool {
