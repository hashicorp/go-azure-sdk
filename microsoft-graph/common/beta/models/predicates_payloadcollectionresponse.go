...
type PayloadCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p PayloadCollectionResponseOperationPredicate) Matches(input PayloadCollectionResponse) bool {
