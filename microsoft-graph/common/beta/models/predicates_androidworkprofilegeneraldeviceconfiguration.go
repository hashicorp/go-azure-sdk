...
type AndroidWorkProfileGeneralDeviceConfigurationOperationPredicate struct {
...
func (p AndroidWorkProfileGeneralDeviceConfigurationOperationPredicate) Matches(input AndroidWorkProfileGeneralDeviceConfiguration) bool {
	...
	if p.WorkProfileAllowAppInstallsFromUnknownSources != nil && (input.WorkProfileAllowAppInstallsFromUnknownSources == nil || *p.WorkProfileAllowAppInstallsFromUnknownSources != *input.WorkProfileAllowAppInstallsFromUnknownSources) {
		return false
	}
