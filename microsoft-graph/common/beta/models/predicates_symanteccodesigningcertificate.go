...
type SymantecCodeSigningCertificateOperationPredicate struct {
	Content            *string
...
func (p SymantecCodeSigningCertificateOperationPredicate) Matches(input SymantecCodeSigningCertificate) bool {
