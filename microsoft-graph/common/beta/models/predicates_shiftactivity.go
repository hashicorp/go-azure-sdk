...
type ShiftActivityOperationPredicate struct {
	Code          *string
	DisplayName   *string
	EndDateTime   *string
	IsPaid        *bool
...
func (p ShiftActivityOperationPredicate) Matches(input ShiftActivity) bool {
	...
	if p.IsPaid != nil && (input.IsPaid == nil || *p.IsPaid != *input.IsPaid) {
		return false
	}
