...
type DeviceHealthScriptBooleanParameterOperationPredicate struct {
...
func (p DeviceHealthScriptBooleanParameterOperationPredicate) Matches(input DeviceHealthScriptBooleanParameter) bool {
