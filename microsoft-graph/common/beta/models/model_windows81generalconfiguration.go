...
type Windows81GeneralConfiguration struct {
	...
	MinimumAutoInstallClassification               *Windows81GeneralConfigurationMinimumAutoInstallClassification        `json:"minimumAutoInstallClassification,omitempty"`
	...
	UpdatesMinimumAutoInstallClassification        *Windows81GeneralConfigurationUpdatesMinimumAutoInstallClassification `json:"updatesMinimumAutoInstallClassification,omitempty"`
