...
type IosDeviceFeaturesConfigurationOperationPredicate struct {
	...
	Description          *string
	DisplayName          *string
	HomeScreenGridHeight *int64
	HomeScreenGridWidth  *int64
	Id                   *string
...
func (p IosDeviceFeaturesConfigurationOperationPredicate) Matches(input IosDeviceFeaturesConfiguration) bool {
	...
	if p.HomeScreenGridHeight != nil && (input.HomeScreenGridHeight == nil || *p.HomeScreenGridHeight != *input.HomeScreenGridHeight) {
		return false
	}

	if p.HomeScreenGridWidth != nil && (input.HomeScreenGridWidth == nil || *p.HomeScreenGridWidth != *input.HomeScreenGridWidth) {
		return false
	}
