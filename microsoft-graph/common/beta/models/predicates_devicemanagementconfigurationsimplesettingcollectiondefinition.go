...
type DeviceManagementConfigurationSimpleSettingCollectionDefinitionOperationPredicate struct {
	BaseUri          *string
	CategoryId       *string
	Description      *string
	DisplayName      *string
...
func (p DeviceManagementConfigurationSimpleSettingCollectionDefinitionOperationPredicate) Matches(input DeviceManagementConfigurationSimpleSettingCollectionDefinition) bool {
