...
type JournalCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p JournalCollectionResponseOperationPredicate) Matches(input JournalCollectionResponse) bool {
