...
type IpRangeCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p IpRangeCollectionResponseOperationPredicate) Matches(input IpRangeCollectionResponse) bool {
