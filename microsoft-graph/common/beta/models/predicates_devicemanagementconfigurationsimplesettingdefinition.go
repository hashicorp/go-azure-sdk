...
type DeviceManagementConfigurationSimpleSettingDefinitionOperationPredicate struct {
	BaseUri          *string
	CategoryId       *string
	Description      *string
	DisplayName      *string
...
func (p DeviceManagementConfigurationSimpleSettingDefinitionOperationPredicate) Matches(input DeviceManagementConfigurationSimpleSettingDefinition) bool {
