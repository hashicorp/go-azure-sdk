...
type AccessReviewReviewerScopeOperationPredicate struct {
	ODataType *string
	Query     *string
	QueryRoot *string
	QueryType *string
...
func (p AccessReviewReviewerScopeOperationPredicate) Matches(input AccessReviewReviewerScope) bool {
