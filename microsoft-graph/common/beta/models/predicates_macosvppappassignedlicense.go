...
type MacOsVppAppAssignedLicenseOperationPredicate struct {
	Id                *string
	ODataType         *string
...
func (p MacOsVppAppAssignedLicenseOperationPredicate) Matches(input MacOsVppAppAssignedLicense) bool {
