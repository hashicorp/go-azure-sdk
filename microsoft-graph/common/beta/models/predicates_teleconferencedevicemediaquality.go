...
type TeleconferenceDeviceMediaQualityOperationPredicate struct {
...
func (p TeleconferenceDeviceMediaQualityOperationPredicate) Matches(input TeleconferenceDeviceMediaQuality) bool {
