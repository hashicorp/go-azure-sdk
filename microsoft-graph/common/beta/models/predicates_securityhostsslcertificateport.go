...
type SecurityHostSslCertificatePortOperationPredicate struct {
...
func (p SecurityHostSslCertificatePortOperationPredicate) Matches(input SecurityHostSslCertificatePort) bool {
