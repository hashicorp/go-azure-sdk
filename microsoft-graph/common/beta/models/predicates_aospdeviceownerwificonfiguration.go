...
type AospDeviceOwnerWiFiConfigurationOperationPredicate struct {
...
func (p AospDeviceOwnerWiFiConfigurationOperationPredicate) Matches(input AospDeviceOwnerWiFiConfiguration) bool {
