...
type WindowsUpdatesBuildVersionDetailsOperationPredicate struct {
	BuildNumber         *int64
	MajorVersion        *int64
	MinorVersion        *int64
	ODataType           *string
...
func (p WindowsUpdatesBuildVersionDetailsOperationPredicate) Matches(input WindowsUpdatesBuildVersionDetails) bool {
