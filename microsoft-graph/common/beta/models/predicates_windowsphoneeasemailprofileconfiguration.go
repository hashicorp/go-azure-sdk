...
type WindowsPhoneEASEmailProfileConfigurationOperationPredicate struct {
	AccountName               *string
...
func (p WindowsPhoneEASEmailProfileConfigurationOperationPredicate) Matches(input WindowsPhoneEASEmailProfileConfiguration) bool {
