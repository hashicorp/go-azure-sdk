...
type MacOSDeviceFeaturesConfiguration struct {
	...
	ContentCachingClientPolicy                  *MacOSDeviceFeaturesConfigurationContentCachingClientPolicy          `json:"contentCachingClientPolicy,omitempty"`
	...
	ContentCachingMaxSizeBytes                  *int64                                                               `json:"contentCachingMaxSizeBytes,omitempty"`
	ContentCachingParentSelectionPolicy         *MacOSDeviceFeaturesConfigurationContentCachingParentSelectionPolicy `json:"contentCachingParentSelectionPolicy,omitempty"`
	...
	ContentCachingPeerPolicy                    *MacOSDeviceFeaturesConfigurationContentCachingPeerPolicy            `json:"contentCachingPeerPolicy,omitempty"`
	ContentCachingPort                          *int64                                                               `json:"contentCachingPort,omitempty"`
	...
	ContentCachingType                          *MacOSDeviceFeaturesConfigurationContentCachingType                  `json:"contentCachingType,omitempty"`
