...
type AccountCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p AccountCollectionResponseOperationPredicate) Matches(input AccountCollectionResponse) bool {
