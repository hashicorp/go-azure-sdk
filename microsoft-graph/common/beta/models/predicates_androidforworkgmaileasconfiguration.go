...
type AndroidForWorkGmailEasConfigurationOperationPredicate struct {
...
func (p AndroidForWorkGmailEasConfigurationOperationPredicate) Matches(input AndroidForWorkGmailEasConfiguration) bool {
