...
type Office365GroupsActivityGroupCountsOperationPredicate struct {
	Active            *int64
	Id                *string
	ODataType         *string
	ReportDate        *string
...
func (p Office365GroupsActivityGroupCountsOperationPredicate) Matches(input Office365GroupsActivityGroupCounts) bool {
