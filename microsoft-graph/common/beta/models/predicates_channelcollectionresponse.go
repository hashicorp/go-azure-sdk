...
type ChannelCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p ChannelCollectionResponseOperationPredicate) Matches(input ChannelCollectionResponse) bool {
