...
type IosEnterpriseWiFiConfiguration struct {
	...
	AuthenticationMethod                        *IosEnterpriseWiFiConfigurationAuthenticationMethod                  `json:"authenticationMethod,omitempty"`
	...
	EapFastConfiguration                        *IosEnterpriseWiFiConfigurationEapFastConfiguration                  `json:"eapFastConfiguration,omitempty"`
	EapType                                     *IosEnterpriseWiFiConfigurationEapType                               `json:"eapType,omitempty"`
	...
	InnerAuthenticationProtocolForEapTtls       *IosEnterpriseWiFiConfigurationInnerAuthenticationProtocolForEapTtls `json:"innerAuthenticationProtocolForEapTtls,omitempty"`
	...
	ProxySettings                               *IosEnterpriseWiFiConfigurationProxySettings                         `json:"proxySettings,omitempty"`
	...
	WiFiSecurityType                            *IosEnterpriseWiFiConfigurationWiFiSecurityType                      `json:"wiFiSecurityType,omitempty"`
}
