...
type MacOSCustomAppConfigurationOperationPredicate struct {
	BundleId             *string
...
func (p MacOSCustomAppConfigurationOperationPredicate) Matches(input MacOSCustomAppConfiguration) bool {

	if p.BundleId != nil && (input.BundleId == nil || *p.BundleId != *input.BundleId) {
		return false
	}

	if p.ConfigurationXml != nil && (input.ConfigurationXml == nil || *p.ConfigurationXml != *input.ConfigurationXml) {
		return false
	}
