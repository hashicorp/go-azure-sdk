...
type CommandCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p CommandCollectionResponseOperationPredicate) Matches(input CommandCollectionResponse) bool {
