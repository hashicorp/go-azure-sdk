...
type BusinessScenarioTask struct {
	...
	PreviewType                     *BusinessScenarioTaskPreviewType                     `json:"previewType,omitempty"`
	...
	SpecifiedCompletionRequirements *BusinessScenarioTaskSpecifiedCompletionRequirements `json:"specifiedCompletionRequirements,omitempty"`
