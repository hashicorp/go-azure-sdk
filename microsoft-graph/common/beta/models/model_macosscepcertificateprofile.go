...
type MacOSScepCertificateProfile struct {
	...
	CertificateStore                            *MacOSScepCertificateProfileCertificateStore               `json:"certificateStore,omitempty"`
	CertificateValidityPeriodScale              *MacOSScepCertificateProfileCertificateValidityPeriodScale `json:"certificateValidityPeriodScale,omitempty"`
	...
	HashAlgorithm                               *MacOSScepCertificateProfileHashAlgorithm                  `json:"hashAlgorithm,omitempty"`
	Id                                          *string                                                    `json:"id,omitempty"`
	KeySize                                     *MacOSScepCertificateProfileKeySize                        `json:"keySize,omitempty"`
	KeyUsage                                    *MacOSScepCertificateProfileKeyUsage                       `json:"keyUsage,omitempty"`
	...
	SubjectAlternativeNameType                  *MacOSScepCertificateProfileSubjectAlternativeNameType     `json:"subjectAlternativeNameType,omitempty"`
	SubjectNameFormat                           *MacOSScepCertificateProfileSubjectNameFormat              `json:"subjectNameFormat,omitempty"`
