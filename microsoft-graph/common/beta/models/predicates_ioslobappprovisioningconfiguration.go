...
type IosLobAppProvisioningConfigurationOperationPredicate struct {
...
func (p IosLobAppProvisioningConfigurationOperationPredicate) Matches(input IosLobAppProvisioningConfiguration) bool {
