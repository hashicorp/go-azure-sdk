...
type AospDeviceOwnerCertificateProfileBaseOperationPredicate struct {
...
func (p AospDeviceOwnerCertificateProfileBaseOperationPredicate) Matches(input AospDeviceOwnerCertificateProfileBase) bool {
