...
type MacOSDmgAppOperationPredicate struct {
...
func (p MacOSDmgAppOperationPredicate) Matches(input MacOSDmgApp) bool {
	...
	if p.PrimaryBundleId != nil && (input.PrimaryBundleId == nil || *p.PrimaryBundleId != *input.PrimaryBundleId) {
		return false
	}

	if p.PrimaryBundleVersion != nil && (input.PrimaryBundleVersion == nil || *p.PrimaryBundleVersion != *input.PrimaryBundleVersion) {
		return false
	}
