...
type WindowsPhone81AppXBundle struct {
	...
	ApplicableArchitectures         *WindowsPhone81AppXBundleApplicableArchitectures `json:"applicableArchitectures,omitempty"`
	...
	PublishingState                 *WindowsPhone81AppXBundlePublishingState         `json:"publishingState,omitempty"`
