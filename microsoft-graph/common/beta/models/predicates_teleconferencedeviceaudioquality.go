...
type TeleconferenceDeviceAudioQualityOperationPredicate struct {
...
func (p TeleconferenceDeviceAudioQualityOperationPredicate) Matches(input TeleconferenceDeviceAudioQuality) bool {
