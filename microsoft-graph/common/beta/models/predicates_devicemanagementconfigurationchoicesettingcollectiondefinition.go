...
type DeviceManagementConfigurationChoiceSettingCollectionDefinitionOperationPredicate struct {
	BaseUri          *string
	CategoryId       *string
...
func (p DeviceManagementConfigurationChoiceSettingCollectionDefinitionOperationPredicate) Matches(input DeviceManagementConfigurationChoiceSettingCollectionDefinition) bool {
	...
	if p.DefaultOptionId != nil && (input.DefaultOptionId == nil || *p.DefaultOptionId != *input.DefaultOptionId) {
		return false
	}
