...
type MachineLearningDetectedSensitiveContentOperationPredicate struct {
	Confidence            *int64
	DisplayName           *string
	Id                    *string
	ModelVersion          *string
...
func (p MachineLearningDetectedSensitiveContentOperationPredicate) Matches(input MachineLearningDetectedSensitiveContent) bool {
	...
	if p.ModelVersion != nil && (input.ModelVersion == nil || *p.ModelVersion != *input.ModelVersion) {
		return false
	}
