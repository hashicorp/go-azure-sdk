...
const (
	DelegatedAdminAccessContainerAccessContainerTypesecurityGroup DelegatedAdminAccessContainerAccessContainerType = "SecurityGroup"
)

func PossibleValuesForDelegatedAdminAccessContainerAccessContainerType() []string {
	return []string{
		string(DelegatedAdminAccessContainerAccessContainerTypesecurityGroup),
	}
}
...
func parseDelegatedAdminAccessContainerAccessContainerType(input string) (*DelegatedAdminAccessContainerAccessContainerType, error) {
	vals := map[string]DelegatedAdminAccessContainerAccessContainerType{
		"securitygroup": DelegatedAdminAccessContainerAccessContainerTypesecurityGroup,
	}
