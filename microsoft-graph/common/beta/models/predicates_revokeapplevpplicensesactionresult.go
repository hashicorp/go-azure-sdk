...
type RevokeAppleVppLicensesActionResultOperationPredicate struct {
	ActionName          *string
...
func (p RevokeAppleVppLicensesActionResultOperationPredicate) Matches(input RevokeAppleVppLicensesActionResult) bool {
