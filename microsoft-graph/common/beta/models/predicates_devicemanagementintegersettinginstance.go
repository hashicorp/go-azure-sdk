...
type DeviceManagementIntegerSettingInstanceOperationPredicate struct {
	DefinitionId *string
	Id           *string
	ODataType    *string
	Value        *int64
...
func (p DeviceManagementIntegerSettingInstanceOperationPredicate) Matches(input DeviceManagementIntegerSettingInstance) bool {
