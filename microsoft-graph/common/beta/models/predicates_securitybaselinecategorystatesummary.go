...
type SecurityBaselineCategoryStateSummaryOperationPredicate struct {
	ConflictCount      *int64
	DisplayName        *string
	ErrorCount         *int64
	Id                 *string
...
func (p SecurityBaselineCategoryStateSummaryOperationPredicate) Matches(input SecurityBaselineCategoryStateSummary) bool {
