...
type ExternalMeetingRegistrantOperationPredicate struct {
	Id         *string
	JoinWebUrl *string
	ODataType  *string
	TenantId   *string
...
func (p ExternalMeetingRegistrantOperationPredicate) Matches(input ExternalMeetingRegistrant) bool {
