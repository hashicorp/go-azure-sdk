...
type IosVppAppAssignedUserLicenseOperationPredicate struct {
	Id                *string
	ODataType         *string
...
func (p IosVppAppAssignedUserLicenseOperationPredicate) Matches(input IosVppAppAssignedUserLicense) bool {
