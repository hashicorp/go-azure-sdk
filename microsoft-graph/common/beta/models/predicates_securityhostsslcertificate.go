...
type SecurityHostSslCertificateOperationPredicate struct {
...
func (p SecurityHostSslCertificateOperationPredicate) Matches(input SecurityHostSslCertificate) bool {
