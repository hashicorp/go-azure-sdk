...
type CloudPCCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p CloudPCCollectionResponseOperationPredicate) Matches(input CloudPCCollectionResponse) bool {
