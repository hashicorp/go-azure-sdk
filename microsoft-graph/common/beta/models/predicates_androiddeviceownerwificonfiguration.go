...
type AndroidDeviceOwnerWiFiConfigurationOperationPredicate struct {
...
func (p AndroidDeviceOwnerWiFiConfigurationOperationPredicate) Matches(input AndroidDeviceOwnerWiFiConfiguration) bool {
