...
type AndroidForWorkEasEmailProfileBaseOperationPredicate struct {
...
func (p AndroidForWorkEasEmailProfileBaseOperationPredicate) Matches(input AndroidForWorkEasEmailProfileBase) bool {
