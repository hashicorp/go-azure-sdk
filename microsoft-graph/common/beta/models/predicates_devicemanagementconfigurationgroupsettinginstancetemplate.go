...
type DeviceManagementConfigurationGroupSettingInstanceTemplateOperationPredicate struct {
	IsRequired                *bool
	ODataType                 *string
...
func (p DeviceManagementConfigurationGroupSettingInstanceTemplateOperationPredicate) Matches(input DeviceManagementConfigurationGroupSettingInstanceTemplate) bool {
