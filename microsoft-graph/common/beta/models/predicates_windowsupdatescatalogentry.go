...
type WindowsUpdatesCatalogEntryOperationPredicate struct {
...
func (p WindowsUpdatesCatalogEntryOperationPredicate) Matches(input WindowsUpdatesCatalogEntry) bool {
