...
const (
	...
	EventMessageMeetingMessageTypemeetingTentativelyAccepted EventMessageMeetingMessageType = "MeetingTentativelyAccepted"
...
func PossibleValuesForEventMessageMeetingMessageType() []string {
	return []string{
		...
		string(EventMessageMeetingMessageTypemeetingTentativelyAccepted),
...
func parseEventMessageMeetingMessageType(input string) (*EventMessageMeetingMessageType, error) {
	vals := map[string]EventMessageMeetingMessageType{
		...
		"meetingtentativelyaccepted": EventMessageMeetingMessageTypemeetingTentativelyAccepted,
