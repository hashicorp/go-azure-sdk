...
type DeviceManagementComplexSettingDefinitionOperationPredicate struct {
	Description      *string
	DisplayName      *string
...
func (p DeviceManagementComplexSettingDefinitionOperationPredicate) Matches(input DeviceManagementComplexSettingDefinition) bool {
