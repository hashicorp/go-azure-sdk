...
type PictureCollectionResponseOperationPredicate struct {
	ODataCount    *int64
	ODataNextLink *string
}

func (p PictureCollectionResponseOperationPredicate) Matches(input PictureCollectionResponse) bool {
