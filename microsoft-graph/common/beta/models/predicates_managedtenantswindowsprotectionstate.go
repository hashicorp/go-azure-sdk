...
type ManagedTenantsWindowsProtectionStateOperationPredicate struct {
	AntiMalwareVersion             *string
	AttentionRequired              *bool
	DeviceDeleted                  *bool
	DevicePropertyRefreshDateTime  *string
...
func (p ManagedTenantsWindowsProtectionStateOperationPredicate) Matches(input ManagedTenantsWindowsProtectionState) bool {

	if p.AntiMalwareVersion != nil && (input.AntiMalwareVersion == nil || *p.AntiMalwareVersion != *input.AntiMalwareVersion) {
		return false
	}

	if p.AttentionRequired != nil && (input.AttentionRequired == nil || *p.AttentionRequired != *input.AttentionRequired) {
		return false
	}
	...
	if p.DevicePropertyRefreshDateTime != nil && (input.DevicePropertyRefreshDateTime == nil || *p.DevicePropertyRefreshDateTime != *input.DevicePropertyRefreshDateTime) {
		return false
	}
	...
	if p.ManagedDeviceHealthState != nil && (input.ManagedDeviceHealthState == nil || *p.ManagedDeviceHealthState != *input.ManagedDeviceHealthState) {
		return false
	}
