...
type SecurityAddWatermarkActionOperationPredicate struct {
	FontColor     *string
	FontName      *string
	FontSize      *int64
	ODataType     *string
...
func (p SecurityAddWatermarkActionOperationPredicate) Matches(input SecurityAddWatermarkAction) bool {
