...
type SecurityRedundancyDetectionSettingsOperationPredicate struct {
	IsEnabled           *bool
	MaxWords            *int64
	MinWords            *int64
	ODataType           *string
...
func (p SecurityRedundancyDetectionSettingsOperationPredicate) Matches(input SecurityRedundancyDetectionSettings) bool {
