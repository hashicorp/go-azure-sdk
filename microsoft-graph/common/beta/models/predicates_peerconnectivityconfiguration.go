...
type PeerConnectivityConfigurationOperationPredicate struct {
	Asn        *int64
	BgpAddress *string
	Endpoint   *string
	ODataType  *string
...
func (p PeerConnectivityConfigurationOperationPredicate) Matches(input PeerConnectivityConfiguration) bool {
