...
type CalendarSharingMessageOperationPredicate struct {
	BodyPreview                *string
	CanAccept                  *bool
	ChangeKey                  *string
...
func (p CalendarSharingMessageOperationPredicate) Matches(input CalendarSharingMessage) bool {

	if p.BodyPreview != nil && (input.BodyPreview == nil || *p.BodyPreview != *input.BodyPreview) {
		return false
	}

	if p.CanAccept != nil && (input.CanAccept == nil || *p.CanAccept != *input.CanAccept) {
		return false
	}
	...
	if p.SuggestedCalendarName != nil && (input.SuggestedCalendarName == nil || *p.SuggestedCalendarName != *input.SuggestedCalendarName) {
		return false
	}
