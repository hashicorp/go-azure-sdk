...
type AppleVpnConfiguration struct {
	...
	AuthenticationMethod                        *AppleVpnConfigurationAuthenticationMethod   `json:"authenticationMethod,omitempty"`
	ConnectionName                              *string                                      `json:"connectionName,omitempty"`
	ConnectionType                              *AppleVpnConfigurationConnectionType         `json:"connectionType,omitempty"`
	...
	ProviderType                                *AppleVpnConfigurationProviderType           `json:"providerType,omitempty"`
