...
type AndroidDeviceOwnerEnterpriseWiFiConfigurationOperationPredicate struct {
...
func (p AndroidDeviceOwnerEnterpriseWiFiConfigurationOperationPredicate) Matches(input AndroidDeviceOwnerEnterpriseWiFiConfiguration) bool {
	...
	if p.PreSharedKeyIsSet != nil && (input.PreSharedKeyIsSet == nil || *p.PreSharedKeyIsSet != *input.PreSharedKeyIsSet) {
		return false
	}
	...
	if p.ProxyExclusionList != nil && (input.ProxyExclusionList == nil || *p.ProxyExclusionList != *input.ProxyExclusionList) {
		return false
	}
