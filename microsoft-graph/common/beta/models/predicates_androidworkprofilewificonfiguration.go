...
type AndroidWorkProfileWiFiConfigurationOperationPredicate struct {
...
func (p AndroidWorkProfileWiFiConfigurationOperationPredicate) Matches(input AndroidWorkProfileWiFiConfiguration) bool {
