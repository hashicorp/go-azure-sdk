...
type AndroidScepCertificateProfile struct {
	...
	CertificateValidityPeriodScale              *AndroidScepCertificateProfileCertificateValidityPeriodScale `json:"certificateValidityPeriodScale,omitempty"`
	...
	HashAlgorithm                               *AndroidScepCertificateProfileHashAlgorithm                  `json:"hashAlgorithm,omitempty"`
	Id                                          *string                                                      `json:"id,omitempty"`
	KeySize                                     *AndroidScepCertificateProfileKeySize                        `json:"keySize,omitempty"`
	KeyUsage                                    *AndroidScepCertificateProfileKeyUsage                       `json:"keyUsage,omitempty"`
	...
	SubjectAlternativeNameType                  *AndroidScepCertificateProfileSubjectAlternativeNameType     `json:"subjectAlternativeNameType,omitempty"`
	SubjectNameFormat                           *AndroidScepCertificateProfileSubjectNameFormat              `json:"subjectNameFormat,omitempty"`
