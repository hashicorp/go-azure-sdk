...
type SecurityEdiscoveryCustodianOperationPredicate struct {
...
func (p SecurityEdiscoveryCustodianOperationPredicate) Matches(input SecurityEdiscoveryCustodian) bool {
