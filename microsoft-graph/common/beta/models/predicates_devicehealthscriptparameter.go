...
type DeviceHealthScriptParameterOperationPredicate struct {
...
func (p DeviceHealthScriptParameterOperationPredicate) Matches(input DeviceHealthScriptParameter) bool {
