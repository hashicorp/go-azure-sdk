...
const (
	AndroidManagedAppRegistrationFlaggedReasonsandroidBootloaderUnlocked AndroidManagedAppRegistrationFlaggedReasons = "AndroidBootloaderUnlocked"
	AndroidManagedAppRegistrationFlaggedReasonsandroidFactoryRomModified AndroidManagedAppRegistrationFlaggedReasons = "AndroidFactoryRomModified"
...
func PossibleValuesForAndroidManagedAppRegistrationFlaggedReasons() []string {
	return []string{
		string(AndroidManagedAppRegistrationFlaggedReasonsandroidBootloaderUnlocked),
		string(AndroidManagedAppRegistrationFlaggedReasonsandroidFactoryRomModified),
...
func parseAndroidManagedAppRegistrationFlaggedReasons(input string) (*AndroidManagedAppRegistrationFlaggedReasons, error) {
	vals := map[string]AndroidManagedAppRegistrationFlaggedReasons{
		"androidbootloaderunlocked": AndroidManagedAppRegistrationFlaggedReasonsandroidBootloaderUnlocked,
		"androidfactoryrommodified": AndroidManagedAppRegistrationFlaggedReasonsandroidFactoryRomModified,
