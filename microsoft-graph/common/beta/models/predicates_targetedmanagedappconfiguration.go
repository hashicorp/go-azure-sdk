...
type TargetedManagedAppConfigurationOperationPredicate struct {
...
func (p TargetedManagedAppConfigurationOperationPredicate) Matches(input TargetedManagedAppConfiguration) bool {
