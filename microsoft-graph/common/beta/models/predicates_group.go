...
type GroupOperationPredicate struct {
	...
	Theme                         *string
	UniqueName                    *string
	UnseenConversationsCount      *int64
	UnseenCount                   *int64
	UnseenMessagesCount           *int64
	Visibility                    *string
}
...
func (p GroupOperationPredicate) Matches(input Group) bool {
	...
	if p.OrganizationId != nil && (input.OrganizationId == nil || *p.OrganizationId != *input.OrganizationId) {
		return false
	}
	...
	if p.UnseenConversationsCount != nil && (input.UnseenConversationsCount == nil || *p.UnseenConversationsCount != *input.UnseenConversationsCount) {
		return false
	}
	...
	if p.UnseenMessagesCount != nil && (input.UnseenMessagesCount == nil || *p.UnseenMessagesCount != *input.UnseenMessagesCount) {
		return false
	}
