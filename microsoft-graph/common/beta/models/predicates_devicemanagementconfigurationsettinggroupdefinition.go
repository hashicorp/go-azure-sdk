...
type DeviceManagementConfigurationSettingGroupDefinitionOperationPredicate struct {
	BaseUri          *string
	CategoryId       *string
	Description      *string
	DisplayName      *string
...
func (p DeviceManagementConfigurationSettingGroupDefinitionOperationPredicate) Matches(input DeviceManagementConfigurationSettingGroupDefinition) bool {
