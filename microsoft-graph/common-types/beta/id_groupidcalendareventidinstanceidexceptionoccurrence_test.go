...
func TestParseGroupIdCalendarEventIdInstanceIdExceptionOccurrenceID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupIdCalendarEventIdInstanceIdExceptionOccurrenceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupIdCalendarEventIdInstanceIdExceptionOccurrenceIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdCalendarEventIdInstanceIdExceptionOccurrenceId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupIdCalendarEventIdInstanceIdExceptionOccurrenceIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupIdCalendarEventIdInstanceIdExceptionOccurrenceId(t *testing.T) {
	segments := GroupIdCalendarEventIdInstanceIdExceptionOccurrenceId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupIdCalendarEventIdInstanceIdExceptionOccurrenceId has no segments")
	}
