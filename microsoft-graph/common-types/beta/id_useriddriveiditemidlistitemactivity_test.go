...
func TestNewUserIdDriveIdItemIdListItemActivityID(t *testing.T) {
	id := NewUserIdDriveIdItemIdListItemActivityID("userIdValue", "driveIdValue", "driveItemIdValue", "itemActivityOLDIdValue")
...
func TestFormatUserIdDriveIdItemIdListItemActivityID(t *testing.T) {
	actual := NewUserIdDriveIdItemIdListItemActivityID("userIdValue", "driveIdValue", "driveItemIdValue", "itemActivityOLDIdValue").ID()
	expected := "/users/userIdValue/drives/driveIdValue/items/driveItemIdValue/listItem/activities/itemActivityOLDIdValue"
	if actual != expected {
...
func TestParseUserIdDriveIdItemIdListItemActivityID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/users/userIdValue/drives/driveIdValue/items/driveItemIdValue/listItem/activities",
			Error: true,
		},
		{
			// Valid URI
			Input: "/users/userIdValue/drives/driveIdValue/items/driveItemIdValue/listItem/activities/itemActivityOLDIdValue",
			Expected: &UserIdDriveIdItemIdListItemActivityId{
				UserId:            "userIdValue",
		...
		},
		{
			...
			Input: "/users/userIdValue/drives/driveIdValue/items/driveItemIdValue/listItem/activities/itemActivityOLDIdValue/extra",
			Error: true,
		},
	}
