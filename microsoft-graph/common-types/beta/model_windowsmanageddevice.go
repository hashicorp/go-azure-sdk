...
type WindowsManagedDevice struct {
	...
	ChassisType                                 *WindowsManagedDeviceChassisType                `json:"chassisType,omitempty"`
	...
	ComplianceState                             *WindowsManagedDeviceComplianceState            `json:"complianceState,omitempty"`
	...
	DeviceEnrollmentType                        *WindowsManagedDeviceDeviceEnrollmentType       `json:"deviceEnrollmentType,omitempty"`
	...
	DeviceRegistrationState                     *WindowsManagedDeviceDeviceRegistrationState    `json:"deviceRegistrationState,omitempty"`
	DeviceType                                  *WindowsManagedDeviceDeviceType                 `json:"deviceType,omitempty"`
	...
	ExchangeAccessState                         *WindowsManagedDeviceExchangeAccessState        `json:"exchangeAccessState,omitempty"`
	ExchangeAccessStateReason                   *WindowsManagedDeviceExchangeAccessStateReason  `json:"exchangeAccessStateReason,omitempty"`
	...
	JoinType                                    *WindowsManagedDeviceJoinType                   `json:"joinType,omitempty"`
	...
	LostModeState                               *WindowsManagedDeviceLostModeState              `json:"lostModeState,omitempty"`
	...
	ManagedDeviceOwnerType                      *WindowsManagedDeviceManagedDeviceOwnerType     `json:"managedDeviceOwnerType,omitempty"`
	ManagementAgent                             *WindowsManagedDeviceManagementAgent            `json:"managementAgent,omitempty"`
	ManagementCertificateExpirationDate         *string                                         `json:"managementCertificateExpirationDate,omitempty"`
	ManagementFeatures                          *WindowsManagedDeviceManagementFeatures         `json:"managementFeatures,omitempty"`
	ManagementState                             *WindowsManagedDeviceManagementState            `json:"managementState,omitempty"`
	...
	OwnerType                                   *WindowsManagedDeviceOwnerType                  `json:"ownerType,omitempty"`
	PartnerReportedThreatState                  *WindowsManagedDevicePartnerReportedThreatState `json:"partnerReportedThreatState,omitempty"`
	...
	ProcessorArchitecture                       *WindowsManagedDeviceProcessorArchitecture      `json:"processorArchitecture,omitempty"`
