...
func TestNewGroupIdDriveIdListContentTypeID(t *testing.T) {
	id := NewGroupIdDriveIdListContentTypeID("groupIdValue", "driveIdValue", "contentTypeIdValue")
...
func TestFormatGroupIdDriveIdListContentTypeID(t *testing.T) {
	actual := NewGroupIdDriveIdListContentTypeID("groupIdValue", "driveIdValue", "contentTypeIdValue").ID()
	expected := "/groups/groupIdValue/drives/driveIdValue/list/contentTypes/contentTypeIdValue"
	if actual != expected {
...
func TestParseGroupIdDriveIdListContentTypeID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/groups/groupIdValue/drives/driveIdValue/list/contentTypes/contentTypeIdValue/extra",
			Error: true,
		},
	}
