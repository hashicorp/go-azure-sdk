...
const (
	...
	WindowsUpdateScheduledInstallScheduledInstallDay_NoScheduledScan WindowsUpdateScheduledInstallScheduledInstallDay = "noScheduledScan"
...
func PossibleValuesForWindowsUpdateScheduledInstallScheduledInstallDay() []string {
	return []string{
		...
		string(WindowsUpdateScheduledInstallScheduledInstallDay_NoScheduledScan),
...
func parseWindowsUpdateScheduledInstallScheduledInstallDay(input string) (*WindowsUpdateScheduledInstallScheduledInstallDay, error) {
	vals := map[string]WindowsUpdateScheduledInstallScheduledInstallDay{
		...
		"noscheduledscan": WindowsUpdateScheduledInstallScheduledInstallDay_NoScheduledScan,
