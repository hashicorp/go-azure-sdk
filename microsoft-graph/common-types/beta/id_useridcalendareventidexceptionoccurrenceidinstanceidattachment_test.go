...
func TestNewUserIdCalendarEventIdExceptionOccurrenceIdInstanceIdAttachmentID(t *testing.T) {
	id := NewUserIdCalendarEventIdExceptionOccurrenceIdInstanceIdAttachmentID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue")
...
func TestFormatUserIdCalendarEventIdExceptionOccurrenceIdInstanceIdAttachmentID(t *testing.T) {
	actual := NewUserIdCalendarEventIdExceptionOccurrenceIdInstanceIdAttachmentID("userIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue").ID()
...
func TestParseUserIdCalendarEventIdExceptionOccurrenceIdInstanceIdAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarEventIdExceptionOccurrenceIdInstanceIdAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarEventIdExceptionOccurrenceIdInstanceIdAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserIdCalendarEventIdExceptionOccurrenceIdInstanceIdAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarEventIdExceptionOccurrenceIdInstanceIdAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarEventIdExceptionOccurrenceIdInstanceIdAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserIdCalendarEventIdExceptionOccurrenceIdInstanceIdAttachmentId(t *testing.T) {
	segments := UserIdCalendarEventIdExceptionOccurrenceIdInstanceIdAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserIdCalendarEventIdExceptionOccurrenceIdInstanceIdAttachmentId has no segments")
	}
