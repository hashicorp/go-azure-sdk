...
const (
	...
	SecurityEdiscoveryPurgeDataOperationAction_ExportReport       SecurityEdiscoveryPurgeDataOperationAction = "exportReport"
	SecurityEdiscoveryPurgeDataOperationAction_ExportResult       SecurityEdiscoveryPurgeDataOperationAction = "exportResult"
...
func PossibleValuesForSecurityEdiscoveryPurgeDataOperationAction() []string {
	return []string{
		...
		string(SecurityEdiscoveryPurgeDataOperationAction_ExportReport),
		string(SecurityEdiscoveryPurgeDataOperationAction_ExportResult),
...
func parseSecurityEdiscoveryPurgeDataOperationAction(input string) (*SecurityEdiscoveryPurgeDataOperationAction, error) {
	vals := map[string]SecurityEdiscoveryPurgeDataOperationAction{
		...
		"exportreport":       SecurityEdiscoveryPurgeDataOperationAction_ExportReport,
		"exportresult":       SecurityEdiscoveryPurgeDataOperationAction_ExportResult,
