...
const (
	...
	EventMessageRequestMeetingMessageType_MeetingTentativelyAccepted EventMessageRequestMeetingMessageType = "meetingTentativelyAccepted"
...
func PossibleValuesForEventMessageRequestMeetingMessageType() []string {
	return []string{
		...
		string(EventMessageRequestMeetingMessageType_MeetingTentativelyAccepted),
...
func parseEventMessageRequestMeetingMessageType(input string) (*EventMessageRequestMeetingMessageType, error) {
	vals := map[string]EventMessageRequestMeetingMessageType{
		...
		"meetingtentativelyaccepted": EventMessageRequestMeetingMessageType_MeetingTentativelyAccepted,
