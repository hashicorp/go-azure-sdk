...
type SecretInformationAccessAwsServerlessFunctionFinding struct {
	...
	SecretInformationWebServices *SecretInformationAccessAwsServerlessFunctionFindingSecretInformationWebServices `json:"secretInformationWebServices,omitempty"`
}
