...
const (
	...
	IosUpdateDeviceStatusInstallStatus_MdmClientCrashed                   IosUpdateDeviceStatusInstallStatus = "mdmClientCrashed"
	...
	IosUpdateDeviceStatusInstallStatus_Timeout                            IosUpdateDeviceStatusInstallStatus = "timeout"
	IosUpdateDeviceStatusInstallStatus_Unknown                            IosUpdateDeviceStatusInstallStatus = "unknown"
	IosUpdateDeviceStatusInstallStatus_UpdateError                        IosUpdateDeviceStatusInstallStatus = "updateError"
	IosUpdateDeviceStatusInstallStatus_UpdateScanFailed                   IosUpdateDeviceStatusInstallStatus = "updateScanFailed"
)
...
func PossibleValuesForIosUpdateDeviceStatusInstallStatus() []string {
	return []string{
		...
		string(IosUpdateDeviceStatusInstallStatus_MdmClientCrashed),
		...
		string(IosUpdateDeviceStatusInstallStatus_Timeout),
		string(IosUpdateDeviceStatusInstallStatus_Unknown),
		string(IosUpdateDeviceStatusInstallStatus_UpdateError),
		string(IosUpdateDeviceStatusInstallStatus_UpdateScanFailed),
	}
}
...
func parseIosUpdateDeviceStatusInstallStatus(input string) (*IosUpdateDeviceStatusInstallStatus, error) {
	vals := map[string]IosUpdateDeviceStatusInstallStatus{
		...
		"mdmclientcrashed":                   IosUpdateDeviceStatusInstallStatus_MdmClientCrashed,
		...
		"timeout":                            IosUpdateDeviceStatusInstallStatus_Timeout,
		"unknown":                            IosUpdateDeviceStatusInstallStatus_Unknown,
		"updateerror":                        IosUpdateDeviceStatusInstallStatus_UpdateError,
		"updatescanfailed":                   IosUpdateDeviceStatusInstallStatus_UpdateScanFailed,
	}
