...
func TestNewGroupIdEventIdInstanceIdExceptionOccurrenceIdExtensionID(t *testing.T) {
	id := NewGroupIdEventIdInstanceIdExceptionOccurrenceIdExtensionID("groupId", "eventId", "eventId1", "eventId2", "extensionId")
...
func TestFormatGroupIdEventIdInstanceIdExceptionOccurrenceIdExtensionID(t *testing.T) {
	actual := NewGroupIdEventIdInstanceIdExceptionOccurrenceIdExtensionID("groupId", "eventId", "eventId1", "eventId2", "extensionId").ID()
	expected := "/groups/groupId/events/eventId/instances/eventId1/exceptionOccurrences/eventId2/extensions/extensionId"
	if actual != expected {
...
func TestParseGroupIdEventIdInstanceIdExceptionOccurrenceIdExtensionID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupId/events/eventId/instances/eventId1/exceptionOccurrences/eventId2/extensions",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupId/events/eventId/instances/eventId1/exceptionOccurrences/eventId2/extensions/extensionId",
			Expected: &GroupIdEventIdInstanceIdExceptionOccurrenceIdExtensionId{
				GroupId:     "groupId",
				EventId:     "eventId",
				EventId1:    "eventId1",
		...
		},
		{
			...
			Input: "/groups/groupId/events/eventId/instances/eventId1/exceptionOccurrences/eventId2/extensions/extensionId/extra",
			Error: true,
		},
	}
