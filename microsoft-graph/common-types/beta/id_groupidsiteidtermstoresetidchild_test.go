...
func TestNewGroupIdSiteIdTermStoreSetIdChildID(t *testing.T) {
	id := NewGroupIdSiteIdTermStoreSetIdChildID("groupIdValue", "siteIdValue", "setIdValue", "termIdValue")
...
func TestFormatGroupIdSiteIdTermStoreSetIdChildID(t *testing.T) {
	actual := NewGroupIdSiteIdTermStoreSetIdChildID("groupIdValue", "siteIdValue", "setIdValue", "termIdValue").ID()
...
func TestParseGroupIdSiteIdTermStoreSetIdChildID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdSiteIdTermStoreSetIdChildId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupIdSiteIdTermStoreSetIdChildID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupIdSiteIdTermStoreSetIdChildIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdSiteIdTermStoreSetIdChildId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupIdSiteIdTermStoreSetIdChildIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupIdSiteIdTermStoreSetIdChildId(t *testing.T) {
	segments := GroupIdSiteIdTermStoreSetIdChildId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupIdSiteIdTermStoreSetIdChildId has no segments")
	}
