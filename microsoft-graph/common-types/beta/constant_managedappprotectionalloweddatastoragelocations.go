...
const (
	...
	ManagedAppProtectionAllowedDataStorageLocations_PhotoLibrary        ManagedAppProtectionAllowedDataStorageLocations = "photoLibrary"
...
func PossibleValuesForManagedAppProtectionAllowedDataStorageLocations() []string {
	return []string{
		...
		string(ManagedAppProtectionAllowedDataStorageLocations_PhotoLibrary),
...
func parseManagedAppProtectionAllowedDataStorageLocations(input string) (*ManagedAppProtectionAllowedDataStorageLocations, error) {
	vals := map[string]ManagedAppProtectionAllowedDataStorageLocations{
		...
		"photolibrary":        ManagedAppProtectionAllowedDataStorageLocations_PhotoLibrary,
