...
type DeviceComanagementAuthorityConfiguration struct {
	...
	DeviceEnrollmentConfigurationType            *DeviceComanagementAuthorityConfigurationDeviceEnrollmentConfigurationType `json:"deviceEnrollmentConfigurationType,omitempty"`
