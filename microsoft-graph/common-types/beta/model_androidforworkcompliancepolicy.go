...
type AndroidForWorkCompliancePolicy struct {
	...
	DeviceThreatProtectionRequiredSecurityLevel        *AndroidForWorkCompliancePolicyDeviceThreatProtectionRequiredSecurityLevel    `json:"deviceThreatProtectionRequiredSecurityLevel,omitempty"`
	...
	PasswordRequiredType                               *AndroidForWorkCompliancePolicyPasswordRequiredType                           `json:"passwordRequiredType,omitempty"`
	PasswordSignInFailureCountBeforeFactoryReset       *int64                                                                        `json:"passwordSignInFailureCountBeforeFactoryReset,omitempty"`
	RequiredPasswordComplexity                         *AndroidForWorkCompliancePolicyRequiredPasswordComplexity                     `json:"requiredPasswordComplexity,omitempty"`
	...
	SecurityRequiredAndroidSafetyNetEvaluationType     *AndroidForWorkCompliancePolicySecurityRequiredAndroidSafetyNetEvaluationType `json:"securityRequiredAndroidSafetyNetEvaluationType,omitempty"`
