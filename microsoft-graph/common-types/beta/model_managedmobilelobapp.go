...
type ManagedMobileLobApp struct {
	AppAvailability         *ManagedMobileLobAppAppAvailability `json:"appAvailability,omitempty"`
	...
	PublishingState         *ManagedMobileLobAppPublishingState `json:"publishingState,omitempty"`
