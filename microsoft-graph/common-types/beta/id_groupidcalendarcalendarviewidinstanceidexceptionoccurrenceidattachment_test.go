...
func TestNewGroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceIdAttachmentID(t *testing.T) {
	id := NewGroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceIdAttachmentID("groupIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue")
...
func TestFormatGroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceIdAttachmentID(t *testing.T) {
	actual := NewGroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceIdAttachmentID("groupIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "attachmentIdValue").ID()
