...
type AndroidWorkProfileGeneralDeviceConfiguration struct {
	...
	RequiredPasswordComplexity                                *AndroidWorkProfileGeneralDeviceConfigurationRequiredPasswordComplexity            `json:"requiredPasswordComplexity,omitempty"`
	...
	WorkProfileAccountUse                                     *AndroidWorkProfileGeneralDeviceConfigurationWorkProfileAccountUse                 `json:"workProfileAccountUse,omitempty"`
	...
	WorkProfileRequiredPasswordComplexity                     *AndroidWorkProfileGeneralDeviceConfigurationWorkProfileRequiredPasswordComplexity `json:"workProfileRequiredPasswordComplexity,omitempty"`
}
