...
func TestNewGroupIdEventIdInstanceIdAttachmentID(t *testing.T) {
	id := NewGroupIdEventIdInstanceIdAttachmentID("groupId", "eventId", "eventId1", "attachmentId")
...
func TestFormatGroupIdEventIdInstanceIdAttachmentID(t *testing.T) {
	actual := NewGroupIdEventIdInstanceIdAttachmentID("groupId", "eventId", "eventId1", "attachmentId").ID()
	expected := "/groups/groupId/events/eventId/instances/eventId1/attachments/attachmentId"
	if actual != expected {
...
func TestParseGroupIdEventIdInstanceIdAttachmentID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupId/events/eventId/instances/eventId1/attachments",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupId/events/eventId/instances/eventId1/attachments/attachmentId",
			Expected: &GroupIdEventIdInstanceIdAttachmentId{
				GroupId:      "groupId",
				EventId:      "eventId",
				EventId1:     "eventId1",
		...
		},
		{
			...
			Input: "/groups/groupId/events/eventId/instances/eventId1/attachments/attachmentId/extra",
			Error: true,
		},
	}
