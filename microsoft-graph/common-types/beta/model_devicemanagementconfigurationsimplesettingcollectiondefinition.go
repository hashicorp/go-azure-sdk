...
func (s *DeviceManagementConfigurationSimpleSettingCollectionDefinition) UnmarshalJSON(bytes []byte) error {
	type alias DeviceManagementConfigurationSimpleSettingCollectionDefinition
	var decoded alias
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling into DeviceManagementConfigurationSimpleSettingCollectionDefinition: %+v", err)
	}
