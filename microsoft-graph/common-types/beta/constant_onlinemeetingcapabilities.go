...
const (
	OnlineMeetingCapabilities_QuestionAndAnswer OnlineMeetingCapabilities = "questionAndAnswer"
)

func PossibleValuesForOnlineMeetingCapabilities() []string {
	return []string{
		string(OnlineMeetingCapabilities_QuestionAndAnswer),
	}
}
...
func parseOnlineMeetingCapabilities(input string) (*OnlineMeetingCapabilities, error) {
	vals := map[string]OnlineMeetingCapabilities{
		"questionandanswer": OnlineMeetingCapabilities_QuestionAndAnswer,
	}
