...
func TestNewGroupIdConversationIdThreadIdPostIdMentionID(t *testing.T) {
	id := NewGroupIdConversationIdThreadIdPostIdMentionID("groupIdValue", "conversationIdValue", "conversationThreadIdValue", "postIdValue", "mentionIdValue")
...
func TestFormatGroupIdConversationIdThreadIdPostIdMentionID(t *testing.T) {
	actual := NewGroupIdConversationIdThreadIdPostIdMentionID("groupIdValue", "conversationIdValue", "conversationThreadIdValue", "postIdValue", "mentionIdValue").ID()
