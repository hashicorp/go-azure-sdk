...
type AndroidDeviceOwnerWiFiConfiguration struct {
	...
	ProxySettings                               *AndroidDeviceOwnerWiFiConfigurationProxySettings    `json:"proxySettings,omitempty"`
	...
	WiFiSecurityType                            *AndroidDeviceOwnerWiFiConfigurationWiFiSecurityType `json:"wiFiSecurityType,omitempty"`
}
