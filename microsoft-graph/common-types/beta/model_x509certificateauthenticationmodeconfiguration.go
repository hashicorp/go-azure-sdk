...
type X509CertificateAuthenticationModeConfiguration struct {
	...
	X509CertificateDefaultRequiredAffinityLevel *X509CertificateAuthenticationModeConfigurationX509CertificateDefaultRequiredAffinityLevel `json:"x509CertificateDefaultRequiredAffinityLevel,omitempty"`
}
