...
type AndroidPkcsCertificateProfile struct {
	...
	CertificateValidityPeriodScale              *AndroidPkcsCertificateProfileCertificateValidityPeriodScale `json:"certificateValidityPeriodScale,omitempty"`
	...
	SubjectAlternativeNameType                  *AndroidPkcsCertificateProfileSubjectAlternativeNameType     `json:"subjectAlternativeNameType,omitempty"`
	SubjectNameFormat                           *AndroidPkcsCertificateProfileSubjectNameFormat              `json:"subjectNameFormat,omitempty"`
