...
type AospDeviceOwnerWiFiConfiguration struct {
	...
	ProxySetting                                *AospDeviceOwnerWiFiConfigurationProxySetting     `json:"proxySetting,omitempty"`
	...
	WiFiSecurityType                            *AospDeviceOwnerWiFiConfigurationWiFiSecurityType `json:"wiFiSecurityType,omitempty"`
}
