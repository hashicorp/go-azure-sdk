...
type MacOSWiFiConfiguration struct {
	...
	ProxySettings                               *MacOSWiFiConfigurationProxySettings         `json:"proxySettings,omitempty"`
	...
	WiFiSecurityType                            *MacOSWiFiConfigurationWiFiSecurityType      `json:"wiFiSecurityType,omitempty"`
}
