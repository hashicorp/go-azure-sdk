...
type AndroidForWorkVpnConfiguration struct {
	...
	AuthenticationMethod                        *AndroidForWorkVpnConfigurationAuthenticationMethod `json:"authenticationMethod,omitempty"`
	ConnectionName                              *string                                             `json:"connectionName,omitempty"`
	ConnectionType                              *AndroidForWorkVpnConfigurationConnectionType       `json:"connectionType,omitempty"`
