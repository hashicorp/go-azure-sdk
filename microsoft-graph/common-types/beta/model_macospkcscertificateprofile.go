...
type MacOSPkcsCertificateProfile struct {
	...
	CertificateStore                            *MacOSPkcsCertificateProfileCertificateStore               `json:"certificateStore,omitempty"`
	CertificateTemplateName                     *string                                                    `json:"certificateTemplateName,omitempty"`
	CertificateValidityPeriodScale              *MacOSPkcsCertificateProfileCertificateValidityPeriodScale `json:"certificateValidityPeriodScale,omitempty"`
	...
	SubjectAlternativeNameType                  *MacOSPkcsCertificateProfileSubjectAlternativeNameType     `json:"subjectAlternativeNameType,omitempty"`
	SubjectNameFormat                           *MacOSPkcsCertificateProfileSubjectNameFormat              `json:"subjectNameFormat,omitempty"`
