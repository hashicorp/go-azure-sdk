...
const (
	...
	EventMessageResponseMeetingMessageType_MeetingTentativelyAccepted EventMessageResponseMeetingMessageType = "meetingTentativelyAccepted"
...
func PossibleValuesForEventMessageResponseMeetingMessageType() []string {
	return []string{
		...
		string(EventMessageResponseMeetingMessageType_MeetingTentativelyAccepted),
...
func parseEventMessageResponseMeetingMessageType(input string) (*EventMessageResponseMeetingMessageType, error) {
	vals := map[string]EventMessageResponseMeetingMessageType{
		...
		"meetingtentativelyaccepted": EventMessageResponseMeetingMessageType_MeetingTentativelyAccepted,
