...
func TestNewGroupIdCalendarViewIdExceptionOccurrenceIdInstanceIdExtensionID(t *testing.T) {
	id := NewGroupIdCalendarViewIdExceptionOccurrenceIdInstanceIdExtensionID("groupId", "eventId", "eventId1", "eventId2", "extensionId")
...
func TestFormatGroupIdCalendarViewIdExceptionOccurrenceIdInstanceIdExtensionID(t *testing.T) {
	actual := NewGroupIdCalendarViewIdExceptionOccurrenceIdInstanceIdExtensionID("groupId", "eventId", "eventId1", "eventId2", "extensionId").ID()
	expected := "/groups/groupId/calendarView/eventId/exceptionOccurrences/eventId1/instances/eventId2/extensions/extensionId"
	if actual != expected {
...
func TestParseGroupIdCalendarViewIdExceptionOccurrenceIdInstanceIdExtensionID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupId/calendarView/eventId/exceptionOccurrences/eventId1/instances/eventId2/extensions",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupId/calendarView/eventId/exceptionOccurrences/eventId1/instances/eventId2/extensions/extensionId",
			Expected: &GroupIdCalendarViewIdExceptionOccurrenceIdInstanceIdExtensionId{
				GroupId:     "groupId",
				EventId:     "eventId",
				EventId1:    "eventId1",
		...
		},
		{
			...
			Input: "/groups/groupId/calendarView/eventId/exceptionOccurrences/eventId1/instances/eventId2/extensions/extensionId/extra",
			Error: true,
		},
	}
