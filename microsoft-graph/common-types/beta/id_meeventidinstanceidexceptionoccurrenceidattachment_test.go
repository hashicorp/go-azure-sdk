...
func TestParseMeEventIdInstanceIdExceptionOccurrenceIdAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
	...
	for _, v := range testData {
		...
		actual, err := ParseMeEventIdInstanceIdExceptionOccurrenceIdAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseMeEventIdInstanceIdExceptionOccurrenceIdAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *MeEventIdInstanceIdExceptionOccurrenceIdAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseMeEventIdInstanceIdExceptionOccurrenceIdAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForMeEventIdInstanceIdExceptionOccurrenceIdAttachmentId(t *testing.T) {
	segments := MeEventIdInstanceIdExceptionOccurrenceIdAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("MeEventIdInstanceIdExceptionOccurrenceIdAttachmentId has no segments")
	}
