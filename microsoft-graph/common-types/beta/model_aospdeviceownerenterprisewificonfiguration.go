...
type AospDeviceOwnerEnterpriseWiFiConfiguration struct {
	...
	AuthenticationMethod                        *AospDeviceOwnerEnterpriseWiFiConfigurationAuthenticationMethod                  `json:"authenticationMethod,omitempty"`
	...
	EapType                                     *AospDeviceOwnerEnterpriseWiFiConfigurationEapType                               `json:"eapType,omitempty"`
	...
	InnerAuthenticationProtocolForEapTtls       *AospDeviceOwnerEnterpriseWiFiConfigurationInnerAuthenticationProtocolForEapTtls `json:"innerAuthenticationProtocolForEapTtls,omitempty"`
	InnerAuthenticationProtocolForPeap          *AospDeviceOwnerEnterpriseWiFiConfigurationInnerAuthenticationProtocolForPeap    `json:"innerAuthenticationProtocolForPeap,omitempty"`
	...
	ProxySetting                                *AospDeviceOwnerEnterpriseWiFiConfigurationProxySetting                          `json:"proxySetting,omitempty"`
	...
	WiFiSecurityType                            *AospDeviceOwnerEnterpriseWiFiConfigurationWiFiSecurityType                      `json:"wiFiSecurityType,omitempty"`
}
