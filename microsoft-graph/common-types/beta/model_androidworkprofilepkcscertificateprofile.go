...
type AndroidWorkProfilePkcsCertificateProfile struct {
	...
	CertificateStore                            *AndroidWorkProfilePkcsCertificateProfileCertificateStore               `json:"certificateStore,omitempty"`
	CertificateTemplateName                     *string                                                                 `json:"certificateTemplateName,omitempty"`
	CertificateValidityPeriodScale              *AndroidWorkProfilePkcsCertificateProfileCertificateValidityPeriodScale `json:"certificateValidityPeriodScale,omitempty"`
	...
	SubjectAlternativeNameType                  *AndroidWorkProfilePkcsCertificateProfileSubjectAlternativeNameType     `json:"subjectAlternativeNameType,omitempty"`
	SubjectNameFormat                           *AndroidWorkProfilePkcsCertificateProfileSubjectNameFormat              `json:"subjectNameFormat,omitempty"`
