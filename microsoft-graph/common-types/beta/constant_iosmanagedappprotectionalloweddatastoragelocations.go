...
const (
	...
	IosManagedAppProtectionAllowedDataStorageLocations_PhotoLibrary        IosManagedAppProtectionAllowedDataStorageLocations = "photoLibrary"
...
func PossibleValuesForIosManagedAppProtectionAllowedDataStorageLocations() []string {
	return []string{
		...
		string(IosManagedAppProtectionAllowedDataStorageLocations_PhotoLibrary),
...
func parseIosManagedAppProtectionAllowedDataStorageLocations(input string) (*IosManagedAppProtectionAllowedDataStorageLocations, error) {
	vals := map[string]IosManagedAppProtectionAllowedDataStorageLocations{
		...
		"photolibrary":        IosManagedAppProtectionAllowedDataStorageLocations_PhotoLibrary,
