...
const (
	...
	SecurityEdiscoveryEstimateOperationAction_ExportReport       SecurityEdiscoveryEstimateOperationAction = "exportReport"
	SecurityEdiscoveryEstimateOperationAction_ExportResult       SecurityEdiscoveryEstimateOperationAction = "exportResult"
...
func PossibleValuesForSecurityEdiscoveryEstimateOperationAction() []string {
	return []string{
		...
		string(SecurityEdiscoveryEstimateOperationAction_ExportReport),
		string(SecurityEdiscoveryEstimateOperationAction_ExportResult),
...
func parseSecurityEdiscoveryEstimateOperationAction(input string) (*SecurityEdiscoveryEstimateOperationAction, error) {
	vals := map[string]SecurityEdiscoveryEstimateOperationAction{
		...
		"exportreport":       SecurityEdiscoveryEstimateOperationAction_ExportReport,
		"exportresult":       SecurityEdiscoveryEstimateOperationAction_ExportResult,
