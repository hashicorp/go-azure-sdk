...
type AndroidDeviceOwnerVpnConfiguration struct {
	...
	AuthenticationMethod                        *AndroidDeviceOwnerVpnConfigurationAuthenticationMethod `json:"authenticationMethod,omitempty"`
	ConnectionName                              *string                                                 `json:"connectionName,omitempty"`
	ConnectionType                              *AndroidDeviceOwnerVpnConfigurationConnectionType       `json:"connectionType,omitempty"`
