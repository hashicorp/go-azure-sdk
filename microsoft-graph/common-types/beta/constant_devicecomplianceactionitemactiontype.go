...
const (
	...
	DeviceComplianceActionItemActionType_RemoteLock                   DeviceComplianceActionItemActionType = "remoteLock"
...
func PossibleValuesForDeviceComplianceActionItemActionType() []string {
	return []string{
		...
		string(DeviceComplianceActionItemActionType_RemoteLock),
...
func parseDeviceComplianceActionItemActionType(input string) (*DeviceComplianceActionItemActionType, error) {
	vals := map[string]DeviceComplianceActionItemActionType{
		...
		"remotelock":                   DeviceComplianceActionItemActionType_RemoteLock,
