...
func TestNewGroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionID(t *testing.T) {
	id := NewGroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionID("groupIdValue", "siteIdValue", "notebookIdValue", "sectionGroupIdValue", "onenoteSectionIdValue")
...
func TestFormatGroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionID(t *testing.T) {
	actual := NewGroupIdSiteIdOnenoteNotebookIdSectionGroupIdSectionID("groupIdValue", "siteIdValue", "notebookIdValue", "sectionGroupIdValue", "onenoteSectionIdValue").ID()
