...
func TestNewGroupIdCalendarEventIdExceptionOccurrenceIdExtensionID(t *testing.T) {
	id := NewGroupIdCalendarEventIdExceptionOccurrenceIdExtensionID("groupId", "eventId", "eventId1", "extensionId")
...
func TestFormatGroupIdCalendarEventIdExceptionOccurrenceIdExtensionID(t *testing.T) {
	actual := NewGroupIdCalendarEventIdExceptionOccurrenceIdExtensionID("groupId", "eventId", "eventId1", "extensionId").ID()
	expected := "/groups/groupId/calendar/events/eventId/exceptionOccurrences/eventId1/extensions/extensionId"
	if actual != expected {
...
func TestParseGroupIdCalendarEventIdExceptionOccurrenceIdExtensionID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupId/calendar/events/eventId/exceptionOccurrences/eventId1/extensions",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupId/calendar/events/eventId/exceptionOccurrences/eventId1/extensions/extensionId",
			Expected: &GroupIdCalendarEventIdExceptionOccurrenceIdExtensionId{
				GroupId:     "groupId",
				EventId:     "eventId",
				EventId1:    "eventId1",
		...
		},
		{
			...
			Input: "/groups/groupId/calendar/events/eventId/exceptionOccurrences/eventId1/extensions/extensionId/extra",
			Error: true,
		},
	}
