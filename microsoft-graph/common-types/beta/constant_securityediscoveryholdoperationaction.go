...
const (
	...
	SecurityEdiscoveryHoldOperationAction_ExportReport       SecurityEdiscoveryHoldOperationAction = "exportReport"
	SecurityEdiscoveryHoldOperationAction_ExportResult       SecurityEdiscoveryHoldOperationAction = "exportResult"
...
func PossibleValuesForSecurityEdiscoveryHoldOperationAction() []string {
	return []string{
		...
		string(SecurityEdiscoveryHoldOperationAction_ExportReport),
		string(SecurityEdiscoveryHoldOperationAction_ExportResult),
...
func parseSecurityEdiscoveryHoldOperationAction(input string) (*SecurityEdiscoveryHoldOperationAction, error) {
	vals := map[string]SecurityEdiscoveryHoldOperationAction{
		...
		"exportreport":       SecurityEdiscoveryHoldOperationAction_ExportReport,
		"exportresult":       SecurityEdiscoveryHoldOperationAction_ExportResult,
