...
type PrivilegedAccessGroupEligibilityScheduleRequest struct {
	AccessId          *PrivilegedAccessGroupEligibilityScheduleRequestAccessId `json:"accessId,omitempty"`
	Action            *PrivilegedAccessGroupEligibilityScheduleRequestAction   `json:"action,omitempty"`
