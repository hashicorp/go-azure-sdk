...
type AndroidWorkProfileCompliancePolicy struct {
	AdvancedThreatProtectionRequiredSecurityLevel      *AndroidWorkProfileCompliancePolicyAdvancedThreatProtectionRequiredSecurityLevel  `json:"advancedThreatProtectionRequiredSecurityLevel,omitempty"`
	...
	DeviceThreatProtectionRequiredSecurityLevel        *AndroidWorkProfileCompliancePolicyDeviceThreatProtectionRequiredSecurityLevel    `json:"deviceThreatProtectionRequiredSecurityLevel,omitempty"`
	...
	PasswordRequiredType                               *AndroidWorkProfileCompliancePolicyPasswordRequiredType                           `json:"passwordRequiredType,omitempty"`
	PasswordSignInFailureCountBeforeFactoryReset       *int64                                                                            `json:"passwordSignInFailureCountBeforeFactoryReset,omitempty"`
	RequiredPasswordComplexity                         *AndroidWorkProfileCompliancePolicyRequiredPasswordComplexity                     `json:"requiredPasswordComplexity,omitempty"`
	...
	SecurityRequiredAndroidSafetyNetEvaluationType     *AndroidWorkProfileCompliancePolicySecurityRequiredAndroidSafetyNetEvaluationType `json:"securityRequiredAndroidSafetyNetEvaluationType,omitempty"`
