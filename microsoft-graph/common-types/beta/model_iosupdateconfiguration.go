...
type IosUpdateConfiguration struct {
	...
	EnforcedSoftwareUpdateDelayInDays           *int64                                       `json:"enforcedSoftwareUpdateDelayInDays,omitempty"`
	...
	UpdateScheduleType                          *IosUpdateConfigurationUpdateScheduleType    `json:"updateScheduleType,omitempty"`
