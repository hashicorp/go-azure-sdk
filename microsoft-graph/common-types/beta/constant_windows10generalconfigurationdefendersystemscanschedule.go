...
const (
	...
	Windows10GeneralConfigurationDefenderSystemScanSchedule_NoScheduledScan Windows10GeneralConfigurationDefenderSystemScanSchedule = "noScheduledScan"
...
func PossibleValuesForWindows10GeneralConfigurationDefenderSystemScanSchedule() []string {
	return []string{
		...
		string(Windows10GeneralConfigurationDefenderSystemScanSchedule_NoScheduledScan),
...
func parseWindows10GeneralConfigurationDefenderSystemScanSchedule(input string) (*Windows10GeneralConfigurationDefenderSystemScanSchedule, error) {
	vals := map[string]Windows10GeneralConfigurationDefenderSystemScanSchedule{
		...
		"noscheduledscan": Windows10GeneralConfigurationDefenderSystemScanSchedule_NoScheduledScan,
