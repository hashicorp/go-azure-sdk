...
const (
	...
	SecurityCaseOperationAction_ExportReport       SecurityCaseOperationAction = "exportReport"
	SecurityCaseOperationAction_ExportResult       SecurityCaseOperationAction = "exportResult"
...
func PossibleValuesForSecurityCaseOperationAction() []string {
	return []string{
		...
		string(SecurityCaseOperationAction_ExportReport),
		string(SecurityCaseOperationAction_ExportResult),
...
func parseSecurityCaseOperationAction(input string) (*SecurityCaseOperationAction, error) {
	vals := map[string]SecurityCaseOperationAction{
		...
		"exportreport":       SecurityCaseOperationAction_ExportReport,
		"exportresult":       SecurityCaseOperationAction_ExportResult,
