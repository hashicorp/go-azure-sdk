...
const (
	...
	DeviceCompliancePolicyStatePlatformType_AndroidAOSP        DeviceCompliancePolicyStatePlatformType = "androidAOSP"
	DeviceCompliancePolicyStatePlatformType_AndroidForWork     DeviceCompliancePolicyStatePlatformType = "androidForWork"
	DeviceCompliancePolicyStatePlatformType_AndroidWorkProfile DeviceCompliancePolicyStatePlatformType = "androidWorkProfile"
	...
	DeviceCompliancePolicyStatePlatformType_Windows10XProfile  DeviceCompliancePolicyStatePlatformType = "windows10XProfile"
...
func PossibleValuesForDeviceCompliancePolicyStatePlatformType() []string {
	return []string{
		...
		string(DeviceCompliancePolicyStatePlatformType_AndroidAOSP),
		string(DeviceCompliancePolicyStatePlatformType_AndroidForWork),
		string(DeviceCompliancePolicyStatePlatformType_AndroidWorkProfile),
		...
		string(DeviceCompliancePolicyStatePlatformType_Windows10XProfile),
...
func parseDeviceCompliancePolicyStatePlatformType(input string) (*DeviceCompliancePolicyStatePlatformType, error) {
	vals := map[string]DeviceCompliancePolicyStatePlatformType{
		...
		"androidaosp":        DeviceCompliancePolicyStatePlatformType_AndroidAOSP,
		"androidforwork":     DeviceCompliancePolicyStatePlatformType_AndroidForWork,
		"androidworkprofile": DeviceCompliancePolicyStatePlatformType_AndroidWorkProfile,
		...
		"windows10xprofile":  DeviceCompliancePolicyStatePlatformType_Windows10XProfile,
