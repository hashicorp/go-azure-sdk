...
type DeviceManagementConfigurationChoiceSettingCollectionDefinition struct {
	AccessTypes                    *DeviceManagementConfigurationChoiceSettingCollectionDefinitionAccessTypes  `json:"accessTypes,omitempty"`
	...
	SettingUsage                   *DeviceManagementConfigurationChoiceSettingCollectionDefinitionSettingUsage `json:"settingUsage,omitempty"`
	UxBehavior                     *DeviceManagementConfigurationChoiceSettingCollectionDefinitionUxBehavior   `json:"uxBehavior,omitempty"`
	Version                        *string                                                                     `json:"version,omitempty"`
	Visibility                     *DeviceManagementConfigurationChoiceSettingCollectionDefinitionVisibility   `json:"visibility,omitempty"`
}
