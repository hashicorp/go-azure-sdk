...
func TestNewGroupIdEventIdInstanceIdExceptionOccurrenceID(t *testing.T) {
	id := NewGroupIdEventIdInstanceIdExceptionOccurrenceID("groupId", "eventId", "eventId1", "eventId2")
...
func TestFormatGroupIdEventIdInstanceIdExceptionOccurrenceID(t *testing.T) {
	actual := NewGroupIdEventIdInstanceIdExceptionOccurrenceID("groupId", "eventId", "eventId1", "eventId2").ID()
	expected := "/groups/groupId/events/eventId/instances/eventId1/exceptionOccurrences/eventId2"
	if actual != expected {
...
func TestParseGroupIdEventIdInstanceIdExceptionOccurrenceID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/groups/groupId/events/eventId/instances/eventId1/exceptionOccurrences/eventId2/extra",
			Error: true,
		},
	}
