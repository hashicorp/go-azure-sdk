...
func TestNewUserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionID(t *testing.T) {
	id := NewUserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionID("userIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue")
...
func TestFormatUserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionID(t *testing.T) {
	actual := NewUserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionID("userIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "eventId2Value", "extensionIdValue").ID()
...
func TestParseUserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionId(t *testing.T) {
	segments := UserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserIdCalendarIdEventIdInstanceIdExceptionOccurrenceIdExtensionId has no segments")
	}
