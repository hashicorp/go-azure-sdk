...
type AndroidLobApp struct {
	...
	PublishingState                 *AndroidLobAppPublishingState   `json:"publishingState,omitempty"`
	...
	TargetedPlatforms               *AndroidLobAppTargetedPlatforms `json:"targetedPlatforms,omitempty"`
