...
const (
	...
	X509CertificateRuleX509CertificateRuleType_IssuerSubjectAndPolicyOID X509CertificateRuleX509CertificateRuleType = "issuerSubjectAndPolicyOID"
...
func PossibleValuesForX509CertificateRuleX509CertificateRuleType() []string {
	return []string{
		...
		string(X509CertificateRuleX509CertificateRuleType_IssuerSubjectAndPolicyOID),
...
func parseX509CertificateRuleX509CertificateRuleType(input string) (*X509CertificateRuleX509CertificateRuleType, error) {
	vals := map[string]X509CertificateRuleX509CertificateRuleType{
		...
		"issuersubjectandpolicyoid": X509CertificateRuleX509CertificateRuleType_IssuerSubjectAndPolicyOID,
