...
const (
	...
	SecurityEdiscoveryExportOperationAction_ExportReport       SecurityEdiscoveryExportOperationAction = "exportReport"
	SecurityEdiscoveryExportOperationAction_ExportResult       SecurityEdiscoveryExportOperationAction = "exportResult"
...
func PossibleValuesForSecurityEdiscoveryExportOperationAction() []string {
	return []string{
		...
		string(SecurityEdiscoveryExportOperationAction_ExportReport),
		string(SecurityEdiscoveryExportOperationAction_ExportResult),
...
func parseSecurityEdiscoveryExportOperationAction(input string) (*SecurityEdiscoveryExportOperationAction, error) {
	vals := map[string]SecurityEdiscoveryExportOperationAction{
		...
		"exportreport":       SecurityEdiscoveryExportOperationAction_ExportReport,
		"exportresult":       SecurityEdiscoveryExportOperationAction_ExportResult,
