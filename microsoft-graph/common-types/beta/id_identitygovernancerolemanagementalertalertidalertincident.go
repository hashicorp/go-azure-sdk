...
func (id IdentityGovernanceRoleManagementAlertAlertIdAlertIncidentId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("unifiedRoleManagementAlertId", "unifiedRoleManagementAlertIdValue"),
		resourceids.StaticSegment("alertIncidents", "alertIncidents", "alertIncidents"),
		resourceids.UserSpecifiedSegment("unifiedRoleManagementAlertIncidentId", "unifiedRoleManagementAlertIncidentIdValue"),
	}
}
