...
type AospDeviceOwnerPkcsCertificateProfile struct {
	...
	CertificateStore                            *AospDeviceOwnerPkcsCertificateProfileCertificateStore               `json:"certificateStore,omitempty"`
	CertificateTemplateName                     *string                                                              `json:"certificateTemplateName,omitempty"`
	CertificateValidityPeriodScale              *AospDeviceOwnerPkcsCertificateProfileCertificateValidityPeriodScale `json:"certificateValidityPeriodScale,omitempty"`
	...
	CertificationAuthorityType                  *AospDeviceOwnerPkcsCertificateProfileCertificationAuthorityType     `json:"certificationAuthorityType,omitempty"`
	...
	SubjectAlternativeNameType                  *AospDeviceOwnerPkcsCertificateProfileSubjectAlternativeNameType     `json:"subjectAlternativeNameType,omitempty"`
	SubjectNameFormat                           *AospDeviceOwnerPkcsCertificateProfileSubjectNameFormat              `json:"subjectNameFormat,omitempty"`
