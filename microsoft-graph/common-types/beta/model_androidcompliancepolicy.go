...
type AndroidCompliancePolicy struct {
	AdvancedThreatProtectionRequiredSecurityLevel      *AndroidCompliancePolicyAdvancedThreatProtectionRequiredSecurityLevel `json:"advancedThreatProtectionRequiredSecurityLevel,omitempty"`
	...
	DeviceThreatProtectionRequiredSecurityLevel        *AndroidCompliancePolicyDeviceThreatProtectionRequiredSecurityLevel   `json:"deviceThreatProtectionRequiredSecurityLevel,omitempty"`
	...
	PasswordRequiredType                               *AndroidCompliancePolicyPasswordRequiredType                          `json:"passwordRequiredType,omitempty"`
	PasswordSignInFailureCountBeforeFactoryReset       *int64                                                                `json:"passwordSignInFailureCountBeforeFactoryReset,omitempty"`
	RequiredPasswordComplexity                         *AndroidCompliancePolicyRequiredPasswordComplexity                    `json:"requiredPasswordComplexity,omitempty"`
