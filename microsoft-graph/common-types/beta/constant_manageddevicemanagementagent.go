...
const (
	...
	ManagedDeviceManagementAgent_IntuneAosp                        ManagedDeviceManagementAgent = "intuneAosp"
...
func PossibleValuesForManagedDeviceManagementAgent() []string {
	return []string{
		...
		string(ManagedDeviceManagementAgent_IntuneAosp),
...
func parseManagedDeviceManagementAgent(input string) (*ManagedDeviceManagementAgent, error) {
	vals := map[string]ManagedDeviceManagementAgent{
		...
		"intuneaosp":                        ManagedDeviceManagementAgent_IntuneAosp,
