...
func TestNewUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentID(t *testing.T) {
	id := NewUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue")
...
func TestFormatUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentID(t *testing.T) {
	actual := NewUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue", "eventId1Value", "attachmentIdValue").ID()
...
func TestParseUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentId(t *testing.T) {
	segments := UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserIdCalendarGroupIdCalendarIdEventIdExceptionOccurrenceIdAttachmentId has no segments")
	}
