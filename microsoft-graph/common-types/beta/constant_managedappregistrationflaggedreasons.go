...
const (
	ManagedAppRegistrationFlaggedReasons_AndroidBootloaderUnlocked ManagedAppRegistrationFlaggedReasons = "androidBootloaderUnlocked"
	ManagedAppRegistrationFlaggedReasons_AndroidFactoryRomModified ManagedAppRegistrationFlaggedReasons = "androidFactoryRomModified"
...
func PossibleValuesForManagedAppRegistrationFlaggedReasons() []string {
	return []string{
		string(ManagedAppRegistrationFlaggedReasons_AndroidBootloaderUnlocked),
		string(ManagedAppRegistrationFlaggedReasons_AndroidFactoryRomModified),
...
func parseManagedAppRegistrationFlaggedReasons(input string) (*ManagedAppRegistrationFlaggedReasons, error) {
	vals := map[string]ManagedAppRegistrationFlaggedReasons{
		"androidbootloaderunlocked": ManagedAppRegistrationFlaggedReasons_AndroidBootloaderUnlocked,
		"androidfactoryrommodified": ManagedAppRegistrationFlaggedReasons_AndroidFactoryRomModified,
