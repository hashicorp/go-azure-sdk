...
func TestNewGroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceID(t *testing.T) {
	id := NewGroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceID("groupId", "eventId", "eventId1", "eventId2")
...
func TestFormatGroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceID(t *testing.T) {
	actual := NewGroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceID("groupId", "eventId", "eventId1", "eventId2").ID()
	expected := "/groups/groupId/calendar/calendarView/eventId/instances/eventId1/exceptionOccurrences/eventId2"
	if actual != expected {
...
func TestParseGroupIdCalendarCalendarViewIdInstanceIdExceptionOccurrenceID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/groups/groupId/calendar/calendarView/eventId/instances/eventId1/exceptionOccurrences/eventId2/extra",
			Error: true,
		},
	}
