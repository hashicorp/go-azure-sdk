...
const (
	...
	TeamworkUserIdentityUserIdentityType_AzureCommunicationServicesUser TeamworkUserIdentityUserIdentityType = "azureCommunicationServicesUser"
...
func PossibleValuesForTeamworkUserIdentityUserIdentityType() []string {
	return []string{
		...
		string(TeamworkUserIdentityUserIdentityType_AzureCommunicationServicesUser),
...
func parseTeamworkUserIdentityUserIdentityType(input string) (*TeamworkUserIdentityUserIdentityType, error) {
	vals := map[string]TeamworkUserIdentityUserIdentityType{
		...
		"azurecommunicationservicesuser": TeamworkUserIdentityUserIdentityType_AzureCommunicationServicesUser,
