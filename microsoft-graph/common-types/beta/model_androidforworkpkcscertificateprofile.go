...
type AndroidForWorkPkcsCertificateProfile struct {
	...
	CertificateValidityPeriodScale              *AndroidForWorkPkcsCertificateProfileCertificateValidityPeriodScale `json:"certificateValidityPeriodScale,omitempty"`
	...
	SubjectAlternativeNameType                  *AndroidForWorkPkcsCertificateProfileSubjectAlternativeNameType     `json:"subjectAlternativeNameType,omitempty"`
	SubjectNameFormat                           *AndroidForWorkPkcsCertificateProfileSubjectNameFormat              `json:"subjectNameFormat,omitempty"`
