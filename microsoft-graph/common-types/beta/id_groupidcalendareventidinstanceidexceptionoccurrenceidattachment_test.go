...
func TestNewGroupIdCalendarEventIdInstanceIdExceptionOccurrenceIdAttachmentID(t *testing.T) {
	id := NewGroupIdCalendarEventIdInstanceIdExceptionOccurrenceIdAttachmentID("groupId", "eventId", "eventId1", "eventId2", "attachmentId")
...
func TestFormatGroupIdCalendarEventIdInstanceIdExceptionOccurrenceIdAttachmentID(t *testing.T) {
	actual := NewGroupIdCalendarEventIdInstanceIdExceptionOccurrenceIdAttachmentID("groupId", "eventId", "eventId1", "eventId2", "attachmentId").ID()
	expected := "/groups/groupId/calendar/events/eventId/instances/eventId1/exceptionOccurrences/eventId2/attachments/attachmentId"
	if actual != expected {
...
func TestParseGroupIdCalendarEventIdInstanceIdExceptionOccurrenceIdAttachmentID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupId/calendar/events/eventId/instances/eventId1/exceptionOccurrences/eventId2/attachments",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupId/calendar/events/eventId/instances/eventId1/exceptionOccurrences/eventId2/attachments/attachmentId",
			Expected: &GroupIdCalendarEventIdInstanceIdExceptionOccurrenceIdAttachmentId{
				GroupId:      "groupId",
				EventId:      "eventId",
				EventId1:     "eventId1",
		...
		},
		{
			...
			Input: "/groups/groupId/calendar/events/eventId/instances/eventId1/exceptionOccurrences/eventId2/attachments/attachmentId/extra",
			Error: true,
		},
	}
