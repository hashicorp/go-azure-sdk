...
func TestNewMeEventIdInstanceIdExtensionID(t *testing.T) {
	id := NewMeEventIdInstanceIdExtensionID("eventId", "eventId1", "extensionId")
...
func TestFormatMeEventIdInstanceIdExtensionID(t *testing.T) {
	actual := NewMeEventIdInstanceIdExtensionID("eventId", "eventId1", "extensionId").ID()
	expected := "/me/events/eventId/instances/eventId1/extensions/extensionId"
	if actual != expected {
...
func TestParseMeEventIdInstanceIdExtensionID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/me/events/eventId/instances/eventId1/extensions",
			Error: true,
		},
		{
			// Valid URI
			Input: "/me/events/eventId/instances/eventId1/extensions/extensionId",
			Expected: &MeEventIdInstanceIdExtensionId{
				EventId:     "eventId",
				EventId1:    "eventId1",
		...
		},
		{
			...
			Input: "/me/events/eventId/instances/eventId1/extensions/extensionId/extra",
			Error: true,
		},
	}
