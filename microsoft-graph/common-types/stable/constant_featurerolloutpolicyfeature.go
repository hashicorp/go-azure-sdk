...
const (
	...
	FeatureRolloutPolicyFeature_MultiFactorAuthentication      FeatureRolloutPolicyFeature = "multiFactorAuthentication"
...
func PossibleValuesForFeatureRolloutPolicyFeature() []string {
	return []string{
		...
		string(FeatureRolloutPolicyFeature_MultiFactorAuthentication),
...
func parseFeatureRolloutPolicyFeature(input string) (*FeatureRolloutPolicyFeature, error) {
	vals := map[string]FeatureRolloutPolicyFeature{
		...
		"multifactorauthentication":      FeatureRolloutPolicyFeature_MultiFactorAuthentication,
