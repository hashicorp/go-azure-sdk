...
func TestNewUserIdCalendarGroupIdCalendarIdEventID(t *testing.T) {
	id := NewUserIdCalendarGroupIdCalendarIdEventID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue")
...
func TestFormatUserIdCalendarGroupIdCalendarIdEventID(t *testing.T) {
	actual := NewUserIdCalendarGroupIdCalendarIdEventID("userIdValue", "calendarGroupIdValue", "calendarIdValue", "eventIdValue").ID()
	expected := "/users/userIdValue/calendarGroups/calendarGroupIdValue/calendars/calendarIdValue/events/eventIdValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseUserIdCalendarGroupIdCalendarIdEventID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarGroupIdCalendarIdEventId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/users/userIdValue/calendarGroups/calendarGroupIdValue/calendars/calendarIdValue/events/eventIdValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarGroupIdCalendarIdEventID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseUserIdCalendarGroupIdCalendarIdEventIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *UserIdCalendarGroupIdCalendarIdEventId
	...
	for _, v := range testData {
		...
		actual, err := ParseUserIdCalendarGroupIdCalendarIdEventIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForUserIdCalendarGroupIdCalendarIdEventId(t *testing.T) {
	segments := UserIdCalendarGroupIdCalendarIdEventId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("UserIdCalendarGroupIdCalendarIdEventId has no segments")
	}
