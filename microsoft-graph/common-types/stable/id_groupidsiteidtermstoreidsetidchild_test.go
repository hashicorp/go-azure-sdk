...
func TestNewGroupIdSiteIdTermStoreIdSetIdChildID(t *testing.T) {
	id := NewGroupIdSiteIdTermStoreIdSetIdChildID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "termIdValue")
...
func TestFormatGroupIdSiteIdTermStoreIdSetIdChildID(t *testing.T) {
	actual := NewGroupIdSiteIdTermStoreIdSetIdChildID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "termIdValue").ID()
	expected := "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/sets/setIdValue/children/termIdValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseGroupIdSiteIdTermStoreIdSetIdChildID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdSiteIdTermStoreIdSetIdChildId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/groups/groupIdValue/sites/siteIdValue/termStores/storeIdValue/sets/setIdValue/children/termIdValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseGroupIdSiteIdTermStoreIdSetIdChildID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupIdSiteIdTermStoreIdSetIdChildIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdSiteIdTermStoreIdSetIdChildId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupIdSiteIdTermStoreIdSetIdChildIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupIdSiteIdTermStoreIdSetIdChildId(t *testing.T) {
	segments := GroupIdSiteIdTermStoreIdSetIdChildId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupIdSiteIdTermStoreIdSetIdChildId has no segments")
	}
