...
func TestNewGroupIdSiteIdOnenoteSectionIdPageID(t *testing.T) {
	id := NewGroupIdSiteIdOnenoteSectionIdPageID("groupIdValue", "siteIdValue", "onenoteSectionIdValue", "onenotePageIdValue")
...
func TestFormatGroupIdSiteIdOnenoteSectionIdPageID(t *testing.T) {
	actual := NewGroupIdSiteIdOnenoteSectionIdPageID("groupIdValue", "siteIdValue", "onenoteSectionIdValue", "onenotePageIdValue").ID()
