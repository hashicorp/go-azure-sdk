...
func (id IdentityGovernanceEntitlementManagementCatalogIdResourceRoleIdResourceRoleId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("accessPackageCatalogId", "accessPackageCatalogIdValue"),
		...
		resourceids.UserSpecifiedSegment("accessPackageResourceRoleId1", "accessPackageResourceRoleId1Value"),
	}
}
