...
func TestNewGroupIdDriveIdSpecialID(t *testing.T) {
	id := NewGroupIdDriveIdSpecialID("groupIdValue", "driveIdValue", "driveItemIdValue")
...
func TestFormatGroupIdDriveIdSpecialID(t *testing.T) {
	actual := NewGroupIdDriveIdSpecialID("groupIdValue", "driveIdValue", "driveItemIdValue").ID()
	expected := "/groups/groupIdValue/drives/driveIdValue/special/driveItemIdValue"
	if actual != expected {
...
func TestParseGroupIdDriveIdSpecialID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/groups/groupIdValue/drives/driveIdValue/special",
			Error: true,
		},
		{
			// Valid URI
			Input: "/groups/groupIdValue/drives/driveIdValue/special/driveItemIdValue",
			Expected: &GroupIdDriveIdSpecialId{
		...
		},
		{
			...
			Input: "/groups/groupIdValue/drives/driveIdValue/special/driveItemIdValue/extra",
			Error: true,
		},
	}
