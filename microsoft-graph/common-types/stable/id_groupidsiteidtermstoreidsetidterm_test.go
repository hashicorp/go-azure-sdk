...
func TestNewGroupIdSiteIdTermStoreIdSetIdTermID(t *testing.T) {
	id := NewGroupIdSiteIdTermStoreIdSetIdTermID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "termIdValue")
...
func TestFormatGroupIdSiteIdTermStoreIdSetIdTermID(t *testing.T) {
	actual := NewGroupIdSiteIdTermStoreIdSetIdTermID("groupIdValue", "siteIdValue", "storeIdValue", "setIdValue", "termIdValue").ID()
...
func TestParseGroupIdSiteIdTermStoreIdSetIdTermID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdSiteIdTermStoreIdSetIdTermId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupIdSiteIdTermStoreIdSetIdTermID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupIdSiteIdTermStoreIdSetIdTermIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdSiteIdTermStoreIdSetIdTermId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupIdSiteIdTermStoreIdSetIdTermIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupIdSiteIdTermStoreIdSetIdTermId(t *testing.T) {
	segments := GroupIdSiteIdTermStoreIdSetIdTermId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupIdSiteIdTermStoreIdSetIdTermId has no segments")
	}
