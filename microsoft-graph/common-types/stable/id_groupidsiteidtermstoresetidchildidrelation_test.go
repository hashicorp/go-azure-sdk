...
func TestNewGroupIdSiteIdTermStoreSetIdChildIdRelationID(t *testing.T) {
	id := NewGroupIdSiteIdTermStoreSetIdChildIdRelationID("groupIdValue", "siteIdValue", "setIdValue", "termIdValue", "relationIdValue")
...
func TestFormatGroupIdSiteIdTermStoreSetIdChildIdRelationID(t *testing.T) {
	actual := NewGroupIdSiteIdTermStoreSetIdChildIdRelationID("groupIdValue", "siteIdValue", "setIdValue", "termIdValue", "relationIdValue").ID()
...
func TestParseGroupIdSiteIdTermStoreSetIdChildIdRelationID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdSiteIdTermStoreSetIdChildIdRelationId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupIdSiteIdTermStoreSetIdChildIdRelationID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseGroupIdSiteIdTermStoreSetIdChildIdRelationIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *GroupIdSiteIdTermStoreSetIdChildIdRelationId
	...
	for _, v := range testData {
		...
		actual, err := ParseGroupIdSiteIdTermStoreSetIdChildIdRelationIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForGroupIdSiteIdTermStoreSetIdChildIdRelationId(t *testing.T) {
	segments := GroupIdSiteIdTermStoreSetIdChildIdRelationId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("GroupIdSiteIdTermStoreSetIdChildIdRelationId has no segments")
	}
