...
func TestNewGroupIdSiteIdOnenoteSectionGroupIdSectionIdPageID(t *testing.T) {
	id := NewGroupIdSiteIdOnenoteSectionGroupIdSectionIdPageID("groupIdValue", "siteIdValue", "sectionGroupIdValue", "onenoteSectionIdValue", "onenotePageIdValue")
...
func TestFormatGroupIdSiteIdOnenoteSectionGroupIdSectionIdPageID(t *testing.T) {
	actual := NewGroupIdSiteIdOnenoteSectionGroupIdSectionIdPageID("groupIdValue", "siteIdValue", "sectionGroupIdValue", "onenoteSectionIdValue", "onenotePageIdValue").ID()
