...
func TestNewGroupIdOnenoteNotebookIdSectionGroupID(t *testing.T) {
	id := NewGroupIdOnenoteNotebookIdSectionGroupID("groupIdValue", "notebookIdValue", "sectionGroupIdValue")
...
func TestFormatGroupIdOnenoteNotebookIdSectionGroupID(t *testing.T) {
	actual := NewGroupIdOnenoteNotebookIdSectionGroupID("groupIdValue", "notebookIdValue", "sectionGroupIdValue").ID()
