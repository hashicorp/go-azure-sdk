...
func TestNewMeEventIdInstanceIdAttachmentID(t *testing.T) {
	id := NewMeEventIdInstanceIdAttachmentID("eventIdValue", "eventId1Value", "attachmentIdValue")
...
func TestFormatMeEventIdInstanceIdAttachmentID(t *testing.T) {
	actual := NewMeEventIdInstanceIdAttachmentID("eventIdValue", "eventId1Value", "attachmentIdValue").ID()
