...
func TestNewUserIdJoinedTeamIdChannelIdMessageIdReplyID(t *testing.T) {
	id := NewUserIdJoinedTeamIdChannelIdMessageIdReplyID("userIdValue", "teamIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageId1Value")
...
func TestFormatUserIdJoinedTeamIdChannelIdMessageIdReplyID(t *testing.T) {
	actual := NewUserIdJoinedTeamIdChannelIdMessageIdReplyID("userIdValue", "teamIdValue", "channelIdValue", "chatMessageIdValue", "chatMessageId1Value").ID()
