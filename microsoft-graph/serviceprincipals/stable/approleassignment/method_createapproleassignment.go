...
func (c AppRoleAssignmentClient) CreateAppRoleAssignment(ctx context.Context, id ServicePrincipalId, input stable.AppRoleAssignment) (result CreateAppRoleAssignmentOperationResponse, err error) {
