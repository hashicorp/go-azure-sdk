...
func (c AppRoleAssignmentClient) CreateAppRoleAssignment(ctx context.Context, id stable.ServicePrincipalId, input stable.AppRoleAssignment) (result CreateAppRoleAssignmentOperationResponse, err error) {
