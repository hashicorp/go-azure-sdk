...
func (c SynchronizationTemplateSchemaDirectoryClient) DiscoverSynchronizationTemplateSchemaDirectory(ctx context.Context, id stable.ServicePrincipalIdSynchronizationTemplateIdSchemaDirectoryId) (result DiscoverSynchronizationTemplateSchemaDirectoryOperationResponse, err error) {
