...
func (c OwnerClient) AddOwnerRef(ctx context.Context, id stable.ServicePrincipalId, input stable.ReferenceCreate) (result AddOwnerRefOperationResponse, err error) {
