...
func (c OwnedObjectClient) GetOwnedObjectApplicationCount(ctx context.Context, id stable.ServicePrincipalId, options GetOwnedObjectApplicationCountOperationOptions) (result GetOwnedObjectApplicationCountOperationResponse, err error) {
