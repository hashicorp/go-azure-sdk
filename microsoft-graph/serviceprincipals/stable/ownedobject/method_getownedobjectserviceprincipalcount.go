...
func (c OwnedObjectClient) GetOwnedObjectServicePrincipalCount(ctx context.Context, id stable.ServicePrincipalId, options GetOwnedObjectServicePrincipalCountOperationOptions) (result GetOwnedObjectServicePrincipalCountOperationResponse, err error) {
