...
func (c OwnedObjectClient) GetOwnedObjectEndpoint(ctx context.Context, id stable.ServicePrincipalIdOwnedObjectId, options GetOwnedObjectEndpointOperationOptions) (result GetOwnedObjectEndpointOperationResponse, err error) {
