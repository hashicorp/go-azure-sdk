...
func (c OwnedObjectClient) ListOwnedObjectGroups(ctx context.Context, id stable.ServicePrincipalId, options ListOwnedObjectGroupsOperationOptions) (result ListOwnedObjectGroupsOperationResponse, err error) {
...
func (c OwnedObjectClient) ListOwnedObjectGroupsComplete(ctx context.Context, id stable.ServicePrincipalId, options ListOwnedObjectGroupsOperationOptions) (ListOwnedObjectGroupsCompleteResult, error) {
...
func (c OwnedObjectClient) ListOwnedObjectGroupsCompleteMatchingPredicate(ctx context.Context, id stable.ServicePrincipalId, options ListOwnedObjectGroupsOperationOptions, predicate GroupOperationPredicate) (result ListOwnedObjectGroupsCompleteResult, err error) {
