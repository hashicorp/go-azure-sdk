...
func (c OwnedObjectClient) GetOwnedObjectGroupCount(ctx context.Context, id stable.ServicePrincipalId, options GetOwnedObjectGroupCountOperationOptions) (result GetOwnedObjectGroupCountOperationResponse, err error) {
