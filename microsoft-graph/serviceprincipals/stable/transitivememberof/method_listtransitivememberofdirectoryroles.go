...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfDirectoryRoles(ctx context.Context, id stable.ServicePrincipalId, options ListTransitiveMemberOfDirectoryRolesOperationOptions) (result ListTransitiveMemberOfDirectoryRolesOperationResponse, err error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfDirectoryRolesComplete(ctx context.Context, id stable.ServicePrincipalId, options ListTransitiveMemberOfDirectoryRolesOperationOptions) (ListTransitiveMemberOfDirectoryRolesCompleteResult, error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfDirectoryRolesCompleteMatchingPredicate(ctx context.Context, id stable.ServicePrincipalId, options ListTransitiveMemberOfDirectoryRolesOperationOptions, predicate DirectoryRoleOperationPredicate) (result ListTransitiveMemberOfDirectoryRolesCompleteResult, err error) {
