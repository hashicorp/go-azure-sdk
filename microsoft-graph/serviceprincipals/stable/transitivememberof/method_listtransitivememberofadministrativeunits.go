...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfAdministrativeUnits(ctx context.Context, id stable.ServicePrincipalId, options ListTransitiveMemberOfAdministrativeUnitsOperationOptions) (result ListTransitiveMemberOfAdministrativeUnitsOperationResponse, err error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfAdministrativeUnitsComplete(ctx context.Context, id stable.ServicePrincipalId, options ListTransitiveMemberOfAdministrativeUnitsOperationOptions) (ListTransitiveMemberOfAdministrativeUnitsCompleteResult, error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfAdministrativeUnitsCompleteMatchingPredicate(ctx context.Context, id stable.ServicePrincipalId, options ListTransitiveMemberOfAdministrativeUnitsOperationOptions, predicate AdministrativeUnitOperationPredicate) (result ListTransitiveMemberOfAdministrativeUnitsCompleteResult, err error) {
