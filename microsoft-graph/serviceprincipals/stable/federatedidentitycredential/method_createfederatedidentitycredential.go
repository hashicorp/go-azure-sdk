...
func (c FederatedIdentityCredentialClient) CreateFederatedIdentityCredential(ctx context.Context, id ServicePrincipalId, input stable.FederatedIdentityCredential) (result CreateFederatedIdentityCredentialOperationResponse, err error) {
