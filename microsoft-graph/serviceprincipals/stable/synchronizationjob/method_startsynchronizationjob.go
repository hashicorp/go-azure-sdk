...
func (c SynchronizationJobClient) StartSynchronizationJob(ctx context.Context, id stable.ServicePrincipalIdSynchronizationJobId) (result StartSynchronizationJobOperationResponse, err error) {
