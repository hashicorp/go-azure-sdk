...
func (c SynchronizationJobClient) PauseSynchronizationJob(ctx context.Context, id stable.ServicePrincipalIdSynchronizationJobId) (result PauseSynchronizationJobOperationResponse, err error) {
