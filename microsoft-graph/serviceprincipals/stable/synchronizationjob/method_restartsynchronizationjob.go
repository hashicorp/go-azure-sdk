...
func (c SynchronizationJobClient) RestartSynchronizationJob(ctx context.Context, id stable.ServicePrincipalIdSynchronizationJobId, input RestartSynchronizationJobRequest) (result RestartSynchronizationJobOperationResponse, err error) {
