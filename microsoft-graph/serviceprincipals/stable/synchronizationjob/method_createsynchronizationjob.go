...
func (c SynchronizationJobClient) CreateSynchronizationJob(ctx context.Context, id stable.ServicePrincipalId, input stable.SynchronizationJob) (result CreateSynchronizationJobOperationResponse, err error) {
