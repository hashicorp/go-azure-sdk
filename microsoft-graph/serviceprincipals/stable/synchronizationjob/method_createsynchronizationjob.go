...
func (c SynchronizationJobClient) CreateSynchronizationJob(ctx context.Context, id ServicePrincipalId, input stable.SynchronizationJob) (result CreateSynchronizationJobOperationResponse, err error) {
