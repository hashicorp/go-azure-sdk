...
func (c SynchronizationTemplateClient) CreateSynchronizationTemplate(ctx context.Context, id stable.ServicePrincipalId, input stable.SynchronizationTemplate) (result CreateSynchronizationTemplateOperationResponse, err error) {
