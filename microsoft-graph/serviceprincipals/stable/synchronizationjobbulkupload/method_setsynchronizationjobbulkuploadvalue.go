...
func (c SynchronizationJobBulkUploadClient) SetSynchronizationJobBulkUploadValue(ctx context.Context, id stable.ServicePrincipalIdSynchronizationJobId, input []byte) (result SetSynchronizationJobBulkUploadValueOperationResponse, err error) {
