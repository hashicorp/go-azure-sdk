...
func (c ServicePrincipalClient) GetAvailableExtensionProperties(ctx context.Context, input GetAvailableExtensionPropertiesRequest, options GetAvailableExtensionPropertiesOperationOptions) (result GetAvailableExtensionPropertiesOperationResponse, err error) {
...
func (c ServicePrincipalClient) GetAvailableExtensionPropertiesComplete(ctx context.Context, input GetAvailableExtensionPropertiesRequest, options GetAvailableExtensionPropertiesOperationOptions) (GetAvailableExtensionPropertiesCompleteResult, error) {
