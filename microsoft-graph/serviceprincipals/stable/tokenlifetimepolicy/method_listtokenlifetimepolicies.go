...
func (c TokenLifetimePolicyClient) ListTokenLifetimePolicies(ctx context.Context, id ServicePrincipalId) (result ListTokenLifetimePoliciesOperationResponse, err error) {
...
func (c TokenLifetimePolicyClient) ListTokenLifetimePoliciesComplete(ctx context.Context, id ServicePrincipalId) (ListTokenLifetimePoliciesCompleteResult, error) {
...
func (c TokenLifetimePolicyClient) ListTokenLifetimePoliciesCompleteMatchingPredicate(ctx context.Context, id ServicePrincipalId, predicate TokenLifetimePolicyOperationPredicate) (result ListTokenLifetimePoliciesCompleteResult, err error) {
