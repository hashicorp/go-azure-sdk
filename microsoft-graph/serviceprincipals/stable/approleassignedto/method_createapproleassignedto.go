...
func (c AppRoleAssignedToClient) CreateAppRoleAssignedTo(ctx context.Context, id ServicePrincipalId, input stable.AppRoleAssignment) (result CreateAppRoleAssignedToOperationResponse, err error) {
