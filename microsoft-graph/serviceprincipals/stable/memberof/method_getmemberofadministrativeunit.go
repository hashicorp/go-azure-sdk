...
func (c MemberOfClient) GetMemberOfAdministrativeUnit(ctx context.Context, id stable.ServicePrincipalIdMemberOfId, options GetMemberOfAdministrativeUnitOperationOptions) (result GetMemberOfAdministrativeUnitOperationResponse, err error) {
