...
func (c MemberOfClient) ListMemberOfGroups(ctx context.Context, id stable.ServicePrincipalId, options ListMemberOfGroupsOperationOptions) (result ListMemberOfGroupsOperationResponse, err error) {
...
func (c MemberOfClient) ListMemberOfGroupsComplete(ctx context.Context, id stable.ServicePrincipalId, options ListMemberOfGroupsOperationOptions) (ListMemberOfGroupsCompleteResult, error) {
...
func (c MemberOfClient) ListMemberOfGroupsCompleteMatchingPredicate(ctx context.Context, id stable.ServicePrincipalId, options ListMemberOfGroupsOperationOptions, predicate GroupOperationPredicate) (result ListMemberOfGroupsCompleteResult, err error) {
