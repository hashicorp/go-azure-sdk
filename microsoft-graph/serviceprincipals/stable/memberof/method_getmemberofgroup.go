...
func (c MemberOfClient) GetMemberOfGroup(ctx context.Context, id stable.ServicePrincipalIdMemberOfId, options GetMemberOfGroupOperationOptions) (result GetMemberOfGroupOperationResponse, err error) {
