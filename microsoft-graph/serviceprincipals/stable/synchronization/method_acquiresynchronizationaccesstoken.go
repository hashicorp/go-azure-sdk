...
func (c SynchronizationClient) AcquireSynchronizationAccessToken(ctx context.Context, id stable.ServicePrincipalId, input AcquireSynchronizationAccessTokenRequest) (result AcquireSynchronizationAccessTokenOperationResponse, err error) {
