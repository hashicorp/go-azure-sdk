...
// target system.
func (c SynchronizationSecretClient) SetSynchronizationSecret(ctx context.Context, id stable.ServicePrincipalId, input SetSynchronizationSecretRequest) (result SetSynchronizationSecretOperationResponse, err error) {
