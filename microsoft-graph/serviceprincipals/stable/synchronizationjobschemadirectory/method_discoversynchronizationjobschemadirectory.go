...
func (c SynchronizationJobSchemaDirectoryClient) DiscoverSynchronizationJobSchemaDirectory(ctx context.Context, id stable.ServicePrincipalIdSynchronizationJobIdSchemaDirectoryId) (result DiscoverSynchronizationJobSchemaDirectoryOperationResponse, err error) {
