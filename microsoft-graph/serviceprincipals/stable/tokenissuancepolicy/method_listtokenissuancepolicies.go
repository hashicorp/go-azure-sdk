...
func (c TokenIssuancePolicyClient) ListTokenIssuancePolicies(ctx context.Context, id ServicePrincipalId) (result ListTokenIssuancePoliciesOperationResponse, err error) {
...
func (c TokenIssuancePolicyClient) ListTokenIssuancePoliciesComplete(ctx context.Context, id ServicePrincipalId) (ListTokenIssuancePoliciesCompleteResult, error) {
	return c.ListTokenIssuancePoliciesCompleteMatchingPredicate(ctx, id, TokenIssuancePolicyOperationPredicate{})
}

// ListTokenIssuancePoliciesCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c TokenIssuancePolicyClient) ListTokenIssuancePoliciesCompleteMatchingPredicate(ctx context.Context, id ServicePrincipalId, predicate TokenIssuancePolicyOperationPredicate) (result ListTokenIssuancePoliciesCompleteResult, err error) {
	items := make([]stable.TokenIssuancePolicy, 0)

	resp, err := c.ListTokenIssuancePolicies(ctx, id)
	if err != nil {
