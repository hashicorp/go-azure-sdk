...
func (c ClaimsMappingPolicyClient) AddClaimsMappingPolicyRef(ctx context.Context, id stable.ServicePrincipalId, input stable.ReferenceCreate) (result AddClaimsMappingPolicyRefOperationResponse, err error) {
