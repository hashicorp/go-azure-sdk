...
func (c EndpointClient) CreateEndpoint(ctx context.Context, id stable.ServicePrincipalId, input stable.Endpoint) (result CreateEndpointOperationResponse, err error) {
