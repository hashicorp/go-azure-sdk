...
func (c RemoteDesktopSecurityConfigurationClient) DeleteRemoteDesktopSecurityConfiguration(ctx context.Context, id ServicePrincipalId) (result DeleteRemoteDesktopSecurityConfigurationOperationResponse, err error) {
