...
func (c RemoteDesktopSecurityConfigurationClient) GetRemoteDesktopSecurityConfiguration(ctx context.Context, id ServicePrincipalId) (result GetRemoteDesktopSecurityConfigurationOperationResponse, err error) {
