...
func (c RemoteDesktopSecurityConfigurationTargetDeviceGroupClient) ListRemoteDesktopSecurityConfigurationTargetDeviceGroups(ctx context.Context, id ServicePrincipalId) (result ListRemoteDesktopSecurityConfigurationTargetDeviceGroupsOperationResponse, err error) {
...
func (c RemoteDesktopSecurityConfigurationTargetDeviceGroupClient) ListRemoteDesktopSecurityConfigurationTargetDeviceGroupsComplete(ctx context.Context, id ServicePrincipalId) (ListRemoteDesktopSecurityConfigurationTargetDeviceGroupsCompleteResult, error) {
	return c.ListRemoteDesktopSecurityConfigurationTargetDeviceGroupsCompleteMatchingPredicate(ctx, id, TargetDeviceGroupOperationPredicate{})
}
