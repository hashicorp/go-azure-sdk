...
func (c RemoteDesktopSecurityConfigurationTargetDeviceGroupClient) DeleteRemoteDesktopSecurityConfigurationTargetDeviceGroup(ctx context.Context, id ServicePrincipalIdRemoteDesktopSecurityConfigurationTargetDeviceGroupId) (result DeleteRemoteDesktopSecurityConfigurationTargetDeviceGroupOperationResponse, err error) {
