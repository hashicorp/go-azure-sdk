...
func (c ServicePrincipalClient) ListServicePrincipalsComplete(ctx context.Context) (ListServicePrincipalsCompleteResult, error) {
	return c.ListServicePrincipalsCompleteMatchingPredicate(ctx, models.ServicePrincipalCollectionResponseOperationPredicate{})
}

// ListServicePrincipalsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c ServicePrincipalClient) ListServicePrincipalsCompleteMatchingPredicate(ctx context.Context, predicate models.ServicePrincipalCollectionResponseOperationPredicate) (result ListServicePrincipalsCompleteResult, err error) {
