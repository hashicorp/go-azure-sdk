...
func TestNewServicePrincipalSynchronizationJobSchemaDirectoryID(t *testing.T) {
	id := NewServicePrincipalSynchronizationJobSchemaDirectoryID("servicePrincipalIdValue", "synchronizationJobIdValue", "directoryDefinitionIdValue")
...
func TestFormatServicePrincipalSynchronizationJobSchemaDirectoryID(t *testing.T) {
	actual := NewServicePrincipalSynchronizationJobSchemaDirectoryID("servicePrincipalIdValue", "synchronizationJobIdValue", "directoryDefinitionIdValue").ID()
...
func TestParseServicePrincipalSynchronizationJobSchemaDirectoryID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ServicePrincipalSynchronizationJobSchemaDirectoryId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseServicePrincipalSynchronizationJobSchemaDirectoryID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseServicePrincipalSynchronizationJobSchemaDirectoryIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ServicePrincipalSynchronizationJobSchemaDirectoryId
	...
	for _, v := range testData {
		...
		actual, err := ParseServicePrincipalSynchronizationJobSchemaDirectoryIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForServicePrincipalSynchronizationJobSchemaDirectoryId(t *testing.T) {
	segments := ServicePrincipalSynchronizationJobSchemaDirectoryId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ServicePrincipalSynchronizationJobSchemaDirectoryId has no segments")
	}
