...
func TestNewServicePrincipalFederatedIdentityCredentialID(t *testing.T) {
	id := NewServicePrincipalFederatedIdentityCredentialID("servicePrincipalIdValue", "federatedIdentityCredentialIdValue")
...
func TestFormatServicePrincipalFederatedIdentityCredentialID(t *testing.T) {
	actual := NewServicePrincipalFederatedIdentityCredentialID("servicePrincipalIdValue", "federatedIdentityCredentialIdValue").ID()
...
func TestParseServicePrincipalFederatedIdentityCredentialID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ServicePrincipalFederatedIdentityCredentialId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseServicePrincipalFederatedIdentityCredentialID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseServicePrincipalFederatedIdentityCredentialIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ServicePrincipalFederatedIdentityCredentialId
	...
	for _, v := range testData {
		...
		actual, err := ParseServicePrincipalFederatedIdentityCredentialIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForServicePrincipalFederatedIdentityCredentialId(t *testing.T) {
	segments := ServicePrincipalFederatedIdentityCredentialId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ServicePrincipalFederatedIdentityCredentialId has no segments")
	}
