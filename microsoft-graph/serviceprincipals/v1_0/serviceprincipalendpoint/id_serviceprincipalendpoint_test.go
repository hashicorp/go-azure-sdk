...
func TestNewServicePrincipalEndpointID(t *testing.T) {
	id := NewServicePrincipalEndpointID("servicePrincipalIdValue", "endpointIdValue")
...
func TestFormatServicePrincipalEndpointID(t *testing.T) {
	actual := NewServicePrincipalEndpointID("servicePrincipalIdValue", "endpointIdValue").ID()
...
func TestParseServicePrincipalEndpointID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ServicePrincipalEndpointId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseServicePrincipalEndpointID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseServicePrincipalEndpointIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ServicePrincipalEndpointId
	...
	for _, v := range testData {
		...
		actual, err := ParseServicePrincipalEndpointIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForServicePrincipalEndpointId(t *testing.T) {
	segments := ServicePrincipalEndpointId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ServicePrincipalEndpointId has no segments")
	}
