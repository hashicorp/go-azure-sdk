...
func TestNewServicePrincipalClaimsMappingPolicyID(t *testing.T) {
	id := NewServicePrincipalClaimsMappingPolicyID("servicePrincipalIdValue", "claimsMappingPolicyIdValue")
...
func TestFormatServicePrincipalClaimsMappingPolicyID(t *testing.T) {
	actual := NewServicePrincipalClaimsMappingPolicyID("servicePrincipalIdValue", "claimsMappingPolicyIdValue").ID()
...
func TestParseServicePrincipalClaimsMappingPolicyID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ServicePrincipalClaimsMappingPolicyId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseServicePrincipalClaimsMappingPolicyID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseServicePrincipalClaimsMappingPolicyIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ServicePrincipalClaimsMappingPolicyId
	...
	for _, v := range testData {
		...
		actual, err := ParseServicePrincipalClaimsMappingPolicyIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForServicePrincipalClaimsMappingPolicyId(t *testing.T) {
	segments := ServicePrincipalClaimsMappingPolicyId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ServicePrincipalClaimsMappingPolicyId has no segments")
	}
