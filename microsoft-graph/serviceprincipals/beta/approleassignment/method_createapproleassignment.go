...
func (c AppRoleAssignmentClient) CreateAppRoleAssignment(ctx context.Context, id ServicePrincipalId, input beta.AppRoleAssignment) (result CreateAppRoleAssignmentOperationResponse, err error) {
