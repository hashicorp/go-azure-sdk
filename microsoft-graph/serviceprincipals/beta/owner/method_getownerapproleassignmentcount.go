...
func (c OwnerClient) GetOwnerAppRoleAssignmentCount(ctx context.Context, id beta.ServicePrincipalId, options GetOwnerAppRoleAssignmentCountOperationOptions) (result GetOwnerAppRoleAssignmentCountOperationResponse, err error) {
