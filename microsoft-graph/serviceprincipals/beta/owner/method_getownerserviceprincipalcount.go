...
func (c OwnerClient) GetOwnerServicePrincipalCount(ctx context.Context, id beta.ServicePrincipalId, options GetOwnerServicePrincipalCountOperationOptions) (result GetOwnerServicePrincipalCountOperationResponse, err error) {
