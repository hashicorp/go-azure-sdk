...
func (c OwnerClient) GetOwnerAppRoleAssignment(ctx context.Context, id beta.ServicePrincipalIdOwnerId, options GetOwnerAppRoleAssignmentOperationOptions) (result GetOwnerAppRoleAssignmentOperationResponse, err error) {
