...
func (c OwnerClient) GetOwnerServicePrincipal(ctx context.Context, id beta.ServicePrincipalIdOwnerId, options GetOwnerServicePrincipalOperationOptions) (result GetOwnerServicePrincipalOperationResponse, err error) {
