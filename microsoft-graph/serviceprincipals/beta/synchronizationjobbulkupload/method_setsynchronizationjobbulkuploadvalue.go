...
func (c SynchronizationJobBulkUploadClient) SetSynchronizationJobBulkUploadValue(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobId, input []byte) (result SetSynchronizationJobBulkUploadValueOperationResponse, err error) {
