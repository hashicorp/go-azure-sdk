...
func (c FederatedIdentityCredentialClient) CreateFederatedIdentityCredential(ctx context.Context, id ServicePrincipalId, input beta.FederatedIdentityCredential) (result CreateFederatedIdentityCredentialOperationResponse, err error) {
