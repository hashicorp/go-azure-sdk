...
// ListLicenseDetails ...
func (c LicenseDetailClient) ListLicenseDetails(ctx context.Context, id ServicePrincipalId) (result ListLicenseDetailsOperationResponse, err error) {
...
func (c LicenseDetailClient) ListLicenseDetailsComplete(ctx context.Context, id ServicePrincipalId) (ListLicenseDetailsCompleteResult, error) {
	return c.ListLicenseDetailsCompleteMatchingPredicate(ctx, id, LicenseDetailsOperationPredicate{})
}

// ListLicenseDetailsCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c LicenseDetailClient) ListLicenseDetailsCompleteMatchingPredicate(ctx context.Context, id ServicePrincipalId, predicate LicenseDetailsOperationPredicate) (result ListLicenseDetailsCompleteResult, err error) {
	items := make([]beta.LicenseDetails, 0)

	resp, err := c.ListLicenseDetails(ctx, id)
	if err != nil {
