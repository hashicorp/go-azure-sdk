...
func (c SynchronizationJobClient) CreateSynchronizationJob(ctx context.Context, id beta.ServicePrincipalId, input beta.SynchronizationJob) (result CreateSynchronizationJobOperationResponse, err error) {
