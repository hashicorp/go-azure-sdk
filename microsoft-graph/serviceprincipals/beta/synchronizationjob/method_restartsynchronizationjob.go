...
func (c SynchronizationJobClient) RestartSynchronizationJob(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobId, input RestartSynchronizationJobRequest) (result RestartSynchronizationJobOperationResponse, err error) {
