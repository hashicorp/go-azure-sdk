...
func (c SynchronizationJobClient) StartSynchronizationJob(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobId) (result StartSynchronizationJobOperationResponse, err error) {
