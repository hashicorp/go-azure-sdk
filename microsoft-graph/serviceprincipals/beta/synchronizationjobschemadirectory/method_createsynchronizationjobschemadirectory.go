...
func (c SynchronizationJobSchemaDirectoryClient) CreateSynchronizationJobSchemaDirectory(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobId, input beta.DirectoryDefinition) (result CreateSynchronizationJobSchemaDirectoryOperationResponse, err error) {
