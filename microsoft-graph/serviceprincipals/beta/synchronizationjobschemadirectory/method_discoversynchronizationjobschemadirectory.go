...
func (c SynchronizationJobSchemaDirectoryClient) DiscoverSynchronizationJobSchemaDirectory(ctx context.Context, id beta.ServicePrincipalIdSynchronizationJobIdSchemaDirectoryId) (result DiscoverSynchronizationJobSchemaDirectoryOperationResponse, err error) {
