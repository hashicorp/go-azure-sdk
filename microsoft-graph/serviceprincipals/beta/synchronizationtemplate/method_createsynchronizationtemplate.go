...
func (c SynchronizationTemplateClient) CreateSynchronizationTemplate(ctx context.Context, id beta.ServicePrincipalId, input beta.SynchronizationTemplate) (result CreateSynchronizationTemplateOperationResponse, err error) {
