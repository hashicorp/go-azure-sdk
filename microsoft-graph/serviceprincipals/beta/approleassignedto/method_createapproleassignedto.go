...
func (c AppRoleAssignedToClient) CreateAppRoleAssignedTo(ctx context.Context, id ServicePrincipalId, input beta.AppRoleAssignment) (result CreateAppRoleAssignedToOperationResponse, err error) {
