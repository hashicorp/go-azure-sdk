...
func (c OwnedObjectClient) ListOwnedObjectAppRoleAssignments(ctx context.Context, id beta.ServicePrincipalId, options ListOwnedObjectAppRoleAssignmentsOperationOptions) (result ListOwnedObjectAppRoleAssignmentsOperationResponse, err error) {
...
func (c OwnedObjectClient) ListOwnedObjectAppRoleAssignmentsComplete(ctx context.Context, id beta.ServicePrincipalId, options ListOwnedObjectAppRoleAssignmentsOperationOptions) (ListOwnedObjectAppRoleAssignmentsCompleteResult, error) {
...
func (c OwnedObjectClient) ListOwnedObjectAppRoleAssignmentsCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListOwnedObjectAppRoleAssignmentsOperationOptions, predicate AppRoleAssignmentOperationPredicate) (result ListOwnedObjectAppRoleAssignmentsCompleteResult, err error) {
