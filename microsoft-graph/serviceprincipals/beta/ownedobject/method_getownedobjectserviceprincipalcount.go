...
func (c OwnedObjectClient) GetOwnedObjectServicePrincipalCount(ctx context.Context, id beta.ServicePrincipalId, options GetOwnedObjectServicePrincipalCountOperationOptions) (result GetOwnedObjectServicePrincipalCountOperationResponse, err error) {
