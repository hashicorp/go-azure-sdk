...
func (c OwnedObjectClient) ListOwnedObjectGroups(ctx context.Context, id beta.ServicePrincipalId, options ListOwnedObjectGroupsOperationOptions) (result ListOwnedObjectGroupsOperationResponse, err error) {
...
func (c OwnedObjectClient) ListOwnedObjectGroupsComplete(ctx context.Context, id beta.ServicePrincipalId, options ListOwnedObjectGroupsOperationOptions) (ListOwnedObjectGroupsCompleteResult, error) {
...
func (c OwnedObjectClient) ListOwnedObjectGroupsCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListOwnedObjectGroupsOperationOptions, predicate GroupOperationPredicate) (result ListOwnedObjectGroupsCompleteResult, err error) {
