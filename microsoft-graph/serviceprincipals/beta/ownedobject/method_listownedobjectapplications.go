...
func (c OwnedObjectClient) ListOwnedObjectApplications(ctx context.Context, id beta.ServicePrincipalId, options ListOwnedObjectApplicationsOperationOptions) (result ListOwnedObjectApplicationsOperationResponse, err error) {
...
func (c OwnedObjectClient) ListOwnedObjectApplicationsComplete(ctx context.Context, id beta.ServicePrincipalId, options ListOwnedObjectApplicationsOperationOptions) (ListOwnedObjectApplicationsCompleteResult, error) {
...
func (c OwnedObjectClient) ListOwnedObjectApplicationsCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListOwnedObjectApplicationsOperationOptions, predicate ApplicationOperationPredicate) (result ListOwnedObjectApplicationsCompleteResult, err error) {
