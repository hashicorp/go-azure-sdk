...
func (c OwnedObjectClient) GetOwnedObjectApplication(ctx context.Context, id beta.ServicePrincipalIdOwnedObjectId, options GetOwnedObjectApplicationOperationOptions) (result GetOwnedObjectApplicationOperationResponse, err error) {
