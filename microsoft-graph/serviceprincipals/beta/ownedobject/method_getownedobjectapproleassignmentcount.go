...
func (c OwnedObjectClient) GetOwnedObjectAppRoleAssignmentCount(ctx context.Context, id beta.ServicePrincipalId, options GetOwnedObjectAppRoleAssignmentCountOperationOptions) (result GetOwnedObjectAppRoleAssignmentCountOperationResponse, err error) {
