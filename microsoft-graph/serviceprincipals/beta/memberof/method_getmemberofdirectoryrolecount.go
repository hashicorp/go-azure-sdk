...
func (c MemberOfClient) GetMemberOfDirectoryRoleCount(ctx context.Context, id beta.ServicePrincipalId, options GetMemberOfDirectoryRoleCountOperationOptions) (result GetMemberOfDirectoryRoleCountOperationResponse, err error) {
