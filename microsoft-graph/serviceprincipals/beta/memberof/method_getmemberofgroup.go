...
func (c MemberOfClient) GetMemberOfGroup(ctx context.Context, id beta.ServicePrincipalIdMemberOfId, options GetMemberOfGroupOperationOptions) (result GetMemberOfGroupOperationResponse, err error) {
