...
func (c MemberOfClient) GetMemberOfAdministrativeUnit(ctx context.Context, id beta.ServicePrincipalIdMemberOfId, options GetMemberOfAdministrativeUnitOperationOptions) (result GetMemberOfAdministrativeUnitOperationResponse, err error) {
