...
func (c MemberOfClient) ListMemberOfDirectoryRoles(ctx context.Context, id beta.ServicePrincipalId, options ListMemberOfDirectoryRolesOperationOptions) (result ListMemberOfDirectoryRolesOperationResponse, err error) {
...
func (c MemberOfClient) ListMemberOfDirectoryRolesComplete(ctx context.Context, id beta.ServicePrincipalId, options ListMemberOfDirectoryRolesOperationOptions) (ListMemberOfDirectoryRolesCompleteResult, error) {
...
func (c MemberOfClient) ListMemberOfDirectoryRolesCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListMemberOfDirectoryRolesOperationOptions, predicate DirectoryRoleOperationPredicate) (result ListMemberOfDirectoryRolesCompleteResult, err error) {
