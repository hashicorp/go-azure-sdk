...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfDirectoryRoles(ctx context.Context, id beta.ServicePrincipalId, options ListTransitiveMemberOfDirectoryRolesOperationOptions) (result ListTransitiveMemberOfDirectoryRolesOperationResponse, err error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfDirectoryRolesComplete(ctx context.Context, id beta.ServicePrincipalId, options ListTransitiveMemberOfDirectoryRolesOperationOptions) (ListTransitiveMemberOfDirectoryRolesCompleteResult, error) {
