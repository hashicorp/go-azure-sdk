...
// collection
func (c TransitiveMemberOfClient) ListTransitiveMemberOfGroups(ctx context.Context, id beta.ServicePrincipalId, options ListTransitiveMemberOfGroupsOperationOptions) (result ListTransitiveMemberOfGroupsOperationResponse, err error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfGroupsComplete(ctx context.Context, id beta.ServicePrincipalId, options ListTransitiveMemberOfGroupsOperationOptions) (ListTransitiveMemberOfGroupsCompleteResult, error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfGroupsCompleteMatchingPredicate(ctx context.Context, id beta.ServicePrincipalId, options ListTransitiveMemberOfGroupsOperationOptions, predicate GroupOperationPredicate) (result ListTransitiveMemberOfGroupsCompleteResult, err error) {
