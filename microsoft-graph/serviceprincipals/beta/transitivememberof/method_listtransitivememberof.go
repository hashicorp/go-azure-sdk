...
func (c TransitiveMemberOfClient) ListTransitiveMemberOf(ctx context.Context, id ServicePrincipalId) (result ListTransitiveMemberOfOperationResponse, err error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfComplete(ctx context.Context, id ServicePrincipalId) (ListTransitiveMemberOfCompleteResult, error) {
...
func (c TransitiveMemberOfClient) ListTransitiveMemberOfCompleteMatchingPredicate(ctx context.Context, id ServicePrincipalId, predicate DirectoryObjectOperationPredicate) (result ListTransitiveMemberOfCompleteResult, err error) {
