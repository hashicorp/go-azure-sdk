...
func (c AppManagementPolicyClient) ListAppManagementPolicies(ctx context.Context, id ServicePrincipalId) (result ListAppManagementPoliciesOperationResponse, err error) {
...
func (c AppManagementPolicyClient) ListAppManagementPoliciesComplete(ctx context.Context, id ServicePrincipalId) (ListAppManagementPoliciesCompleteResult, error) {
...
func (c AppManagementPolicyClient) ListAppManagementPoliciesCompleteMatchingPredicate(ctx context.Context, id ServicePrincipalId, predicate AppManagementPolicyOperationPredicate) (result ListAppManagementPoliciesCompleteResult, err error) {
