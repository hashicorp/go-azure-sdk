...
func TestNewServicePrincipalSynchronizationTemplateSchemaDirectoryID(t *testing.T) {
	id := NewServicePrincipalSynchronizationTemplateSchemaDirectoryID("servicePrincipalIdValue", "synchronizationTemplateIdValue", "directoryDefinitionIdValue")
...
func TestFormatServicePrincipalSynchronizationTemplateSchemaDirectoryID(t *testing.T) {
	actual := NewServicePrincipalSynchronizationTemplateSchemaDirectoryID("servicePrincipalIdValue", "synchronizationTemplateIdValue", "directoryDefinitionIdValue").ID()
...
func TestParseServicePrincipalSynchronizationTemplateSchemaDirectoryID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ServicePrincipalSynchronizationTemplateSchemaDirectoryId
	}{
		{
			// Incomplete URI
			Input: "",
	...
	for _, v := range testData {
		...
		actual, err := ParseServicePrincipalSynchronizationTemplateSchemaDirectoryID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseServicePrincipalSynchronizationTemplateSchemaDirectoryIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *ServicePrincipalSynchronizationTemplateSchemaDirectoryId
	...
	for _, v := range testData {
		...
		actual, err := ParseServicePrincipalSynchronizationTemplateSchemaDirectoryIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForServicePrincipalSynchronizationTemplateSchemaDirectoryId(t *testing.T) {
	segments := ServicePrincipalSynchronizationTemplateSchemaDirectoryId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("ServicePrincipalSynchronizationTemplateSchemaDirectoryId has no segments")
	}
