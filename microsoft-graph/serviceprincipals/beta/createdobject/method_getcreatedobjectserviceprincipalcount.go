...
func (c CreatedObjectClient) GetCreatedObjectServicePrincipalCount(ctx context.Context, id beta.ServicePrincipalId, options GetCreatedObjectServicePrincipalCountOperationOptions) (result GetCreatedObjectServicePrincipalCountOperationResponse, err error) {
