...
func (c SynchronizationTemplateSchemaDirectoryClient) DiscoverSynchronizationTemplateSchemaDirectory(ctx context.Context, id beta.ServicePrincipalIdSynchronizationTemplateIdSchemaDirectoryId) (result DiscoverSynchronizationTemplateSchemaDirectoryOperationResponse, err error) {
