...
func (c SynchronizationTemplateSchemaDirectoryClient) ListSynchronizationTemplateSchemaDirectories(ctx context.Context, id ServicePrincipalIdSynchronizationTemplateId) (result ListSynchronizationTemplateSchemaDirectoriesOperationResponse, err error) {
...
func (c SynchronizationTemplateSchemaDirectoryClient) ListSynchronizationTemplateSchemaDirectoriesComplete(ctx context.Context, id ServicePrincipalIdSynchronizationTemplateId) (ListSynchronizationTemplateSchemaDirectoriesCompleteResult, error) {
