...
func (c ServicePrincipalClient) UpdateServicePrincipal(ctx context.Context, id beta.ServicePrincipalId, input beta.ServicePrincipal) (result UpdateServicePrincipalOperationResponse, err error) {
