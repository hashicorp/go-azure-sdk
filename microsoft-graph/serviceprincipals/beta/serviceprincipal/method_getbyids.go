...
// function are to:
func (c ServicePrincipalClient) GetByIds(ctx context.Context, input GetByIdsRequest, options GetByIdsOperationOptions) (result GetByIdsOperationResponse, err error) {
...
func (c ServicePrincipalClient) GetByIdsComplete(ctx context.Context, input GetByIdsRequest, options GetByIdsOperationOptions) (GetByIdsCompleteResult, error) {
...
func (c ServicePrincipalClient) GetByIdsCompleteMatchingPredicate(ctx context.Context, input GetByIdsRequest, options GetByIdsOperationOptions, predicate DirectoryObjectOperationPredicate) (result GetByIdsCompleteResult, err error) {
