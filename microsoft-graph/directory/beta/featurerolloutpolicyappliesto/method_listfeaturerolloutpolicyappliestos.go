...
func (c FeatureRolloutPolicyAppliesToClient) ListFeatureRolloutPolicyAppliesTos(ctx context.Context, id DirectoryFeatureRolloutPolicyId) (result ListFeatureRolloutPolicyAppliesTosOperationResponse, err error) {
...
func (c FeatureRolloutPolicyAppliesToClient) ListFeatureRolloutPolicyAppliesTosComplete(ctx context.Context, id DirectoryFeatureRolloutPolicyId) (ListFeatureRolloutPolicyAppliesTosCompleteResult, error) {
...
func (c FeatureRolloutPolicyAppliesToClient) ListFeatureRolloutPolicyAppliesTosCompleteMatchingPredicate(ctx context.Context, id DirectoryFeatureRolloutPolicyId, predicate DirectoryObjectOperationPredicate) (result ListFeatureRolloutPolicyAppliesTosCompleteResult, err error) {
