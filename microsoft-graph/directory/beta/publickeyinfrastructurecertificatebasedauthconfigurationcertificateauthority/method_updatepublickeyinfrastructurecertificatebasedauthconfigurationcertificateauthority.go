...
// UpdatePublicKeyInfrastructureCertificateBasedAuthConfigurationCertificateAuthority - Update
// certificateAuthorityDetail. Update the properties of a certificateAuthorityDetail object.
func (c PublicKeyInfrastructureCertificateBasedAuthConfigurationCertificateAuthorityClient) UpdatePublicKeyInfrastructureCertificateBasedAuthConfigurationCertificateAuthority(ctx context.Context, id beta.DirectoryPublicKeyInfrastructureCertificateBasedAuthConfigurationIdCertificateAuthorityId, input beta.CertificateAuthorityDetail, options UpdatePublicKeyInfrastructureCertificateBasedAuthConfigurationCertificateAuthorityOperationOptions) (result UpdatePublicKeyInfrastructureCertificateBasedAuthConfigurationCertificateAuthorityOperationResponse, err error) {
