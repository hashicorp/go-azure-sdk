...
// DeleteTemplate - Delete navigation property templates for directory
func (c TemplateClient) DeleteTemplate(ctx context.Context, options DeleteTemplateOperationOptions) (result DeleteTemplateOperationResponse, err error) {
