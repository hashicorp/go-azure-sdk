...
// GetTemplate - Get templates from directory. A container for templates, such as device templates used for onboarding
// devices in Microsoft Entra ID.
func (c TemplateClient) GetTemplate(ctx context.Context, options GetTemplateOperationOptions) (result GetTemplateOperationResponse, err error) {
