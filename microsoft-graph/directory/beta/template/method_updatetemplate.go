...
// UpdateTemplate - Update the navigation property templates in directory
func (c TemplateClient) UpdateTemplate(ctx context.Context, input beta.Template, options UpdateTemplateOperationOptions) (result UpdateTemplateOperationResponse, err error) {
