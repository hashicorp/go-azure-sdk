...
func ParseDirectoryOnPremisesSynchronizationID(input string) (*DirectoryOnPremisesSynchronizationId, error) {
	...
	if id.OnPremisesDirectorySynchronizationId, ok = parsed.Parsed["onPremisesDirectorySynchronizationId"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "onPremisesDirectorySynchronizationId", *parsed)
	}
...
func (id DirectoryOnPremisesSynchronizationId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.StaticSegment("staticOnPremisesSynchronization", "onPremisesSynchronization", "onPremisesSynchronization"),
