...
type ValidateDeletedItemsPropertyOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

// ValidateDeletedItemsProperty - Invoke action validateProperties. Validate that a Microsoft 365 group's display name
...
func (c DeletedItemClient) ValidateDeletedItemsProperty(ctx context.Context, input ValidateDeletedItemsPropertyRequest) (result ValidateDeletedItemsPropertyOperationResponse, err error) {
