...
func (c DeletedItemClient) GetDeletedItemAdministrativeUnit(ctx context.Context, id beta.DirectoryDeletedItemId, options GetDeletedItemAdministrativeUnitOperationOptions) (result GetDeletedItemAdministrativeUnitOperationResponse, err error) {
