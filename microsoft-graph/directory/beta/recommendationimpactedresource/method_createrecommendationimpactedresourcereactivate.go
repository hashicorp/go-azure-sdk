...
func (c RecommendationImpactedResourceClient) CreateRecommendationImpactedResourceReactivate(ctx context.Context, id DirectoryRecommendationIdImpactedResourceId) (result CreateRecommendationImpactedResourceReactivateOperationResponse, err error) {
