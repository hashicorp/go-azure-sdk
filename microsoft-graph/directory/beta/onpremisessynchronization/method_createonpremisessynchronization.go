...
func (c OnPremisesSynchronizationClient) CreateOnPremisesSynchronization(ctx context.Context, input beta.OnPremisesDirectorySynchronization) (result CreateOnPremisesSynchronizationOperationResponse, err error) {
