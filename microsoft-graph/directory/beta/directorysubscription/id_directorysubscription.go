...
func ParseDirectorySubscriptionID(input string) (*DirectorySubscriptionId, error) {
	...
	if id.CompanySubscriptionId, ok = parsed.Parsed["companySubscriptionId"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "companySubscriptionId", *parsed)
	}
...
func (id DirectorySubscriptionId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("companySubscriptionId", "companySubscriptionIdValue"),
	}
}
