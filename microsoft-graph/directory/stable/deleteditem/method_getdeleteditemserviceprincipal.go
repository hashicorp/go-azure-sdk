...
func (c DeletedItemClient) GetDeletedItemServicePrincipal(ctx context.Context, id stable.DirectoryDeletedItemId, options GetDeletedItemServicePrincipalOperationOptions) (result GetDeletedItemServicePrincipalOperationResponse, err error) {
