...
func (c DeletedItemClient) GetDeletedItemGroup(ctx context.Context, id stable.DirectoryDeletedItemId, options GetDeletedItemGroupOperationOptions) (result GetDeletedItemGroupOperationResponse, err error) {
