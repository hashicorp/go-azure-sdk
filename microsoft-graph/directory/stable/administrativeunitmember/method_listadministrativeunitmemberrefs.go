...
// ListAdministrativeUnitMemberRefs ...
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberRefs(ctx context.Context, id DirectoryAdministrativeUnitId) (result ListAdministrativeUnitMemberRefsOperationResponse, err error) {
...
func (c AdministrativeUnitMemberClient) ListAdministrativeUnitMemberRefsComplete(ctx context.Context, id DirectoryAdministrativeUnitId) (result ListAdministrativeUnitMemberRefsCompleteResult, err error) {
	items := make([]string, 0)

	resp, err := c.ListAdministrativeUnitMemberRefs(ctx, id)
	if err != nil {
