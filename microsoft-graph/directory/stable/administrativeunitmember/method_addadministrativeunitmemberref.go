...
func (c AdministrativeUnitMemberClient) AddAdministrativeUnitMemberRef(ctx context.Context, id stable.DirectoryAdministrativeUnitId, input stable.ReferenceCreate) (result AddAdministrativeUnitMemberRefOperationResponse, err error) {
