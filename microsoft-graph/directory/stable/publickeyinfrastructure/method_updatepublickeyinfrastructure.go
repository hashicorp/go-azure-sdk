...
func (c PublicKeyInfrastructureClient) UpdatePublicKeyInfrastructure(ctx context.Context, input stable.PublicKeyInfrastructureRoot, options UpdatePublicKeyInfrastructureOperationOptions) (result UpdatePublicKeyInfrastructureOperationResponse, err error) {
