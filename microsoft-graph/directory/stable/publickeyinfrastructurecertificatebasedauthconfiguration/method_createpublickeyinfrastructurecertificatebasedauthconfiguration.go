...
// CreatePublicKeyInfrastructureCertificateBasedAuthConfiguration - Create new navigation property to
// certificateBasedAuthConfigurations for directory
func (c PublicKeyInfrastructureCertificateBasedAuthConfigurationClient) CreatePublicKeyInfrastructureCertificateBasedAuthConfiguration(ctx context.Context, input stable.CertificateBasedAuthPki, options CreatePublicKeyInfrastructureCertificateBasedAuthConfigurationOperationOptions) (result CreatePublicKeyInfrastructureCertificateBasedAuthConfigurationOperationResponse, err error) {
	...
	var model stable.CertificateBasedAuthPki
	result.Model = &model
