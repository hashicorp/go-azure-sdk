...
func (c AdministrativeUnitClient) GetAdministrativeUnit(ctx context.Context, id DirectoryAdministrativeUnitId) (result GetAdministrativeUnitOperationResponse, err error) {
