...
func (c VerificationDnsRecordClient) CreateVerificationDnsRecord(ctx context.Context, id beta.DomainId, input beta.DomainDnsRecord) (result CreateVerificationDnsRecordOperationResponse, err error) {
