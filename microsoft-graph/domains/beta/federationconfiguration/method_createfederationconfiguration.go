...
func (c FederationConfigurationClient) CreateFederationConfiguration(ctx context.Context, id DomainId, input beta.InternalDomainFederation) (result CreateFederationConfigurationOperationResponse, err error) {
