...
func (c InvitedUserMailboxSettingClient) UpdateInvitedUserMailboxSetting(ctx context.Context, input stable.MailboxSettings) (result UpdateInvitedUserMailboxSettingOperationResponse, err error) {
