...
func TestNewInvitationInvitedUserSponsorID(t *testing.T) {
	id := NewInvitationInvitedUserSponsorID("invitationIdValue", "directoryObjectIdValue")
...
func TestFormatInvitationInvitedUserSponsorID(t *testing.T) {
	actual := NewInvitationInvitedUserSponsorID("invitationIdValue", "directoryObjectIdValue").ID()
