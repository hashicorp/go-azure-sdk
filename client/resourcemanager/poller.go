...
func NewPollerFromResponse(ctx context.Context, resp *base.Response, client *Client) (*LongRunningPoller, error) {
...
func (p *LongRunningPoller) PollUntilDone() error {
	...
	req, err := p.client.Client.NewRequest(p.ctx, http.MethodGet, "application/json; charset=utf-8", p.pollingUrl.Path, base.QueryParams{}, odata.Query{})
	if err != nil {
		return err
	}
